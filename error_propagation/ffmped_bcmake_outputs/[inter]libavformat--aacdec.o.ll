; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[inter]libavformat--aacdec.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[inter]libavformat--aacdec.o.i"
...
@.str.1 = private unnamed_addr constant [37 x i8] c"raw ADTS AAC (Advanced Audio Coding)\00", align 1
@.str.2 = private unnamed_addr constant [33 x i8] c"audio/aac,audio/aacp,audio/x-aac\00", align 1
@ff_aac_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1, i32 0, i32 0), i32 256, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), %struct.AVCodecTag** null, %struct.AVClass* null, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2, i32 0, i32 0), %struct.AVInputFormat* null, i32 86018, i32 0, i32 (%struct.AVProbeData*)* @adts_aac_probe, i32 (%struct.AVFormatContext*)* @adts_aac_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @adts_aac_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
@.str.3 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@.str.4 = private unnamed_addr constant [4 x i8] c"ID3\00", align 1

; Function Attrs: nounwind uwtable
define internal i32 @adts_aac_probe(%struct.AVProbeData* %p) #0 !dbg !2151 {
entry:
  %x.addr.i58 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %x.addr.i58, metadata !2153, metadata !2158), !dbg !2159
  %x.addr.i = alloca i16, align 2
  call void @llvm.dbg.declare(metadata i16* %x.addr.i, metadata !2167, metadata !2158), !dbg !2171
  ...
  call void @llvm.dbg.declare(metadata %struct.AVProbeData** %p.addr, metadata !2173, metadata !2158), !dbg !2174
  call void @llvm.dbg.declare(metadata i32* %max_frames, metadata !2175, metadata !2158), !dbg !2176
  store i32 0, i32* %max_frames, align 4, !dbg !2176
  call void @llvm.dbg.declare(metadata i32* %first_frames, metadata !2177, metadata !2158), !dbg !2178
  store i32 0, i32* %first_frames, align 4, !dbg !2178
  call void @llvm.dbg.declare(metadata i32* %fsize, metadata !2179, metadata !2158), !dbg !2180
  call void @llvm.dbg.declare(metadata i32* %frames, metadata !2181, metadata !2158), !dbg !2182
  call void @llvm.dbg.declare(metadata i8** %buf0, metadata !2183, metadata !2158), !dbg !2184
  %0 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2185
  %buf = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %0, i32 0, i32 1, !dbg !2186
  %1 = load i8*, i8** %buf, align 8, !dbg !2186
  store i8* %1, i8** %buf0, align 8, !dbg !2184
  call void @llvm.dbg.declare(metadata i8** %buf2, metadata !2187, metadata !2158), !dbg !2188
  call void @llvm.dbg.declare(metadata i8** %buf1, metadata !2189, metadata !2158), !dbg !2190
  call void @llvm.dbg.declare(metadata i8** %end, metadata !2191, metadata !2158), !dbg !2192
  %2 = load i8*, i8** %buf0, align 8, !dbg !2193
  %3 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2194
  %buf_size = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %3, i32 0, i32 2, !dbg !2195
  %4 = load i32, i32* %buf_size, align 8, !dbg !2195
  %idx.ext = sext i32 %4 to i64, !dbg !2196
  %add.ptr = getelementptr inbounds i8, i8* %2, i64 %idx.ext, !dbg !2196
  %add.ptr2 = getelementptr inbounds i8, i8* %add.ptr, i64 -7, !dbg !2197
  store i8* %add.ptr2, i8** %end, align 8, !dbg !2192
  %5 = load i8*, i8** %buf0, align 8, !dbg !2198
  store i8* %5, i8** %buf1, align 8, !dbg !2199
  br label %for.cond, !dbg !2200

for.cond:                                         ; preds = %for.inc40, %entry
  %6 = load i8*, i8** %buf1, align 8, !dbg !2201
  %7 = load i8*, i8** %end, align 8, !dbg !2203
  %cmp = icmp ult i8* %6, %7, !dbg !2204
  br i1 %cmp, label %for.body, label %for.end42, !dbg !2205

for.body:                                         ; preds = %for.cond
  %8 = load i8*, i8** %buf1, align 8, !dbg !2206
  store i8* %8, i8** %buf2, align 8, !dbg !2207
  store i32 0, i32* %frames, align 4, !dbg !2208
  br label %for.cond3, !dbg !2209

for.cond3:                                        ; preds = %for.inc, %for.body
  %9 = load i8*, i8** %buf2, align 8, !dbg !2210
  %10 = load i8*, i8** %end, align 8, !dbg !2212
  %cmp4 = icmp ult i8* %9, %10, !dbg !2213
  br i1 %cmp4, label %for.body5, label %for.end, !dbg !2214

for.body5:                                        ; preds = %for.cond3
  call void @llvm.dbg.declare(metadata i32* %header, metadata !2215, metadata !2158), !dbg !2216
  %11 = load i8*, i8** %buf2, align 8, !dbg !2217
  %12 = bitcast i8* %11 to %union.unaligned_16*, !dbg !2218
  %l = bitcast %union.unaligned_16* %12 to i16*, !dbg !2218
  %13 = load i16, i16* %l, align 1, !dbg !2218
  store i16 %13, i16* %x.addr.i, align 2, !dbg !2219
  %14 = load i16, i16* %x.addr.i, align 2, !dbg !2220
  %conv.i = zext i16 %14 to i32, !dbg !2220
  %shr.i = ashr i32 %conv.i, 8, !dbg !2221
  %15 = load i16, i16* %x.addr.i, align 2, !dbg !2222
  %conv1.i = zext i16 %15 to i32, !dbg !2222
  %shl.i = shl i32 %conv1.i, 8, !dbg !2223
  %or.i = or i32 %shr.i, %shl.i, !dbg !2224
  %conv2.i = trunc i32 %or.i to i16, !dbg !2225
  store i16 %conv2.i, i16* %x.addr.i, align 2, !dbg !2226
  %16 = load i16, i16* %x.addr.i, align 2, !dbg !2227
  %conv = zext i16 %16 to i32, !dbg !2219
  store i32 %conv, i32* %header, align 4, !dbg !2216
  %17 = load i32, i32* %header, align 4, !dbg !2228
  %and = and i32 %17, 65526, !dbg !2230
  %cmp6 = icmp ne i32 %and, 65520, !dbg !2231
  br i1 %cmp6, label %if.then, label %if.end11, !dbg !2232

if.then:                                          ; preds = %for.body5
  %18 = load i8*, i8** %buf1, align 8, !dbg !2233
  %19 = load i8*, i8** %buf0, align 8, !dbg !2236
  %cmp8 = icmp ne i8* %18, %19, !dbg !2237
  br i1 %cmp8, label %if.then10, label %if.end, !dbg !2238

if.then10:                                        ; preds = %if.then
  store i32 0, i32* %frames, align 4, !dbg !2239
  br label %if.end, !dbg !2241

if.end:                                           ; preds = %if.then10, %if.then
  br label %for.end, !dbg !2242

if.end11:                                         ; preds = %for.body5
  %20 = load i8*, i8** %buf2, align 8, !dbg !2243
  %add.ptr12 = getelementptr inbounds i8, i8* %20, i64 3, !dbg !2244
  %21 = bitcast i8* %add.ptr12 to %union.unaligned_32*, !dbg !2245
  %l13 = bitcast %union.unaligned_32* %21 to i32*, !dbg !2245
  %22 = load i32, i32* %l13, align 1, !dbg !2245
  store i32 %22, i32* %x.addr.i58, align 4, !dbg !2246
  %23 = load i32, i32* %x.addr.i58, align 4, !dbg !2247
  %shl.i59 = shl i32 %23, 8, !dbg !2248
  %and.i = and i32 %shl.i59, 65280, !dbg !2249
  %24 = load i32, i32* %x.addr.i58, align 4, !dbg !2250
  %shr.i60 = lshr i32 %24, 8, !dbg !2251
  %and1.i = and i32 %shr.i60, 255, !dbg !2252
  %or.i61 = or i32 %and.i, %and1.i, !dbg !2253
  %shl2.i = shl i32 %or.i61, 16, !dbg !2254
  %25 = load i32, i32* %x.addr.i58, align 4, !dbg !2255
  %shr3.i = lshr i32 %25, 16, !dbg !2256
  %shl4.i = shl i32 %shr3.i, 8, !dbg !2257
  %and5.i = and i32 %shl4.i, 65280, !dbg !2258
  %26 = load i32, i32* %x.addr.i58, align 4, !dbg !2259
  %shr6.i = lshr i32 %26, 16, !dbg !2260
  %shr7.i = lshr i32 %shr6.i, 8, !dbg !2261
  %and8.i = and i32 %shr7.i, 255, !dbg !2262
  %or9.i = or i32 %and5.i, %and8.i, !dbg !2263
  %or10.i = or i32 %shl2.i, %or9.i, !dbg !2264
  %shr = lshr i32 %or10.i, 13, !dbg !2265
  %and15 = and i32 %shr, 8191, !dbg !2266
  store i32 %and15, i32* %fsize, align 4, !dbg !2267
  %27 = load i32, i32* %fsize, align 4, !dbg !2268
  %cmp16 = icmp slt i32 %27, 7, !dbg !2270
  br i1 %cmp16, label %if.then18, label %if.end19, !dbg !2271

if.then18:                                        ; preds = %if.end11
  br label %for.end, !dbg !2272

if.end19:                                         ; preds = %if.end11
  %28 = load i32, i32* %fsize, align 4, !dbg !2273
  %conv20 = sext i32 %28 to i64, !dbg !2274
  %29 = load i8*, i8** %end, align 8, !dbg !2275
  %30 = load i8*, i8** %buf2, align 8, !dbg !2276
  %sub.ptr.lhs.cast = ptrtoint i8* %29 to i64, !dbg !2277
  %sub.ptr.rhs.cast = ptrtoint i8* %30 to i64, !dbg !2277
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast, !dbg !2277
  %cmp21 = icmp sgt i64 %conv20, %sub.ptr.sub, !dbg !2278
  br i1 %cmp21, label %cond.true, label %cond.false, !dbg !2274

cond.true:                                        ; preds = %if.end19
  %31 = load i8*, i8** %end, align 8, !dbg !2279
  %32 = load i8*, i8** %buf2, align 8, !dbg !2281
  %sub.ptr.lhs.cast23 = ptrtoint i8* %31 to i64, !dbg !2282
  %sub.ptr.rhs.cast24 = ptrtoint i8* %32 to i64, !dbg !2282
  %sub.ptr.sub25 = sub i64 %sub.ptr.lhs.cast23, %sub.ptr.rhs.cast24, !dbg !2282
  br label %cond.end, !dbg !2283

cond.false:                                       ; preds = %if.end19
  %33 = load i32, i32* %fsize, align 4, !dbg !2284
  %conv26 = sext i32 %33 to i64, !dbg !2286
  br label %cond.end, !dbg !2287

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i64 [ %sub.ptr.sub25, %cond.true ], [ %conv26, %cond.false ], !dbg !2288
  %conv27 = trunc i64 %cond to i32, !dbg !2290
  store i32 %conv27, i32* %fsize, align 4, !dbg !2291
  %34 = load i32, i32* %fsize, align 4, !dbg !2292
  %35 = load i8*, i8** %buf2, align 8, !dbg !2293
  %idx.ext28 = sext i32 %34 to i64, !dbg !2293
  %add.ptr29 = getelementptr inbounds i8, i8* %35, i64 %idx.ext28, !dbg !2293
  store i8* %add.ptr29, i8** %buf2, align 8, !dbg !2293
  br label %for.inc, !dbg !2294

for.inc:                                          ; preds = %cond.end
  %36 = load i32, i32* %frames, align 4, !dbg !2295
  %inc = add nsw i32 %36, 1, !dbg !2295
  store i32 %inc, i32* %frames, align 4, !dbg !2295
  br label %for.cond3, !dbg !2297, !llvm.loop !2298

for.end:                                          ; preds = %if.then18, %if.end, %for.cond3
  %37 = load i32, i32* %max_frames, align 4, !dbg !2300
  %38 = load i32, i32* %frames, align 4, !dbg !2301
  %cmp30 = icmp sgt i32 %37, %38, !dbg !2302
  br i1 %cmp30, label %cond.true32, label %cond.false33, !dbg !2303

cond.true32:                                      ; preds = %for.end
  %39 = load i32, i32* %max_frames, align 4, !dbg !2304
  br label %cond.end34, !dbg !2306

cond.false33:                                     ; preds = %for.end
  %40 = load i32, i32* %frames, align 4, !dbg !2307
  br label %cond.end34, !dbg !2309

cond.end34:                                       ; preds = %cond.false33, %cond.true32
  %cond35 = phi i32 [ %39, %cond.true32 ], [ %40, %cond.false33 ], !dbg !2310
  store i32 %cond35, i32* %max_frames, align 4, !dbg !2312
  %41 = load i8*, i8** %buf1, align 8, !dbg !2313
  %42 = load i8*, i8** %buf0, align 8, !dbg !2315
  %cmp36 = icmp eq i8* %41, %42, !dbg !2316
  br i1 %cmp36, label %if.then38, label %if.end39, !dbg !2317

if.then38:                                        ; preds = %cond.end34
  %43 = load i32, i32* %frames, align 4, !dbg !2318
  store i32 %43, i32* %first_frames, align 4, !dbg !2319
  br label %if.end39, !dbg !2320

if.end39:                                         ; preds = %if.then38, %cond.end34
  br label %for.inc40, !dbg !2321

for.inc40:                                        ; preds = %if.end39
  %44 = load i8*, i8** %buf2, align 8, !dbg !2322
  %add.ptr41 = getelementptr inbounds i8, i8* %44, i64 1, !dbg !2324
  store i8* %add.ptr41, i8** %buf1, align 8, !dbg !2325
  br label %for.cond, !dbg !2326, !llvm.loop !2327

for.end42:                                        ; preds = %for.cond
  %45 = load i32, i32* %first_frames, align 4, !dbg !2328
  %cmp43 = icmp sge i32 %45, 3, !dbg !2330
  br i1 %cmp43, label %if.then45, label %if.else, !dbg !2331

if.then45:                                        ; preds = %for.end42
  store i32 51, i32* %retval, align 4, !dbg !2332
  br label %return, !dbg !2332

if.else:                                          ; preds = %for.end42
  %46 = load i32, i32* %max_frames, align 4, !dbg !2333
  %cmp46 = icmp sgt i32 %46, 100, !dbg !2335
  br i1 %cmp46, label %if.then48, label %if.else49, !dbg !2336

if.then48:                                        ; preds = %if.else
  store i32 50, i32* %retval, align 4, !dbg !2337
  br label %return, !dbg !2337

if.else49:                                        ; preds = %if.else
  %47 = load i32, i32* %max_frames, align 4, !dbg !2338
  %cmp50 = icmp sge i32 %47, 3, !dbg !2340
  br i1 %cmp50, label %if.then52, label %if.else53, !dbg !2341

if.then52:                                        ; preds = %if.else49
  store i32 25, i32* %retval, align 4, !dbg !2342
  br label %return, !dbg !2342

if.else53:                                        ; preds = %if.else49
  %48 = load i32, i32* %first_frames, align 4, !dbg !2343
  %cmp54 = icmp sge i32 %48, 1, !dbg !2345
  br i1 %cmp54, label %if.then56, label %if.else57, !dbg !2346
...
return:                                           ; preds = %if.else57, %if.then56, %if.then52, %if.then48, %if.then45
  %49 = load i32, i32* %retval, align 4, !dbg !2349
  ret i32 %49, !dbg !2349
}

; Function Attrs: nounwind uwtable
define internal i32 @adts_aac_read_header(%struct.AVFormatContext* %s) #0 !dbg !2350 {
entry:
  %s.addr.i37 = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i37, metadata !2355, metadata !2158), !dbg !2359
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2355, metadata !2158), !dbg !2362
  %retval = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2366, metadata !2158), !dbg !2367
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2368, metadata !2158), !dbg !2369
  call void @llvm.dbg.declare(metadata i16* %state, metadata !2370, metadata !2158), !dbg !2371
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2372
  %call = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %0, %struct.AVCodec* null), !dbg !2373
  store %struct.AVStream* %call, %struct.AVStream** %st, align 8, !dbg !2374
  %1 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2375
  %tobool = icmp ne %struct.AVStream* %1, null, !dbg !2375
...
if.end:                                           ; preds = %entry
  %2 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2379
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %2, i32 0, i32 19, !dbg !2380
  %3 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2380
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %3, i32 0, i32 0, !dbg !2381
  store i32 1, i32* %codec_type, align 8, !dbg !2382
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2383
  %iformat = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %4, i32 0, i32 1, !dbg !2384
  %5 = load %struct.AVInputFormat*, %struct.AVInputFormat** %iformat, align 8, !dbg !2384
  %raw_codec_id = getelementptr inbounds %struct.AVInputFormat, %struct.AVInputFormat* %5, i32 0, i32 8, !dbg !2385
  %6 = load i32, i32* %raw_codec_id, align 8, !dbg !2385
  %7 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2386
  %codecpar1 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %7, i32 0, i32 19, !dbg !2387
  %8 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar1, align 8, !dbg !2387
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %8, i32 0, i32 1, !dbg !2388
  store i32 %6, i32* %codec_id, align 4, !dbg !2389
  %9 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2390
  %need_parsing = getelementptr inbounds %struct.AVStream, %struct.AVStream* %9, i32 0, i32 28, !dbg !2391
  store i32 5, i32* %need_parsing, align 4, !dbg !2392
  %10 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2393
  call void @ff_id3v1_read(%struct.AVFormatContext* %10), !dbg !2394
  %11 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2395
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %11, i32 0, i32 4, !dbg !2396
  %12 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2396
  %seekable = getelementptr inbounds %struct.AVIOContext, %struct.AVIOContext* %12, i32 0, i32 19, !dbg !2397
  %13 = load i32, i32* %seekable, align 8, !dbg !2397
  %and = and i32 %13, 1, !dbg !2398
  %tobool2 = icmp ne i32 %and, 0, !dbg !2398
  br i1 %tobool2, label %land.lhs.true, label %if.end11, !dbg !2399

land.lhs.true:                                    ; preds = %if.end
  %14 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2400
  %metadata = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %14, i32 0, i32 29, !dbg !2401
  %15 = load %struct.AVDictionary*, %struct.AVDictionary** %metadata, align 8, !dbg !2401
  %call3 = call %struct.AVDictionaryEntry* @av_dict_get(%struct.AVDictionary* %15, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.3, i32 0, i32 0), %struct.AVDictionaryEntry* null, i32 2), !dbg !2402
  %tobool4 = icmp ne %struct.AVDictionaryEntry* %call3, null, !dbg !2402
  br i1 %tobool4, label %if.end11, label %if.then5, !dbg !2403

if.then5:                                         ; preds = %land.lhs.true
  call void @llvm.dbg.declare(metadata i64* %cur, metadata !2405, metadata !2158), !dbg !2406
  %16 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2407
  %pb6 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %16, i32 0, i32 4, !dbg !2408
  %17 = load %struct.AVIOContext*, %struct.AVIOContext** %pb6, align 8, !dbg !2408
  store %struct.AVIOContext* %17, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2409
  %18 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2410
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %18, i64 0, i32 1) #3, !dbg !2411
  store i64 %call.i, i64* %cur, align 8, !dbg !2406
  %19 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2412
  %call8 = call i64 @ff_ape_parse_tag(%struct.AVFormatContext* %19), !dbg !2413
  %20 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2414
  %pb9 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %20, i32 0, i32 4, !dbg !2415
  %21 = load %struct.AVIOContext*, %struct.AVIOContext** %pb9, align 8, !dbg !2415
  %22 = load i64, i64* %cur, align 8, !dbg !2416
  %call10 = call i64 @avio_seek(%struct.AVIOContext* %21, i64 %22, i32 0), !dbg !2417
  br label %if.end11, !dbg !2418

if.end11:                                         ; preds = %if.then5, %land.lhs.true, %if.end
  %23 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2419
  %pb12 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %23, i32 0, i32 4, !dbg !2420
  %24 = load %struct.AVIOContext*, %struct.AVIOContext** %pb12, align 8, !dbg !2420
  %call13 = call i32 @avio_r8(%struct.AVIOContext* %24), !dbg !2421
  %conv = trunc i32 %call13 to i16, !dbg !2421
  store i16 %conv, i16* %state, align 2, !dbg !2422
  br label %while.cond, !dbg !2423

while.cond:                                       ; preds = %if.then27, %if.end11
  %25 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2424
  %pb14 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %25, i32 0, i32 4, !dbg !2425
  %26 = load %struct.AVIOContext*, %struct.AVIOContext** %pb14, align 8, !dbg !2425
  %call15 = call i32 @avio_feof(%struct.AVIOContext* %26), !dbg !2426
  %tobool16 = icmp ne i32 %call15, 0, !dbg !2426
  br i1 %tobool16, label %land.end, label %land.rhs, !dbg !2427

land.rhs:                                         ; preds = %while.cond
  %27 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2428
  %pb17 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %27, i32 0, i32 4, !dbg !2429
  %28 = load %struct.AVIOContext*, %struct.AVIOContext** %pb17, align 8, !dbg !2429
  store %struct.AVIOContext* %28, %struct.AVIOContext** %s.addr.i37, align 8, !dbg !2430
  %29 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i37, align 8, !dbg !2431
  %call.i38 = call i64 @avio_seek(%struct.AVIOContext* %29, i64 0, i32 1) #3, !dbg !2432
  %30 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2433
  %probesize = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %30, i32 0, i32 16, !dbg !2434
  %31 = load i64, i64* %probesize, align 8, !dbg !2434
  %cmp = icmp slt i64 %call.i38, %31, !dbg !2435
  br label %land.end

land.end:                                         ; preds = %land.rhs, %while.cond
  %32 = phi i1 [ false, %while.cond ], [ %cmp, %land.rhs ]
  br i1 %32, label %while.body, label %while.end, !dbg !2436

while.body:                                       ; preds = %land.end
  %33 = load i16, i16* %state, align 2, !dbg !2438
  %conv20 = zext i16 %33 to i32, !dbg !2438
  %shl = shl i32 %conv20, 8, !dbg !2440
  %34 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2441
  %pb21 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %34, i32 0, i32 4, !dbg !2442
  %35 = load %struct.AVIOContext*, %struct.AVIOContext** %pb21, align 8, !dbg !2442
  %call22 = call i32 @avio_r8(%struct.AVIOContext* %35), !dbg !2443
  %or = or i32 %shl, %call22, !dbg !2444
  %conv23 = trunc i32 %or to i16, !dbg !2445
  store i16 %conv23, i16* %state, align 2, !dbg !2446
  %36 = load i16, i16* %state, align 2, !dbg !2447
  %conv24 = zext i16 %36 to i32, !dbg !2447
  %shr = ashr i32 %conv24, 4, !dbg !2449
  %cmp25 = icmp ne i32 %shr, 4095, !dbg !2450
  br i1 %cmp25, label %if.then27, label %if.end28, !dbg !2451
...
if.end28:                                         ; preds = %while.body
  ...
  %pb29 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %37, i32 0, i32 4, !dbg !2455
  %38 = load %struct.AVIOContext*, %struct.AVIOContext** %pb29, align 8, !dbg !2455
  %call30 = call i64 @avio_seek(%struct.AVIOContext* %38, i64 -2, i32 1), !dbg !2456
  br label %while.end, !dbg !2457

while.end:                                        ; preds = %if.end28, %land.end
  %39 = load i16, i16* %state, align 2, !dbg !2458
  %conv31 = zext i16 %39 to i32, !dbg !2458
  %shr32 = ashr i32 %conv31, 4, !dbg !2460
  %cmp33 = icmp ne i32 %shr32, 4095, !dbg !2461
  br i1 %cmp33, label %if.then35, label %if.end36, !dbg !2462
...
if.end36:                                         ; preds = %while.end
  %40 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2464
  call void @avpriv_set_pts_info(%struct.AVStream* %40, i32 64, i32 1, i32 28224000), !dbg !2465
  store i32 0, i32* %retval, align 4, !dbg !2466
  br label %return, !dbg !2466

return:                                           ; preds = %if.end36, %if.then35, %if.then
  %41 = load i32, i32* %retval, align 4, !dbg !2467
  ret i32 %41, !dbg !2467
}

; Function Attrs: nounwind uwtable
define internal i32 @adts_aac_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2468 {
entry:
  %x.addr.i32 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %x.addr.i32, metadata !2153, metadata !2158), !dbg !2471
  %x.addr.i = alloca i16, align 2
  call void @llvm.dbg.declare(metadata i16* %x.addr.i, metadata !2167, metadata !2158), !dbg !2473
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  %fsize = alloca i32, align 4
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2476, metadata !2158), !dbg !2477
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2478, metadata !2158), !dbg !2479
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2480, metadata !2158), !dbg !2481
  call void @llvm.dbg.declare(metadata i32* %fsize, metadata !2482, metadata !2158), !dbg !2483
  br label %while.body, !dbg !2484

while.body:                                       ; preds = %entry, %if.then4
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2485
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2487
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2487
  %2 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2488
  %call = call i32 @av_get_packet(%struct.AVIOContext* %1, %struct.AVPacket* %2, i32 10), !dbg !2489
  store i32 %call, i32* %ret, align 4, !dbg !2490
  %3 = load i32, i32* %ret, align 4, !dbg !2491
  %cmp = icmp sge i32 %3, 10, !dbg !2493
  br i1 %cmp, label %land.lhs.true, label %if.end5, !dbg !2494

land.lhs.true:                                    ; preds = %while.body
  %4 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2495
  %data = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %4, i32 0, i32 3, !dbg !2497
  %5 = load i8*, i8** %data, align 8, !dbg !2497
  %call1 = call i32 @ff_id3v2_match(i8* %5, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i32 0, i32 0)), !dbg !2498
  %tobool = icmp ne i32 %call1, 0, !dbg !2498
  br i1 %tobool, label %if.then, label %if.end5, !dbg !2499

if.then:                                          ; preds = %land.lhs.true
  %6 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2500
  %7 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2503
  %call2 = call i32 @handle_id3(%struct.AVFormatContext* %6, %struct.AVPacket* %7), !dbg !2504
  store i32 %call2, i32* %ret, align 4, !dbg !2505
  %cmp3 = icmp sge i32 %call2, 0, !dbg !2506
  br i1 %cmp3, label %if.then4, label %if.end, !dbg !2507

if.then4:                                         ; preds = %if.then
  br label %while.body, !dbg !2508, !llvm.loop !2510

if.end:                                           ; preds = %if.then
  br label %if.end5, !dbg !2511

if.end5:                                          ; preds = %if.end, %land.lhs.true, %while.body
  br label %while.end, !dbg !2512

while.end:                                        ; preds = %if.end5
  %8 = load i32, i32* %ret, align 4, !dbg !2513
  %cmp6 = icmp slt i32 %8, 0, !dbg !2515
  br i1 %cmp6, label %if.then7, label %if.end8, !dbg !2516

if.then7:                                         ; preds = %while.end
  %9 = load i32, i32* %ret, align 4, !dbg !2517
  store i32 %9, i32* %retval, align 4, !dbg !2518
  br label %return, !dbg !2518

if.end8:                                          ; preds = %while.end
  %10 = load i32, i32* %ret, align 4, !dbg !2519
  %cmp9 = icmp slt i32 %10, 7, !dbg !2521
  br i1 %cmp9, label %if.then10, label %if.end11, !dbg !2522

if.then10:                                        ; preds = %if.end8
  %11 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2523
  call void @av_packet_unref(%struct.AVPacket* %11), !dbg !2525
  store i32 -5, i32* %retval, align 4, !dbg !2526
  br label %return, !dbg !2526

if.end11:                                         ; preds = %if.end8
  %12 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2527
  %data12 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %12, i32 0, i32 3, !dbg !2528
  %13 = load i8*, i8** %data12, align 8, !dbg !2528
  %14 = bitcast i8* %13 to %union.unaligned_16*, !dbg !2529
  %l = bitcast %union.unaligned_16* %14 to i16*, !dbg !2529
  %15 = load i16, i16* %l, align 1, !dbg !2529
  store i16 %15, i16* %x.addr.i, align 2, !dbg !2530
  %16 = load i16, i16* %x.addr.i, align 2, !dbg !2531
  %conv.i = zext i16 %16 to i32, !dbg !2531
  %shr.i = ashr i32 %conv.i, 8, !dbg !2532
  %17 = load i16, i16* %x.addr.i, align 2, !dbg !2533
  %conv1.i = zext i16 %17 to i32, !dbg !2533
  %shl.i = shl i32 %conv1.i, 8, !dbg !2534
  %or.i = or i32 %shr.i, %shl.i, !dbg !2535
  %conv2.i = trunc i32 %or.i to i16, !dbg !2536
  store i16 %conv2.i, i16* %x.addr.i, align 2, !dbg !2537
  %18 = load i16, i16* %x.addr.i, align 2, !dbg !2538
  %conv = zext i16 %18 to i32, !dbg !2530
  %shr = ashr i32 %conv, 4, !dbg !2539
  %cmp14 = icmp ne i32 %shr, 4095, !dbg !2540
  br i1 %cmp14, label %if.then16, label %if.end17, !dbg !2541

if.then16:                                        ; preds = %if.end11
  %19 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2542
  call void @av_packet_unref(%struct.AVPacket* %19), !dbg !2544
  store i32 -1094995529, i32* %retval, align 4, !dbg !2545
  br label %return, !dbg !2545

if.end17:                                         ; preds = %if.end11
  %20 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2546
  %data18 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %20, i32 0, i32 3, !dbg !2547
  %21 = load i8*, i8** %data18, align 8, !dbg !2547
  %add.ptr = getelementptr inbounds i8, i8* %21, i64 3, !dbg !2548
  %22 = bitcast i8* %add.ptr to %union.unaligned_32*, !dbg !2549
  %l19 = bitcast %union.unaligned_32* %22 to i32*, !dbg !2549
  %23 = load i32, i32* %l19, align 1, !dbg !2549
  store i32 %23, i32* %x.addr.i32, align 4, !dbg !2550
  %24 = load i32, i32* %x.addr.i32, align 4, !dbg !2551
  %shl.i33 = shl i32 %24, 8, !dbg !2552
  %and.i = and i32 %shl.i33, 65280, !dbg !2553
  %25 = load i32, i32* %x.addr.i32, align 4, !dbg !2554
  %shr.i34 = lshr i32 %25, 8, !dbg !2555
  %and1.i = and i32 %shr.i34, 255, !dbg !2556
  %or.i35 = or i32 %and.i, %and1.i, !dbg !2557
  %shl2.i = shl i32 %or.i35, 16, !dbg !2558
  %26 = load i32, i32* %x.addr.i32, align 4, !dbg !2559
  %shr3.i = lshr i32 %26, 16, !dbg !2560
  %shl4.i = shl i32 %shr3.i, 8, !dbg !2561
  %and5.i = and i32 %shl4.i, 65280, !dbg !2562
  %27 = load i32, i32* %x.addr.i32, align 4, !dbg !2563
  %shr6.i = lshr i32 %27, 16, !dbg !2564
  ...
  %shr21 = lshr i32 %or10.i, 13, !dbg !2569
  %and = and i32 %shr21, 8191, !dbg !2570
  store i32 %and, i32* %fsize, align 4, !dbg !2571
  %28 = load i32, i32* %fsize, align 4, !dbg !2572
  %cmp22 = icmp slt i32 %28, 7, !dbg !2574
  br i1 %cmp22, label %if.then24, label %if.end25, !dbg !2575

if.then24:                                        ; preds = %if.end17
  %29 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2576
  call void @av_packet_unref(%struct.AVPacket* %29), !dbg !2578
  store i32 -1094995529, i32* %retval, align 4, !dbg !2579
  br label %return, !dbg !2579

if.end25:                                         ; preds = %if.end17
  %30 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2580
  %pb26 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %30, i32 0, i32 4, !dbg !2581
  %31 = load %struct.AVIOContext*, %struct.AVIOContext** %pb26, align 8, !dbg !2581
  %32 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2582
  %33 = load i32, i32* %fsize, align 4, !dbg !2583
  %34 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2584
  %size = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %34, i32 0, i32 4, !dbg !2585
  %35 = load i32, i32* %size, align 8, !dbg !2585
  %sub = sub nsw i32 %33, %35, !dbg !2586
  %call27 = call i32 @av_append_packet(%struct.AVIOContext* %31, %struct.AVPacket* %32, i32 %sub), !dbg !2587
  store i32 %call27, i32* %ret, align 4, !dbg !2588
  %36 = load i32, i32* %ret, align 4, !dbg !2589
  %cmp28 = icmp slt i32 %36, 0, !dbg !2591
  br i1 %cmp28, label %if.then30, label %if.end31, !dbg !2592

if.then30:                                        ; preds = %if.end25
  %37 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2593
  call void @av_packet_unref(%struct.AVPacket* %37), !dbg !2594
  br label %if.end31, !dbg !2594

if.end31:                                         ; preds = %if.then30, %if.end25
  %38 = load i32, i32* %ret, align 4, !dbg !2595
  store i32 %38, i32* %retval, align 4, !dbg !2596
  br label %return, !dbg !2596

return:                                           ; preds = %if.end31, %if.then24, %if.then16, %if.then10, %if.then7
  %39 = load i32, i32* %retval, align 4, !dbg !2597
  ret i32 %39, !dbg !2597
}
...
; Function Attrs: nounwind uwtable
define internal i32 @handle_id3(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2598 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %pkt.addr = alloca %struct.AVPacket*, align 8
  %metadata = alloca %struct.AVDictionary*, align 8
  %ioctx = alloca %struct.AVIOContext, align 8
  %id3v2_extra_meta = alloca %struct.ID3v2ExtraMeta*, align 8
  %ret = alloca i32, align 4
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2599, metadata !2158), !dbg !2600
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2601, metadata !2158), !dbg !2602
  call void @llvm.dbg.declare(metadata %struct.AVDictionary** %metadata, metadata !2603, metadata !2158), !dbg !2604
  store %struct.AVDictionary* null, %struct.AVDictionary** %metadata, align 8, !dbg !2604
  call void @llvm.dbg.declare(metadata %struct.AVIOContext* %ioctx, metadata !2605, metadata !2158), !dbg !2606
  call void @llvm.dbg.declare(metadata %struct.ID3v2ExtraMeta** %id3v2_extra_meta, metadata !2607, metadata !2158), !dbg !2617
  store %struct.ID3v2ExtraMeta* null, %struct.ID3v2ExtraMeta** %id3v2_extra_meta, align 8, !dbg !2617
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2618, metadata !2158), !dbg !2619
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2620
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2621
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2621
  %2 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2622
  %3 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2623
  %data = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %3, i32 0, i32 3, !dbg !2624
  %4 = load i8*, i8** %data, align 8, !dbg !2624
  %call = call i32 @ff_id3v2_tag_len(i8* %4), !dbg !2625
  %5 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2626
  %size = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %5, i32 0, i32 4, !dbg !2627
  %6 = load i32, i32* %size, align 8, !dbg !2627
  %sub = sub nsw i32 %call, %6, !dbg !2628
  %call1 = call i32 @av_append_packet(%struct.AVIOContext* %1, %struct.AVPacket* %2, i32 %sub), !dbg !2629
  store i32 %call1, i32* %ret, align 4, !dbg !2631
  %7 = load i32, i32* %ret, align 4, !dbg !2632
  %cmp = icmp slt i32 %7, 0, !dbg !2634
  br i1 %cmp, label %if.then, label %if.end, !dbg !2635

if.then:                                          ; preds = %entry
  %8 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2636
  call void @av_packet_unref(%struct.AVPacket* %8), !dbg !2638
  %9 = load i32, i32* %ret, align 4, !dbg !2639
  store i32 %9, i32* %retval, align 4, !dbg !2640
  br label %return, !dbg !2640

if.end:                                           ; preds = %entry
  %10 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2641
  %data2 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %10, i32 0, i32 3, !dbg !2642
  %11 = load i8*, i8** %data2, align 8, !dbg !2642
  %12 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2643
  %size3 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %12, i32 0, i32 4, !dbg !2644
  %13 = load i32, i32* %size3, align 8, !dbg !2644
  %call4 = call i32 @ffio_init_context(%struct.AVIOContext* %ioctx, i8* %11, i32 %13, i32 0, i8* null, i32 (i8*, i8*, i32)* null, i32 (i8*, i8*, i32)* null, i64 (i8*, i64, i32)* null), !dbg !2645
  call void @ff_id3v2_read_dict(%struct.AVIOContext* %ioctx, %struct.AVDictionary** %metadata, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i32 0, i32 0), %struct.ID3v2ExtraMeta** %id3v2_extra_meta), !dbg !2646
  %call5 = call i32 @ff_id3v2_parse_priv_dict(%struct.AVDictionary** %metadata, %struct.ID3v2ExtraMeta** %id3v2_extra_meta), !dbg !2647
  store i32 %call5, i32* %ret, align 4, !dbg !2649
  %cmp6 = icmp slt i32 %call5, 0, !dbg !2650
  br i1 %cmp6, label %if.then7, label %if.end8, !dbg !2651

if.then7:                                         ; preds = %if.end
  br label %error, !dbg !2652

if.end8:                                          ; preds = %if.end
  %14 = load %struct.AVDictionary*, %struct.AVDictionary** %metadata, align 8, !dbg !2653
  %tobool = icmp ne %struct.AVDictionary* %14, null, !dbg !2653
  br i1 %tobool, label %if.then9, label %if.end15, !dbg !2655

if.then9:                                         ; preds = %if.end8
  %15 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2656
  %metadata10 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %15, i32 0, i32 29, !dbg !2659
  %16 = load %struct.AVDictionary*, %struct.AVDictionary** %metadata, align 8, !dbg !2660
  %call11 = call i32 @av_dict_copy(%struct.AVDictionary** %metadata10, %struct.AVDictionary* %16, i32 0), !dbg !2661
  store i32 %call11, i32* %ret, align 4, !dbg !2662
  %cmp12 = icmp slt i32 %call11, 0, !dbg !2663
  br i1 %cmp12, label %if.then13, label %if.end14, !dbg !2664

if.then13:                                        ; preds = %if.then9
  br label %error, !dbg !2665

if.end14:                                         ; preds = %if.then9
  %17 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2666
  %event_flags = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %17, i32 0, i32 37, !dbg !2667
  %18 = load i32, i32* %event_flags, align 4, !dbg !2668
  %or = or i32 %18, 1, !dbg !2668
  store i32 %or, i32* %event_flags, align 4, !dbg !2668
  br label %if.end15, !dbg !2669

if.end15:                                         ; preds = %if.end14, %if.end8
  br label %error, !dbg !2670

error:                                            ; preds = %if.end15, %if.then13, %if.then7
  %19 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2672
  call void @av_packet_unref(%struct.AVPacket* %19), !dbg !2673
  call void @ff_id3v2_free_extra_meta(%struct.ID3v2ExtraMeta** %id3v2_extra_meta), !dbg !2674
  call void @av_dict_free(%struct.AVDictionary** %metadata), !dbg !2675
  %20 = load i32, i32* %ret, align 4, !dbg !2676
  store i32 %20, i32* %retval, align 4, !dbg !2677
  br label %return, !dbg !2677

return:                                           ; preds = %error, %if.then
  %21 = load i32, i32* %retval, align 4, !dbg !2678
  ret i32 %21, !dbg !2678
}
...
declare void @ff_id3v2_read_dict(%struct.AVIOContext*, %struct.AVDictionary**, i8*, %struct.ID3v2ExtraMeta**) #2

declare i32 @ff_id3v2_parse_priv_dict(%struct.AVDictionary**, %struct.ID3v2ExtraMeta**) #2
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[inter]libavformat--aacdec.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs")
...
!935 = !{!936}
!936 = distinct !DIGlobalVariable(name: "ff_aac_demuxer", scope: !0, file: !937, line: 194, type: !938, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_aac_demuxer)
!937 = !DIFile(filename: "libavformat/aacdec.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs")
...
!2151 = distinct !DISubprogram(name: "adts_aac_probe", scope: !937, file: !937, line: 33, type: !1006, isLocal: true, isDefinition: true, scopeLine: 34, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2152 = !{}
...
!2160 = distinct !DILocation(line: 59, column: 22, scope: !2161)
!2161 = distinct !DILexicalBlock(scope: !2162, file: !937, line: 47, column: 48)
!2162 = distinct !DILexicalBlock(scope: !2163, file: !937, line: 47, column: 9)
!2163 = distinct !DILexicalBlock(scope: !2164, file: !937, line: 47, column: 9)
!2164 = distinct !DILexicalBlock(scope: !2165, file: !937, line: 44, column: 39)
!2165 = distinct !DILexicalBlock(scope: !2166, file: !937, line: 44, column: 5)
!2166 = distinct !DILexicalBlock(scope: !2151, file: !937, line: 44, column: 5)
!2167 = !DILocalVariable(name: "x", arg: 1, scope: !2168, file: !2155, line: 58, type: !923)
!2168 = distinct !DISubprogram(name: "av_bswap16", scope: !2155, file: !2155, line: 58, type: !2169, isLocal: true, isDefinition: true, scopeLine: 59, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2169 = !DISubroutineType(types: !2170)
!2170 = !{!923, !923}
!2171 = !DILocation(line: 58, column: 98, scope: !2168, inlinedAt: !2172)
!2172 = distinct !DILocation(line: 48, column: 31, scope: !2161)
!2173 = !DILocalVariable(name: "p", arg: 1, scope: !2151, file: !937, line: 33, type: !1008)
!2174 = !DILocation(line: 33, column: 40, scope: !2151)
!2175 = !DILocalVariable(name: "max_frames", scope: !2151, file: !937, line: 35, type: !933)
!2176 = !DILocation(line: 35, column: 9, scope: !2151)
!2177 = !DILocalVariable(name: "first_frames", scope: !2151, file: !937, line: 35, type: !933)
!2178 = !DILocation(line: 35, column: 25, scope: !2151)
!2179 = !DILocalVariable(name: "fsize", scope: !2151, file: !937, line: 36, type: !933)
!2180 = !DILocation(line: 36, column: 9, scope: !2151)
!2181 = !DILocalVariable(name: "frames", scope: !2151, file: !937, line: 36, type: !933)
!2182 = !DILocation(line: 36, column: 16, scope: !2151)
!2183 = !DILocalVariable(name: "buf0", scope: !2151, file: !937, line: 37, type: !1258)
!2184 = !DILocation(line: 37, column: 20, scope: !2151)
!2185 = !DILocation(line: 37, column: 27, scope: !2151)
!2186 = !DILocation(line: 37, column: 30, scope: !2151)
!2187 = !DILocalVariable(name: "buf2", scope: !2151, file: !937, line: 38, type: !1258)
!2188 = !DILocation(line: 38, column: 20, scope: !2151)
!2189 = !DILocalVariable(name: "buf", scope: !2151, file: !937, line: 39, type: !1258)
!2190 = !DILocation(line: 39, column: 20, scope: !2151)
!2191 = !DILocalVariable(name: "end", scope: !2151, file: !937, line: 40, type: !1258)
!2192 = !DILocation(line: 40, column: 20, scope: !2151)
!2193 = !DILocation(line: 40, column: 26, scope: !2151)
!2194 = !DILocation(line: 40, column: 33, scope: !2151)
!2195 = !DILocation(line: 40, column: 36, scope: !2151)
!2196 = !DILocation(line: 40, column: 31, scope: !2151)
!2197 = !DILocation(line: 40, column: 45, scope: !2151)
!2198 = !DILocation(line: 42, column: 11, scope: !2151)
!2199 = !DILocation(line: 42, column: 9, scope: !2151)
!2200 = !DILocation(line: 44, column: 5, scope: !2151)
!2201 = !DILocation(line: 44, column: 12, scope: !2202)
!2202 = !DILexicalBlockFile(scope: !2165, file: !937, discriminator: 1)
!2203 = !DILocation(line: 44, column: 18, scope: !2202)
!2204 = !DILocation(line: 44, column: 16, scope: !2202)
!2205 = !DILocation(line: 44, column: 5, scope: !2202)
!2206 = !DILocation(line: 45, column: 16, scope: !2164)
!2207 = !DILocation(line: 45, column: 14, scope: !2164)
!2208 = !DILocation(line: 47, column: 21, scope: !2163)
!2209 = !DILocation(line: 47, column: 14, scope: !2163)
!2210 = !DILocation(line: 47, column: 26, scope: !2211)
!2211 = !DILexicalBlockFile(scope: !2162, file: !937, discriminator: 1)
!2212 = !DILocation(line: 47, column: 33, scope: !2211)
!2213 = !DILocation(line: 47, column: 31, scope: !2211)
!2214 = !DILocation(line: 47, column: 9, scope: !2211)
!2215 = !DILocalVariable(name: "header", scope: !2161, file: !937, line: 48, type: !931)
!2216 = !DILocation(line: 48, column: 22, scope: !2161)
!2217 = !DILocation(line: 48, column: 74, scope: !2161)
!2218 = !DILocation(line: 48, column: 82, scope: !2161)
!2219 = !DILocation(line: 48, column: 31, scope: !2161)
!2220 = !DILocation(line: 60, column: 9, scope: !2168, inlinedAt: !2172)
!2221 = !DILocation(line: 60, column: 10, scope: !2168, inlinedAt: !2172)
!2222 = !DILocation(line: 60, column: 18, scope: !2168, inlinedAt: !2172)
!2223 = !DILocation(line: 60, column: 19, scope: !2168, inlinedAt: !2172)
!2224 = !DILocation(line: 60, column: 15, scope: !2168, inlinedAt: !2172)
!2225 = !DILocation(line: 60, column: 8, scope: !2168, inlinedAt: !2172)
!2226 = !DILocation(line: 60, column: 6, scope: !2168, inlinedAt: !2172)
!2227 = !DILocation(line: 61, column: 12, scope: !2168, inlinedAt: !2172)
!2228 = !DILocation(line: 49, column: 18, scope: !2229)
!2229 = distinct !DILexicalBlock(scope: !2161, file: !937, line: 49, column: 17)
!2230 = !DILocation(line: 49, column: 25, scope: !2229)
!2231 = !DILocation(line: 49, column: 35, scope: !2229)
!2232 = !DILocation(line: 49, column: 17, scope: !2161)
!2233 = !DILocation(line: 50, column: 21, scope: !2234)
!2234 = distinct !DILexicalBlock(scope: !2235, file: !937, line: 50, column: 21)
!2235 = distinct !DILexicalBlock(scope: !2229, file: !937, line: 49, column: 46)
!2236 = !DILocation(line: 50, column: 28, scope: !2234)
!2237 = !DILocation(line: 50, column: 25, scope: !2234)
!2238 = !DILocation(line: 50, column: 21, scope: !2235)
!2239 = !DILocation(line: 55, column: 28, scope: !2240)
!2240 = distinct !DILexicalBlock(scope: !2234, file: !937, line: 50, column: 34)
!2241 = !DILocation(line: 56, column: 17, scope: !2240)
!2242 = !DILocation(line: 57, column: 17, scope: !2235)
!2243 = !DILocation(line: 59, column: 65, scope: !2161)
!2244 = !DILocation(line: 59, column: 70, scope: !2161)
!2245 = !DILocation(line: 59, column: 77, scope: !2161)
!2246 = !DILocation(line: 59, column: 22, scope: !2161)
!2247 = !DILocation(line: 68, column: 16, scope: !2154, inlinedAt: !2160)
!2248 = !DILocation(line: 68, column: 19, scope: !2154, inlinedAt: !2160)
!2249 = !DILocation(line: 68, column: 24, scope: !2154, inlinedAt: !2160)
!2250 = !DILocation(line: 68, column: 38, scope: !2154, inlinedAt: !2160)
!2251 = !DILocation(line: 68, column: 41, scope: !2154, inlinedAt: !2160)
!2252 = !DILocation(line: 68, column: 46, scope: !2154, inlinedAt: !2160)
!2253 = !DILocation(line: 68, column: 34, scope: !2154, inlinedAt: !2160)
!2254 = !DILocation(line: 68, column: 57, scope: !2154, inlinedAt: !2160)
!2255 = !DILocation(line: 68, column: 69, scope: !2154, inlinedAt: !2160)
!2256 = !DILocation(line: 68, column: 72, scope: !2154, inlinedAt: !2160)
!2257 = !DILocation(line: 68, column: 79, scope: !2154, inlinedAt: !2160)
!2258 = !DILocation(line: 68, column: 84, scope: !2154, inlinedAt: !2160)
!2259 = !DILocation(line: 68, column: 99, scope: !2154, inlinedAt: !2160)
!2260 = !DILocation(line: 68, column: 102, scope: !2154, inlinedAt: !2160)
!2261 = !DILocation(line: 68, column: 109, scope: !2154, inlinedAt: !2160)
!2262 = !DILocation(line: 68, column: 114, scope: !2154, inlinedAt: !2160)
!2263 = !DILocation(line: 68, column: 94, scope: !2154, inlinedAt: !2160)
!2264 = !DILocation(line: 68, column: 63, scope: !2154, inlinedAt: !2160)
!2265 = !DILocation(line: 59, column: 81, scope: !2161)
!2266 = !DILocation(line: 59, column: 88, scope: !2161)
!2267 = !DILocation(line: 59, column: 19, scope: !2161)
!2268 = !DILocation(line: 60, column: 17, scope: !2269)
!2269 = distinct !DILexicalBlock(scope: !2161, file: !937, line: 60, column: 17)
!2270 = !DILocation(line: 60, column: 23, scope: !2269)
!2271 = !DILocation(line: 60, column: 17, scope: !2161)
!2272 = !DILocation(line: 61, column: 17, scope: !2269)
!2273 = !DILocation(line: 62, column: 23, scope: !2161)
!2274 = !DILocation(line: 62, column: 22, scope: !2161)
!2275 = !DILocation(line: 62, column: 33, scope: !2161)
!2276 = !DILocation(line: 62, column: 39, scope: !2161)
!2277 = !DILocation(line: 62, column: 37, scope: !2161)
!2278 = !DILocation(line: 62, column: 30, scope: !2161)
!2279 = !DILocation(line: 62, column: 48, scope: !2280)
!2280 = !DILexicalBlockFile(scope: !2161, file: !937, discriminator: 1)
!2281 = !DILocation(line: 62, column: 54, scope: !2280)
!2282 = !DILocation(line: 62, column: 52, scope: !2280)
!2283 = !DILocation(line: 62, column: 22, scope: !2280)
!2284 = !DILocation(line: 62, column: 63, scope: !2285)
!2285 = !DILexicalBlockFile(scope: !2161, file: !937, discriminator: 2)
!2286 = !DILocation(line: 62, column: 62, scope: !2285)
!2287 = !DILocation(line: 62, column: 22, scope: !2285)
!2288 = !DILocation(line: 62, column: 22, scope: !2289)
!2289 = !DILexicalBlockFile(scope: !2161, file: !937, discriminator: 3)
!2290 = !DILocation(line: 62, column: 21, scope: !2289)
!2291 = !DILocation(line: 62, column: 19, scope: !2289)
!2292 = !DILocation(line: 63, column: 21, scope: !2161)
!2293 = !DILocation(line: 63, column: 18, scope: !2161)
!2294 = !DILocation(line: 64, column: 9, scope: !2161)
!2295 = !DILocation(line: 47, column: 44, scope: !2296)
!2296 = !DILexicalBlockFile(scope: !2162, file: !937, discriminator: 2)
!2297 = !DILocation(line: 47, column: 9, scope: !2296)
!2298 = distinct !{!2298, !2299}
!2299 = !DILocation(line: 47, column: 9, scope: !2164)
!2300 = !DILocation(line: 65, column: 24, scope: !2164)
!2301 = !DILocation(line: 65, column: 39, scope: !2164)
!2302 = !DILocation(line: 65, column: 36, scope: !2164)
!2303 = !DILocation(line: 65, column: 23, scope: !2164)
!2304 = !DILocation(line: 65, column: 50, scope: !2305)
!2305 = !DILexicalBlockFile(scope: !2164, file: !937, discriminator: 1)
!2306 = !DILocation(line: 65, column: 23, scope: !2305)
!2307 = !DILocation(line: 65, column: 65, scope: !2308)
!2308 = !DILexicalBlockFile(scope: !2164, file: !937, discriminator: 2)
!2309 = !DILocation(line: 65, column: 23, scope: !2308)
!2310 = !DILocation(line: 65, column: 23, scope: !2311)
!2311 = !DILexicalBlockFile(scope: !2164, file: !937, discriminator: 3)
!2312 = !DILocation(line: 65, column: 20, scope: !2311)
!2313 = !DILocation(line: 66, column: 13, scope: !2314)
!2314 = distinct !DILexicalBlock(scope: !2164, file: !937, line: 66, column: 13)
!2315 = !DILocation(line: 66, column: 20, scope: !2314)
!2316 = !DILocation(line: 66, column: 17, scope: !2314)
!2317 = !DILocation(line: 66, column: 13, scope: !2164)
!2318 = !DILocation(line: 67, column: 28, scope: !2314)
!2319 = !DILocation(line: 67, column: 26, scope: !2314)
!2320 = !DILocation(line: 67, column: 13, scope: !2314)
!2321 = !DILocation(line: 68, column: 5, scope: !2164)
!2322 = !DILocation(line: 44, column: 29, scope: !2323)
!2323 = !DILexicalBlockFile(scope: !2165, file: !937, discriminator: 2)
!2324 = !DILocation(line: 44, column: 34, scope: !2323)
!2325 = !DILocation(line: 44, column: 27, scope: !2323)
!2326 = !DILocation(line: 44, column: 5, scope: !2323)
!2327 = distinct !{!2327, !2200}
!2328 = !DILocation(line: 70, column: 9, scope: !2329)
!2329 = distinct !DILexicalBlock(scope: !2151, file: !937, line: 70, column: 9)
!2330 = !DILocation(line: 70, column: 22, scope: !2329)
!2331 = !DILocation(line: 70, column: 9, scope: !2151)
!2332 = !DILocation(line: 71, column: 9, scope: !2329)
!2333 = !DILocation(line: 72, column: 14, scope: !2334)
!2334 = distinct !DILexicalBlock(scope: !2329, file: !937, line: 72, column: 14)
!2335 = !DILocation(line: 72, column: 25, scope: !2334)
!2336 = !DILocation(line: 72, column: 14, scope: !2329)
!2337 = !DILocation(line: 73, column: 9, scope: !2334)
!2338 = !DILocation(line: 74, column: 14, scope: !2339)
!2339 = distinct !DILexicalBlock(scope: !2334, file: !937, line: 74, column: 14)
!2340 = !DILocation(line: 74, column: 25, scope: !2339)
!2341 = !DILocation(line: 74, column: 14, scope: !2334)
!2342 = !DILocation(line: 75, column: 9, scope: !2339)
!2343 = !DILocation(line: 76, column: 14, scope: !2344)
!2344 = distinct !DILexicalBlock(scope: !2339, file: !937, line: 76, column: 14)
!2345 = !DILocation(line: 76, column: 27, scope: !2344)
!2346 = !DILocation(line: 76, column: 14, scope: !2339)
!2347 = !DILocation(line: 77, column: 9, scope: !2344)
!2348 = !DILocation(line: 79, column: 9, scope: !2344)
!2349 = !DILocation(line: 80, column: 1, scope: !2151)
!2350 = distinct !DISubprogram(name: "adts_aac_read_header", scope: !937, file: !937, line: 82, type: !2351, isLocal: true, isDefinition: true, scopeLine: 83, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2351 = !DISubroutineType(types: !2352)
!2352 = !{!933, !2353}
!2353 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2354, size: 64, align: 64)
!2354 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1023)
!2355 = !DILocalVariable(name: "s", arg: 1, scope: !2356, file: !628, line: 557, type: !1229)
!2356 = distinct !DISubprogram(name: "avio_tell", scope: !628, file: !628, line: 557, type: !2357, isLocal: true, isDefinition: true, scopeLine: 558, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2357 = !DISubroutineType(types: !2358)
!2358 = !{!1067, !1229}
!2359 = !DILocation(line: 557, column: 77, scope: !2356, inlinedAt: !2360)
!2360 = distinct !DILocation(line: 105, column: 33, scope: !2361)
!2361 = !DILexicalBlockFile(scope: !2350, file: !937, discriminator: 2)
!2362 = !DILocation(line: 557, column: 77, scope: !2356, inlinedAt: !2363)
!2363 = distinct !DILocation(line: 98, column: 23, scope: !2364)
!2364 = distinct !DILexicalBlock(scope: !2365, file: !937, line: 97, column: 48)
!2365 = distinct !DILexicalBlock(scope: !2350, file: !937, line: 96, column: 9)
!2366 = !DILocalVariable(name: "s", arg: 1, scope: !2350, file: !937, line: 82, type: !2353)
!2367 = !DILocation(line: 82, column: 50, scope: !2350)
!2368 = !DILocalVariable(name: "st", scope: !2350, file: !937, line: 84, type: !1297)
!2369 = !DILocation(line: 84, column: 15, scope: !2350)
!2370 = !DILocalVariable(name: "state", scope: !2350, file: !937, line: 85, type: !923)
!2371 = !DILocation(line: 85, column: 14, scope: !2350)
!2372 = !DILocation(line: 87, column: 30, scope: !2350)
!2373 = !DILocation(line: 87, column: 10, scope: !2350)
!2374 = !DILocation(line: 87, column: 8, scope: !2350)
!2375 = !DILocation(line: 88, column: 10, scope: !2376)
!2376 = distinct !DILexicalBlock(scope: !2350, file: !937, line: 88, column: 9)
!2377 = !DILocation(line: 88, column: 9, scope: !2350)
!2378 = !DILocation(line: 89, column: 9, scope: !2376)
!2379 = !DILocation(line: 91, column: 5, scope: !2350)
!2380 = !DILocation(line: 91, column: 9, scope: !2350)
!2381 = !DILocation(line: 91, column: 19, scope: !2350)
!2382 = !DILocation(line: 91, column: 30, scope: !2350)
!2383 = !DILocation(line: 92, column: 30, scope: !2350)
!2384 = !DILocation(line: 92, column: 33, scope: !2350)
!2385 = !DILocation(line: 92, column: 42, scope: !2350)
!2386 = !DILocation(line: 92, column: 5, scope: !2350)
!2387 = !DILocation(line: 92, column: 9, scope: !2350)
!2388 = !DILocation(line: 92, column: 19, scope: !2350)
!2389 = !DILocation(line: 92, column: 28, scope: !2350)
!2390 = !DILocation(line: 93, column: 5, scope: !2350)
!2391 = !DILocation(line: 93, column: 9, scope: !2350)
!2392 = !DILocation(line: 93, column: 22, scope: !2350)
!2393 = !DILocation(line: 95, column: 19, scope: !2350)
!2394 = !DILocation(line: 95, column: 5, scope: !2350)
!2395 = !DILocation(line: 96, column: 10, scope: !2365)
!2396 = !DILocation(line: 96, column: 13, scope: !2365)
!2397 = !DILocation(line: 96, column: 17, scope: !2365)
!2398 = !DILocation(line: 96, column: 26, scope: !2365)
!2399 = !DILocation(line: 96, column: 38, scope: !2365)
!2400 = !DILocation(line: 97, column: 22, scope: !2365)
!2401 = !DILocation(line: 97, column: 25, scope: !2365)
!2402 = !DILocation(line: 97, column: 10, scope: !2365)
!2403 = !DILocation(line: 96, column: 9, scope: !2404)
!2404 = !DILexicalBlockFile(scope: !2350, file: !937, discriminator: 1)
!2405 = !DILocalVariable(name: "cur", scope: !2364, file: !937, line: 98, type: !1067)
!2406 = !DILocation(line: 98, column: 17, scope: !2364)
!2407 = !DILocation(line: 98, column: 33, scope: !2364)
!2408 = !DILocation(line: 98, column: 36, scope: !2364)
!2409 = !DILocation(line: 98, column: 23, scope: !2364)
!2410 = !DILocation(line: 559, column: 22, scope: !2356, inlinedAt: !2363)
!2411 = !DILocation(line: 559, column: 12, scope: !2356, inlinedAt: !2363)
!2412 = !DILocation(line: 99, column: 26, scope: !2364)
!2413 = !DILocation(line: 99, column: 9, scope: !2364)
!2414 = !DILocation(line: 100, column: 19, scope: !2364)
!2415 = !DILocation(line: 100, column: 22, scope: !2364)
!2416 = !DILocation(line: 100, column: 26, scope: !2364)
!2417 = !DILocation(line: 100, column: 9, scope: !2364)
!2418 = !DILocation(line: 101, column: 5, scope: !2364)
!2419 = !DILocation(line: 104, column: 21, scope: !2350)
!2420 = !DILocation(line: 104, column: 24, scope: !2350)
!2421 = !DILocation(line: 104, column: 13, scope: !2350)
!2422 = !DILocation(line: 104, column: 11, scope: !2350)
!2423 = !DILocation(line: 105, column: 5, scope: !2350)
!2424 = !DILocation(line: 105, column: 23, scope: !2404)
!2425 = !DILocation(line: 105, column: 26, scope: !2404)
!2426 = !DILocation(line: 105, column: 13, scope: !2404)
!2427 = !DILocation(line: 105, column: 30, scope: !2404)
!2428 = !DILocation(line: 105, column: 43, scope: !2361)
!2429 = !DILocation(line: 105, column: 46, scope: !2361)
!2430 = !DILocation(line: 105, column: 33, scope: !2361)
!2431 = !DILocation(line: 559, column: 22, scope: !2356, inlinedAt: !2360)
!2432 = !DILocation(line: 559, column: 12, scope: !2356, inlinedAt: !2360)
!2433 = !DILocation(line: 105, column: 52, scope: !2361)
!2434 = !DILocation(line: 105, column: 55, scope: !2361)
!2435 = !DILocation(line: 105, column: 50, scope: !2361)
!2436 = !DILocation(line: 105, column: 5, scope: !2437)
!2437 = !DILexicalBlockFile(scope: !2350, file: !937, discriminator: 3)
!2438 = !DILocation(line: 106, column: 18, scope: !2439)
!2439 = distinct !DILexicalBlock(scope: !2350, file: !937, line: 105, column: 66)
!2440 = !DILocation(line: 106, column: 24, scope: !2439)
!2441 = !DILocation(line: 106, column: 40, scope: !2439)
!2442 = !DILocation(line: 106, column: 43, scope: !2439)
!2443 = !DILocation(line: 106, column: 32, scope: !2439)
!2444 = !DILocation(line: 106, column: 30, scope: !2439)
!2445 = !DILocation(line: 106, column: 17, scope: !2439)
!2446 = !DILocation(line: 106, column: 15, scope: !2439)
!2447 = !DILocation(line: 107, column: 14, scope: !2448)
!2448 = distinct !DILexicalBlock(scope: !2439, file: !937, line: 107, column: 13)
!2449 = !DILocation(line: 107, column: 20, scope: !2448)
!2450 = !DILocation(line: 107, column: 26, scope: !2448)
!2451 = !DILocation(line: 107, column: 13, scope: !2439)
!2452 = !DILocation(line: 108, column: 13, scope: !2448)
!2453 = distinct !{!2453, !2423}
!2454 = !DILocation(line: 109, column: 19, scope: !2439)
!2455 = !DILocation(line: 109, column: 22, scope: !2439)
!2456 = !DILocation(line: 109, column: 9, scope: !2439)
!2457 = !DILocation(line: 110, column: 9, scope: !2439)
!2458 = !DILocation(line: 112, column: 10, scope: !2459)
!2459 = distinct !DILexicalBlock(scope: !2350, file: !937, line: 112, column: 9)
!2460 = !DILocation(line: 112, column: 16, scope: !2459)
!2461 = !DILocation(line: 112, column: 22, scope: !2459)
!2462 = !DILocation(line: 112, column: 9, scope: !2350)
!2463 = !DILocation(line: 113, column: 9, scope: !2459)
!2464 = !DILocation(line: 116, column: 25, scope: !2350)
!2465 = !DILocation(line: 116, column: 5, scope: !2350)
!2466 = !DILocation(line: 118, column: 5, scope: !2350)
!2467 = !DILocation(line: 119, column: 1, scope: !2350)
!2468 = distinct !DISubprogram(name: "adts_aac_read_packet", scope: !937, file: !937, line: 153, type: !2469, isLocal: true, isDefinition: true, scopeLine: 154, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2469 = !DISubroutineType(types: !2470)
!2470 = !{!933, !2353, !1048}
!2471 = !DILocation(line: 66, column: 98, scope: !2154, inlinedAt: !2472)
!2472 = distinct !DILocation(line: 181, column: 14, scope: !2468)
!2473 = !DILocation(line: 58, column: 98, scope: !2168, inlinedAt: !2474)
!2474 = distinct !DILocation(line: 176, column: 10, scope: !2475)
!2475 = distinct !DILexicalBlock(scope: !2468, file: !937, line: 176, column: 9)
!2476 = !DILocalVariable(name: "s", arg: 1, scope: !2468, file: !937, line: 153, type: !2353)
!2477 = !DILocation(line: 153, column: 50, scope: !2468)
!2478 = !DILocalVariable(name: "pkt", arg: 2, scope: !2468, file: !937, line: 153, type: !1048)
!2479 = !DILocation(line: 153, column: 63, scope: !2468)
!2480 = !DILocalVariable(name: "ret", scope: !2468, file: !937, line: 155, type: !933)
!2481 = !DILocation(line: 155, column: 9, scope: !2468)
!2482 = !DILocalVariable(name: "fsize", scope: !2468, file: !937, line: 155, type: !933)
!2483 = !DILocation(line: 155, column: 14, scope: !2468)
!2484 = !DILocation(line: 158, column: 5, scope: !2468)
!2485 = !DILocation(line: 159, column: 29, scope: !2486)
!2486 = distinct !DILexicalBlock(scope: !2468, file: !937, line: 158, column: 15)
!2487 = !DILocation(line: 159, column: 32, scope: !2486)
!2488 = !DILocation(line: 159, column: 36, scope: !2486)
!2489 = !DILocation(line: 159, column: 15, scope: !2486)
!2490 = !DILocation(line: 159, column: 13, scope: !2486)
!2491 = !DILocation(line: 160, column: 13, scope: !2492)
!2492 = distinct !DILexicalBlock(scope: !2486, file: !937, line: 160, column: 13)
!2493 = !DILocation(line: 160, column: 17, scope: !2492)
!2494 = !DILocation(line: 160, column: 23, scope: !2492)
!2495 = !DILocation(line: 160, column: 41, scope: !2496)
!2496 = !DILexicalBlockFile(scope: !2492, file: !937, discriminator: 1)
!2497 = !DILocation(line: 160, column: 46, scope: !2496)
!2498 = !DILocation(line: 160, column: 26, scope: !2496)
!2499 = !DILocation(line: 160, column: 13, scope: !2496)
!2500 = !DILocation(line: 161, column: 35, scope: !2501)
!2501 = distinct !DILexicalBlock(scope: !2502, file: !937, line: 161, column: 17)
!2502 = distinct !DILexicalBlock(scope: !2492, file: !937, line: 160, column: 60)
!2503 = !DILocation(line: 161, column: 38, scope: !2501)
!2504 = !DILocation(line: 161, column: 24, scope: !2501)
!2505 = !DILocation(line: 161, column: 22, scope: !2501)
!2506 = !DILocation(line: 161, column: 44, scope: !2501)
!2507 = !DILocation(line: 161, column: 17, scope: !2502)
!2508 = !DILocation(line: 162, column: 17, scope: !2509)
!2509 = distinct !DILexicalBlock(scope: !2501, file: !937, line: 161, column: 50)
!2510 = distinct !{!2510, !2484}
!2511 = !DILocation(line: 164, column: 9, scope: !2502)
!2512 = !DILocation(line: 165, column: 9, scope: !2486)
!2513 = !DILocation(line: 168, column: 9, scope: !2514)
!2514 = distinct !DILexicalBlock(scope: !2468, file: !937, line: 168, column: 9)
!2515 = !DILocation(line: 168, column: 13, scope: !2514)
!2516 = !DILocation(line: 168, column: 9, scope: !2468)
!2517 = !DILocation(line: 169, column: 16, scope: !2514)
!2518 = !DILocation(line: 169, column: 9, scope: !2514)
!2519 = !DILocation(line: 171, column: 9, scope: !2520)
!2520 = distinct !DILexicalBlock(scope: !2468, file: !937, line: 171, column: 9)
!2521 = !DILocation(line: 171, column: 13, scope: !2520)
!2522 = !DILocation(line: 171, column: 9, scope: !2468)
!2523 = !DILocation(line: 172, column: 25, scope: !2524)
!2524 = distinct !DILexicalBlock(scope: !2520, file: !937, line: 171, column: 18)
!2525 = !DILocation(line: 172, column: 9, scope: !2524)
!2526 = !DILocation(line: 173, column: 9, scope: !2524)
!2527 = !DILocation(line: 176, column: 53, scope: !2475)
!2528 = !DILocation(line: 176, column: 58, scope: !2475)
!2529 = !DILocation(line: 176, column: 66, scope: !2475)
!2530 = !DILocation(line: 176, column: 10, scope: !2475)
!2531 = !DILocation(line: 60, column: 9, scope: !2168, inlinedAt: !2474)
!2532 = !DILocation(line: 60, column: 10, scope: !2168, inlinedAt: !2474)
!2533 = !DILocation(line: 60, column: 18, scope: !2168, inlinedAt: !2474)
!2534 = !DILocation(line: 60, column: 19, scope: !2168, inlinedAt: !2474)
!2535 = !DILocation(line: 60, column: 15, scope: !2168, inlinedAt: !2474)
!2536 = !DILocation(line: 60, column: 8, scope: !2168, inlinedAt: !2474)
!2537 = !DILocation(line: 60, column: 6, scope: !2168, inlinedAt: !2474)
!2538 = !DILocation(line: 61, column: 12, scope: !2168, inlinedAt: !2474)
!2539 = !DILocation(line: 176, column: 70, scope: !2475)
!2540 = !DILocation(line: 176, column: 76, scope: !2475)
!2541 = !DILocation(line: 176, column: 9, scope: !2468)
!2542 = !DILocation(line: 177, column: 25, scope: !2543)
!2543 = distinct !DILexicalBlock(scope: !2475, file: !937, line: 176, column: 86)
!2544 = !DILocation(line: 177, column: 9, scope: !2543)
!2545 = !DILocation(line: 178, column: 9, scope: !2543)
!2546 = !DILocation(line: 181, column: 57, scope: !2468)
!2547 = !DILocation(line: 181, column: 62, scope: !2468)
!2548 = !DILocation(line: 181, column: 67, scope: !2468)
!2549 = !DILocation(line: 181, column: 74, scope: !2468)
!2550 = !DILocation(line: 181, column: 14, scope: !2468)
!2551 = !DILocation(line: 68, column: 16, scope: !2154, inlinedAt: !2472)
!2552 = !DILocation(line: 68, column: 19, scope: !2154, inlinedAt: !2472)
!2553 = !DILocation(line: 68, column: 24, scope: !2154, inlinedAt: !2472)
!2554 = !DILocation(line: 68, column: 38, scope: !2154, inlinedAt: !2472)
!2555 = !DILocation(line: 68, column: 41, scope: !2154, inlinedAt: !2472)
!2556 = !DILocation(line: 68, column: 46, scope: !2154, inlinedAt: !2472)
!2557 = !DILocation(line: 68, column: 34, scope: !2154, inlinedAt: !2472)
!2558 = !DILocation(line: 68, column: 57, scope: !2154, inlinedAt: !2472)
!2559 = !DILocation(line: 68, column: 69, scope: !2154, inlinedAt: !2472)
!2560 = !DILocation(line: 68, column: 72, scope: !2154, inlinedAt: !2472)
!2561 = !DILocation(line: 68, column: 79, scope: !2154, inlinedAt: !2472)
!2562 = !DILocation(line: 68, column: 84, scope: !2154, inlinedAt: !2472)
!2563 = !DILocation(line: 68, column: 99, scope: !2154, inlinedAt: !2472)
!2564 = !DILocation(line: 68, column: 102, scope: !2154, inlinedAt: !2472)
!2565 = !DILocation(line: 68, column: 109, scope: !2154, inlinedAt: !2472)
!2566 = !DILocation(line: 68, column: 114, scope: !2154, inlinedAt: !2472)
!2567 = !DILocation(line: 68, column: 94, scope: !2154, inlinedAt: !2472)
!2568 = !DILocation(line: 68, column: 63, scope: !2154, inlinedAt: !2472)
!2569 = !DILocation(line: 181, column: 78, scope: !2468)
!2570 = !DILocation(line: 181, column: 85, scope: !2468)
!2571 = !DILocation(line: 181, column: 11, scope: !2468)
!2572 = !DILocation(line: 182, column: 9, scope: !2573)
!2573 = distinct !DILexicalBlock(scope: !2468, file: !937, line: 182, column: 9)
!2574 = !DILocation(line: 182, column: 15, scope: !2573)
!2575 = !DILocation(line: 182, column: 9, scope: !2468)
!2576 = !DILocation(line: 183, column: 25, scope: !2577)
!2577 = distinct !DILexicalBlock(scope: !2573, file: !937, line: 182, column: 20)
!2578 = !DILocation(line: 183, column: 9, scope: !2577)
!2579 = !DILocation(line: 184, column: 9, scope: !2577)
!2580 = !DILocation(line: 187, column: 28, scope: !2468)
!2581 = !DILocation(line: 187, column: 31, scope: !2468)
!2582 = !DILocation(line: 187, column: 35, scope: !2468)
!2583 = !DILocation(line: 187, column: 40, scope: !2468)
!2584 = !DILocation(line: 187, column: 48, scope: !2468)
!2585 = !DILocation(line: 187, column: 53, scope: !2468)
!2586 = !DILocation(line: 187, column: 46, scope: !2468)
!2587 = !DILocation(line: 187, column: 11, scope: !2468)
!2588 = !DILocation(line: 187, column: 9, scope: !2468)
!2589 = !DILocation(line: 188, column: 9, scope: !2590)
!2590 = distinct !DILexicalBlock(scope: !2468, file: !937, line: 188, column: 9)
!2591 = !DILocation(line: 188, column: 13, scope: !2590)
!2592 = !DILocation(line: 188, column: 9, scope: !2468)
!2593 = !DILocation(line: 189, column: 25, scope: !2590)
!2594 = !DILocation(line: 189, column: 9, scope: !2590)
!2595 = !DILocation(line: 191, column: 12, scope: !2468)
!2596 = !DILocation(line: 191, column: 5, scope: !2468)
!2597 = !DILocation(line: 192, column: 1, scope: !2468)
!2598 = distinct !DISubprogram(name: "handle_id3", scope: !937, file: !937, line: 121, type: !2469, isLocal: true, isDefinition: true, scopeLine: 122, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2599 = !DILocalVariable(name: "s", arg: 1, scope: !2598, file: !937, line: 121, type: !2353)
!2600 = !DILocation(line: 121, column: 40, scope: !2598)
!2601 = !DILocalVariable(name: "pkt", arg: 2, scope: !2598, file: !937, line: 121, type: !1048)
!2602 = !DILocation(line: 121, column: 53, scope: !2598)
!2603 = !DILocalVariable(name: "metadata", scope: !2598, file: !937, line: 123, type: !1169)
!2604 = !DILocation(line: 123, column: 19, scope: !2598)
!2605 = !DILocalVariable(name: "ioctx", scope: !2598, file: !937, line: 124, type: !1230)
!2606 = !DILocation(line: 124, column: 17, scope: !2598)
!2607 = !DILocalVariable(name: "id3v2_extra_meta", scope: !2598, file: !937, line: 125, type: !2608)
...
!2612 = !{!2613, !2614, !2615}
!2613 = !DIDerivedType(tag: DW_TAG_member, name: "tag", scope: !2611, file: !2610, line: 58, baseType: !942, size: 64, align: 64)
!2614 = !DIDerivedType(tag: DW_TAG_member, name: "data", scope: !2611, file: !2610, line: 59, baseType: !934, size: 64, align: 64, offset: 64)
...
!2617 = !DILocation(line: 125, column: 21, scope: !2598)
!2618 = !DILocalVariable(name: "ret", scope: !2598, file: !937, line: 126, type: !933)
!2619 = !DILocation(line: 126, column: 9, scope: !2598)
!2620 = !DILocation(line: 128, column: 28, scope: !2598)
!2621 = !DILocation(line: 128, column: 31, scope: !2598)
!2622 = !DILocation(line: 128, column: 35, scope: !2598)
!2623 = !DILocation(line: 128, column: 57, scope: !2598)
!2624 = !DILocation(line: 128, column: 62, scope: !2598)
!2625 = !DILocation(line: 128, column: 40, scope: !2598)
!2626 = !DILocation(line: 128, column: 70, scope: !2598)
!2627 = !DILocation(line: 128, column: 75, scope: !2598)
!2628 = !DILocation(line: 128, column: 68, scope: !2598)
!2629 = !DILocation(line: 128, column: 11, scope: !2630)
!2630 = !DILexicalBlockFile(scope: !2598, file: !937, discriminator: 1)
!2631 = !DILocation(line: 128, column: 9, scope: !2598)
!2632 = !DILocation(line: 129, column: 9, scope: !2633)
!2633 = distinct !DILexicalBlock(scope: !2598, file: !937, line: 129, column: 9)
!2634 = !DILocation(line: 129, column: 13, scope: !2633)
!2635 = !DILocation(line: 129, column: 9, scope: !2598)
!2636 = !DILocation(line: 130, column: 25, scope: !2637)
!2637 = distinct !DILexicalBlock(scope: !2633, file: !937, line: 129, column: 18)
!2638 = !DILocation(line: 130, column: 9, scope: !2637)
!2639 = !DILocation(line: 131, column: 16, scope: !2637)
!2640 = !DILocation(line: 131, column: 9, scope: !2637)
!2641 = !DILocation(line: 134, column: 31, scope: !2598)
!2642 = !DILocation(line: 134, column: 36, scope: !2598)
!2643 = !DILocation(line: 134, column: 42, scope: !2598)
!2644 = !DILocation(line: 134, column: 47, scope: !2598)
!2645 = !DILocation(line: 134, column: 5, scope: !2598)
!2646 = !DILocation(line: 135, column: 5, scope: !2598)
!2647 = !DILocation(line: 136, column: 16, scope: !2648)
!2648 = distinct !DILexicalBlock(scope: !2598, file: !937, line: 136, column: 9)
!2649 = !DILocation(line: 136, column: 14, scope: !2648)
!2650 = !DILocation(line: 136, column: 72, scope: !2648)
!2651 = !DILocation(line: 136, column: 9, scope: !2598)
!2652 = !DILocation(line: 137, column: 9, scope: !2648)
!2653 = !DILocation(line: 139, column: 9, scope: !2654)
!2654 = distinct !DILexicalBlock(scope: !2598, file: !937, line: 139, column: 9)
!2655 = !DILocation(line: 139, column: 9, scope: !2598)
!2656 = !DILocation(line: 140, column: 34, scope: !2657)
!2657 = distinct !DILexicalBlock(scope: !2658, file: !937, line: 140, column: 13)
!2658 = distinct !DILexicalBlock(scope: !2654, file: !937, line: 139, column: 19)
!2659 = !DILocation(line: 140, column: 37, scope: !2657)
!2660 = !DILocation(line: 140, column: 47, scope: !2657)
!2661 = !DILocation(line: 140, column: 20, scope: !2657)
!2662 = !DILocation(line: 140, column: 18, scope: !2657)
!2663 = !DILocation(line: 140, column: 61, scope: !2657)
!2664 = !DILocation(line: 140, column: 13, scope: !2658)
!2665 = !DILocation(line: 141, column: 13, scope: !2657)
!2666 = !DILocation(line: 142, column: 9, scope: !2658)
!2667 = !DILocation(line: 142, column: 12, scope: !2658)
!2668 = !DILocation(line: 142, column: 24, scope: !2658)
!2669 = !DILocation(line: 143, column: 5, scope: !2658)
!2670 = !DILocation(line: 139, column: 9, scope: !2671)
!2671 = !DILexicalBlockFile(scope: !2654, file: !937, discriminator: 1)
!2672 = !DILocation(line: 146, column: 21, scope: !2598)
!2673 = !DILocation(line: 146, column: 5, scope: !2598)
!2674 = !DILocation(line: 147, column: 5, scope: !2598)
!2675 = !DILocation(line: 148, column: 5, scope: !2598)
!2676 = !DILocation(line: 150, column: 12, scope: !2598)
!2677 = !DILocation(line: 150, column: 5, scope: !2598)
!2678 = !DILocation(line: 151, column: 1, scope: !2598)
