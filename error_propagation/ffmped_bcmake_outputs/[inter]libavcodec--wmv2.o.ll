; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[inter]libavcodec--wmv2.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[inter]libavcodec--wmv2.o.i"
...
define void @ff_wmv2_common_init(%struct.Wmv2Context* %w) #0 !dbg !2695 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.Wmv2Context** %w.addr, metadata !2700, metadata !2701), !dbg !2702
  call void @llvm.dbg.declare(metadata %struct.MpegEncContext** %s, metadata !2703, metadata !2701), !dbg !2706
  %0 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w.addr, align 8, !dbg !2707
  %s1 = getelementptr inbounds %struct.Wmv2Context, %struct.Wmv2Context* %0, i32 0, i32 0, !dbg !2708
  store %struct.MpegEncContext* %s1, %struct.MpegEncContext** %s, align 8, !dbg !2706
  %1 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s, align 8, !dbg !2709
  %bdsp = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %1, i32 0, i32 97, !dbg !2710
  %2 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s, align 8, !dbg !2711
  %avctx = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %2, i32 0, i32 10, !dbg !2712
  %3 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx, align 8, !dbg !2712
  call void @ff_blockdsp_init(%struct.BlockDSPContext* %bdsp, %struct.AVCodecContext* %3), !dbg !2713
  %4 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w.addr, align 8, !dbg !2714
  %wdsp = getelementptr inbounds %struct.Wmv2Context, %struct.Wmv2Context* %4, i32 0, i32 2, !dbg !2715
  call void @ff_wmv2dsp_init(%struct.WMV2DSPContext* %wdsp), !dbg !2716
  %5 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w.addr, align 8, !dbg !2717
  %wdsp2 = getelementptr inbounds %struct.Wmv2Context, %struct.Wmv2Context* %5, i32 0, i32 2, !dbg !2718
  %idct_perm = getelementptr inbounds %struct.WMV2DSPContext, %struct.WMV2DSPContext* %wdsp2, i32 0, i32 3, !dbg !2719
  %6 = load i32, i32* %idct_perm, align 16, !dbg !2719
  %7 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s, align 8, !dbg !2720
  %idsp = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %7, i32 0, i32 101, !dbg !2721
  %perm_type = getelementptr inbounds %struct.IDCTDSPContext, %struct.IDCTDSPContext* %idsp, i32 0, i32 7, !dbg !2722
  store i32 %6, i32* %perm_type, align 8, !dbg !2723
  %8 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s, align 8, !dbg !2724
  %idsp3 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %8, i32 0, i32 101, !dbg !2725
  %idct_permutation = getelementptr inbounds %struct.IDCTDSPContext, %struct.IDCTDSPContext* %idsp3, i32 0, i32 6, !dbg !2726
  %arraydecay = getelementptr inbounds [64 x i8], [64 x i8]* %idct_permutation, i32 0, i32 0, !dbg !2724
  %9 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w.addr, align 8, !dbg !2727
  %wdsp4 = getelementptr inbounds %struct.Wmv2Context, %struct.Wmv2Context* %9, i32 0, i32 2, !dbg !2728
  %idct_perm5 = getelementptr inbounds %struct.WMV2DSPContext, %struct.WMV2DSPContext* %wdsp4, i32 0, i32 3, !dbg !2729
  %10 = load i32, i32* %idct_perm5, align 16, !dbg !2729
  call void @ff_init_scantable_permutation(i8* %arraydecay, i32 %10), !dbg !2730
  %11 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s, align 8, !dbg !2731
  %idsp6 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %11, i32 0, i32 101, !dbg !2732
  %idct_permutation7 = getelementptr inbounds %struct.IDCTDSPContext, %struct.IDCTDSPContext* %idsp6, i32 0, i32 6, !dbg !2733
  %arraydecay8 = getelementptr inbounds [64 x i8], [64 x i8]* %idct_permutation7, i32 0, i32 0, !dbg !2731
  %12 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w.addr, align 8, !dbg !2734
  %abt_scantable = getelementptr inbounds %struct.Wmv2Context, %struct.Wmv2Context* %12, i32 0, i32 16, !dbg !2735
  %arrayidx = getelementptr inbounds [2 x %struct.ScanTable], [2 x %struct.ScanTable]* %abt_scantable, i64 0, i64 0, !dbg !2734
  call void @ff_init_scantable(i8* %arraydecay8, %struct.ScanTable* %arrayidx, i8* getelementptr inbounds ([64 x i8], [64 x i8]* @ff_wmv2_scantableA, i32 0, i32 0)), !dbg !2736
  %13 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s, align 8, !dbg !2737
  %idsp9 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %13, i32 0, i32 101, !dbg !2738
  %idct_permutation10 = getelementptr inbounds %struct.IDCTDSPContext, %struct.IDCTDSPContext* %idsp9, i32 0, i32 6, !dbg !2739
  %arraydecay11 = getelementptr inbounds [64 x i8], [64 x i8]* %idct_permutation10, i32 0, i32 0, !dbg !2737
  %14 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w.addr, align 8, !dbg !2740
  %abt_scantable12 = getelementptr inbounds %struct.Wmv2Context, %struct.Wmv2Context* %14, i32 0, i32 16, !dbg !2741
  %arrayidx13 = getelementptr inbounds [2 x %struct.ScanTable], [2 x %struct.ScanTable]* %abt_scantable12, i64 0, i64 1, !dbg !2740
  call void @ff_init_scantable(i8* %arraydecay11, %struct.ScanTable* %arrayidx13, i8* getelementptr inbounds ([64 x i8], [64 x i8]* @ff_wmv2_scantableB, i32 0, i32 0)), !dbg !2742
  %15 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s, align 8, !dbg !2743
  %idsp14 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %15, i32 0, i32 101, !dbg !2744
  %idct_permutation15 = getelementptr inbounds %struct.IDCTDSPContext, %struct.IDCTDSPContext* %idsp14, i32 0, i32 6, !dbg !2745
  %arraydecay16 = getelementptr inbounds [64 x i8], [64 x i8]* %idct_permutation15, i32 0, i32 0, !dbg !2743
  %16 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s, align 8, !dbg !2746
  %intra_scantable = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %16, i32 0, i32 7, !dbg !2747
  call void @ff_init_scantable(i8* %arraydecay16, %struct.ScanTable* %intra_scantable, i8* getelementptr inbounds ([4 x [64 x i8]], [4 x [64 x i8]]* @ff_wmv1_scantable, i64 0, i64 1, i32 0)), !dbg !2748
  %17 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s, align 8, !dbg !2749
  %idsp17 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %17, i32 0, i32 101, !dbg !2750
  %idct_permutation18 = getelementptr inbounds %struct.IDCTDSPContext, %struct.IDCTDSPContext* %idsp17, i32 0, i32 6, !dbg !2751
  %arraydecay19 = getelementptr inbounds [64 x i8], [64 x i8]* %idct_permutation18, i32 0, i32 0, !dbg !2749
  %18 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s, align 8, !dbg !2752
  %intra_h_scantable = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %18, i32 0, i32 8, !dbg !2753
  call void @ff_init_scantable(i8* %arraydecay19, %struct.ScanTable* %intra_h_scantable, i8* getelementptr inbounds ([4 x [64 x i8]], [4 x [64 x i8]]* @ff_wmv1_scantable, i64 0, i64 2, i32 0)), !dbg !2754
  %19 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s, align 8, !dbg !2755
  %idsp20 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %19, i32 0, i32 101, !dbg !2756
  %idct_permutation21 = getelementptr inbounds %struct.IDCTDSPContext, %struct.IDCTDSPContext* %idsp20, i32 0, i32 6, !dbg !2757
  %arraydecay22 = getelementptr inbounds [64 x i8], [64 x i8]* %idct_permutation21, i32 0, i32 0, !dbg !2755
  %20 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s, align 8, !dbg !2758
  %intra_v_scantable = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %20, i32 0, i32 9, !dbg !2759
  call void @ff_init_scantable(i8* %arraydecay22, %struct.ScanTable* %intra_v_scantable, i8* getelementptr inbounds ([4 x [64 x i8]], [4 x [64 x i8]]* @ff_wmv1_scantable, i64 0, i64 3, i32 0)), !dbg !2760
  %21 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s, align 8, !dbg !2761
  %idsp23 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %21, i32 0, i32 101, !dbg !2762
  %idct_permutation24 = getelementptr inbounds %struct.IDCTDSPContext, %struct.IDCTDSPContext* %idsp23, i32 0, i32 6, !dbg !2763
  %arraydecay25 = getelementptr inbounds [64 x i8], [64 x i8]* %idct_permutation24, i32 0, i32 0, !dbg !2761
  %22 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s, align 8, !dbg !2764
  %inter_scantable = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %22, i32 0, i32 6, !dbg !2765
  call void @ff_init_scantable(i8* %arraydecay25, %struct.ScanTable* %inter_scantable, i8* getelementptr inbounds ([4 x [64 x i8]], [4 x [64 x i8]]* @ff_wmv1_scantable, i64 0, i64 0, i32 0)), !dbg !2766
  %23 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w.addr, align 8, !dbg !2767
  %wdsp26 = getelementptr inbounds %struct.Wmv2Context, %struct.Wmv2Context* %23, i32 0, i32 2, !dbg !2768
  %idct_put = getelementptr inbounds %struct.WMV2DSPContext, %struct.WMV2DSPContext* %wdsp26, i32 0, i32 1, !dbg !2769
  %24 = load void (i8*, i64, i16*)*, void (i8*, i64, i16*)** %idct_put, align 8, !dbg !2769
  %25 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s, align 8, !dbg !2770
  %idsp27 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %25, i32 0, i32 101, !dbg !2771
  %idct_put28 = getelementptr inbounds %struct.IDCTDSPContext, %struct.IDCTDSPContext* %idsp27, i32 0, i32 4, !dbg !2772
  store void (i8*, i64, i16*)* %24, void (i8*, i64, i16*)** %idct_put28, align 8, !dbg !2773
  %26 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w.addr, align 8, !dbg !2774
  %wdsp29 = getelementptr inbounds %struct.Wmv2Context, %struct.Wmv2Context* %26, i32 0, i32 2, !dbg !2775
  %idct_add = getelementptr inbounds %struct.WMV2DSPContext, %struct.WMV2DSPContext* %wdsp29, i32 0, i32 0, !dbg !2776
  %27 = load void (i8*, i64, i16*)*, void (i8*, i64, i16*)** %idct_add, align 32, !dbg !2776
  %28 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s, align 8, !dbg !2777
  %idsp30 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %28, i32 0, i32 101, !dbg !2778
  %idct_add31 = getelementptr inbounds %struct.IDCTDSPContext, %struct.IDCTDSPContext* %idsp30, i32 0, i32 5, !dbg !2779
  store void (i8*, i64, i16*)* %27, void (i8*, i64, i16*)** %idct_add31, align 8, !dbg !2780
  %29 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s, align 8, !dbg !2781
  %idsp32 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %29, i32 0, i32 101, !dbg !2782
  %idct = getelementptr inbounds %struct.IDCTDSPContext, %struct.IDCTDSPContext* %idsp32, i32 0, i32 3, !dbg !2783
  store void (i16*)* null, void (i16*)** %idct, align 8, !dbg !2784
  ret void, !dbg !2785
}
...
declare void @ff_wmv2dsp_init(%struct.WMV2DSPContext*) #2

declare void @ff_init_scantable_permutation(i8*, i32) #2

declare void @ff_init_scantable(i8*, %struct.ScanTable*, i8*) #2

; Function Attrs: nounwind uwtable
define void @ff_wmv2_add_mb(%struct.MpegEncContext* %s, [64 x i16]* %block1, i8* %dest_y, i8* %dest_cb, i8* %dest_cr) #3 !dbg !2786 {
entry:
  %s.addr = alloca %struct.MpegEncContext*, align 8
  %block1.addr = alloca [64 x i16]*, align 8
  ...
  call void @llvm.dbg.declare(metadata %struct.MpegEncContext** %s.addr, metadata !2789, metadata !2701), !dbg !2790
  store [64 x i16]* %block1, [64 x i16]** %block1.addr, align 8
  call void @llvm.dbg.declare(metadata [64 x i16]** %block1.addr, metadata !2791, metadata !2701), !dbg !2792
  store i8* %dest_y, i8** %dest_y.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %dest_y.addr, metadata !2793, metadata !2701), !dbg !2794
  store i8* %dest_cb, i8** %dest_cb.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %dest_cb.addr, metadata !2795, metadata !2701), !dbg !2796
  store i8* %dest_cr, i8** %dest_cr.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %dest_cr.addr, metadata !2797, metadata !2701), !dbg !2798
  call void @llvm.dbg.declare(metadata %struct.Wmv2Context** %w, metadata !2799, metadata !2701), !dbg !2801
  %0 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !2802
  %1 = bitcast %struct.MpegEncContext* %0 to %struct.Wmv2Context*, !dbg !2803
  store %struct.Wmv2Context* %1, %struct.Wmv2Context** %w, align 8, !dbg !2801
  %2 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w, align 8, !dbg !2804
  %3 = load [64 x i16]*, [64 x i16]** %block1.addr, align 8, !dbg !2805
  %arrayidx = getelementptr inbounds [64 x i16], [64 x i16]* %3, i64 0, !dbg !2805
  %arraydecay = getelementptr inbounds [64 x i16], [64 x i16]* %arrayidx, i32 0, i32 0, !dbg !2805
  %4 = load i8*, i8** %dest_y.addr, align 8, !dbg !2806
  %5 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !2807
  %linesize = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %5, i32 0, i32 42, !dbg !2808
  %6 = load i64, i64* %linesize, align 8, !dbg !2808
  %conv = trunc i64 %6 to i32, !dbg !2807
  call void @wmv2_add_block(%struct.Wmv2Context* %2, i16* %arraydecay, i8* %4, i32 %conv, i32 0), !dbg !2809
  %7 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w, align 8, !dbg !2810
  %8 = load [64 x i16]*, [64 x i16]** %block1.addr, align 8, !dbg !2811
  %arrayidx1 = getelementptr inbounds [64 x i16], [64 x i16]* %8, i64 1, !dbg !2811
  %arraydecay2 = getelementptr inbounds [64 x i16], [64 x i16]* %arrayidx1, i32 0, i32 0, !dbg !2811
  %9 = load i8*, i8** %dest_y.addr, align 8, !dbg !2812
  %add.ptr = getelementptr inbounds i8, i8* %9, i64 8, !dbg !2813
  %10 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !2814
  %linesize3 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %10, i32 0, i32 42, !dbg !2815
  %11 = load i64, i64* %linesize3, align 8, !dbg !2815
  %conv4 = trunc i64 %11 to i32, !dbg !2814
  call void @wmv2_add_block(%struct.Wmv2Context* %7, i16* %arraydecay2, i8* %add.ptr, i32 %conv4, i32 1), !dbg !2816
  %12 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w, align 8, !dbg !2817
  %13 = load [64 x i16]*, [64 x i16]** %block1.addr, align 8, !dbg !2818
  %arrayidx5 = getelementptr inbounds [64 x i16], [64 x i16]* %13, i64 2, !dbg !2818
  %arraydecay6 = getelementptr inbounds [64 x i16], [64 x i16]* %arrayidx5, i32 0, i32 0, !dbg !2818
  %14 = load i8*, i8** %dest_y.addr, align 8, !dbg !2819
  %15 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !2820
  %linesize7 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %15, i32 0, i32 42, !dbg !2821
  %16 = load i64, i64* %linesize7, align 8, !dbg !2821
  %mul = mul nsw i64 8, %16, !dbg !2822
  %add.ptr8 = getelementptr inbounds i8, i8* %14, i64 %mul, !dbg !2823
  %17 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !2824
  %linesize9 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %17, i32 0, i32 42, !dbg !2825
  %18 = load i64, i64* %linesize9, align 8, !dbg !2825
  %conv10 = trunc i64 %18 to i32, !dbg !2824
  call void @wmv2_add_block(%struct.Wmv2Context* %12, i16* %arraydecay6, i8* %add.ptr8, i32 %conv10, i32 2), !dbg !2826
  %19 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w, align 8, !dbg !2827
  %20 = load [64 x i16]*, [64 x i16]** %block1.addr, align 8, !dbg !2828
  %arrayidx11 = getelementptr inbounds [64 x i16], [64 x i16]* %20, i64 3, !dbg !2828
  %arraydecay12 = getelementptr inbounds [64 x i16], [64 x i16]* %arrayidx11, i32 0, i32 0, !dbg !2828
  %21 = load i8*, i8** %dest_y.addr, align 8, !dbg !2829
  %add.ptr13 = getelementptr inbounds i8, i8* %21, i64 8, !dbg !2830
  %22 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !2831
  %linesize14 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %22, i32 0, i32 42, !dbg !2832
  %23 = load i64, i64* %linesize14, align 8, !dbg !2832
  %mul15 = mul nsw i64 8, %23, !dbg !2833
  %add.ptr16 = getelementptr inbounds i8, i8* %add.ptr13, i64 %mul15, !dbg !2834
  %24 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !2835
  %linesize17 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %24, i32 0, i32 42, !dbg !2836
  %25 = load i64, i64* %linesize17, align 8, !dbg !2836
  %conv18 = trunc i64 %25 to i32, !dbg !2835
  call void @wmv2_add_block(%struct.Wmv2Context* %19, i16* %arraydecay12, i8* %add.ptr16, i32 %conv18, i32 3), !dbg !2837
  %26 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !2838
  %avctx = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %26, i32 0, i32 10, !dbg !2840
  %27 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx, align 8, !dbg !2840
  %flags = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %27, i32 0, i32 13, !dbg !2841
  %28 = load i32, i32* %flags, align 4, !dbg !2841
  %and = and i32 %28, 8192, !dbg !2842
...
if.end:                                           ; preds = %entry
  %29 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w, align 8, !dbg !2845
  %30 = load [64 x i16]*, [64 x i16]** %block1.addr, align 8, !dbg !2846
  %arrayidx19 = getelementptr inbounds [64 x i16], [64 x i16]* %30, i64 4, !dbg !2846
  %arraydecay20 = getelementptr inbounds [64 x i16], [64 x i16]* %arrayidx19, i32 0, i32 0, !dbg !2846
  %31 = load i8*, i8** %dest_cb.addr, align 8, !dbg !2847
  %32 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !2848
  %uvlinesize = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %32, i32 0, i32 43, !dbg !2849
  %33 = load i64, i64* %uvlinesize, align 8, !dbg !2849
  %conv21 = trunc i64 %33 to i32, !dbg !2848
  call void @wmv2_add_block(%struct.Wmv2Context* %29, i16* %arraydecay20, i8* %31, i32 %conv21, i32 4), !dbg !2850
  %34 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w, align 8, !dbg !2851
  %35 = load [64 x i16]*, [64 x i16]** %block1.addr, align 8, !dbg !2852
  %arrayidx22 = getelementptr inbounds [64 x i16], [64 x i16]* %35, i64 5, !dbg !2852
  %arraydecay23 = getelementptr inbounds [64 x i16], [64 x i16]* %arrayidx22, i32 0, i32 0, !dbg !2852
  %36 = load i8*, i8** %dest_cr.addr, align 8, !dbg !2853
  %37 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !2854
  %uvlinesize24 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %37, i32 0, i32 43, !dbg !2855
  %38 = load i64, i64* %uvlinesize24, align 8, !dbg !2855
  %conv25 = trunc i64 %38 to i32, !dbg !2854
  call void @wmv2_add_block(%struct.Wmv2Context* %34, i16* %arraydecay23, i8* %36, i32 %conv25, i32 5), !dbg !2856
...
; Function Attrs: nounwind uwtable
define internal void @wmv2_add_block(%struct.Wmv2Context* %w, i16* %block1, i8* %dst, i32 %stride, i32 %n) #3 !dbg !2860 {
entry:
  %w.addr = alloca %struct.Wmv2Context*, align 8
  ...
  %s = alloca %struct.MpegEncContext*, align 8
  store %struct.Wmv2Context* %w, %struct.Wmv2Context** %w.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.Wmv2Context** %w.addr, metadata !2863, metadata !2701), !dbg !2864
  store i16* %block1, i16** %block1.addr, align 8
  call void @llvm.dbg.declare(metadata i16** %block1.addr, metadata !2865, metadata !2701), !dbg !2866
  store i8* %dst, i8** %dst.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %dst.addr, metadata !2867, metadata !2701), !dbg !2868
  store i32 %stride, i32* %stride.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %stride.addr, metadata !2869, metadata !2701), !dbg !2870
  store i32 %n, i32* %n.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %n.addr, metadata !2871, metadata !2701), !dbg !2872
  call void @llvm.dbg.declare(metadata %struct.MpegEncContext** %s, metadata !2873, metadata !2701), !dbg !2874
  %0 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w.addr, align 8, !dbg !2875
  %s1 = getelementptr inbounds %struct.Wmv2Context, %struct.Wmv2Context* %0, i32 0, i32 0, !dbg !2876
  store %struct.MpegEncContext* %s1, %struct.MpegEncContext** %s, align 8, !dbg !2874
  %1 = load i32, i32* %n.addr, align 4, !dbg !2877
  %idxprom = sext i32 %1 to i64, !dbg !2879
  %2 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s, align 8, !dbg !2879
  %block_last_index = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %2, i32 0, i32 4, !dbg !2880
  %arrayidx = getelementptr inbounds [12 x i32], [12 x i32]* %block_last_index, i64 0, i64 %idxprom, !dbg !2879
  %3 = load i32, i32* %arrayidx, align 4, !dbg !2879
  %cmp = icmp sge i32 %3, 0, !dbg !2881
  br i1 %cmp, label %if.then, label %if.end, !dbg !2882

if.then:                                          ; preds = %entry
  %4 = load i32, i32* %n.addr, align 4, !dbg !2883
  %idxprom2 = sext i32 %4 to i64, !dbg !2885
  %5 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w.addr, align 8, !dbg !2885
  %abt_type_table = getelementptr inbounds %struct.Wmv2Context, %struct.Wmv2Context* %5, i32 0, i32 7, !dbg !2886
  %arrayidx3 = getelementptr inbounds [6 x i32], [6 x i32]* %abt_type_table, i64 0, i64 %idxprom2, !dbg !2885
  %6 = load i32, i32* %arrayidx3, align 4, !dbg !2885
...
sw.bb:                                            ; preds = %if.then
  %7 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w.addr, align 8, !dbg !2888
  %wdsp = getelementptr inbounds %struct.Wmv2Context, %struct.Wmv2Context* %7, i32 0, i32 2, !dbg !2890
  %idct_add = getelementptr inbounds %struct.WMV2DSPContext, %struct.WMV2DSPContext* %wdsp, i32 0, i32 0, !dbg !2891
  %8 = load void (i8*, i64, i16*)*, void (i8*, i64, i16*)** %idct_add, align 32, !dbg !2891
  %9 = load i8*, i8** %dst.addr, align 8, !dbg !2892
  %10 = load i32, i32* %stride.addr, align 4, !dbg !2893
  %conv = sext i32 %10 to i64, !dbg !2893
  %11 = load i16*, i16** %block1.addr, align 8, !dbg !2894
  call void %8(i8* %9, i64 %conv, i16* %11), !dbg !2888
  br label %sw.epilog, !dbg !2895

sw.bb4:                                           ; preds = %if.then
  %12 = load i8*, i8** %dst.addr, align 8, !dbg !2896
  %13 = load i32, i32* %stride.addr, align 4, !dbg !2897
  %conv5 = sext i32 %13 to i64, !dbg !2897
  %14 = load i16*, i16** %block1.addr, align 8, !dbg !2898
  call void @ff_simple_idct84_add(i8* %12, i64 %conv5, i16* %14), !dbg !2899
  %15 = load i8*, i8** %dst.addr, align 8, !dbg !2900
  %16 = load i32, i32* %stride.addr, align 4, !dbg !2901
  %mul = mul nsw i32 4, %16, !dbg !2902
  %idx.ext = sext i32 %mul to i64, !dbg !2903
  %add.ptr = getelementptr inbounds i8, i8* %15, i64 %idx.ext, !dbg !2903
  %17 = load i32, i32* %stride.addr, align 4, !dbg !2904
  %conv6 = sext i32 %17 to i64, !dbg !2904
  %18 = load i32, i32* %n.addr, align 4, !dbg !2905
  %idxprom7 = sext i32 %18 to i64, !dbg !2906
  %19 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w.addr, align 8, !dbg !2906
  %abt_block2 = getelementptr inbounds %struct.Wmv2Context, %struct.Wmv2Context* %19, i32 0, i32 18, !dbg !2907
  %arrayidx8 = getelementptr inbounds [6 x [64 x i16]], [6 x [64 x i16]]* %abt_block2, i64 0, i64 %idxprom7, !dbg !2906
  %arraydecay = getelementptr inbounds [64 x i16], [64 x i16]* %arrayidx8, i32 0, i32 0, !dbg !2906
  call void @ff_simple_idct84_add(i8* %add.ptr, i64 %conv6, i16* %arraydecay), !dbg !2908
  %20 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s, align 8, !dbg !2909
  %bdsp = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %20, i32 0, i32 97, !dbg !2910
  %clear_block = getelementptr inbounds %struct.BlockDSPContext, %struct.BlockDSPContext* %bdsp, i32 0, i32 0, !dbg !2911
  %21 = load void (i16*)*, void (i16*)** %clear_block, align 8, !dbg !2911
  %22 = load i32, i32* %n.addr, align 4, !dbg !2912
  %idxprom9 = sext i32 %22 to i64, !dbg !2913
  %23 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w.addr, align 8, !dbg !2913
  %abt_block210 = getelementptr inbounds %struct.Wmv2Context, %struct.Wmv2Context* %23, i32 0, i32 18, !dbg !2914
  %arrayidx11 = getelementptr inbounds [6 x [64 x i16]], [6 x [64 x i16]]* %abt_block210, i64 0, i64 %idxprom9, !dbg !2913
  %arraydecay12 = getelementptr inbounds [64 x i16], [64 x i16]* %arrayidx11, i32 0, i32 0, !dbg !2913
  call void %21(i16* %arraydecay12), !dbg !2909
  br label %sw.epilog, !dbg !2915

sw.bb13:                                          ; preds = %if.then
  %24 = load i8*, i8** %dst.addr, align 8, !dbg !2916
  %25 = load i32, i32* %stride.addr, align 4, !dbg !2917
  %conv14 = sext i32 %25 to i64, !dbg !2917
  %26 = load i16*, i16** %block1.addr, align 8, !dbg !2918
  call void @ff_simple_idct48_add(i8* %24, i64 %conv14, i16* %26), !dbg !2919
  %27 = load i8*, i8** %dst.addr, align 8, !dbg !2920
  %add.ptr15 = getelementptr inbounds i8, i8* %27, i64 4, !dbg !2921
  %28 = load i32, i32* %stride.addr, align 4, !dbg !2922
  %conv16 = sext i32 %28 to i64, !dbg !2922
  %29 = load i32, i32* %n.addr, align 4, !dbg !2923
  %idxprom17 = sext i32 %29 to i64, !dbg !2924
  %30 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w.addr, align 8, !dbg !2924
  %abt_block218 = getelementptr inbounds %struct.Wmv2Context, %struct.Wmv2Context* %30, i32 0, i32 18, !dbg !2925
  %arrayidx19 = getelementptr inbounds [6 x [64 x i16]], [6 x [64 x i16]]* %abt_block218, i64 0, i64 %idxprom17, !dbg !2924
  %arraydecay20 = getelementptr inbounds [64 x i16], [64 x i16]* %arrayidx19, i32 0, i32 0, !dbg !2924
  call void @ff_simple_idct48_add(i8* %add.ptr15, i64 %conv16, i16* %arraydecay20), !dbg !2926
  %31 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s, align 8, !dbg !2927
  %bdsp21 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %31, i32 0, i32 97, !dbg !2928
  %clear_block22 = getelementptr inbounds %struct.BlockDSPContext, %struct.BlockDSPContext* %bdsp21, i32 0, i32 0, !dbg !2929
  %32 = load void (i16*)*, void (i16*)** %clear_block22, align 8, !dbg !2929
  %33 = load i32, i32* %n.addr, align 4, !dbg !2930
  %idxprom23 = sext i32 %33 to i64, !dbg !2931
  %34 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w.addr, align 8, !dbg !2931
  %abt_block224 = getelementptr inbounds %struct.Wmv2Context, %struct.Wmv2Context* %34, i32 0, i32 18, !dbg !2932
  %arrayidx25 = getelementptr inbounds [6 x [64 x i16]], [6 x [64 x i16]]* %abt_block224, i64 0, i64 %idxprom23, !dbg !2931
  %arraydecay26 = getelementptr inbounds [64 x i16], [64 x i16]* %arrayidx25, i32 0, i32 0, !dbg !2931
  call void %32(i16* %arraydecay26), !dbg !2927
  br label %sw.epilog, !dbg !2933

sw.default:                                       ; preds = %if.then
  %35 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s, align 8, !dbg !2934
  %avctx = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %35, i32 0, i32 10, !dbg !2935
  %36 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx, align 8, !dbg !2935
  %37 = bitcast %struct.AVCodecContext* %36 to i8*, !dbg !2934
  call void (i8*, i32, i8*, ...) @av_log(i8* %37, i32 16, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str, i32 0, i32 0)), !dbg !2936
...
; Function Attrs: nounwind uwtable
define void @ff_mspel_motion(%struct.MpegEncContext* %s, i8* %dest_y, i8* %dest_cb, i8* %dest_cr, i8** %ref_picture, [4 x void (i8*, i8*, i64, i32)*]* %pix_op, i32 %motion_x, i32 %motion_y, i32 %h) #3 !dbg !2940 {
entry:
  %retval.i188 = alloca i32, align 4
  %a.addr.i189 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %a.addr.i189, metadata !2943, metadata !2701), !dbg !2948
  %amin.addr.i190 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %amin.addr.i190, metadata !2950, metadata !2701), !dbg !2951
  %amax.addr.i191 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %amax.addr.i191, metadata !2952, metadata !2701), !dbg !2953
  %retval.i177 = alloca i32, align 4
  %a.addr.i178 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %a.addr.i178, metadata !2943, metadata !2701), !dbg !2954
  %amin.addr.i179 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %amin.addr.i179, metadata !2950, metadata !2701), !dbg !2956
  %amax.addr.i180 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %amax.addr.i180, metadata !2952, metadata !2701), !dbg !2957
  %retval.i166 = alloca i32, align 4
  %a.addr.i167 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %a.addr.i167, metadata !2943, metadata !2701), !dbg !2958
  %amin.addr.i168 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %amin.addr.i168, metadata !2950, metadata !2701), !dbg !2960
  %amax.addr.i169 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %amax.addr.i169, metadata !2952, metadata !2701), !dbg !2961
  %retval.i = alloca i32, align 4
  %a.addr.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %a.addr.i, metadata !2943, metadata !2701), !dbg !2962
  %amin.addr.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %amin.addr.i, metadata !2950, metadata !2701), !dbg !2964
  %amax.addr.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %amax.addr.i, metadata !2952, metadata !2701), !dbg !2965
  %s.addr = alloca %struct.MpegEncContext*, align 8
  %dest_y.addr = alloca i8*, align 8
  %dest_cb.addr = alloca i8*, align 8
  %dest_cr.addr = alloca i8*, align 8
  %ref_picture.addr = alloca i8**, align 8
  %pix_op.addr = alloca [4 x void (i8*, i8*, i64, i32)*]*, align 8
  ...
  store %struct.MpegEncContext* %s, %struct.MpegEncContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.MpegEncContext** %s.addr, metadata !2966, metadata !2701), !dbg !2967
  store i8* %dest_y, i8** %dest_y.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %dest_y.addr, metadata !2968, metadata !2701), !dbg !2969
  store i8* %dest_cb, i8** %dest_cb.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %dest_cb.addr, metadata !2970, metadata !2701), !dbg !2971
  store i8* %dest_cr, i8** %dest_cr.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %dest_cr.addr, metadata !2972, metadata !2701), !dbg !2973
  store i8** %ref_picture, i8*** %ref_picture.addr, align 8
  call void @llvm.dbg.declare(metadata i8*** %ref_picture.addr, metadata !2974, metadata !2701), !dbg !2975
  store [4 x void (i8*, i8*, i64, i32)*]* %pix_op, [4 x void (i8*, i8*, i64, i32)*]** %pix_op.addr, align 8
  call void @llvm.dbg.declare(metadata [4 x void (i8*, i8*, i64, i32)*]** %pix_op.addr, metadata !2976, metadata !2701), !dbg !2977
  store i32 %motion_x, i32* %motion_x.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %motion_x.addr, metadata !2978, metadata !2701), !dbg !2979
  store i32 %motion_y, i32* %motion_y.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %motion_y.addr, metadata !2980, metadata !2701), !dbg !2981
  store i32 %h, i32* %h.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %h.addr, metadata !2982, metadata !2701), !dbg !2983
  call void @llvm.dbg.declare(metadata %struct.Wmv2Context** %w, metadata !2984, metadata !2701), !dbg !2985
  %0 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !2986
  %1 = bitcast %struct.MpegEncContext* %0 to %struct.Wmv2Context*, !dbg !2987
  store %struct.Wmv2Context* %1, %struct.Wmv2Context** %w, align 8, !dbg !2985
  call void @llvm.dbg.declare(metadata i8** %ptr, metadata !2988, metadata !2701), !dbg !2989
  call void @llvm.dbg.declare(metadata i32* %dxy, metadata !2990, metadata !2701), !dbg !2991
  call void @llvm.dbg.declare(metadata i32* %mx, metadata !2992, metadata !2701), !dbg !2993
  call void @llvm.dbg.declare(metadata i32* %my, metadata !2994, metadata !2701), !dbg !2995
  call void @llvm.dbg.declare(metadata i32* %src_x, metadata !2996, metadata !2701), !dbg !2997
  call void @llvm.dbg.declare(metadata i32* %src_y, metadata !2998, metadata !2701), !dbg !2999
  call void @llvm.dbg.declare(metadata i32* %v_edge_pos, metadata !3000, metadata !2701), !dbg !3001
  call void @llvm.dbg.declare(metadata i64* %offset, metadata !3002, metadata !2701), !dbg !3003
  call void @llvm.dbg.declare(metadata i64* %linesize, metadata !3004, metadata !2701), !dbg !3005
  call void @llvm.dbg.declare(metadata i64* %uvlinesize, metadata !3006, metadata !2701), !dbg !3007
  call void @llvm.dbg.declare(metadata i32* %emu, metadata !3008, metadata !2701), !dbg !3009
  store i32 0, i32* %emu, align 4, !dbg !3009
  %2 = load i32, i32* %motion_y.addr, align 4, !dbg !3010
  %and = and i32 %2, 1, !dbg !3011
  %shl = shl i32 %and, 1, !dbg !3012
  %3 = load i32, i32* %motion_x.addr, align 4, !dbg !3013
  %and1 = and i32 %3, 1, !dbg !3014
  %or = or i32 %shl, %and1, !dbg !3015
  store i32 %or, i32* %dxy, align 4, !dbg !3016
  %4 = load i32, i32* %dxy, align 4, !dbg !3017
  %mul = mul nsw i32 2, %4, !dbg !3018
  %5 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w, align 8, !dbg !3019
  %hshift = getelementptr inbounds %struct.Wmv2Context, %struct.Wmv2Context* %5, i32 0, i32 15, !dbg !3020
  %6 = load i32, i32* %hshift, align 4, !dbg !3020
  %add = add nsw i32 %mul, %6, !dbg !3021
  store i32 %add, i32* %dxy, align 4, !dbg !3022
  %7 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3023
  %mb_x = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %7, i32 0, i32 141, !dbg !3024
  %8 = load i32, i32* %mb_x, align 4, !dbg !3024
  %mul2 = mul nsw i32 %8, 16, !dbg !3025
  %9 = load i32, i32* %motion_x.addr, align 4, !dbg !3026
  %shr = ashr i32 %9, 1, !dbg !3027
  %add3 = add nsw i32 %mul2, %shr, !dbg !3028
  store i32 %add3, i32* %src_x, align 4, !dbg !3029
  %10 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3030
  %mb_y = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %10, i32 0, i32 142, !dbg !3031
  %11 = load i32, i32* %mb_y, align 8, !dbg !3031
  %mul4 = mul nsw i32 %11, 16, !dbg !3032
  %12 = load i32, i32* %motion_y.addr, align 4, !dbg !3033
  %shr5 = ashr i32 %12, 1, !dbg !3034
  %add6 = add nsw i32 %mul4, %shr5, !dbg !3035
  store i32 %add6, i32* %src_y, align 4, !dbg !3036
  %13 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3037
  %v_edge_pos7 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %13, i32 0, i32 40, !dbg !3038
  %14 = load i32, i32* %v_edge_pos7, align 8, !dbg !3038
  store i32 %14, i32* %v_edge_pos, align 4, !dbg !3039
  %15 = load i32, i32* %src_x, align 4, !dbg !3040
  %16 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3041
  %width = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %16, i32 0, i32 11, !dbg !3042
  %17 = load i32, i32* %width, align 8, !dbg !3042
  store i32 %15, i32* %a.addr.i, align 4, !dbg !3043
  store i32 -16, i32* %amin.addr.i, align 4, !dbg !3043
  store i32 %17, i32* %amax.addr.i, align 4, !dbg !3043
  %18 = load i32, i32* %a.addr.i, align 4, !dbg !3044
  %19 = load i32, i32* %amin.addr.i, align 4, !dbg !3046
  %cmp.i = icmp slt i32 %18, %19, !dbg !3047
  br i1 %cmp.i, label %if.then.i, label %if.else.i, !dbg !3048

if.then.i:                                        ; preds = %entry
  %20 = load i32, i32* %amin.addr.i, align 4, !dbg !3049
  store i32 %20, i32* %retval.i, align 4, !dbg !3051
  br label %av_clip_c.exit, !dbg !3051

if.else.i:                                        ; preds = %entry
  %21 = load i32, i32* %a.addr.i, align 4, !dbg !3052
  %22 = load i32, i32* %amax.addr.i, align 4, !dbg !3054
  %cmp1.i = icmp sgt i32 %21, %22, !dbg !3055
  br i1 %cmp1.i, label %if.then2.i, label %if.else3.i, !dbg !3056

if.then2.i:                                       ; preds = %if.else.i
  %23 = load i32, i32* %amax.addr.i, align 4, !dbg !3057
  store i32 %23, i32* %retval.i, align 4, !dbg !3059
  br label %av_clip_c.exit, !dbg !3059

if.else3.i:                                       ; preds = %if.else.i
  %24 = load i32, i32* %a.addr.i, align 4, !dbg !3060
  store i32 %24, i32* %retval.i, align 4, !dbg !3061
  br label %av_clip_c.exit, !dbg !3061

av_clip_c.exit:                                   ; preds = %if.then.i, %if.then2.i, %if.else3.i
  %25 = load i32, i32* %retval.i, align 4, !dbg !3062
  store i32 %25, i32* %src_x, align 4, !dbg !3063
  %26 = load i32, i32* %src_y, align 4, !dbg !3064
  %27 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3065
  %height = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %27, i32 0, i32 12, !dbg !3066
  %28 = load i32, i32* %height, align 4, !dbg !3066
  store i32 %26, i32* %a.addr.i167, align 4, !dbg !3067
  store i32 -16, i32* %amin.addr.i168, align 4, !dbg !3067
  store i32 %28, i32* %amax.addr.i169, align 4, !dbg !3067
  %29 = load i32, i32* %a.addr.i167, align 4, !dbg !3068
  %30 = load i32, i32* %amin.addr.i168, align 4, !dbg !3069
  %cmp.i170 = icmp slt i32 %29, %30, !dbg !3070
  br i1 %cmp.i170, label %if.then.i171, label %if.else.i173, !dbg !3071

if.then.i171:                                     ; preds = %av_clip_c.exit
  %31 = load i32, i32* %amin.addr.i168, align 4, !dbg !3072
  store i32 %31, i32* %retval.i166, align 4, !dbg !3073
  br label %av_clip_c.exit176, !dbg !3073

if.else.i173:                                     ; preds = %av_clip_c.exit
  %32 = load i32, i32* %a.addr.i167, align 4, !dbg !3074
  %33 = load i32, i32* %amax.addr.i169, align 4, !dbg !3075
  %cmp1.i172 = icmp sgt i32 %32, %33, !dbg !3076
  br i1 %cmp1.i172, label %if.then2.i174, label %if.else3.i175, !dbg !3077

if.then2.i174:                                    ; preds = %if.else.i173
  %34 = load i32, i32* %amax.addr.i169, align 4, !dbg !3078
  store i32 %34, i32* %retval.i166, align 4, !dbg !3079
  br label %av_clip_c.exit176, !dbg !3079

if.else3.i175:                                    ; preds = %if.else.i173
  %35 = load i32, i32* %a.addr.i167, align 4, !dbg !3080
  store i32 %35, i32* %retval.i166, align 4, !dbg !3081
  br label %av_clip_c.exit176, !dbg !3081

av_clip_c.exit176:                                ; preds = %if.then.i171, %if.then2.i174, %if.else3.i175
  %36 = load i32, i32* %retval.i166, align 4, !dbg !3082
  store i32 %36, i32* %src_y, align 4, !dbg !3083
  %37 = load i32, i32* %src_x, align 4, !dbg !3084
  %cmp = icmp sle i32 %37, -16, !dbg !3086
  br i1 %cmp, label %if.then, label %lor.lhs.false, !dbg !3087

lor.lhs.false:                                    ; preds = %av_clip_c.exit176
  %38 = load i32, i32* %src_x, align 4, !dbg !3088
  %39 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3090
  %width9 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %39, i32 0, i32 11, !dbg !3091
  %40 = load i32, i32* %width9, align 8, !dbg !3091
  %cmp10 = icmp sge i32 %38, %40, !dbg !3092
  br i1 %cmp10, label %if.then, label %if.end, !dbg !3093

if.then:                                          ; preds = %lor.lhs.false, %av_clip_c.exit176
  %41 = load i32, i32* %dxy, align 4, !dbg !3094
  %and11 = and i32 %41, -4, !dbg !3094
  store i32 %and11, i32* %dxy, align 4, !dbg !3094
  br label %if.end, !dbg !3095

if.end:                                           ; preds = %if.then, %lor.lhs.false
  %42 = load i32, i32* %src_y, align 4, !dbg !3096
  %cmp12 = icmp sle i32 %42, -16, !dbg !3098
  br i1 %cmp12, label %if.then16, label %lor.lhs.false13, !dbg !3099

lor.lhs.false13:                                  ; preds = %if.end
  %43 = load i32, i32* %src_y, align 4, !dbg !3100
  %44 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3102
  %height14 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %44, i32 0, i32 12, !dbg !3103
  %45 = load i32, i32* %height14, align 4, !dbg !3103
  %cmp15 = icmp sge i32 %43, %45, !dbg !3104
  br i1 %cmp15, label %if.then16, label %if.end18, !dbg !3105

if.then16:                                        ; preds = %lor.lhs.false13, %if.end
  %46 = load i32, i32* %dxy, align 4, !dbg !3106
  %and17 = and i32 %46, -5, !dbg !3106
  store i32 %and17, i32* %dxy, align 4, !dbg !3106
  br label %if.end18, !dbg !3107

if.end18:                                         ; preds = %if.then16, %lor.lhs.false13
  %47 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3108
  %linesize19 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %47, i32 0, i32 42, !dbg !3109
  %48 = load i64, i64* %linesize19, align 8, !dbg !3109
  store i64 %48, i64* %linesize, align 8, !dbg !3110
  %49 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3111
  %uvlinesize20 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %49, i32 0, i32 43, !dbg !3112
  %50 = load i64, i64* %uvlinesize20, align 8, !dbg !3112
  store i64 %50, i64* %uvlinesize, align 8, !dbg !3113
  %51 = load i8**, i8*** %ref_picture.addr, align 8, !dbg !3114
  %arrayidx = getelementptr inbounds i8*, i8** %51, i64 0, !dbg !3114
  %52 = load i8*, i8** %arrayidx, align 8, !dbg !3114
  %53 = load i32, i32* %src_y, align 4, !dbg !3115
  %conv = sext i32 %53 to i64, !dbg !3115
  %54 = load i64, i64* %linesize, align 8, !dbg !3116
  %mul21 = mul nsw i64 %conv, %54, !dbg !3117
  %add.ptr = getelementptr inbounds i8, i8* %52, i64 %mul21, !dbg !3118
  %55 = load i32, i32* %src_x, align 4, !dbg !3119
  %idx.ext = sext i32 %55 to i64, !dbg !3120
  %add.ptr22 = getelementptr inbounds i8, i8* %add.ptr, i64 %idx.ext, !dbg !3120
  store i8* %add.ptr22, i8** %ptr, align 8, !dbg !3121
  %56 = load i32, i32* %src_x, align 4, !dbg !3122
  %cmp23 = icmp slt i32 %56, 1, !dbg !3124
  br i1 %cmp23, label %if.then37, label %lor.lhs.false25, !dbg !3125

lor.lhs.false25:                                  ; preds = %if.end18
  %57 = load i32, i32* %src_y, align 4, !dbg !3126
  %cmp26 = icmp slt i32 %57, 1, !dbg !3128
  br i1 %cmp26, label %if.then37, label %lor.lhs.false28, !dbg !3129

lor.lhs.false28:                                  ; preds = %lor.lhs.false25
  %58 = load i32, i32* %src_x, align 4, !dbg !3130
  %add29 = add nsw i32 %58, 17, !dbg !3132
  %59 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3133
  %h_edge_pos = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %59, i32 0, i32 39, !dbg !3134
  %60 = load i32, i32* %h_edge_pos, align 4, !dbg !3134
  %cmp30 = icmp sge i32 %add29, %60, !dbg !3135
  br i1 %cmp30, label %if.then37, label %lor.lhs.false32, !dbg !3136

lor.lhs.false32:                                  ; preds = %lor.lhs.false28
  %61 = load i32, i32* %src_y, align 4, !dbg !3137
  %62 = load i32, i32* %h.addr, align 4, !dbg !3138
  %add33 = add nsw i32 %61, %62, !dbg !3139
  %add34 = add nsw i32 %add33, 1, !dbg !3140
  %63 = load i32, i32* %v_edge_pos, align 4, !dbg !3141
  %cmp35 = icmp sge i32 %add34, %63, !dbg !3142
  br i1 %cmp35, label %if.then37, label %if.end51, !dbg !3143

if.then37:                                        ; preds = %lor.lhs.false32, %lor.lhs.false28, %lor.lhs.false25, %if.end18
  %64 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3145
  %vdsp = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %64, i32 0, i32 107, !dbg !3147
  %emulated_edge_mc = getelementptr inbounds %struct.VideoDSPContext, %struct.VideoDSPContext* %vdsp, i32 0, i32 0, !dbg !3148
  %65 = load void (i8*, i8*, i64, i64, i32, i32, i32, i32, i32, i32)*, void (i8*, i8*, i64, i64, i32, i32, i32, i32, i32, i32)** %emulated_edge_mc, align 8, !dbg !3148
  %66 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3149
  %sc = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %66, i32 0, i32 77, !dbg !3150
  %edge_emu_buffer = getelementptr inbounds %struct.ScratchpadContext, %struct.ScratchpadContext* %sc, i32 0, i32 0, !dbg !3151
  %67 = load i8*, i8** %edge_emu_buffer, align 8, !dbg !3151
  %68 = load i8*, i8** %ptr, align 8, !dbg !3152
  %add.ptr38 = getelementptr inbounds i8, i8* %68, i64 -1, !dbg !3153
  %69 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3154
  %linesize39 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %69, i32 0, i32 42, !dbg !3155
  %70 = load i64, i64* %linesize39, align 8, !dbg !3155
  %idx.neg = sub i64 0, %70, !dbg !3156
  %add.ptr40 = getelementptr inbounds i8, i8* %add.ptr38, i64 %idx.neg, !dbg !3156
  %71 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3157
  %linesize41 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %71, i32 0, i32 42, !dbg !3158
  %72 = load i64, i64* %linesize41, align 8, !dbg !3158
  %73 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3159
  %linesize42 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %73, i32 0, i32 42, !dbg !3160
  %74 = load i64, i64* %linesize42, align 8, !dbg !3160
  %75 = load i32, i32* %src_x, align 4, !dbg !3161
  %sub = sub nsw i32 %75, 1, !dbg !3162
  %76 = load i32, i32* %src_y, align 4, !dbg !3163
  %sub43 = sub nsw i32 %76, 1, !dbg !3164
  %77 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3165
  %h_edge_pos44 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %77, i32 0, i32 39, !dbg !3166
  %78 = load i32, i32* %h_edge_pos44, align 4, !dbg !3166
  %79 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3167
  %v_edge_pos45 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %79, i32 0, i32 40, !dbg !3168
  %80 = load i32, i32* %v_edge_pos45, align 8, !dbg !3168
  call void %65(i8* %67, i8* %add.ptr40, i64 %72, i64 %74, i32 19, i32 19, i32 %sub, i32 %sub43, i32 %78, i32 %80), !dbg !3145
  %81 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3169
  %sc46 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %81, i32 0, i32 77, !dbg !3170
  %edge_emu_buffer47 = getelementptr inbounds %struct.ScratchpadContext, %struct.ScratchpadContext* %sc46, i32 0, i32 0, !dbg !3171
  %82 = load i8*, i8** %edge_emu_buffer47, align 8, !dbg !3171
  %add.ptr48 = getelementptr inbounds i8, i8* %82, i64 1, !dbg !3172
  %83 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3173
  %linesize49 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %83, i32 0, i32 42, !dbg !3174
  %84 = load i64, i64* %linesize49, align 8, !dbg !3174
  %add.ptr50 = getelementptr inbounds i8, i8* %add.ptr48, i64 %84, !dbg !3175
  store i8* %add.ptr50, i8** %ptr, align 8, !dbg !3176
  store i32 1, i32* %emu, align 4, !dbg !3177
  br label %if.end51, !dbg !3178

if.end51:                                         ; preds = %if.then37, %lor.lhs.false32
  %85 = load i32, i32* %dxy, align 4, !dbg !3179
  %idxprom = sext i32 %85 to i64, !dbg !3180
  %86 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w, align 8, !dbg !3180
  %wdsp = getelementptr inbounds %struct.Wmv2Context, %struct.Wmv2Context* %86, i32 0, i32 2, !dbg !3181
  %put_mspel_pixels_tab = getelementptr inbounds %struct.WMV2DSPContext, %struct.WMV2DSPContext* %wdsp, i32 0, i32 2, !dbg !3182
  %arrayidx52 = getelementptr inbounds [8 x void (i8*, i8*, i64)*], [8 x void (i8*, i8*, i64)*]* %put_mspel_pixels_tab, i64 0, i64 %idxprom, !dbg !3180
  %87 = load void (i8*, i8*, i64)*, void (i8*, i8*, i64)** %arrayidx52, align 8, !dbg !3180
  %88 = load i8*, i8** %dest_y.addr, align 8, !dbg !3183
  %89 = load i8*, i8** %ptr, align 8, !dbg !3184
  %90 = load i64, i64* %linesize, align 8, !dbg !3185
  call void %87(i8* %88, i8* %89, i64 %90), !dbg !3180
  %91 = load i32, i32* %dxy, align 4, !dbg !3186
  %idxprom53 = sext i32 %91 to i64, !dbg !3187
  %92 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w, align 8, !dbg !3187
  %wdsp54 = getelementptr inbounds %struct.Wmv2Context, %struct.Wmv2Context* %92, i32 0, i32 2, !dbg !3188
  %put_mspel_pixels_tab55 = getelementptr inbounds %struct.WMV2DSPContext, %struct.WMV2DSPContext* %wdsp54, i32 0, i32 2, !dbg !3189
  %arrayidx56 = getelementptr inbounds [8 x void (i8*, i8*, i64)*], [8 x void (i8*, i8*, i64)*]* %put_mspel_pixels_tab55, i64 0, i64 %idxprom53, !dbg !3187
  %93 = load void (i8*, i8*, i64)*, void (i8*, i8*, i64)** %arrayidx56, align 8, !dbg !3187
  %94 = load i8*, i8** %dest_y.addr, align 8, !dbg !3190
  %add.ptr57 = getelementptr inbounds i8, i8* %94, i64 8, !dbg !3191
  %95 = load i8*, i8** %ptr, align 8, !dbg !3192
  %add.ptr58 = getelementptr inbounds i8, i8* %95, i64 8, !dbg !3193
  %96 = load i64, i64* %linesize, align 8, !dbg !3194
  call void %93(i8* %add.ptr57, i8* %add.ptr58, i64 %96), !dbg !3187
  %97 = load i32, i32* %dxy, align 4, !dbg !3195
  %idxprom59 = sext i32 %97 to i64, !dbg !3196
  %98 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w, align 8, !dbg !3196
  %wdsp60 = getelementptr inbounds %struct.Wmv2Context, %struct.Wmv2Context* %98, i32 0, i32 2, !dbg !3197
  %put_mspel_pixels_tab61 = getelementptr inbounds %struct.WMV2DSPContext, %struct.WMV2DSPContext* %wdsp60, i32 0, i32 2, !dbg !3198
  %arrayidx62 = getelementptr inbounds [8 x void (i8*, i8*, i64)*], [8 x void (i8*, i8*, i64)*]* %put_mspel_pixels_tab61, i64 0, i64 %idxprom59, !dbg !3196
  %99 = load void (i8*, i8*, i64)*, void (i8*, i8*, i64)** %arrayidx62, align 8, !dbg !3196
  %100 = load i8*, i8** %dest_y.addr, align 8, !dbg !3199
  %101 = load i64, i64* %linesize, align 8, !dbg !3200
  %mul63 = mul nsw i64 8, %101, !dbg !3201
  %add.ptr64 = getelementptr inbounds i8, i8* %100, i64 %mul63, !dbg !3202
  %102 = load i8*, i8** %ptr, align 8, !dbg !3203
  %103 = load i64, i64* %linesize, align 8, !dbg !3204
  %mul65 = mul nsw i64 8, %103, !dbg !3205
  %add.ptr66 = getelementptr inbounds i8, i8* %102, i64 %mul65, !dbg !3206
  %104 = load i64, i64* %linesize, align 8, !dbg !3207
  call void %99(i8* %add.ptr64, i8* %add.ptr66, i64 %104), !dbg !3196
  %105 = load i32, i32* %dxy, align 4, !dbg !3208
  %idxprom67 = sext i32 %105 to i64, !dbg !3209
  %106 = load %struct.Wmv2Context*, %struct.Wmv2Context** %w, align 8, !dbg !3209
  %wdsp68 = getelementptr inbounds %struct.Wmv2Context, %struct.Wmv2Context* %106, i32 0, i32 2, !dbg !3210
  %put_mspel_pixels_tab69 = getelementptr inbounds %struct.WMV2DSPContext, %struct.WMV2DSPContext* %wdsp68, i32 0, i32 2, !dbg !3211
  %arrayidx70 = getelementptr inbounds [8 x void (i8*, i8*, i64)*], [8 x void (i8*, i8*, i64)*]* %put_mspel_pixels_tab69, i64 0, i64 %idxprom67, !dbg !3209
  %107 = load void (i8*, i8*, i64)*, void (i8*, i8*, i64)** %arrayidx70, align 8, !dbg !3209
  %108 = load i8*, i8** %dest_y.addr, align 8, !dbg !3212
  %add.ptr71 = getelementptr inbounds i8, i8* %108, i64 8, !dbg !3213
  %109 = load i64, i64* %linesize, align 8, !dbg !3214
  %mul72 = mul nsw i64 8, %109, !dbg !3215
  %add.ptr73 = getelementptr inbounds i8, i8* %add.ptr71, i64 %mul72, !dbg !3216
  %110 = load i8*, i8** %ptr, align 8, !dbg !3217
  %add.ptr74 = getelementptr inbounds i8, i8* %110, i64 8, !dbg !3218
  %111 = load i64, i64* %linesize, align 8, !dbg !3219
  %mul75 = mul nsw i64 8, %111, !dbg !3220
  %add.ptr76 = getelementptr inbounds i8, i8* %add.ptr74, i64 %mul75, !dbg !3221
  %112 = load i64, i64* %linesize, align 8, !dbg !3222
  call void %107(i8* %add.ptr73, i8* %add.ptr76, i64 %112), !dbg !3209
  %113 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3223
  %avctx = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %113, i32 0, i32 10, !dbg !3225
  %114 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx, align 8, !dbg !3225
  %flags = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %114, i32 0, i32 13, !dbg !3226
  %115 = load i32, i32* %flags, align 4, !dbg !3226
  %and77 = and i32 %115, 8192, !dbg !3227
  %tobool = icmp ne i32 %and77, 0, !dbg !3227
  br i1 %tobool, label %if.then78, label %if.end79, !dbg !3228

if.then78:                                        ; preds = %if.end51
  br label %return, !dbg !3229

if.end79:                                         ; preds = %if.end51
  store i32 0, i32* %dxy, align 4, !dbg !3230
  %116 = load i32, i32* %motion_x.addr, align 4, !dbg !3231
  %and80 = and i32 %116, 3, !dbg !3233
  %cmp81 = icmp ne i32 %and80, 0, !dbg !3234
  br i1 %cmp81, label %if.then83, label %if.end85, !dbg !3235

if.then83:                                        ; preds = %if.end79
  %117 = load i32, i32* %dxy, align 4, !dbg !3236
  %or84 = or i32 %117, 1, !dbg !3236
  store i32 %or84, i32* %dxy, align 4, !dbg !3236
  br label %if.end85, !dbg !3237

if.end85:                                         ; preds = %if.then83, %if.end79
  %118 = load i32, i32* %motion_y.addr, align 4, !dbg !3238
  %and86 = and i32 %118, 3, !dbg !3240
  %cmp87 = icmp ne i32 %and86, 0, !dbg !3241
  br i1 %cmp87, label %if.then89, label %if.end91, !dbg !3242

if.then89:                                        ; preds = %if.end85
  %119 = load i32, i32* %dxy, align 4, !dbg !3243
  %or90 = or i32 %119, 2, !dbg !3243
  store i32 %or90, i32* %dxy, align 4, !dbg !3243
  br label %if.end91, !dbg !3244

if.end91:                                         ; preds = %if.then89, %if.end85
  %120 = load i32, i32* %motion_x.addr, align 4, !dbg !3245
  %shr92 = ashr i32 %120, 2, !dbg !3246
  store i32 %shr92, i32* %mx, align 4, !dbg !3247
  %121 = load i32, i32* %motion_y.addr, align 4, !dbg !3248
  %shr93 = ashr i32 %121, 2, !dbg !3249
  store i32 %shr93, i32* %my, align 4, !dbg !3250
  %122 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3251
  %mb_x94 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %122, i32 0, i32 141, !dbg !3252
  %123 = load i32, i32* %mb_x94, align 4, !dbg !3252
  %mul95 = mul nsw i32 %123, 8, !dbg !3253
  %124 = load i32, i32* %mx, align 4, !dbg !3254
  %add96 = add nsw i32 %mul95, %124, !dbg !3255
  store i32 %add96, i32* %src_x, align 4, !dbg !3256
  %125 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3257
  %mb_y97 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %125, i32 0, i32 142, !dbg !3258
  %126 = load i32, i32* %mb_y97, align 8, !dbg !3258
  %mul98 = mul nsw i32 %126, 8, !dbg !3259
  %127 = load i32, i32* %my, align 4, !dbg !3260
  %add99 = add nsw i32 %mul98, %127, !dbg !3261
  store i32 %add99, i32* %src_y, align 4, !dbg !3262
  %128 = load i32, i32* %src_x, align 4, !dbg !3263
  %129 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3264
  %width100 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %129, i32 0, i32 11, !dbg !3265
  %130 = load i32, i32* %width100, align 8, !dbg !3265
  %shr101 = ashr i32 %130, 1, !dbg !3266
  store i32 %128, i32* %a.addr.i178, align 4, !dbg !3267
  store i32 -8, i32* %amin.addr.i179, align 4, !dbg !3267
  store i32 %shr101, i32* %amax.addr.i180, align 4, !dbg !3267
  %131 = load i32, i32* %a.addr.i178, align 4, !dbg !3268
  %132 = load i32, i32* %amin.addr.i179, align 4, !dbg !3269
  %cmp.i181 = icmp slt i32 %131, %132, !dbg !3270
  br i1 %cmp.i181, label %if.then.i182, label %if.else.i184, !dbg !3271

if.then.i182:                                     ; preds = %if.end91
  %133 = load i32, i32* %amin.addr.i179, align 4, !dbg !3272
  store i32 %133, i32* %retval.i177, align 4, !dbg !3273
  br label %av_clip_c.exit187, !dbg !3273

if.else.i184:                                     ; preds = %if.end91
  %134 = load i32, i32* %a.addr.i178, align 4, !dbg !3274
  %135 = load i32, i32* %amax.addr.i180, align 4, !dbg !3275
  %cmp1.i183 = icmp sgt i32 %134, %135, !dbg !3276
  br i1 %cmp1.i183, label %if.then2.i185, label %if.else3.i186, !dbg !3277

if.then2.i185:                                    ; preds = %if.else.i184
  %136 = load i32, i32* %amax.addr.i180, align 4, !dbg !3278
  store i32 %136, i32* %retval.i177, align 4, !dbg !3279
  br label %av_clip_c.exit187, !dbg !3279

if.else3.i186:                                    ; preds = %if.else.i184
  %137 = load i32, i32* %a.addr.i178, align 4, !dbg !3280
  store i32 %137, i32* %retval.i177, align 4, !dbg !3281
  br label %av_clip_c.exit187, !dbg !3281

av_clip_c.exit187:                                ; preds = %if.then.i182, %if.then2.i185, %if.else3.i186
  %138 = load i32, i32* %retval.i177, align 4, !dbg !3282
  store i32 %138, i32* %src_x, align 4, !dbg !3283
  %139 = load i32, i32* %src_x, align 4, !dbg !3284
  %140 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3286
  %width103 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %140, i32 0, i32 11, !dbg !3287
  %141 = load i32, i32* %width103, align 8, !dbg !3287
  %shr104 = ashr i32 %141, 1, !dbg !3288
  %cmp105 = icmp eq i32 %139, %shr104, !dbg !3289
  br i1 %cmp105, label %if.then107, label %if.end109, !dbg !3290

if.then107:                                       ; preds = %av_clip_c.exit187
  %142 = load i32, i32* %dxy, align 4, !dbg !3291
  %and108 = and i32 %142, -2, !dbg !3291
  store i32 %and108, i32* %dxy, align 4, !dbg !3291
  br label %if.end109, !dbg !3292

if.end109:                                        ; preds = %if.then107, %av_clip_c.exit187
  %143 = load i32, i32* %src_y, align 4, !dbg !3293
  %144 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3294
  %height110 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %144, i32 0, i32 12, !dbg !3295
  %145 = load i32, i32* %height110, align 4, !dbg !3295
  %shr111 = ashr i32 %145, 1, !dbg !3296
  store i32 %143, i32* %a.addr.i189, align 4, !dbg !3297
  store i32 -8, i32* %amin.addr.i190, align 4, !dbg !3297
  store i32 %shr111, i32* %amax.addr.i191, align 4, !dbg !3297
  %146 = load i32, i32* %a.addr.i189, align 4, !dbg !3298
  %147 = load i32, i32* %amin.addr.i190, align 4, !dbg !3299
  %cmp.i192 = icmp slt i32 %146, %147, !dbg !3300
  br i1 %cmp.i192, label %if.then.i193, label %if.else.i195, !dbg !3301

if.then.i193:                                     ; preds = %if.end109
  %148 = load i32, i32* %amin.addr.i190, align 4, !dbg !3302
  store i32 %148, i32* %retval.i188, align 4, !dbg !3303
  br label %av_clip_c.exit198, !dbg !3303

if.else.i195:                                     ; preds = %if.end109
  %149 = load i32, i32* %a.addr.i189, align 4, !dbg !3304
  %150 = load i32, i32* %amax.addr.i191, align 4, !dbg !3305
  %cmp1.i194 = icmp sgt i32 %149, %150, !dbg !3306
  br i1 %cmp1.i194, label %if.then2.i196, label %if.else3.i197, !dbg !3307

if.then2.i196:                                    ; preds = %if.else.i195
  %151 = load i32, i32* %amax.addr.i191, align 4, !dbg !3308
  store i32 %151, i32* %retval.i188, align 4, !dbg !3309
  br label %av_clip_c.exit198, !dbg !3309

if.else3.i197:                                    ; preds = %if.else.i195
  %152 = load i32, i32* %a.addr.i189, align 4, !dbg !3310
  store i32 %152, i32* %retval.i188, align 4, !dbg !3311
  br label %av_clip_c.exit198, !dbg !3311

av_clip_c.exit198:                                ; preds = %if.then.i193, %if.then2.i196, %if.else3.i197
  %153 = load i32, i32* %retval.i188, align 4, !dbg !3312
  store i32 %153, i32* %src_y, align 4, !dbg !3313
  %154 = load i32, i32* %src_y, align 4, !dbg !3314
  %155 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3316
  %height113 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %155, i32 0, i32 12, !dbg !3317
  %156 = load i32, i32* %height113, align 4, !dbg !3317
  %shr114 = ashr i32 %156, 1, !dbg !3318
  %cmp115 = icmp eq i32 %154, %shr114, !dbg !3319
  br i1 %cmp115, label %if.then117, label %if.end119, !dbg !3320

if.then117:                                       ; preds = %av_clip_c.exit198
  %157 = load i32, i32* %dxy, align 4, !dbg !3321
  %and118 = and i32 %157, -3, !dbg !3321
  store i32 %and118, i32* %dxy, align 4, !dbg !3321
  br label %if.end119, !dbg !3322

if.end119:                                        ; preds = %if.then117, %av_clip_c.exit198
  %158 = load i32, i32* %src_y, align 4, !dbg !3323
  %conv120 = sext i32 %158 to i64, !dbg !3323
  %159 = load i64, i64* %uvlinesize, align 8, !dbg !3324
  %mul121 = mul nsw i64 %conv120, %159, !dbg !3325
  %160 = load i32, i32* %src_x, align 4, !dbg !3326
  %conv122 = sext i32 %160 to i64, !dbg !3326
  %add123 = add nsw i64 %mul121, %conv122, !dbg !3327
  store i64 %add123, i64* %offset, align 8, !dbg !3328
  %161 = load i8**, i8*** %ref_picture.addr, align 8, !dbg !3329
  %arrayidx124 = getelementptr inbounds i8*, i8** %161, i64 1, !dbg !3329
  %162 = load i8*, i8** %arrayidx124, align 8, !dbg !3329
  %163 = load i64, i64* %offset, align 8, !dbg !3330
  %add.ptr125 = getelementptr inbounds i8, i8* %162, i64 %163, !dbg !3331
  store i8* %add.ptr125, i8** %ptr, align 8, !dbg !3332
  %164 = load i32, i32* %emu, align 4, !dbg !3333
  %tobool126 = icmp ne i32 %164, 0, !dbg !3333
  br i1 %tobool126, label %if.then127, label %if.end140, !dbg !3335

if.then127:                                       ; preds = %if.end119
  %165 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3336
  %vdsp128 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %165, i32 0, i32 107, !dbg !3338
  %emulated_edge_mc129 = getelementptr inbounds %struct.VideoDSPContext, %struct.VideoDSPContext* %vdsp128, i32 0, i32 0, !dbg !3339
  %166 = load void (i8*, i8*, i64, i64, i32, i32, i32, i32, i32, i32)*, void (i8*, i8*, i64, i64, i32, i32, i32, i32, i32, i32)** %emulated_edge_mc129, align 8, !dbg !3339
  %167 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3340
  %sc130 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %167, i32 0, i32 77, !dbg !3341
  %edge_emu_buffer131 = getelementptr inbounds %struct.ScratchpadContext, %struct.ScratchpadContext* %sc130, i32 0, i32 0, !dbg !3342
  %168 = load i8*, i8** %edge_emu_buffer131, align 8, !dbg !3342
  %169 = load i8*, i8** %ptr, align 8, !dbg !3343
  %170 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3344
  %uvlinesize132 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %170, i32 0, i32 43, !dbg !3345
  %171 = load i64, i64* %uvlinesize132, align 8, !dbg !3345
  %172 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3346
  %uvlinesize133 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %172, i32 0, i32 43, !dbg !3347
  %173 = load i64, i64* %uvlinesize133, align 8, !dbg !3347
  %174 = load i32, i32* %src_x, align 4, !dbg !3348
  %175 = load i32, i32* %src_y, align 4, !dbg !3349
  %176 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3350
  %h_edge_pos134 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %176, i32 0, i32 39, !dbg !3351
  %177 = load i32, i32* %h_edge_pos134, align 4, !dbg !3351
  %shr135 = ashr i32 %177, 1, !dbg !3352
  %178 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3353
  %v_edge_pos136 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %178, i32 0, i32 40, !dbg !3354
  %179 = load i32, i32* %v_edge_pos136, align 8, !dbg !3354
  %shr137 = ashr i32 %179, 1, !dbg !3355
  call void %166(i8* %168, i8* %169, i64 %171, i64 %173, i32 9, i32 9, i32 %174, i32 %175, i32 %shr135, i32 %shr137), !dbg !3336
  %180 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3356
  %sc138 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %180, i32 0, i32 77, !dbg !3357
  %edge_emu_buffer139 = getelementptr inbounds %struct.ScratchpadContext, %struct.ScratchpadContext* %sc138, i32 0, i32 0, !dbg !3358
  %181 = load i8*, i8** %edge_emu_buffer139, align 8, !dbg !3358
  store i8* %181, i8** %ptr, align 8, !dbg !3359
  br label %if.end140, !dbg !3360

if.end140:                                        ; preds = %if.then127, %if.end119
  %182 = load i32, i32* %dxy, align 4, !dbg !3361
  %idxprom141 = sext i32 %182 to i64, !dbg !3362
  %183 = load [4 x void (i8*, i8*, i64, i32)*]*, [4 x void (i8*, i8*, i64, i32)*]** %pix_op.addr, align 8, !dbg !3362
  %arrayidx142 = getelementptr inbounds [4 x void (i8*, i8*, i64, i32)*], [4 x void (i8*, i8*, i64, i32)*]* %183, i64 1, !dbg !3362
  %arrayidx143 = getelementptr inbounds [4 x void (i8*, i8*, i64, i32)*], [4 x void (i8*, i8*, i64, i32)*]* %arrayidx142, i64 0, i64 %idxprom141, !dbg !3362
  %184 = load void (i8*, i8*, i64, i32)*, void (i8*, i8*, i64, i32)** %arrayidx143, align 8, !dbg !3362
  %185 = load i8*, i8** %dest_cb.addr, align 8, !dbg !3363
  %186 = load i8*, i8** %ptr, align 8, !dbg !3364
  %187 = load i64, i64* %uvlinesize, align 8, !dbg !3365
  %188 = load i32, i32* %h.addr, align 4, !dbg !3366
  %shr144 = ashr i32 %188, 1, !dbg !3367
  call void %184(i8* %185, i8* %186, i64 %187, i32 %shr144), !dbg !3362
  %189 = load i8**, i8*** %ref_picture.addr, align 8, !dbg !3368
  %arrayidx145 = getelementptr inbounds i8*, i8** %189, i64 2, !dbg !3368
  %190 = load i8*, i8** %arrayidx145, align 8, !dbg !3368
  %191 = load i64, i64* %offset, align 8, !dbg !3369
  %add.ptr146 = getelementptr inbounds i8, i8* %190, i64 %191, !dbg !3370
  store i8* %add.ptr146, i8** %ptr, align 8, !dbg !3371
  %192 = load i32, i32* %emu, align 4, !dbg !3372
  %tobool147 = icmp ne i32 %192, 0, !dbg !3372
  br i1 %tobool147, label %if.then148, label %if.end161, !dbg !3374

if.then148:                                       ; preds = %if.end140
  %193 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3375
  %vdsp149 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %193, i32 0, i32 107, !dbg !3377
  %emulated_edge_mc150 = getelementptr inbounds %struct.VideoDSPContext, %struct.VideoDSPContext* %vdsp149, i32 0, i32 0, !dbg !3378
  %194 = load void (i8*, i8*, i64, i64, i32, i32, i32, i32, i32, i32)*, void (i8*, i8*, i64, i64, i32, i32, i32, i32, i32, i32)** %emulated_edge_mc150, align 8, !dbg !3378
  %195 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3379
  %sc151 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %195, i32 0, i32 77, !dbg !3380
  %edge_emu_buffer152 = getelementptr inbounds %struct.ScratchpadContext, %struct.ScratchpadContext* %sc151, i32 0, i32 0, !dbg !3381
  %196 = load i8*, i8** %edge_emu_buffer152, align 8, !dbg !3381
  %197 = load i8*, i8** %ptr, align 8, !dbg !3382
  %198 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3383
  %uvlinesize153 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %198, i32 0, i32 43, !dbg !3384
  %199 = load i64, i64* %uvlinesize153, align 8, !dbg !3384
  %200 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3385
  %uvlinesize154 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %200, i32 0, i32 43, !dbg !3386
  %201 = load i64, i64* %uvlinesize154, align 8, !dbg !3386
  %202 = load i32, i32* %src_x, align 4, !dbg !3387
  %203 = load i32, i32* %src_y, align 4, !dbg !3388
  %204 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3389
  %h_edge_pos155 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %204, i32 0, i32 39, !dbg !3390
  %205 = load i32, i32* %h_edge_pos155, align 4, !dbg !3390
  %shr156 = ashr i32 %205, 1, !dbg !3391
  %206 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3392
  %v_edge_pos157 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %206, i32 0, i32 40, !dbg !3393
  %207 = load i32, i32* %v_edge_pos157, align 8, !dbg !3393
  %shr158 = ashr i32 %207, 1, !dbg !3394
  call void %194(i8* %196, i8* %197, i64 %199, i64 %201, i32 9, i32 9, i32 %202, i32 %203, i32 %shr156, i32 %shr158), !dbg !3375
  %208 = load %struct.MpegEncContext*, %struct.MpegEncContext** %s.addr, align 8, !dbg !3395
  %sc159 = getelementptr inbounds %struct.MpegEncContext, %struct.MpegEncContext* %208, i32 0, i32 77, !dbg !3396
  %edge_emu_buffer160 = getelementptr inbounds %struct.ScratchpadContext, %struct.ScratchpadContext* %sc159, i32 0, i32 0, !dbg !3397
  %209 = load i8*, i8** %edge_emu_buffer160, align 8, !dbg !3397
  store i8* %209, i8** %ptr, align 8, !dbg !3398
  br label %if.end161, !dbg !3399

if.end161:                                        ; preds = %if.then148, %if.end140
  %210 = load i32, i32* %dxy, align 4, !dbg !3400
  %idxprom162 = sext i32 %210 to i64, !dbg !3401
  %211 = load [4 x void (i8*, i8*, i64, i32)*]*, [4 x void (i8*, i8*, i64, i32)*]** %pix_op.addr, align 8, !dbg !3401
  %arrayidx163 = getelementptr inbounds [4 x void (i8*, i8*, i64, i32)*], [4 x void (i8*, i8*, i64, i32)*]* %211, i64 1, !dbg !3401
  %arrayidx164 = getelementptr inbounds [4 x void (i8*, i8*, i64, i32)*], [4 x void (i8*, i8*, i64, i32)*]* %arrayidx163, i64 0, i64 %idxprom162, !dbg !3401
  %212 = load void (i8*, i8*, i64, i32)*, void (i8*, i8*, i64, i32)** %arrayidx164, align 8, !dbg !3401
  %213 = load i8*, i8** %dest_cr.addr, align 8, !dbg !3402
  %214 = load i8*, i8** %ptr, align 8, !dbg !3403
  %215 = load i64, i64* %uvlinesize, align 8, !dbg !3404
  %216 = load i32, i32* %h.addr, align 4, !dbg !3405
  %shr165 = ashr i32 %216, 1, !dbg !3406
  call void %212(i8* %213, i8* %214, i64 %215, i32 %shr165), !dbg !3401
  br label %return, !dbg !3407

return:                                           ; preds = %if.end161, %if.then78
  ret void, !dbg !3408
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[inter]libavcodec--wmv2.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs")
...
!2691 = !{!1987, !1042}
!2692 = !{i32 2, !"Dwarf Version", i32 4}
!2693 = !{i32 2, !"Debug Info Version", i32 3}
!2694 = !{!"clang version 3.9.0 (tags/RELEASE_390/final)"}
!2695 = distinct !DISubprogram(name: "ff_wmv2_common_init", scope: !2696, file: !2696, line: 31, type: !2697, isLocal: false, isDefinition: true, scopeLine: 32, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2699)
!2696 = !DIFile(filename: "libavcodec/wmv2.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs")
!2697 = !DISubroutineType(types: !2698)
!2698 = !{null, !926}
!2699 = !{}
!2700 = !DILocalVariable(name: "w", arg: 1, scope: !2695, file: !2696, line: 31, type: !926)
!2701 = !DIExpression()
!2702 = !DILocation(line: 31, column: 61, scope: !2695)
!2703 = !DILocalVariable(name: "s", scope: !2695, file: !2696, line: 33, type: !2704)
...
!2706 = !DILocation(line: 33, column: 27, scope: !2695)
!2707 = !DILocation(line: 33, column: 32, scope: !2695)
!2708 = !DILocation(line: 33, column: 35, scope: !2695)
!2709 = !DILocation(line: 35, column: 23, scope: !2695)
!2710 = !DILocation(line: 35, column: 26, scope: !2695)
!2711 = !DILocation(line: 35, column: 32, scope: !2695)
!2712 = !DILocation(line: 35, column: 35, scope: !2695)
!2713 = !DILocation(line: 35, column: 5, scope: !2695)
!2714 = !DILocation(line: 36, column: 22, scope: !2695)
!2715 = !DILocation(line: 36, column: 25, scope: !2695)
!2716 = !DILocation(line: 36, column: 5, scope: !2695)
!2717 = !DILocation(line: 37, column: 25, scope: !2695)
!2718 = !DILocation(line: 37, column: 28, scope: !2695)
!2719 = !DILocation(line: 37, column: 33, scope: !2695)
!2720 = !DILocation(line: 37, column: 5, scope: !2695)
!2721 = !DILocation(line: 37, column: 8, scope: !2695)
!2722 = !DILocation(line: 37, column: 13, scope: !2695)
!2723 = !DILocation(line: 37, column: 23, scope: !2695)
!2724 = !DILocation(line: 38, column: 35, scope: !2695)
!2725 = !DILocation(line: 38, column: 38, scope: !2695)
!2726 = !DILocation(line: 38, column: 43, scope: !2695)
!2727 = !DILocation(line: 39, column: 35, scope: !2695)
!2728 = !DILocation(line: 39, column: 38, scope: !2695)
!2729 = !DILocation(line: 39, column: 43, scope: !2695)
!2730 = !DILocation(line: 38, column: 5, scope: !2695)
!2731 = !DILocation(line: 40, column: 23, scope: !2695)
!2732 = !DILocation(line: 40, column: 26, scope: !2695)
!2733 = !DILocation(line: 40, column: 31, scope: !2695)
!2734 = !DILocation(line: 40, column: 50, scope: !2695)
!2735 = !DILocation(line: 40, column: 53, scope: !2695)
!2736 = !DILocation(line: 40, column: 5, scope: !2695)
!2737 = !DILocation(line: 42, column: 23, scope: !2695)
!2738 = !DILocation(line: 42, column: 26, scope: !2695)
!2739 = !DILocation(line: 42, column: 31, scope: !2695)
!2740 = !DILocation(line: 42, column: 50, scope: !2695)
!2741 = !DILocation(line: 42, column: 53, scope: !2695)
!2742 = !DILocation(line: 42, column: 5, scope: !2695)
!2743 = !DILocation(line: 44, column: 23, scope: !2695)
!2744 = !DILocation(line: 44, column: 26, scope: !2695)
!2745 = !DILocation(line: 44, column: 31, scope: !2695)
!2746 = !DILocation(line: 44, column: 50, scope: !2695)
!2747 = !DILocation(line: 44, column: 53, scope: !2695)
!2748 = !DILocation(line: 44, column: 5, scope: !2695)
!2749 = !DILocation(line: 46, column: 23, scope: !2695)
!2750 = !DILocation(line: 46, column: 26, scope: !2695)
!2751 = !DILocation(line: 46, column: 31, scope: !2695)
!2752 = !DILocation(line: 46, column: 50, scope: !2695)
!2753 = !DILocation(line: 46, column: 53, scope: !2695)
!2754 = !DILocation(line: 46, column: 5, scope: !2695)
!2755 = !DILocation(line: 48, column: 23, scope: !2695)
!2756 = !DILocation(line: 48, column: 26, scope: !2695)
!2757 = !DILocation(line: 48, column: 31, scope: !2695)
!2758 = !DILocation(line: 48, column: 50, scope: !2695)
!2759 = !DILocation(line: 48, column: 53, scope: !2695)
!2760 = !DILocation(line: 48, column: 5, scope: !2695)
!2761 = !DILocation(line: 50, column: 23, scope: !2695)
!2762 = !DILocation(line: 50, column: 26, scope: !2695)
!2763 = !DILocation(line: 50, column: 31, scope: !2695)
!2764 = !DILocation(line: 50, column: 50, scope: !2695)
!2765 = !DILocation(line: 50, column: 53, scope: !2695)
!2766 = !DILocation(line: 50, column: 5, scope: !2695)
!2767 = !DILocation(line: 52, column: 24, scope: !2695)
!2768 = !DILocation(line: 52, column: 27, scope: !2695)
!2769 = !DILocation(line: 52, column: 32, scope: !2695)
!2770 = !DILocation(line: 52, column: 5, scope: !2695)
!2771 = !DILocation(line: 52, column: 8, scope: !2695)
!2772 = !DILocation(line: 52, column: 13, scope: !2695)
!2773 = !DILocation(line: 52, column: 22, scope: !2695)
!2774 = !DILocation(line: 53, column: 24, scope: !2695)
!2775 = !DILocation(line: 53, column: 27, scope: !2695)
!2776 = !DILocation(line: 53, column: 32, scope: !2695)
!2777 = !DILocation(line: 53, column: 5, scope: !2695)
!2778 = !DILocation(line: 53, column: 8, scope: !2695)
!2779 = !DILocation(line: 53, column: 13, scope: !2695)
!2780 = !DILocation(line: 53, column: 22, scope: !2695)
!2781 = !DILocation(line: 54, column: 5, scope: !2695)
!2782 = !DILocation(line: 54, column: 8, scope: !2695)
!2783 = !DILocation(line: 54, column: 13, scope: !2695)
!2784 = !DILocation(line: 54, column: 18, scope: !2695)
!2785 = !DILocation(line: 55, column: 1, scope: !2695)
!2786 = distinct !DISubprogram(name: "ff_wmv2_add_mb", scope: !2696, file: !2696, line: 83, type: !2787, isLocal: false, isDefinition: true, scopeLine: 85, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2699)
!2787 = !DISubroutineType(types: !2788)
!2788 = !{null, !2705, !2472, !1127, !1127, !1127}
!2789 = !DILocalVariable(name: "s", arg: 1, scope: !2786, file: !2696, line: 83, type: !2705)
!2790 = !DILocation(line: 83, column: 37, scope: !2786)
!2791 = !DILocalVariable(name: "block1", arg: 2, scope: !2786, file: !2696, line: 83, type: !2472)
!2792 = !DILocation(line: 83, column: 48, scope: !2786)
!2793 = !DILocalVariable(name: "dest_y", arg: 3, scope: !2786, file: !2696, line: 84, type: !1127)
!2794 = !DILocation(line: 84, column: 30, scope: !2786)
!2795 = !DILocalVariable(name: "dest_cb", arg: 4, scope: !2786, file: !2696, line: 84, type: !1127)
!2796 = !DILocation(line: 84, column: 47, scope: !2786)
!2797 = !DILocalVariable(name: "dest_cr", arg: 5, scope: !2786, file: !2696, line: 84, type: !1127)
!2798 = !DILocation(line: 84, column: 65, scope: !2786)
!2799 = !DILocalVariable(name: "w", scope: !2786, file: !2696, line: 86, type: !2800)
!2800 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !926)
!2801 = !DILocation(line: 86, column: 24, scope: !2786)
!2802 = !DILocation(line: 86, column: 44, scope: !2786)
!2803 = !DILocation(line: 86, column: 28, scope: !2786)
!2804 = !DILocation(line: 88, column: 20, scope: !2786)
!2805 = !DILocation(line: 88, column: 23, scope: !2786)
!2806 = !DILocation(line: 88, column: 34, scope: !2786)
!2807 = !DILocation(line: 88, column: 42, scope: !2786)
!2808 = !DILocation(line: 88, column: 45, scope: !2786)
!2809 = !DILocation(line: 88, column: 5, scope: !2786)
!2810 = !DILocation(line: 89, column: 20, scope: !2786)
!2811 = !DILocation(line: 89, column: 23, scope: !2786)
!2812 = !DILocation(line: 89, column: 34, scope: !2786)
!2813 = !DILocation(line: 89, column: 41, scope: !2786)
!2814 = !DILocation(line: 89, column: 46, scope: !2786)
!2815 = !DILocation(line: 89, column: 49, scope: !2786)
!2816 = !DILocation(line: 89, column: 5, scope: !2786)
!2817 = !DILocation(line: 90, column: 20, scope: !2786)
!2818 = !DILocation(line: 90, column: 23, scope: !2786)
!2819 = !DILocation(line: 90, column: 34, scope: !2786)
!2820 = !DILocation(line: 90, column: 47, scope: !2786)
!2821 = !DILocation(line: 90, column: 50, scope: !2786)
!2822 = !DILocation(line: 90, column: 45, scope: !2786)
!2823 = !DILocation(line: 90, column: 41, scope: !2786)
!2824 = !DILocation(line: 90, column: 60, scope: !2786)
!2825 = !DILocation(line: 90, column: 63, scope: !2786)
!2826 = !DILocation(line: 90, column: 5, scope: !2786)
!2827 = !DILocation(line: 91, column: 20, scope: !2786)
!2828 = !DILocation(line: 91, column: 23, scope: !2786)
!2829 = !DILocation(line: 91, column: 34, scope: !2786)
!2830 = !DILocation(line: 91, column: 41, scope: !2786)
!2831 = !DILocation(line: 91, column: 51, scope: !2786)
!2832 = !DILocation(line: 91, column: 54, scope: !2786)
!2833 = !DILocation(line: 91, column: 49, scope: !2786)
!2834 = !DILocation(line: 91, column: 45, scope: !2786)
!2835 = !DILocation(line: 91, column: 64, scope: !2786)
!2836 = !DILocation(line: 91, column: 67, scope: !2786)
!2837 = !DILocation(line: 91, column: 5, scope: !2786)
!2838 = !DILocation(line: 93, column: 9, scope: !2839)
!2839 = distinct !DILexicalBlock(scope: !2786, file: !2696, line: 93, column: 9)
!2840 = !DILocation(line: 93, column: 12, scope: !2839)
!2841 = !DILocation(line: 93, column: 19, scope: !2839)
!2842 = !DILocation(line: 93, column: 25, scope: !2839)
!2843 = !DILocation(line: 93, column: 9, scope: !2786)
!2844 = !DILocation(line: 94, column: 9, scope: !2839)
!2845 = !DILocation(line: 96, column: 20, scope: !2786)
!2846 = !DILocation(line: 96, column: 23, scope: !2786)
!2847 = !DILocation(line: 96, column: 34, scope: !2786)
!2848 = !DILocation(line: 96, column: 43, scope: !2786)
!2849 = !DILocation(line: 96, column: 46, scope: !2786)
!2850 = !DILocation(line: 96, column: 5, scope: !2786)
!2851 = !DILocation(line: 97, column: 20, scope: !2786)
!2852 = !DILocation(line: 97, column: 23, scope: !2786)
!2853 = !DILocation(line: 97, column: 34, scope: !2786)
!2854 = !DILocation(line: 97, column: 43, scope: !2786)
!2855 = !DILocation(line: 97, column: 46, scope: !2786)
!2856 = !DILocation(line: 97, column: 5, scope: !2786)
!2857 = !DILocation(line: 98, column: 1, scope: !2786)
!2858 = !DILocation(line: 98, column: 1, scope: !2859)
!2859 = !DILexicalBlockFile(scope: !2786, file: !2696, discriminator: 1)
!2860 = distinct !DISubprogram(name: "wmv2_add_block", scope: !2696, file: !2696, line: 57, type: !2861, isLocal: true, isDefinition: true, scopeLine: 59, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2699)
!2861 = !DISubroutineType(types: !2862)
!2862 = !{null, !926, !1848, !1127, !958, !958}
!2863 = !DILocalVariable(name: "w", arg: 1, scope: !2860, file: !2696, line: 57, type: !926)
!2864 = !DILocation(line: 57, column: 41, scope: !2860)
!2865 = !DILocalVariable(name: "block1", arg: 2, scope: !2860, file: !2696, line: 57, type: !1848)
!2866 = !DILocation(line: 57, column: 53, scope: !2860)
!2867 = !DILocalVariable(name: "dst", arg: 3, scope: !2860, file: !2696, line: 58, type: !1127)
!2868 = !DILocation(line: 58, column: 37, scope: !2860)
!2869 = !DILocalVariable(name: "stride", arg: 4, scope: !2860, file: !2696, line: 58, type: !958)
!2870 = !DILocation(line: 58, column: 46, scope: !2860)
!2871 = !DILocalVariable(name: "n", arg: 5, scope: !2860, file: !2696, line: 58, type: !958)
!2872 = !DILocation(line: 58, column: 58, scope: !2860)
!2873 = !DILocalVariable(name: "s", scope: !2860, file: !2696, line: 60, type: !2704)
!2874 = !DILocation(line: 60, column: 27, scope: !2860)
!2875 = !DILocation(line: 60, column: 32, scope: !2860)
!2876 = !DILocation(line: 60, column: 35, scope: !2860)
!2877 = !DILocation(line: 62, column: 29, scope: !2878)
!2878 = distinct !DILexicalBlock(scope: !2860, file: !2696, line: 62, column: 9)
!2879 = !DILocation(line: 62, column: 9, scope: !2878)
!2880 = !DILocation(line: 62, column: 12, scope: !2878)
!2881 = !DILocation(line: 62, column: 32, scope: !2878)
!2882 = !DILocation(line: 62, column: 9, scope: !2860)
!2883 = !DILocation(line: 63, column: 35, scope: !2884)
!2884 = distinct !DILexicalBlock(scope: !2878, file: !2696, line: 62, column: 38)
!2885 = !DILocation(line: 63, column: 17, scope: !2884)
!2886 = !DILocation(line: 63, column: 20, scope: !2884)
!2887 = !DILocation(line: 63, column: 9, scope: !2884)
!2888 = !DILocation(line: 65, column: 13, scope: !2889)
!2889 = distinct !DILexicalBlock(scope: !2884, file: !2696, line: 63, column: 39)
!2890 = !DILocation(line: 65, column: 16, scope: !2889)
!2891 = !DILocation(line: 65, column: 21, scope: !2889)
!2892 = !DILocation(line: 65, column: 30, scope: !2889)
!2893 = !DILocation(line: 65, column: 35, scope: !2889)
!2894 = !DILocation(line: 65, column: 43, scope: !2889)
!2895 = !DILocation(line: 66, column: 13, scope: !2889)
!2896 = !DILocation(line: 68, column: 34, scope: !2889)
!2897 = !DILocation(line: 68, column: 39, scope: !2889)
!2898 = !DILocation(line: 68, column: 47, scope: !2889)
!2899 = !DILocation(line: 68, column: 13, scope: !2889)
!2900 = !DILocation(line: 69, column: 34, scope: !2889)
!2901 = !DILocation(line: 69, column: 44, scope: !2889)
!2902 = !DILocation(line: 69, column: 42, scope: !2889)
!2903 = !DILocation(line: 69, column: 38, scope: !2889)
!2904 = !DILocation(line: 69, column: 52, scope: !2889)
!2905 = !DILocation(line: 69, column: 74, scope: !2889)
!2906 = !DILocation(line: 69, column: 60, scope: !2889)
!2907 = !DILocation(line: 69, column: 63, scope: !2889)
!2908 = !DILocation(line: 69, column: 13, scope: !2889)
!2909 = !DILocation(line: 70, column: 13, scope: !2889)
!2910 = !DILocation(line: 70, column: 16, scope: !2889)
!2911 = !DILocation(line: 70, column: 21, scope: !2889)
!2912 = !DILocation(line: 70, column: 47, scope: !2889)
!2913 = !DILocation(line: 70, column: 33, scope: !2889)
!2914 = !DILocation(line: 70, column: 36, scope: !2889)
!2915 = !DILocation(line: 71, column: 13, scope: !2889)
!2916 = !DILocation(line: 73, column: 34, scope: !2889)
!2917 = !DILocation(line: 73, column: 39, scope: !2889)
!2918 = !DILocation(line: 73, column: 47, scope: !2889)
!2919 = !DILocation(line: 73, column: 13, scope: !2889)
!2920 = !DILocation(line: 74, column: 34, scope: !2889)
!2921 = !DILocation(line: 74, column: 38, scope: !2889)
!2922 = !DILocation(line: 74, column: 43, scope: !2889)
!2923 = !DILocation(line: 74, column: 65, scope: !2889)
!2924 = !DILocation(line: 74, column: 51, scope: !2889)
!2925 = !DILocation(line: 74, column: 54, scope: !2889)
!2926 = !DILocation(line: 74, column: 13, scope: !2889)
!2927 = !DILocation(line: 75, column: 13, scope: !2889)
!2928 = !DILocation(line: 75, column: 16, scope: !2889)
!2929 = !DILocation(line: 75, column: 21, scope: !2889)
!2930 = !DILocation(line: 75, column: 47, scope: !2889)
!2931 = !DILocation(line: 75, column: 33, scope: !2889)
!2932 = !DILocation(line: 75, column: 36, scope: !2889)
!2933 = !DILocation(line: 76, column: 13, scope: !2889)
!2934 = !DILocation(line: 78, column: 20, scope: !2889)
!2935 = !DILocation(line: 78, column: 23, scope: !2889)
!2936 = !DILocation(line: 78, column: 13, scope: !2889)
!2937 = !DILocation(line: 79, column: 9, scope: !2889)
!2938 = !DILocation(line: 80, column: 5, scope: !2884)
!2939 = !DILocation(line: 81, column: 1, scope: !2860)
!2940 = distinct !DISubprogram(name: "ff_mspel_motion", scope: !2696, file: !2696, line: 100, type: !2941, isLocal: false, isDefinition: true, scopeLine: 104, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2699)
!2941 = !DISubroutineType(types: !2942)
!2942 = !{null, !2705, !1127, !1127, !1127, !1219, !2188, !958, !958, !958}
!2943 = !DILocalVariable(name: "a", arg: 1, scope: !2944, file: !2945, line: 127, type: !958)
!2944 = distinct !DISubprogram(name: "av_clip_c", scope: !2945, file: !2945, line: 127, type: !2946, isLocal: true, isDefinition: true, scopeLine: 128, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2699)
!2945 = !DIFile(filename: "./libavutil/common.h", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs")
!2946 = !DISubroutineType(types: !2947)
!2947 = !{!958, !958, !958, !958}
!2948 = !DILocation(line: 127, column: 87, scope: !2944, inlinedAt: !2949)
!2949 = distinct !DILocation(line: 161, column: 13, scope: !2940)
!2950 = !DILocalVariable(name: "amin", arg: 2, scope: !2944, file: !2945, line: 127, type: !958)
!2951 = !DILocation(line: 127, column: 94, scope: !2944, inlinedAt: !2949)
!2952 = !DILocalVariable(name: "amax", arg: 3, scope: !2944, file: !2945, line: 127, type: !958)
!2953 = !DILocation(line: 127, column: 104, scope: !2944, inlinedAt: !2949)
!2954 = !DILocation(line: 127, column: 87, scope: !2944, inlinedAt: !2955)
!2955 = distinct !DILocation(line: 158, column: 13, scope: !2940)
!2956 = !DILocation(line: 127, column: 94, scope: !2944, inlinedAt: !2955)
!2957 = !DILocation(line: 127, column: 104, scope: !2944, inlinedAt: !2955)
!2958 = !DILocation(line: 127, column: 87, scope: !2944, inlinedAt: !2959)
!2959 = distinct !DILocation(line: 119, column: 13, scope: !2940)
!2960 = !DILocation(line: 127, column: 94, scope: !2944, inlinedAt: !2959)
!2961 = !DILocation(line: 127, column: 104, scope: !2944, inlinedAt: !2959)
!2962 = !DILocation(line: 127, column: 87, scope: !2944, inlinedAt: !2963)
!2963 = distinct !DILocation(line: 118, column: 13, scope: !2940)
!2964 = !DILocation(line: 127, column: 94, scope: !2944, inlinedAt: !2963)
!2965 = !DILocation(line: 127, column: 104, scope: !2944, inlinedAt: !2963)
!2966 = !DILocalVariable(name: "s", arg: 1, scope: !2940, file: !2696, line: 100, type: !2705)
!2967 = !DILocation(line: 100, column: 38, scope: !2940)
!2968 = !DILocalVariable(name: "dest_y", arg: 2, scope: !2940, file: !2696, line: 100, type: !1127)
!2969 = !DILocation(line: 100, column: 50, scope: !2940)
!2970 = !DILocalVariable(name: "dest_cb", arg: 3, scope: !2940, file: !2696, line: 101, type: !1127)
!2971 = !DILocation(line: 101, column: 31, scope: !2940)
!2972 = !DILocalVariable(name: "dest_cr", arg: 4, scope: !2940, file: !2696, line: 101, type: !1127)
!2973 = !DILocation(line: 101, column: 49, scope: !2940)
!2974 = !DILocalVariable(name: "ref_picture", arg: 5, scope: !2940, file: !2696, line: 102, type: !1219)
!2975 = !DILocation(line: 102, column: 32, scope: !2940)
!2976 = !DILocalVariable(name: "pix_op", arg: 6, scope: !2940, file: !2696, line: 102, type: !2188)
!2977 = !DILocation(line: 102, column: 62, scope: !2940)
!2978 = !DILocalVariable(name: "motion_x", arg: 7, scope: !2940, file: !2696, line: 103, type: !958)
!2979 = !DILocation(line: 103, column: 26, scope: !2940)
!2980 = !DILocalVariable(name: "motion_y", arg: 8, scope: !2940, file: !2696, line: 103, type: !958)
!2981 = !DILocation(line: 103, column: 40, scope: !2940)
!2982 = !DILocalVariable(name: "h", arg: 9, scope: !2940, file: !2696, line: 103, type: !958)
!2983 = !DILocation(line: 103, column: 54, scope: !2940)
!2984 = !DILocalVariable(name: "w", scope: !2940, file: !2696, line: 105, type: !2800)
!2985 = !DILocation(line: 105, column: 24, scope: !2940)
!2986 = !DILocation(line: 105, column: 44, scope: !2940)
!2987 = !DILocation(line: 105, column: 28, scope: !2940)
!2988 = !DILocalVariable(name: "ptr", scope: !2940, file: !2696, line: 106, type: !1127)
!2989 = !DILocation(line: 106, column: 14, scope: !2940)
!2990 = !DILocalVariable(name: "dxy", scope: !2940, file: !2696, line: 107, type: !958)
!2991 = !DILocation(line: 107, column: 9, scope: !2940)
!2992 = !DILocalVariable(name: "mx", scope: !2940, file: !2696, line: 107, type: !958)
!2993 = !DILocation(line: 107, column: 14, scope: !2940)
!2994 = !DILocalVariable(name: "my", scope: !2940, file: !2696, line: 107, type: !958)
!2995 = !DILocation(line: 107, column: 18, scope: !2940)
!2996 = !DILocalVariable(name: "src_x", scope: !2940, file: !2696, line: 107, type: !958)
!2997 = !DILocation(line: 107, column: 22, scope: !2940)
!2998 = !DILocalVariable(name: "src_y", scope: !2940, file: !2696, line: 107, type: !958)
!2999 = !DILocation(line: 107, column: 29, scope: !2940)
!3000 = !DILocalVariable(name: "v_edge_pos", scope: !2940, file: !2696, line: 107, type: !958)
!3001 = !DILocation(line: 107, column: 36, scope: !2940)
!3002 = !DILocalVariable(name: "offset", scope: !2940, file: !2696, line: 108, type: !1755)
!3003 = !DILocation(line: 108, column: 15, scope: !2940)
!3004 = !DILocalVariable(name: "linesize", scope: !2940, file: !2696, line: 108, type: !1755)
!3005 = !DILocation(line: 108, column: 23, scope: !2940)
!3006 = !DILocalVariable(name: "uvlinesize", scope: !2940, file: !2696, line: 108, type: !1755)
!3007 = !DILocation(line: 108, column: 33, scope: !2940)
!3008 = !DILocalVariable(name: "emu", scope: !2940, file: !2696, line: 109, type: !958)
!3009 = !DILocation(line: 109, column: 9, scope: !2940)
!3010 = !DILocation(line: 111, column: 13, scope: !2940)
!3011 = !DILocation(line: 111, column: 22, scope: !2940)
!3012 = !DILocation(line: 111, column: 27, scope: !2940)
!3013 = !DILocation(line: 111, column: 36, scope: !2940)
!3014 = !DILocation(line: 111, column: 45, scope: !2940)
!3015 = !DILocation(line: 111, column: 33, scope: !2940)
!3016 = !DILocation(line: 111, column: 9, scope: !2940)
!3017 = !DILocation(line: 112, column: 15, scope: !2940)
!3018 = !DILocation(line: 112, column: 13, scope: !2940)
!3019 = !DILocation(line: 112, column: 21, scope: !2940)
!3020 = !DILocation(line: 112, column: 24, scope: !2940)
!3021 = !DILocation(line: 112, column: 19, scope: !2940)
!3022 = !DILocation(line: 112, column: 9, scope: !2940)
!3023 = !DILocation(line: 113, column: 13, scope: !2940)
!3024 = !DILocation(line: 113, column: 16, scope: !2940)
!3025 = !DILocation(line: 113, column: 21, scope: !2940)
!3026 = !DILocation(line: 113, column: 29, scope: !2940)
!3027 = !DILocation(line: 113, column: 38, scope: !2940)
!3028 = !DILocation(line: 113, column: 26, scope: !2940)
!3029 = !DILocation(line: 113, column: 11, scope: !2940)
!3030 = !DILocation(line: 114, column: 13, scope: !2940)
!3031 = !DILocation(line: 114, column: 16, scope: !2940)
!3032 = !DILocation(line: 114, column: 21, scope: !2940)
!3033 = !DILocation(line: 114, column: 29, scope: !2940)
!3034 = !DILocation(line: 114, column: 38, scope: !2940)
!3035 = !DILocation(line: 114, column: 26, scope: !2940)
!3036 = !DILocation(line: 114, column: 11, scope: !2940)
!3037 = !DILocation(line: 117, column: 18, scope: !2940)
!3038 = !DILocation(line: 117, column: 21, scope: !2940)
!3039 = !DILocation(line: 117, column: 16, scope: !2940)
!3040 = !DILocation(line: 118, column: 23, scope: !2940)
!3041 = !DILocation(line: 118, column: 35, scope: !2940)
!3042 = !DILocation(line: 118, column: 38, scope: !2940)
!3043 = !DILocation(line: 118, column: 13, scope: !2940)
!3044 = !DILocation(line: 132, column: 9, scope: !3045, inlinedAt: !2963)
!3045 = distinct !DILexicalBlock(scope: !2944, file: !2945, line: 132, column: 9)
!3046 = !DILocation(line: 132, column: 13, scope: !3045, inlinedAt: !2963)
!3047 = !DILocation(line: 132, column: 11, scope: !3045, inlinedAt: !2963)
!3048 = !DILocation(line: 132, column: 9, scope: !2944, inlinedAt: !2963)
!3049 = !DILocation(line: 132, column: 26, scope: !3050, inlinedAt: !2963)
!3050 = !DILexicalBlockFile(scope: !3045, file: !2945, discriminator: 1)
!3051 = !DILocation(line: 132, column: 19, scope: !3050, inlinedAt: !2963)
!3052 = !DILocation(line: 133, column: 14, scope: !3053, inlinedAt: !2963)
!3053 = distinct !DILexicalBlock(scope: !3045, file: !2945, line: 133, column: 14)
!3054 = !DILocation(line: 133, column: 18, scope: !3053, inlinedAt: !2963)
!3055 = !DILocation(line: 133, column: 16, scope: !3053, inlinedAt: !2963)
!3056 = !DILocation(line: 133, column: 14, scope: !3045, inlinedAt: !2963)
!3057 = !DILocation(line: 133, column: 31, scope: !3058, inlinedAt: !2963)
!3058 = !DILexicalBlockFile(scope: !3053, file: !2945, discriminator: 1)
!3059 = !DILocation(line: 133, column: 24, scope: !3058, inlinedAt: !2963)
!3060 = !DILocation(line: 134, column: 17, scope: !3053, inlinedAt: !2963)
!3061 = !DILocation(line: 134, column: 10, scope: !3053, inlinedAt: !2963)
!3062 = !DILocation(line: 135, column: 1, scope: !2944, inlinedAt: !2963)
!3063 = !DILocation(line: 118, column: 11, scope: !2940)
!3064 = !DILocation(line: 119, column: 23, scope: !2940)
!3065 = !DILocation(line: 119, column: 35, scope: !2940)
!3066 = !DILocation(line: 119, column: 38, scope: !2940)
!3067 = !DILocation(line: 119, column: 13, scope: !2940)
!3068 = !DILocation(line: 132, column: 9, scope: !3045, inlinedAt: !2959)
!3069 = !DILocation(line: 132, column: 13, scope: !3045, inlinedAt: !2959)
!3070 = !DILocation(line: 132, column: 11, scope: !3045, inlinedAt: !2959)
!3071 = !DILocation(line: 132, column: 9, scope: !2944, inlinedAt: !2959)
!3072 = !DILocation(line: 132, column: 26, scope: !3050, inlinedAt: !2959)
!3073 = !DILocation(line: 132, column: 19, scope: !3050, inlinedAt: !2959)
!3074 = !DILocation(line: 133, column: 14, scope: !3053, inlinedAt: !2959)
!3075 = !DILocation(line: 133, column: 18, scope: !3053, inlinedAt: !2959)
!3076 = !DILocation(line: 133, column: 16, scope: !3053, inlinedAt: !2959)
!3077 = !DILocation(line: 133, column: 14, scope: !3045, inlinedAt: !2959)
!3078 = !DILocation(line: 133, column: 31, scope: !3058, inlinedAt: !2959)
!3079 = !DILocation(line: 133, column: 24, scope: !3058, inlinedAt: !2959)
!3080 = !DILocation(line: 134, column: 17, scope: !3053, inlinedAt: !2959)
!3081 = !DILocation(line: 134, column: 10, scope: !3053, inlinedAt: !2959)
!3082 = !DILocation(line: 135, column: 1, scope: !2944, inlinedAt: !2959)
!3083 = !DILocation(line: 119, column: 11, scope: !2940)
!3084 = !DILocation(line: 121, column: 9, scope: !3085)
!3085 = distinct !DILexicalBlock(scope: !2940, file: !2696, line: 121, column: 9)
!3086 = !DILocation(line: 121, column: 15, scope: !3085)
!3087 = !DILocation(line: 121, column: 22, scope: !3085)
!3088 = !DILocation(line: 121, column: 25, scope: !3089)
!3089 = !DILexicalBlockFile(scope: !3085, file: !2696, discriminator: 1)
!3090 = !DILocation(line: 121, column: 34, scope: !3089)
!3091 = !DILocation(line: 121, column: 37, scope: !3089)
!3092 = !DILocation(line: 121, column: 31, scope: !3089)
!3093 = !DILocation(line: 121, column: 9, scope: !3089)
!3094 = !DILocation(line: 122, column: 13, scope: !3085)
!3095 = !DILocation(line: 122, column: 9, scope: !3085)
!3096 = !DILocation(line: 123, column: 9, scope: !3097)
!3097 = distinct !DILexicalBlock(scope: !2940, file: !2696, line: 123, column: 9)
!3098 = !DILocation(line: 123, column: 15, scope: !3097)
!3099 = !DILocation(line: 123, column: 22, scope: !3097)
!3100 = !DILocation(line: 123, column: 25, scope: !3101)
!3101 = !DILexicalBlockFile(scope: !3097, file: !2696, discriminator: 1)
!3102 = !DILocation(line: 123, column: 34, scope: !3101)
!3103 = !DILocation(line: 123, column: 37, scope: !3101)
!3104 = !DILocation(line: 123, column: 31, scope: !3101)
!3105 = !DILocation(line: 123, column: 9, scope: !3101)
!3106 = !DILocation(line: 124, column: 13, scope: !3097)
!3107 = !DILocation(line: 124, column: 9, scope: !3097)
!3108 = !DILocation(line: 126, column: 16, scope: !2940)
!3109 = !DILocation(line: 126, column: 19, scope: !2940)
!3110 = !DILocation(line: 126, column: 14, scope: !2940)
!3111 = !DILocation(line: 127, column: 18, scope: !2940)
!3112 = !DILocation(line: 127, column: 21, scope: !2940)
!3113 = !DILocation(line: 127, column: 16, scope: !2940)
!3114 = !DILocation(line: 128, column: 11, scope: !2940)
!3115 = !DILocation(line: 128, column: 29, scope: !2940)
!3116 = !DILocation(line: 128, column: 37, scope: !2940)
!3117 = !DILocation(line: 128, column: 35, scope: !2940)
!3118 = !DILocation(line: 128, column: 26, scope: !2940)
!3119 = !DILocation(line: 128, column: 49, scope: !2940)
!3120 = !DILocation(line: 128, column: 47, scope: !2940)
!3121 = !DILocation(line: 128, column: 9, scope: !2940)
!3122 = !DILocation(line: 130, column: 9, scope: !3123)
!3123 = distinct !DILexicalBlock(scope: !2940, file: !2696, line: 130, column: 9)
!3124 = !DILocation(line: 130, column: 15, scope: !3123)
!3125 = !DILocation(line: 130, column: 19, scope: !3123)
!3126 = !DILocation(line: 130, column: 22, scope: !3127)
!3127 = !DILexicalBlockFile(scope: !3123, file: !2696, discriminator: 1)
!3128 = !DILocation(line: 130, column: 28, scope: !3127)
!3129 = !DILocation(line: 130, column: 32, scope: !3127)
!3130 = !DILocation(line: 130, column: 35, scope: !3131)
!3131 = !DILexicalBlockFile(scope: !3123, file: !2696, discriminator: 2)
!3132 = !DILocation(line: 130, column: 41, scope: !3131)
!3133 = !DILocation(line: 130, column: 49, scope: !3131)
!3134 = !DILocation(line: 130, column: 52, scope: !3131)
!3135 = !DILocation(line: 130, column: 46, scope: !3131)
!3136 = !DILocation(line: 130, column: 63, scope: !3131)
!3137 = !DILocation(line: 131, column: 9, scope: !3123)
!3138 = !DILocation(line: 131, column: 17, scope: !3123)
!3139 = !DILocation(line: 131, column: 15, scope: !3123)
!3140 = !DILocation(line: 131, column: 19, scope: !3123)
!3141 = !DILocation(line: 131, column: 26, scope: !3123)
!3142 = !DILocation(line: 131, column: 23, scope: !3123)
!3143 = !DILocation(line: 130, column: 9, scope: !3144)
!3144 = !DILexicalBlockFile(scope: !2940, file: !2696, discriminator: 3)
!3145 = !DILocation(line: 132, column: 9, scope: !3146)
!3146 = distinct !DILexicalBlock(scope: !3123, file: !2696, line: 131, column: 38)
!3147 = !DILocation(line: 132, column: 12, scope: !3146)
!3148 = !DILocation(line: 132, column: 17, scope: !3146)
!3149 = !DILocation(line: 132, column: 34, scope: !3146)
!3150 = !DILocation(line: 132, column: 37, scope: !3146)
!3151 = !DILocation(line: 132, column: 40, scope: !3146)
!3152 = !DILocation(line: 132, column: 57, scope: !3146)
!3153 = !DILocation(line: 132, column: 61, scope: !3146)
!3154 = !DILocation(line: 132, column: 67, scope: !3146)
!3155 = !DILocation(line: 132, column: 70, scope: !3146)
!3156 = !DILocation(line: 132, column: 65, scope: !3146)
!3157 = !DILocation(line: 133, column: 34, scope: !3146)
!3158 = !DILocation(line: 133, column: 37, scope: !3146)
!3159 = !DILocation(line: 133, column: 47, scope: !3146)
!3160 = !DILocation(line: 133, column: 50, scope: !3146)
!3161 = !DILocation(line: 134, column: 34, scope: !3146)
!3162 = !DILocation(line: 134, column: 40, scope: !3146)
!3163 = !DILocation(line: 134, column: 45, scope: !3146)
!3164 = !DILocation(line: 134, column: 51, scope: !3146)
!3165 = !DILocation(line: 135, column: 34, scope: !3146)
!3166 = !DILocation(line: 135, column: 37, scope: !3146)
!3167 = !DILocation(line: 135, column: 49, scope: !3146)
!3168 = !DILocation(line: 135, column: 52, scope: !3146)
!3169 = !DILocation(line: 136, column: 15, scope: !3146)
!3170 = !DILocation(line: 136, column: 18, scope: !3146)
!3171 = !DILocation(line: 136, column: 21, scope: !3146)
!3172 = !DILocation(line: 136, column: 37, scope: !3146)
!3173 = !DILocation(line: 136, column: 43, scope: !3146)
!3174 = !DILocation(line: 136, column: 46, scope: !3146)
!3175 = !DILocation(line: 136, column: 41, scope: !3146)
!3176 = !DILocation(line: 136, column: 13, scope: !3146)
!3177 = !DILocation(line: 137, column: 13, scope: !3146)
!3178 = !DILocation(line: 138, column: 5, scope: !3146)
!3179 = !DILocation(line: 140, column: 34, scope: !2940)
!3180 = !DILocation(line: 140, column: 5, scope: !2940)
!3181 = !DILocation(line: 140, column: 8, scope: !2940)
!3182 = !DILocation(line: 140, column: 13, scope: !2940)
!3183 = !DILocation(line: 140, column: 39, scope: !2940)
!3184 = !DILocation(line: 140, column: 47, scope: !2940)
!3185 = !DILocation(line: 140, column: 52, scope: !2940)
!3186 = !DILocation(line: 141, column: 34, scope: !2940)
!3187 = !DILocation(line: 141, column: 5, scope: !2940)
!3188 = !DILocation(line: 141, column: 8, scope: !2940)
!3189 = !DILocation(line: 141, column: 13, scope: !2940)
!3190 = !DILocation(line: 141, column: 39, scope: !2940)
!3191 = !DILocation(line: 141, column: 46, scope: !2940)
!3192 = !DILocation(line: 141, column: 51, scope: !2940)
!3193 = !DILocation(line: 141, column: 55, scope: !2940)
!3194 = !DILocation(line: 141, column: 60, scope: !2940)
!3195 = !DILocation(line: 142, column: 34, scope: !2940)
!3196 = !DILocation(line: 142, column: 5, scope: !2940)
!3197 = !DILocation(line: 142, column: 8, scope: !2940)
!3198 = !DILocation(line: 142, column: 13, scope: !2940)
!3199 = !DILocation(line: 142, column: 39, scope: !2940)
!3200 = !DILocation(line: 142, column: 52, scope: !2940)
!3201 = !DILocation(line: 142, column: 50, scope: !2940)
!3202 = !DILocation(line: 142, column: 46, scope: !2940)
!3203 = !DILocation(line: 142, column: 62, scope: !2940)
!3204 = !DILocation(line: 142, column: 72, scope: !2940)
!3205 = !DILocation(line: 142, column: 70, scope: !2940)
!3206 = !DILocation(line: 142, column: 66, scope: !2940)
!3207 = !DILocation(line: 142, column: 82, scope: !2940)
!3208 = !DILocation(line: 143, column: 34, scope: !2940)
!3209 = !DILocation(line: 143, column: 5, scope: !2940)
!3210 = !DILocation(line: 143, column: 8, scope: !2940)
!3211 = !DILocation(line: 143, column: 13, scope: !2940)
!3212 = !DILocation(line: 143, column: 39, scope: !2940)
!3213 = !DILocation(line: 143, column: 46, scope: !2940)
!3214 = !DILocation(line: 143, column: 56, scope: !2940)
!3215 = !DILocation(line: 143, column: 54, scope: !2940)
!3216 = !DILocation(line: 143, column: 50, scope: !2940)
!3217 = !DILocation(line: 143, column: 66, scope: !2940)
!3218 = !DILocation(line: 143, column: 70, scope: !2940)
!3219 = !DILocation(line: 143, column: 80, scope: !2940)
!3220 = !DILocation(line: 143, column: 78, scope: !2940)
!3221 = !DILocation(line: 143, column: 74, scope: !2940)
!3222 = !DILocation(line: 143, column: 90, scope: !2940)
!3223 = !DILocation(line: 145, column: 9, scope: !3224)
!3224 = distinct !DILexicalBlock(scope: !2940, file: !2696, line: 145, column: 9)
!3225 = !DILocation(line: 145, column: 12, scope: !3224)
!3226 = !DILocation(line: 145, column: 19, scope: !3224)
!3227 = !DILocation(line: 145, column: 25, scope: !3224)
!3228 = !DILocation(line: 145, column: 9, scope: !2940)
!3229 = !DILocation(line: 146, column: 9, scope: !3224)
!3230 = !DILocation(line: 148, column: 9, scope: !2940)
!3231 = !DILocation(line: 149, column: 10, scope: !3232)
!3232 = distinct !DILexicalBlock(scope: !2940, file: !2696, line: 149, column: 9)
!3233 = !DILocation(line: 149, column: 19, scope: !3232)
!3234 = !DILocation(line: 149, column: 24, scope: !3232)
!3235 = !DILocation(line: 149, column: 9, scope: !2940)
!3236 = !DILocation(line: 150, column: 13, scope: !3232)
!3237 = !DILocation(line: 150, column: 9, scope: !3232)
!3238 = !DILocation(line: 151, column: 10, scope: !3239)
!3239 = distinct !DILexicalBlock(scope: !2940, file: !2696, line: 151, column: 9)
!3240 = !DILocation(line: 151, column: 19, scope: !3239)
!3241 = !DILocation(line: 151, column: 24, scope: !3239)
!3242 = !DILocation(line: 151, column: 9, scope: !2940)
!3243 = !DILocation(line: 152, column: 13, scope: !3239)
!3244 = !DILocation(line: 152, column: 9, scope: !3239)
!3245 = !DILocation(line: 153, column: 10, scope: !2940)
!3246 = !DILocation(line: 153, column: 19, scope: !2940)
!3247 = !DILocation(line: 153, column: 8, scope: !2940)
!3248 = !DILocation(line: 154, column: 10, scope: !2940)
!3249 = !DILocation(line: 154, column: 19, scope: !2940)
!3250 = !DILocation(line: 154, column: 8, scope: !2940)
!3251 = !DILocation(line: 156, column: 13, scope: !2940)
!3252 = !DILocation(line: 156, column: 16, scope: !2940)
!3253 = !DILocation(line: 156, column: 21, scope: !2940)
!3254 = !DILocation(line: 156, column: 27, scope: !2940)
!3255 = !DILocation(line: 156, column: 25, scope: !2940)
!3256 = !DILocation(line: 156, column: 11, scope: !2940)
!3257 = !DILocation(line: 157, column: 13, scope: !2940)
!3258 = !DILocation(line: 157, column: 16, scope: !2940)
!3259 = !DILocation(line: 157, column: 21, scope: !2940)
!3260 = !DILocation(line: 157, column: 27, scope: !2940)
!3261 = !DILocation(line: 157, column: 25, scope: !2940)
!3262 = !DILocation(line: 157, column: 11, scope: !2940)
!3263 = !DILocation(line: 158, column: 23, scope: !2940)
!3264 = !DILocation(line: 158, column: 34, scope: !2940)
!3265 = !DILocation(line: 158, column: 37, scope: !2940)
!3266 = !DILocation(line: 158, column: 43, scope: !2940)
!3267 = !DILocation(line: 158, column: 13, scope: !2940)
!3268 = !DILocation(line: 132, column: 9, scope: !3045, inlinedAt: !2955)
!3269 = !DILocation(line: 132, column: 13, scope: !3045, inlinedAt: !2955)
!3270 = !DILocation(line: 132, column: 11, scope: !3045, inlinedAt: !2955)
!3271 = !DILocation(line: 132, column: 9, scope: !2944, inlinedAt: !2955)
!3272 = !DILocation(line: 132, column: 26, scope: !3050, inlinedAt: !2955)
!3273 = !DILocation(line: 132, column: 19, scope: !3050, inlinedAt: !2955)
!3274 = !DILocation(line: 133, column: 14, scope: !3053, inlinedAt: !2955)
!3275 = !DILocation(line: 133, column: 18, scope: !3053, inlinedAt: !2955)
!3276 = !DILocation(line: 133, column: 16, scope: !3053, inlinedAt: !2955)
!3277 = !DILocation(line: 133, column: 14, scope: !3045, inlinedAt: !2955)
!3278 = !DILocation(line: 133, column: 31, scope: !3058, inlinedAt: !2955)
!3279 = !DILocation(line: 133, column: 24, scope: !3058, inlinedAt: !2955)
!3280 = !DILocation(line: 134, column: 17, scope: !3053, inlinedAt: !2955)
!3281 = !DILocation(line: 134, column: 10, scope: !3053, inlinedAt: !2955)
!3282 = !DILocation(line: 135, column: 1, scope: !2944, inlinedAt: !2955)
!3283 = !DILocation(line: 158, column: 11, scope: !2940)
!3284 = !DILocation(line: 159, column: 9, scope: !3285)
!3285 = distinct !DILexicalBlock(scope: !2940, file: !2696, line: 159, column: 9)
!3286 = !DILocation(line: 159, column: 19, scope: !3285)
!3287 = !DILocation(line: 159, column: 22, scope: !3285)
!3288 = !DILocation(line: 159, column: 28, scope: !3285)
!3289 = !DILocation(line: 159, column: 15, scope: !3285)
!3290 = !DILocation(line: 159, column: 9, scope: !2940)
!3291 = !DILocation(line: 160, column: 13, scope: !3285)
!3292 = !DILocation(line: 160, column: 9, scope: !3285)
!3293 = !DILocation(line: 161, column: 23, scope: !2940)
!3294 = !DILocation(line: 161, column: 34, scope: !2940)
!3295 = !DILocation(line: 161, column: 37, scope: !2940)
!3296 = !DILocation(line: 161, column: 44, scope: !2940)
!3297 = !DILocation(line: 161, column: 13, scope: !2940)
!3298 = !DILocation(line: 132, column: 9, scope: !3045, inlinedAt: !2949)
!3299 = !DILocation(line: 132, column: 13, scope: !3045, inlinedAt: !2949)
!3300 = !DILocation(line: 132, column: 11, scope: !3045, inlinedAt: !2949)
!3301 = !DILocation(line: 132, column: 9, scope: !2944, inlinedAt: !2949)
!3302 = !DILocation(line: 132, column: 26, scope: !3050, inlinedAt: !2949)
!3303 = !DILocation(line: 132, column: 19, scope: !3050, inlinedAt: !2949)
!3304 = !DILocation(line: 133, column: 14, scope: !3053, inlinedAt: !2949)
!3305 = !DILocation(line: 133, column: 18, scope: !3053, inlinedAt: !2949)
!3306 = !DILocation(line: 133, column: 16, scope: !3053, inlinedAt: !2949)
!3307 = !DILocation(line: 133, column: 14, scope: !3045, inlinedAt: !2949)
!3308 = !DILocation(line: 133, column: 31, scope: !3058, inlinedAt: !2949)
!3309 = !DILocation(line: 133, column: 24, scope: !3058, inlinedAt: !2949)
!3310 = !DILocation(line: 134, column: 17, scope: !3053, inlinedAt: !2949)
!3311 = !DILocation(line: 134, column: 10, scope: !3053, inlinedAt: !2949)
!3312 = !DILocation(line: 135, column: 1, scope: !2944, inlinedAt: !2949)
!3313 = !DILocation(line: 161, column: 11, scope: !2940)
!3314 = !DILocation(line: 162, column: 9, scope: !3315)
!3315 = distinct !DILexicalBlock(scope: !2940, file: !2696, line: 162, column: 9)
!3316 = !DILocation(line: 162, column: 19, scope: !3315)
!3317 = !DILocation(line: 162, column: 22, scope: !3315)
!3318 = !DILocation(line: 162, column: 29, scope: !3315)
!3319 = !DILocation(line: 162, column: 15, scope: !3315)
!3320 = !DILocation(line: 162, column: 9, scope: !2940)
!3321 = !DILocation(line: 163, column: 13, scope: !3315)
!3322 = !DILocation(line: 163, column: 9, scope: !3315)
!3323 = !DILocation(line: 164, column: 15, scope: !2940)
!3324 = !DILocation(line: 164, column: 23, scope: !2940)
!3325 = !DILocation(line: 164, column: 21, scope: !2940)
!3326 = !DILocation(line: 164, column: 37, scope: !2940)
!3327 = !DILocation(line: 164, column: 35, scope: !2940)
!3328 = !DILocation(line: 164, column: 12, scope: !2940)
!3329 = !DILocation(line: 165, column: 11, scope: !2940)
!3330 = !DILocation(line: 165, column: 28, scope: !2940)
!3331 = !DILocation(line: 165, column: 26, scope: !2940)
!3332 = !DILocation(line: 165, column: 9, scope: !2940)
!3333 = !DILocation(line: 166, column: 9, scope: !3334)
!3334 = distinct !DILexicalBlock(scope: !2940, file: !2696, line: 166, column: 9)
!3335 = !DILocation(line: 166, column: 9, scope: !2940)
!3336 = !DILocation(line: 167, column: 9, scope: !3337)
!3337 = distinct !DILexicalBlock(scope: !3334, file: !2696, line: 166, column: 14)
!3338 = !DILocation(line: 167, column: 12, scope: !3337)
!3339 = !DILocation(line: 167, column: 17, scope: !3337)
!3340 = !DILocation(line: 167, column: 34, scope: !3337)
!3341 = !DILocation(line: 167, column: 37, scope: !3337)
!3342 = !DILocation(line: 167, column: 40, scope: !3337)
!3343 = !DILocation(line: 167, column: 57, scope: !3337)
!3344 = !DILocation(line: 168, column: 34, scope: !3337)
!3345 = !DILocation(line: 168, column: 37, scope: !3337)
!3346 = !DILocation(line: 168, column: 49, scope: !3337)
!3347 = !DILocation(line: 168, column: 52, scope: !3337)
!3348 = !DILocation(line: 170, column: 34, scope: !3337)
!3349 = !DILocation(line: 170, column: 41, scope: !3337)
!3350 = !DILocation(line: 171, column: 34, scope: !3337)
!3351 = !DILocation(line: 171, column: 37, scope: !3337)
!3352 = !DILocation(line: 171, column: 48, scope: !3337)
!3353 = !DILocation(line: 171, column: 54, scope: !3337)
!3354 = !DILocation(line: 171, column: 57, scope: !3337)
!3355 = !DILocation(line: 171, column: 68, scope: !3337)
!3356 = !DILocation(line: 172, column: 15, scope: !3337)
!3357 = !DILocation(line: 172, column: 18, scope: !3337)
!3358 = !DILocation(line: 172, column: 21, scope: !3337)
!3359 = !DILocation(line: 172, column: 13, scope: !3337)
!3360 = !DILocation(line: 173, column: 5, scope: !3337)
!3361 = !DILocation(line: 174, column: 15, scope: !2940)
!3362 = !DILocation(line: 174, column: 5, scope: !2940)
!3363 = !DILocation(line: 174, column: 20, scope: !2940)
!3364 = !DILocation(line: 174, column: 29, scope: !2940)
!3365 = !DILocation(line: 174, column: 34, scope: !2940)
!3366 = !DILocation(line: 174, column: 46, scope: !2940)
!3367 = !DILocation(line: 174, column: 48, scope: !2940)
!3368 = !DILocation(line: 176, column: 11, scope: !2940)
!3369 = !DILocation(line: 176, column: 28, scope: !2940)
!3370 = !DILocation(line: 176, column: 26, scope: !2940)
!3371 = !DILocation(line: 176, column: 9, scope: !2940)
!3372 = !DILocation(line: 177, column: 9, scope: !3373)
!3373 = distinct !DILexicalBlock(scope: !2940, file: !2696, line: 177, column: 9)
!3374 = !DILocation(line: 177, column: 9, scope: !2940)
!3375 = !DILocation(line: 178, column: 9, scope: !3376)
!3376 = distinct !DILexicalBlock(scope: !3373, file: !2696, line: 177, column: 14)
!3377 = !DILocation(line: 178, column: 12, scope: !3376)
!3378 = !DILocation(line: 178, column: 17, scope: !3376)
!3379 = !DILocation(line: 178, column: 34, scope: !3376)
!3380 = !DILocation(line: 178, column: 37, scope: !3376)
!3381 = !DILocation(line: 178, column: 40, scope: !3376)
!3382 = !DILocation(line: 178, column: 57, scope: !3376)
!3383 = !DILocation(line: 179, column: 34, scope: !3376)
!3384 = !DILocation(line: 179, column: 37, scope: !3376)
!3385 = !DILocation(line: 179, column: 49, scope: !3376)
!3386 = !DILocation(line: 179, column: 52, scope: !3376)
!3387 = !DILocation(line: 181, column: 34, scope: !3376)
!3388 = !DILocation(line: 181, column: 41, scope: !3376)
!3389 = !DILocation(line: 182, column: 34, scope: !3376)
!3390 = !DILocation(line: 182, column: 37, scope: !3376)
!3391 = !DILocation(line: 182, column: 48, scope: !3376)
!3392 = !DILocation(line: 182, column: 54, scope: !3376)
!3393 = !DILocation(line: 182, column: 57, scope: !3376)
!3394 = !DILocation(line: 182, column: 68, scope: !3376)
!3395 = !DILocation(line: 183, column: 15, scope: !3376)
!3396 = !DILocation(line: 183, column: 18, scope: !3376)
!3397 = !DILocation(line: 183, column: 21, scope: !3376)
!3398 = !DILocation(line: 183, column: 13, scope: !3376)
!3399 = !DILocation(line: 184, column: 5, scope: !3376)
!3400 = !DILocation(line: 185, column: 15, scope: !2940)
!3401 = !DILocation(line: 185, column: 5, scope: !2940)
!3402 = !DILocation(line: 185, column: 20, scope: !2940)
!3403 = !DILocation(line: 185, column: 29, scope: !2940)
!3404 = !DILocation(line: 185, column: 34, scope: !2940)
!3405 = !DILocation(line: 185, column: 46, scope: !2940)
!3406 = !DILocation(line: 185, column: 48, scope: !2940)
!3407 = !DILocation(line: 186, column: 1, scope: !2940)
!3408 = !DILocation(line: 186, column: 1, scope: !3409)
!3409 = !DILexicalBlockFile(scope: !2940, file: !2696, discriminator: 1)
