...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[inter]libavcodec--sbcdsp_data.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs")
!2 = !{}
!3 = !{!4, !13, !14, !18}
!4 = distinct !DIGlobalVariable(name: "ff_sbcdsp_analysis_consts_fixed4_simd_even", scope: !0, file: !5, line: 47, type: !6, isLocal: false, isDefinition: true, variable: [56 x i16]* @ff_sbcdsp_analysis_consts_fixed4_simd_even)
!5 = !DIFile(filename: "libavcodec/sbcdsp_data.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs")
!6 = !DICompositeType(tag: DW_TAG_array_type, baseType: !7, size: 896, align: 16, elements: !11)
...
!13 = distinct !DIGlobalVariable(name: "ff_sbcdsp_analysis_consts_fixed4_simd_odd", scope: !0, file: !5, line: 92, type: !6, isLocal: false, isDefinition: true, variable: [56 x i16]* @ff_sbcdsp_analysis_consts_fixed4_simd_odd)
!14 = distinct !DIGlobalVariable(name: "ff_sbcdsp_analysis_consts_fixed8_simd_even", scope: !0, file: !5, line: 137, type: !15, isLocal: false, isDefinition: true, variable: [144 x i16]* @ff_sbcdsp_analysis_consts_fixed8_simd_even)
!15 = !DICompositeType(tag: DW_TAG_array_type, baseType: !7, size: 2304, align: 16, elements: !16)
!16 = !{!17}
!17 = !DISubrange(count: 144)
!18 = distinct !DIGlobalVariable(name: "ff_sbcdsp_analysis_consts_fixed8_simd_odd", scope: !0, file: !5, line: 234, type: !15, isLocal: false, isDefinition: true, variable: [144 x i16]* @ff_sbcdsp_analysis_consts_fixed8_simd_odd)
