; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[inter]libavformat--avr.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[inter]libavformat--avr.o.i"
...
@ff_avr_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.1, i32 0, i32 0), i32 256, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 0, i32 (%struct.AVProbeData*)* @avr_probe, i32 (%struct.AVFormatContext*)* @avr_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @ff_pcm_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* @ff_pcm_read_seek, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
...
define internal i32 @avr_probe(%struct.AVProbeData* %p) #0 !dbg !2151 {
entry:
  %x.addr.i27 = alloca i16, align 2
  call void @llvm.dbg.declare(metadata i16* %x.addr.i27, metadata !2153, metadata !2158), !dbg !2159
  %x.addr.i20 = alloca i16, align 2
  call void @llvm.dbg.declare(metadata i16* %x.addr.i20, metadata !2153, metadata !2158), !dbg !2163
  %x.addr.i = alloca i16, align 2
  call void @llvm.dbg.declare(metadata i16* %x.addr.i, metadata !2153, metadata !2158), !dbg !2166
  ...
  %buf = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %0, i32 0, i32 1, !dbg !2172
  %1 = load i8*, i8** %buf, align 8, !dbg !2172
  %2 = bitcast i8* %1 to %union.unaligned_32*, !dbg !2173
  %l = bitcast %union.unaligned_32* %2 to i32*, !dbg !2173
  %3 = load i32, i32* %l, align 1, !dbg !2173
  %cmp = icmp ne i32 %3, 1414087218, !dbg !2174
...
if.end:                                           ; preds = %entry
  %4 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2177
  ...
  %add.ptr = getelementptr inbounds i8, i8* %5, i64 12, !dbg !2179
  %6 = bitcast i8* %add.ptr to %union.unaligned_16*, !dbg !2180
  %l2 = bitcast %union.unaligned_16* %6 to i16*, !dbg !2180
  %7 = load i16, i16* %l2, align 1, !dbg !2180
  store i16 %7, i16* %x.addr.i, align 2, !dbg !2181
  %8 = load i16, i16* %x.addr.i, align 2, !dbg !2182
  %conv.i = zext i16 %8 to i32, !dbg !2182
  %shr.i = ashr i32 %conv.i, 8, !dbg !2183
  %9 = load i16, i16* %x.addr.i, align 2, !dbg !2184
  %conv1.i = zext i16 %9 to i32, !dbg !2184
  %shl.i = shl i32 %conv1.i, 8, !dbg !2185
  %or.i = or i32 %shr.i, %shl.i, !dbg !2186
  %conv2.i = trunc i32 %or.i to i16, !dbg !2187
  store i16 %conv2.i, i16* %x.addr.i, align 2, !dbg !2188
  %10 = load i16, i16* %x.addr.i, align 2, !dbg !2189
  %tobool = icmp ne i16 %10, 0, !dbg !2181
  br i1 %tobool, label %lor.lhs.false, label %if.then9, !dbg !2190

lor.lhs.false:                                    ; preds = %if.end
  %11 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2191
  %buf3 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %11, i32 0, i32 1, !dbg !2192
  %12 = load i8*, i8** %buf3, align 8, !dbg !2192
  %add.ptr4 = getelementptr inbounds i8, i8* %12, i64 12, !dbg !2193
  %13 = bitcast i8* %add.ptr4 to %union.unaligned_16*, !dbg !2194
  %l5 = bitcast %union.unaligned_16* %13 to i16*, !dbg !2194
  %14 = load i16, i16* %l5, align 1, !dbg !2194
  store i16 %14, i16* %x.addr.i27, align 2, !dbg !2195
  %15 = load i16, i16* %x.addr.i27, align 2, !dbg !2196
  %conv.i28 = zext i16 %15 to i32, !dbg !2196
  %shr.i29 = ashr i32 %conv.i28, 8, !dbg !2197
  %16 = load i16, i16* %x.addr.i27, align 2, !dbg !2198
  %conv1.i30 = zext i16 %16 to i32, !dbg !2198
  %shl.i31 = shl i32 %conv1.i30, 8, !dbg !2199
  %or.i32 = or i32 %shr.i29, %shl.i31, !dbg !2200
  %conv2.i33 = trunc i32 %or.i32 to i16, !dbg !2201
  store i16 %conv2.i33, i16* %x.addr.i27, align 2, !dbg !2202
  %17 = load i16, i16* %x.addr.i27, align 2, !dbg !2203
  %conv = zext i16 %17 to i32, !dbg !2195
  %cmp7 = icmp sgt i32 %conv, 256, !dbg !2204
  br i1 %cmp7, label %if.then9, label %if.end10, !dbg !2205

if.then9:                                         ; preds = %lor.lhs.false, %if.end
  store i32 25, i32* %retval, align 4, !dbg !2206
...
if.end10:                                         ; preds = %lor.lhs.false
  ...
  %add.ptr12 = getelementptr inbounds i8, i8* %19, i64 14, !dbg !2209
  %20 = bitcast i8* %add.ptr12 to %union.unaligned_16*, !dbg !2210
  %l13 = bitcast %union.unaligned_16* %20 to i16*, !dbg !2210
  %21 = load i16, i16* %l13, align 1, !dbg !2210
  store i16 %21, i16* %x.addr.i20, align 2, !dbg !2211
  %22 = load i16, i16* %x.addr.i20, align 2, !dbg !2212
  %conv.i21 = zext i16 %22 to i32, !dbg !2212
  %shr.i22 = ashr i32 %conv.i21, 8, !dbg !2213
  %23 = load i16, i16* %x.addr.i20, align 2, !dbg !2214
  %conv1.i23 = zext i16 %23 to i32, !dbg !2214
  %shl.i24 = shl i32 %conv1.i23, 8, !dbg !2215
  %or.i25 = or i32 %shr.i22, %shl.i24, !dbg !2216
  %conv2.i26 = trunc i32 %or.i25 to i16, !dbg !2217
  store i16 %conv2.i26, i16* %x.addr.i20, align 2, !dbg !2218
  %24 = load i16, i16* %x.addr.i20, align 2, !dbg !2219
  %conv15 = zext i16 %24 to i32, !dbg !2211
  %cmp16 = icmp sgt i32 %conv15, 256, !dbg !2220
  br i1 %cmp16, label %if.then18, label %if.end19, !dbg !2221
...
if.end19:                                         ; preds = %if.end10
  store i32 50, i32* %retval, align 4, !dbg !2223
  br label %return, !dbg !2223

return:                                           ; preds = %if.end19, %if.then18, %if.then9, %if.then
  %25 = load i32, i32* %retval, align 4, !dbg !2224
  ret i32 %25, !dbg !2224
}

; Function Attrs: nounwind uwtable
define internal i32 @avr_read_header(%struct.AVFormatContext* %s) #0 !dbg !2225 {
entry:
  %retval = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2230, metadata !2158), !dbg !2231
  call void @llvm.dbg.declare(metadata i16* %chan, metadata !2232, metadata !2158), !dbg !2233
  call void @llvm.dbg.declare(metadata i16* %sign, metadata !2234, metadata !2158), !dbg !2235
  call void @llvm.dbg.declare(metadata i16* %bps, metadata !2236, metadata !2158), !dbg !2237
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2238, metadata !2158), !dbg !2239
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2240
  %call = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %0, %struct.AVCodec* null), !dbg !2241
  store %struct.AVStream* %call, %struct.AVStream** %st, align 8, !dbg !2242
  %1 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2243
  %tobool = icmp ne %struct.AVStream* %1, null, !dbg !2243
...
if.end:                                           ; preds = %entry
  %2 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2247
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %2, i32 0, i32 19, !dbg !2248
  %3 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2248
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %3, i32 0, i32 0, !dbg !2249
  store i32 1, i32* %codec_type, align 8, !dbg !2250
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2251
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %4, i32 0, i32 4, !dbg !2252
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2252
  %call1 = call i64 @avio_skip(%struct.AVIOContext* %5, i64 4), !dbg !2253
  %6 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2254
  %pb2 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %6, i32 0, i32 4, !dbg !2255
  %7 = load %struct.AVIOContext*, %struct.AVIOContext** %pb2, align 8, !dbg !2255
  %call3 = call i64 @avio_skip(%struct.AVIOContext* %7, i64 8), !dbg !2256
  %8 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2257
  %pb4 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %8, i32 0, i32 4, !dbg !2258
  %9 = load %struct.AVIOContext*, %struct.AVIOContext** %pb4, align 8, !dbg !2258
  %call5 = call i32 @avio_rb16(%struct.AVIOContext* %9), !dbg !2259
  %conv = trunc i32 %call5 to i16, !dbg !2259
  store i16 %conv, i16* %chan, align 2, !dbg !2260
  %10 = load i16, i16* %chan, align 2, !dbg !2261
  %tobool6 = icmp ne i16 %10, 0, !dbg !2261
  br i1 %tobool6, label %if.else, label %if.then7, !dbg !2263

if.then7:                                         ; preds = %if.end
  %11 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2264
  %codecpar8 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %11, i32 0, i32 19, !dbg !2266
  %12 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar8, align 8, !dbg !2266
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %12, i32 0, i32 22, !dbg !2267
  store i32 1, i32* %channels, align 8, !dbg !2268
  br label %if.end17, !dbg !2269

if.else:                                          ; preds = %if.end
  %13 = load i16, i16* %chan, align 2, !dbg !2270
  %conv9 = zext i16 %13 to i32, !dbg !2270
  %cmp = icmp eq i32 %conv9, 65535, !dbg !2273
  br i1 %cmp, label %if.then11, label %if.else14, !dbg !2270

if.then11:                                        ; preds = %if.else
  %14 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2274
  %codecpar12 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %14, i32 0, i32 19, !dbg !2276
  %15 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar12, align 8, !dbg !2276
  %channels13 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %15, i32 0, i32 22, !dbg !2277
  store i32 2, i32* %channels13, align 8, !dbg !2278
  br label %if.end16, !dbg !2279

if.else14:                                        ; preds = %if.else
  %16 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2280
  %17 = bitcast %struct.AVFormatContext* %16 to i8*, !dbg !2280
  %18 = load i16, i16* %chan, align 2, !dbg !2282
  %conv15 = zext i16 %18 to i32, !dbg !2282
  call void (i8*, i8*, ...) @avpriv_request_sample(i8* %17, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i32 0, i32 0), i32 %conv15), !dbg !2283
  store i32 -1163346256, i32* %retval, align 4, !dbg !2284
...
if.end17:                                         ; preds = %if.end16, %if.then7
  %19 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2285
  %pb18 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %19, i32 0, i32 4, !dbg !2286
  %20 = load %struct.AVIOContext*, %struct.AVIOContext** %pb18, align 8, !dbg !2286
  %call19 = call i32 @avio_rb16(%struct.AVIOContext* %20), !dbg !2287
  %conv20 = trunc i32 %call19 to i16, !dbg !2287
  store i16 %conv20, i16* %bps, align 2, !dbg !2288
  %conv21 = zext i16 %conv20 to i32, !dbg !2289
  %21 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2290
  %codecpar22 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %21, i32 0, i32 19, !dbg !2291
  %22 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar22, align 8, !dbg !2291
  %bits_per_coded_sample = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %22, i32 0, i32 7, !dbg !2292
  store i32 %conv21, i32* %bits_per_coded_sample, align 8, !dbg !2293
  %23 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2294
  %pb23 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %23, i32 0, i32 4, !dbg !2295
  %24 = load %struct.AVIOContext*, %struct.AVIOContext** %pb23, align 8, !dbg !2295
  %call24 = call i32 @avio_rb16(%struct.AVIOContext* %24), !dbg !2296
  %conv25 = trunc i32 %call24 to i16, !dbg !2296
  store i16 %conv25, i16* %sign, align 2, !dbg !2297
  %25 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2298
  %pb26 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %25, i32 0, i32 4, !dbg !2299
  %26 = load %struct.AVIOContext*, %struct.AVIOContext** %pb26, align 8, !dbg !2299
  %call27 = call i64 @avio_skip(%struct.AVIOContext* %26, i64 2), !dbg !2300
  %27 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2301
  %pb28 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %27, i32 0, i32 4, !dbg !2302
  %28 = load %struct.AVIOContext*, %struct.AVIOContext** %pb28, align 8, !dbg !2302
  %call29 = call i64 @avio_skip(%struct.AVIOContext* %28, i64 2), !dbg !2303
  %29 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2304
  %pb30 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %29, i32 0, i32 4, !dbg !2305
  %30 = load %struct.AVIOContext*, %struct.AVIOContext** %pb30, align 8, !dbg !2305
  %call31 = call i64 @avio_skip(%struct.AVIOContext* %30, i64 1), !dbg !2306
  %31 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2307
  %pb32 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %31, i32 0, i32 4, !dbg !2308
  %32 = load %struct.AVIOContext*, %struct.AVIOContext** %pb32, align 8, !dbg !2308
  %call33 = call i32 @avio_rb24(%struct.AVIOContext* %32), !dbg !2309
  %33 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2310
  %codecpar34 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %33, i32 0, i32 19, !dbg !2311
  %34 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar34, align 8, !dbg !2311
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %34, i32 0, i32 23, !dbg !2312
  store i32 %call33, i32* %sample_rate, align 4, !dbg !2313
  %35 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2314
  %pb35 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %35, i32 0, i32 4, !dbg !2315
  %36 = load %struct.AVIOContext*, %struct.AVIOContext** %pb35, align 8, !dbg !2315
  %call36 = call i64 @avio_skip(%struct.AVIOContext* %36, i64 12), !dbg !2316
  %37 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2317
  %pb37 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %37, i32 0, i32 4, !dbg !2318
  %38 = load %struct.AVIOContext*, %struct.AVIOContext** %pb37, align 8, !dbg !2318
  %call38 = call i64 @avio_skip(%struct.AVIOContext* %38, i64 6), !dbg !2319
  %39 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2320
  %pb39 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %39, i32 0, i32 4, !dbg !2321
  %40 = load %struct.AVIOContext*, %struct.AVIOContext** %pb39, align 8, !dbg !2321
  %call40 = call i64 @avio_skip(%struct.AVIOContext* %40, i64 20), !dbg !2322
  %41 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2323
  %pb41 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %41, i32 0, i32 4, !dbg !2324
  %42 = load %struct.AVIOContext*, %struct.AVIOContext** %pb41, align 8, !dbg !2324
  %call42 = call i64 @avio_skip(%struct.AVIOContext* %42, i64 64), !dbg !2325
  %43 = load i16, i16* %bps, align 2, !dbg !2326
  %conv43 = zext i16 %43 to i32, !dbg !2326
  %44 = load i16, i16* %sign, align 2, !dbg !2327
  %conv44 = zext i16 %44 to i32, !dbg !2327
  %call45 = call i32 @ff_get_pcm_codec_id(i32 %conv43, i32 0, i32 1, i32 %conv44), !dbg !2328
  %45 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2329
  %codecpar46 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %45, i32 0, i32 19, !dbg !2330
  %46 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar46, align 8, !dbg !2330
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %46, i32 0, i32 1, !dbg !2331
  store i32 %call45, i32* %codec_id, align 4, !dbg !2332
  %47 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2333
  %codecpar47 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %47, i32 0, i32 19, !dbg !2335
  %48 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar47, align 8, !dbg !2335
  %codec_id48 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %48, i32 0, i32 1, !dbg !2336
  %49 = load i32, i32* %codec_id48, align 4, !dbg !2336
  %cmp49 = icmp eq i32 %49, 0, !dbg !2337
  br i1 %cmp49, label %if.then51, label %if.end54, !dbg !2338

if.then51:                                        ; preds = %if.end17
  %50 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2339
  %51 = bitcast %struct.AVFormatContext* %50 to i8*, !dbg !2339
  %52 = load i16, i16* %bps, align 2, !dbg !2341
  %conv52 = zext i16 %52 to i32, !dbg !2341
  %53 = load i16, i16* %sign, align 2, !dbg !2342
  %conv53 = zext i16 %53 to i32, !dbg !2342
  call void (i8*, i8*, ...) @avpriv_request_sample(i8* %51, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.3, i32 0, i32 0), i32 %conv52, i32 %conv53), !dbg !2343
  store i32 -1163346256, i32* %retval, align 4, !dbg !2344
  br label %return, !dbg !2344

if.end54:                                         ; preds = %if.end17
  %54 = load i16, i16* %bps, align 2, !dbg !2345
  %conv55 = zext i16 %54 to i32, !dbg !2345
  %55 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2346
  %codecpar56 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %55, i32 0, i32 19, !dbg !2347
  %56 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar56, align 8, !dbg !2347
  %channels57 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %56, i32 0, i32 22, !dbg !2348
  %57 = load i32, i32* %channels57, align 8, !dbg !2348
  %mul = mul nsw i32 %conv55, %57, !dbg !2349
  %div = sdiv i32 %mul, 8, !dbg !2350
  %58 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2351
  %codecpar58 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %58, i32 0, i32 19, !dbg !2352
  %59 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar58, align 8, !dbg !2352
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %59, i32 0, i32 24, !dbg !2353
  store i32 %div, i32* %block_align, align 8, !dbg !2354
  %60 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2355
  %61 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2356
  %codecpar59 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %61, i32 0, i32 19, !dbg !2357
  %62 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar59, align 8, !dbg !2357
  %sample_rate60 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %62, i32 0, i32 23, !dbg !2358
  %63 = load i32, i32* %sample_rate60, align 4, !dbg !2358
  call void @avpriv_set_pts_info(%struct.AVStream* %60, i32 64, i32 1, i32 %63), !dbg !2359
  store i32 0, i32* %retval, align 4, !dbg !2360
  br label %return, !dbg !2360

return:                                           ; preds = %if.end54, %if.then51, %if.else14, %if.then
  %64 = load i32, i32* %retval, align 4, !dbg !2361
  ret i32 %64, !dbg !2361
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[inter]libavformat--avr.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs")
...
!934 = !{!935}
!935 = distinct !DIGlobalVariable(name: "ff_avr_demuxer", scope: !0, file: !936, line: 90, type: !937, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_avr_demuxer)
!936 = !DIFile(filename: "libavformat/avr.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs")
...
!2151 = distinct !DISubprogram(name: "avr_probe", scope: !936, file: !936, line: 27, type: !1006, isLocal: true, isDefinition: true, scopeLine: 28, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2152 = !{}
...
!2160 = distinct !DILocation(line: 32, column: 73, scope: !2161)
!2161 = !DILexicalBlockFile(scope: !2162, file: !936, discriminator: 1)
!2162 = distinct !DILexicalBlock(scope: !2151, file: !936, line: 32, column: 9)
!2163 = !DILocation(line: 58, column: 98, scope: !2154, inlinedAt: !2164)
!2164 = distinct !DILocation(line: 34, column: 9, scope: !2165)
!2165 = distinct !DILexicalBlock(scope: !2151, file: !936, line: 34, column: 9)
!2166 = !DILocation(line: 58, column: 98, scope: !2154, inlinedAt: !2167)
!2167 = distinct !DILocation(line: 32, column: 10, scope: !2162)
!2168 = !DILocalVariable(name: "p", arg: 1, scope: !2151, file: !936, line: 27, type: !1008)
!2169 = !DILocation(line: 27, column: 35, scope: !2151)
!2170 = !DILocation(line: 29, column: 41, scope: !2171)
!2171 = distinct !DILexicalBlock(scope: !2151, file: !936, line: 29, column: 9)
!2172 = !DILocation(line: 29, column: 44, scope: !2171)
!2173 = !DILocation(line: 29, column: 51, scope: !2171)
!2174 = !DILocation(line: 29, column: 54, scope: !2171)
!2175 = !DILocation(line: 29, column: 9, scope: !2151)
!2176 = !DILocation(line: 30, column: 9, scope: !2171)
!2177 = !DILocation(line: 32, column: 53, scope: !2162)
!2178 = !DILocation(line: 32, column: 56, scope: !2162)
!2179 = !DILocation(line: 32, column: 59, scope: !2162)
!2180 = !DILocation(line: 32, column: 66, scope: !2162)
!2181 = !DILocation(line: 32, column: 10, scope: !2162)
!2182 = !DILocation(line: 60, column: 9, scope: !2154, inlinedAt: !2167)
!2183 = !DILocation(line: 60, column: 10, scope: !2154, inlinedAt: !2167)
!2184 = !DILocation(line: 60, column: 18, scope: !2154, inlinedAt: !2167)
!2185 = !DILocation(line: 60, column: 19, scope: !2154, inlinedAt: !2167)
!2186 = !DILocation(line: 60, column: 15, scope: !2154, inlinedAt: !2167)
!2187 = !DILocation(line: 60, column: 8, scope: !2154, inlinedAt: !2167)
!2188 = !DILocation(line: 60, column: 6, scope: !2154, inlinedAt: !2167)
!2189 = !DILocation(line: 61, column: 12, scope: !2154, inlinedAt: !2167)
!2190 = !DILocation(line: 32, column: 70, scope: !2162)
!2191 = !DILocation(line: 32, column: 116, scope: !2161)
!2192 = !DILocation(line: 32, column: 119, scope: !2161)
!2193 = !DILocation(line: 32, column: 122, scope: !2161)
!2194 = !DILocation(line: 32, column: 129, scope: !2161)
!2195 = !DILocation(line: 32, column: 73, scope: !2161)
!2196 = !DILocation(line: 60, column: 9, scope: !2154, inlinedAt: !2160)
!2197 = !DILocation(line: 60, column: 10, scope: !2154, inlinedAt: !2160)
!2198 = !DILocation(line: 60, column: 18, scope: !2154, inlinedAt: !2160)
!2199 = !DILocation(line: 60, column: 19, scope: !2154, inlinedAt: !2160)
!2200 = !DILocation(line: 60, column: 15, scope: !2154, inlinedAt: !2160)
!2201 = !DILocation(line: 60, column: 8, scope: !2154, inlinedAt: !2160)
!2202 = !DILocation(line: 60, column: 6, scope: !2154, inlinedAt: !2160)
!2203 = !DILocation(line: 61, column: 12, scope: !2154, inlinedAt: !2160)
!2204 = !DILocation(line: 32, column: 133, scope: !2161)
!2205 = !DILocation(line: 32, column: 9, scope: !2161)
!2206 = !DILocation(line: 33, column: 9, scope: !2162)
!2207 = !DILocation(line: 34, column: 52, scope: !2165)
!2208 = !DILocation(line: 34, column: 55, scope: !2165)
!2209 = !DILocation(line: 34, column: 58, scope: !2165)
!2210 = !DILocation(line: 34, column: 65, scope: !2165)
!2211 = !DILocation(line: 34, column: 9, scope: !2165)
!2212 = !DILocation(line: 60, column: 9, scope: !2154, inlinedAt: !2164)
!2213 = !DILocation(line: 60, column: 10, scope: !2154, inlinedAt: !2164)
!2214 = !DILocation(line: 60, column: 18, scope: !2154, inlinedAt: !2164)
!2215 = !DILocation(line: 60, column: 19, scope: !2154, inlinedAt: !2164)
!2216 = !DILocation(line: 60, column: 15, scope: !2154, inlinedAt: !2164)
!2217 = !DILocation(line: 60, column: 8, scope: !2154, inlinedAt: !2164)
!2218 = !DILocation(line: 60, column: 6, scope: !2154, inlinedAt: !2164)
!2219 = !DILocation(line: 61, column: 12, scope: !2154, inlinedAt: !2164)
!2220 = !DILocation(line: 34, column: 69, scope: !2165)
!2221 = !DILocation(line: 34, column: 9, scope: !2151)
!2222 = !DILocation(line: 35, column: 9, scope: !2165)
!2223 = !DILocation(line: 37, column: 5, scope: !2151)
!2224 = !DILocation(line: 38, column: 1, scope: !2151)
!2225 = distinct !DISubprogram(name: "avr_read_header", scope: !936, file: !936, line: 40, type: !2226, isLocal: true, isDefinition: true, scopeLine: 41, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2226 = !DISubroutineType(types: !2227)
!2227 = !{!933, !2228}
!2228 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2229, size: 64, align: 64)
!2229 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1023)
!2230 = !DILocalVariable(name: "s", arg: 1, scope: !2225, file: !936, line: 40, type: !2228)
!2231 = !DILocation(line: 40, column: 45, scope: !2225)
!2232 = !DILocalVariable(name: "chan", scope: !2225, file: !936, line: 42, type: !931)
!2233 = !DILocation(line: 42, column: 14, scope: !2225)
!2234 = !DILocalVariable(name: "sign", scope: !2225, file: !936, line: 42, type: !931)
!2235 = !DILocation(line: 42, column: 20, scope: !2225)
!2236 = !DILocalVariable(name: "bps", scope: !2225, file: !936, line: 42, type: !931)
!2237 = !DILocation(line: 42, column: 26, scope: !2225)
!2238 = !DILocalVariable(name: "st", scope: !2225, file: !936, line: 43, type: !1297)
!2239 = !DILocation(line: 43, column: 15, scope: !2225)
!2240 = !DILocation(line: 45, column: 30, scope: !2225)
!2241 = !DILocation(line: 45, column: 10, scope: !2225)
!2242 = !DILocation(line: 45, column: 8, scope: !2225)
!2243 = !DILocation(line: 46, column: 10, scope: !2244)
!2244 = distinct !DILexicalBlock(scope: !2225, file: !936, line: 46, column: 9)
!2245 = !DILocation(line: 46, column: 9, scope: !2225)
!2246 = !DILocation(line: 47, column: 9, scope: !2244)
!2247 = !DILocation(line: 49, column: 5, scope: !2225)
!2248 = !DILocation(line: 49, column: 9, scope: !2225)
!2249 = !DILocation(line: 49, column: 19, scope: !2225)
!2250 = !DILocation(line: 49, column: 30, scope: !2225)
!2251 = !DILocation(line: 51, column: 15, scope: !2225)
!2252 = !DILocation(line: 51, column: 18, scope: !2225)
!2253 = !DILocation(line: 51, column: 5, scope: !2225)
!2254 = !DILocation(line: 52, column: 15, scope: !2225)
!2255 = !DILocation(line: 52, column: 18, scope: !2225)
!2256 = !DILocation(line: 52, column: 5, scope: !2225)
!2257 = !DILocation(line: 54, column: 22, scope: !2225)
!2258 = !DILocation(line: 54, column: 25, scope: !2225)
!2259 = !DILocation(line: 54, column: 12, scope: !2225)
!2260 = !DILocation(line: 54, column: 10, scope: !2225)
!2261 = !DILocation(line: 55, column: 10, scope: !2262)
!2262 = distinct !DILexicalBlock(scope: !2225, file: !936, line: 55, column: 9)
!2263 = !DILocation(line: 55, column: 9, scope: !2225)
!2264 = !DILocation(line: 56, column: 9, scope: !2265)
!2265 = distinct !DILexicalBlock(scope: !2262, file: !936, line: 55, column: 16)
!2266 = !DILocation(line: 56, column: 13, scope: !2265)
!2267 = !DILocation(line: 56, column: 23, scope: !2265)
!2268 = !DILocation(line: 56, column: 32, scope: !2265)
!2269 = !DILocation(line: 57, column: 5, scope: !2265)
!2270 = !DILocation(line: 57, column: 16, scope: !2271)
!2271 = !DILexicalBlockFile(scope: !2272, file: !936, discriminator: 1)
!2272 = distinct !DILexicalBlock(scope: !2262, file: !936, line: 57, column: 16)
!2273 = !DILocation(line: 57, column: 21, scope: !2271)
!2274 = !DILocation(line: 58, column: 9, scope: !2275)
!2275 = distinct !DILexicalBlock(scope: !2272, file: !936, line: 57, column: 33)
!2276 = !DILocation(line: 58, column: 13, scope: !2275)
!2277 = !DILocation(line: 58, column: 23, scope: !2275)
!2278 = !DILocation(line: 58, column: 32, scope: !2275)
!2279 = !DILocation(line: 59, column: 5, scope: !2275)
!2280 = !DILocation(line: 60, column: 31, scope: !2281)
!2281 = distinct !DILexicalBlock(scope: !2272, file: !936, line: 59, column: 12)
!2282 = !DILocation(line: 60, column: 45, scope: !2281)
!2283 = !DILocation(line: 60, column: 9, scope: !2281)
!2284 = !DILocation(line: 61, column: 9, scope: !2281)
!2285 = !DILocation(line: 64, column: 59, scope: !2225)
!2286 = !DILocation(line: 64, column: 62, scope: !2225)
!2287 = !DILocation(line: 64, column: 49, scope: !2225)
!2288 = !DILocation(line: 64, column: 47, scope: !2225)
!2289 = !DILocation(line: 64, column: 43, scope: !2225)
!2290 = !DILocation(line: 64, column: 5, scope: !2225)
!2291 = !DILocation(line: 64, column: 9, scope: !2225)
!2292 = !DILocation(line: 64, column: 19, scope: !2225)
!2293 = !DILocation(line: 64, column: 41, scope: !2225)
!2294 = !DILocation(line: 66, column: 22, scope: !2225)
!2295 = !DILocation(line: 66, column: 25, scope: !2225)
!2296 = !DILocation(line: 66, column: 12, scope: !2225)
!2297 = !DILocation(line: 66, column: 10, scope: !2225)
!2298 = !DILocation(line: 68, column: 15, scope: !2225)
!2299 = !DILocation(line: 68, column: 18, scope: !2225)
!2300 = !DILocation(line: 68, column: 5, scope: !2225)
!2301 = !DILocation(line: 69, column: 15, scope: !2225)
!2302 = !DILocation(line: 69, column: 18, scope: !2225)
!2303 = !DILocation(line: 69, column: 5, scope: !2225)
!2304 = !DILocation(line: 70, column: 15, scope: !2225)
!2305 = !DILocation(line: 70, column: 18, scope: !2225)
!2306 = !DILocation(line: 70, column: 5, scope: !2225)
!2307 = !DILocation(line: 72, column: 43, scope: !2225)
!2308 = !DILocation(line: 72, column: 46, scope: !2225)
!2309 = !DILocation(line: 72, column: 33, scope: !2225)
!2310 = !DILocation(line: 72, column: 5, scope: !2225)
!2311 = !DILocation(line: 72, column: 9, scope: !2225)
!2312 = !DILocation(line: 72, column: 19, scope: !2225)
!2313 = !DILocation(line: 72, column: 31, scope: !2225)
!2314 = !DILocation(line: 73, column: 15, scope: !2225)
!2315 = !DILocation(line: 73, column: 18, scope: !2225)
!2316 = !DILocation(line: 73, column: 5, scope: !2225)
!2317 = !DILocation(line: 74, column: 15, scope: !2225)
!2318 = !DILocation(line: 74, column: 18, scope: !2225)
!2319 = !DILocation(line: 74, column: 5, scope: !2225)
!2320 = !DILocation(line: 75, column: 15, scope: !2225)
!2321 = !DILocation(line: 75, column: 18, scope: !2225)
!2322 = !DILocation(line: 75, column: 5, scope: !2225)
!2323 = !DILocation(line: 76, column: 15, scope: !2225)
!2324 = !DILocation(line: 76, column: 18, scope: !2225)
!2325 = !DILocation(line: 76, column: 5, scope: !2225)
!2326 = !DILocation(line: 78, column: 50, scope: !2225)
!2327 = !DILocation(line: 78, column: 61, scope: !2225)
!2328 = !DILocation(line: 78, column: 30, scope: !2225)
!2329 = !DILocation(line: 78, column: 5, scope: !2225)
!2330 = !DILocation(line: 78, column: 9, scope: !2225)
!2331 = !DILocation(line: 78, column: 19, scope: !2225)
!2332 = !DILocation(line: 78, column: 28, scope: !2225)
!2333 = !DILocation(line: 79, column: 9, scope: !2334)
!2334 = distinct !DILexicalBlock(scope: !2225, file: !936, line: 79, column: 9)
!2335 = !DILocation(line: 79, column: 13, scope: !2334)
!2336 = !DILocation(line: 79, column: 23, scope: !2334)
!2337 = !DILocation(line: 79, column: 32, scope: !2334)
!2338 = !DILocation(line: 79, column: 9, scope: !2225)
!2339 = !DILocation(line: 80, column: 31, scope: !2340)
!2340 = distinct !DILexicalBlock(scope: !2334, file: !936, line: 79, column: 53)
!2341 = !DILocation(line: 80, column: 56, scope: !2340)
!2342 = !DILocation(line: 80, column: 61, scope: !2340)
!2343 = !DILocation(line: 80, column: 9, scope: !2340)
!2344 = !DILocation(line: 81, column: 9, scope: !2340)
!2345 = !DILocation(line: 84, column: 33, scope: !2225)
!2346 = !DILocation(line: 84, column: 39, scope: !2225)
!2347 = !DILocation(line: 84, column: 43, scope: !2225)
!2348 = !DILocation(line: 84, column: 53, scope: !2225)
!2349 = !DILocation(line: 84, column: 37, scope: !2225)
!2350 = !DILocation(line: 84, column: 62, scope: !2225)
!2351 = !DILocation(line: 84, column: 5, scope: !2225)
!2352 = !DILocation(line: 84, column: 9, scope: !2225)
!2353 = !DILocation(line: 84, column: 19, scope: !2225)
!2354 = !DILocation(line: 84, column: 31, scope: !2225)
!2355 = !DILocation(line: 86, column: 25, scope: !2225)
!2356 = !DILocation(line: 86, column: 36, scope: !2225)
!2357 = !DILocation(line: 86, column: 40, scope: !2225)
!2358 = !DILocation(line: 86, column: 50, scope: !2225)
!2359 = !DILocation(line: 86, column: 5, scope: !2225)
!2360 = !DILocation(line: 87, column: 5, scope: !2225)
!2361 = !DILocation(line: 88, column: 1, scope: !2225)
