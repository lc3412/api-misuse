; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[inter]libavcodec--cook_parser.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[inter]libavcodec--cook_parser.o.i"
...
@ff_cook_parser = global { [5 x i32], i32, i32 (%struct.AVCodecParserContext*)*, i32 (%struct.AVCodecParserContext*, %struct.AVCodecContext*, i8**, i32*, i8*, i32)*, void (%struct.AVCodecParserContext*)*, i32 (%struct.AVCodecContext*, i8*, i32)*, %struct.AVCodecParser* } { [5 x i32] [i32 86036, i32 0, i32 0, i32 0, i32 0], i32 4, i32 (%struct.AVCodecParserContext*)* null, i32 (%struct.AVCodecParserContext*, %struct.AVCodecContext*, i8**, i32*, i8*, i32)* @cook_parse, void (%struct.AVCodecParserContext*)* null, i32 (%struct.AVCodecContext*, i8*, i32)* null, %struct.AVCodecParser* null }, align 8

; Function Attrs: nounwind uwtable
define internal i32 @cook_parse(%struct.AVCodecParserContext* %s1, %struct.AVCodecContext* %avctx, i8** %poutbuf, i32* %poutbuf_size, i8* %buf, i32 %buf_size) #0 !dbg !1575 {
entry:
  %x.addr.i = alloca i16, align 2
  call void @llvm.dbg.declare(metadata i16* %x.addr.i, metadata !1577, metadata !1582), !dbg !1583
  ...
  %s = alloca %struct.CookParseContext*, align 8
  store %struct.AVCodecParserContext* %s1, %struct.AVCodecParserContext** %s1.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVCodecParserContext** %s1.addr, metadata !1586, metadata !1582), !dbg !1587
  store %struct.AVCodecContext* %avctx, %struct.AVCodecContext** %avctx.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVCodecContext** %avctx.addr, metadata !1588, metadata !1582), !dbg !1589
  store i8** %poutbuf, i8*** %poutbuf.addr, align 8
  call void @llvm.dbg.declare(metadata i8*** %poutbuf.addr, metadata !1590, metadata !1582), !dbg !1591
  store i32* %poutbuf_size, i32** %poutbuf_size.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %poutbuf_size.addr, metadata !1592, metadata !1582), !dbg !1593
  store i8* %buf, i8** %buf.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %buf.addr, metadata !1594, metadata !1582), !dbg !1595
  store i32 %buf_size, i32* %buf_size.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %buf_size.addr, metadata !1596, metadata !1582), !dbg !1597
  call void @llvm.dbg.declare(metadata %struct.CookParseContext** %s, metadata !1598, metadata !1582), !dbg !1604
  %0 = load %struct.AVCodecParserContext*, %struct.AVCodecParserContext** %s1.addr, align 8, !dbg !1605
  %priv_data = getelementptr inbounds %struct.AVCodecParserContext, %struct.AVCodecParserContext* %0, i32 0, i32 0, !dbg !1606
  %1 = load i8*, i8** %priv_data, align 8, !dbg !1606
  %2 = bitcast i8* %1 to %struct.CookParseContext*, !dbg !1605
  store %struct.CookParseContext* %2, %struct.CookParseContext** %s, align 8, !dbg !1604
  %3 = load %struct.CookParseContext*, %struct.CookParseContext** %s, align 8, !dbg !1607
  %duration = getelementptr inbounds %struct.CookParseContext, %struct.CookParseContext* %3, i32 0, i32 0, !dbg !1608
  %4 = load i32, i32* %duration, align 4, !dbg !1608
  %tobool = icmp ne i32 %4, 0, !dbg !1607
  br i1 %tobool, label %if.end, label %land.lhs.true, !dbg !1609

land.lhs.true:                                    ; preds = %entry
  %5 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1610
  %extradata = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %5, i32 0, i32 15, !dbg !1611
  %6 = load i8*, i8** %extradata, align 8, !dbg !1611
  %tobool1 = icmp ne i8* %6, null, !dbg !1610
  br i1 %tobool1, label %land.lhs.true2, label %if.end, !dbg !1612

land.lhs.true2:                                   ; preds = %land.lhs.true
  %7 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1613
  %extradata_size = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %7, i32 0, i32 16, !dbg !1615
  %8 = load i32, i32* %extradata_size, align 8, !dbg !1615
  %cmp = icmp sge i32 %8, 8, !dbg !1616
  br i1 %cmp, label %land.lhs.true3, label %if.end, !dbg !1617

land.lhs.true3:                                   ; preds = %land.lhs.true2
  %9 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1618
  %channels = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %9, i32 0, i32 83, !dbg !1620
  %10 = load i32, i32* %channels, align 4, !dbg !1620
  %tobool4 = icmp ne i32 %10, 0, !dbg !1618
  br i1 %tobool4, label %if.then, label %if.end, !dbg !1621

if.then:                                          ; preds = %land.lhs.true3
  %11 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1623
  %extradata5 = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %11, i32 0, i32 15, !dbg !1624
  %12 = load i8*, i8** %extradata5, align 8, !dbg !1624
  %add.ptr = getelementptr inbounds i8, i8* %12, i64 4, !dbg !1625
  %13 = bitcast i8* %add.ptr to %union.unaligned_16*, !dbg !1626
  %l = bitcast %union.unaligned_16* %13 to i16*, !dbg !1626
  %14 = load i16, i16* %l, align 1, !dbg !1626
  store i16 %14, i16* %x.addr.i, align 2, !dbg !1627
  %15 = load i16, i16* %x.addr.i, align 2, !dbg !1628
  %conv.i = zext i16 %15 to i32, !dbg !1628
  %shr.i = ashr i32 %conv.i, 8, !dbg !1629
  %16 = load i16, i16* %x.addr.i, align 2, !dbg !1630
  %conv1.i = zext i16 %16 to i32, !dbg !1630
  %shl.i = shl i32 %conv1.i, 8, !dbg !1631
  %or.i = or i32 %shr.i, %shl.i, !dbg !1632
  %conv2.i = trunc i32 %or.i to i16, !dbg !1633
  store i16 %conv2.i, i16* %x.addr.i, align 2, !dbg !1634
  %17 = load i16, i16* %x.addr.i, align 2, !dbg !1635
  %conv = zext i16 %17 to i32, !dbg !1627
  %18 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1636
  %channels6 = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %18, i32 0, i32 83, !dbg !1637
  %19 = load i32, i32* %channels6, align 4, !dbg !1637
  %div = sdiv i32 %conv, %19, !dbg !1638
  %20 = load %struct.CookParseContext*, %struct.CookParseContext** %s, align 8, !dbg !1639
  %duration7 = getelementptr inbounds %struct.CookParseContext, %struct.CookParseContext* %20, i32 0, i32 0, !dbg !1640
  store i32 %div, i32* %duration7, align 4, !dbg !1641
  br label %if.end, !dbg !1639

if.end:                                           ; preds = %if.then, %land.lhs.true3, %land.lhs.true2, %land.lhs.true, %entry
  %21 = load %struct.CookParseContext*, %struct.CookParseContext** %s, align 8, !dbg !1642
  %duration8 = getelementptr inbounds %struct.CookParseContext, %struct.CookParseContext* %21, i32 0, i32 0, !dbg !1643
  %22 = load i32, i32* %duration8, align 4, !dbg !1643
  %23 = load %struct.AVCodecParserContext*, %struct.AVCodecParserContext** %s1.addr, align 8, !dbg !1644
  %duration9 = getelementptr inbounds %struct.AVCodecParserContext, %struct.AVCodecParserContext* %23, i32 0, i32 27, !dbg !1645
  store i32 %22, i32* %duration9, align 8, !dbg !1646
  %24 = load i8*, i8** %buf.addr, align 8, !dbg !1647
  %25 = load i8**, i8*** %poutbuf.addr, align 8, !dbg !1648
  store i8* %24, i8** %25, align 8, !dbg !1649
  %26 = load i32, i32* %buf_size.addr, align 4, !dbg !1650
  %27 = load i32*, i32** %poutbuf_size.addr, align 8, !dbg !1651
  store i32 %26, i32* %27, align 4, !dbg !1652
  %28 = load i32, i32* %buf_size.addr, align 4, !dbg !1653
  ret i32 %28, !dbg !1654
}
...
!0 = distinct !DICompileUnit(language: DW_LANG_C99, file: !1, producer: "clang version 3.9.0 (tags/RELEASE_390/final)", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, enums: !2, retainedTypes: !893, globals: !903)
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[inter]libavcodec--cook_parser.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs")
...
!903 = !{!904}
!904 = distinct !DIGlobalVariable(name: "ff_cook_parser", scope: !0, file: !905, line: 56, type: !906, isLocal: false, isDefinition: true, variable: { [5 x i32], i32, i32 (%struct.AVCodecParserContext*)*, i32 (%struct.AVCodecParserContext*, %struct.AVCodecContext*, i8**, i32*, i8*, i32)*, void (%struct.AVCodecParserContext*)*, i32 (%struct.AVCodecContext*, i8*, i32)*, %struct.AVCodecParser* }* @ff_cook_parser)
!905 = !DIFile(filename: "libavcodec/cook_parser.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs")
!906 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVCodecParser", file: !4, line: 5272, baseType: !907)
!907 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "AVCodecParser", file: !4, line: 5259, size: 512, align: 64, elements: !908)
!908 = !{!909, !914, !915, !966, !1563, !1567, !1571}
!909 = !DIDerivedType(tag: DW_TAG_member, name: "codec_ids", scope: !907, file: !4, line: 5260, baseType: !910, size: 160, align: 32)
!910 = !DICompositeType(tag: DW_TAG_array_type, baseType: !911, size: 160, align: 32, elements: !912)
!911 = !DIBasicType(name: "int", size: 32, align: 32, encoding: DW_ATE_signed)
!912 = !{!913}
!913 = !DISubrange(count: 5)
!914 = !DIDerivedType(tag: DW_TAG_member, name: "priv_data_size", scope: !907, file: !4, line: 5261, baseType: !911, size: 32, align: 32, offset: 160)
!915 = !DIDerivedType(tag: DW_TAG_member, name: "parser_init", scope: !907, file: !4, line: 5262, baseType: !916, size: 64, align: 64, offset: 192)
...
!920 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVCodecParserContext", file: !4, line: 5257, baseType: !921)
!921 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "AVCodecParserContext", file: !4, line: 5092, size: 2816, align: 64, elements: !922)
!922 = !{!923, !925, !927, !930, !931, !932, !933, !934, !935, !936, !937, !938, !939, !940, !944, !945, !946, !947, !948, !949, !950, !951, !952, !953, !954, !955, !956, !957, !958, !959, !960, !961, !962, !963, !964, !965}
!923 = !DIDerivedType(tag: DW_TAG_member, name: "priv_data", scope: !921, file: !4, line: 5093, baseType: !924, size: 64, align: 64)
!924 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64, align: 64)
!925 = !DIDerivedType(tag: DW_TAG_member, name: "parser", scope: !921, file: !4, line: 5094, baseType: !926, size: 64, align: 64, offset: 64)
!926 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !907, size: 64, align: 64)
!927 = !DIDerivedType(tag: DW_TAG_member, name: "frame_offset", scope: !921, file: !4, line: 5095, baseType: !928, size: 64, align: 64, offset: 128)
!928 = !DIDerivedType(tag: DW_TAG_typedef, name: "int64_t", file: !901, line: 40, baseType: !929)
!929 = !DIBasicType(name: "long int", size: 64, align: 64, encoding: DW_ATE_signed)
!930 = !DIDerivedType(tag: DW_TAG_member, name: "cur_offset", scope: !921, file: !4, line: 5096, baseType: !928, size: 64, align: 64, offset: 192)
!931 = !DIDerivedType(tag: DW_TAG_member, name: "next_frame_offset", scope: !921, file: !4, line: 5098, baseType: !928, size: 64, align: 64, offset: 256)
!932 = !DIDerivedType(tag: DW_TAG_member, name: "pict_type", scope: !921, file: !4, line: 5100, baseType: !911, size: 32, align: 32, offset: 320)
!933 = !DIDerivedType(tag: DW_TAG_member, name: "repeat_pict", scope: !921, file: !4, line: 5110, baseType: !911, size: 32, align: 32, offset: 352)
!934 = !DIDerivedType(tag: DW_TAG_member, name: "pts", scope: !921, file: !4, line: 5111, baseType: !928, size: 64, align: 64, offset: 384)
!935 = !DIDerivedType(tag: DW_TAG_member, name: "dts", scope: !921, file: !4, line: 5112, baseType: !928, size: 64, align: 64, offset: 448)
!936 = !DIDerivedType(tag: DW_TAG_member, name: "last_pts", scope: !921, file: !4, line: 5115, baseType: !928, size: 64, align: 64, offset: 512)
!937 = !DIDerivedType(tag: DW_TAG_member, name: "last_dts", scope: !921, file: !4, line: 5116, baseType: !928, size: 64, align: 64, offset: 576)
!938 = !DIDerivedType(tag: DW_TAG_member, name: "fetch_timestamp", scope: !921, file: !4, line: 5117, baseType: !911, size: 32, align: 32, offset: 640)
!939 = !DIDerivedType(tag: DW_TAG_member, name: "cur_frame_start_index", scope: !921, file: !4, line: 5120, baseType: !911, size: 32, align: 32, offset: 672)
!940 = !DIDerivedType(tag: DW_TAG_member, name: "cur_frame_offset", scope: !921, file: !4, line: 5121, baseType: !941, size: 256, align: 64, offset: 704)
!941 = !DICompositeType(tag: DW_TAG_array_type, baseType: !928, size: 256, align: 64, elements: !942)
!942 = !{!943}
!943 = !DISubrange(count: 4)
!944 = !DIDerivedType(tag: DW_TAG_member, name: "cur_frame_pts", scope: !921, file: !4, line: 5122, baseType: !941, size: 256, align: 64, offset: 960)
!945 = !DIDerivedType(tag: DW_TAG_member, name: "cur_frame_dts", scope: !921, file: !4, line: 5123, baseType: !941, size: 256, align: 64, offset: 1216)
!946 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !921, file: !4, line: 5125, baseType: !911, size: 32, align: 32, offset: 1472)
!947 = !DIDerivedType(tag: DW_TAG_member, name: "offset", scope: !921, file: !4, line: 5132, baseType: !928, size: 64, align: 64, offset: 1536)
!948 = !DIDerivedType(tag: DW_TAG_member, name: "cur_frame_end", scope: !921, file: !4, line: 5133, baseType: !941, size: 256, align: 64, offset: 1600)
!949 = !DIDerivedType(tag: DW_TAG_member, name: "key_frame", scope: !921, file: !4, line: 5141, baseType: !911, size: 32, align: 32, offset: 1856)
!950 = !DIDerivedType(tag: DW_TAG_member, name: "convergence_duration", scope: !921, file: !4, line: 5148, baseType: !928, size: 64, align: 64, offset: 1920)
!951 = !DIDerivedType(tag: DW_TAG_member, name: "dts_sync_point", scope: !921, file: !4, line: 5161, baseType: !911, size: 32, align: 32, offset: 1984)
!952 = !DIDerivedType(tag: DW_TAG_member, name: "dts_ref_dts_delta", scope: !921, file: !4, line: 5176, baseType: !911, size: 32, align: 32, offset: 2016)
!953 = !DIDerivedType(tag: DW_TAG_member, name: "pts_dts_delta", scope: !921, file: !4, line: 5190, baseType: !911, size: 32, align: 32, offset: 2048)
!954 = !DIDerivedType(tag: DW_TAG_member, name: "cur_frame_pos", scope: !921, file: !4, line: 5197, baseType: !941, size: 256, align: 64, offset: 2112)
!955 = !DIDerivedType(tag: DW_TAG_member, name: "pos", scope: !921, file: !4, line: 5202, baseType: !928, size: 64, align: 64, offset: 2368)
!956 = !DIDerivedType(tag: DW_TAG_member, name: "last_pos", scope: !921, file: !4, line: 5207, baseType: !928, size: 64, align: 64, offset: 2432)
!957 = !DIDerivedType(tag: DW_TAG_member, name: "duration", scope: !921, file: !4, line: 5214, baseType: !911, size: 32, align: 32, offset: 2496)
!958 = !DIDerivedType(tag: DW_TAG_member, name: "field_order", scope: !921, file: !4, line: 5216, baseType: !3, size: 32, align: 32, offset: 2528)
!959 = !DIDerivedType(tag: DW_TAG_member, name: "picture_structure", scope: !921, file: !4, line: 5226, baseType: !12, size: 32, align: 32, offset: 2560)
!960 = !DIDerivedType(tag: DW_TAG_member, name: "output_picture_number", scope: !921, file: !4, line: 5234, baseType: !911, size: 32, align: 32, offset: 2592)
!961 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !921, file: !4, line: 5239, baseType: !911, size: 32, align: 32, offset: 2624)
!962 = !DIDerivedType(tag: DW_TAG_member, name: "height", scope: !921, file: !4, line: 5240, baseType: !911, size: 32, align: 32, offset: 2656)
!963 = !DIDerivedType(tag: DW_TAG_member, name: "coded_width", scope: !921, file: !4, line: 5245, baseType: !911, size: 32, align: 32, offset: 2688)
!964 = !DIDerivedType(tag: DW_TAG_member, name: "coded_height", scope: !921, file: !4, line: 5246, baseType: !911, size: 32, align: 32, offset: 2720)
!965 = !DIDerivedType(tag: DW_TAG_member, name: "format", scope: !921, file: !4, line: 5256, baseType: !911, size: 32, align: 32, offset: 2752)
!966 = !DIDerivedType(tag: DW_TAG_member, name: "parser_parse", scope: !907, file: !4, line: 5265, baseType: !967, size: 64, align: 64, offset: 256)
!967 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !968, size: 64, align: 64)
!968 = !DISubroutineType(types: !969)
!969 = !{!911, !919, !970, !1562, !1255, !1458, !911}
...
!992 = !DIDerivedType(tag: DW_TAG_member, name: "version", scope: !978, file: !19, line: 93, baseType: !911, size: 32, align: 32, offset: 192)
!993 = !DIDerivedType(tag: DW_TAG_member, name: "log_level_offset_offset", scope: !978, file: !19, line: 99, baseType: !911, size: 32, align: 32, offset: 224)
!994 = !DIDerivedType(tag: DW_TAG_member, name: "parent_log_context_offset", scope: !978, file: !19, line: 108, baseType: !911, size: 32, align: 32, offset: 256)
...
!1018 = !DIDerivedType(tag: DW_TAG_member, name: "log_level_offset", scope: !972, file: !4, line: 1562, baseType: !911, size: 32, align: 32, offset: 64)
...
!1029 = !DIDerivedType(tag: DW_TAG_member, name: "capabilities", scope: !1023, file: !4, line: 3487, baseType: !911, size: 32, align: 32, offset: 192)
...
!1036 = !{!1037, !1038}
!1037 = !DIDerivedType(tag: DW_TAG_member, name: "num", scope: !1035, file: !1034, line: 59, baseType: !911, size: 32, align: 32)
!1038 = !DIDerivedType(tag: DW_TAG_member, name: "den", scope: !1035, file: !1034, line: 60, baseType: !911, size: 32, align: 32, offset: 32)
...
!1044 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !911)
...
!1051 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint64_t", file: !901, line: 55, baseType: !1052)
...
!1054 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint8_t", file: !901, line: 48, baseType: !1055)
...
!1062 = !{!1063, !1064}
!1063 = !DIDerivedType(tag: DW_TAG_member, name: "profile", scope: !1061, file: !4, line: 3402, baseType: !911, size: 32, align: 32)
...
!1066 = !DIDerivedType(tag: DW_TAG_member, name: "priv_data_size", scope: !1023, file: !4, line: 3516, baseType: !911, size: 32, align: 32, offset: 832)
...
!1097 = !{!1098, !1099, !1102, !1103, !1104, !1134}
!1098 = !DIDerivedType(tag: DW_TAG_member, name: "format", scope: !1096, file: !4, line: 3921, baseType: !900, size: 16, align: 16)
!1099 = !DIDerivedType(tag: DW_TAG_member, name: "start_display_time", scope: !1096, file: !4, line: 3922, baseType: !1100, size: 32, align: 32, offset: 32)
!1100 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint32_t", file: !901, line: 51, baseType: !1101)
!1101 = !DIBasicType(name: "unsigned int", size: 32, align: 32, encoding: DW_ATE_unsigned)
!1102 = !DIDerivedType(tag: DW_TAG_member, name: "end_display_time", scope: !1096, file: !4, line: 3923, baseType: !1100, size: 32, align: 32, offset: 64)
!1103 = !DIDerivedType(tag: DW_TAG_member, name: "num_rects", scope: !1096, file: !4, line: 3924, baseType: !1101, size: 32, align: 32, offset: 96)
...
!1110 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !1108, file: !4, line: 3886, baseType: !911, size: 32, align: 32)
!1111 = !DIDerivedType(tag: DW_TAG_member, name: "y", scope: !1108, file: !4, line: 3887, baseType: !911, size: 32, align: 32, offset: 32)
!1112 = !DIDerivedType(tag: DW_TAG_member, name: "w", scope: !1108, file: !4, line: 3888, baseType: !911, size: 32, align: 32, offset: 64)
!1113 = !DIDerivedType(tag: DW_TAG_member, name: "h", scope: !1108, file: !4, line: 3889, baseType: !911, size: 32, align: 32, offset: 96)
!1114 = !DIDerivedType(tag: DW_TAG_member, name: "nb_colors", scope: !1108, file: !4, line: 3890, baseType: !911, size: 32, align: 32, offset: 128)
...
!1124 = !DICompositeType(tag: DW_TAG_array_type, baseType: !911, size: 256, align: 32, elements: !1121)
...
!1128 = !DICompositeType(tag: DW_TAG_array_type, baseType: !911, size: 128, align: 32, elements: !942)
...
!1133 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !1108, file: !4, line: 3917, baseType: !911, size: 32, align: 32, offset: 1536)
!1134 = !DIDerivedType(tag: DW_TAG_member, name: "pts", scope: !1096, file: !4, line: 3926, baseType: !928, size: 64, align: 64, offset: 192)
...
!1154 = !DIDerivedType(tag: DW_TAG_member, name: "size", scope: !1147, file: !1146, line: 93, baseType: !911, size: 32, align: 32, offset: 128)
!1155 = !DIDerivedType(tag: DW_TAG_member, name: "pts", scope: !1141, file: !4, line: 1461, baseType: !928, size: 64, align: 64, offset: 64)
!1156 = !DIDerivedType(tag: DW_TAG_member, name: "dts", scope: !1141, file: !4, line: 1467, baseType: !928, size: 64, align: 64, offset: 128)
!1157 = !DIDerivedType(tag: DW_TAG_member, name: "data", scope: !1141, file: !4, line: 1468, baseType: !1093, size: 64, align: 64, offset: 192)
!1158 = !DIDerivedType(tag: DW_TAG_member, name: "size", scope: !1141, file: !4, line: 1469, baseType: !911, size: 32, align: 32, offset: 256)
!1159 = !DIDerivedType(tag: DW_TAG_member, name: "stream_index", scope: !1141, file: !4, line: 1470, baseType: !911, size: 32, align: 32, offset: 288)
!1160 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !1141, file: !4, line: 1474, baseType: !911, size: 32, align: 32, offset: 320)
...
!1167 = !DIDerivedType(tag: DW_TAG_member, name: "size", scope: !1164, file: !4, line: 1413, baseType: !911, size: 32, align: 32, offset: 64)
!1168 = !DIDerivedType(tag: DW_TAG_member, name: "type", scope: !1164, file: !4, line: 1414, baseType: !731, size: 32, align: 32, offset: 96)
!1169 = !DIDerivedType(tag: DW_TAG_member, name: "side_data_elems", scope: !1141, file: !4, line: 1480, baseType: !911, size: 32, align: 32, offset: 448)
!1170 = !DIDerivedType(tag: DW_TAG_member, name: "duration", scope: !1141, file: !4, line: 1486, baseType: !928, size: 64, align: 64, offset: 512)
!1171 = !DIDerivedType(tag: DW_TAG_member, name: "pos", scope: !1141, file: !4, line: 1488, baseType: !928, size: 64, align: 64, offset: 576)
!1172 = !DIDerivedType(tag: DW_TAG_member, name: "convergence_duration", scope: !1141, file: !4, line: 1497, baseType: !928, size: 64, align: 64, offset: 640)
...
!1182 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !1176, file: !772, line: 326, baseType: !911, size: 32, align: 32, offset: 832)
!1183 = !DIDerivedType(tag: DW_TAG_member, name: "height", scope: !1176, file: !772, line: 326, baseType: !911, size: 32, align: 32, offset: 864)
!1184 = !DIDerivedType(tag: DW_TAG_member, name: "nb_samples", scope: !1176, file: !772, line: 334, baseType: !911, size: 32, align: 32, offset: 896)
!1185 = !DIDerivedType(tag: DW_TAG_member, name: "format", scope: !1176, file: !772, line: 341, baseType: !911, size: 32, align: 32, offset: 928)
!1186 = !DIDerivedType(tag: DW_TAG_member, name: "key_frame", scope: !1176, file: !772, line: 346, baseType: !911, size: 32, align: 32, offset: 960)
...
!1189 = !DIDerivedType(tag: DW_TAG_member, name: "pts", scope: !1176, file: !772, line: 361, baseType: !928, size: 64, align: 64, offset: 1088)
!1190 = !DIDerivedType(tag: DW_TAG_member, name: "pkt_pts", scope: !1176, file: !772, line: 369, baseType: !928, size: 64, align: 64, offset: 1152)
!1191 = !DIDerivedType(tag: DW_TAG_member, name: "pkt_dts", scope: !1176, file: !772, line: 377, baseType: !928, size: 64, align: 64, offset: 1216)
!1192 = !DIDerivedType(tag: DW_TAG_member, name: "coded_picture_number", scope: !1176, file: !772, line: 382, baseType: !911, size: 32, align: 32, offset: 1280)
!1193 = !DIDerivedType(tag: DW_TAG_member, name: "display_picture_number", scope: !1176, file: !772, line: 386, baseType: !911, size: 32, align: 32, offset: 1312)
!1194 = !DIDerivedType(tag: DW_TAG_member, name: "quality", scope: !1176, file: !772, line: 391, baseType: !911, size: 32, align: 32, offset: 1344)
!1195 = !DIDerivedType(tag: DW_TAG_member, name: "opaque", scope: !1176, file: !772, line: 396, baseType: !924, size: 64, align: 64, offset: 1408)
...
!1198 = !DIDerivedType(tag: DW_TAG_member, name: "repeat_pict", scope: !1176, file: !772, line: 410, baseType: !911, size: 32, align: 32, offset: 1984)
!1199 = !DIDerivedType(tag: DW_TAG_member, name: "interlaced_frame", scope: !1176, file: !772, line: 415, baseType: !911, size: 32, align: 32, offset: 2016)
!1200 = !DIDerivedType(tag: DW_TAG_member, name: "top_field_first", scope: !1176, file: !772, line: 420, baseType: !911, size: 32, align: 32, offset: 2048)
!1201 = !DIDerivedType(tag: DW_TAG_member, name: "palette_has_changed", scope: !1176, file: !772, line: 425, baseType: !911, size: 32, align: 32, offset: 2080)
!1202 = !DIDerivedType(tag: DW_TAG_member, name: "reordered_opaque", scope: !1176, file: !772, line: 435, baseType: !928, size: 64, align: 64, offset: 2112)
!1203 = !DIDerivedType(tag: DW_TAG_member, name: "sample_rate", scope: !1176, file: !772, line: 440, baseType: !911, size: 32, align: 32, offset: 2176)
...
!1209 = !DIDerivedType(tag: DW_TAG_member, name: "nb_extended_buf", scope: !1176, file: !772, line: 477, baseType: !911, size: 32, align: 32, offset: 2880)
...
!1218 = !DIDerivedType(tag: DW_TAG_member, name: "size", scope: !1214, file: !772, line: 204, baseType: !911, size: 32, align: 32, offset: 128)
...
!1225 = !DIDerivedType(tag: DW_TAG_member, name: "nb_side_data", scope: !1176, file: !772, line: 480, baseType: !911, size: 32, align: 32, offset: 3008)
!1226 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !1176, file: !772, line: 505, baseType: !911, size: 32, align: 32, offset: 3040)
...
!1232 = !DIDerivedType(tag: DW_TAG_member, name: "best_effort_timestamp", scope: !1176, file: !772, line: 532, baseType: !928, size: 64, align: 64, offset: 3264)
!1233 = !DIDerivedType(tag: DW_TAG_member, name: "pkt_pos", scope: !1176, file: !772, line: 539, baseType: !928, size: 64, align: 64, offset: 3328)
!1234 = !DIDerivedType(tag: DW_TAG_member, name: "pkt_duration", scope: !1176, file: !772, line: 547, baseType: !928, size: 64, align: 64, offset: 3392)
...
!1236 = !DIDerivedType(tag: DW_TAG_member, name: "decode_error_flags", scope: !1176, file: !772, line: 563, baseType: !911, size: 32, align: 32, offset: 3520)
!1237 = !DIDerivedType(tag: DW_TAG_member, name: "channels", scope: !1176, file: !772, line: 572, baseType: !911, size: 32, align: 32, offset: 3552)
!1238 = !DIDerivedType(tag: DW_TAG_member, name: "pkt_size", scope: !1176, file: !772, line: 581, baseType: !911, size: 32, align: 32, offset: 3584)
...
!1241 = !DIDerivedType(tag: DW_TAG_typedef, name: "int8_t", file: !901, line: 36, baseType: !1242)
!1242 = !DIBasicType(name: "signed char", size: 8, align: 8, encoding: DW_ATE_signed_char)
!1243 = !DIDerivedType(tag: DW_TAG_member, name: "qstride", scope: !1176, file: !772, line: 593, baseType: !911, size: 32, align: 32, offset: 3712)
!1244 = !DIDerivedType(tag: DW_TAG_member, name: "qscale_type", scope: !1176, file: !772, line: 596, baseType: !911, size: 32, align: 32, offset: 3744)
...
!1255 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !911, size: 64, align: 64)
...
!1277 = !{null, !970}
!1278 = !DIDerivedType(tag: DW_TAG_member, name: "caps_internal", scope: !1023, file: !4, line: 3594, baseType: !911, size: 32, align: 32, offset: 1792)
...
!1286 = !DIDerivedType(tag: DW_TAG_member, name: "codec_tag", scope: !972, file: !4, line: 1581, baseType: !1101, size: 32, align: 32, offset: 224)
!1287 = !DIDerivedType(tag: DW_TAG_member, name: "priv_data", scope: !972, file: !4, line: 1583, baseType: !924, size: 64, align: 64, offset: 256)
...
!1291 = !DIDerivedType(tag: DW_TAG_member, name: "opaque", scope: !972, file: !4, line: 1598, baseType: !924, size: 64, align: 64, offset: 384)
!1292 = !DIDerivedType(tag: DW_TAG_member, name: "bit_rate", scope: !972, file: !4, line: 1606, baseType: !928, size: 64, align: 64, offset: 448)
!1293 = !DIDerivedType(tag: DW_TAG_member, name: "bit_rate_tolerance", scope: !972, file: !4, line: 1614, baseType: !911, size: 32, align: 32, offset: 512)
!1294 = !DIDerivedType(tag: DW_TAG_member, name: "global_quality", scope: !972, file: !4, line: 1622, baseType: !911, size: 32, align: 32, offset: 544)
!1295 = !DIDerivedType(tag: DW_TAG_member, name: "compression_level", scope: !972, file: !4, line: 1628, baseType: !911, size: 32, align: 32, offset: 576)
!1296 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !972, file: !4, line: 1636, baseType: !911, size: 32, align: 32, offset: 608)
!1297 = !DIDerivedType(tag: DW_TAG_member, name: "flags2", scope: !972, file: !4, line: 1643, baseType: !911, size: 32, align: 32, offset: 640)
!1298 = !DIDerivedType(tag: DW_TAG_member, name: "extradata", scope: !972, file: !4, line: 1657, baseType: !1093, size: 64, align: 64, offset: 704)
!1299 = !DIDerivedType(tag: DW_TAG_member, name: "extradata_size", scope: !972, file: !4, line: 1658, baseType: !911, size: 32, align: 32, offset: 768)
!1300 = !DIDerivedType(tag: DW_TAG_member, name: "time_base", scope: !972, file: !4, line: 1679, baseType: !1033, size: 64, align: 32, offset: 800)
!1301 = !DIDerivedType(tag: DW_TAG_member, name: "ticks_per_frame", scope: !972, file: !4, line: 1688, baseType: !911, size: 32, align: 32, offset: 864)
!1302 = !DIDerivedType(tag: DW_TAG_member, name: "delay", scope: !972, file: !4, line: 1712, baseType: !911, size: 32, align: 32, offset: 896)
!1303 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !972, file: !4, line: 1729, baseType: !911, size: 32, align: 32, offset: 928)
!1304 = !DIDerivedType(tag: DW_TAG_member, name: "height", scope: !972, file: !4, line: 1729, baseType: !911, size: 32, align: 32, offset: 960)
!1305 = !DIDerivedType(tag: DW_TAG_member, name: "coded_width", scope: !972, file: !4, line: 1744, baseType: !911, size: 32, align: 32, offset: 992)
!1306 = !DIDerivedType(tag: DW_TAG_member, name: "coded_height", scope: !972, file: !4, line: 1744, baseType: !911, size: 32, align: 32, offset: 1024)
!1307 = !DIDerivedType(tag: DW_TAG_member, name: "gop_size", scope: !972, file: !4, line: 1751, baseType: !911, size: 32, align: 32, offset: 1056)
...
!1312 = !{null, !1313, !1173, !1255, !911, !911, !911}
...
!1317 = !{!508, !1313, !1040}
!1318 = !DIDerivedType(tag: DW_TAG_member, name: "max_b_frames", scope: !972, file: !4, line: 1816, baseType: !911, size: 32, align: 32, offset: 1280)
...
!1321 = !DIDerivedType(tag: DW_TAG_member, name: "b_frame_strategy", scope: !972, file: !4, line: 1830, baseType: !911, size: 32, align: 32, offset: 1344)
...
!1323 = !DIDerivedType(tag: DW_TAG_member, name: "has_b_frames", scope: !972, file: !4, line: 1846, baseType: !911, size: 32, align: 32, offset: 1408)
!1324 = !DIDerivedType(tag: DW_TAG_member, name: "mpeg_quant", scope: !972, file: !4, line: 1851, baseType: !911, size: 32, align: 32, offset: 1440)
...
!1332 = !DIDerivedType(tag: DW_TAG_member, name: "slice_count", scope: !972, file: !4, line: 1910, baseType: !911, size: 32, align: 32, offset: 1696)
!1333 = !DIDerivedType(tag: DW_TAG_member, name: "prediction_method", scope: !972, file: !4, line: 1915, baseType: !911, size: 32, align: 32, offset: 1728)
...
!1336 = !DIDerivedType(tag: DW_TAG_member, name: "me_cmp", scope: !972, file: !4, line: 1942, baseType: !911, size: 32, align: 32, offset: 1920)
!1337 = !DIDerivedType(tag: DW_TAG_member, name: "me_sub_cmp", scope: !972, file: !4, line: 1948, baseType: !911, size: 32, align: 32, offset: 1952)
!1338 = !DIDerivedType(tag: DW_TAG_member, name: "mb_cmp", scope: !972, file: !4, line: 1954, baseType: !911, size: 32, align: 32, offset: 1984)
!1339 = !DIDerivedType(tag: DW_TAG_member, name: "ildct_cmp", scope: !972, file: !4, line: 1960, baseType: !911, size: 32, align: 32, offset: 2016)
!1340 = !DIDerivedType(tag: DW_TAG_member, name: "dia_size", scope: !972, file: !4, line: 1984, baseType: !911, size: 32, align: 32, offset: 2048)
!1341 = !DIDerivedType(tag: DW_TAG_member, name: "last_predictor_count", scope: !972, file: !4, line: 1991, baseType: !911, size: 32, align: 32, offset: 2080)
!1342 = !DIDerivedType(tag: DW_TAG_member, name: "pre_me", scope: !972, file: !4, line: 1996, baseType: !911, size: 32, align: 32, offset: 2112)
!1343 = !DIDerivedType(tag: DW_TAG_member, name: "me_pre_cmp", scope: !972, file: !4, line: 2004, baseType: !911, size: 32, align: 32, offset: 2144)
!1344 = !DIDerivedType(tag: DW_TAG_member, name: "pre_dia_size", scope: !972, file: !4, line: 2011, baseType: !911, size: 32, align: 32, offset: 2176)
!1345 = !DIDerivedType(tag: DW_TAG_member, name: "me_subpel_quality", scope: !972, file: !4, line: 2018, baseType: !911, size: 32, align: 32, offset: 2208)
!1346 = !DIDerivedType(tag: DW_TAG_member, name: "me_range", scope: !972, file: !4, line: 2027, baseType: !911, size: 32, align: 32, offset: 2240)
!1347 = !DIDerivedType(tag: DW_TAG_member, name: "slice_flags", scope: !972, file: !4, line: 2034, baseType: !911, size: 32, align: 32, offset: 2272)
!1348 = !DIDerivedType(tag: DW_TAG_member, name: "mb_decision", scope: !972, file: !4, line: 2044, baseType: !911, size: 32, align: 32, offset: 2304)
...
!1350 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !900, size: 64, align: 64)
...
!1352 = !DIDerivedType(tag: DW_TAG_member, name: "scenechange_threshold", scope: !972, file: !4, line: 2066, baseType: !911, size: 32, align: 32, offset: 2496)
!1353 = !DIDerivedType(tag: DW_TAG_member, name: "noise_reduction", scope: !972, file: !4, line: 2070, baseType: !911, size: 32, align: 32, offset: 2528)
!1354 = !DIDerivedType(tag: DW_TAG_member, name: "intra_dc_precision", scope: !972, file: !4, line: 2078, baseType: !911, size: 32, align: 32, offset: 2560)
!1355 = !DIDerivedType(tag: DW_TAG_member, name: "skip_top", scope: !972, file: !4, line: 2085, baseType: !911, size: 32, align: 32, offset: 2592)
!1356 = !DIDerivedType(tag: DW_TAG_member, name: "skip_bottom", scope: !972, file: !4, line: 2092, baseType: !911, size: 32, align: 32, offset: 2624)
!1357 = !DIDerivedType(tag: DW_TAG_member, name: "mb_lmin", scope: !972, file: !4, line: 2099, baseType: !911, size: 32, align: 32, offset: 2656)
!1358 = !DIDerivedType(tag: DW_TAG_member, name: "mb_lmax", scope: !972, file: !4, line: 2106, baseType: !911, size: 32, align: 32, offset: 2688)
!1359 = !DIDerivedType(tag: DW_TAG_member, name: "me_penalty_compensation", scope: !972, file: !4, line: 2113, baseType: !911, size: 32, align: 32, offset: 2720)
!1360 = !DIDerivedType(tag: DW_TAG_member, name: "bidir_refine", scope: !972, file: !4, line: 2120, baseType: !911, size: 32, align: 32, offset: 2752)
!1361 = !DIDerivedType(tag: DW_TAG_member, name: "brd_scale", scope: !972, file: !4, line: 2125, baseType: !911, size: 32, align: 32, offset: 2784)
!1362 = !DIDerivedType(tag: DW_TAG_member, name: "keyint_min", scope: !972, file: !4, line: 2133, baseType: !911, size: 32, align: 32, offset: 2816)
!1363 = !DIDerivedType(tag: DW_TAG_member, name: "refs", scope: !972, file: !4, line: 2140, baseType: !911, size: 32, align: 32, offset: 2848)
!1364 = !DIDerivedType(tag: DW_TAG_member, name: "chromaoffset", scope: !972, file: !4, line: 2145, baseType: !911, size: 32, align: 32, offset: 2880)
!1365 = !DIDerivedType(tag: DW_TAG_member, name: "mv0_threshold", scope: !972, file: !4, line: 2153, baseType: !911, size: 32, align: 32, offset: 2912)
!1366 = !DIDerivedType(tag: DW_TAG_member, name: "b_sensitivity", scope: !972, file: !4, line: 2158, baseType: !911, size: 32, align: 32, offset: 2944)
...
!1372 = !DIDerivedType(tag: DW_TAG_member, name: "slices", scope: !972, file: !4, line: 2203, baseType: !911, size: 32, align: 32, offset: 3136)
!1373 = !DIDerivedType(tag: DW_TAG_member, name: "field_order", scope: !972, file: !4, line: 2209, baseType: !3, size: 32, align: 32, offset: 3168)
!1374 = !DIDerivedType(tag: DW_TAG_member, name: "sample_rate", scope: !972, file: !4, line: 2212, baseType: !911, size: 32, align: 32, offset: 3200)
!1375 = !DIDerivedType(tag: DW_TAG_member, name: "channels", scope: !972, file: !4, line: 2213, baseType: !911, size: 32, align: 32, offset: 3232)
...
!1377 = !DIDerivedType(tag: DW_TAG_member, name: "frame_size", scope: !972, file: !4, line: 2232, baseType: !911, size: 32, align: 32, offset: 3296)
!1378 = !DIDerivedType(tag: DW_TAG_member, name: "frame_number", scope: !972, file: !4, line: 2243, baseType: !911, size: 32, align: 32, offset: 3328)
!1379 = !DIDerivedType(tag: DW_TAG_member, name: "block_align", scope: !972, file: !4, line: 2249, baseType: !911, size: 32, align: 32, offset: 3360)
!1380 = !DIDerivedType(tag: DW_TAG_member, name: "cutoff", scope: !972, file: !4, line: 2256, baseType: !911, size: 32, align: 32, offset: 3392)
...
!1388 = !{!911, !1313, !1273, !911}
!1389 = !DIDerivedType(tag: DW_TAG_member, name: "refcounted_frames", scope: !972, file: !4, line: 2383, baseType: !911, size: 32, align: 32, offset: 3712)
...
!1392 = !DIDerivedType(tag: DW_TAG_member, name: "qmin", scope: !972, file: !4, line: 2394, baseType: !911, size: 32, align: 32, offset: 3808)
!1393 = !DIDerivedType(tag: DW_TAG_member, name: "qmax", scope: !972, file: !4, line: 2401, baseType: !911, size: 32, align: 32, offset: 3840)
!1394 = !DIDerivedType(tag: DW_TAG_member, name: "max_qdiff", scope: !972, file: !4, line: 2408, baseType: !911, size: 32, align: 32, offset: 3872)
!1395 = !DIDerivedType(tag: DW_TAG_member, name: "rc_buffer_size", scope: !972, file: !4, line: 2415, baseType: !911, size: 32, align: 32, offset: 3904)
!1396 = !DIDerivedType(tag: DW_TAG_member, name: "rc_override_count", scope: !972, file: !4, line: 2422, baseType: !911, size: 32, align: 32, offset: 3936)
...
!1402 = !DIDerivedType(tag: DW_TAG_member, name: "start_frame", scope: !1400, file: !4, line: 827, baseType: !911, size: 32, align: 32)
!1403 = !DIDerivedType(tag: DW_TAG_member, name: "end_frame", scope: !1400, file: !4, line: 828, baseType: !911, size: 32, align: 32, offset: 32)
!1404 = !DIDerivedType(tag: DW_TAG_member, name: "qscale", scope: !1400, file: !4, line: 829, baseType: !911, size: 32, align: 32, offset: 64)
...
!1406 = !DIDerivedType(tag: DW_TAG_member, name: "rc_max_rate", scope: !972, file: !4, line: 2430, baseType: !928, size: 64, align: 64, offset: 4032)
!1407 = !DIDerivedType(tag: DW_TAG_member, name: "rc_min_rate", scope: !972, file: !4, line: 2437, baseType: !928, size: 64, align: 64, offset: 4096)
...
!1410 = !DIDerivedType(tag: DW_TAG_member, name: "rc_initial_buffer_occupancy", scope: !972, file: !4, line: 2458, baseType: !911, size: 32, align: 32, offset: 4224)
!1411 = !DIDerivedType(tag: DW_TAG_member, name: "coder_type", scope: !972, file: !4, line: 2469, baseType: !911, size: 32, align: 32, offset: 4256)
!1412 = !DIDerivedType(tag: DW_TAG_member, name: "context_model", scope: !972, file: !4, line: 2475, baseType: !911, size: 32, align: 32, offset: 4288)
!1413 = !DIDerivedType(tag: DW_TAG_member, name: "frame_skip_threshold", scope: !972, file: !4, line: 2481, baseType: !911, size: 32, align: 32, offset: 4320)
!1414 = !DIDerivedType(tag: DW_TAG_member, name: "frame_skip_factor", scope: !972, file: !4, line: 2485, baseType: !911, size: 32, align: 32, offset: 4352)
!1415 = !DIDerivedType(tag: DW_TAG_member, name: "frame_skip_exp", scope: !972, file: !4, line: 2489, baseType: !911, size: 32, align: 32, offset: 4384)
!1416 = !DIDerivedType(tag: DW_TAG_member, name: "frame_skip_cmp", scope: !972, file: !4, line: 2493, baseType: !911, size: 32, align: 32, offset: 4416)
!1417 = !DIDerivedType(tag: DW_TAG_member, name: "trellis", scope: !972, file: !4, line: 2501, baseType: !911, size: 32, align: 32, offset: 4448)
!1418 = !DIDerivedType(tag: DW_TAG_member, name: "min_prediction_order", scope: !972, file: !4, line: 2506, baseType: !911, size: 32, align: 32, offset: 4480)
!1419 = !DIDerivedType(tag: DW_TAG_member, name: "max_prediction_order", scope: !972, file: !4, line: 2510, baseType: !911, size: 32, align: 32, offset: 4512)
!1420 = !DIDerivedType(tag: DW_TAG_member, name: "timecode_frame_start", scope: !972, file: !4, line: 2514, baseType: !928, size: 64, align: 64, offset: 4544)
...
!1424 = !{null, !1313, !924, !911, !911}
!1425 = !DIDerivedType(tag: DW_TAG_member, name: "rtp_payload_size", scope: !972, file: !4, line: 2534, baseType: !911, size: 32, align: 32, offset: 4672)
!1426 = !DIDerivedType(tag: DW_TAG_member, name: "mv_bits", scope: !972, file: !4, line: 2545, baseType: !911, size: 32, align: 32, offset: 4704)
!1427 = !DIDerivedType(tag: DW_TAG_member, name: "header_bits", scope: !972, file: !4, line: 2547, baseType: !911, size: 32, align: 32, offset: 4736)
!1428 = !DIDerivedType(tag: DW_TAG_member, name: "i_tex_bits", scope: !972, file: !4, line: 2549, baseType: !911, size: 32, align: 32, offset: 4768)
!1429 = !DIDerivedType(tag: DW_TAG_member, name: "p_tex_bits", scope: !972, file: !4, line: 2551, baseType: !911, size: 32, align: 32, offset: 4800)
!1430 = !DIDerivedType(tag: DW_TAG_member, name: "i_count", scope: !972, file: !4, line: 2553, baseType: !911, size: 32, align: 32, offset: 4832)
!1431 = !DIDerivedType(tag: DW_TAG_member, name: "p_count", scope: !972, file: !4, line: 2555, baseType: !911, size: 32, align: 32, offset: 4864)
!1432 = !DIDerivedType(tag: DW_TAG_member, name: "skip_count", scope: !972, file: !4, line: 2557, baseType: !911, size: 32, align: 32, offset: 4896)
!1433 = !DIDerivedType(tag: DW_TAG_member, name: "misc_bits", scope: !972, file: !4, line: 2559, baseType: !911, size: 32, align: 32, offset: 4928)
!1434 = !DIDerivedType(tag: DW_TAG_member, name: "frame_bits", scope: !972, file: !4, line: 2563, baseType: !911, size: 32, align: 32, offset: 4960)
...
!1437 = !DIDerivedType(tag: DW_TAG_member, name: "workaround_bugs", scope: !972, file: !4, line: 2586, baseType: !911, size: 32, align: 32, offset: 5120)
!1438 = !DIDerivedType(tag: DW_TAG_member, name: "strict_std_compliance", scope: !972, file: !4, line: 2615, baseType: !911, size: 32, align: 32, offset: 5152)
!1439 = !DIDerivedType(tag: DW_TAG_member, name: "error_concealment", scope: !972, file: !4, line: 2627, baseType: !911, size: 32, align: 32, offset: 5184)
!1440 = !DIDerivedType(tag: DW_TAG_member, name: "debug", scope: !972, file: !4, line: 2637, baseType: !911, size: 32, align: 32, offset: 5216)
!1441 = !DIDerivedType(tag: DW_TAG_member, name: "err_recognition", scope: !972, file: !4, line: 2681, baseType: !911, size: 32, align: 32, offset: 5248)
!1442 = !DIDerivedType(tag: DW_TAG_member, name: "reordered_opaque", scope: !972, file: !4, line: 2709, baseType: !928, size: 64, align: 64, offset: 5312)
...
!1452 = !DIDerivedType(tag: DW_TAG_member, name: "capabilities", scope: !1446, file: !4, line: 3669, baseType: !911, size: 32, align: 32, offset: 160)
...
!1466 = !DIDerivedType(tag: DW_TAG_member, name: "frame_priv_data_size", scope: !1446, file: !4, line: 3746, baseType: !911, size: 32, align: 32, offset: 512)
...
!1475 = !DIDerivedType(tag: DW_TAG_member, name: "priv_data_size", scope: !1446, file: !4, line: 3780, baseType: !911, size: 32, align: 32, offset: 768)
!1476 = !DIDerivedType(tag: DW_TAG_member, name: "caps_internal", scope: !1446, file: !4, line: 3785, baseType: !911, size: 32, align: 32, offset: 800)
...
!1480 = !{!911, !970, !1144}
!1481 = !DIDerivedType(tag: DW_TAG_member, name: "hwaccel_context", scope: !972, file: !4, line: 2728, baseType: !924, size: 64, align: 64, offset: 5440)
!1482 = !DIDerivedType(tag: DW_TAG_member, name: "error", scope: !972, file: !4, line: 2735, baseType: !1197, size: 512, align: 64, offset: 5504)
!1483 = !DIDerivedType(tag: DW_TAG_member, name: "dct_algo", scope: !972, file: !4, line: 2742, baseType: !911, size: 32, align: 32, offset: 6016)
!1484 = !DIDerivedType(tag: DW_TAG_member, name: "idct_algo", scope: !972, file: !4, line: 2755, baseType: !911, size: 32, align: 32, offset: 6048)
!1485 = !DIDerivedType(tag: DW_TAG_member, name: "bits_per_coded_sample", scope: !972, file: !4, line: 2776, baseType: !911, size: 32, align: 32, offset: 6080)
!1486 = !DIDerivedType(tag: DW_TAG_member, name: "bits_per_raw_sample", scope: !972, file: !4, line: 2783, baseType: !911, size: 32, align: 32, offset: 6112)
!1487 = !DIDerivedType(tag: DW_TAG_member, name: "lowres", scope: !972, file: !4, line: 2791, baseType: !911, size: 32, align: 32, offset: 6144)
...
!1489 = !DIDerivedType(tag: DW_TAG_member, name: "thread_count", scope: !972, file: !4, line: 2811, baseType: !911, size: 32, align: 32, offset: 6272)
!1490 = !DIDerivedType(tag: DW_TAG_member, name: "thread_type", scope: !972, file: !4, line: 2821, baseType: !911, size: 32, align: 32, offset: 6304)
!1491 = !DIDerivedType(tag: DW_TAG_member, name: "active_thread_type", scope: !972, file: !4, line: 2830, baseType: !911, size: 32, align: 32, offset: 6336)
!1492 = !DIDerivedType(tag: DW_TAG_member, name: "thread_safe_callbacks", scope: !972, file: !4, line: 2840, baseType: !911, size: 32, align: 32, offset: 6368)
...
!1496 = !{!911, !1313, !1497, !924, !1255, !911, !911}
...
!1503 = !{!911, !1313, !1504, !924, !1255, !911}
!1504 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1505, size: 64, align: 64)
!1505 = !DISubroutineType(types: !1506)
!1506 = !{!911, !1313, !924, !911, !911}
!1507 = !DIDerivedType(tag: DW_TAG_member, name: "nsse_weight", scope: !972, file: !4, line: 2878, baseType: !911, size: 32, align: 32, offset: 6528)
!1508 = !DIDerivedType(tag: DW_TAG_member, name: "profile", scope: !972, file: !4, line: 2885, baseType: !911, size: 32, align: 32, offset: 6560)
!1509 = !DIDerivedType(tag: DW_TAG_member, name: "level", scope: !972, file: !4, line: 3005, baseType: !911, size: 32, align: 32, offset: 6592)
...
!1514 = !DIDerivedType(tag: DW_TAG_member, name: "subtitle_header_size", scope: !972, file: !4, line: 3038, baseType: !911, size: 32, align: 32, offset: 6784)
...
!1516 = !DIDerivedType(tag: DW_TAG_member, name: "side_data_only_packets", scope: !972, file: !4, line: 3065, baseType: !911, size: 32, align: 32, offset: 6912)
!1517 = !DIDerivedType(tag: DW_TAG_member, name: "initial_padding", scope: !972, file: !4, line: 3083, baseType: !911, size: 32, align: 32, offset: 6944)
...
!1531 = !DIDerivedType(tag: DW_TAG_member, name: "props", scope: !1525, file: !4, line: 728, baseType: !911, size: 32, align: 32, offset: 192)
...
!1538 = !DIDerivedType(tag: DW_TAG_member, name: "pts_correction_num_faulty_pts", scope: !972, file: !4, line: 3129, baseType: !928, size: 64, align: 64, offset: 7232)
!1539 = !DIDerivedType(tag: DW_TAG_member, name: "pts_correction_num_faulty_dts", scope: !972, file: !4, line: 3130, baseType: !928, size: 64, align: 64, offset: 7296)
!1540 = !DIDerivedType(tag: DW_TAG_member, name: "pts_correction_last_pts", scope: !972, file: !4, line: 3131, baseType: !928, size: 64, align: 64, offset: 7360)
!1541 = !DIDerivedType(tag: DW_TAG_member, name: "pts_correction_last_dts", scope: !972, file: !4, line: 3132, baseType: !928, size: 64, align: 64, offset: 7424)
...
!1543 = !DIDerivedType(tag: DW_TAG_member, name: "sub_charenc_mode", scope: !972, file: !4, line: 3147, baseType: !911, size: 32, align: 32, offset: 7552)
!1544 = !DIDerivedType(tag: DW_TAG_member, name: "skip_alpha", scope: !972, file: !4, line: 3165, baseType: !911, size: 32, align: 32, offset: 7584)
!1545 = !DIDerivedType(tag: DW_TAG_member, name: "seek_preroll", scope: !972, file: !4, line: 3172, baseType: !911, size: 32, align: 32, offset: 7616)
!1546 = !DIDerivedType(tag: DW_TAG_member, name: "debug_mv", scope: !972, file: !4, line: 3180, baseType: !911, size: 32, align: 32, offset: 7648)
...
!1550 = !DIDerivedType(tag: DW_TAG_member, name: "properties", scope: !972, file: !4, line: 3214, baseType: !1101, size: 32, align: 32, offset: 7872)
...
!1552 = !DIDerivedType(tag: DW_TAG_member, name: "nb_coded_side_data", scope: !972, file: !4, line: 3225, baseType: !911, size: 32, align: 32, offset: 8000)
...
!1554 = !DIDerivedType(tag: DW_TAG_member, name: "sub_text_format", scope: !972, file: !4, line: 3256, baseType: !911, size: 32, align: 32, offset: 8128)
!1555 = !DIDerivedType(tag: DW_TAG_member, name: "trailing_padding", scope: !972, file: !4, line: 3271, baseType: !911, size: 32, align: 32, offset: 8160)
!1556 = !DIDerivedType(tag: DW_TAG_member, name: "max_pixels", scope: !972, file: !4, line: 3279, baseType: !928, size: 64, align: 64, offset: 8192)
...
!1558 = !DIDerivedType(tag: DW_TAG_member, name: "hwaccel_flags", scope: !972, file: !4, line: 3310, baseType: !911, size: 32, align: 32, offset: 8320)
!1559 = !DIDerivedType(tag: DW_TAG_member, name: "apply_cropping", scope: !972, file: !4, line: 3337, baseType: !911, size: 32, align: 32, offset: 8352)
!1560 = !DIDerivedType(tag: DW_TAG_member, name: "extra_hw_frames", scope: !972, file: !4, line: 3351, baseType: !911, size: 32, align: 32, offset: 8384)
!1561 = !DIDerivedType(tag: DW_TAG_member, name: "discard_damaged_percentage", scope: !972, file: !4, line: 3359, baseType: !911, size: 32, align: 32, offset: 8416)
!1562 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1458, size: 64, align: 64)
!1563 = !DIDerivedType(tag: DW_TAG_member, name: "parser_close", scope: !907, file: !4, line: 5269, baseType: !1564, size: 64, align: 64, offset: 320)
!1564 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1565, size: 64, align: 64)
!1565 = !DISubroutineType(types: !1566)
!1566 = !{null, !919}
!1567 = !DIDerivedType(tag: DW_TAG_member, name: "split", scope: !907, file: !4, line: 5270, baseType: !1568, size: 64, align: 64, offset: 384)
!1568 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1569, size: 64, align: 64)
!1569 = !DISubroutineType(types: !1570)
!1570 = !{!911, !970, !1458, !911}
!1571 = !DIDerivedType(tag: DW_TAG_member, name: "next", scope: !907, file: !4, line: 5271, baseType: !926, size: 64, align: 64, offset: 448)
!1572 = !{i32 2, !"Dwarf Version", i32 4}
!1573 = !{i32 2, !"Debug Info Version", i32 3}
!1574 = !{!"clang version 3.9.0 (tags/RELEASE_390/final)"}
!1575 = distinct !DISubprogram(name: "cook_parse", scope: !905, file: !905, line: 37, type: !968, isLocal: true, isDefinition: true, scopeLine: 40, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1576)
!1576 = !{}
!1577 = !DILocalVariable(name: "x", arg: 1, scope: !1578, file: !1579, line: 58, type: !900)
!1578 = distinct !DISubprogram(name: "av_bswap16", scope: !1579, file: !1579, line: 58, type: !1580, isLocal: true, isDefinition: true, scopeLine: 59, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1576)
!1579 = !DIFile(filename: "./libavutil/bswap.h", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs")
!1580 = !DISubroutineType(types: !1581)
!1581 = !{!900, !900}
!1582 = !DIExpression()
!1583 = !DILocation(line: 58, column: 98, scope: !1578, inlinedAt: !1584)
!1584 = distinct !DILocation(line: 45, column: 23, scope: !1585)
!1585 = distinct !DILexicalBlock(scope: !1575, file: !905, line: 43, column: 9)
!1586 = !DILocalVariable(name: "s1", arg: 1, scope: !1575, file: !905, line: 37, type: !919)
!1587 = !DILocation(line: 37, column: 45, scope: !1575)
!1588 = !DILocalVariable(name: "avctx", arg: 2, scope: !1575, file: !905, line: 37, type: !970)
!1589 = !DILocation(line: 37, column: 65, scope: !1575)
!1590 = !DILocalVariable(name: "poutbuf", arg: 3, scope: !1575, file: !905, line: 38, type: !1562)
!1591 = !DILocation(line: 38, column: 39, scope: !1575)
!1592 = !DILocalVariable(name: "poutbuf_size", arg: 4, scope: !1575, file: !905, line: 38, type: !1255)
!1593 = !DILocation(line: 38, column: 53, scope: !1575)
!1594 = !DILocalVariable(name: "buf", arg: 5, scope: !1575, file: !905, line: 39, type: !1458)
!1595 = !DILocation(line: 39, column: 38, scope: !1575)
!1596 = !DILocalVariable(name: "buf_size", arg: 6, scope: !1575, file: !905, line: 39, type: !911)
!1597 = !DILocation(line: 39, column: 47, scope: !1575)
!1598 = !DILocalVariable(name: "s", scope: !1575, file: !905, line: 41, type: !1599)
!1599 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1600, size: 64, align: 64)
!1600 = !DIDerivedType(tag: DW_TAG_typedef, name: "CookParseContext", file: !905, line: 35, baseType: !1601)
!1601 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "CookParseContext", file: !905, line: 33, size: 32, align: 32, elements: !1602)
!1602 = !{!1603}
!1603 = !DIDerivedType(tag: DW_TAG_member, name: "duration", scope: !1601, file: !905, line: 34, baseType: !911, size: 32, align: 32)
!1604 = !DILocation(line: 41, column: 23, scope: !1575)
!1605 = !DILocation(line: 41, column: 27, scope: !1575)
!1606 = !DILocation(line: 41, column: 31, scope: !1575)
!1607 = !DILocation(line: 43, column: 10, scope: !1585)
!1608 = !DILocation(line: 43, column: 13, scope: !1585)
!1609 = !DILocation(line: 43, column: 22, scope: !1585)
!1610 = !DILocation(line: 44, column: 17, scope: !1585)
!1611 = !DILocation(line: 44, column: 24, scope: !1585)
!1612 = !DILocation(line: 44, column: 34, scope: !1585)
!1613 = !DILocation(line: 44, column: 37, scope: !1614)
!1614 = !DILexicalBlockFile(scope: !1585, file: !905, discriminator: 1)
!1615 = !DILocation(line: 44, column: 44, scope: !1614)
!1616 = !DILocation(line: 44, column: 59, scope: !1614)
!1617 = !DILocation(line: 44, column: 64, scope: !1614)
!1618 = !DILocation(line: 44, column: 67, scope: !1619)
!1619 = !DILexicalBlockFile(scope: !1585, file: !905, discriminator: 2)
!1620 = !DILocation(line: 44, column: 74, scope: !1619)
!1621 = !DILocation(line: 43, column: 9, scope: !1622)
!1622 = !DILexicalBlockFile(scope: !1575, file: !905, discriminator: 1)
!1623 = !DILocation(line: 45, column: 66, scope: !1585)
!1624 = !DILocation(line: 45, column: 73, scope: !1585)
!1625 = !DILocation(line: 45, column: 83, scope: !1585)
!1626 = !DILocation(line: 45, column: 90, scope: !1585)
!1627 = !DILocation(line: 45, column: 23, scope: !1585)
!1628 = !DILocation(line: 60, column: 9, scope: !1578, inlinedAt: !1584)
!1629 = !DILocation(line: 60, column: 10, scope: !1578, inlinedAt: !1584)
!1630 = !DILocation(line: 60, column: 18, scope: !1578, inlinedAt: !1584)
!1631 = !DILocation(line: 60, column: 19, scope: !1578, inlinedAt: !1584)
!1632 = !DILocation(line: 60, column: 15, scope: !1578, inlinedAt: !1584)
!1633 = !DILocation(line: 60, column: 8, scope: !1578, inlinedAt: !1584)
!1634 = !DILocation(line: 60, column: 6, scope: !1578, inlinedAt: !1584)
!1635 = !DILocation(line: 61, column: 12, scope: !1578, inlinedAt: !1584)
!1636 = !DILocation(line: 45, column: 96, scope: !1585)
!1637 = !DILocation(line: 45, column: 103, scope: !1585)
!1638 = !DILocation(line: 45, column: 94, scope: !1585)
!1639 = !DILocation(line: 45, column: 9, scope: !1585)
!1640 = !DILocation(line: 45, column: 12, scope: !1585)
!1641 = !DILocation(line: 45, column: 21, scope: !1585)
!1642 = !DILocation(line: 47, column: 20, scope: !1575)
!1643 = !DILocation(line: 47, column: 23, scope: !1575)
!1644 = !DILocation(line: 47, column: 5, scope: !1575)
!1645 = !DILocation(line: 47, column: 9, scope: !1575)
!1646 = !DILocation(line: 47, column: 18, scope: !1575)
!1647 = !DILocation(line: 51, column: 16, scope: !1575)
!1648 = !DILocation(line: 51, column: 6, scope: !1575)
!1649 = !DILocation(line: 51, column: 14, scope: !1575)
!1650 = !DILocation(line: 52, column: 21, scope: !1575)
!1651 = !DILocation(line: 52, column: 6, scope: !1575)
!1652 = !DILocation(line: 52, column: 19, scope: !1575)
!1653 = !DILocation(line: 53, column: 12, scope: !1575)
!1654 = !DILocation(line: 53, column: 5, scope: !1575)
