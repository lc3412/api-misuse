; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavfilter--libavfilter.a/[inter]libavfilter--asink_anullsink.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavfilter--libavfilter.a/[inter]libavfilter--asink_anullsink.o.i"
...
@.str = private unnamed_addr constant [10 x i8] c"anullsink\00", align 1
@.str.1 = private unnamed_addr constant [44 x i8] c"Do absolutely nothing with the input audio.\00", align 1
@avfilter_asink_anullsink_inputs = internal constant [2 x %struct.AVFilterPad] [%struct.AVFilterPad { i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i32 0, i32 0), i32 1, %struct.AVFrame* (%struct.AVFilterLink*, i32, i32)* null, %struct.AVFrame* (%struct.AVFilterLink*, i32)* null, i32 (%struct.AVFilterLink*, %struct.AVFrame*)* @null_filter_frame, i32 (%struct.AVFilterLink*)* null, i32 (%struct.AVFilterLink*)* null, i32 (%struct.AVFilterLink*)* null, i32 0, i32 0 }, %struct.AVFilterPad zeroinitializer], align 16
@ff_asink_anullsink = global %struct.AVFilter { i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.1, i32 0, i32 0), %struct.AVFilterPad* getelementptr inbounds ([2 x %struct.AVFilterPad], [2 x %struct.AVFilterPad]* @avfilter_asink_anullsink_inputs, i32 0, i32 0), %struct.AVFilterPad* null, %struct.AVClass* null, i32 0, i32 (%struct.AVFilterContext*)* null, i32 (%struct.AVFilterContext*)* null, i32 (%struct.AVFilterContext*, %struct.AVDictionary**)* null, void (%struct.AVFilterContext*)* null, i32 (%struct.AVFilterContext*)* null, i32 0, i32 0, %struct.AVFilter* null, i32 (%struct.AVFilterContext*, i8*, i8*, i8*, i32, i32)* null, i32 (%struct.AVFilterContext*, i8*)* null, i32 (%struct.AVFilterContext*)* null }, align 8
@.str.2 = private unnamed_addr constant [8 x i8] c"default\00", align 1

; Function Attrs: nounwind uwtable
define internal i32 @null_filter_frame(%struct.AVFilterLink* %link, %struct.AVFrame* %frame) #0 !dbg !536 {
entry:
  %link.addr = alloca %struct.AVFilterLink*, align 8
  %frame.addr = alloca %struct.AVFrame*, align 8
  store %struct.AVFilterLink* %link, %struct.AVFilterLink** %link.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFilterLink** %link.addr, metadata !538, metadata !539), !dbg !540
  store %struct.AVFrame* %frame, %struct.AVFrame** %frame.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFrame** %frame.addr, metadata !541, metadata !539), !dbg !542
  call void @av_frame_free(%struct.AVFrame** %frame.addr), !dbg !543
  ret i32 0, !dbg !544
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavfilter--libavfilter.a/[inter]libavfilter--asink_anullsink.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavfilter--libavfilter.a")
...
!526 = !{!527, !529}
!527 = distinct !DIGlobalVariable(name: "ff_asink_anullsink", scope: !0, file: !528, line: 40, type: !204, isLocal: false, isDefinition: true, variable: %struct.AVFilter* @ff_asink_anullsink)
!528 = !DIFile(filename: "libavfilter/asink_anullsink.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavfilter--libavfilter.a")
!529 = distinct !DIGlobalVariable(name: "avfilter_asink_anullsink_inputs", scope: !0, file: !528, line: 31, type: !530, isLocal: true, isDefinition: true, variable: [2 x %struct.AVFilterPad]* @avfilter_asink_anullsink_inputs)
!530 = !DICompositeType(tag: DW_TAG_array_type, baseType: !211, size: 1152, align: 64, elements: !531)
!531 = !{!532}
!532 = !DISubrange(count: 2)
!533 = !{i32 2, !"Dwarf Version", i32 4}
!534 = !{i32 2, !"Debug Info Version", i32 3}
!535 = !{!"clang version 3.9.0 (tags/RELEASE_390/final)"}
!536 = distinct !DISubprogram(name: "null_filter_frame", scope: !528, file: !528, line: 25, type: !340, isLocal: true, isDefinition: true, scopeLine: 26, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !537)
!537 = !{}
!538 = !DILocalVariable(name: "link", arg: 1, scope: !536, file: !528, line: 25, type: !332)
!539 = !DIExpression()
!540 = !DILocation(line: 25, column: 44, scope: !536)
!541 = !DILocalVariable(name: "frame", arg: 2, scope: !536, file: !528, line: 25, type: !222)
!542 = !DILocation(line: 25, column: 59, scope: !536)
!543 = !DILocation(line: 27, column: 5, scope: !536)
!544 = !DILocation(line: 28, column: 5, scope: !536)
