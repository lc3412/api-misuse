; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavfilter--libavfilter.a/[inter]libavfilter--af_acopy.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavfilter--libavfilter.a/[inter]libavfilter--af_acopy.o.i"
...
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.AVFilterLink** %inlink.addr, metadata !539, metadata !540), !dbg !541
  store %struct.AVFrame* %in, %struct.AVFrame** %in.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFrame** %in.addr, metadata !542, metadata !540), !dbg !543
  call void @llvm.dbg.declare(metadata %struct.AVFilterLink** %outlink, metadata !544, metadata !540), !dbg !545
  %0 = load %struct.AVFilterLink*, %struct.AVFilterLink** %inlink.addr, align 8, !dbg !546
  %dst = getelementptr inbounds %struct.AVFilterLink, %struct.AVFilterLink* %0, i32 0, i32 2, !dbg !547
  %1 = load %struct.AVFilterContext*, %struct.AVFilterContext** %dst, align 8, !dbg !547
  %outputs = getelementptr inbounds %struct.AVFilterContext, %struct.AVFilterContext* %1, i32 0, i32 7, !dbg !548
  %2 = load %struct.AVFilterLink**, %struct.AVFilterLink*** %outputs, align 8, !dbg !548
  %arrayidx = getelementptr inbounds %struct.AVFilterLink*, %struct.AVFilterLink** %2, i64 0, !dbg !546
  %3 = load %struct.AVFilterLink*, %struct.AVFilterLink** %arrayidx, align 8, !dbg !546
  store %struct.AVFilterLink* %3, %struct.AVFilterLink** %outlink, align 8, !dbg !545
  call void @llvm.dbg.declare(metadata %struct.AVFrame** %out, metadata !549, metadata !540), !dbg !550
  %4 = load %struct.AVFilterLink*, %struct.AVFilterLink** %outlink, align 8, !dbg !551
  %5 = load %struct.AVFrame*, %struct.AVFrame** %in.addr, align 8, !dbg !552
  %nb_samples = getelementptr inbounds %struct.AVFrame, %struct.AVFrame* %5, i32 0, i32 5, !dbg !553
  %6 = load i32, i32* %nb_samples, align 8, !dbg !553
  %call = call %struct.AVFrame* @ff_get_audio_buffer(%struct.AVFilterLink* %4, i32 %6), !dbg !554
  store %struct.AVFrame* %call, %struct.AVFrame** %out, align 8, !dbg !550
  %7 = load %struct.AVFrame*, %struct.AVFrame** %out, align 8, !dbg !555
  %tobool = icmp ne %struct.AVFrame* %7, null, !dbg !555
  br i1 %tobool, label %if.end, label %if.then, !dbg !557

if.then:                                          ; preds = %entry
  call void @av_frame_free(%struct.AVFrame** %in.addr), !dbg !558
  store i32 -12, i32* %retval, align 4, !dbg !560
  br label %return, !dbg !560

if.end:                                           ; preds = %entry
  %8 = load %struct.AVFrame*, %struct.AVFrame** %out, align 8, !dbg !561
  %9 = load %struct.AVFrame*, %struct.AVFrame** %in.addr, align 8, !dbg !562
  %call1 = call i32 @av_frame_copy_props(%struct.AVFrame* %8, %struct.AVFrame* %9), !dbg !563
  %10 = load %struct.AVFrame*, %struct.AVFrame** %out, align 8, !dbg !564
  %11 = load %struct.AVFrame*, %struct.AVFrame** %in.addr, align 8, !dbg !565
  %call2 = call i32 @av_frame_copy(%struct.AVFrame* %10, %struct.AVFrame* %11), !dbg !566
  call void @av_frame_free(%struct.AVFrame** %in.addr), !dbg !567
  %12 = load %struct.AVFilterLink*, %struct.AVFilterLink** %outlink, align 8, !dbg !568
  %13 = load %struct.AVFrame*, %struct.AVFrame** %out, align 8, !dbg !569
  %call3 = call i32 @ff_filter_frame(%struct.AVFilterLink* %12, %struct.AVFrame* %13), !dbg !570
  store i32 %call3, i32* %retval, align 4, !dbg !571
  br label %return, !dbg !571

return:                                           ; preds = %if.end, %if.then
  %14 = load i32, i32* %retval, align 4, !dbg !572
  ret i32 %14, !dbg !572
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavfilter--libavfilter.a/[inter]libavfilter--af_acopy.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavfilter--libavfilter.a")
...
!526 = !{!527, !529, !533}
!527 = distinct !DIGlobalVariable(name: "ff_af_acopy", scope: !0, file: !528, line: 55, type: !204, isLocal: false, isDefinition: true, variable: %struct.AVFilter* @ff_af_acopy)
!528 = !DIFile(filename: "libavfilter/af_acopy.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavfilter--libavfilter.a")
!529 = distinct !DIGlobalVariable(name: "acopy_inputs", scope: !0, file: !528, line: 38, type: !530, isLocal: true, isDefinition: true, variable: [2 x %struct.AVFilterPad]* @acopy_inputs)
!530 = !DICompositeType(tag: DW_TAG_array_type, baseType: !211, size: 1152, align: 64, elements: !531)
!531 = !{!532}
!532 = !DISubrange(count: 2)
!533 = distinct !DIGlobalVariable(name: "acopy_outputs", scope: !0, file: !528, line: 47, type: !530, isLocal: true, isDefinition: true, variable: [2 x %struct.AVFilterPad]* @acopy_outputs)
!534 = !{i32 2, !"Dwarf Version", i32 4}
!535 = !{i32 2, !"Debug Info Version", i32 3}
!536 = !{!"clang version 3.9.0 (tags/RELEASE_390/final)"}
!537 = distinct !DISubprogram(name: "filter_frame", scope: !528, file: !528, line: 23, type: !340, isLocal: true, isDefinition: true, scopeLine: 24, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !538)
!538 = !{}
!539 = !DILocalVariable(name: "inlink", arg: 1, scope: !537, file: !528, line: 23, type: !332)
!540 = !DIExpression()
!541 = !DILocation(line: 23, column: 39, scope: !537)
!542 = !DILocalVariable(name: "in", arg: 2, scope: !537, file: !528, line: 23, type: !222)
!543 = !DILocation(line: 23, column: 56, scope: !537)
!544 = !DILocalVariable(name: "outlink", scope: !537, file: !528, line: 25, type: !332)
!545 = !DILocation(line: 25, column: 19, scope: !537)
!546 = !DILocation(line: 25, column: 29, scope: !537)
!547 = !DILocation(line: 25, column: 37, scope: !537)
!548 = !DILocation(line: 25, column: 42, scope: !537)
!549 = !DILocalVariable(name: "out", scope: !537, file: !528, line: 26, type: !222)
!550 = !DILocation(line: 26, column: 14, scope: !537)
!551 = !DILocation(line: 26, column: 40, scope: !537)
!552 = !DILocation(line: 26, column: 49, scope: !537)
!553 = !DILocation(line: 26, column: 53, scope: !537)
!554 = !DILocation(line: 26, column: 20, scope: !537)
!555 = !DILocation(line: 28, column: 10, scope: !556)
!556 = distinct !DILexicalBlock(scope: !537, file: !528, line: 28, column: 9)
!557 = !DILocation(line: 28, column: 9, scope: !537)
!558 = !DILocation(line: 29, column: 9, scope: !559)
!559 = distinct !DILexicalBlock(scope: !556, file: !528, line: 28, column: 15)
!560 = !DILocation(line: 30, column: 9, scope: !559)
!561 = !DILocation(line: 32, column: 25, scope: !537)
!562 = !DILocation(line: 32, column: 30, scope: !537)
!563 = !DILocation(line: 32, column: 5, scope: !537)
!564 = !DILocation(line: 33, column: 19, scope: !537)
!565 = !DILocation(line: 33, column: 24, scope: !537)
!566 = !DILocation(line: 33, column: 5, scope: !537)
!567 = !DILocation(line: 34, column: 5, scope: !537)
!568 = !DILocation(line: 35, column: 28, scope: !537)
!569 = !DILocation(line: 35, column: 37, scope: !537)
!570 = !DILocation(line: 35, column: 12, scope: !537)
!571 = !DILocation(line: 35, column: 5, scope: !537)
!572 = !DILocation(line: 36, column: 1, scope: !537)
