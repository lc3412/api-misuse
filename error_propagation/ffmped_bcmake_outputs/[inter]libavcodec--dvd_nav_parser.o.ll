; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[inter]libavcodec--dvd_nav_parser.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[inter]libavcodec--dvd_nav_parser.o.i"
...
@ff_dvd_nav_parser = global { [5 x i32], i32, i32 (%struct.AVCodecParserContext*)*, i32 (%struct.AVCodecParserContext*, %struct.AVCodecContext*, i8**, i32*, i8*, i32)*, void (%struct.AVCodecParserContext*)*, i32 (%struct.AVCodecContext*, i8*, i32)*, %struct.AVCodecParser* } { [5 x i32] [i32 100357, i32 0, i32 0, i32 0, i32 0], i32 2008, i32 (%struct.AVCodecParserContext*)* @dvd_nav_parse_init, i32 (%struct.AVCodecParserContext*, %struct.AVCodecContext*, i8**, i32*, i8*, i32)* @dvd_nav_parse, void (%struct.AVCodecParserContext*)* null, i32 (%struct.AVCodecContext*, i8*, i32)* null, %struct.AVCodecParser* null }, align 8

; Function Attrs: cold nounwind optsize uwtable
define internal i32 @dvd_nav_parse_init(%struct.AVCodecParserContext* %s) #0 !dbg !1575 {
entry:
  %s.addr = alloca %struct.AVCodecParserContext*, align 8
  %pc = alloca %struct.DVDNavParseContext*, align 8
  ...
  call void @llvm.dbg.declare(metadata %struct.DVDNavParseContext** %pc, metadata !1580, metadata !1578), !dbg !1591
  %0 = load %struct.AVCodecParserContext*, %struct.AVCodecParserContext** %s.addr, align 8, !dbg !1592
  %priv_data = getelementptr inbounds %struct.AVCodecParserContext, %struct.AVCodecParserContext* %0, i32 0, i32 0, !dbg !1593
  %1 = load i8*, i8** %priv_data, align 8, !dbg !1593
  %2 = bitcast i8* %1 to %struct.DVDNavParseContext*, !dbg !1592
  store %struct.DVDNavParseContext* %2, %struct.DVDNavParseContext** %pc, align 8, !dbg !1591
  %3 = load %struct.DVDNavParseContext*, %struct.DVDNavParseContext** %pc, align 8, !dbg !1594
  %lba = getelementptr inbounds %struct.DVDNavParseContext, %struct.DVDNavParseContext* %3, i32 0, i32 0, !dbg !1595
  store i32 -1, i32* %lba, align 4, !dbg !1596
  %4 = load %struct.DVDNavParseContext*, %struct.DVDNavParseContext** %pc, align 8, !dbg !1597
  %copied = getelementptr inbounds %struct.DVDNavParseContext, %struct.DVDNavParseContext* %4, i32 0, i32 2, !dbg !1598
  store i32 0, i32* %copied, align 4, !dbg !1599
  ret i32 0, !dbg !1600
}

; Function Attrs: nounwind uwtable
define internal i32 @dvd_nav_parse(%struct.AVCodecParserContext* %s, %struct.AVCodecContext* %avctx, i8** %poutbuf, i32* %poutbuf_size, i8* %buf, i32 %buf_size) #1 !dbg !1601 {
entry:
  %x.addr.i81 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %x.addr.i81, metadata !1602, metadata !1578), !dbg !1607
  %x.addr.i66 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %x.addr.i66, metadata !1602, metadata !1578), !dbg !1614
  %x.addr.i51 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %x.addr.i51, metadata !1602, metadata !1578), !dbg !1616
  %x.addr.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %x.addr.i, metadata !1602, metadata !1578), !dbg !1620
  %s.addr = alloca %struct.AVCodecParserContext*, align 8
  ...
  %pc1 = alloca %struct.DVDNavParseContext*, align 8
  %lastPacket = alloca i32, align 4
  %valid = alloca i32, align 4
  %lba = alloca i32, align 4
  %startpts = alloca i32, align 4
  %endpts = alloca i32, align 4
  %lba26 = alloca i32, align 4
  store %struct.AVCodecParserContext* %s, %struct.AVCodecParserContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVCodecParserContext** %s.addr, metadata !1622, metadata !1578), !dbg !1623
  store %struct.AVCodecContext* %avctx, %struct.AVCodecContext** %avctx.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVCodecContext** %avctx.addr, metadata !1624, metadata !1578), !dbg !1625
  store i8** %poutbuf, i8*** %poutbuf.addr, align 8
  call void @llvm.dbg.declare(metadata i8*** %poutbuf.addr, metadata !1626, metadata !1578), !dbg !1627
  store i32* %poutbuf_size, i32** %poutbuf_size.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %poutbuf_size.addr, metadata !1628, metadata !1578), !dbg !1629
  store i8* %buf, i8** %buf.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %buf.addr, metadata !1630, metadata !1578), !dbg !1631
  store i32 %buf_size, i32* %buf_size.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %buf_size.addr, metadata !1632, metadata !1578), !dbg !1633
  call void @llvm.dbg.declare(metadata %struct.DVDNavParseContext** %pc1, metadata !1634, metadata !1578), !dbg !1635
  %0 = load %struct.AVCodecParserContext*, %struct.AVCodecParserContext** %s.addr, align 8, !dbg !1636
  %priv_data = getelementptr inbounds %struct.AVCodecParserContext, %struct.AVCodecParserContext* %0, i32 0, i32 0, !dbg !1637
  %1 = load i8*, i8** %priv_data, align 8, !dbg !1637
  %2 = bitcast i8* %1 to %struct.DVDNavParseContext*, !dbg !1636
  store %struct.DVDNavParseContext* %2, %struct.DVDNavParseContext** %pc1, align 8, !dbg !1635
  call void @llvm.dbg.declare(metadata i32* %lastPacket, metadata !1638, metadata !1578), !dbg !1639
  store i32 0, i32* %lastPacket, align 4, !dbg !1639
  call void @llvm.dbg.declare(metadata i32* %valid, metadata !1640, metadata !1578), !dbg !1641
  store i32 0, i32* %valid, align 4, !dbg !1641
  %3 = load %struct.AVCodecParserContext*, %struct.AVCodecParserContext** %s.addr, align 8, !dbg !1642
  %pict_type = getelementptr inbounds %struct.AVCodecParserContext, %struct.AVCodecParserContext* %3, i32 0, i32 5, !dbg !1643
  store i32 0, i32* %pict_type, align 8, !dbg !1644
  %4 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1645
  %time_base = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %4, i32 0, i32 17, !dbg !1646
  %num = getelementptr inbounds %struct.AVRational, %struct.AVRational* %time_base, i32 0, i32 0, !dbg !1647
  store i32 1, i32* %num, align 4, !dbg !1648
  %5 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1649
  %time_base1 = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %5, i32 0, i32 17, !dbg !1650
  %den = getelementptr inbounds %struct.AVRational, %struct.AVRational* %time_base1, i32 0, i32 1, !dbg !1651
  store i32 90000, i32* %den, align 4, !dbg !1652
  %6 = load i8*, i8** %buf.addr, align 8, !dbg !1653
  %tobool = icmp ne i8* %6, null, !dbg !1653
  br i1 %tobool, label %land.lhs.true, label %if.end39, !dbg !1654

land.lhs.true:                                    ; preds = %entry
  %7 = load i32, i32* %buf_size.addr, align 4, !dbg !1655
  %tobool2 = icmp ne i32 %7, 0, !dbg !1655
  br i1 %tobool2, label %if.then, label %if.end39, !dbg !1657

if.then:                                          ; preds = %land.lhs.true
  %8 = load i8*, i8** %buf.addr, align 8, !dbg !1658
  %arrayidx = getelementptr inbounds i8, i8* %8, i64 0, !dbg !1658
  %9 = load i8, i8* %arrayidx, align 1, !dbg !1658
  %conv = zext i8 %9 to i32, !dbg !1658
...
sw.bb:                                            ; preds = %if.then
  %10 = load i32, i32* %buf_size.addr, align 4, !dbg !1660
  %cmp = icmp eq i32 %10, 980, !dbg !1661
  br i1 %cmp, label %if.then4, label %if.end17, !dbg !1662

if.then4:                                         ; preds = %sw.bb
  call void @llvm.dbg.declare(metadata i32* %lba, metadata !1663, metadata !1578), !dbg !1664
  %11 = load i8*, i8** %buf.addr, align 8, !dbg !1665
  %arrayidx5 = getelementptr inbounds i8, i8* %11, i64 1, !dbg !1665
  %12 = bitcast i8* %arrayidx5 to %union.unaligned_32*, !dbg !1666
  %l = bitcast %union.unaligned_32* %12 to i32*, !dbg !1666
  %13 = load i32, i32* %l, align 1, !dbg !1666
  store i32 %13, i32* %x.addr.i, align 4, !dbg !1667
  %14 = load i32, i32* %x.addr.i, align 4, !dbg !1668
  %shl.i = shl i32 %14, 8, !dbg !1669
  %and.i = and i32 %shl.i, 65280, !dbg !1670
  %15 = load i32, i32* %x.addr.i, align 4, !dbg !1671
  %shr.i = lshr i32 %15, 8, !dbg !1672
  %and1.i = and i32 %shr.i, 255, !dbg !1673
  %or.i = or i32 %and.i, %and1.i, !dbg !1674
  %shl2.i = shl i32 %or.i, 16, !dbg !1675
  %16 = load i32, i32* %x.addr.i, align 4, !dbg !1676
  %shr3.i = lshr i32 %16, 16, !dbg !1677
  %shl4.i = shl i32 %shr3.i, 8, !dbg !1678
  %and5.i = and i32 %shl4.i, 65280, !dbg !1679
  %17 = load i32, i32* %x.addr.i, align 4, !dbg !1680
  %shr6.i = lshr i32 %17, 16, !dbg !1681
  ...
  store i32 %or10.i, i32* %lba, align 4, !dbg !1664
  call void @llvm.dbg.declare(metadata i32* %startpts, metadata !1686, metadata !1578), !dbg !1687
  %18 = load i8*, i8** %buf.addr, align 8, !dbg !1688
  %arrayidx6 = getelementptr inbounds i8, i8* %18, i64 13, !dbg !1688
  %19 = bitcast i8* %arrayidx6 to %union.unaligned_32*, !dbg !1689
  %l7 = bitcast %union.unaligned_32* %19 to i32*, !dbg !1689
  %20 = load i32, i32* %l7, align 1, !dbg !1689
  store i32 %20, i32* %x.addr.i81, align 4, !dbg !1690
  %21 = load i32, i32* %x.addr.i81, align 4, !dbg !1691
  %shl.i82 = shl i32 %21, 8, !dbg !1692
  %and.i83 = and i32 %shl.i82, 65280, !dbg !1693
  %22 = load i32, i32* %x.addr.i81, align 4, !dbg !1694
  %shr.i84 = lshr i32 %22, 8, !dbg !1695
  %and1.i85 = and i32 %shr.i84, 255, !dbg !1696
  %or.i86 = or i32 %and.i83, %and1.i85, !dbg !1697
  %shl2.i87 = shl i32 %or.i86, 16, !dbg !1698
  %23 = load i32, i32* %x.addr.i81, align 4, !dbg !1699
  %shr3.i88 = lshr i32 %23, 16, !dbg !1700
  %shl4.i89 = shl i32 %shr3.i88, 8, !dbg !1701
  %and5.i90 = and i32 %shl4.i89, 65280, !dbg !1702
  %24 = load i32, i32* %x.addr.i81, align 4, !dbg !1703
  %shr6.i91 = lshr i32 %24, 16, !dbg !1704
  %shr7.i92 = lshr i32 %shr6.i91, 8, !dbg !1705
  %and8.i93 = and i32 %shr7.i92, 255, !dbg !1706
  %or9.i94 = or i32 %and5.i90, %and8.i93, !dbg !1707
  %or10.i95 = or i32 %shl2.i87, %or9.i94, !dbg !1708
  store i32 %or10.i95, i32* %startpts, align 4, !dbg !1687
  call void @llvm.dbg.declare(metadata i32* %endpts, metadata !1709, metadata !1578), !dbg !1710
  %25 = load i8*, i8** %buf.addr, align 8, !dbg !1711
  %arrayidx9 = getelementptr inbounds i8, i8* %25, i64 17, !dbg !1711
  %26 = bitcast i8* %arrayidx9 to %union.unaligned_32*, !dbg !1712
  %l10 = bitcast %union.unaligned_32* %26 to i32*, !dbg !1712
  %27 = load i32, i32* %l10, align 1, !dbg !1712
  store i32 %27, i32* %x.addr.i66, align 4, !dbg !1713
  %28 = load i32, i32* %x.addr.i66, align 4, !dbg !1714
  %shl.i67 = shl i32 %28, 8, !dbg !1715
  %and.i68 = and i32 %shl.i67, 65280, !dbg !1716
  %29 = load i32, i32* %x.addr.i66, align 4, !dbg !1717
  %shr.i69 = lshr i32 %29, 8, !dbg !1718
  %and1.i70 = and i32 %shr.i69, 255, !dbg !1719
  %or.i71 = or i32 %and.i68, %and1.i70, !dbg !1720
  %shl2.i72 = shl i32 %or.i71, 16, !dbg !1721
  %30 = load i32, i32* %x.addr.i66, align 4, !dbg !1722
  %shr3.i73 = lshr i32 %30, 16, !dbg !1723
  %shl4.i74 = shl i32 %shr3.i73, 8, !dbg !1724
  %and5.i75 = and i32 %shl4.i74, 65280, !dbg !1725
  %31 = load i32, i32* %x.addr.i66, align 4, !dbg !1726
  %shr6.i76 = lshr i32 %31, 16, !dbg !1727
  %shr7.i77 = lshr i32 %shr6.i76, 8, !dbg !1728
  %and8.i78 = and i32 %shr7.i77, 255, !dbg !1729
  %or9.i79 = or i32 %and5.i75, %and8.i78, !dbg !1730
  %or10.i80 = or i32 %shl2.i72, %or9.i79, !dbg !1731
  store i32 %or10.i80, i32* %endpts, align 4, !dbg !1710
  %32 = load i32, i32* %endpts, align 4, !dbg !1732
  %33 = load i32, i32* %startpts, align 4, !dbg !1734
  %cmp12 = icmp ugt i32 %32, %33, !dbg !1735
  br i1 %cmp12, label %if.then14, label %if.end, !dbg !1736

if.then14:                                        ; preds = %if.then4
  %34 = load i32, i32* %lba, align 4, !dbg !1737
  %35 = load %struct.DVDNavParseContext*, %struct.DVDNavParseContext** %pc1, align 8, !dbg !1739
  %lba15 = getelementptr inbounds %struct.DVDNavParseContext, %struct.DVDNavParseContext* %35, i32 0, i32 0, !dbg !1740
  store i32 %34, i32* %lba15, align 4, !dbg !1741
  %36 = load i32, i32* %startpts, align 4, !dbg !1742
  %conv16 = zext i32 %36 to i64, !dbg !1743
  %37 = load %struct.AVCodecParserContext*, %struct.AVCodecParserContext** %s.addr, align 8, !dbg !1744
  %pts = getelementptr inbounds %struct.AVCodecParserContext, %struct.AVCodecParserContext* %37, i32 0, i32 7, !dbg !1745
  store i64 %conv16, i64* %pts, align 8, !dbg !1746
  %38 = load i32, i32* %endpts, align 4, !dbg !1747
  %39 = load i32, i32* %startpts, align 4, !dbg !1748
  %sub = sub i32 %38, %39, !dbg !1749
  %40 = load %struct.AVCodecParserContext*, %struct.AVCodecParserContext** %s.addr, align 8, !dbg !1750
  %duration = getelementptr inbounds %struct.AVCodecParserContext, %struct.AVCodecParserContext* %40, i32 0, i32 27, !dbg !1751
  store i32 %sub, i32* %duration, align 8, !dbg !1752
  %41 = load %struct.DVDNavParseContext*, %struct.DVDNavParseContext** %pc1, align 8, !dbg !1753
  %buffer = getelementptr inbounds %struct.DVDNavParseContext, %struct.DVDNavParseContext* %41, i32 0, i32 1, !dbg !1754
  %arraydecay = getelementptr inbounds [1998 x i8], [1998 x i8]* %buffer, i32 0, i32 0, !dbg !1755
  %42 = load i8*, i8** %buf.addr, align 8, !dbg !1756
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %arraydecay, i8* %42, i64 980, i32 1, i1 false), !dbg !1755
  %43 = load %struct.DVDNavParseContext*, %struct.DVDNavParseContext** %pc1, align 8, !dbg !1757
  %copied = getelementptr inbounds %struct.DVDNavParseContext, %struct.DVDNavParseContext* %43, i32 0, i32 2, !dbg !1758
  store i32 980, i32* %copied, align 4, !dbg !1759
  store i32 1, i32* %valid, align 4, !dbg !1760
  br label %if.end, !dbg !1761

if.end:                                           ; preds = %if.then14, %if.then4
  br label %if.end17, !dbg !1762

if.end17:                                         ; preds = %if.end, %sw.bb
  br label %sw.epilog, !dbg !1763

sw.bb18:                                          ; preds = %if.then
  %44 = load i32, i32* %buf_size.addr, align 4, !dbg !1764
  %cmp19 = icmp eq i32 %44, 1018, !dbg !1765
  br i1 %cmp19, label %land.lhs.true21, label %if.end38, !dbg !1766

land.lhs.true21:                                  ; preds = %sw.bb18
  %45 = load %struct.DVDNavParseContext*, %struct.DVDNavParseContext** %pc1, align 8, !dbg !1767
  %copied22 = getelementptr inbounds %struct.DVDNavParseContext, %struct.DVDNavParseContext* %45, i32 0, i32 2, !dbg !1769
  %46 = load i32, i32* %copied22, align 4, !dbg !1769
  %cmp23 = icmp eq i32 %46, 980, !dbg !1770
  br i1 %cmp23, label %if.then25, label %if.end38, !dbg !1771

if.then25:                                        ; preds = %land.lhs.true21
  call void @llvm.dbg.declare(metadata i32* %lba26, metadata !1772, metadata !1578), !dbg !1773
  %47 = load i8*, i8** %buf.addr, align 8, !dbg !1774
  %arrayidx27 = getelementptr inbounds i8, i8* %47, i64 5, !dbg !1774
  %48 = bitcast i8* %arrayidx27 to %union.unaligned_32*, !dbg !1775
  %l28 = bitcast %union.unaligned_32* %48 to i32*, !dbg !1775
  %49 = load i32, i32* %l28, align 1, !dbg !1775
  store i32 %49, i32* %x.addr.i51, align 4, !dbg !1776
  %50 = load i32, i32* %x.addr.i51, align 4, !dbg !1777
  %shl.i52 = shl i32 %50, 8, !dbg !1778
  %and.i53 = and i32 %shl.i52, 65280, !dbg !1779
  %51 = load i32, i32* %x.addr.i51, align 4, !dbg !1780
  %shr.i54 = lshr i32 %51, 8, !dbg !1781
  %and1.i55 = and i32 %shr.i54, 255, !dbg !1782
  %or.i56 = or i32 %and.i53, %and1.i55, !dbg !1783
  %shl2.i57 = shl i32 %or.i56, 16, !dbg !1784
  %52 = load i32, i32* %x.addr.i51, align 4, !dbg !1785
  %shr3.i58 = lshr i32 %52, 16, !dbg !1786
  %shl4.i59 = shl i32 %shr3.i58, 8, !dbg !1787
  %and5.i60 = and i32 %shl4.i59, 65280, !dbg !1788
  %53 = load i32, i32* %x.addr.i51, align 4, !dbg !1789
  %shr6.i61 = lshr i32 %53, 16, !dbg !1790
  %shr7.i62 = lshr i32 %shr6.i61, 8, !dbg !1791
  %and8.i63 = and i32 %shr7.i62, 255, !dbg !1792
  %or9.i64 = or i32 %and5.i60, %and8.i63, !dbg !1793
  %or10.i65 = or i32 %shl2.i57, %or9.i64, !dbg !1794
  store i32 %or10.i65, i32* %lba26, align 4, !dbg !1773
  %54 = load i32, i32* %lba26, align 4, !dbg !1795
  %55 = load %struct.DVDNavParseContext*, %struct.DVDNavParseContext** %pc1, align 8, !dbg !1797
  %lba30 = getelementptr inbounds %struct.DVDNavParseContext, %struct.DVDNavParseContext* %55, i32 0, i32 0, !dbg !1798
  %56 = load i32, i32* %lba30, align 4, !dbg !1798
  %cmp31 = icmp eq i32 %54, %56, !dbg !1799
  br i1 %cmp31, label %if.then33, label %if.end37, !dbg !1800

if.then33:                                        ; preds = %if.then25
  %57 = load %struct.DVDNavParseContext*, %struct.DVDNavParseContext** %pc1, align 8, !dbg !1801
  %buffer34 = getelementptr inbounds %struct.DVDNavParseContext, %struct.DVDNavParseContext* %57, i32 0, i32 1, !dbg !1803
  %arraydecay35 = getelementptr inbounds [1998 x i8], [1998 x i8]* %buffer34, i32 0, i32 0, !dbg !1801
  %58 = load %struct.DVDNavParseContext*, %struct.DVDNavParseContext** %pc1, align 8, !dbg !1804
  %copied36 = getelementptr inbounds %struct.DVDNavParseContext, %struct.DVDNavParseContext* %58, i32 0, i32 2, !dbg !1805
  %59 = load i32, i32* %copied36, align 4, !dbg !1805
  %idx.ext = sext i32 %59 to i64, !dbg !1806
  %add.ptr = getelementptr inbounds i8, i8* %arraydecay35, i64 %idx.ext, !dbg !1806
  %60 = load i8*, i8** %buf.addr, align 8, !dbg !1807
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %add.ptr, i8* %60, i64 1018, i32 1, i1 false), !dbg !1808
  store i32 1, i32* %lastPacket, align 4, !dbg !1809
  store i32 1, i32* %valid, align 4, !dbg !1810
  br label %if.end37, !dbg !1811

if.end37:                                         ; preds = %if.then33, %if.then25
  br label %if.end38, !dbg !1812

if.end38:                                         ; preds = %if.end37, %land.lhs.true21, %sw.bb18
  br label %sw.epilog, !dbg !1813

sw.epilog:                                        ; preds = %if.then, %if.end38, %if.end17
  br label %if.end39, !dbg !1814

if.end39:                                         ; preds = %sw.epilog, %land.lhs.true, %entry
  %61 = load i32, i32* %valid, align 4, !dbg !1815
  %tobool40 = icmp ne i32 %61, 0, !dbg !1815
  br i1 %tobool40, label %lor.lhs.false, label %if.then42, !dbg !1817

lor.lhs.false:                                    ; preds = %if.end39
  %62 = load i32, i32* %lastPacket, align 4, !dbg !1818
  %tobool41 = icmp ne i32 %62, 0, !dbg !1818
  br i1 %tobool41, label %if.then42, label %if.end45, !dbg !1820

if.then42:                                        ; preds = %lor.lhs.false, %if.end39
  %63 = load %struct.DVDNavParseContext*, %struct.DVDNavParseContext** %pc1, align 8, !dbg !1821
  %copied43 = getelementptr inbounds %struct.DVDNavParseContext, %struct.DVDNavParseContext* %63, i32 0, i32 2, !dbg !1823
  store i32 0, i32* %copied43, align 4, !dbg !1824
  %64 = load %struct.DVDNavParseContext*, %struct.DVDNavParseContext** %pc1, align 8, !dbg !1825
  %lba44 = getelementptr inbounds %struct.DVDNavParseContext, %struct.DVDNavParseContext* %64, i32 0, i32 0, !dbg !1826
  store i32 -1, i32* %lba44, align 4, !dbg !1827
  br label %if.end45, !dbg !1828

if.end45:                                         ; preds = %if.then42, %lor.lhs.false
  %65 = load i32, i32* %lastPacket, align 4, !dbg !1829
  %tobool46 = icmp ne i32 %65, 0, !dbg !1829
  br i1 %tobool46, label %if.then47, label %if.else, !dbg !1831

if.then47:                                        ; preds = %if.end45
  %66 = load %struct.DVDNavParseContext*, %struct.DVDNavParseContext** %pc1, align 8, !dbg !1832
  %buffer48 = getelementptr inbounds %struct.DVDNavParseContext, %struct.DVDNavParseContext* %66, i32 0, i32 1, !dbg !1834
  %arraydecay49 = getelementptr inbounds [1998 x i8], [1998 x i8]* %buffer48, i32 0, i32 0, !dbg !1832
  %67 = load i8**, i8*** %poutbuf.addr, align 8, !dbg !1835
  store i8* %arraydecay49, i8** %67, align 8, !dbg !1836
  %68 = load i32*, i32** %poutbuf_size.addr, align 8, !dbg !1837
  store i32 1998, i32* %68, align 4, !dbg !1838
  br label %if.end50, !dbg !1839

if.else:                                          ; preds = %if.end45
  %69 = load i8**, i8*** %poutbuf.addr, align 8, !dbg !1840
  store i8* null, i8** %69, align 8, !dbg !1842
  %70 = load i32*, i32** %poutbuf_size.addr, align 8, !dbg !1843
  store i32 0, i32* %70, align 4, !dbg !1844
  br label %if.end50

if.end50:                                         ; preds = %if.else, %if.then47
  %71 = load i32, i32* %buf_size.addr, align 4, !dbg !1845
  ret i32 %71, !dbg !1846
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[inter]libavcodec--dvd_nav_parser.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs")
...
!903 = !DIDerivedType(tag: DW_TAG_typedef, name: "int64_t", file: !901, line: 40, baseType: !904)
!904 = !DIBasicType(name: "long int", size: 64, align: 64, encoding: DW_ATE_signed)
!905 = !{!906}
!906 = distinct !DIGlobalVariable(name: "ff_dvd_nav_parser", scope: !0, file: !907, line: 110, type: !908, isLocal: false, isDefinition: true, variable: { [5 x i32], i32, i32 (%struct.AVCodecParserContext*)*, i32 (%struct.AVCodecParserContext*, %struct.AVCodecContext*, i8**, i32*, i8*, i32)*, void (%struct.AVCodecParserContext*)*, i32 (%struct.AVCodecContext*, i8*, i32)*, %struct.AVCodecParser* }* @ff_dvd_nav_parser)
!907 = !DIFile(filename: "libavcodec/dvd_nav_parser.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs")
...
!929 = !DIDerivedType(tag: DW_TAG_member, name: "frame_offset", scope: !923, file: !4, line: 5095, baseType: !903, size: 64, align: 64, offset: 128)
!930 = !DIDerivedType(tag: DW_TAG_member, name: "cur_offset", scope: !923, file: !4, line: 5096, baseType: !903, size: 64, align: 64, offset: 192)
!931 = !DIDerivedType(tag: DW_TAG_member, name: "next_frame_offset", scope: !923, file: !4, line: 5098, baseType: !903, size: 64, align: 64, offset: 256)
...
!934 = !DIDerivedType(tag: DW_TAG_member, name: "pts", scope: !923, file: !4, line: 5111, baseType: !903, size: 64, align: 64, offset: 384)
!935 = !DIDerivedType(tag: DW_TAG_member, name: "dts", scope: !923, file: !4, line: 5112, baseType: !903, size: 64, align: 64, offset: 448)
!936 = !DIDerivedType(tag: DW_TAG_member, name: "last_pts", scope: !923, file: !4, line: 5115, baseType: !903, size: 64, align: 64, offset: 512)
!937 = !DIDerivedType(tag: DW_TAG_member, name: "last_dts", scope: !923, file: !4, line: 5116, baseType: !903, size: 64, align: 64, offset: 576)
...
!941 = !DICompositeType(tag: DW_TAG_array_type, baseType: !903, size: 256, align: 64, elements: !942)
!942 = !{!943}
...
!947 = !DIDerivedType(tag: DW_TAG_member, name: "offset", scope: !923, file: !4, line: 5132, baseType: !903, size: 64, align: 64, offset: 1536)
...
!950 = !DIDerivedType(tag: DW_TAG_member, name: "convergence_duration", scope: !923, file: !4, line: 5148, baseType: !903, size: 64, align: 64, offset: 1920)
...
!955 = !DIDerivedType(tag: DW_TAG_member, name: "pos", scope: !923, file: !4, line: 5202, baseType: !903, size: 64, align: 64, offset: 2368)
!956 = !DIDerivedType(tag: DW_TAG_member, name: "last_pos", scope: !923, file: !4, line: 5207, baseType: !903, size: 64, align: 64, offset: 2432)
...
!1099 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint16_t", file: !901, line: 49, baseType: !1100)
!1100 = !DIBasicType(name: "unsigned short", size: 16, align: 16, encoding: DW_ATE_unsigned)
!1101 = !DIDerivedType(tag: DW_TAG_member, name: "start_display_time", scope: !1096, file: !4, line: 3922, baseType: !900, size: 32, align: 32, offset: 32)
!1102 = !DIDerivedType(tag: DW_TAG_member, name: "end_display_time", scope: !1096, file: !4, line: 3923, baseType: !900, size: 32, align: 32, offset: 64)
!1103 = !DIDerivedType(tag: DW_TAG_member, name: "num_rects", scope: !1096, file: !4, line: 3924, baseType: !902, size: 32, align: 32, offset: 96)
...
!1134 = !DIDerivedType(tag: DW_TAG_member, name: "pts", scope: !1096, file: !4, line: 3926, baseType: !903, size: 64, align: 64, offset: 192)
...
!1155 = !DIDerivedType(tag: DW_TAG_member, name: "pts", scope: !1141, file: !4, line: 1461, baseType: !903, size: 64, align: 64, offset: 64)
!1156 = !DIDerivedType(tag: DW_TAG_member, name: "dts", scope: !1141, file: !4, line: 1467, baseType: !903, size: 64, align: 64, offset: 128)
...
!1170 = !DIDerivedType(tag: DW_TAG_member, name: "duration", scope: !1141, file: !4, line: 1486, baseType: !903, size: 64, align: 64, offset: 512)
!1171 = !DIDerivedType(tag: DW_TAG_member, name: "pos", scope: !1141, file: !4, line: 1488, baseType: !903, size: 64, align: 64, offset: 576)
!1172 = !DIDerivedType(tag: DW_TAG_member, name: "convergence_duration", scope: !1141, file: !4, line: 1497, baseType: !903, size: 64, align: 64, offset: 640)
...
!1189 = !DIDerivedType(tag: DW_TAG_member, name: "pts", scope: !1176, file: !772, line: 361, baseType: !903, size: 64, align: 64, offset: 1088)
!1190 = !DIDerivedType(tag: DW_TAG_member, name: "pkt_pts", scope: !1176, file: !772, line: 369, baseType: !903, size: 64, align: 64, offset: 1152)
!1191 = !DIDerivedType(tag: DW_TAG_member, name: "pkt_dts", scope: !1176, file: !772, line: 377, baseType: !903, size: 64, align: 64, offset: 1216)
...
!1202 = !DIDerivedType(tag: DW_TAG_member, name: "reordered_opaque", scope: !1176, file: !772, line: 435, baseType: !903, size: 64, align: 64, offset: 2112)
...
!1232 = !DIDerivedType(tag: DW_TAG_member, name: "best_effort_timestamp", scope: !1176, file: !772, line: 532, baseType: !903, size: 64, align: 64, offset: 3264)
!1233 = !DIDerivedType(tag: DW_TAG_member, name: "pkt_pos", scope: !1176, file: !772, line: 539, baseType: !903, size: 64, align: 64, offset: 3328)
!1234 = !DIDerivedType(tag: DW_TAG_member, name: "pkt_duration", scope: !1176, file: !772, line: 547, baseType: !903, size: 64, align: 64, offset: 3392)
...
!1286 = !DIDerivedType(tag: DW_TAG_member, name: "codec_tag", scope: !972, file: !4, line: 1581, baseType: !902, size: 32, align: 32, offset: 224)
...
!1292 = !DIDerivedType(tag: DW_TAG_member, name: "bit_rate", scope: !972, file: !4, line: 1606, baseType: !903, size: 64, align: 64, offset: 448)
...
!1406 = !DIDerivedType(tag: DW_TAG_member, name: "rc_max_rate", scope: !972, file: !4, line: 2430, baseType: !903, size: 64, align: 64, offset: 4032)
!1407 = !DIDerivedType(tag: DW_TAG_member, name: "rc_min_rate", scope: !972, file: !4, line: 2437, baseType: !903, size: 64, align: 64, offset: 4096)
...
!1420 = !DIDerivedType(tag: DW_TAG_member, name: "timecode_frame_start", scope: !972, file: !4, line: 2514, baseType: !903, size: 64, align: 64, offset: 4544)
...
!1442 = !DIDerivedType(tag: DW_TAG_member, name: "reordered_opaque", scope: !972, file: !4, line: 2709, baseType: !903, size: 64, align: 64, offset: 5312)
...
!1538 = !DIDerivedType(tag: DW_TAG_member, name: "pts_correction_num_faulty_pts", scope: !972, file: !4, line: 3129, baseType: !903, size: 64, align: 64, offset: 7232)
!1539 = !DIDerivedType(tag: DW_TAG_member, name: "pts_correction_num_faulty_dts", scope: !972, file: !4, line: 3130, baseType: !903, size: 64, align: 64, offset: 7296)
!1540 = !DIDerivedType(tag: DW_TAG_member, name: "pts_correction_last_pts", scope: !972, file: !4, line: 3131, baseType: !903, size: 64, align: 64, offset: 7360)
!1541 = !DIDerivedType(tag: DW_TAG_member, name: "pts_correction_last_dts", scope: !972, file: !4, line: 3132, baseType: !903, size: 64, align: 64, offset: 7424)
...
!1550 = !DIDerivedType(tag: DW_TAG_member, name: "properties", scope: !972, file: !4, line: 3214, baseType: !902, size: 32, align: 32, offset: 7872)
...
!1556 = !DIDerivedType(tag: DW_TAG_member, name: "max_pixels", scope: !972, file: !4, line: 3279, baseType: !903, size: 64, align: 64, offset: 8192)
...
!1575 = distinct !DISubprogram(name: "dvd_nav_parse_init", scope: !907, file: !907, line: 35, type: !919, isLocal: true, isDefinition: true, scopeLine: 36, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1576)
!1576 = !{}
!1577 = !DILocalVariable(name: "s", arg: 1, scope: !1575, file: !907, line: 35, type: !921)
!1578 = !DIExpression()
!1579 = !DILocation(line: 35, column: 75, scope: !1575)
!1580 = !DILocalVariable(name: "pc", scope: !1575, file: !907, line: 37, type: !1581)
!1581 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1582, size: 64, align: 64)
!1582 = !DIDerivedType(tag: DW_TAG_typedef, name: "DVDNavParseContext", file: !907, line: 33, baseType: !1583)
!1583 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "DVDNavParseContext", file: !907, line: 29, size: 16064, align: 32, elements: !1584)
!1584 = !{!1585, !1586, !1590}
!1585 = !DIDerivedType(tag: DW_TAG_member, name: "lba", scope: !1583, file: !907, line: 30, baseType: !900, size: 32, align: 32)
!1586 = !DIDerivedType(tag: DW_TAG_member, name: "buffer", scope: !1583, file: !907, line: 31, baseType: !1587, size: 15984, align: 8, offset: 32)
!1587 = !DICompositeType(tag: DW_TAG_array_type, baseType: !1054, size: 15984, align: 8, elements: !1588)
!1588 = !{!1589}
!1589 = !DISubrange(count: 1998)
!1590 = !DIDerivedType(tag: DW_TAG_member, name: "copied", scope: !1583, file: !907, line: 32, baseType: !913, size: 32, align: 32, offset: 16032)
!1591 = !DILocation(line: 37, column: 25, scope: !1575)
!1592 = !DILocation(line: 37, column: 30, scope: !1575)
!1593 = !DILocation(line: 37, column: 33, scope: !1575)
!1594 = !DILocation(line: 39, column: 5, scope: !1575)
!1595 = !DILocation(line: 39, column: 9, scope: !1575)
!1596 = !DILocation(line: 39, column: 13, scope: !1575)
!1597 = !DILocation(line: 40, column: 5, scope: !1575)
!1598 = !DILocation(line: 40, column: 9, scope: !1575)
!1599 = !DILocation(line: 40, column: 16, scope: !1575)
!1600 = !DILocation(line: 41, column: 5, scope: !1575)
!1601 = distinct !DISubprogram(name: "dvd_nav_parse", scope: !907, file: !907, line: 44, type: !968, isLocal: true, isDefinition: true, scopeLine: 48, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1576)
!1602 = !DILocalVariable(name: "x", arg: 1, scope: !1603, file: !1604, line: 66, type: !900)
!1603 = distinct !DISubprogram(name: "av_bswap32", scope: !1604, file: !1604, line: 66, type: !1605, isLocal: true, isDefinition: true, scopeLine: 67, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1576)
!1604 = !DIFile(filename: "./libavutil/bswap.h", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs")
!1605 = !DISubroutineType(types: !1606)
!1606 = !{!900, !900}
!1607 = !DILocation(line: 66, column: 98, scope: !1603, inlinedAt: !1608)
!1608 = distinct !DILocation(line: 64, column: 41, scope: !1609)
!1609 = distinct !DILexicalBlock(scope: !1610, file: !907, line: 61, column: 38)
!1610 = distinct !DILexicalBlock(scope: !1611, file: !907, line: 61, column: 21)
!1611 = distinct !DILexicalBlock(scope: !1612, file: !907, line: 59, column: 24)
!1612 = distinct !DILexicalBlock(scope: !1613, file: !907, line: 58, column: 26)
!1613 = distinct !DILexicalBlock(scope: !1601, file: !907, line: 58, column: 9)
!1614 = !DILocation(line: 66, column: 98, scope: !1603, inlinedAt: !1615)
!1615 = distinct !DILocation(line: 65, column: 39, scope: !1609)
!1616 = !DILocation(line: 66, column: 98, scope: !1603, inlinedAt: !1617)
!1617 = distinct !DILocation(line: 82, column: 36, scope: !1618)
!1618 = distinct !DILexicalBlock(scope: !1619, file: !907, line: 80, column: 65)
!1619 = distinct !DILexicalBlock(scope: !1611, file: !907, line: 80, column: 21)
!1620 = !DILocation(line: 66, column: 98, scope: !1603, inlinedAt: !1621)
!1621 = distinct !DILocation(line: 63, column: 36, scope: !1609)
!1622 = !DILocalVariable(name: "s", arg: 1, scope: !1601, file: !907, line: 44, type: !921)
!1623 = !DILocation(line: 44, column: 48, scope: !1601)
!1624 = !DILocalVariable(name: "avctx", arg: 2, scope: !1601, file: !907, line: 45, type: !970)
!1625 = !DILocation(line: 45, column: 42, scope: !1601)
!1626 = !DILocalVariable(name: "poutbuf", arg: 3, scope: !1601, file: !907, line: 46, type: !1562)
!1627 = !DILocation(line: 46, column: 42, scope: !1601)
!1628 = !DILocalVariable(name: "poutbuf_size", arg: 4, scope: !1601, file: !907, line: 46, type: !1255)
!1629 = !DILocation(line: 46, column: 56, scope: !1601)
!1630 = !DILocalVariable(name: "buf", arg: 5, scope: !1601, file: !907, line: 47, type: !1458)
!1631 = !DILocation(line: 47, column: 41, scope: !1601)
!1632 = !DILocalVariable(name: "buf_size", arg: 6, scope: !1601, file: !907, line: 47, type: !913)
!1633 = !DILocation(line: 47, column: 50, scope: !1601)
!1634 = !DILocalVariable(name: "pc1", scope: !1601, file: !907, line: 49, type: !1581)
!1635 = !DILocation(line: 49, column: 25, scope: !1601)
!1636 = !DILocation(line: 49, column: 31, scope: !1601)
!1637 = !DILocation(line: 49, column: 34, scope: !1601)
!1638 = !DILocalVariable(name: "lastPacket", scope: !1601, file: !907, line: 50, type: !913)
!1639 = !DILocation(line: 50, column: 9, scope: !1601)
!1640 = !DILocalVariable(name: "valid", scope: !1601, file: !907, line: 51, type: !913)
!1641 = !DILocation(line: 51, column: 9, scope: !1601)
!1642 = !DILocation(line: 53, column: 5, scope: !1601)
!1643 = !DILocation(line: 53, column: 8, scope: !1601)
!1644 = !DILocation(line: 53, column: 18, scope: !1601)
!1645 = !DILocation(line: 55, column: 5, scope: !1601)
!1646 = !DILocation(line: 55, column: 12, scope: !1601)
!1647 = !DILocation(line: 55, column: 22, scope: !1601)
!1648 = !DILocation(line: 55, column: 26, scope: !1601)
!1649 = !DILocation(line: 56, column: 5, scope: !1601)
!1650 = !DILocation(line: 56, column: 12, scope: !1601)
!1651 = !DILocation(line: 56, column: 22, scope: !1601)
!1652 = !DILocation(line: 56, column: 26, scope: !1601)
!1653 = !DILocation(line: 58, column: 9, scope: !1613)
!1654 = !DILocation(line: 58, column: 13, scope: !1613)
!1655 = !DILocation(line: 58, column: 16, scope: !1656)
!1656 = !DILexicalBlockFile(scope: !1613, file: !907, discriminator: 1)
!1657 = !DILocation(line: 58, column: 9, scope: !1656)
!1658 = !DILocation(line: 59, column: 16, scope: !1612)
!1659 = !DILocation(line: 59, column: 9, scope: !1612)
!1660 = !DILocation(line: 61, column: 21, scope: !1610)
!1661 = !DILocation(line: 61, column: 30, scope: !1610)
!1662 = !DILocation(line: 61, column: 21, scope: !1611)
!1663 = !DILocalVariable(name: "lba", scope: !1609, file: !907, line: 63, type: !900)
!1664 = !DILocation(line: 63, column: 30, scope: !1609)
!1665 = !DILocation(line: 63, column: 80, scope: !1609)
!1666 = !DILocation(line: 63, column: 93, scope: !1609)
!1667 = !DILocation(line: 63, column: 36, scope: !1609)
!1668 = !DILocation(line: 68, column: 16, scope: !1603, inlinedAt: !1621)
!1669 = !DILocation(line: 68, column: 19, scope: !1603, inlinedAt: !1621)
!1670 = !DILocation(line: 68, column: 24, scope: !1603, inlinedAt: !1621)
!1671 = !DILocation(line: 68, column: 38, scope: !1603, inlinedAt: !1621)
!1672 = !DILocation(line: 68, column: 41, scope: !1603, inlinedAt: !1621)
!1673 = !DILocation(line: 68, column: 46, scope: !1603, inlinedAt: !1621)
!1674 = !DILocation(line: 68, column: 34, scope: !1603, inlinedAt: !1621)
!1675 = !DILocation(line: 68, column: 57, scope: !1603, inlinedAt: !1621)
!1676 = !DILocation(line: 68, column: 69, scope: !1603, inlinedAt: !1621)
!1677 = !DILocation(line: 68, column: 72, scope: !1603, inlinedAt: !1621)
!1678 = !DILocation(line: 68, column: 79, scope: !1603, inlinedAt: !1621)
!1679 = !DILocation(line: 68, column: 84, scope: !1603, inlinedAt: !1621)
!1680 = !DILocation(line: 68, column: 99, scope: !1603, inlinedAt: !1621)
!1681 = !DILocation(line: 68, column: 102, scope: !1603, inlinedAt: !1621)
!1682 = !DILocation(line: 68, column: 109, scope: !1603, inlinedAt: !1621)
!1683 = !DILocation(line: 68, column: 114, scope: !1603, inlinedAt: !1621)
!1684 = !DILocation(line: 68, column: 94, scope: !1603, inlinedAt: !1621)
!1685 = !DILocation(line: 68, column: 63, scope: !1603, inlinedAt: !1621)
!1686 = !DILocalVariable(name: "startpts", scope: !1609, file: !907, line: 64, type: !900)
!1687 = !DILocation(line: 64, column: 30, scope: !1609)
!1688 = !DILocation(line: 64, column: 85, scope: !1609)
!1689 = !DILocation(line: 64, column: 98, scope: !1609)
!1690 = !DILocation(line: 64, column: 41, scope: !1609)
!1691 = !DILocation(line: 68, column: 16, scope: !1603, inlinedAt: !1608)
!1692 = !DILocation(line: 68, column: 19, scope: !1603, inlinedAt: !1608)
!1693 = !DILocation(line: 68, column: 24, scope: !1603, inlinedAt: !1608)
!1694 = !DILocation(line: 68, column: 38, scope: !1603, inlinedAt: !1608)
!1695 = !DILocation(line: 68, column: 41, scope: !1603, inlinedAt: !1608)
!1696 = !DILocation(line: 68, column: 46, scope: !1603, inlinedAt: !1608)
!1697 = !DILocation(line: 68, column: 34, scope: !1603, inlinedAt: !1608)
!1698 = !DILocation(line: 68, column: 57, scope: !1603, inlinedAt: !1608)
!1699 = !DILocation(line: 68, column: 69, scope: !1603, inlinedAt: !1608)
!1700 = !DILocation(line: 68, column: 72, scope: !1603, inlinedAt: !1608)
!1701 = !DILocation(line: 68, column: 79, scope: !1603, inlinedAt: !1608)
!1702 = !DILocation(line: 68, column: 84, scope: !1603, inlinedAt: !1608)
!1703 = !DILocation(line: 68, column: 99, scope: !1603, inlinedAt: !1608)
!1704 = !DILocation(line: 68, column: 102, scope: !1603, inlinedAt: !1608)
!1705 = !DILocation(line: 68, column: 109, scope: !1603, inlinedAt: !1608)
!1706 = !DILocation(line: 68, column: 114, scope: !1603, inlinedAt: !1608)
!1707 = !DILocation(line: 68, column: 94, scope: !1603, inlinedAt: !1608)
!1708 = !DILocation(line: 68, column: 63, scope: !1603, inlinedAt: !1608)
!1709 = !DILocalVariable(name: "endpts", scope: !1609, file: !907, line: 65, type: !900)
!1710 = !DILocation(line: 65, column: 30, scope: !1609)
!1711 = !DILocation(line: 65, column: 83, scope: !1609)
!1712 = !DILocation(line: 65, column: 96, scope: !1609)
!1713 = !DILocation(line: 65, column: 39, scope: !1609)
!1714 = !DILocation(line: 68, column: 16, scope: !1603, inlinedAt: !1615)
!1715 = !DILocation(line: 68, column: 19, scope: !1603, inlinedAt: !1615)
!1716 = !DILocation(line: 68, column: 24, scope: !1603, inlinedAt: !1615)
!1717 = !DILocation(line: 68, column: 38, scope: !1603, inlinedAt: !1615)
!1718 = !DILocation(line: 68, column: 41, scope: !1603, inlinedAt: !1615)
!1719 = !DILocation(line: 68, column: 46, scope: !1603, inlinedAt: !1615)
!1720 = !DILocation(line: 68, column: 34, scope: !1603, inlinedAt: !1615)
!1721 = !DILocation(line: 68, column: 57, scope: !1603, inlinedAt: !1615)
!1722 = !DILocation(line: 68, column: 69, scope: !1603, inlinedAt: !1615)
!1723 = !DILocation(line: 68, column: 72, scope: !1603, inlinedAt: !1615)
!1724 = !DILocation(line: 68, column: 79, scope: !1603, inlinedAt: !1615)
!1725 = !DILocation(line: 68, column: 84, scope: !1603, inlinedAt: !1615)
!1726 = !DILocation(line: 68, column: 99, scope: !1603, inlinedAt: !1615)
!1727 = !DILocation(line: 68, column: 102, scope: !1603, inlinedAt: !1615)
!1728 = !DILocation(line: 68, column: 109, scope: !1603, inlinedAt: !1615)
!1729 = !DILocation(line: 68, column: 114, scope: !1603, inlinedAt: !1615)
!1730 = !DILocation(line: 68, column: 94, scope: !1603, inlinedAt: !1615)
!1731 = !DILocation(line: 68, column: 63, scope: !1603, inlinedAt: !1615)
!1732 = !DILocation(line: 67, column: 25, scope: !1733)
!1733 = distinct !DILexicalBlock(scope: !1609, file: !907, line: 67, column: 25)
!1734 = !DILocation(line: 67, column: 34, scope: !1733)
!1735 = !DILocation(line: 67, column: 32, scope: !1733)
!1736 = !DILocation(line: 67, column: 25, scope: !1609)
!1737 = !DILocation(line: 68, column: 36, scope: !1738)
!1738 = distinct !DILexicalBlock(scope: !1733, file: !907, line: 67, column: 44)
!1739 = !DILocation(line: 68, column: 25, scope: !1738)
!1740 = !DILocation(line: 68, column: 30, scope: !1738)
!1741 = !DILocation(line: 68, column: 34, scope: !1738)
!1742 = !DILocation(line: 69, column: 43, scope: !1738)
!1743 = !DILocation(line: 69, column: 34, scope: !1738)
!1744 = !DILocation(line: 69, column: 25, scope: !1738)
!1745 = !DILocation(line: 69, column: 28, scope: !1738)
!1746 = !DILocation(line: 69, column: 32, scope: !1738)
!1747 = !DILocation(line: 70, column: 39, scope: !1738)
!1748 = !DILocation(line: 70, column: 48, scope: !1738)
!1749 = !DILocation(line: 70, column: 46, scope: !1738)
!1750 = !DILocation(line: 70, column: 25, scope: !1738)
!1751 = !DILocation(line: 70, column: 28, scope: !1738)
!1752 = !DILocation(line: 70, column: 37, scope: !1738)
!1753 = !DILocation(line: 72, column: 32, scope: !1738)
!1754 = !DILocation(line: 72, column: 37, scope: !1738)
!1755 = !DILocation(line: 72, column: 25, scope: !1738)
!1756 = !DILocation(line: 72, column: 45, scope: !1738)
!1757 = !DILocation(line: 73, column: 25, scope: !1738)
!1758 = !DILocation(line: 73, column: 30, scope: !1738)
!1759 = !DILocation(line: 73, column: 37, scope: !1738)
!1760 = !DILocation(line: 74, column: 31, scope: !1738)
!1761 = !DILocation(line: 75, column: 21, scope: !1738)
!1762 = !DILocation(line: 76, column: 17, scope: !1609)
!1763 = !DILocation(line: 77, column: 17, scope: !1611)
!1764 = !DILocation(line: 80, column: 22, scope: !1619)
!1765 = !DILocation(line: 80, column: 31, scope: !1619)
!1766 = !DILocation(line: 80, column: 40, scope: !1619)
!1767 = !DILocation(line: 80, column: 44, scope: !1768)
!1768 = !DILexicalBlockFile(scope: !1619, file: !907, discriminator: 1)
!1769 = !DILocation(line: 80, column: 49, scope: !1768)
!1770 = !DILocation(line: 80, column: 56, scope: !1768)
!1771 = !DILocation(line: 80, column: 21, scope: !1768)
!1772 = !DILocalVariable(name: "lba", scope: !1618, file: !907, line: 82, type: !900)
!1773 = !DILocation(line: 82, column: 30, scope: !1618)
!1774 = !DILocation(line: 82, column: 80, scope: !1618)
!1775 = !DILocation(line: 82, column: 93, scope: !1618)
!1776 = !DILocation(line: 82, column: 36, scope: !1618)
!1777 = !DILocation(line: 68, column: 16, scope: !1603, inlinedAt: !1617)
!1778 = !DILocation(line: 68, column: 19, scope: !1603, inlinedAt: !1617)
!1779 = !DILocation(line: 68, column: 24, scope: !1603, inlinedAt: !1617)
!1780 = !DILocation(line: 68, column: 38, scope: !1603, inlinedAt: !1617)
!1781 = !DILocation(line: 68, column: 41, scope: !1603, inlinedAt: !1617)
!1782 = !DILocation(line: 68, column: 46, scope: !1603, inlinedAt: !1617)
!1783 = !DILocation(line: 68, column: 34, scope: !1603, inlinedAt: !1617)
!1784 = !DILocation(line: 68, column: 57, scope: !1603, inlinedAt: !1617)
!1785 = !DILocation(line: 68, column: 69, scope: !1603, inlinedAt: !1617)
!1786 = !DILocation(line: 68, column: 72, scope: !1603, inlinedAt: !1617)
!1787 = !DILocation(line: 68, column: 79, scope: !1603, inlinedAt: !1617)
!1788 = !DILocation(line: 68, column: 84, scope: !1603, inlinedAt: !1617)
!1789 = !DILocation(line: 68, column: 99, scope: !1603, inlinedAt: !1617)
!1790 = !DILocation(line: 68, column: 102, scope: !1603, inlinedAt: !1617)
!1791 = !DILocation(line: 68, column: 109, scope: !1603, inlinedAt: !1617)
!1792 = !DILocation(line: 68, column: 114, scope: !1603, inlinedAt: !1617)
!1793 = !DILocation(line: 68, column: 94, scope: !1603, inlinedAt: !1617)
!1794 = !DILocation(line: 68, column: 63, scope: !1603, inlinedAt: !1617)
!1795 = !DILocation(line: 84, column: 25, scope: !1796)
!1796 = distinct !DILexicalBlock(scope: !1618, file: !907, line: 84, column: 25)
!1797 = !DILocation(line: 84, column: 32, scope: !1796)
!1798 = !DILocation(line: 84, column: 37, scope: !1796)
!1799 = !DILocation(line: 84, column: 29, scope: !1796)
!1800 = !DILocation(line: 84, column: 25, scope: !1618)
!1801 = !DILocation(line: 85, column: 32, scope: !1802)
!1802 = distinct !DILexicalBlock(scope: !1796, file: !907, line: 84, column: 42)
!1803 = !DILocation(line: 85, column: 37, scope: !1802)
!1804 = !DILocation(line: 85, column: 46, scope: !1802)
!1805 = !DILocation(line: 85, column: 51, scope: !1802)
!1806 = !DILocation(line: 85, column: 44, scope: !1802)
!1807 = !DILocation(line: 85, column: 59, scope: !1802)
!1808 = !DILocation(line: 85, column: 25, scope: !1802)
!1809 = !DILocation(line: 86, column: 36, scope: !1802)
!1810 = !DILocation(line: 87, column: 31, scope: !1802)
!1811 = !DILocation(line: 88, column: 21, scope: !1802)
!1812 = !DILocation(line: 89, column: 17, scope: !1618)
!1813 = !DILocation(line: 90, column: 17, scope: !1611)
!1814 = !DILocation(line: 92, column: 5, scope: !1612)
!1815 = !DILocation(line: 94, column: 10, scope: !1816)
!1816 = distinct !DILexicalBlock(scope: !1601, file: !907, line: 94, column: 9)
!1817 = !DILocation(line: 94, column: 16, scope: !1816)
!1818 = !DILocation(line: 94, column: 19, scope: !1819)
!1819 = !DILexicalBlockFile(scope: !1816, file: !907, discriminator: 1)
!1820 = !DILocation(line: 94, column: 9, scope: !1819)
!1821 = !DILocation(line: 95, column: 9, scope: !1822)
!1822 = distinct !DILexicalBlock(scope: !1816, file: !907, line: 94, column: 31)
!1823 = !DILocation(line: 95, column: 14, scope: !1822)
!1824 = !DILocation(line: 95, column: 21, scope: !1822)
!1825 = !DILocation(line: 96, column: 9, scope: !1822)
!1826 = !DILocation(line: 96, column: 14, scope: !1822)
!1827 = !DILocation(line: 96, column: 18, scope: !1822)
!1828 = !DILocation(line: 97, column: 5, scope: !1822)
!1829 = !DILocation(line: 99, column: 9, scope: !1830)
!1830 = distinct !DILexicalBlock(scope: !1601, file: !907, line: 99, column: 9)
!1831 = !DILocation(line: 99, column: 9, scope: !1601)
!1832 = !DILocation(line: 100, column: 20, scope: !1833)
!1833 = distinct !DILexicalBlock(scope: !1830, file: !907, line: 99, column: 21)
!1834 = !DILocation(line: 100, column: 25, scope: !1833)
!1835 = !DILocation(line: 100, column: 10, scope: !1833)
!1836 = !DILocation(line: 100, column: 18, scope: !1833)
!1837 = !DILocation(line: 101, column: 10, scope: !1833)
!1838 = !DILocation(line: 101, column: 23, scope: !1833)
!1839 = !DILocation(line: 102, column: 5, scope: !1833)
!1840 = !DILocation(line: 103, column: 10, scope: !1841)
!1841 = distinct !DILexicalBlock(scope: !1830, file: !907, line: 102, column: 12)
!1842 = !DILocation(line: 103, column: 18, scope: !1841)
!1843 = !DILocation(line: 104, column: 10, scope: !1841)
!1844 = !DILocation(line: 104, column: 23, scope: !1841)
!1845 = !DILocation(line: 107, column: 12, scope: !1601)
!1846 = !DILocation(line: 107, column: 5, scope: !1601)
