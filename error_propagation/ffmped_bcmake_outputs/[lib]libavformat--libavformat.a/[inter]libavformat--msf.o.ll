; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--msf.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--msf.o.i"
...
@ff_msf_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 0, i32 (%struct.AVProbeData*)* @msf_probe, i32 (%struct.AVFormatContext*)* @msf_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @msf_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
...
define internal i32 @msf_probe(%struct.AVProbeData* %p) #0 !dbg !2150 {
entry:
  %x.addr.i34 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %x.addr.i34, metadata !2152, metadata !2157), !dbg !2158
  %x.addr.i19 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %x.addr.i19, metadata !2152, metadata !2157), !dbg !2161
  %x.addr.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %x.addr.i, metadata !2152, metadata !2157), !dbg !2164
  %retval = alloca i32, align 4
  %p.addr = alloca %struct.AVProbeData*, align 8
  store %struct.AVProbeData* %p, %struct.AVProbeData** %p.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVProbeData** %p.addr, metadata !2167, metadata !2157), !dbg !2168
  ...
  %call = call i32 @memcmp(i8* %1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0), i64 3) #5, !dbg !2172
  %tobool = icmp ne i32 %call, 0, !dbg !2172
  br i1 %tobool, label %if.then, label %if.end, !dbg !2173
...
if.end:                                           ; preds = %entry
  ...
  %buf1 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %2, i32 0, i32 1, !dbg !2176
  %3 = load i8*, i8** %buf1, align 8, !dbg !2176
  %add.ptr = getelementptr inbounds i8, i8* %3, i64 8, !dbg !2177
  %4 = bitcast i8* %add.ptr to %union.unaligned_32*, !dbg !2178
  %l = bitcast %union.unaligned_32* %4 to i32*, !dbg !2178
  %5 = load i32, i32* %l, align 1, !dbg !2178
  store i32 %5, i32* %x.addr.i, align 4, !dbg !2179
  %6 = load i32, i32* %x.addr.i, align 4, !dbg !2180
  %shl.i = shl i32 %6, 8, !dbg !2181
  %and.i = and i32 %shl.i, 65280, !dbg !2182
  %7 = load i32, i32* %x.addr.i, align 4, !dbg !2183
  %shr.i = lshr i32 %7, 8, !dbg !2184
  %and1.i = and i32 %shr.i, 255, !dbg !2185
  %or.i = or i32 %and.i, %and1.i, !dbg !2186
  %shl2.i = shl i32 %or.i, 16, !dbg !2187
  %8 = load i32, i32* %x.addr.i, align 4, !dbg !2188
  %shr3.i = lshr i32 %8, 16, !dbg !2189
  %shl4.i = shl i32 %shr3.i, 8, !dbg !2190
  %and5.i = and i32 %shl4.i, 65280, !dbg !2191
  %9 = load i32, i32* %x.addr.i, align 4, !dbg !2192
  %shr6.i = lshr i32 %9, 16, !dbg !2193
  %shr7.i = lshr i32 %shr6.i, 8, !dbg !2194
  %and8.i = and i32 %shr7.i, 255, !dbg !2195
  %or9.i = or i32 %and5.i, %and8.i, !dbg !2196
  %or10.i = or i32 %shl2.i, %or9.i, !dbg !2197
  %cmp = icmp ule i32 %or10.i, 0, !dbg !2198
  br i1 %cmp, label %if.then3, label %if.end4, !dbg !2199
...
if.end4:                                          ; preds = %if.end
  %10 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2201
  %buf5 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %10, i32 0, i32 1, !dbg !2202
  %11 = load i8*, i8** %buf5, align 8, !dbg !2202
  %add.ptr6 = getelementptr inbounds i8, i8* %11, i64 16, !dbg !2203
  %12 = bitcast i8* %add.ptr6 to %union.unaligned_32*, !dbg !2204
  %l7 = bitcast %union.unaligned_32* %12 to i32*, !dbg !2204
  %13 = load i32, i32* %l7, align 1, !dbg !2204
  store i32 %13, i32* %x.addr.i34, align 4, !dbg !2205
  %14 = load i32, i32* %x.addr.i34, align 4, !dbg !2206
  %shl.i35 = shl i32 %14, 8, !dbg !2207
  %and.i36 = and i32 %shl.i35, 65280, !dbg !2208
  %15 = load i32, i32* %x.addr.i34, align 4, !dbg !2209
  %shr.i37 = lshr i32 %15, 8, !dbg !2210
  %and1.i38 = and i32 %shr.i37, 255, !dbg !2211
  %or.i39 = or i32 %and.i36, %and1.i38, !dbg !2212
  %shl2.i40 = shl i32 %or.i39, 16, !dbg !2213
  %16 = load i32, i32* %x.addr.i34, align 4, !dbg !2214
  %shr3.i41 = lshr i32 %16, 16, !dbg !2215
  %shl4.i42 = shl i32 %shr3.i41, 8, !dbg !2216
  %and5.i43 = and i32 %shl4.i42, 65280, !dbg !2217
  %17 = load i32, i32* %x.addr.i34, align 4, !dbg !2218
  %shr6.i44 = lshr i32 %17, 16, !dbg !2219
  %shr7.i45 = lshr i32 %shr6.i44, 8, !dbg !2220
  %and8.i46 = and i32 %shr7.i45, 255, !dbg !2221
  %or9.i47 = or i32 %and5.i43, %and8.i46, !dbg !2222
  %or10.i48 = or i32 %shl2.i40, %or9.i47, !dbg !2223
  %cmp9 = icmp ule i32 %or10.i48, 0, !dbg !2224
  br i1 %cmp9, label %if.then10, label %if.end11, !dbg !2225
...
if.end11:                                         ; preds = %if.end4
  ...
  %buf12 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %18, i32 0, i32 1, !dbg !2228
  %19 = load i8*, i8** %buf12, align 8, !dbg !2228
  %add.ptr13 = getelementptr inbounds i8, i8* %19, i64 4, !dbg !2229
  %20 = bitcast i8* %add.ptr13 to %union.unaligned_32*, !dbg !2230
  %l14 = bitcast %union.unaligned_32* %20 to i32*, !dbg !2230
  %21 = load i32, i32* %l14, align 1, !dbg !2230
  store i32 %21, i32* %x.addr.i19, align 4, !dbg !2231
  %22 = load i32, i32* %x.addr.i19, align 4, !dbg !2232
  %shl.i20 = shl i32 %22, 8, !dbg !2233
  %and.i21 = and i32 %shl.i20, 65280, !dbg !2234
  %23 = load i32, i32* %x.addr.i19, align 4, !dbg !2235
  %shr.i22 = lshr i32 %23, 8, !dbg !2236
  %and1.i23 = and i32 %shr.i22, 255, !dbg !2237
  %or.i24 = or i32 %and.i21, %and1.i23, !dbg !2238
  %shl2.i25 = shl i32 %or.i24, 16, !dbg !2239
  %24 = load i32, i32* %x.addr.i19, align 4, !dbg !2240
  %shr3.i26 = lshr i32 %24, 16, !dbg !2241
  %shl4.i27 = shl i32 %shr3.i26, 8, !dbg !2242
  %and5.i28 = and i32 %shl4.i27, 65280, !dbg !2243
  %25 = load i32, i32* %x.addr.i19, align 4, !dbg !2244
  %shr6.i29 = lshr i32 %25, 16, !dbg !2245
  %shr7.i30 = lshr i32 %shr6.i29, 8, !dbg !2246
  %and8.i31 = and i32 %shr7.i30, 255, !dbg !2247
  %or9.i32 = or i32 %and5.i28, %and8.i31, !dbg !2248
  %or10.i33 = or i32 %shl2.i25, %or9.i32, !dbg !2249
  %cmp16 = icmp ugt i32 %or10.i33, 16, !dbg !2250
  br i1 %cmp16, label %if.then17, label %if.end18, !dbg !2251

if.then17:                                        ; preds = %if.end11
  store i32 20, i32* %retval, align 4, !dbg !2252
  br label %return, !dbg !2252

if.end18:                                         ; preds = %if.end11
  store i32 66, i32* %retval, align 4, !dbg !2253
  br label %return, !dbg !2253

return:                                           ; preds = %if.end18, %if.then17, %if.then10, %if.then3, %if.then
  %26 = load i32, i32* %retval, align 4, !dbg !2254
  ret i32 %26, !dbg !2254
}

; Function Attrs: nounwind uwtable
define internal i32 @msf_read_header(%struct.AVFormatContext* %s) #0 !dbg !2255 {
entry:
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2260, metadata !2157), !dbg !2264
  %retval = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2266, metadata !2157), !dbg !2267
  call void @llvm.dbg.declare(metadata i32* %codec, metadata !2268, metadata !2157), !dbg !2269
  call void @llvm.dbg.declare(metadata i32* %size, metadata !2270, metadata !2157), !dbg !2271
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2272, metadata !2157), !dbg !2273
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2274, metadata !2157), !dbg !2275
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2276
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2277
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2277
  %call = call i64 @avio_skip(%struct.AVIOContext* %1, i64 4), !dbg !2278
  %2 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2279
  %call1 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %2, %struct.AVCodec* null), !dbg !2280
  store %struct.AVStream* %call1, %struct.AVStream** %st, align 8, !dbg !2281
  %3 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2282
  %tobool = icmp ne %struct.AVStream* %3, null, !dbg !2282
...
if.end:                                           ; preds = %entry
  %4 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2286
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %4, i32 0, i32 19, !dbg !2287
  %5 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2287
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %5, i32 0, i32 0, !dbg !2288
  store i32 1, i32* %codec_type, align 8, !dbg !2289
  %6 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2290
  %pb2 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %6, i32 0, i32 4, !dbg !2291
  %7 = load %struct.AVIOContext*, %struct.AVIOContext** %pb2, align 8, !dbg !2291
  %call3 = call i32 @avio_rb32(%struct.AVIOContext* %7), !dbg !2292
  store i32 %call3, i32* %codec, align 4, !dbg !2293
  %8 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2294
  %pb4 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %8, i32 0, i32 4, !dbg !2295
  %9 = load %struct.AVIOContext*, %struct.AVIOContext** %pb4, align 8, !dbg !2295
  %call5 = call i32 @avio_rb32(%struct.AVIOContext* %9), !dbg !2296
  %10 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2297
  %codecpar6 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %10, i32 0, i32 19, !dbg !2298
  %11 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar6, align 8, !dbg !2298
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %11, i32 0, i32 22, !dbg !2299
  store i32 %call5, i32* %channels, align 8, !dbg !2300
  %12 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2301
  %codecpar7 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %12, i32 0, i32 19, !dbg !2303
  %13 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar7, align 8, !dbg !2303
  %channels8 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %13, i32 0, i32 22, !dbg !2304
  %14 = load i32, i32* %channels8, align 8, !dbg !2304
  %cmp = icmp sle i32 %14, 0, !dbg !2305
  br i1 %cmp, label %if.then12, label %lor.lhs.false, !dbg !2306

lor.lhs.false:                                    ; preds = %if.end
  %15 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2307
  %codecpar9 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %15, i32 0, i32 19, !dbg !2309
  %16 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar9, align 8, !dbg !2309
  %channels10 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %16, i32 0, i32 22, !dbg !2310
  %17 = load i32, i32* %channels10, align 8, !dbg !2310
  %cmp11 = icmp sge i32 %17, 2097151, !dbg !2311
  br i1 %cmp11, label %if.then12, label %if.end13, !dbg !2312
...
if.end13:                                         ; preds = %lor.lhs.false
  %18 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2314
  %pb14 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %18, i32 0, i32 4, !dbg !2315
  %19 = load %struct.AVIOContext*, %struct.AVIOContext** %pb14, align 8, !dbg !2315
  %call15 = call i32 @avio_rb32(%struct.AVIOContext* %19), !dbg !2316
  store i32 %call15, i32* %size, align 4, !dbg !2317
  %20 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2318
  %pb16 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %20, i32 0, i32 4, !dbg !2319
  %21 = load %struct.AVIOContext*, %struct.AVIOContext** %pb16, align 8, !dbg !2319
  %call17 = call i32 @avio_rb32(%struct.AVIOContext* %21), !dbg !2320
  %22 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2321
  %codecpar18 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %22, i32 0, i32 19, !dbg !2322
  %23 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar18, align 8, !dbg !2322
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %23, i32 0, i32 23, !dbg !2323
  store i32 %call17, i32* %sample_rate, align 4, !dbg !2324
  %24 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2325
  %codecpar19 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %24, i32 0, i32 19, !dbg !2327
  %25 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar19, align 8, !dbg !2327
  %sample_rate20 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %25, i32 0, i32 23, !dbg !2328
  %26 = load i32, i32* %sample_rate20, align 4, !dbg !2328
  %cmp21 = icmp sle i32 %26, 0, !dbg !2329
  br i1 %cmp21, label %if.then22, label %if.end23, !dbg !2330
...
if.end23:                                         ; preds = %if.end13
  %27 = load i32, i32* %codec, align 4, !dbg !2332
...
sw.bb:                                            ; preds = %if.end23
  ...
  %codecpar24 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %28, i32 0, i32 19, !dbg !2336
  %29 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar24, align 8, !dbg !2336
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %29, i32 0, i32 1, !dbg !2337
  store i32 65537, i32* %codec_id, align 4, !dbg !2338
  br label %sw.epilog, !dbg !2339

sw.bb25:                                          ; preds = %if.end23
  %30 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2340
  %codecpar26 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %30, i32 0, i32 19, !dbg !2341
  %31 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar26, align 8, !dbg !2341
  %codec_id27 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %31, i32 0, i32 1, !dbg !2342
  store i32 65536, i32* %codec_id27, align 4, !dbg !2343
  br label %sw.epilog, !dbg !2344

sw.bb28:                                          ; preds = %if.end23
  %32 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2345
  %codecpar29 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %32, i32 0, i32 19, !dbg !2346
  %33 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar29, align 8, !dbg !2346
  %channels30 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %33, i32 0, i32 22, !dbg !2347
  %34 = load i32, i32* %channels30, align 8, !dbg !2347
  %mul = mul nsw i32 16, %34, !dbg !2348
  %35 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2349
  %codecpar31 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %35, i32 0, i32 19, !dbg !2350
  %36 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar31, align 8, !dbg !2350
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %36, i32 0, i32 24, !dbg !2351
  store i32 %mul, i32* %block_align, align 8, !dbg !2352
  %37 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2353
  %codecpar32 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %37, i32 0, i32 19, !dbg !2354
  %38 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar32, align 8, !dbg !2354
  %codec_id33 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %38, i32 0, i32 1, !dbg !2355
  store i32 71686, i32* %codec_id33, align 4, !dbg !2356
  br label %sw.epilog, !dbg !2357

sw.bb34:                                          ; preds = %if.end23, %if.end23, %if.end23
  %39 = load i32, i32* %codec, align 4, !dbg !2358
  %cmp35 = icmp eq i32 %39, 4, !dbg !2359
  br i1 %cmp35, label %cond.true, label %cond.false, !dbg !2358

cond.true:                                        ; preds = %sw.bb34
  br label %cond.end, !dbg !2360

cond.false:                                       ; preds = %sw.bb34
  %40 = load i32, i32* %codec, align 4, !dbg !2362
  %cmp36 = icmp eq i32 %40, 5, !dbg !2364
  %cond = select i1 %cmp36, i32 152, i32 192, !dbg !2362
  br label %cond.end, !dbg !2365

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond37 = phi i32 [ 96, %cond.true ], [ %cond, %cond.false ], !dbg !2366
  %41 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2368
  %codecpar38 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %41, i32 0, i32 19, !dbg !2369
  %42 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar38, align 8, !dbg !2369
  %channels39 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %42, i32 0, i32 22, !dbg !2370
  %43 = load i32, i32* %channels39, align 8, !dbg !2370
  %mul40 = mul nsw i32 %cond37, %43, !dbg !2371
  %44 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2372
  %codecpar41 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %44, i32 0, i32 19, !dbg !2373
  %45 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar41, align 8, !dbg !2373
  %block_align42 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %45, i32 0, i32 24, !dbg !2374
  store i32 %mul40, i32* %block_align42, align 8, !dbg !2375
  %46 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2376
  %codecpar43 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %46, i32 0, i32 19, !dbg !2377
  %47 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar43, align 8, !dbg !2377
  %call44 = call i32 @ff_alloc_extradata(%struct.AVCodecParameters* %47, i32 14), !dbg !2378
  store i32 %call44, i32* %ret, align 4, !dbg !2379
  %48 = load i32, i32* %ret, align 4, !dbg !2380
  %cmp45 = icmp slt i32 %48, 0, !dbg !2382
  br i1 %cmp45, label %if.then46, label %if.end47, !dbg !2383

if.then46:                                        ; preds = %cond.end
  %49 = load i32, i32* %ret, align 4, !dbg !2384
  store i32 %49, i32* %retval, align 4, !dbg !2385
  br label %return, !dbg !2385

if.end47:                                         ; preds = %cond.end
  %50 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2386
  %codecpar48 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %50, i32 0, i32 19, !dbg !2387
  %51 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar48, align 8, !dbg !2387
  %extradata = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %51, i32 0, i32 3, !dbg !2388
  %52 = load i8*, i8** %extradata, align 8, !dbg !2388
  %53 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2389
  %codecpar49 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %53, i32 0, i32 19, !dbg !2390
  %54 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar49, align 8, !dbg !2390
  %extradata_size = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %54, i32 0, i32 4, !dbg !2391
  %55 = load i32, i32* %extradata_size, align 8, !dbg !2391
  %conv = sext i32 %55 to i64, !dbg !2389
  call void @llvm.memset.p0i8.i64(i8* %52, i8 0, i64 %conv, i32 1, i1 false), !dbg !2392
  %56 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2393
  %codecpar50 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %56, i32 0, i32 19, !dbg !2394
  %57 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar50, align 8, !dbg !2394
  %extradata51 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %57, i32 0, i32 3, !dbg !2395
  %58 = load i8*, i8** %extradata51, align 8, !dbg !2395
  %59 = bitcast i8* %58 to %union.unaligned_16*, !dbg !2396
  %l = bitcast %union.unaligned_16* %59 to i16*, !dbg !2396
  store i16 1, i16* %l, align 1, !dbg !2397
  %60 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2398
  %codecpar52 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %60, i32 0, i32 19, !dbg !2399
  %61 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar52, align 8, !dbg !2399
  %channels53 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %61, i32 0, i32 22, !dbg !2400
  %62 = load i32, i32* %channels53, align 8, !dbg !2400
  %mul54 = mul nsw i32 2048, %62, !dbg !2401
  %conv55 = trunc i32 %mul54 to i16, !dbg !2402
  %63 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2403
  %codecpar56 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %63, i32 0, i32 19, !dbg !2404
  %64 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar56, align 8, !dbg !2404
  %extradata57 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %64, i32 0, i32 3, !dbg !2405
  %65 = load i8*, i8** %extradata57, align 8, !dbg !2405
  %add.ptr = getelementptr inbounds i8, i8* %65, i64 2, !dbg !2406
  %66 = bitcast i8* %add.ptr to %union.unaligned_16*, !dbg !2407
  %l58 = bitcast %union.unaligned_16* %66 to i16*, !dbg !2407
  store i16 %conv55, i16* %l58, align 1, !dbg !2408
  %67 = load i32, i32* %codec, align 4, !dbg !2409
  %cmp59 = icmp eq i32 %67, 4, !dbg !2410
  %cond61 = select i1 %cmp59, i32 1, i32 0, !dbg !2409
  %conv62 = trunc i32 %cond61 to i16, !dbg !2411
  %68 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2412
  %codecpar63 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %68, i32 0, i32 19, !dbg !2413
  %69 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar63, align 8, !dbg !2413
  %extradata64 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %69, i32 0, i32 3, !dbg !2414
  %70 = load i8*, i8** %extradata64, align 8, !dbg !2414
  %add.ptr65 = getelementptr inbounds i8, i8* %70, i64 6, !dbg !2415
  %71 = bitcast i8* %add.ptr65 to %union.unaligned_16*, !dbg !2416
  %l66 = bitcast %union.unaligned_16* %71 to i16*, !dbg !2416
  store i16 %conv62, i16* %l66, align 1, !dbg !2417
  %72 = load i32, i32* %codec, align 4, !dbg !2418
  %cmp67 = icmp eq i32 %72, 4, !dbg !2419
  %cond69 = select i1 %cmp67, i32 1, i32 0, !dbg !2418
  %conv70 = trunc i32 %cond69 to i16, !dbg !2420
  %73 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2421
  %codecpar71 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %73, i32 0, i32 19, !dbg !2422
  %74 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar71, align 8, !dbg !2422
  %extradata72 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %74, i32 0, i32 3, !dbg !2423
  %75 = load i8*, i8** %extradata72, align 8, !dbg !2423
  %add.ptr73 = getelementptr inbounds i8, i8* %75, i64 8, !dbg !2424
  %76 = bitcast i8* %add.ptr73 to %union.unaligned_16*, !dbg !2425
  %l74 = bitcast %union.unaligned_16* %76 to i16*, !dbg !2425
  store i16 %conv70, i16* %l74, align 1, !dbg !2426
  %77 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2427
  %codecpar75 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %77, i32 0, i32 19, !dbg !2428
  %78 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar75, align 8, !dbg !2428
  %extradata76 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %78, i32 0, i32 3, !dbg !2429
  %79 = load i8*, i8** %extradata76, align 8, !dbg !2429
  %add.ptr77 = getelementptr inbounds i8, i8* %79, i64 10, !dbg !2430
  %80 = bitcast i8* %add.ptr77 to %union.unaligned_16*, !dbg !2431
  %l78 = bitcast %union.unaligned_16* %80 to i16*, !dbg !2431
  store i16 1, i16* %l78, align 1, !dbg !2432
  %81 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2433
  %codecpar79 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %81, i32 0, i32 19, !dbg !2434
  %82 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar79, align 8, !dbg !2434
  %codec_id80 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %82, i32 0, i32 1, !dbg !2435
  store i32 86047, i32* %codec_id80, align 4, !dbg !2436
  br label %sw.epilog, !dbg !2437

sw.bb81:                                          ; preds = %if.end23
  %83 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2438
  %need_parsing = getelementptr inbounds %struct.AVStream, %struct.AVStream* %83, i32 0, i32 28, !dbg !2439
  store i32 5, i32* %need_parsing, align 4, !dbg !2440
  %84 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2441
  %codecpar82 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %84, i32 0, i32 19, !dbg !2442
  %85 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar82, align 8, !dbg !2442
  %codec_id83 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %85, i32 0, i32 1, !dbg !2443
  store i32 86017, i32* %codec_id83, align 4, !dbg !2444
  br label %sw.epilog, !dbg !2445

sw.default:                                       ; preds = %if.end23
  %86 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2446
  %87 = bitcast %struct.AVFormatContext* %86 to i8*, !dbg !2446
  %88 = load i32, i32* %codec, align 4, !dbg !2447
  call void (i8*, i8*, ...) @avpriv_request_sample(i8* %87, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i32 0, i32 0), i32 %88), !dbg !2448
  store i32 -1163346256, i32* %retval, align 4, !dbg !2449
  br label %return, !dbg !2449

sw.epilog:                                        ; preds = %sw.bb81, %if.end47, %sw.bb28, %sw.bb25, %sw.bb
  %89 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2450
  %codecpar84 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %89, i32 0, i32 19, !dbg !2451
  %90 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar84, align 8, !dbg !2451
  %91 = load i32, i32* %size, align 4, !dbg !2452
  %call85 = call i32 @av_get_audio_frame_duration2(%struct.AVCodecParameters* %90, i32 %91), !dbg !2453
  %conv86 = sext i32 %call85 to i64, !dbg !2453
  %92 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2454
  %duration = getelementptr inbounds %struct.AVStream, %struct.AVStream* %92, i32 0, i32 6, !dbg !2455
  store i64 %conv86, i64* %duration, align 8, !dbg !2456
  %93 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2457
  %pb87 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %93, i32 0, i32 4, !dbg !2458
  %94 = load %struct.AVIOContext*, %struct.AVIOContext** %pb87, align 8, !dbg !2458
  %95 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2459
  %pb88 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %95, i32 0, i32 4, !dbg !2460
  %96 = load %struct.AVIOContext*, %struct.AVIOContext** %pb88, align 8, !dbg !2460
  store %struct.AVIOContext* %96, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2461
  %97 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2462
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %97, i64 0, i32 1) #6, !dbg !2463
  %sub = sub nsw i64 64, %call.i, !dbg !2464
  %call90 = call i64 @avio_skip(%struct.AVIOContext* %94, i64 %sub), !dbg !2465
  %98 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2467
  %99 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2468
  %codecpar91 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %99, i32 0, i32 19, !dbg !2469
  %100 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar91, align 8, !dbg !2469
  %sample_rate92 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %100, i32 0, i32 23, !dbg !2470
  %101 = load i32, i32* %sample_rate92, align 4, !dbg !2470
  call void @avpriv_set_pts_info(%struct.AVStream* %98, i32 64, i32 1, i32 %101), !dbg !2471
  store i32 0, i32* %retval, align 4, !dbg !2472
  br label %return, !dbg !2472

return:                                           ; preds = %sw.epilog, %sw.default, %if.then46, %if.then22, %if.then12, %if.then
  %102 = load i32, i32* %retval, align 4, !dbg !2473
  ret i32 %102, !dbg !2473
}

; Function Attrs: nounwind uwtable
define internal i32 @msf_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2474 {
entry:
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %pkt.addr = alloca %struct.AVPacket*, align 8
  %par = alloca %struct.AVCodecParameters*, align 8
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2477, metadata !2157), !dbg !2478
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2479, metadata !2157), !dbg !2480
  call void @llvm.dbg.declare(metadata %struct.AVCodecParameters** %par, metadata !2481, metadata !2157), !dbg !2482
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2483
  %streams = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 7, !dbg !2484
  %1 = load %struct.AVStream**, %struct.AVStream*** %streams, align 8, !dbg !2484
  %arrayidx = getelementptr inbounds %struct.AVStream*, %struct.AVStream** %1, i64 0, !dbg !2483
  %2 = load %struct.AVStream*, %struct.AVStream** %arrayidx, align 8, !dbg !2483
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %2, i32 0, i32 19, !dbg !2485
  %3 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2485
  store %struct.AVCodecParameters* %3, %struct.AVCodecParameters** %par, align 8, !dbg !2482
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2486
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %4, i32 0, i32 4, !dbg !2487
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2487
  %6 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2488
  %7 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2489
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %7, i32 0, i32 24, !dbg !2490
  %8 = load i32, i32* %block_align, align 8, !dbg !2490
  %tobool = icmp ne i32 %8, 0, !dbg !2489
  br i1 %tobool, label %cond.true, label %cond.false, !dbg !2489

cond.true:                                        ; preds = %entry
  %9 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2491
  %block_align1 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %9, i32 0, i32 24, !dbg !2493
  %10 = load i32, i32* %block_align1, align 8, !dbg !2493
  br label %cond.end, !dbg !2494

cond.false:                                       ; preds = %entry
  %11 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2495
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %11, i32 0, i32 22, !dbg !2497
  %12 = load i32, i32* %channels, align 8, !dbg !2497
  %mul = mul nsw i32 1024, %12, !dbg !2498
  br label %cond.end, !dbg !2499

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %10, %cond.true ], [ %mul, %cond.false ], !dbg !2500
  %call = call i32 @av_get_packet(%struct.AVIOContext* %5, %struct.AVPacket* %6, i32 %cond), !dbg !2502
  ret i32 %call, !dbg !2503
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--msf.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!933 = !{!934}
!934 = distinct !DIGlobalVariable(name: "ff_msf_demuxer", scope: !0, file: !935, line: 103, type: !936, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_msf_demuxer)
!935 = !DIFile(filename: "libavformat/msf.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2150 = distinct !DISubprogram(name: "msf_probe", scope: !935, file: !935, line: 26, type: !1005, isLocal: true, isDefinition: true, scopeLine: 27, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2151)
!2151 = !{}
!2152 = !DILocalVariable(name: "x", arg: 1, scope: !2153, file: !2154, line: 66, type: !923)
!2153 = distinct !DISubprogram(name: "av_bswap32", scope: !2154, file: !2154, line: 66, type: !2155, isLocal: true, isDefinition: true, scopeLine: 67, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2151)
!2154 = !DIFile(filename: "./libavutil/bswap.h", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
!2155 = !DISubroutineType(types: !2156)
!2156 = !{!923, !923}
!2157 = !DIExpression()
!2158 = !DILocation(line: 66, column: 98, scope: !2153, inlinedAt: !2159)
!2159 = distinct !DILocation(line: 34, column: 9, scope: !2160)
!2160 = distinct !DILexicalBlock(scope: !2150, file: !935, line: 34, column: 9)
!2161 = !DILocation(line: 66, column: 98, scope: !2153, inlinedAt: !2162)
!2162 = distinct !DILocation(line: 37, column: 9, scope: !2163)
!2163 = distinct !DILexicalBlock(scope: !2150, file: !935, line: 37, column: 9)
!2164 = !DILocation(line: 66, column: 98, scope: !2153, inlinedAt: !2165)
!2165 = distinct !DILocation(line: 31, column: 9, scope: !2166)
!2166 = distinct !DILexicalBlock(scope: !2150, file: !935, line: 31, column: 9)
!2167 = !DILocalVariable(name: "p", arg: 1, scope: !2150, file: !935, line: 26, type: !1007)
!2168 = !DILocation(line: 26, column: 35, scope: !2150)
!2169 = !DILocation(line: 28, column: 16, scope: !2170)
!2170 = distinct !DILexicalBlock(scope: !2150, file: !935, line: 28, column: 9)
!2171 = !DILocation(line: 28, column: 19, scope: !2170)
!2172 = !DILocation(line: 28, column: 9, scope: !2170)
!2173 = !DILocation(line: 28, column: 9, scope: !2150)
!2174 = !DILocation(line: 29, column: 9, scope: !2170)
!2175 = !DILocation(line: 31, column: 52, scope: !2166)
!2176 = !DILocation(line: 31, column: 55, scope: !2166)
!2177 = !DILocation(line: 31, column: 58, scope: !2166)
!2178 = !DILocation(line: 31, column: 64, scope: !2166)
!2179 = !DILocation(line: 31, column: 9, scope: !2166)
!2180 = !DILocation(line: 68, column: 16, scope: !2153, inlinedAt: !2165)
!2181 = !DILocation(line: 68, column: 19, scope: !2153, inlinedAt: !2165)
!2182 = !DILocation(line: 68, column: 24, scope: !2153, inlinedAt: !2165)
!2183 = !DILocation(line: 68, column: 38, scope: !2153, inlinedAt: !2165)
!2184 = !DILocation(line: 68, column: 41, scope: !2153, inlinedAt: !2165)
!2185 = !DILocation(line: 68, column: 46, scope: !2153, inlinedAt: !2165)
!2186 = !DILocation(line: 68, column: 34, scope: !2153, inlinedAt: !2165)
!2187 = !DILocation(line: 68, column: 57, scope: !2153, inlinedAt: !2165)
!2188 = !DILocation(line: 68, column: 69, scope: !2153, inlinedAt: !2165)
!2189 = !DILocation(line: 68, column: 72, scope: !2153, inlinedAt: !2165)
!2190 = !DILocation(line: 68, column: 79, scope: !2153, inlinedAt: !2165)
!2191 = !DILocation(line: 68, column: 84, scope: !2153, inlinedAt: !2165)
!2192 = !DILocation(line: 68, column: 99, scope: !2153, inlinedAt: !2165)
!2193 = !DILocation(line: 68, column: 102, scope: !2153, inlinedAt: !2165)
!2194 = !DILocation(line: 68, column: 109, scope: !2153, inlinedAt: !2165)
!2195 = !DILocation(line: 68, column: 114, scope: !2153, inlinedAt: !2165)
!2196 = !DILocation(line: 68, column: 94, scope: !2153, inlinedAt: !2165)
!2197 = !DILocation(line: 68, column: 63, scope: !2153, inlinedAt: !2165)
!2198 = !DILocation(line: 31, column: 68, scope: !2166)
!2199 = !DILocation(line: 31, column: 9, scope: !2150)
!2200 = !DILocation(line: 32, column: 9, scope: !2166)
!2201 = !DILocation(line: 34, column: 52, scope: !2160)
!2202 = !DILocation(line: 34, column: 55, scope: !2160)
!2203 = !DILocation(line: 34, column: 58, scope: !2160)
!2204 = !DILocation(line: 34, column: 65, scope: !2160)
!2205 = !DILocation(line: 34, column: 9, scope: !2160)
!2206 = !DILocation(line: 68, column: 16, scope: !2153, inlinedAt: !2159)
!2207 = !DILocation(line: 68, column: 19, scope: !2153, inlinedAt: !2159)
!2208 = !DILocation(line: 68, column: 24, scope: !2153, inlinedAt: !2159)
!2209 = !DILocation(line: 68, column: 38, scope: !2153, inlinedAt: !2159)
!2210 = !DILocation(line: 68, column: 41, scope: !2153, inlinedAt: !2159)
!2211 = !DILocation(line: 68, column: 46, scope: !2153, inlinedAt: !2159)
!2212 = !DILocation(line: 68, column: 34, scope: !2153, inlinedAt: !2159)
!2213 = !DILocation(line: 68, column: 57, scope: !2153, inlinedAt: !2159)
!2214 = !DILocation(line: 68, column: 69, scope: !2153, inlinedAt: !2159)
!2215 = !DILocation(line: 68, column: 72, scope: !2153, inlinedAt: !2159)
!2216 = !DILocation(line: 68, column: 79, scope: !2153, inlinedAt: !2159)
!2217 = !DILocation(line: 68, column: 84, scope: !2153, inlinedAt: !2159)
!2218 = !DILocation(line: 68, column: 99, scope: !2153, inlinedAt: !2159)
!2219 = !DILocation(line: 68, column: 102, scope: !2153, inlinedAt: !2159)
!2220 = !DILocation(line: 68, column: 109, scope: !2153, inlinedAt: !2159)
!2221 = !DILocation(line: 68, column: 114, scope: !2153, inlinedAt: !2159)
!2222 = !DILocation(line: 68, column: 94, scope: !2153, inlinedAt: !2159)
!2223 = !DILocation(line: 68, column: 63, scope: !2153, inlinedAt: !2159)
!2224 = !DILocation(line: 34, column: 69, scope: !2160)
!2225 = !DILocation(line: 34, column: 9, scope: !2150)
!2226 = !DILocation(line: 35, column: 9, scope: !2160)
!2227 = !DILocation(line: 37, column: 52, scope: !2163)
!2228 = !DILocation(line: 37, column: 55, scope: !2163)
!2229 = !DILocation(line: 37, column: 58, scope: !2163)
!2230 = !DILocation(line: 37, column: 64, scope: !2163)
!2231 = !DILocation(line: 37, column: 9, scope: !2163)
!2232 = !DILocation(line: 68, column: 16, scope: !2153, inlinedAt: !2162)
!2233 = !DILocation(line: 68, column: 19, scope: !2153, inlinedAt: !2162)
!2234 = !DILocation(line: 68, column: 24, scope: !2153, inlinedAt: !2162)
!2235 = !DILocation(line: 68, column: 38, scope: !2153, inlinedAt: !2162)
!2236 = !DILocation(line: 68, column: 41, scope: !2153, inlinedAt: !2162)
!2237 = !DILocation(line: 68, column: 46, scope: !2153, inlinedAt: !2162)
!2238 = !DILocation(line: 68, column: 34, scope: !2153, inlinedAt: !2162)
!2239 = !DILocation(line: 68, column: 57, scope: !2153, inlinedAt: !2162)
!2240 = !DILocation(line: 68, column: 69, scope: !2153, inlinedAt: !2162)
!2241 = !DILocation(line: 68, column: 72, scope: !2153, inlinedAt: !2162)
!2242 = !DILocation(line: 68, column: 79, scope: !2153, inlinedAt: !2162)
!2243 = !DILocation(line: 68, column: 84, scope: !2153, inlinedAt: !2162)
!2244 = !DILocation(line: 68, column: 99, scope: !2153, inlinedAt: !2162)
!2245 = !DILocation(line: 68, column: 102, scope: !2153, inlinedAt: !2162)
!2246 = !DILocation(line: 68, column: 109, scope: !2153, inlinedAt: !2162)
!2247 = !DILocation(line: 68, column: 114, scope: !2153, inlinedAt: !2162)
!2248 = !DILocation(line: 68, column: 94, scope: !2153, inlinedAt: !2162)
!2249 = !DILocation(line: 68, column: 63, scope: !2153, inlinedAt: !2162)
!2250 = !DILocation(line: 37, column: 68, scope: !2163)
!2251 = !DILocation(line: 37, column: 9, scope: !2150)
!2252 = !DILocation(line: 38, column: 9, scope: !2163)
!2253 = !DILocation(line: 40, column: 5, scope: !2150)
!2254 = !DILocation(line: 41, column: 1, scope: !2150)
!2255 = distinct !DISubprogram(name: "msf_read_header", scope: !935, file: !935, line: 43, type: !2256, isLocal: true, isDefinition: true, scopeLine: 44, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2151)
!2256 = !DISubroutineType(types: !2257)
!2257 = !{!926, !2258}
!2258 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2259, size: 64, align: 64)
!2259 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1022)
!2260 = !DILocalVariable(name: "s", arg: 1, scope: !2261, file: !628, line: 557, type: !1228)
!2261 = distinct !DISubprogram(name: "avio_tell", scope: !628, file: !628, line: 557, type: !2262, isLocal: true, isDefinition: true, scopeLine: 558, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2151)
!2262 = !DISubroutineType(types: !2263)
!2263 = !{!1066, !1228}
!2264 = !DILocation(line: 557, column: 77, scope: !2261, inlinedAt: !2265)
!2265 = distinct !DILocation(line: 90, column: 29, scope: !2255)
!2266 = !DILocalVariable(name: "s", arg: 1, scope: !2255, file: !935, line: 43, type: !2258)
!2267 = !DILocation(line: 43, column: 45, scope: !2255)
!2268 = !DILocalVariable(name: "codec", scope: !2255, file: !935, line: 45, type: !925)
!2269 = !DILocation(line: 45, column: 14, scope: !2255)
!2270 = !DILocalVariable(name: "size", scope: !2255, file: !935, line: 45, type: !925)
!2271 = !DILocation(line: 45, column: 21, scope: !2255)
!2272 = !DILocalVariable(name: "st", scope: !2255, file: !935, line: 46, type: !1296)
!2273 = !DILocation(line: 46, column: 15, scope: !2255)
!2274 = !DILocalVariable(name: "ret", scope: !2255, file: !935, line: 47, type: !926)
!2275 = !DILocation(line: 47, column: 9, scope: !2255)
!2276 = !DILocation(line: 49, column: 15, scope: !2255)
!2277 = !DILocation(line: 49, column: 18, scope: !2255)
!2278 = !DILocation(line: 49, column: 5, scope: !2255)
!2279 = !DILocation(line: 51, column: 30, scope: !2255)
!2280 = !DILocation(line: 51, column: 10, scope: !2255)
!2281 = !DILocation(line: 51, column: 8, scope: !2255)
!2282 = !DILocation(line: 52, column: 10, scope: !2283)
!2283 = distinct !DILexicalBlock(scope: !2255, file: !935, line: 52, column: 9)
!2284 = !DILocation(line: 52, column: 9, scope: !2255)
!2285 = !DILocation(line: 53, column: 9, scope: !2283)
!2286 = !DILocation(line: 55, column: 5, scope: !2255)
!2287 = !DILocation(line: 55, column: 9, scope: !2255)
!2288 = !DILocation(line: 55, column: 19, scope: !2255)
!2289 = !DILocation(line: 55, column: 30, scope: !2255)
!2290 = !DILocation(line: 56, column: 23, scope: !2255)
!2291 = !DILocation(line: 56, column: 26, scope: !2255)
!2292 = !DILocation(line: 56, column: 13, scope: !2255)
!2293 = !DILocation(line: 56, column: 11, scope: !2255)
!2294 = !DILocation(line: 57, column: 40, scope: !2255)
!2295 = !DILocation(line: 57, column: 43, scope: !2255)
!2296 = !DILocation(line: 57, column: 30, scope: !2255)
!2297 = !DILocation(line: 57, column: 5, scope: !2255)
!2298 = !DILocation(line: 57, column: 9, scope: !2255)
!2299 = !DILocation(line: 57, column: 19, scope: !2255)
!2300 = !DILocation(line: 57, column: 28, scope: !2255)
!2301 = !DILocation(line: 58, column: 9, scope: !2302)
!2302 = distinct !DILexicalBlock(scope: !2255, file: !935, line: 58, column: 9)
!2303 = !DILocation(line: 58, column: 13, scope: !2302)
!2304 = !DILocation(line: 58, column: 23, scope: !2302)
!2305 = !DILocation(line: 58, column: 32, scope: !2302)
!2306 = !DILocation(line: 58, column: 37, scope: !2302)
!2307 = !DILocation(line: 58, column: 40, scope: !2308)
!2308 = !DILexicalBlockFile(scope: !2302, file: !935, discriminator: 1)
!2309 = !DILocation(line: 58, column: 44, scope: !2308)
!2310 = !DILocation(line: 58, column: 54, scope: !2308)
!2311 = !DILocation(line: 58, column: 63, scope: !2308)
!2312 = !DILocation(line: 58, column: 9, scope: !2308)
!2313 = !DILocation(line: 59, column: 9, scope: !2302)
!2314 = !DILocation(line: 60, column: 22, scope: !2255)
!2315 = !DILocation(line: 60, column: 25, scope: !2255)
!2316 = !DILocation(line: 60, column: 12, scope: !2255)
!2317 = !DILocation(line: 60, column: 10, scope: !2255)
!2318 = !DILocation(line: 61, column: 43, scope: !2255)
!2319 = !DILocation(line: 61, column: 46, scope: !2255)
!2320 = !DILocation(line: 61, column: 33, scope: !2255)
!2321 = !DILocation(line: 61, column: 5, scope: !2255)
!2322 = !DILocation(line: 61, column: 9, scope: !2255)
!2323 = !DILocation(line: 61, column: 19, scope: !2255)
!2324 = !DILocation(line: 61, column: 31, scope: !2255)
!2325 = !DILocation(line: 62, column: 9, scope: !2326)
!2326 = distinct !DILexicalBlock(scope: !2255, file: !935, line: 62, column: 9)
!2327 = !DILocation(line: 62, column: 13, scope: !2326)
!2328 = !DILocation(line: 62, column: 23, scope: !2326)
!2329 = !DILocation(line: 62, column: 35, scope: !2326)
!2330 = !DILocation(line: 62, column: 9, scope: !2255)
!2331 = !DILocation(line: 63, column: 9, scope: !2326)
!2332 = !DILocation(line: 65, column: 13, scope: !2255)
!2333 = !DILocation(line: 65, column: 5, scope: !2255)
!2334 = !DILocation(line: 66, column: 13, scope: !2335)
!2335 = distinct !DILexicalBlock(scope: !2255, file: !935, line: 65, column: 20)
!2336 = !DILocation(line: 66, column: 17, scope: !2335)
!2337 = !DILocation(line: 66, column: 27, scope: !2335)
!2338 = !DILocation(line: 66, column: 36, scope: !2335)
!2339 = !DILocation(line: 66, column: 61, scope: !2335)
!2340 = !DILocation(line: 67, column: 13, scope: !2335)
!2341 = !DILocation(line: 67, column: 17, scope: !2335)
!2342 = !DILocation(line: 67, column: 27, scope: !2335)
!2343 = !DILocation(line: 67, column: 36, scope: !2335)
!2344 = !DILocation(line: 67, column: 61, scope: !2335)
!2345 = !DILocation(line: 68, column: 46, scope: !2335)
!2346 = !DILocation(line: 68, column: 50, scope: !2335)
!2347 = !DILocation(line: 68, column: 60, scope: !2335)
!2348 = !DILocation(line: 68, column: 44, scope: !2335)
!2349 = !DILocation(line: 68, column: 13, scope: !2335)
!2350 = !DILocation(line: 68, column: 17, scope: !2335)
!2351 = !DILocation(line: 68, column: 27, scope: !2335)
!2352 = !DILocation(line: 68, column: 39, scope: !2335)
!2353 = !DILocation(line: 69, column: 13, scope: !2335)
!2354 = !DILocation(line: 69, column: 17, scope: !2335)
!2355 = !DILocation(line: 69, column: 27, scope: !2335)
!2356 = !DILocation(line: 69, column: 36, scope: !2335)
!2357 = !DILocation(line: 69, column: 61, scope: !2335)
!2358 = !DILocation(line: 72, column: 42, scope: !2335)
!2359 = !DILocation(line: 72, column: 48, scope: !2335)
!2360 = !DILocation(line: 72, column: 42, scope: !2361)
!2361 = !DILexicalBlockFile(scope: !2335, file: !935, discriminator: 1)
!2362 = !DILocation(line: 72, column: 60, scope: !2363)
!2363 = !DILexicalBlockFile(scope: !2335, file: !935, discriminator: 2)
!2364 = !DILocation(line: 72, column: 66, scope: !2363)
!2365 = !DILocation(line: 72, column: 42, scope: !2363)
!2366 = !DILocation(line: 72, column: 42, scope: !2367)
!2367 = !DILexicalBlockFile(scope: !2335, file: !935, discriminator: 3)
!2368 = !DILocation(line: 72, column: 86, scope: !2367)
!2369 = !DILocation(line: 72, column: 90, scope: !2367)
!2370 = !DILocation(line: 72, column: 100, scope: !2367)
!2371 = !DILocation(line: 72, column: 84, scope: !2367)
!2372 = !DILocation(line: 72, column: 13, scope: !2367)
!2373 = !DILocation(line: 72, column: 17, scope: !2367)
!2374 = !DILocation(line: 72, column: 27, scope: !2367)
!2375 = !DILocation(line: 72, column: 39, scope: !2367)
!2376 = !DILocation(line: 73, column: 38, scope: !2335)
!2377 = !DILocation(line: 73, column: 42, scope: !2335)
!2378 = !DILocation(line: 73, column: 19, scope: !2335)
!2379 = !DILocation(line: 73, column: 17, scope: !2335)
!2380 = !DILocation(line: 74, column: 17, scope: !2381)
!2381 = distinct !DILexicalBlock(scope: !2335, file: !935, line: 74, column: 17)
!2382 = !DILocation(line: 74, column: 21, scope: !2381)
!2383 = !DILocation(line: 74, column: 17, scope: !2335)
!2384 = !DILocation(line: 75, column: 24, scope: !2381)
!2385 = !DILocation(line: 75, column: 17, scope: !2381)
!2386 = !DILocation(line: 76, column: 20, scope: !2335)
!2387 = !DILocation(line: 76, column: 24, scope: !2335)
!2388 = !DILocation(line: 76, column: 34, scope: !2335)
!2389 = !DILocation(line: 76, column: 48, scope: !2335)
!2390 = !DILocation(line: 76, column: 52, scope: !2335)
!2391 = !DILocation(line: 76, column: 62, scope: !2335)
!2392 = !DILocation(line: 76, column: 13, scope: !2335)
!2393 = !DILocation(line: 77, column: 40, scope: !2335)
!2394 = !DILocation(line: 77, column: 44, scope: !2335)
!2395 = !DILocation(line: 77, column: 54, scope: !2335)
!2396 = !DILocation(line: 77, column: 67, scope: !2335)
!2397 = !DILocation(line: 77, column: 70, scope: !2335)
!2398 = !DILocation(line: 78, column: 82, scope: !2335)
!2399 = !DILocation(line: 78, column: 86, scope: !2335)
!2400 = !DILocation(line: 78, column: 96, scope: !2335)
!2401 = !DILocation(line: 78, column: 80, scope: !2335)
!2402 = !DILocation(line: 78, column: 74, scope: !2335)
!2403 = !DILocation(line: 78, column: 40, scope: !2335)
!2404 = !DILocation(line: 78, column: 44, scope: !2335)
!2405 = !DILocation(line: 78, column: 54, scope: !2335)
!2406 = !DILocation(line: 78, column: 63, scope: !2335)
!2407 = !DILocation(line: 78, column: 69, scope: !2335)
!2408 = !DILocation(line: 78, column: 72, scope: !2335)
!2409 = !DILocation(line: 79, column: 75, scope: !2335)
!2410 = !DILocation(line: 79, column: 81, scope: !2335)
!2411 = !DILocation(line: 79, column: 74, scope: !2335)
!2412 = !DILocation(line: 79, column: 40, scope: !2335)
!2413 = !DILocation(line: 79, column: 44, scope: !2335)
!2414 = !DILocation(line: 79, column: 54, scope: !2335)
!2415 = !DILocation(line: 79, column: 63, scope: !2335)
!2416 = !DILocation(line: 79, column: 69, scope: !2335)
!2417 = !DILocation(line: 79, column: 72, scope: !2335)
!2418 = !DILocation(line: 80, column: 75, scope: !2335)
!2419 = !DILocation(line: 80, column: 81, scope: !2335)
!2420 = !DILocation(line: 80, column: 74, scope: !2335)
!2421 = !DILocation(line: 80, column: 40, scope: !2335)
!2422 = !DILocation(line: 80, column: 44, scope: !2335)
!2423 = !DILocation(line: 80, column: 54, scope: !2335)
!2424 = !DILocation(line: 80, column: 63, scope: !2335)
!2425 = !DILocation(line: 80, column: 69, scope: !2335)
!2426 = !DILocation(line: 80, column: 72, scope: !2335)
!2427 = !DILocation(line: 81, column: 40, scope: !2335)
!2428 = !DILocation(line: 81, column: 44, scope: !2335)
!2429 = !DILocation(line: 81, column: 54, scope: !2335)
!2430 = !DILocation(line: 81, column: 63, scope: !2335)
!2431 = !DILocation(line: 81, column: 70, scope: !2335)
!2432 = !DILocation(line: 81, column: 73, scope: !2335)
!2433 = !DILocation(line: 82, column: 13, scope: !2335)
!2434 = !DILocation(line: 82, column: 17, scope: !2335)
!2435 = !DILocation(line: 82, column: 27, scope: !2335)
!2436 = !DILocation(line: 82, column: 36, scope: !2335)
!2437 = !DILocation(line: 82, column: 58, scope: !2335)
!2438 = !DILocation(line: 83, column: 13, scope: !2335)
!2439 = !DILocation(line: 83, column: 17, scope: !2335)
!2440 = !DILocation(line: 83, column: 30, scope: !2335)
!2441 = !DILocation(line: 84, column: 13, scope: !2335)
!2442 = !DILocation(line: 84, column: 17, scope: !2335)
!2443 = !DILocation(line: 84, column: 27, scope: !2335)
!2444 = !DILocation(line: 84, column: 36, scope: !2335)
!2445 = !DILocation(line: 84, column: 55, scope: !2335)
!2446 = !DILocation(line: 86, column: 35, scope: !2335)
!2447 = !DILocation(line: 86, column: 50, scope: !2335)
!2448 = !DILocation(line: 86, column: 13, scope: !2335)
!2449 = !DILocation(line: 87, column: 13, scope: !2335)
!2450 = !DILocation(line: 89, column: 49, scope: !2255)
!2451 = !DILocation(line: 89, column: 53, scope: !2255)
!2452 = !DILocation(line: 89, column: 63, scope: !2255)
!2453 = !DILocation(line: 89, column: 20, scope: !2255)
!2454 = !DILocation(line: 89, column: 5, scope: !2255)
!2455 = !DILocation(line: 89, column: 9, scope: !2255)
!2456 = !DILocation(line: 89, column: 18, scope: !2255)
!2457 = !DILocation(line: 90, column: 15, scope: !2255)
!2458 = !DILocation(line: 90, column: 18, scope: !2255)
!2459 = !DILocation(line: 90, column: 39, scope: !2255)
!2460 = !DILocation(line: 90, column: 42, scope: !2255)
!2461 = !DILocation(line: 90, column: 29, scope: !2255)
!2462 = !DILocation(line: 559, column: 22, scope: !2261, inlinedAt: !2265)
!2463 = !DILocation(line: 559, column: 12, scope: !2261, inlinedAt: !2265)
!2464 = !DILocation(line: 90, column: 27, scope: !2255)
!2465 = !DILocation(line: 90, column: 5, scope: !2466)
!2466 = !DILexicalBlockFile(scope: !2255, file: !935, discriminator: 1)
!2467 = !DILocation(line: 91, column: 25, scope: !2255)
!2468 = !DILocation(line: 91, column: 36, scope: !2255)
!2469 = !DILocation(line: 91, column: 40, scope: !2255)
!2470 = !DILocation(line: 91, column: 50, scope: !2255)
!2471 = !DILocation(line: 91, column: 5, scope: !2255)
!2472 = !DILocation(line: 93, column: 5, scope: !2255)
!2473 = !DILocation(line: 94, column: 1, scope: !2255)
!2474 = distinct !DISubprogram(name: "msf_read_packet", scope: !935, file: !935, line: 96, type: !2475, isLocal: true, isDefinition: true, scopeLine: 97, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2151)
!2475 = !DISubroutineType(types: !2476)
!2476 = !{!926, !2258, !1047}
!2477 = !DILocalVariable(name: "s", arg: 1, scope: !2474, file: !935, line: 96, type: !2258)
!2478 = !DILocation(line: 96, column: 45, scope: !2474)
!2479 = !DILocalVariable(name: "pkt", arg: 2, scope: !2474, file: !935, line: 96, type: !1047)
!2480 = !DILocation(line: 96, column: 58, scope: !2474)
!2481 = !DILocalVariable(name: "par", scope: !2474, file: !935, line: 98, type: !1737)
!2482 = !DILocation(line: 98, column: 24, scope: !2474)
!2483 = !DILocation(line: 98, column: 30, scope: !2474)
!2484 = !DILocation(line: 98, column: 33, scope: !2474)
!2485 = !DILocation(line: 98, column: 45, scope: !2474)
!2486 = !DILocation(line: 100, column: 26, scope: !2474)
!2487 = !DILocation(line: 100, column: 29, scope: !2474)
!2488 = !DILocation(line: 100, column: 33, scope: !2474)
!2489 = !DILocation(line: 100, column: 38, scope: !2474)
!2490 = !DILocation(line: 100, column: 43, scope: !2474)
!2491 = !DILocation(line: 100, column: 57, scope: !2492)
!2492 = !DILexicalBlockFile(scope: !2474, file: !935, discriminator: 1)
!2493 = !DILocation(line: 100, column: 62, scope: !2492)
!2494 = !DILocation(line: 100, column: 38, scope: !2492)
!2495 = !DILocation(line: 100, column: 83, scope: !2496)
!2496 = !DILexicalBlockFile(scope: !2474, file: !935, discriminator: 2)
!2497 = !DILocation(line: 100, column: 88, scope: !2496)
!2498 = !DILocation(line: 100, column: 81, scope: !2496)
!2499 = !DILocation(line: 100, column: 38, scope: !2496)
!2500 = !DILocation(line: 100, column: 38, scope: !2501)
!2501 = !DILexicalBlockFile(scope: !2474, file: !935, discriminator: 3)
!2502 = !DILocation(line: 100, column: 12, scope: !2501)
!2503 = !DILocation(line: 100, column: 5, scope: !2501)
