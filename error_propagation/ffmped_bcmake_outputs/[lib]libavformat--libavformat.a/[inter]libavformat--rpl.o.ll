; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--rpl.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--rpl.o.i"
...
@ff_rpl_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1, i32 0, i32 0), i32 0, i8* null, %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 16, i32 (%struct.AVProbeData*)* @rpl_probe, i32 (%struct.AVFormatContext*)* @rpl_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @rpl_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
...
@.str.9 = private unnamed_addr constant [16 x i8] c"Audio format %d\00", align 1
@.str.10 = private unnamed_addr constant [82 x i8] c"Don't know how to split frames for video format %s. Video stream will be broken!\0A\00", align 1
@.str.11 = private unnamed_addr constant [16 x i8] c"%ld , %ld ; %ld\00", align 1

; Function Attrs: nounwind uwtable
define internal i32 @rpl_probe(%struct.AVProbeData* %p) #0 !dbg !2140 {
entry:
  ...
  %call = call i32 @memcmp(i8* %1, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i32 0, i32 0), i64 8) #6, !dbg !2148
...
; Function Attrs: nounwind uwtable
define internal i32 @rpl_read_header(%struct.AVFormatContext* %s) #0 !dbg !2153 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %pb = alloca %struct.AVIOContext*, align 8
  %rpl = alloca %struct.RPLContext*, align 8
  %vst = alloca %struct.AVStream*, align 8
  %ast = alloca %struct.AVStream*, align 8
  %total_audio_size = alloca i32, align 4
  %error = alloca i32, align 4
  %endptr = alloca i8*, align 8
  %audio_type = alloca [256 x i8], align 16
  %i = alloca i32, align 4
  %audio_format = alloca i32, align 4
  %chunk_catalog_offset = alloca i32, align 4
  %number_of_chunks = alloca i32, align 4
  ...
  %.compoundliteral164 = alloca [32 x i8], align 1
  %offset = alloca i64, align 8
  %video_size = alloca i64, align 8
  %audio_size = alloca i64, align 8
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2158, metadata !2143), !dbg !2159
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2160, metadata !2143), !dbg !2161
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2162
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2163
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2163
  store %struct.AVIOContext* %1, %struct.AVIOContext** %pb, align 8, !dbg !2161
  call void @llvm.dbg.declare(metadata %struct.RPLContext** %rpl, metadata !2164, metadata !2143), !dbg !2174
  %2 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2175
  %priv_data = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %2, i32 0, i32 3, !dbg !2176
  %3 = load i8*, i8** %priv_data, align 8, !dbg !2176
  %4 = bitcast i8* %3 to %struct.RPLContext*, !dbg !2175
  store %struct.RPLContext* %4, %struct.RPLContext** %rpl, align 8, !dbg !2174
  call void @llvm.dbg.declare(metadata %struct.AVStream** %vst, metadata !2177, metadata !2143), !dbg !2178
  store %struct.AVStream* null, %struct.AVStream** %vst, align 8, !dbg !2178
  call void @llvm.dbg.declare(metadata %struct.AVStream** %ast, metadata !2179, metadata !2143), !dbg !2180
  store %struct.AVStream* null, %struct.AVStream** %ast, align 8, !dbg !2180
  call void @llvm.dbg.declare(metadata i32* %total_audio_size, metadata !2181, metadata !2143), !dbg !2182
  call void @llvm.dbg.declare(metadata i32* %error, metadata !2183, metadata !2143), !dbg !2184
  store i32 0, i32* %error, align 4, !dbg !2184
  call void @llvm.dbg.declare(metadata i8** %endptr, metadata !2185, metadata !2143), !dbg !2186
  call void @llvm.dbg.declare(metadata [256 x i8]* %audio_type, metadata !2187, metadata !2143), !dbg !2191
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2192, metadata !2143), !dbg !2193
  call void @llvm.dbg.declare(metadata i32* %audio_format, metadata !2194, metadata !2143), !dbg !2195
  call void @llvm.dbg.declare(metadata i32* %chunk_catalog_offset, metadata !2196, metadata !2143), !dbg !2197
  call void @llvm.dbg.declare(metadata i32* %number_of_chunks, metadata !2198, metadata !2143), !dbg !2199
  call void @llvm.dbg.declare(metadata %struct.AVRational* %fps, metadata !2200, metadata !2143), !dbg !2201
  call void @llvm.dbg.declare(metadata [256 x i8]* %line, metadata !2202, metadata !2143), !dbg !2203
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2204
  %arraydecay = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !2205
  %call = call i32 @read_line(%struct.AVIOContext* %5, i8* %arraydecay, i32 256), !dbg !2206
  %6 = load i32, i32* %error, align 4, !dbg !2207
  %or = or i32 %6, %call, !dbg !2207
  store i32 %or, i32* %error, align 4, !dbg !2207
  %7 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2208
  %arraydecay2 = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !2209
  %call3 = call i32 @read_line(%struct.AVIOContext* %7, i8* %arraydecay2, i32 256), !dbg !2210
  %8 = load i32, i32* %error, align 4, !dbg !2211
  %or4 = or i32 %8, %call3, !dbg !2211
  store i32 %or4, i32* %error, align 4, !dbg !2211
  %9 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2212
  %metadata = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %9, i32 0, i32 29, !dbg !2213
  %arraydecay5 = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !2214
  %call6 = call i32 @av_dict_set(%struct.AVDictionary** %metadata, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i32 0, i32 0), i8* %arraydecay5, i32 0), !dbg !2215
  %10 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2216
  %arraydecay7 = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !2217
  %call8 = call i32 @read_line(%struct.AVIOContext* %10, i8* %arraydecay7, i32 256), !dbg !2218
  %11 = load i32, i32* %error, align 4, !dbg !2219
  %or9 = or i32 %11, %call8, !dbg !2219
  store i32 %or9, i32* %error, align 4, !dbg !2219
  %12 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2220
  %metadata10 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %12, i32 0, i32 29, !dbg !2221
  %arraydecay11 = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !2222
  %call12 = call i32 @av_dict_set(%struct.AVDictionary** %metadata10, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.4, i32 0, i32 0), i8* %arraydecay11, i32 0), !dbg !2223
  %13 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2224
  %arraydecay13 = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !2225
  %call14 = call i32 @read_line(%struct.AVIOContext* %13, i8* %arraydecay13, i32 256), !dbg !2226
  %14 = load i32, i32* %error, align 4, !dbg !2227
  %or15 = or i32 %14, %call14, !dbg !2227
  store i32 %or15, i32* %error, align 4, !dbg !2227
  %15 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2228
  %metadata16 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %15, i32 0, i32 29, !dbg !2229
  %arraydecay17 = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !2230
  %call18 = call i32 @av_dict_set(%struct.AVDictionary** %metadata16, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.5, i32 0, i32 0), i8* %arraydecay17, i32 0), !dbg !2231
  %16 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2232
  %call19 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %16, %struct.AVCodec* null), !dbg !2233
  store %struct.AVStream* %call19, %struct.AVStream** %vst, align 8, !dbg !2234
  %17 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2235
  %tobool = icmp ne %struct.AVStream* %17, null, !dbg !2235
  br i1 %tobool, label %if.end, label %if.then, !dbg !2237

if.then:                                          ; preds = %entry
  store i32 -12, i32* %retval, align 4, !dbg !2238
  br label %return, !dbg !2238

if.end:                                           ; preds = %entry
  %18 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2239
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %18, i32 0, i32 19, !dbg !2240
  %19 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2240
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %19, i32 0, i32 0, !dbg !2241
  store i32 0, i32* %codec_type, align 8, !dbg !2242
  %20 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2243
  %call20 = call i32 @read_line_and_int(%struct.AVIOContext* %20, i32* %error), !dbg !2244
  %21 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2245
  %codecpar21 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %21, i32 0, i32 19, !dbg !2246
  %22 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar21, align 8, !dbg !2246
  %codec_tag = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %22, i32 0, i32 2, !dbg !2247
  store i32 %call20, i32* %codec_tag, align 8, !dbg !2248
  %23 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2249
  %call22 = call i32 @read_line_and_int(%struct.AVIOContext* %23, i32* %error), !dbg !2250
  %24 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2251
  %codecpar23 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %24, i32 0, i32 19, !dbg !2252
  %25 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar23, align 8, !dbg !2252
  %width = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %25, i32 0, i32 11, !dbg !2253
  store i32 %call22, i32* %width, align 8, !dbg !2254
  %26 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2255
  %call24 = call i32 @read_line_and_int(%struct.AVIOContext* %26, i32* %error), !dbg !2256
  %27 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2257
  %codecpar25 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %27, i32 0, i32 19, !dbg !2258
  %28 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar25, align 8, !dbg !2258
  %height = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %28, i32 0, i32 12, !dbg !2259
  store i32 %call24, i32* %height, align 4, !dbg !2260
  %29 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2261
  %call26 = call i32 @read_line_and_int(%struct.AVIOContext* %29, i32* %error), !dbg !2262
  %30 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2263
  %codecpar27 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %30, i32 0, i32 19, !dbg !2264
  %31 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar27, align 8, !dbg !2264
  %bits_per_coded_sample = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %31, i32 0, i32 7, !dbg !2265
  store i32 %call26, i32* %bits_per_coded_sample, align 8, !dbg !2266
  %32 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2267
  %arraydecay28 = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !2268
  %call29 = call i32 @read_line(%struct.AVIOContext* %32, i8* %arraydecay28, i32 256), !dbg !2269
  %33 = load i32, i32* %error, align 4, !dbg !2270
  %or30 = or i32 %33, %call29, !dbg !2270
  store i32 %or30, i32* %error, align 4, !dbg !2270
  %arraydecay31 = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !2271
  %call32 = call i64 @read_fps(i8* %arraydecay31, i32* %error), !dbg !2272
  %34 = bitcast %struct.AVRational* %coerce to i64*, !dbg !2272
  store i64 %call32, i64* %34, align 4, !dbg !2272
  %35 = bitcast %struct.AVRational* %fps to i8*, !dbg !2272
  %36 = bitcast %struct.AVRational* %coerce to i8*, !dbg !2272
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %35, i8* %36, i64 8, i32 4, i1 false), !dbg !2273
  %37 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2275
  %den = getelementptr inbounds %struct.AVRational, %struct.AVRational* %fps, i32 0, i32 1, !dbg !2276
  %38 = load i32, i32* %den, align 4, !dbg !2276
  %num = getelementptr inbounds %struct.AVRational, %struct.AVRational* %fps, i32 0, i32 0, !dbg !2277
  %39 = load i32, i32* %num, align 4, !dbg !2277
  call void @avpriv_set_pts_info(%struct.AVStream* %37, i32 32, i32 %38, i32 %39), !dbg !2278
  %40 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2279
  %codecpar33 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %40, i32 0, i32 19, !dbg !2280
  %41 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar33, align 8, !dbg !2280
  %codec_tag34 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %41, i32 0, i32 2, !dbg !2281
  %42 = load i32, i32* %codec_tag34, align 8, !dbg !2281
...
sw.bb:                                            ; preds = %if.end
  %43 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2283
  %codecpar35 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %43, i32 0, i32 19, !dbg !2285
  %44 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar35, align 8, !dbg !2285
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %44, i32 0, i32 1, !dbg !2286
  store i32 115, i32* %codec_id, align 4, !dbg !2287
  %45 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2288
  %codecpar36 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %45, i32 0, i32 19, !dbg !2289
  %46 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar36, align 8, !dbg !2289
  %bits_per_coded_sample37 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %46, i32 0, i32 7, !dbg !2290
  store i32 16, i32* %bits_per_coded_sample37, align 8, !dbg !2291
  br label %sw.epilog, !dbg !2292

sw.bb38:                                          ; preds = %if.end
  %47 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2293
  %codecpar39 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %47, i32 0, i32 19, !dbg !2294
  %48 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar39, align 8, !dbg !2294
  %codec_id40 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %48, i32 0, i32 1, !dbg !2295
  store i32 169, i32* %codec_id40, align 4, !dbg !2296
  br label %sw.epilog, !dbg !2297

sw.default:                                       ; preds = %if.end
  %49 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2298
  %50 = bitcast %struct.AVFormatContext* %49 to i8*, !dbg !2298
  %51 = bitcast [32 x i8]* %.compoundliteral to i8*, !dbg !2299
  call void @llvm.memset.p0i8.i64(i8* %51, i8 0, i64 32, i32 1, i1 false), !dbg !2299
  %arrayinit.begin = getelementptr inbounds [32 x i8], [32 x i8]* %.compoundliteral, i64 0, i64 0, !dbg !2300
  store i8 0, i8* %arrayinit.begin, align 1, !dbg !2300
  %arraydecay41 = getelementptr inbounds [32 x i8], [32 x i8]* %.compoundliteral, i32 0, i32 0, !dbg !2299
  %52 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2301
  %codecpar42 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %52, i32 0, i32 19, !dbg !2302
  %53 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar42, align 8, !dbg !2302
  %codec_tag43 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %53, i32 0, i32 2, !dbg !2303
  %54 = load i32, i32* %codec_tag43, align 8, !dbg !2303
  %call44 = call i8* @av_fourcc_make_string(i8* %arraydecay41, i32 %54), !dbg !2304
  call void (i8*, i8*, ...) @avpriv_report_missing_feature(i8* %50, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.6, i32 0, i32 0), i8* %call44), !dbg !2306
  %55 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2307
  %codecpar45 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %55, i32 0, i32 19, !dbg !2308
  %56 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar45, align 8, !dbg !2308
  %codec_id46 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %56, i32 0, i32 1, !dbg !2309
  store i32 0, i32* %codec_id46, align 4, !dbg !2310
  br label %sw.epilog, !dbg !2311

sw.epilog:                                        ; preds = %sw.default, %sw.bb38, %sw.bb
  %57 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2312
  %call47 = call i32 @read_line_and_int(%struct.AVIOContext* %57, i32* %error), !dbg !2313
  store i32 %call47, i32* %audio_format, align 4, !dbg !2314
  %58 = load i32, i32* %audio_format, align 4, !dbg !2315
  %tobool48 = icmp ne i32 %58, 0, !dbg !2315
  br i1 %tobool48, label %if.then49, label %if.else148, !dbg !2317

if.then49:                                        ; preds = %sw.epilog
  %59 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2318
  %call50 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %59, %struct.AVCodec* null), !dbg !2320
  store %struct.AVStream* %call50, %struct.AVStream** %ast, align 8, !dbg !2321
  %60 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2322
  %tobool51 = icmp ne %struct.AVStream* %60, null, !dbg !2322
  br i1 %tobool51, label %if.end53, label %if.then52, !dbg !2324

if.then52:                                        ; preds = %if.then49
  store i32 -12, i32* %retval, align 4, !dbg !2325
  br label %return, !dbg !2325

if.end53:                                         ; preds = %if.then49
  %61 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2326
  %codecpar54 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %61, i32 0, i32 19, !dbg !2327
  %62 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar54, align 8, !dbg !2327
  %codec_type55 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %62, i32 0, i32 0, !dbg !2328
  store i32 1, i32* %codec_type55, align 8, !dbg !2329
  %63 = load i32, i32* %audio_format, align 4, !dbg !2330
  %64 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2331
  %codecpar56 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %64, i32 0, i32 19, !dbg !2332
  %65 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar56, align 8, !dbg !2332
  %codec_tag57 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %65, i32 0, i32 2, !dbg !2333
  store i32 %63, i32* %codec_tag57, align 8, !dbg !2334
  %66 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2335
  %call58 = call i32 @read_line_and_int(%struct.AVIOContext* %66, i32* %error), !dbg !2336
  %67 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2337
  %codecpar59 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %67, i32 0, i32 19, !dbg !2338
  %68 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar59, align 8, !dbg !2338
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %68, i32 0, i32 23, !dbg !2339
  store i32 %call58, i32* %sample_rate, align 4, !dbg !2340
  %69 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2341
  %call60 = call i32 @read_line_and_int(%struct.AVIOContext* %69, i32* %error), !dbg !2342
  %70 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2343
  %codecpar61 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %70, i32 0, i32 19, !dbg !2344
  %71 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar61, align 8, !dbg !2344
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %71, i32 0, i32 22, !dbg !2345
  store i32 %call60, i32* %channels, align 8, !dbg !2346
  %72 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2347
  %arraydecay62 = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !2348
  %call63 = call i32 @read_line(%struct.AVIOContext* %72, i8* %arraydecay62, i32 256), !dbg !2349
  %73 = load i32, i32* %error, align 4, !dbg !2350
  %or64 = or i32 %73, %call63, !dbg !2350
  store i32 %or64, i32* %error, align 4, !dbg !2350
  %arraydecay65 = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !2351
  %call66 = call i32 @read_int(i8* %arraydecay65, i8** %endptr, i32* %error), !dbg !2352
  %74 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2353
  %codecpar67 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %74, i32 0, i32 19, !dbg !2354
  %75 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar67, align 8, !dbg !2354
  %bits_per_coded_sample68 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %75, i32 0, i32 7, !dbg !2355
  store i32 %call66, i32* %bits_per_coded_sample68, align 8, !dbg !2356
  %arraydecay69 = getelementptr inbounds [256 x i8], [256 x i8]* %audio_type, i32 0, i32 0, !dbg !2357
  %76 = load i8*, i8** %endptr, align 8, !dbg !2358
  %call70 = call i8* @strcpy(i8* %arraydecay69, i8* %76) #7, !dbg !2359
  %77 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2360
  %codecpar71 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %77, i32 0, i32 19, !dbg !2362
  %78 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar71, align 8, !dbg !2362
  %bits_per_coded_sample72 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %78, i32 0, i32 7, !dbg !2363
  %79 = load i32, i32* %bits_per_coded_sample72, align 8, !dbg !2363
  %cmp = icmp eq i32 %79, 0, !dbg !2364
  br i1 %cmp, label %if.then73, label %if.end76, !dbg !2365

if.then73:                                        ; preds = %if.end53
  %80 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2366
  %codecpar74 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %80, i32 0, i32 19, !dbg !2367
  %81 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar74, align 8, !dbg !2367
  %bits_per_coded_sample75 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %81, i32 0, i32 7, !dbg !2368
  store i32 4, i32* %bits_per_coded_sample75, align 8, !dbg !2369
  br label %if.end76, !dbg !2366

if.end76:                                         ; preds = %if.then73, %if.end53
  %82 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2370
  %codecpar77 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %82, i32 0, i32 19, !dbg !2371
  %83 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar77, align 8, !dbg !2371
  %sample_rate78 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %83, i32 0, i32 23, !dbg !2372
  %84 = load i32, i32* %sample_rate78, align 4, !dbg !2372
  %85 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2373
  %codecpar79 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %85, i32 0, i32 19, !dbg !2374
  %86 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar79, align 8, !dbg !2374
  %bits_per_coded_sample80 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %86, i32 0, i32 7, !dbg !2375
  %87 = load i32, i32* %bits_per_coded_sample80, align 8, !dbg !2375
  %mul = mul nsw i32 %84, %87, !dbg !2376
  %88 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2377
  %codecpar81 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %88, i32 0, i32 19, !dbg !2378
  %89 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar81, align 8, !dbg !2378
  %channels82 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %89, i32 0, i32 22, !dbg !2379
  %90 = load i32, i32* %channels82, align 8, !dbg !2379
  %mul83 = mul nsw i32 %mul, %90, !dbg !2380
  %conv = sext i32 %mul83 to i64, !dbg !2370
  %91 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2381
  %codecpar84 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %91, i32 0, i32 19, !dbg !2382
  %92 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar84, align 8, !dbg !2382
  %bit_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %92, i32 0, i32 6, !dbg !2383
  store i64 %conv, i64* %bit_rate, align 8, !dbg !2384
  %93 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2385
  %codecpar85 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %93, i32 0, i32 19, !dbg !2386
  %94 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar85, align 8, !dbg !2386
  %codec_id86 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %94, i32 0, i32 1, !dbg !2387
  store i32 0, i32* %codec_id86, align 4, !dbg !2388
  %95 = load i32, i32* %audio_format, align 4, !dbg !2389
  switch i32 %95, label %sw.epilog138 [
    i32 1, label %sw.bb87
    i32 101, label %sw.bb120
  ], !dbg !2390

sw.bb87:                                          ; preds = %if.end76
  %96 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2391
  %codecpar88 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %96, i32 0, i32 19, !dbg !2394
  %97 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar88, align 8, !dbg !2394
  %bits_per_coded_sample89 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %97, i32 0, i32 7, !dbg !2395
  %98 = load i32, i32* %bits_per_coded_sample89, align 8, !dbg !2395
  %cmp90 = icmp eq i32 %98, 16, !dbg !2396
  br i1 %cmp90, label %if.then92, label %if.else, !dbg !2397

if.then92:                                        ; preds = %sw.bb87
  %99 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2398
  %codecpar93 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %99, i32 0, i32 19, !dbg !2400
  %100 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar93, align 8, !dbg !2400
  %codec_id94 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %100, i32 0, i32 1, !dbg !2401
  store i32 65536, i32* %codec_id94, align 4, !dbg !2402
  br label %sw.epilog138, !dbg !2403

if.else:                                          ; preds = %sw.bb87
  %101 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2404
  %codecpar95 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %101, i32 0, i32 19, !dbg !2406
  %102 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar95, align 8, !dbg !2406
  %bits_per_coded_sample96 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %102, i32 0, i32 7, !dbg !2407
  %103 = load i32, i32* %bits_per_coded_sample96, align 8, !dbg !2407
  %cmp97 = icmp eq i32 %103, 8, !dbg !2408
  br i1 %cmp97, label %if.then99, label %if.end118, !dbg !2409

if.then99:                                        ; preds = %if.else
  %arraydecay100 = getelementptr inbounds [256 x i8], [256 x i8]* %audio_type, i32 0, i32 0, !dbg !2410
  %call101 = call i8* @strstr(i8* %arraydecay100, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.7, i32 0, i32 0)) #6, !dbg !2413
  %cmp102 = icmp ne i8* %call101, null, !dbg !2414
  br i1 %cmp102, label %if.then104, label %if.else107, !dbg !2415

if.then104:                                       ; preds = %if.then99
  %104 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2416
  %codecpar105 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %104, i32 0, i32 19, !dbg !2418
  %105 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar105, align 8, !dbg !2418
  %codec_id106 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %105, i32 0, i32 1, !dbg !2419
  store i32 65541, i32* %codec_id106, align 4, !dbg !2420
  br label %sw.epilog138, !dbg !2421

if.else107:                                       ; preds = %if.then99
  %arraydecay108 = getelementptr inbounds [256 x i8], [256 x i8]* %audio_type, i32 0, i32 0, !dbg !2422
  %call109 = call i8* @strstr(i8* %arraydecay108, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.8, i32 0, i32 0)) #6, !dbg !2424
  %cmp110 = icmp ne i8* %call109, null, !dbg !2425
  br i1 %cmp110, label %if.then112, label %if.else115, !dbg !2426

if.then112:                                       ; preds = %if.else107
  %106 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2427
  %codecpar113 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %106, i32 0, i32 19, !dbg !2429
  %107 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar113, align 8, !dbg !2429
  %codec_id114 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %107, i32 0, i32 1, !dbg !2430
  store i32 65540, i32* %codec_id114, align 4, !dbg !2431
  br label %sw.epilog138, !dbg !2432

if.else115:                                       ; preds = %if.else107
  %108 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2433
  %codecpar116 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %108, i32 0, i32 19, !dbg !2435
  %109 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar116, align 8, !dbg !2435
  %codec_id117 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %109, i32 0, i32 1, !dbg !2436
  store i32 67588, i32* %codec_id117, align 4, !dbg !2437
  br label %sw.epilog138, !dbg !2438

if.end118:                                        ; preds = %if.else
  br label %if.end119

if.end119:                                        ; preds = %if.end118
  br label %sw.epilog138, !dbg !2439

sw.bb120:                                         ; preds = %if.end76
  %110 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2440
  %codecpar121 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %110, i32 0, i32 19, !dbg !2442
  %111 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar121, align 8, !dbg !2442
  %bits_per_coded_sample122 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %111, i32 0, i32 7, !dbg !2443
  %112 = load i32, i32* %bits_per_coded_sample122, align 8, !dbg !2443
  %cmp123 = icmp eq i32 %112, 8, !dbg !2444
  br i1 %cmp123, label %if.then125, label %if.else128, !dbg !2445

if.then125:                                       ; preds = %sw.bb120
  %113 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2446
  %codecpar126 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %113, i32 0, i32 19, !dbg !2448
  %114 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar126, align 8, !dbg !2448
  %codec_id127 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %114, i32 0, i32 1, !dbg !2449
  store i32 65541, i32* %codec_id127, align 4, !dbg !2450
  br label %sw.epilog138, !dbg !2451

if.else128:                                       ; preds = %sw.bb120
  %115 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2452
  %codecpar129 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %115, i32 0, i32 19, !dbg !2454
  %116 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar129, align 8, !dbg !2454
  %bits_per_coded_sample130 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %116, i32 0, i32 7, !dbg !2455
  %117 = load i32, i32* %bits_per_coded_sample130, align 8, !dbg !2455
  %cmp131 = icmp eq i32 %117, 4, !dbg !2456
  br i1 %cmp131, label %if.then133, label %if.end136, !dbg !2457

if.then133:                                       ; preds = %if.else128
  %118 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2458
  %codecpar134 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %118, i32 0, i32 19, !dbg !2460
  %119 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar134, align 8, !dbg !2460
  %codec_id135 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %119, i32 0, i32 1, !dbg !2461
  store i32 69655, i32* %codec_id135, align 4, !dbg !2462
  br label %sw.epilog138, !dbg !2463

if.end136:                                        ; preds = %if.else128
  br label %if.end137

if.end137:                                        ; preds = %if.end136
  br label %sw.epilog138, !dbg !2464

sw.epilog138:                                     ; preds = %if.end76, %if.end137, %if.then133, %if.then125, %if.end119, %if.else115, %if.then112, %if.then104, %if.then92
  %120 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2465
  %codecpar139 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %120, i32 0, i32 19, !dbg !2467
  %121 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar139, align 8, !dbg !2467
  %codec_id140 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %121, i32 0, i32 1, !dbg !2468
  %122 = load i32, i32* %codec_id140, align 4, !dbg !2468
  %cmp141 = icmp eq i32 %122, 0, !dbg !2469
  br i1 %cmp141, label %if.then143, label %if.end144, !dbg !2470

if.then143:                                       ; preds = %sw.epilog138
  %123 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2471
  %124 = bitcast %struct.AVFormatContext* %123 to i8*, !dbg !2471
  %125 = load i32, i32* %audio_format, align 4, !dbg !2472
  call void (i8*, i8*, ...) @avpriv_request_sample(i8* %124, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.9, i32 0, i32 0), i32 %125), !dbg !2473
  br label %if.end144, !dbg !2473

if.end144:                                        ; preds = %if.then143, %sw.epilog138
  %126 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2474
  %127 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2475
  %codecpar145 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %127, i32 0, i32 19, !dbg !2476
  %128 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar145, align 8, !dbg !2476
  %bit_rate146 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %128, i32 0, i32 6, !dbg !2477
  %129 = load i64, i64* %bit_rate146, align 8, !dbg !2477
  %conv147 = trunc i64 %129 to i32, !dbg !2475
  call void @avpriv_set_pts_info(%struct.AVStream* %126, i32 32, i32 1, i32 %conv147), !dbg !2478
  br label %if.end154, !dbg !2479

if.else148:                                       ; preds = %sw.epilog
  store i32 0, i32* %i, align 4, !dbg !2480
  br label %for.cond, !dbg !2483

for.cond:                                         ; preds = %for.inc, %if.else148
  %130 = load i32, i32* %i, align 4, !dbg !2484
  %cmp149 = icmp ult i32 %130, 3, !dbg !2487
  br i1 %cmp149, label %for.body, label %for.end, !dbg !2488

for.body:                                         ; preds = %for.cond
  %131 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2489
  %arraydecay151 = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !2490
  %call152 = call i32 @read_line(%struct.AVIOContext* %131, i8* %arraydecay151, i32 256), !dbg !2491
  %132 = load i32, i32* %error, align 4, !dbg !2492
  %or153 = or i32 %132, %call152, !dbg !2492
  store i32 %or153, i32* %error, align 4, !dbg !2492
  br label %for.inc, !dbg !2493

for.inc:                                          ; preds = %for.body
  %133 = load i32, i32* %i, align 4, !dbg !2494
  %inc = add i32 %133, 1, !dbg !2494
  store i32 %inc, i32* %i, align 4, !dbg !2494
  br label %for.cond, !dbg !2496, !llvm.loop !2497

for.end:                                          ; preds = %for.cond
  br label %if.end154

if.end154:                                        ; preds = %for.end, %if.end144
  %134 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2499
  %call155 = call i32 @read_line_and_int(%struct.AVIOContext* %134, i32* %error), !dbg !2500
  %135 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2501
  %frames_per_chunk = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %135, i32 0, i32 0, !dbg !2502
  store i32 %call155, i32* %frames_per_chunk, align 4, !dbg !2503
  %136 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2504
  %frames_per_chunk156 = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %136, i32 0, i32 0, !dbg !2506
  %137 = load i32, i32* %frames_per_chunk156, align 4, !dbg !2506
  %cmp157 = icmp sgt i32 %137, 1, !dbg !2507
  br i1 %cmp157, label %land.lhs.true, label %if.end170, !dbg !2508

land.lhs.true:                                    ; preds = %if.end154
  %138 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2509
  %codecpar159 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %138, i32 0, i32 19, !dbg !2511
  %139 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar159, align 8, !dbg !2511
  %codec_tag160 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %139, i32 0, i32 2, !dbg !2512
  %140 = load i32, i32* %codec_tag160, align 8, !dbg !2512
  %cmp161 = icmp ne i32 %140, 124, !dbg !2513
  br i1 %cmp161, label %if.then163, label %if.end170, !dbg !2514

if.then163:                                       ; preds = %land.lhs.true
  %141 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2515
  %142 = bitcast %struct.AVFormatContext* %141 to i8*, !dbg !2515
  %143 = bitcast [32 x i8]* %.compoundliteral164 to i8*, !dbg !2516
  call void @llvm.memset.p0i8.i64(i8* %143, i8 0, i64 32, i32 1, i1 false), !dbg !2516
  %arrayinit.begin165 = getelementptr inbounds [32 x i8], [32 x i8]* %.compoundliteral164, i64 0, i64 0, !dbg !2517
  store i8 0, i8* %arrayinit.begin165, align 1, !dbg !2517
  %arraydecay166 = getelementptr inbounds [32 x i8], [32 x i8]* %.compoundliteral164, i32 0, i32 0, !dbg !2516
  %144 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2518
  %codecpar167 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %144, i32 0, i32 19, !dbg !2519
  %145 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar167, align 8, !dbg !2519
  %codec_tag168 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %145, i32 0, i32 2, !dbg !2520
  %146 = load i32, i32* %codec_tag168, align 8, !dbg !2520
  %call169 = call i8* @av_fourcc_make_string(i8* %arraydecay166, i32 %146), !dbg !2521
  call void (i8*, i32, i8*, ...) @av_log(i8* %142, i32 24, i8* getelementptr inbounds ([82 x i8], [82 x i8]* @.str.10, i32 0, i32 0), i8* %call169), !dbg !2522
  br label %if.end170, !dbg !2522

if.end170:                                        ; preds = %if.then163, %land.lhs.true, %if.end154
  %147 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2523
  %call171 = call i32 @read_line_and_int(%struct.AVIOContext* %147, i32* %error), !dbg !2524
  store i32 %call171, i32* %number_of_chunks, align 4, !dbg !2525
  %148 = load i32, i32* %number_of_chunks, align 4, !dbg !2526
  %inc172 = add nsw i32 %148, 1, !dbg !2526
  store i32 %inc172, i32* %number_of_chunks, align 4, !dbg !2526
  %149 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2527
  %arraydecay173 = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !2528
  %call174 = call i32 @read_line(%struct.AVIOContext* %149, i8* %arraydecay173, i32 256), !dbg !2529
  %150 = load i32, i32* %error, align 4, !dbg !2530
  %or175 = or i32 %150, %call174, !dbg !2530
  store i32 %or175, i32* %error, align 4, !dbg !2530
  %151 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2531
  %arraydecay176 = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !2532
  %call177 = call i32 @read_line(%struct.AVIOContext* %151, i8* %arraydecay176, i32 256), !dbg !2533
  %152 = load i32, i32* %error, align 4, !dbg !2534
  %or178 = or i32 %152, %call177, !dbg !2534
  store i32 %or178, i32* %error, align 4, !dbg !2534
  %153 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2535
  %call179 = call i32 @read_line_and_int(%struct.AVIOContext* %153, i32* %error), !dbg !2536
  store i32 %call179, i32* %chunk_catalog_offset, align 4, !dbg !2537
  %154 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2538
  %arraydecay180 = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !2539
  %call181 = call i32 @read_line(%struct.AVIOContext* %154, i8* %arraydecay180, i32 256), !dbg !2540
  %155 = load i32, i32* %error, align 4, !dbg !2541
  %or182 = or i32 %155, %call181, !dbg !2541
  store i32 %or182, i32* %error, align 4, !dbg !2541
  %156 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2542
  %arraydecay183 = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !2543
  %call184 = call i32 @read_line(%struct.AVIOContext* %156, i8* %arraydecay183, i32 256), !dbg !2544
  %157 = load i32, i32* %error, align 4, !dbg !2545
  %or185 = or i32 %157, %call184, !dbg !2545
  store i32 %or185, i32* %error, align 4, !dbg !2545
  %158 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2546
  %arraydecay186 = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !2547
  %call187 = call i32 @read_line(%struct.AVIOContext* %158, i8* %arraydecay186, i32 256), !dbg !2548
  %159 = load i32, i32* %error, align 4, !dbg !2549
  %or188 = or i32 %159, %call187, !dbg !2549
  store i32 %or188, i32* %error, align 4, !dbg !2549
  %160 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2550
  %161 = load i32, i32* %chunk_catalog_offset, align 4, !dbg !2551
  %conv189 = sext i32 %161 to i64, !dbg !2551
  %call190 = call i64 @avio_seek(%struct.AVIOContext* %160, i64 %conv189, i32 0), !dbg !2552
  store i32 0, i32* %total_audio_size, align 4, !dbg !2553
  store i32 0, i32* %i, align 4, !dbg !2554
  br label %for.cond191, !dbg !2556

for.cond191:                                      ; preds = %for.inc223, %if.end170
  %162 = load i32, i32* %error, align 4, !dbg !2557
  %tobool192 = icmp ne i32 %162, 0, !dbg !2557
  br i1 %tobool192, label %land.end, label %land.rhs, !dbg !2560

land.rhs:                                         ; preds = %for.cond191
  %163 = load i32, i32* %i, align 4, !dbg !2561
  %164 = load i32, i32* %number_of_chunks, align 4, !dbg !2563
  %cmp193 = icmp ult i32 %163, %164, !dbg !2564
  br label %land.end

land.end:                                         ; preds = %land.rhs, %for.cond191
  %165 = phi i1 [ false, %for.cond191 ], [ %cmp193, %land.rhs ]
  br i1 %165, label %for.body195, label %for.end225, !dbg !2565

for.body195:                                      ; preds = %land.end
  call void @llvm.dbg.declare(metadata i64* %offset, metadata !2567, metadata !2143), !dbg !2569
  call void @llvm.dbg.declare(metadata i64* %video_size, metadata !2570, metadata !2143), !dbg !2571
  call void @llvm.dbg.declare(metadata i64* %audio_size, metadata !2572, metadata !2143), !dbg !2573
  %166 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2574
  %arraydecay196 = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !2575
  %call197 = call i32 @read_line(%struct.AVIOContext* %166, i8* %arraydecay196, i32 256), !dbg !2576
  %167 = load i32, i32* %error, align 4, !dbg !2577
  %or198 = or i32 %167, %call197, !dbg !2577
  store i32 %or198, i32* %error, align 4, !dbg !2577
  %arraydecay199 = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !2578
  %call200 = call i32 (i8*, i8*, ...) @__isoc99_sscanf(i8* %arraydecay199, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.11, i32 0, i32 0), i64* %offset, i64* %video_size, i64* %audio_size) #7, !dbg !2580
  %cmp201 = icmp ne i32 3, %call200, !dbg !2581
  br i1 %cmp201, label %if.then203, label %if.end204, !dbg !2582

if.then203:                                       ; preds = %for.body195
  store i32 -1, i32* %error, align 4, !dbg !2583
  br label %for.inc223, !dbg !2585

if.end204:                                        ; preds = %for.body195
  %168 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2586
  %169 = load i64, i64* %offset, align 8, !dbg !2587
  %170 = load i32, i32* %i, align 4, !dbg !2588
  %171 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2589
  %frames_per_chunk205 = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %171, i32 0, i32 0, !dbg !2590
  %172 = load i32, i32* %frames_per_chunk205, align 4, !dbg !2590
  %mul206 = mul i32 %170, %172, !dbg !2591
  %conv207 = zext i32 %mul206 to i64, !dbg !2588
  %173 = load i64, i64* %video_size, align 8, !dbg !2592
  %conv208 = trunc i64 %173 to i32, !dbg !2592
  %174 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2593
  %frames_per_chunk209 = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %174, i32 0, i32 0, !dbg !2594
  %175 = load i32, i32* %frames_per_chunk209, align 4, !dbg !2594
  %call210 = call i32 @av_add_index_entry(%struct.AVStream* %168, i64 %169, i64 %conv207, i32 %conv208, i32 %175, i32 0), !dbg !2595
  %176 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2596
  %tobool211 = icmp ne %struct.AVStream* %176, null, !dbg !2596
  br i1 %tobool211, label %if.then212, label %if.end218, !dbg !2598

if.then212:                                       ; preds = %if.end204
  %177 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2599
  %178 = load i64, i64* %offset, align 8, !dbg !2600
  %179 = load i64, i64* %video_size, align 8, !dbg !2601
  %add = add nsw i64 %178, %179, !dbg !2602
  %180 = load i32, i32* %total_audio_size, align 4, !dbg !2603
  %conv213 = sext i32 %180 to i64, !dbg !2603
  %181 = load i64, i64* %audio_size, align 8, !dbg !2604
  %conv214 = trunc i64 %181 to i32, !dbg !2604
  %182 = load i64, i64* %audio_size, align 8, !dbg !2605
  %mul215 = mul nsw i64 %182, 8, !dbg !2606
  %conv216 = trunc i64 %mul215 to i32, !dbg !2605
  %call217 = call i32 @av_add_index_entry(%struct.AVStream* %177, i64 %add, i64 %conv213, i32 %conv214, i32 %conv216, i32 0), !dbg !2607
  br label %if.end218, !dbg !2607

if.end218:                                        ; preds = %if.then212, %if.end204
  %183 = load i64, i64* %audio_size, align 8, !dbg !2608
  %mul219 = mul nsw i64 %183, 8, !dbg !2609
  %184 = load i32, i32* %total_audio_size, align 4, !dbg !2610
  %conv220 = sext i32 %184 to i64, !dbg !2610
  %add221 = add nsw i64 %conv220, %mul219, !dbg !2610
  %conv222 = trunc i64 %add221 to i32, !dbg !2610
  store i32 %conv222, i32* %total_audio_size, align 4, !dbg !2610
  br label %for.inc223, !dbg !2611

for.inc223:                                       ; preds = %if.end218, %if.then203
  %185 = load i32, i32* %i, align 4, !dbg !2612
  %inc224 = add i32 %185, 1, !dbg !2612
  store i32 %inc224, i32* %i, align 4, !dbg !2612
  br label %for.cond191, !dbg !2614, !llvm.loop !2615

for.end225:                                       ; preds = %land.end
  %186 = load i32, i32* %error, align 4, !dbg !2617
  %tobool226 = icmp ne i32 %186, 0, !dbg !2617
  br i1 %tobool226, label %if.then227, label %if.end228, !dbg !2619

if.then227:                                       ; preds = %for.end225
  store i32 -5, i32* %retval, align 4, !dbg !2620
  br label %return, !dbg !2620

if.end228:                                        ; preds = %for.end225
  store i32 0, i32* %retval, align 4, !dbg !2622
  br label %return, !dbg !2622

return:                                           ; preds = %if.end228, %if.then227, %if.then52, %if.then
  %187 = load i32, i32* %retval, align 4, !dbg !2623
  ret i32 %187, !dbg !2623
}

; Function Attrs: nounwind uwtable
define internal i32 @rpl_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2624 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  %index_entry = alloca %struct.AVIndexEntry*, align 8
  %ret = alloca i32, align 4
  %frame_size = alloca i32, align 4
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2627, metadata !2143), !dbg !2628
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2629, metadata !2143), !dbg !2630
  call void @llvm.dbg.declare(metadata %struct.RPLContext** %rpl, metadata !2631, metadata !2143), !dbg !2632
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2633
  %priv_data = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 3, !dbg !2634
  %1 = load i8*, i8** %priv_data, align 8, !dbg !2634
  %2 = bitcast i8* %1 to %struct.RPLContext*, !dbg !2633
  store %struct.RPLContext* %2, %struct.RPLContext** %rpl, align 8, !dbg !2632
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2635, metadata !2143), !dbg !2636
  ...
  call void @llvm.dbg.declare(metadata %struct.AVStream** %stream, metadata !2639, metadata !2143), !dbg !2640
  call void @llvm.dbg.declare(metadata %struct.AVIndexEntry** %index_entry, metadata !2641, metadata !2143), !dbg !2642
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2643, metadata !2143), !dbg !2644
  %5 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2645
  %chunk_part = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %5, i32 0, i32 2, !dbg !2647
  %6 = load i32, i32* %chunk_part, align 4, !dbg !2647
  %7 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2648
  %nb_streams = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %7, i32 0, i32 6, !dbg !2649
  %8 = load i32, i32* %nb_streams, align 4, !dbg !2649
  %cmp = icmp eq i32 %6, %8, !dbg !2650
  br i1 %cmp, label %if.then, label %if.end, !dbg !2651

if.then:                                          ; preds = %entry
  %9 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2652
  %chunk_number = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %9, i32 0, i32 1, !dbg !2654
  %10 = load i32, i32* %chunk_number, align 4, !dbg !2655
  %inc = add i32 %10, 1, !dbg !2655
  store i32 %inc, i32* %chunk_number, align 4, !dbg !2655
  %11 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2656
  %chunk_part2 = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %11, i32 0, i32 2, !dbg !2657
  store i32 0, i32* %chunk_part2, align 4, !dbg !2658
  br label %if.end, !dbg !2659

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2660
  %chunk_part3 = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %12, i32 0, i32 2, !dbg !2661
  %13 = load i32, i32* %chunk_part3, align 4, !dbg !2661
  %idxprom = zext i32 %13 to i64, !dbg !2662
  %14 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2662
  %streams = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %14, i32 0, i32 7, !dbg !2663
  %15 = load %struct.AVStream**, %struct.AVStream*** %streams, align 8, !dbg !2663
  %arrayidx = getelementptr inbounds %struct.AVStream*, %struct.AVStream** %15, i64 %idxprom, !dbg !2662
  %16 = load %struct.AVStream*, %struct.AVStream** %arrayidx, align 8, !dbg !2662
  store %struct.AVStream* %16, %struct.AVStream** %stream, align 8, !dbg !2664
  %17 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2665
  %chunk_number4 = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %17, i32 0, i32 1, !dbg !2667
  %18 = load i32, i32* %chunk_number4, align 4, !dbg !2667
  %19 = load %struct.AVStream*, %struct.AVStream** %stream, align 8, !dbg !2668
  %nb_index_entries = getelementptr inbounds %struct.AVStream, %struct.AVStream* %19, i32 0, i32 34, !dbg !2669
  %20 = load i32, i32* %nb_index_entries, align 8, !dbg !2669
  %cmp5 = icmp uge i32 %18, %20, !dbg !2670
  br i1 %cmp5, label %if.then6, label %if.end7, !dbg !2671

if.then6:                                         ; preds = %if.end
  store i32 -541478725, i32* %retval, align 4, !dbg !2672
  br label %return, !dbg !2672

if.end7:                                          ; preds = %if.end
  %21 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2673
  %chunk_number8 = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %21, i32 0, i32 1, !dbg !2674
  %22 = load i32, i32* %chunk_number8, align 4, !dbg !2674
  %idxprom9 = zext i32 %22 to i64, !dbg !2675
  %23 = load %struct.AVStream*, %struct.AVStream** %stream, align 8, !dbg !2675
  %index_entries = getelementptr inbounds %struct.AVStream, %struct.AVStream* %23, i32 0, i32 33, !dbg !2676
  %24 = load %struct.AVIndexEntry*, %struct.AVIndexEntry** %index_entries, align 8, !dbg !2676
  %arrayidx10 = getelementptr inbounds %struct.AVIndexEntry, %struct.AVIndexEntry* %24, i64 %idxprom9, !dbg !2675
  store %struct.AVIndexEntry* %arrayidx10, %struct.AVIndexEntry** %index_entry, align 8, !dbg !2677
  %25 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2678
  %frame_in_part = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %25, i32 0, i32 3, !dbg !2680
  %26 = load i32, i32* %frame_in_part, align 4, !dbg !2680
  %cmp11 = icmp eq i32 %26, 0, !dbg !2681
  br i1 %cmp11, label %if.then12, label %if.end16, !dbg !2682

if.then12:                                        ; preds = %if.end7
  %27 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2683
  %28 = load %struct.AVIndexEntry*, %struct.AVIndexEntry** %index_entry, align 8, !dbg !2685
  %pos = getelementptr inbounds %struct.AVIndexEntry, %struct.AVIndexEntry* %28, i32 0, i32 0, !dbg !2686
  %29 = load i64, i64* %pos, align 8, !dbg !2686
  %call = call i64 @avio_seek(%struct.AVIOContext* %27, i64 %29, i32 0), !dbg !2687
  %cmp13 = icmp slt i64 %call, 0, !dbg !2688
  br i1 %cmp13, label %if.then14, label %if.end15, !dbg !2689
...
if.end16:                                         ; preds = %if.end15, %if.end7
  %30 = load %struct.AVStream*, %struct.AVStream** %stream, align 8, !dbg !2693
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %30, i32 0, i32 19, !dbg !2695
  %31 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2695
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %31, i32 0, i32 0, !dbg !2696
  %32 = load i32, i32* %codec_type, align 8, !dbg !2696
  %cmp17 = icmp eq i32 %32, 0, !dbg !2697
  br i1 %cmp17, label %land.lhs.true, label %if.else, !dbg !2698

land.lhs.true:                                    ; preds = %if.end16
  %33 = load %struct.AVStream*, %struct.AVStream** %stream, align 8, !dbg !2699
  %codecpar18 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %33, i32 0, i32 19, !dbg !2700
  %34 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar18, align 8, !dbg !2700
  %codec_tag = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %34, i32 0, i32 2, !dbg !2701
  %35 = load i32, i32* %codec_tag, align 8, !dbg !2701
  %cmp19 = icmp eq i32 %35, 124, !dbg !2702
  br i1 %cmp19, label %if.then20, label %if.else, !dbg !2703

if.then20:                                        ; preds = %land.lhs.true
  call void @llvm.dbg.declare(metadata i32* %frame_size, metadata !2705, metadata !2143), !dbg !2707
  %36 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2708
  %call21 = call i64 @avio_skip(%struct.AVIOContext* %36, i64 4), !dbg !2709
  %37 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2710
  %call22 = call i32 @avio_rl32(%struct.AVIOContext* %37), !dbg !2711
  store i32 %call22, i32* %frame_size, align 4, !dbg !2712
  %38 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2713
  %call23 = call i64 @avio_seek(%struct.AVIOContext* %38, i64 -8, i32 1), !dbg !2715
  %cmp24 = icmp slt i64 %call23, 0, !dbg !2716
  br i1 %cmp24, label %if.then25, label %if.end26, !dbg !2717

if.then25:                                        ; preds = %if.then20
  store i32 -5, i32* %retval, align 4, !dbg !2718
  br label %return, !dbg !2718

if.end26:                                         ; preds = %if.then20
  %39 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2719
  %40 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2720
  %41 = load i32, i32* %frame_size, align 4, !dbg !2721
  %call27 = call i32 @av_get_packet(%struct.AVIOContext* %39, %struct.AVPacket* %40, i32 %41), !dbg !2722
  store i32 %call27, i32* %ret, align 4, !dbg !2723
  %42 = load i32, i32* %ret, align 4, !dbg !2724
  %cmp28 = icmp slt i32 %42, 0, !dbg !2726
  br i1 %cmp28, label %if.then29, label %if.end30, !dbg !2727

if.then29:                                        ; preds = %if.end26
  %43 = load i32, i32* %ret, align 4, !dbg !2728
  store i32 %43, i32* %retval, align 4, !dbg !2729
  br label %return, !dbg !2729

if.end30:                                         ; preds = %if.end26
  %44 = load i32, i32* %ret, align 4, !dbg !2730
  %45 = load i32, i32* %frame_size, align 4, !dbg !2732
  %cmp31 = icmp ne i32 %44, %45, !dbg !2733
  br i1 %cmp31, label %if.then32, label %if.end33, !dbg !2734

if.then32:                                        ; preds = %if.end30
  %46 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2735
  call void @av_packet_unref(%struct.AVPacket* %46), !dbg !2737
  store i32 -5, i32* %retval, align 4, !dbg !2738
  br label %return, !dbg !2738

if.end33:                                         ; preds = %if.end30
  %47 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2739
  %duration = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %47, i32 0, i32 9, !dbg !2740
  store i64 1, i64* %duration, align 8, !dbg !2741
  %48 = load %struct.AVIndexEntry*, %struct.AVIndexEntry** %index_entry, align 8, !dbg !2742
  %timestamp = getelementptr inbounds %struct.AVIndexEntry, %struct.AVIndexEntry* %48, i32 0, i32 1, !dbg !2743
  %49 = load i64, i64* %timestamp, align 8, !dbg !2743
  %50 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2744
  %frame_in_part34 = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %50, i32 0, i32 3, !dbg !2745
  %51 = load i32, i32* %frame_in_part34, align 4, !dbg !2745
  %conv = zext i32 %51 to i64, !dbg !2744
  %add = add nsw i64 %49, %conv, !dbg !2746
  %52 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2747
  %pts = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %52, i32 0, i32 1, !dbg !2748
  store i64 %add, i64* %pts, align 8, !dbg !2749
  %53 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2750
  %chunk_part35 = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %53, i32 0, i32 2, !dbg !2751
  %54 = load i32, i32* %chunk_part35, align 4, !dbg !2751
  %55 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2752
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %55, i32 0, i32 5, !dbg !2753
  store i32 %54, i32* %stream_index, align 4, !dbg !2754
  %56 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2755
  %frame_in_part36 = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %56, i32 0, i32 3, !dbg !2756
  %57 = load i32, i32* %frame_in_part36, align 4, !dbg !2757
  %inc37 = add i32 %57, 1, !dbg !2757
  store i32 %inc37, i32* %frame_in_part36, align 4, !dbg !2757
  %58 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2758
  %frame_in_part38 = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %58, i32 0, i32 3, !dbg !2760
  %59 = load i32, i32* %frame_in_part38, align 4, !dbg !2760
  %60 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2761
  %frames_per_chunk = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %60, i32 0, i32 0, !dbg !2762
  %61 = load i32, i32* %frames_per_chunk, align 4, !dbg !2762
  %cmp39 = icmp eq i32 %59, %61, !dbg !2763
  br i1 %cmp39, label %if.then41, label %if.end45, !dbg !2764

if.then41:                                        ; preds = %if.end33
  %62 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2765
  %frame_in_part42 = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %62, i32 0, i32 3, !dbg !2767
  store i32 0, i32* %frame_in_part42, align 4, !dbg !2768
  %63 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2769
  %chunk_part43 = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %63, i32 0, i32 2, !dbg !2770
  %64 = load i32, i32* %chunk_part43, align 4, !dbg !2771
  %inc44 = add i32 %64, 1, !dbg !2771
  store i32 %inc44, i32* %chunk_part43, align 4, !dbg !2771
  br label %if.end45, !dbg !2772

if.end45:                                         ; preds = %if.then41, %if.end33
  br label %if.end76, !dbg !2773

if.else:                                          ; preds = %land.lhs.true, %if.end16
  %65 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2774
  %66 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2776
  %67 = load %struct.AVIndexEntry*, %struct.AVIndexEntry** %index_entry, align 8, !dbg !2777
  %size = getelementptr inbounds %struct.AVIndexEntry, %struct.AVIndexEntry* %67, i32 0, i32 2, !dbg !2778
  %bf.load = load i32, i32* %size, align 8, !dbg !2778
  %bf.ashr = ashr i32 %bf.load, 2, !dbg !2778
  %call46 = call i32 @av_get_packet(%struct.AVIOContext* %65, %struct.AVPacket* %66, i32 %bf.ashr), !dbg !2779
  store i32 %call46, i32* %ret, align 4, !dbg !2780
  %68 = load i32, i32* %ret, align 4, !dbg !2781
  %cmp47 = icmp slt i32 %68, 0, !dbg !2783
  br i1 %cmp47, label %if.then49, label %if.end50, !dbg !2784

if.then49:                                        ; preds = %if.else
  %69 = load i32, i32* %ret, align 4, !dbg !2785
  store i32 %69, i32* %retval, align 4, !dbg !2786
  br label %return, !dbg !2786

if.end50:                                         ; preds = %if.else
  %70 = load i32, i32* %ret, align 4, !dbg !2787
  %71 = load %struct.AVIndexEntry*, %struct.AVIndexEntry** %index_entry, align 8, !dbg !2789
  %size51 = getelementptr inbounds %struct.AVIndexEntry, %struct.AVIndexEntry* %71, i32 0, i32 2, !dbg !2790
  %bf.load52 = load i32, i32* %size51, align 8, !dbg !2790
  %bf.ashr53 = ashr i32 %bf.load52, 2, !dbg !2790
  %cmp54 = icmp ne i32 %70, %bf.ashr53, !dbg !2791
  br i1 %cmp54, label %if.then56, label %if.end57, !dbg !2792

if.then56:                                        ; preds = %if.end50
  %72 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2793
  call void @av_packet_unref(%struct.AVPacket* %72), !dbg !2795
  store i32 -5, i32* %retval, align 4, !dbg !2796
  br label %return, !dbg !2796

if.end57:                                         ; preds = %if.end50
  %73 = load %struct.AVStream*, %struct.AVStream** %stream, align 8, !dbg !2797
  %codecpar58 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %73, i32 0, i32 19, !dbg !2799
  %74 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar58, align 8, !dbg !2799
  %codec_type59 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %74, i32 0, i32 0, !dbg !2800
  %75 = load i32, i32* %codec_type59, align 8, !dbg !2800
  %cmp60 = icmp eq i32 %75, 0, !dbg !2801
  br i1 %cmp60, label %if.then62, label %if.else66, !dbg !2802

if.then62:                                        ; preds = %if.end57
  %76 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2803
  %frames_per_chunk63 = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %76, i32 0, i32 0, !dbg !2805
  %77 = load i32, i32* %frames_per_chunk63, align 4, !dbg !2805
  %conv64 = sext i32 %77 to i64, !dbg !2803
  %78 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2806
  %duration65 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %78, i32 0, i32 9, !dbg !2807
  store i64 %conv64, i64* %duration65, align 8, !dbg !2808
  br label %if.end69, !dbg !2809

if.else66:                                        ; preds = %if.end57
  %79 = load i32, i32* %ret, align 4, !dbg !2810
  %mul = mul nsw i32 %79, 8, !dbg !2812
  %conv67 = sext i32 %mul to i64, !dbg !2810
  %80 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2813
  %duration68 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %80, i32 0, i32 9, !dbg !2814
  store i64 %conv67, i64* %duration68, align 8, !dbg !2815
  br label %if.end69

if.end69:                                         ; preds = %if.else66, %if.then62
  %81 = load %struct.AVIndexEntry*, %struct.AVIndexEntry** %index_entry, align 8, !dbg !2816
  %timestamp70 = getelementptr inbounds %struct.AVIndexEntry, %struct.AVIndexEntry* %81, i32 0, i32 1, !dbg !2817
  %82 = load i64, i64* %timestamp70, align 8, !dbg !2817
  %83 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2818
  %pts71 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %83, i32 0, i32 1, !dbg !2819
  store i64 %82, i64* %pts71, align 8, !dbg !2820
  %84 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2821
  %chunk_part72 = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %84, i32 0, i32 2, !dbg !2822
  %85 = load i32, i32* %chunk_part72, align 4, !dbg !2822
  %86 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2823
  %stream_index73 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %86, i32 0, i32 5, !dbg !2824
  store i32 %85, i32* %stream_index73, align 4, !dbg !2825
  %87 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2826
  %chunk_part74 = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %87, i32 0, i32 2, !dbg !2827
  %88 = load i32, i32* %chunk_part74, align 4, !dbg !2828
  %inc75 = add i32 %88, 1, !dbg !2828
  store i32 %inc75, i32* %chunk_part74, align 4, !dbg !2828
  br label %if.end76

if.end76:                                         ; preds = %if.end69, %if.end45
  %89 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2829
  %chunk_number77 = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %89, i32 0, i32 1, !dbg !2831
  %90 = load i32, i32* %chunk_number77, align 4, !dbg !2831
  %cmp78 = icmp eq i32 %90, 0, !dbg !2832
  br i1 %cmp78, label %land.lhs.true80, label %if.end85, !dbg !2833

land.lhs.true80:                                  ; preds = %if.end76
  %91 = load %struct.RPLContext*, %struct.RPLContext** %rpl, align 8, !dbg !2834
  %frame_in_part81 = getelementptr inbounds %struct.RPLContext, %struct.RPLContext* %91, i32 0, i32 3, !dbg !2836
  %92 = load i32, i32* %frame_in_part81, align 4, !dbg !2836
  %cmp82 = icmp eq i32 %92, 0, !dbg !2837
  br i1 %cmp82, label %if.then84, label %if.end85, !dbg !2838

if.then84:                                        ; preds = %land.lhs.true80
  %93 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2839
  %flags = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %93, i32 0, i32 6, !dbg !2840
  %94 = load i32, i32* %flags, align 8, !dbg !2841
  %or = or i32 %94, 1, !dbg !2841
  store i32 %or, i32* %flags, align 8, !dbg !2841
  br label %if.end85, !dbg !2839

if.end85:                                         ; preds = %if.then84, %land.lhs.true80, %if.end76
  %95 = load i32, i32* %ret, align 4, !dbg !2842
  store i32 %95, i32* %retval, align 4, !dbg !2843
  br label %return, !dbg !2843

return:                                           ; preds = %if.end85, %if.then56, %if.then49, %if.then32, %if.then29, %if.then25, %if.then14, %if.then6
  %96 = load i32, i32* %retval, align 4, !dbg !2844
  ret i32 %96, !dbg !2844
}
...
; Function Attrs: nounwind uwtable
define internal i32 @read_line(%struct.AVIOContext* %pb, i8* %line, i32 %bufsize) #0 !dbg !2845 {
entry:
  %retval = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb.addr, metadata !2848, metadata !2143), !dbg !2849
  store i8* %line, i8** %line.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %line.addr, metadata !2850, metadata !2143), !dbg !2851
  store i32 %bufsize, i32* %bufsize.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %bufsize.addr, metadata !2852, metadata !2143), !dbg !2853
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2854, metadata !2143), !dbg !2855
  store i32 0, i32* %i, align 4, !dbg !2856
  br label %for.cond, !dbg !2858

for.cond:                                         ; preds = %for.inc, %entry
  %0 = load i32, i32* %i, align 4, !dbg !2859
  %1 = load i32, i32* %bufsize.addr, align 4, !dbg !2862
  %sub = sub nsw i32 %1, 1, !dbg !2863
  %cmp = icmp slt i32 %0, %sub, !dbg !2864
  br i1 %cmp, label %for.body, label %for.end, !dbg !2865

for.body:                                         ; preds = %for.cond
  call void @llvm.dbg.declare(metadata i32* %b, metadata !2866, metadata !2143), !dbg !2868
  %2 = load %struct.AVIOContext*, %struct.AVIOContext** %pb.addr, align 8, !dbg !2869
  %call = call i32 @avio_r8(%struct.AVIOContext* %2), !dbg !2870
  store i32 %call, i32* %b, align 4, !dbg !2868
  %3 = load i32, i32* %b, align 4, !dbg !2871
  %cmp1 = icmp eq i32 %3, 0, !dbg !2873
  br i1 %cmp1, label %if.then, label %if.end, !dbg !2874

if.then:                                          ; preds = %for.body
  br label %for.end, !dbg !2875

if.end:                                           ; preds = %for.body
  %4 = load i32, i32* %b, align 4, !dbg !2876
  %cmp2 = icmp eq i32 %4, 10, !dbg !2878
  br i1 %cmp2, label %if.then3, label %if.end5, !dbg !2879

if.then3:                                         ; preds = %if.end
  %5 = load i32, i32* %i, align 4, !dbg !2880
  %idxprom = sext i32 %5 to i64, !dbg !2882
  %6 = load i8*, i8** %line.addr, align 8, !dbg !2882
  %arrayidx = getelementptr inbounds i8, i8* %6, i64 %idxprom, !dbg !2882
  store i8 0, i8* %arrayidx, align 1, !dbg !2883
  %7 = load %struct.AVIOContext*, %struct.AVIOContext** %pb.addr, align 8, !dbg !2884
  %call4 = call i32 @avio_feof(%struct.AVIOContext* %7), !dbg !2885
  %tobool = icmp ne i32 %call4, 0, !dbg !2885
  %cond = select i1 %tobool, i32 -1, i32 0, !dbg !2885
  store i32 %cond, i32* %retval, align 4, !dbg !2886
  br label %return, !dbg !2886

if.end5:                                          ; preds = %if.end
  %8 = load i32, i32* %b, align 4, !dbg !2887
  %conv = trunc i32 %8 to i8, !dbg !2887
  %9 = load i32, i32* %i, align 4, !dbg !2888
  %idxprom6 = sext i32 %9 to i64, !dbg !2889
  %10 = load i8*, i8** %line.addr, align 8, !dbg !2889
  %arrayidx7 = getelementptr inbounds i8, i8* %10, i64 %idxprom6, !dbg !2889
  store i8 %conv, i8* %arrayidx7, align 1, !dbg !2890
  br label %for.inc, !dbg !2891

for.inc:                                          ; preds = %if.end5
  %11 = load i32, i32* %i, align 4, !dbg !2892
  %inc = add nsw i32 %11, 1, !dbg !2892
  store i32 %inc, i32* %i, align 4, !dbg !2892
  br label %for.cond, !dbg !2894, !llvm.loop !2895

for.end:                                          ; preds = %if.then, %for.cond
  %12 = load i32, i32* %i, align 4, !dbg !2897
  %idxprom8 = sext i32 %12 to i64, !dbg !2898
  %13 = load i8*, i8** %line.addr, align 8, !dbg !2898
  %arrayidx9 = getelementptr inbounds i8, i8* %13, i64 %idxprom8, !dbg !2898
  store i8 0, i8* %arrayidx9, align 1, !dbg !2899
  store i32 -1, i32* %retval, align 4, !dbg !2900
  br label %return, !dbg !2900

return:                                           ; preds = %for.end, %if.then3
  %14 = load i32, i32* %retval, align 4, !dbg !2901
  ret i32 %14, !dbg !2901
}
...
; Function Attrs: nounwind uwtable
define internal i32 @read_line_and_int(%struct.AVIOContext* %pb, i32* %error) #0 !dbg !2902 {
entry:
  %pb.addr = alloca %struct.AVIOContext*, align 8
  ...
  %endptr = alloca i8*, align 8
  store %struct.AVIOContext* %pb, %struct.AVIOContext** %pb.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb.addr, metadata !2905, metadata !2143), !dbg !2906
  store i32* %error, i32** %error.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %error.addr, metadata !2907, metadata !2143), !dbg !2908
  call void @llvm.dbg.declare(metadata [256 x i8]* %line, metadata !2909, metadata !2143), !dbg !2910
  call void @llvm.dbg.declare(metadata i8** %endptr, metadata !2911, metadata !2143), !dbg !2912
  %0 = load %struct.AVIOContext*, %struct.AVIOContext** %pb.addr, align 8, !dbg !2913
  %arraydecay = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !2914
  %call = call i32 @read_line(%struct.AVIOContext* %0, i8* %arraydecay, i32 256), !dbg !2915
  %1 = load i32*, i32** %error.addr, align 8, !dbg !2916
  %2 = load i32, i32* %1, align 4, !dbg !2917
  %or = or i32 %2, %call, !dbg !2917
  store i32 %or, i32* %1, align 4, !dbg !2917
  %arraydecay1 = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !2918
  %3 = load i32*, i32** %error.addr, align 8, !dbg !2919
  %call2 = call i32 @read_int(i8* %arraydecay1, i8** %endptr, i32* %3), !dbg !2920
  ret i32 %call2, !dbg !2921
}

; Function Attrs: nounwind uwtable
define internal i64 @read_fps(i8* %line, i32* %error) #0 !dbg !2922 {
entry:
  ...
  %result = alloca %struct.AVRational, align 4
  store i8* %line, i8** %line.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %line.addr, metadata !2925, metadata !2143), !dbg !2926
  store i32* %error, i32** %error.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %error.addr, metadata !2927, metadata !2143), !dbg !2928
  call void @llvm.dbg.declare(metadata i64* %num, metadata !2929, metadata !2143), !dbg !2930
  call void @llvm.dbg.declare(metadata i64* %den, metadata !2931, metadata !2143), !dbg !2932
  store i64 1, i64* %den, align 8, !dbg !2932
  call void @llvm.dbg.declare(metadata %struct.AVRational* %result, metadata !2933, metadata !2143), !dbg !2934
  %0 = load i8*, i8** %line.addr, align 8, !dbg !2935
  %1 = load i32*, i32** %error.addr, align 8, !dbg !2936
  %call = call i32 @read_int(i8* %0, i8** %line.addr, i32* %1), !dbg !2937
  %conv = sext i32 %call to i64, !dbg !2937
  store i64 %conv, i64* %num, align 8, !dbg !2938
  %2 = load i8*, i8** %line.addr, align 8, !dbg !2939
  %3 = load i8, i8* %2, align 1, !dbg !2941
  %conv1 = sext i8 %3 to i32, !dbg !2941
  %cmp = icmp eq i32 %conv1, 46, !dbg !2942
  br i1 %cmp, label %if.then, label %if.end, !dbg !2943

if.then:                                          ; preds = %entry
  %4 = load i8*, i8** %line.addr, align 8, !dbg !2944
  %incdec.ptr = getelementptr inbounds i8, i8* %4, i32 1, !dbg !2944
  store i8* %incdec.ptr, i8** %line.addr, align 8, !dbg !2944
...
for.cond:                                         ; preds = %for.inc, %if.end
  %5 = load i8*, i8** %line.addr, align 8, !dbg !2947
  %6 = load i8, i8* %5, align 1, !dbg !2951
  %conv3 = sext i8 %6 to i32, !dbg !2951
  %cmp4 = icmp sge i32 %conv3, 48, !dbg !2952
  br i1 %cmp4, label %land.rhs, label %land.end, !dbg !2953

land.rhs:                                         ; preds = %for.cond
  %7 = load i8*, i8** %line.addr, align 8, !dbg !2954
  %8 = load i8, i8* %7, align 1, !dbg !2956
  %conv6 = sext i8 %8 to i32, !dbg !2956
  %cmp7 = icmp sle i32 %conv6, 57, !dbg !2957
  br label %land.end

land.end:                                         ; preds = %land.rhs, %for.cond
  %9 = phi i1 [ false, %for.cond ], [ %cmp7, %land.rhs ]
  br i1 %9, label %for.body, label %for.end, !dbg !2958

for.body:                                         ; preds = %land.end
  %10 = load i64, i64* %num, align 8, !dbg !2960
  %cmp9 = icmp sgt i64 %10, 922337203685477579, !dbg !2963
  br i1 %cmp9, label %if.then13, label %lor.lhs.false, !dbg !2964

lor.lhs.false:                                    ; preds = %for.body
  %11 = load i64, i64* %den, align 8, !dbg !2965
  %cmp11 = icmp sgt i64 %11, 922337203685477580, !dbg !2967
  br i1 %cmp11, label %if.then13, label %if.end14, !dbg !2968

if.then13:                                        ; preds = %lor.lhs.false, %for.body
  br label %for.end, !dbg !2969

if.end14:                                         ; preds = %lor.lhs.false
  %12 = load i64, i64* %num, align 8, !dbg !2970
  %mul = mul nsw i64 10, %12, !dbg !2971
  %13 = load i8*, i8** %line.addr, align 8, !dbg !2972
  %14 = load i8, i8* %13, align 1, !dbg !2973
  %conv15 = sext i8 %14 to i64, !dbg !2973
  %add = add nsw i64 %mul, %conv15, !dbg !2974
  %sub = sub nsw i64 %add, 48, !dbg !2975
  store i64 %sub, i64* %num, align 8, !dbg !2976
  %15 = load i64, i64* %den, align 8, !dbg !2977
  %mul16 = mul nsw i64 %15, 10, !dbg !2977
  store i64 %mul16, i64* %den, align 8, !dbg !2977
  br label %for.inc, !dbg !2978

for.inc:                                          ; preds = %if.end14
  %16 = load i8*, i8** %line.addr, align 8, !dbg !2979
  %incdec.ptr17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !2979
  store i8* %incdec.ptr17, i8** %line.addr, align 8, !dbg !2979
  br label %for.cond, !dbg !2981, !llvm.loop !2982

for.end:                                          ; preds = %if.then13, %land.end
  %17 = load i64, i64* %num, align 8, !dbg !2983
  %tobool = icmp ne i64 %17, 0, !dbg !2983
  br i1 %tobool, label %if.end19, label %if.then18, !dbg !2985

if.then18:                                        ; preds = %for.end
  %18 = load i32*, i32** %error.addr, align 8, !dbg !2986
  store i32 -1, i32* %18, align 4, !dbg !2987
  br label %if.end19, !dbg !2988

if.end19:                                         ; preds = %if.then18, %for.end
  %num20 = getelementptr inbounds %struct.AVRational, %struct.AVRational* %result, i32 0, i32 0, !dbg !2989
  %den21 = getelementptr inbounds %struct.AVRational, %struct.AVRational* %result, i32 0, i32 1, !dbg !2990
  %19 = load i64, i64* %num, align 8, !dbg !2991
  %20 = load i64, i64* %den, align 8, !dbg !2992
  %call22 = call i32 @av_reduce(i32* %num20, i32* %den21, i64 %19, i64 %20, i64 2147483647), !dbg !2993
  %21 = bitcast %struct.AVRational* %retval to i8*, !dbg !2994
  %22 = bitcast %struct.AVRational* %result to i8*, !dbg !2994
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %21, i8* %22, i64 8, i32 4, i1 false), !dbg !2994
  %23 = bitcast %struct.AVRational* %retval to i64*, !dbg !2995
  %24 = load i64, i64* %23, align 4, !dbg !2995
  ret i64 %24, !dbg !2995
}
...
; Function Attrs: nounwind uwtable
define internal i32 @read_int(i8* %line, i8** %endptr, i32* %error) #0 !dbg !2996 {
entry:
  %line.addr = alloca i8*, align 8
  ...
  store i8* %line, i8** %line.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %line.addr, metadata !3000, metadata !2143), !dbg !3001
  store i8** %endptr, i8*** %endptr.addr, align 8
  call void @llvm.dbg.declare(metadata i8*** %endptr.addr, metadata !3002, metadata !2143), !dbg !3003
  store i32* %error, i32** %error.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %error.addr, metadata !3004, metadata !2143), !dbg !3005
  call void @llvm.dbg.declare(metadata i64* %result, metadata !3006, metadata !2143), !dbg !3007
  store i64 0, i64* %result, align 8, !dbg !3007
  br label %for.cond, !dbg !3008

for.cond:                                         ; preds = %for.inc, %entry
  %0 = load i8*, i8** %line.addr, align 8, !dbg !3009
  %1 = load i8, i8* %0, align 1, !dbg !3013
  %conv = sext i8 %1 to i32, !dbg !3013
  %cmp = icmp sge i32 %conv, 48, !dbg !3014
  br i1 %cmp, label %land.rhs, label %land.end, !dbg !3015

land.rhs:                                         ; preds = %for.cond
  %2 = load i8*, i8** %line.addr, align 8, !dbg !3016
  %3 = load i8, i8* %2, align 1, !dbg !3018
  %conv2 = sext i8 %3 to i32, !dbg !3018
  %cmp3 = icmp sle i32 %conv2, 57, !dbg !3019
  br label %land.end

land.end:                                         ; preds = %land.rhs, %for.cond
  %4 = phi i1 [ false, %for.cond ], [ %cmp3, %land.rhs ]
  br i1 %4, label %for.body, label %for.end, !dbg !3020

for.body:                                         ; preds = %land.end
  %5 = load i64, i64* %result, align 8, !dbg !3022
  %cmp5 = icmp ugt i64 %5, 214748363, !dbg !3025
  br i1 %cmp5, label %if.then, label %if.end, !dbg !3026

if.then:                                          ; preds = %for.body
  %6 = load i32*, i32** %error.addr, align 8, !dbg !3027
  store i32 -1, i32* %6, align 4, !dbg !3028
  br label %if.end, !dbg !3029

if.end:                                           ; preds = %if.then, %for.body
  %7 = load i64, i64* %result, align 8, !dbg !3030
  %mul = mul i64 10, %7, !dbg !3031
  %8 = load i8*, i8** %line.addr, align 8, !dbg !3032
  %9 = load i8, i8* %8, align 1, !dbg !3033
  %conv7 = sext i8 %9 to i64, !dbg !3033
  %add = add i64 %mul, %conv7, !dbg !3034
  %sub = sub i64 %add, 48, !dbg !3035
  store i64 %sub, i64* %result, align 8, !dbg !3036
  br label %for.inc, !dbg !3037

for.inc:                                          ; preds = %if.end
  %10 = load i8*, i8** %line.addr, align 8, !dbg !3038
  %incdec.ptr = getelementptr inbounds i8, i8* %10, i32 1, !dbg !3038
  store i8* %incdec.ptr, i8** %line.addr, align 8, !dbg !3038
  br label %for.cond, !dbg !3040, !llvm.loop !3041

for.end:                                          ; preds = %land.end
  %11 = load i8*, i8** %line.addr, align 8, !dbg !3042
  %12 = load i8**, i8*** %endptr.addr, align 8, !dbg !3043
  store i8* %11, i8** %12, align 8, !dbg !3044
  %13 = load i64, i64* %result, align 8, !dbg !3045
  %conv8 = trunc i64 %13 to i32, !dbg !3045
  ret i32 %conv8, !dbg !3046
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--rpl.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!920 = !{!921}
!921 = distinct !DIGlobalVariable(name: "ff_rpl_demuxer", scope: !0, file: !922, line: 372, type: !923, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_rpl_demuxer)
!922 = !DIFile(filename: "libavformat/rpl.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2140 = distinct !DISubprogram(name: "rpl_probe", scope: !922, file: !922, line: 36, type: !991, isLocal: true, isDefinition: true, scopeLine: 37, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2141 = !{}
!2142 = !DILocalVariable(name: "p", arg: 1, scope: !2140, file: !922, line: 36, type: !993)
!2143 = !DIExpression()
!2144 = !DILocation(line: 36, column: 35, scope: !2140)
!2145 = !DILocation(line: 38, column: 16, scope: !2146)
!2146 = distinct !DILexicalBlock(scope: !2140, file: !922, line: 38, column: 9)
!2147 = !DILocation(line: 38, column: 19, scope: !2146)
!2148 = !DILocation(line: 38, column: 9, scope: !2146)
!2149 = !DILocation(line: 38, column: 9, scope: !2140)
!2150 = !DILocation(line: 39, column: 9, scope: !2146)
!2151 = !DILocation(line: 41, column: 5, scope: !2140)
!2152 = !DILocation(line: 42, column: 1, scope: !2140)
!2153 = distinct !DISubprogram(name: "rpl_read_header", scope: !922, file: !922, line: 115, type: !2154, isLocal: true, isDefinition: true, scopeLine: 116, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2154 = !DISubroutineType(types: !2155)
!2155 = !{!918, !2156}
!2156 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2157, size: 64, align: 64)
!2157 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1008)
!2158 = !DILocalVariable(name: "s", arg: 1, scope: !2153, file: !922, line: 115, type: !2156)
!2159 = !DILocation(line: 115, column: 45, scope: !2153)
!2160 = !DILocalVariable(name: "pb", scope: !2153, file: !922, line: 117, type: !1215)
!2161 = !DILocation(line: 117, column: 18, scope: !2153)
!2162 = !DILocation(line: 117, column: 23, scope: !2153)
!2163 = !DILocation(line: 117, column: 26, scope: !2153)
!2164 = !DILocalVariable(name: "rpl", scope: !2153, file: !922, line: 118, type: !2165)
!2165 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2166, size: 64, align: 64)
!2166 = !DIDerivedType(tag: DW_TAG_typedef, name: "RPLContext", file: !922, line: 52, baseType: !2167)
!2167 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "RPLContext", file: !922, line: 44, size: 128, align: 32, elements: !2168)
!2168 = !{!2169, !2171, !2172, !2173}
!2169 = !DIDerivedType(tag: DW_TAG_member, name: "frames_per_chunk", scope: !2167, file: !922, line: 46, baseType: !2170, size: 32, align: 32)
!2170 = !DIDerivedType(tag: DW_TAG_typedef, name: "int32_t", file: !1050, line: 38, baseType: !918)
!2171 = !DIDerivedType(tag: DW_TAG_member, name: "chunk_number", scope: !2167, file: !922, line: 49, baseType: !1368, size: 32, align: 32, offset: 32)
!2172 = !DIDerivedType(tag: DW_TAG_member, name: "chunk_part", scope: !2167, file: !922, line: 50, baseType: !1368, size: 32, align: 32, offset: 64)
!2173 = !DIDerivedType(tag: DW_TAG_member, name: "frame_in_part", scope: !2167, file: !922, line: 51, baseType: !1368, size: 32, align: 32, offset: 96)
!2174 = !DILocation(line: 118, column: 17, scope: !2153)
!2175 = !DILocation(line: 118, column: 23, scope: !2153)
!2176 = !DILocation(line: 118, column: 26, scope: !2153)
!2177 = !DILocalVariable(name: "vst", scope: !2153, file: !922, line: 119, type: !1283)
!2178 = !DILocation(line: 119, column: 15, scope: !2153)
!2179 = !DILocalVariable(name: "ast", scope: !2153, file: !922, line: 119, type: !1283)
!2180 = !DILocation(line: 119, column: 27, scope: !2153)
!2181 = !DILocalVariable(name: "total_audio_size", scope: !2153, file: !922, line: 120, type: !918)
!2182 = !DILocation(line: 120, column: 9, scope: !2153)
!2183 = !DILocalVariable(name: "error", scope: !2153, file: !922, line: 121, type: !918)
!2184 = !DILocation(line: 121, column: 9, scope: !2153)
!2185 = !DILocalVariable(name: "endptr", scope: !2153, file: !922, line: 122, type: !927)
!2186 = !DILocation(line: 122, column: 17, scope: !2153)
!2187 = !DILocalVariable(name: "audio_type", scope: !2153, file: !922, line: 123, type: !2188)
!2188 = !DICompositeType(tag: DW_TAG_array_type, baseType: !929, size: 2048, align: 8, elements: !2189)
!2189 = !{!2190}
!2190 = !DISubrange(count: 256)
!2191 = !DILocation(line: 123, column: 10, scope: !2153)
!2192 = !DILocalVariable(name: "i", scope: !2153, file: !922, line: 125, type: !1368)
!2193 = !DILocation(line: 125, column: 14, scope: !2153)
!2194 = !DILocalVariable(name: "audio_format", scope: !2153, file: !922, line: 127, type: !2170)
!2195 = !DILocation(line: 127, column: 13, scope: !2153)
!2196 = !DILocalVariable(name: "chunk_catalog_offset", scope: !2153, file: !922, line: 127, type: !2170)
!2197 = !DILocation(line: 127, column: 27, scope: !2153)
!2198 = !DILocalVariable(name: "number_of_chunks", scope: !2153, file: !922, line: 127, type: !2170)
!2199 = !DILocation(line: 127, column: 49, scope: !2153)
!2200 = !DILocalVariable(name: "fps", scope: !2153, file: !922, line: 128, type: !1117)
!2201 = !DILocation(line: 128, column: 16, scope: !2153)
!2202 = !DILocalVariable(name: "line", scope: !2153, file: !922, line: 130, type: !2188)
!2203 = !DILocation(line: 130, column: 10, scope: !2153)
!2204 = !DILocation(line: 138, column: 24, scope: !2153)
!2205 = !DILocation(line: 138, column: 28, scope: !2153)
!2206 = !DILocation(line: 138, column: 14, scope: !2153)
!2207 = !DILocation(line: 138, column: 11, scope: !2153)
!2208 = !DILocation(line: 139, column: 24, scope: !2153)
!2209 = !DILocation(line: 139, column: 28, scope: !2153)
!2210 = !DILocation(line: 139, column: 14, scope: !2153)
!2211 = !DILocation(line: 139, column: 11, scope: !2153)
!2212 = !DILocation(line: 140, column: 18, scope: !2153)
!2213 = !DILocation(line: 140, column: 21, scope: !2153)
!2214 = !DILocation(line: 140, column: 41, scope: !2153)
!2215 = !DILocation(line: 140, column: 5, scope: !2153)
!2216 = !DILocation(line: 141, column: 24, scope: !2153)
!2217 = !DILocation(line: 141, column: 28, scope: !2153)
!2218 = !DILocation(line: 141, column: 14, scope: !2153)
!2219 = !DILocation(line: 141, column: 11, scope: !2153)
!2220 = !DILocation(line: 142, column: 18, scope: !2153)
!2221 = !DILocation(line: 142, column: 21, scope: !2153)
!2222 = !DILocation(line: 142, column: 44, scope: !2153)
!2223 = !DILocation(line: 142, column: 5, scope: !2153)
!2224 = !DILocation(line: 143, column: 24, scope: !2153)
!2225 = !DILocation(line: 143, column: 28, scope: !2153)
!2226 = !DILocation(line: 143, column: 14, scope: !2153)
!2227 = !DILocation(line: 143, column: 11, scope: !2153)
!2228 = !DILocation(line: 144, column: 18, scope: !2153)
!2229 = !DILocation(line: 144, column: 21, scope: !2153)
!2230 = !DILocation(line: 144, column: 42, scope: !2153)
!2231 = !DILocation(line: 144, column: 5, scope: !2153)
!2232 = !DILocation(line: 147, column: 31, scope: !2153)
!2233 = !DILocation(line: 147, column: 11, scope: !2153)
!2234 = !DILocation(line: 147, column: 9, scope: !2153)
!2235 = !DILocation(line: 148, column: 10, scope: !2236)
!2236 = distinct !DILexicalBlock(scope: !2153, file: !922, line: 148, column: 9)
!2237 = !DILocation(line: 148, column: 9, scope: !2153)
!2238 = !DILocation(line: 149, column: 9, scope: !2236)
!2239 = !DILocation(line: 150, column: 5, scope: !2153)
!2240 = !DILocation(line: 150, column: 10, scope: !2153)
!2241 = !DILocation(line: 150, column: 20, scope: !2153)
!2242 = !DILocation(line: 150, column: 31, scope: !2153)
!2243 = !DILocation(line: 151, column: 50, scope: !2153)
!2244 = !DILocation(line: 151, column: 32, scope: !2153)
!2245 = !DILocation(line: 151, column: 5, scope: !2153)
!2246 = !DILocation(line: 151, column: 10, scope: !2153)
!2247 = !DILocation(line: 151, column: 20, scope: !2153)
!2248 = !DILocation(line: 151, column: 30, scope: !2153)
!2249 = !DILocation(line: 152, column: 46, scope: !2153)
!2250 = !DILocation(line: 152, column: 28, scope: !2153)
!2251 = !DILocation(line: 152, column: 5, scope: !2153)
!2252 = !DILocation(line: 152, column: 10, scope: !2153)
!2253 = !DILocation(line: 152, column: 20, scope: !2153)
!2254 = !DILocation(line: 152, column: 26, scope: !2153)
!2255 = !DILocation(line: 153, column: 47, scope: !2153)
!2256 = !DILocation(line: 153, column: 29, scope: !2153)
!2257 = !DILocation(line: 153, column: 5, scope: !2153)
!2258 = !DILocation(line: 153, column: 10, scope: !2153)
!2259 = !DILocation(line: 153, column: 20, scope: !2153)
!2260 = !DILocation(line: 153, column: 27, scope: !2153)
!2261 = !DILocation(line: 154, column: 62, scope: !2153)
!2262 = !DILocation(line: 154, column: 44, scope: !2153)
!2263 = !DILocation(line: 154, column: 5, scope: !2153)
!2264 = !DILocation(line: 154, column: 10, scope: !2153)
!2265 = !DILocation(line: 154, column: 20, scope: !2153)
!2266 = !DILocation(line: 154, column: 42, scope: !2153)
!2267 = !DILocation(line: 155, column: 24, scope: !2153)
!2268 = !DILocation(line: 155, column: 28, scope: !2153)
!2269 = !DILocation(line: 155, column: 14, scope: !2153)
!2270 = !DILocation(line: 155, column: 11, scope: !2153)
!2271 = !DILocation(line: 156, column: 20, scope: !2153)
!2272 = !DILocation(line: 156, column: 11, scope: !2153)
!2273 = !DILocation(line: 156, column: 11, scope: !2274)
!2274 = !DILexicalBlockFile(scope: !2153, file: !922, discriminator: 1)
!2275 = !DILocation(line: 157, column: 25, scope: !2153)
!2276 = !DILocation(line: 157, column: 38, scope: !2153)
!2277 = !DILocation(line: 157, column: 47, scope: !2153)
!2278 = !DILocation(line: 157, column: 5, scope: !2153)
!2279 = !DILocation(line: 160, column: 13, scope: !2153)
!2280 = !DILocation(line: 160, column: 18, scope: !2153)
!2281 = !DILocation(line: 160, column: 28, scope: !2153)
!2282 = !DILocation(line: 160, column: 5, scope: !2153)
!2283 = !DILocation(line: 167, column: 13, scope: !2284)
!2284 = distinct !DILexicalBlock(scope: !2153, file: !922, line: 160, column: 39)
!2285 = !DILocation(line: 167, column: 18, scope: !2284)
!2286 = !DILocation(line: 167, column: 28, scope: !2284)
!2287 = !DILocation(line: 167, column: 37, scope: !2284)
!2288 = !DILocation(line: 169, column: 13, scope: !2284)
!2289 = !DILocation(line: 169, column: 18, scope: !2284)
!2290 = !DILocation(line: 169, column: 28, scope: !2284)
!2291 = !DILocation(line: 169, column: 50, scope: !2284)
!2292 = !DILocation(line: 170, column: 13, scope: !2284)
!2293 = !DILocation(line: 172, column: 13, scope: !2284)
!2294 = !DILocation(line: 172, column: 18, scope: !2284)
!2295 = !DILocation(line: 172, column: 28, scope: !2284)
!2296 = !DILocation(line: 172, column: 37, scope: !2284)
!2297 = !DILocation(line: 173, column: 13, scope: !2284)
!2298 = !DILocation(line: 175, column: 43, scope: !2284)
!2299 = !DILocation(line: 176, column: 65, scope: !2284)
!2300 = !DILocation(line: 176, column: 75, scope: !2284)
!2301 = !DILocation(line: 176, column: 80, scope: !2284)
!2302 = !DILocation(line: 176, column: 85, scope: !2284)
!2303 = !DILocation(line: 176, column: 95, scope: !2284)
!2304 = !DILocation(line: 176, column: 43, scope: !2305)
!2305 = !DILexicalBlockFile(scope: !2284, file: !922, discriminator: 1)
!2306 = !DILocation(line: 175, column: 13, scope: !2284)
!2307 = !DILocation(line: 177, column: 13, scope: !2284)
!2308 = !DILocation(line: 177, column: 18, scope: !2284)
!2309 = !DILocation(line: 177, column: 28, scope: !2284)
!2310 = !DILocation(line: 177, column: 37, scope: !2284)
!2311 = !DILocation(line: 178, column: 5, scope: !2284)
!2312 = !DILocation(line: 184, column: 38, scope: !2153)
!2313 = !DILocation(line: 184, column: 20, scope: !2153)
!2314 = !DILocation(line: 184, column: 18, scope: !2153)
!2315 = !DILocation(line: 185, column: 9, scope: !2316)
!2316 = distinct !DILexicalBlock(scope: !2153, file: !922, line: 185, column: 9)
!2317 = !DILocation(line: 185, column: 9, scope: !2153)
!2318 = !DILocation(line: 186, column: 35, scope: !2319)
!2319 = distinct !DILexicalBlock(scope: !2316, file: !922, line: 185, column: 23)
!2320 = !DILocation(line: 186, column: 15, scope: !2319)
!2321 = !DILocation(line: 186, column: 13, scope: !2319)
!2322 = !DILocation(line: 187, column: 14, scope: !2323)
!2323 = distinct !DILexicalBlock(scope: !2319, file: !922, line: 187, column: 13)
!2324 = !DILocation(line: 187, column: 13, scope: !2319)
!2325 = !DILocation(line: 188, column: 13, scope: !2323)
!2326 = !DILocation(line: 189, column: 9, scope: !2319)
!2327 = !DILocation(line: 189, column: 14, scope: !2319)
!2328 = !DILocation(line: 189, column: 24, scope: !2319)
!2329 = !DILocation(line: 189, column: 35, scope: !2319)
!2330 = !DILocation(line: 190, column: 36, scope: !2319)
!2331 = !DILocation(line: 190, column: 9, scope: !2319)
!2332 = !DILocation(line: 190, column: 14, scope: !2319)
!2333 = !DILocation(line: 190, column: 24, scope: !2319)
!2334 = !DILocation(line: 190, column: 34, scope: !2319)
!2335 = !DILocation(line: 191, column: 56, scope: !2319)
!2336 = !DILocation(line: 191, column: 38, scope: !2319)
!2337 = !DILocation(line: 191, column: 9, scope: !2319)
!2338 = !DILocation(line: 191, column: 14, scope: !2319)
!2339 = !DILocation(line: 191, column: 24, scope: !2319)
!2340 = !DILocation(line: 191, column: 36, scope: !2319)
!2341 = !DILocation(line: 192, column: 53, scope: !2319)
!2342 = !DILocation(line: 192, column: 35, scope: !2319)
!2343 = !DILocation(line: 192, column: 9, scope: !2319)
!2344 = !DILocation(line: 192, column: 14, scope: !2319)
!2345 = !DILocation(line: 192, column: 24, scope: !2319)
!2346 = !DILocation(line: 192, column: 33, scope: !2319)
!2347 = !DILocation(line: 193, column: 28, scope: !2319)
!2348 = !DILocation(line: 193, column: 32, scope: !2319)
!2349 = !DILocation(line: 193, column: 18, scope: !2319)
!2350 = !DILocation(line: 193, column: 15, scope: !2319)
!2351 = !DILocation(line: 194, column: 57, scope: !2319)
!2352 = !DILocation(line: 194, column: 48, scope: !2319)
!2353 = !DILocation(line: 194, column: 9, scope: !2319)
!2354 = !DILocation(line: 194, column: 14, scope: !2319)
!2355 = !DILocation(line: 194, column: 24, scope: !2319)
!2356 = !DILocation(line: 194, column: 46, scope: !2319)
!2357 = !DILocation(line: 195, column: 16, scope: !2319)
!2358 = !DILocation(line: 195, column: 28, scope: !2319)
!2359 = !DILocation(line: 195, column: 9, scope: !2319)
!2360 = !DILocation(line: 198, column: 13, scope: !2361)
!2361 = distinct !DILexicalBlock(scope: !2319, file: !922, line: 198, column: 13)
!2362 = !DILocation(line: 198, column: 18, scope: !2361)
!2363 = !DILocation(line: 198, column: 28, scope: !2361)
!2364 = !DILocation(line: 198, column: 50, scope: !2361)
!2365 = !DILocation(line: 198, column: 13, scope: !2319)
!2366 = !DILocation(line: 199, column: 13, scope: !2361)
!2367 = !DILocation(line: 199, column: 18, scope: !2361)
!2368 = !DILocation(line: 199, column: 28, scope: !2361)
!2369 = !DILocation(line: 199, column: 50, scope: !2361)
!2370 = !DILocation(line: 201, column: 35, scope: !2319)
!2371 = !DILocation(line: 201, column: 40, scope: !2319)
!2372 = !DILocation(line: 201, column: 50, scope: !2319)
!2373 = !DILocation(line: 202, column: 35, scope: !2319)
!2374 = !DILocation(line: 202, column: 40, scope: !2319)
!2375 = !DILocation(line: 202, column: 50, scope: !2319)
!2376 = !DILocation(line: 201, column: 62, scope: !2319)
!2377 = !DILocation(line: 203, column: 35, scope: !2319)
!2378 = !DILocation(line: 203, column: 40, scope: !2319)
!2379 = !DILocation(line: 203, column: 50, scope: !2319)
!2380 = !DILocation(line: 202, column: 72, scope: !2319)
!2381 = !DILocation(line: 201, column: 9, scope: !2319)
!2382 = !DILocation(line: 201, column: 14, scope: !2319)
!2383 = !DILocation(line: 201, column: 24, scope: !2319)
!2384 = !DILocation(line: 201, column: 33, scope: !2319)
!2385 = !DILocation(line: 205, column: 9, scope: !2319)
!2386 = !DILocation(line: 205, column: 14, scope: !2319)
!2387 = !DILocation(line: 205, column: 24, scope: !2319)
!2388 = !DILocation(line: 205, column: 33, scope: !2319)
!2389 = !DILocation(line: 206, column: 17, scope: !2319)
!2390 = !DILocation(line: 206, column: 9, scope: !2319)
!2391 = !DILocation(line: 208, column: 21, scope: !2392)
!2392 = distinct !DILexicalBlock(scope: !2393, file: !922, line: 208, column: 21)
!2393 = distinct !DILexicalBlock(scope: !2319, file: !922, line: 206, column: 31)
!2394 = !DILocation(line: 208, column: 26, scope: !2392)
!2395 = !DILocation(line: 208, column: 36, scope: !2392)
!2396 = !DILocation(line: 208, column: 58, scope: !2392)
!2397 = !DILocation(line: 208, column: 21, scope: !2393)
!2398 = !DILocation(line: 210, column: 21, scope: !2399)
!2399 = distinct !DILexicalBlock(scope: !2392, file: !922, line: 208, column: 65)
!2400 = !DILocation(line: 210, column: 26, scope: !2399)
!2401 = !DILocation(line: 210, column: 36, scope: !2399)
!2402 = !DILocation(line: 210, column: 45, scope: !2399)
!2403 = !DILocation(line: 211, column: 21, scope: !2399)
!2404 = !DILocation(line: 212, column: 28, scope: !2405)
!2405 = distinct !DILexicalBlock(scope: !2392, file: !922, line: 212, column: 28)
!2406 = !DILocation(line: 212, column: 33, scope: !2405)
!2407 = !DILocation(line: 212, column: 43, scope: !2405)
!2408 = !DILocation(line: 212, column: 65, scope: !2405)
!2409 = !DILocation(line: 212, column: 28, scope: !2392)
!2410 = !DILocation(line: 213, column: 31, scope: !2411)
!2411 = distinct !DILexicalBlock(scope: !2412, file: !922, line: 213, column: 24)
!2412 = distinct !DILexicalBlock(scope: !2405, file: !922, line: 212, column: 71)
!2413 = !DILocation(line: 213, column: 24, scope: !2411)
!2414 = !DILocation(line: 213, column: 55, scope: !2411)
!2415 = !DILocation(line: 213, column: 24, scope: !2412)
!2416 = !DILocation(line: 214, column: 25, scope: !2417)
!2417 = distinct !DILexicalBlock(scope: !2411, file: !922, line: 213, column: 63)
!2418 = !DILocation(line: 214, column: 30, scope: !2417)
!2419 = !DILocation(line: 214, column: 40, scope: !2417)
!2420 = !DILocation(line: 214, column: 49, scope: !2417)
!2421 = !DILocation(line: 215, column: 25, scope: !2417)
!2422 = !DILocation(line: 216, column: 38, scope: !2423)
!2423 = distinct !DILexicalBlock(scope: !2411, file: !922, line: 216, column: 31)
!2424 = !DILocation(line: 216, column: 31, scope: !2423)
!2425 = !DILocation(line: 216, column: 60, scope: !2423)
!2426 = !DILocation(line: 216, column: 31, scope: !2411)
!2427 = !DILocation(line: 217, column: 25, scope: !2428)
!2428 = distinct !DILexicalBlock(scope: !2423, file: !922, line: 216, column: 68)
!2429 = !DILocation(line: 217, column: 30, scope: !2428)
!2430 = !DILocation(line: 217, column: 40, scope: !2428)
!2431 = !DILocation(line: 217, column: 49, scope: !2428)
!2432 = !DILocation(line: 218, column: 25, scope: !2428)
!2433 = !DILocation(line: 220, column: 25, scope: !2434)
!2434 = distinct !DILexicalBlock(scope: !2423, file: !922, line: 219, column: 28)
!2435 = !DILocation(line: 220, column: 30, scope: !2434)
!2436 = !DILocation(line: 220, column: 40, scope: !2434)
!2437 = !DILocation(line: 220, column: 49, scope: !2434)
!2438 = !DILocation(line: 221, column: 25, scope: !2434)
!2439 = !DILocation(line: 226, column: 17, scope: !2393)
!2440 = !DILocation(line: 228, column: 21, scope: !2441)
!2441 = distinct !DILexicalBlock(scope: !2393, file: !922, line: 228, column: 21)
!2442 = !DILocation(line: 228, column: 26, scope: !2441)
!2443 = !DILocation(line: 228, column: 36, scope: !2441)
!2444 = !DILocation(line: 228, column: 58, scope: !2441)
!2445 = !DILocation(line: 228, column: 21, scope: !2393)
!2446 = !DILocation(line: 231, column: 21, scope: !2447)
!2447 = distinct !DILexicalBlock(scope: !2441, file: !922, line: 228, column: 64)
!2448 = !DILocation(line: 231, column: 26, scope: !2447)
!2449 = !DILocation(line: 231, column: 36, scope: !2447)
!2450 = !DILocation(line: 231, column: 45, scope: !2447)
!2451 = !DILocation(line: 232, column: 21, scope: !2447)
!2452 = !DILocation(line: 233, column: 28, scope: !2453)
!2453 = distinct !DILexicalBlock(scope: !2441, file: !922, line: 233, column: 28)
!2454 = !DILocation(line: 233, column: 33, scope: !2453)
!2455 = !DILocation(line: 233, column: 43, scope: !2453)
!2456 = !DILocation(line: 233, column: 65, scope: !2453)
!2457 = !DILocation(line: 233, column: 28, scope: !2441)
!2458 = !DILocation(line: 234, column: 21, scope: !2459)
!2459 = distinct !DILexicalBlock(scope: !2453, file: !922, line: 233, column: 71)
!2460 = !DILocation(line: 234, column: 26, scope: !2459)
!2461 = !DILocation(line: 234, column: 36, scope: !2459)
!2462 = !DILocation(line: 234, column: 45, scope: !2459)
!2463 = !DILocation(line: 235, column: 21, scope: !2459)
!2464 = !DILocation(line: 237, column: 17, scope: !2393)
!2465 = !DILocation(line: 239, column: 13, scope: !2466)
!2466 = distinct !DILexicalBlock(scope: !2319, file: !922, line: 239, column: 13)
!2467 = !DILocation(line: 239, column: 18, scope: !2466)
!2468 = !DILocation(line: 239, column: 28, scope: !2466)
!2469 = !DILocation(line: 239, column: 37, scope: !2466)
!2470 = !DILocation(line: 239, column: 13, scope: !2319)
!2471 = !DILocation(line: 240, column: 35, scope: !2466)
!2472 = !DILocation(line: 241, column: 35, scope: !2466)
!2473 = !DILocation(line: 240, column: 13, scope: !2466)
!2474 = !DILocation(line: 242, column: 29, scope: !2319)
!2475 = !DILocation(line: 242, column: 41, scope: !2319)
!2476 = !DILocation(line: 242, column: 46, scope: !2319)
!2477 = !DILocation(line: 242, column: 56, scope: !2319)
!2478 = !DILocation(line: 242, column: 9, scope: !2319)
!2479 = !DILocation(line: 243, column: 5, scope: !2319)
!2480 = !DILocation(line: 244, column: 16, scope: !2481)
!2481 = distinct !DILexicalBlock(scope: !2482, file: !922, line: 244, column: 9)
!2482 = distinct !DILexicalBlock(scope: !2316, file: !922, line: 243, column: 12)
!2483 = !DILocation(line: 244, column: 14, scope: !2481)
!2484 = !DILocation(line: 244, column: 21, scope: !2485)
!2485 = !DILexicalBlockFile(scope: !2486, file: !922, discriminator: 1)
!2486 = distinct !DILexicalBlock(scope: !2481, file: !922, line: 244, column: 9)
!2487 = !DILocation(line: 244, column: 23, scope: !2485)
!2488 = !DILocation(line: 244, column: 9, scope: !2485)
!2489 = !DILocation(line: 245, column: 32, scope: !2486)
!2490 = !DILocation(line: 245, column: 36, scope: !2486)
!2491 = !DILocation(line: 245, column: 22, scope: !2486)
!2492 = !DILocation(line: 245, column: 19, scope: !2486)
!2493 = !DILocation(line: 245, column: 13, scope: !2486)
!2494 = !DILocation(line: 244, column: 29, scope: !2495)
!2495 = !DILexicalBlockFile(scope: !2486, file: !922, discriminator: 2)
!2496 = !DILocation(line: 244, column: 9, scope: !2495)
!2497 = distinct !{!2497, !2498}
!2498 = !DILocation(line: 244, column: 9, scope: !2482)
!2499 = !DILocation(line: 248, column: 47, scope: !2153)
!2500 = !DILocation(line: 248, column: 29, scope: !2153)
!2501 = !DILocation(line: 248, column: 5, scope: !2153)
!2502 = !DILocation(line: 248, column: 10, scope: !2153)
!2503 = !DILocation(line: 248, column: 27, scope: !2153)
!2504 = !DILocation(line: 249, column: 9, scope: !2505)
!2505 = distinct !DILexicalBlock(scope: !2153, file: !922, line: 249, column: 9)
!2506 = !DILocation(line: 249, column: 14, scope: !2505)
!2507 = !DILocation(line: 249, column: 31, scope: !2505)
!2508 = !DILocation(line: 249, column: 35, scope: !2505)
!2509 = !DILocation(line: 249, column: 38, scope: !2510)
!2510 = !DILexicalBlockFile(scope: !2505, file: !922, discriminator: 1)
!2511 = !DILocation(line: 249, column: 43, scope: !2510)
!2512 = !DILocation(line: 249, column: 53, scope: !2510)
!2513 = !DILocation(line: 249, column: 63, scope: !2510)
!2514 = !DILocation(line: 249, column: 9, scope: !2510)
!2515 = !DILocation(line: 250, column: 16, scope: !2505)
!2516 = !DILocation(line: 252, column: 72, scope: !2505)
!2517 = !DILocation(line: 252, column: 82, scope: !2505)
!2518 = !DILocation(line: 252, column: 87, scope: !2505)
!2519 = !DILocation(line: 252, column: 92, scope: !2505)
!2520 = !DILocation(line: 252, column: 102, scope: !2505)
!2521 = !DILocation(line: 252, column: 50, scope: !2510)
!2522 = !DILocation(line: 250, column: 9, scope: !2505)
!2523 = !DILocation(line: 254, column: 42, scope: !2153)
!2524 = !DILocation(line: 254, column: 24, scope: !2153)
!2525 = !DILocation(line: 254, column: 22, scope: !2153)
!2526 = !DILocation(line: 256, column: 21, scope: !2153)
!2527 = !DILocation(line: 258, column: 24, scope: !2153)
!2528 = !DILocation(line: 258, column: 28, scope: !2153)
!2529 = !DILocation(line: 258, column: 14, scope: !2153)
!2530 = !DILocation(line: 258, column: 11, scope: !2153)
!2531 = !DILocation(line: 259, column: 24, scope: !2153)
!2532 = !DILocation(line: 259, column: 28, scope: !2153)
!2533 = !DILocation(line: 259, column: 14, scope: !2153)
!2534 = !DILocation(line: 259, column: 11, scope: !2153)
!2535 = !DILocation(line: 261, column: 27, scope: !2153)
!2536 = !DILocation(line: 261, column: 9, scope: !2153)
!2537 = !DILocation(line: 260, column: 26, scope: !2153)
!2538 = !DILocation(line: 262, column: 24, scope: !2153)
!2539 = !DILocation(line: 262, column: 28, scope: !2153)
!2540 = !DILocation(line: 262, column: 14, scope: !2153)
!2541 = !DILocation(line: 262, column: 11, scope: !2153)
!2542 = !DILocation(line: 263, column: 24, scope: !2153)
!2543 = !DILocation(line: 263, column: 28, scope: !2153)
!2544 = !DILocation(line: 263, column: 14, scope: !2153)
!2545 = !DILocation(line: 263, column: 11, scope: !2153)
!2546 = !DILocation(line: 264, column: 24, scope: !2153)
!2547 = !DILocation(line: 264, column: 28, scope: !2153)
!2548 = !DILocation(line: 264, column: 14, scope: !2153)
!2549 = !DILocation(line: 264, column: 11, scope: !2153)
!2550 = !DILocation(line: 267, column: 15, scope: !2153)
!2551 = !DILocation(line: 267, column: 19, scope: !2153)
!2552 = !DILocation(line: 267, column: 5, scope: !2153)
!2553 = !DILocation(line: 268, column: 22, scope: !2153)
!2554 = !DILocation(line: 269, column: 12, scope: !2555)
!2555 = distinct !DILexicalBlock(scope: !2153, file: !922, line: 269, column: 5)
!2556 = !DILocation(line: 269, column: 10, scope: !2555)
!2557 = !DILocation(line: 269, column: 18, scope: !2558)
!2558 = !DILexicalBlockFile(scope: !2559, file: !922, discriminator: 1)
!2559 = distinct !DILexicalBlock(scope: !2555, file: !922, line: 269, column: 5)
!2560 = !DILocation(line: 269, column: 24, scope: !2558)
!2561 = !DILocation(line: 269, column: 27, scope: !2562)
!2562 = !DILexicalBlockFile(scope: !2559, file: !922, discriminator: 2)
!2563 = !DILocation(line: 269, column: 31, scope: !2562)
!2564 = !DILocation(line: 269, column: 29, scope: !2562)
!2565 = !DILocation(line: 269, column: 5, scope: !2566)
!2566 = !DILexicalBlockFile(scope: !2555, file: !922, discriminator: 3)
!2567 = !DILocalVariable(name: "offset", scope: !2568, file: !922, line: 270, type: !1053)
!2568 = distinct !DILexicalBlock(scope: !2559, file: !922, line: 269, column: 54)
!2569 = !DILocation(line: 270, column: 17, scope: !2568)
!2570 = !DILocalVariable(name: "video_size", scope: !2568, file: !922, line: 270, type: !1053)
!2571 = !DILocation(line: 270, column: 25, scope: !2568)
!2572 = !DILocalVariable(name: "audio_size", scope: !2568, file: !922, line: 270, type: !1053)
!2573 = !DILocation(line: 270, column: 37, scope: !2568)
!2574 = !DILocation(line: 271, column: 28, scope: !2568)
!2575 = !DILocation(line: 271, column: 32, scope: !2568)
!2576 = !DILocation(line: 271, column: 18, scope: !2568)
!2577 = !DILocation(line: 271, column: 15, scope: !2568)
!2578 = !DILocation(line: 272, column: 25, scope: !2579)
!2579 = distinct !DILexicalBlock(scope: !2568, file: !922, line: 272, column: 13)
!2580 = !DILocation(line: 272, column: 18, scope: !2579)
!2581 = !DILocation(line: 272, column: 15, scope: !2579)
!2582 = !DILocation(line: 272, column: 13, scope: !2568)
!2583 = !DILocation(line: 274, column: 19, scope: !2584)
!2584 = distinct !DILexicalBlock(scope: !2579, file: !922, line: 273, column: 61)
!2585 = !DILocation(line: 275, column: 13, scope: !2584)
!2586 = !DILocation(line: 277, column: 28, scope: !2568)
!2587 = !DILocation(line: 277, column: 33, scope: !2568)
!2588 = !DILocation(line: 277, column: 41, scope: !2568)
!2589 = !DILocation(line: 277, column: 45, scope: !2568)
!2590 = !DILocation(line: 277, column: 50, scope: !2568)
!2591 = !DILocation(line: 277, column: 43, scope: !2568)
!2592 = !DILocation(line: 278, column: 28, scope: !2568)
!2593 = !DILocation(line: 278, column: 40, scope: !2568)
!2594 = !DILocation(line: 278, column: 45, scope: !2568)
!2595 = !DILocation(line: 277, column: 9, scope: !2568)
!2596 = !DILocation(line: 279, column: 13, scope: !2597)
!2597 = distinct !DILexicalBlock(scope: !2568, file: !922, line: 279, column: 13)
!2598 = !DILocation(line: 279, column: 13, scope: !2568)
!2599 = !DILocation(line: 280, column: 32, scope: !2597)
!2600 = !DILocation(line: 280, column: 37, scope: !2597)
!2601 = !DILocation(line: 280, column: 46, scope: !2597)
!2602 = !DILocation(line: 280, column: 44, scope: !2597)
!2603 = !DILocation(line: 280, column: 58, scope: !2597)
!2604 = !DILocation(line: 281, column: 32, scope: !2597)
!2605 = !DILocation(line: 281, column: 44, scope: !2597)
!2606 = !DILocation(line: 281, column: 55, scope: !2597)
!2607 = !DILocation(line: 280, column: 13, scope: !2597)
!2608 = !DILocation(line: 282, column: 29, scope: !2568)
!2609 = !DILocation(line: 282, column: 40, scope: !2568)
!2610 = !DILocation(line: 282, column: 26, scope: !2568)
!2611 = !DILocation(line: 283, column: 5, scope: !2568)
!2612 = !DILocation(line: 269, column: 50, scope: !2613)
!2613 = !DILexicalBlockFile(scope: !2559, file: !922, discriminator: 4)
!2614 = !DILocation(line: 269, column: 5, scope: !2613)
!2615 = distinct !{!2615, !2616}
!2616 = !DILocation(line: 269, column: 5, scope: !2153)
!2617 = !DILocation(line: 285, column: 9, scope: !2618)
!2618 = distinct !DILexicalBlock(scope: !2153, file: !922, line: 285, column: 9)
!2619 = !DILocation(line: 285, column: 9, scope: !2153)
!2620 = !DILocation(line: 285, column: 16, scope: !2621)
!2621 = !DILexicalBlockFile(scope: !2618, file: !922, discriminator: 1)
!2622 = !DILocation(line: 287, column: 5, scope: !2153)
!2623 = !DILocation(line: 288, column: 1, scope: !2153)
!2624 = distinct !DISubprogram(name: "rpl_read_packet", scope: !922, file: !922, line: 290, type: !2625, isLocal: true, isDefinition: true, scopeLine: 291, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2625 = !DISubroutineType(types: !2626)
!2626 = !{!918, !2156, !1033}
!2627 = !DILocalVariable(name: "s", arg: 1, scope: !2624, file: !922, line: 290, type: !2156)
!2628 = !DILocation(line: 290, column: 45, scope: !2624)
!2629 = !DILocalVariable(name: "pkt", arg: 2, scope: !2624, file: !922, line: 290, type: !1033)
!2630 = !DILocation(line: 290, column: 58, scope: !2624)
!2631 = !DILocalVariable(name: "rpl", scope: !2624, file: !922, line: 292, type: !2165)
!2632 = !DILocation(line: 292, column: 17, scope: !2624)
!2633 = !DILocation(line: 292, column: 23, scope: !2624)
!2634 = !DILocation(line: 292, column: 26, scope: !2624)
!2635 = !DILocalVariable(name: "pb", scope: !2624, file: !922, line: 293, type: !1215)
!2636 = !DILocation(line: 293, column: 18, scope: !2624)
!2637 = !DILocation(line: 293, column: 23, scope: !2624)
!2638 = !DILocation(line: 293, column: 26, scope: !2624)
!2639 = !DILocalVariable(name: "stream", scope: !2624, file: !922, line: 294, type: !1283)
!2640 = !DILocation(line: 294, column: 15, scope: !2624)
!2641 = !DILocalVariable(name: "index_entry", scope: !2624, file: !922, line: 295, type: !1873)
!2642 = !DILocation(line: 295, column: 19, scope: !2624)
!2643 = !DILocalVariable(name: "ret", scope: !2624, file: !922, line: 296, type: !918)
!2644 = !DILocation(line: 296, column: 9, scope: !2624)
!2645 = !DILocation(line: 298, column: 9, scope: !2646)
!2646 = distinct !DILexicalBlock(scope: !2624, file: !922, line: 298, column: 9)
!2647 = !DILocation(line: 298, column: 14, scope: !2646)
!2648 = !DILocation(line: 298, column: 28, scope: !2646)
!2649 = !DILocation(line: 298, column: 31, scope: !2646)
!2650 = !DILocation(line: 298, column: 25, scope: !2646)
!2651 = !DILocation(line: 298, column: 9, scope: !2624)
!2652 = !DILocation(line: 299, column: 9, scope: !2653)
!2653 = distinct !DILexicalBlock(scope: !2646, file: !922, line: 298, column: 43)
!2654 = !DILocation(line: 299, column: 14, scope: !2653)
!2655 = !DILocation(line: 299, column: 26, scope: !2653)
!2656 = !DILocation(line: 300, column: 9, scope: !2653)
!2657 = !DILocation(line: 300, column: 14, scope: !2653)
!2658 = !DILocation(line: 300, column: 25, scope: !2653)
!2659 = !DILocation(line: 301, column: 5, scope: !2653)
!2660 = !DILocation(line: 303, column: 25, scope: !2624)
!2661 = !DILocation(line: 303, column: 30, scope: !2624)
!2662 = !DILocation(line: 303, column: 14, scope: !2624)
!2663 = !DILocation(line: 303, column: 17, scope: !2624)
!2664 = !DILocation(line: 303, column: 12, scope: !2624)
!2665 = !DILocation(line: 305, column: 9, scope: !2666)
!2666 = distinct !DILexicalBlock(scope: !2624, file: !922, line: 305, column: 9)
!2667 = !DILocation(line: 305, column: 14, scope: !2666)
!2668 = !DILocation(line: 305, column: 30, scope: !2666)
!2669 = !DILocation(line: 305, column: 38, scope: !2666)
!2670 = !DILocation(line: 305, column: 27, scope: !2666)
!2671 = !DILocation(line: 305, column: 9, scope: !2624)
!2672 = !DILocation(line: 306, column: 9, scope: !2666)
!2673 = !DILocation(line: 308, column: 42, scope: !2624)
!2674 = !DILocation(line: 308, column: 47, scope: !2624)
!2675 = !DILocation(line: 308, column: 20, scope: !2624)
!2676 = !DILocation(line: 308, column: 28, scope: !2624)
!2677 = !DILocation(line: 308, column: 17, scope: !2624)
!2678 = !DILocation(line: 310, column: 9, scope: !2679)
!2679 = distinct !DILexicalBlock(scope: !2624, file: !922, line: 310, column: 9)
!2680 = !DILocation(line: 310, column: 14, scope: !2679)
!2681 = !DILocation(line: 310, column: 28, scope: !2679)
!2682 = !DILocation(line: 310, column: 9, scope: !2624)
!2683 = !DILocation(line: 311, column: 23, scope: !2684)
!2684 = distinct !DILexicalBlock(scope: !2679, file: !922, line: 311, column: 13)
!2685 = !DILocation(line: 311, column: 27, scope: !2684)
!2686 = !DILocation(line: 311, column: 40, scope: !2684)
!2687 = !DILocation(line: 311, column: 13, scope: !2684)
!2688 = !DILocation(line: 311, column: 54, scope: !2684)
!2689 = !DILocation(line: 311, column: 13, scope: !2679)
!2690 = !DILocation(line: 312, column: 13, scope: !2684)
!2691 = !DILocation(line: 311, column: 56, scope: !2692)
!2692 = !DILexicalBlockFile(scope: !2684, file: !922, discriminator: 1)
!2693 = !DILocation(line: 314, column: 9, scope: !2694)
!2694 = distinct !DILexicalBlock(scope: !2624, file: !922, line: 314, column: 9)
!2695 = !DILocation(line: 314, column: 17, scope: !2694)
!2696 = !DILocation(line: 314, column: 27, scope: !2694)
!2697 = !DILocation(line: 314, column: 38, scope: !2694)
!2698 = !DILocation(line: 314, column: 60, scope: !2694)
!2699 = !DILocation(line: 315, column: 9, scope: !2694)
!2700 = !DILocation(line: 315, column: 17, scope: !2694)
!2701 = !DILocation(line: 315, column: 27, scope: !2694)
!2702 = !DILocation(line: 315, column: 37, scope: !2694)
!2703 = !DILocation(line: 314, column: 9, scope: !2704)
!2704 = !DILexicalBlockFile(scope: !2624, file: !922, discriminator: 1)
!2705 = !DILocalVariable(name: "frame_size", scope: !2706, file: !922, line: 318, type: !1368)
!2706 = distinct !DILexicalBlock(scope: !2694, file: !922, line: 315, column: 45)
!2707 = !DILocation(line: 318, column: 18, scope: !2706)
!2708 = !DILocation(line: 320, column: 19, scope: !2706)
!2709 = !DILocation(line: 320, column: 9, scope: !2706)
!2710 = !DILocation(line: 321, column: 32, scope: !2706)
!2711 = !DILocation(line: 321, column: 22, scope: !2706)
!2712 = !DILocation(line: 321, column: 20, scope: !2706)
!2713 = !DILocation(line: 322, column: 23, scope: !2714)
!2714 = distinct !DILexicalBlock(scope: !2706, file: !922, line: 322, column: 13)
!2715 = !DILocation(line: 322, column: 13, scope: !2714)
!2716 = !DILocation(line: 322, column: 40, scope: !2714)
!2717 = !DILocation(line: 322, column: 13, scope: !2706)
!2718 = !DILocation(line: 323, column: 13, scope: !2714)
!2719 = !DILocation(line: 325, column: 29, scope: !2706)
!2720 = !DILocation(line: 325, column: 33, scope: !2706)
!2721 = !DILocation(line: 325, column: 38, scope: !2706)
!2722 = !DILocation(line: 325, column: 15, scope: !2706)
!2723 = !DILocation(line: 325, column: 13, scope: !2706)
!2724 = !DILocation(line: 326, column: 13, scope: !2725)
!2725 = distinct !DILexicalBlock(scope: !2706, file: !922, line: 326, column: 13)
!2726 = !DILocation(line: 326, column: 17, scope: !2725)
!2727 = !DILocation(line: 326, column: 13, scope: !2706)
!2728 = !DILocation(line: 327, column: 20, scope: !2725)
!2729 = !DILocation(line: 327, column: 13, scope: !2725)
!2730 = !DILocation(line: 328, column: 13, scope: !2731)
!2731 = distinct !DILexicalBlock(scope: !2706, file: !922, line: 328, column: 13)
!2732 = !DILocation(line: 328, column: 20, scope: !2731)
!2733 = !DILocation(line: 328, column: 17, scope: !2731)
!2734 = !DILocation(line: 328, column: 13, scope: !2706)
!2735 = !DILocation(line: 329, column: 29, scope: !2736)
!2736 = distinct !DILexicalBlock(scope: !2731, file: !922, line: 328, column: 32)
!2737 = !DILocation(line: 329, column: 13, scope: !2736)
!2738 = !DILocation(line: 330, column: 13, scope: !2736)
!2739 = !DILocation(line: 332, column: 9, scope: !2706)
!2740 = !DILocation(line: 332, column: 14, scope: !2706)
!2741 = !DILocation(line: 332, column: 23, scope: !2706)
!2742 = !DILocation(line: 333, column: 20, scope: !2706)
!2743 = !DILocation(line: 333, column: 33, scope: !2706)
!2744 = !DILocation(line: 333, column: 45, scope: !2706)
!2745 = !DILocation(line: 333, column: 50, scope: !2706)
!2746 = !DILocation(line: 333, column: 43, scope: !2706)
!2747 = !DILocation(line: 333, column: 9, scope: !2706)
!2748 = !DILocation(line: 333, column: 14, scope: !2706)
!2749 = !DILocation(line: 333, column: 18, scope: !2706)
!2750 = !DILocation(line: 334, column: 29, scope: !2706)
!2751 = !DILocation(line: 334, column: 34, scope: !2706)
!2752 = !DILocation(line: 334, column: 9, scope: !2706)
!2753 = !DILocation(line: 334, column: 14, scope: !2706)
!2754 = !DILocation(line: 334, column: 27, scope: !2706)
!2755 = !DILocation(line: 336, column: 9, scope: !2706)
!2756 = !DILocation(line: 336, column: 14, scope: !2706)
!2757 = !DILocation(line: 336, column: 27, scope: !2706)
!2758 = !DILocation(line: 337, column: 13, scope: !2759)
!2759 = distinct !DILexicalBlock(scope: !2706, file: !922, line: 337, column: 13)
!2760 = !DILocation(line: 337, column: 18, scope: !2759)
!2761 = !DILocation(line: 337, column: 35, scope: !2759)
!2762 = !DILocation(line: 337, column: 40, scope: !2759)
!2763 = !DILocation(line: 337, column: 32, scope: !2759)
!2764 = !DILocation(line: 337, column: 13, scope: !2706)
!2765 = !DILocation(line: 338, column: 13, scope: !2766)
!2766 = distinct !DILexicalBlock(scope: !2759, file: !922, line: 337, column: 58)
!2767 = !DILocation(line: 338, column: 18, scope: !2766)
!2768 = !DILocation(line: 338, column: 32, scope: !2766)
!2769 = !DILocation(line: 339, column: 13, scope: !2766)
!2770 = !DILocation(line: 339, column: 18, scope: !2766)
!2771 = !DILocation(line: 339, column: 28, scope: !2766)
!2772 = !DILocation(line: 340, column: 9, scope: !2766)
!2773 = !DILocation(line: 341, column: 5, scope: !2706)
!2774 = !DILocation(line: 342, column: 29, scope: !2775)
!2775 = distinct !DILexicalBlock(scope: !2694, file: !922, line: 341, column: 12)
!2776 = !DILocation(line: 342, column: 33, scope: !2775)
!2777 = !DILocation(line: 342, column: 38, scope: !2775)
!2778 = !DILocation(line: 342, column: 51, scope: !2775)
!2779 = !DILocation(line: 342, column: 15, scope: !2775)
!2780 = !DILocation(line: 342, column: 13, scope: !2775)
!2781 = !DILocation(line: 343, column: 13, scope: !2782)
!2782 = distinct !DILexicalBlock(scope: !2775, file: !922, line: 343, column: 13)
!2783 = !DILocation(line: 343, column: 17, scope: !2782)
!2784 = !DILocation(line: 343, column: 13, scope: !2775)
!2785 = !DILocation(line: 344, column: 20, scope: !2782)
!2786 = !DILocation(line: 344, column: 13, scope: !2782)
!2787 = !DILocation(line: 345, column: 13, scope: !2788)
!2788 = distinct !DILexicalBlock(scope: !2775, file: !922, line: 345, column: 13)
!2789 = !DILocation(line: 345, column: 20, scope: !2788)
!2790 = !DILocation(line: 345, column: 33, scope: !2788)
!2791 = !DILocation(line: 345, column: 17, scope: !2788)
!2792 = !DILocation(line: 345, column: 13, scope: !2775)
!2793 = !DILocation(line: 346, column: 29, scope: !2794)
!2794 = distinct !DILexicalBlock(scope: !2788, file: !922, line: 345, column: 39)
!2795 = !DILocation(line: 346, column: 13, scope: !2794)
!2796 = !DILocation(line: 347, column: 13, scope: !2794)
!2797 = !DILocation(line: 350, column: 13, scope: !2798)
!2798 = distinct !DILexicalBlock(scope: !2775, file: !922, line: 350, column: 13)
!2799 = !DILocation(line: 350, column: 21, scope: !2798)
!2800 = !DILocation(line: 350, column: 31, scope: !2798)
!2801 = !DILocation(line: 350, column: 42, scope: !2798)
!2802 = !DILocation(line: 350, column: 13, scope: !2775)
!2803 = !DILocation(line: 353, column: 29, scope: !2804)
!2804 = distinct !DILexicalBlock(scope: !2798, file: !922, line: 350, column: 65)
!2805 = !DILocation(line: 353, column: 34, scope: !2804)
!2806 = !DILocation(line: 353, column: 13, scope: !2804)
!2807 = !DILocation(line: 353, column: 18, scope: !2804)
!2808 = !DILocation(line: 353, column: 27, scope: !2804)
!2809 = !DILocation(line: 354, column: 9, scope: !2804)
!2810 = !DILocation(line: 357, column: 29, scope: !2811)
!2811 = distinct !DILexicalBlock(scope: !2798, file: !922, line: 354, column: 16)
!2812 = !DILocation(line: 357, column: 33, scope: !2811)
!2813 = !DILocation(line: 357, column: 13, scope: !2811)
!2814 = !DILocation(line: 357, column: 18, scope: !2811)
!2815 = !DILocation(line: 357, column: 27, scope: !2811)
!2816 = !DILocation(line: 359, column: 20, scope: !2775)
!2817 = !DILocation(line: 359, column: 33, scope: !2775)
!2818 = !DILocation(line: 359, column: 9, scope: !2775)
!2819 = !DILocation(line: 359, column: 14, scope: !2775)
!2820 = !DILocation(line: 359, column: 18, scope: !2775)
!2821 = !DILocation(line: 360, column: 29, scope: !2775)
!2822 = !DILocation(line: 360, column: 34, scope: !2775)
!2823 = !DILocation(line: 360, column: 9, scope: !2775)
!2824 = !DILocation(line: 360, column: 14, scope: !2775)
!2825 = !DILocation(line: 360, column: 27, scope: !2775)
!2826 = !DILocation(line: 361, column: 9, scope: !2775)
!2827 = !DILocation(line: 361, column: 14, scope: !2775)
!2828 = !DILocation(line: 361, column: 24, scope: !2775)
!2829 = !DILocation(line: 366, column: 9, scope: !2830)
!2830 = distinct !DILexicalBlock(scope: !2624, file: !922, line: 366, column: 9)
!2831 = !DILocation(line: 366, column: 14, scope: !2830)
!2832 = !DILocation(line: 366, column: 27, scope: !2830)
!2833 = !DILocation(line: 366, column: 32, scope: !2830)
!2834 = !DILocation(line: 366, column: 35, scope: !2835)
!2835 = !DILexicalBlockFile(scope: !2830, file: !922, discriminator: 1)
!2836 = !DILocation(line: 366, column: 40, scope: !2835)
!2837 = !DILocation(line: 366, column: 54, scope: !2835)
!2838 = !DILocation(line: 366, column: 9, scope: !2835)
!2839 = !DILocation(line: 367, column: 9, scope: !2830)
!2840 = !DILocation(line: 367, column: 14, scope: !2830)
!2841 = !DILocation(line: 367, column: 20, scope: !2830)
!2842 = !DILocation(line: 369, column: 12, scope: !2624)
!2843 = !DILocation(line: 369, column: 5, scope: !2624)
!2844 = !DILocation(line: 370, column: 1, scope: !2624)
!2845 = distinct !DISubprogram(name: "read_line", scope: !922, file: !922, line: 54, type: !2846, isLocal: true, isDefinition: true, scopeLine: 55, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2846 = !DISubroutineType(types: !2847)
!2847 = !{!918, !1215, !1396, !918}
!2848 = !DILocalVariable(name: "pb", arg: 1, scope: !2845, file: !922, line: 54, type: !1215)
!2849 = !DILocation(line: 54, column: 36, scope: !2845)
!2850 = !DILocalVariable(name: "line", arg: 2, scope: !2845, file: !922, line: 54, type: !1396)
!2851 = !DILocation(line: 54, column: 46, scope: !2845)
!2852 = !DILocalVariable(name: "bufsize", arg: 3, scope: !2845, file: !922, line: 54, type: !918)
!2853 = !DILocation(line: 54, column: 56, scope: !2845)
!2854 = !DILocalVariable(name: "i", scope: !2845, file: !922, line: 56, type: !918)
!2855 = !DILocation(line: 56, column: 9, scope: !2845)
!2856 = !DILocation(line: 57, column: 12, scope: !2857)
!2857 = distinct !DILexicalBlock(scope: !2845, file: !922, line: 57, column: 5)
!2858 = !DILocation(line: 57, column: 10, scope: !2857)
!2859 = !DILocation(line: 57, column: 17, scope: !2860)
!2860 = !DILexicalBlockFile(scope: !2861, file: !922, discriminator: 1)
!2861 = distinct !DILexicalBlock(scope: !2857, file: !922, line: 57, column: 5)
!2862 = !DILocation(line: 57, column: 21, scope: !2860)
!2863 = !DILocation(line: 57, column: 29, scope: !2860)
!2864 = !DILocation(line: 57, column: 19, scope: !2860)
!2865 = !DILocation(line: 57, column: 5, scope: !2860)
!2866 = !DILocalVariable(name: "b", scope: !2867, file: !922, line: 58, type: !918)
!2867 = distinct !DILexicalBlock(scope: !2861, file: !922, line: 57, column: 39)
!2868 = !DILocation(line: 58, column: 13, scope: !2867)
!2869 = !DILocation(line: 58, column: 25, scope: !2867)
!2870 = !DILocation(line: 58, column: 17, scope: !2867)
!2871 = !DILocation(line: 59, column: 13, scope: !2872)
!2872 = distinct !DILexicalBlock(scope: !2867, file: !922, line: 59, column: 13)
!2873 = !DILocation(line: 59, column: 15, scope: !2872)
!2874 = !DILocation(line: 59, column: 13, scope: !2867)
!2875 = !DILocation(line: 60, column: 13, scope: !2872)
!2876 = !DILocation(line: 61, column: 13, scope: !2877)
!2877 = distinct !DILexicalBlock(scope: !2867, file: !922, line: 61, column: 13)
!2878 = !DILocation(line: 61, column: 15, scope: !2877)
!2879 = !DILocation(line: 61, column: 13, scope: !2867)
!2880 = !DILocation(line: 62, column: 18, scope: !2881)
!2881 = distinct !DILexicalBlock(scope: !2877, file: !922, line: 61, column: 24)
!2882 = !DILocation(line: 62, column: 13, scope: !2881)
!2883 = !DILocation(line: 62, column: 21, scope: !2881)
!2884 = !DILocation(line: 63, column: 30, scope: !2881)
!2885 = !DILocation(line: 63, column: 20, scope: !2881)
!2886 = !DILocation(line: 63, column: 13, scope: !2881)
!2887 = !DILocation(line: 65, column: 19, scope: !2867)
!2888 = !DILocation(line: 65, column: 14, scope: !2867)
!2889 = !DILocation(line: 65, column: 9, scope: !2867)
!2890 = !DILocation(line: 65, column: 17, scope: !2867)
!2891 = !DILocation(line: 66, column: 5, scope: !2867)
!2892 = !DILocation(line: 57, column: 35, scope: !2893)
!2893 = !DILexicalBlockFile(scope: !2861, file: !922, discriminator: 2)
!2894 = !DILocation(line: 57, column: 5, scope: !2893)
!2895 = distinct !{!2895, !2896}
!2896 = !DILocation(line: 57, column: 5, scope: !2845)
!2897 = !DILocation(line: 67, column: 10, scope: !2845)
!2898 = !DILocation(line: 67, column: 5, scope: !2845)
!2899 = !DILocation(line: 67, column: 13, scope: !2845)
!2900 = !DILocation(line: 68, column: 5, scope: !2845)
!2901 = !DILocation(line: 69, column: 1, scope: !2845)
!2902 = distinct !DISubprogram(name: "read_line_and_int", scope: !922, file: !922, line: 83, type: !2903, isLocal: true, isDefinition: true, scopeLine: 84, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2903 = !DISubroutineType(types: !2904)
!2904 = !{!2170, !1215, !1406}
!2905 = !DILocalVariable(name: "pb", arg: 1, scope: !2902, file: !922, line: 83, type: !1215)
!2906 = !DILocation(line: 83, column: 48, scope: !2902)
!2907 = !DILocalVariable(name: "error", arg: 2, scope: !2902, file: !922, line: 83, type: !1406)
!2908 = !DILocation(line: 83, column: 57, scope: !2902)
!2909 = !DILocalVariable(name: "line", scope: !2902, file: !922, line: 85, type: !2188)
!2910 = !DILocation(line: 85, column: 10, scope: !2902)
!2911 = !DILocalVariable(name: "endptr", scope: !2902, file: !922, line: 86, type: !927)
!2912 = !DILocation(line: 86, column: 17, scope: !2902)
!2913 = !DILocation(line: 87, column: 25, scope: !2902)
!2914 = !DILocation(line: 87, column: 29, scope: !2902)
!2915 = !DILocation(line: 87, column: 15, scope: !2902)
!2916 = !DILocation(line: 87, column: 6, scope: !2902)
!2917 = !DILocation(line: 87, column: 12, scope: !2902)
!2918 = !DILocation(line: 88, column: 21, scope: !2902)
!2919 = !DILocation(line: 88, column: 36, scope: !2902)
!2920 = !DILocation(line: 88, column: 12, scope: !2902)
!2921 = !DILocation(line: 88, column: 5, scope: !2902)
!2922 = distinct !DISubprogram(name: "read_fps", scope: !922, file: !922, line: 95, type: !2923, isLocal: true, isDefinition: true, scopeLine: 96, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2923 = !DISubroutineType(types: !2924)
!2924 = !{!1117, !927, !1406}
!2925 = !DILocalVariable(name: "line", arg: 1, scope: !2922, file: !922, line: 95, type: !927)
!2926 = !DILocation(line: 95, column: 40, scope: !2922)
!2927 = !DILocalVariable(name: "error", arg: 2, scope: !2922, file: !922, line: 95, type: !1406)
!2928 = !DILocation(line: 95, column: 51, scope: !2922)
!2929 = !DILocalVariable(name: "num", scope: !2922, file: !922, line: 97, type: !1053)
!2930 = !DILocation(line: 97, column: 13, scope: !2922)
!2931 = !DILocalVariable(name: "den", scope: !2922, file: !922, line: 97, type: !1053)
!2932 = !DILocation(line: 97, column: 18, scope: !2922)
!2933 = !DILocalVariable(name: "result", scope: !2922, file: !922, line: 98, type: !1117)
!2934 = !DILocation(line: 98, column: 16, scope: !2922)
!2935 = !DILocation(line: 99, column: 20, scope: !2922)
!2936 = !DILocation(line: 99, column: 33, scope: !2922)
!2937 = !DILocation(line: 99, column: 11, scope: !2922)
!2938 = !DILocation(line: 99, column: 9, scope: !2922)
!2939 = !DILocation(line: 100, column: 10, scope: !2940)
!2940 = distinct !DILexicalBlock(scope: !2922, file: !922, line: 100, column: 9)
!2941 = !DILocation(line: 100, column: 9, scope: !2940)
!2942 = !DILocation(line: 100, column: 15, scope: !2940)
!2943 = !DILocation(line: 100, column: 9, scope: !2922)
!2944 = !DILocation(line: 101, column: 13, scope: !2940)
!2945 = !DILocation(line: 101, column: 9, scope: !2940)
!2946 = !DILocation(line: 102, column: 5, scope: !2922)
!2947 = !DILocation(line: 102, column: 13, scope: !2948)
!2948 = !DILexicalBlockFile(scope: !2949, file: !922, discriminator: 1)
!2949 = distinct !DILexicalBlock(scope: !2950, file: !922, line: 102, column: 5)
!2950 = distinct !DILexicalBlock(scope: !2922, file: !922, line: 102, column: 5)
!2951 = !DILocation(line: 102, column: 12, scope: !2948)
!2952 = !DILocation(line: 102, column: 17, scope: !2948)
!2953 = !DILocation(line: 102, column: 23, scope: !2948)
!2954 = !DILocation(line: 102, column: 27, scope: !2955)
!2955 = !DILexicalBlockFile(scope: !2949, file: !922, discriminator: 2)
!2956 = !DILocation(line: 102, column: 26, scope: !2955)
!2957 = !DILocation(line: 102, column: 31, scope: !2955)
!2958 = !DILocation(line: 102, column: 5, scope: !2959)
!2959 = !DILexicalBlockFile(scope: !2950, file: !922, discriminator: 3)
!2960 = !DILocation(line: 104, column: 13, scope: !2961)
!2961 = distinct !DILexicalBlock(scope: !2962, file: !922, line: 104, column: 13)
!2962 = distinct !DILexicalBlock(scope: !2949, file: !922, line: 102, column: 46)
!2963 = !DILocation(line: 104, column: 17, scope: !2961)
!2964 = !DILocation(line: 104, column: 39, scope: !2961)
!2965 = !DILocation(line: 104, column: 42, scope: !2966)
!2966 = !DILexicalBlockFile(scope: !2961, file: !922, discriminator: 1)
!2967 = !DILocation(line: 104, column: 46, scope: !2966)
!2968 = !DILocation(line: 104, column: 13, scope: !2966)
!2969 = !DILocation(line: 105, column: 13, scope: !2961)
!2970 = !DILocation(line: 106, column: 20, scope: !2962)
!2971 = !DILocation(line: 106, column: 18, scope: !2962)
!2972 = !DILocation(line: 106, column: 27, scope: !2962)
!2973 = !DILocation(line: 106, column: 26, scope: !2962)
!2974 = !DILocation(line: 106, column: 24, scope: !2962)
!2975 = !DILocation(line: 106, column: 32, scope: !2962)
!2976 = !DILocation(line: 106, column: 13, scope: !2962)
!2977 = !DILocation(line: 107, column: 13, scope: !2962)
!2978 = !DILocation(line: 108, column: 5, scope: !2962)
!2979 = !DILocation(line: 102, column: 42, scope: !2980)
!2980 = !DILexicalBlockFile(scope: !2949, file: !922, discriminator: 4)
!2981 = !DILocation(line: 102, column: 5, scope: !2980)
!2982 = distinct !{!2982, !2946}
!2983 = !DILocation(line: 109, column: 10, scope: !2984)
!2984 = distinct !DILexicalBlock(scope: !2922, file: !922, line: 109, column: 9)
!2985 = !DILocation(line: 109, column: 9, scope: !2922)
!2986 = !DILocation(line: 110, column: 10, scope: !2984)
!2987 = !DILocation(line: 110, column: 16, scope: !2984)
!2988 = !DILocation(line: 110, column: 9, scope: !2984)
!2989 = !DILocation(line: 111, column: 23, scope: !2922)
!2990 = !DILocation(line: 111, column: 36, scope: !2922)
!2991 = !DILocation(line: 111, column: 41, scope: !2922)
!2992 = !DILocation(line: 111, column: 46, scope: !2922)
!2993 = !DILocation(line: 111, column: 5, scope: !2922)
!2994 = !DILocation(line: 112, column: 12, scope: !2922)
!2995 = !DILocation(line: 112, column: 5, scope: !2922)
!2996 = distinct !DISubprogram(name: "read_int", scope: !922, file: !922, line: 71, type: !2997, isLocal: true, isDefinition: true, scopeLine: 72, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2997 = !DISubroutineType(types: !2998)
!2998 = !{!2170, !927, !2999, !1406}
!2999 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !927, size: 64, align: 64)
!3000 = !DILocalVariable(name: "line", arg: 1, scope: !2996, file: !922, line: 71, type: !927)
!3001 = !DILocation(line: 71, column: 37, scope: !2996)
!3002 = !DILocalVariable(name: "endptr", arg: 2, scope: !2996, file: !922, line: 71, type: !2999)
!3003 = !DILocation(line: 71, column: 56, scope: !2996)
!3004 = !DILocalVariable(name: "error", arg: 3, scope: !2996, file: !922, line: 71, type: !1406)
!3005 = !DILocation(line: 71, column: 69, scope: !2996)
!3006 = !DILocalVariable(name: "result", scope: !2996, file: !922, line: 73, type: !1092)
!3007 = !DILocation(line: 73, column: 19, scope: !2996)
!3008 = !DILocation(line: 74, column: 5, scope: !2996)
!3009 = !DILocation(line: 74, column: 13, scope: !3010)
!3010 = !DILexicalBlockFile(scope: !3011, file: !922, discriminator: 1)
!3011 = distinct !DILexicalBlock(scope: !3012, file: !922, line: 74, column: 5)
!3012 = distinct !DILexicalBlock(scope: !2996, file: !922, line: 74, column: 5)
!3013 = !DILocation(line: 74, column: 12, scope: !3010)
!3014 = !DILocation(line: 74, column: 17, scope: !3010)
!3015 = !DILocation(line: 74, column: 23, scope: !3010)
!3016 = !DILocation(line: 74, column: 27, scope: !3017)
!3017 = !DILexicalBlockFile(scope: !3011, file: !922, discriminator: 2)
!3018 = !DILocation(line: 74, column: 26, scope: !3017)
!3019 = !DILocation(line: 74, column: 31, scope: !3017)
!3020 = !DILocation(line: 74, column: 5, scope: !3021)
!3021 = !DILexicalBlockFile(scope: !3012, file: !922, discriminator: 3)
!3022 = !DILocation(line: 75, column: 13, scope: !3023)
!3023 = distinct !DILexicalBlock(scope: !3024, file: !922, line: 75, column: 13)
!3024 = distinct !DILexicalBlock(scope: !3011, file: !922, line: 74, column: 46)
!3025 = !DILocation(line: 75, column: 20, scope: !3023)
!3026 = !DILocation(line: 75, column: 13, scope: !3024)
!3027 = !DILocation(line: 76, column: 14, scope: !3023)
!3028 = !DILocation(line: 76, column: 20, scope: !3023)
!3029 = !DILocation(line: 76, column: 13, scope: !3023)
!3030 = !DILocation(line: 77, column: 23, scope: !3024)
!3031 = !DILocation(line: 77, column: 21, scope: !3024)
!3032 = !DILocation(line: 77, column: 33, scope: !3024)
!3033 = !DILocation(line: 77, column: 32, scope: !3024)
!3034 = !DILocation(line: 77, column: 30, scope: !3024)
!3035 = !DILocation(line: 77, column: 38, scope: !3024)
!3036 = !DILocation(line: 77, column: 16, scope: !3024)
!3037 = !DILocation(line: 78, column: 5, scope: !3024)
!3038 = !DILocation(line: 74, column: 42, scope: !3039)
!3039 = !DILexicalBlockFile(scope: !3011, file: !922, discriminator: 4)
!3040 = !DILocation(line: 74, column: 5, scope: !3039)
!3041 = distinct !{!3041, !3008}
!3042 = !DILocation(line: 79, column: 15, scope: !2996)
!3043 = !DILocation(line: 79, column: 6, scope: !2996)
!3044 = !DILocation(line: 79, column: 13, scope: !2996)
!3045 = !DILocation(line: 80, column: 12, scope: !2996)
!3046 = !DILocation(line: 80, column: 5, scope: !2996)
