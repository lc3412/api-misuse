; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--paf.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--paf.o.i"
...
%struct.PAFDemuxContext = type { i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32*, i32*, i32*, i8*, i32, i8*, i8*, i32, i32 }
...
@ff_paf_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1, i32 0, i32 0), i32 0, i8* null, %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 104, i32 (%struct.AVProbeData*)* @read_probe, i32 (%struct.AVFormatContext*)* @read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @read_packet, i32 (%struct.AVFormatContext*)* @read_close, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
...
define internal i32 @read_probe(%struct.AVProbeData* %p) #0 !dbg !2140 {
entry:
  ...
  %buf_size = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %0, i32 0, i32 2, !dbg !2147
  %1 = load i32, i32* %buf_size, align 8, !dbg !2147
  %conv = sext i32 %1 to i64, !dbg !2145
  %cmp = icmp uge i64 %conv, 55, !dbg !2148
  br i1 %cmp, label %land.lhs.true, label %if.end, !dbg !2149

land.lhs.true:                                    ; preds = %entry
  %2 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2150
  %buf = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %2, i32 0, i32 1, !dbg !2151
  %3 = load i8*, i8** %buf, align 8, !dbg !2151
  %call = call i32 @memcmp(i8* %3, i8* getelementptr inbounds ([56 x i8], [56 x i8]* @.str.2, i32 0, i32 0), i64 55) #5, !dbg !2152
  %tobool = icmp ne i32 %call, 0, !dbg !2152
...
; Function Attrs: nounwind uwtable
define internal i32 @read_header(%struct.AVFormatContext* %s) #0 !dbg !2158 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %p = alloca %struct.PAFDemuxContext*, align 8
  %pb = alloca %struct.AVIOContext*, align 8
  %ast = alloca %struct.AVStream*, align 8
  %vst = alloca %struct.AVStream*, align 8
  %ret = alloca i32, align 4
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2163, metadata !2143), !dbg !2164
  call void @llvm.dbg.declare(metadata %struct.PAFDemuxContext** %p, metadata !2165, metadata !2143), !dbg !2190
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2191
  ...
  %2 = bitcast i8* %1 to %struct.PAFDemuxContext*, !dbg !2191
  store %struct.PAFDemuxContext* %2, %struct.PAFDemuxContext** %p, align 8, !dbg !2190
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2193, metadata !2143), !dbg !2194
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2195
  ...
  call void @llvm.dbg.declare(metadata %struct.AVStream** %ast, metadata !2197, metadata !2143), !dbg !2198
  call void @llvm.dbg.declare(metadata %struct.AVStream** %vst, metadata !2199, metadata !2143), !dbg !2200
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2201, metadata !2143), !dbg !2202
  store i32 0, i32* %ret, align 4, !dbg !2202
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2203
  %call = call i64 @avio_skip(%struct.AVIOContext* %5, i64 132), !dbg !2204
  %6 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2205
  %call2 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %6, %struct.AVCodec* null), !dbg !2206
  store %struct.AVStream* %call2, %struct.AVStream** %vst, align 8, !dbg !2207
  %7 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2208
  %tobool = icmp ne %struct.AVStream* %7, null, !dbg !2208
...
if.end:                                           ; preds = %entry
  %8 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2212
  %start_time = getelementptr inbounds %struct.AVStream, %struct.AVStream* %8, i32 0, i32 5, !dbg !2213
  store i64 0, i64* %start_time, align 8, !dbg !2214
  %9 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2215
  %call3 = call i32 @avio_rl32(%struct.AVIOContext* %9), !dbg !2216
  %10 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2217
  %nb_frames = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %10, i32 0, i32 2, !dbg !2218
  store i32 %call3, i32* %nb_frames, align 8, !dbg !2219
  %conv = zext i32 %call3 to i64, !dbg !2217
  %11 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2220
  %duration = getelementptr inbounds %struct.AVStream, %struct.AVStream* %11, i32 0, i32 6, !dbg !2221
  store i64 %conv, i64* %duration, align 8, !dbg !2222
  %12 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2223
  %nb_frames4 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %12, i32 0, i32 7, !dbg !2224
  store i64 %conv, i64* %nb_frames4, align 8, !dbg !2225
  %13 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2226
  %call5 = call i64 @avio_skip(%struct.AVIOContext* %13, i64 4), !dbg !2227
  %14 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2228
  %call6 = call i32 @avio_rl32(%struct.AVIOContext* %14), !dbg !2229
  %15 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2230
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %15, i32 0, i32 19, !dbg !2231
  %16 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2231
  %width = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %16, i32 0, i32 11, !dbg !2232
  store i32 %call6, i32* %width, align 8, !dbg !2233
  %17 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2234
  %call7 = call i32 @avio_rl32(%struct.AVIOContext* %17), !dbg !2235
  %18 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2236
  %codecpar8 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %18, i32 0, i32 19, !dbg !2237
  %19 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar8, align 8, !dbg !2237
  %height = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %19, i32 0, i32 12, !dbg !2238
  store i32 %call7, i32* %height, align 4, !dbg !2239
  %20 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2240
  %call9 = call i64 @avio_skip(%struct.AVIOContext* %20, i64 4), !dbg !2241
  %21 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2242
  %codecpar10 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %21, i32 0, i32 19, !dbg !2243
  %22 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar10, align 8, !dbg !2243
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %22, i32 0, i32 0, !dbg !2244
  store i32 0, i32* %codec_type, align 8, !dbg !2245
  %23 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2246
  %codecpar11 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %23, i32 0, i32 19, !dbg !2247
  %24 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar11, align 8, !dbg !2247
  %codec_tag = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %24, i32 0, i32 2, !dbg !2248
  store i32 0, i32* %codec_tag, align 8, !dbg !2249
  %25 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2250
  %codecpar12 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %25, i32 0, i32 19, !dbg !2251
  %26 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar12, align 8, !dbg !2251
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %26, i32 0, i32 1, !dbg !2252
  store i32 177, i32* %codec_id, align 4, !dbg !2253
  %27 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2254
  call void @avpriv_set_pts_info(%struct.AVStream* %27, i32 64, i32 1, i32 10), !dbg !2255
  %28 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2256
  %call13 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %28, %struct.AVCodec* null), !dbg !2257
  store %struct.AVStream* %call13, %struct.AVStream** %ast, align 8, !dbg !2258
  %29 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2259
  %tobool14 = icmp ne %struct.AVStream* %29, null, !dbg !2259
  br i1 %tobool14, label %if.end16, label %if.then15, !dbg !2261
...
if.end16:                                         ; preds = %if.end
  %30 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2263
  %start_time17 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %30, i32 0, i32 5, !dbg !2264
  store i64 0, i64* %start_time17, align 8, !dbg !2265
  %31 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2266
  %codecpar18 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %31, i32 0, i32 19, !dbg !2267
  %32 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar18, align 8, !dbg !2267
  %codec_type19 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %32, i32 0, i32 0, !dbg !2268
  store i32 1, i32* %codec_type19, align 8, !dbg !2269
  %33 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2270
  %codecpar20 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %33, i32 0, i32 19, !dbg !2271
  %34 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar20, align 8, !dbg !2271
  %codec_tag21 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %34, i32 0, i32 2, !dbg !2272
  store i32 0, i32* %codec_tag21, align 8, !dbg !2273
  %35 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2274
  %codecpar22 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %35, i32 0, i32 19, !dbg !2275
  %36 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar22, align 8, !dbg !2275
  %codec_id23 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %36, i32 0, i32 1, !dbg !2276
  store i32 86080, i32* %codec_id23, align 4, !dbg !2277
  %37 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2278
  %codecpar24 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %37, i32 0, i32 19, !dbg !2279
  %38 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar24, align 8, !dbg !2279
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %38, i32 0, i32 22, !dbg !2280
  store i32 2, i32* %channels, align 8, !dbg !2281
  %39 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2282
  %codecpar25 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %39, i32 0, i32 19, !dbg !2283
  %40 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar25, align 8, !dbg !2283
  %channel_layout = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %40, i32 0, i32 21, !dbg !2284
  store i64 3, i64* %channel_layout, align 8, !dbg !2285
  %41 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2286
  %codecpar26 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %41, i32 0, i32 19, !dbg !2287
  %42 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar26, align 8, !dbg !2287
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %42, i32 0, i32 23, !dbg !2288
  store i32 22050, i32* %sample_rate, align 4, !dbg !2289
  %43 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2290
  call void @avpriv_set_pts_info(%struct.AVStream* %43, i32 64, i32 1, i32 22050), !dbg !2291
  %44 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2292
  %call27 = call i32 @avio_rl32(%struct.AVIOContext* %44), !dbg !2293
  %45 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2294
  %buffer_size = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %45, i32 0, i32 0, !dbg !2295
  store i32 %call27, i32* %buffer_size, align 8, !dbg !2296
  %46 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2297
  %call28 = call i32 @avio_rl32(%struct.AVIOContext* %46), !dbg !2298
  %47 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2299
  %preload_count = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %47, i32 0, i32 4, !dbg !2300
  store i32 %call28, i32* %preload_count, align 8, !dbg !2301
  %48 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2302
  %call29 = call i32 @avio_rl32(%struct.AVIOContext* %48), !dbg !2303
  %49 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2304
  %frame_blks = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %49, i32 0, i32 1, !dbg !2305
  store i32 %call29, i32* %frame_blks, align 4, !dbg !2306
  %50 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2307
  %call30 = call i32 @avio_rl32(%struct.AVIOContext* %50), !dbg !2308
  %51 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2309
  %start_offset = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %51, i32 0, i32 3, !dbg !2310
  store i32 %call30, i32* %start_offset, align 4, !dbg !2311
  %52 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2312
  %call31 = call i32 @avio_rl32(%struct.AVIOContext* %52), !dbg !2313
  %53 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2314
  %max_video_blks = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %53, i32 0, i32 5, !dbg !2315
  store i32 %call31, i32* %max_video_blks, align 4, !dbg !2316
  %54 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2317
  %call32 = call i32 @avio_rl32(%struct.AVIOContext* %54), !dbg !2318
  %55 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2319
  %max_audio_blks = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %55, i32 0, i32 6, !dbg !2320
  store i32 %call32, i32* %max_audio_blks, align 8, !dbg !2321
  %56 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2322
  %buffer_size33 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %56, i32 0, i32 0, !dbg !2324
  %57 = load i32, i32* %buffer_size33, align 8, !dbg !2324
  %cmp = icmp ult i32 %57, 175, !dbg !2325
  br i1 %cmp, label %if.then76, label %lor.lhs.false, !dbg !2326

lor.lhs.false:                                    ; preds = %if.end16
  %58 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2327
  %max_audio_blks35 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %58, i32 0, i32 6, !dbg !2328
  %59 = load i32, i32* %max_audio_blks35, align 8, !dbg !2328
  %cmp36 = icmp ult i32 %59, 2, !dbg !2329
  br i1 %cmp36, label %if.then76, label %lor.lhs.false38, !dbg !2330

lor.lhs.false38:                                  ; preds = %lor.lhs.false
  %60 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2331
  %max_video_blks39 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %60, i32 0, i32 5, !dbg !2332
  %61 = load i32, i32* %max_video_blks39, align 4, !dbg !2332
  %cmp40 = icmp ult i32 %61, 1, !dbg !2333
  br i1 %cmp40, label %if.then76, label %lor.lhs.false42, !dbg !2334

lor.lhs.false42:                                  ; preds = %lor.lhs.false38
  %62 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2335
  %frame_blks43 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %62, i32 0, i32 1, !dbg !2336
  %63 = load i32, i32* %frame_blks43, align 4, !dbg !2336
  %cmp44 = icmp ult i32 %63, 1, !dbg !2337
  br i1 %cmp44, label %if.then76, label %lor.lhs.false46, !dbg !2338

lor.lhs.false46:                                  ; preds = %lor.lhs.false42
  %64 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2339
  %nb_frames47 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %64, i32 0, i32 2, !dbg !2340
  %65 = load i32, i32* %nb_frames47, align 8, !dbg !2340
  %cmp48 = icmp ult i32 %65, 1, !dbg !2341
  br i1 %cmp48, label %if.then76, label %lor.lhs.false50, !dbg !2342

lor.lhs.false50:                                  ; preds = %lor.lhs.false46
  %66 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2343
  %preload_count51 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %66, i32 0, i32 4, !dbg !2344
  %67 = load i32, i32* %preload_count51, align 8, !dbg !2344
  %cmp52 = icmp ult i32 %67, 1, !dbg !2345
  br i1 %cmp52, label %if.then76, label %lor.lhs.false54, !dbg !2346

lor.lhs.false54:                                  ; preds = %lor.lhs.false50
  %68 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2347
  %buffer_size55 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %68, i32 0, i32 0, !dbg !2348
  %69 = load i32, i32* %buffer_size55, align 8, !dbg !2348
  %cmp56 = icmp ugt i32 %69, 2048, !dbg !2349
  br i1 %cmp56, label %if.then76, label %lor.lhs.false58, !dbg !2350

lor.lhs.false58:                                  ; preds = %lor.lhs.false54
  %70 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2351
  %max_video_blks59 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %70, i32 0, i32 5, !dbg !2352
  %71 = load i32, i32* %max_video_blks59, align 4, !dbg !2352
  %cmp60 = icmp ugt i32 %71, 2048, !dbg !2353
  br i1 %cmp60, label %if.then76, label %lor.lhs.false62, !dbg !2354

lor.lhs.false62:                                  ; preds = %lor.lhs.false58
  %72 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2355
  %max_audio_blks63 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %72, i32 0, i32 6, !dbg !2356
  %73 = load i32, i32* %max_audio_blks63, align 8, !dbg !2356
  %cmp64 = icmp ugt i32 %73, 2048, !dbg !2357
  br i1 %cmp64, label %if.then76, label %lor.lhs.false66, !dbg !2358

lor.lhs.false66:                                  ; preds = %lor.lhs.false62
  %74 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2359
  %nb_frames67 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %74, i32 0, i32 2, !dbg !2360
  %75 = load i32, i32* %nb_frames67, align 8, !dbg !2360
  %conv68 = zext i32 %75 to i64, !dbg !2359
  %cmp69 = icmp ugt i64 %conv68, 536870911, !dbg !2361
  br i1 %cmp69, label %if.then76, label %lor.lhs.false71, !dbg !2362

lor.lhs.false71:                                  ; preds = %lor.lhs.false66
  %76 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2363
  %frame_blks72 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %76, i32 0, i32 1, !dbg !2364
  %77 = load i32, i32* %frame_blks72, align 4, !dbg !2364
  %conv73 = zext i32 %77 to i64, !dbg !2363
  %cmp74 = icmp ugt i64 %conv73, 536870911, !dbg !2365
  br i1 %cmp74, label %if.then76, label %if.end77, !dbg !2366

if.then76:                                        ; preds = %lor.lhs.false71, %lor.lhs.false66, %lor.lhs.false62, %lor.lhs.false58, %lor.lhs.false54, %lor.lhs.false50, %lor.lhs.false46, %lor.lhs.false42, %lor.lhs.false38, %lor.lhs.false, %if.end16
  store i32 -1094995529, i32* %retval, align 4, !dbg !2368
  br label %return, !dbg !2368

if.end77:                                         ; preds = %lor.lhs.false71
  %78 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2369
  %nb_frames78 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %78, i32 0, i32 2, !dbg !2370
  %79 = load i32, i32* %nb_frames78, align 8, !dbg !2370
  %conv79 = zext i32 %79 to i64, !dbg !2369
  %mul = mul i64 %conv79, 4, !dbg !2371
  %call80 = call noalias i8* @av_mallocz(i64 %mul), !dbg !2372
  %80 = bitcast i8* %call80 to i32*, !dbg !2372
  %81 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2373
  %blocks_count_table = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %81, i32 0, i32 10, !dbg !2374
  store i32* %80, i32** %blocks_count_table, align 8, !dbg !2375
  %82 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2376
  %nb_frames81 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %82, i32 0, i32 2, !dbg !2377
  %83 = load i32, i32* %nb_frames81, align 8, !dbg !2377
  %conv82 = zext i32 %83 to i64, !dbg !2376
  %mul83 = mul i64 %conv82, 4, !dbg !2378
  %call84 = call noalias i8* @av_mallocz(i64 %mul83), !dbg !2379
  %84 = bitcast i8* %call84 to i32*, !dbg !2379
  %85 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2380
  %frames_offset_table = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %85, i32 0, i32 11, !dbg !2381
  store i32* %84, i32** %frames_offset_table, align 8, !dbg !2382
  %86 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2383
  %frame_blks85 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %86, i32 0, i32 1, !dbg !2384
  %87 = load i32, i32* %frame_blks85, align 4, !dbg !2384
  %conv86 = zext i32 %87 to i64, !dbg !2383
  %mul87 = mul i64 %conv86, 4, !dbg !2385
  %call88 = call noalias i8* @av_mallocz(i64 %mul87), !dbg !2386
  %88 = bitcast i8* %call88 to i32*, !dbg !2386
  %89 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2387
  %blocks_offset_table = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %89, i32 0, i32 12, !dbg !2388
  store i32* %88, i32** %blocks_offset_table, align 8, !dbg !2389
  %90 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2390
  %max_video_blks89 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %90, i32 0, i32 5, !dbg !2391
  %91 = load i32, i32* %max_video_blks89, align 4, !dbg !2391
  %92 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2392
  %buffer_size90 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %92, i32 0, i32 0, !dbg !2393
  %93 = load i32, i32* %buffer_size90, align 8, !dbg !2393
  %mul91 = mul i32 %91, %93, !dbg !2394
  %94 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2395
  %video_size = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %94, i32 0, i32 14, !dbg !2396
  store i32 %mul91, i32* %video_size, align 8, !dbg !2397
  %95 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2398
  %video_size92 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %95, i32 0, i32 14, !dbg !2399
  %96 = load i32, i32* %video_size92, align 8, !dbg !2399
  %conv93 = sext i32 %96 to i64, !dbg !2398
  %call94 = call noalias i8* @av_mallocz(i64 %conv93), !dbg !2400
  %97 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2401
  %video_frame = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %97, i32 0, i32 13, !dbg !2402
  store i8* %call94, i8** %video_frame, align 8, !dbg !2403
  %98 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2404
  %max_audio_blks95 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %98, i32 0, i32 6, !dbg !2405
  %99 = load i32, i32* %max_audio_blks95, align 8, !dbg !2405
  %100 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2406
  %buffer_size96 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %100, i32 0, i32 0, !dbg !2407
  %101 = load i32, i32* %buffer_size96, align 8, !dbg !2407
  %mul97 = mul i32 %99, %101, !dbg !2408
  %102 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2409
  %audio_size = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %102, i32 0, i32 17, !dbg !2410
  store i32 %mul97, i32* %audio_size, align 8, !dbg !2411
  %103 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2412
  %audio_size98 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %103, i32 0, i32 17, !dbg !2413
  %104 = load i32, i32* %audio_size98, align 8, !dbg !2413
  %conv99 = sext i32 %104 to i64, !dbg !2412
  %call100 = call noalias i8* @av_mallocz(i64 %conv99), !dbg !2414
  %105 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2415
  %audio_frame = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %105, i32 0, i32 15, !dbg !2416
  store i8* %call100, i8** %audio_frame, align 8, !dbg !2417
  %106 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2418
  %audio_size101 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %106, i32 0, i32 17, !dbg !2419
  %107 = load i32, i32* %audio_size101, align 8, !dbg !2419
  %conv102 = sext i32 %107 to i64, !dbg !2418
  %call103 = call noalias i8* @av_mallocz(i64 %conv102), !dbg !2420
  %108 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2421
  %temp_audio_frame = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %108, i32 0, i32 16, !dbg !2422
  store i8* %call103, i8** %temp_audio_frame, align 8, !dbg !2423
  %109 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2424
  %blocks_count_table104 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %109, i32 0, i32 10, !dbg !2426
  %110 = load i32*, i32** %blocks_count_table104, align 8, !dbg !2426
  %tobool105 = icmp ne i32* %110, null, !dbg !2424
  br i1 %tobool105, label %lor.lhs.false106, label %if.then121, !dbg !2427

lor.lhs.false106:                                 ; preds = %if.end77
  %111 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2428
  %frames_offset_table107 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %111, i32 0, i32 11, !dbg !2429
  %112 = load i32*, i32** %frames_offset_table107, align 8, !dbg !2429
  %tobool108 = icmp ne i32* %112, null, !dbg !2428
  br i1 %tobool108, label %lor.lhs.false109, label %if.then121, !dbg !2430

lor.lhs.false109:                                 ; preds = %lor.lhs.false106
  %113 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2431
  %blocks_offset_table110 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %113, i32 0, i32 12, !dbg !2432
  %114 = load i32*, i32** %blocks_offset_table110, align 8, !dbg !2432
  %tobool111 = icmp ne i32* %114, null, !dbg !2431
  br i1 %tobool111, label %lor.lhs.false112, label %if.then121, !dbg !2433

lor.lhs.false112:                                 ; preds = %lor.lhs.false109
  %115 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2434
  %video_frame113 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %115, i32 0, i32 13, !dbg !2435
  %116 = load i8*, i8** %video_frame113, align 8, !dbg !2435
  %tobool114 = icmp ne i8* %116, null, !dbg !2434
  br i1 %tobool114, label %lor.lhs.false115, label %if.then121, !dbg !2436

lor.lhs.false115:                                 ; preds = %lor.lhs.false112
  %117 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2437
  %audio_frame116 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %117, i32 0, i32 15, !dbg !2438
  %118 = load i8*, i8** %audio_frame116, align 8, !dbg !2438
  %tobool117 = icmp ne i8* %118, null, !dbg !2437
  br i1 %tobool117, label %lor.lhs.false118, label %if.then121, !dbg !2439

lor.lhs.false118:                                 ; preds = %lor.lhs.false115
  %119 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2440
  %temp_audio_frame119 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %119, i32 0, i32 16, !dbg !2441
  %120 = load i8*, i8** %temp_audio_frame119, align 8, !dbg !2441
  %tobool120 = icmp ne i8* %120, null, !dbg !2440
  br i1 %tobool120, label %if.end122, label %if.then121, !dbg !2442

if.then121:                                       ; preds = %lor.lhs.false118, %lor.lhs.false115, %lor.lhs.false112, %lor.lhs.false109, %lor.lhs.false106, %if.end77
  store i32 -12, i32* %ret, align 4, !dbg !2443
  br label %fail, !dbg !2445

if.end122:                                        ; preds = %lor.lhs.false118
  %121 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2446
  %122 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2447
  %buffer_size123 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %122, i32 0, i32 0, !dbg !2448
  %123 = load i32, i32* %buffer_size123, align 8, !dbg !2448
  %conv124 = zext i32 %123 to i64, !dbg !2447
  %call125 = call i64 @avio_seek(%struct.AVIOContext* %121, i64 %conv124, i32 0), !dbg !2449
  %124 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2450
  %125 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2451
  %blocks_count_table126 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %125, i32 0, i32 10, !dbg !2452
  %126 = load i32*, i32** %blocks_count_table126, align 8, !dbg !2452
  %127 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2453
  %nb_frames127 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %127, i32 0, i32 2, !dbg !2454
  %128 = load i32, i32* %nb_frames127, align 8, !dbg !2454
  call void @read_table(%struct.AVFormatContext* %124, i32* %126, i32 %128), !dbg !2455
  %129 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2456
  %130 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2457
  %frames_offset_table128 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %130, i32 0, i32 11, !dbg !2458
  %131 = load i32*, i32** %frames_offset_table128, align 8, !dbg !2458
  %132 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2459
  %nb_frames129 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %132, i32 0, i32 2, !dbg !2460
  %133 = load i32, i32* %nb_frames129, align 8, !dbg !2460
  call void @read_table(%struct.AVFormatContext* %129, i32* %131, i32 %133), !dbg !2461
  %134 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2462
  %135 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2463
  %blocks_offset_table130 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %135, i32 0, i32 12, !dbg !2464
  %136 = load i32*, i32** %blocks_offset_table130, align 8, !dbg !2464
  %137 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2465
  %frame_blks131 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %137, i32 0, i32 1, !dbg !2466
  %138 = load i32, i32* %frame_blks131, align 4, !dbg !2466
  call void @read_table(%struct.AVFormatContext* %134, i32* %136, i32 %138), !dbg !2467
  %139 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2468
  %got_audio = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %139, i32 0, i32 18, !dbg !2469
  store i32 0, i32* %got_audio, align 4, !dbg !2470
  %140 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2471
  %current_frame = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %140, i32 0, i32 7, !dbg !2472
  store i32 0, i32* %current_frame, align 4, !dbg !2473
  %141 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2474
  %current_frame_block = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %141, i32 0, i32 9, !dbg !2475
  store i32 0, i32* %current_frame_block, align 4, !dbg !2476
  %142 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2477
  %143 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2478
  %start_offset132 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %143, i32 0, i32 3, !dbg !2479
  %144 = load i32, i32* %start_offset132, align 4, !dbg !2479
  %conv133 = zext i32 %144 to i64, !dbg !2478
  %call134 = call i64 @avio_seek(%struct.AVIOContext* %142, i64 %conv133, i32 0), !dbg !2480
  store i32 0, i32* %retval, align 4, !dbg !2481
  br label %return, !dbg !2481

fail:                                             ; preds = %if.then121
  %145 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2482
  %call135 = call i32 @read_close(%struct.AVFormatContext* %145), !dbg !2483
  %146 = load i32, i32* %ret, align 4, !dbg !2484
  store i32 %146, i32* %retval, align 4, !dbg !2485
  br label %return, !dbg !2485

return:                                           ; preds = %fail, %if.end122, %if.then76, %if.then15, %if.then
  %147 = load i32, i32* %retval, align 4, !dbg !2486
  ret i32 %147, !dbg !2486
}

; Function Attrs: nounwind uwtable
define internal i32 @read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2487 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2490, metadata !2143), !dbg !2491
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2492, metadata !2143), !dbg !2493
  call void @llvm.dbg.declare(metadata %struct.PAFDemuxContext** %p, metadata !2494, metadata !2143), !dbg !2495
  ...
  %2 = bitcast i8* %1 to %struct.PAFDemuxContext*, !dbg !2496
  store %struct.PAFDemuxContext* %2, %struct.PAFDemuxContext** %p, align 8, !dbg !2495
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2498, metadata !2143), !dbg !2499
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2500
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %3, i32 0, i32 4, !dbg !2501
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2501
  store %struct.AVIOContext* %4, %struct.AVIOContext** %pb, align 8, !dbg !2499
  call void @llvm.dbg.declare(metadata i32* %count, metadata !2502, metadata !2143), !dbg !2503
  call void @llvm.dbg.declare(metadata i32* %offset, metadata !2504, metadata !2143), !dbg !2505
  call void @llvm.dbg.declare(metadata i32* %size, metadata !2506, metadata !2143), !dbg !2507
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2508, metadata !2143), !dbg !2509
  %5 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2510
  %current_frame = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %5, i32 0, i32 7, !dbg !2512
  %6 = load i32, i32* %current_frame, align 4, !dbg !2512
  %7 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2513
  %nb_frames = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %7, i32 0, i32 2, !dbg !2514
  %8 = load i32, i32* %nb_frames, align 8, !dbg !2514
  %cmp = icmp uge i32 %6, %8, !dbg !2515
  br i1 %cmp, label %if.then, label %if.end, !dbg !2516

if.then:                                          ; preds = %entry
  store i32 -541478725, i32* %retval, align 4, !dbg !2517
  br label %return, !dbg !2517

if.end:                                           ; preds = %entry
  %9 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2518
  %call = call i32 @avio_feof(%struct.AVIOContext* %9), !dbg !2520
  %tobool = icmp ne i32 %call, 0, !dbg !2520
  br i1 %tobool, label %if.then2, label %if.end3, !dbg !2521

if.then2:                                         ; preds = %if.end
  store i32 -541478725, i32* %retval, align 4, !dbg !2522
  br label %return, !dbg !2522

if.end3:                                          ; preds = %if.end
  %10 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2523
  %got_audio = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %10, i32 0, i32 18, !dbg !2525
  %11 = load i32, i32* %got_audio, align 4, !dbg !2525
  %tobool4 = icmp ne i32 %11, 0, !dbg !2523
  br i1 %tobool4, label %if.then5, label %if.end15, !dbg !2526

if.then5:                                         ; preds = %if.end3
  %12 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2527
  %13 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2530
  %audio_size = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %13, i32 0, i32 17, !dbg !2531
  %14 = load i32, i32* %audio_size, align 8, !dbg !2531
  %call6 = call i32 @av_new_packet(%struct.AVPacket* %12, i32 %14), !dbg !2532
  %cmp7 = icmp slt i32 %call6, 0, !dbg !2533
  br i1 %cmp7, label %if.then8, label %if.end9, !dbg !2534

if.then8:                                         ; preds = %if.then5
  store i32 -12, i32* %retval, align 4, !dbg !2535
  br label %return, !dbg !2535

if.end9:                                          ; preds = %if.then5
  %15 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2536
  %data = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %15, i32 0, i32 3, !dbg !2537
  %16 = load i8*, i8** %data, align 8, !dbg !2537
  %17 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2538
  %temp_audio_frame = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %17, i32 0, i32 16, !dbg !2539
  %18 = load i8*, i8** %temp_audio_frame, align 8, !dbg !2539
  %19 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2540
  %audio_size10 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %19, i32 0, i32 17, !dbg !2541
  %20 = load i32, i32* %audio_size10, align 8, !dbg !2541
  %conv = sext i32 %20 to i64, !dbg !2540
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %16, i8* %18, i64 %conv, i32 1, i1 false), !dbg !2542
  %21 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2543
  %audio_size11 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %21, i32 0, i32 17, !dbg !2544
  %22 = load i32, i32* %audio_size11, align 8, !dbg !2544
  %div = sdiv i32 %22, 4922, !dbg !2545
  %mul = mul nsw i32 2205, %div, !dbg !2546
  %conv12 = sext i32 %mul to i64, !dbg !2547
  %23 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2548
  %duration = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %23, i32 0, i32 9, !dbg !2549
  store i64 %conv12, i64* %duration, align 8, !dbg !2550
  %24 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2551
  %flags = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %24, i32 0, i32 6, !dbg !2552
  %25 = load i32, i32* %flags, align 8, !dbg !2553
  %or = or i32 %25, 1, !dbg !2553
  store i32 %or, i32* %flags, align 8, !dbg !2553
  %26 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2554
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %26, i32 0, i32 5, !dbg !2555
  store i32 1, i32* %stream_index, align 4, !dbg !2556
  %27 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2557
  %got_audio13 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %27, i32 0, i32 18, !dbg !2558
  store i32 0, i32* %got_audio13, align 4, !dbg !2559
  %28 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2560
  %size14 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %28, i32 0, i32 4, !dbg !2561
  %29 = load i32, i32* %size14, align 8, !dbg !2561
  store i32 %29, i32* %retval, align 4, !dbg !2562
  br label %return, !dbg !2562

if.end15:                                         ; preds = %if.end3
  %30 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2563
  %current_frame16 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %30, i32 0, i32 7, !dbg !2564
  %31 = load i32, i32* %current_frame16, align 4, !dbg !2564
  %cmp17 = icmp eq i32 %31, 0, !dbg !2565
  br i1 %cmp17, label %cond.true, label %cond.false, !dbg !2566

cond.true:                                        ; preds = %if.end15
  %32 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2567
  %preload_count = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %32, i32 0, i32 4, !dbg !2569
  %33 = load i32, i32* %preload_count, align 8, !dbg !2569
  br label %cond.end, !dbg !2570

cond.false:                                       ; preds = %if.end15
  %34 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2571
  %current_frame19 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %34, i32 0, i32 7, !dbg !2572
  %35 = load i32, i32* %current_frame19, align 4, !dbg !2572
  %sub = sub i32 %35, 1, !dbg !2573
  %idxprom = zext i32 %sub to i64, !dbg !2574
  %36 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2574
  %blocks_count_table = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %36, i32 0, i32 10, !dbg !2575
  %37 = load i32*, i32** %blocks_count_table, align 8, !dbg !2575
  %arrayidx = getelementptr inbounds i32, i32* %37, i64 %idxprom, !dbg !2574
  %38 = load i32, i32* %arrayidx, align 4, !dbg !2574
  br label %cond.end, !dbg !2576

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %33, %cond.true ], [ %38, %cond.false ], !dbg !2578
  store i32 %cond, i32* %count, align 4, !dbg !2580
  store i32 0, i32* %i, align 4, !dbg !2581
  br label %for.cond, !dbg !2583

for.cond:                                         ; preds = %for.inc, %cond.end
  %39 = load i32, i32* %i, align 4, !dbg !2584
  %40 = load i32, i32* %count, align 4, !dbg !2587
  %cmp20 = icmp ult i32 %39, %40, !dbg !2588
  br i1 %cmp20, label %for.body, label %for.end, !dbg !2589

for.body:                                         ; preds = %for.cond
  %41 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2590
  %current_frame_block = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %41, i32 0, i32 9, !dbg !2593
  %42 = load i32, i32* %current_frame_block, align 4, !dbg !2593
  %43 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2594
  %frame_blks = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %43, i32 0, i32 1, !dbg !2595
  %44 = load i32, i32* %frame_blks, align 4, !dbg !2595
  %cmp22 = icmp uge i32 %42, %44, !dbg !2596
  br i1 %cmp22, label %if.then24, label %if.end25, !dbg !2597
...
if.end25:                                         ; preds = %for.body
  %45 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2599
  %current_frame_block26 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %45, i32 0, i32 9, !dbg !2600
  %46 = load i32, i32* %current_frame_block26, align 4, !dbg !2600
  %idxprom27 = zext i32 %46 to i64, !dbg !2601
  %47 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2601
  %blocks_offset_table = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %47, i32 0, i32 12, !dbg !2602
  %48 = load i32*, i32** %blocks_offset_table, align 8, !dbg !2602
  %arrayidx28 = getelementptr inbounds i32, i32* %48, i64 %idxprom27, !dbg !2601
  %49 = load i32, i32* %arrayidx28, align 4, !dbg !2601
  %and = and i32 %49, 2147483647, !dbg !2603
  store i32 %and, i32* %offset, align 4, !dbg !2604
  %50 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2605
  %current_frame_block29 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %50, i32 0, i32 9, !dbg !2607
  %51 = load i32, i32* %current_frame_block29, align 4, !dbg !2607
  %idxprom30 = zext i32 %51 to i64, !dbg !2608
  %52 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2608
  %blocks_offset_table31 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %52, i32 0, i32 12, !dbg !2609
  %53 = load i32*, i32** %blocks_offset_table31, align 8, !dbg !2609
  %arrayidx32 = getelementptr inbounds i32, i32* %53, i64 %idxprom30, !dbg !2608
  %54 = load i32, i32* %arrayidx32, align 4, !dbg !2608
  %and33 = and i32 %54, -2147483648, !dbg !2610
  %tobool34 = icmp ne i32 %and33, 0, !dbg !2610
  br i1 %tobool34, label %if.then35, label %if.else, !dbg !2611

if.then35:                                        ; preds = %if.end25
  %55 = load i32, i32* %offset, align 4, !dbg !2612
  %56 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2615
  %audio_size36 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %56, i32 0, i32 17, !dbg !2616
  %57 = load i32, i32* %audio_size36, align 8, !dbg !2616
  %58 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2617
  %buffer_size = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %58, i32 0, i32 0, !dbg !2618
  %59 = load i32, i32* %buffer_size, align 8, !dbg !2618
  %sub37 = sub i32 %57, %59, !dbg !2619
  %cmp38 = icmp ugt i32 %55, %sub37, !dbg !2620
  br i1 %cmp38, label %if.then40, label %if.end41, !dbg !2621

if.then40:                                        ; preds = %if.then35
  store i32 -1094995529, i32* %retval, align 4, !dbg !2622
  br label %return, !dbg !2622

if.end41:                                         ; preds = %if.then35
  %60 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2623
  %61 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2624
  %audio_frame = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %61, i32 0, i32 15, !dbg !2625
  %62 = load i8*, i8** %audio_frame, align 8, !dbg !2625
  %63 = load i32, i32* %offset, align 4, !dbg !2626
  %idx.ext = zext i32 %63 to i64, !dbg !2627
  %add.ptr = getelementptr inbounds i8, i8* %62, i64 %idx.ext, !dbg !2627
  %64 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2628
  %buffer_size42 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %64, i32 0, i32 0, !dbg !2629
  %65 = load i32, i32* %buffer_size42, align 8, !dbg !2629
  %call43 = call i32 @avio_read(%struct.AVIOContext* %60, i8* %add.ptr, i32 %65), !dbg !2630
  %66 = load i32, i32* %offset, align 4, !dbg !2631
  %67 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2633
  %max_audio_blks = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %67, i32 0, i32 6, !dbg !2634
  %68 = load i32, i32* %max_audio_blks, align 8, !dbg !2634
  %sub44 = sub i32 %68, 2, !dbg !2635
  %69 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2636
  %buffer_size45 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %69, i32 0, i32 0, !dbg !2637
  %70 = load i32, i32* %buffer_size45, align 8, !dbg !2637
  %mul46 = mul i32 %sub44, %70, !dbg !2638
  %cmp47 = icmp eq i32 %66, %mul46, !dbg !2639
  br i1 %cmp47, label %if.then49, label %if.end55, !dbg !2640

if.then49:                                        ; preds = %if.end41
  %71 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2641
  %temp_audio_frame50 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %71, i32 0, i32 16, !dbg !2643
  %72 = load i8*, i8** %temp_audio_frame50, align 8, !dbg !2643
  %73 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2644
  %audio_frame51 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %73, i32 0, i32 15, !dbg !2645
  %74 = load i8*, i8** %audio_frame51, align 8, !dbg !2645
  %75 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2646
  %audio_size52 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %75, i32 0, i32 17, !dbg !2647
  %76 = load i32, i32* %audio_size52, align 8, !dbg !2647
  %conv53 = sext i32 %76 to i64, !dbg !2646
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %72, i8* %74, i64 %conv53, i32 1, i1 false), !dbg !2648
  %77 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2649
  %got_audio54 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %77, i32 0, i32 18, !dbg !2650
  store i32 1, i32* %got_audio54, align 4, !dbg !2651
  br label %if.end55, !dbg !2652

if.end55:                                         ; preds = %if.then49, %if.end41
  br label %if.end66, !dbg !2653

if.else:                                          ; preds = %if.end25
  %78 = load i32, i32* %offset, align 4, !dbg !2654
  %79 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2657
  %video_size = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %79, i32 0, i32 14, !dbg !2658
  %80 = load i32, i32* %video_size, align 8, !dbg !2658
  %81 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2659
  %buffer_size56 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %81, i32 0, i32 0, !dbg !2660
  %82 = load i32, i32* %buffer_size56, align 8, !dbg !2660
  %sub57 = sub i32 %80, %82, !dbg !2661
  %cmp58 = icmp ugt i32 %78, %sub57, !dbg !2662
  br i1 %cmp58, label %if.then60, label %if.end61, !dbg !2663
...
if.end61:                                         ; preds = %if.else
  %83 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2665
  %84 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2666
  %video_frame = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %84, i32 0, i32 13, !dbg !2667
  %85 = load i8*, i8** %video_frame, align 8, !dbg !2667
  %86 = load i32, i32* %offset, align 4, !dbg !2668
  %idx.ext62 = zext i32 %86 to i64, !dbg !2669
  %add.ptr63 = getelementptr inbounds i8, i8* %85, i64 %idx.ext62, !dbg !2669
  %87 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2670
  %buffer_size64 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %87, i32 0, i32 0, !dbg !2671
  %88 = load i32, i32* %buffer_size64, align 8, !dbg !2671
  %call65 = call i32 @avio_read(%struct.AVIOContext* %83, i8* %add.ptr63, i32 %88), !dbg !2672
  br label %if.end66

if.end66:                                         ; preds = %if.end61, %if.end55
  %89 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2673
  %current_frame_block67 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %89, i32 0, i32 9, !dbg !2674
  %90 = load i32, i32* %current_frame_block67, align 4, !dbg !2675
  %inc = add i32 %90, 1, !dbg !2675
  store i32 %inc, i32* %current_frame_block67, align 4, !dbg !2675
  br label %for.inc, !dbg !2676

for.inc:                                          ; preds = %if.end66
  %91 = load i32, i32* %i, align 4, !dbg !2677
  %inc68 = add nsw i32 %91, 1, !dbg !2677
  store i32 %inc68, i32* %i, align 4, !dbg !2677
  br label %for.cond, !dbg !2679, !llvm.loop !2680

for.end:                                          ; preds = %for.cond
  %92 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2682
  %current_frame69 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %92, i32 0, i32 7, !dbg !2684
  %93 = load i32, i32* %current_frame69, align 4, !dbg !2684
  %idxprom70 = zext i32 %93 to i64, !dbg !2685
  %94 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2685
  %frames_offset_table = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %94, i32 0, i32 11, !dbg !2686
  %95 = load i32*, i32** %frames_offset_table, align 8, !dbg !2686
  %arrayidx71 = getelementptr inbounds i32, i32* %95, i64 %idxprom70, !dbg !2685
  %96 = load i32, i32* %arrayidx71, align 4, !dbg !2685
  %97 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2687
  %video_size72 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %97, i32 0, i32 14, !dbg !2688
  %98 = load i32, i32* %video_size72, align 8, !dbg !2688
  %cmp73 = icmp uge i32 %96, %98, !dbg !2689
  br i1 %cmp73, label %if.then75, label %if.end76, !dbg !2690
...
if.end76:                                         ; preds = %for.end
  %99 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2692
  %video_size77 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %99, i32 0, i32 14, !dbg !2693
  %100 = load i32, i32* %video_size77, align 8, !dbg !2693
  %101 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2694
  %current_frame78 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %101, i32 0, i32 7, !dbg !2695
  %102 = load i32, i32* %current_frame78, align 4, !dbg !2695
  %idxprom79 = zext i32 %102 to i64, !dbg !2696
  %103 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2696
  %frames_offset_table80 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %103, i32 0, i32 11, !dbg !2697
  %104 = load i32*, i32** %frames_offset_table80, align 8, !dbg !2697
  %arrayidx81 = getelementptr inbounds i32, i32* %104, i64 %idxprom79, !dbg !2696
  %105 = load i32, i32* %arrayidx81, align 4, !dbg !2696
  %sub82 = sub i32 %100, %105, !dbg !2698
  store i32 %sub82, i32* %size, align 4, !dbg !2699
  %106 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2700
  %107 = load i32, i32* %size, align 4, !dbg !2702
  %call83 = call i32 @av_new_packet(%struct.AVPacket* %106, i32 %107), !dbg !2703
  %cmp84 = icmp slt i32 %call83, 0, !dbg !2704
  br i1 %cmp84, label %if.then86, label %if.end87, !dbg !2705
...
if.end87:                                         ; preds = %if.end76
  %108 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2707
  %stream_index88 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %108, i32 0, i32 5, !dbg !2708
  store i32 0, i32* %stream_index88, align 4, !dbg !2709
  %109 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2710
  %duration89 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %109, i32 0, i32 9, !dbg !2711
  store i64 1, i64* %duration89, align 8, !dbg !2712
  %110 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2713
  %data90 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %110, i32 0, i32 3, !dbg !2714
  %111 = load i8*, i8** %data90, align 8, !dbg !2714
  %112 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2715
  %video_frame91 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %112, i32 0, i32 13, !dbg !2716
  %113 = load i8*, i8** %video_frame91, align 8, !dbg !2716
  %114 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2717
  %current_frame92 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %114, i32 0, i32 7, !dbg !2718
  %115 = load i32, i32* %current_frame92, align 4, !dbg !2718
  %idxprom93 = zext i32 %115 to i64, !dbg !2719
  %116 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2719
  %frames_offset_table94 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %116, i32 0, i32 11, !dbg !2720
  %117 = load i32*, i32** %frames_offset_table94, align 8, !dbg !2720
  %arrayidx95 = getelementptr inbounds i32, i32* %117, i64 %idxprom93, !dbg !2719
  %118 = load i32, i32* %arrayidx95, align 4, !dbg !2719
  %idx.ext96 = zext i32 %118 to i64, !dbg !2721
  %add.ptr97 = getelementptr inbounds i8, i8* %113, i64 %idx.ext96, !dbg !2721
  %119 = load i32, i32* %size, align 4, !dbg !2722
  %conv98 = sext i32 %119 to i64, !dbg !2722
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %111, i8* %add.ptr97, i64 %conv98, i32 1, i1 false), !dbg !2723
  %120 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2724
  %data99 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %120, i32 0, i32 3, !dbg !2726
  %121 = load i8*, i8** %data99, align 8, !dbg !2726
  %arrayidx100 = getelementptr inbounds i8, i8* %121, i64 0, !dbg !2724
  %122 = load i8, i8* %arrayidx100, align 1, !dbg !2724
  %conv101 = zext i8 %122 to i32, !dbg !2724
  %and102 = and i32 %conv101, 32, !dbg !2727
  %tobool103 = icmp ne i32 %and102, 0, !dbg !2727
  br i1 %tobool103, label %if.then104, label %if.end107, !dbg !2728

if.then104:                                       ; preds = %if.end87
  %123 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2729
  %flags105 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %123, i32 0, i32 6, !dbg !2730
  %124 = load i32, i32* %flags105, align 8, !dbg !2731
  %or106 = or i32 %124, 1, !dbg !2731
  store i32 %or106, i32* %flags105, align 8, !dbg !2731
  br label %if.end107, !dbg !2729

if.end107:                                        ; preds = %if.then104, %if.end87
  %125 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2732
  %current_frame108 = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %125, i32 0, i32 7, !dbg !2733
  %126 = load i32, i32* %current_frame108, align 4, !dbg !2734
  %inc109 = add i32 %126, 1, !dbg !2734
  store i32 %inc109, i32* %current_frame108, align 4, !dbg !2734
  %127 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2735
  %size110 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %127, i32 0, i32 4, !dbg !2736
  %128 = load i32, i32* %size110, align 8, !dbg !2736
  store i32 %128, i32* %retval, align 4, !dbg !2737
  br label %return, !dbg !2737

return:                                           ; preds = %if.end107, %if.then86, %if.then75, %if.then60, %if.then40, %if.then24, %if.end9, %if.then8, %if.then2, %if.then
  %129 = load i32, i32* %retval, align 4, !dbg !2738
  ret i32 %129, !dbg !2738
}

; Function Attrs: nounwind uwtable
define internal i32 @read_close(%struct.AVFormatContext* %s) #0 !dbg !2739 {
entry:
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %p = alloca %struct.PAFDemuxContext*, align 8
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2740, metadata !2143), !dbg !2741
  call void @llvm.dbg.declare(metadata %struct.PAFDemuxContext** %p, metadata !2742, metadata !2143), !dbg !2743
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2744
  %priv_data = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 3, !dbg !2745
  %1 = load i8*, i8** %priv_data, align 8, !dbg !2745
  %2 = bitcast i8* %1 to %struct.PAFDemuxContext*, !dbg !2744
  store %struct.PAFDemuxContext* %2, %struct.PAFDemuxContext** %p, align 8, !dbg !2743
  %3 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2746
  %blocks_count_table = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %3, i32 0, i32 10, !dbg !2747
  %4 = bitcast i32** %blocks_count_table to i8*, !dbg !2748
  call void @av_freep(i8* %4), !dbg !2749
  %5 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2750
  %frames_offset_table = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %5, i32 0, i32 11, !dbg !2751
  %6 = bitcast i32** %frames_offset_table to i8*, !dbg !2752
  call void @av_freep(i8* %6), !dbg !2753
  %7 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2754
  %blocks_offset_table = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %7, i32 0, i32 12, !dbg !2755
  %8 = bitcast i32** %blocks_offset_table to i8*, !dbg !2756
  call void @av_freep(i8* %8), !dbg !2757
  %9 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2758
  %video_frame = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %9, i32 0, i32 13, !dbg !2759
  %10 = bitcast i8** %video_frame to i8*, !dbg !2760
  call void @av_freep(i8* %10), !dbg !2761
  %11 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2762
  %audio_frame = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %11, i32 0, i32 15, !dbg !2763
  %12 = bitcast i8** %audio_frame to i8*, !dbg !2764
  call void @av_freep(i8* %12), !dbg !2765
  %13 = load %struct.PAFDemuxContext*, %struct.PAFDemuxContext** %p, align 8, !dbg !2766
  %temp_audio_frame = getelementptr inbounds %struct.PAFDemuxContext, %struct.PAFDemuxContext* %13, i32 0, i32 16, !dbg !2767
  %14 = bitcast i8** %temp_audio_frame to i8*, !dbg !2768
  call void @av_freep(i8* %14), !dbg !2769
  ret i32 0, !dbg !2770
}
...
; Function Attrs: nounwind uwtable
define internal void @read_table(%struct.AVFormatContext* %s, i32* %table, i32 %count) #0 !dbg !2771 {
entry:
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  %i = alloca i32, align 4
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2774, metadata !2143), !dbg !2775
  store i32* %table, i32** %table.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %table.addr, metadata !2776, metadata !2143), !dbg !2777
  store i32 %count, i32* %count.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %count.addr, metadata !2778, metadata !2143), !dbg !2779
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2780, metadata !2143), !dbg !2781
  store i32 0, i32* %i, align 4, !dbg !2782
  br label %for.cond, !dbg !2784

for.cond:                                         ; preds = %for.inc, %entry
  %0 = load i32, i32* %i, align 4, !dbg !2785
  %1 = load i32, i32* %count.addr, align 4, !dbg !2788
  %cmp = icmp ult i32 %0, %1, !dbg !2789
  br i1 %cmp, label %for.body, label %for.end, !dbg !2790

for.body:                                         ; preds = %for.cond
  %2 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2791
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %2, i32 0, i32 4, !dbg !2792
  %3 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2792
  %call = call i32 @avio_rl32(%struct.AVIOContext* %3), !dbg !2793
  %4 = load i32, i32* %i, align 4, !dbg !2794
  %idxprom = sext i32 %4 to i64, !dbg !2795
  %5 = load i32*, i32** %table.addr, align 8, !dbg !2795
  %arrayidx = getelementptr inbounds i32, i32* %5, i64 %idxprom, !dbg !2795
  store i32 %call, i32* %arrayidx, align 4, !dbg !2796
  br label %for.inc, !dbg !2795

for.inc:                                          ; preds = %for.body
  %6 = load i32, i32* %i, align 4, !dbg !2797
  %inc = add nsw i32 %6, 1, !dbg !2797
  store i32 %inc, i32* %i, align 4, !dbg !2797
  br label %for.cond, !dbg !2799, !llvm.loop !2800

for.end:                                          ; preds = %for.cond
  %7 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2802
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %7, i32 0, i32 4, !dbg !2803
  %8 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2803
  %9 = load i32, i32* %count.addr, align 4, !dbg !2804
  %add = add i32 %9, 512, !dbg !2805
  %sub = sub i32 %add, 1, !dbg !2806
  %and = and i32 %sub, -512, !dbg !2807
  %10 = load i32, i32* %count.addr, align 4, !dbg !2808
  %sub2 = sub i32 %and, %10, !dbg !2809
  %mul = mul i32 4, %sub2, !dbg !2810
  %conv = zext i32 %mul to i64, !dbg !2811
  %call3 = call i64 @avio_skip(%struct.AVIOContext* %8, i64 %conv), !dbg !2812
  ret void, !dbg !2813
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--paf.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!919 = !{!920}
!920 = distinct !DIGlobalVariable(name: "ff_paf_demuxer", scope: !0, file: !921, line: 260, type: !922, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_paf_demuxer)
!921 = !DIFile(filename: "libavformat/paf.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2140 = distinct !DISubprogram(name: "read_probe", scope: !921, file: !921, line: 56, type: !991, isLocal: true, isDefinition: true, scopeLine: 57, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2141 = !{}
!2142 = !DILocalVariable(name: "p", arg: 1, scope: !2140, file: !921, line: 56, type: !993)
!2143 = !DIExpression()
!2144 = !DILocation(line: 56, column: 36, scope: !2140)
!2145 = !DILocation(line: 58, column: 10, scope: !2146)
!2146 = distinct !DILexicalBlock(scope: !2140, file: !921, line: 58, column: 9)
!2147 = !DILocation(line: 58, column: 13, scope: !2146)
!2148 = !DILocation(line: 58, column: 22, scope: !2146)
!2149 = !DILocation(line: 58, column: 99, scope: !2146)
!2150 = !DILocation(line: 59, column: 17, scope: !2146)
!2151 = !DILocation(line: 59, column: 20, scope: !2146)
!2152 = !DILocation(line: 59, column: 10, scope: !2146)
!2153 = !DILocation(line: 58, column: 9, scope: !2154)
!2154 = !DILexicalBlockFile(scope: !2140, file: !921, discriminator: 1)
!2155 = !DILocation(line: 60, column: 9, scope: !2146)
!2156 = !DILocation(line: 61, column: 5, scope: !2140)
!2157 = !DILocation(line: 62, column: 1, scope: !2140)
!2158 = distinct !DISubprogram(name: "read_header", scope: !921, file: !921, line: 88, type: !2159, isLocal: true, isDefinition: true, scopeLine: 89, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
...
!2163 = !DILocalVariable(name: "s", arg: 1, scope: !2158, file: !921, line: 88, type: !2161)
!2164 = !DILocation(line: 88, column: 41, scope: !2158)
!2165 = !DILocalVariable(name: "p", scope: !2158, file: !921, line: 90, type: !2166)
!2166 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2167, size: 64, align: 64)
!2167 = !DIDerivedType(tag: DW_TAG_typedef, name: "PAFDemuxContext", file: !921, line: 54, baseType: !2168)
!2168 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "PAFDemuxContext", file: !921, line: 29, size: 832, align: 64, elements: !2169)
!2169 = !{!2170, !2171, !2172, !2173, !2174, !2175, !2176, !2177, !2178, !2179, !2180, !2182, !2183, !2184, !2185, !2186, !2187, !2188, !2189}
!2170 = !DIDerivedType(tag: DW_TAG_member, name: "buffer_size", scope: !2168, file: !921, line: 30, baseType: !1368, size: 32, align: 32)
!2171 = !DIDerivedType(tag: DW_TAG_member, name: "frame_blks", scope: !2168, file: !921, line: 31, baseType: !1368, size: 32, align: 32, offset: 32)
!2172 = !DIDerivedType(tag: DW_TAG_member, name: "nb_frames", scope: !2168, file: !921, line: 32, baseType: !1368, size: 32, align: 32, offset: 64)
!2173 = !DIDerivedType(tag: DW_TAG_member, name: "start_offset", scope: !2168, file: !921, line: 33, baseType: !1368, size: 32, align: 32, offset: 96)
!2174 = !DIDerivedType(tag: DW_TAG_member, name: "preload_count", scope: !2168, file: !921, line: 34, baseType: !1368, size: 32, align: 32, offset: 128)
!2175 = !DIDerivedType(tag: DW_TAG_member, name: "max_video_blks", scope: !2168, file: !921, line: 35, baseType: !1368, size: 32, align: 32, offset: 160)
!2176 = !DIDerivedType(tag: DW_TAG_member, name: "max_audio_blks", scope: !2168, file: !921, line: 36, baseType: !1368, size: 32, align: 32, offset: 192)
!2177 = !DIDerivedType(tag: DW_TAG_member, name: "current_frame", scope: !2168, file: !921, line: 38, baseType: !1368, size: 32, align: 32, offset: 224)
!2178 = !DIDerivedType(tag: DW_TAG_member, name: "current_frame_count", scope: !2168, file: !921, line: 39, baseType: !1368, size: 32, align: 32, offset: 256)
!2179 = !DIDerivedType(tag: DW_TAG_member, name: "current_frame_block", scope: !2168, file: !921, line: 40, baseType: !1368, size: 32, align: 32, offset: 288)
!2180 = !DIDerivedType(tag: DW_TAG_member, name: "blocks_count_table", scope: !2168, file: !921, line: 42, baseType: !2181, size: 64, align: 64, offset: 320)
!2181 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1368, size: 64, align: 64)
!2182 = !DIDerivedType(tag: DW_TAG_member, name: "frames_offset_table", scope: !2168, file: !921, line: 43, baseType: !2181, size: 64, align: 64, offset: 384)
!2183 = !DIDerivedType(tag: DW_TAG_member, name: "blocks_offset_table", scope: !2168, file: !921, line: 44, baseType: !2181, size: 64, align: 64, offset: 448)
!2184 = !DIDerivedType(tag: DW_TAG_member, name: "video_frame", scope: !2168, file: !921, line: 46, baseType: !1048, size: 64, align: 64, offset: 512)
!2185 = !DIDerivedType(tag: DW_TAG_member, name: "video_size", scope: !2168, file: !921, line: 47, baseType: !917, size: 32, align: 32, offset: 576)
!2186 = !DIDerivedType(tag: DW_TAG_member, name: "audio_frame", scope: !2168, file: !921, line: 49, baseType: !1048, size: 64, align: 64, offset: 640)
!2187 = !DIDerivedType(tag: DW_TAG_member, name: "temp_audio_frame", scope: !2168, file: !921, line: 50, baseType: !1048, size: 64, align: 64, offset: 704)
!2188 = !DIDerivedType(tag: DW_TAG_member, name: "audio_size", scope: !2168, file: !921, line: 51, baseType: !917, size: 32, align: 32, offset: 768)
!2189 = !DIDerivedType(tag: DW_TAG_member, name: "got_audio", scope: !2168, file: !921, line: 53, baseType: !917, size: 32, align: 32, offset: 800)
!2190 = !DILocation(line: 90, column: 22, scope: !2158)
!2191 = !DILocation(line: 90, column: 26, scope: !2158)
!2192 = !DILocation(line: 90, column: 29, scope: !2158)
!2193 = !DILocalVariable(name: "pb", scope: !2158, file: !921, line: 91, type: !1215)
!2194 = !DILocation(line: 91, column: 18, scope: !2158)
!2195 = !DILocation(line: 91, column: 23, scope: !2158)
!2196 = !DILocation(line: 91, column: 26, scope: !2158)
!2197 = !DILocalVariable(name: "ast", scope: !2158, file: !921, line: 92, type: !1283)
!2198 = !DILocation(line: 92, column: 15, scope: !2158)
!2199 = !DILocalVariable(name: "vst", scope: !2158, file: !921, line: 92, type: !1283)
!2200 = !DILocation(line: 92, column: 21, scope: !2158)
!2201 = !DILocalVariable(name: "ret", scope: !2158, file: !921, line: 93, type: !917)
!2202 = !DILocation(line: 93, column: 9, scope: !2158)
!2203 = !DILocation(line: 95, column: 15, scope: !2158)
!2204 = !DILocation(line: 95, column: 5, scope: !2158)
!2205 = !DILocation(line: 97, column: 31, scope: !2158)
!2206 = !DILocation(line: 97, column: 11, scope: !2158)
!2207 = !DILocation(line: 97, column: 9, scope: !2158)
!2208 = !DILocation(line: 98, column: 10, scope: !2209)
!2209 = distinct !DILexicalBlock(scope: !2158, file: !921, line: 98, column: 9)
!2210 = !DILocation(line: 98, column: 9, scope: !2158)
!2211 = !DILocation(line: 99, column: 9, scope: !2209)
!2212 = !DILocation(line: 101, column: 5, scope: !2158)
!2213 = !DILocation(line: 101, column: 10, scope: !2158)
!2214 = !DILocation(line: 101, column: 21, scope: !2158)
!2215 = !DILocation(line: 104, column: 30, scope: !2158)
!2216 = !DILocation(line: 104, column: 20, scope: !2158)
!2217 = !DILocation(line: 104, column: 5, scope: !2158)
!2218 = !DILocation(line: 104, column: 8, scope: !2158)
!2219 = !DILocation(line: 104, column: 18, scope: !2158)
!2220 = !DILocation(line: 103, column: 5, scope: !2158)
!2221 = !DILocation(line: 103, column: 10, scope: !2158)
!2222 = !DILocation(line: 103, column: 19, scope: !2158)
!2223 = !DILocation(line: 102, column: 5, scope: !2158)
!2224 = !DILocation(line: 102, column: 10, scope: !2158)
!2225 = !DILocation(line: 102, column: 20, scope: !2158)
!2226 = !DILocation(line: 105, column: 15, scope: !2158)
!2227 = !DILocation(line: 105, column: 5, scope: !2158)
!2228 = !DILocation(line: 107, column: 38, scope: !2158)
!2229 = !DILocation(line: 107, column: 28, scope: !2158)
!2230 = !DILocation(line: 107, column: 5, scope: !2158)
!2231 = !DILocation(line: 107, column: 10, scope: !2158)
!2232 = !DILocation(line: 107, column: 20, scope: !2158)
!2233 = !DILocation(line: 107, column: 26, scope: !2158)
!2234 = !DILocation(line: 108, column: 39, scope: !2158)
!2235 = !DILocation(line: 108, column: 29, scope: !2158)
!2236 = !DILocation(line: 108, column: 5, scope: !2158)
!2237 = !DILocation(line: 108, column: 10, scope: !2158)
!2238 = !DILocation(line: 108, column: 20, scope: !2158)
!2239 = !DILocation(line: 108, column: 27, scope: !2158)
!2240 = !DILocation(line: 109, column: 15, scope: !2158)
!2241 = !DILocation(line: 109, column: 5, scope: !2158)
!2242 = !DILocation(line: 111, column: 5, scope: !2158)
!2243 = !DILocation(line: 111, column: 10, scope: !2158)
!2244 = !DILocation(line: 111, column: 20, scope: !2158)
!2245 = !DILocation(line: 111, column: 31, scope: !2158)
!2246 = !DILocation(line: 112, column: 5, scope: !2158)
!2247 = !DILocation(line: 112, column: 10, scope: !2158)
!2248 = !DILocation(line: 112, column: 20, scope: !2158)
!2249 = !DILocation(line: 112, column: 30, scope: !2158)
!2250 = !DILocation(line: 113, column: 5, scope: !2158)
!2251 = !DILocation(line: 113, column: 10, scope: !2158)
!2252 = !DILocation(line: 113, column: 20, scope: !2158)
!2253 = !DILocation(line: 113, column: 29, scope: !2158)
!2254 = !DILocation(line: 114, column: 25, scope: !2158)
!2255 = !DILocation(line: 114, column: 5, scope: !2158)
!2256 = !DILocation(line: 116, column: 31, scope: !2158)
!2257 = !DILocation(line: 116, column: 11, scope: !2158)
!2258 = !DILocation(line: 116, column: 9, scope: !2158)
!2259 = !DILocation(line: 117, column: 10, scope: !2260)
!2260 = distinct !DILexicalBlock(scope: !2158, file: !921, line: 117, column: 9)
!2261 = !DILocation(line: 117, column: 9, scope: !2158)
!2262 = !DILocation(line: 118, column: 9, scope: !2260)
!2263 = !DILocation(line: 120, column: 5, scope: !2158)
!2264 = !DILocation(line: 120, column: 10, scope: !2158)
!2265 = !DILocation(line: 120, column: 21, scope: !2158)
!2266 = !DILocation(line: 121, column: 5, scope: !2158)
!2267 = !DILocation(line: 121, column: 10, scope: !2158)
!2268 = !DILocation(line: 121, column: 20, scope: !2158)
!2269 = !DILocation(line: 121, column: 31, scope: !2158)
!2270 = !DILocation(line: 122, column: 5, scope: !2158)
!2271 = !DILocation(line: 122, column: 10, scope: !2158)
!2272 = !DILocation(line: 122, column: 20, scope: !2158)
!2273 = !DILocation(line: 122, column: 30, scope: !2158)
!2274 = !DILocation(line: 123, column: 5, scope: !2158)
!2275 = !DILocation(line: 123, column: 10, scope: !2158)
!2276 = !DILocation(line: 123, column: 20, scope: !2158)
!2277 = !DILocation(line: 123, column: 29, scope: !2158)
!2278 = !DILocation(line: 124, column: 5, scope: !2158)
!2279 = !DILocation(line: 124, column: 10, scope: !2158)
!2280 = !DILocation(line: 124, column: 20, scope: !2158)
!2281 = !DILocation(line: 124, column: 29, scope: !2158)
!2282 = !DILocation(line: 125, column: 5, scope: !2158)
!2283 = !DILocation(line: 125, column: 10, scope: !2158)
!2284 = !DILocation(line: 125, column: 20, scope: !2158)
!2285 = !DILocation(line: 125, column: 35, scope: !2158)
!2286 = !DILocation(line: 126, column: 5, scope: !2158)
!2287 = !DILocation(line: 126, column: 10, scope: !2158)
!2288 = !DILocation(line: 126, column: 20, scope: !2158)
!2289 = !DILocation(line: 126, column: 32, scope: !2158)
!2290 = !DILocation(line: 127, column: 25, scope: !2158)
!2291 = !DILocation(line: 127, column: 5, scope: !2158)
!2292 = !DILocation(line: 129, column: 32, scope: !2158)
!2293 = !DILocation(line: 129, column: 22, scope: !2158)
!2294 = !DILocation(line: 129, column: 5, scope: !2158)
!2295 = !DILocation(line: 129, column: 8, scope: !2158)
!2296 = !DILocation(line: 129, column: 20, scope: !2158)
!2297 = !DILocation(line: 130, column: 34, scope: !2158)
!2298 = !DILocation(line: 130, column: 24, scope: !2158)
!2299 = !DILocation(line: 130, column: 5, scope: !2158)
!2300 = !DILocation(line: 130, column: 8, scope: !2158)
!2301 = !DILocation(line: 130, column: 22, scope: !2158)
!2302 = !DILocation(line: 131, column: 31, scope: !2158)
!2303 = !DILocation(line: 131, column: 21, scope: !2158)
!2304 = !DILocation(line: 131, column: 5, scope: !2158)
!2305 = !DILocation(line: 131, column: 8, scope: !2158)
!2306 = !DILocation(line: 131, column: 19, scope: !2158)
!2307 = !DILocation(line: 132, column: 33, scope: !2158)
!2308 = !DILocation(line: 132, column: 23, scope: !2158)
!2309 = !DILocation(line: 132, column: 5, scope: !2158)
!2310 = !DILocation(line: 132, column: 8, scope: !2158)
!2311 = !DILocation(line: 132, column: 21, scope: !2158)
!2312 = !DILocation(line: 133, column: 35, scope: !2158)
!2313 = !DILocation(line: 133, column: 25, scope: !2158)
!2314 = !DILocation(line: 133, column: 5, scope: !2158)
!2315 = !DILocation(line: 133, column: 8, scope: !2158)
!2316 = !DILocation(line: 133, column: 23, scope: !2158)
!2317 = !DILocation(line: 134, column: 35, scope: !2158)
!2318 = !DILocation(line: 134, column: 25, scope: !2158)
!2319 = !DILocation(line: 134, column: 5, scope: !2158)
!2320 = !DILocation(line: 134, column: 8, scope: !2158)
!2321 = !DILocation(line: 134, column: 23, scope: !2158)
!2322 = !DILocation(line: 135, column: 9, scope: !2323)
!2323 = distinct !DILexicalBlock(scope: !2158, file: !921, line: 135, column: 9)
!2324 = !DILocation(line: 135, column: 12, scope: !2323)
!2325 = !DILocation(line: 135, column: 24, scope: !2323)
!2326 = !DILocation(line: 135, column: 30, scope: !2323)
!2327 = !DILocation(line: 136, column: 9, scope: !2323)
!2328 = !DILocation(line: 136, column: 12, scope: !2323)
!2329 = !DILocation(line: 136, column: 27, scope: !2323)
!2330 = !DILocation(line: 136, column: 31, scope: !2323)
!2331 = !DILocation(line: 137, column: 9, scope: !2323)
!2332 = !DILocation(line: 137, column: 12, scope: !2323)
!2333 = !DILocation(line: 137, column: 27, scope: !2323)
!2334 = !DILocation(line: 137, column: 31, scope: !2323)
!2335 = !DILocation(line: 138, column: 9, scope: !2323)
!2336 = !DILocation(line: 138, column: 12, scope: !2323)
!2337 = !DILocation(line: 138, column: 23, scope: !2323)
!2338 = !DILocation(line: 138, column: 27, scope: !2323)
!2339 = !DILocation(line: 139, column: 9, scope: !2323)
!2340 = !DILocation(line: 139, column: 12, scope: !2323)
!2341 = !DILocation(line: 139, column: 22, scope: !2323)
!2342 = !DILocation(line: 139, column: 26, scope: !2323)
!2343 = !DILocation(line: 140, column: 9, scope: !2323)
!2344 = !DILocation(line: 140, column: 12, scope: !2323)
!2345 = !DILocation(line: 140, column: 26, scope: !2323)
!2346 = !DILocation(line: 140, column: 30, scope: !2323)
!2347 = !DILocation(line: 141, column: 9, scope: !2323)
!2348 = !DILocation(line: 141, column: 12, scope: !2323)
!2349 = !DILocation(line: 141, column: 24, scope: !2323)
!2350 = !DILocation(line: 141, column: 31, scope: !2323)
!2351 = !DILocation(line: 142, column: 9, scope: !2323)
!2352 = !DILocation(line: 142, column: 12, scope: !2323)
!2353 = !DILocation(line: 142, column: 27, scope: !2323)
!2354 = !DILocation(line: 142, column: 34, scope: !2323)
!2355 = !DILocation(line: 143, column: 9, scope: !2323)
!2356 = !DILocation(line: 143, column: 12, scope: !2323)
!2357 = !DILocation(line: 143, column: 27, scope: !2323)
!2358 = !DILocation(line: 143, column: 34, scope: !2323)
!2359 = !DILocation(line: 144, column: 9, scope: !2323)
!2360 = !DILocation(line: 144, column: 12, scope: !2323)
!2361 = !DILocation(line: 144, column: 22, scope: !2323)
!2362 = !DILocation(line: 144, column: 54, scope: !2323)
!2363 = !DILocation(line: 145, column: 9, scope: !2323)
!2364 = !DILocation(line: 145, column: 12, scope: !2323)
!2365 = !DILocation(line: 145, column: 23, scope: !2323)
!2366 = !DILocation(line: 135, column: 9, scope: !2367)
!2367 = !DILexicalBlockFile(scope: !2158, file: !921, discriminator: 1)
!2368 = !DILocation(line: 146, column: 9, scope: !2323)
!2369 = !DILocation(line: 148, column: 40, scope: !2158)
!2370 = !DILocation(line: 148, column: 43, scope: !2158)
!2371 = !DILocation(line: 148, column: 53, scope: !2158)
!2372 = !DILocation(line: 148, column: 29, scope: !2158)
!2373 = !DILocation(line: 148, column: 5, scope: !2158)
!2374 = !DILocation(line: 148, column: 8, scope: !2158)
!2375 = !DILocation(line: 148, column: 27, scope: !2158)
!2376 = !DILocation(line: 150, column: 41, scope: !2158)
!2377 = !DILocation(line: 150, column: 44, scope: !2158)
!2378 = !DILocation(line: 150, column: 54, scope: !2158)
!2379 = !DILocation(line: 150, column: 30, scope: !2158)
!2380 = !DILocation(line: 150, column: 5, scope: !2158)
!2381 = !DILocation(line: 150, column: 8, scope: !2158)
!2382 = !DILocation(line: 150, column: 28, scope: !2158)
!2383 = !DILocation(line: 152, column: 41, scope: !2158)
!2384 = !DILocation(line: 152, column: 44, scope: !2158)
!2385 = !DILocation(line: 152, column: 55, scope: !2158)
!2386 = !DILocation(line: 152, column: 30, scope: !2158)
!2387 = !DILocation(line: 152, column: 5, scope: !2158)
!2388 = !DILocation(line: 152, column: 8, scope: !2158)
!2389 = !DILocation(line: 152, column: 28, scope: !2158)
!2390 = !DILocation(line: 155, column: 21, scope: !2158)
!2391 = !DILocation(line: 155, column: 24, scope: !2158)
!2392 = !DILocation(line: 155, column: 41, scope: !2158)
!2393 = !DILocation(line: 155, column: 44, scope: !2158)
!2394 = !DILocation(line: 155, column: 39, scope: !2158)
!2395 = !DILocation(line: 155, column: 5, scope: !2158)
!2396 = !DILocation(line: 155, column: 8, scope: !2158)
!2397 = !DILocation(line: 155, column: 19, scope: !2158)
!2398 = !DILocation(line: 156, column: 33, scope: !2158)
!2399 = !DILocation(line: 156, column: 36, scope: !2158)
!2400 = !DILocation(line: 156, column: 22, scope: !2158)
!2401 = !DILocation(line: 156, column: 5, scope: !2158)
!2402 = !DILocation(line: 156, column: 8, scope: !2158)
!2403 = !DILocation(line: 156, column: 20, scope: !2158)
!2404 = !DILocation(line: 158, column: 21, scope: !2158)
!2405 = !DILocation(line: 158, column: 24, scope: !2158)
!2406 = !DILocation(line: 158, column: 41, scope: !2158)
!2407 = !DILocation(line: 158, column: 44, scope: !2158)
!2408 = !DILocation(line: 158, column: 39, scope: !2158)
!2409 = !DILocation(line: 158, column: 5, scope: !2158)
!2410 = !DILocation(line: 158, column: 8, scope: !2158)
!2411 = !DILocation(line: 158, column: 19, scope: !2158)
!2412 = !DILocation(line: 159, column: 33, scope: !2158)
!2413 = !DILocation(line: 159, column: 36, scope: !2158)
!2414 = !DILocation(line: 159, column: 22, scope: !2158)
!2415 = !DILocation(line: 159, column: 5, scope: !2158)
!2416 = !DILocation(line: 159, column: 8, scope: !2158)
!2417 = !DILocation(line: 159, column: 20, scope: !2158)
!2418 = !DILocation(line: 160, column: 38, scope: !2158)
!2419 = !DILocation(line: 160, column: 41, scope: !2158)
!2420 = !DILocation(line: 160, column: 27, scope: !2158)
!2421 = !DILocation(line: 160, column: 5, scope: !2158)
!2422 = !DILocation(line: 160, column: 8, scope: !2158)
!2423 = !DILocation(line: 160, column: 25, scope: !2158)
!2424 = !DILocation(line: 162, column: 10, scope: !2425)
!2425 = distinct !DILexicalBlock(scope: !2158, file: !921, line: 162, column: 9)
!2426 = !DILocation(line: 162, column: 13, scope: !2425)
!2427 = !DILocation(line: 162, column: 32, scope: !2425)
!2428 = !DILocation(line: 163, column: 10, scope: !2425)
!2429 = !DILocation(line: 163, column: 13, scope: !2425)
!2430 = !DILocation(line: 163, column: 33, scope: !2425)
!2431 = !DILocation(line: 164, column: 10, scope: !2425)
!2432 = !DILocation(line: 164, column: 13, scope: !2425)
!2433 = !DILocation(line: 164, column: 33, scope: !2425)
!2434 = !DILocation(line: 165, column: 10, scope: !2425)
!2435 = !DILocation(line: 165, column: 13, scope: !2425)
!2436 = !DILocation(line: 165, column: 25, scope: !2425)
!2437 = !DILocation(line: 166, column: 10, scope: !2425)
!2438 = !DILocation(line: 166, column: 13, scope: !2425)
!2439 = !DILocation(line: 166, column: 25, scope: !2425)
!2440 = !DILocation(line: 167, column: 10, scope: !2425)
!2441 = !DILocation(line: 167, column: 13, scope: !2425)
!2442 = !DILocation(line: 162, column: 9, scope: !2367)
!2443 = !DILocation(line: 168, column: 13, scope: !2444)
!2444 = distinct !DILexicalBlock(scope: !2425, file: !921, line: 167, column: 31)
!2445 = !DILocation(line: 169, column: 9, scope: !2444)
!2446 = !DILocation(line: 172, column: 15, scope: !2158)
!2447 = !DILocation(line: 172, column: 19, scope: !2158)
!2448 = !DILocation(line: 172, column: 22, scope: !2158)
!2449 = !DILocation(line: 172, column: 5, scope: !2158)
!2450 = !DILocation(line: 174, column: 16, scope: !2158)
!2451 = !DILocation(line: 174, column: 19, scope: !2158)
!2452 = !DILocation(line: 174, column: 22, scope: !2158)
!2453 = !DILocation(line: 174, column: 42, scope: !2158)
!2454 = !DILocation(line: 174, column: 45, scope: !2158)
!2455 = !DILocation(line: 174, column: 5, scope: !2158)
!2456 = !DILocation(line: 175, column: 16, scope: !2158)
!2457 = !DILocation(line: 175, column: 19, scope: !2158)
!2458 = !DILocation(line: 175, column: 22, scope: !2158)
!2459 = !DILocation(line: 175, column: 43, scope: !2158)
!2460 = !DILocation(line: 175, column: 46, scope: !2158)
!2461 = !DILocation(line: 175, column: 5, scope: !2158)
!2462 = !DILocation(line: 176, column: 16, scope: !2158)
!2463 = !DILocation(line: 176, column: 19, scope: !2158)
!2464 = !DILocation(line: 176, column: 22, scope: !2158)
!2465 = !DILocation(line: 176, column: 43, scope: !2158)
!2466 = !DILocation(line: 176, column: 46, scope: !2158)
!2467 = !DILocation(line: 176, column: 5, scope: !2158)
!2468 = !DILocation(line: 178, column: 5, scope: !2158)
!2469 = !DILocation(line: 178, column: 8, scope: !2158)
!2470 = !DILocation(line: 178, column: 18, scope: !2158)
!2471 = !DILocation(line: 179, column: 5, scope: !2158)
!2472 = !DILocation(line: 179, column: 8, scope: !2158)
!2473 = !DILocation(line: 179, column: 22, scope: !2158)
!2474 = !DILocation(line: 180, column: 5, scope: !2158)
!2475 = !DILocation(line: 180, column: 8, scope: !2158)
!2476 = !DILocation(line: 180, column: 28, scope: !2158)
!2477 = !DILocation(line: 182, column: 15, scope: !2158)
!2478 = !DILocation(line: 182, column: 19, scope: !2158)
!2479 = !DILocation(line: 182, column: 22, scope: !2158)
!2480 = !DILocation(line: 182, column: 5, scope: !2158)
!2481 = !DILocation(line: 184, column: 5, scope: !2158)
!2482 = !DILocation(line: 187, column: 16, scope: !2158)
!2483 = !DILocation(line: 187, column: 5, scope: !2158)
!2484 = !DILocation(line: 189, column: 12, scope: !2158)
!2485 = !DILocation(line: 189, column: 5, scope: !2158)
!2486 = !DILocation(line: 190, column: 1, scope: !2158)
!2487 = distinct !DISubprogram(name: "read_packet", scope: !921, file: !921, line: 192, type: !2488, isLocal: true, isDefinition: true, scopeLine: 193, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2488 = !DISubroutineType(types: !2489)
!2489 = !{!917, !2161, !1033}
!2490 = !DILocalVariable(name: "s", arg: 1, scope: !2487, file: !921, line: 192, type: !2161)
!2491 = !DILocation(line: 192, column: 41, scope: !2487)
!2492 = !DILocalVariable(name: "pkt", arg: 2, scope: !2487, file: !921, line: 192, type: !1033)
!2493 = !DILocation(line: 192, column: 54, scope: !2487)
!2494 = !DILocalVariable(name: "p", scope: !2487, file: !921, line: 194, type: !2166)
!2495 = !DILocation(line: 194, column: 22, scope: !2487)
!2496 = !DILocation(line: 194, column: 26, scope: !2487)
!2497 = !DILocation(line: 194, column: 29, scope: !2487)
!2498 = !DILocalVariable(name: "pb", scope: !2487, file: !921, line: 195, type: !1215)
!2499 = !DILocation(line: 195, column: 18, scope: !2487)
!2500 = !DILocation(line: 195, column: 23, scope: !2487)
!2501 = !DILocation(line: 195, column: 26, scope: !2487)
!2502 = !DILocalVariable(name: "count", scope: !2487, file: !921, line: 196, type: !1368)
!2503 = !DILocation(line: 196, column: 14, scope: !2487)
!2504 = !DILocalVariable(name: "offset", scope: !2487, file: !921, line: 196, type: !1368)
!2505 = !DILocation(line: 196, column: 21, scope: !2487)
!2506 = !DILocalVariable(name: "size", scope: !2487, file: !921, line: 197, type: !917)
!2507 = !DILocation(line: 197, column: 9, scope: !2487)
!2508 = !DILocalVariable(name: "i", scope: !2487, file: !921, line: 197, type: !917)
!2509 = !DILocation(line: 197, column: 15, scope: !2487)
!2510 = !DILocation(line: 199, column: 9, scope: !2511)
!2511 = distinct !DILexicalBlock(scope: !2487, file: !921, line: 199, column: 9)
!2512 = !DILocation(line: 199, column: 12, scope: !2511)
!2513 = !DILocation(line: 199, column: 29, scope: !2511)
!2514 = !DILocation(line: 199, column: 32, scope: !2511)
!2515 = !DILocation(line: 199, column: 26, scope: !2511)
!2516 = !DILocation(line: 199, column: 9, scope: !2487)
!2517 = !DILocation(line: 200, column: 9, scope: !2511)
!2518 = !DILocation(line: 202, column: 19, scope: !2519)
!2519 = distinct !DILexicalBlock(scope: !2487, file: !921, line: 202, column: 9)
!2520 = !DILocation(line: 202, column: 9, scope: !2519)
!2521 = !DILocation(line: 202, column: 9, scope: !2487)
!2522 = !DILocation(line: 203, column: 9, scope: !2519)
!2523 = !DILocation(line: 205, column: 9, scope: !2524)
!2524 = distinct !DILexicalBlock(scope: !2487, file: !921, line: 205, column: 9)
!2525 = !DILocation(line: 205, column: 12, scope: !2524)
!2526 = !DILocation(line: 205, column: 9, scope: !2487)
!2527 = !DILocation(line: 206, column: 27, scope: !2528)
!2528 = distinct !DILexicalBlock(scope: !2529, file: !921, line: 206, column: 13)
!2529 = distinct !DILexicalBlock(scope: !2524, file: !921, line: 205, column: 23)
!2530 = !DILocation(line: 206, column: 32, scope: !2528)
!2531 = !DILocation(line: 206, column: 35, scope: !2528)
!2532 = !DILocation(line: 206, column: 13, scope: !2528)
!2533 = !DILocation(line: 206, column: 47, scope: !2528)
!2534 = !DILocation(line: 206, column: 13, scope: !2529)
!2535 = !DILocation(line: 207, column: 13, scope: !2528)
!2536 = !DILocation(line: 209, column: 16, scope: !2529)
!2537 = !DILocation(line: 209, column: 21, scope: !2529)
!2538 = !DILocation(line: 209, column: 27, scope: !2529)
!2539 = !DILocation(line: 209, column: 30, scope: !2529)
!2540 = !DILocation(line: 209, column: 48, scope: !2529)
!2541 = !DILocation(line: 209, column: 51, scope: !2529)
!2542 = !DILocation(line: 209, column: 9, scope: !2529)
!2543 = !DILocation(line: 210, column: 33, scope: !2529)
!2544 = !DILocation(line: 210, column: 36, scope: !2529)
!2545 = !DILocation(line: 210, column: 47, scope: !2529)
!2546 = !DILocation(line: 210, column: 30, scope: !2529)
!2547 = !DILocation(line: 210, column: 25, scope: !2529)
!2548 = !DILocation(line: 210, column: 9, scope: !2529)
!2549 = !DILocation(line: 210, column: 14, scope: !2529)
!2550 = !DILocation(line: 210, column: 23, scope: !2529)
!2551 = !DILocation(line: 211, column: 9, scope: !2529)
!2552 = !DILocation(line: 211, column: 14, scope: !2529)
!2553 = !DILocation(line: 211, column: 20, scope: !2529)
!2554 = !DILocation(line: 212, column: 9, scope: !2529)
!2555 = !DILocation(line: 212, column: 14, scope: !2529)
!2556 = !DILocation(line: 212, column: 27, scope: !2529)
!2557 = !DILocation(line: 213, column: 9, scope: !2529)
!2558 = !DILocation(line: 213, column: 12, scope: !2529)
!2559 = !DILocation(line: 213, column: 22, scope: !2529)
!2560 = !DILocation(line: 214, column: 16, scope: !2529)
!2561 = !DILocation(line: 214, column: 21, scope: !2529)
!2562 = !DILocation(line: 214, column: 9, scope: !2529)
!2563 = !DILocation(line: 217, column: 14, scope: !2487)
!2564 = !DILocation(line: 217, column: 17, scope: !2487)
!2565 = !DILocation(line: 217, column: 31, scope: !2487)
!2566 = !DILocation(line: 217, column: 13, scope: !2487)
!2567 = !DILocation(line: 217, column: 39, scope: !2568)
!2568 = !DILexicalBlockFile(scope: !2487, file: !921, discriminator: 1)
!2569 = !DILocation(line: 217, column: 42, scope: !2568)
!2570 = !DILocation(line: 217, column: 13, scope: !2568)
!2571 = !DILocation(line: 218, column: 61, scope: !2487)
!2572 = !DILocation(line: 218, column: 64, scope: !2487)
!2573 = !DILocation(line: 218, column: 78, scope: !2487)
!2574 = !DILocation(line: 218, column: 39, scope: !2487)
!2575 = !DILocation(line: 218, column: 42, scope: !2487)
!2576 = !DILocation(line: 217, column: 13, scope: !2577)
!2577 = !DILexicalBlockFile(scope: !2487, file: !921, discriminator: 2)
!2578 = !DILocation(line: 217, column: 13, scope: !2579)
!2579 = !DILexicalBlockFile(scope: !2487, file: !921, discriminator: 3)
!2580 = !DILocation(line: 217, column: 11, scope: !2579)
!2581 = !DILocation(line: 219, column: 12, scope: !2582)
!2582 = distinct !DILexicalBlock(scope: !2487, file: !921, line: 219, column: 5)
!2583 = !DILocation(line: 219, column: 10, scope: !2582)
!2584 = !DILocation(line: 219, column: 17, scope: !2585)
!2585 = !DILexicalBlockFile(scope: !2586, file: !921, discriminator: 1)
!2586 = distinct !DILexicalBlock(scope: !2582, file: !921, line: 219, column: 5)
!2587 = !DILocation(line: 219, column: 21, scope: !2585)
!2588 = !DILocation(line: 219, column: 19, scope: !2585)
!2589 = !DILocation(line: 219, column: 5, scope: !2585)
!2590 = !DILocation(line: 220, column: 13, scope: !2591)
!2591 = distinct !DILexicalBlock(scope: !2592, file: !921, line: 220, column: 13)
!2592 = distinct !DILexicalBlock(scope: !2586, file: !921, line: 219, column: 33)
!2593 = !DILocation(line: 220, column: 16, scope: !2591)
!2594 = !DILocation(line: 220, column: 39, scope: !2591)
!2595 = !DILocation(line: 220, column: 42, scope: !2591)
!2596 = !DILocation(line: 220, column: 36, scope: !2591)
!2597 = !DILocation(line: 220, column: 13, scope: !2592)
!2598 = !DILocation(line: 221, column: 13, scope: !2591)
!2599 = !DILocation(line: 223, column: 41, scope: !2592)
!2600 = !DILocation(line: 223, column: 44, scope: !2592)
!2601 = !DILocation(line: 223, column: 18, scope: !2592)
!2602 = !DILocation(line: 223, column: 21, scope: !2592)
!2603 = !DILocation(line: 223, column: 65, scope: !2592)
!2604 = !DILocation(line: 223, column: 16, scope: !2592)
!2605 = !DILocation(line: 224, column: 36, scope: !2606)
!2606 = distinct !DILexicalBlock(scope: !2592, file: !921, line: 224, column: 13)
!2607 = !DILocation(line: 224, column: 39, scope: !2606)
!2608 = !DILocation(line: 224, column: 13, scope: !2606)
!2609 = !DILocation(line: 224, column: 16, scope: !2606)
!2610 = !DILocation(line: 224, column: 60, scope: !2606)
!2611 = !DILocation(line: 224, column: 13, scope: !2592)
!2612 = !DILocation(line: 225, column: 17, scope: !2613)
!2613 = distinct !DILexicalBlock(scope: !2614, file: !921, line: 225, column: 17)
!2614 = distinct !DILexicalBlock(scope: !2606, file: !921, line: 224, column: 74)
!2615 = !DILocation(line: 225, column: 26, scope: !2613)
!2616 = !DILocation(line: 225, column: 29, scope: !2613)
!2617 = !DILocation(line: 225, column: 42, scope: !2613)
!2618 = !DILocation(line: 225, column: 45, scope: !2613)
!2619 = !DILocation(line: 225, column: 40, scope: !2613)
!2620 = !DILocation(line: 225, column: 24, scope: !2613)
!2621 = !DILocation(line: 225, column: 17, scope: !2614)
!2622 = !DILocation(line: 226, column: 17, scope: !2613)
!2623 = !DILocation(line: 228, column: 23, scope: !2614)
!2624 = !DILocation(line: 228, column: 27, scope: !2614)
!2625 = !DILocation(line: 228, column: 30, scope: !2614)
!2626 = !DILocation(line: 228, column: 44, scope: !2614)
!2627 = !DILocation(line: 228, column: 42, scope: !2614)
!2628 = !DILocation(line: 228, column: 52, scope: !2614)
!2629 = !DILocation(line: 228, column: 55, scope: !2614)
!2630 = !DILocation(line: 228, column: 13, scope: !2614)
!2631 = !DILocation(line: 229, column: 17, scope: !2632)
!2632 = distinct !DILexicalBlock(scope: !2614, file: !921, line: 229, column: 17)
!2633 = !DILocation(line: 229, column: 28, scope: !2632)
!2634 = !DILocation(line: 229, column: 31, scope: !2632)
!2635 = !DILocation(line: 229, column: 46, scope: !2632)
!2636 = !DILocation(line: 229, column: 53, scope: !2632)
!2637 = !DILocation(line: 229, column: 56, scope: !2632)
!2638 = !DILocation(line: 229, column: 51, scope: !2632)
!2639 = !DILocation(line: 229, column: 24, scope: !2632)
!2640 = !DILocation(line: 229, column: 17, scope: !2614)
!2641 = !DILocation(line: 230, column: 24, scope: !2642)
!2642 = distinct !DILexicalBlock(scope: !2632, file: !921, line: 229, column: 69)
!2643 = !DILocation(line: 230, column: 27, scope: !2642)
!2644 = !DILocation(line: 230, column: 45, scope: !2642)
!2645 = !DILocation(line: 230, column: 48, scope: !2642)
!2646 = !DILocation(line: 230, column: 61, scope: !2642)
!2647 = !DILocation(line: 230, column: 64, scope: !2642)
!2648 = !DILocation(line: 230, column: 17, scope: !2642)
!2649 = !DILocation(line: 231, column: 17, scope: !2642)
!2650 = !DILocation(line: 231, column: 20, scope: !2642)
!2651 = !DILocation(line: 231, column: 30, scope: !2642)
!2652 = !DILocation(line: 232, column: 13, scope: !2642)
!2653 = !DILocation(line: 233, column: 9, scope: !2614)
!2654 = !DILocation(line: 234, column: 17, scope: !2655)
!2655 = distinct !DILexicalBlock(scope: !2656, file: !921, line: 234, column: 17)
!2656 = distinct !DILexicalBlock(scope: !2606, file: !921, line: 233, column: 16)
!2657 = !DILocation(line: 234, column: 26, scope: !2655)
!2658 = !DILocation(line: 234, column: 29, scope: !2655)
!2659 = !DILocation(line: 234, column: 42, scope: !2655)
!2660 = !DILocation(line: 234, column: 45, scope: !2655)
!2661 = !DILocation(line: 234, column: 40, scope: !2655)
!2662 = !DILocation(line: 234, column: 24, scope: !2655)
!2663 = !DILocation(line: 234, column: 17, scope: !2656)
!2664 = !DILocation(line: 235, column: 17, scope: !2655)
!2665 = !DILocation(line: 237, column: 23, scope: !2656)
!2666 = !DILocation(line: 237, column: 27, scope: !2656)
!2667 = !DILocation(line: 237, column: 30, scope: !2656)
!2668 = !DILocation(line: 237, column: 44, scope: !2656)
!2669 = !DILocation(line: 237, column: 42, scope: !2656)
!2670 = !DILocation(line: 237, column: 52, scope: !2656)
!2671 = !DILocation(line: 237, column: 55, scope: !2656)
!2672 = !DILocation(line: 237, column: 13, scope: !2656)
!2673 = !DILocation(line: 239, column: 9, scope: !2592)
!2674 = !DILocation(line: 239, column: 12, scope: !2592)
!2675 = !DILocation(line: 239, column: 31, scope: !2592)
!2676 = !DILocation(line: 240, column: 5, scope: !2592)
!2677 = !DILocation(line: 219, column: 29, scope: !2678)
!2678 = !DILexicalBlockFile(scope: !2586, file: !921, discriminator: 2)
!2679 = !DILocation(line: 219, column: 5, scope: !2678)
!2680 = distinct !{!2680, !2681}
!2681 = !DILocation(line: 219, column: 5, scope: !2487)
!2682 = !DILocation(line: 242, column: 32, scope: !2683)
!2683 = distinct !DILexicalBlock(scope: !2487, file: !921, line: 242, column: 9)
!2684 = !DILocation(line: 242, column: 35, scope: !2683)
!2685 = !DILocation(line: 242, column: 9, scope: !2683)
!2686 = !DILocation(line: 242, column: 12, scope: !2683)
!2687 = !DILocation(line: 242, column: 53, scope: !2683)
!2688 = !DILocation(line: 242, column: 56, scope: !2683)
!2689 = !DILocation(line: 242, column: 50, scope: !2683)
!2690 = !DILocation(line: 242, column: 9, scope: !2487)
!2691 = !DILocation(line: 243, column: 9, scope: !2683)
!2692 = !DILocation(line: 245, column: 12, scope: !2487)
!2693 = !DILocation(line: 245, column: 15, scope: !2487)
!2694 = !DILocation(line: 245, column: 51, scope: !2487)
!2695 = !DILocation(line: 245, column: 54, scope: !2487)
!2696 = !DILocation(line: 245, column: 28, scope: !2487)
!2697 = !DILocation(line: 245, column: 31, scope: !2487)
!2698 = !DILocation(line: 245, column: 26, scope: !2487)
!2699 = !DILocation(line: 245, column: 10, scope: !2487)
!2700 = !DILocation(line: 247, column: 23, scope: !2701)
!2701 = distinct !DILexicalBlock(scope: !2487, file: !921, line: 247, column: 9)
!2702 = !DILocation(line: 247, column: 28, scope: !2701)
!2703 = !DILocation(line: 247, column: 9, scope: !2701)
!2704 = !DILocation(line: 247, column: 34, scope: !2701)
!2705 = !DILocation(line: 247, column: 9, scope: !2487)
!2706 = !DILocation(line: 248, column: 9, scope: !2701)
!2707 = !DILocation(line: 250, column: 5, scope: !2487)
!2708 = !DILocation(line: 250, column: 10, scope: !2487)
!2709 = !DILocation(line: 250, column: 23, scope: !2487)
!2710 = !DILocation(line: 251, column: 5, scope: !2487)
!2711 = !DILocation(line: 251, column: 10, scope: !2487)
!2712 = !DILocation(line: 251, column: 19, scope: !2487)
!2713 = !DILocation(line: 252, column: 12, scope: !2487)
!2714 = !DILocation(line: 252, column: 17, scope: !2487)
!2715 = !DILocation(line: 252, column: 23, scope: !2487)
!2716 = !DILocation(line: 252, column: 26, scope: !2487)
!2717 = !DILocation(line: 252, column: 63, scope: !2487)
!2718 = !DILocation(line: 252, column: 66, scope: !2487)
!2719 = !DILocation(line: 252, column: 40, scope: !2487)
!2720 = !DILocation(line: 252, column: 43, scope: !2487)
!2721 = !DILocation(line: 252, column: 38, scope: !2487)
!2722 = !DILocation(line: 252, column: 82, scope: !2487)
!2723 = !DILocation(line: 252, column: 5, scope: !2487)
!2724 = !DILocation(line: 253, column: 9, scope: !2725)
!2725 = distinct !DILexicalBlock(scope: !2487, file: !921, line: 253, column: 9)
!2726 = !DILocation(line: 253, column: 14, scope: !2725)
!2727 = !DILocation(line: 253, column: 22, scope: !2725)
!2728 = !DILocation(line: 253, column: 9, scope: !2487)
!2729 = !DILocation(line: 254, column: 9, scope: !2725)
!2730 = !DILocation(line: 254, column: 14, scope: !2725)
!2731 = !DILocation(line: 254, column: 20, scope: !2725)
!2732 = !DILocation(line: 255, column: 5, scope: !2487)
!2733 = !DILocation(line: 255, column: 8, scope: !2487)
!2734 = !DILocation(line: 255, column: 21, scope: !2487)
!2735 = !DILocation(line: 257, column: 12, scope: !2487)
!2736 = !DILocation(line: 257, column: 17, scope: !2487)
!2737 = !DILocation(line: 257, column: 5, scope: !2487)
!2738 = !DILocation(line: 258, column: 1, scope: !2487)
!2739 = distinct !DISubprogram(name: "read_close", scope: !921, file: !921, line: 64, type: !2159, isLocal: true, isDefinition: true, scopeLine: 65, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2740 = !DILocalVariable(name: "s", arg: 1, scope: !2739, file: !921, line: 64, type: !2161)
!2741 = !DILocation(line: 64, column: 40, scope: !2739)
!2742 = !DILocalVariable(name: "p", scope: !2739, file: !921, line: 66, type: !2166)
!2743 = !DILocation(line: 66, column: 22, scope: !2739)
!2744 = !DILocation(line: 66, column: 26, scope: !2739)
!2745 = !DILocation(line: 66, column: 29, scope: !2739)
!2746 = !DILocation(line: 68, column: 15, scope: !2739)
!2747 = !DILocation(line: 68, column: 18, scope: !2739)
!2748 = !DILocation(line: 68, column: 14, scope: !2739)
!2749 = !DILocation(line: 68, column: 5, scope: !2739)
!2750 = !DILocation(line: 69, column: 15, scope: !2739)
!2751 = !DILocation(line: 69, column: 18, scope: !2739)
!2752 = !DILocation(line: 69, column: 14, scope: !2739)
!2753 = !DILocation(line: 69, column: 5, scope: !2739)
!2754 = !DILocation(line: 70, column: 15, scope: !2739)
!2755 = !DILocation(line: 70, column: 18, scope: !2739)
!2756 = !DILocation(line: 70, column: 14, scope: !2739)
!2757 = !DILocation(line: 70, column: 5, scope: !2739)
!2758 = !DILocation(line: 71, column: 15, scope: !2739)
!2759 = !DILocation(line: 71, column: 18, scope: !2739)
!2760 = !DILocation(line: 71, column: 14, scope: !2739)
!2761 = !DILocation(line: 71, column: 5, scope: !2739)
!2762 = !DILocation(line: 72, column: 15, scope: !2739)
!2763 = !DILocation(line: 72, column: 18, scope: !2739)
!2764 = !DILocation(line: 72, column: 14, scope: !2739)
!2765 = !DILocation(line: 72, column: 5, scope: !2739)
!2766 = !DILocation(line: 73, column: 15, scope: !2739)
!2767 = !DILocation(line: 73, column: 18, scope: !2739)
!2768 = !DILocation(line: 73, column: 14, scope: !2739)
!2769 = !DILocation(line: 73, column: 5, scope: !2739)
!2770 = !DILocation(line: 75, column: 5, scope: !2739)
!2771 = distinct !DISubprogram(name: "read_table", scope: !921, file: !921, line: 78, type: !2772, isLocal: true, isDefinition: true, scopeLine: 79, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2772 = !DISubroutineType(types: !2773)
!2773 = !{null, !2161, !2181, !1368}
!2774 = !DILocalVariable(name: "s", arg: 1, scope: !2771, file: !921, line: 78, type: !2161)
!2775 = !DILocation(line: 78, column: 41, scope: !2771)
!2776 = !DILocalVariable(name: "table", arg: 2, scope: !2771, file: !921, line: 78, type: !2181)
!2777 = !DILocation(line: 78, column: 54, scope: !2771)
!2778 = !DILocalVariable(name: "count", arg: 3, scope: !2771, file: !921, line: 78, type: !1368)
!2779 = !DILocation(line: 78, column: 70, scope: !2771)
!2780 = !DILocalVariable(name: "i", scope: !2771, file: !921, line: 80, type: !917)
!2781 = !DILocation(line: 80, column: 9, scope: !2771)
!2782 = !DILocation(line: 82, column: 12, scope: !2783)
!2783 = distinct !DILexicalBlock(scope: !2771, file: !921, line: 82, column: 5)
!2784 = !DILocation(line: 82, column: 10, scope: !2783)
!2785 = !DILocation(line: 82, column: 17, scope: !2786)
!2786 = !DILexicalBlockFile(scope: !2787, file: !921, discriminator: 1)
!2787 = distinct !DILexicalBlock(scope: !2783, file: !921, line: 82, column: 5)
!2788 = !DILocation(line: 82, column: 21, scope: !2786)
!2789 = !DILocation(line: 82, column: 19, scope: !2786)
!2790 = !DILocation(line: 82, column: 5, scope: !2786)
!2791 = !DILocation(line: 83, column: 30, scope: !2787)
!2792 = !DILocation(line: 83, column: 33, scope: !2787)
!2793 = !DILocation(line: 83, column: 20, scope: !2787)
!2794 = !DILocation(line: 83, column: 15, scope: !2787)
!2795 = !DILocation(line: 83, column: 9, scope: !2787)
!2796 = !DILocation(line: 83, column: 18, scope: !2787)
!2797 = !DILocation(line: 82, column: 29, scope: !2798)
!2798 = !DILexicalBlockFile(scope: !2787, file: !921, discriminator: 2)
!2799 = !DILocation(line: 82, column: 5, scope: !2798)
!2800 = distinct !{!2800, !2801}
!2801 = !DILocation(line: 82, column: 5, scope: !2771)
!2802 = !DILocation(line: 85, column: 15, scope: !2771)
!2803 = !DILocation(line: 85, column: 18, scope: !2771)
!2804 = !DILocation(line: 85, column: 30, scope: !2771)
!2805 = !DILocation(line: 85, column: 36, scope: !2771)
!2806 = !DILocation(line: 85, column: 42, scope: !2771)
!2807 = !DILocation(line: 85, column: 45, scope: !2771)
!2808 = !DILocation(line: 85, column: 60, scope: !2771)
!2809 = !DILocation(line: 85, column: 58, scope: !2771)
!2810 = !DILocation(line: 85, column: 24, scope: !2771)
!2811 = !DILocation(line: 85, column: 22, scope: !2771)
!2812 = !DILocation(line: 85, column: 5, scope: !2771)
!2813 = !DILocation(line: 86, column: 1, scope: !2771)
