; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--mgsts.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--mgsts.o.i"
...
@ff_mgsts_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.1, i32 0, i32 0), i32 256, i8* null, %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 0, i32 (%struct.AVProbeData*)* @read_probe, i32 (%struct.AVFormatContext*)* @read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
@ff_codec_bmp_tags = external constant [0 x %struct.AVCodecTag], align 4

; Function Attrs: nounwind uwtable
define internal i32 @read_probe(%struct.AVProbeData* %p) #0 !dbg !2146 {
entry:
  %x.addr.i26 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %x.addr.i26, metadata !2148, metadata !2153), !dbg !2154
  %x.addr.i11 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %x.addr.i11, metadata !2148, metadata !2153), !dbg !2157
  %x.addr.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %x.addr.i, metadata !2148, metadata !2153), !dbg !2159
  %retval = alloca i32, align 4
  %p.addr = alloca %struct.AVProbeData*, align 8
  store %struct.AVProbeData* %p, %struct.AVProbeData** %p.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVProbeData** %p.addr, metadata !2161, metadata !2153), !dbg !2162
  ...
  %2 = bitcast i8* %1 to %union.unaligned_32*, !dbg !2165
  %l = bitcast %union.unaligned_32* %2 to i32*, !dbg !2165
  %3 = load i32, i32* %l, align 1, !dbg !2165
  store i32 %3, i32* %x.addr.i, align 4, !dbg !2166
  %4 = load i32, i32* %x.addr.i, align 4, !dbg !2167
  %shl.i = shl i32 %4, 8, !dbg !2168
  %and.i = and i32 %shl.i, 65280, !dbg !2169
  %5 = load i32, i32* %x.addr.i, align 4, !dbg !2170
  %shr.i = lshr i32 %5, 8, !dbg !2171
  %and1.i = and i32 %shr.i, 255, !dbg !2172
  %or.i = or i32 %and.i, %and1.i, !dbg !2173
  %shl2.i = shl i32 %or.i, 16, !dbg !2174
  %6 = load i32, i32* %x.addr.i, align 4, !dbg !2175
  %shr3.i = lshr i32 %6, 16, !dbg !2176
  %shl4.i = shl i32 %shr3.i, 8, !dbg !2177
  %and5.i = and i32 %shl4.i, 65280, !dbg !2178
  %7 = load i32, i32* %x.addr.i, align 4, !dbg !2179
  %shr6.i = lshr i32 %7, 16, !dbg !2180
  ...
  %cmp = icmp ne i32 %or10.i, 14, !dbg !2185
  br i1 %cmp, label %if.then, label %lor.lhs.false, !dbg !2186

lor.lhs.false:                                    ; preds = %entry
  %8 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2187
  %buf1 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %8, i32 0, i32 1, !dbg !2188
  %9 = load i8*, i8** %buf1, align 8, !dbg !2188
  %add.ptr = getelementptr inbounds i8, i8* %9, i64 4, !dbg !2189
  %10 = bitcast i8* %add.ptr to %union.unaligned_32*, !dbg !2190
  %l2 = bitcast %union.unaligned_32* %10 to i32*, !dbg !2190
  %11 = load i32, i32* %l2, align 1, !dbg !2190
  store i32 %11, i32* %x.addr.i26, align 4, !dbg !2191
  %12 = load i32, i32* %x.addr.i26, align 4, !dbg !2192
  %shl.i27 = shl i32 %12, 8, !dbg !2193
  %and.i28 = and i32 %shl.i27, 65280, !dbg !2194
  %13 = load i32, i32* %x.addr.i26, align 4, !dbg !2195
  %shr.i29 = lshr i32 %13, 8, !dbg !2196
  %and1.i30 = and i32 %shr.i29, 255, !dbg !2197
  %or.i31 = or i32 %and.i28, %and1.i30, !dbg !2198
  %shl2.i32 = shl i32 %or.i31, 16, !dbg !2199
  %14 = load i32, i32* %x.addr.i26, align 4, !dbg !2200
  %shr3.i33 = lshr i32 %14, 16, !dbg !2201
  %shl4.i34 = shl i32 %shr3.i33, 8, !dbg !2202
  %and5.i35 = and i32 %shl4.i34, 65280, !dbg !2203
  %15 = load i32, i32* %x.addr.i26, align 4, !dbg !2204
  %shr6.i36 = lshr i32 %15, 16, !dbg !2205
  %shr7.i37 = lshr i32 %shr6.i36, 8, !dbg !2206
  %and8.i38 = and i32 %shr7.i37, 255, !dbg !2207
  %or9.i39 = or i32 %and5.i35, %and8.i38, !dbg !2208
  %or10.i40 = or i32 %shl2.i32, %or9.i39, !dbg !2209
  %cmp4 = icmp ne i32 %or10.i40, 80, !dbg !2210
  br i1 %cmp4, label %if.then, label %lor.lhs.false5, !dbg !2211

lor.lhs.false5:                                   ; preds = %lor.lhs.false
  %16 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2212
  %buf6 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %16, i32 0, i32 1, !dbg !2213
  %17 = load i8*, i8** %buf6, align 8, !dbg !2213
  %add.ptr7 = getelementptr inbounds i8, i8* %17, i64 12, !dbg !2214
  %18 = bitcast i8* %add.ptr7 to %union.unaligned_32*, !dbg !2215
  %l8 = bitcast %union.unaligned_32* %18 to i32*, !dbg !2215
  %19 = load i32, i32* %l8, align 1, !dbg !2215
  store i32 %19, i32* %x.addr.i11, align 4, !dbg !2216
  %20 = load i32, i32* %x.addr.i11, align 4, !dbg !2217
  %shl.i12 = shl i32 %20, 8, !dbg !2218
  %and.i13 = and i32 %shl.i12, 65280, !dbg !2219
  %21 = load i32, i32* %x.addr.i11, align 4, !dbg !2220
  %shr.i14 = lshr i32 %21, 8, !dbg !2221
  %and1.i15 = and i32 %shr.i14, 255, !dbg !2222
  %or.i16 = or i32 %and.i13, %and1.i15, !dbg !2223
  %shl2.i17 = shl i32 %or.i16, 16, !dbg !2224
  %22 = load i32, i32* %x.addr.i11, align 4, !dbg !2225
  %shr3.i18 = lshr i32 %22, 16, !dbg !2226
  %shl4.i19 = shl i32 %shr3.i18, 8, !dbg !2227
  %and5.i20 = and i32 %shl4.i19, 65280, !dbg !2228
  %23 = load i32, i32* %x.addr.i11, align 4, !dbg !2229
  %shr6.i21 = lshr i32 %23, 16, !dbg !2230
  %shr7.i22 = lshr i32 %shr6.i21, 8, !dbg !2231
  %and8.i23 = and i32 %shr7.i22, 255, !dbg !2232
  %or9.i24 = or i32 %and5.i20, %and8.i23, !dbg !2233
  %or10.i25 = or i32 %shl2.i17, %or9.i24, !dbg !2234
  %cmp10 = icmp ne i32 %or10.i25, 52, !dbg !2235
  br i1 %cmp10, label %if.then, label %if.end, !dbg !2236
...
; Function Attrs: nounwind uwtable
define internal i32 @read_header(%struct.AVFormatContext* %s) #0 !dbg !2241 {
entry:
  %i.addr.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %i.addr.i, metadata !2246, metadata !2153), !dbg !2251
  %v.i = alloca %union.av_intfloat32, align 4
  call void @llvm.dbg.declare(metadata %union.av_intfloat32* %v.i, metadata !2254, metadata !2153), !dbg !2259
  %retval = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2260, metadata !2153), !dbg !2261
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2262, metadata !2153), !dbg !2263
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2264
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2265
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2265
  store %struct.AVIOContext* %1, %struct.AVIOContext** %pb, align 8, !dbg !2263
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2266, metadata !2153), !dbg !2267
  call void @llvm.dbg.declare(metadata %struct.AVRational* %fps, metadata !2268, metadata !2153), !dbg !2269
  call void @llvm.dbg.declare(metadata i32* %chunk_size, metadata !2270, metadata !2153), !dbg !2271
  %2 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2272
  %call = call i64 @avio_skip(%struct.AVIOContext* %2, i64 4), !dbg !2273
  %3 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2274
  %call2 = call i32 @avio_rb32(%struct.AVIOContext* %3), !dbg !2275
  store i32 %call2, i32* %chunk_size, align 4, !dbg !2276
  %4 = load i32, i32* %chunk_size, align 4, !dbg !2277
  %cmp = icmp ne i32 %4, 80, !dbg !2279
  br i1 %cmp, label %if.then, label %if.end, !dbg !2280

if.then:                                          ; preds = %entry
  store i32 -5, i32* %retval, align 4, !dbg !2281
  br label %return, !dbg !2281

if.end:                                           ; preds = %entry
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2282
  %call3 = call i64 @avio_skip(%struct.AVIOContext* %5, i64 20), !dbg !2283
  %6 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2284
  %call4 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %6, %struct.AVCodec* null), !dbg !2285
  store %struct.AVStream* %call4, %struct.AVStream** %st, align 8, !dbg !2286
  %7 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2287
  %tobool = icmp ne %struct.AVStream* %7, null, !dbg !2287
  br i1 %tobool, label %if.end6, label %if.then5, !dbg !2289

if.then5:                                         ; preds = %if.end
  store i32 -12, i32* %retval, align 4, !dbg !2290
  br label %return, !dbg !2290

if.end6:                                          ; preds = %if.end
  %8 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2291
  %need_parsing = getelementptr inbounds %struct.AVStream, %struct.AVStream* %8, i32 0, i32 28, !dbg !2292
  store i32 2, i32* %need_parsing, align 4, !dbg !2293
  %9 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2294
  %start_time = getelementptr inbounds %struct.AVStream, %struct.AVStream* %9, i32 0, i32 5, !dbg !2295
  store i64 0, i64* %start_time, align 8, !dbg !2296
  %10 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2297
  %call7 = call i32 @avio_rb32(%struct.AVIOContext* %10), !dbg !2298
  %conv = zext i32 %call7 to i64, !dbg !2298
  %11 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2299
  %duration = getelementptr inbounds %struct.AVStream, %struct.AVStream* %11, i32 0, i32 6, !dbg !2300
  store i64 %conv, i64* %duration, align 8, !dbg !2301
  %12 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2302
  %nb_frames = getelementptr inbounds %struct.AVStream, %struct.AVStream* %12, i32 0, i32 7, !dbg !2303
  store i64 %conv, i64* %nb_frames, align 8, !dbg !2304
  %13 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2305
  %call8 = call i32 @avio_rb32(%struct.AVIOContext* %13), !dbg !2306
  store i32 %call8, i32* %i.addr.i, align 4, !dbg !2307
  %14 = load i32, i32* %i.addr.i, align 4, !dbg !2308
  %i1.i = bitcast %union.av_intfloat32* %v.i to i32*, !dbg !2309
  store i32 %14, i32* %i1.i, align 4, !dbg !2310
  %f.i = bitcast %union.av_intfloat32* %v.i to float*, !dbg !2311
  %15 = load float, float* %f.i, align 4, !dbg !2311
  %conv10 = fpext float %15 to double, !dbg !2312
  %call11 = call i64 @av_d2q(double %conv10, i32 2147483647) #1, !dbg !2313
  %16 = bitcast %struct.AVRational* %coerce to i64*, !dbg !2315
  store i64 %call11, i64* %16, align 4, !dbg !2315
  %17 = bitcast %struct.AVRational* %fps to i8*, !dbg !2315
  %18 = bitcast %struct.AVRational* %coerce to i8*, !dbg !2315
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %17, i8* %18, i64 8, i32 4, i1 false), !dbg !2316
  %19 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2318
  %call12 = call i32 @avio_rb32(%struct.AVIOContext* %19), !dbg !2319
  %20 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2320
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %20, i32 0, i32 19, !dbg !2321
  %21 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2321
  %width = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %21, i32 0, i32 11, !dbg !2322
  store i32 %call12, i32* %width, align 8, !dbg !2323
  %22 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2324
  %call13 = call i32 @avio_rb32(%struct.AVIOContext* %22), !dbg !2325
  %23 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2326
  %codecpar14 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %23, i32 0, i32 19, !dbg !2327
  %24 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar14, align 8, !dbg !2327
  %height = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %24, i32 0, i32 12, !dbg !2328
  store i32 %call13, i32* %height, align 4, !dbg !2329
  %25 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2330
  %call15 = call i64 @avio_skip(%struct.AVIOContext* %25, i64 12), !dbg !2331
  %26 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2332
  %codecpar16 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %26, i32 0, i32 19, !dbg !2333
  %27 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar16, align 8, !dbg !2333
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %27, i32 0, i32 0, !dbg !2334
  store i32 0, i32* %codec_type, align 8, !dbg !2335
  %28 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2336
  %call17 = call i32 @avio_rb32(%struct.AVIOContext* %28), !dbg !2337
  %29 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2338
  %codecpar18 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %29, i32 0, i32 19, !dbg !2339
  %30 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar18, align 8, !dbg !2339
  %codec_tag = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %30, i32 0, i32 2, !dbg !2340
  store i32 %call17, i32* %codec_tag, align 8, !dbg !2341
  %31 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2342
  %codecpar19 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %31, i32 0, i32 19, !dbg !2343
  %32 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar19, align 8, !dbg !2343
  %codec_tag20 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %32, i32 0, i32 2, !dbg !2344
  %33 = load i32, i32* %codec_tag20, align 8, !dbg !2344
  %call21 = call i32 @ff_codec_get_id(%struct.AVCodecTag* getelementptr inbounds ([0 x %struct.AVCodecTag], [0 x %struct.AVCodecTag]* @ff_codec_bmp_tags, i32 0, i32 0), i32 %33), !dbg !2345
  %34 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2346
  %codecpar22 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %34, i32 0, i32 19, !dbg !2347
  %35 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar22, align 8, !dbg !2347
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %35, i32 0, i32 1, !dbg !2348
  store i32 %call21, i32* %codec_id, align 4, !dbg !2349
  %36 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2350
  %den = getelementptr inbounds %struct.AVRational, %struct.AVRational* %fps, i32 0, i32 1, !dbg !2351
  %37 = load i32, i32* %den, align 4, !dbg !2351
  %num = getelementptr inbounds %struct.AVRational, %struct.AVRational* %fps, i32 0, i32 0, !dbg !2352
  %38 = load i32, i32* %num, align 4, !dbg !2352
  call void @avpriv_set_pts_info(%struct.AVStream* %36, i32 64, i32 %37, i32 %38), !dbg !2353
  %39 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2354
  %call23 = call i64 @avio_skip(%struct.AVIOContext* %39, i64 20), !dbg !2355
  store i32 0, i32* %retval, align 4, !dbg !2356
  br label %return, !dbg !2356

return:                                           ; preds = %if.end6, %if.then5, %if.then
  %40 = load i32, i32* %retval, align 4, !dbg !2357
  ret i32 %40, !dbg !2357
}

; Function Attrs: nounwind uwtable
define internal i32 @read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2358 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2361, metadata !2153), !dbg !2362
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2363, metadata !2153), !dbg !2364
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2365, metadata !2153), !dbg !2366
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2367
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2368
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2368
  store %struct.AVIOContext* %1, %struct.AVIOContext** %pb, align 8, !dbg !2366
  call void @llvm.dbg.declare(metadata i32* %chunk_size, metadata !2369, metadata !2153), !dbg !2370
  call void @llvm.dbg.declare(metadata i32* %payload_size, metadata !2371, metadata !2153), !dbg !2372
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2373, metadata !2153), !dbg !2374
  %2 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2375
  %call = call i32 @avio_feof(%struct.AVIOContext* %2), !dbg !2377
  %tobool = icmp ne i32 %call, 0, !dbg !2377
  br i1 %tobool, label %if.then, label %if.end, !dbg !2378

if.then:                                          ; preds = %entry
  store i32 -541478725, i32* %retval, align 4, !dbg !2379
  br label %return, !dbg !2379

if.end:                                           ; preds = %entry
  %3 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2380
  %call2 = call i64 @avio_skip(%struct.AVIOContext* %3, i64 4), !dbg !2381
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2382
  %call3 = call i32 @avio_rb32(%struct.AVIOContext* %4), !dbg !2383
  store i32 %call3, i32* %chunk_size, align 4, !dbg !2384
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2385
  %call4 = call i64 @avio_skip(%struct.AVIOContext* %5, i64 4), !dbg !2386
  %6 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2387
  %call5 = call i32 @avio_rb32(%struct.AVIOContext* %6), !dbg !2388
  store i32 %call5, i32* %payload_size, align 4, !dbg !2389
  %7 = load i32, i32* %chunk_size, align 4, !dbg !2390
  %8 = load i32, i32* %payload_size, align 4, !dbg !2392
  %add = add i32 %8, 16, !dbg !2393
  %cmp = icmp ult i32 %7, %add, !dbg !2394
  br i1 %cmp, label %if.then6, label %if.end7, !dbg !2395

if.then6:                                         ; preds = %if.end
  store i32 -5, i32* %retval, align 4, !dbg !2396
  br label %return, !dbg !2396

if.end7:                                          ; preds = %if.end
  %9 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2397
  %10 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2398
  %11 = load i32, i32* %payload_size, align 4, !dbg !2399
  %call8 = call i32 @av_get_packet(%struct.AVIOContext* %9, %struct.AVPacket* %10, i32 %11), !dbg !2400
  store i32 %call8, i32* %ret, align 4, !dbg !2401
  %12 = load i32, i32* %ret, align 4, !dbg !2402
  %cmp9 = icmp slt i32 %12, 0, !dbg !2404
  br i1 %cmp9, label %if.then10, label %if.end11, !dbg !2405

if.then10:                                        ; preds = %if.end7
  %13 = load i32, i32* %ret, align 4, !dbg !2406
  store i32 %13, i32* %retval, align 4, !dbg !2407
  br label %return, !dbg !2407

if.end11:                                         ; preds = %if.end7
  %14 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2408
  %pos = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %14, i32 0, i32 10, !dbg !2409
  %15 = load i64, i64* %pos, align 8, !dbg !2410
  %sub = sub nsw i64 %15, 16, !dbg !2410
  store i64 %sub, i64* %pos, align 8, !dbg !2410
  %16 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2411
  %duration = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %16, i32 0, i32 9, !dbg !2412
  store i64 1, i64* %duration, align 8, !dbg !2413
  %17 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2414
  %18 = load i32, i32* %chunk_size, align 4, !dbg !2415
  %19 = load i32, i32* %ret, align 4, !dbg !2416
  %add12 = add nsw i32 %19, 16, !dbg !2417
  %sub13 = sub i32 %18, %add12, !dbg !2418
  %conv = zext i32 %sub13 to i64, !dbg !2415
  %call14 = call i64 @avio_skip(%struct.AVIOContext* %17, i64 %conv), !dbg !2419
  %20 = load i32, i32* %ret, align 4, !dbg !2420
  store i32 %20, i32* %retval, align 4, !dbg !2421
  br label %return, !dbg !2421

return:                                           ; preds = %if.end11, %if.then10, %if.then6, %if.then
  %21 = load i32, i32* %retval, align 4, !dbg !2422
  ret i32 %21, !dbg !2422
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--mgsts.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!927 = !{!928}
!928 = distinct !DIGlobalVariable(name: "ff_mgsts_demuxer", scope: !0, file: !929, line: 99, type: !930, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_mgsts_demuxer)
!929 = !DIFile(filename: "libavformat/mgsts.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2146 = distinct !DISubprogram(name: "read_probe", scope: !929, file: !929, line: 27, type: !999, isLocal: true, isDefinition: true, scopeLine: 28, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2147 = !{}
...
!2156 = distinct !DILexicalBlock(scope: !2146, file: !929, line: 29, column: 9)
!2157 = !DILocation(line: 66, column: 98, scope: !2149, inlinedAt: !2158)
!2158 = distinct !DILocation(line: 31, column: 9, scope: !2156)
!2159 = !DILocation(line: 66, column: 98, scope: !2149, inlinedAt: !2160)
!2160 = distinct !DILocation(line: 29, column: 9, scope: !2156)
!2161 = !DILocalVariable(name: "p", arg: 1, scope: !2146, file: !929, line: 27, type: !1001)
!2162 = !DILocation(line: 27, column: 36, scope: !2146)
!2163 = !DILocation(line: 29, column: 52, scope: !2156)
!2164 = !DILocation(line: 29, column: 55, scope: !2156)
!2165 = !DILocation(line: 29, column: 62, scope: !2156)
!2166 = !DILocation(line: 29, column: 9, scope: !2156)
!2167 = !DILocation(line: 68, column: 16, scope: !2149, inlinedAt: !2160)
!2168 = !DILocation(line: 68, column: 19, scope: !2149, inlinedAt: !2160)
!2169 = !DILocation(line: 68, column: 24, scope: !2149, inlinedAt: !2160)
!2170 = !DILocation(line: 68, column: 38, scope: !2149, inlinedAt: !2160)
!2171 = !DILocation(line: 68, column: 41, scope: !2149, inlinedAt: !2160)
!2172 = !DILocation(line: 68, column: 46, scope: !2149, inlinedAt: !2160)
!2173 = !DILocation(line: 68, column: 34, scope: !2149, inlinedAt: !2160)
!2174 = !DILocation(line: 68, column: 57, scope: !2149, inlinedAt: !2160)
!2175 = !DILocation(line: 68, column: 69, scope: !2149, inlinedAt: !2160)
!2176 = !DILocation(line: 68, column: 72, scope: !2149, inlinedAt: !2160)
!2177 = !DILocation(line: 68, column: 79, scope: !2149, inlinedAt: !2160)
!2178 = !DILocation(line: 68, column: 84, scope: !2149, inlinedAt: !2160)
!2179 = !DILocation(line: 68, column: 99, scope: !2149, inlinedAt: !2160)
!2180 = !DILocation(line: 68, column: 102, scope: !2149, inlinedAt: !2160)
!2181 = !DILocation(line: 68, column: 109, scope: !2149, inlinedAt: !2160)
!2182 = !DILocation(line: 68, column: 114, scope: !2149, inlinedAt: !2160)
!2183 = !DILocation(line: 68, column: 94, scope: !2149, inlinedAt: !2160)
!2184 = !DILocation(line: 68, column: 63, scope: !2149, inlinedAt: !2160)
!2185 = !DILocation(line: 29, column: 66, scope: !2156)
!2186 = !DILocation(line: 29, column: 76, scope: !2156)
!2187 = !DILocation(line: 30, column: 52, scope: !2156)
!2188 = !DILocation(line: 30, column: 55, scope: !2156)
!2189 = !DILocation(line: 30, column: 59, scope: !2156)
!2190 = !DILocation(line: 30, column: 66, scope: !2156)
!2191 = !DILocation(line: 30, column: 9, scope: !2156)
!2192 = !DILocation(line: 68, column: 16, scope: !2149, inlinedAt: !2155)
!2193 = !DILocation(line: 68, column: 19, scope: !2149, inlinedAt: !2155)
!2194 = !DILocation(line: 68, column: 24, scope: !2149, inlinedAt: !2155)
!2195 = !DILocation(line: 68, column: 38, scope: !2149, inlinedAt: !2155)
!2196 = !DILocation(line: 68, column: 41, scope: !2149, inlinedAt: !2155)
!2197 = !DILocation(line: 68, column: 46, scope: !2149, inlinedAt: !2155)
!2198 = !DILocation(line: 68, column: 34, scope: !2149, inlinedAt: !2155)
!2199 = !DILocation(line: 68, column: 57, scope: !2149, inlinedAt: !2155)
!2200 = !DILocation(line: 68, column: 69, scope: !2149, inlinedAt: !2155)
!2201 = !DILocation(line: 68, column: 72, scope: !2149, inlinedAt: !2155)
!2202 = !DILocation(line: 68, column: 79, scope: !2149, inlinedAt: !2155)
!2203 = !DILocation(line: 68, column: 84, scope: !2149, inlinedAt: !2155)
!2204 = !DILocation(line: 68, column: 99, scope: !2149, inlinedAt: !2155)
!2205 = !DILocation(line: 68, column: 102, scope: !2149, inlinedAt: !2155)
!2206 = !DILocation(line: 68, column: 109, scope: !2149, inlinedAt: !2155)
!2207 = !DILocation(line: 68, column: 114, scope: !2149, inlinedAt: !2155)
!2208 = !DILocation(line: 68, column: 94, scope: !2149, inlinedAt: !2155)
!2209 = !DILocation(line: 68, column: 63, scope: !2149, inlinedAt: !2155)
!2210 = !DILocation(line: 30, column: 70, scope: !2156)
!2211 = !DILocation(line: 30, column: 80, scope: !2156)
!2212 = !DILocation(line: 31, column: 52, scope: !2156)
!2213 = !DILocation(line: 31, column: 55, scope: !2156)
!2214 = !DILocation(line: 31, column: 59, scope: !2156)
!2215 = !DILocation(line: 31, column: 67, scope: !2156)
!2216 = !DILocation(line: 31, column: 9, scope: !2156)
...
!2235 = !DILocation(line: 31, column: 71, scope: !2156)
!2236 = !DILocation(line: 29, column: 9, scope: !2237)
!2237 = !DILexicalBlockFile(scope: !2146, file: !929, discriminator: 1)
!2238 = !DILocation(line: 32, column: 9, scope: !2156)
!2239 = !DILocation(line: 33, column: 5, scope: !2146)
!2240 = !DILocation(line: 34, column: 1, scope: !2146)
!2241 = distinct !DISubprogram(name: "read_header", scope: !929, file: !929, line: 36, type: !2242, isLocal: true, isDefinition: true, scopeLine: 37, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
...
!2246 = !DILocalVariable(name: "i", arg: 1, scope: !2247, file: !2248, line: 40, type: !923)
!2247 = distinct !DISubprogram(name: "av_int2float", scope: !2248, file: !2248, line: 40, type: !2249, isLocal: true, isDefinition: true, scopeLine: 41, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2248 = !DIFile(filename: "./libavutil/intfloat.h", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
!2249 = !DISubroutineType(types: !2250)
!2250 = !{!1476, !923}
!2251 = !DILocation(line: 40, column: 74, scope: !2247, inlinedAt: !2252)
!2252 = distinct !DILocation(line: 57, column: 18, scope: !2253)
!2253 = !DILexicalBlockFile(scope: !2241, file: !929, discriminator: 1)
!2254 = !DILocalVariable(name: "v", scope: !2247, file: !2248, line: 42, type: !2255)
!2255 = distinct !DICompositeType(tag: DW_TAG_union_type, name: "av_intfloat32", file: !2248, line: 27, size: 32, align: 32, elements: !2256)
!2256 = !{!2257, !2258}
!2257 = !DIDerivedType(tag: DW_TAG_member, name: "i", scope: !2255, file: !2248, line: 28, baseType: !923, size: 32, align: 32)
!2258 = !DIDerivedType(tag: DW_TAG_member, name: "f", scope: !2255, file: !2248, line: 29, baseType: !1476, size: 32, align: 32)
!2259 = !DILocation(line: 42, column: 25, scope: !2247, inlinedAt: !2252)
!2260 = !DILocalVariable(name: "s", arg: 1, scope: !2241, file: !929, line: 36, type: !2244)
!2261 = !DILocation(line: 36, column: 41, scope: !2241)
!2262 = !DILocalVariable(name: "pb", scope: !2241, file: !929, line: 38, type: !1222)
!2263 = !DILocation(line: 38, column: 18, scope: !2241)
!2264 = !DILocation(line: 38, column: 23, scope: !2241)
!2265 = !DILocation(line: 38, column: 26, scope: !2241)
!2266 = !DILocalVariable(name: "st", scope: !2241, file: !929, line: 39, type: !1290)
!2267 = !DILocation(line: 39, column: 15, scope: !2241)
!2268 = !DILocalVariable(name: "fps", scope: !2241, file: !929, line: 40, type: !1124)
!2269 = !DILocation(line: 40, column: 16, scope: !2241)
!2270 = !DILocalVariable(name: "chunk_size", scope: !2241, file: !929, line: 41, type: !923)
!2271 = !DILocation(line: 41, column: 14, scope: !2241)
!2272 = !DILocation(line: 43, column: 15, scope: !2241)
!2273 = !DILocation(line: 43, column: 5, scope: !2241)
!2274 = !DILocation(line: 44, column: 28, scope: !2241)
!2275 = !DILocation(line: 44, column: 18, scope: !2241)
!2276 = !DILocation(line: 44, column: 16, scope: !2241)
!2277 = !DILocation(line: 45, column: 9, scope: !2278)
!2278 = distinct !DILexicalBlock(scope: !2241, file: !929, line: 45, column: 9)
!2279 = !DILocation(line: 45, column: 20, scope: !2278)
!2280 = !DILocation(line: 45, column: 9, scope: !2241)
!2281 = !DILocation(line: 46, column: 9, scope: !2278)
!2282 = !DILocation(line: 47, column: 15, scope: !2241)
!2283 = !DILocation(line: 47, column: 5, scope: !2241)
!2284 = !DILocation(line: 49, column: 30, scope: !2241)
!2285 = !DILocation(line: 49, column: 10, scope: !2241)
!2286 = !DILocation(line: 49, column: 8, scope: !2241)
!2287 = !DILocation(line: 50, column: 10, scope: !2288)
!2288 = distinct !DILexicalBlock(scope: !2241, file: !929, line: 50, column: 9)
!2289 = !DILocation(line: 50, column: 9, scope: !2241)
!2290 = !DILocation(line: 51, column: 9, scope: !2288)
!2291 = !DILocation(line: 53, column: 5, scope: !2241)
!2292 = !DILocation(line: 53, column: 9, scope: !2241)
!2293 = !DILocation(line: 53, column: 22, scope: !2241)
!2294 = !DILocation(line: 54, column: 5, scope: !2241)
!2295 = !DILocation(line: 54, column: 9, scope: !2241)
!2296 = !DILocation(line: 54, column: 20, scope: !2241)
!2297 = !DILocation(line: 56, column: 30, scope: !2241)
!2298 = !DILocation(line: 56, column: 20, scope: !2241)
!2299 = !DILocation(line: 56, column: 5, scope: !2241)
!2300 = !DILocation(line: 56, column: 9, scope: !2241)
!2301 = !DILocation(line: 56, column: 18, scope: !2241)
!2302 = !DILocation(line: 55, column: 5, scope: !2241)
!2303 = !DILocation(line: 55, column: 9, scope: !2241)
!2304 = !DILocation(line: 55, column: 19, scope: !2241)
!2305 = !DILocation(line: 57, column: 41, scope: !2241)
!2306 = !DILocation(line: 57, column: 31, scope: !2241)
!2307 = !DILocation(line: 57, column: 18, scope: !2253)
!2308 = !DILocation(line: 43, column: 11, scope: !2247, inlinedAt: !2252)
!2309 = !DILocation(line: 43, column: 7, scope: !2247, inlinedAt: !2252)
!2310 = !DILocation(line: 43, column: 9, scope: !2247, inlinedAt: !2252)
!2311 = !DILocation(line: 44, column: 14, scope: !2247, inlinedAt: !2252)
!2312 = !DILocation(line: 57, column: 18, scope: !2241)
!2313 = !DILocation(line: 57, column: 11, scope: !2314)
!2314 = !DILexicalBlockFile(scope: !2241, file: !929, discriminator: 2)
!2315 = !DILocation(line: 57, column: 11, scope: !2241)
!2316 = !DILocation(line: 57, column: 11, scope: !2317)
!2317 = !DILexicalBlockFile(scope: !2241, file: !929, discriminator: 3)
!2318 = !DILocation(line: 58, column: 37, scope: !2241)
!2319 = !DILocation(line: 58, column: 27, scope: !2241)
!2320 = !DILocation(line: 58, column: 5, scope: !2241)
!2321 = !DILocation(line: 58, column: 9, scope: !2241)
!2322 = !DILocation(line: 58, column: 19, scope: !2241)
!2323 = !DILocation(line: 58, column: 25, scope: !2241)
!2324 = !DILocation(line: 59, column: 38, scope: !2241)
!2325 = !DILocation(line: 59, column: 28, scope: !2241)
!2326 = !DILocation(line: 59, column: 5, scope: !2241)
!2327 = !DILocation(line: 59, column: 9, scope: !2241)
!2328 = !DILocation(line: 59, column: 19, scope: !2241)
!2329 = !DILocation(line: 59, column: 26, scope: !2241)
!2330 = !DILocation(line: 60, column: 15, scope: !2241)
!2331 = !DILocation(line: 60, column: 5, scope: !2241)
!2332 = !DILocation(line: 61, column: 5, scope: !2241)
!2333 = !DILocation(line: 61, column: 9, scope: !2241)
!2334 = !DILocation(line: 61, column: 19, scope: !2241)
!2335 = !DILocation(line: 61, column: 30, scope: !2241)
!2336 = !DILocation(line: 62, column: 41, scope: !2241)
!2337 = !DILocation(line: 62, column: 31, scope: !2241)
!2338 = !DILocation(line: 62, column: 5, scope: !2241)
!2339 = !DILocation(line: 62, column: 9, scope: !2241)
!2340 = !DILocation(line: 62, column: 19, scope: !2241)
!2341 = !DILocation(line: 62, column: 29, scope: !2241)
!2342 = !DILocation(line: 64, column: 48, scope: !2241)
!2343 = !DILocation(line: 64, column: 52, scope: !2241)
!2344 = !DILocation(line: 64, column: 62, scope: !2241)
!2345 = !DILocation(line: 63, column: 30, scope: !2241)
!2346 = !DILocation(line: 63, column: 5, scope: !2241)
!2347 = !DILocation(line: 63, column: 9, scope: !2241)
!2348 = !DILocation(line: 63, column: 19, scope: !2241)
!2349 = !DILocation(line: 63, column: 28, scope: !2241)
!2350 = !DILocation(line: 65, column: 25, scope: !2241)
!2351 = !DILocation(line: 65, column: 37, scope: !2241)
!2352 = !DILocation(line: 65, column: 46, scope: !2241)
!2353 = !DILocation(line: 65, column: 5, scope: !2241)
!2354 = !DILocation(line: 66, column: 15, scope: !2241)
!2355 = !DILocation(line: 66, column: 5, scope: !2241)
!2356 = !DILocation(line: 68, column: 5, scope: !2241)
!2357 = !DILocation(line: 69, column: 1, scope: !2241)
!2358 = distinct !DISubprogram(name: "read_packet", scope: !929, file: !929, line: 71, type: !2359, isLocal: true, isDefinition: true, scopeLine: 72, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2359 = !DISubroutineType(types: !2360)
!2360 = !{!926, !2244, !1041}
!2361 = !DILocalVariable(name: "s", arg: 1, scope: !2358, file: !929, line: 71, type: !2244)
!2362 = !DILocation(line: 71, column: 41, scope: !2358)
!2363 = !DILocalVariable(name: "pkt", arg: 2, scope: !2358, file: !929, line: 71, type: !1041)
!2364 = !DILocation(line: 71, column: 54, scope: !2358)
!2365 = !DILocalVariable(name: "pb", scope: !2358, file: !929, line: 73, type: !1222)
!2366 = !DILocation(line: 73, column: 18, scope: !2358)
!2367 = !DILocation(line: 73, column: 23, scope: !2358)
!2368 = !DILocation(line: 73, column: 26, scope: !2358)
!2369 = !DILocalVariable(name: "chunk_size", scope: !2358, file: !929, line: 74, type: !923)
!2370 = !DILocation(line: 74, column: 14, scope: !2358)
!2371 = !DILocalVariable(name: "payload_size", scope: !2358, file: !929, line: 74, type: !923)
!2372 = !DILocation(line: 74, column: 26, scope: !2358)
!2373 = !DILocalVariable(name: "ret", scope: !2358, file: !929, line: 75, type: !926)
!2374 = !DILocation(line: 75, column: 9, scope: !2358)
!2375 = !DILocation(line: 77, column: 19, scope: !2376)
!2376 = distinct !DILexicalBlock(scope: !2358, file: !929, line: 77, column: 9)
!2377 = !DILocation(line: 77, column: 9, scope: !2376)
!2378 = !DILocation(line: 77, column: 9, scope: !2358)
!2379 = !DILocation(line: 78, column: 9, scope: !2376)
!2380 = !DILocation(line: 80, column: 15, scope: !2358)
!2381 = !DILocation(line: 80, column: 5, scope: !2358)
!2382 = !DILocation(line: 81, column: 28, scope: !2358)
!2383 = !DILocation(line: 81, column: 18, scope: !2358)
!2384 = !DILocation(line: 81, column: 16, scope: !2358)
!2385 = !DILocation(line: 82, column: 15, scope: !2358)
!2386 = !DILocation(line: 82, column: 5, scope: !2358)
!2387 = !DILocation(line: 83, column: 30, scope: !2358)
!2388 = !DILocation(line: 83, column: 20, scope: !2358)
!2389 = !DILocation(line: 83, column: 18, scope: !2358)
!2390 = !DILocation(line: 85, column: 9, scope: !2391)
!2391 = distinct !DILexicalBlock(scope: !2358, file: !929, line: 85, column: 9)
!2392 = !DILocation(line: 85, column: 22, scope: !2391)
!2393 = !DILocation(line: 85, column: 35, scope: !2391)
!2394 = !DILocation(line: 85, column: 20, scope: !2391)
!2395 = !DILocation(line: 85, column: 9, scope: !2358)
!2396 = !DILocation(line: 86, column: 9, scope: !2391)
!2397 = !DILocation(line: 88, column: 25, scope: !2358)
!2398 = !DILocation(line: 88, column: 29, scope: !2358)
!2399 = !DILocation(line: 88, column: 34, scope: !2358)
!2400 = !DILocation(line: 88, column: 11, scope: !2358)
!2401 = !DILocation(line: 88, column: 9, scope: !2358)
!2402 = !DILocation(line: 89, column: 9, scope: !2403)
!2403 = distinct !DILexicalBlock(scope: !2358, file: !929, line: 89, column: 9)
!2404 = !DILocation(line: 89, column: 13, scope: !2403)
!2405 = !DILocation(line: 89, column: 9, scope: !2358)
!2406 = !DILocation(line: 90, column: 16, scope: !2403)
!2407 = !DILocation(line: 90, column: 9, scope: !2403)
!2408 = !DILocation(line: 92, column: 5, scope: !2358)
!2409 = !DILocation(line: 92, column: 10, scope: !2358)
!2410 = !DILocation(line: 92, column: 14, scope: !2358)
!2411 = !DILocation(line: 93, column: 5, scope: !2358)
!2412 = !DILocation(line: 93, column: 10, scope: !2358)
!2413 = !DILocation(line: 93, column: 19, scope: !2358)
!2414 = !DILocation(line: 94, column: 15, scope: !2358)
!2415 = !DILocation(line: 94, column: 19, scope: !2358)
!2416 = !DILocation(line: 94, column: 33, scope: !2358)
!2417 = !DILocation(line: 94, column: 37, scope: !2358)
!2418 = !DILocation(line: 94, column: 30, scope: !2358)
!2419 = !DILocation(line: 94, column: 5, scope: !2358)
!2420 = !DILocation(line: 96, column: 12, scope: !2358)
!2421 = !DILocation(line: 96, column: 5, scope: !2358)
!2422 = !DILocation(line: 97, column: 1, scope: !2358)
