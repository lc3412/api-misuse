; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--ads.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--ads.o.i"
...
@ff_ads_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i32 0, i32 0), %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 0, i32 (%struct.AVProbeData*)* @ads_probe, i32 (%struct.AVFormatContext*)* @ads_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @ads_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
...
define internal i32 @ads_probe(%struct.AVProbeData* %p) #0 !dbg !2140 {
entry:
  ...
  br i1 %tobool, label %if.then, label %lor.lhs.false, !dbg !2149
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %add.ptr = getelementptr inbounds i8, i8* %3, i64 32, !dbg !2152
  %call2 = call i32 @memcmp(i8* %add.ptr, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i32 0, i32 0), i64 4) #4, !dbg !2153
  %tobool3 = icmp ne i32 %call2, 0, !dbg !2153
  br i1 %tobool3, label %if.then, label %if.end, !dbg !2154
...
if.end:                                           ; preds = %lor.lhs.false
  store i32 66, i32* %retval, align 4, !dbg !2157
...
; Function Attrs: nounwind uwtable
define internal i32 @ads_read_header(%struct.AVFormatContext* %s) #0 !dbg !2159 {
entry:
  %retval = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata i32* %align, metadata !2166, metadata !2143), !dbg !2167
  call void @llvm.dbg.declare(metadata i32* %codec, metadata !2168, metadata !2143), !dbg !2169
  call void @llvm.dbg.declare(metadata i32* %size, metadata !2170, metadata !2143), !dbg !2171
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2172, metadata !2143), !dbg !2173
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2174
  %call = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %0, %struct.AVCodec* null), !dbg !2175
  store %struct.AVStream* %call, %struct.AVStream** %st, align 8, !dbg !2176
  %1 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2177
  %tobool = icmp ne %struct.AVStream* %1, null, !dbg !2177
  br i1 %tobool, label %if.end, label %if.then, !dbg !2179

if.then:                                          ; preds = %entry
  store i32 -12, i32* %retval, align 4, !dbg !2180
  br label %return, !dbg !2180

if.end:                                           ; preds = %entry
  %2 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2181
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %2, i32 0, i32 4, !dbg !2182
  %3 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2182
  %call1 = call i64 @avio_skip(%struct.AVIOContext* %3, i64 8), !dbg !2183
  %4 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2184
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %4, i32 0, i32 19, !dbg !2185
  %5 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2185
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %5, i32 0, i32 0, !dbg !2186
  store i32 1, i32* %codec_type, align 8, !dbg !2187
  %6 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2188
  %pb2 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %6, i32 0, i32 4, !dbg !2189
  %7 = load %struct.AVIOContext*, %struct.AVIOContext** %pb2, align 8, !dbg !2189
  %call3 = call i32 @avio_rl32(%struct.AVIOContext* %7), !dbg !2190
  store i32 %call3, i32* %codec, align 4, !dbg !2191
  %8 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2192
  %pb4 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %8, i32 0, i32 4, !dbg !2193
  %9 = load %struct.AVIOContext*, %struct.AVIOContext** %pb4, align 8, !dbg !2193
  %call5 = call i32 @avio_rl32(%struct.AVIOContext* %9), !dbg !2194
  %10 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2195
  %codecpar6 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %10, i32 0, i32 19, !dbg !2196
  %11 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar6, align 8, !dbg !2196
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %11, i32 0, i32 23, !dbg !2197
  store i32 %call5, i32* %sample_rate, align 4, !dbg !2198
  %12 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2199
  %codecpar7 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %12, i32 0, i32 19, !dbg !2201
  %13 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar7, align 8, !dbg !2201
  %sample_rate8 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %13, i32 0, i32 23, !dbg !2202
  %14 = load i32, i32* %sample_rate8, align 4, !dbg !2202
  %cmp = icmp sle i32 %14, 0, !dbg !2203
  br i1 %cmp, label %if.then9, label %if.end10, !dbg !2204
...
if.end10:                                         ; preds = %if.end
  %15 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2206
  %pb11 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %15, i32 0, i32 4, !dbg !2207
  %16 = load %struct.AVIOContext*, %struct.AVIOContext** %pb11, align 8, !dbg !2207
  %call12 = call i32 @avio_rl32(%struct.AVIOContext* %16), !dbg !2208
  %17 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2209
  %codecpar13 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %17, i32 0, i32 19, !dbg !2210
  %18 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar13, align 8, !dbg !2210
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %18, i32 0, i32 22, !dbg !2211
  store i32 %call12, i32* %channels, align 8, !dbg !2212
  %19 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2213
  %codecpar14 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %19, i32 0, i32 19, !dbg !2215
  %20 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar14, align 8, !dbg !2215
  %channels15 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %20, i32 0, i32 22, !dbg !2216
  %21 = load i32, i32* %channels15, align 8, !dbg !2216
  %cmp16 = icmp sle i32 %21, 0, !dbg !2217
  br i1 %cmp16, label %if.then17, label %if.end18, !dbg !2218
...
if.end18:                                         ; preds = %if.end10
  %22 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2220
  %pb19 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %22, i32 0, i32 4, !dbg !2221
  %23 = load %struct.AVIOContext*, %struct.AVIOContext** %pb19, align 8, !dbg !2221
  %call20 = call i32 @avio_rl32(%struct.AVIOContext* %23), !dbg !2222
  store i32 %call20, i32* %align, align 4, !dbg !2223
  %24 = load i32, i32* %align, align 4, !dbg !2224
  %cmp21 = icmp sle i32 %24, 0, !dbg !2226
  br i1 %cmp21, label %if.then25, label %lor.lhs.false, !dbg !2227

lor.lhs.false:                                    ; preds = %if.end18
  %25 = load i32, i32* %align, align 4, !dbg !2228
  %26 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2230
  %codecpar22 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %26, i32 0, i32 19, !dbg !2231
  %27 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar22, align 8, !dbg !2231
  %channels23 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %27, i32 0, i32 22, !dbg !2232
  %28 = load i32, i32* %channels23, align 8, !dbg !2232
  %div = sdiv i32 2147483647, %28, !dbg !2233
  %cmp24 = icmp sgt i32 %25, %div, !dbg !2234
  br i1 %cmp24, label %if.then25, label %if.end26, !dbg !2235
...
if.end26:                                         ; preds = %lor.lhs.false
  %29 = load i32, i32* %codec, align 4, !dbg !2237
  %cmp27 = icmp eq i32 %29, 1, !dbg !2239
  br i1 %cmp27, label %if.then28, label %if.else, !dbg !2240

if.then28:                                        ; preds = %if.end26
  %30 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2241
  %codecpar29 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %30, i32 0, i32 19, !dbg !2242
  %31 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar29, align 8, !dbg !2242
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %31, i32 0, i32 1, !dbg !2243
  store i32 65554, i32* %codec_id, align 4, !dbg !2244
  br label %if.end32, !dbg !2241

if.else:                                          ; preds = %if.end26
  %32 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2245
  %codecpar30 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %32, i32 0, i32 19, !dbg !2246
  %33 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar30, align 8, !dbg !2246
  %codec_id31 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %33, i32 0, i32 1, !dbg !2247
  store i32 71686, i32* %codec_id31, align 4, !dbg !2248
  br label %if.end32

if.end32:                                         ; preds = %if.else, %if.then28
  %34 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2249
  %codecpar33 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %34, i32 0, i32 19, !dbg !2250
  %35 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar33, align 8, !dbg !2250
  %channels34 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %35, i32 0, i32 22, !dbg !2251
  %36 = load i32, i32* %channels34, align 8, !dbg !2251
  %37 = load i32, i32* %align, align 4, !dbg !2252
  %mul = mul nsw i32 %36, %37, !dbg !2253
  %38 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2254
  %codecpar35 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %38, i32 0, i32 19, !dbg !2255
  %39 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar35, align 8, !dbg !2255
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %39, i32 0, i32 24, !dbg !2256
  store i32 %mul, i32* %block_align, align 8, !dbg !2257
  %40 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2258
  %pb36 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %40, i32 0, i32 4, !dbg !2259
  %41 = load %struct.AVIOContext*, %struct.AVIOContext** %pb36, align 8, !dbg !2259
  %call37 = call i64 @avio_skip(%struct.AVIOContext* %41, i64 12), !dbg !2260
  %42 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2261
  %pb38 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %42, i32 0, i32 4, !dbg !2262
  %43 = load %struct.AVIOContext*, %struct.AVIOContext** %pb38, align 8, !dbg !2262
  %call39 = call i32 @avio_rl32(%struct.AVIOContext* %43), !dbg !2263
  store i32 %call39, i32* %size, align 4, !dbg !2264
  %44 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2265
  %codecpar40 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %44, i32 0, i32 19, !dbg !2267
  %45 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar40, align 8, !dbg !2267
  %codec_id41 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %45, i32 0, i32 1, !dbg !2268
  %46 = load i32, i32* %codec_id41, align 4, !dbg !2268
  %cmp42 = icmp eq i32 %46, 71686, !dbg !2269
  br i1 %cmp42, label %if.then43, label %if.end49, !dbg !2270

if.then43:                                        ; preds = %if.end32
  %47 = load i32, i32* %size, align 4, !dbg !2271
  %sub = sub nsw i32 %47, 64, !dbg !2272
  %div44 = sdiv i32 %sub, 16, !dbg !2273
  %48 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2274
  %codecpar45 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %48, i32 0, i32 19, !dbg !2275
  %49 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar45, align 8, !dbg !2275
  %channels46 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %49, i32 0, i32 22, !dbg !2276
  %50 = load i32, i32* %channels46, align 8, !dbg !2276
  %div47 = sdiv i32 %div44, %50, !dbg !2277
  %mul48 = mul nsw i32 %div47, 28, !dbg !2278
  %conv = sext i32 %mul48 to i64, !dbg !2279
  %51 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2280
  %duration = getelementptr inbounds %struct.AVStream, %struct.AVStream* %51, i32 0, i32 6, !dbg !2281
  store i64 %conv, i64* %duration, align 8, !dbg !2282
  br label %if.end49, !dbg !2280

if.end49:                                         ; preds = %if.then43, %if.end32
  %52 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2283
  %53 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2284
  %codecpar50 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %53, i32 0, i32 19, !dbg !2285
  %54 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar50, align 8, !dbg !2285
  %sample_rate51 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %54, i32 0, i32 23, !dbg !2286
  %55 = load i32, i32* %sample_rate51, align 4, !dbg !2286
  call void @avpriv_set_pts_info(%struct.AVStream* %52, i32 64, i32 1, i32 %55), !dbg !2287
  store i32 0, i32* %retval, align 4, !dbg !2288
  br label %return, !dbg !2288

return:                                           ; preds = %if.end49, %if.then25, %if.then17, %if.then9, %if.then
  %56 = load i32, i32* %retval, align 4, !dbg !2289
  ret i32 %56, !dbg !2289
}

; Function Attrs: nounwind uwtable
define internal i32 @ads_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2290 {
entry:
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2293, metadata !2143), !dbg !2294
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2295, metadata !2143), !dbg !2296
  call void @llvm.dbg.declare(metadata %struct.AVCodecParameters** %par, metadata !2297, metadata !2143), !dbg !2298
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2299
  %streams = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 7, !dbg !2300
  %1 = load %struct.AVStream**, %struct.AVStream*** %streams, align 8, !dbg !2300
  %arrayidx = getelementptr inbounds %struct.AVStream*, %struct.AVStream** %1, i64 0, !dbg !2299
  %2 = load %struct.AVStream*, %struct.AVStream** %arrayidx, align 8, !dbg !2299
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %2, i32 0, i32 19, !dbg !2301
  %3 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2301
  store %struct.AVCodecParameters* %3, %struct.AVCodecParameters** %par, align 8, !dbg !2298
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2302, metadata !2143), !dbg !2303
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2304
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %4, i32 0, i32 4, !dbg !2305
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2305
  %6 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2306
  %7 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2307
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %7, i32 0, i32 24, !dbg !2308
  %8 = load i32, i32* %block_align, align 8, !dbg !2308
  %call = call i32 @av_get_packet(%struct.AVIOContext* %5, %struct.AVPacket* %6, i32 %8), !dbg !2309
  store i32 %call, i32* %ret, align 4, !dbg !2310
  %9 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2311
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %9, i32 0, i32 5, !dbg !2312
  store i32 0, i32* %stream_index, align 4, !dbg !2313
  %10 = load i32, i32* %ret, align 4, !dbg !2314
  ret i32 %10, !dbg !2315
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--ads.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!919 = !{!920}
!920 = distinct !DIGlobalVariable(name: "ff_ads_demuxer", scope: !0, file: !921, line: 82, type: !922, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_ads_demuxer)
!921 = !DIFile(filename: "libavformat/ads.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2140 = distinct !DISubprogram(name: "ads_probe", scope: !921, file: !921, line: 26, type: !991, isLocal: true, isDefinition: true, scopeLine: 27, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2141 = !{}
!2142 = !DILocalVariable(name: "p", arg: 1, scope: !2140, file: !921, line: 26, type: !993)
!2143 = !DIExpression()
!2144 = !DILocation(line: 26, column: 35, scope: !2140)
!2145 = !DILocation(line: 28, column: 16, scope: !2146)
!2146 = distinct !DILexicalBlock(scope: !2140, file: !921, line: 28, column: 9)
!2147 = !DILocation(line: 28, column: 19, scope: !2146)
!2148 = !DILocation(line: 28, column: 9, scope: !2146)
!2149 = !DILocation(line: 28, column: 35, scope: !2146)
!2150 = !DILocation(line: 29, column: 16, scope: !2146)
!2151 = !DILocation(line: 29, column: 19, scope: !2146)
!2152 = !DILocation(line: 29, column: 22, scope: !2146)
!2153 = !DILocation(line: 29, column: 9, scope: !2146)
!2154 = !DILocation(line: 28, column: 9, scope: !2155)
!2155 = !DILexicalBlockFile(scope: !2140, file: !921, discriminator: 1)
!2156 = !DILocation(line: 30, column: 9, scope: !2146)
!2157 = !DILocation(line: 32, column: 5, scope: !2140)
!2158 = !DILocation(line: 33, column: 1, scope: !2140)
!2159 = distinct !DISubprogram(name: "ads_read_header", scope: !921, file: !921, line: 35, type: !2160, isLocal: true, isDefinition: true, scopeLine: 36, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
...
!2164 = !DILocalVariable(name: "s", arg: 1, scope: !2159, file: !921, line: 35, type: !2162)
!2165 = !DILocation(line: 35, column: 45, scope: !2159)
!2166 = !DILocalVariable(name: "align", scope: !2159, file: !921, line: 37, type: !917)
!2167 = !DILocation(line: 37, column: 9, scope: !2159)
!2168 = !DILocalVariable(name: "codec", scope: !2159, file: !921, line: 37, type: !917)
!2169 = !DILocation(line: 37, column: 16, scope: !2159)
!2170 = !DILocalVariable(name: "size", scope: !2159, file: !921, line: 37, type: !917)
!2171 = !DILocation(line: 37, column: 23, scope: !2159)
!2172 = !DILocalVariable(name: "st", scope: !2159, file: !921, line: 38, type: !1283)
!2173 = !DILocation(line: 38, column: 15, scope: !2159)
!2174 = !DILocation(line: 40, column: 30, scope: !2159)
!2175 = !DILocation(line: 40, column: 10, scope: !2159)
!2176 = !DILocation(line: 40, column: 8, scope: !2159)
!2177 = !DILocation(line: 41, column: 10, scope: !2178)
!2178 = distinct !DILexicalBlock(scope: !2159, file: !921, line: 41, column: 9)
!2179 = !DILocation(line: 41, column: 9, scope: !2159)
!2180 = !DILocation(line: 42, column: 9, scope: !2178)
!2181 = !DILocation(line: 44, column: 15, scope: !2159)
!2182 = !DILocation(line: 44, column: 18, scope: !2159)
!2183 = !DILocation(line: 44, column: 5, scope: !2159)
!2184 = !DILocation(line: 45, column: 5, scope: !2159)
!2185 = !DILocation(line: 45, column: 9, scope: !2159)
!2186 = !DILocation(line: 45, column: 19, scope: !2159)
!2187 = !DILocation(line: 45, column: 30, scope: !2159)
!2188 = !DILocation(line: 46, column: 23, scope: !2159)
!2189 = !DILocation(line: 46, column: 26, scope: !2159)
!2190 = !DILocation(line: 46, column: 13, scope: !2159)
!2191 = !DILocation(line: 46, column: 11, scope: !2159)
!2192 = !DILocation(line: 47, column: 43, scope: !2159)
!2193 = !DILocation(line: 47, column: 46, scope: !2159)
!2194 = !DILocation(line: 47, column: 33, scope: !2159)
!2195 = !DILocation(line: 47, column: 5, scope: !2159)
!2196 = !DILocation(line: 47, column: 9, scope: !2159)
!2197 = !DILocation(line: 47, column: 19, scope: !2159)
!2198 = !DILocation(line: 47, column: 31, scope: !2159)
!2199 = !DILocation(line: 48, column: 9, scope: !2200)
!2200 = distinct !DILexicalBlock(scope: !2159, file: !921, line: 48, column: 9)
!2201 = !DILocation(line: 48, column: 13, scope: !2200)
!2202 = !DILocation(line: 48, column: 23, scope: !2200)
!2203 = !DILocation(line: 48, column: 35, scope: !2200)
!2204 = !DILocation(line: 48, column: 9, scope: !2159)
!2205 = !DILocation(line: 49, column: 9, scope: !2200)
!2206 = !DILocation(line: 50, column: 40, scope: !2159)
!2207 = !DILocation(line: 50, column: 43, scope: !2159)
!2208 = !DILocation(line: 50, column: 30, scope: !2159)
!2209 = !DILocation(line: 50, column: 5, scope: !2159)
!2210 = !DILocation(line: 50, column: 9, scope: !2159)
!2211 = !DILocation(line: 50, column: 19, scope: !2159)
!2212 = !DILocation(line: 50, column: 28, scope: !2159)
!2213 = !DILocation(line: 51, column: 9, scope: !2214)
!2214 = distinct !DILexicalBlock(scope: !2159, file: !921, line: 51, column: 9)
!2215 = !DILocation(line: 51, column: 13, scope: !2214)
!2216 = !DILocation(line: 51, column: 23, scope: !2214)
!2217 = !DILocation(line: 51, column: 32, scope: !2214)
!2218 = !DILocation(line: 51, column: 9, scope: !2159)
!2219 = !DILocation(line: 52, column: 9, scope: !2214)
!2220 = !DILocation(line: 53, column: 23, scope: !2159)
!2221 = !DILocation(line: 53, column: 26, scope: !2159)
!2222 = !DILocation(line: 53, column: 13, scope: !2159)
!2223 = !DILocation(line: 53, column: 11, scope: !2159)
!2224 = !DILocation(line: 54, column: 9, scope: !2225)
!2225 = distinct !DILexicalBlock(scope: !2159, file: !921, line: 54, column: 9)
!2226 = !DILocation(line: 54, column: 15, scope: !2225)
!2227 = !DILocation(line: 54, column: 20, scope: !2225)
!2228 = !DILocation(line: 54, column: 23, scope: !2229)
!2229 = !DILexicalBlockFile(scope: !2225, file: !921, discriminator: 1)
!2230 = !DILocation(line: 54, column: 44, scope: !2229)
!2231 = !DILocation(line: 54, column: 48, scope: !2229)
!2232 = !DILocation(line: 54, column: 58, scope: !2229)
!2233 = !DILocation(line: 54, column: 42, scope: !2229)
!2234 = !DILocation(line: 54, column: 29, scope: !2229)
!2235 = !DILocation(line: 54, column: 9, scope: !2229)
!2236 = !DILocation(line: 55, column: 9, scope: !2225)
!2237 = !DILocation(line: 57, column: 9, scope: !2238)
!2238 = distinct !DILexicalBlock(scope: !2159, file: !921, line: 57, column: 9)
!2239 = !DILocation(line: 57, column: 15, scope: !2238)
!2240 = !DILocation(line: 57, column: 9, scope: !2159)
!2241 = !DILocation(line: 58, column: 9, scope: !2238)
!2242 = !DILocation(line: 58, column: 13, scope: !2238)
!2243 = !DILocation(line: 58, column: 23, scope: !2238)
!2244 = !DILocation(line: 58, column: 32, scope: !2238)
!2245 = !DILocation(line: 60, column: 9, scope: !2238)
!2246 = !DILocation(line: 60, column: 13, scope: !2238)
!2247 = !DILocation(line: 60, column: 23, scope: !2238)
!2248 = !DILocation(line: 60, column: 32, scope: !2238)
!2249 = !DILocation(line: 62, column: 33, scope: !2159)
!2250 = !DILocation(line: 62, column: 37, scope: !2159)
!2251 = !DILocation(line: 62, column: 47, scope: !2159)
!2252 = !DILocation(line: 62, column: 58, scope: !2159)
!2253 = !DILocation(line: 62, column: 56, scope: !2159)
!2254 = !DILocation(line: 62, column: 5, scope: !2159)
!2255 = !DILocation(line: 62, column: 9, scope: !2159)
!2256 = !DILocation(line: 62, column: 19, scope: !2159)
!2257 = !DILocation(line: 62, column: 31, scope: !2159)
!2258 = !DILocation(line: 63, column: 15, scope: !2159)
!2259 = !DILocation(line: 63, column: 18, scope: !2159)
!2260 = !DILocation(line: 63, column: 5, scope: !2159)
!2261 = !DILocation(line: 64, column: 22, scope: !2159)
!2262 = !DILocation(line: 64, column: 25, scope: !2159)
!2263 = !DILocation(line: 64, column: 12, scope: !2159)
!2264 = !DILocation(line: 64, column: 10, scope: !2159)
!2265 = !DILocation(line: 65, column: 9, scope: !2266)
!2266 = distinct !DILexicalBlock(scope: !2159, file: !921, line: 65, column: 9)
!2267 = !DILocation(line: 65, column: 13, scope: !2266)
!2268 = !DILocation(line: 65, column: 23, scope: !2266)
!2269 = !DILocation(line: 65, column: 32, scope: !2266)
!2270 = !DILocation(line: 65, column: 9, scope: !2159)
!2271 = !DILocation(line: 66, column: 25, scope: !2266)
!2272 = !DILocation(line: 66, column: 30, scope: !2266)
!2273 = !DILocation(line: 66, column: 38, scope: !2266)
!2274 = !DILocation(line: 66, column: 45, scope: !2266)
!2275 = !DILocation(line: 66, column: 49, scope: !2266)
!2276 = !DILocation(line: 66, column: 59, scope: !2266)
!2277 = !DILocation(line: 66, column: 43, scope: !2266)
!2278 = !DILocation(line: 66, column: 68, scope: !2266)
!2279 = !DILocation(line: 66, column: 24, scope: !2266)
!2280 = !DILocation(line: 66, column: 9, scope: !2266)
!2281 = !DILocation(line: 66, column: 13, scope: !2266)
!2282 = !DILocation(line: 66, column: 22, scope: !2266)
!2283 = !DILocation(line: 67, column: 25, scope: !2159)
!2284 = !DILocation(line: 67, column: 36, scope: !2159)
!2285 = !DILocation(line: 67, column: 40, scope: !2159)
!2286 = !DILocation(line: 67, column: 50, scope: !2159)
!2287 = !DILocation(line: 67, column: 5, scope: !2159)
!2288 = !DILocation(line: 69, column: 5, scope: !2159)
!2289 = !DILocation(line: 70, column: 1, scope: !2159)
!2290 = distinct !DISubprogram(name: "ads_read_packet", scope: !921, file: !921, line: 72, type: !2291, isLocal: true, isDefinition: true, scopeLine: 73, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2291 = !DISubroutineType(types: !2292)
!2292 = !{!917, !2162, !1033}
!2293 = !DILocalVariable(name: "s", arg: 1, scope: !2290, file: !921, line: 72, type: !2162)
!2294 = !DILocation(line: 72, column: 45, scope: !2290)
!2295 = !DILocalVariable(name: "pkt", arg: 2, scope: !2290, file: !921, line: 72, type: !1033)
!2296 = !DILocation(line: 72, column: 58, scope: !2290)
!2297 = !DILocalVariable(name: "par", scope: !2290, file: !921, line: 74, type: !1727)
!2298 = !DILocation(line: 74, column: 24, scope: !2290)
!2299 = !DILocation(line: 74, column: 30, scope: !2290)
!2300 = !DILocation(line: 74, column: 33, scope: !2290)
!2301 = !DILocation(line: 74, column: 45, scope: !2290)
!2302 = !DILocalVariable(name: "ret", scope: !2290, file: !921, line: 75, type: !917)
!2303 = !DILocation(line: 75, column: 9, scope: !2290)
!2304 = !DILocation(line: 77, column: 25, scope: !2290)
!2305 = !DILocation(line: 77, column: 28, scope: !2290)
!2306 = !DILocation(line: 77, column: 32, scope: !2290)
!2307 = !DILocation(line: 77, column: 37, scope: !2290)
!2308 = !DILocation(line: 77, column: 42, scope: !2290)
!2309 = !DILocation(line: 77, column: 11, scope: !2290)
!2310 = !DILocation(line: 77, column: 9, scope: !2290)
!2311 = !DILocation(line: 78, column: 5, scope: !2290)
!2312 = !DILocation(line: 78, column: 10, scope: !2290)
!2313 = !DILocation(line: 78, column: 23, scope: !2290)
!2314 = !DILocation(line: 79, column: 12, scope: !2290)
!2315 = !DILocation(line: 79, column: 5, scope: !2290)
