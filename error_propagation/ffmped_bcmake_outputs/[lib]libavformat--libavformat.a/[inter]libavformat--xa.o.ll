; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--xa.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--xa.o.i"
...
@ff_xa_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i32 0, i32 0), i32 0, i8* null, %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 8, i32 (%struct.AVProbeData*)* @xa_probe, i32 (%struct.AVFormatContext*)* @xa_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @xa_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8

; Function Attrs: nounwind uwtable
define internal i32 @xa_probe(%struct.AVProbeData* %p) #0 !dbg !2151 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %channels, metadata !2156, metadata !2154), !dbg !2157
  call void @llvm.dbg.declare(metadata i32* %srate, metadata !2158, metadata !2154), !dbg !2159
  call void @llvm.dbg.declare(metadata i32* %bits_per_sample, metadata !2160, metadata !2154), !dbg !2161
  ...
  %cmp = icmp slt i32 %1, 24, !dbg !2165
...
if.end:                                           ; preds = %entry
  ...
  %buf = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %2, i32 0, i32 1, !dbg !2169
  %3 = load i8*, i8** %buf, align 8, !dbg !2169
  %4 = bitcast i8* %3 to %union.unaligned_32*, !dbg !2170
  %l = bitcast %union.unaligned_32* %4 to i32*, !dbg !2170
  %5 = load i32, i32* %l, align 1, !dbg !2170
  switch i32 %5, label %sw.default [
    i32 16728, label %sw.bb
    i32 4800856, label %sw.bb
    i32 4866392, label %sw.bb
  ], !dbg !2171
...
sw.epilog:                                        ; preds = %sw.bb
  %6 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2175
  %buf1 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %6, i32 0, i32 1, !dbg !2176
  %7 = load i8*, i8** %buf1, align 8, !dbg !2176
  %add.ptr = getelementptr inbounds i8, i8* %7, i64 10, !dbg !2177
  %8 = bitcast i8* %add.ptr to %union.unaligned_16*, !dbg !2178
  %l2 = bitcast %union.unaligned_16* %8 to i16*, !dbg !2178
  %9 = load i16, i16* %l2, align 1, !dbg !2178
  %conv = zext i16 %9 to i32, !dbg !2179
  store i32 %conv, i32* %channels, align 4, !dbg !2180
  %10 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2181
  %buf3 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %10, i32 0, i32 1, !dbg !2182
  %11 = load i8*, i8** %buf3, align 8, !dbg !2182
  %add.ptr4 = getelementptr inbounds i8, i8* %11, i64 12, !dbg !2183
  %12 = bitcast i8* %add.ptr4 to %union.unaligned_32*, !dbg !2184
  %l5 = bitcast %union.unaligned_32* %12 to i32*, !dbg !2184
  %13 = load i32, i32* %l5, align 1, !dbg !2184
  store i32 %13, i32* %srate, align 4, !dbg !2185
  %14 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2186
  %buf6 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %14, i32 0, i32 1, !dbg !2187
  %15 = load i8*, i8** %buf6, align 8, !dbg !2187
  %add.ptr7 = getelementptr inbounds i8, i8* %15, i64 22, !dbg !2188
  %16 = bitcast i8* %add.ptr7 to %union.unaligned_16*, !dbg !2189
  %l8 = bitcast %union.unaligned_16* %16 to i16*, !dbg !2189
  %17 = load i16, i16* %l8, align 1, !dbg !2189
  %conv9 = zext i16 %17 to i32, !dbg !2190
  store i32 %conv9, i32* %bits_per_sample, align 4, !dbg !2191
  %18 = load i32, i32* %channels, align 4, !dbg !2192
  %tobool = icmp ne i32 %18, 0, !dbg !2192
  br i1 %tobool, label %lor.lhs.false, label %if.then23, !dbg !2194

lor.lhs.false:                                    ; preds = %sw.epilog
  %19 = load i32, i32* %channels, align 4, !dbg !2195
  %cmp10 = icmp sgt i32 %19, 8, !dbg !2197
  br i1 %cmp10, label %if.then23, label %lor.lhs.false12, !dbg !2198

lor.lhs.false12:                                  ; preds = %lor.lhs.false
  %20 = load i32, i32* %srate, align 4, !dbg !2199
  %tobool13 = icmp ne i32 %20, 0, !dbg !2199
  br i1 %tobool13, label %lor.lhs.false14, label %if.then23, !dbg !2201

lor.lhs.false14:                                  ; preds = %lor.lhs.false12
  %21 = load i32, i32* %srate, align 4, !dbg !2202
  %cmp15 = icmp sgt i32 %21, 192000, !dbg !2204
  br i1 %cmp15, label %if.then23, label %lor.lhs.false17, !dbg !2205

lor.lhs.false17:                                  ; preds = %lor.lhs.false14
  %22 = load i32, i32* %bits_per_sample, align 4, !dbg !2206
  %cmp18 = icmp slt i32 %22, 4, !dbg !2207
  br i1 %cmp18, label %if.then23, label %lor.lhs.false20, !dbg !2208

lor.lhs.false20:                                  ; preds = %lor.lhs.false17
  %23 = load i32, i32* %bits_per_sample, align 4, !dbg !2209
  %cmp21 = icmp sgt i32 %23, 32, !dbg !2210
  br i1 %cmp21, label %if.then23, label %if.end24, !dbg !2211

if.then23:                                        ; preds = %lor.lhs.false20, %lor.lhs.false17, %lor.lhs.false14, %lor.lhs.false12, %lor.lhs.false, %sw.epilog
  store i32 0, i32* %retval, align 4, !dbg !2213
  br label %return, !dbg !2213

if.end24:                                         ; preds = %lor.lhs.false20
  store i32 50, i32* %retval, align 4, !dbg !2214
  br label %return, !dbg !2214

return:                                           ; preds = %if.end24, %if.then23, %sw.default, %if.then
  %24 = load i32, i32* %retval, align 4, !dbg !2215
  ret i32 %24, !dbg !2215
}

; Function Attrs: nounwind uwtable
define internal i32 @xa_read_header(%struct.AVFormatContext* %s) #0 !dbg !2216 {
entry:
  %retval.i = alloca i32, align 4
  %a.addr.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %a.addr.i, metadata !2221, metadata !2154), !dbg !2226
  %amin.addr.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %amin.addr.i, metadata !2228, metadata !2154), !dbg !2229
  %amax.addr.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %amax.addr.i, metadata !2230, metadata !2154), !dbg !2231
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %xa = alloca %struct.MaxisXADemuxContext*, align 8
  %pb = alloca %struct.AVIOContext*, align 8
  %st = alloca %struct.AVStream*, align 8
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2232, metadata !2154), !dbg !2233
  call void @llvm.dbg.declare(metadata %struct.MaxisXADemuxContext** %xa, metadata !2234, metadata !2154), !dbg !2241
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2242
  %priv_data = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 3, !dbg !2243
  %1 = load i8*, i8** %priv_data, align 8, !dbg !2243
  %2 = bitcast i8* %1 to %struct.MaxisXADemuxContext*, !dbg !2242
  store %struct.MaxisXADemuxContext* %2, %struct.MaxisXADemuxContext** %xa, align 8, !dbg !2241
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2244, metadata !2154), !dbg !2245
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2246
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %3, i32 0, i32 4, !dbg !2247
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2247
  store %struct.AVIOContext* %4, %struct.AVIOContext** %pb, align 8, !dbg !2245
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2248, metadata !2154), !dbg !2249
  %5 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2250
  %call = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %5, %struct.AVCodec* null), !dbg !2251
  store %struct.AVStream* %call, %struct.AVStream** %st, align 8, !dbg !2252
  %6 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2253
  %tobool = icmp ne %struct.AVStream* %6, null, !dbg !2253
...
if.end:                                           ; preds = %entry
  %7 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2257
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %7, i32 0, i32 19, !dbg !2258
  %8 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2258
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %8, i32 0, i32 0, !dbg !2259
  store i32 1, i32* %codec_type, align 8, !dbg !2260
  %9 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2261
  %codecpar2 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %9, i32 0, i32 19, !dbg !2262
  %10 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar2, align 8, !dbg !2262
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %10, i32 0, i32 1, !dbg !2263
  store i32 69658, i32* %codec_id, align 4, !dbg !2264
  %11 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2265
  %call3 = call i64 @avio_skip(%struct.AVIOContext* %11, i64 4), !dbg !2266
  %12 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2267
  %call4 = call i32 @avio_rl32(%struct.AVIOContext* %12), !dbg !2268
  %13 = load %struct.MaxisXADemuxContext*, %struct.MaxisXADemuxContext** %xa, align 8, !dbg !2269
  %out_size = getelementptr inbounds %struct.MaxisXADemuxContext, %struct.MaxisXADemuxContext* %13, i32 0, i32 0, !dbg !2270
  store i32 %call4, i32* %out_size, align 4, !dbg !2271
  %14 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2272
  %call5 = call i64 @avio_skip(%struct.AVIOContext* %14, i64 2), !dbg !2273
  %15 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2274
  %call6 = call i32 @avio_rl16(%struct.AVIOContext* %15), !dbg !2275
  %16 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2276
  %codecpar7 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %16, i32 0, i32 19, !dbg !2277
  %17 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar7, align 8, !dbg !2277
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %17, i32 0, i32 22, !dbg !2278
  store i32 %call6, i32* %channels, align 8, !dbg !2279
  %18 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2280
  %call8 = call i32 @avio_rl32(%struct.AVIOContext* %18), !dbg !2281
  %19 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2282
  %codecpar9 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %19, i32 0, i32 19, !dbg !2283
  %20 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar9, align 8, !dbg !2283
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %20, i32 0, i32 23, !dbg !2284
  store i32 %call8, i32* %sample_rate, align 4, !dbg !2285
  %21 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2286
  %call10 = call i64 @avio_skip(%struct.AVIOContext* %21, i64 4), !dbg !2287
  %22 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2288
  %call11 = call i64 @avio_skip(%struct.AVIOContext* %22, i64 2), !dbg !2289
  %23 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2290
  %call12 = call i64 @avio_skip(%struct.AVIOContext* %23, i64 2), !dbg !2291
  %24 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2292
  %codecpar13 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %24, i32 0, i32 19, !dbg !2294
  %25 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar13, align 8, !dbg !2294
  %channels14 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %25, i32 0, i32 22, !dbg !2295
  %26 = load i32, i32* %channels14, align 8, !dbg !2295
  %tobool15 = icmp ne i32 %26, 0, !dbg !2292
  br i1 %tobool15, label %lor.lhs.false, label %if.then19, !dbg !2296

lor.lhs.false:                                    ; preds = %if.end
  %27 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2297
  %codecpar16 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %27, i32 0, i32 19, !dbg !2299
  %28 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar16, align 8, !dbg !2299
  %sample_rate17 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %28, i32 0, i32 23, !dbg !2300
  %29 = load i32, i32* %sample_rate17, align 4, !dbg !2300
  %tobool18 = icmp ne i32 %29, 0, !dbg !2297
  br i1 %tobool18, label %if.end20, label %if.then19, !dbg !2301
...
if.end20:                                         ; preds = %lor.lhs.false
  %30 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2303
  %codecpar21 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %30, i32 0, i32 19, !dbg !2304
  %31 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar21, align 8, !dbg !2304
  %channels22 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %31, i32 0, i32 22, !dbg !2305
  %32 = load i32, i32* %channels22, align 8, !dbg !2305
  %conv = sext i32 %32 to i64, !dbg !2303
  %mul = mul nsw i64 15, %conv, !dbg !2306
  %mul23 = mul nsw i64 %mul, 8, !dbg !2307
  %33 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2308
  %codecpar24 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %33, i32 0, i32 19, !dbg !2309
  %34 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar24, align 8, !dbg !2309
  %sample_rate25 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %34, i32 0, i32 23, !dbg !2310
  %35 = load i32, i32* %sample_rate25, align 4, !dbg !2310
  %conv26 = sext i32 %35 to i64, !dbg !2308
  %mul27 = mul nsw i64 %mul23, %conv26, !dbg !2311
  %div = sdiv i64 %mul27, 28, !dbg !2312
  %conv28 = trunc i64 %div to i32, !dbg !2313
  store i32 %conv28, i32* %a.addr.i, align 4, !dbg !2314
  store i32 0, i32* %amin.addr.i, align 4, !dbg !2314
  store i32 2147483647, i32* %amax.addr.i, align 4, !dbg !2314
  %36 = load i32, i32* %a.addr.i, align 4, !dbg !2315
  %37 = load i32, i32* %amin.addr.i, align 4, !dbg !2317
  %cmp.i = icmp slt i32 %36, %37, !dbg !2318
  br i1 %cmp.i, label %if.then.i, label %if.else.i, !dbg !2319

if.then.i:                                        ; preds = %if.end20
  %38 = load i32, i32* %amin.addr.i, align 4, !dbg !2320
  store i32 %38, i32* %retval.i, align 4, !dbg !2322
  br label %av_clip_c.exit, !dbg !2322

if.else.i:                                        ; preds = %if.end20
  %39 = load i32, i32* %a.addr.i, align 4, !dbg !2323
  %40 = load i32, i32* %amax.addr.i, align 4, !dbg !2325
  %cmp1.i = icmp sgt i32 %39, %40, !dbg !2326
  br i1 %cmp1.i, label %if.then2.i, label %if.else3.i, !dbg !2327

if.then2.i:                                       ; preds = %if.else.i
  %41 = load i32, i32* %amax.addr.i, align 4, !dbg !2328
  store i32 %41, i32* %retval.i, align 4, !dbg !2330
  br label %av_clip_c.exit, !dbg !2330

if.else3.i:                                       ; preds = %if.else.i
  %42 = load i32, i32* %a.addr.i, align 4, !dbg !2331
  store i32 %42, i32* %retval.i, align 4, !dbg !2332
  br label %av_clip_c.exit, !dbg !2332

av_clip_c.exit:                                   ; preds = %if.then.i, %if.then2.i, %if.else3.i
  %43 = load i32, i32* %retval.i, align 4, !dbg !2333
  %conv30 = sext i32 %43 to i64, !dbg !2314
  %44 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2334
  %codecpar31 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %44, i32 0, i32 19, !dbg !2335
  %45 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar31, align 8, !dbg !2335
  %bit_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %45, i32 0, i32 6, !dbg !2336
  store i64 %conv30, i64* %bit_rate, align 8, !dbg !2337
  %46 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2338
  %47 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2339
  %codecpar32 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %47, i32 0, i32 19, !dbg !2340
  %48 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar32, align 8, !dbg !2340
  %sample_rate33 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %48, i32 0, i32 23, !dbg !2341
  %49 = load i32, i32* %sample_rate33, align 4, !dbg !2341
  call void @avpriv_set_pts_info(%struct.AVStream* %46, i32 64, i32 1, i32 %49), !dbg !2342
  %50 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2343
  %start_time = getelementptr inbounds %struct.AVStream, %struct.AVStream* %50, i32 0, i32 5, !dbg !2344
  store i64 0, i64* %start_time, align 8, !dbg !2345
  store i32 0, i32* %retval, align 4, !dbg !2346
  br label %return, !dbg !2346

return:                                           ; preds = %av_clip_c.exit, %if.then19, %if.then
  %51 = load i32, i32* %retval, align 4, !dbg !2347
  ret i32 %51, !dbg !2347
}

; Function Attrs: nounwind uwtable
define internal i32 @xa_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2348 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2351, metadata !2154), !dbg !2352
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2353, metadata !2154), !dbg !2354
  call void @llvm.dbg.declare(metadata %struct.MaxisXADemuxContext** %xa, metadata !2355, metadata !2154), !dbg !2356
  ...
  %2 = bitcast i8* %1 to %struct.MaxisXADemuxContext*, !dbg !2357
  store %struct.MaxisXADemuxContext* %2, %struct.MaxisXADemuxContext** %xa, align 8, !dbg !2356
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2359, metadata !2154), !dbg !2360
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2361
  %streams = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %3, i32 0, i32 7, !dbg !2362
  %4 = load %struct.AVStream**, %struct.AVStream*** %streams, align 8, !dbg !2362
  %arrayidx = getelementptr inbounds %struct.AVStream*, %struct.AVStream** %4, i64 0, !dbg !2361
  %5 = load %struct.AVStream*, %struct.AVStream** %arrayidx, align 8, !dbg !2361
  store %struct.AVStream* %5, %struct.AVStream** %st, align 8, !dbg !2360
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2363, metadata !2154), !dbg !2364
  %6 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2365
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %6, i32 0, i32 4, !dbg !2366
  %7 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2366
  store %struct.AVIOContext* %7, %struct.AVIOContext** %pb, align 8, !dbg !2364
  call void @llvm.dbg.declare(metadata i32* %packet_size, metadata !2367, metadata !2154), !dbg !2368
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2369, metadata !2154), !dbg !2370
  %8 = load %struct.MaxisXADemuxContext*, %struct.MaxisXADemuxContext** %xa, align 8, !dbg !2371
  %sent_bytes = getelementptr inbounds %struct.MaxisXADemuxContext, %struct.MaxisXADemuxContext* %8, i32 0, i32 1, !dbg !2373
  %9 = load i32, i32* %sent_bytes, align 4, !dbg !2373
  %10 = load %struct.MaxisXADemuxContext*, %struct.MaxisXADemuxContext** %xa, align 8, !dbg !2374
  %out_size = getelementptr inbounds %struct.MaxisXADemuxContext, %struct.MaxisXADemuxContext* %10, i32 0, i32 0, !dbg !2375
  %11 = load i32, i32* %out_size, align 4, !dbg !2375
  %cmp = icmp uge i32 %9, %11, !dbg !2376
  br i1 %cmp, label %if.then, label %if.end, !dbg !2377

if.then:                                          ; preds = %entry
  store i32 -541478725, i32* %retval, align 4, !dbg !2378
  br label %return, !dbg !2378

if.end:                                           ; preds = %entry
  %12 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2379
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %12, i32 0, i32 19, !dbg !2380
  %13 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2380
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %13, i32 0, i32 22, !dbg !2381
  %14 = load i32, i32* %channels, align 8, !dbg !2381
  %mul = mul nsw i32 15, %14, !dbg !2382
  store i32 %mul, i32* %packet_size, align 4, !dbg !2383
  %15 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2384
  %16 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2385
  %17 = load i32, i32* %packet_size, align 4, !dbg !2386
  %call = call i32 @av_get_packet(%struct.AVIOContext* %15, %struct.AVPacket* %16, i32 %17), !dbg !2387
  store i32 %call, i32* %ret, align 4, !dbg !2388
  %18 = load i32, i32* %ret, align 4, !dbg !2389
  %cmp2 = icmp slt i32 %18, 0, !dbg !2391
  br i1 %cmp2, label %if.then3, label %if.end4, !dbg !2392

if.then3:                                         ; preds = %if.end
  %19 = load i32, i32* %ret, align 4, !dbg !2393
  store i32 %19, i32* %retval, align 4, !dbg !2394
  br label %return, !dbg !2394

if.end4:                                          ; preds = %if.end
  %20 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2395
  %index = getelementptr inbounds %struct.AVStream, %struct.AVStream* %20, i32 0, i32 0, !dbg !2396
  %21 = load i32, i32* %index, align 8, !dbg !2396
  %22 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2397
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %22, i32 0, i32 5, !dbg !2398
  store i32 %21, i32* %stream_index, align 4, !dbg !2399
  %23 = load i32, i32* %packet_size, align 4, !dbg !2400
  %24 = load %struct.MaxisXADemuxContext*, %struct.MaxisXADemuxContext** %xa, align 8, !dbg !2401
  %sent_bytes5 = getelementptr inbounds %struct.MaxisXADemuxContext, %struct.MaxisXADemuxContext* %24, i32 0, i32 1, !dbg !2402
  %25 = load i32, i32* %sent_bytes5, align 4, !dbg !2403
  %add = add i32 %25, %23, !dbg !2403
  store i32 %add, i32* %sent_bytes5, align 4, !dbg !2403
  %26 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2404
  %duration = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %26, i32 0, i32 9, !dbg !2405
  store i64 28, i64* %duration, align 8, !dbg !2406
  %27 = load i32, i32* %ret, align 4, !dbg !2407
  store i32 %27, i32* %retval, align 4, !dbg !2408
  br label %return, !dbg !2408

return:                                           ; preds = %if.end4, %if.then3, %if.then
  %28 = load i32, i32* %retval, align 4, !dbg !2409
  ret i32 %28, !dbg !2409
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--xa.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!934 = !{!935}
!935 = distinct !DIGlobalVariable(name: "ff_xa_demuxer", scope: !0, file: !936, line: 124, type: !937, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_xa_demuxer)
!936 = !DIFile(filename: "libavformat/xa.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2151 = distinct !DISubprogram(name: "xa_probe", scope: !936, file: !936, line: 43, type: !1006, isLocal: true, isDefinition: true, scopeLine: 44, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2152 = !{}
!2153 = !DILocalVariable(name: "p", arg: 1, scope: !2151, file: !936, line: 43, type: !1008)
!2154 = !DIExpression()
!2155 = !DILocation(line: 43, column: 34, scope: !2151)
!2156 = !DILocalVariable(name: "channels", scope: !2151, file: !936, line: 45, type: !933)
!2157 = !DILocation(line: 45, column: 9, scope: !2151)
!2158 = !DILocalVariable(name: "srate", scope: !2151, file: !936, line: 45, type: !933)
!2159 = !DILocation(line: 45, column: 19, scope: !2151)
!2160 = !DILocalVariable(name: "bits_per_sample", scope: !2151, file: !936, line: 45, type: !933)
!2161 = !DILocation(line: 45, column: 26, scope: !2151)
!2162 = !DILocation(line: 46, column: 9, scope: !2163)
!2163 = distinct !DILexicalBlock(scope: !2151, file: !936, line: 46, column: 9)
!2164 = !DILocation(line: 46, column: 12, scope: !2163)
!2165 = !DILocation(line: 46, column: 21, scope: !2163)
!2166 = !DILocation(line: 46, column: 9, scope: !2151)
!2167 = !DILocation(line: 47, column: 9, scope: !2163)
!2168 = !DILocation(line: 48, column: 44, scope: !2151)
!2169 = !DILocation(line: 48, column: 47, scope: !2151)
!2170 = !DILocation(line: 48, column: 54, scope: !2151)
!2171 = !DILocation(line: 48, column: 5, scope: !2151)
!2172 = !DILocation(line: 52, column: 9, scope: !2173)
!2173 = distinct !DILexicalBlock(scope: !2151, file: !936, line: 48, column: 58)
!2174 = !DILocation(line: 54, column: 9, scope: !2173)
!2175 = !DILocation(line: 56, column: 48, scope: !2151)
!2176 = !DILocation(line: 56, column: 51, scope: !2151)
!2177 = !DILocation(line: 56, column: 55, scope: !2151)
!2178 = !DILocation(line: 56, column: 63, scope: !2151)
!2179 = !DILocation(line: 56, column: 16, scope: !2151)
!2180 = !DILocation(line: 56, column: 14, scope: !2151)
!2181 = !DILocation(line: 57, column: 45, scope: !2151)
!2182 = !DILocation(line: 57, column: 48, scope: !2151)
!2183 = !DILocation(line: 57, column: 52, scope: !2151)
!2184 = !DILocation(line: 57, column: 60, scope: !2151)
!2185 = !DILocation(line: 57, column: 11, scope: !2151)
!2186 = !DILocation(line: 58, column: 55, scope: !2151)
!2187 = !DILocation(line: 58, column: 58, scope: !2151)
!2188 = !DILocation(line: 58, column: 62, scope: !2151)
!2189 = !DILocation(line: 58, column: 70, scope: !2151)
!2190 = !DILocation(line: 58, column: 23, scope: !2151)
!2191 = !DILocation(line: 58, column: 21, scope: !2151)
!2192 = !DILocation(line: 59, column: 10, scope: !2193)
!2193 = distinct !DILexicalBlock(scope: !2151, file: !936, line: 59, column: 9)
!2194 = !DILocation(line: 59, column: 19, scope: !2193)
!2195 = !DILocation(line: 59, column: 22, scope: !2196)
!2196 = !DILexicalBlockFile(scope: !2193, file: !936, discriminator: 1)
!2197 = !DILocation(line: 59, column: 31, scope: !2196)
!2198 = !DILocation(line: 59, column: 35, scope: !2196)
!2199 = !DILocation(line: 59, column: 39, scope: !2200)
!2200 = !DILexicalBlockFile(scope: !2193, file: !936, discriminator: 2)
!2201 = !DILocation(line: 59, column: 45, scope: !2200)
!2202 = !DILocation(line: 59, column: 48, scope: !2203)
!2203 = !DILexicalBlockFile(scope: !2193, file: !936, discriminator: 3)
!2204 = !DILocation(line: 59, column: 54, scope: !2203)
!2205 = !DILocation(line: 59, column: 63, scope: !2203)
!2206 = !DILocation(line: 60, column: 9, scope: !2193)
!2207 = !DILocation(line: 60, column: 25, scope: !2193)
!2208 = !DILocation(line: 60, column: 29, scope: !2193)
!2209 = !DILocation(line: 60, column: 32, scope: !2196)
!2210 = !DILocation(line: 60, column: 48, scope: !2196)
!2211 = !DILocation(line: 59, column: 9, scope: !2212)
!2212 = !DILexicalBlockFile(scope: !2151, file: !936, discriminator: 4)
!2213 = !DILocation(line: 61, column: 9, scope: !2193)
!2214 = !DILocation(line: 62, column: 5, scope: !2151)
!2215 = !DILocation(line: 63, column: 1, scope: !2151)
!2216 = distinct !DISubprogram(name: "xa_read_header", scope: !936, file: !936, line: 65, type: !2217, isLocal: true, isDefinition: true, scopeLine: 66, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2217 = !DISubroutineType(types: !2218)
!2218 = !{!933, !2219}
!2219 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2220, size: 64, align: 64)
!2220 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1023)
!2221 = !DILocalVariable(name: "a", arg: 1, scope: !2222, file: !2223, line: 127, type: !933)
!2222 = distinct !DISubprogram(name: "av_clip_c", scope: !2223, file: !2223, line: 127, type: !2224, isLocal: true, isDefinition: true, scopeLine: 128, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2223 = !DIFile(filename: "./libavutil/common.h", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
!2224 = !DISubroutineType(types: !2225)
!2225 = !{!933, !933, !933, !933}
!2226 = !DILocation(line: 127, column: 87, scope: !2222, inlinedAt: !2227)
!2227 = distinct !DILocation(line: 90, column: 30, scope: !2216)
!2228 = !DILocalVariable(name: "amin", arg: 2, scope: !2222, file: !2223, line: 127, type: !933)
!2229 = !DILocation(line: 127, column: 94, scope: !2222, inlinedAt: !2227)
!2230 = !DILocalVariable(name: "amax", arg: 3, scope: !2222, file: !2223, line: 127, type: !933)
!2231 = !DILocation(line: 127, column: 104, scope: !2222, inlinedAt: !2227)
!2232 = !DILocalVariable(name: "s", arg: 1, scope: !2216, file: !936, line: 65, type: !2219)
!2233 = !DILocation(line: 65, column: 44, scope: !2216)
!2234 = !DILocalVariable(name: "xa", scope: !2216, file: !936, line: 67, type: !2235)
!2235 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2236, size: 64, align: 64)
!2236 = !DIDerivedType(tag: DW_TAG_typedef, name: "MaxisXADemuxContext", file: !936, line: 41, baseType: !2237)
!2237 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "MaxisXADemuxContext", file: !936, line: 38, size: 64, align: 32, elements: !2238)
!2238 = !{!2239, !2240}
!2239 = !DIDerivedType(tag: DW_TAG_member, name: "out_size", scope: !2237, file: !936, line: 39, baseType: !923, size: 32, align: 32)
!2240 = !DIDerivedType(tag: DW_TAG_member, name: "sent_bytes", scope: !2237, file: !936, line: 40, baseType: !923, size: 32, align: 32, offset: 32)
!2241 = !DILocation(line: 67, column: 26, scope: !2216)
!2242 = !DILocation(line: 67, column: 31, scope: !2216)
!2243 = !DILocation(line: 67, column: 34, scope: !2216)
!2244 = !DILocalVariable(name: "pb", scope: !2216, file: !936, line: 68, type: !1229)
!2245 = !DILocation(line: 68, column: 18, scope: !2216)
!2246 = !DILocation(line: 68, column: 23, scope: !2216)
!2247 = !DILocation(line: 68, column: 26, scope: !2216)
!2248 = !DILocalVariable(name: "st", scope: !2216, file: !936, line: 69, type: !1297)
!2249 = !DILocation(line: 69, column: 15, scope: !2216)
!2250 = !DILocation(line: 72, column: 30, scope: !2216)
!2251 = !DILocation(line: 72, column: 10, scope: !2216)
!2252 = !DILocation(line: 72, column: 8, scope: !2216)
!2253 = !DILocation(line: 73, column: 10, scope: !2254)
!2254 = distinct !DILexicalBlock(scope: !2216, file: !936, line: 73, column: 9)
!2255 = !DILocation(line: 73, column: 9, scope: !2216)
!2256 = !DILocation(line: 74, column: 9, scope: !2254)
!2257 = !DILocation(line: 76, column: 5, scope: !2216)
!2258 = !DILocation(line: 76, column: 9, scope: !2216)
!2259 = !DILocation(line: 76, column: 19, scope: !2216)
!2260 = !DILocation(line: 76, column: 30, scope: !2216)
!2261 = !DILocation(line: 77, column: 5, scope: !2216)
!2262 = !DILocation(line: 77, column: 9, scope: !2216)
!2263 = !DILocation(line: 77, column: 19, scope: !2216)
!2264 = !DILocation(line: 77, column: 28, scope: !2216)
!2265 = !DILocation(line: 78, column: 15, scope: !2216)
!2266 = !DILocation(line: 78, column: 5, scope: !2216)
!2267 = !DILocation(line: 79, column: 30, scope: !2216)
!2268 = !DILocation(line: 79, column: 20, scope: !2216)
!2269 = !DILocation(line: 79, column: 5, scope: !2216)
!2270 = !DILocation(line: 79, column: 9, scope: !2216)
!2271 = !DILocation(line: 79, column: 18, scope: !2216)
!2272 = !DILocation(line: 80, column: 15, scope: !2216)
!2273 = !DILocation(line: 80, column: 5, scope: !2216)
!2274 = !DILocation(line: 81, column: 40, scope: !2216)
!2275 = !DILocation(line: 81, column: 30, scope: !2216)
!2276 = !DILocation(line: 81, column: 5, scope: !2216)
!2277 = !DILocation(line: 81, column: 9, scope: !2216)
!2278 = !DILocation(line: 81, column: 19, scope: !2216)
!2279 = !DILocation(line: 81, column: 28, scope: !2216)
!2280 = !DILocation(line: 82, column: 43, scope: !2216)
!2281 = !DILocation(line: 82, column: 33, scope: !2216)
!2282 = !DILocation(line: 82, column: 5, scope: !2216)
!2283 = !DILocation(line: 82, column: 9, scope: !2216)
!2284 = !DILocation(line: 82, column: 19, scope: !2216)
!2285 = !DILocation(line: 82, column: 31, scope: !2216)
!2286 = !DILocation(line: 83, column: 15, scope: !2216)
!2287 = !DILocation(line: 83, column: 5, scope: !2216)
!2288 = !DILocation(line: 84, column: 15, scope: !2216)
!2289 = !DILocation(line: 84, column: 5, scope: !2216)
!2290 = !DILocation(line: 85, column: 15, scope: !2216)
!2291 = !DILocation(line: 85, column: 5, scope: !2216)
!2292 = !DILocation(line: 87, column: 10, scope: !2293)
!2293 = distinct !DILexicalBlock(scope: !2216, file: !936, line: 87, column: 9)
!2294 = !DILocation(line: 87, column: 14, scope: !2293)
!2295 = !DILocation(line: 87, column: 24, scope: !2293)
!2296 = !DILocation(line: 87, column: 33, scope: !2293)
!2297 = !DILocation(line: 87, column: 37, scope: !2298)
!2298 = !DILexicalBlockFile(scope: !2293, file: !936, discriminator: 1)
!2299 = !DILocation(line: 87, column: 41, scope: !2298)
!2300 = !DILocation(line: 87, column: 51, scope: !2298)
!2301 = !DILocation(line: 87, column: 9, scope: !2298)
!2302 = !DILocation(line: 88, column: 9, scope: !2293)
!2303 = !DILocation(line: 90, column: 47, scope: !2216)
!2304 = !DILocation(line: 90, column: 51, scope: !2216)
!2305 = !DILocation(line: 90, column: 61, scope: !2216)
!2306 = !DILocation(line: 90, column: 45, scope: !2216)
!2307 = !DILocation(line: 90, column: 70, scope: !2216)
!2308 = !DILocation(line: 91, column: 35, scope: !2216)
!2309 = !DILocation(line: 91, column: 39, scope: !2216)
!2310 = !DILocation(line: 91, column: 49, scope: !2216)
!2311 = !DILocation(line: 90, column: 74, scope: !2216)
!2312 = !DILocation(line: 91, column: 61, scope: !2216)
!2313 = !DILocation(line: 90, column: 40, scope: !2216)
!2314 = !DILocation(line: 90, column: 30, scope: !2216)
!2315 = !DILocation(line: 132, column: 9, scope: !2316, inlinedAt: !2227)
!2316 = distinct !DILexicalBlock(scope: !2222, file: !2223, line: 132, column: 9)
!2317 = !DILocation(line: 132, column: 13, scope: !2316, inlinedAt: !2227)
!2318 = !DILocation(line: 132, column: 11, scope: !2316, inlinedAt: !2227)
!2319 = !DILocation(line: 132, column: 9, scope: !2222, inlinedAt: !2227)
!2320 = !DILocation(line: 132, column: 26, scope: !2321, inlinedAt: !2227)
!2321 = !DILexicalBlockFile(scope: !2316, file: !2223, discriminator: 1)
!2322 = !DILocation(line: 132, column: 19, scope: !2321, inlinedAt: !2227)
!2323 = !DILocation(line: 133, column: 14, scope: !2324, inlinedAt: !2227)
!2324 = distinct !DILexicalBlock(scope: !2316, file: !2223, line: 133, column: 14)
!2325 = !DILocation(line: 133, column: 18, scope: !2324, inlinedAt: !2227)
!2326 = !DILocation(line: 133, column: 16, scope: !2324, inlinedAt: !2227)
!2327 = !DILocation(line: 133, column: 14, scope: !2316, inlinedAt: !2227)
!2328 = !DILocation(line: 133, column: 31, scope: !2329, inlinedAt: !2227)
!2329 = !DILexicalBlockFile(scope: !2324, file: !2223, discriminator: 1)
!2330 = !DILocation(line: 133, column: 24, scope: !2329, inlinedAt: !2227)
!2331 = !DILocation(line: 134, column: 17, scope: !2324, inlinedAt: !2227)
!2332 = !DILocation(line: 134, column: 10, scope: !2324, inlinedAt: !2227)
!2333 = !DILocation(line: 135, column: 1, scope: !2222, inlinedAt: !2227)
!2334 = !DILocation(line: 90, column: 5, scope: !2216)
!2335 = !DILocation(line: 90, column: 9, scope: !2216)
!2336 = !DILocation(line: 90, column: 19, scope: !2216)
!2337 = !DILocation(line: 90, column: 28, scope: !2216)
!2338 = !DILocation(line: 93, column: 25, scope: !2216)
!2339 = !DILocation(line: 93, column: 36, scope: !2216)
!2340 = !DILocation(line: 93, column: 40, scope: !2216)
!2341 = !DILocation(line: 93, column: 50, scope: !2216)
!2342 = !DILocation(line: 93, column: 5, scope: !2216)
!2343 = !DILocation(line: 94, column: 5, scope: !2216)
!2344 = !DILocation(line: 94, column: 9, scope: !2216)
!2345 = !DILocation(line: 94, column: 20, scope: !2216)
!2346 = !DILocation(line: 96, column: 5, scope: !2216)
!2347 = !DILocation(line: 97, column: 1, scope: !2216)
!2348 = distinct !DISubprogram(name: "xa_read_packet", scope: !936, file: !936, line: 99, type: !2349, isLocal: true, isDefinition: true, scopeLine: 101, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2349 = !DISubroutineType(types: !2350)
!2350 = !{!933, !2219, !1048}
!2351 = !DILocalVariable(name: "s", arg: 1, scope: !2348, file: !936, line: 99, type: !2219)
!2352 = !DILocation(line: 99, column: 44, scope: !2348)
!2353 = !DILocalVariable(name: "pkt", arg: 2, scope: !2348, file: !936, line: 100, type: !1048)
!2354 = !DILocation(line: 100, column: 37, scope: !2348)
!2355 = !DILocalVariable(name: "xa", scope: !2348, file: !936, line: 102, type: !2235)
!2356 = !DILocation(line: 102, column: 26, scope: !2348)
!2357 = !DILocation(line: 102, column: 31, scope: !2348)
!2358 = !DILocation(line: 102, column: 34, scope: !2348)
!2359 = !DILocalVariable(name: "st", scope: !2348, file: !936, line: 103, type: !1297)
!2360 = !DILocation(line: 103, column: 15, scope: !2348)
!2361 = !DILocation(line: 103, column: 20, scope: !2348)
!2362 = !DILocation(line: 103, column: 23, scope: !2348)
!2363 = !DILocalVariable(name: "pb", scope: !2348, file: !936, line: 104, type: !1229)
!2364 = !DILocation(line: 104, column: 18, scope: !2348)
!2365 = !DILocation(line: 104, column: 23, scope: !2348)
!2366 = !DILocation(line: 104, column: 26, scope: !2348)
!2367 = !DILocalVariable(name: "packet_size", scope: !2348, file: !936, line: 105, type: !925)
!2368 = !DILocation(line: 105, column: 18, scope: !2348)
!2369 = !DILocalVariable(name: "ret", scope: !2348, file: !936, line: 106, type: !933)
!2370 = !DILocation(line: 106, column: 9, scope: !2348)
!2371 = !DILocation(line: 108, column: 9, scope: !2372)
!2372 = distinct !DILexicalBlock(scope: !2348, file: !936, line: 108, column: 9)
!2373 = !DILocation(line: 108, column: 13, scope: !2372)
!2374 = !DILocation(line: 108, column: 27, scope: !2372)
!2375 = !DILocation(line: 108, column: 31, scope: !2372)
!2376 = !DILocation(line: 108, column: 24, scope: !2372)
!2377 = !DILocation(line: 108, column: 9, scope: !2348)
!2378 = !DILocation(line: 109, column: 9, scope: !2372)
!2379 = !DILocation(line: 111, column: 22, scope: !2348)
!2380 = !DILocation(line: 111, column: 26, scope: !2348)
!2381 = !DILocation(line: 111, column: 36, scope: !2348)
!2382 = !DILocation(line: 111, column: 21, scope: !2348)
!2383 = !DILocation(line: 111, column: 17, scope: !2348)
!2384 = !DILocation(line: 113, column: 25, scope: !2348)
!2385 = !DILocation(line: 113, column: 29, scope: !2348)
!2386 = !DILocation(line: 113, column: 34, scope: !2348)
!2387 = !DILocation(line: 113, column: 11, scope: !2348)
!2388 = !DILocation(line: 113, column: 9, scope: !2348)
!2389 = !DILocation(line: 114, column: 8, scope: !2390)
!2390 = distinct !DILexicalBlock(scope: !2348, file: !936, line: 114, column: 8)
!2391 = !DILocation(line: 114, column: 12, scope: !2390)
!2392 = !DILocation(line: 114, column: 8, scope: !2348)
!2393 = !DILocation(line: 115, column: 16, scope: !2390)
!2394 = !DILocation(line: 115, column: 9, scope: !2390)
!2395 = !DILocation(line: 117, column: 25, scope: !2348)
!2396 = !DILocation(line: 117, column: 29, scope: !2348)
!2397 = !DILocation(line: 117, column: 5, scope: !2348)
!2398 = !DILocation(line: 117, column: 10, scope: !2348)
!2399 = !DILocation(line: 117, column: 23, scope: !2348)
!2400 = !DILocation(line: 118, column: 23, scope: !2348)
!2401 = !DILocation(line: 118, column: 5, scope: !2348)
!2402 = !DILocation(line: 118, column: 9, scope: !2348)
!2403 = !DILocation(line: 118, column: 20, scope: !2348)
!2404 = !DILocation(line: 119, column: 5, scope: !2348)
!2405 = !DILocation(line: 119, column: 10, scope: !2348)
!2406 = !DILocation(line: 119, column: 19, scope: !2348)
!2407 = !DILocation(line: 121, column: 12, scope: !2348)
!2408 = !DILocation(line: 121, column: 5, scope: !2348)
!2409 = !DILocation(line: 122, column: 1, scope: !2348)
