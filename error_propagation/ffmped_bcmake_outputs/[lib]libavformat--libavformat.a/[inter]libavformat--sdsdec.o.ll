; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--sdsdec.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--sdsdec.o.i"
...
%struct.SDSContext = type { [120 x i8], i32, i32, void (i8*, i32*)* }
...
entry:
  ...
  %2 = bitcast i8* %1 to %union.unaligned_32*, !dbg !2162
  %l = bitcast %union.unaligned_32* %2 to i32*, !dbg !2162
  %3 = load i32, i32* %l, align 1, !dbg !2162
  store i32 %3, i32* %x.addr.i, align 4, !dbg !2163
  %4 = load i32, i32* %x.addr.i, align 4, !dbg !2164
  %shl.i = shl i32 %4, 8, !dbg !2165
  %and.i = and i32 %shl.i, 65280, !dbg !2166
  %5 = load i32, i32* %x.addr.i, align 4, !dbg !2167
  %shr.i = lshr i32 %5, 8, !dbg !2168
  %and1.i = and i32 %shr.i, 255, !dbg !2169
  %or.i = or i32 %and.i, %and1.i, !dbg !2170
  %shl2.i = shl i32 %or.i, 16, !dbg !2171
  %6 = load i32, i32* %x.addr.i, align 4, !dbg !2172
  %shr3.i = lshr i32 %6, 16, !dbg !2173
  %shl4.i = shl i32 %shr3.i, 8, !dbg !2174
  %and5.i = and i32 %shl4.i, 65280, !dbg !2175
  %7 = load i32, i32* %x.addr.i, align 4, !dbg !2176
  %shr6.i = lshr i32 %7, 16, !dbg !2177
  %shr7.i = lshr i32 %shr6.i, 8, !dbg !2178
  %and8.i = and i32 %shr7.i, 255, !dbg !2179
  %or9.i = or i32 %and5.i, %and8.i, !dbg !2180
  %or10.i = or i32 %shl2.i, %or9.i, !dbg !2181
  %cmp = icmp eq i32 %or10.i, -260177919, !dbg !2182
  br i1 %cmp, label %land.lhs.true, label %if.end, !dbg !2183

land.lhs.true:                                    ; preds = %entry
  %8 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2184
  %buf1 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %8, i32 0, i32 1, !dbg !2186
  %9 = load i8*, i8** %buf1, align 8, !dbg !2186
  %arrayidx = getelementptr inbounds i8, i8* %9, i64 20, !dbg !2184
  %10 = load i8, i8* %arrayidx, align 1, !dbg !2184
  %conv = zext i8 %10 to i32, !dbg !2184
  %cmp2 = icmp eq i32 %conv, 247, !dbg !2187
  br i1 %cmp2, label %land.lhs.true4, label %if.end, !dbg !2188

land.lhs.true4:                                   ; preds = %land.lhs.true
  %11 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2189
  %buf5 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %11, i32 0, i32 1, !dbg !2190
  %12 = load i8*, i8** %buf5, align 8, !dbg !2190
  %arrayidx6 = getelementptr inbounds i8, i8* %12, i64 6, !dbg !2189
  %13 = load i8, i8* %arrayidx6, align 1, !dbg !2189
  %conv7 = zext i8 %13 to i32, !dbg !2189
  %cmp8 = icmp sge i32 %conv7, 8, !dbg !2191
  br i1 %cmp8, label %land.lhs.true10, label %if.end, !dbg !2192

land.lhs.true10:                                  ; preds = %land.lhs.true4
  %14 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2193
  %buf11 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %14, i32 0, i32 1, !dbg !2194
  %15 = load i8*, i8** %buf11, align 8, !dbg !2194
  %arrayidx12 = getelementptr inbounds i8, i8* %15, i64 6, !dbg !2193
  %16 = load i8, i8* %arrayidx12, align 1, !dbg !2193
  %conv13 = zext i8 %16 to i32, !dbg !2193
  %cmp14 = icmp sle i32 %conv13, 28, !dbg !2195
  br i1 %cmp14, label %if.then, label %if.end, !dbg !2196

if.then:                                          ; preds = %land.lhs.true10
  store i32 50, i32* %retval, align 4, !dbg !2198
...
return:                                           ; preds = %if.end, %if.then
  %17 = load i32, i32* %retval, align 4, !dbg !2200
  ret i32 %17, !dbg !2200
}

; Function Attrs: nounwind uwtable
define internal i32 @sds_read_header(%struct.AVFormatContext* %ctx) #0 !dbg !2201 {
entry:
  %retval = alloca i32, align 4
  %ctx.addr = alloca %struct.AVFormatContext*, align 8
  %s = alloca %struct.SDSContext*, align 8
  %sample_period = alloca i32, align 4
  %pb = alloca %struct.AVIOContext*, align 8
  %st = alloca %struct.AVStream*, align 8
  store %struct.AVFormatContext* %ctx, %struct.AVFormatContext** %ctx.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %ctx.addr, metadata !2206, metadata !2154), !dbg !2207
  call void @llvm.dbg.declare(metadata %struct.SDSContext** %s, metadata !2208, metadata !2154), !dbg !2223
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %ctx.addr, align 8, !dbg !2224
  ...
  %2 = bitcast i8* %1 to %struct.SDSContext*, !dbg !2224
  store %struct.SDSContext* %2, %struct.SDSContext** %s, align 8, !dbg !2223
  call void @llvm.dbg.declare(metadata i32* %sample_period, metadata !2226, metadata !2154), !dbg !2227
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2228, metadata !2154), !dbg !2229
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %ctx.addr, align 8, !dbg !2230
  ...
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2232, metadata !2154), !dbg !2233
  %5 = load %struct.AVFormatContext*, %struct.AVFormatContext** %ctx.addr, align 8, !dbg !2234
  %call = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %5, %struct.AVCodec* null), !dbg !2235
  store %struct.AVStream* %call, %struct.AVStream** %st, align 8, !dbg !2236
  %6 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2237
  %tobool = icmp ne %struct.AVStream* %6, null, !dbg !2237
...
if.end:                                           ; preds = %entry
  %7 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2241
  %call2 = call i64 @avio_skip(%struct.AVIOContext* %7, i64 4), !dbg !2242
  %8 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2243
  %call3 = call i64 @avio_skip(%struct.AVIOContext* %8, i64 2), !dbg !2244
  %9 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2245
  %call4 = call i32 @avio_r8(%struct.AVIOContext* %9), !dbg !2246
  %10 = load %struct.SDSContext*, %struct.SDSContext** %s, align 8, !dbg !2247
  %bit_depth = getelementptr inbounds %struct.SDSContext, %struct.SDSContext* %10, i32 0, i32 1, !dbg !2248
  store i32 %call4, i32* %bit_depth, align 8, !dbg !2249
  %11 = load %struct.SDSContext*, %struct.SDSContext** %s, align 8, !dbg !2250
  %bit_depth5 = getelementptr inbounds %struct.SDSContext, %struct.SDSContext* %11, i32 0, i32 1, !dbg !2252
  %12 = load i32, i32* %bit_depth5, align 8, !dbg !2252
  %cmp = icmp slt i32 %12, 8, !dbg !2253
  br i1 %cmp, label %if.then8, label %lor.lhs.false, !dbg !2254

lor.lhs.false:                                    ; preds = %if.end
  %13 = load %struct.SDSContext*, %struct.SDSContext** %s, align 8, !dbg !2255
  %bit_depth6 = getelementptr inbounds %struct.SDSContext, %struct.SDSContext* %13, i32 0, i32 1, !dbg !2257
  %14 = load i32, i32* %bit_depth6, align 8, !dbg !2257
  %cmp7 = icmp sgt i32 %14, 28, !dbg !2258
  br i1 %cmp7, label %if.then8, label %if.end9, !dbg !2259
...
if.end9:                                          ; preds = %lor.lhs.false
  %15 = load %struct.SDSContext*, %struct.SDSContext** %s, align 8, !dbg !2261
  %bit_depth10 = getelementptr inbounds %struct.SDSContext, %struct.SDSContext* %15, i32 0, i32 1, !dbg !2263
  %16 = load i32, i32* %bit_depth10, align 8, !dbg !2263
  %cmp11 = icmp slt i32 %16, 14, !dbg !2264
  br i1 %cmp11, label %if.then12, label %if.else, !dbg !2265

if.then12:                                        ; preds = %if.end9
  %17 = load %struct.SDSContext*, %struct.SDSContext** %s, align 8, !dbg !2266
  %read_block = getelementptr inbounds %struct.SDSContext, %struct.SDSContext* %17, i32 0, i32 3, !dbg !2268
  store void (i8*, i32*)* @byte2_read, void (i8*, i32*)** %read_block, align 8, !dbg !2269
  %18 = load %struct.SDSContext*, %struct.SDSContext** %s, align 8, !dbg !2270
  %size = getelementptr inbounds %struct.SDSContext, %struct.SDSContext* %18, i32 0, i32 2, !dbg !2271
  store i32 240, i32* %size, align 4, !dbg !2272
  br label %if.end22, !dbg !2273

if.else:                                          ; preds = %if.end9
  %19 = load %struct.SDSContext*, %struct.SDSContext** %s, align 8, !dbg !2274
  %bit_depth13 = getelementptr inbounds %struct.SDSContext, %struct.SDSContext* %19, i32 0, i32 1, !dbg !2277
  %20 = load i32, i32* %bit_depth13, align 8, !dbg !2277
  %cmp14 = icmp slt i32 %20, 21, !dbg !2278
  br i1 %cmp14, label %if.then15, label %if.else18, !dbg !2274

if.then15:                                        ; preds = %if.else
  %21 = load %struct.SDSContext*, %struct.SDSContext** %s, align 8, !dbg !2279
  %read_block16 = getelementptr inbounds %struct.SDSContext, %struct.SDSContext* %21, i32 0, i32 3, !dbg !2281
  store void (i8*, i32*)* @byte3_read, void (i8*, i32*)** %read_block16, align 8, !dbg !2282
  %22 = load %struct.SDSContext*, %struct.SDSContext** %s, align 8, !dbg !2283
  %size17 = getelementptr inbounds %struct.SDSContext, %struct.SDSContext* %22, i32 0, i32 2, !dbg !2284
  store i32 160, i32* %size17, align 4, !dbg !2285
  br label %if.end21, !dbg !2286

if.else18:                                        ; preds = %if.else
  %23 = load %struct.SDSContext*, %struct.SDSContext** %s, align 8, !dbg !2287
  %read_block19 = getelementptr inbounds %struct.SDSContext, %struct.SDSContext* %23, i32 0, i32 3, !dbg !2289
  store void (i8*, i32*)* @byte4_read, void (i8*, i32*)** %read_block19, align 8, !dbg !2290
  %24 = load %struct.SDSContext*, %struct.SDSContext** %s, align 8, !dbg !2291
  %size20 = getelementptr inbounds %struct.SDSContext, %struct.SDSContext* %24, i32 0, i32 2, !dbg !2292
  store i32 120, i32* %size20, align 4, !dbg !2293
  br label %if.end21
...
if.end22:                                         ; preds = %if.end21, %if.then12
  %25 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2294
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %25, i32 0, i32 19, !dbg !2295
  %26 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2295
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %26, i32 0, i32 1, !dbg !2296
  store i32 65546, i32* %codec_id, align 4, !dbg !2297
  %27 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2298
  %call23 = call i32 @avio_rl24(%struct.AVIOContext* %27), !dbg !2299
  store i32 %call23, i32* %sample_period, align 4, !dbg !2300
  %28 = load i32, i32* %sample_period, align 4, !dbg !2301
  %and = and i32 %28, 127, !dbg !2302
  %29 = load i32, i32* %sample_period, align 4, !dbg !2303
  %and24 = and i32 %29, 32512, !dbg !2304
  %shr = lshr i32 %and24, 1, !dbg !2305
  %or = or i32 %and, %shr, !dbg !2306
  %30 = load i32, i32* %sample_period, align 4, !dbg !2307
  %and25 = and i32 %30, 8323072, !dbg !2308
  %shr26 = lshr i32 %and25, 2, !dbg !2309
  %or27 = or i32 %or, %shr26, !dbg !2310
  store i32 %or27, i32* %sample_period, align 4, !dbg !2311
  %31 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2312
  %call28 = call i64 @avio_skip(%struct.AVIOContext* %31, i64 11), !dbg !2313
  %32 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2314
  %codecpar29 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %32, i32 0, i32 19, !dbg !2315
  %33 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar29, align 8, !dbg !2315
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %33, i32 0, i32 0, !dbg !2316
  store i32 1, i32* %codec_type, align 8, !dbg !2317
  %34 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2318
  %codecpar30 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %34, i32 0, i32 19, !dbg !2319
  %35 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar30, align 8, !dbg !2319
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %35, i32 0, i32 22, !dbg !2320
  store i32 1, i32* %channels, align 8, !dbg !2321
  %36 = load i32, i32* %sample_period, align 4, !dbg !2322
  %tobool31 = icmp ne i32 %36, 0, !dbg !2322
  br i1 %tobool31, label %cond.true, label %cond.false, !dbg !2322

cond.true:                                        ; preds = %if.end22
  %37 = load i32, i32* %sample_period, align 4, !dbg !2323
  %div = udiv i32 1000000000, %37, !dbg !2325
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %div, %cond.true ], [ 16000, %cond.false ], !dbg !2329
  %38 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2331
  %codecpar32 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %38, i32 0, i32 19, !dbg !2332
  %39 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar32, align 8, !dbg !2332
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %39, i32 0, i32 23, !dbg !2333
  store i32 %cond, i32* %sample_rate, align 4, !dbg !2334
  %40 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2335
  %call33 = call i64 @avio_size(%struct.AVIOContext* %40), !dbg !2336
  %sub = sub nsw i64 %call33, 21, !dbg !2337
  %div34 = sdiv i64 %sub, 127, !dbg !2338
  %41 = load %struct.SDSContext*, %struct.SDSContext** %s, align 8, !dbg !2339
  %size35 = getelementptr inbounds %struct.SDSContext, %struct.SDSContext* %41, i32 0, i32 2, !dbg !2340
  %42 = load i32, i32* %size35, align 4, !dbg !2340
  %conv = sext i32 %42 to i64, !dbg !2339
  %mul = mul nsw i64 %div34, %conv, !dbg !2341
  %div36 = sdiv i64 %mul, 4, !dbg !2342
  %43 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2343
  %duration = getelementptr inbounds %struct.AVStream, %struct.AVStream* %43, i32 0, i32 6, !dbg !2344
  store i64 %div36, i64* %duration, align 8, !dbg !2345
  %44 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2346
  %45 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2347
  %codecpar37 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %45, i32 0, i32 19, !dbg !2348
  %46 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar37, align 8, !dbg !2348
  %sample_rate38 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %46, i32 0, i32 23, !dbg !2349
  %47 = load i32, i32* %sample_rate38, align 4, !dbg !2349
  call void @avpriv_set_pts_info(%struct.AVStream* %44, i32 64, i32 1, i32 %47), !dbg !2350
  store i32 0, i32* %retval, align 4, !dbg !2351
  br label %return, !dbg !2351

return:                                           ; preds = %cond.end, %if.then8, %if.then
  %48 = load i32, i32* %retval, align 4, !dbg !2352
  ret i32 %48, !dbg !2352
}

; Function Attrs: nounwind uwtable
define internal i32 @sds_read_packet(%struct.AVFormatContext* %ctx, %struct.AVPacket* %pkt) #0 !dbg !2353 {
entry:
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2356, metadata !2154), !dbg !2360
  %retval = alloca i32, align 4
  %ctx.addr = alloca %struct.AVFormatContext*, align 8
  ...
  store %struct.AVFormatContext* %ctx, %struct.AVFormatContext** %ctx.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %ctx.addr, metadata !2362, metadata !2154), !dbg !2363
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2364, metadata !2154), !dbg !2365
  call void @llvm.dbg.declare(metadata %struct.SDSContext** %s, metadata !2366, metadata !2154), !dbg !2367
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %ctx.addr, align 8, !dbg !2368
  ...
  %2 = bitcast i8* %1 to %struct.SDSContext*, !dbg !2368
  store %struct.SDSContext* %2, %struct.SDSContext** %s, align 8, !dbg !2367
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2370, metadata !2154), !dbg !2371
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %ctx.addr, align 8, !dbg !2372
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %3, i32 0, i32 4, !dbg !2373
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2373
  store %struct.AVIOContext* %4, %struct.AVIOContext** %pb, align 8, !dbg !2371
  call void @llvm.dbg.declare(metadata i64* %pos, metadata !2374, metadata !2154), !dbg !2375
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2376, metadata !2154), !dbg !2377
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2378
  %call = call i32 @avio_feof(%struct.AVIOContext* %5), !dbg !2380
  %tobool = icmp ne i32 %call, 0, !dbg !2380
...
if.end:                                           ; preds = %entry
  %6 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2383
  store %struct.AVIOContext* %6, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2384
  %7 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2385
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %7, i64 0, i32 1) #3, !dbg !2386
  store i64 %call.i, i64* %pos, align 8, !dbg !2387
  %8 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2388
  %call3 = call i32 @avio_rb16(%struct.AVIOContext* %8), !dbg !2390
  %cmp = icmp ne i32 %call3, 61566, !dbg !2391
  br i1 %cmp, label %if.then4, label %if.end5, !dbg !2392
...
if.end5:                                          ; preds = %if.end
  %9 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2394
  %call6 = call i64 @avio_skip(%struct.AVIOContext* %9, i64 3), !dbg !2395
  %10 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2396
  %11 = load %struct.SDSContext*, %struct.SDSContext** %s, align 8, !dbg !2397
  %size = getelementptr inbounds %struct.SDSContext, %struct.SDSContext* %11, i32 0, i32 2, !dbg !2398
  %12 = load i32, i32* %size, align 4, !dbg !2398
  %call7 = call i32 @av_new_packet(%struct.AVPacket* %10, i32 %12), !dbg !2399
  store i32 %call7, i32* %ret, align 4, !dbg !2400
  %13 = load i32, i32* %ret, align 4, !dbg !2401
  %cmp8 = icmp slt i32 %13, 0, !dbg !2403
  br i1 %cmp8, label %if.then9, label %if.end10, !dbg !2404
...
if.end10:                                         ; preds = %if.end5
  %15 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2407
  %16 = load %struct.SDSContext*, %struct.SDSContext** %s, align 8, !dbg !2408
  %data = getelementptr inbounds %struct.SDSContext, %struct.SDSContext* %16, i32 0, i32 0, !dbg !2409
  %arraydecay = getelementptr inbounds [120 x i8], [120 x i8]* %data, i32 0, i32 0, !dbg !2408
  %call11 = call i32 @avio_read(%struct.AVIOContext* %15, i8* %arraydecay, i32 120), !dbg !2410
  store i32 %call11, i32* %ret, align 4, !dbg !2411
  %17 = load %struct.SDSContext*, %struct.SDSContext** %s, align 8, !dbg !2412
  %read_block = getelementptr inbounds %struct.SDSContext, %struct.SDSContext* %17, i32 0, i32 3, !dbg !2413
  %18 = load void (i8*, i32*)*, void (i8*, i32*)** %read_block, align 8, !dbg !2413
  %19 = load %struct.SDSContext*, %struct.SDSContext** %s, align 8, !dbg !2414
  %data12 = getelementptr inbounds %struct.SDSContext, %struct.SDSContext* %19, i32 0, i32 0, !dbg !2415
  %arraydecay13 = getelementptr inbounds [120 x i8], [120 x i8]* %data12, i32 0, i32 0, !dbg !2414
  %20 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2416
  %data14 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %20, i32 0, i32 3, !dbg !2417
  %21 = load i8*, i8** %data14, align 8, !dbg !2417
  %22 = bitcast i8* %21 to i32*, !dbg !2418
  call void %18(i8* %arraydecay13, i32* %22), !dbg !2412
  %23 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2419
  %call15 = call i64 @avio_skip(%struct.AVIOContext* %23, i64 1), !dbg !2420
  %24 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2421
  %call16 = call i32 @avio_r8(%struct.AVIOContext* %24), !dbg !2423
  %cmp17 = icmp ne i32 %call16, 247, !dbg !2424
  br i1 %cmp17, label %if.then18, label %if.end19, !dbg !2425
...
if.end19:                                         ; preds = %if.end10
  %25 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2427
  %flags = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %25, i32 0, i32 6, !dbg !2428
  %26 = load i32, i32* %flags, align 8, !dbg !2429
  %and = and i32 %26, -3, !dbg !2429
  store i32 %and, i32* %flags, align 8, !dbg !2429
  %27 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2430
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %27, i32 0, i32 5, !dbg !2431
  store i32 0, i32* %stream_index, align 4, !dbg !2432
  %28 = load i64, i64* %pos, align 8, !dbg !2433
  %29 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2434
  %pos20 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %29, i32 0, i32 10, !dbg !2435
  store i64 %28, i64* %pos20, align 8, !dbg !2436
  %30 = load i32, i32* %ret, align 4, !dbg !2437
  store i32 %30, i32* %retval, align 4, !dbg !2438
  br label %return, !dbg !2438

return:                                           ; preds = %if.end19, %if.then18, %if.then9, %if.then4, %if.then
  %31 = load i32, i32* %retval, align 4, !dbg !2439
  ret i32 %31, !dbg !2439
}
...
; Function Attrs: nounwind uwtable
define internal void @byte2_read(i8* %src, i32* %dst) #0 !dbg !2440 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %src.addr, metadata !2441, metadata !2154), !dbg !2442
  store i32* %dst, i32** %dst.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %dst.addr, metadata !2443, metadata !2154), !dbg !2444
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2445, metadata !2154), !dbg !2446
  store i32 0, i32* %i, align 4, !dbg !2447
  br label %for.cond, !dbg !2449

for.cond:                                         ; preds = %for.inc, %entry
  %0 = load i32, i32* %i, align 4, !dbg !2450
  %cmp = icmp slt i32 %0, 120, !dbg !2453
  br i1 %cmp, label %for.body, label %for.end, !dbg !2454

for.body:                                         ; preds = %for.cond
  call void @llvm.dbg.declare(metadata i32* %sample, metadata !2455, metadata !2154), !dbg !2457
  %1 = load i32, i32* %i, align 4, !dbg !2458
  %add = add nsw i32 %1, 0, !dbg !2459
  %idxprom = sext i32 %add to i64, !dbg !2460
  %2 = load i8*, i8** %src.addr, align 8, !dbg !2460
  %arrayidx = getelementptr inbounds i8, i8* %2, i64 %idxprom, !dbg !2460
  %3 = load i8, i8* %arrayidx, align 1, !dbg !2460
  %conv = zext i8 %3 to i32, !dbg !2460
  %shl = shl i32 %conv, 25, !dbg !2461
  %4 = load i32, i32* %i, align 4, !dbg !2462
  %add1 = add nsw i32 %4, 1, !dbg !2463
  %idxprom2 = sext i32 %add1 to i64, !dbg !2464
  %5 = load i8*, i8** %src.addr, align 8, !dbg !2464
  %arrayidx3 = getelementptr inbounds i8, i8* %5, i64 %idxprom2, !dbg !2464
  %6 = load i8, i8* %arrayidx3, align 1, !dbg !2464
  %conv4 = zext i8 %6 to i32, !dbg !2464
  %shl5 = shl i32 %conv4, 18, !dbg !2465
  %add6 = add nsw i32 %shl, %shl5, !dbg !2466
  store i32 %add6, i32* %sample, align 4, !dbg !2457
  %7 = load i32, i32* %sample, align 4, !dbg !2467
  %8 = load i32, i32* %i, align 4, !dbg !2468
  %div = sdiv i32 %8, 2, !dbg !2469
  %idxprom7 = sext i32 %div to i64, !dbg !2470
  %9 = load i32*, i32** %dst.addr, align 8, !dbg !2470
  %arrayidx8 = getelementptr inbounds i32, i32* %9, i64 %idxprom7, !dbg !2470
  store i32 %7, i32* %arrayidx8, align 4, !dbg !2471
  br label %for.inc, !dbg !2472

for.inc:                                          ; preds = %for.body
  %10 = load i32, i32* %i, align 4, !dbg !2473
  %add9 = add nsw i32 %10, 2, !dbg !2473
  store i32 %add9, i32* %i, align 4, !dbg !2473
...
; Function Attrs: nounwind uwtable
define internal void @byte3_read(i8* %src, i32* %dst) #0 !dbg !2479 {
entry:
  %src.addr = alloca i8*, align 8
  %dst.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  %sample = alloca i32, align 4
  store i8* %src, i8** %src.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %src.addr, metadata !2480, metadata !2154), !dbg !2481
  store i32* %dst, i32** %dst.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %dst.addr, metadata !2482, metadata !2154), !dbg !2483
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2484, metadata !2154), !dbg !2485
  store i32 0, i32* %i, align 4, !dbg !2486
  br label %for.cond, !dbg !2488

for.cond:                                         ; preds = %for.inc, %entry
  %0 = load i32, i32* %i, align 4, !dbg !2489
  %cmp = icmp slt i32 %0, 120, !dbg !2492
  br i1 %cmp, label %for.body, label %for.end, !dbg !2493

for.body:                                         ; preds = %for.cond
  call void @llvm.dbg.declare(metadata i32* %sample, metadata !2494, metadata !2154), !dbg !2496
  %1 = load i32, i32* %i, align 4, !dbg !2497
  %add = add nsw i32 %1, 0, !dbg !2498
  %idxprom = sext i32 %add to i64, !dbg !2499
  %2 = load i8*, i8** %src.addr, align 8, !dbg !2499
  %arrayidx = getelementptr inbounds i8, i8* %2, i64 %idxprom, !dbg !2499
  %3 = load i8, i8* %arrayidx, align 1, !dbg !2499
  %conv = zext i8 %3 to i32, !dbg !2499
  %shl = shl i32 %conv, 25, !dbg !2500
  %4 = load i32, i32* %i, align 4, !dbg !2501
  %add1 = add nsw i32 %4, 1, !dbg !2502
  %idxprom2 = sext i32 %add1 to i64, !dbg !2503
  %5 = load i8*, i8** %src.addr, align 8, !dbg !2503
  %arrayidx3 = getelementptr inbounds i8, i8* %5, i64 %idxprom2, !dbg !2503
  %6 = load i8, i8* %arrayidx3, align 1, !dbg !2503
  %conv4 = zext i8 %6 to i32, !dbg !2503
  %shl5 = shl i32 %conv4, 18, !dbg !2504
  %or = or i32 %shl, %shl5, !dbg !2505
  %7 = load i32, i32* %i, align 4, !dbg !2506
  %add6 = add nsw i32 %7, 2, !dbg !2507
  %idxprom7 = sext i32 %add6 to i64, !dbg !2508
  %8 = load i8*, i8** %src.addr, align 8, !dbg !2508
  %arrayidx8 = getelementptr inbounds i8, i8* %8, i64 %idxprom7, !dbg !2508
  %9 = load i8, i8* %arrayidx8, align 1, !dbg !2508
  %conv9 = zext i8 %9 to i32, !dbg !2508
  %shl10 = shl i32 %conv9, 11, !dbg !2509
  %or11 = or i32 %or, %shl10, !dbg !2510
  store i32 %or11, i32* %sample, align 4, !dbg !2511
  %10 = load i32, i32* %sample, align 4, !dbg !2512
  %11 = load i32, i32* %i, align 4, !dbg !2513
  %div = sdiv i32 %11, 3, !dbg !2514
  %idxprom12 = sext i32 %div to i64, !dbg !2515
  %12 = load i32*, i32** %dst.addr, align 8, !dbg !2515
  %arrayidx13 = getelementptr inbounds i32, i32* %12, i64 %idxprom12, !dbg !2515
  store i32 %10, i32* %arrayidx13, align 4, !dbg !2516
  br label %for.inc, !dbg !2517

for.inc:                                          ; preds = %for.body
  %13 = load i32, i32* %i, align 4, !dbg !2518
  %add14 = add nsw i32 %13, 3, !dbg !2518
  store i32 %add14, i32* %i, align 4, !dbg !2518
...
; Function Attrs: nounwind uwtable
define internal void @byte4_read(i8* %src, i32* %dst) #0 !dbg !2524 {
entry:
  %src.addr = alloca i8*, align 8
  %dst.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  %sample = alloca i32, align 4
  store i8* %src, i8** %src.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %src.addr, metadata !2525, metadata !2154), !dbg !2526
  store i32* %dst, i32** %dst.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %dst.addr, metadata !2527, metadata !2154), !dbg !2528
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2529, metadata !2154), !dbg !2530
  store i32 0, i32* %i, align 4, !dbg !2531
  br label %for.cond, !dbg !2533

for.cond:                                         ; preds = %for.inc, %entry
  %0 = load i32, i32* %i, align 4, !dbg !2534
  %cmp = icmp slt i32 %0, 120, !dbg !2537
  br i1 %cmp, label %for.body, label %for.end, !dbg !2538

for.body:                                         ; preds = %for.cond
  call void @llvm.dbg.declare(metadata i32* %sample, metadata !2539, metadata !2154), !dbg !2541
  %1 = load i32, i32* %i, align 4, !dbg !2542
  %add = add nsw i32 %1, 0, !dbg !2543
  %idxprom = sext i32 %add to i64, !dbg !2544
  %2 = load i8*, i8** %src.addr, align 8, !dbg !2544
  %arrayidx = getelementptr inbounds i8, i8* %2, i64 %idxprom, !dbg !2544
  %3 = load i8, i8* %arrayidx, align 1, !dbg !2544
  %conv = zext i8 %3 to i32, !dbg !2544
  %shl = shl i32 %conv, 25, !dbg !2545
  %4 = load i32, i32* %i, align 4, !dbg !2546
  %add1 = add nsw i32 %4, 1, !dbg !2547
  %idxprom2 = sext i32 %add1 to i64, !dbg !2548
  %5 = load i8*, i8** %src.addr, align 8, !dbg !2548
  %arrayidx3 = getelementptr inbounds i8, i8* %5, i64 %idxprom2, !dbg !2548
  %6 = load i8, i8* %arrayidx3, align 1, !dbg !2548
  %conv4 = zext i8 %6 to i32, !dbg !2548
  %shl5 = shl i32 %conv4, 18, !dbg !2549
  %or = or i32 %shl, %shl5, !dbg !2550
  %7 = load i32, i32* %i, align 4, !dbg !2551
  %add6 = add nsw i32 %7, 2, !dbg !2552
  %idxprom7 = sext i32 %add6 to i64, !dbg !2553
  %8 = load i8*, i8** %src.addr, align 8, !dbg !2553
  %arrayidx8 = getelementptr inbounds i8, i8* %8, i64 %idxprom7, !dbg !2553
  %9 = load i8, i8* %arrayidx8, align 1, !dbg !2553
  %conv9 = zext i8 %9 to i32, !dbg !2553
  %shl10 = shl i32 %conv9, 11, !dbg !2554
  %or11 = or i32 %or, %shl10, !dbg !2555
  %10 = load i32, i32* %i, align 4, !dbg !2556
  %add12 = add nsw i32 %10, 3, !dbg !2557
  %idxprom13 = sext i32 %add12 to i64, !dbg !2558
  %11 = load i8*, i8** %src.addr, align 8, !dbg !2558
  %arrayidx14 = getelementptr inbounds i8, i8* %11, i64 %idxprom13, !dbg !2558
  %12 = load i8, i8* %arrayidx14, align 1, !dbg !2558
  %conv15 = zext i8 %12 to i32, !dbg !2558
  %shl16 = shl i32 %conv15, 4, !dbg !2559
  %or17 = or i32 %or11, %shl16, !dbg !2560
  store i32 %or17, i32* %sample, align 4, !dbg !2561
  %13 = load i32, i32* %sample, align 4, !dbg !2562
  %14 = load i32, i32* %i, align 4, !dbg !2563
  %div = sdiv i32 %14, 4, !dbg !2564
  %idxprom18 = sext i32 %div to i64, !dbg !2565
  %15 = load i32*, i32** %dst.addr, align 8, !dbg !2565
  %arrayidx19 = getelementptr inbounds i32, i32* %15, i64 %idxprom18, !dbg !2565
  store i32 %13, i32* %arrayidx19, align 4, !dbg !2566
  br label %for.inc, !dbg !2567

for.inc:                                          ; preds = %for.body
  %16 = load i32, i32* %i, align 4, !dbg !2568
  %add20 = add nsw i32 %16, 4, !dbg !2568
  store i32 %add20, i32* %i, align 4, !dbg !2568
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--sdsdec.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!927 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !923, size: 64, align: 64)
!928 = !{!929}
!929 = distinct !DIGlobalVariable(name: "ff_sds_demuxer", scope: !0, file: !930, line: 156, type: !931, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_sds_demuxer)
!930 = !DIFile(filename: "libavformat/sdsdec.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!933 = !{!934, !938, !939, !940, !941, !951, !993, !994, !996, !997, !998, !1012, !2125, !2126, !2127, !2131, !2135, !2136, !2137, !2141, !2142, !2143}
...
!1651 = !{!926, !1470, !1652, !962, !1413, !926, !926}
...
!1782 = !DIDerivedType(tag: DW_TAG_member, name: "codec_info_duration", scope: !1769, file: !897, line: 1034, baseType: !1061, size: 64, align: 64, offset: 320)
!1783 = !DIDerivedType(tag: DW_TAG_member, name: "codec_info_duration_fields", scope: !1769, file: !897, line: 1035, baseType: !1061, size: 64, align: 64, offset: 384)
...
!1786 = !DIDerivedType(tag: DW_TAG_member, name: "last_duration", scope: !1769, file: !897, line: 1045, baseType: !1061, size: 64, align: 64, offset: 512)
!1787 = !DIDerivedType(tag: DW_TAG_member, name: "fps_first_dts", scope: !1769, file: !897, line: 1050, baseType: !1061, size: 64, align: 64, offset: 576)
...
!1789 = !DIDerivedType(tag: DW_TAG_member, name: "fps_last_dts", scope: !1769, file: !897, line: 1052, baseType: !1061, size: 64, align: 64, offset: 704)
...
!1792 = !DIDerivedType(tag: DW_TAG_member, name: "first_dts", scope: !1293, file: !897, line: 1067, baseType: !1061, size: 64, align: 64, offset: 1856)
!1793 = !DIDerivedType(tag: DW_TAG_member, name: "cur_dts", scope: !1293, file: !897, line: 1068, baseType: !1061, size: 64, align: 64, offset: 1920)
!1794 = !DIDerivedType(tag: DW_TAG_member, name: "last_IP_pts", scope: !1293, file: !897, line: 1069, baseType: !1061, size: 64, align: 64, offset: 1984)
...
!1803 = !DIDerivedType(tag: DW_TAG_member, name: "priv_data", scope: !1801, file: !4, line: 5093, baseType: !962, size: 64, align: 64)
...
!1833 = !DIDerivedType(tag: DW_TAG_member, name: "frame_offset", scope: !1801, file: !4, line: 5095, baseType: !1061, size: 64, align: 64, offset: 128)
!1834 = !DIDerivedType(tag: DW_TAG_member, name: "cur_offset", scope: !1801, file: !4, line: 5096, baseType: !1061, size: 64, align: 64, offset: 192)
!1835 = !DIDerivedType(tag: DW_TAG_member, name: "next_frame_offset", scope: !1801, file: !4, line: 5098, baseType: !1061, size: 64, align: 64, offset: 256)
...
!1838 = !DIDerivedType(tag: DW_TAG_member, name: "pts", scope: !1801, file: !4, line: 5111, baseType: !1061, size: 64, align: 64, offset: 384)
!1839 = !DIDerivedType(tag: DW_TAG_member, name: "dts", scope: !1801, file: !4, line: 5112, baseType: !1061, size: 64, align: 64, offset: 448)
!1840 = !DIDerivedType(tag: DW_TAG_member, name: "last_pts", scope: !1801, file: !4, line: 5115, baseType: !1061, size: 64, align: 64, offset: 512)
!1841 = !DIDerivedType(tag: DW_TAG_member, name: "last_dts", scope: !1801, file: !4, line: 5116, baseType: !1061, size: 64, align: 64, offset: 576)
...
!1845 = !DICompositeType(tag: DW_TAG_array_type, baseType: !1061, size: 256, align: 64, elements: !1397)
...
!1849 = !DIDerivedType(tag: DW_TAG_member, name: "offset", scope: !1801, file: !4, line: 5132, baseType: !1061, size: 64, align: 64, offset: 1536)
...
!1852 = !DIDerivedType(tag: DW_TAG_member, name: "convergence_duration", scope: !1801, file: !4, line: 5148, baseType: !1061, size: 64, align: 64, offset: 1920)
...
!1857 = !DIDerivedType(tag: DW_TAG_member, name: "pos", scope: !1801, file: !4, line: 5202, baseType: !1061, size: 64, align: 64, offset: 2368)
!1858 = !DIDerivedType(tag: DW_TAG_member, name: "last_pos", scope: !1801, file: !4, line: 5207, baseType: !1061, size: 64, align: 64, offset: 2432)
...
!1871 = !{!1872, !1873}
!1872 = !DIDerivedType(tag: DW_TAG_member, name: "pkt", scope: !1870, file: !897, line: 2004, baseType: !1043, size: 704, align: 64)
!1873 = !DIDerivedType(tag: DW_TAG_member, name: "next", scope: !1870, file: !897, line: 2005, baseType: !1869, size: 64, align: 64, offset: 704)
!1874 = !DIDerivedType(tag: DW_TAG_member, name: "probe_data", scope: !1293, file: !897, line: 1090, baseType: !1003, size: 256, align: 64, offset: 2304)
...
!1876 = !DICompositeType(tag: DW_TAG_array_type, baseType: !1061, size: 1088, align: 64, elements: !1877)
!1877 = !{!1878}
...
!1884 = !DIDerivedType(tag: DW_TAG_member, name: "pos", scope: !1882, file: !897, line: 794, baseType: !1061, size: 64, align: 64)
!1885 = !DIDerivedType(tag: DW_TAG_member, name: "timestamp", scope: !1882, file: !897, line: 795, baseType: !1061, size: 64, align: 64, offset: 64)
...
!1895 = !DIDerivedType(tag: DW_TAG_member, name: "interleaver_chunk_size", scope: !1293, file: !897, line: 1113, baseType: !1061, size: 64, align: 64, offset: 3904)
!1896 = !DIDerivedType(tag: DW_TAG_member, name: "interleaver_chunk_duration", scope: !1293, file: !897, line: 1114, baseType: !1061, size: 64, align: 64, offset: 3968)
...
!1900 = !DIDerivedType(tag: DW_TAG_member, name: "start_skip_samples", scope: !1293, file: !897, line: 1142, baseType: !1061, size: 64, align: 64, offset: 4160)
!1901 = !DIDerivedType(tag: DW_TAG_member, name: "first_discard_sample", scope: !1293, file: !897, line: 1150, baseType: !1061, size: 64, align: 64, offset: 4224)
!1902 = !DIDerivedType(tag: DW_TAG_member, name: "last_discard_sample", scope: !1293, file: !897, line: 1157, baseType: !1061, size: 64, align: 64, offset: 4288)
...
!1904 = !DIDerivedType(tag: DW_TAG_member, name: "mux_ts_offset", scope: !1293, file: !897, line: 1169, baseType: !1061, size: 64, align: 64, offset: 4416)
!1905 = !DIDerivedType(tag: DW_TAG_member, name: "pts_wrap_reference", scope: !1293, file: !897, line: 1174, baseType: !1061, size: 64, align: 64, offset: 4480)
...
!1910 = !DICompositeType(tag: DW_TAG_array_type, baseType: !1058, size: 136, align: 8, elements: !1877)
!1911 = !DIDerivedType(tag: DW_TAG_member, name: "last_dts_for_order_check", scope: !1293, file: !897, line: 1202, baseType: !1061, size: 64, align: 64, offset: 5888)
!1912 = !DIDerivedType(tag: DW_TAG_member, name: "dts_ordered", scope: !1293, file: !897, line: 1203, baseType: !1058, size: 8, align: 8, offset: 5952)
!1913 = !DIDerivedType(tag: DW_TAG_member, name: "dts_misordered", scope: !1293, file: !897, line: 1204, baseType: !1058, size: 8, align: 8, offset: 5960)
...
!1957 = !DIDerivedType(tag: DW_TAG_member, name: "priv_data", scope: !1926, file: !4, line: 5768, baseType: !962, size: 64, align: 64, offset: 192)
...
!1971 = !DIDerivedType(tag: DW_TAG_member, name: "pkt", scope: !1968, file: !947, line: 185, baseType: !1042, size: 64, align: 64, offset: 64)
...
!1978 = !{!1979, !1980, !1981}
!1979 = !DIDerivedType(tag: DW_TAG_member, name: "val", scope: !1977, file: !947, line: 62, baseType: !1061, size: 64, align: 64)
!1980 = !DIDerivedType(tag: DW_TAG_member, name: "num", scope: !1977, file: !947, line: 62, baseType: !1061, size: 64, align: 64, offset: 64)
!1981 = !DIDerivedType(tag: DW_TAG_member, name: "den", scope: !1977, file: !947, line: 62, baseType: !1061, size: 64, align: 64, offset: 128)
!1982 = !DIDerivedType(tag: DW_TAG_member, name: "filename", scope: !1017, file: !897, line: 1417, baseType: !1983, size: 8192, align: 8, offset: 448)
!1983 = !DICompositeType(tag: DW_TAG_array_type, baseType: !937, size: 8192, align: 8, elements: !1984)
!1984 = !{!1985}
!1985 = !DISubrange(count: 1024)
!1986 = !DIDerivedType(tag: DW_TAG_member, name: "url", scope: !1017, file: !897, line: 1433, baseType: !1403, size: 64, align: 64, offset: 8640)
!1987 = !DIDerivedType(tag: DW_TAG_member, name: "start_time", scope: !1017, file: !897, line: 1442, baseType: !1061, size: 64, align: 64, offset: 8704)
!1988 = !DIDerivedType(tag: DW_TAG_member, name: "duration", scope: !1017, file: !897, line: 1452, baseType: !1061, size: 64, align: 64, offset: 8768)
!1989 = !DIDerivedType(tag: DW_TAG_member, name: "bit_rate", scope: !1017, file: !897, line: 1459, baseType: !1061, size: 64, align: 64, offset: 8832)
!1990 = !DIDerivedType(tag: DW_TAG_member, name: "packet_size", scope: !1017, file: !897, line: 1461, baseType: !925, size: 32, align: 32, offset: 8896)
!1991 = !DIDerivedType(tag: DW_TAG_member, name: "max_delay", scope: !1017, file: !897, line: 1462, baseType: !926, size: 32, align: 32, offset: 8928)
!1992 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !1017, file: !897, line: 1468, baseType: !926, size: 32, align: 32, offset: 8960)
!1993 = !DIDerivedType(tag: DW_TAG_member, name: "probesize", scope: !1017, file: !897, line: 1503, baseType: !1061, size: 64, align: 64, offset: 9024)
!1994 = !DIDerivedType(tag: DW_TAG_member, name: "max_analyze_duration", scope: !1017, file: !897, line: 1511, baseType: !1061, size: 64, align: 64, offset: 9088)
!1995 = !DIDerivedType(tag: DW_TAG_member, name: "key", scope: !1017, file: !897, line: 1513, baseType: !1252, size: 64, align: 64, offset: 9152)
!1996 = !DIDerivedType(tag: DW_TAG_member, name: "keylen", scope: !1017, file: !897, line: 1514, baseType: !926, size: 32, align: 32, offset: 9216)
!1997 = !DIDerivedType(tag: DW_TAG_member, name: "nb_programs", scope: !1017, file: !897, line: 1516, baseType: !925, size: 32, align: 32, offset: 9248)
!1998 = !DIDerivedType(tag: DW_TAG_member, name: "programs", scope: !1017, file: !897, line: 1517, baseType: !1999, size: 64, align: 64, offset: 9280)
...
!2015 = !DIDerivedType(tag: DW_TAG_member, name: "start_time", scope: !2002, file: !897, line: 1279, baseType: !1061, size: 64, align: 64, offset: 448)
!2016 = !DIDerivedType(tag: DW_TAG_member, name: "end_time", scope: !2002, file: !897, line: 1280, baseType: !1061, size: 64, align: 64, offset: 512)
!2017 = !DIDerivedType(tag: DW_TAG_member, name: "pts_wrap_reference", scope: !2002, file: !897, line: 1282, baseType: !1061, size: 64, align: 64, offset: 576)
...
!2019 = !DIDerivedType(tag: DW_TAG_member, name: "video_codec_id", scope: !1017, file: !897, line: 1523, baseType: !3, size: 32, align: 32, offset: 9344)
!2020 = !DIDerivedType(tag: DW_TAG_member, name: "audio_codec_id", scope: !1017, file: !897, line: 1529, baseType: !3, size: 32, align: 32, offset: 9376)
!2021 = !DIDerivedType(tag: DW_TAG_member, name: "subtitle_codec_id", scope: !1017, file: !897, line: 1535, baseType: !3, size: 32, align: 32, offset: 9408)
!2022 = !DIDerivedType(tag: DW_TAG_member, name: "max_index_size", scope: !1017, file: !897, line: 1547, baseType: !925, size: 32, align: 32, offset: 9440)
!2023 = !DIDerivedType(tag: DW_TAG_member, name: "max_picture_buffer", scope: !1017, file: !897, line: 1553, baseType: !925, size: 32, align: 32, offset: 9472)
!2024 = !DIDerivedType(tag: DW_TAG_member, name: "nb_chapters", scope: !1017, file: !897, line: 1566, baseType: !925, size: 32, align: 32, offset: 9504)
!2025 = !DIDerivedType(tag: DW_TAG_member, name: "chapters", scope: !1017, file: !897, line: 1567, baseType: !2026, size: 64, align: 64, offset: 9536)
...
!2033 = !DIDerivedType(tag: DW_TAG_member, name: "start", scope: !2029, file: !897, line: 1297, baseType: !1061, size: 64, align: 64, offset: 128)
!2034 = !DIDerivedType(tag: DW_TAG_member, name: "end", scope: !2029, file: !897, line: 1297, baseType: !1061, size: 64, align: 64, offset: 192)
...
!2036 = !DIDerivedType(tag: DW_TAG_member, name: "metadata", scope: !1017, file: !897, line: 1577, baseType: !1163, size: 64, align: 64, offset: 9600)
!2037 = !DIDerivedType(tag: DW_TAG_member, name: "start_time_realtime", scope: !1017, file: !897, line: 1590, baseType: !1061, size: 64, align: 64, offset: 9664)
!2038 = !DIDerivedType(tag: DW_TAG_member, name: "fps_probe_size", scope: !1017, file: !897, line: 1597, baseType: !926, size: 32, align: 32, offset: 9728)
!2039 = !DIDerivedType(tag: DW_TAG_member, name: "error_recognition", scope: !1017, file: !897, line: 1604, baseType: !926, size: 32, align: 32, offset: 9760)
!2040 = !DIDerivedType(tag: DW_TAG_member, name: "interrupt_callback", scope: !1017, file: !897, line: 1615, baseType: !2041, size: 128, align: 64, offset: 9792)
...
!2045 = !DIDerivedType(tag: DW_TAG_member, name: "opaque", scope: !2042, file: !628, line: 60, baseType: !962, size: 64, align: 64, offset: 64)
!2046 = !DIDerivedType(tag: DW_TAG_member, name: "debug", scope: !1017, file: !897, line: 1620, baseType: !926, size: 32, align: 32, offset: 9920)
!2047 = !DIDerivedType(tag: DW_TAG_member, name: "max_interleave_delta", scope: !1017, file: !897, line: 1639, baseType: !1061, size: 64, align: 64, offset: 9984)
!2048 = !DIDerivedType(tag: DW_TAG_member, name: "strict_std_compliance", scope: !1017, file: !897, line: 1645, baseType: !926, size: 32, align: 32, offset: 10048)
!2049 = !DIDerivedType(tag: DW_TAG_member, name: "event_flags", scope: !1017, file: !897, line: 1652, baseType: !926, size: 32, align: 32, offset: 10080)
!2050 = !DIDerivedType(tag: DW_TAG_member, name: "max_ts_probe", scope: !1017, file: !897, line: 1659, baseType: !926, size: 32, align: 32, offset: 10112)
!2051 = !DIDerivedType(tag: DW_TAG_member, name: "avoid_negative_ts", scope: !1017, file: !897, line: 1668, baseType: !926, size: 32, align: 32, offset: 10144)
!2052 = !DIDerivedType(tag: DW_TAG_member, name: "ts_id", scope: !1017, file: !897, line: 1677, baseType: !926, size: 32, align: 32, offset: 10176)
!2053 = !DIDerivedType(tag: DW_TAG_member, name: "audio_preload", scope: !1017, file: !897, line: 1685, baseType: !926, size: 32, align: 32, offset: 10208)
!2054 = !DIDerivedType(tag: DW_TAG_member, name: "max_chunk_duration", scope: !1017, file: !897, line: 1693, baseType: !926, size: 32, align: 32, offset: 10240)
!2055 = !DIDerivedType(tag: DW_TAG_member, name: "max_chunk_size", scope: !1017, file: !897, line: 1701, baseType: !926, size: 32, align: 32, offset: 10272)
!2056 = !DIDerivedType(tag: DW_TAG_member, name: "use_wallclock_as_timestamps", scope: !1017, file: !897, line: 1709, baseType: !926, size: 32, align: 32, offset: 10304)
!2057 = !DIDerivedType(tag: DW_TAG_member, name: "avio_flags", scope: !1017, file: !897, line: 1716, baseType: !926, size: 32, align: 32, offset: 10336)
!2058 = !DIDerivedType(tag: DW_TAG_member, name: "duration_estimation_method", scope: !1017, file: !897, line: 1724, baseType: !911, size: 32, align: 32, offset: 10368)
!2059 = !DIDerivedType(tag: DW_TAG_member, name: "skip_initial_bytes", scope: !1017, file: !897, line: 1731, baseType: !1061, size: 64, align: 64, offset: 10432)
!2060 = !DIDerivedType(tag: DW_TAG_member, name: "correct_ts_overflow", scope: !1017, file: !897, line: 1738, baseType: !925, size: 32, align: 32, offset: 10496)
!2061 = !DIDerivedType(tag: DW_TAG_member, name: "seek2any", scope: !1017, file: !897, line: 1745, baseType: !926, size: 32, align: 32, offset: 10528)
!2062 = !DIDerivedType(tag: DW_TAG_member, name: "flush_packets", scope: !1017, file: !897, line: 1752, baseType: !926, size: 32, align: 32, offset: 10560)
!2063 = !DIDerivedType(tag: DW_TAG_member, name: "probe_score", scope: !1017, file: !897, line: 1761, baseType: !926, size: 32, align: 32, offset: 10592)
!2064 = !DIDerivedType(tag: DW_TAG_member, name: "format_probesize", scope: !1017, file: !897, line: 1768, baseType: !926, size: 32, align: 32, offset: 10624)
!2065 = !DIDerivedType(tag: DW_TAG_member, name: "codec_whitelist", scope: !1017, file: !897, line: 1776, baseType: !1403, size: 64, align: 64, offset: 10688)
!2066 = !DIDerivedType(tag: DW_TAG_member, name: "format_whitelist", scope: !1017, file: !897, line: 1784, baseType: !1403, size: 64, align: 64, offset: 10752)
!2067 = !DIDerivedType(tag: DW_TAG_member, name: "internal", scope: !1017, file: !897, line: 1790, baseType: !2068, size: 64, align: 64, offset: 10816)
...
!2075 = !DIDerivedType(tag: DW_TAG_member, name: "data_offset", scope: !2070, file: !947, line: 82, baseType: !1061, size: 64, align: 64, offset: 192)
...
!2081 = !DIDerivedType(tag: DW_TAG_member, name: "offset", scope: !2070, file: !947, line: 108, baseType: !1061, size: 64, align: 64, offset: 576)
...
!2086 = !DIDerivedType(tag: DW_TAG_member, name: "shortest_end", scope: !2070, file: !947, line: 126, baseType: !1061, size: 64, align: 64, offset: 832)
...
!2091 = !DIDerivedType(tag: DW_TAG_member, name: "io_repositioned", scope: !1017, file: !897, line: 1798, baseType: !926, size: 32, align: 32, offset: 10880)
!2092 = !DIDerivedType(tag: DW_TAG_member, name: "video_codec", scope: !1017, file: !897, line: 1806, baseType: !2093, size: 64, align: 64, offset: 10944)
...
!2095 = !DIDerivedType(tag: DW_TAG_member, name: "audio_codec", scope: !1017, file: !897, line: 1814, baseType: !2093, size: 64, align: 64, offset: 11008)
!2096 = !DIDerivedType(tag: DW_TAG_member, name: "subtitle_codec", scope: !1017, file: !897, line: 1822, baseType: !2093, size: 64, align: 64, offset: 11072)
!2097 = !DIDerivedType(tag: DW_TAG_member, name: "data_codec", scope: !1017, file: !897, line: 1830, baseType: !2093, size: 64, align: 64, offset: 11136)
!2098 = !DIDerivedType(tag: DW_TAG_member, name: "metadata_header_padding", scope: !1017, file: !897, line: 1837, baseType: !926, size: 32, align: 32, offset: 11200)
!2099 = !DIDerivedType(tag: DW_TAG_member, name: "opaque", scope: !1017, file: !897, line: 1843, baseType: !962, size: 64, align: 64, offset: 11264)
!2100 = !DIDerivedType(tag: DW_TAG_member, name: "control_message_cb", scope: !1017, file: !897, line: 1848, baseType: !2101, size: 64, align: 64, offset: 11328)
!2101 = !DIDerivedType(tag: DW_TAG_typedef, name: "av_format_control_message", file: !897, line: 1305, baseType: !1095)
!2102 = !DIDerivedType(tag: DW_TAG_member, name: "output_ts_offset", scope: !1017, file: !897, line: 1854, baseType: !1061, size: 64, align: 64, offset: 11392)
!2103 = !DIDerivedType(tag: DW_TAG_member, name: "dump_separator", scope: !1017, file: !897, line: 1862, baseType: !1057, size: 64, align: 64, offset: 11456)
!2104 = !DIDerivedType(tag: DW_TAG_member, name: "data_codec_id", scope: !1017, file: !897, line: 1868, baseType: !3, size: 32, align: 32, offset: 11520)
!2105 = !DIDerivedType(tag: DW_TAG_member, name: "open_cb", scope: !1017, file: !897, line: 1889, baseType: !2106, size: 64, align: 64, offset: 11584)
!2106 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2107, size: 64, align: 64)
!2107 = !DISubroutineType(types: !2108)
!2108 = !{!926, !1016, !2109, !935, !926, !2110, !2112}
...
!2113 = !DIDerivedType(tag: DW_TAG_member, name: "protocol_whitelist", scope: !1017, file: !897, line: 1897, baseType: !1403, size: 64, align: 64, offset: 11648)
!2114 = !DIDerivedType(tag: DW_TAG_member, name: "io_open", scope: !1017, file: !897, line: 1919, baseType: !2115, size: 64, align: 64, offset: 11712)
!2115 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2116, size: 64, align: 64)
!2116 = !DISubroutineType(types: !2117)
!2117 = !{!926, !1016, !2109, !935, !926, !2112}
!2118 = !DIDerivedType(tag: DW_TAG_member, name: "io_close", scope: !1017, file: !897, line: 1925, baseType: !2119, size: 64, align: 64, offset: 11776)
!2119 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2120, size: 64, align: 64)
!2120 = !DISubroutineType(types: !2121)
!2121 = !{null, !1016, !1223}
!2122 = !DIDerivedType(tag: DW_TAG_member, name: "protocol_blacklist", scope: !1017, file: !897, line: 1932, baseType: !1403, size: 64, align: 64, offset: 11840)
!2123 = !DIDerivedType(tag: DW_TAG_member, name: "max_streams", scope: !1017, file: !897, line: 1939, baseType: !926, size: 32, align: 32, offset: 11904)
!2124 = !DIDerivedType(tag: DW_TAG_member, name: "skip_estimate_duration_from_pts", scope: !1017, file: !897, line: 1946, baseType: !926, size: 32, align: 32, offset: 11936)
!2125 = !DIDerivedType(tag: DW_TAG_member, name: "read_packet", scope: !932, file: !897, line: 714, baseType: !1039, size: 64, align: 64, offset: 704)
!2126 = !DIDerivedType(tag: DW_TAG_member, name: "read_close", scope: !932, file: !897, line: 720, baseType: !1013, size: 64, align: 64, offset: 768)
...
!2134 = !{!1061, !1016, !926, !1093, !1061}
!2135 = !DIDerivedType(tag: DW_TAG_member, name: "read_play", scope: !932, file: !897, line: 744, baseType: !1013, size: 64, align: 64, offset: 960)
!2136 = !DIDerivedType(tag: DW_TAG_member, name: "read_pause", scope: !932, file: !897, line: 750, baseType: !1013, size: 64, align: 64, offset: 1024)
...
!2140 = !{!926, !1016, !926, !1061, !1061, !1061, !926}
...
!2147 = distinct !DISubprogram(name: "sds_probe", scope: !930, file: !930, line: 33, type: !1000, isLocal: true, isDefinition: true, scopeLine: 34, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2148)
!2148 = !{}
!2149 = !DILocalVariable(name: "x", arg: 1, scope: !2150, file: !2151, line: 66, type: !923)
!2150 = distinct !DISubprogram(name: "av_bswap32", scope: !2151, file: !2151, line: 66, type: !2152, isLocal: true, isDefinition: true, scopeLine: 67, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2148)
!2151 = !DIFile(filename: "./libavutil/bswap.h", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
!2152 = !DISubroutineType(types: !2153)
!2153 = !{!923, !923}
!2154 = !DIExpression()
!2155 = !DILocation(line: 66, column: 98, scope: !2150, inlinedAt: !2156)
!2156 = distinct !DILocation(line: 35, column: 9, scope: !2157)
!2157 = distinct !DILexicalBlock(scope: !2147, file: !930, line: 35, column: 9)
!2158 = !DILocalVariable(name: "p", arg: 1, scope: !2147, file: !930, line: 33, type: !1002)
!2159 = !DILocation(line: 33, column: 35, scope: !2147)
!2160 = !DILocation(line: 35, column: 52, scope: !2157)
!2161 = !DILocation(line: 35, column: 55, scope: !2157)
!2162 = !DILocation(line: 35, column: 62, scope: !2157)
!2163 = !DILocation(line: 35, column: 9, scope: !2157)
!2164 = !DILocation(line: 68, column: 16, scope: !2150, inlinedAt: !2156)
!2165 = !DILocation(line: 68, column: 19, scope: !2150, inlinedAt: !2156)
!2166 = !DILocation(line: 68, column: 24, scope: !2150, inlinedAt: !2156)
!2167 = !DILocation(line: 68, column: 38, scope: !2150, inlinedAt: !2156)
!2168 = !DILocation(line: 68, column: 41, scope: !2150, inlinedAt: !2156)
!2169 = !DILocation(line: 68, column: 46, scope: !2150, inlinedAt: !2156)
!2170 = !DILocation(line: 68, column: 34, scope: !2150, inlinedAt: !2156)
!2171 = !DILocation(line: 68, column: 57, scope: !2150, inlinedAt: !2156)
!2172 = !DILocation(line: 68, column: 69, scope: !2150, inlinedAt: !2156)
!2173 = !DILocation(line: 68, column: 72, scope: !2150, inlinedAt: !2156)
!2174 = !DILocation(line: 68, column: 79, scope: !2150, inlinedAt: !2156)
!2175 = !DILocation(line: 68, column: 84, scope: !2150, inlinedAt: !2156)
!2176 = !DILocation(line: 68, column: 99, scope: !2150, inlinedAt: !2156)
!2177 = !DILocation(line: 68, column: 102, scope: !2150, inlinedAt: !2156)
!2178 = !DILocation(line: 68, column: 109, scope: !2150, inlinedAt: !2156)
!2179 = !DILocation(line: 68, column: 114, scope: !2150, inlinedAt: !2156)
!2180 = !DILocation(line: 68, column: 94, scope: !2150, inlinedAt: !2156)
!2181 = !DILocation(line: 68, column: 63, scope: !2150, inlinedAt: !2156)
!2182 = !DILocation(line: 35, column: 66, scope: !2157)
!2183 = !DILocation(line: 35, column: 80, scope: !2157)
!2184 = !DILocation(line: 35, column: 83, scope: !2185)
!2185 = !DILexicalBlockFile(scope: !2157, file: !930, discriminator: 1)
!2186 = !DILocation(line: 35, column: 86, scope: !2185)
!2187 = !DILocation(line: 35, column: 94, scope: !2185)
!2188 = !DILocation(line: 35, column: 102, scope: !2185)
!2189 = !DILocation(line: 36, column: 9, scope: !2157)
!2190 = !DILocation(line: 36, column: 12, scope: !2157)
!2191 = !DILocation(line: 36, column: 19, scope: !2157)
!2192 = !DILocation(line: 36, column: 24, scope: !2157)
!2193 = !DILocation(line: 36, column: 27, scope: !2185)
!2194 = !DILocation(line: 36, column: 30, scope: !2185)
!2195 = !DILocation(line: 36, column: 37, scope: !2185)
!2196 = !DILocation(line: 35, column: 9, scope: !2197)
!2197 = !DILexicalBlockFile(scope: !2147, file: !930, discriminator: 2)
!2198 = !DILocation(line: 37, column: 9, scope: !2157)
!2199 = !DILocation(line: 38, column: 5, scope: !2147)
!2200 = !DILocation(line: 39, column: 1, scope: !2147)
!2201 = distinct !DISubprogram(name: "sds_read_header", scope: !930, file: !930, line: 78, type: !2202, isLocal: true, isDefinition: true, scopeLine: 79, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2148)
!2202 = !DISubroutineType(types: !2203)
!2203 = !{!926, !2204}
!2204 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2205, size: 64, align: 64)
!2205 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1017)
!2206 = !DILocalVariable(name: "ctx", arg: 1, scope: !2201, file: !930, line: 78, type: !2204)
!2207 = !DILocation(line: 78, column: 45, scope: !2201)
!2208 = !DILocalVariable(name: "s", scope: !2201, file: !930, line: 80, type: !2209)
!2209 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2210, size: 64, align: 64)
!2210 = !DIDerivedType(tag: DW_TAG_typedef, name: "SDSContext", file: !930, line: 31, baseType: !2211)
!2211 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "SDSContext", file: !930, line: 26, size: 1088, align: 64, elements: !2212)
!2212 = !{!2213, !2217, !2218, !2219}
!2213 = !DIDerivedType(tag: DW_TAG_member, name: "data", scope: !2211, file: !930, line: 27, baseType: !2214, size: 960, align: 8)
!2214 = !DICompositeType(tag: DW_TAG_array_type, baseType: !1058, size: 960, align: 8, elements: !2215)
!2215 = !{!2216}
!2216 = !DISubrange(count: 120)
!2217 = !DIDerivedType(tag: DW_TAG_member, name: "bit_depth", scope: !2211, file: !930, line: 28, baseType: !926, size: 32, align: 32, offset: 960)
!2218 = !DIDerivedType(tag: DW_TAG_member, name: "size", scope: !2211, file: !930, line: 29, baseType: !926, size: 32, align: 32, offset: 992)
!2219 = !DIDerivedType(tag: DW_TAG_member, name: "read_block", scope: !2211, file: !930, line: 30, baseType: !2220, size: 64, align: 64, offset: 1024)
!2220 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2221, size: 64, align: 64)
!2221 = !DISubroutineType(types: !2222)
!2222 = !{null, !1252, !927}
!2223 = !DILocation(line: 80, column: 17, scope: !2201)
!2224 = !DILocation(line: 80, column: 21, scope: !2201)
!2225 = !DILocation(line: 80, column: 26, scope: !2201)
!2226 = !DILocalVariable(name: "sample_period", scope: !2201, file: !930, line: 81, type: !925)
!2227 = !DILocation(line: 81, column: 14, scope: !2201)
!2228 = !DILocalVariable(name: "pb", scope: !2201, file: !930, line: 82, type: !1223)
!2229 = !DILocation(line: 82, column: 18, scope: !2201)
!2230 = !DILocation(line: 82, column: 23, scope: !2201)
!2231 = !DILocation(line: 82, column: 28, scope: !2201)
!2232 = !DILocalVariable(name: "st", scope: !2201, file: !930, line: 83, type: !1291)
!2233 = !DILocation(line: 83, column: 15, scope: !2201)
!2234 = !DILocation(line: 85, column: 30, scope: !2201)
!2235 = !DILocation(line: 85, column: 10, scope: !2201)
!2236 = !DILocation(line: 85, column: 8, scope: !2201)
!2237 = !DILocation(line: 86, column: 10, scope: !2238)
!2238 = distinct !DILexicalBlock(scope: !2201, file: !930, line: 86, column: 9)
!2239 = !DILocation(line: 86, column: 9, scope: !2201)
!2240 = !DILocation(line: 87, column: 9, scope: !2238)
!2241 = !DILocation(line: 89, column: 15, scope: !2201)
!2242 = !DILocation(line: 89, column: 5, scope: !2201)
!2243 = !DILocation(line: 90, column: 15, scope: !2201)
!2244 = !DILocation(line: 90, column: 5, scope: !2201)
!2245 = !DILocation(line: 92, column: 28, scope: !2201)
!2246 = !DILocation(line: 92, column: 20, scope: !2201)
!2247 = !DILocation(line: 92, column: 5, scope: !2201)
!2248 = !DILocation(line: 92, column: 8, scope: !2201)
!2249 = !DILocation(line: 92, column: 18, scope: !2201)
!2250 = !DILocation(line: 93, column: 9, scope: !2251)
!2251 = distinct !DILexicalBlock(scope: !2201, file: !930, line: 93, column: 9)
!2252 = !DILocation(line: 93, column: 12, scope: !2251)
!2253 = !DILocation(line: 93, column: 22, scope: !2251)
!2254 = !DILocation(line: 93, column: 26, scope: !2251)
!2255 = !DILocation(line: 93, column: 29, scope: !2256)
!2256 = !DILexicalBlockFile(scope: !2251, file: !930, discriminator: 1)
!2257 = !DILocation(line: 93, column: 32, scope: !2256)
!2258 = !DILocation(line: 93, column: 42, scope: !2256)
!2259 = !DILocation(line: 93, column: 9, scope: !2256)
!2260 = !DILocation(line: 94, column: 9, scope: !2251)
!2261 = !DILocation(line: 96, column: 9, scope: !2262)
!2262 = distinct !DILexicalBlock(scope: !2201, file: !930, line: 96, column: 9)
!2263 = !DILocation(line: 96, column: 12, scope: !2262)
!2264 = !DILocation(line: 96, column: 22, scope: !2262)
!2265 = !DILocation(line: 96, column: 9, scope: !2201)
!2266 = !DILocation(line: 97, column: 9, scope: !2267)
!2267 = distinct !DILexicalBlock(scope: !2262, file: !930, line: 96, column: 28)
!2268 = !DILocation(line: 97, column: 12, scope: !2267)
!2269 = !DILocation(line: 97, column: 23, scope: !2267)
!2270 = !DILocation(line: 98, column: 9, scope: !2267)
!2271 = !DILocation(line: 98, column: 12, scope: !2267)
!2272 = !DILocation(line: 98, column: 17, scope: !2267)
!2273 = !DILocation(line: 99, column: 5, scope: !2267)
!2274 = !DILocation(line: 99, column: 16, scope: !2275)
!2275 = !DILexicalBlockFile(scope: !2276, file: !930, discriminator: 1)
!2276 = distinct !DILexicalBlock(scope: !2262, file: !930, line: 99, column: 16)
!2277 = !DILocation(line: 99, column: 19, scope: !2275)
!2278 = !DILocation(line: 99, column: 29, scope: !2275)
!2279 = !DILocation(line: 100, column: 9, scope: !2280)
!2280 = distinct !DILexicalBlock(scope: !2276, file: !930, line: 99, column: 35)
!2281 = !DILocation(line: 100, column: 12, scope: !2280)
!2282 = !DILocation(line: 100, column: 23, scope: !2280)
!2283 = !DILocation(line: 101, column: 9, scope: !2280)
!2284 = !DILocation(line: 101, column: 12, scope: !2280)
!2285 = !DILocation(line: 101, column: 17, scope: !2280)
!2286 = !DILocation(line: 102, column: 5, scope: !2280)
!2287 = !DILocation(line: 103, column: 9, scope: !2288)
!2288 = distinct !DILexicalBlock(scope: !2276, file: !930, line: 102, column: 12)
!2289 = !DILocation(line: 103, column: 12, scope: !2288)
!2290 = !DILocation(line: 103, column: 23, scope: !2288)
!2291 = !DILocation(line: 104, column: 9, scope: !2288)
!2292 = !DILocation(line: 104, column: 12, scope: !2288)
!2293 = !DILocation(line: 104, column: 17, scope: !2288)
!2294 = !DILocation(line: 106, column: 5, scope: !2201)
!2295 = !DILocation(line: 106, column: 9, scope: !2201)
!2296 = !DILocation(line: 106, column: 19, scope: !2201)
!2297 = !DILocation(line: 106, column: 28, scope: !2201)
!2298 = !DILocation(line: 108, column: 31, scope: !2201)
!2299 = !DILocation(line: 108, column: 21, scope: !2201)
!2300 = !DILocation(line: 108, column: 19, scope: !2201)
!2301 = !DILocation(line: 109, column: 24, scope: !2201)
!2302 = !DILocation(line: 109, column: 39, scope: !2201)
!2303 = !DILocation(line: 109, column: 52, scope: !2201)
!2304 = !DILocation(line: 109, column: 67, scope: !2201)
!2305 = !DILocation(line: 109, column: 77, scope: !2201)
!2306 = !DILocation(line: 109, column: 47, scope: !2201)
!2307 = !DILocation(line: 109, column: 88, scope: !2201)
!2308 = !DILocation(line: 109, column: 103, scope: !2201)
!2309 = !DILocation(line: 109, column: 115, scope: !2201)
!2310 = !DILocation(line: 109, column: 83, scope: !2201)
!2311 = !DILocation(line: 109, column: 19, scope: !2201)
!2312 = !DILocation(line: 110, column: 15, scope: !2201)
!2313 = !DILocation(line: 110, column: 5, scope: !2201)
!2314 = !DILocation(line: 112, column: 5, scope: !2201)
!2315 = !DILocation(line: 112, column: 9, scope: !2201)
!2316 = !DILocation(line: 112, column: 19, scope: !2201)
!2317 = !DILocation(line: 112, column: 30, scope: !2201)
!2318 = !DILocation(line: 113, column: 5, scope: !2201)
!2319 = !DILocation(line: 113, column: 9, scope: !2201)
!2320 = !DILocation(line: 113, column: 19, scope: !2201)
!2321 = !DILocation(line: 113, column: 28, scope: !2201)
!2322 = !DILocation(line: 114, column: 33, scope: !2201)
!2323 = !DILocation(line: 114, column: 62, scope: !2324)
!2324 = !DILexicalBlockFile(scope: !2201, file: !930, discriminator: 1)
!2325 = !DILocation(line: 114, column: 60, scope: !2324)
!2326 = !DILocation(line: 114, column: 33, scope: !2324)
!2327 = !DILocation(line: 114, column: 33, scope: !2328)
!2328 = !DILexicalBlockFile(scope: !2201, file: !930, discriminator: 2)
!2329 = !DILocation(line: 114, column: 33, scope: !2330)
!2330 = !DILexicalBlockFile(scope: !2201, file: !930, discriminator: 3)
!2331 = !DILocation(line: 114, column: 5, scope: !2330)
!2332 = !DILocation(line: 114, column: 9, scope: !2330)
!2333 = !DILocation(line: 114, column: 19, scope: !2330)
!2334 = !DILocation(line: 114, column: 31, scope: !2330)
!2335 = !DILocation(line: 115, column: 31, scope: !2201)
!2336 = !DILocation(line: 115, column: 21, scope: !2201)
!2337 = !DILocation(line: 115, column: 35, scope: !2201)
!2338 = !DILocation(line: 115, column: 41, scope: !2201)
!2339 = !DILocation(line: 115, column: 51, scope: !2201)
!2340 = !DILocation(line: 115, column: 54, scope: !2201)
!2341 = !DILocation(line: 115, column: 49, scope: !2201)
!2342 = !DILocation(line: 115, column: 59, scope: !2201)
!2343 = !DILocation(line: 115, column: 5, scope: !2201)
!2344 = !DILocation(line: 115, column: 9, scope: !2201)
!2345 = !DILocation(line: 115, column: 18, scope: !2201)
!2346 = !DILocation(line: 117, column: 25, scope: !2201)
!2347 = !DILocation(line: 117, column: 36, scope: !2201)
!2348 = !DILocation(line: 117, column: 40, scope: !2201)
!2349 = !DILocation(line: 117, column: 50, scope: !2201)
!2350 = !DILocation(line: 117, column: 5, scope: !2201)
!2351 = !DILocation(line: 119, column: 5, scope: !2201)
!2352 = !DILocation(line: 120, column: 1, scope: !2201)
!2353 = distinct !DISubprogram(name: "sds_read_packet", scope: !930, file: !930, line: 122, type: !2354, isLocal: true, isDefinition: true, scopeLine: 123, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2148)
!2354 = !DISubroutineType(types: !2355)
!2355 = !{!926, !2204, !1042}
!2356 = !DILocalVariable(name: "s", arg: 1, scope: !2357, file: !628, line: 557, type: !1223)
!2357 = distinct !DISubprogram(name: "avio_tell", scope: !628, file: !628, line: 557, type: !2358, isLocal: true, isDefinition: true, scopeLine: 558, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2148)
!2358 = !DISubroutineType(types: !2359)
!2359 = !{!1061, !1223}
!2360 = !DILocation(line: 557, column: 77, scope: !2357, inlinedAt: !2361)
!2361 = distinct !DILocation(line: 132, column: 11, scope: !2353)
!2362 = !DILocalVariable(name: "ctx", arg: 1, scope: !2353, file: !930, line: 122, type: !2204)
!2363 = !DILocation(line: 122, column: 45, scope: !2353)
!2364 = !DILocalVariable(name: "pkt", arg: 2, scope: !2353, file: !930, line: 122, type: !1042)
!2365 = !DILocation(line: 122, column: 60, scope: !2353)
!2366 = !DILocalVariable(name: "s", scope: !2353, file: !930, line: 124, type: !2209)
!2367 = !DILocation(line: 124, column: 17, scope: !2353)
!2368 = !DILocation(line: 124, column: 21, scope: !2353)
!2369 = !DILocation(line: 124, column: 26, scope: !2353)
!2370 = !DILocalVariable(name: "pb", scope: !2353, file: !930, line: 125, type: !1223)
!2371 = !DILocation(line: 125, column: 18, scope: !2353)
!2372 = !DILocation(line: 125, column: 23, scope: !2353)
!2373 = !DILocation(line: 125, column: 28, scope: !2353)
!2374 = !DILocalVariable(name: "pos", scope: !2353, file: !930, line: 126, type: !1061)
!2375 = !DILocation(line: 126, column: 13, scope: !2353)
!2376 = !DILocalVariable(name: "ret", scope: !2353, file: !930, line: 127, type: !926)
!2377 = !DILocation(line: 127, column: 9, scope: !2353)
!2378 = !DILocation(line: 129, column: 19, scope: !2379)
!2379 = distinct !DILexicalBlock(scope: !2353, file: !930, line: 129, column: 9)
!2380 = !DILocation(line: 129, column: 9, scope: !2379)
!2381 = !DILocation(line: 129, column: 9, scope: !2353)
!2382 = !DILocation(line: 130, column: 9, scope: !2379)
!2383 = !DILocation(line: 132, column: 21, scope: !2353)
!2384 = !DILocation(line: 132, column: 11, scope: !2353)
!2385 = !DILocation(line: 559, column: 22, scope: !2357, inlinedAt: !2361)
!2386 = !DILocation(line: 559, column: 12, scope: !2357, inlinedAt: !2361)
!2387 = !DILocation(line: 132, column: 9, scope: !2353)
!2388 = !DILocation(line: 133, column: 19, scope: !2389)
!2389 = distinct !DILexicalBlock(scope: !2353, file: !930, line: 133, column: 9)
!2390 = !DILocation(line: 133, column: 9, scope: !2389)
!2391 = !DILocation(line: 133, column: 23, scope: !2389)
!2392 = !DILocation(line: 133, column: 9, scope: !2353)
!2393 = !DILocation(line: 134, column: 9, scope: !2389)
!2394 = !DILocation(line: 135, column: 15, scope: !2353)
!2395 = !DILocation(line: 135, column: 5, scope: !2353)
!2396 = !DILocation(line: 137, column: 25, scope: !2353)
!2397 = !DILocation(line: 137, column: 30, scope: !2353)
!2398 = !DILocation(line: 137, column: 33, scope: !2353)
!2399 = !DILocation(line: 137, column: 11, scope: !2353)
!2400 = !DILocation(line: 137, column: 9, scope: !2353)
!2401 = !DILocation(line: 138, column: 9, scope: !2402)
!2402 = distinct !DILexicalBlock(scope: !2353, file: !930, line: 138, column: 9)
!2403 = !DILocation(line: 138, column: 13, scope: !2402)
!2404 = !DILocation(line: 138, column: 9, scope: !2353)
!2405 = !DILocation(line: 139, column: 16, scope: !2402)
!2406 = !DILocation(line: 139, column: 9, scope: !2402)
!2407 = !DILocation(line: 141, column: 21, scope: !2353)
!2408 = !DILocation(line: 141, column: 25, scope: !2353)
!2409 = !DILocation(line: 141, column: 28, scope: !2353)
!2410 = !DILocation(line: 141, column: 11, scope: !2353)
!2411 = !DILocation(line: 141, column: 9, scope: !2353)
!2412 = !DILocation(line: 143, column: 5, scope: !2353)
!2413 = !DILocation(line: 143, column: 8, scope: !2353)
!2414 = !DILocation(line: 143, column: 19, scope: !2353)
!2415 = !DILocation(line: 143, column: 22, scope: !2353)
!2416 = !DILocation(line: 143, column: 40, scope: !2353)
!2417 = !DILocation(line: 143, column: 45, scope: !2353)
!2418 = !DILocation(line: 143, column: 28, scope: !2353)
!2419 = !DILocation(line: 145, column: 15, scope: !2353)
!2420 = !DILocation(line: 145, column: 5, scope: !2353)
!2421 = !DILocation(line: 146, column: 17, scope: !2422)
!2422 = distinct !DILexicalBlock(scope: !2353, file: !930, line: 146, column: 9)
!2423 = !DILocation(line: 146, column: 9, scope: !2422)
!2424 = !DILocation(line: 146, column: 21, scope: !2422)
!2425 = !DILocation(line: 146, column: 9, scope: !2353)
!2426 = !DILocation(line: 147, column: 9, scope: !2422)
!2427 = !DILocation(line: 149, column: 5, scope: !2353)
!2428 = !DILocation(line: 149, column: 10, scope: !2353)
!2429 = !DILocation(line: 149, column: 16, scope: !2353)
!2430 = !DILocation(line: 150, column: 5, scope: !2353)
!2431 = !DILocation(line: 150, column: 10, scope: !2353)
!2432 = !DILocation(line: 150, column: 23, scope: !2353)
!2433 = !DILocation(line: 151, column: 16, scope: !2353)
!2434 = !DILocation(line: 151, column: 5, scope: !2353)
!2435 = !DILocation(line: 151, column: 10, scope: !2353)
!2436 = !DILocation(line: 151, column: 14, scope: !2353)
!2437 = !DILocation(line: 153, column: 12, scope: !2353)
!2438 = !DILocation(line: 153, column: 5, scope: !2353)
!2439 = !DILocation(line: 154, column: 1, scope: !2353)
!2440 = distinct !DISubprogram(name: "byte2_read", scope: !930, file: !930, line: 41, type: !2221, isLocal: true, isDefinition: true, scopeLine: 42, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2148)
!2441 = !DILocalVariable(name: "src", arg: 1, scope: !2440, file: !930, line: 41, type: !1252)
!2442 = !DILocation(line: 41, column: 39, scope: !2440)
!2443 = !DILocalVariable(name: "dst", arg: 2, scope: !2440, file: !930, line: 41, type: !927)
!2444 = !DILocation(line: 41, column: 54, scope: !2440)
!2445 = !DILocalVariable(name: "i", scope: !2440, file: !930, line: 43, type: !926)
!2446 = !DILocation(line: 43, column: 9, scope: !2440)
!2447 = !DILocation(line: 45, column: 12, scope: !2448)
!2448 = distinct !DILexicalBlock(scope: !2440, file: !930, line: 45, column: 5)
!2449 = !DILocation(line: 45, column: 10, scope: !2448)
!2450 = !DILocation(line: 45, column: 17, scope: !2451)
!2451 = !DILexicalBlockFile(scope: !2452, file: !930, discriminator: 1)
!2452 = distinct !DILexicalBlock(scope: !2448, file: !930, line: 45, column: 5)
!2453 = !DILocation(line: 45, column: 19, scope: !2451)
!2454 = !DILocation(line: 45, column: 5, scope: !2451)
!2455 = !DILocalVariable(name: "sample", scope: !2456, file: !930, line: 46, type: !925)
!2456 = distinct !DILexicalBlock(scope: !2452, file: !930, line: 45, column: 34)
!2457 = !DILocation(line: 46, column: 18, scope: !2456)
!2458 = !DILocation(line: 46, column: 32, scope: !2456)
!2459 = !DILocation(line: 46, column: 34, scope: !2456)
!2460 = !DILocation(line: 46, column: 28, scope: !2456)
!2461 = !DILocation(line: 46, column: 39, scope: !2456)
!2462 = !DILocation(line: 46, column: 53, scope: !2456)
!2463 = !DILocation(line: 46, column: 55, scope: !2456)
!2464 = !DILocation(line: 46, column: 49, scope: !2456)
!2465 = !DILocation(line: 46, column: 60, scope: !2456)
!2466 = !DILocation(line: 46, column: 46, scope: !2456)
!2467 = !DILocation(line: 48, column: 22, scope: !2456)
!2468 = !DILocation(line: 48, column: 13, scope: !2456)
!2469 = !DILocation(line: 48, column: 15, scope: !2456)
!2470 = !DILocation(line: 48, column: 9, scope: !2456)
!2471 = !DILocation(line: 48, column: 20, scope: !2456)
!2472 = !DILocation(line: 49, column: 5, scope: !2456)
!2473 = !DILocation(line: 45, column: 28, scope: !2474)
!2474 = !DILexicalBlockFile(scope: !2452, file: !930, discriminator: 2)
!2475 = !DILocation(line: 45, column: 5, scope: !2474)
!2476 = distinct !{!2476, !2477}
!2477 = !DILocation(line: 45, column: 5, scope: !2440)
!2478 = !DILocation(line: 50, column: 1, scope: !2440)
!2479 = distinct !DISubprogram(name: "byte3_read", scope: !930, file: !930, line: 52, type: !2221, isLocal: true, isDefinition: true, scopeLine: 53, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2148)
!2480 = !DILocalVariable(name: "src", arg: 1, scope: !2479, file: !930, line: 52, type: !1252)
!2481 = !DILocation(line: 52, column: 39, scope: !2479)
!2482 = !DILocalVariable(name: "dst", arg: 2, scope: !2479, file: !930, line: 52, type: !927)
!2483 = !DILocation(line: 52, column: 54, scope: !2479)
!2484 = !DILocalVariable(name: "i", scope: !2479, file: !930, line: 54, type: !926)
!2485 = !DILocation(line: 54, column: 9, scope: !2479)
!2486 = !DILocation(line: 56, column: 12, scope: !2487)
!2487 = distinct !DILexicalBlock(scope: !2479, file: !930, line: 56, column: 5)
!2488 = !DILocation(line: 56, column: 10, scope: !2487)
!2489 = !DILocation(line: 56, column: 17, scope: !2490)
!2490 = !DILexicalBlockFile(scope: !2491, file: !930, discriminator: 1)
!2491 = distinct !DILexicalBlock(scope: !2487, file: !930, line: 56, column: 5)
!2492 = !DILocation(line: 56, column: 19, scope: !2490)
!2493 = !DILocation(line: 56, column: 5, scope: !2490)
!2494 = !DILocalVariable(name: "sample", scope: !2495, file: !930, line: 57, type: !925)
!2495 = distinct !DILexicalBlock(scope: !2491, file: !930, line: 56, column: 34)
!2496 = !DILocation(line: 57, column: 18, scope: !2495)
!2497 = !DILocation(line: 59, column: 23, scope: !2495)
!2498 = !DILocation(line: 59, column: 25, scope: !2495)
!2499 = !DILocation(line: 59, column: 19, scope: !2495)
!2500 = !DILocation(line: 59, column: 30, scope: !2495)
!2501 = !DILocation(line: 59, column: 44, scope: !2495)
!2502 = !DILocation(line: 59, column: 46, scope: !2495)
!2503 = !DILocation(line: 59, column: 40, scope: !2495)
!2504 = !DILocation(line: 59, column: 51, scope: !2495)
!2505 = !DILocation(line: 59, column: 37, scope: !2495)
!2506 = !DILocation(line: 59, column: 65, scope: !2495)
!2507 = !DILocation(line: 59, column: 67, scope: !2495)
!2508 = !DILocation(line: 59, column: 61, scope: !2495)
!2509 = !DILocation(line: 59, column: 72, scope: !2495)
!2510 = !DILocation(line: 59, column: 58, scope: !2495)
!2511 = !DILocation(line: 59, column: 16, scope: !2495)
!2512 = !DILocation(line: 60, column: 22, scope: !2495)
!2513 = !DILocation(line: 60, column: 13, scope: !2495)
!2514 = !DILocation(line: 60, column: 15, scope: !2495)
!2515 = !DILocation(line: 60, column: 9, scope: !2495)
!2516 = !DILocation(line: 60, column: 20, scope: !2495)
!2517 = !DILocation(line: 61, column: 5, scope: !2495)
!2518 = !DILocation(line: 56, column: 28, scope: !2519)
!2519 = !DILexicalBlockFile(scope: !2491, file: !930, discriminator: 2)
!2520 = !DILocation(line: 56, column: 5, scope: !2519)
!2521 = distinct !{!2521, !2522}
!2522 = !DILocation(line: 56, column: 5, scope: !2479)
!2523 = !DILocation(line: 62, column: 1, scope: !2479)
!2524 = distinct !DISubprogram(name: "byte4_read", scope: !930, file: !930, line: 64, type: !2221, isLocal: true, isDefinition: true, scopeLine: 65, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2148)
!2525 = !DILocalVariable(name: "src", arg: 1, scope: !2524, file: !930, line: 64, type: !1252)
!2526 = !DILocation(line: 64, column: 39, scope: !2524)
!2527 = !DILocalVariable(name: "dst", arg: 2, scope: !2524, file: !930, line: 64, type: !927)
!2528 = !DILocation(line: 64, column: 54, scope: !2524)
!2529 = !DILocalVariable(name: "i", scope: !2524, file: !930, line: 66, type: !926)
!2530 = !DILocation(line: 66, column: 9, scope: !2524)
!2531 = !DILocation(line: 68, column: 12, scope: !2532)
!2532 = distinct !DILexicalBlock(scope: !2524, file: !930, line: 68, column: 5)
!2533 = !DILocation(line: 68, column: 10, scope: !2532)
!2534 = !DILocation(line: 68, column: 17, scope: !2535)
!2535 = !DILexicalBlockFile(scope: !2536, file: !930, discriminator: 1)
!2536 = distinct !DILexicalBlock(scope: !2532, file: !930, line: 68, column: 5)
!2537 = !DILocation(line: 68, column: 19, scope: !2535)
!2538 = !DILocation(line: 68, column: 5, scope: !2535)
!2539 = !DILocalVariable(name: "sample", scope: !2540, file: !930, line: 69, type: !925)
!2540 = distinct !DILexicalBlock(scope: !2536, file: !930, line: 68, column: 34)
!2541 = !DILocation(line: 69, column: 18, scope: !2540)
!2542 = !DILocation(line: 71, column: 23, scope: !2540)
!2543 = !DILocation(line: 71, column: 25, scope: !2540)
!2544 = !DILocation(line: 71, column: 19, scope: !2540)
!2545 = !DILocation(line: 71, column: 30, scope: !2540)
!2546 = !DILocation(line: 71, column: 44, scope: !2540)
!2547 = !DILocation(line: 71, column: 46, scope: !2540)
!2548 = !DILocation(line: 71, column: 40, scope: !2540)
!2549 = !DILocation(line: 71, column: 51, scope: !2540)
!2550 = !DILocation(line: 71, column: 37, scope: !2540)
!2551 = !DILocation(line: 71, column: 65, scope: !2540)
!2552 = !DILocation(line: 71, column: 67, scope: !2540)
!2553 = !DILocation(line: 71, column: 61, scope: !2540)
!2554 = !DILocation(line: 71, column: 72, scope: !2540)
!2555 = !DILocation(line: 71, column: 58, scope: !2540)
!2556 = !DILocation(line: 71, column: 86, scope: !2540)
!2557 = !DILocation(line: 71, column: 88, scope: !2540)
!2558 = !DILocation(line: 71, column: 82, scope: !2540)
!2559 = !DILocation(line: 71, column: 93, scope: !2540)
!2560 = !DILocation(line: 71, column: 79, scope: !2540)
!2561 = !DILocation(line: 71, column: 16, scope: !2540)
!2562 = !DILocation(line: 72, column: 22, scope: !2540)
!2563 = !DILocation(line: 72, column: 13, scope: !2540)
!2564 = !DILocation(line: 72, column: 15, scope: !2540)
!2565 = !DILocation(line: 72, column: 9, scope: !2540)
!2566 = !DILocation(line: 72, column: 20, scope: !2540)
!2567 = !DILocation(line: 73, column: 5, scope: !2540)
!2568 = !DILocation(line: 68, column: 28, scope: !2569)
!2569 = !DILexicalBlockFile(scope: !2536, file: !930, discriminator: 2)
!2570 = !DILocation(line: 68, column: 5, scope: !2569)
!2571 = distinct !{!2571, !2572}
!2572 = !DILocation(line: 68, column: 5, scope: !2524)
!2573 = !DILocation(line: 74, column: 1, scope: !2524)
