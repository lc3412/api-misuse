; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--sdxdec.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--sdxdec.o.i"
...
@ff_sdx_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i32 0, i32 0), i32 256, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 0, i32 (%struct.AVProbeData*)* @sdx_probe, i32 (%struct.AVFormatContext*)* @sdx_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @ff_pcm_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* @ff_pcm_read_seek, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
@.str.2 = private unnamed_addr constant [5 x i8] c"SDX:\00", align 1

; Function Attrs: nounwind uwtable
define internal i32 @sdx_probe(%struct.AVProbeData* %p) #0 !dbg !2146 {
entry:
  %x.addr.i2 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %x.addr.i2, metadata !2148, metadata !2153), !dbg !2154
  %x.addr.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %x.addr.i, metadata !2148, metadata !2153), !dbg !2158
  %retval = alloca i32, align 4
  %p.addr = alloca %struct.AVProbeData*, align 8
  store %struct.AVProbeData* %p, %struct.AVProbeData** %p.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVProbeData** %p.addr, metadata !2160, metadata !2153), !dbg !2161
  ...
  store i32 %3, i32* %x.addr.i, align 4, !dbg !2165
  %4 = load i32, i32* %x.addr.i, align 4, !dbg !2166
  %shl.i = shl i32 %4, 8, !dbg !2167
  %and.i = and i32 %shl.i, 65280, !dbg !2168
  %5 = load i32, i32* %x.addr.i, align 4, !dbg !2169
  %shr.i = lshr i32 %5, 8, !dbg !2170
  %and1.i = and i32 %shr.i, 255, !dbg !2171
  %or.i = or i32 %and.i, %and1.i, !dbg !2172
  %shl2.i = shl i32 %or.i, 16, !dbg !2173
  %6 = load i32, i32* %x.addr.i, align 4, !dbg !2174
  %shr3.i = lshr i32 %6, 16, !dbg !2175
  %shl4.i = shl i32 %shr3.i, 8, !dbg !2176
  %and5.i = and i32 %shl4.i, 65280, !dbg !2177
  %7 = load i32, i32* %x.addr.i, align 4, !dbg !2178
  %shr6.i = lshr i32 %7, 16, !dbg !2179
  %shr7.i = lshr i32 %shr6.i, 8, !dbg !2180
  %and8.i = and i32 %shr7.i, 255, !dbg !2181
  %or9.i = or i32 %and5.i, %and8.i, !dbg !2182
  %or10.i = or i32 %shl2.i, %or9.i, !dbg !2183
  %8 = load i32, i32* bitcast ([5 x i8]* @.str.2 to i32*), align 1, !dbg !2184
  store i32 %8, i32* %x.addr.i2, align 4, !dbg !2185
  %9 = load i32, i32* %x.addr.i2, align 4, !dbg !2186
  %shl.i3 = shl i32 %9, 8, !dbg !2187
  %and.i4 = and i32 %shl.i3, 65280, !dbg !2188
  %10 = load i32, i32* %x.addr.i2, align 4, !dbg !2189
  %shr.i5 = lshr i32 %10, 8, !dbg !2190
  %and1.i6 = and i32 %shr.i5, 255, !dbg !2191
  %or.i7 = or i32 %and.i4, %and1.i6, !dbg !2192
  %shl2.i8 = shl i32 %or.i7, 16, !dbg !2193
  %11 = load i32, i32* %x.addr.i2, align 4, !dbg !2194
  %shr3.i9 = lshr i32 %11, 16, !dbg !2195
  %shl4.i10 = shl i32 %shr3.i9, 8, !dbg !2196
  %and5.i11 = and i32 %shl4.i10, 65280, !dbg !2197
  %12 = load i32, i32* %x.addr.i2, align 4, !dbg !2198
  %shr6.i12 = lshr i32 %12, 16, !dbg !2199
  %shr7.i13 = lshr i32 %shr6.i12, 8, !dbg !2200
  %and8.i14 = and i32 %shr7.i13, 255, !dbg !2201
  %or9.i15 = or i32 %and5.i11, %and8.i14, !dbg !2202
  %or10.i16 = or i32 %shl2.i8, %or9.i15, !dbg !2203
  %cmp = icmp eq i32 %or10.i, %or10.i16, !dbg !2204
  br i1 %cmp, label %if.then, label %if.end, !dbg !2205

if.then:                                          ; preds = %entry
  store i32 50, i32* %retval, align 4, !dbg !2206
...
return:                                           ; preds = %if.end, %if.then
  %13 = load i32, i32* %retval, align 4, !dbg !2208
  ret i32 %13, !dbg !2208
}

; Function Attrs: nounwind uwtable
define internal i32 @sdx_read_header(%struct.AVFormatContext* %s) #0 !dbg !2209 {
entry:
  %retval = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2214, metadata !2153), !dbg !2215
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2216, metadata !2153), !dbg !2217
  call void @llvm.dbg.declare(metadata i32* %depth, metadata !2218, metadata !2153), !dbg !2219
  call void @llvm.dbg.declare(metadata i32* %length, metadata !2220, metadata !2153), !dbg !2221
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2222
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2223
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2223
  %call = call i64 @avio_skip(%struct.AVIOContext* %1, i64 4), !dbg !2224
  br label %while.cond, !dbg !2225

while.cond:                                       ; preds = %if.end, %entry
  %2 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2226
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %2, i32 0, i32 4, !dbg !2228
  %3 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2228
  %call2 = call i32 @avio_feof(%struct.AVIOContext* %3), !dbg !2229
  %tobool = icmp ne i32 %call2, 0, !dbg !2230
  %lnot = xor i1 %tobool, true, !dbg !2230
  br i1 %lnot, label %while.body, label %while.end, !dbg !2231

while.body:                                       ; preds = %while.cond
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2232
  %pb3 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %4, i32 0, i32 4, !dbg !2235
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb3, align 8, !dbg !2235
  %call4 = call i32 @avio_r8(%struct.AVIOContext* %5), !dbg !2236
  %cmp = icmp eq i32 %call4, 26, !dbg !2237
  br i1 %cmp, label %if.then, label %if.end, !dbg !2238

if.then:                                          ; preds = %while.body
  br label %while.end, !dbg !2239

if.end:                                           ; preds = %while.body
  br label %while.cond, !dbg !2240, !llvm.loop !2242

while.end:                                        ; preds = %if.then, %while.cond
  %6 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2243
  %pb5 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %6, i32 0, i32 4, !dbg !2245
  %7 = load %struct.AVIOContext*, %struct.AVIOContext** %pb5, align 8, !dbg !2245
  %call6 = call i32 @avio_r8(%struct.AVIOContext* %7), !dbg !2246
  %cmp7 = icmp ne i32 %call6, 1, !dbg !2247
  br i1 %cmp7, label %if.then8, label %if.end9, !dbg !2248
...
if.end9:                                          ; preds = %while.end
  %8 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2250
  %pb10 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %8, i32 0, i32 4, !dbg !2251
  %9 = load %struct.AVIOContext*, %struct.AVIOContext** %pb10, align 8, !dbg !2251
  %call11 = call i32 @avio_r8(%struct.AVIOContext* %9), !dbg !2252
  store i32 %call11, i32* %length, align 4, !dbg !2253
  %10 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2254
  %pb12 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %10, i32 0, i32 4, !dbg !2255
  %11 = load %struct.AVIOContext*, %struct.AVIOContext** %pb12, align 8, !dbg !2255
  %12 = load i32, i32* %length, align 4, !dbg !2256
  %conv = sext i32 %12 to i64, !dbg !2256
  %call13 = call i64 @avio_skip(%struct.AVIOContext* %11, i64 %conv), !dbg !2257
  %13 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2258
  %pb14 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %13, i32 0, i32 4, !dbg !2259
  %14 = load %struct.AVIOContext*, %struct.AVIOContext** %pb14, align 8, !dbg !2259
  %call15 = call i64 @avio_skip(%struct.AVIOContext* %14, i64 4), !dbg !2260
  %15 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2261
  %pb16 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %15, i32 0, i32 4, !dbg !2262
  %16 = load %struct.AVIOContext*, %struct.AVIOContext** %pb16, align 8, !dbg !2262
  %call17 = call i32 @avio_r8(%struct.AVIOContext* %16), !dbg !2263
  store i32 %call17, i32* %depth, align 4, !dbg !2264
  %17 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2265
  %call18 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %17, %struct.AVCodec* null), !dbg !2266
  store %struct.AVStream* %call18, %struct.AVStream** %st, align 8, !dbg !2267
  %18 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2268
  %tobool19 = icmp ne %struct.AVStream* %18, null, !dbg !2268
  br i1 %tobool19, label %if.end21, label %if.then20, !dbg !2270
...
if.end21:                                         ; preds = %if.end9
  %19 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2272
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %19, i32 0, i32 19, !dbg !2273
  %20 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2273
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %20, i32 0, i32 0, !dbg !2274
  store i32 1, i32* %codec_type, align 8, !dbg !2275
  %21 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2276
  %codecpar22 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %21, i32 0, i32 19, !dbg !2277
  %22 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar22, align 8, !dbg !2277
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %22, i32 0, i32 22, !dbg !2278
  store i32 1, i32* %channels, align 8, !dbg !2279
  %23 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2280
  %pb23 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %23, i32 0, i32 4, !dbg !2281
  %24 = load %struct.AVIOContext*, %struct.AVIOContext** %pb23, align 8, !dbg !2281
  %call24 = call i32 @avio_rl32(%struct.AVIOContext* %24), !dbg !2282
  %25 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2283
  %codecpar25 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %25, i32 0, i32 19, !dbg !2284
  %26 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar25, align 8, !dbg !2284
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %26, i32 0, i32 23, !dbg !2285
  store i32 %call24, i32* %sample_rate, align 4, !dbg !2286
  %27 = load i32, i32* %depth, align 4, !dbg !2287
...
sw.bb:                                            ; preds = %if.end21
  %28 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2289
  %codecpar26 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %28, i32 0, i32 19, !dbg !2291
  %29 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar26, align 8, !dbg !2291
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %29, i32 0, i32 1, !dbg !2292
  store i32 65541, i32* %codec_id, align 4, !dbg !2293
  br label %sw.epilog, !dbg !2294

sw.bb27:                                          ; preds = %if.end21
  %30 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2295
  %codecpar28 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %30, i32 0, i32 19, !dbg !2296
  %31 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar28, align 8, !dbg !2296
  %codec_id29 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %31, i32 0, i32 1, !dbg !2297
  store i32 65538, i32* %codec_id29, align 4, !dbg !2298
  br label %sw.epilog, !dbg !2299

sw.bb30:                                          ; preds = %if.end21
  %32 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2300
  %codecpar31 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %32, i32 0, i32 19, !dbg !2301
  %33 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar31, align 8, !dbg !2301
  %codec_id32 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %33, i32 0, i32 1, !dbg !2302
  store i32 65550, i32* %codec_id32, align 4, !dbg !2303
  br label %sw.epilog, !dbg !2304

sw.bb33:                                          ; preds = %if.end21
  %34 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2305
  %codecpar34 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %34, i32 0, i32 19, !dbg !2306
  %35 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar34, align 8, !dbg !2306
  %codec_id35 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %35, i32 0, i32 1, !dbg !2307
  store i32 65546, i32* %codec_id35, align 4, !dbg !2308
...
sw.epilog:                                        ; preds = %sw.bb33, %sw.bb30, %sw.bb27, %sw.bb
  %36 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2311
  %pb36 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %36, i32 0, i32 4, !dbg !2312
  %37 = load %struct.AVIOContext*, %struct.AVIOContext** %pb36, align 8, !dbg !2312
  %call37 = call i64 @avio_skip(%struct.AVIOContext* %37, i64 16), !dbg !2313
  %38 = load i32, i32* %depth, align 4, !dbg !2314
  %div = sdiv i32 %38, 8, !dbg !2315
  %39 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2316
  %codecpar38 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %39, i32 0, i32 19, !dbg !2317
  %40 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar38, align 8, !dbg !2317
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %40, i32 0, i32 24, !dbg !2318
  store i32 %div, i32* %block_align, align 8, !dbg !2319
  store i32 0, i32* %retval, align 4, !dbg !2320
  br label %return, !dbg !2320

return:                                           ; preds = %sw.epilog, %sw.default, %if.then20, %if.then8
  %41 = load i32, i32* %retval, align 4, !dbg !2321
  ret i32 %41, !dbg !2321
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--sdxdec.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!927 = !{!928}
!928 = distinct !DIGlobalVariable(name: "ff_sdx_demuxer", scope: !0, file: !929, line: 81, type: !930, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_sdx_demuxer)
!929 = !DIFile(filename: "libavformat/sdxdec.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2146 = distinct !DISubprogram(name: "sdx_probe", scope: !929, file: !929, line: 28, type: !999, isLocal: true, isDefinition: true, scopeLine: 29, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2147 = !{}
...
!2156 = !DILexicalBlockFile(scope: !2157, file: !929, discriminator: 1)
...
!2159 = distinct !DILocation(line: 30, column: 9, scope: !2157)
!2160 = !DILocalVariable(name: "p", arg: 1, scope: !2146, file: !929, line: 28, type: !1001)
!2161 = !DILocation(line: 28, column: 35, scope: !2146)
!2162 = !DILocation(line: 30, column: 52, scope: !2157)
!2163 = !DILocation(line: 30, column: 55, scope: !2157)
!2164 = !DILocation(line: 30, column: 62, scope: !2157)
!2165 = !DILocation(line: 30, column: 9, scope: !2157)
!2166 = !DILocation(line: 68, column: 16, scope: !2149, inlinedAt: !2159)
!2167 = !DILocation(line: 68, column: 19, scope: !2149, inlinedAt: !2159)
!2168 = !DILocation(line: 68, column: 24, scope: !2149, inlinedAt: !2159)
!2169 = !DILocation(line: 68, column: 38, scope: !2149, inlinedAt: !2159)
!2170 = !DILocation(line: 68, column: 41, scope: !2149, inlinedAt: !2159)
!2171 = !DILocation(line: 68, column: 46, scope: !2149, inlinedAt: !2159)
!2172 = !DILocation(line: 68, column: 34, scope: !2149, inlinedAt: !2159)
!2173 = !DILocation(line: 68, column: 57, scope: !2149, inlinedAt: !2159)
!2174 = !DILocation(line: 68, column: 69, scope: !2149, inlinedAt: !2159)
!2175 = !DILocation(line: 68, column: 72, scope: !2149, inlinedAt: !2159)
!2176 = !DILocation(line: 68, column: 79, scope: !2149, inlinedAt: !2159)
!2177 = !DILocation(line: 68, column: 84, scope: !2149, inlinedAt: !2159)
!2178 = !DILocation(line: 68, column: 99, scope: !2149, inlinedAt: !2159)
!2179 = !DILocation(line: 68, column: 102, scope: !2149, inlinedAt: !2159)
!2180 = !DILocation(line: 68, column: 109, scope: !2149, inlinedAt: !2159)
!2181 = !DILocation(line: 68, column: 114, scope: !2149, inlinedAt: !2159)
!2182 = !DILocation(line: 68, column: 94, scope: !2149, inlinedAt: !2159)
!2183 = !DILocation(line: 68, column: 63, scope: !2149, inlinedAt: !2159)
!2184 = !DILocation(line: 30, column: 122, scope: !2157)
!2185 = !DILocation(line: 30, column: 69, scope: !2156)
!2186 = !DILocation(line: 68, column: 16, scope: !2149, inlinedAt: !2155)
!2187 = !DILocation(line: 68, column: 19, scope: !2149, inlinedAt: !2155)
!2188 = !DILocation(line: 68, column: 24, scope: !2149, inlinedAt: !2155)
!2189 = !DILocation(line: 68, column: 38, scope: !2149, inlinedAt: !2155)
!2190 = !DILocation(line: 68, column: 41, scope: !2149, inlinedAt: !2155)
!2191 = !DILocation(line: 68, column: 46, scope: !2149, inlinedAt: !2155)
!2192 = !DILocation(line: 68, column: 34, scope: !2149, inlinedAt: !2155)
!2193 = !DILocation(line: 68, column: 57, scope: !2149, inlinedAt: !2155)
!2194 = !DILocation(line: 68, column: 69, scope: !2149, inlinedAt: !2155)
!2195 = !DILocation(line: 68, column: 72, scope: !2149, inlinedAt: !2155)
!2196 = !DILocation(line: 68, column: 79, scope: !2149, inlinedAt: !2155)
!2197 = !DILocation(line: 68, column: 84, scope: !2149, inlinedAt: !2155)
!2198 = !DILocation(line: 68, column: 99, scope: !2149, inlinedAt: !2155)
!2199 = !DILocation(line: 68, column: 102, scope: !2149, inlinedAt: !2155)
!2200 = !DILocation(line: 68, column: 109, scope: !2149, inlinedAt: !2155)
!2201 = !DILocation(line: 68, column: 114, scope: !2149, inlinedAt: !2155)
!2202 = !DILocation(line: 68, column: 94, scope: !2149, inlinedAt: !2155)
!2203 = !DILocation(line: 68, column: 63, scope: !2149, inlinedAt: !2155)
!2204 = !DILocation(line: 30, column: 66, scope: !2157)
!2205 = !DILocation(line: 30, column: 9, scope: !2146)
!2206 = !DILocation(line: 31, column: 9, scope: !2157)
!2207 = !DILocation(line: 32, column: 5, scope: !2146)
!2208 = !DILocation(line: 33, column: 1, scope: !2146)
!2209 = distinct !DISubprogram(name: "sdx_read_header", scope: !929, file: !929, line: 35, type: !2210, isLocal: true, isDefinition: true, scopeLine: 36, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2210 = !DISubroutineType(types: !2211)
!2211 = !{!926, !2212}
!2212 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2213, size: 64, align: 64)
!2213 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1016)
!2214 = !DILocalVariable(name: "s", arg: 1, scope: !2209, file: !929, line: 35, type: !2212)
!2215 = !DILocation(line: 35, column: 45, scope: !2209)
!2216 = !DILocalVariable(name: "st", scope: !2209, file: !929, line: 37, type: !1290)
!2217 = !DILocation(line: 37, column: 15, scope: !2209)
!2218 = !DILocalVariable(name: "depth", scope: !2209, file: !929, line: 38, type: !926)
!2219 = !DILocation(line: 38, column: 9, scope: !2209)
!2220 = !DILocalVariable(name: "length", scope: !2209, file: !929, line: 38, type: !926)
!2221 = !DILocation(line: 38, column: 16, scope: !2209)
!2222 = !DILocation(line: 40, column: 15, scope: !2209)
!2223 = !DILocation(line: 40, column: 18, scope: !2209)
!2224 = !DILocation(line: 40, column: 5, scope: !2209)
!2225 = !DILocation(line: 41, column: 5, scope: !2209)
!2226 = !DILocation(line: 41, column: 23, scope: !2227)
!2227 = !DILexicalBlockFile(scope: !2209, file: !929, discriminator: 1)
!2228 = !DILocation(line: 41, column: 26, scope: !2227)
!2229 = !DILocation(line: 41, column: 13, scope: !2227)
!2230 = !DILocation(line: 41, column: 12, scope: !2227)
!2231 = !DILocation(line: 41, column: 5, scope: !2227)
!2232 = !DILocation(line: 42, column: 21, scope: !2233)
!2233 = distinct !DILexicalBlock(scope: !2234, file: !929, line: 42, column: 13)
!2234 = distinct !DILexicalBlock(scope: !2209, file: !929, line: 41, column: 31)
!2235 = !DILocation(line: 42, column: 24, scope: !2233)
!2236 = !DILocation(line: 42, column: 13, scope: !2233)
!2237 = !DILocation(line: 42, column: 28, scope: !2233)
!2238 = !DILocation(line: 42, column: 13, scope: !2234)
!2239 = !DILocation(line: 43, column: 13, scope: !2233)
!2240 = !DILocation(line: 41, column: 5, scope: !2241)
!2241 = !DILexicalBlockFile(scope: !2209, file: !929, discriminator: 2)
!2242 = distinct !{!2242, !2225}
!2243 = !DILocation(line: 45, column: 17, scope: !2244)
!2244 = distinct !DILexicalBlock(scope: !2209, file: !929, line: 45, column: 9)
!2245 = !DILocation(line: 45, column: 20, scope: !2244)
!2246 = !DILocation(line: 45, column: 9, scope: !2244)
!2247 = !DILocation(line: 45, column: 24, scope: !2244)
!2248 = !DILocation(line: 45, column: 9, scope: !2209)
!2249 = !DILocation(line: 46, column: 9, scope: !2244)
!2250 = !DILocation(line: 47, column: 22, scope: !2209)
!2251 = !DILocation(line: 47, column: 25, scope: !2209)
!2252 = !DILocation(line: 47, column: 14, scope: !2209)
!2253 = !DILocation(line: 47, column: 12, scope: !2209)
!2254 = !DILocation(line: 48, column: 15, scope: !2209)
!2255 = !DILocation(line: 48, column: 18, scope: !2209)
!2256 = !DILocation(line: 48, column: 22, scope: !2209)
!2257 = !DILocation(line: 48, column: 5, scope: !2209)
!2258 = !DILocation(line: 49, column: 15, scope: !2209)
!2259 = !DILocation(line: 49, column: 18, scope: !2209)
!2260 = !DILocation(line: 49, column: 5, scope: !2209)
!2261 = !DILocation(line: 50, column: 21, scope: !2209)
!2262 = !DILocation(line: 50, column: 24, scope: !2209)
!2263 = !DILocation(line: 50, column: 13, scope: !2209)
!2264 = !DILocation(line: 50, column: 11, scope: !2209)
!2265 = !DILocation(line: 52, column: 30, scope: !2209)
!2266 = !DILocation(line: 52, column: 10, scope: !2209)
!2267 = !DILocation(line: 52, column: 8, scope: !2209)
!2268 = !DILocation(line: 53, column: 10, scope: !2269)
!2269 = distinct !DILexicalBlock(scope: !2209, file: !929, line: 53, column: 9)
!2270 = !DILocation(line: 53, column: 9, scope: !2209)
!2271 = !DILocation(line: 54, column: 9, scope: !2269)
!2272 = !DILocation(line: 56, column: 5, scope: !2209)
!2273 = !DILocation(line: 56, column: 9, scope: !2209)
!2274 = !DILocation(line: 56, column: 19, scope: !2209)
!2275 = !DILocation(line: 56, column: 30, scope: !2209)
!2276 = !DILocation(line: 57, column: 5, scope: !2209)
!2277 = !DILocation(line: 57, column: 9, scope: !2209)
!2278 = !DILocation(line: 57, column: 19, scope: !2209)
!2279 = !DILocation(line: 57, column: 28, scope: !2209)
!2280 = !DILocation(line: 58, column: 43, scope: !2209)
!2281 = !DILocation(line: 58, column: 46, scope: !2209)
!2282 = !DILocation(line: 58, column: 33, scope: !2209)
!2283 = !DILocation(line: 58, column: 5, scope: !2209)
!2284 = !DILocation(line: 58, column: 9, scope: !2209)
!2285 = !DILocation(line: 58, column: 19, scope: !2209)
!2286 = !DILocation(line: 58, column: 31, scope: !2209)
!2287 = !DILocation(line: 59, column: 13, scope: !2209)
!2288 = !DILocation(line: 59, column: 5, scope: !2209)
!2289 = !DILocation(line: 61, column: 9, scope: !2290)
!2290 = distinct !DILexicalBlock(scope: !2209, file: !929, line: 59, column: 20)
!2291 = !DILocation(line: 61, column: 13, scope: !2290)
!2292 = !DILocation(line: 61, column: 23, scope: !2290)
!2293 = !DILocation(line: 61, column: 32, scope: !2290)
!2294 = !DILocation(line: 62, column: 9, scope: !2290)
!2295 = !DILocation(line: 64, column: 9, scope: !2290)
!2296 = !DILocation(line: 64, column: 13, scope: !2290)
!2297 = !DILocation(line: 64, column: 23, scope: !2290)
!2298 = !DILocation(line: 64, column: 32, scope: !2290)
!2299 = !DILocation(line: 65, column: 9, scope: !2290)
!2300 = !DILocation(line: 67, column: 9, scope: !2290)
!2301 = !DILocation(line: 67, column: 13, scope: !2290)
!2302 = !DILocation(line: 67, column: 23, scope: !2290)
!2303 = !DILocation(line: 67, column: 32, scope: !2290)
!2304 = !DILocation(line: 68, column: 9, scope: !2290)
!2305 = !DILocation(line: 70, column: 9, scope: !2290)
!2306 = !DILocation(line: 70, column: 13, scope: !2290)
!2307 = !DILocation(line: 70, column: 23, scope: !2290)
!2308 = !DILocation(line: 70, column: 32, scope: !2290)
!2309 = !DILocation(line: 71, column: 9, scope: !2290)
!2310 = !DILocation(line: 73, column: 9, scope: !2290)
!2311 = !DILocation(line: 75, column: 15, scope: !2209)
!2312 = !DILocation(line: 75, column: 18, scope: !2209)
!2313 = !DILocation(line: 75, column: 5, scope: !2209)
!2314 = !DILocation(line: 76, column: 33, scope: !2209)
!2315 = !DILocation(line: 76, column: 39, scope: !2209)
!2316 = !DILocation(line: 76, column: 5, scope: !2209)
!2317 = !DILocation(line: 76, column: 9, scope: !2209)
!2318 = !DILocation(line: 76, column: 19, scope: !2209)
!2319 = !DILocation(line: 76, column: 31, scope: !2209)
!2320 = !DILocation(line: 78, column: 5, scope: !2209)
!2321 = !DILocation(line: 79, column: 1, scope: !2209)
