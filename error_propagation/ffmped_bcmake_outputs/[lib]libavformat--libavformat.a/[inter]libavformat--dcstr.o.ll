; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--dcstr.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--dcstr.o.i"
...
define internal i32 @dcstr_probe(%struct.AVProbeData* %p) #0 !dbg !2140 {
entry:
  ...
  %cmp = icmp slt i32 %1, 224, !dbg !2148
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %buf = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %2, i32 0, i32 1, !dbg !2152
  %3 = load i8*, i8** %buf, align 8, !dbg !2152
  %add.ptr = getelementptr inbounds i8, i8* %3, i64 213, !dbg !2153
  %call = call i32 @memcmp(i8* %add.ptr, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.3, i32 0, i32 0), i64 11) #4, !dbg !2154
...
; Function Attrs: nounwind uwtable
define internal i32 @dcstr_read_header(%struct.AVFormatContext* %s) #0 !dbg !2159 {
entry:
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2164, metadata !2143), !dbg !2168
  %retval = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2170, metadata !2143), !dbg !2171
  call void @llvm.dbg.declare(metadata i32* %codec, metadata !2172, metadata !2143), !dbg !2173
  call void @llvm.dbg.declare(metadata i32* %align, metadata !2174, metadata !2143), !dbg !2175
  call void @llvm.dbg.declare(metadata i32* %mult, metadata !2176, metadata !2143), !dbg !2177
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2178, metadata !2143), !dbg !2179
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2180
  %call = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %0, %struct.AVCodec* null), !dbg !2181
  store %struct.AVStream* %call, %struct.AVStream** %st, align 8, !dbg !2182
  %1 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2183
  %tobool = icmp ne %struct.AVStream* %1, null, !dbg !2183
...
if.end:                                           ; preds = %entry
  %2 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2187
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %2, i32 0, i32 19, !dbg !2188
  %3 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2188
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %3, i32 0, i32 0, !dbg !2189
  store i32 1, i32* %codec_type, align 8, !dbg !2190
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2191
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %4, i32 0, i32 4, !dbg !2192
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2192
  %call1 = call i32 @avio_rl32(%struct.AVIOContext* %5), !dbg !2193
  %6 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2194
  %codecpar2 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %6, i32 0, i32 19, !dbg !2195
  %7 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar2, align 8, !dbg !2195
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %7, i32 0, i32 22, !dbg !2196
  store i32 %call1, i32* %channels, align 8, !dbg !2197
  %8 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2198
  %pb3 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %8, i32 0, i32 4, !dbg !2199
  %9 = load %struct.AVIOContext*, %struct.AVIOContext** %pb3, align 8, !dbg !2199
  %call4 = call i32 @avio_rl32(%struct.AVIOContext* %9), !dbg !2200
  %10 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2201
  %codecpar5 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %10, i32 0, i32 19, !dbg !2202
  %11 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar5, align 8, !dbg !2202
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %11, i32 0, i32 23, !dbg !2203
  store i32 %call4, i32* %sample_rate, align 4, !dbg !2204
  %12 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2205
  %pb6 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %12, i32 0, i32 4, !dbg !2206
  %13 = load %struct.AVIOContext*, %struct.AVIOContext** %pb6, align 8, !dbg !2206
  %call7 = call i32 @avio_rl32(%struct.AVIOContext* %13), !dbg !2207
  store i32 %call7, i32* %codec, align 4, !dbg !2208
  %14 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2209
  %pb8 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %14, i32 0, i32 4, !dbg !2210
  %15 = load %struct.AVIOContext*, %struct.AVIOContext** %pb8, align 8, !dbg !2210
  %call9 = call i32 @avio_rl32(%struct.AVIOContext* %15), !dbg !2211
  store i32 %call9, i32* %align, align 4, !dbg !2212
  %16 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2213
  %pb10 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %16, i32 0, i32 4, !dbg !2214
  %17 = load %struct.AVIOContext*, %struct.AVIOContext** %pb10, align 8, !dbg !2214
  %call11 = call i64 @avio_skip(%struct.AVIOContext* %17, i64 4), !dbg !2215
  %18 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2216
  %pb12 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %18, i32 0, i32 4, !dbg !2217
  %19 = load %struct.AVIOContext*, %struct.AVIOContext** %pb12, align 8, !dbg !2217
  %call13 = call i32 @avio_rl32(%struct.AVIOContext* %19), !dbg !2218
  %conv = zext i32 %call13 to i64, !dbg !2218
  %20 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2219
  %duration = getelementptr inbounds %struct.AVStream, %struct.AVStream* %20, i32 0, i32 6, !dbg !2220
  store i64 %conv, i64* %duration, align 8, !dbg !2221
  %21 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2222
  %pb14 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %21, i32 0, i32 4, !dbg !2223
  %22 = load %struct.AVIOContext*, %struct.AVIOContext** %pb14, align 8, !dbg !2223
  %call15 = call i32 @avio_rl32(%struct.AVIOContext* %22), !dbg !2224
  store i32 %call15, i32* %mult, align 4, !dbg !2225
  %23 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2226
  %codecpar16 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %23, i32 0, i32 19, !dbg !2228
  %24 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar16, align 8, !dbg !2228
  %channels17 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %24, i32 0, i32 22, !dbg !2229
  %25 = load i32, i32* %channels17, align 8, !dbg !2229
  %cmp = icmp sle i32 %25, 0, !dbg !2230
  br i1 %cmp, label %if.then26, label %lor.lhs.false, !dbg !2231

lor.lhs.false:                                    ; preds = %if.end
  %26 = load i32, i32* %mult, align 4, !dbg !2232
  %cmp19 = icmp sle i32 %26, 0, !dbg !2234
  br i1 %cmp19, label %if.then26, label %lor.lhs.false21, !dbg !2235

lor.lhs.false21:                                  ; preds = %lor.lhs.false
  %27 = load i32, i32* %mult, align 4, !dbg !2236
  %28 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2238
  %codecpar22 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %28, i32 0, i32 19, !dbg !2239
  %29 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar22, align 8, !dbg !2239
  %channels23 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %29, i32 0, i32 22, !dbg !2240
  %30 = load i32, i32* %channels23, align 8, !dbg !2240
  %div = sdiv i32 2147483647, %30, !dbg !2241
  %cmp24 = icmp sgt i32 %27, %div, !dbg !2242
  br i1 %cmp24, label %if.then26, label %if.end29, !dbg !2243

if.then26:                                        ; preds = %lor.lhs.false21, %lor.lhs.false, %if.end
  %31 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2244
  %32 = bitcast %struct.AVFormatContext* %31 to i8*, !dbg !2244
  %33 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2246
  %codecpar27 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %33, i32 0, i32 19, !dbg !2247
  %34 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar27, align 8, !dbg !2247
  %channels28 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %34, i32 0, i32 22, !dbg !2248
  %35 = load i32, i32* %channels28, align 8, !dbg !2248
  %36 = load i32, i32* %mult, align 4, !dbg !2249
  call void (i8*, i32, i8*, ...) @av_log(i8* %32, i32 16, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.4, i32 0, i32 0), i32 %35, i32 %36), !dbg !2250
  store i32 -1094995529, i32* %retval, align 4, !dbg !2251
  br label %return, !dbg !2251

if.end29:                                         ; preds = %lor.lhs.false21
  %37 = load i32, i32* %mult, align 4, !dbg !2252
  %38 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2253
  %codecpar30 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %38, i32 0, i32 19, !dbg !2254
  %39 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar30, align 8, !dbg !2254
  %channels31 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %39, i32 0, i32 22, !dbg !2255
  %40 = load i32, i32* %channels31, align 8, !dbg !2256
  %mul = mul nsw i32 %40, %37, !dbg !2256
  store i32 %mul, i32* %channels31, align 8, !dbg !2256
  %41 = load i32, i32* %align, align 4, !dbg !2257
  %tobool32 = icmp ne i32 %41, 0, !dbg !2257
  br i1 %tobool32, label %lor.lhs.false33, label %if.then39, !dbg !2259

lor.lhs.false33:                                  ; preds = %if.end29
  %42 = load i32, i32* %align, align 4, !dbg !2260
  %43 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2262
  %codecpar34 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %43, i32 0, i32 19, !dbg !2263
  %44 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar34, align 8, !dbg !2263
  %channels35 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %44, i32 0, i32 22, !dbg !2264
  %45 = load i32, i32* %channels35, align 8, !dbg !2264
  %div36 = sdiv i32 2147483647, %45, !dbg !2265
  %cmp37 = icmp ugt i32 %42, %div36, !dbg !2266
  br i1 %cmp37, label %if.then39, label %if.end40, !dbg !2267
...
if.end40:                                         ; preds = %lor.lhs.false33
  %46 = load i32, i32* %align, align 4, !dbg !2269
  %47 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2270
  %codecpar41 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %47, i32 0, i32 19, !dbg !2271
  %48 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar41, align 8, !dbg !2271
  %channels42 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %48, i32 0, i32 22, !dbg !2272
  %49 = load i32, i32* %channels42, align 8, !dbg !2272
  %mul43 = mul i32 %46, %49, !dbg !2273
  %50 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2274
  %codecpar44 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %50, i32 0, i32 19, !dbg !2275
  %51 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar44, align 8, !dbg !2275
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %51, i32 0, i32 24, !dbg !2276
  store i32 %mul43, i32* %block_align, align 8, !dbg !2277
  %52 = load i32, i32* %codec, align 4, !dbg !2278
...
sw.bb:                                            ; preds = %if.end40
  %53 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2280
  %codecpar45 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %53, i32 0, i32 19, !dbg !2282
  %54 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar45, align 8, !dbg !2282
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %54, i32 0, i32 1, !dbg !2283
  store i32 71687, i32* %codec_id, align 4, !dbg !2284
  br label %sw.epilog, !dbg !2285

sw.bb46:                                          ; preds = %if.end40
  %55 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2286
  %codecpar47 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %55, i32 0, i32 19, !dbg !2287
  %56 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar47, align 8, !dbg !2287
  %codec_id48 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %56, i32 0, i32 1, !dbg !2288
  store i32 65554, i32* %codec_id48, align 4, !dbg !2289
  br label %sw.epilog, !dbg !2290

sw.default:                                       ; preds = %if.end40
  %57 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2291
  %58 = bitcast %struct.AVFormatContext* %57 to i8*, !dbg !2291
  %59 = load i32, i32* %codec, align 4, !dbg !2292
  call void (i8*, i8*, ...) @avpriv_request_sample(i8* %58, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.5, i32 0, i32 0), i32 %59), !dbg !2293
  store i32 -1163346256, i32* %retval, align 4, !dbg !2294
  br label %return, !dbg !2294

sw.epilog:                                        ; preds = %sw.bb46, %sw.bb
  %60 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2295
  %pb49 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %60, i32 0, i32 4, !dbg !2296
  %61 = load %struct.AVIOContext*, %struct.AVIOContext** %pb49, align 8, !dbg !2296
  %62 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2297
  %pb50 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %62, i32 0, i32 4, !dbg !2298
  %63 = load %struct.AVIOContext*, %struct.AVIOContext** %pb50, align 8, !dbg !2298
  store %struct.AVIOContext* %63, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2299
  %64 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2300
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %64, i64 0, i32 1) #5, !dbg !2301
  %sub = sub nsw i64 2048, %call.i, !dbg !2302
  %call52 = call i64 @avio_skip(%struct.AVIOContext* %61, i64 %sub), !dbg !2303
  %65 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2305
  %66 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2306
  %codecpar53 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %66, i32 0, i32 19, !dbg !2307
  %67 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar53, align 8, !dbg !2307
  %sample_rate54 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %67, i32 0, i32 23, !dbg !2308
  %68 = load i32, i32* %sample_rate54, align 4, !dbg !2308
  call void @avpriv_set_pts_info(%struct.AVStream* %65, i32 64, i32 1, i32 %68), !dbg !2309
  store i32 0, i32* %retval, align 4, !dbg !2310
  br label %return, !dbg !2310

return:                                           ; preds = %sw.epilog, %sw.default, %if.then39, %if.then26, %if.then
  %69 = load i32, i32* %retval, align 4, !dbg !2311
  ret i32 %69, !dbg !2311
}

; Function Attrs: nounwind uwtable
define internal i32 @dcstr_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2312 {
entry:
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %pkt.addr = alloca %struct.AVPacket*, align 8
  %par = alloca %struct.AVCodecParameters*, align 8
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2315, metadata !2143), !dbg !2316
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2317, metadata !2143), !dbg !2318
  call void @llvm.dbg.declare(metadata %struct.AVCodecParameters** %par, metadata !2319, metadata !2143), !dbg !2320
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2321
  %streams = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 7, !dbg !2322
  %1 = load %struct.AVStream**, %struct.AVStream*** %streams, align 8, !dbg !2322
  %arrayidx = getelementptr inbounds %struct.AVStream*, %struct.AVStream** %1, i64 0, !dbg !2321
  %2 = load %struct.AVStream*, %struct.AVStream** %arrayidx, align 8, !dbg !2321
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %2, i32 0, i32 19, !dbg !2323
  %3 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2323
  store %struct.AVCodecParameters* %3, %struct.AVCodecParameters** %par, align 8, !dbg !2320
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2324
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %4, i32 0, i32 4, !dbg !2325
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2325
  %6 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2326
  %7 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2327
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %7, i32 0, i32 24, !dbg !2328
  %8 = load i32, i32* %block_align, align 8, !dbg !2328
  %call = call i32 @av_get_packet(%struct.AVIOContext* %5, %struct.AVPacket* %6, i32 %8), !dbg !2329
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--dcstr.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!919 = !{!920}
!920 = distinct !DIGlobalVariable(name: "ff_dcstr_demuxer", scope: !0, file: !921, line: 79, type: !922, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_dcstr_demuxer)
!921 = !DIFile(filename: "libavformat/dcstr.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2140 = distinct !DISubprogram(name: "dcstr_probe", scope: !921, file: !921, line: 25, type: !991, isLocal: true, isDefinition: true, scopeLine: 26, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2141 = !{}
!2142 = !DILocalVariable(name: "p", arg: 1, scope: !2140, file: !921, line: 25, type: !993)
!2143 = !DIExpression()
!2144 = !DILocation(line: 25, column: 37, scope: !2140)
!2145 = !DILocation(line: 27, column: 9, scope: !2146)
!2146 = distinct !DILexicalBlock(scope: !2140, file: !921, line: 27, column: 9)
!2147 = !DILocation(line: 27, column: 12, scope: !2146)
!2148 = !DILocation(line: 27, column: 21, scope: !2146)
!2149 = !DILocation(line: 27, column: 27, scope: !2146)
!2150 = !DILocation(line: 27, column: 37, scope: !2151)
!2151 = !DILexicalBlockFile(scope: !2146, file: !921, discriminator: 1)
!2152 = !DILocation(line: 27, column: 40, scope: !2151)
!2153 = !DILocation(line: 27, column: 44, scope: !2151)
!2154 = !DILocation(line: 27, column: 30, scope: !2151)
!2155 = !DILocation(line: 27, column: 9, scope: !2151)
!2156 = !DILocation(line: 28, column: 9, scope: !2146)
!2157 = !DILocation(line: 30, column: 5, scope: !2140)
!2158 = !DILocation(line: 31, column: 1, scope: !2140)
!2159 = distinct !DISubprogram(name: "dcstr_read_header", scope: !921, file: !921, line: 33, type: !2160, isLocal: true, isDefinition: true, scopeLine: 34, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
...
!2169 = distinct !DILocation(line: 67, column: 30, scope: !2159)
!2170 = !DILocalVariable(name: "s", arg: 1, scope: !2159, file: !921, line: 33, type: !2162)
!2171 = !DILocation(line: 33, column: 47, scope: !2159)
!2172 = !DILocalVariable(name: "codec", scope: !2159, file: !921, line: 35, type: !918)
!2173 = !DILocation(line: 35, column: 14, scope: !2159)
!2174 = !DILocalVariable(name: "align", scope: !2159, file: !921, line: 35, type: !918)
!2175 = !DILocation(line: 35, column: 21, scope: !2159)
!2176 = !DILocalVariable(name: "mult", scope: !2159, file: !921, line: 36, type: !917)
!2177 = !DILocation(line: 36, column: 9, scope: !2159)
!2178 = !DILocalVariable(name: "st", scope: !2159, file: !921, line: 37, type: !1283)
!2179 = !DILocation(line: 37, column: 15, scope: !2159)
!2180 = !DILocation(line: 39, column: 30, scope: !2159)
!2181 = !DILocation(line: 39, column: 10, scope: !2159)
!2182 = !DILocation(line: 39, column: 8, scope: !2159)
!2183 = !DILocation(line: 40, column: 10, scope: !2184)
!2184 = distinct !DILexicalBlock(scope: !2159, file: !921, line: 40, column: 9)
!2185 = !DILocation(line: 40, column: 9, scope: !2159)
!2186 = !DILocation(line: 41, column: 9, scope: !2184)
!2187 = !DILocation(line: 43, column: 5, scope: !2159)
!2188 = !DILocation(line: 43, column: 9, scope: !2159)
!2189 = !DILocation(line: 43, column: 19, scope: !2159)
!2190 = !DILocation(line: 43, column: 30, scope: !2159)
!2191 = !DILocation(line: 44, column: 40, scope: !2159)
!2192 = !DILocation(line: 44, column: 43, scope: !2159)
!2193 = !DILocation(line: 44, column: 30, scope: !2159)
!2194 = !DILocation(line: 44, column: 5, scope: !2159)
!2195 = !DILocation(line: 44, column: 9, scope: !2159)
!2196 = !DILocation(line: 44, column: 19, scope: !2159)
!2197 = !DILocation(line: 44, column: 28, scope: !2159)
!2198 = !DILocation(line: 45, column: 43, scope: !2159)
!2199 = !DILocation(line: 45, column: 46, scope: !2159)
!2200 = !DILocation(line: 45, column: 33, scope: !2159)
!2201 = !DILocation(line: 45, column: 5, scope: !2159)
!2202 = !DILocation(line: 45, column: 9, scope: !2159)
!2203 = !DILocation(line: 45, column: 19, scope: !2159)
!2204 = !DILocation(line: 45, column: 31, scope: !2159)
!2205 = !DILocation(line: 46, column: 23, scope: !2159)
!2206 = !DILocation(line: 46, column: 26, scope: !2159)
!2207 = !DILocation(line: 46, column: 13, scope: !2159)
!2208 = !DILocation(line: 46, column: 11, scope: !2159)
!2209 = !DILocation(line: 47, column: 23, scope: !2159)
!2210 = !DILocation(line: 47, column: 26, scope: !2159)
!2211 = !DILocation(line: 47, column: 13, scope: !2159)
!2212 = !DILocation(line: 47, column: 11, scope: !2159)
!2213 = !DILocation(line: 48, column: 15, scope: !2159)
!2214 = !DILocation(line: 48, column: 18, scope: !2159)
!2215 = !DILocation(line: 48, column: 5, scope: !2159)
!2216 = !DILocation(line: 49, column: 30, scope: !2159)
!2217 = !DILocation(line: 49, column: 33, scope: !2159)
!2218 = !DILocation(line: 49, column: 20, scope: !2159)
!2219 = !DILocation(line: 49, column: 5, scope: !2159)
!2220 = !DILocation(line: 49, column: 9, scope: !2159)
!2221 = !DILocation(line: 49, column: 18, scope: !2159)
!2222 = !DILocation(line: 50, column: 22, scope: !2159)
!2223 = !DILocation(line: 50, column: 25, scope: !2159)
!2224 = !DILocation(line: 50, column: 12, scope: !2159)
!2225 = !DILocation(line: 50, column: 10, scope: !2159)
!2226 = !DILocation(line: 51, column: 9, scope: !2227)
!2227 = distinct !DILexicalBlock(scope: !2159, file: !921, line: 51, column: 9)
!2228 = !DILocation(line: 51, column: 13, scope: !2227)
!2229 = !DILocation(line: 51, column: 23, scope: !2227)
!2230 = !DILocation(line: 51, column: 32, scope: !2227)
!2231 = !DILocation(line: 51, column: 37, scope: !2227)
!2232 = !DILocation(line: 51, column: 40, scope: !2233)
!2233 = !DILexicalBlockFile(scope: !2227, file: !921, discriminator: 1)
!2234 = !DILocation(line: 51, column: 45, scope: !2233)
!2235 = !DILocation(line: 51, column: 50, scope: !2233)
!2236 = !DILocation(line: 51, column: 53, scope: !2237)
!2237 = !DILexicalBlockFile(scope: !2227, file: !921, discriminator: 2)
!2238 = !DILocation(line: 51, column: 73, scope: !2237)
!2239 = !DILocation(line: 51, column: 77, scope: !2237)
!2240 = !DILocation(line: 51, column: 87, scope: !2237)
!2241 = !DILocation(line: 51, column: 71, scope: !2237)
!2242 = !DILocation(line: 51, column: 58, scope: !2237)
!2243 = !DILocation(line: 51, column: 9, scope: !2237)
!2244 = !DILocation(line: 52, column: 16, scope: !2245)
!2245 = distinct !DILexicalBlock(scope: !2227, file: !921, line: 51, column: 97)
!2246 = !DILocation(line: 52, column: 63, scope: !2245)
!2247 = !DILocation(line: 52, column: 67, scope: !2245)
!2248 = !DILocation(line: 52, column: 77, scope: !2245)
!2249 = !DILocation(line: 52, column: 87, scope: !2245)
!2250 = !DILocation(line: 52, column: 9, scope: !2245)
!2251 = !DILocation(line: 53, column: 9, scope: !2245)
!2252 = !DILocation(line: 55, column: 31, scope: !2159)
!2253 = !DILocation(line: 55, column: 5, scope: !2159)
!2254 = !DILocation(line: 55, column: 9, scope: !2159)
!2255 = !DILocation(line: 55, column: 19, scope: !2159)
!2256 = !DILocation(line: 55, column: 28, scope: !2159)
!2257 = !DILocation(line: 56, column: 10, scope: !2258)
!2258 = distinct !DILexicalBlock(scope: !2159, file: !921, line: 56, column: 9)
!2259 = !DILocation(line: 56, column: 16, scope: !2258)
!2260 = !DILocation(line: 56, column: 19, scope: !2261)
!2261 = !DILexicalBlockFile(scope: !2258, file: !921, discriminator: 1)
!2262 = !DILocation(line: 56, column: 40, scope: !2261)
!2263 = !DILocation(line: 56, column: 44, scope: !2261)
!2264 = !DILocation(line: 56, column: 54, scope: !2261)
!2265 = !DILocation(line: 56, column: 38, scope: !2261)
!2266 = !DILocation(line: 56, column: 25, scope: !2261)
!2267 = !DILocation(line: 56, column: 9, scope: !2261)
!2268 = !DILocation(line: 57, column: 9, scope: !2258)
!2269 = !DILocation(line: 58, column: 33, scope: !2159)
!2270 = !DILocation(line: 58, column: 41, scope: !2159)
!2271 = !DILocation(line: 58, column: 45, scope: !2159)
!2272 = !DILocation(line: 58, column: 55, scope: !2159)
!2273 = !DILocation(line: 58, column: 39, scope: !2159)
!2274 = !DILocation(line: 58, column: 5, scope: !2159)
!2275 = !DILocation(line: 58, column: 9, scope: !2159)
!2276 = !DILocation(line: 58, column: 19, scope: !2159)
!2277 = !DILocation(line: 58, column: 31, scope: !2159)
!2278 = !DILocation(line: 60, column: 13, scope: !2159)
!2279 = !DILocation(line: 60, column: 5, scope: !2159)
!2280 = !DILocation(line: 61, column: 13, scope: !2281)
!2281 = distinct !DILexicalBlock(scope: !2159, file: !921, line: 60, column: 20)
!2282 = !DILocation(line: 61, column: 17, scope: !2281)
!2283 = !DILocation(line: 61, column: 27, scope: !2281)
!2284 = !DILocation(line: 61, column: 36, scope: !2281)
!2285 = !DILocation(line: 61, column: 62, scope: !2281)
!2286 = !DILocation(line: 62, column: 14, scope: !2281)
!2287 = !DILocation(line: 62, column: 18, scope: !2281)
!2288 = !DILocation(line: 62, column: 28, scope: !2281)
!2289 = !DILocation(line: 62, column: 37, scope: !2281)
!2290 = !DILocation(line: 62, column: 69, scope: !2281)
!2291 = !DILocation(line: 63, column: 36, scope: !2281)
!2292 = !DILocation(line: 63, column: 51, scope: !2281)
!2293 = !DILocation(line: 63, column: 14, scope: !2281)
!2294 = !DILocation(line: 64, column: 14, scope: !2281)
!2295 = !DILocation(line: 67, column: 15, scope: !2159)
!2296 = !DILocation(line: 67, column: 18, scope: !2159)
!2297 = !DILocation(line: 67, column: 40, scope: !2159)
!2298 = !DILocation(line: 67, column: 43, scope: !2159)
!2299 = !DILocation(line: 67, column: 30, scope: !2159)
!2300 = !DILocation(line: 559, column: 22, scope: !2165, inlinedAt: !2169)
!2301 = !DILocation(line: 559, column: 12, scope: !2165, inlinedAt: !2169)
!2302 = !DILocation(line: 67, column: 28, scope: !2159)
!2303 = !DILocation(line: 67, column: 5, scope: !2304)
!2304 = !DILexicalBlockFile(scope: !2159, file: !921, discriminator: 1)
!2305 = !DILocation(line: 68, column: 25, scope: !2159)
!2306 = !DILocation(line: 68, column: 36, scope: !2159)
!2307 = !DILocation(line: 68, column: 40, scope: !2159)
!2308 = !DILocation(line: 68, column: 50, scope: !2159)
!2309 = !DILocation(line: 68, column: 5, scope: !2159)
!2310 = !DILocation(line: 70, column: 5, scope: !2159)
!2311 = !DILocation(line: 71, column: 1, scope: !2159)
!2312 = distinct !DISubprogram(name: "dcstr_read_packet", scope: !921, file: !921, line: 73, type: !2313, isLocal: true, isDefinition: true, scopeLine: 74, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2313 = !DISubroutineType(types: !2314)
!2314 = !{!917, !2162, !1033}
!2315 = !DILocalVariable(name: "s", arg: 1, scope: !2312, file: !921, line: 73, type: !2162)
!2316 = !DILocation(line: 73, column: 47, scope: !2312)
!2317 = !DILocalVariable(name: "pkt", arg: 2, scope: !2312, file: !921, line: 73, type: !1033)
!2318 = !DILocation(line: 73, column: 60, scope: !2312)
!2319 = !DILocalVariable(name: "par", scope: !2312, file: !921, line: 75, type: !1727)
!2320 = !DILocation(line: 75, column: 24, scope: !2312)
!2321 = !DILocation(line: 75, column: 30, scope: !2312)
!2322 = !DILocation(line: 75, column: 33, scope: !2312)
!2323 = !DILocation(line: 75, column: 45, scope: !2312)
!2324 = !DILocation(line: 76, column: 26, scope: !2312)
!2325 = !DILocation(line: 76, column: 29, scope: !2312)
!2326 = !DILocation(line: 76, column: 33, scope: !2312)
!2327 = !DILocation(line: 76, column: 38, scope: !2312)
!2328 = !DILocation(line: 76, column: 43, scope: !2312)
!2329 = !DILocation(line: 76, column: 12, scope: !2312)
!2330 = !DILocation(line: 76, column: 5, scope: !2312)
