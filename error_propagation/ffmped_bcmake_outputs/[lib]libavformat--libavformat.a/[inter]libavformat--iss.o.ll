; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--iss.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--iss.o.i"
...
@ff_iss_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 0, i8* null, %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 8, i32 (%struct.AVProbeData*)* @iss_probe, i32 (%struct.AVFormatContext*)* @iss_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @iss_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
...
define internal i32 @iss_probe(%struct.AVProbeData* %p) #0 !dbg !2140 {
entry:
  ...
  %call = call i32 @strncmp(i8* %1, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i32 0, i32 0), i64 15) #6, !dbg !2148
...
define internal i32 @iss_read_header(%struct.AVFormatContext* %s) #1 !dbg !2153 {
entry:
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2158, metadata !2143), !dbg !2162
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %iss = alloca %struct.IssDemuxContext*, align 8
  %pb = alloca %struct.AVIOContext*, align 8
  %st = alloca %struct.AVStream*, align 8
  %token = alloca [20 x i8], align 16
  %stereo = alloca i32, align 4
  %rate_divisor = alloca i32, align 4
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2164, metadata !2143), !dbg !2165
  call void @llvm.dbg.declare(metadata %struct.IssDemuxContext** %iss, metadata !2166, metadata !2143), !dbg !2173
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2174
  %priv_data = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 3, !dbg !2175
  %1 = load i8*, i8** %priv_data, align 8, !dbg !2175
  %2 = bitcast i8* %1 to %struct.IssDemuxContext*, !dbg !2174
  store %struct.IssDemuxContext* %2, %struct.IssDemuxContext** %iss, align 8, !dbg !2173
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2176, metadata !2143), !dbg !2177
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2178
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %3, i32 0, i32 4, !dbg !2179
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2179
  store %struct.AVIOContext* %4, %struct.AVIOContext** %pb, align 8, !dbg !2177
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2180, metadata !2143), !dbg !2181
  call void @llvm.dbg.declare(metadata [20 x i8]* %token, metadata !2182, metadata !2143), !dbg !2186
  call void @llvm.dbg.declare(metadata i32* %stereo, metadata !2187, metadata !2143), !dbg !2188
  call void @llvm.dbg.declare(metadata i32* %rate_divisor, metadata !2189, metadata !2143), !dbg !2190
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2191
  %arraydecay = getelementptr inbounds [20 x i8], [20 x i8]* %token, i32 0, i32 0, !dbg !2192
  call void @get_token(%struct.AVIOContext* %5, i8* %arraydecay, i32 20), !dbg !2193
  %6 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2194
  %arraydecay2 = getelementptr inbounds [20 x i8], [20 x i8]* %token, i32 0, i32 0, !dbg !2195
  call void @get_token(%struct.AVIOContext* %6, i8* %arraydecay2, i32 20), !dbg !2196
  %arraydecay3 = getelementptr inbounds [20 x i8], [20 x i8]* %token, i32 0, i32 0, !dbg !2197
  %7 = load %struct.IssDemuxContext*, %struct.IssDemuxContext** %iss, align 8, !dbg !2199
  %packet_size = getelementptr inbounds %struct.IssDemuxContext, %struct.IssDemuxContext* %7, i32 0, i32 0, !dbg !2200
  %call = call i32 (i8*, i8*, ...) @__isoc99_sscanf(i8* %arraydecay3, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0), i32* %packet_size) #7, !dbg !2201
  %cmp = icmp ne i32 %call, 1, !dbg !2202
  br i1 %cmp, label %if.then, label %if.end, !dbg !2203

if.then:                                          ; preds = %entry
  %8 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2204
  %9 = bitcast %struct.AVFormatContext* %8 to i8*, !dbg !2204
  call void (i8*, i32, i8*, ...) @av_log(i8* %9, i32 16, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.4, i32 0, i32 0)), !dbg !2206
  store i32 -1094995529, i32* %retval, align 4, !dbg !2207
  br label %return, !dbg !2207

if.end:                                           ; preds = %entry
  %10 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2208
  %arraydecay4 = getelementptr inbounds [20 x i8], [20 x i8]* %token, i32 0, i32 0, !dbg !2209
  call void @get_token(%struct.AVIOContext* %10, i8* %arraydecay4, i32 20), !dbg !2210
  %11 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2211
  %arraydecay5 = getelementptr inbounds [20 x i8], [20 x i8]* %token, i32 0, i32 0, !dbg !2212
  call void @get_token(%struct.AVIOContext* %11, i8* %arraydecay5, i32 20), !dbg !2213
  %12 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2214
  %arraydecay6 = getelementptr inbounds [20 x i8], [20 x i8]* %token, i32 0, i32 0, !dbg !2215
  call void @get_token(%struct.AVIOContext* %12, i8* %arraydecay6, i32 20), !dbg !2216
  %arraydecay7 = getelementptr inbounds [20 x i8], [20 x i8]* %token, i32 0, i32 0, !dbg !2217
  %call8 = call i32 (i8*, i8*, ...) @__isoc99_sscanf(i8* %arraydecay7, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0), i32* %stereo) #7, !dbg !2219
  %cmp9 = icmp ne i32 %call8, 1, !dbg !2220
  br i1 %cmp9, label %if.then10, label %if.end11, !dbg !2221

if.then10:                                        ; preds = %if.end
  %13 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2222
  %14 = bitcast %struct.AVFormatContext* %13 to i8*, !dbg !2222
  call void (i8*, i32, i8*, ...) @av_log(i8* %14, i32 16, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.5, i32 0, i32 0)), !dbg !2224
  store i32 -1094995529, i32* %retval, align 4, !dbg !2225
  br label %return, !dbg !2225

if.end11:                                         ; preds = %if.end
  %15 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2226
  %arraydecay12 = getelementptr inbounds [20 x i8], [20 x i8]* %token, i32 0, i32 0, !dbg !2227
  call void @get_token(%struct.AVIOContext* %15, i8* %arraydecay12, i32 20), !dbg !2228
  %16 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2229
  %arraydecay13 = getelementptr inbounds [20 x i8], [20 x i8]* %token, i32 0, i32 0, !dbg !2230
  call void @get_token(%struct.AVIOContext* %16, i8* %arraydecay13, i32 20), !dbg !2231
  %arraydecay14 = getelementptr inbounds [20 x i8], [20 x i8]* %token, i32 0, i32 0, !dbg !2232
  %call15 = call i32 (i8*, i8*, ...) @__isoc99_sscanf(i8* %arraydecay14, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0), i32* %rate_divisor) #7, !dbg !2234
  %cmp16 = icmp ne i32 %call15, 1, !dbg !2235
  br i1 %cmp16, label %if.then17, label %if.end18, !dbg !2236

if.then17:                                        ; preds = %if.end11
  %17 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2237
  %18 = bitcast %struct.AVFormatContext* %17 to i8*, !dbg !2237
  call void (i8*, i32, i8*, ...) @av_log(i8* %18, i32 16, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.6, i32 0, i32 0)), !dbg !2239
  store i32 -1094995529, i32* %retval, align 4, !dbg !2240
  br label %return, !dbg !2240

if.end18:                                         ; preds = %if.end11
  %19 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2241
  %arraydecay19 = getelementptr inbounds [20 x i8], [20 x i8]* %token, i32 0, i32 0, !dbg !2242
  call void @get_token(%struct.AVIOContext* %19, i8* %arraydecay19, i32 20), !dbg !2243
  %20 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2244
  %arraydecay20 = getelementptr inbounds [20 x i8], [20 x i8]* %token, i32 0, i32 0, !dbg !2245
  call void @get_token(%struct.AVIOContext* %20, i8* %arraydecay20, i32 20), !dbg !2246
  %21 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2247
  %arraydecay21 = getelementptr inbounds [20 x i8], [20 x i8]* %token, i32 0, i32 0, !dbg !2248
  call void @get_token(%struct.AVIOContext* %21, i8* %arraydecay21, i32 20), !dbg !2249
  %22 = load %struct.IssDemuxContext*, %struct.IssDemuxContext** %iss, align 8, !dbg !2250
  %packet_size22 = getelementptr inbounds %struct.IssDemuxContext, %struct.IssDemuxContext* %22, i32 0, i32 0, !dbg !2252
  %23 = load i32, i32* %packet_size22, align 4, !dbg !2252
  %cmp23 = icmp sle i32 %23, 0, !dbg !2253
  br i1 %cmp23, label %if.then24, label %if.end26, !dbg !2254

if.then24:                                        ; preds = %if.end18
  %24 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2255
  %25 = bitcast %struct.AVFormatContext* %24 to i8*, !dbg !2255
  %26 = load %struct.IssDemuxContext*, %struct.IssDemuxContext** %iss, align 8, !dbg !2257
  %packet_size25 = getelementptr inbounds %struct.IssDemuxContext, %struct.IssDemuxContext* %26, i32 0, i32 0, !dbg !2258
  %27 = load i32, i32* %packet_size25, align 4, !dbg !2258
  call void (i8*, i32, i8*, ...) @av_log(i8* %25, i32 16, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.7, i32 0, i32 0), i32 %27), !dbg !2259
  store i32 -1094995529, i32* %retval, align 4, !dbg !2260
  br label %return, !dbg !2260

if.end26:                                         ; preds = %if.end18
  %28 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2261
  store %struct.AVIOContext* %28, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2262
  %29 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2263
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %29, i64 0, i32 1) #7, !dbg !2264
  %conv = trunc i64 %call.i to i32, !dbg !2262
  %30 = load %struct.IssDemuxContext*, %struct.IssDemuxContext** %iss, align 8, !dbg !2265
  %sample_start_pos = getelementptr inbounds %struct.IssDemuxContext, %struct.IssDemuxContext* %30, i32 0, i32 1, !dbg !2266
  store i32 %conv, i32* %sample_start_pos, align 4, !dbg !2267
  %31 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2268
  %call28 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %31, %struct.AVCodec* null), !dbg !2269
  store %struct.AVStream* %call28, %struct.AVStream** %st, align 8, !dbg !2270
  %32 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2271
  %tobool = icmp ne %struct.AVStream* %32, null, !dbg !2271
  br i1 %tobool, label %if.end30, label %if.then29, !dbg !2273
...
if.end30:                                         ; preds = %if.end26
  %33 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2275
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %33, i32 0, i32 19, !dbg !2276
  %34 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2276
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %34, i32 0, i32 0, !dbg !2277
  store i32 1, i32* %codec_type, align 8, !dbg !2278
  %35 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2279
  %codecpar31 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %35, i32 0, i32 19, !dbg !2280
  %36 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar31, align 8, !dbg !2280
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %36, i32 0, i32 1, !dbg !2281
  store i32 69659, i32* %codec_id, align 4, !dbg !2282
  %37 = load i32, i32* %stereo, align 4, !dbg !2283
  %tobool32 = icmp ne i32 %37, 0, !dbg !2283
  br i1 %tobool32, label %if.then33, label %if.else, !dbg !2285

if.then33:                                        ; preds = %if.end30
  %38 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2286
  %codecpar34 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %38, i32 0, i32 19, !dbg !2288
  %39 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar34, align 8, !dbg !2288
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %39, i32 0, i32 22, !dbg !2289
  store i32 2, i32* %channels, align 8, !dbg !2290
  %40 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2291
  %codecpar35 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %40, i32 0, i32 19, !dbg !2292
  %41 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar35, align 8, !dbg !2292
  %channel_layout = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %41, i32 0, i32 21, !dbg !2293
  store i64 3, i64* %channel_layout, align 8, !dbg !2294
  br label %if.end40, !dbg !2295

if.else:                                          ; preds = %if.end30
  %42 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2296
  %codecpar36 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %42, i32 0, i32 19, !dbg !2298
  %43 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar36, align 8, !dbg !2298
  %channels37 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %43, i32 0, i32 22, !dbg !2299
  store i32 1, i32* %channels37, align 8, !dbg !2300
  %44 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2301
  %codecpar38 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %44, i32 0, i32 19, !dbg !2302
  %45 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar38, align 8, !dbg !2302
  %channel_layout39 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %45, i32 0, i32 21, !dbg !2303
  store i64 4, i64* %channel_layout39, align 8, !dbg !2304
  br label %if.end40

if.end40:                                         ; preds = %if.else, %if.then33
  %46 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2305
  %codecpar41 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %46, i32 0, i32 19, !dbg !2306
  %47 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar41, align 8, !dbg !2306
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %47, i32 0, i32 23, !dbg !2307
  store i32 44100, i32* %sample_rate, align 4, !dbg !2308
  %48 = load i32, i32* %rate_divisor, align 4, !dbg !2309
  %cmp42 = icmp sgt i32 %48, 0, !dbg !2311
  br i1 %cmp42, label %if.then44, label %if.end47, !dbg !2312

if.then44:                                        ; preds = %if.end40
  %49 = load i32, i32* %rate_divisor, align 4, !dbg !2313
  %50 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2314
  %codecpar45 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %50, i32 0, i32 19, !dbg !2315
  %51 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar45, align 8, !dbg !2315
  %sample_rate46 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %51, i32 0, i32 23, !dbg !2316
  %52 = load i32, i32* %sample_rate46, align 4, !dbg !2317
  %div = sdiv i32 %52, %49, !dbg !2317
  store i32 %div, i32* %sample_rate46, align 4, !dbg !2317
  br label %if.end47, !dbg !2314

if.end47:                                         ; preds = %if.then44, %if.end40
  %53 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2318
  %codecpar48 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %53, i32 0, i32 19, !dbg !2319
  %54 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar48, align 8, !dbg !2319
  %bits_per_coded_sample = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %54, i32 0, i32 7, !dbg !2320
  store i32 4, i32* %bits_per_coded_sample, align 8, !dbg !2321
  %55 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2322
  %codecpar49 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %55, i32 0, i32 19, !dbg !2323
  %56 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar49, align 8, !dbg !2323
  %channels50 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %56, i32 0, i32 22, !dbg !2324
  %57 = load i32, i32* %channels50, align 8, !dbg !2324
  %58 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2325
  %codecpar51 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %58, i32 0, i32 19, !dbg !2326
  %59 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar51, align 8, !dbg !2326
  %sample_rate52 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %59, i32 0, i32 23, !dbg !2327
  %60 = load i32, i32* %sample_rate52, align 4, !dbg !2327
  %mul = mul nsw i32 %57, %60, !dbg !2328
  %61 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2329
  %codecpar53 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %61, i32 0, i32 19, !dbg !2330
  %62 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar53, align 8, !dbg !2330
  %bits_per_coded_sample54 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %62, i32 0, i32 7, !dbg !2331
  %63 = load i32, i32* %bits_per_coded_sample54, align 8, !dbg !2331
  %mul55 = mul nsw i32 %mul, %63, !dbg !2332
  %conv56 = sext i32 %mul55 to i64, !dbg !2322
  %64 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2333
  %codecpar57 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %64, i32 0, i32 19, !dbg !2334
  %65 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar57, align 8, !dbg !2334
  %bit_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %65, i32 0, i32 6, !dbg !2335
  store i64 %conv56, i64* %bit_rate, align 8, !dbg !2336
  %66 = load %struct.IssDemuxContext*, %struct.IssDemuxContext** %iss, align 8, !dbg !2337
  %packet_size58 = getelementptr inbounds %struct.IssDemuxContext, %struct.IssDemuxContext* %66, i32 0, i32 0, !dbg !2338
  %67 = load i32, i32* %packet_size58, align 4, !dbg !2338
  %68 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2339
  %codecpar59 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %68, i32 0, i32 19, !dbg !2340
  %69 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar59, align 8, !dbg !2340
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %69, i32 0, i32 24, !dbg !2341
  store i32 %67, i32* %block_align, align 8, !dbg !2342
  %70 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2343
  %71 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2344
  %codecpar60 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %71, i32 0, i32 19, !dbg !2345
  %72 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar60, align 8, !dbg !2345
  %sample_rate61 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %72, i32 0, i32 23, !dbg !2346
  %73 = load i32, i32* %sample_rate61, align 4, !dbg !2346
  call void @avpriv_set_pts_info(%struct.AVStream* %70, i32 32, i32 1, i32 %73), !dbg !2347
  store i32 0, i32* %retval, align 4, !dbg !2348
  br label %return, !dbg !2348

return:                                           ; preds = %if.end47, %if.then29, %if.then24, %if.then17, %if.then10, %if.then
  %74 = load i32, i32* %retval, align 4, !dbg !2349
  ret i32 %74, !dbg !2349
}

; Function Attrs: nounwind uwtable
define internal i32 @iss_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2350 {
entry:
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2158, metadata !2143), !dbg !2353
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2355, metadata !2143), !dbg !2356
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2357, metadata !2143), !dbg !2358
  call void @llvm.dbg.declare(metadata %struct.IssDemuxContext** %iss, metadata !2359, metadata !2143), !dbg !2360
  ...
  %2 = bitcast i8* %1 to %struct.IssDemuxContext*, !dbg !2361
  store %struct.IssDemuxContext* %2, %struct.IssDemuxContext** %iss, align 8, !dbg !2360
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2363, metadata !2143), !dbg !2364
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2365
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %3, i32 0, i32 4, !dbg !2366
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2366
  %5 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2367
  %6 = load %struct.IssDemuxContext*, %struct.IssDemuxContext** %iss, align 8, !dbg !2368
  %packet_size = getelementptr inbounds %struct.IssDemuxContext, %struct.IssDemuxContext* %6, i32 0, i32 0, !dbg !2369
  %7 = load i32, i32* %packet_size, align 4, !dbg !2369
  %call = call i32 @av_get_packet(%struct.AVIOContext* %4, %struct.AVPacket* %5, i32 %7), !dbg !2370
  store i32 %call, i32* %ret, align 4, !dbg !2364
  %8 = load i32, i32* %ret, align 4, !dbg !2371
  %9 = load %struct.IssDemuxContext*, %struct.IssDemuxContext** %iss, align 8, !dbg !2373
  %packet_size1 = getelementptr inbounds %struct.IssDemuxContext, %struct.IssDemuxContext* %9, i32 0, i32 0, !dbg !2374
  %10 = load i32, i32* %packet_size1, align 4, !dbg !2374
  %cmp = icmp ne i32 %8, %10, !dbg !2375
  br i1 %cmp, label %if.then, label %if.end, !dbg !2376

if.then:                                          ; preds = %entry
  store i32 -5, i32* %retval, align 4, !dbg !2377
  br label %return, !dbg !2377

if.end:                                           ; preds = %entry
  %11 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2378
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %11, i32 0, i32 5, !dbg !2379
  store i32 0, i32* %stream_index, align 4, !dbg !2380
  %12 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2381
  %pb2 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %12, i32 0, i32 4, !dbg !2382
  %13 = load %struct.AVIOContext*, %struct.AVIOContext** %pb2, align 8, !dbg !2382
  store %struct.AVIOContext* %13, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2383
  %14 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2384
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %14, i64 0, i32 1) #7, !dbg !2385
  %15 = load %struct.IssDemuxContext*, %struct.IssDemuxContext** %iss, align 8, !dbg !2386
  %sample_start_pos = getelementptr inbounds %struct.IssDemuxContext, %struct.IssDemuxContext* %15, i32 0, i32 1, !dbg !2387
  %16 = load i32, i32* %sample_start_pos, align 4, !dbg !2387
  %conv = sext i32 %16 to i64, !dbg !2386
  %sub = sub nsw i64 %call.i, %conv, !dbg !2388
  %17 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2389
  %pts = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %17, i32 0, i32 1, !dbg !2390
  store i64 %sub, i64* %pts, align 8, !dbg !2391
  %18 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2392
  %streams = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %18, i32 0, i32 7, !dbg !2394
  %19 = load %struct.AVStream**, %struct.AVStream*** %streams, align 8, !dbg !2394
  %arrayidx = getelementptr inbounds %struct.AVStream*, %struct.AVStream** %19, i64 0, !dbg !2392
  %20 = load %struct.AVStream*, %struct.AVStream** %arrayidx, align 8, !dbg !2392
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %20, i32 0, i32 19, !dbg !2395
  %21 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2395
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %21, i32 0, i32 22, !dbg !2396
  %22 = load i32, i32* %channels, align 8, !dbg !2396
  %cmp4 = icmp sgt i32 %22, 0, !dbg !2397
  br i1 %cmp4, label %if.then6, label %if.end13, !dbg !2398

if.then6:                                         ; preds = %if.end
  %23 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2399
  %streams7 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %23, i32 0, i32 7, !dbg !2400
  %24 = load %struct.AVStream**, %struct.AVStream*** %streams7, align 8, !dbg !2400
  %arrayidx8 = getelementptr inbounds %struct.AVStream*, %struct.AVStream** %24, i64 0, !dbg !2399
  %25 = load %struct.AVStream*, %struct.AVStream** %arrayidx8, align 8, !dbg !2399
  %codecpar9 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %25, i32 0, i32 19, !dbg !2401
  %26 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar9, align 8, !dbg !2401
  %channels10 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %26, i32 0, i32 22, !dbg !2402
  %27 = load i32, i32* %channels10, align 8, !dbg !2402
  %mul = mul nsw i32 %27, 2, !dbg !2403
  %conv11 = sext i32 %mul to i64, !dbg !2399
  %28 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2404
  %pts12 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %28, i32 0, i32 1, !dbg !2405
  %29 = load i64, i64* %pts12, align 8, !dbg !2406
  %div = sdiv i64 %29, %conv11, !dbg !2406
  store i64 %div, i64* %pts12, align 8, !dbg !2406
  br label %if.end13, !dbg !2404
...
return:                                           ; preds = %if.end13, %if.then
  %30 = load i32, i32* %retval, align 4, !dbg !2408
  ret i32 %30, !dbg !2408
}
...
; Function Attrs: nounwind uwtable
define internal void @get_token(%struct.AVIOContext* %s, i8* %buf, i32 %maxlen) #0 !dbg !2409 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr, metadata !2412, metadata !2143), !dbg !2413
  store i8* %buf, i8** %buf.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %buf.addr, metadata !2414, metadata !2143), !dbg !2415
  store i32 %maxlen, i32* %maxlen.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %maxlen.addr, metadata !2416, metadata !2143), !dbg !2417
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2418, metadata !2143), !dbg !2419
  store i32 0, i32* %i, align 4, !dbg !2419
  call void @llvm.dbg.declare(metadata i8* %c, metadata !2420, metadata !2143), !dbg !2421
  br label %while.cond, !dbg !2422

while.cond:                                       ; preds = %if.end6, %entry
  %0 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr, align 8, !dbg !2423
  %call = call i32 @avio_r8(%struct.AVIOContext* %0), !dbg !2425
  %conv = trunc i32 %call to i8, !dbg !2425
  store i8 %conv, i8* %c, align 1, !dbg !2426
  %tobool = icmp ne i8 %conv, 0, !dbg !2427
  br i1 %tobool, label %while.body, label %while.end, !dbg !2427

while.body:                                       ; preds = %while.cond
  %1 = load i8, i8* %c, align 1, !dbg !2428
  %conv1 = sext i8 %1 to i32, !dbg !2428
  %cmp = icmp eq i32 %conv1, 32, !dbg !2431
  br i1 %cmp, label %if.then, label %if.end, !dbg !2432

if.then:                                          ; preds = %while.body
  br label %while.end, !dbg !2433

if.end:                                           ; preds = %while.body
  %2 = load i32, i32* %i, align 4, !dbg !2434
  %3 = load i32, i32* %maxlen.addr, align 4, !dbg !2436
  %sub = sub nsw i32 %3, 1, !dbg !2437
  %cmp3 = icmp slt i32 %2, %sub, !dbg !2438
  br i1 %cmp3, label %if.then5, label %if.end6, !dbg !2439

if.then5:                                         ; preds = %if.end
  %4 = load i8, i8* %c, align 1, !dbg !2440
  %5 = load i32, i32* %i, align 4, !dbg !2441
  %inc = add nsw i32 %5, 1, !dbg !2441
  store i32 %inc, i32* %i, align 4, !dbg !2441
  %idxprom = sext i32 %5 to i64, !dbg !2442
  %6 = load i8*, i8** %buf.addr, align 8, !dbg !2442
  %arrayidx = getelementptr inbounds i8, i8* %6, i64 %idxprom, !dbg !2442
  store i8 %4, i8* %arrayidx, align 1, !dbg !2443
  br label %if.end6, !dbg !2442

if.end6:                                          ; preds = %if.then5, %if.end
  br label %while.cond, !dbg !2444, !llvm.loop !2446

while.end:                                        ; preds = %if.then, %while.cond
  %7 = load i8, i8* %c, align 1, !dbg !2447
  %tobool7 = icmp ne i8 %7, 0, !dbg !2447
  br i1 %tobool7, label %if.end10, label %if.then8, !dbg !2449

if.then8:                                         ; preds = %while.end
  %8 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr, align 8, !dbg !2450
  %call9 = call i32 @avio_r8(%struct.AVIOContext* %8), !dbg !2451
  br label %if.end10, !dbg !2451

if.end10:                                         ; preds = %if.then8, %while.end
  %9 = load i32, i32* %i, align 4, !dbg !2452
  %idxprom11 = sext i32 %9 to i64, !dbg !2453
  %10 = load i8*, i8** %buf.addr, align 8, !dbg !2453
  %arrayidx12 = getelementptr inbounds i8, i8* %10, i64 %idxprom11, !dbg !2453
  store i8 0, i8* %arrayidx12, align 1, !dbg !2454
  ret void, !dbg !2455
}
...
declare %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext*, %struct.AVCodec*) #5

declare void @avpriv_set_pts_info(%struct.AVStream*, i32, i32, i32) #5

declare i32 @avio_r8(%struct.AVIOContext*) #5

declare i64 @avio_seek(%struct.AVIOContext*, i64, i32) #5

declare i32 @av_get_packet(%struct.AVIOContext*, %struct.AVPacket*, i32) #5
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--iss.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!919 = !{!920}
!920 = distinct !DIGlobalVariable(name: "ff_iss_demuxer", scope: !0, file: !921, line: 146, type: !922, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_iss_demuxer)
!921 = !DIFile(filename: "libavformat/iss.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2140 = distinct !DISubprogram(name: "iss_probe", scope: !921, file: !921, line: 61, type: !991, isLocal: true, isDefinition: true, scopeLine: 62, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2141 = !{}
!2142 = !DILocalVariable(name: "p", arg: 1, scope: !2140, file: !921, line: 61, type: !993)
!2143 = !DIExpression()
!2144 = !DILocation(line: 61, column: 35, scope: !2140)
!2145 = !DILocation(line: 63, column: 17, scope: !2146)
!2146 = distinct !DILexicalBlock(scope: !2140, file: !921, line: 63, column: 9)
!2147 = !DILocation(line: 63, column: 20, scope: !2146)
!2148 = !DILocation(line: 63, column: 9, scope: !2146)
!2149 = !DILocation(line: 63, column: 9, scope: !2140)
!2150 = !DILocation(line: 64, column: 9, scope: !2146)
!2151 = !DILocation(line: 66, column: 5, scope: !2140)
!2152 = !DILocation(line: 67, column: 1, scope: !2140)
!2153 = distinct !DISubprogram(name: "iss_read_header", scope: !921, file: !921, line: 69, type: !2154, isLocal: true, isDefinition: true, scopeLine: 70, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
...
!2158 = !DILocalVariable(name: "s", arg: 1, scope: !2159, file: !628, line: 557, type: !1215)
!2159 = distinct !DISubprogram(name: "avio_tell", scope: !628, file: !628, line: 557, type: !2160, isLocal: true, isDefinition: true, scopeLine: 558, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2160 = !DISubroutineType(types: !2161)
!2161 = !{!1053, !1215}
!2162 = !DILocation(line: 557, column: 77, scope: !2159, inlinedAt: !2163)
!2163 = distinct !DILocation(line: 105, column: 29, scope: !2153)
!2164 = !DILocalVariable(name: "s", arg: 1, scope: !2153, file: !921, line: 69, type: !2156)
!2165 = !DILocation(line: 69, column: 67, scope: !2153)
!2166 = !DILocalVariable(name: "iss", scope: !2153, file: !921, line: 71, type: !2167)
!2167 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2168, size: 64, align: 64)
!2168 = !DIDerivedType(tag: DW_TAG_typedef, name: "IssDemuxContext", file: !921, line: 41, baseType: !2169)
!2169 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "IssDemuxContext", file: !921, line: 38, size: 64, align: 32, elements: !2170)
!2170 = !{!2171, !2172}
!2171 = !DIDerivedType(tag: DW_TAG_member, name: "packet_size", scope: !2169, file: !921, line: 39, baseType: !917, size: 32, align: 32)
!2172 = !DIDerivedType(tag: DW_TAG_member, name: "sample_start_pos", scope: !2169, file: !921, line: 40, baseType: !917, size: 32, align: 32, offset: 32)
!2173 = !DILocation(line: 71, column: 22, scope: !2153)
!2174 = !DILocation(line: 71, column: 28, scope: !2153)
!2175 = !DILocation(line: 71, column: 31, scope: !2153)
!2176 = !DILocalVariable(name: "pb", scope: !2153, file: !921, line: 72, type: !1215)
!2177 = !DILocation(line: 72, column: 18, scope: !2153)
!2178 = !DILocation(line: 72, column: 23, scope: !2153)
!2179 = !DILocation(line: 72, column: 26, scope: !2153)
!2180 = !DILocalVariable(name: "st", scope: !2153, file: !921, line: 73, type: !1283)
!2181 = !DILocation(line: 73, column: 15, scope: !2153)
!2182 = !DILocalVariable(name: "token", scope: !2153, file: !921, line: 74, type: !2183)
!2183 = !DICompositeType(tag: DW_TAG_array_type, baseType: !928, size: 160, align: 8, elements: !2184)
!2184 = !{!2185}
!2185 = !DISubrange(count: 20)
!2186 = !DILocation(line: 74, column: 10, scope: !2153)
!2187 = !DILocalVariable(name: "stereo", scope: !2153, file: !921, line: 75, type: !917)
!2188 = !DILocation(line: 75, column: 9, scope: !2153)
!2189 = !DILocalVariable(name: "rate_divisor", scope: !2153, file: !921, line: 75, type: !917)
!2190 = !DILocation(line: 75, column: 17, scope: !2153)
!2191 = !DILocation(line: 77, column: 15, scope: !2153)
!2192 = !DILocation(line: 77, column: 19, scope: !2153)
!2193 = !DILocation(line: 77, column: 5, scope: !2153)
!2194 = !DILocation(line: 78, column: 15, scope: !2153)
!2195 = !DILocation(line: 78, column: 19, scope: !2153)
!2196 = !DILocation(line: 78, column: 5, scope: !2153)
!2197 = !DILocation(line: 79, column: 16, scope: !2198)
!2198 = distinct !DILexicalBlock(scope: !2153, file: !921, line: 79, column: 9)
!2199 = !DILocation(line: 79, column: 30, scope: !2198)
!2200 = !DILocation(line: 79, column: 35, scope: !2198)
!2201 = !DILocation(line: 79, column: 9, scope: !2198)
!2202 = !DILocation(line: 79, column: 48, scope: !2198)
!2203 = !DILocation(line: 79, column: 9, scope: !2153)
!2204 = !DILocation(line: 80, column: 16, scope: !2205)
!2205 = distinct !DILexicalBlock(scope: !2198, file: !921, line: 79, column: 54)
!2206 = !DILocation(line: 80, column: 9, scope: !2205)
!2207 = !DILocation(line: 81, column: 9, scope: !2205)
!2208 = !DILocation(line: 83, column: 15, scope: !2153)
!2209 = !DILocation(line: 83, column: 19, scope: !2153)
!2210 = !DILocation(line: 83, column: 5, scope: !2153)
!2211 = !DILocation(line: 84, column: 15, scope: !2153)
!2212 = !DILocation(line: 84, column: 19, scope: !2153)
!2213 = !DILocation(line: 84, column: 5, scope: !2153)
!2214 = !DILocation(line: 85, column: 15, scope: !2153)
!2215 = !DILocation(line: 85, column: 19, scope: !2153)
!2216 = !DILocation(line: 85, column: 5, scope: !2153)
!2217 = !DILocation(line: 86, column: 16, scope: !2218)
!2218 = distinct !DILexicalBlock(scope: !2153, file: !921, line: 86, column: 9)
!2219 = !DILocation(line: 86, column: 9, scope: !2218)
!2220 = !DILocation(line: 86, column: 38, scope: !2218)
!2221 = !DILocation(line: 86, column: 9, scope: !2153)
!2222 = !DILocation(line: 87, column: 16, scope: !2223)
!2223 = distinct !DILexicalBlock(scope: !2218, file: !921, line: 86, column: 44)
!2224 = !DILocation(line: 87, column: 9, scope: !2223)
!2225 = !DILocation(line: 88, column: 9, scope: !2223)
!2226 = !DILocation(line: 90, column: 15, scope: !2153)
!2227 = !DILocation(line: 90, column: 19, scope: !2153)
!2228 = !DILocation(line: 90, column: 5, scope: !2153)
!2229 = !DILocation(line: 91, column: 15, scope: !2153)
!2230 = !DILocation(line: 91, column: 19, scope: !2153)
!2231 = !DILocation(line: 91, column: 5, scope: !2153)
!2232 = !DILocation(line: 92, column: 16, scope: !2233)
!2233 = distinct !DILexicalBlock(scope: !2153, file: !921, line: 92, column: 9)
!2234 = !DILocation(line: 92, column: 9, scope: !2233)
!2235 = !DILocation(line: 92, column: 44, scope: !2233)
!2236 = !DILocation(line: 92, column: 9, scope: !2153)
!2237 = !DILocation(line: 93, column: 16, scope: !2238)
!2238 = distinct !DILexicalBlock(scope: !2233, file: !921, line: 92, column: 50)
!2239 = !DILocation(line: 93, column: 9, scope: !2238)
!2240 = !DILocation(line: 94, column: 9, scope: !2238)
!2241 = !DILocation(line: 96, column: 15, scope: !2153)
!2242 = !DILocation(line: 96, column: 19, scope: !2153)
!2243 = !DILocation(line: 96, column: 5, scope: !2153)
!2244 = !DILocation(line: 97, column: 15, scope: !2153)
!2245 = !DILocation(line: 97, column: 19, scope: !2153)
!2246 = !DILocation(line: 97, column: 5, scope: !2153)
!2247 = !DILocation(line: 98, column: 15, scope: !2153)
!2248 = !DILocation(line: 98, column: 19, scope: !2153)
!2249 = !DILocation(line: 98, column: 5, scope: !2153)
!2250 = !DILocation(line: 100, column: 9, scope: !2251)
!2251 = distinct !DILexicalBlock(scope: !2153, file: !921, line: 100, column: 9)
!2252 = !DILocation(line: 100, column: 14, scope: !2251)
!2253 = !DILocation(line: 100, column: 26, scope: !2251)
!2254 = !DILocation(line: 100, column: 9, scope: !2153)
!2255 = !DILocation(line: 101, column: 16, scope: !2256)
!2256 = distinct !DILexicalBlock(scope: !2251, file: !921, line: 100, column: 32)
!2257 = !DILocation(line: 101, column: 54, scope: !2256)
!2258 = !DILocation(line: 101, column: 59, scope: !2256)
!2259 = !DILocation(line: 101, column: 9, scope: !2256)
!2260 = !DILocation(line: 102, column: 9, scope: !2256)
!2261 = !DILocation(line: 105, column: 39, scope: !2153)
!2262 = !DILocation(line: 105, column: 29, scope: !2153)
!2263 = !DILocation(line: 559, column: 22, scope: !2159, inlinedAt: !2163)
!2264 = !DILocation(line: 559, column: 12, scope: !2159, inlinedAt: !2163)
!2265 = !DILocation(line: 105, column: 5, scope: !2153)
!2266 = !DILocation(line: 105, column: 10, scope: !2153)
!2267 = !DILocation(line: 105, column: 27, scope: !2153)
!2268 = !DILocation(line: 107, column: 30, scope: !2153)
!2269 = !DILocation(line: 107, column: 10, scope: !2153)
!2270 = !DILocation(line: 107, column: 8, scope: !2153)
!2271 = !DILocation(line: 108, column: 10, scope: !2272)
!2272 = distinct !DILexicalBlock(scope: !2153, file: !921, line: 108, column: 9)
!2273 = !DILocation(line: 108, column: 9, scope: !2153)
!2274 = !DILocation(line: 109, column: 9, scope: !2272)
!2275 = !DILocation(line: 110, column: 5, scope: !2153)
!2276 = !DILocation(line: 110, column: 9, scope: !2153)
!2277 = !DILocation(line: 110, column: 19, scope: !2153)
!2278 = !DILocation(line: 110, column: 30, scope: !2153)
!2279 = !DILocation(line: 111, column: 5, scope: !2153)
!2280 = !DILocation(line: 111, column: 9, scope: !2153)
!2281 = !DILocation(line: 111, column: 19, scope: !2153)
!2282 = !DILocation(line: 111, column: 28, scope: !2153)
!2283 = !DILocation(line: 112, column: 9, scope: !2284)
!2284 = distinct !DILexicalBlock(scope: !2153, file: !921, line: 112, column: 9)
!2285 = !DILocation(line: 112, column: 9, scope: !2153)
!2286 = !DILocation(line: 113, column: 9, scope: !2287)
!2287 = distinct !DILexicalBlock(scope: !2284, file: !921, line: 112, column: 17)
!2288 = !DILocation(line: 113, column: 13, scope: !2287)
!2289 = !DILocation(line: 113, column: 23, scope: !2287)
!2290 = !DILocation(line: 113, column: 32, scope: !2287)
!2291 = !DILocation(line: 114, column: 9, scope: !2287)
!2292 = !DILocation(line: 114, column: 13, scope: !2287)
!2293 = !DILocation(line: 114, column: 23, scope: !2287)
!2294 = !DILocation(line: 114, column: 38, scope: !2287)
!2295 = !DILocation(line: 115, column: 5, scope: !2287)
!2296 = !DILocation(line: 116, column: 9, scope: !2297)
!2297 = distinct !DILexicalBlock(scope: !2284, file: !921, line: 115, column: 12)
!2298 = !DILocation(line: 116, column: 13, scope: !2297)
!2299 = !DILocation(line: 116, column: 23, scope: !2297)
!2300 = !DILocation(line: 116, column: 32, scope: !2297)
!2301 = !DILocation(line: 117, column: 9, scope: !2297)
!2302 = !DILocation(line: 117, column: 13, scope: !2297)
!2303 = !DILocation(line: 117, column: 23, scope: !2297)
!2304 = !DILocation(line: 117, column: 38, scope: !2297)
!2305 = !DILocation(line: 119, column: 5, scope: !2153)
!2306 = !DILocation(line: 119, column: 9, scope: !2153)
!2307 = !DILocation(line: 119, column: 19, scope: !2153)
!2308 = !DILocation(line: 119, column: 31, scope: !2153)
!2309 = !DILocation(line: 120, column: 8, scope: !2310)
!2310 = distinct !DILexicalBlock(scope: !2153, file: !921, line: 120, column: 8)
!2311 = !DILocation(line: 120, column: 21, scope: !2310)
!2312 = !DILocation(line: 120, column: 8, scope: !2153)
!2313 = !DILocation(line: 121, column: 39, scope: !2310)
!2314 = !DILocation(line: 121, column: 10, scope: !2310)
!2315 = !DILocation(line: 121, column: 14, scope: !2310)
!2316 = !DILocation(line: 121, column: 24, scope: !2310)
!2317 = !DILocation(line: 121, column: 36, scope: !2310)
!2318 = !DILocation(line: 122, column: 5, scope: !2153)
!2319 = !DILocation(line: 122, column: 9, scope: !2153)
!2320 = !DILocation(line: 122, column: 19, scope: !2153)
!2321 = !DILocation(line: 122, column: 41, scope: !2153)
!2322 = !DILocation(line: 123, column: 30, scope: !2153)
!2323 = !DILocation(line: 123, column: 34, scope: !2153)
!2324 = !DILocation(line: 123, column: 44, scope: !2153)
!2325 = !DILocation(line: 123, column: 55, scope: !2153)
!2326 = !DILocation(line: 123, column: 59, scope: !2153)
!2327 = !DILocation(line: 123, column: 69, scope: !2153)
!2328 = !DILocation(line: 123, column: 53, scope: !2153)
!2329 = !DILocation(line: 124, column: 41, scope: !2153)
!2330 = !DILocation(line: 124, column: 45, scope: !2153)
!2331 = !DILocation(line: 124, column: 55, scope: !2153)
!2332 = !DILocation(line: 124, column: 39, scope: !2153)
!2333 = !DILocation(line: 123, column: 5, scope: !2153)
!2334 = !DILocation(line: 123, column: 9, scope: !2153)
!2335 = !DILocation(line: 123, column: 19, scope: !2153)
!2336 = !DILocation(line: 123, column: 28, scope: !2153)
!2337 = !DILocation(line: 125, column: 33, scope: !2153)
!2338 = !DILocation(line: 125, column: 38, scope: !2153)
!2339 = !DILocation(line: 125, column: 5, scope: !2153)
!2340 = !DILocation(line: 125, column: 9, scope: !2153)
!2341 = !DILocation(line: 125, column: 19, scope: !2153)
!2342 = !DILocation(line: 125, column: 31, scope: !2153)
!2343 = !DILocation(line: 126, column: 25, scope: !2153)
!2344 = !DILocation(line: 126, column: 36, scope: !2153)
!2345 = !DILocation(line: 126, column: 40, scope: !2153)
!2346 = !DILocation(line: 126, column: 50, scope: !2153)
!2347 = !DILocation(line: 126, column: 5, scope: !2153)
!2348 = !DILocation(line: 128, column: 5, scope: !2153)
!2349 = !DILocation(line: 129, column: 1, scope: !2153)
!2350 = distinct !DISubprogram(name: "iss_read_packet", scope: !921, file: !921, line: 131, type: !2351, isLocal: true, isDefinition: true, scopeLine: 132, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2351 = !DISubroutineType(types: !2352)
!2352 = !{!917, !2156, !1033}
!2353 = !DILocation(line: 557, column: 77, scope: !2159, inlinedAt: !2354)
!2354 = distinct !DILocation(line: 140, column: 16, scope: !2350)
!2355 = !DILocalVariable(name: "s", arg: 1, scope: !2350, file: !921, line: 131, type: !2156)
!2356 = !DILocation(line: 131, column: 45, scope: !2350)
!2357 = !DILocalVariable(name: "pkt", arg: 2, scope: !2350, file: !921, line: 131, type: !1033)
!2358 = !DILocation(line: 131, column: 58, scope: !2350)
!2359 = !DILocalVariable(name: "iss", scope: !2350, file: !921, line: 133, type: !2167)
!2360 = !DILocation(line: 133, column: 22, scope: !2350)
!2361 = !DILocation(line: 133, column: 28, scope: !2350)
!2362 = !DILocation(line: 133, column: 31, scope: !2350)
!2363 = !DILocalVariable(name: "ret", scope: !2350, file: !921, line: 134, type: !917)
!2364 = !DILocation(line: 134, column: 9, scope: !2350)
!2365 = !DILocation(line: 134, column: 29, scope: !2350)
!2366 = !DILocation(line: 134, column: 32, scope: !2350)
!2367 = !DILocation(line: 134, column: 36, scope: !2350)
!2368 = !DILocation(line: 134, column: 41, scope: !2350)
!2369 = !DILocation(line: 134, column: 46, scope: !2350)
!2370 = !DILocation(line: 134, column: 15, scope: !2350)
!2371 = !DILocation(line: 136, column: 8, scope: !2372)
!2372 = distinct !DILexicalBlock(scope: !2350, file: !921, line: 136, column: 8)
!2373 = !DILocation(line: 136, column: 15, scope: !2372)
!2374 = !DILocation(line: 136, column: 20, scope: !2372)
!2375 = !DILocation(line: 136, column: 12, scope: !2372)
!2376 = !DILocation(line: 136, column: 8, scope: !2350)
!2377 = !DILocation(line: 137, column: 9, scope: !2372)
!2378 = !DILocation(line: 139, column: 5, scope: !2350)
!2379 = !DILocation(line: 139, column: 10, scope: !2350)
!2380 = !DILocation(line: 139, column: 23, scope: !2350)
!2381 = !DILocation(line: 140, column: 26, scope: !2350)
!2382 = !DILocation(line: 140, column: 29, scope: !2350)
!2383 = !DILocation(line: 140, column: 16, scope: !2350)
!2384 = !DILocation(line: 559, column: 22, scope: !2159, inlinedAt: !2354)
!2385 = !DILocation(line: 559, column: 12, scope: !2159, inlinedAt: !2354)
!2386 = !DILocation(line: 140, column: 35, scope: !2350)
!2387 = !DILocation(line: 140, column: 40, scope: !2350)
!2388 = !DILocation(line: 140, column: 33, scope: !2350)
!2389 = !DILocation(line: 140, column: 5, scope: !2350)
!2390 = !DILocation(line: 140, column: 10, scope: !2350)
!2391 = !DILocation(line: 140, column: 14, scope: !2350)
!2392 = !DILocation(line: 141, column: 8, scope: !2393)
!2393 = distinct !DILexicalBlock(scope: !2350, file: !921, line: 141, column: 8)
!2394 = !DILocation(line: 141, column: 11, scope: !2393)
!2395 = !DILocation(line: 141, column: 23, scope: !2393)
!2396 = !DILocation(line: 141, column: 33, scope: !2393)
!2397 = !DILocation(line: 141, column: 42, scope: !2393)
!2398 = !DILocation(line: 141, column: 8, scope: !2350)
!2399 = !DILocation(line: 142, column: 21, scope: !2393)
!2400 = !DILocation(line: 142, column: 24, scope: !2393)
!2401 = !DILocation(line: 142, column: 36, scope: !2393)
!2402 = !DILocation(line: 142, column: 46, scope: !2393)
!2403 = !DILocation(line: 142, column: 54, scope: !2393)
!2404 = !DILocation(line: 142, column: 9, scope: !2393)
!2405 = !DILocation(line: 142, column: 14, scope: !2393)
!2406 = !DILocation(line: 142, column: 18, scope: !2393)
!2407 = !DILocation(line: 143, column: 5, scope: !2350)
!2408 = !DILocation(line: 144, column: 1, scope: !2350)
!2409 = distinct !DISubprogram(name: "get_token", scope: !921, file: !921, line: 43, type: !2410, isLocal: true, isDefinition: true, scopeLine: 44, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2410 = !DISubroutineType(types: !2411)
!2411 = !{null, !1215, !1396, !917}
!2412 = !DILocalVariable(name: "s", arg: 1, scope: !2409, file: !921, line: 43, type: !1215)
!2413 = !DILocation(line: 43, column: 36, scope: !2409)
!2414 = !DILocalVariable(name: "buf", arg: 2, scope: !2409, file: !921, line: 43, type: !1396)
!2415 = !DILocation(line: 43, column: 45, scope: !2409)
!2416 = !DILocalVariable(name: "maxlen", arg: 3, scope: !2409, file: !921, line: 43, type: !917)
!2417 = !DILocation(line: 43, column: 54, scope: !2409)
!2418 = !DILocalVariable(name: "i", scope: !2409, file: !921, line: 45, type: !917)
!2419 = !DILocation(line: 45, column: 9, scope: !2409)
!2420 = !DILocalVariable(name: "c", scope: !2409, file: !921, line: 46, type: !928)
!2421 = !DILocation(line: 46, column: 10, scope: !2409)
!2422 = !DILocation(line: 48, column: 5, scope: !2409)
!2423 = !DILocation(line: 48, column: 25, scope: !2424)
!2424 = !DILexicalBlockFile(scope: !2409, file: !921, discriminator: 1)
!2425 = !DILocation(line: 48, column: 17, scope: !2424)
!2426 = !DILocation(line: 48, column: 15, scope: !2424)
!2427 = !DILocation(line: 48, column: 5, scope: !2424)
!2428 = !DILocation(line: 49, column: 12, scope: !2429)
!2429 = distinct !DILexicalBlock(scope: !2430, file: !921, line: 49, column: 12)
!2430 = distinct !DILexicalBlock(scope: !2409, file: !921, line: 48, column: 30)
!2431 = !DILocation(line: 49, column: 14, scope: !2429)
!2432 = !DILocation(line: 49, column: 12, scope: !2430)
!2433 = !DILocation(line: 50, column: 13, scope: !2429)
!2434 = !DILocation(line: 51, column: 13, scope: !2435)
!2435 = distinct !DILexicalBlock(scope: !2430, file: !921, line: 51, column: 13)
!2436 = !DILocation(line: 51, column: 17, scope: !2435)
!2437 = !DILocation(line: 51, column: 23, scope: !2435)
!2438 = !DILocation(line: 51, column: 15, scope: !2435)
!2439 = !DILocation(line: 51, column: 13, scope: !2430)
!2440 = !DILocation(line: 52, column: 24, scope: !2435)
!2441 = !DILocation(line: 52, column: 18, scope: !2435)
!2442 = !DILocation(line: 52, column: 13, scope: !2435)
!2443 = !DILocation(line: 52, column: 22, scope: !2435)
!2444 = !DILocation(line: 48, column: 5, scope: !2445)
!2445 = !DILexicalBlockFile(scope: !2409, file: !921, discriminator: 2)
!2446 = distinct !{!2446, !2422}
!2447 = !DILocation(line: 55, column: 9, scope: !2448)
!2448 = distinct !DILexicalBlock(scope: !2409, file: !921, line: 55, column: 8)
!2449 = !DILocation(line: 55, column: 8, scope: !2409)
!2450 = !DILocation(line: 56, column: 17, scope: !2448)
!2451 = !DILocation(line: 56, column: 9, scope: !2448)
!2452 = !DILocation(line: 58, column: 9, scope: !2409)
!2453 = !DILocation(line: 58, column: 5, scope: !2409)
!2454 = !DILocation(line: 58, column: 12, scope: !2409)
!2455 = !DILocation(line: 59, column: 1, scope: !2409)
