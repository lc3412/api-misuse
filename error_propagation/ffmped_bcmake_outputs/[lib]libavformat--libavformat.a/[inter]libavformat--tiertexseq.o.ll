; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--tiertexseq.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--tiertexseq.o.i"
...
%struct.SeqDemuxContext = type { i32, i32, i32, i32, [30 x %struct.TiertexSeqFrameBuffer], i32, i32, i32, i32, i32, i32, i8*, i32 }
%struct.TiertexSeqFrameBuffer = type { i32, i32, i8* }
...
@ff_tiertexseq_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 0, i8* null, %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 536, i32 (%struct.AVProbeData*)* @seq_probe, i32 (%struct.AVFormatContext*)* @seq_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @seq_read_packet, i32 (%struct.AVFormatContext*)* @seq_read_close, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8

; Function Attrs: nounwind uwtable
define internal i32 @seq_probe(%struct.AVProbeData* %p) #0 !dbg !2140 {
entry:
  ...
  %0 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2147
  %buf_size = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %0, i32 0, i32 2, !dbg !2149
  %1 = load i32, i32* %buf_size, align 8, !dbg !2149
  %cmp = icmp slt i32 %1, 258, !dbg !2150
...
for.cond:                                         ; preds = %for.inc, %if.end
  %2 = load i32, i32* %i, align 4, !dbg !2156
  %cmp1 = icmp slt i32 %2, 256, !dbg !2159
  br i1 %cmp1, label %for.body, label %for.end, !dbg !2160

for.body:                                         ; preds = %for.cond
  %3 = load i32, i32* %i, align 4, !dbg !2161
  %idxprom = sext i32 %3 to i64, !dbg !2163
  %4 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2163
  %buf = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %4, i32 0, i32 1, !dbg !2164
  %5 = load i8*, i8** %buf, align 8, !dbg !2164
  %arrayidx = getelementptr inbounds i8, i8* %5, i64 %idxprom, !dbg !2163
  %6 = load i8, i8* %arrayidx, align 1, !dbg !2163
  %tobool = icmp ne i8 %6, 0, !dbg !2163
  br i1 %tobool, label %if.then2, label %if.end3, !dbg !2165
...
for.inc:                                          ; preds = %if.end3
  %7 = load i32, i32* %i, align 4, !dbg !2169
  %inc = add nsw i32 %7, 1, !dbg !2169
...
for.end:                                          ; preds = %for.cond
  ...
  %buf4 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %8, i32 0, i32 1, !dbg !2176
  %9 = load i8*, i8** %buf4, align 8, !dbg !2176
  %arrayidx5 = getelementptr inbounds i8, i8* %9, i64 256, !dbg !2174
  %10 = load i8, i8* %arrayidx5, align 1, !dbg !2174
  %conv = zext i8 %10 to i32, !dbg !2174
  %cmp6 = icmp eq i32 %conv, 0, !dbg !2177
  br i1 %cmp6, label %land.lhs.true, label %if.end14, !dbg !2178

land.lhs.true:                                    ; preds = %for.end
  %11 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2179
  %buf8 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %11, i32 0, i32 1, !dbg !2181
  %12 = load i8*, i8** %buf8, align 8, !dbg !2181
  %arrayidx9 = getelementptr inbounds i8, i8* %12, i64 257, !dbg !2179
  %13 = load i8, i8* %arrayidx9, align 1, !dbg !2179
  %conv10 = zext i8 %13 to i32, !dbg !2179
  %cmp11 = icmp eq i32 %conv10, 0, !dbg !2182
  br i1 %cmp11, label %if.then13, label %if.end14, !dbg !2183
...
if.end14:                                         ; preds = %land.lhs.true, %for.end
  store i32 25, i32* %retval, align 4, !dbg !2185
  br label %return, !dbg !2185

return:                                           ; preds = %if.end14, %if.then13, %if.then2, %if.then
  %14 = load i32, i32* %retval, align 4, !dbg !2186
  ret i32 %14, !dbg !2186
}

; Function Attrs: nounwind uwtable
define internal i32 @seq_read_header(%struct.AVFormatContext* %s) #0 !dbg !2187 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %i = alloca i32, align 4
  %rc = alloca i32, align 4
  %seq = alloca %struct.SeqDemuxContext*, align 8
  %pb = alloca %struct.AVIOContext*, align 8
  %st = alloca %struct.AVStream*, align 8
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2192, metadata !2143), !dbg !2193
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2194, metadata !2143), !dbg !2195
  call void @llvm.dbg.declare(metadata i32* %rc, metadata !2196, metadata !2143), !dbg !2197
  call void @llvm.dbg.declare(metadata %struct.SeqDemuxContext** %seq, metadata !2198, metadata !2143), !dbg !2225
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2226
  ...
  %2 = bitcast i8* %1 to %struct.SeqDemuxContext*, !dbg !2226
  store %struct.SeqDemuxContext* %2, %struct.SeqDemuxContext** %seq, align 8, !dbg !2225
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2228, metadata !2143), !dbg !2229
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2230
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %3, i32 0, i32 4, !dbg !2231
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2231
  store %struct.AVIOContext* %4, %struct.AVIOContext** %pb, align 8, !dbg !2229
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2232, metadata !2143), !dbg !2233
  %5 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2234
  %6 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2235
  %call = call i32 @seq_init_frame_buffers(%struct.SeqDemuxContext* %5, %struct.AVIOContext* %6), !dbg !2236
  store i32 %call, i32* %rc, align 4, !dbg !2237
  %7 = load i32, i32* %rc, align 4, !dbg !2238
  %tobool = icmp ne i32 %7, 0, !dbg !2238
  br i1 %tobool, label %if.then, label %if.end, !dbg !2240

if.then:                                          ; preds = %entry
  %8 = load i32, i32* %rc, align 4, !dbg !2241
  store i32 %8, i32* %retval, align 4, !dbg !2242
  br label %return, !dbg !2242

if.end:                                           ; preds = %entry
  %9 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2243
  %current_frame_offs = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %9, i32 0, i32 3, !dbg !2244
  store i32 0, i32* %current_frame_offs, align 4, !dbg !2245
  store i32 1, i32* %i, align 4, !dbg !2246
  br label %for.cond, !dbg !2248

for.cond:                                         ; preds = %for.inc, %if.end
  %10 = load i32, i32* %i, align 4, !dbg !2249
  %cmp = icmp sle i32 %10, 100, !dbg !2252
  br i1 %cmp, label %for.body, label %for.end, !dbg !2253

for.body:                                         ; preds = %for.cond
  %11 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2254
  %12 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2256
  %call2 = call i32 @seq_parse_frame_data(%struct.SeqDemuxContext* %11, %struct.AVIOContext* %12), !dbg !2257
  store i32 %call2, i32* %rc, align 4, !dbg !2258
  %13 = load i32, i32* %rc, align 4, !dbg !2259
  %tobool3 = icmp ne i32 %13, 0, !dbg !2259
  br i1 %tobool3, label %if.then4, label %if.end5, !dbg !2261

if.then4:                                         ; preds = %for.body
  %14 = load i32, i32* %rc, align 4, !dbg !2262
  store i32 %14, i32* %retval, align 4, !dbg !2263
...
for.inc:                                          ; preds = %if.end5
  %15 = load i32, i32* %i, align 4, !dbg !2265
  %inc = add nsw i32 %15, 1, !dbg !2265
  store i32 %inc, i32* %i, align 4, !dbg !2265
  br label %for.cond, !dbg !2267, !llvm.loop !2268

for.end:                                          ; preds = %for.cond
  %16 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2270
  %current_frame_pts = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %16, i32 0, i32 2, !dbg !2271
  store i32 0, i32* %current_frame_pts, align 8, !dbg !2272
  %17 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2273
  %audio_buffer_full = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %17, i32 0, i32 12, !dbg !2274
  store i32 0, i32* %audio_buffer_full, align 8, !dbg !2275
  %18 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2276
  %call6 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %18, %struct.AVCodec* null), !dbg !2277
  store %struct.AVStream* %call6, %struct.AVStream** %st, align 8, !dbg !2278
  %19 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2279
  %tobool7 = icmp ne %struct.AVStream* %19, null, !dbg !2279
  br i1 %tobool7, label %if.end9, label %if.then8, !dbg !2281

if.then8:                                         ; preds = %for.end
  store i32 -12, i32* %retval, align 4, !dbg !2282
  br label %return, !dbg !2282

if.end9:                                          ; preds = %for.end
  %20 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2283
  call void @avpriv_set_pts_info(%struct.AVStream* %20, i32 32, i32 1, i32 25), !dbg !2284
  %21 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2285
  %index = getelementptr inbounds %struct.AVStream, %struct.AVStream* %21, i32 0, i32 0, !dbg !2286
  %22 = load i32, i32* %index, align 8, !dbg !2286
  %23 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2287
  %video_stream_index = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %23, i32 0, i32 1, !dbg !2288
  store i32 %22, i32* %video_stream_index, align 4, !dbg !2289
  %24 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2290
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %24, i32 0, i32 19, !dbg !2291
  %25 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2291
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %25, i32 0, i32 0, !dbg !2292
  store i32 0, i32* %codec_type, align 8, !dbg !2293
  %26 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2294
  %codecpar10 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %26, i32 0, i32 19, !dbg !2295
  %27 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar10, align 8, !dbg !2295
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %27, i32 0, i32 1, !dbg !2296
  store i32 95, i32* %codec_id, align 4, !dbg !2297
  %28 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2298
  %codecpar11 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %28, i32 0, i32 19, !dbg !2299
  %29 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar11, align 8, !dbg !2299
  %codec_tag = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %29, i32 0, i32 2, !dbg !2300
  store i32 0, i32* %codec_tag, align 8, !dbg !2301
  %30 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2302
  %codecpar12 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %30, i32 0, i32 19, !dbg !2303
  %31 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar12, align 8, !dbg !2303
  %width = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %31, i32 0, i32 11, !dbg !2304
  store i32 256, i32* %width, align 8, !dbg !2305
  %32 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2306
  %codecpar13 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %32, i32 0, i32 19, !dbg !2307
  %33 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar13, align 8, !dbg !2307
  %height = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %33, i32 0, i32 12, !dbg !2308
  store i32 128, i32* %height, align 4, !dbg !2309
  %34 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2310
  %call14 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %34, %struct.AVCodec* null), !dbg !2311
  store %struct.AVStream* %call14, %struct.AVStream** %st, align 8, !dbg !2312
  %35 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2313
  %tobool15 = icmp ne %struct.AVStream* %35, null, !dbg !2313
  br i1 %tobool15, label %if.end17, label %if.then16, !dbg !2315
...
if.end17:                                         ; preds = %if.end9
  %36 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2317
  %start_time = getelementptr inbounds %struct.AVStream, %struct.AVStream* %36, i32 0, i32 5, !dbg !2318
  store i64 0, i64* %start_time, align 8, !dbg !2319
  %37 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2320
  call void @avpriv_set_pts_info(%struct.AVStream* %37, i32 32, i32 1, i32 22050), !dbg !2321
  %38 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2322
  %index18 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %38, i32 0, i32 0, !dbg !2323
  %39 = load i32, i32* %index18, align 8, !dbg !2323
  %40 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2324
  %audio_stream_index = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %40, i32 0, i32 0, !dbg !2325
  store i32 %39, i32* %audio_stream_index, align 8, !dbg !2326
  %41 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2327
  %codecpar19 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %41, i32 0, i32 19, !dbg !2328
  %42 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar19, align 8, !dbg !2328
  %codec_type20 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %42, i32 0, i32 0, !dbg !2329
  store i32 1, i32* %codec_type20, align 8, !dbg !2330
  %43 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2331
  %codecpar21 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %43, i32 0, i32 19, !dbg !2332
  %44 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar21, align 8, !dbg !2332
  %codec_id22 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %44, i32 0, i32 1, !dbg !2333
  store i32 65537, i32* %codec_id22, align 4, !dbg !2334
  %45 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2335
  %codecpar23 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %45, i32 0, i32 19, !dbg !2336
  %46 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar23, align 8, !dbg !2336
  %codec_tag24 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %46, i32 0, i32 2, !dbg !2337
  store i32 0, i32* %codec_tag24, align 8, !dbg !2338
  %47 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2339
  %codecpar25 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %47, i32 0, i32 19, !dbg !2340
  %48 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar25, align 8, !dbg !2340
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %48, i32 0, i32 22, !dbg !2341
  store i32 1, i32* %channels, align 8, !dbg !2342
  %49 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2343
  %codecpar26 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %49, i32 0, i32 19, !dbg !2344
  %50 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar26, align 8, !dbg !2344
  %channel_layout = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %50, i32 0, i32 21, !dbg !2345
  store i64 4, i64* %channel_layout, align 8, !dbg !2346
  %51 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2347
  %codecpar27 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %51, i32 0, i32 19, !dbg !2348
  %52 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar27, align 8, !dbg !2348
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %52, i32 0, i32 23, !dbg !2349
  store i32 22050, i32* %sample_rate, align 4, !dbg !2350
  %53 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2351
  %codecpar28 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %53, i32 0, i32 19, !dbg !2352
  %54 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar28, align 8, !dbg !2352
  %bits_per_coded_sample = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %54, i32 0, i32 7, !dbg !2353
  store i32 16, i32* %bits_per_coded_sample, align 8, !dbg !2354
  %55 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2355
  %codecpar29 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %55, i32 0, i32 19, !dbg !2356
  %56 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar29, align 8, !dbg !2356
  %sample_rate30 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %56, i32 0, i32 23, !dbg !2357
  %57 = load i32, i32* %sample_rate30, align 4, !dbg !2357
  %58 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2358
  %codecpar31 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %58, i32 0, i32 19, !dbg !2359
  %59 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar31, align 8, !dbg !2359
  %bits_per_coded_sample32 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %59, i32 0, i32 7, !dbg !2360
  %60 = load i32, i32* %bits_per_coded_sample32, align 8, !dbg !2360
  %mul = mul nsw i32 %57, %60, !dbg !2361
  %61 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2362
  %codecpar33 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %61, i32 0, i32 19, !dbg !2363
  %62 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar33, align 8, !dbg !2363
  %channels34 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %62, i32 0, i32 22, !dbg !2364
  %63 = load i32, i32* %channels34, align 8, !dbg !2364
  %mul35 = mul nsw i32 %mul, %63, !dbg !2365
  %conv = sext i32 %mul35 to i64, !dbg !2355
  %64 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2366
  %codecpar36 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %64, i32 0, i32 19, !dbg !2367
  %65 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar36, align 8, !dbg !2367
  %bit_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %65, i32 0, i32 6, !dbg !2368
  store i64 %conv, i64* %bit_rate, align 8, !dbg !2369
  %66 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2370
  %codecpar37 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %66, i32 0, i32 19, !dbg !2371
  %67 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar37, align 8, !dbg !2371
  %channels38 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %67, i32 0, i32 22, !dbg !2372
  %68 = load i32, i32* %channels38, align 8, !dbg !2372
  %69 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2373
  %codecpar39 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %69, i32 0, i32 19, !dbg !2374
  %70 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar39, align 8, !dbg !2374
  %bits_per_coded_sample40 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %70, i32 0, i32 7, !dbg !2375
  %71 = load i32, i32* %bits_per_coded_sample40, align 8, !dbg !2375
  %mul41 = mul nsw i32 %68, %71, !dbg !2376
  %div = sdiv i32 %mul41, 8, !dbg !2377
  %72 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2378
  %codecpar42 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %72, i32 0, i32 19, !dbg !2379
  %73 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar42, align 8, !dbg !2379
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %73, i32 0, i32 24, !dbg !2380
  store i32 %div, i32* %block_align, align 8, !dbg !2381
  store i32 0, i32* %retval, align 4, !dbg !2382
  br label %return, !dbg !2382

return:                                           ; preds = %if.end17, %if.then16, %if.then8, %if.then4, %if.then
  %74 = load i32, i32* %retval, align 4, !dbg !2383
  ret i32 %74, !dbg !2383
}

; Function Attrs: nounwind uwtable
define internal i32 @seq_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2384 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  %pb = alloca %struct.AVIOContext*, align 8
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2387, metadata !2143), !dbg !2388
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2389, metadata !2143), !dbg !2390
  call void @llvm.dbg.declare(metadata i32* %rc, metadata !2391, metadata !2143), !dbg !2392
  call void @llvm.dbg.declare(metadata %struct.SeqDemuxContext** %seq, metadata !2393, metadata !2143), !dbg !2394
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2395
  %priv_data = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 3, !dbg !2396
  %1 = load i8*, i8** %priv_data, align 8, !dbg !2396
  %2 = bitcast i8* %1 to %struct.SeqDemuxContext*, !dbg !2395
  store %struct.SeqDemuxContext* %2, %struct.SeqDemuxContext** %seq, align 8, !dbg !2394
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2397, metadata !2143), !dbg !2398
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2399
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %3, i32 0, i32 4, !dbg !2400
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2400
  store %struct.AVIOContext* %4, %struct.AVIOContext** %pb, align 8, !dbg !2398
  %5 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2401
  %audio_buffer_full = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %5, i32 0, i32 12, !dbg !2403
  %6 = load i32, i32* %audio_buffer_full, align 8, !dbg !2403
  %tobool = icmp ne i32 %6, 0, !dbg !2401
  br i1 %tobool, label %if.end50, label %if.then, !dbg !2404

if.then:                                          ; preds = %entry
  %7 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2405
  %8 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2407
  %call = call i32 @seq_parse_frame_data(%struct.SeqDemuxContext* %7, %struct.AVIOContext* %8), !dbg !2408
  store i32 %call, i32* %rc, align 4, !dbg !2409
  %9 = load i32, i32* %rc, align 4, !dbg !2410
  %tobool2 = icmp ne i32 %9, 0, !dbg !2410
  br i1 %tobool2, label %if.then3, label %if.end, !dbg !2412

if.then3:                                         ; preds = %if.then
  %10 = load i32, i32* %rc, align 4, !dbg !2413
  store i32 %10, i32* %retval, align 4, !dbg !2414
  br label %return, !dbg !2414

if.end:                                           ; preds = %if.then
  %11 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2415
  %current_pal_data_size = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %11, i32 0, i32 8, !dbg !2417
  %12 = load i32, i32* %current_pal_data_size, align 4, !dbg !2417
  %13 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2418
  %current_video_data_size = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %13, i32 0, i32 10, !dbg !2419
  %14 = load i32, i32* %current_video_data_size, align 4, !dbg !2419
  %add = add i32 %12, %14, !dbg !2420
  %cmp = icmp ne i32 %add, 0, !dbg !2421
  br i1 %cmp, label %if.then4, label %if.end49, !dbg !2422

if.then4:                                         ; preds = %if.end
  %15 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2423
  %16 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2426
  %current_pal_data_size5 = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %16, i32 0, i32 8, !dbg !2427
  %17 = load i32, i32* %current_pal_data_size5, align 4, !dbg !2427
  %add6 = add i32 1, %17, !dbg !2428
  %18 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2429
  %current_video_data_size7 = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %18, i32 0, i32 10, !dbg !2430
  %19 = load i32, i32* %current_video_data_size7, align 4, !dbg !2430
  %add8 = add i32 %add6, %19, !dbg !2431
  %call9 = call i32 @av_new_packet(%struct.AVPacket* %15, i32 %add8), !dbg !2432
  %tobool10 = icmp ne i32 %call9, 0, !dbg !2432
  br i1 %tobool10, label %if.then11, label %if.end12, !dbg !2433
...
if.end12:                                         ; preds = %if.then4
  %20 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2435
  %data = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %20, i32 0, i32 3, !dbg !2436
  %21 = load i8*, i8** %data, align 8, !dbg !2436
  %arrayidx = getelementptr inbounds i8, i8* %21, i64 0, !dbg !2435
  store i8 0, i8* %arrayidx, align 1, !dbg !2437
  %22 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2438
  %current_pal_data_size13 = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %22, i32 0, i32 8, !dbg !2440
  %23 = load i32, i32* %current_pal_data_size13, align 4, !dbg !2440
  %tobool14 = icmp ne i32 %23, 0, !dbg !2438
  br i1 %tobool14, label %if.then15, label %if.end31, !dbg !2441

if.then15:                                        ; preds = %if.end12
  %24 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2442
  %data16 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %24, i32 0, i32 3, !dbg !2444
  %25 = load i8*, i8** %data16, align 8, !dbg !2444
  %arrayidx17 = getelementptr inbounds i8, i8* %25, i64 0, !dbg !2442
  %26 = load i8, i8* %arrayidx17, align 1, !dbg !2445
  %conv = zext i8 %26 to i32, !dbg !2445
  %or = or i32 %conv, 1, !dbg !2445
  %conv18 = trunc i32 %or to i8, !dbg !2445
  store i8 %conv18, i8* %arrayidx17, align 1, !dbg !2445
  %27 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2446
  %28 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2447
  %current_frame_offs = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %28, i32 0, i32 3, !dbg !2448
  %29 = load i32, i32* %current_frame_offs, align 4, !dbg !2448
  %30 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2449
  %current_pal_data_offs = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %30, i32 0, i32 9, !dbg !2450
  %31 = load i32, i32* %current_pal_data_offs, align 8, !dbg !2450
  %add19 = add i32 %29, %31, !dbg !2451
  %conv20 = zext i32 %add19 to i64, !dbg !2447
  %call21 = call i64 @avio_seek(%struct.AVIOContext* %27, i64 %conv20, i32 0), !dbg !2452
  %32 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2453
  %33 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2455
  %data22 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %33, i32 0, i32 3, !dbg !2456
  %34 = load i8*, i8** %data22, align 8, !dbg !2456
  %arrayidx23 = getelementptr inbounds i8, i8* %34, i64 1, !dbg !2455
  %35 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2457
  %current_pal_data_size24 = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %35, i32 0, i32 8, !dbg !2458
  %36 = load i32, i32* %current_pal_data_size24, align 4, !dbg !2458
  %call25 = call i32 @avio_read(%struct.AVIOContext* %32, i8* %arrayidx23, i32 %36), !dbg !2459
  %37 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2460
  %current_pal_data_size26 = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %37, i32 0, i32 8, !dbg !2461
  %38 = load i32, i32* %current_pal_data_size26, align 4, !dbg !2461
  %cmp27 = icmp ne i32 %call25, %38, !dbg !2462
  br i1 %cmp27, label %if.then29, label %if.end30, !dbg !2463

if.then29:                                        ; preds = %if.then15
  store i32 -5, i32* %retval, align 4, !dbg !2464
...
if.end31:                                         ; preds = %if.end30, %if.end12
  %39 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2466
  %current_video_data_size32 = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %39, i32 0, i32 10, !dbg !2468
  %40 = load i32, i32* %current_video_data_size32, align 4, !dbg !2468
  %tobool33 = icmp ne i32 %40, 0, !dbg !2466
  br i1 %tobool33, label %if.then34, label %if.end46, !dbg !2469

if.then34:                                        ; preds = %if.end31
  %41 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2470
  %data35 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %41, i32 0, i32 3, !dbg !2472
  %42 = load i8*, i8** %data35, align 8, !dbg !2472
  %arrayidx36 = getelementptr inbounds i8, i8* %42, i64 0, !dbg !2470
  %43 = load i8, i8* %arrayidx36, align 1, !dbg !2473
  %conv37 = zext i8 %43 to i32, !dbg !2473
  %or38 = or i32 %conv37, 2, !dbg !2473
  %conv39 = trunc i32 %or38 to i8, !dbg !2473
  store i8 %conv39, i8* %arrayidx36, align 1, !dbg !2473
  %44 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2474
  %current_pal_data_size40 = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %44, i32 0, i32 8, !dbg !2475
  %45 = load i32, i32* %current_pal_data_size40, align 4, !dbg !2475
  %add41 = add i32 1, %45, !dbg !2476
  %idxprom = zext i32 %add41 to i64, !dbg !2477
  %46 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2477
  %data42 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %46, i32 0, i32 3, !dbg !2478
  %47 = load i8*, i8** %data42, align 8, !dbg !2478
  %arrayidx43 = getelementptr inbounds i8, i8* %47, i64 %idxprom, !dbg !2477
  %48 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2479
  %current_video_data_ptr = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %48, i32 0, i32 11, !dbg !2480
  %49 = load i8*, i8** %current_video_data_ptr, align 8, !dbg !2480
  %50 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2481
  %current_video_data_size44 = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %50, i32 0, i32 10, !dbg !2482
  %51 = load i32, i32* %current_video_data_size44, align 4, !dbg !2482
  %conv45 = zext i32 %51 to i64, !dbg !2481
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %arrayidx43, i8* %49, i64 %conv45, i32 1, i1 false), !dbg !2483
  br label %if.end46, !dbg !2484

if.end46:                                         ; preds = %if.then34, %if.end31
  %52 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2485
  %video_stream_index = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %52, i32 0, i32 1, !dbg !2486
  %53 = load i32, i32* %video_stream_index, align 4, !dbg !2486
  %54 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2487
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %54, i32 0, i32 5, !dbg !2488
  store i32 %53, i32* %stream_index, align 4, !dbg !2489
  %55 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2490
  %current_frame_pts = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %55, i32 0, i32 2, !dbg !2491
  %56 = load i32, i32* %current_frame_pts, align 8, !dbg !2491
  %conv47 = sext i32 %56 to i64, !dbg !2490
  %57 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2492
  %pts = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %57, i32 0, i32 1, !dbg !2493
  store i64 %conv47, i64* %pts, align 8, !dbg !2494
  %58 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2495
  %audio_buffer_full48 = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %58, i32 0, i32 12, !dbg !2496
  store i32 1, i32* %audio_buffer_full48, align 8, !dbg !2497
  store i32 0, i32* %retval, align 4, !dbg !2498
  br label %return, !dbg !2498

if.end49:                                         ; preds = %if.end
  br label %if.end50, !dbg !2499

if.end50:                                         ; preds = %if.end49, %entry
  %59 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2500
  %current_audio_data_offs = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %59, i32 0, i32 7, !dbg !2502
  %60 = load i32, i32* %current_audio_data_offs, align 8, !dbg !2502
  %cmp51 = icmp eq i32 %60, 0, !dbg !2503
  br i1 %cmp51, label %if.then53, label %if.end54, !dbg !2504

if.then53:                                        ; preds = %if.end50
  store i32 -5, i32* %retval, align 4, !dbg !2505
  br label %return, !dbg !2505

if.end54:                                         ; preds = %if.end50
  %61 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2506
  %62 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2507
  %current_frame_offs55 = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %62, i32 0, i32 3, !dbg !2508
  %63 = load i32, i32* %current_frame_offs55, align 4, !dbg !2508
  %64 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2509
  %current_audio_data_offs56 = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %64, i32 0, i32 7, !dbg !2510
  %65 = load i32, i32* %current_audio_data_offs56, align 8, !dbg !2510
  %add57 = add i32 %63, %65, !dbg !2511
  %conv58 = zext i32 %add57 to i64, !dbg !2507
  %call59 = call i64 @avio_seek(%struct.AVIOContext* %61, i64 %conv58, i32 0), !dbg !2512
  %66 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2513
  %67 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2514
  %68 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2515
  %current_audio_data_size = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %68, i32 0, i32 6, !dbg !2516
  %69 = load i32, i32* %current_audio_data_size, align 4, !dbg !2516
  %call60 = call i32 @av_get_packet(%struct.AVIOContext* %66, %struct.AVPacket* %67, i32 %69), !dbg !2517
  store i32 %call60, i32* %rc, align 4, !dbg !2518
  %70 = load i32, i32* %rc, align 4, !dbg !2519
  %cmp61 = icmp slt i32 %70, 0, !dbg !2521
  br i1 %cmp61, label %if.then63, label %if.end64, !dbg !2522

if.then63:                                        ; preds = %if.end54
  %71 = load i32, i32* %rc, align 4, !dbg !2523
  store i32 %71, i32* %retval, align 4, !dbg !2524
  br label %return, !dbg !2524

if.end64:                                         ; preds = %if.end54
  %72 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2525
  %audio_stream_index = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %72, i32 0, i32 0, !dbg !2526
  %73 = load i32, i32* %audio_stream_index, align 8, !dbg !2526
  %74 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2527
  %stream_index65 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %74, i32 0, i32 5, !dbg !2528
  store i32 %73, i32* %stream_index65, align 4, !dbg !2529
  %75 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2530
  %current_frame_pts66 = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %75, i32 0, i32 2, !dbg !2531
  %76 = load i32, i32* %current_frame_pts66, align 8, !dbg !2532
  %inc = add nsw i32 %76, 1, !dbg !2532
  store i32 %inc, i32* %current_frame_pts66, align 8, !dbg !2532
  %77 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2533
  %audio_buffer_full67 = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %77, i32 0, i32 12, !dbg !2534
  store i32 0, i32* %audio_buffer_full67, align 8, !dbg !2535
  store i32 0, i32* %retval, align 4, !dbg !2536
  br label %return, !dbg !2536

return:                                           ; preds = %if.end64, %if.then63, %if.then53, %if.end46, %if.then29, %if.then11, %if.then3
  %78 = load i32, i32* %retval, align 4, !dbg !2537
  ret i32 %78, !dbg !2537
}

; Function Attrs: nounwind uwtable
define internal i32 @seq_read_close(%struct.AVFormatContext* %s) #0 !dbg !2538 {
entry:
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %i = alloca i32, align 4
  %seq = alloca %struct.SeqDemuxContext*, align 8
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2539, metadata !2143), !dbg !2540
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2541, metadata !2143), !dbg !2542
  call void @llvm.dbg.declare(metadata %struct.SeqDemuxContext** %seq, metadata !2543, metadata !2143), !dbg !2544
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2545
  %priv_data = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 3, !dbg !2546
  %1 = load i8*, i8** %priv_data, align 8, !dbg !2546
  %2 = bitcast i8* %1 to %struct.SeqDemuxContext*, !dbg !2545
  store %struct.SeqDemuxContext* %2, %struct.SeqDemuxContext** %seq, align 8, !dbg !2544
  store i32 0, i32* %i, align 4, !dbg !2547
  br label %for.cond, !dbg !2549

for.cond:                                         ; preds = %for.inc, %entry
  %3 = load i32, i32* %i, align 4, !dbg !2550
  %cmp = icmp slt i32 %3, 30, !dbg !2553
  br i1 %cmp, label %for.body, label %for.end, !dbg !2554

for.body:                                         ; preds = %for.cond
  %4 = load i32, i32* %i, align 4, !dbg !2555
  %idxprom = sext i32 %4 to i64, !dbg !2556
  %5 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq, align 8, !dbg !2556
  %frame_buffers = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %5, i32 0, i32 4, !dbg !2557
  %arrayidx = getelementptr inbounds [30 x %struct.TiertexSeqFrameBuffer], [30 x %struct.TiertexSeqFrameBuffer]* %frame_buffers, i64 0, i64 %idxprom, !dbg !2556
  %data = getelementptr inbounds %struct.TiertexSeqFrameBuffer, %struct.TiertexSeqFrameBuffer* %arrayidx, i32 0, i32 2, !dbg !2558
  %6 = bitcast i8** %data to i8*, !dbg !2559
  call void @av_freep(i8* %6), !dbg !2560
  br label %for.inc, !dbg !2560

for.inc:                                          ; preds = %for.body
  %7 = load i32, i32* %i, align 4, !dbg !2561
  %inc = add nsw i32 %7, 1, !dbg !2561
  store i32 %inc, i32* %i, align 4, !dbg !2561
...
; Function Attrs: nounwind uwtable
define internal i32 @seq_init_frame_buffers(%struct.SeqDemuxContext* %seq, %struct.AVIOContext* %pb) #0 !dbg !2567 {
entry:
  %retval = alloca i32, align 4
  %seq.addr = alloca %struct.SeqDemuxContext*, align 8
  %pb.addr = alloca %struct.AVIOContext*, align 8
  %i = alloca i32, align 4
  %sz = alloca i32, align 4
  %seq_buffer = alloca %struct.TiertexSeqFrameBuffer*, align 8
  store %struct.SeqDemuxContext* %seq, %struct.SeqDemuxContext** %seq.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.SeqDemuxContext** %seq.addr, metadata !2570, metadata !2143), !dbg !2571
  store %struct.AVIOContext* %pb, %struct.AVIOContext** %pb.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb.addr, metadata !2572, metadata !2143), !dbg !2573
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2574, metadata !2143), !dbg !2575
  call void @llvm.dbg.declare(metadata i32* %sz, metadata !2576, metadata !2143), !dbg !2577
  call void @llvm.dbg.declare(metadata %struct.TiertexSeqFrameBuffer** %seq_buffer, metadata !2578, metadata !2143), !dbg !2580
  %0 = load %struct.AVIOContext*, %struct.AVIOContext** %pb.addr, align 8, !dbg !2581
  %call = call i64 @avio_seek(%struct.AVIOContext* %0, i64 256, i32 0), !dbg !2582
  store i32 0, i32* %i, align 4, !dbg !2583
  br label %for.cond, !dbg !2585

for.cond:                                         ; preds = %for.inc, %entry
  %1 = load i32, i32* %i, align 4, !dbg !2586
  %cmp = icmp slt i32 %1, 30, !dbg !2589
  br i1 %cmp, label %for.body, label %for.end, !dbg !2590

for.body:                                         ; preds = %for.cond
  %2 = load %struct.AVIOContext*, %struct.AVIOContext** %pb.addr, align 8, !dbg !2591
  %call1 = call i32 @avio_rl16(%struct.AVIOContext* %2), !dbg !2593
  store i32 %call1, i32* %sz, align 4, !dbg !2594
  %3 = load i32, i32* %sz, align 4, !dbg !2595
  %cmp2 = icmp eq i32 %3, 0, !dbg !2597
  br i1 %cmp2, label %if.then, label %if.else, !dbg !2598

if.then:                                          ; preds = %for.body
  br label %for.end, !dbg !2599

if.else:                                          ; preds = %for.body
  %4 = load i32, i32* %i, align 4, !dbg !2600
  %idxprom = sext i32 %4 to i64, !dbg !2602
  %5 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq.addr, align 8, !dbg !2602
  %frame_buffers = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %5, i32 0, i32 4, !dbg !2603
  %arrayidx = getelementptr inbounds [30 x %struct.TiertexSeqFrameBuffer], [30 x %struct.TiertexSeqFrameBuffer]* %frame_buffers, i64 0, i64 %idxprom, !dbg !2602
  store %struct.TiertexSeqFrameBuffer* %arrayidx, %struct.TiertexSeqFrameBuffer** %seq_buffer, align 8, !dbg !2604
  %6 = load %struct.TiertexSeqFrameBuffer*, %struct.TiertexSeqFrameBuffer** %seq_buffer, align 8, !dbg !2605
  %fill_size = getelementptr inbounds %struct.TiertexSeqFrameBuffer, %struct.TiertexSeqFrameBuffer* %6, i32 0, i32 0, !dbg !2606
  store i32 0, i32* %fill_size, align 8, !dbg !2607
  %7 = load i32, i32* %sz, align 4, !dbg !2608
  %8 = load %struct.TiertexSeqFrameBuffer*, %struct.TiertexSeqFrameBuffer** %seq_buffer, align 8, !dbg !2609
  %data_size = getelementptr inbounds %struct.TiertexSeqFrameBuffer, %struct.TiertexSeqFrameBuffer* %8, i32 0, i32 1, !dbg !2610
  store i32 %7, i32* %data_size, align 4, !dbg !2611
  %9 = load i32, i32* %sz, align 4, !dbg !2612
  %conv = sext i32 %9 to i64, !dbg !2612
  %call3 = call noalias i8* @av_malloc(i64 %conv), !dbg !2613
  %10 = load %struct.TiertexSeqFrameBuffer*, %struct.TiertexSeqFrameBuffer** %seq_buffer, align 8, !dbg !2614
  %data = getelementptr inbounds %struct.TiertexSeqFrameBuffer, %struct.TiertexSeqFrameBuffer* %10, i32 0, i32 2, !dbg !2615
  store i8* %call3, i8** %data, align 8, !dbg !2616
  %11 = load %struct.TiertexSeqFrameBuffer*, %struct.TiertexSeqFrameBuffer** %seq_buffer, align 8, !dbg !2617
  %data4 = getelementptr inbounds %struct.TiertexSeqFrameBuffer, %struct.TiertexSeqFrameBuffer* %11, i32 0, i32 2, !dbg !2619
  %12 = load i8*, i8** %data4, align 8, !dbg !2619
  %tobool = icmp ne i8* %12, null, !dbg !2617
  br i1 %tobool, label %if.end, label %if.then5, !dbg !2620
...
for.inc:                                          ; preds = %if.end6
  %13 = load i32, i32* %i, align 4, !dbg !2623
  %inc = add nsw i32 %13, 1, !dbg !2623
  store i32 %inc, i32* %i, align 4, !dbg !2623
  br label %for.cond, !dbg !2625, !llvm.loop !2626

for.end:                                          ; preds = %if.then, %for.cond
  %14 = load i32, i32* %i, align 4, !dbg !2628
  %15 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq.addr, align 8, !dbg !2629
  %frame_buffers_count = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %15, i32 0, i32 5, !dbg !2630
  store i32 %14, i32* %frame_buffers_count, align 8, !dbg !2631
  store i32 0, i32* %retval, align 4, !dbg !2632
  br label %return, !dbg !2632

return:                                           ; preds = %for.end, %if.then5
  %16 = load i32, i32* %retval, align 4, !dbg !2633
  ret i32 %16, !dbg !2633
}

; Function Attrs: nounwind uwtable
define internal i32 @seq_parse_frame_data(%struct.SeqDemuxContext* %seq, %struct.AVIOContext* %pb) #0 !dbg !2634 {
entry:
  %retval = alloca i32, align 4
  %seq.addr = alloca %struct.SeqDemuxContext*, align 8
  %pb.addr = alloca %struct.AVIOContext*, align 8
  %offset_table = alloca [4 x i32], align 16
  %buffer_num = alloca [4 x i32], align 16
  %seq_buffer = alloca %struct.TiertexSeqFrameBuffer*, align 8
  %i = alloca i32, align 4
  %e = alloca i32, align 4
  %err = alloca i32, align 4
  store %struct.SeqDemuxContext* %seq, %struct.SeqDemuxContext** %seq.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.SeqDemuxContext** %seq.addr, metadata !2635, metadata !2143), !dbg !2636
  store %struct.AVIOContext* %pb, %struct.AVIOContext** %pb.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb.addr, metadata !2637, metadata !2143), !dbg !2638
  call void @llvm.dbg.declare(metadata [4 x i32]* %offset_table, metadata !2639, metadata !2143), !dbg !2641
  call void @llvm.dbg.declare(metadata [4 x i32]* %buffer_num, metadata !2642, metadata !2143), !dbg !2643
  call void @llvm.dbg.declare(metadata %struct.TiertexSeqFrameBuffer** %seq_buffer, metadata !2644, metadata !2143), !dbg !2645
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2646, metadata !2143), !dbg !2647
  call void @llvm.dbg.declare(metadata i32* %e, metadata !2648, metadata !2143), !dbg !2649
  call void @llvm.dbg.declare(metadata i32* %err, metadata !2650, metadata !2143), !dbg !2651
  %0 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq.addr, align 8, !dbg !2652
  %current_frame_offs = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %0, i32 0, i32 3, !dbg !2653
  %1 = load i32, i32* %current_frame_offs, align 4, !dbg !2654
  %add = add nsw i32 %1, 6144, !dbg !2654
  store i32 %add, i32* %current_frame_offs, align 4, !dbg !2654
  %2 = load %struct.AVIOContext*, %struct.AVIOContext** %pb.addr, align 8, !dbg !2655
  %3 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq.addr, align 8, !dbg !2656
  %current_frame_offs1 = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %3, i32 0, i32 3, !dbg !2657
  %4 = load i32, i32* %current_frame_offs1, align 4, !dbg !2657
  %conv = sext i32 %4 to i64, !dbg !2656
  %call = call i64 @avio_seek(%struct.AVIOContext* %2, i64 %conv, i32 0), !dbg !2658
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb.addr, align 8, !dbg !2659
  %call2 = call i32 @avio_rl16(%struct.AVIOContext* %5), !dbg !2660
  %6 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq.addr, align 8, !dbg !2661
  %current_audio_data_offs = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %6, i32 0, i32 7, !dbg !2662
  store i32 %call2, i32* %current_audio_data_offs, align 8, !dbg !2663
  %7 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq.addr, align 8, !dbg !2664
  %current_audio_data_offs3 = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %7, i32 0, i32 7, !dbg !2666
  %8 = load i32, i32* %current_audio_data_offs3, align 8, !dbg !2666
  %tobool = icmp ne i32 %8, 0, !dbg !2664
  br i1 %tobool, label %if.then, label %if.else, !dbg !2667

if.then:                                          ; preds = %entry
  %9 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq.addr, align 8, !dbg !2668
  %current_audio_data_size = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %9, i32 0, i32 6, !dbg !2670
  store i32 1764, i32* %current_audio_data_size, align 4, !dbg !2671
  br label %if.end, !dbg !2672

if.else:                                          ; preds = %entry
  %10 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq.addr, align 8, !dbg !2673
  %current_audio_data_size4 = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %10, i32 0, i32 6, !dbg !2675
  store i32 0, i32* %current_audio_data_size4, align 4, !dbg !2676
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %11 = load %struct.AVIOContext*, %struct.AVIOContext** %pb.addr, align 8, !dbg !2677
  %call5 = call i32 @avio_rl16(%struct.AVIOContext* %11), !dbg !2678
  %12 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq.addr, align 8, !dbg !2679
  %current_pal_data_offs = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %12, i32 0, i32 9, !dbg !2680
  store i32 %call5, i32* %current_pal_data_offs, align 8, !dbg !2681
  %13 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq.addr, align 8, !dbg !2682
  %current_pal_data_offs6 = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %13, i32 0, i32 9, !dbg !2684
  %14 = load i32, i32* %current_pal_data_offs6, align 8, !dbg !2684
  %tobool7 = icmp ne i32 %14, 0, !dbg !2682
  br i1 %tobool7, label %if.then8, label %if.else9, !dbg !2685

if.then8:                                         ; preds = %if.end
  %15 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq.addr, align 8, !dbg !2686
  %current_pal_data_size = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %15, i32 0, i32 8, !dbg !2688
  store i32 768, i32* %current_pal_data_size, align 4, !dbg !2689
  br label %if.end11, !dbg !2690

if.else9:                                         ; preds = %if.end
  %16 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq.addr, align 8, !dbg !2691
  %current_pal_data_size10 = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %16, i32 0, i32 8, !dbg !2693
  store i32 0, i32* %current_pal_data_size10, align 4, !dbg !2694
  br label %if.end11
...
for.cond:                                         ; preds = %for.inc, %if.end11
  %17 = load i32, i32* %i, align 4, !dbg !2698
  %cmp = icmp slt i32 %17, 4, !dbg !2701
  br i1 %cmp, label %for.body, label %for.end, !dbg !2702

for.body:                                         ; preds = %for.cond
  %18 = load %struct.AVIOContext*, %struct.AVIOContext** %pb.addr, align 8, !dbg !2703
  %call13 = call i32 @avio_r8(%struct.AVIOContext* %18), !dbg !2704
  %19 = load i32, i32* %i, align 4, !dbg !2705
  %idxprom = sext i32 %19 to i64, !dbg !2706
  %arrayidx = getelementptr inbounds [4 x i32], [4 x i32]* %buffer_num, i64 0, i64 %idxprom, !dbg !2706
  store i32 %call13, i32* %arrayidx, align 4, !dbg !2707
  br label %for.inc, !dbg !2706

for.inc:                                          ; preds = %for.body
  %20 = load i32, i32* %i, align 4, !dbg !2708
  %inc = add nsw i32 %20, 1, !dbg !2708
  store i32 %inc, i32* %i, align 4, !dbg !2708
  br label %for.cond, !dbg !2710, !llvm.loop !2711

for.end:                                          ; preds = %for.cond
  store i32 0, i32* %i, align 4, !dbg !2713
  br label %for.cond14, !dbg !2715

for.cond14:                                       ; preds = %for.inc21, %for.end
  %21 = load i32, i32* %i, align 4, !dbg !2716
  %cmp15 = icmp slt i32 %21, 4, !dbg !2719
  br i1 %cmp15, label %for.body17, label %for.end23, !dbg !2720

for.body17:                                       ; preds = %for.cond14
  %22 = load %struct.AVIOContext*, %struct.AVIOContext** %pb.addr, align 8, !dbg !2721
  %call18 = call i32 @avio_rl16(%struct.AVIOContext* %22), !dbg !2722
  %23 = load i32, i32* %i, align 4, !dbg !2723
  %idxprom19 = sext i32 %23 to i64, !dbg !2724
  %arrayidx20 = getelementptr inbounds [4 x i32], [4 x i32]* %offset_table, i64 0, i64 %idxprom19, !dbg !2724
  store i32 %call18, i32* %arrayidx20, align 4, !dbg !2725
  br label %for.inc21, !dbg !2724

for.inc21:                                        ; preds = %for.body17
  %24 = load i32, i32* %i, align 4, !dbg !2726
  %inc22 = add nsw i32 %24, 1, !dbg !2726
  store i32 %inc22, i32* %i, align 4, !dbg !2726
  br label %for.cond14, !dbg !2728, !llvm.loop !2729
...
for.cond24:                                       ; preds = %for.inc58, %for.end23
  %25 = load i32, i32* %i, align 4, !dbg !2734
  %cmp25 = icmp slt i32 %25, 3, !dbg !2737
  br i1 %cmp25, label %for.body27, label %for.end60, !dbg !2738

for.body27:                                       ; preds = %for.cond24
  %26 = load i32, i32* %i, align 4, !dbg !2739
  %idxprom28 = sext i32 %26 to i64, !dbg !2742
  %arrayidx29 = getelementptr inbounds [4 x i32], [4 x i32]* %offset_table, i64 0, i64 %idxprom28, !dbg !2742
  %27 = load i32, i32* %arrayidx29, align 4, !dbg !2742
  %tobool30 = icmp ne i32 %27, 0, !dbg !2742
  br i1 %tobool30, label %if.then31, label %if.end57, !dbg !2743

if.then31:                                        ; preds = %for.body27
  %28 = load i32, i32* %i, align 4, !dbg !2744
  %add32 = add nsw i32 %28, 1, !dbg !2747
  store i32 %add32, i32* %e, align 4, !dbg !2748
  br label %for.cond33, !dbg !2749

for.cond33:                                       ; preds = %for.inc41, %if.then31
  %29 = load i32, i32* %e, align 4, !dbg !2750
  %cmp34 = icmp slt i32 %29, 3, !dbg !2753
  br i1 %cmp34, label %land.rhs, label %land.end, !dbg !2754

land.rhs:                                         ; preds = %for.cond33
  %30 = load i32, i32* %e, align 4, !dbg !2755
  %idxprom36 = sext i32 %30 to i64, !dbg !2757
  %arrayidx37 = getelementptr inbounds [4 x i32], [4 x i32]* %offset_table, i64 0, i64 %idxprom36, !dbg !2757
  %31 = load i32, i32* %arrayidx37, align 4, !dbg !2757
  %cmp38 = icmp eq i32 %31, 0, !dbg !2758
  br label %land.end

land.end:                                         ; preds = %land.rhs, %for.cond33
  %32 = phi i1 [ false, %for.cond33 ], [ %cmp38, %land.rhs ]
  br i1 %32, label %for.body40, label %for.end43, !dbg !2759

for.body40:                                       ; preds = %land.end
  br label %for.inc41, !dbg !2761

for.inc41:                                        ; preds = %for.body40
  %33 = load i32, i32* %e, align 4, !dbg !2763
  %inc42 = add nsw i32 %33, 1, !dbg !2763
  store i32 %inc42, i32* %e, align 4, !dbg !2763
  br label %for.cond33, !dbg !2765, !llvm.loop !2766

for.end43:                                        ; preds = %land.end
  %34 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq.addr, align 8, !dbg !2768
  %35 = load %struct.AVIOContext*, %struct.AVIOContext** %pb.addr, align 8, !dbg !2769
  %36 = load i32, i32* %i, align 4, !dbg !2770
  %add44 = add nsw i32 1, %36, !dbg !2771
  %idxprom45 = sext i32 %add44 to i64, !dbg !2772
  %arrayidx46 = getelementptr inbounds [4 x i32], [4 x i32]* %buffer_num, i64 0, i64 %idxprom45, !dbg !2772
  %37 = load i32, i32* %arrayidx46, align 4, !dbg !2772
  %38 = load i32, i32* %i, align 4, !dbg !2773
  %idxprom47 = sext i32 %38 to i64, !dbg !2774
  %arrayidx48 = getelementptr inbounds [4 x i32], [4 x i32]* %offset_table, i64 0, i64 %idxprom47, !dbg !2774
  %39 = load i32, i32* %arrayidx48, align 4, !dbg !2774
  %40 = load i32, i32* %e, align 4, !dbg !2775
  %idxprom49 = sext i32 %40 to i64, !dbg !2776
  %arrayidx50 = getelementptr inbounds [4 x i32], [4 x i32]* %offset_table, i64 0, i64 %idxprom49, !dbg !2776
  %41 = load i32, i32* %arrayidx50, align 4, !dbg !2776
  %42 = load i32, i32* %i, align 4, !dbg !2777
  %idxprom51 = sext i32 %42 to i64, !dbg !2778
  %arrayidx52 = getelementptr inbounds [4 x i32], [4 x i32]* %offset_table, i64 0, i64 %idxprom51, !dbg !2778
  %43 = load i32, i32* %arrayidx52, align 4, !dbg !2778
  %sub = sub i32 %41, %43, !dbg !2779
  %call53 = call i32 @seq_fill_buffer(%struct.SeqDemuxContext* %34, %struct.AVIOContext* %35, i32 %37, i32 %39, i32 %sub), !dbg !2780
  store i32 %call53, i32* %err, align 4, !dbg !2781
  %44 = load i32, i32* %err, align 4, !dbg !2782
  %tobool54 = icmp ne i32 %44, 0, !dbg !2782
  br i1 %tobool54, label %if.then55, label %if.end56, !dbg !2784

if.then55:                                        ; preds = %for.end43
  %45 = load i32, i32* %err, align 4, !dbg !2785
  store i32 %45, i32* %retval, align 4, !dbg !2786
  br label %return, !dbg !2786

if.end56:                                         ; preds = %for.end43
  br label %if.end57, !dbg !2787

if.end57:                                         ; preds = %if.end56, %for.body27
  br label %for.inc58, !dbg !2788

for.inc58:                                        ; preds = %if.end57
  %46 = load i32, i32* %i, align 4, !dbg !2789
  %inc59 = add nsw i32 %46, 1, !dbg !2789
  store i32 %inc59, i32* %i, align 4, !dbg !2789
  br label %for.cond24, !dbg !2791, !llvm.loop !2792

for.end60:                                        ; preds = %for.cond24
  %arrayidx61 = getelementptr inbounds [4 x i32], [4 x i32]* %buffer_num, i64 0, i64 0, !dbg !2794
  %47 = load i32, i32* %arrayidx61, align 16, !dbg !2794
  %cmp62 = icmp ne i32 %47, 255, !dbg !2796
  br i1 %cmp62, label %if.then64, label %if.else74, !dbg !2797

if.then64:                                        ; preds = %for.end60
  %arrayidx65 = getelementptr inbounds [4 x i32], [4 x i32]* %buffer_num, i64 0, i64 0, !dbg !2798
  %48 = load i32, i32* %arrayidx65, align 16, !dbg !2798
  %cmp66 = icmp uge i32 %48, 30, !dbg !2801
  br i1 %cmp66, label %if.then68, label %if.end69, !dbg !2802

if.then68:                                        ; preds = %if.then64
  store i32 -1094995529, i32* %retval, align 4, !dbg !2803
  br label %return, !dbg !2803

if.end69:                                         ; preds = %if.then64
  %arrayidx70 = getelementptr inbounds [4 x i32], [4 x i32]* %buffer_num, i64 0, i64 0, !dbg !2804
  %49 = load i32, i32* %arrayidx70, align 16, !dbg !2804
  %idxprom71 = zext i32 %49 to i64, !dbg !2805
  %50 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq.addr, align 8, !dbg !2805
  %frame_buffers = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %50, i32 0, i32 4, !dbg !2806
  %arrayidx72 = getelementptr inbounds [30 x %struct.TiertexSeqFrameBuffer], [30 x %struct.TiertexSeqFrameBuffer]* %frame_buffers, i64 0, i64 %idxprom71, !dbg !2805
  store %struct.TiertexSeqFrameBuffer* %arrayidx72, %struct.TiertexSeqFrameBuffer** %seq_buffer, align 8, !dbg !2807
  %51 = load %struct.TiertexSeqFrameBuffer*, %struct.TiertexSeqFrameBuffer** %seq_buffer, align 8, !dbg !2808
  %fill_size = getelementptr inbounds %struct.TiertexSeqFrameBuffer, %struct.TiertexSeqFrameBuffer* %51, i32 0, i32 0, !dbg !2809
  %52 = load i32, i32* %fill_size, align 8, !dbg !2809
  %53 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq.addr, align 8, !dbg !2810
  %current_video_data_size = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %53, i32 0, i32 10, !dbg !2811
  store i32 %52, i32* %current_video_data_size, align 4, !dbg !2812
  %54 = load %struct.TiertexSeqFrameBuffer*, %struct.TiertexSeqFrameBuffer** %seq_buffer, align 8, !dbg !2813
  %data = getelementptr inbounds %struct.TiertexSeqFrameBuffer, %struct.TiertexSeqFrameBuffer* %54, i32 0, i32 2, !dbg !2814
  %55 = load i8*, i8** %data, align 8, !dbg !2814
  %56 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq.addr, align 8, !dbg !2815
  %current_video_data_ptr = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %56, i32 0, i32 11, !dbg !2816
  store i8* %55, i8** %current_video_data_ptr, align 8, !dbg !2817
  %57 = load %struct.TiertexSeqFrameBuffer*, %struct.TiertexSeqFrameBuffer** %seq_buffer, align 8, !dbg !2818
  %fill_size73 = getelementptr inbounds %struct.TiertexSeqFrameBuffer, %struct.TiertexSeqFrameBuffer* %57, i32 0, i32 0, !dbg !2819
  store i32 0, i32* %fill_size73, align 8, !dbg !2820
  br label %if.end77, !dbg !2821

if.else74:                                        ; preds = %for.end60
  %58 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq.addr, align 8, !dbg !2822
  %current_video_data_size75 = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %58, i32 0, i32 10, !dbg !2824
  store i32 0, i32* %current_video_data_size75, align 4, !dbg !2825
  %59 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq.addr, align 8, !dbg !2826
  %current_video_data_ptr76 = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %59, i32 0, i32 11, !dbg !2827
  store i8* null, i8** %current_video_data_ptr76, align 8, !dbg !2828
  br label %if.end77

if.end77:                                         ; preds = %if.else74, %if.end69
  store i32 0, i32* %retval, align 4, !dbg !2829
  br label %return, !dbg !2829

return:                                           ; preds = %if.end77, %if.then68, %if.then55
  %60 = load i32, i32* %retval, align 4, !dbg !2830
  ret i32 %60, !dbg !2830
}
...
; Function Attrs: nounwind uwtable
define internal i32 @seq_fill_buffer(%struct.SeqDemuxContext* %seq, %struct.AVIOContext* %pb, i32 %buffer_num, i32 %data_offs, i32 %data_size) #0 !dbg !2831 {
entry:
  %retval = alloca i32, align 4
  %seq.addr = alloca %struct.SeqDemuxContext*, align 8
  %pb.addr = alloca %struct.AVIOContext*, align 8
  %buffer_num.addr = alloca i32, align 4
  %data_offs.addr = alloca i32, align 4
  %data_size.addr = alloca i32, align 4
  %seq_buffer = alloca %struct.TiertexSeqFrameBuffer*, align 8
  store %struct.SeqDemuxContext* %seq, %struct.SeqDemuxContext** %seq.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.SeqDemuxContext** %seq.addr, metadata !2834, metadata !2143), !dbg !2835
  store %struct.AVIOContext* %pb, %struct.AVIOContext** %pb.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb.addr, metadata !2836, metadata !2143), !dbg !2837
  store i32 %buffer_num, i32* %buffer_num.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %buffer_num.addr, metadata !2838, metadata !2143), !dbg !2839
  store i32 %data_offs, i32* %data_offs.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %data_offs.addr, metadata !2840, metadata !2143), !dbg !2841
  store i32 %data_size, i32* %data_size.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %data_size.addr, metadata !2842, metadata !2143), !dbg !2843
  call void @llvm.dbg.declare(metadata %struct.TiertexSeqFrameBuffer** %seq_buffer, metadata !2844, metadata !2143), !dbg !2845
  %0 = load i32, i32* %buffer_num.addr, align 4, !dbg !2846
  %cmp = icmp sge i32 %0, 30, !dbg !2848
  br i1 %cmp, label %if.then, label %if.end, !dbg !2849

if.then:                                          ; preds = %entry
  store i32 -1094995529, i32* %retval, align 4, !dbg !2850
  br label %return, !dbg !2850

if.end:                                           ; preds = %entry
  %1 = load i32, i32* %buffer_num.addr, align 4, !dbg !2851
  %idxprom = sext i32 %1 to i64, !dbg !2852
  %2 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq.addr, align 8, !dbg !2852
  %frame_buffers = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %2, i32 0, i32 4, !dbg !2853
  %arrayidx = getelementptr inbounds [30 x %struct.TiertexSeqFrameBuffer], [30 x %struct.TiertexSeqFrameBuffer]* %frame_buffers, i64 0, i64 %idxprom, !dbg !2852
  store %struct.TiertexSeqFrameBuffer* %arrayidx, %struct.TiertexSeqFrameBuffer** %seq_buffer, align 8, !dbg !2854
  %3 = load %struct.TiertexSeqFrameBuffer*, %struct.TiertexSeqFrameBuffer** %seq_buffer, align 8, !dbg !2855
  %fill_size = getelementptr inbounds %struct.TiertexSeqFrameBuffer, %struct.TiertexSeqFrameBuffer* %3, i32 0, i32 0, !dbg !2857
  %4 = load i32, i32* %fill_size, align 8, !dbg !2857
  %5 = load i32, i32* %data_size.addr, align 4, !dbg !2858
  %add = add nsw i32 %4, %5, !dbg !2859
  %6 = load %struct.TiertexSeqFrameBuffer*, %struct.TiertexSeqFrameBuffer** %seq_buffer, align 8, !dbg !2860
  %data_size1 = getelementptr inbounds %struct.TiertexSeqFrameBuffer, %struct.TiertexSeqFrameBuffer* %6, i32 0, i32 1, !dbg !2861
  %7 = load i32, i32* %data_size1, align 4, !dbg !2861
  %cmp2 = icmp sgt i32 %add, %7, !dbg !2862
  br i1 %cmp2, label %if.then4, label %lor.lhs.false, !dbg !2863

lor.lhs.false:                                    ; preds = %if.end
  %8 = load i32, i32* %data_size.addr, align 4, !dbg !2864
  %cmp3 = icmp sle i32 %8, 0, !dbg !2866
  br i1 %cmp3, label %if.then4, label %if.end5, !dbg !2867
...
if.end5:                                          ; preds = %lor.lhs.false
  %9 = load %struct.AVIOContext*, %struct.AVIOContext** %pb.addr, align 8, !dbg !2869
  %10 = load %struct.SeqDemuxContext*, %struct.SeqDemuxContext** %seq.addr, align 8, !dbg !2870
  %current_frame_offs = getelementptr inbounds %struct.SeqDemuxContext, %struct.SeqDemuxContext* %10, i32 0, i32 3, !dbg !2871
  %11 = load i32, i32* %current_frame_offs, align 4, !dbg !2871
  %12 = load i32, i32* %data_offs.addr, align 4, !dbg !2872
  %add6 = add i32 %11, %12, !dbg !2873
  %conv = zext i32 %add6 to i64, !dbg !2870
  %call = call i64 @avio_seek(%struct.AVIOContext* %9, i64 %conv, i32 0), !dbg !2874
  %13 = load %struct.AVIOContext*, %struct.AVIOContext** %pb.addr, align 8, !dbg !2875
  %14 = load %struct.TiertexSeqFrameBuffer*, %struct.TiertexSeqFrameBuffer** %seq_buffer, align 8, !dbg !2877
  %data = getelementptr inbounds %struct.TiertexSeqFrameBuffer, %struct.TiertexSeqFrameBuffer* %14, i32 0, i32 2, !dbg !2878
  %15 = load i8*, i8** %data, align 8, !dbg !2878
  %16 = load %struct.TiertexSeqFrameBuffer*, %struct.TiertexSeqFrameBuffer** %seq_buffer, align 8, !dbg !2879
  %fill_size7 = getelementptr inbounds %struct.TiertexSeqFrameBuffer, %struct.TiertexSeqFrameBuffer* %16, i32 0, i32 0, !dbg !2880
  %17 = load i32, i32* %fill_size7, align 8, !dbg !2880
  %idx.ext = sext i32 %17 to i64, !dbg !2881
  %add.ptr = getelementptr inbounds i8, i8* %15, i64 %idx.ext, !dbg !2881
  %18 = load i32, i32* %data_size.addr, align 4, !dbg !2882
  %call8 = call i32 @avio_read(%struct.AVIOContext* %13, i8* %add.ptr, i32 %18), !dbg !2883
  %19 = load i32, i32* %data_size.addr, align 4, !dbg !2884
  %cmp9 = icmp ne i32 %call8, %19, !dbg !2885
  br i1 %cmp9, label %if.then11, label %if.end12, !dbg !2886

if.then11:                                        ; preds = %if.end5
  store i32 -5, i32* %retval, align 4, !dbg !2887
  br label %return, !dbg !2887

if.end12:                                         ; preds = %if.end5
  %20 = load i32, i32* %data_size.addr, align 4, !dbg !2888
  %21 = load %struct.TiertexSeqFrameBuffer*, %struct.TiertexSeqFrameBuffer** %seq_buffer, align 8, !dbg !2889
  %fill_size13 = getelementptr inbounds %struct.TiertexSeqFrameBuffer, %struct.TiertexSeqFrameBuffer* %21, i32 0, i32 0, !dbg !2890
  %22 = load i32, i32* %fill_size13, align 8, !dbg !2891
  %add14 = add nsw i32 %22, %20, !dbg !2891
  store i32 %add14, i32* %fill_size13, align 8, !dbg !2891
  store i32 0, i32* %retval, align 4, !dbg !2892
  br label %return, !dbg !2892

return:                                           ; preds = %if.end12, %if.then11, %if.then4, %if.then
  %23 = load i32, i32* %retval, align 4, !dbg !2893
  ret i32 %23, !dbg !2893
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--tiertexseq.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!919 = !{!920}
!920 = distinct !DIGlobalVariable(name: "ff_tiertexseq_demuxer", scope: !0, file: !921, line: 309, type: !922, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_tiertexseq_demuxer)
!921 = !DIFile(filename: "libavformat/tiertexseq.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2140 = distinct !DISubprogram(name: "seq_probe", scope: !921, file: !921, line: 63, type: !991, isLocal: true, isDefinition: true, scopeLine: 64, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2141 = !{}
!2142 = !DILocalVariable(name: "p", arg: 1, scope: !2140, file: !921, line: 63, type: !993)
!2143 = !DIExpression()
!2144 = !DILocation(line: 63, column: 35, scope: !2140)
!2145 = !DILocalVariable(name: "i", scope: !2140, file: !921, line: 65, type: !917)
!2146 = !DILocation(line: 65, column: 9, scope: !2140)
!2147 = !DILocation(line: 67, column: 9, scope: !2148)
!2148 = distinct !DILexicalBlock(scope: !2140, file: !921, line: 67, column: 9)
!2149 = !DILocation(line: 67, column: 12, scope: !2148)
!2150 = !DILocation(line: 67, column: 21, scope: !2148)
!2151 = !DILocation(line: 67, column: 9, scope: !2140)
!2152 = !DILocation(line: 68, column: 9, scope: !2148)
!2153 = !DILocation(line: 72, column: 12, scope: !2154)
!2154 = distinct !DILexicalBlock(scope: !2140, file: !921, line: 72, column: 5)
!2155 = !DILocation(line: 72, column: 10, scope: !2154)
!2156 = !DILocation(line: 72, column: 17, scope: !2157)
!2157 = !DILexicalBlockFile(scope: !2158, file: !921, discriminator: 1)
!2158 = distinct !DILexicalBlock(scope: !2154, file: !921, line: 72, column: 5)
!2159 = !DILocation(line: 72, column: 19, scope: !2157)
!2160 = !DILocation(line: 72, column: 5, scope: !2157)
!2161 = !DILocation(line: 73, column: 20, scope: !2162)
!2162 = distinct !DILexicalBlock(scope: !2158, file: !921, line: 73, column: 13)
!2163 = !DILocation(line: 73, column: 13, scope: !2162)
!2164 = !DILocation(line: 73, column: 16, scope: !2162)
!2165 = !DILocation(line: 73, column: 13, scope: !2158)
!2166 = !DILocation(line: 74, column: 13, scope: !2162)
!2167 = !DILocation(line: 73, column: 21, scope: !2168)
!2168 = !DILexicalBlockFile(scope: !2162, file: !921, discriminator: 1)
!2169 = !DILocation(line: 72, column: 27, scope: !2170)
!2170 = !DILexicalBlockFile(scope: !2158, file: !921, discriminator: 2)
!2171 = !DILocation(line: 72, column: 5, scope: !2170)
!2172 = distinct !{!2172, !2173}
!2173 = !DILocation(line: 72, column: 5, scope: !2140)
!2174 = !DILocation(line: 76, column: 8, scope: !2175)
!2175 = distinct !DILexicalBlock(scope: !2140, file: !921, line: 76, column: 8)
!2176 = !DILocation(line: 76, column: 11, scope: !2175)
!2177 = !DILocation(line: 76, column: 19, scope: !2175)
!2178 = !DILocation(line: 76, column: 23, scope: !2175)
!2179 = !DILocation(line: 76, column: 26, scope: !2180)
!2180 = !DILexicalBlockFile(scope: !2175, file: !921, discriminator: 1)
!2181 = !DILocation(line: 76, column: 29, scope: !2180)
!2182 = !DILocation(line: 76, column: 37, scope: !2180)
!2183 = !DILocation(line: 76, column: 8, scope: !2180)
!2184 = !DILocation(line: 77, column: 9, scope: !2175)
!2185 = !DILocation(line: 80, column: 5, scope: !2140)
!2186 = !DILocation(line: 81, column: 1, scope: !2140)
!2187 = distinct !DISubprogram(name: "seq_read_header", scope: !921, file: !921, line: 185, type: !2188, isLocal: true, isDefinition: true, scopeLine: 186, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2188 = !DISubroutineType(types: !2189)
!2189 = !{!917, !2190}
!2190 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2191, size: 64, align: 64)
!2191 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1008)
!2192 = !DILocalVariable(name: "s", arg: 1, scope: !2187, file: !921, line: 185, type: !2190)
!2193 = !DILocation(line: 185, column: 45, scope: !2187)
!2194 = !DILocalVariable(name: "i", scope: !2187, file: !921, line: 187, type: !917)
!2195 = !DILocation(line: 187, column: 9, scope: !2187)
!2196 = !DILocalVariable(name: "rc", scope: !2187, file: !921, line: 187, type: !917)
!2197 = !DILocation(line: 187, column: 12, scope: !2187)
!2198 = !DILocalVariable(name: "seq", scope: !2187, file: !921, line: 188, type: !2199)
!2199 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2200, size: 64, align: 64)
!2200 = !DIDerivedType(tag: DW_TAG_typedef, name: "SeqDemuxContext", file: !921, line: 60, baseType: !2201)
!2201 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "SeqDemuxContext", file: !921, line: 46, size: 4288, align: 64, elements: !2202)
!2202 = !{!2203, !2204, !2205, !2206, !2207, !2217, !2218, !2219, !2220, !2221, !2222, !2223, !2224}
!2203 = !DIDerivedType(tag: DW_TAG_member, name: "audio_stream_index", scope: !2201, file: !921, line: 47, baseType: !917, size: 32, align: 32)
!2204 = !DIDerivedType(tag: DW_TAG_member, name: "video_stream_index", scope: !2201, file: !921, line: 48, baseType: !917, size: 32, align: 32, offset: 32)
!2205 = !DIDerivedType(tag: DW_TAG_member, name: "current_frame_pts", scope: !2201, file: !921, line: 49, baseType: !917, size: 32, align: 32, offset: 64)
!2206 = !DIDerivedType(tag: DW_TAG_member, name: "current_frame_offs", scope: !2201, file: !921, line: 50, baseType: !917, size: 32, align: 32, offset: 96)
!2207 = !DIDerivedType(tag: DW_TAG_member, name: "frame_buffers", scope: !2201, file: !921, line: 51, baseType: !2208, size: 3840, align: 64, offset: 128)
!2208 = !DICompositeType(tag: DW_TAG_array_type, baseType: !2209, size: 3840, align: 64, elements: !2215)
!2209 = !DIDerivedType(tag: DW_TAG_typedef, name: "TiertexSeqFrameBuffer", file: !921, line: 44, baseType: !2210)
!2210 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "TiertexSeqFrameBuffer", file: !921, line: 40, size: 128, align: 64, elements: !2211)
!2211 = !{!2212, !2213, !2214}
!2212 = !DIDerivedType(tag: DW_TAG_member, name: "fill_size", scope: !2210, file: !921, line: 41, baseType: !917, size: 32, align: 32)
!2213 = !DIDerivedType(tag: DW_TAG_member, name: "data_size", scope: !2210, file: !921, line: 42, baseType: !917, size: 32, align: 32, offset: 32)
!2214 = !DIDerivedType(tag: DW_TAG_member, name: "data", scope: !2210, file: !921, line: 43, baseType: !999, size: 64, align: 64, offset: 64)
!2215 = !{!2216}
!2216 = !DISubrange(count: 30)
!2217 = !DIDerivedType(tag: DW_TAG_member, name: "frame_buffers_count", scope: !2201, file: !921, line: 52, baseType: !917, size: 32, align: 32, offset: 3968)
!2218 = !DIDerivedType(tag: DW_TAG_member, name: "current_audio_data_size", scope: !2201, file: !921, line: 53, baseType: !918, size: 32, align: 32, offset: 4000)
!2219 = !DIDerivedType(tag: DW_TAG_member, name: "current_audio_data_offs", scope: !2201, file: !921, line: 54, baseType: !918, size: 32, align: 32, offset: 4032)
!2220 = !DIDerivedType(tag: DW_TAG_member, name: "current_pal_data_size", scope: !2201, file: !921, line: 55, baseType: !918, size: 32, align: 32, offset: 4064)
!2221 = !DIDerivedType(tag: DW_TAG_member, name: "current_pal_data_offs", scope: !2201, file: !921, line: 56, baseType: !918, size: 32, align: 32, offset: 4096)
!2222 = !DIDerivedType(tag: DW_TAG_member, name: "current_video_data_size", scope: !2201, file: !921, line: 57, baseType: !918, size: 32, align: 32, offset: 4128)
!2223 = !DIDerivedType(tag: DW_TAG_member, name: "current_video_data_ptr", scope: !2201, file: !921, line: 58, baseType: !999, size: 64, align: 64, offset: 4160)
!2224 = !DIDerivedType(tag: DW_TAG_member, name: "audio_buffer_full", scope: !2201, file: !921, line: 59, baseType: !917, size: 32, align: 32, offset: 4224)
!2225 = !DILocation(line: 188, column: 22, scope: !2187)
!2226 = !DILocation(line: 188, column: 28, scope: !2187)
!2227 = !DILocation(line: 188, column: 31, scope: !2187)
!2228 = !DILocalVariable(name: "pb", scope: !2187, file: !921, line: 189, type: !1215)
!2229 = !DILocation(line: 189, column: 18, scope: !2187)
!2230 = !DILocation(line: 189, column: 23, scope: !2187)
!2231 = !DILocation(line: 189, column: 26, scope: !2187)
!2232 = !DILocalVariable(name: "st", scope: !2187, file: !921, line: 190, type: !1283)
!2233 = !DILocation(line: 190, column: 15, scope: !2187)
!2234 = !DILocation(line: 193, column: 33, scope: !2187)
!2235 = !DILocation(line: 193, column: 38, scope: !2187)
!2236 = !DILocation(line: 193, column: 10, scope: !2187)
!2237 = !DILocation(line: 193, column: 8, scope: !2187)
!2238 = !DILocation(line: 194, column: 9, scope: !2239)
!2239 = distinct !DILexicalBlock(scope: !2187, file: !921, line: 194, column: 9)
!2240 = !DILocation(line: 194, column: 9, scope: !2187)
!2241 = !DILocation(line: 195, column: 16, scope: !2239)
!2242 = !DILocation(line: 195, column: 9, scope: !2239)
!2243 = !DILocation(line: 197, column: 5, scope: !2187)
!2244 = !DILocation(line: 197, column: 10, scope: !2187)
!2245 = !DILocation(line: 197, column: 29, scope: !2187)
!2246 = !DILocation(line: 200, column: 12, scope: !2247)
!2247 = distinct !DILexicalBlock(scope: !2187, file: !921, line: 200, column: 5)
!2248 = !DILocation(line: 200, column: 10, scope: !2247)
!2249 = !DILocation(line: 200, column: 17, scope: !2250)
!2250 = !DILexicalBlockFile(scope: !2251, file: !921, discriminator: 1)
!2251 = distinct !DILexicalBlock(scope: !2247, file: !921, line: 200, column: 5)
!2252 = !DILocation(line: 200, column: 19, scope: !2250)
!2253 = !DILocation(line: 200, column: 5, scope: !2250)
!2254 = !DILocation(line: 201, column: 35, scope: !2255)
!2255 = distinct !DILexicalBlock(scope: !2251, file: !921, line: 200, column: 32)
!2256 = !DILocation(line: 201, column: 40, scope: !2255)
!2257 = !DILocation(line: 201, column: 14, scope: !2255)
!2258 = !DILocation(line: 201, column: 12, scope: !2255)
!2259 = !DILocation(line: 202, column: 13, scope: !2260)
!2260 = distinct !DILexicalBlock(scope: !2255, file: !921, line: 202, column: 13)
!2261 = !DILocation(line: 202, column: 13, scope: !2255)
!2262 = !DILocation(line: 203, column: 20, scope: !2260)
!2263 = !DILocation(line: 203, column: 13, scope: !2260)
!2264 = !DILocation(line: 204, column: 5, scope: !2255)
!2265 = !DILocation(line: 200, column: 28, scope: !2266)
!2266 = !DILexicalBlockFile(scope: !2251, file: !921, discriminator: 2)
!2267 = !DILocation(line: 200, column: 5, scope: !2266)
!2268 = distinct !{!2268, !2269}
!2269 = !DILocation(line: 200, column: 5, scope: !2187)
!2270 = !DILocation(line: 206, column: 5, scope: !2187)
!2271 = !DILocation(line: 206, column: 10, scope: !2187)
!2272 = !DILocation(line: 206, column: 28, scope: !2187)
!2273 = !DILocation(line: 208, column: 5, scope: !2187)
!2274 = !DILocation(line: 208, column: 10, scope: !2187)
!2275 = !DILocation(line: 208, column: 28, scope: !2187)
!2276 = !DILocation(line: 211, column: 30, scope: !2187)
!2277 = !DILocation(line: 211, column: 10, scope: !2187)
!2278 = !DILocation(line: 211, column: 8, scope: !2187)
!2279 = !DILocation(line: 212, column: 10, scope: !2280)
!2280 = distinct !DILexicalBlock(scope: !2187, file: !921, line: 212, column: 9)
!2281 = !DILocation(line: 212, column: 9, scope: !2187)
!2282 = !DILocation(line: 213, column: 9, scope: !2280)
!2283 = !DILocation(line: 215, column: 25, scope: !2187)
!2284 = !DILocation(line: 215, column: 5, scope: !2187)
!2285 = !DILocation(line: 216, column: 31, scope: !2187)
!2286 = !DILocation(line: 216, column: 35, scope: !2187)
!2287 = !DILocation(line: 216, column: 5, scope: !2187)
!2288 = !DILocation(line: 216, column: 10, scope: !2187)
!2289 = !DILocation(line: 216, column: 29, scope: !2187)
!2290 = !DILocation(line: 217, column: 5, scope: !2187)
!2291 = !DILocation(line: 217, column: 9, scope: !2187)
!2292 = !DILocation(line: 217, column: 19, scope: !2187)
!2293 = !DILocation(line: 217, column: 30, scope: !2187)
!2294 = !DILocation(line: 218, column: 5, scope: !2187)
!2295 = !DILocation(line: 218, column: 9, scope: !2187)
!2296 = !DILocation(line: 218, column: 19, scope: !2187)
!2297 = !DILocation(line: 218, column: 28, scope: !2187)
!2298 = !DILocation(line: 219, column: 5, scope: !2187)
!2299 = !DILocation(line: 219, column: 9, scope: !2187)
!2300 = !DILocation(line: 219, column: 19, scope: !2187)
!2301 = !DILocation(line: 219, column: 29, scope: !2187)
!2302 = !DILocation(line: 220, column: 5, scope: !2187)
!2303 = !DILocation(line: 220, column: 9, scope: !2187)
!2304 = !DILocation(line: 220, column: 19, scope: !2187)
!2305 = !DILocation(line: 220, column: 25, scope: !2187)
!2306 = !DILocation(line: 221, column: 5, scope: !2187)
!2307 = !DILocation(line: 221, column: 9, scope: !2187)
!2308 = !DILocation(line: 221, column: 19, scope: !2187)
!2309 = !DILocation(line: 221, column: 26, scope: !2187)
!2310 = !DILocation(line: 224, column: 30, scope: !2187)
!2311 = !DILocation(line: 224, column: 10, scope: !2187)
!2312 = !DILocation(line: 224, column: 8, scope: !2187)
!2313 = !DILocation(line: 225, column: 10, scope: !2314)
!2314 = distinct !DILexicalBlock(scope: !2187, file: !921, line: 225, column: 9)
!2315 = !DILocation(line: 225, column: 9, scope: !2187)
!2316 = !DILocation(line: 226, column: 9, scope: !2314)
!2317 = !DILocation(line: 228, column: 5, scope: !2187)
!2318 = !DILocation(line: 228, column: 9, scope: !2187)
!2319 = !DILocation(line: 228, column: 20, scope: !2187)
!2320 = !DILocation(line: 229, column: 25, scope: !2187)
!2321 = !DILocation(line: 229, column: 5, scope: !2187)
!2322 = !DILocation(line: 230, column: 31, scope: !2187)
!2323 = !DILocation(line: 230, column: 35, scope: !2187)
!2324 = !DILocation(line: 230, column: 5, scope: !2187)
!2325 = !DILocation(line: 230, column: 10, scope: !2187)
!2326 = !DILocation(line: 230, column: 29, scope: !2187)
!2327 = !DILocation(line: 231, column: 5, scope: !2187)
!2328 = !DILocation(line: 231, column: 9, scope: !2187)
!2329 = !DILocation(line: 231, column: 19, scope: !2187)
!2330 = !DILocation(line: 231, column: 30, scope: !2187)
!2331 = !DILocation(line: 232, column: 5, scope: !2187)
!2332 = !DILocation(line: 232, column: 9, scope: !2187)
!2333 = !DILocation(line: 232, column: 19, scope: !2187)
!2334 = !DILocation(line: 232, column: 28, scope: !2187)
!2335 = !DILocation(line: 233, column: 5, scope: !2187)
!2336 = !DILocation(line: 233, column: 9, scope: !2187)
!2337 = !DILocation(line: 233, column: 19, scope: !2187)
!2338 = !DILocation(line: 233, column: 29, scope: !2187)
!2339 = !DILocation(line: 234, column: 5, scope: !2187)
!2340 = !DILocation(line: 234, column: 9, scope: !2187)
!2341 = !DILocation(line: 234, column: 19, scope: !2187)
!2342 = !DILocation(line: 234, column: 28, scope: !2187)
!2343 = !DILocation(line: 235, column: 5, scope: !2187)
!2344 = !DILocation(line: 235, column: 9, scope: !2187)
!2345 = !DILocation(line: 235, column: 19, scope: !2187)
!2346 = !DILocation(line: 235, column: 34, scope: !2187)
!2347 = !DILocation(line: 236, column: 5, scope: !2187)
!2348 = !DILocation(line: 236, column: 9, scope: !2187)
!2349 = !DILocation(line: 236, column: 19, scope: !2187)
!2350 = !DILocation(line: 236, column: 31, scope: !2187)
!2351 = !DILocation(line: 237, column: 5, scope: !2187)
!2352 = !DILocation(line: 237, column: 9, scope: !2187)
!2353 = !DILocation(line: 237, column: 19, scope: !2187)
!2354 = !DILocation(line: 237, column: 41, scope: !2187)
!2355 = !DILocation(line: 238, column: 30, scope: !2187)
!2356 = !DILocation(line: 238, column: 34, scope: !2187)
!2357 = !DILocation(line: 238, column: 44, scope: !2187)
!2358 = !DILocation(line: 238, column: 58, scope: !2187)
!2359 = !DILocation(line: 238, column: 62, scope: !2187)
!2360 = !DILocation(line: 238, column: 72, scope: !2187)
!2361 = !DILocation(line: 238, column: 56, scope: !2187)
!2362 = !DILocation(line: 238, column: 96, scope: !2187)
!2363 = !DILocation(line: 238, column: 100, scope: !2187)
!2364 = !DILocation(line: 238, column: 110, scope: !2187)
!2365 = !DILocation(line: 238, column: 94, scope: !2187)
!2366 = !DILocation(line: 238, column: 5, scope: !2187)
!2367 = !DILocation(line: 238, column: 9, scope: !2187)
!2368 = !DILocation(line: 238, column: 19, scope: !2187)
!2369 = !DILocation(line: 238, column: 28, scope: !2187)
!2370 = !DILocation(line: 239, column: 33, scope: !2187)
!2371 = !DILocation(line: 239, column: 37, scope: !2187)
!2372 = !DILocation(line: 239, column: 47, scope: !2187)
!2373 = !DILocation(line: 239, column: 58, scope: !2187)
!2374 = !DILocation(line: 239, column: 62, scope: !2187)
!2375 = !DILocation(line: 239, column: 72, scope: !2187)
!2376 = !DILocation(line: 239, column: 56, scope: !2187)
!2377 = !DILocation(line: 239, column: 94, scope: !2187)
!2378 = !DILocation(line: 239, column: 5, scope: !2187)
!2379 = !DILocation(line: 239, column: 9, scope: !2187)
!2380 = !DILocation(line: 239, column: 19, scope: !2187)
!2381 = !DILocation(line: 239, column: 31, scope: !2187)
!2382 = !DILocation(line: 241, column: 5, scope: !2187)
!2383 = !DILocation(line: 242, column: 1, scope: !2187)
!2384 = distinct !DISubprogram(name: "seq_read_packet", scope: !921, file: !921, line: 244, type: !2385, isLocal: true, isDefinition: true, scopeLine: 245, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2385 = !DISubroutineType(types: !2386)
!2386 = !{!917, !2190, !1033}
!2387 = !DILocalVariable(name: "s", arg: 1, scope: !2384, file: !921, line: 244, type: !2190)
!2388 = !DILocation(line: 244, column: 45, scope: !2384)
!2389 = !DILocalVariable(name: "pkt", arg: 2, scope: !2384, file: !921, line: 244, type: !1033)
!2390 = !DILocation(line: 244, column: 58, scope: !2384)
!2391 = !DILocalVariable(name: "rc", scope: !2384, file: !921, line: 246, type: !917)
!2392 = !DILocation(line: 246, column: 9, scope: !2384)
!2393 = !DILocalVariable(name: "seq", scope: !2384, file: !921, line: 247, type: !2199)
!2394 = !DILocation(line: 247, column: 22, scope: !2384)
!2395 = !DILocation(line: 247, column: 28, scope: !2384)
!2396 = !DILocation(line: 247, column: 31, scope: !2384)
!2397 = !DILocalVariable(name: "pb", scope: !2384, file: !921, line: 248, type: !1215)
!2398 = !DILocation(line: 248, column: 18, scope: !2384)
!2399 = !DILocation(line: 248, column: 23, scope: !2384)
!2400 = !DILocation(line: 248, column: 26, scope: !2384)
!2401 = !DILocation(line: 250, column: 10, scope: !2402)
!2402 = distinct !DILexicalBlock(scope: !2384, file: !921, line: 250, column: 9)
!2403 = !DILocation(line: 250, column: 15, scope: !2402)
!2404 = !DILocation(line: 250, column: 9, scope: !2384)
!2405 = !DILocation(line: 251, column: 35, scope: !2406)
!2406 = distinct !DILexicalBlock(scope: !2402, file: !921, line: 250, column: 34)
!2407 = !DILocation(line: 251, column: 40, scope: !2406)
!2408 = !DILocation(line: 251, column: 14, scope: !2406)
!2409 = !DILocation(line: 251, column: 12, scope: !2406)
!2410 = !DILocation(line: 252, column: 13, scope: !2411)
!2411 = distinct !DILexicalBlock(scope: !2406, file: !921, line: 252, column: 13)
!2412 = !DILocation(line: 252, column: 13, scope: !2406)
!2413 = !DILocation(line: 253, column: 20, scope: !2411)
!2414 = !DILocation(line: 253, column: 13, scope: !2411)
!2415 = !DILocation(line: 256, column: 13, scope: !2416)
!2416 = distinct !DILexicalBlock(scope: !2406, file: !921, line: 256, column: 13)
!2417 = !DILocation(line: 256, column: 18, scope: !2416)
!2418 = !DILocation(line: 256, column: 42, scope: !2416)
!2419 = !DILocation(line: 256, column: 47, scope: !2416)
!2420 = !DILocation(line: 256, column: 40, scope: !2416)
!2421 = !DILocation(line: 256, column: 71, scope: !2416)
!2422 = !DILocation(line: 256, column: 13, scope: !2406)
!2423 = !DILocation(line: 257, column: 31, scope: !2424)
!2424 = distinct !DILexicalBlock(scope: !2425, file: !921, line: 257, column: 17)
!2425 = distinct !DILexicalBlock(scope: !2416, file: !921, line: 256, column: 77)
!2426 = !DILocation(line: 257, column: 40, scope: !2424)
!2427 = !DILocation(line: 257, column: 45, scope: !2424)
!2428 = !DILocation(line: 257, column: 38, scope: !2424)
!2429 = !DILocation(line: 257, column: 69, scope: !2424)
!2430 = !DILocation(line: 257, column: 74, scope: !2424)
!2431 = !DILocation(line: 257, column: 67, scope: !2424)
!2432 = !DILocation(line: 257, column: 17, scope: !2424)
!2433 = !DILocation(line: 257, column: 17, scope: !2425)
!2434 = !DILocation(line: 258, column: 17, scope: !2424)
!2435 = !DILocation(line: 260, column: 13, scope: !2425)
!2436 = !DILocation(line: 260, column: 18, scope: !2425)
!2437 = !DILocation(line: 260, column: 26, scope: !2425)
!2438 = !DILocation(line: 261, column: 17, scope: !2439)
!2439 = distinct !DILexicalBlock(scope: !2425, file: !921, line: 261, column: 17)
!2440 = !DILocation(line: 261, column: 22, scope: !2439)
!2441 = !DILocation(line: 261, column: 17, scope: !2425)
!2442 = !DILocation(line: 262, column: 17, scope: !2443)
!2443 = distinct !DILexicalBlock(scope: !2439, file: !921, line: 261, column: 45)
!2444 = !DILocation(line: 262, column: 22, scope: !2443)
!2445 = !DILocation(line: 262, column: 30, scope: !2443)
!2446 = !DILocation(line: 263, column: 27, scope: !2443)
!2447 = !DILocation(line: 263, column: 31, scope: !2443)
!2448 = !DILocation(line: 263, column: 36, scope: !2443)
!2449 = !DILocation(line: 263, column: 57, scope: !2443)
!2450 = !DILocation(line: 263, column: 62, scope: !2443)
!2451 = !DILocation(line: 263, column: 55, scope: !2443)
!2452 = !DILocation(line: 263, column: 17, scope: !2443)
!2453 = !DILocation(line: 264, column: 31, scope: !2454)
!2454 = distinct !DILexicalBlock(scope: !2443, file: !921, line: 264, column: 21)
!2455 = !DILocation(line: 264, column: 36, scope: !2454)
!2456 = !DILocation(line: 264, column: 41, scope: !2454)
!2457 = !DILocation(line: 264, column: 50, scope: !2454)
!2458 = !DILocation(line: 264, column: 55, scope: !2454)
!2459 = !DILocation(line: 264, column: 21, scope: !2454)
!2460 = !DILocation(line: 264, column: 81, scope: !2454)
!2461 = !DILocation(line: 264, column: 86, scope: !2454)
!2462 = !DILocation(line: 264, column: 78, scope: !2454)
!2463 = !DILocation(line: 264, column: 21, scope: !2443)
!2464 = !DILocation(line: 265, column: 21, scope: !2454)
!2465 = !DILocation(line: 266, column: 13, scope: !2443)
!2466 = !DILocation(line: 267, column: 17, scope: !2467)
!2467 = distinct !DILexicalBlock(scope: !2425, file: !921, line: 267, column: 17)
!2468 = !DILocation(line: 267, column: 22, scope: !2467)
!2469 = !DILocation(line: 267, column: 17, scope: !2425)
!2470 = !DILocation(line: 268, column: 17, scope: !2471)
!2471 = distinct !DILexicalBlock(scope: !2467, file: !921, line: 267, column: 47)
!2472 = !DILocation(line: 268, column: 22, scope: !2471)
!2473 = !DILocation(line: 268, column: 30, scope: !2471)
!2474 = !DILocation(line: 269, column: 39, scope: !2471)
!2475 = !DILocation(line: 269, column: 44, scope: !2471)
!2476 = !DILocation(line: 269, column: 37, scope: !2471)
!2477 = !DILocation(line: 269, column: 25, scope: !2471)
!2478 = !DILocation(line: 269, column: 30, scope: !2471)
!2479 = !DILocation(line: 270, column: 19, scope: !2471)
!2480 = !DILocation(line: 270, column: 24, scope: !2471)
!2481 = !DILocation(line: 271, column: 19, scope: !2471)
!2482 = !DILocation(line: 271, column: 24, scope: !2471)
!2483 = !DILocation(line: 269, column: 17, scope: !2471)
!2484 = !DILocation(line: 272, column: 13, scope: !2471)
!2485 = !DILocation(line: 273, column: 33, scope: !2425)
!2486 = !DILocation(line: 273, column: 38, scope: !2425)
!2487 = !DILocation(line: 273, column: 13, scope: !2425)
!2488 = !DILocation(line: 273, column: 18, scope: !2425)
!2489 = !DILocation(line: 273, column: 31, scope: !2425)
!2490 = !DILocation(line: 274, column: 24, scope: !2425)
!2491 = !DILocation(line: 274, column: 29, scope: !2425)
!2492 = !DILocation(line: 274, column: 13, scope: !2425)
!2493 = !DILocation(line: 274, column: 18, scope: !2425)
!2494 = !DILocation(line: 274, column: 22, scope: !2425)
!2495 = !DILocation(line: 277, column: 13, scope: !2425)
!2496 = !DILocation(line: 277, column: 18, scope: !2425)
!2497 = !DILocation(line: 277, column: 36, scope: !2425)
!2498 = !DILocation(line: 278, column: 13, scope: !2425)
!2499 = !DILocation(line: 280, column: 5, scope: !2406)
!2500 = !DILocation(line: 283, column: 9, scope: !2501)
!2501 = distinct !DILexicalBlock(scope: !2384, file: !921, line: 283, column: 9)
!2502 = !DILocation(line: 283, column: 14, scope: !2501)
!2503 = !DILocation(line: 283, column: 38, scope: !2501)
!2504 = !DILocation(line: 283, column: 9, scope: !2384)
!2505 = !DILocation(line: 284, column: 9, scope: !2501)
!2506 = !DILocation(line: 286, column: 15, scope: !2384)
!2507 = !DILocation(line: 286, column: 19, scope: !2384)
!2508 = !DILocation(line: 286, column: 24, scope: !2384)
!2509 = !DILocation(line: 286, column: 45, scope: !2384)
!2510 = !DILocation(line: 286, column: 50, scope: !2384)
!2511 = !DILocation(line: 286, column: 43, scope: !2384)
!2512 = !DILocation(line: 286, column: 5, scope: !2384)
!2513 = !DILocation(line: 287, column: 24, scope: !2384)
!2514 = !DILocation(line: 287, column: 28, scope: !2384)
!2515 = !DILocation(line: 287, column: 33, scope: !2384)
!2516 = !DILocation(line: 287, column: 38, scope: !2384)
!2517 = !DILocation(line: 287, column: 10, scope: !2384)
!2518 = !DILocation(line: 287, column: 8, scope: !2384)
!2519 = !DILocation(line: 288, column: 9, scope: !2520)
!2520 = distinct !DILexicalBlock(scope: !2384, file: !921, line: 288, column: 9)
!2521 = !DILocation(line: 288, column: 12, scope: !2520)
!2522 = !DILocation(line: 288, column: 9, scope: !2384)
!2523 = !DILocation(line: 289, column: 16, scope: !2520)
!2524 = !DILocation(line: 289, column: 9, scope: !2520)
!2525 = !DILocation(line: 291, column: 25, scope: !2384)
!2526 = !DILocation(line: 291, column: 30, scope: !2384)
!2527 = !DILocation(line: 291, column: 5, scope: !2384)
!2528 = !DILocation(line: 291, column: 10, scope: !2384)
!2529 = !DILocation(line: 291, column: 23, scope: !2384)
!2530 = !DILocation(line: 292, column: 5, scope: !2384)
!2531 = !DILocation(line: 292, column: 10, scope: !2384)
!2532 = !DILocation(line: 292, column: 27, scope: !2384)
!2533 = !DILocation(line: 294, column: 5, scope: !2384)
!2534 = !DILocation(line: 294, column: 10, scope: !2384)
!2535 = !DILocation(line: 294, column: 28, scope: !2384)
!2536 = !DILocation(line: 295, column: 5, scope: !2384)
!2537 = !DILocation(line: 296, column: 1, scope: !2384)
!2538 = distinct !DISubprogram(name: "seq_read_close", scope: !921, file: !921, line: 298, type: !2188, isLocal: true, isDefinition: true, scopeLine: 299, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2539 = !DILocalVariable(name: "s", arg: 1, scope: !2538, file: !921, line: 298, type: !2190)
!2540 = !DILocation(line: 298, column: 44, scope: !2538)
!2541 = !DILocalVariable(name: "i", scope: !2538, file: !921, line: 300, type: !917)
!2542 = !DILocation(line: 300, column: 9, scope: !2538)
!2543 = !DILocalVariable(name: "seq", scope: !2538, file: !921, line: 301, type: !2199)
!2544 = !DILocation(line: 301, column: 22, scope: !2538)
!2545 = !DILocation(line: 301, column: 28, scope: !2538)
!2546 = !DILocation(line: 301, column: 31, scope: !2538)
!2547 = !DILocation(line: 303, column: 12, scope: !2548)
!2548 = distinct !DILexicalBlock(scope: !2538, file: !921, line: 303, column: 5)
!2549 = !DILocation(line: 303, column: 10, scope: !2548)
!2550 = !DILocation(line: 303, column: 17, scope: !2551)
!2551 = !DILexicalBlockFile(scope: !2552, file: !921, discriminator: 1)
!2552 = distinct !DILexicalBlock(scope: !2548, file: !921, line: 303, column: 5)
!2553 = !DILocation(line: 303, column: 19, scope: !2551)
!2554 = !DILocation(line: 303, column: 5, scope: !2551)
!2555 = !DILocation(line: 304, column: 38, scope: !2552)
!2556 = !DILocation(line: 304, column: 19, scope: !2552)
!2557 = !DILocation(line: 304, column: 24, scope: !2552)
!2558 = !DILocation(line: 304, column: 41, scope: !2552)
!2559 = !DILocation(line: 304, column: 18, scope: !2552)
!2560 = !DILocation(line: 304, column: 9, scope: !2552)
!2561 = !DILocation(line: 303, column: 26, scope: !2562)
!2562 = !DILexicalBlockFile(scope: !2552, file: !921, discriminator: 2)
!2563 = !DILocation(line: 303, column: 5, scope: !2562)
!2564 = distinct !{!2564, !2565}
!2565 = !DILocation(line: 303, column: 5, scope: !2538)
!2566 = !DILocation(line: 306, column: 5, scope: !2538)
!2567 = distinct !DISubprogram(name: "seq_init_frame_buffers", scope: !921, file: !921, line: 83, type: !2568, isLocal: true, isDefinition: true, scopeLine: 84, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2568 = !DISubroutineType(types: !2569)
!2569 = !{!917, !2199, !1215}
!2570 = !DILocalVariable(name: "seq", arg: 1, scope: !2567, file: !921, line: 83, type: !2199)
!2571 = !DILocation(line: 83, column: 52, scope: !2567)
!2572 = !DILocalVariable(name: "pb", arg: 2, scope: !2567, file: !921, line: 83, type: !1215)
!2573 = !DILocation(line: 83, column: 70, scope: !2567)
!2574 = !DILocalVariable(name: "i", scope: !2567, file: !921, line: 85, type: !917)
!2575 = !DILocation(line: 85, column: 9, scope: !2567)
!2576 = !DILocalVariable(name: "sz", scope: !2567, file: !921, line: 85, type: !917)
!2577 = !DILocation(line: 85, column: 12, scope: !2567)
!2578 = !DILocalVariable(name: "seq_buffer", scope: !2567, file: !921, line: 86, type: !2579)
!2579 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2209, size: 64, align: 64)
!2580 = !DILocation(line: 86, column: 28, scope: !2567)
!2581 = !DILocation(line: 88, column: 15, scope: !2567)
!2582 = !DILocation(line: 88, column: 5, scope: !2567)
!2583 = !DILocation(line: 90, column: 12, scope: !2584)
!2584 = distinct !DILexicalBlock(scope: !2567, file: !921, line: 90, column: 5)
!2585 = !DILocation(line: 90, column: 10, scope: !2584)
!2586 = !DILocation(line: 90, column: 17, scope: !2587)
!2587 = !DILexicalBlockFile(scope: !2588, file: !921, discriminator: 1)
!2588 = distinct !DILexicalBlock(scope: !2584, file: !921, line: 90, column: 5)
!2589 = !DILocation(line: 90, column: 19, scope: !2587)
!2590 = !DILocation(line: 90, column: 5, scope: !2587)
!2591 = !DILocation(line: 91, column: 24, scope: !2592)
!2592 = distinct !DILexicalBlock(scope: !2588, file: !921, line: 90, column: 30)
!2593 = !DILocation(line: 91, column: 14, scope: !2592)
!2594 = !DILocation(line: 91, column: 12, scope: !2592)
!2595 = !DILocation(line: 92, column: 13, scope: !2596)
!2596 = distinct !DILexicalBlock(scope: !2592, file: !921, line: 92, column: 13)
!2597 = !DILocation(line: 92, column: 16, scope: !2596)
!2598 = !DILocation(line: 92, column: 13, scope: !2592)
!2599 = !DILocation(line: 93, column: 13, scope: !2596)
!2600 = !DILocation(line: 95, column: 46, scope: !2601)
!2601 = distinct !DILexicalBlock(scope: !2596, file: !921, line: 94, column: 14)
!2602 = !DILocation(line: 95, column: 27, scope: !2601)
!2603 = !DILocation(line: 95, column: 32, scope: !2601)
!2604 = !DILocation(line: 95, column: 24, scope: !2601)
!2605 = !DILocation(line: 96, column: 13, scope: !2601)
!2606 = !DILocation(line: 96, column: 25, scope: !2601)
!2607 = !DILocation(line: 96, column: 35, scope: !2601)
!2608 = !DILocation(line: 97, column: 37, scope: !2601)
!2609 = !DILocation(line: 97, column: 13, scope: !2601)
!2610 = !DILocation(line: 97, column: 25, scope: !2601)
!2611 = !DILocation(line: 97, column: 35, scope: !2601)
!2612 = !DILocation(line: 98, column: 42, scope: !2601)
!2613 = !DILocation(line: 98, column: 32, scope: !2601)
!2614 = !DILocation(line: 98, column: 13, scope: !2601)
!2615 = !DILocation(line: 98, column: 25, scope: !2601)
!2616 = !DILocation(line: 98, column: 30, scope: !2601)
!2617 = !DILocation(line: 99, column: 18, scope: !2618)
!2618 = distinct !DILexicalBlock(scope: !2601, file: !921, line: 99, column: 17)
!2619 = !DILocation(line: 99, column: 30, scope: !2618)
!2620 = !DILocation(line: 99, column: 17, scope: !2601)
!2621 = !DILocation(line: 100, column: 17, scope: !2618)
!2622 = !DILocation(line: 102, column: 5, scope: !2592)
!2623 = !DILocation(line: 90, column: 26, scope: !2624)
!2624 = !DILexicalBlockFile(scope: !2588, file: !921, discriminator: 2)
!2625 = !DILocation(line: 90, column: 5, scope: !2624)
!2626 = distinct !{!2626, !2627}
!2627 = !DILocation(line: 90, column: 5, scope: !2567)
!2628 = !DILocation(line: 103, column: 32, scope: !2567)
!2629 = !DILocation(line: 103, column: 5, scope: !2567)
!2630 = !DILocation(line: 103, column: 10, scope: !2567)
!2631 = !DILocation(line: 103, column: 30, scope: !2567)
!2632 = !DILocation(line: 104, column: 5, scope: !2567)
!2633 = !DILocation(line: 105, column: 1, scope: !2567)
!2634 = distinct !DISubprogram(name: "seq_parse_frame_data", scope: !921, file: !921, line: 126, type: !2568, isLocal: true, isDefinition: true, scopeLine: 127, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2635 = !DILocalVariable(name: "seq", arg: 1, scope: !2634, file: !921, line: 126, type: !2199)
!2636 = !DILocation(line: 126, column: 50, scope: !2634)
!2637 = !DILocalVariable(name: "pb", arg: 2, scope: !2634, file: !921, line: 126, type: !1215)
!2638 = !DILocation(line: 126, column: 68, scope: !2634)
!2639 = !DILocalVariable(name: "offset_table", scope: !2634, file: !921, line: 128, type: !2640)
!2640 = !DICompositeType(tag: DW_TAG_array_type, baseType: !918, size: 128, align: 32, elements: !1390)
!2641 = !DILocation(line: 128, column: 18, scope: !2634)
!2642 = !DILocalVariable(name: "buffer_num", scope: !2634, file: !921, line: 128, type: !2640)
!2643 = !DILocation(line: 128, column: 35, scope: !2634)
!2644 = !DILocalVariable(name: "seq_buffer", scope: !2634, file: !921, line: 129, type: !2579)
!2645 = !DILocation(line: 129, column: 28, scope: !2634)
!2646 = !DILocalVariable(name: "i", scope: !2634, file: !921, line: 130, type: !917)
!2647 = !DILocation(line: 130, column: 9, scope: !2634)
!2648 = !DILocalVariable(name: "e", scope: !2634, file: !921, line: 130, type: !917)
!2649 = !DILocation(line: 130, column: 12, scope: !2634)
!2650 = !DILocalVariable(name: "err", scope: !2634, file: !921, line: 130, type: !917)
!2651 = !DILocation(line: 130, column: 15, scope: !2634)
!2652 = !DILocation(line: 132, column: 5, scope: !2634)
!2653 = !DILocation(line: 132, column: 10, scope: !2634)
!2654 = !DILocation(line: 132, column: 29, scope: !2634)
!2655 = !DILocation(line: 133, column: 15, scope: !2634)
!2656 = !DILocation(line: 133, column: 19, scope: !2634)
!2657 = !DILocation(line: 133, column: 24, scope: !2634)
!2658 = !DILocation(line: 133, column: 5, scope: !2634)
!2659 = !DILocation(line: 136, column: 46, scope: !2634)
!2660 = !DILocation(line: 136, column: 36, scope: !2634)
!2661 = !DILocation(line: 136, column: 5, scope: !2634)
!2662 = !DILocation(line: 136, column: 10, scope: !2634)
!2663 = !DILocation(line: 136, column: 34, scope: !2634)
!2664 = !DILocation(line: 137, column: 9, scope: !2665)
!2665 = distinct !DILexicalBlock(scope: !2634, file: !921, line: 137, column: 9)
!2666 = !DILocation(line: 137, column: 14, scope: !2665)
!2667 = !DILocation(line: 137, column: 9, scope: !2634)
!2668 = !DILocation(line: 138, column: 9, scope: !2669)
!2669 = distinct !DILexicalBlock(scope: !2665, file: !921, line: 137, column: 39)
!2670 = !DILocation(line: 138, column: 14, scope: !2669)
!2671 = !DILocation(line: 138, column: 38, scope: !2669)
!2672 = !DILocation(line: 139, column: 5, scope: !2669)
!2673 = !DILocation(line: 140, column: 9, scope: !2674)
!2674 = distinct !DILexicalBlock(scope: !2665, file: !921, line: 139, column: 12)
!2675 = !DILocation(line: 140, column: 14, scope: !2674)
!2676 = !DILocation(line: 140, column: 38, scope: !2674)
!2677 = !DILocation(line: 144, column: 44, scope: !2634)
!2678 = !DILocation(line: 144, column: 34, scope: !2634)
!2679 = !DILocation(line: 144, column: 5, scope: !2634)
!2680 = !DILocation(line: 144, column: 10, scope: !2634)
!2681 = !DILocation(line: 144, column: 32, scope: !2634)
!2682 = !DILocation(line: 145, column: 9, scope: !2683)
!2683 = distinct !DILexicalBlock(scope: !2634, file: !921, line: 145, column: 9)
!2684 = !DILocation(line: 145, column: 14, scope: !2683)
!2685 = !DILocation(line: 145, column: 9, scope: !2634)
!2686 = !DILocation(line: 146, column: 9, scope: !2687)
!2687 = distinct !DILexicalBlock(scope: !2683, file: !921, line: 145, column: 37)
!2688 = !DILocation(line: 146, column: 14, scope: !2687)
!2689 = !DILocation(line: 146, column: 36, scope: !2687)
!2690 = !DILocation(line: 147, column: 5, scope: !2687)
!2691 = !DILocation(line: 148, column: 9, scope: !2692)
!2692 = distinct !DILexicalBlock(scope: !2683, file: !921, line: 147, column: 12)
!2693 = !DILocation(line: 148, column: 14, scope: !2692)
!2694 = !DILocation(line: 148, column: 36, scope: !2692)
!2695 = !DILocation(line: 152, column: 12, scope: !2696)
!2696 = distinct !DILexicalBlock(scope: !2634, file: !921, line: 152, column: 5)
!2697 = !DILocation(line: 152, column: 10, scope: !2696)
!2698 = !DILocation(line: 152, column: 17, scope: !2699)
!2699 = !DILexicalBlockFile(scope: !2700, file: !921, discriminator: 1)
!2700 = distinct !DILexicalBlock(scope: !2696, file: !921, line: 152, column: 5)
!2701 = !DILocation(line: 152, column: 19, scope: !2699)
!2702 = !DILocation(line: 152, column: 5, scope: !2699)
!2703 = !DILocation(line: 153, column: 33, scope: !2700)
!2704 = !DILocation(line: 153, column: 25, scope: !2700)
!2705 = !DILocation(line: 153, column: 20, scope: !2700)
!2706 = !DILocation(line: 153, column: 9, scope: !2700)
!2707 = !DILocation(line: 153, column: 23, scope: !2700)
!2708 = !DILocation(line: 152, column: 25, scope: !2709)
!2709 = !DILexicalBlockFile(scope: !2700, file: !921, discriminator: 2)
!2710 = !DILocation(line: 152, column: 5, scope: !2709)
!2711 = distinct !{!2711, !2712}
!2712 = !DILocation(line: 152, column: 5, scope: !2634)
!2713 = !DILocation(line: 155, column: 12, scope: !2714)
!2714 = distinct !DILexicalBlock(scope: !2634, file: !921, line: 155, column: 5)
!2715 = !DILocation(line: 155, column: 10, scope: !2714)
!2716 = !DILocation(line: 155, column: 17, scope: !2717)
!2717 = !DILexicalBlockFile(scope: !2718, file: !921, discriminator: 1)
!2718 = distinct !DILexicalBlock(scope: !2714, file: !921, line: 155, column: 5)
!2719 = !DILocation(line: 155, column: 19, scope: !2717)
!2720 = !DILocation(line: 155, column: 5, scope: !2717)
!2721 = !DILocation(line: 156, column: 37, scope: !2718)
!2722 = !DILocation(line: 156, column: 27, scope: !2718)
!2723 = !DILocation(line: 156, column: 22, scope: !2718)
!2724 = !DILocation(line: 156, column: 9, scope: !2718)
!2725 = !DILocation(line: 156, column: 25, scope: !2718)
!2726 = !DILocation(line: 155, column: 25, scope: !2727)
!2727 = !DILexicalBlockFile(scope: !2718, file: !921, discriminator: 2)
!2728 = !DILocation(line: 155, column: 5, scope: !2727)
!2729 = distinct !{!2729, !2730}
!2730 = !DILocation(line: 155, column: 5, scope: !2634)
!2731 = !DILocation(line: 158, column: 12, scope: !2732)
!2732 = distinct !DILexicalBlock(scope: !2634, file: !921, line: 158, column: 5)
!2733 = !DILocation(line: 158, column: 10, scope: !2732)
!2734 = !DILocation(line: 158, column: 17, scope: !2735)
!2735 = !DILexicalBlockFile(scope: !2736, file: !921, discriminator: 1)
!2736 = distinct !DILexicalBlock(scope: !2732, file: !921, line: 158, column: 5)
!2737 = !DILocation(line: 158, column: 19, scope: !2735)
!2738 = !DILocation(line: 158, column: 5, scope: !2735)
!2739 = !DILocation(line: 159, column: 26, scope: !2740)
!2740 = distinct !DILexicalBlock(scope: !2741, file: !921, line: 159, column: 13)
!2741 = distinct !DILexicalBlock(scope: !2736, file: !921, line: 158, column: 29)
!2742 = !DILocation(line: 159, column: 13, scope: !2740)
!2743 = !DILocation(line: 159, column: 13, scope: !2741)
!2744 = !DILocation(line: 160, column: 22, scope: !2745)
!2745 = distinct !DILexicalBlock(scope: !2746, file: !921, line: 160, column: 13)
!2746 = distinct !DILexicalBlock(scope: !2740, file: !921, line: 159, column: 30)
!2747 = !DILocation(line: 160, column: 24, scope: !2745)
!2748 = !DILocation(line: 160, column: 20, scope: !2745)
!2749 = !DILocation(line: 160, column: 18, scope: !2745)
!2750 = !DILocation(line: 160, column: 29, scope: !2751)
!2751 = !DILexicalBlockFile(scope: !2752, file: !921, discriminator: 1)
!2752 = distinct !DILexicalBlock(scope: !2745, file: !921, line: 160, column: 13)
!2753 = !DILocation(line: 160, column: 31, scope: !2751)
!2754 = !DILocation(line: 160, column: 35, scope: !2751)
!2755 = !DILocation(line: 160, column: 51, scope: !2756)
!2756 = !DILexicalBlockFile(scope: !2752, file: !921, discriminator: 2)
!2757 = !DILocation(line: 160, column: 38, scope: !2756)
!2758 = !DILocation(line: 160, column: 54, scope: !2756)
!2759 = !DILocation(line: 160, column: 13, scope: !2760)
!2760 = !DILexicalBlockFile(scope: !2745, file: !921, discriminator: 3)
!2761 = !DILocation(line: 160, column: 13, scope: !2762)
!2762 = !DILexicalBlockFile(scope: !2745, file: !921, discriminator: 4)
!2763 = !DILocation(line: 160, column: 61, scope: !2764)
!2764 = !DILexicalBlockFile(scope: !2752, file: !921, discriminator: 5)
!2765 = !DILocation(line: 160, column: 13, scope: !2764)
!2766 = distinct !{!2766, !2767}
!2767 = !DILocation(line: 160, column: 13, scope: !2746)
!2768 = !DILocation(line: 161, column: 35, scope: !2746)
!2769 = !DILocation(line: 161, column: 40, scope: !2746)
!2770 = !DILocation(line: 161, column: 59, scope: !2746)
!2771 = !DILocation(line: 161, column: 57, scope: !2746)
!2772 = !DILocation(line: 161, column: 44, scope: !2746)
!2773 = !DILocation(line: 162, column: 28, scope: !2746)
!2774 = !DILocation(line: 162, column: 15, scope: !2746)
!2775 = !DILocation(line: 163, column: 28, scope: !2746)
!2776 = !DILocation(line: 163, column: 15, scope: !2746)
!2777 = !DILocation(line: 163, column: 46, scope: !2746)
!2778 = !DILocation(line: 163, column: 33, scope: !2746)
!2779 = !DILocation(line: 163, column: 31, scope: !2746)
!2780 = !DILocation(line: 161, column: 19, scope: !2746)
!2781 = !DILocation(line: 161, column: 17, scope: !2746)
!2782 = !DILocation(line: 164, column: 17, scope: !2783)
!2783 = distinct !DILexicalBlock(scope: !2746, file: !921, line: 164, column: 17)
!2784 = !DILocation(line: 164, column: 17, scope: !2746)
!2785 = !DILocation(line: 165, column: 24, scope: !2783)
!2786 = !DILocation(line: 165, column: 17, scope: !2783)
!2787 = !DILocation(line: 166, column: 9, scope: !2746)
!2788 = !DILocation(line: 167, column: 5, scope: !2741)
!2789 = !DILocation(line: 158, column: 25, scope: !2790)
!2790 = !DILexicalBlockFile(scope: !2736, file: !921, discriminator: 2)
!2791 = !DILocation(line: 158, column: 5, scope: !2790)
!2792 = distinct !{!2792, !2793}
!2793 = !DILocation(line: 158, column: 5, scope: !2634)
!2794 = !DILocation(line: 169, column: 9, scope: !2795)
!2795 = distinct !DILexicalBlock(scope: !2634, file: !921, line: 169, column: 9)
!2796 = !DILocation(line: 169, column: 23, scope: !2795)
!2797 = !DILocation(line: 169, column: 9, scope: !2634)
!2798 = !DILocation(line: 170, column: 13, scope: !2799)
!2799 = distinct !DILexicalBlock(scope: !2800, file: !921, line: 170, column: 13)
!2800 = distinct !DILexicalBlock(scope: !2795, file: !921, line: 169, column: 31)
!2801 = !DILocation(line: 170, column: 27, scope: !2799)
!2802 = !DILocation(line: 170, column: 13, scope: !2800)
!2803 = !DILocation(line: 171, column: 13, scope: !2799)
!2804 = !DILocation(line: 173, column: 42, scope: !2800)
!2805 = !DILocation(line: 173, column: 23, scope: !2800)
!2806 = !DILocation(line: 173, column: 28, scope: !2800)
!2807 = !DILocation(line: 173, column: 20, scope: !2800)
!2808 = !DILocation(line: 174, column: 40, scope: !2800)
!2809 = !DILocation(line: 174, column: 52, scope: !2800)
!2810 = !DILocation(line: 174, column: 9, scope: !2800)
!2811 = !DILocation(line: 174, column: 14, scope: !2800)
!2812 = !DILocation(line: 174, column: 38, scope: !2800)
!2813 = !DILocation(line: 175, column: 39, scope: !2800)
!2814 = !DILocation(line: 175, column: 51, scope: !2800)
!2815 = !DILocation(line: 175, column: 9, scope: !2800)
!2816 = !DILocation(line: 175, column: 14, scope: !2800)
!2817 = !DILocation(line: 175, column: 37, scope: !2800)
!2818 = !DILocation(line: 176, column: 9, scope: !2800)
!2819 = !DILocation(line: 176, column: 21, scope: !2800)
!2820 = !DILocation(line: 176, column: 31, scope: !2800)
!2821 = !DILocation(line: 177, column: 5, scope: !2800)
!2822 = !DILocation(line: 178, column: 9, scope: !2823)
!2823 = distinct !DILexicalBlock(scope: !2795, file: !921, line: 177, column: 12)
!2824 = !DILocation(line: 178, column: 14, scope: !2823)
!2825 = !DILocation(line: 178, column: 38, scope: !2823)
!2826 = !DILocation(line: 179, column: 9, scope: !2823)
!2827 = !DILocation(line: 179, column: 14, scope: !2823)
!2828 = !DILocation(line: 179, column: 37, scope: !2823)
!2829 = !DILocation(line: 182, column: 5, scope: !2634)
!2830 = !DILocation(line: 183, column: 1, scope: !2634)
!2831 = distinct !DISubprogram(name: "seq_fill_buffer", scope: !921, file: !921, line: 107, type: !2832, isLocal: true, isDefinition: true, scopeLine: 108, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2832 = !DISubroutineType(types: !2833)
!2833 = !{!917, !2199, !1215, !917, !918, !917}
!2834 = !DILocalVariable(name: "seq", arg: 1, scope: !2831, file: !921, line: 107, type: !2199)
!2835 = !DILocation(line: 107, column: 45, scope: !2831)
!2836 = !DILocalVariable(name: "pb", arg: 2, scope: !2831, file: !921, line: 107, type: !1215)
!2837 = !DILocation(line: 107, column: 63, scope: !2831)
!2838 = !DILocalVariable(name: "buffer_num", arg: 3, scope: !2831, file: !921, line: 107, type: !917)
!2839 = !DILocation(line: 107, column: 71, scope: !2831)
!2840 = !DILocalVariable(name: "data_offs", arg: 4, scope: !2831, file: !921, line: 107, type: !918)
!2841 = !DILocation(line: 107, column: 96, scope: !2831)
!2842 = !DILocalVariable(name: "data_size", arg: 5, scope: !2831, file: !921, line: 107, type: !917)
!2843 = !DILocation(line: 107, column: 111, scope: !2831)
!2844 = !DILocalVariable(name: "seq_buffer", scope: !2831, file: !921, line: 109, type: !2579)
!2845 = !DILocation(line: 109, column: 28, scope: !2831)
!2846 = !DILocation(line: 111, column: 9, scope: !2847)
!2847 = distinct !DILexicalBlock(scope: !2831, file: !921, line: 111, column: 9)
!2848 = !DILocation(line: 111, column: 20, scope: !2847)
!2849 = !DILocation(line: 111, column: 9, scope: !2831)
!2850 = !DILocation(line: 112, column: 9, scope: !2847)
!2851 = !DILocation(line: 114, column: 38, scope: !2831)
!2852 = !DILocation(line: 114, column: 19, scope: !2831)
!2853 = !DILocation(line: 114, column: 24, scope: !2831)
!2854 = !DILocation(line: 114, column: 16, scope: !2831)
!2855 = !DILocation(line: 115, column: 9, scope: !2856)
!2856 = distinct !DILexicalBlock(scope: !2831, file: !921, line: 115, column: 9)
!2857 = !DILocation(line: 115, column: 21, scope: !2856)
!2858 = !DILocation(line: 115, column: 33, scope: !2856)
!2859 = !DILocation(line: 115, column: 31, scope: !2856)
!2860 = !DILocation(line: 115, column: 45, scope: !2856)
!2861 = !DILocation(line: 115, column: 57, scope: !2856)
!2862 = !DILocation(line: 115, column: 43, scope: !2856)
!2863 = !DILocation(line: 115, column: 67, scope: !2856)
!2864 = !DILocation(line: 115, column: 70, scope: !2865)
!2865 = !DILexicalBlockFile(scope: !2856, file: !921, discriminator: 1)
!2866 = !DILocation(line: 115, column: 80, scope: !2865)
!2867 = !DILocation(line: 115, column: 9, scope: !2865)
!2868 = !DILocation(line: 116, column: 9, scope: !2856)
!2869 = !DILocation(line: 118, column: 15, scope: !2831)
!2870 = !DILocation(line: 118, column: 19, scope: !2831)
!2871 = !DILocation(line: 118, column: 24, scope: !2831)
!2872 = !DILocation(line: 118, column: 45, scope: !2831)
!2873 = !DILocation(line: 118, column: 43, scope: !2831)
!2874 = !DILocation(line: 118, column: 5, scope: !2831)
!2875 = !DILocation(line: 119, column: 19, scope: !2876)
!2876 = distinct !DILexicalBlock(scope: !2831, file: !921, line: 119, column: 9)
!2877 = !DILocation(line: 119, column: 23, scope: !2876)
!2878 = !DILocation(line: 119, column: 35, scope: !2876)
!2879 = !DILocation(line: 119, column: 42, scope: !2876)
!2880 = !DILocation(line: 119, column: 54, scope: !2876)
!2881 = !DILocation(line: 119, column: 40, scope: !2876)
!2882 = !DILocation(line: 119, column: 65, scope: !2876)
!2883 = !DILocation(line: 119, column: 9, scope: !2876)
!2884 = !DILocation(line: 119, column: 79, scope: !2876)
!2885 = !DILocation(line: 119, column: 76, scope: !2876)
!2886 = !DILocation(line: 119, column: 9, scope: !2831)
!2887 = !DILocation(line: 120, column: 9, scope: !2876)
!2888 = !DILocation(line: 122, column: 30, scope: !2831)
!2889 = !DILocation(line: 122, column: 5, scope: !2831)
!2890 = !DILocation(line: 122, column: 17, scope: !2831)
!2891 = !DILocation(line: 122, column: 27, scope: !2831)
!2892 = !DILocation(line: 123, column: 5, scope: !2831)
!2893 = !DILocation(line: 124, column: 1, scope: !2831)
