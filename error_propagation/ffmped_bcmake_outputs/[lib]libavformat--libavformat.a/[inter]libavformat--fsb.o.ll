; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--fsb.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--fsb.o.i"
...
@ff_fsb_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 256, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 0, i32 (%struct.AVProbeData*)* @fsb_probe, i32 (%struct.AVFormatContext*)* @fsb_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @fsb_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
...
define internal i32 @fsb_probe(%struct.AVProbeData* %p) #0 !dbg !2147 {
entry:
  ...
  %0 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2152
  %buf = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %0, i32 0, i32 1, !dbg !2154
  %1 = load i8*, i8** %buf, align 8, !dbg !2154
  %call = call i32 @memcmp(i8* %1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0), i64 3) #6, !dbg !2155
  %tobool = icmp ne i32 %call, 0, !dbg !2155
  br i1 %tobool, label %if.then, label %lor.lhs.false, !dbg !2156

lor.lhs.false:                                    ; preds = %entry
  %2 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2157
  %buf1 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %2, i32 0, i32 1, !dbg !2159
  %3 = load i8*, i8** %buf1, align 8, !dbg !2159
  %arrayidx = getelementptr inbounds i8, i8* %3, i64 3, !dbg !2157
  %4 = load i8, i8* %arrayidx, align 1, !dbg !2157
  %conv = zext i8 %4 to i32, !dbg !2157
  %sub = sub nsw i32 %conv, 48, !dbg !2160
  %cmp = icmp slt i32 %sub, 1, !dbg !2161
  br i1 %cmp, label %if.then, label %lor.lhs.false3, !dbg !2162

lor.lhs.false3:                                   ; preds = %lor.lhs.false
  %5 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2163
  %buf4 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %5, i32 0, i32 1, !dbg !2165
  %6 = load i8*, i8** %buf4, align 8, !dbg !2165
  %arrayidx5 = getelementptr inbounds i8, i8* %6, i64 3, !dbg !2163
  %7 = load i8, i8* %arrayidx5, align 1, !dbg !2163
  %conv6 = zext i8 %7 to i32, !dbg !2163
  %sub7 = sub nsw i32 %conv6, 48, !dbg !2166
  %cmp8 = icmp sgt i32 %sub7, 5, !dbg !2167
  br i1 %cmp8, label %if.then, label %if.end, !dbg !2168
...
if.end:                                           ; preds = %lor.lhs.false3
  ...
  %buf10 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %8, i32 0, i32 1, !dbg !2172
  %9 = load i8*, i8** %buf10, align 8, !dbg !2172
  %add.ptr = getelementptr inbounds i8, i8* %9, i64 4, !dbg !2173
  %10 = bitcast i8* %add.ptr to %union.unaligned_32*, !dbg !2174
  %l = bitcast %union.unaligned_32* %10 to i32*, !dbg !2174
  %11 = load i32, i32* %l, align 1, !dbg !2174
  %cmp11 = icmp ne i32 %11, 1, !dbg !2175
...
if.end14:                                         ; preds = %if.end
  store i32 100, i32* %retval, align 4, !dbg !2178
  br label %return, !dbg !2178

return:                                           ; preds = %if.end14, %if.then13, %if.then
  %12 = load i32, i32* %retval, align 4, !dbg !2179
  ret i32 %12, !dbg !2179
}

; Function Attrs: nounwind uwtable
define internal i32 @fsb_read_header(%struct.AVFormatContext* %s) #0 !dbg !2180 {
entry:
  %s.addr.i156 = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i156, metadata !2185, metadata !2150), !dbg !2189
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2185, metadata !2150), !dbg !2191
  %retval = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2193, metadata !2150), !dbg !2194
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2195, metadata !2150), !dbg !2196
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2197
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2198
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2198
  store %struct.AVIOContext* %1, %struct.AVIOContext** %pb, align 8, !dbg !2196
  call void @llvm.dbg.declare(metadata i32* %format, metadata !2199, metadata !2150), !dbg !2200
  call void @llvm.dbg.declare(metadata i32* %version, metadata !2201, metadata !2150), !dbg !2202
  call void @llvm.dbg.declare(metadata i32* %c, metadata !2203, metadata !2150), !dbg !2204
  call void @llvm.dbg.declare(metadata i64* %offset, metadata !2205, metadata !2150), !dbg !2206
  call void @llvm.dbg.declare(metadata %struct.AVCodecParameters** %par, metadata !2207, metadata !2150), !dbg !2208
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2209, metadata !2150), !dbg !2210
  %2 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2211
  %call = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %2, %struct.AVCodec* null), !dbg !2212
  store %struct.AVStream* %call, %struct.AVStream** %st, align 8, !dbg !2210
  %3 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2213
  %call2 = call i64 @avio_skip(%struct.AVIOContext* %3, i64 3), !dbg !2214
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2215
  %call3 = call i32 @avio_r8(%struct.AVIOContext* %4), !dbg !2216
  %sub = sub nsw i32 %call3, 48, !dbg !2217
  store i32 %sub, i32* %version, align 4, !dbg !2218
  %5 = load i32, i32* %version, align 4, !dbg !2219
  %cmp = icmp ne i32 %5, 4, !dbg !2221
  br i1 %cmp, label %land.lhs.true, label %if.end, !dbg !2222

land.lhs.true:                                    ; preds = %entry
  %6 = load i32, i32* %version, align 4, !dbg !2223
  %cmp4 = icmp ne i32 %6, 3, !dbg !2225
  br i1 %cmp4, label %if.then, label %if.end, !dbg !2226

if.then:                                          ; preds = %land.lhs.true
  %7 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2227
  %8 = bitcast %struct.AVFormatContext* %7 to i8*, !dbg !2227
  %9 = load i32, i32* %version, align 4, !dbg !2229
  call void (i8*, i8*, ...) @avpriv_request_sample(i8* %8, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.3, i32 0, i32 0), i32 %9), !dbg !2230
  store i32 -1163346256, i32* %retval, align 4, !dbg !2231
  br label %return, !dbg !2231

if.end:                                           ; preds = %land.lhs.true, %entry
  %10 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2232
  %call5 = call i64 @avio_skip(%struct.AVIOContext* %10, i64 4), !dbg !2233
  %11 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2234
  %tobool = icmp ne %struct.AVStream* %11, null, !dbg !2234
  br i1 %tobool, label %if.end7, label %if.then6, !dbg !2236

if.then6:                                         ; preds = %if.end
  store i32 -12, i32* %retval, align 4, !dbg !2237
  br label %return, !dbg !2237

if.end7:                                          ; preds = %if.end
  %12 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2238
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %12, i32 0, i32 19, !dbg !2239
  %13 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2239
  store %struct.AVCodecParameters* %13, %struct.AVCodecParameters** %par, align 8, !dbg !2240
  %14 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2241
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %14, i32 0, i32 0, !dbg !2242
  store i32 1, i32* %codec_type, align 8, !dbg !2243
  %15 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2244
  %codec_tag = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %15, i32 0, i32 2, !dbg !2245
  store i32 0, i32* %codec_tag, align 8, !dbg !2246
  %16 = load i32, i32* %version, align 4, !dbg !2247
  %cmp8 = icmp eq i32 %16, 3, !dbg !2249
  br i1 %cmp8, label %if.then9, label %if.else78, !dbg !2250

if.then9:                                         ; preds = %if.end7
  %17 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2251
  %call10 = call i32 @avio_rl32(%struct.AVIOContext* %17), !dbg !2253
  %add = add i32 %call10, 24, !dbg !2254
  %conv = zext i32 %add to i64, !dbg !2253
  store i64 %conv, i64* %offset, align 8, !dbg !2255
  %18 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2256
  %call11 = call i64 @avio_skip(%struct.AVIOContext* %18, i64 44), !dbg !2257
  %19 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2258
  %call12 = call i32 @avio_rl32(%struct.AVIOContext* %19), !dbg !2259
  %conv13 = zext i32 %call12 to i64, !dbg !2259
  %20 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2260
  %duration = getelementptr inbounds %struct.AVStream, %struct.AVStream* %20, i32 0, i32 6, !dbg !2261
  store i64 %conv13, i64* %duration, align 8, !dbg !2262
  %21 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2263
  %call14 = call i64 @avio_skip(%struct.AVIOContext* %21, i64 12), !dbg !2264
  %22 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2265
  %call15 = call i32 @avio_rl32(%struct.AVIOContext* %22), !dbg !2266
  store i32 %call15, i32* %format, align 4, !dbg !2267
  %23 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2268
  %call16 = call i32 @avio_rl32(%struct.AVIOContext* %23), !dbg !2269
  %24 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2270
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %24, i32 0, i32 23, !dbg !2271
  store i32 %call16, i32* %sample_rate, align 4, !dbg !2272
  %25 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2273
  %sample_rate17 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %25, i32 0, i32 23, !dbg !2275
  %26 = load i32, i32* %sample_rate17, align 4, !dbg !2275
  %cmp18 = icmp sle i32 %26, 0, !dbg !2276
  br i1 %cmp18, label %if.then20, label %if.end21, !dbg !2277
...
if.end21:                                         ; preds = %if.then9
  %27 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2279
  %call22 = call i64 @avio_skip(%struct.AVIOContext* %27, i64 6), !dbg !2280
  %28 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2281
  %call23 = call i32 @avio_rl16(%struct.AVIOContext* %28), !dbg !2282
  %29 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2283
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %29, i32 0, i32 22, !dbg !2284
  store i32 %call23, i32* %channels, align 8, !dbg !2285
  %30 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2286
  %channels24 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %30, i32 0, i32 22, !dbg !2288
  %31 = load i32, i32* %channels24, align 8, !dbg !2288
  %tobool25 = icmp ne i32 %31, 0, !dbg !2286
  br i1 %tobool25, label %if.end27, label %if.then26, !dbg !2289
...
if.end27:                                         ; preds = %if.end21
  %32 = load i32, i32* %format, align 4, !dbg !2291
  %and = and i32 %32, 256, !dbg !2293
  %tobool28 = icmp ne i32 %and, 0, !dbg !2293
  br i1 %tobool28, label %if.then29, label %if.else, !dbg !2294

if.then29:                                        ; preds = %if.end27
  %33 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2295
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %33, i32 0, i32 1, !dbg !2297
  store i32 65536, i32* %codec_id, align 4, !dbg !2298
  %34 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2299
  %channels30 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %34, i32 0, i32 22, !dbg !2300
  %35 = load i32, i32* %channels30, align 8, !dbg !2300
  %mul = mul nsw i32 4096, %35, !dbg !2301
  %36 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2302
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %36, i32 0, i32 24, !dbg !2303
  store i32 %mul, i32* %block_align, align 8, !dbg !2304
  br label %if.end77, !dbg !2305

if.else:                                          ; preds = %if.end27
  %37 = load i32, i32* %format, align 4, !dbg !2306
  %and31 = and i32 %37, 4194304, !dbg !2309
  %tobool32 = icmp ne i32 %and31, 0, !dbg !2309
  br i1 %tobool32, label %if.then33, label %if.else38, !dbg !2306

if.then33:                                        ; preds = %if.else
  %38 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2310
  %bits_per_coded_sample = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %38, i32 0, i32 7, !dbg !2312
  store i32 4, i32* %bits_per_coded_sample, align 8, !dbg !2313
  %39 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2314
  %codec_id34 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %39, i32 0, i32 1, !dbg !2315
  store i32 69633, i32* %codec_id34, align 4, !dbg !2316
  %40 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2317
  %channels35 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %40, i32 0, i32 22, !dbg !2318
  %41 = load i32, i32* %channels35, align 8, !dbg !2318
  %mul36 = mul nsw i32 36, %41, !dbg !2319
  %42 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2320
  %block_align37 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %42, i32 0, i32 24, !dbg !2321
  store i32 %mul36, i32* %block_align37, align 8, !dbg !2322
  br label %if.end76, !dbg !2323

if.else38:                                        ; preds = %if.else
  %43 = load i32, i32* %format, align 4, !dbg !2324
  %and39 = and i32 %43, 8388608, !dbg !2327
  %tobool40 = icmp ne i32 %and39, 0, !dbg !2327
  br i1 %tobool40, label %if.then41, label %if.else46, !dbg !2324

if.then41:                                        ; preds = %if.else38
  %44 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2328
  %codec_id42 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %44, i32 0, i32 1, !dbg !2330
  store i32 71686, i32* %codec_id42, align 4, !dbg !2331
  %45 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2332
  %channels43 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %45, i32 0, i32 22, !dbg !2333
  %46 = load i32, i32* %channels43, align 8, !dbg !2333
  %mul44 = mul nsw i32 16, %46, !dbg !2334
  %47 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2335
  %block_align45 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %47, i32 0, i32 24, !dbg !2336
  store i32 %mul44, i32* %block_align45, align 8, !dbg !2337
  br label %if.end75, !dbg !2338

if.else46:                                        ; preds = %if.else38
  %48 = load i32, i32* %format, align 4, !dbg !2339
  %and47 = and i32 %48, 33554432, !dbg !2342
  %tobool48 = icmp ne i32 %and47, 0, !dbg !2342
  br i1 %tobool48, label %if.then49, label %if.else73, !dbg !2339

if.then49:                                        ; preds = %if.else46
  %49 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2343
  %codec_id50 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %49, i32 0, i32 1, !dbg !2345
  store i32 69650, i32* %codec_id50, align 4, !dbg !2346
  %50 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2347
  %channels51 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %50, i32 0, i32 22, !dbg !2348
  %51 = load i32, i32* %channels51, align 8, !dbg !2348
  %mul52 = mul nsw i32 8, %51, !dbg !2349
  %52 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2350
  %block_align53 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %52, i32 0, i32 24, !dbg !2351
  store i32 %mul52, i32* %block_align53, align 8, !dbg !2352
  %53 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2353
  %channels54 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %53, i32 0, i32 22, !dbg !2355
  %54 = load i32, i32* %channels54, align 8, !dbg !2355
  %cmp55 = icmp sgt i32 %54, 67108863, !dbg !2356
  br i1 %cmp55, label %if.then57, label %if.end58, !dbg !2357
...
if.end58:                                         ; preds = %if.then49
  %55 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2359
  %56 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2360
  %channels59 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %56, i32 0, i32 22, !dbg !2361
  %57 = load i32, i32* %channels59, align 8, !dbg !2361
  %mul60 = mul nsw i32 32, %57, !dbg !2362
  %call61 = call i32 @ff_alloc_extradata(%struct.AVCodecParameters* %55, i32 %mul60), !dbg !2363
  %58 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2364
  %extradata = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %58, i32 0, i32 3, !dbg !2366
  %59 = load i8*, i8** %extradata, align 8, !dbg !2366
  %tobool62 = icmp ne i8* %59, null, !dbg !2364
  br i1 %tobool62, label %if.end64, label %if.then63, !dbg !2367

if.then63:                                        ; preds = %if.end58
  store i32 -12, i32* %retval, align 4, !dbg !2368
  br label %return, !dbg !2368

if.end64:                                         ; preds = %if.end58
  %60 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2369
  %call65 = call i64 @avio_seek(%struct.AVIOContext* %60, i64 104, i32 0), !dbg !2370
  store i32 0, i32* %c, align 4, !dbg !2371
  br label %for.cond, !dbg !2373

for.cond:                                         ; preds = %for.inc, %if.end64
  %61 = load i32, i32* %c, align 4, !dbg !2374
  %62 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2377
  %channels66 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %62, i32 0, i32 22, !dbg !2378
  %63 = load i32, i32* %channels66, align 8, !dbg !2378
  %cmp67 = icmp ult i32 %61, %63, !dbg !2379
  br i1 %cmp67, label %for.body, label %for.end, !dbg !2380

for.body:                                         ; preds = %for.cond
  %64 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2381
  %65 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2383
  %extradata69 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %65, i32 0, i32 3, !dbg !2384
  %66 = load i8*, i8** %extradata69, align 8, !dbg !2384
  %67 = load i32, i32* %c, align 4, !dbg !2385
  %mul70 = mul i32 32, %67, !dbg !2386
  %idx.ext = zext i32 %mul70 to i64, !dbg !2387
  %add.ptr = getelementptr inbounds i8, i8* %66, i64 %idx.ext, !dbg !2387
  %call71 = call i32 @avio_read(%struct.AVIOContext* %64, i8* %add.ptr, i32 32), !dbg !2388
  %68 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2389
  %call72 = call i64 @avio_skip(%struct.AVIOContext* %68, i64 14), !dbg !2390
  br label %for.inc, !dbg !2391

for.inc:                                          ; preds = %for.body
  %69 = load i32, i32* %c, align 4, !dbg !2392
  %inc = add i32 %69, 1, !dbg !2392
  store i32 %inc, i32* %c, align 4, !dbg !2392
  br label %for.cond, !dbg !2394, !llvm.loop !2395

for.end:                                          ; preds = %for.cond
  br label %if.end74, !dbg !2397

if.else73:                                        ; preds = %if.else46
  %70 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2398
  %71 = bitcast %struct.AVFormatContext* %70 to i8*, !dbg !2398
  %72 = load i32, i32* %format, align 4, !dbg !2400
  call void (i8*, i8*, ...) @avpriv_request_sample(i8* %71, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.4, i32 0, i32 0), i32 %72), !dbg !2401
  store i32 -1163346256, i32* %retval, align 4, !dbg !2402
...
if.end77:                                         ; preds = %if.end76, %if.then29
  br label %if.end150, !dbg !2403

if.else78:                                        ; preds = %if.end7
  %73 = load i32, i32* %version, align 4, !dbg !2404
  %cmp79 = icmp eq i32 %73, 4, !dbg !2407
  br i1 %cmp79, label %if.then81, label %if.else148, !dbg !2404

if.then81:                                        ; preds = %if.else78
  %74 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2408
  %call82 = call i32 @avio_rl32(%struct.AVIOContext* %74), !dbg !2410
  %add83 = add i32 %call82, 48, !dbg !2411
  %conv84 = zext i32 %add83 to i64, !dbg !2410
  store i64 %conv84, i64* %offset, align 8, !dbg !2412
  %75 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2413
  %call85 = call i64 @avio_skip(%struct.AVIOContext* %75, i64 80), !dbg !2414
  %76 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2415
  %call86 = call i32 @avio_rl32(%struct.AVIOContext* %76), !dbg !2416
  %conv87 = zext i32 %call86 to i64, !dbg !2416
  %77 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2417
  %duration88 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %77, i32 0, i32 6, !dbg !2418
  store i64 %conv87, i64* %duration88, align 8, !dbg !2419
  %78 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2420
  %call89 = call i32 @avio_rb32(%struct.AVIOContext* %78), !dbg !2421
  store i32 %call89, i32* %format, align 4, !dbg !2422
  %79 = load i32, i32* %format, align 4, !dbg !2423
  switch i32 %79, label %sw.default [
    i32 1073745921, label %sw.bb
    i32 4101, label %sw.bb
    i32 1073746049, label %sw.bb
    i32 1075838977, label %sw.bb
    i32 1073743874, label %sw.bb91
  ], !dbg !2424

sw.bb:                                            ; preds = %if.then81, %if.then81, %if.then81, %if.then81
  %80 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2425
  %codec_id90 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %80, i32 0, i32 1, !dbg !2427
  store i32 88076, i32* %codec_id90, align 4, !dbg !2428
  br label %sw.epilog, !dbg !2429

sw.bb91:                                          ; preds = %if.then81
  %81 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2430
  %codec_id92 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %81, i32 0, i32 1, !dbg !2431
  store i32 69650, i32* %codec_id92, align 4, !dbg !2432
  br label %sw.epilog, !dbg !2433

sw.default:                                       ; preds = %if.then81
  %82 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2434
  %83 = bitcast %struct.AVFormatContext* %82 to i8*, !dbg !2434
  %84 = load i32, i32* %format, align 4, !dbg !2435
  call void (i8*, i8*, ...) @avpriv_request_sample(i8* %83, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.4, i32 0, i32 0), i32 %84), !dbg !2436
  store i32 -1163346256, i32* %retval, align 4, !dbg !2437
  br label %return, !dbg !2437

sw.epilog:                                        ; preds = %sw.bb91, %sw.bb
  %85 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2438
  %call93 = call i32 @avio_rl32(%struct.AVIOContext* %85), !dbg !2439
  %86 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2440
  %sample_rate94 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %86, i32 0, i32 23, !dbg !2441
  store i32 %call93, i32* %sample_rate94, align 4, !dbg !2442
  %87 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2443
  %sample_rate95 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %87, i32 0, i32 23, !dbg !2445
  %88 = load i32, i32* %sample_rate95, align 4, !dbg !2445
  %cmp96 = icmp sle i32 %88, 0, !dbg !2446
  br i1 %cmp96, label %if.then98, label %if.end99, !dbg !2447

if.then98:                                        ; preds = %sw.epilog
  store i32 -1094995529, i32* %retval, align 4, !dbg !2448
  br label %return, !dbg !2448

if.end99:                                         ; preds = %sw.epilog
  %89 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2449
  %call100 = call i64 @avio_skip(%struct.AVIOContext* %89, i64 6), !dbg !2450
  %90 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2451
  %call101 = call i32 @avio_rl16(%struct.AVIOContext* %90), !dbg !2452
  %91 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2453
  %channels102 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %91, i32 0, i32 22, !dbg !2454
  store i32 %call101, i32* %channels102, align 8, !dbg !2455
  %92 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2456
  %channels103 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %92, i32 0, i32 22, !dbg !2458
  %93 = load i32, i32* %channels103, align 8, !dbg !2458
  %tobool104 = icmp ne i32 %93, 0, !dbg !2456
  br i1 %tobool104, label %if.end106, label %if.then105, !dbg !2459
...
if.end106:                                        ; preds = %if.end99
  %94 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2461
  %codec_id107 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %94, i32 0, i32 1, !dbg !2462
  %95 = load i32, i32* %codec_id107, align 4, !dbg !2462
  switch i32 %95, label %sw.epilog147 [
    i32 88076, label %sw.bb108
    i32 69650, label %sw.bb116
  ], !dbg !2463

sw.bb108:                                         ; preds = %if.end106
  %96 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2464
  %call109 = call i32 @ff_alloc_extradata(%struct.AVCodecParameters* %96, i32 34), !dbg !2466
  %97 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2467
  %extradata110 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %97, i32 0, i32 3, !dbg !2469
  %98 = load i8*, i8** %extradata110, align 8, !dbg !2469
  %tobool111 = icmp ne i8* %98, null, !dbg !2467
  br i1 %tobool111, label %if.end113, label %if.then112, !dbg !2470
...
if.end113:                                        ; preds = %sw.bb108
  %99 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2472
  %extradata114 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %99, i32 0, i32 3, !dbg !2473
  %100 = load i8*, i8** %extradata114, align 8, !dbg !2473
  call void @llvm.memset.p0i8.i64(i8* %100, i8 0, i64 34, i32 1, i1 false), !dbg !2474
  %101 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2475
  %block_align115 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %101, i32 0, i32 24, !dbg !2476
  store i32 2048, i32* %block_align115, align 8, !dbg !2477
  br label %sw.epilog147, !dbg !2478

sw.bb116:                                         ; preds = %if.end106
  %102 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2479
  %channels117 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %102, i32 0, i32 22, !dbg !2481
  %103 = load i32, i32* %channels117, align 8, !dbg !2481
  %cmp118 = icmp sgt i32 %103, 67108863, !dbg !2482
  br i1 %cmp118, label %if.then120, label %if.end121, !dbg !2483
...
if.end121:                                        ; preds = %sw.bb116
  %104 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2485
  %105 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2486
  %channels122 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %105, i32 0, i32 22, !dbg !2487
  %106 = load i32, i32* %channels122, align 8, !dbg !2487
  %mul123 = mul nsw i32 32, %106, !dbg !2488
  %call124 = call i32 @ff_alloc_extradata(%struct.AVCodecParameters* %104, i32 %mul123), !dbg !2489
  %107 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2490
  %extradata125 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %107, i32 0, i32 3, !dbg !2492
  %108 = load i8*, i8** %extradata125, align 8, !dbg !2492
  %tobool126 = icmp ne i8* %108, null, !dbg !2490
  br i1 %tobool126, label %if.end128, label %if.then127, !dbg !2493
...
if.end128:                                        ; preds = %if.end121
  %109 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2495
  %call129 = call i64 @avio_seek(%struct.AVIOContext* %109, i64 128, i32 0), !dbg !2496
  store i32 0, i32* %c, align 4, !dbg !2497
  br label %for.cond130, !dbg !2499

for.cond130:                                      ; preds = %for.inc141, %if.end128
  %110 = load i32, i32* %c, align 4, !dbg !2500
  %111 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2503
  %channels131 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %111, i32 0, i32 22, !dbg !2504
  %112 = load i32, i32* %channels131, align 8, !dbg !2504
  %cmp132 = icmp ult i32 %110, %112, !dbg !2505
  br i1 %cmp132, label %for.body134, label %for.end143, !dbg !2506

for.body134:                                      ; preds = %for.cond130
  %113 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2507
  %114 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2509
  %extradata135 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %114, i32 0, i32 3, !dbg !2510
  %115 = load i8*, i8** %extradata135, align 8, !dbg !2510
  %116 = load i32, i32* %c, align 4, !dbg !2511
  %mul136 = mul i32 32, %116, !dbg !2512
  %idx.ext137 = zext i32 %mul136 to i64, !dbg !2513
  %add.ptr138 = getelementptr inbounds i8, i8* %115, i64 %idx.ext137, !dbg !2513
  %call139 = call i32 @avio_read(%struct.AVIOContext* %113, i8* %add.ptr138, i32 32), !dbg !2514
  %117 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2515
  %call140 = call i64 @avio_skip(%struct.AVIOContext* %117, i64 14), !dbg !2516
  br label %for.inc141, !dbg !2517

for.inc141:                                       ; preds = %for.body134
  %118 = load i32, i32* %c, align 4, !dbg !2518
  %inc142 = add i32 %118, 1, !dbg !2518
  store i32 %inc142, i32* %c, align 4, !dbg !2518
  br label %for.cond130, !dbg !2520, !llvm.loop !2521

for.end143:                                       ; preds = %for.cond130
  %119 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2523
  %channels144 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %119, i32 0, i32 22, !dbg !2524
  %120 = load i32, i32* %channels144, align 8, !dbg !2524
  %mul145 = mul nsw i32 8, %120, !dbg !2525
  %121 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2526
  %block_align146 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %121, i32 0, i32 24, !dbg !2527
  store i32 %mul145, i32* %block_align146, align 8, !dbg !2528
  br label %sw.epilog147, !dbg !2529

sw.epilog147:                                     ; preds = %if.end106, %for.end143, %if.end113
  br label %if.end149, !dbg !2530

if.else148:                                       ; preds = %if.else78
  br label %do.body, !dbg !2531, !llvm.loop !2533

do.body:                                          ; preds = %if.else148
  call void (i8*, i32, i8*, ...) @av_log(i8* null, i32 0, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.7, i32 0, i32 0), i32 154), !dbg !2534
  call void @abort() #7, !dbg !2539
  unreachable, !dbg !2541

do.end:                                           ; No predecessors!
  br label %if.end149

if.end149:                                        ; preds = %do.end, %sw.epilog147
  br label %if.end150

if.end150:                                        ; preds = %if.end149, %if.end77
  %122 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2542
  %123 = load i64, i64* %offset, align 8, !dbg !2543
  %124 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2544
  store %struct.AVIOContext* %124, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2545
  %125 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2546
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %125, i64 0, i32 1) #8, !dbg !2547
  %sub152 = sub nsw i64 %123, %call.i, !dbg !2548
  %call153 = call i64 @avio_skip(%struct.AVIOContext* %122, i64 %sub152), !dbg !2549
  %126 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2551
  store %struct.AVIOContext* %126, %struct.AVIOContext** %s.addr.i156, align 8, !dbg !2552
  %127 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i156, align 8, !dbg !2553
  %call.i157 = call i64 @avio_seek(%struct.AVIOContext* %127, i64 0, i32 1) #8, !dbg !2554
  %128 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2555
  %internal = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %128, i32 0, i32 55, !dbg !2556
  %129 = load %struct.AVFormatInternal*, %struct.AVFormatInternal** %internal, align 8, !dbg !2556
  %data_offset = getelementptr inbounds %struct.AVFormatInternal, %struct.AVFormatInternal* %129, i32 0, i32 3, !dbg !2557
  store i64 %call.i157, i64* %data_offset, align 8, !dbg !2558
  %130 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2559
  %131 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2560
  %sample_rate155 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %131, i32 0, i32 23, !dbg !2561
  %132 = load i32, i32* %sample_rate155, align 4, !dbg !2561
  call void @avpriv_set_pts_info(%struct.AVStream* %130, i32 64, i32 1, i32 %132), !dbg !2562
  store i32 0, i32* %retval, align 4, !dbg !2563
  br label %return, !dbg !2563

return:                                           ; preds = %if.end150, %if.then127, %if.then120, %if.then112, %if.then105, %if.then98, %sw.default, %if.else73, %if.then63, %if.then57, %if.then26, %if.then20, %if.then6, %if.then
  %133 = load i32, i32* %retval, align 4, !dbg !2564
  ret i32 %133, !dbg !2564
}

; Function Attrs: nounwind uwtable
define internal i32 @fsb_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2565 {
entry:
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2185, metadata !2150), !dbg !2568
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2570, metadata !2150), !dbg !2571
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2572, metadata !2150), !dbg !2573
  call void @llvm.dbg.declare(metadata %struct.AVCodecParameters** %par, metadata !2574, metadata !2150), !dbg !2575
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2576
  %streams = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 7, !dbg !2577
  %1 = load %struct.AVStream**, %struct.AVStream*** %streams, align 8, !dbg !2577
  %arrayidx = getelementptr inbounds %struct.AVStream*, %struct.AVStream** %1, i64 0, !dbg !2576
  %2 = load %struct.AVStream*, %struct.AVStream** %arrayidx, align 8, !dbg !2576
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %2, i32 0, i32 19, !dbg !2578
  %3 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2578
  store %struct.AVCodecParameters* %3, %struct.AVCodecParameters** %par, align 8, !dbg !2575
  call void @llvm.dbg.declare(metadata i64* %pos, metadata !2579, metadata !2150), !dbg !2580
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2581, metadata !2150), !dbg !2582
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2583
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %4, i32 0, i32 4, !dbg !2585
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2585
  %call = call i32 @avio_feof(%struct.AVIOContext* %5), !dbg !2586
  %tobool = icmp ne i32 %call, 0, !dbg !2586
  br i1 %tobool, label %if.then, label %if.end, !dbg !2587

if.then:                                          ; preds = %entry
  store i32 -541478725, i32* %retval, align 4, !dbg !2588
  br label %return, !dbg !2588

if.end:                                           ; preds = %entry
  %6 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2589
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %6, i32 0, i32 4, !dbg !2590
  %7 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2590
  store %struct.AVIOContext* %7, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2591
  %8 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2592
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %8, i64 0, i32 1) #8, !dbg !2593
  store i64 %call.i, i64* %pos, align 8, !dbg !2594
  %9 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2595
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %9, i32 0, i32 1, !dbg !2597
  %10 = load i32, i32* %codec_id, align 4, !dbg !2597
  %cmp = icmp eq i32 %10, 69650, !dbg !2598
  br i1 %cmp, label %land.lhs.true, label %if.else, !dbg !2599

land.lhs.true:                                    ; preds = %if.end
  %11 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2600
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %11, i32 0, i32 22, !dbg !2601
  %12 = load i32, i32* %channels, align 8, !dbg !2601
  %cmp3 = icmp sgt i32 %12, 1, !dbg !2602
  br i1 %cmp3, label %if.then4, label %if.else, !dbg !2603

if.then4:                                         ; preds = %land.lhs.true
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2605, metadata !2150), !dbg !2607
  call void @llvm.dbg.declare(metadata i32* %ch, metadata !2608, metadata !2150), !dbg !2609
  %13 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2610
  %14 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2611
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %14, i32 0, i32 24, !dbg !2612
  %15 = load i32, i32* %block_align, align 8, !dbg !2612
  %call5 = call i32 @av_new_packet(%struct.AVPacket* %13, i32 %15), !dbg !2613
  store i32 %call5, i32* %ret, align 4, !dbg !2614
  %16 = load i32, i32* %ret, align 4, !dbg !2615
  %cmp6 = icmp slt i32 %16, 0, !dbg !2617
  br i1 %cmp6, label %if.then7, label %if.end8, !dbg !2618

if.then7:                                         ; preds = %if.then4
  %17 = load i32, i32* %ret, align 4, !dbg !2619
  store i32 %17, i32* %retval, align 4, !dbg !2620
...
for.cond:                                         ; preds = %for.inc29, %if.end8
  %18 = load i32, i32* %i, align 4, !dbg !2624
  %cmp9 = icmp slt i32 %18, 4, !dbg !2627
  br i1 %cmp9, label %for.body, label %for.end31, !dbg !2628

for.body:                                         ; preds = %for.cond
  store i32 0, i32* %ch, align 4, !dbg !2629
  br label %for.cond10, !dbg !2632

for.cond10:                                       ; preds = %for.inc, %for.body
  %19 = load i32, i32* %ch, align 4, !dbg !2633
  %20 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2636
  %channels11 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %20, i32 0, i32 22, !dbg !2637
  %21 = load i32, i32* %channels11, align 8, !dbg !2637
  %cmp12 = icmp slt i32 %19, %21, !dbg !2638
  br i1 %cmp12, label %for.body13, label %for.end, !dbg !2639

for.body13:                                       ; preds = %for.cond10
  %22 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2640
  %pb14 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %22, i32 0, i32 4, !dbg !2642
  %23 = load %struct.AVIOContext*, %struct.AVIOContext** %pb14, align 8, !dbg !2642
  %call15 = call i32 @avio_r8(%struct.AVIOContext* %23), !dbg !2643
  %conv = trunc i32 %call15 to i8, !dbg !2643
  %24 = load i32, i32* %ch, align 4, !dbg !2644
  %mul = mul nsw i32 %24, 8, !dbg !2645
  %25 = load i32, i32* %i, align 4, !dbg !2646
  %mul16 = mul nsw i32 %25, 2, !dbg !2647
  %add = add nsw i32 %mul, %mul16, !dbg !2648
  %add17 = add nsw i32 %add, 0, !dbg !2649
  %idxprom = sext i32 %add17 to i64, !dbg !2650
  %26 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2650
  %data = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %26, i32 0, i32 3, !dbg !2651
  %27 = load i8*, i8** %data, align 8, !dbg !2651
  %arrayidx18 = getelementptr inbounds i8, i8* %27, i64 %idxprom, !dbg !2650
  store i8 %conv, i8* %arrayidx18, align 1, !dbg !2652
  %28 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2653
  %pb19 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %28, i32 0, i32 4, !dbg !2654
  %29 = load %struct.AVIOContext*, %struct.AVIOContext** %pb19, align 8, !dbg !2654
  %call20 = call i32 @avio_r8(%struct.AVIOContext* %29), !dbg !2655
  %conv21 = trunc i32 %call20 to i8, !dbg !2655
  %30 = load i32, i32* %ch, align 4, !dbg !2656
  %mul22 = mul nsw i32 %30, 8, !dbg !2657
  %31 = load i32, i32* %i, align 4, !dbg !2658
  %mul23 = mul nsw i32 %31, 2, !dbg !2659
  %add24 = add nsw i32 %mul22, %mul23, !dbg !2660
  %add25 = add nsw i32 %add24, 1, !dbg !2661
  %idxprom26 = sext i32 %add25 to i64, !dbg !2662
  %32 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2662
  %data27 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %32, i32 0, i32 3, !dbg !2663
  %33 = load i8*, i8** %data27, align 8, !dbg !2663
  %arrayidx28 = getelementptr inbounds i8, i8* %33, i64 %idxprom26, !dbg !2662
  store i8 %conv21, i8* %arrayidx28, align 1, !dbg !2664
  br label %for.inc, !dbg !2665

for.inc:                                          ; preds = %for.body13
  %34 = load i32, i32* %ch, align 4, !dbg !2666
  %inc = add nsw i32 %34, 1, !dbg !2666
  store i32 %inc, i32* %ch, align 4, !dbg !2666
  br label %for.cond10, !dbg !2668, !llvm.loop !2669

for.end:                                          ; preds = %for.cond10
  br label %for.inc29, !dbg !2671

for.inc29:                                        ; preds = %for.end
  %35 = load i32, i32* %i, align 4, !dbg !2672
  %inc30 = add nsw i32 %35, 1, !dbg !2672
  store i32 %inc30, i32* %i, align 4, !dbg !2672
  br label %for.cond, !dbg !2674, !llvm.loop !2675

for.end31:                                        ; preds = %for.cond
  store i32 0, i32* %ret, align 4, !dbg !2677
  br label %if.end35, !dbg !2678

if.else:                                          ; preds = %land.lhs.true, %if.end
  %36 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2679
  %pb32 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %36, i32 0, i32 4, !dbg !2681
  %37 = load %struct.AVIOContext*, %struct.AVIOContext** %pb32, align 8, !dbg !2681
  %38 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2682
  %39 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2683
  %block_align33 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %39, i32 0, i32 24, !dbg !2684
  %40 = load i32, i32* %block_align33, align 8, !dbg !2684
  %call34 = call i32 @av_get_packet(%struct.AVIOContext* %37, %struct.AVPacket* %38, i32 %40), !dbg !2685
  store i32 %call34, i32* %ret, align 4, !dbg !2686
  br label %if.end35

if.end35:                                         ; preds = %if.else, %for.end31
  %41 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2687
  %codec_id36 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %41, i32 0, i32 1, !dbg !2689
  %42 = load i32, i32* %codec_id36, align 4, !dbg !2689
  %cmp37 = icmp eq i32 %42, 88076, !dbg !2690
  br i1 %cmp37, label %land.lhs.true39, label %if.end48, !dbg !2691

land.lhs.true39:                                  ; preds = %if.end35
  %43 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2692
  %size = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %43, i32 0, i32 4, !dbg !2694
  %44 = load i32, i32* %size, align 8, !dbg !2694
  %cmp40 = icmp sge i32 %44, 1, !dbg !2695
  br i1 %cmp40, label %if.then42, label %if.end48, !dbg !2696

if.then42:                                        ; preds = %land.lhs.true39
  %45 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2697
  %data43 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %45, i32 0, i32 3, !dbg !2698
  %46 = load i8*, i8** %data43, align 8, !dbg !2698
  %arrayidx44 = getelementptr inbounds i8, i8* %46, i64 0, !dbg !2697
  %47 = load i8, i8* %arrayidx44, align 1, !dbg !2697
  %conv45 = zext i8 %47 to i32, !dbg !2697
  %shr = ashr i32 %conv45, 2, !dbg !2699
  %mul46 = mul nsw i32 %shr, 512, !dbg !2700
  %conv47 = sext i32 %mul46 to i64, !dbg !2701
  %48 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2702
  %duration = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %48, i32 0, i32 9, !dbg !2703
  store i64 %conv47, i64* %duration, align 8, !dbg !2704
  br label %if.end48, !dbg !2702

if.end48:                                         ; preds = %if.then42, %land.lhs.true39, %if.end35
  %49 = load i64, i64* %pos, align 8, !dbg !2705
  %50 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2706
  %pos49 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %50, i32 0, i32 10, !dbg !2707
  store i64 %49, i64* %pos49, align 8, !dbg !2708
  %51 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2709
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %51, i32 0, i32 5, !dbg !2710
  store i32 0, i32* %stream_index, align 4, !dbg !2711
  %52 = load i32, i32* %ret, align 4, !dbg !2712
  store i32 %52, i32* %retval, align 4, !dbg !2713
  br label %return, !dbg !2713

return:                                           ; preds = %if.end48, %if.then7, %if.then
  %53 = load i32, i32* %retval, align 4, !dbg !2714
  ret i32 %53, !dbg !2714
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--fsb.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!928 = !{!929}
!929 = distinct !DIGlobalVariable(name: "ff_fsb_demuxer", scope: !0, file: !930, line: 202, type: !931, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_fsb_demuxer)
!930 = !DIFile(filename: "libavformat/fsb.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!933 = !{!934, !938, !939, !940, !941, !951, !992, !993, !995, !996, !997, !1011, !2125, !2126, !2127, !2131, !2135, !2136, !2137, !2141, !2142, !2143}
...
!961 = !{!935, !927}
!962 = !DIDerivedType(tag: DW_TAG_member, name: "option", scope: !955, file: !464, line: 85, baseType: !963, size: 64, align: 64, offset: 128)
...
!966 = !DIDerivedType(tag: DW_TAG_member, name: "version", scope: !955, file: !464, line: 93, baseType: !926, size: 32, align: 32, offset: 192)
!967 = !DIDerivedType(tag: DW_TAG_member, name: "log_level_offset_offset", scope: !955, file: !464, line: 99, baseType: !926, size: 32, align: 32, offset: 224)
!968 = !DIDerivedType(tag: DW_TAG_member, name: "parent_log_context_offset", scope: !955, file: !464, line: 108, baseType: !926, size: 32, align: 32, offset: 256)
!969 = !DIDerivedType(tag: DW_TAG_member, name: "child_next", scope: !955, file: !464, line: 113, baseType: !970, size: 64, align: 64, offset: 320)
!970 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !971, size: 64, align: 64)
!971 = !DISubroutineType(types: !972)
!972 = !{!927, !927, !927}
!973 = !DIDerivedType(tag: DW_TAG_member, name: "child_class_next", scope: !955, file: !464, line: 123, baseType: !974, size: 64, align: 64, offset: 384)
!974 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !975, size: 64, align: 64)
!975 = !DISubroutineType(types: !976)
!976 = !{!977, !977}
!977 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !978, size: 64, align: 64)
!978 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !955)
!979 = !DIDerivedType(tag: DW_TAG_member, name: "category", scope: !955, file: !464, line: 130, baseType: !980, size: 32, align: 32, offset: 448)
!980 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVClassCategory", file: !464, line: 48, baseType: !463)
!981 = !DIDerivedType(tag: DW_TAG_member, name: "get_category", scope: !955, file: !464, line: 136, baseType: !982, size: 64, align: 64, offset: 512)
!982 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !983, size: 64, align: 64)
!983 = !DISubroutineType(types: !984)
!984 = !{!980, !927}
!985 = !DIDerivedType(tag: DW_TAG_member, name: "query_ranges", scope: !955, file: !464, line: 142, baseType: !986, size: 64, align: 64, offset: 576)
!986 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !987, size: 64, align: 64)
!987 = !DISubroutineType(types: !988)
!988 = !{!926, !989, !927, !935, !926}
...
!992 = !DIDerivedType(tag: DW_TAG_member, name: "mime_type", scope: !932, file: !897, line: 670, baseType: !935, size: 64, align: 64, offset: 384)
!993 = !DIDerivedType(tag: DW_TAG_member, name: "next", scope: !932, file: !897, line: 679, baseType: !994, size: 64, align: 64, offset: 448)
!994 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !932, size: 64, align: 64)
!995 = !DIDerivedType(tag: DW_TAG_member, name: "raw_codec_id", scope: !932, file: !897, line: 684, baseType: !926, size: 32, align: 32, offset: 512)
!996 = !DIDerivedType(tag: DW_TAG_member, name: "priv_data_size", scope: !932, file: !897, line: 689, baseType: !926, size: 32, align: 32, offset: 544)
!997 = !DIDerivedType(tag: DW_TAG_member, name: "read_probe", scope: !932, file: !897, line: 696, baseType: !998, size: 64, align: 64, offset: 576)
...
!1011 = !DIDerivedType(tag: DW_TAG_member, name: "read_header", scope: !932, file: !897, line: 703, baseType: !1012, size: 64, align: 64, offset: 640)
...
!1017 = !{!1018, !1019, !1020, !1221, !1222, !1287, !1288, !1289, !1982, !1986, !1987, !1988, !1989, !1990, !1991, !1992, !1993, !1994, !1995, !1996, !1997, !1998, !2019, !2020, !2021, !2022, !2023, !2024, !2025, !2036, !2037, !2038, !2039, !2040, !2046, !2047, !2048, !2049, !2050, !2051, !2052, !2053, !2054, !2055, !2056, !2057, !2058, !2059, !2060, !2061, !2062, !2063, !2064, !2065, !2066, !2067, !2091, !2092, !2095, !2096, !2097, !2098, !2099, !2100, !2102, !2103, !2104, !2105, !2113, !2114, !2118, !2122, !2123, !2124}
!1018 = !DIDerivedType(tag: DW_TAG_member, name: "av_class", scope: !1016, file: !897, line: 1342, baseType: !952, size: 64, align: 64)
...
!1023 = !{!1024, !1025, !1026, !1027, !1028, !1029, !1030, !1031, !1032, !1033, !1034, !1035, !1036, !1037, !1080, !1081, !1085, !1089, !1094, !1101, !1196, !1202, !1208, !1209, !1210, !1211, !1215}
!1024 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !1022, file: !897, line: 498, baseType: !935, size: 64, align: 64)
!1025 = !DIDerivedType(tag: DW_TAG_member, name: "long_name", scope: !1022, file: !897, line: 504, baseType: !935, size: 64, align: 64, offset: 64)
!1026 = !DIDerivedType(tag: DW_TAG_member, name: "mime_type", scope: !1022, file: !897, line: 505, baseType: !935, size: 64, align: 64, offset: 128)
!1027 = !DIDerivedType(tag: DW_TAG_member, name: "extensions", scope: !1022, file: !897, line: 506, baseType: !935, size: 64, align: 64, offset: 192)
...
!1032 = !DIDerivedType(tag: DW_TAG_member, name: "codec_tag", scope: !1022, file: !897, line: 523, baseType: !942, size: 64, align: 64, offset: 384)
!1033 = !DIDerivedType(tag: DW_TAG_member, name: "priv_class", scope: !1022, file: !897, line: 526, baseType: !952, size: 64, align: 64, offset: 448)
...
!1044 = !{!1045, !1059, !1063, !1064, !1065, !1066, !1067, !1068, !1076, !1077, !1078, !1079}
...
!1061 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/sys/types.h", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
!1062 = !DIBasicType(name: "long int", size: 64, align: 64, encoding: DW_ATE_signed)
!1063 = !DIDerivedType(tag: DW_TAG_member, name: "dts", scope: !1043, file: !4, line: 1467, baseType: !1060, size: 64, align: 64, offset: 128)
...
!1077 = !DIDerivedType(tag: DW_TAG_member, name: "duration", scope: !1043, file: !4, line: 1486, baseType: !1060, size: 64, align: 64, offset: 512)
!1078 = !DIDerivedType(tag: DW_TAG_member, name: "pos", scope: !1043, file: !4, line: 1488, baseType: !1060, size: 64, align: 64, offset: 576)
!1079 = !DIDerivedType(tag: DW_TAG_member, name: "convergence_duration", scope: !1043, file: !4, line: 1497, baseType: !1060, size: 64, align: 64, offset: 640)
!1080 = !DIDerivedType(tag: DW_TAG_member, name: "write_trailer", scope: !1022, file: !897, line: 550, baseType: !1012, size: 64, align: 64, offset: 768)
!1081 = !DIDerivedType(tag: DW_TAG_member, name: "interleave_packet", scope: !1022, file: !897, line: 554, baseType: !1082, size: 64, align: 64, offset: 832)
!1082 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1083, size: 64, align: 64)
!1083 = !DISubroutineType(types: !1084)
!1084 = !{!926, !1015, !1041, !1041, !926}
!1085 = !DIDerivedType(tag: DW_TAG_member, name: "query_codec", scope: !1022, file: !897, line: 563, baseType: !1086, size: 64, align: 64, offset: 896)
!1086 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1087, size: 64, align: 64)
!1087 = !DISubroutineType(types: !1088)
!1088 = !{!926, !3, !926}
!1089 = !DIDerivedType(tag: DW_TAG_member, name: "get_output_timestamp", scope: !1022, file: !897, line: 565, baseType: !1090, size: 64, align: 64, offset: 960)
!1090 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1091, size: 64, align: 64)
!1091 = !DISubroutineType(types: !1092)
!1092 = !{null, !1015, !926, !1093, !1093}
!1093 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1060, size: 64, align: 64)
!1094 = !DIDerivedType(tag: DW_TAG_member, name: "control_message", scope: !1022, file: !897, line: 570, baseType: !1095, size: 64, align: 64, offset: 1024)
!1095 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1096, size: 64, align: 64)
!1096 = !DISubroutineType(types: !1097)
!1097 = !{!926, !1015, !926, !927, !1098}
...
!1101 = !DIDerivedType(tag: DW_TAG_member, name: "write_uncoded_frame", scope: !1022, file: !897, line: 581, baseType: !1102, size: 64, align: 64, offset: 1088)
!1102 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1103, size: 64, align: 64)
!1103 = !DISubroutineType(types: !1104)
!1104 = !{!926, !1015, !926, !1105, !925}
...
!1111 = !DICompositeType(tag: DW_TAG_array_type, baseType: !1056, size: 512, align: 64, elements: !1112)
!1112 = !{!1113}
...
!1117 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1056, size: 64, align: 64)
...
!1131 = !DIDerivedType(tag: DW_TAG_member, name: "pts", scope: !1108, file: !526, line: 361, baseType: !1060, size: 64, align: 64, offset: 1088)
!1132 = !DIDerivedType(tag: DW_TAG_member, name: "pkt_pts", scope: !1108, file: !526, line: 369, baseType: !1060, size: 64, align: 64, offset: 1152)
!1133 = !DIDerivedType(tag: DW_TAG_member, name: "pkt_dts", scope: !1108, file: !526, line: 377, baseType: !1060, size: 64, align: 64, offset: 1216)
...
!1145 = !DIDerivedType(tag: DW_TAG_member, name: "reordered_opaque", scope: !1108, file: !526, line: 435, baseType: !1060, size: 64, align: 64, offset: 2112)
...
!1149 = !DICompositeType(tag: DW_TAG_array_type, baseType: !1046, size: 512, align: 64, elements: !1112)
...
!1151 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1046, size: 64, align: 64)
...
!1160 = !DIDerivedType(tag: DW_TAG_member, name: "data", scope: !1157, file: !526, line: 203, baseType: !1056, size: 64, align: 64, offset: 64)
...
!1167 = !DIDerivedType(tag: DW_TAG_member, name: "buf", scope: !1157, file: !526, line: 206, baseType: !1046, size: 64, align: 64, offset: 256)
...
!1175 = !DIDerivedType(tag: DW_TAG_member, name: "best_effort_timestamp", scope: !1108, file: !526, line: 532, baseType: !1060, size: 64, align: 64, offset: 3264)
!1176 = !DIDerivedType(tag: DW_TAG_member, name: "pkt_pos", scope: !1108, file: !526, line: 539, baseType: !1060, size: 64, align: 64, offset: 3328)
!1177 = !DIDerivedType(tag: DW_TAG_member, name: "pkt_duration", scope: !1108, file: !526, line: 547, baseType: !1060, size: 64, align: 64, offset: 3392)
...
!1184 = !DIDerivedType(tag: DW_TAG_typedef, name: "int8_t", file: !1061, line: 194, baseType: !1185)
...
!1188 = !DIDerivedType(tag: DW_TAG_member, name: "qp_table_buf", scope: !1108, file: !526, line: 599, baseType: !1046, size: 64, align: 64, offset: 3776)
!1189 = !DIDerivedType(tag: DW_TAG_member, name: "hw_frames_ctx", scope: !1108, file: !526, line: 605, baseType: !1046, size: 64, align: 64, offset: 3840)
!1190 = !DIDerivedType(tag: DW_TAG_member, name: "opaque_ref", scope: !1108, file: !526, line: 616, baseType: !1046, size: 64, align: 64, offset: 3904)
...
!1195 = !DIDerivedType(tag: DW_TAG_member, name: "private_ref", scope: !1108, file: !526, line: 645, baseType: !1046, size: 64, align: 64, offset: 4224)
!1196 = !DIDerivedType(tag: DW_TAG_member, name: "get_device_list", scope: !1022, file: !897, line: 587, baseType: !1197, size: 64, align: 64, offset: 1152)
...
!1202 = !DIDerivedType(tag: DW_TAG_member, name: "create_device_capabilities", scope: !1022, file: !897, line: 592, baseType: !1203, size: 64, align: 64, offset: 1216)
...
!1208 = !DIDerivedType(tag: DW_TAG_member, name: "free_device_capabilities", scope: !1022, file: !897, line: 597, baseType: !1203, size: 64, align: 64, offset: 1280)
!1209 = !DIDerivedType(tag: DW_TAG_member, name: "data_codec", scope: !1022, file: !897, line: 598, baseType: !3, size: 32, align: 32, offset: 1344)
!1210 = !DIDerivedType(tag: DW_TAG_member, name: "init", scope: !1022, file: !897, line: 608, baseType: !1012, size: 64, align: 64, offset: 1408)
!1211 = !DIDerivedType(tag: DW_TAG_member, name: "deinit", scope: !1022, file: !897, line: 617, baseType: !1212, size: 64, align: 64, offset: 1472)
!1212 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1213, size: 64, align: 64)
!1213 = !DISubroutineType(types: !1214)
!1214 = !{null, !1015}
!1215 = !DIDerivedType(tag: DW_TAG_member, name: "check_bitstream", scope: !1022, file: !897, line: 623, baseType: !1216, size: 64, align: 64, offset: 1536)
!1216 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1217, size: 64, align: 64)
!1217 = !DISubroutineType(types: !1218)
!1218 = !{!926, !1015, !1219}
!1219 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1220, size: 64, align: 64)
!1220 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1042)
!1221 = !DIDerivedType(tag: DW_TAG_member, name: "priv_data", scope: !1016, file: !897, line: 1365, baseType: !927, size: 64, align: 64, offset: 192)
!1222 = !DIDerivedType(tag: DW_TAG_member, name: "pb", scope: !1016, file: !897, line: 1379, baseType: !1223, size: 64, align: 64, offset: 256)
...
!1228 = !DIDerivedType(tag: DW_TAG_member, name: "buffer", scope: !1225, file: !628, line: 226, baseType: !1007, size: 64, align: 64, offset: 64)
...
!1230 = !DIDerivedType(tag: DW_TAG_member, name: "buf_ptr", scope: !1225, file: !628, line: 228, baseType: !1007, size: 64, align: 64, offset: 192)
!1231 = !DIDerivedType(tag: DW_TAG_member, name: "buf_end", scope: !1225, file: !628, line: 229, baseType: !1007, size: 64, align: 64, offset: 256)
...
!1241 = !{!1060, !927, !1060, !926}
!1242 = !DIDerivedType(tag: DW_TAG_member, name: "pos", scope: !1225, file: !628, line: 238, baseType: !1060, size: 64, align: 64, offset: 576)
...
!1247 = !DIDerivedType(tag: DW_TAG_member, name: "checksum_ptr", scope: !1225, file: !628, line: 243, baseType: !1007, size: 64, align: 64, offset: 832)
...
!1253 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1057)
...
!1264 = !DIDerivedType(tag: DW_TAG_member, name: "maxsize", scope: !1225, file: !628, line: 266, baseType: !1060, size: 64, align: 64, offset: 1216)
!1265 = !DIDerivedType(tag: DW_TAG_member, name: "direct", scope: !1225, file: !628, line: 273, baseType: !926, size: 32, align: 32, offset: 1280)
!1266 = !DIDerivedType(tag: DW_TAG_member, name: "bytes_read", scope: !1225, file: !628, line: 279, baseType: !1060, size: 64, align: 64, offset: 1344)
...
!1276 = !{!926, !927, !1056, !926, !627, !1060}
...
!1279 = !DIDerivedType(tag: DW_TAG_member, name: "last_time", scope: !1225, file: !628, line: 332, baseType: !1060, size: 64, align: 64, offset: 1792)
...
!1283 = !{!926, !927}
!1284 = !DIDerivedType(tag: DW_TAG_member, name: "written", scope: !1225, file: !628, line: 340, baseType: !1060, size: 64, align: 64, offset: 1920)
!1285 = !DIDerivedType(tag: DW_TAG_member, name: "buf_ptr_max", scope: !1225, file: !628, line: 346, baseType: !1007, size: 64, align: 64, offset: 1984)
...
!1287 = !DIDerivedType(tag: DW_TAG_member, name: "ctx_flags", scope: !1016, file: !897, line: 1386, baseType: !926, size: 32, align: 32, offset: 320)
!1288 = !DIDerivedType(tag: DW_TAG_member, name: "nb_streams", scope: !1016, file: !897, line: 1393, baseType: !925, size: 32, align: 32, offset: 352)
!1289 = !DIDerivedType(tag: DW_TAG_member, name: "streams", scope: !1016, file: !897, line: 1405, baseType: !1290, size: 64, align: 64, offset: 384)
...
!1330 = !DIDerivedType(tag: DW_TAG_member, name: "max_lowres", scope: !1308, file: !4, line: 3493, baseType: !1057, size: 8, align: 8, offset: 576)
...
!1396 = !DICompositeType(tag: DW_TAG_array_type, baseType: !1056, size: 256, align: 64, elements: !1397)
!1397 = !{!1398}
...
!1406 = !DIDerivedType(tag: DW_TAG_member, name: "pts", scope: !1370, file: !4, line: 3926, baseType: !1060, size: 64, align: 64, offset: 192)
...
!1449 = !DIDerivedType(tag: DW_TAG_member, name: "bit_rate", scope: !1300, file: !4, line: 1606, baseType: !1060, size: 64, align: 64, offset: 448)
...
!1455 = !DIDerivedType(tag: DW_TAG_member, name: "extradata", scope: !1300, file: !4, line: 1657, baseType: !1056, size: 64, align: 64, offset: 704)
...
!1563 = !DIDerivedType(tag: DW_TAG_member, name: "rc_max_rate", scope: !1300, file: !4, line: 2430, baseType: !1060, size: 64, align: 64, offset: 4032)
!1564 = !DIDerivedType(tag: DW_TAG_member, name: "rc_min_rate", scope: !1300, file: !4, line: 2437, baseType: !1060, size: 64, align: 64, offset: 4096)
...
!1577 = !DIDerivedType(tag: DW_TAG_member, name: "timecode_frame_start", scope: !1300, file: !4, line: 2514, baseType: !1060, size: 64, align: 64, offset: 4544)
...
!1599 = !DIDerivedType(tag: DW_TAG_member, name: "reordered_opaque", scope: !1300, file: !4, line: 2709, baseType: !1060, size: 64, align: 64, offset: 5312)
...
!1668 = !DIDerivedType(tag: DW_TAG_member, name: "subtitle_header", scope: !1300, file: !4, line: 3037, baseType: !1056, size: 64, align: 64, offset: 6720)
...
!1693 = !DIDerivedType(tag: DW_TAG_member, name: "pts_correction_num_faulty_pts", scope: !1300, file: !4, line: 3129, baseType: !1060, size: 64, align: 64, offset: 7232)
!1694 = !DIDerivedType(tag: DW_TAG_member, name: "pts_correction_num_faulty_dts", scope: !1300, file: !4, line: 3130, baseType: !1060, size: 64, align: 64, offset: 7296)
!1695 = !DIDerivedType(tag: DW_TAG_member, name: "pts_correction_last_pts", scope: !1300, file: !4, line: 3131, baseType: !1060, size: 64, align: 64, offset: 7360)
!1696 = !DIDerivedType(tag: DW_TAG_member, name: "pts_correction_last_dts", scope: !1300, file: !4, line: 3132, baseType: !1060, size: 64, align: 64, offset: 7424)
...
!1703 = !DIDerivedType(tag: DW_TAG_member, name: "dump_separator", scope: !1300, file: !4, line: 3199, baseType: !1056, size: 64, align: 64, offset: 7744)
...
!1708 = !DIDerivedType(tag: DW_TAG_member, name: "hw_frames_ctx", scope: !1300, file: !4, line: 3249, baseType: !1046, size: 64, align: 64, offset: 8064)
...
!1711 = !DIDerivedType(tag: DW_TAG_member, name: "max_pixels", scope: !1300, file: !4, line: 3279, baseType: !1060, size: 64, align: 64, offset: 8192)
!1712 = !DIDerivedType(tag: DW_TAG_member, name: "hw_device_ctx", scope: !1300, file: !4, line: 3301, baseType: !1046, size: 64, align: 64, offset: 8256)
...
!1719 = !DIDerivedType(tag: DW_TAG_member, name: "start_time", scope: !1293, file: !897, line: 904, baseType: !1060, size: 64, align: 64, offset: 256)
!1720 = !DIDerivedType(tag: DW_TAG_member, name: "duration", scope: !1293, file: !897, line: 914, baseType: !1060, size: 64, align: 64, offset: 320)
!1721 = !DIDerivedType(tag: DW_TAG_member, name: "nb_frames", scope: !1293, file: !897, line: 916, baseType: !1060, size: 64, align: 64, offset: 384)
...
!1727 = !DIDerivedType(tag: DW_TAG_member, name: "attached_pic", scope: !1293, file: !897, line: 947, baseType: !1042, size: 704, align: 64, offset: 704)
...
!1741 = !DIDerivedType(tag: DW_TAG_member, name: "extradata", scope: !1736, file: !4, line: 3958, baseType: !1056, size: 64, align: 64, offset: 128)
...
!1792 = !DIDerivedType(tag: DW_TAG_member, name: "first_dts", scope: !1293, file: !897, line: 1067, baseType: !1060, size: 64, align: 64, offset: 1856)
!1793 = !DIDerivedType(tag: DW_TAG_member, name: "cur_dts", scope: !1293, file: !897, line: 1068, baseType: !1060, size: 64, align: 64, offset: 1920)
!1794 = !DIDerivedType(tag: DW_TAG_member, name: "last_IP_pts", scope: !1293, file: !897, line: 1069, baseType: !1060, size: 64, align: 64, offset: 1984)
...
!1871 = !{!1872, !1873}
!1872 = !DIDerivedType(tag: DW_TAG_member, name: "pkt", scope: !1870, file: !897, line: 2004, baseType: !1042, size: 704, align: 64)
!1873 = !DIDerivedType(tag: DW_TAG_member, name: "next", scope: !1870, file: !897, line: 2005, baseType: !1869, size: 64, align: 64, offset: 704)
!1874 = !DIDerivedType(tag: DW_TAG_member, name: "probe_data", scope: !1293, file: !897, line: 1090, baseType: !1002, size: 256, align: 64, offset: 2304)
...
!1895 = !DIDerivedType(tag: DW_TAG_member, name: "interleaver_chunk_size", scope: !1293, file: !897, line: 1113, baseType: !1060, size: 64, align: 64, offset: 3904)
!1896 = !DIDerivedType(tag: DW_TAG_member, name: "interleaver_chunk_duration", scope: !1293, file: !897, line: 1114, baseType: !1060, size: 64, align: 64, offset: 3968)
...
!1900 = !DIDerivedType(tag: DW_TAG_member, name: "start_skip_samples", scope: !1293, file: !897, line: 1142, baseType: !1060, size: 64, align: 64, offset: 4160)
!1901 = !DIDerivedType(tag: DW_TAG_member, name: "first_discard_sample", scope: !1293, file: !897, line: 1150, baseType: !1060, size: 64, align: 64, offset: 4224)
!1902 = !DIDerivedType(tag: DW_TAG_member, name: "last_discard_sample", scope: !1293, file: !897, line: 1157, baseType: !1060, size: 64, align: 64, offset: 4288)
...
!1904 = !DIDerivedType(tag: DW_TAG_member, name: "mux_ts_offset", scope: !1293, file: !897, line: 1169, baseType: !1060, size: 64, align: 64, offset: 4416)
!1905 = !DIDerivedType(tag: DW_TAG_member, name: "pts_wrap_reference", scope: !1293, file: !897, line: 1174, baseType: !1060, size: 64, align: 64, offset: 4480)
...
!1910 = !DICompositeType(tag: DW_TAG_array_type, baseType: !1057, size: 136, align: 8, elements: !1877)
!1911 = !DIDerivedType(tag: DW_TAG_member, name: "last_dts_for_order_check", scope: !1293, file: !897, line: 1202, baseType: !1060, size: 64, align: 64, offset: 5888)
!1912 = !DIDerivedType(tag: DW_TAG_member, name: "dts_ordered", scope: !1293, file: !897, line: 1203, baseType: !1057, size: 8, align: 8, offset: 5952)
!1913 = !DIDerivedType(tag: DW_TAG_member, name: "dts_misordered", scope: !1293, file: !897, line: 1204, baseType: !1057, size: 8, align: 8, offset: 5960)
...
!1919 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "AVStreamInternal", file: !947, line: 149, size: 640, align: 64, elements: !1920)
!1920 = !{!1921, !1922, !1962, !1963, !1964, !1965, !1966, !1967, !1973, !1974}
!1921 = !DIDerivedType(tag: DW_TAG_member, name: "reorder", scope: !1919, file: !947, line: 154, baseType: !926, size: 32, align: 32)
!1922 = !DIDerivedType(tag: DW_TAG_member, name: "bsfcs", scope: !1919, file: !947, line: 161, baseType: !1923, size: 64, align: 64, offset: 64)
...
!1928 = !DIDerivedType(tag: DW_TAG_member, name: "av_class", scope: !1926, file: !4, line: 5751, baseType: !952, size: 64, align: 64)
...
!1934 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !1932, file: !4, line: 5797, baseType: !935, size: 64, align: 64)
...
!1938 = !DIDerivedType(tag: DW_TAG_member, name: "priv_class", scope: !1932, file: !4, line: 5815, baseType: !952, size: 64, align: 64, offset: 128)
...
!1962 = !DIDerivedType(tag: DW_TAG_member, name: "nb_bsfcs", scope: !1919, file: !947, line: 162, baseType: !926, size: 32, align: 32, offset: 128)
!1963 = !DIDerivedType(tag: DW_TAG_member, name: "bitstream_checked", scope: !1919, file: !947, line: 167, baseType: !926, size: 32, align: 32, offset: 160)
!1964 = !DIDerivedType(tag: DW_TAG_member, name: "avctx", scope: !1919, file: !947, line: 172, baseType: !1298, size: 64, align: 64, offset: 192)
!1965 = !DIDerivedType(tag: DW_TAG_member, name: "avctx_inited", scope: !1919, file: !947, line: 176, baseType: !926, size: 32, align: 32, offset: 256)
!1966 = !DIDerivedType(tag: DW_TAG_member, name: "orig_codec_id", scope: !1919, file: !947, line: 178, baseType: !3, size: 32, align: 32, offset: 288)
!1967 = !DIDerivedType(tag: DW_TAG_member, name: "extract_extradata", scope: !1919, file: !947, line: 187, baseType: !1968, size: 192, align: 64, offset: 320)
!1968 = distinct !DICompositeType(tag: DW_TAG_structure_type, scope: !1919, file: !947, line: 183, size: 192, align: 64, elements: !1969)
!1969 = !{!1970, !1971, !1972}
!1970 = !DIDerivedType(tag: DW_TAG_member, name: "bsf", scope: !1968, file: !947, line: 184, baseType: !1924, size: 64, align: 64)
!1971 = !DIDerivedType(tag: DW_TAG_member, name: "pkt", scope: !1968, file: !947, line: 185, baseType: !1041, size: 64, align: 64, offset: 64)
!1972 = !DIDerivedType(tag: DW_TAG_member, name: "inited", scope: !1968, file: !947, line: 186, baseType: !926, size: 32, align: 32, offset: 128)
!1973 = !DIDerivedType(tag: DW_TAG_member, name: "need_context_update", scope: !1919, file: !947, line: 192, baseType: !926, size: 32, align: 32, offset: 512)
!1974 = !DIDerivedType(tag: DW_TAG_member, name: "priv_pts", scope: !1919, file: !947, line: 194, baseType: !1975, size: 64, align: 64, offset: 576)
!1975 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1976, size: 64, align: 64)
!1976 = !DIDerivedType(tag: DW_TAG_typedef, name: "FFFrac", file: !947, line: 63, baseType: !1977)
!1977 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "FFFrac", file: !947, line: 61, size: 192, align: 64, elements: !1978)
!1978 = !{!1979, !1980, !1981}
!1979 = !DIDerivedType(tag: DW_TAG_member, name: "val", scope: !1977, file: !947, line: 62, baseType: !1060, size: 64, align: 64)
!1980 = !DIDerivedType(tag: DW_TAG_member, name: "num", scope: !1977, file: !947, line: 62, baseType: !1060, size: 64, align: 64, offset: 64)
!1981 = !DIDerivedType(tag: DW_TAG_member, name: "den", scope: !1977, file: !947, line: 62, baseType: !1060, size: 64, align: 64, offset: 128)
!1982 = !DIDerivedType(tag: DW_TAG_member, name: "filename", scope: !1016, file: !897, line: 1417, baseType: !1983, size: 8192, align: 8, offset: 448)
!1983 = !DICompositeType(tag: DW_TAG_array_type, baseType: !937, size: 8192, align: 8, elements: !1984)
!1984 = !{!1985}
!1985 = !DISubrange(count: 1024)
!1986 = !DIDerivedType(tag: DW_TAG_member, name: "url", scope: !1016, file: !897, line: 1433, baseType: !1403, size: 64, align: 64, offset: 8640)
!1987 = !DIDerivedType(tag: DW_TAG_member, name: "start_time", scope: !1016, file: !897, line: 1442, baseType: !1060, size: 64, align: 64, offset: 8704)
!1988 = !DIDerivedType(tag: DW_TAG_member, name: "duration", scope: !1016, file: !897, line: 1452, baseType: !1060, size: 64, align: 64, offset: 8768)
!1989 = !DIDerivedType(tag: DW_TAG_member, name: "bit_rate", scope: !1016, file: !897, line: 1459, baseType: !1060, size: 64, align: 64, offset: 8832)
!1990 = !DIDerivedType(tag: DW_TAG_member, name: "packet_size", scope: !1016, file: !897, line: 1461, baseType: !925, size: 32, align: 32, offset: 8896)
!1991 = !DIDerivedType(tag: DW_TAG_member, name: "max_delay", scope: !1016, file: !897, line: 1462, baseType: !926, size: 32, align: 32, offset: 8928)
!1992 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !1016, file: !897, line: 1468, baseType: !926, size: 32, align: 32, offset: 8960)
!1993 = !DIDerivedType(tag: DW_TAG_member, name: "probesize", scope: !1016, file: !897, line: 1503, baseType: !1060, size: 64, align: 64, offset: 9024)
!1994 = !DIDerivedType(tag: DW_TAG_member, name: "max_analyze_duration", scope: !1016, file: !897, line: 1511, baseType: !1060, size: 64, align: 64, offset: 9088)
!1995 = !DIDerivedType(tag: DW_TAG_member, name: "key", scope: !1016, file: !897, line: 1513, baseType: !1252, size: 64, align: 64, offset: 9152)
!1996 = !DIDerivedType(tag: DW_TAG_member, name: "keylen", scope: !1016, file: !897, line: 1514, baseType: !926, size: 32, align: 32, offset: 9216)
!1997 = !DIDerivedType(tag: DW_TAG_member, name: "nb_programs", scope: !1016, file: !897, line: 1516, baseType: !925, size: 32, align: 32, offset: 9248)
!1998 = !DIDerivedType(tag: DW_TAG_member, name: "programs", scope: !1016, file: !897, line: 1517, baseType: !1999, size: 64, align: 64, offset: 9280)
...
!2019 = !DIDerivedType(tag: DW_TAG_member, name: "video_codec_id", scope: !1016, file: !897, line: 1523, baseType: !3, size: 32, align: 32, offset: 9344)
!2020 = !DIDerivedType(tag: DW_TAG_member, name: "audio_codec_id", scope: !1016, file: !897, line: 1529, baseType: !3, size: 32, align: 32, offset: 9376)
!2021 = !DIDerivedType(tag: DW_TAG_member, name: "subtitle_codec_id", scope: !1016, file: !897, line: 1535, baseType: !3, size: 32, align: 32, offset: 9408)
!2022 = !DIDerivedType(tag: DW_TAG_member, name: "max_index_size", scope: !1016, file: !897, line: 1547, baseType: !925, size: 32, align: 32, offset: 9440)
!2023 = !DIDerivedType(tag: DW_TAG_member, name: "max_picture_buffer", scope: !1016, file: !897, line: 1553, baseType: !925, size: 32, align: 32, offset: 9472)
!2024 = !DIDerivedType(tag: DW_TAG_member, name: "nb_chapters", scope: !1016, file: !897, line: 1566, baseType: !925, size: 32, align: 32, offset: 9504)
!2025 = !DIDerivedType(tag: DW_TAG_member, name: "chapters", scope: !1016, file: !897, line: 1567, baseType: !2026, size: 64, align: 64, offset: 9536)
...
!2036 = !DIDerivedType(tag: DW_TAG_member, name: "metadata", scope: !1016, file: !897, line: 1577, baseType: !1163, size: 64, align: 64, offset: 9600)
!2037 = !DIDerivedType(tag: DW_TAG_member, name: "start_time_realtime", scope: !1016, file: !897, line: 1590, baseType: !1060, size: 64, align: 64, offset: 9664)
!2038 = !DIDerivedType(tag: DW_TAG_member, name: "fps_probe_size", scope: !1016, file: !897, line: 1597, baseType: !926, size: 32, align: 32, offset: 9728)
!2039 = !DIDerivedType(tag: DW_TAG_member, name: "error_recognition", scope: !1016, file: !897, line: 1604, baseType: !926, size: 32, align: 32, offset: 9760)
!2040 = !DIDerivedType(tag: DW_TAG_member, name: "interrupt_callback", scope: !1016, file: !897, line: 1615, baseType: !2041, size: 128, align: 64, offset: 9792)
...
!2046 = !DIDerivedType(tag: DW_TAG_member, name: "debug", scope: !1016, file: !897, line: 1620, baseType: !926, size: 32, align: 32, offset: 9920)
!2047 = !DIDerivedType(tag: DW_TAG_member, name: "max_interleave_delta", scope: !1016, file: !897, line: 1639, baseType: !1060, size: 64, align: 64, offset: 9984)
!2048 = !DIDerivedType(tag: DW_TAG_member, name: "strict_std_compliance", scope: !1016, file: !897, line: 1645, baseType: !926, size: 32, align: 32, offset: 10048)
!2049 = !DIDerivedType(tag: DW_TAG_member, name: "event_flags", scope: !1016, file: !897, line: 1652, baseType: !926, size: 32, align: 32, offset: 10080)
!2050 = !DIDerivedType(tag: DW_TAG_member, name: "max_ts_probe", scope: !1016, file: !897, line: 1659, baseType: !926, size: 32, align: 32, offset: 10112)
!2051 = !DIDerivedType(tag: DW_TAG_member, name: "avoid_negative_ts", scope: !1016, file: !897, line: 1668, baseType: !926, size: 32, align: 32, offset: 10144)
!2052 = !DIDerivedType(tag: DW_TAG_member, name: "ts_id", scope: !1016, file: !897, line: 1677, baseType: !926, size: 32, align: 32, offset: 10176)
!2053 = !DIDerivedType(tag: DW_TAG_member, name: "audio_preload", scope: !1016, file: !897, line: 1685, baseType: !926, size: 32, align: 32, offset: 10208)
!2054 = !DIDerivedType(tag: DW_TAG_member, name: "max_chunk_duration", scope: !1016, file: !897, line: 1693, baseType: !926, size: 32, align: 32, offset: 10240)
!2055 = !DIDerivedType(tag: DW_TAG_member, name: "max_chunk_size", scope: !1016, file: !897, line: 1701, baseType: !926, size: 32, align: 32, offset: 10272)
!2056 = !DIDerivedType(tag: DW_TAG_member, name: "use_wallclock_as_timestamps", scope: !1016, file: !897, line: 1709, baseType: !926, size: 32, align: 32, offset: 10304)
!2057 = !DIDerivedType(tag: DW_TAG_member, name: "avio_flags", scope: !1016, file: !897, line: 1716, baseType: !926, size: 32, align: 32, offset: 10336)
!2058 = !DIDerivedType(tag: DW_TAG_member, name: "duration_estimation_method", scope: !1016, file: !897, line: 1724, baseType: !911, size: 32, align: 32, offset: 10368)
!2059 = !DIDerivedType(tag: DW_TAG_member, name: "skip_initial_bytes", scope: !1016, file: !897, line: 1731, baseType: !1060, size: 64, align: 64, offset: 10432)
!2060 = !DIDerivedType(tag: DW_TAG_member, name: "correct_ts_overflow", scope: !1016, file: !897, line: 1738, baseType: !925, size: 32, align: 32, offset: 10496)
!2061 = !DIDerivedType(tag: DW_TAG_member, name: "seek2any", scope: !1016, file: !897, line: 1745, baseType: !926, size: 32, align: 32, offset: 10528)
!2062 = !DIDerivedType(tag: DW_TAG_member, name: "flush_packets", scope: !1016, file: !897, line: 1752, baseType: !926, size: 32, align: 32, offset: 10560)
!2063 = !DIDerivedType(tag: DW_TAG_member, name: "probe_score", scope: !1016, file: !897, line: 1761, baseType: !926, size: 32, align: 32, offset: 10592)
!2064 = !DIDerivedType(tag: DW_TAG_member, name: "format_probesize", scope: !1016, file: !897, line: 1768, baseType: !926, size: 32, align: 32, offset: 10624)
!2065 = !DIDerivedType(tag: DW_TAG_member, name: "codec_whitelist", scope: !1016, file: !897, line: 1776, baseType: !1403, size: 64, align: 64, offset: 10688)
!2066 = !DIDerivedType(tag: DW_TAG_member, name: "format_whitelist", scope: !1016, file: !897, line: 1784, baseType: !1403, size: 64, align: 64, offset: 10752)
!2067 = !DIDerivedType(tag: DW_TAG_member, name: "internal", scope: !1016, file: !897, line: 1790, baseType: !2068, size: 64, align: 64, offset: 10816)
...
!2070 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "AVFormatInternal", file: !947, line: 66, size: 1088, align: 64, elements: !2071)
!2071 = !{!2072, !2073, !2074, !2075, !2076, !2077, !2078, !2079, !2080, !2081, !2082, !2083, !2084, !2085, !2086, !2087, !2088, !2089, !2090}
!2072 = !DIDerivedType(tag: DW_TAG_member, name: "nb_interleaved_streams", scope: !2070, file: !947, line: 71, baseType: !926, size: 32, align: 32)
!2073 = !DIDerivedType(tag: DW_TAG_member, name: "packet_buffer", scope: !2070, file: !947, line: 78, baseType: !1869, size: 64, align: 64, offset: 64)
!2074 = !DIDerivedType(tag: DW_TAG_member, name: "packet_buffer_end", scope: !2070, file: !947, line: 79, baseType: !1869, size: 64, align: 64, offset: 128)
!2075 = !DIDerivedType(tag: DW_TAG_member, name: "data_offset", scope: !2070, file: !947, line: 82, baseType: !1060, size: 64, align: 64, offset: 192)
!2076 = !DIDerivedType(tag: DW_TAG_member, name: "raw_packet_buffer", scope: !2070, file: !947, line: 90, baseType: !1869, size: 64, align: 64, offset: 256)
!2077 = !DIDerivedType(tag: DW_TAG_member, name: "raw_packet_buffer_end", scope: !2070, file: !947, line: 91, baseType: !1869, size: 64, align: 64, offset: 320)
!2078 = !DIDerivedType(tag: DW_TAG_member, name: "parse_queue", scope: !2070, file: !947, line: 95, baseType: !1869, size: 64, align: 64, offset: 384)
!2079 = !DIDerivedType(tag: DW_TAG_member, name: "parse_queue_end", scope: !2070, file: !947, line: 96, baseType: !1869, size: 64, align: 64, offset: 448)
!2080 = !DIDerivedType(tag: DW_TAG_member, name: "raw_packet_buffer_remaining_size", scope: !2070, file: !947, line: 101, baseType: !926, size: 32, align: 32, offset: 512)
!2081 = !DIDerivedType(tag: DW_TAG_member, name: "offset", scope: !2070, file: !947, line: 108, baseType: !1060, size: 64, align: 64, offset: 576)
!2082 = !DIDerivedType(tag: DW_TAG_member, name: "offset_timebase", scope: !2070, file: !947, line: 113, baseType: !1125, size: 64, align: 32, offset: 640)
!2083 = !DIDerivedType(tag: DW_TAG_member, name: "missing_ts_warning", scope: !2070, file: !947, line: 116, baseType: !926, size: 32, align: 32, offset: 704)
!2084 = !DIDerivedType(tag: DW_TAG_member, name: "inject_global_side_data", scope: !2070, file: !947, line: 119, baseType: !926, size: 32, align: 32, offset: 736)
!2085 = !DIDerivedType(tag: DW_TAG_member, name: "avoid_negative_ts_use_pts", scope: !2070, file: !947, line: 121, baseType: !926, size: 32, align: 32, offset: 768)
!2086 = !DIDerivedType(tag: DW_TAG_member, name: "shortest_end", scope: !2070, file: !947, line: 126, baseType: !1060, size: 64, align: 64, offset: 832)
!2087 = !DIDerivedType(tag: DW_TAG_member, name: "initialized", scope: !2070, file: !947, line: 131, baseType: !926, size: 32, align: 32, offset: 896)
!2088 = !DIDerivedType(tag: DW_TAG_member, name: "streams_initialized", scope: !2070, file: !947, line: 136, baseType: !926, size: 32, align: 32, offset: 928)
!2089 = !DIDerivedType(tag: DW_TAG_member, name: "id3v2_meta", scope: !2070, file: !947, line: 141, baseType: !1163, size: 64, align: 64, offset: 960)
!2090 = !DIDerivedType(tag: DW_TAG_member, name: "prefer_codec_framerate", scope: !2070, file: !947, line: 146, baseType: !926, size: 32, align: 32, offset: 1024)
!2091 = !DIDerivedType(tag: DW_TAG_member, name: "io_repositioned", scope: !1016, file: !897, line: 1798, baseType: !926, size: 32, align: 32, offset: 10880)
!2092 = !DIDerivedType(tag: DW_TAG_member, name: "video_codec", scope: !1016, file: !897, line: 1806, baseType: !2093, size: 64, align: 64, offset: 10944)
...
!2095 = !DIDerivedType(tag: DW_TAG_member, name: "audio_codec", scope: !1016, file: !897, line: 1814, baseType: !2093, size: 64, align: 64, offset: 11008)
!2096 = !DIDerivedType(tag: DW_TAG_member, name: "subtitle_codec", scope: !1016, file: !897, line: 1822, baseType: !2093, size: 64, align: 64, offset: 11072)
!2097 = !DIDerivedType(tag: DW_TAG_member, name: "data_codec", scope: !1016, file: !897, line: 1830, baseType: !2093, size: 64, align: 64, offset: 11136)
!2098 = !DIDerivedType(tag: DW_TAG_member, name: "metadata_header_padding", scope: !1016, file: !897, line: 1837, baseType: !926, size: 32, align: 32, offset: 11200)
!2099 = !DIDerivedType(tag: DW_TAG_member, name: "opaque", scope: !1016, file: !897, line: 1843, baseType: !927, size: 64, align: 64, offset: 11264)
!2100 = !DIDerivedType(tag: DW_TAG_member, name: "control_message_cb", scope: !1016, file: !897, line: 1848, baseType: !2101, size: 64, align: 64, offset: 11328)
!2101 = !DIDerivedType(tag: DW_TAG_typedef, name: "av_format_control_message", file: !897, line: 1305, baseType: !1095)
!2102 = !DIDerivedType(tag: DW_TAG_member, name: "output_ts_offset", scope: !1016, file: !897, line: 1854, baseType: !1060, size: 64, align: 64, offset: 11392)
!2103 = !DIDerivedType(tag: DW_TAG_member, name: "dump_separator", scope: !1016, file: !897, line: 1862, baseType: !1056, size: 64, align: 64, offset: 11456)
!2104 = !DIDerivedType(tag: DW_TAG_member, name: "data_codec_id", scope: !1016, file: !897, line: 1868, baseType: !3, size: 32, align: 32, offset: 11520)
!2105 = !DIDerivedType(tag: DW_TAG_member, name: "open_cb", scope: !1016, file: !897, line: 1889, baseType: !2106, size: 64, align: 64, offset: 11584)
!2106 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2107, size: 64, align: 64)
!2107 = !DISubroutineType(types: !2108)
!2108 = !{!926, !1015, !2109, !935, !926, !2110, !2112}
...
!2113 = !DIDerivedType(tag: DW_TAG_member, name: "protocol_whitelist", scope: !1016, file: !897, line: 1897, baseType: !1403, size: 64, align: 64, offset: 11648)
!2114 = !DIDerivedType(tag: DW_TAG_member, name: "io_open", scope: !1016, file: !897, line: 1919, baseType: !2115, size: 64, align: 64, offset: 11712)
!2115 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2116, size: 64, align: 64)
!2116 = !DISubroutineType(types: !2117)
!2117 = !{!926, !1015, !2109, !935, !926, !2112}
!2118 = !DIDerivedType(tag: DW_TAG_member, name: "io_close", scope: !1016, file: !897, line: 1925, baseType: !2119, size: 64, align: 64, offset: 11776)
!2119 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2120, size: 64, align: 64)
!2120 = !DISubroutineType(types: !2121)
!2121 = !{null, !1015, !1223}
!2122 = !DIDerivedType(tag: DW_TAG_member, name: "protocol_blacklist", scope: !1016, file: !897, line: 1932, baseType: !1403, size: 64, align: 64, offset: 11840)
!2123 = !DIDerivedType(tag: DW_TAG_member, name: "max_streams", scope: !1016, file: !897, line: 1939, baseType: !926, size: 32, align: 32, offset: 11904)
!2124 = !DIDerivedType(tag: DW_TAG_member, name: "skip_estimate_duration_from_pts", scope: !1016, file: !897, line: 1946, baseType: !926, size: 32, align: 32, offset: 11936)
!2125 = !DIDerivedType(tag: DW_TAG_member, name: "read_packet", scope: !932, file: !897, line: 714, baseType: !1038, size: 64, align: 64, offset: 704)
!2126 = !DIDerivedType(tag: DW_TAG_member, name: "read_close", scope: !932, file: !897, line: 720, baseType: !1012, size: 64, align: 64, offset: 768)
!2127 = !DIDerivedType(tag: DW_TAG_member, name: "read_seek", scope: !932, file: !897, line: 730, baseType: !2128, size: 64, align: 64, offset: 832)
!2128 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2129, size: 64, align: 64)
!2129 = !DISubroutineType(types: !2130)
!2130 = !{!926, !1015, !926, !1060, !926}
!2131 = !DIDerivedType(tag: DW_TAG_member, name: "read_timestamp", scope: !932, file: !897, line: 737, baseType: !2132, size: 64, align: 64, offset: 896)
!2132 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2133, size: 64, align: 64)
!2133 = !DISubroutineType(types: !2134)
!2134 = !{!1060, !1015, !926, !1093, !1060}
!2135 = !DIDerivedType(tag: DW_TAG_member, name: "read_play", scope: !932, file: !897, line: 744, baseType: !1012, size: 64, align: 64, offset: 960)
!2136 = !DIDerivedType(tag: DW_TAG_member, name: "read_pause", scope: !932, file: !897, line: 750, baseType: !1012, size: 64, align: 64, offset: 1024)
!2137 = !DIDerivedType(tag: DW_TAG_member, name: "read_seek2", scope: !932, file: !897, line: 758, baseType: !2138, size: 64, align: 64, offset: 1088)
!2138 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2139, size: 64, align: 64)
!2139 = !DISubroutineType(types: !2140)
!2140 = !{!926, !1015, !926, !1060, !1060, !1060, !926}
!2141 = !DIDerivedType(tag: DW_TAG_member, name: "get_device_list", scope: !932, file: !897, line: 764, baseType: !1197, size: 64, align: 64, offset: 1152)
!2142 = !DIDerivedType(tag: DW_TAG_member, name: "create_device_capabilities", scope: !932, file: !897, line: 770, baseType: !1203, size: 64, align: 64, offset: 1216)
!2143 = !DIDerivedType(tag: DW_TAG_member, name: "free_device_capabilities", scope: !932, file: !897, line: 776, baseType: !1203, size: 64, align: 64, offset: 1280)
!2144 = !{i32 2, !"Dwarf Version", i32 4}
!2145 = !{i32 2, !"Debug Info Version", i32 3}
!2146 = !{!"clang version 3.9.0 (tags/RELEASE_390/final)"}
!2147 = distinct !DISubprogram(name: "fsb_probe", scope: !930, file: !930, line: 28, type: !999, isLocal: true, isDefinition: true, scopeLine: 29, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2148)
!2148 = !{}
!2149 = !DILocalVariable(name: "p", arg: 1, scope: !2147, file: !930, line: 28, type: !1001)
!2150 = !DIExpression()
!2151 = !DILocation(line: 28, column: 35, scope: !2147)
!2152 = !DILocation(line: 30, column: 16, scope: !2153)
!2153 = distinct !DILexicalBlock(scope: !2147, file: !930, line: 30, column: 9)
!2154 = !DILocation(line: 30, column: 19, scope: !2153)
!2155 = !DILocation(line: 30, column: 9, scope: !2153)
!2156 = !DILocation(line: 30, column: 34, scope: !2153)
!2157 = !DILocation(line: 30, column: 37, scope: !2158)
!2158 = !DILexicalBlockFile(scope: !2153, file: !930, discriminator: 1)
!2159 = !DILocation(line: 30, column: 40, scope: !2158)
!2160 = !DILocation(line: 30, column: 47, scope: !2158)
!2161 = !DILocation(line: 30, column: 53, scope: !2158)
!2162 = !DILocation(line: 30, column: 57, scope: !2158)
!2163 = !DILocation(line: 30, column: 60, scope: !2164)
!2164 = !DILexicalBlockFile(scope: !2153, file: !930, discriminator: 2)
!2165 = !DILocation(line: 30, column: 63, scope: !2164)
!2166 = !DILocation(line: 30, column: 70, scope: !2164)
!2167 = !DILocation(line: 30, column: 76, scope: !2164)
!2168 = !DILocation(line: 30, column: 9, scope: !2164)
!2169 = !DILocation(line: 31, column: 9, scope: !2153)
!2170 = !DILocation(line: 32, column: 41, scope: !2171)
!2171 = distinct !DILexicalBlock(scope: !2147, file: !930, line: 32, column: 9)
!2172 = !DILocation(line: 32, column: 44, scope: !2171)
!2173 = !DILocation(line: 32, column: 48, scope: !2171)
!2174 = !DILocation(line: 32, column: 55, scope: !2171)
!2175 = !DILocation(line: 32, column: 58, scope: !2171)
!2176 = !DILocation(line: 32, column: 9, scope: !2147)
!2177 = !DILocation(line: 33, column: 9, scope: !2171)
!2178 = !DILocation(line: 34, column: 5, scope: !2147)
!2179 = !DILocation(line: 35, column: 1, scope: !2147)
!2180 = distinct !DISubprogram(name: "fsb_read_header", scope: !930, file: !930, line: 37, type: !2181, isLocal: true, isDefinition: true, scopeLine: 38, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2148)
!2181 = !DISubroutineType(types: !2182)
!2182 = !{!926, !2183}
!2183 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2184, size: 64, align: 64)
!2184 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1016)
!2185 = !DILocalVariable(name: "s", arg: 1, scope: !2186, file: !628, line: 557, type: !1223)
!2186 = distinct !DISubprogram(name: "avio_tell", scope: !628, file: !628, line: 557, type: !2187, isLocal: true, isDefinition: true, scopeLine: 558, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2148)
!2187 = !DISubroutineType(types: !2188)
!2188 = !{!1060, !1223}
!2189 = !DILocation(line: 557, column: 77, scope: !2186, inlinedAt: !2190)
!2190 = distinct !DILocation(line: 158, column: 32, scope: !2180)
!2191 = !DILocation(line: 557, column: 77, scope: !2186, inlinedAt: !2192)
!2192 = distinct !DILocation(line: 157, column: 28, scope: !2180)
!2193 = !DILocalVariable(name: "s", arg: 1, scope: !2180, file: !930, line: 37, type: !2183)
!2194 = !DILocation(line: 37, column: 45, scope: !2180)
!2195 = !DILocalVariable(name: "pb", scope: !2180, file: !930, line: 39, type: !1223)
!2196 = !DILocation(line: 39, column: 18, scope: !2180)
!2197 = !DILocation(line: 39, column: 23, scope: !2180)
!2198 = !DILocation(line: 39, column: 26, scope: !2180)
!2199 = !DILocalVariable(name: "format", scope: !2180, file: !930, line: 40, type: !925)
!2200 = !DILocation(line: 40, column: 14, scope: !2180)
!2201 = !DILocalVariable(name: "version", scope: !2180, file: !930, line: 40, type: !925)
!2202 = !DILocation(line: 40, column: 22, scope: !2180)
!2203 = !DILocalVariable(name: "c", scope: !2180, file: !930, line: 40, type: !925)
!2204 = !DILocation(line: 40, column: 31, scope: !2180)
!2205 = !DILocalVariable(name: "offset", scope: !2180, file: !930, line: 41, type: !1060)
!2206 = !DILocation(line: 41, column: 13, scope: !2180)
!2207 = !DILocalVariable(name: "par", scope: !2180, file: !930, line: 42, type: !1734)
!2208 = !DILocation(line: 42, column: 24, scope: !2180)
!2209 = !DILocalVariable(name: "st", scope: !2180, file: !930, line: 43, type: !1291)
!2210 = !DILocation(line: 43, column: 15, scope: !2180)
!2211 = !DILocation(line: 43, column: 40, scope: !2180)
!2212 = !DILocation(line: 43, column: 20, scope: !2180)
!2213 = !DILocation(line: 45, column: 15, scope: !2180)
!2214 = !DILocation(line: 45, column: 5, scope: !2180)
!2215 = !DILocation(line: 46, column: 23, scope: !2180)
!2216 = !DILocation(line: 46, column: 15, scope: !2180)
!2217 = !DILocation(line: 46, column: 27, scope: !2180)
!2218 = !DILocation(line: 46, column: 13, scope: !2180)
!2219 = !DILocation(line: 47, column: 9, scope: !2220)
!2220 = distinct !DILexicalBlock(scope: !2180, file: !930, line: 47, column: 9)
!2221 = !DILocation(line: 47, column: 17, scope: !2220)
!2222 = !DILocation(line: 47, column: 22, scope: !2220)
!2223 = !DILocation(line: 47, column: 25, scope: !2224)
!2224 = !DILexicalBlockFile(scope: !2220, file: !930, discriminator: 1)
!2225 = !DILocation(line: 47, column: 33, scope: !2224)
!2226 = !DILocation(line: 47, column: 9, scope: !2224)
!2227 = !DILocation(line: 48, column: 31, scope: !2228)
!2228 = distinct !DILexicalBlock(scope: !2220, file: !930, line: 47, column: 39)
!2229 = !DILocation(line: 48, column: 48, scope: !2228)
!2230 = !DILocation(line: 48, column: 9, scope: !2228)
!2231 = !DILocation(line: 49, column: 9, scope: !2228)
!2232 = !DILocation(line: 52, column: 15, scope: !2180)
!2233 = !DILocation(line: 52, column: 5, scope: !2180)
!2234 = !DILocation(line: 54, column: 10, scope: !2235)
!2235 = distinct !DILexicalBlock(scope: !2180, file: !930, line: 54, column: 9)
!2236 = !DILocation(line: 54, column: 9, scope: !2180)
!2237 = !DILocation(line: 55, column: 9, scope: !2235)
!2238 = !DILocation(line: 56, column: 11, scope: !2180)
!2239 = !DILocation(line: 56, column: 15, scope: !2180)
!2240 = !DILocation(line: 56, column: 9, scope: !2180)
!2241 = !DILocation(line: 57, column: 5, scope: !2180)
!2242 = !DILocation(line: 57, column: 10, scope: !2180)
!2243 = !DILocation(line: 57, column: 21, scope: !2180)
!2244 = !DILocation(line: 58, column: 5, scope: !2180)
!2245 = !DILocation(line: 58, column: 10, scope: !2180)
!2246 = !DILocation(line: 58, column: 20, scope: !2180)
!2247 = !DILocation(line: 60, column: 9, scope: !2248)
!2248 = distinct !DILexicalBlock(scope: !2180, file: !930, line: 60, column: 9)
!2249 = !DILocation(line: 60, column: 17, scope: !2248)
!2250 = !DILocation(line: 60, column: 9, scope: !2180)
!2251 = !DILocation(line: 61, column: 28, scope: !2252)
!2252 = distinct !DILexicalBlock(scope: !2248, file: !930, line: 60, column: 23)
!2253 = !DILocation(line: 61, column: 18, scope: !2252)
!2254 = !DILocation(line: 61, column: 32, scope: !2252)
!2255 = !DILocation(line: 61, column: 16, scope: !2252)
!2256 = !DILocation(line: 62, column: 19, scope: !2252)
!2257 = !DILocation(line: 62, column: 9, scope: !2252)
!2258 = !DILocation(line: 63, column: 34, scope: !2252)
!2259 = !DILocation(line: 63, column: 24, scope: !2252)
!2260 = !DILocation(line: 63, column: 9, scope: !2252)
!2261 = !DILocation(line: 63, column: 13, scope: !2252)
!2262 = !DILocation(line: 63, column: 22, scope: !2252)
!2263 = !DILocation(line: 64, column: 19, scope: !2252)
!2264 = !DILocation(line: 64, column: 9, scope: !2252)
!2265 = !DILocation(line: 65, column: 28, scope: !2252)
!2266 = !DILocation(line: 65, column: 18, scope: !2252)
!2267 = !DILocation(line: 65, column: 16, scope: !2252)
!2268 = !DILocation(line: 66, column: 38, scope: !2252)
!2269 = !DILocation(line: 66, column: 28, scope: !2252)
!2270 = !DILocation(line: 66, column: 9, scope: !2252)
!2271 = !DILocation(line: 66, column: 14, scope: !2252)
!2272 = !DILocation(line: 66, column: 26, scope: !2252)
!2273 = !DILocation(line: 67, column: 13, scope: !2274)
!2274 = distinct !DILexicalBlock(scope: !2252, file: !930, line: 67, column: 13)
!2275 = !DILocation(line: 67, column: 18, scope: !2274)
!2276 = !DILocation(line: 67, column: 30, scope: !2274)
!2277 = !DILocation(line: 67, column: 13, scope: !2252)
!2278 = !DILocation(line: 68, column: 13, scope: !2274)
!2279 = !DILocation(line: 69, column: 19, scope: !2252)
!2280 = !DILocation(line: 69, column: 9, scope: !2252)
!2281 = !DILocation(line: 70, column: 35, scope: !2252)
!2282 = !DILocation(line: 70, column: 25, scope: !2252)
!2283 = !DILocation(line: 70, column: 9, scope: !2252)
!2284 = !DILocation(line: 70, column: 14, scope: !2252)
!2285 = !DILocation(line: 70, column: 23, scope: !2252)
!2286 = !DILocation(line: 71, column: 14, scope: !2287)
!2287 = distinct !DILexicalBlock(scope: !2252, file: !930, line: 71, column: 13)
!2288 = !DILocation(line: 71, column: 19, scope: !2287)
!2289 = !DILocation(line: 71, column: 13, scope: !2252)
!2290 = !DILocation(line: 72, column: 13, scope: !2287)
!2291 = !DILocation(line: 74, column: 13, scope: !2292)
!2292 = distinct !DILexicalBlock(scope: !2252, file: !930, line: 74, column: 13)
!2293 = !DILocation(line: 74, column: 20, scope: !2292)
!2294 = !DILocation(line: 74, column: 13, scope: !2252)
!2295 = !DILocation(line: 75, column: 13, scope: !2296)
!2296 = distinct !DILexicalBlock(scope: !2292, file: !930, line: 74, column: 34)
!2297 = !DILocation(line: 75, column: 18, scope: !2296)
!2298 = !DILocation(line: 75, column: 27, scope: !2296)
!2299 = !DILocation(line: 76, column: 39, scope: !2296)
!2300 = !DILocation(line: 76, column: 44, scope: !2296)
!2301 = !DILocation(line: 76, column: 37, scope: !2296)
!2302 = !DILocation(line: 76, column: 13, scope: !2296)
!2303 = !DILocation(line: 76, column: 18, scope: !2296)
!2304 = !DILocation(line: 76, column: 30, scope: !2296)
!2305 = !DILocation(line: 77, column: 9, scope: !2296)
!2306 = !DILocation(line: 77, column: 20, scope: !2307)
!2307 = !DILexicalBlockFile(scope: !2308, file: !930, discriminator: 1)
!2308 = distinct !DILexicalBlock(scope: !2292, file: !930, line: 77, column: 20)
!2309 = !DILocation(line: 77, column: 27, scope: !2307)
!2310 = !DILocation(line: 78, column: 13, scope: !2311)
!2311 = distinct !DILexicalBlock(scope: !2308, file: !930, line: 77, column: 41)
!2312 = !DILocation(line: 78, column: 18, scope: !2311)
!2313 = !DILocation(line: 78, column: 40, scope: !2311)
!2314 = !DILocation(line: 79, column: 13, scope: !2311)
!2315 = !DILocation(line: 79, column: 18, scope: !2311)
!2316 = !DILocation(line: 79, column: 27, scope: !2311)
!2317 = !DILocation(line: 80, column: 37, scope: !2311)
!2318 = !DILocation(line: 80, column: 42, scope: !2311)
!2319 = !DILocation(line: 80, column: 35, scope: !2311)
!2320 = !DILocation(line: 80, column: 13, scope: !2311)
!2321 = !DILocation(line: 80, column: 18, scope: !2311)
!2322 = !DILocation(line: 80, column: 30, scope: !2311)
!2323 = !DILocation(line: 81, column: 9, scope: !2311)
!2324 = !DILocation(line: 81, column: 20, scope: !2325)
!2325 = !DILexicalBlockFile(scope: !2326, file: !930, discriminator: 1)
!2326 = distinct !DILexicalBlock(scope: !2308, file: !930, line: 81, column: 20)
!2327 = !DILocation(line: 81, column: 27, scope: !2325)
!2328 = !DILocation(line: 82, column: 13, scope: !2329)
!2329 = distinct !DILexicalBlock(scope: !2326, file: !930, line: 81, column: 41)
!2330 = !DILocation(line: 82, column: 18, scope: !2329)
!2331 = !DILocation(line: 82, column: 27, scope: !2329)
!2332 = !DILocation(line: 83, column: 37, scope: !2329)
!2333 = !DILocation(line: 83, column: 42, scope: !2329)
!2334 = !DILocation(line: 83, column: 35, scope: !2329)
!2335 = !DILocation(line: 83, column: 13, scope: !2329)
!2336 = !DILocation(line: 83, column: 18, scope: !2329)
!2337 = !DILocation(line: 83, column: 30, scope: !2329)
!2338 = !DILocation(line: 84, column: 9, scope: !2329)
!2339 = !DILocation(line: 84, column: 20, scope: !2340)
!2340 = !DILexicalBlockFile(scope: !2341, file: !930, discriminator: 1)
!2341 = distinct !DILexicalBlock(scope: !2326, file: !930, line: 84, column: 20)
!2342 = !DILocation(line: 84, column: 27, scope: !2340)
!2343 = !DILocation(line: 85, column: 13, scope: !2344)
!2344 = distinct !DILexicalBlock(scope: !2341, file: !930, line: 84, column: 41)
!2345 = !DILocation(line: 85, column: 18, scope: !2344)
!2346 = !DILocation(line: 85, column: 27, scope: !2344)
!2347 = !DILocation(line: 86, column: 36, scope: !2344)
!2348 = !DILocation(line: 86, column: 41, scope: !2344)
!2349 = !DILocation(line: 86, column: 34, scope: !2344)
!2350 = !DILocation(line: 86, column: 13, scope: !2344)
!2351 = !DILocation(line: 86, column: 18, scope: !2344)
!2352 = !DILocation(line: 86, column: 30, scope: !2344)
!2353 = !DILocation(line: 87, column: 17, scope: !2354)
!2354 = distinct !DILexicalBlock(scope: !2344, file: !930, line: 87, column: 17)
!2355 = !DILocation(line: 87, column: 22, scope: !2354)
!2356 = !DILocation(line: 87, column: 31, scope: !2354)
!2357 = !DILocation(line: 87, column: 17, scope: !2344)
!2358 = !DILocation(line: 88, column: 17, scope: !2354)
!2359 = !DILocation(line: 89, column: 32, scope: !2344)
!2360 = !DILocation(line: 89, column: 42, scope: !2344)
!2361 = !DILocation(line: 89, column: 47, scope: !2344)
!2362 = !DILocation(line: 89, column: 40, scope: !2344)
!2363 = !DILocation(line: 89, column: 13, scope: !2344)
!2364 = !DILocation(line: 90, column: 18, scope: !2365)
!2365 = distinct !DILexicalBlock(scope: !2344, file: !930, line: 90, column: 17)
!2366 = !DILocation(line: 90, column: 23, scope: !2365)
!2367 = !DILocation(line: 90, column: 17, scope: !2344)
!2368 = !DILocation(line: 91, column: 17, scope: !2365)
!2369 = !DILocation(line: 92, column: 23, scope: !2344)
!2370 = !DILocation(line: 92, column: 13, scope: !2344)
!2371 = !DILocation(line: 93, column: 20, scope: !2372)
!2372 = distinct !DILexicalBlock(scope: !2344, file: !930, line: 93, column: 13)
!2373 = !DILocation(line: 93, column: 18, scope: !2372)
!2374 = !DILocation(line: 93, column: 25, scope: !2375)
!2375 = !DILexicalBlockFile(scope: !2376, file: !930, discriminator: 1)
!2376 = distinct !DILexicalBlock(scope: !2372, file: !930, line: 93, column: 13)
!2377 = !DILocation(line: 93, column: 29, scope: !2375)
!2378 = !DILocation(line: 93, column: 34, scope: !2375)
!2379 = !DILocation(line: 93, column: 27, scope: !2375)
!2380 = !DILocation(line: 93, column: 13, scope: !2375)
!2381 = !DILocation(line: 94, column: 27, scope: !2382)
!2382 = distinct !DILexicalBlock(scope: !2376, file: !930, line: 93, column: 49)
!2383 = !DILocation(line: 94, column: 31, scope: !2382)
!2384 = !DILocation(line: 94, column: 36, scope: !2382)
!2385 = !DILocation(line: 94, column: 53, scope: !2382)
!2386 = !DILocation(line: 94, column: 51, scope: !2382)
!2387 = !DILocation(line: 94, column: 46, scope: !2382)
!2388 = !DILocation(line: 94, column: 17, scope: !2382)
!2389 = !DILocation(line: 95, column: 27, scope: !2382)
!2390 = !DILocation(line: 95, column: 17, scope: !2382)
!2391 = !DILocation(line: 96, column: 13, scope: !2382)
!2392 = !DILocation(line: 93, column: 45, scope: !2393)
!2393 = !DILexicalBlockFile(scope: !2376, file: !930, discriminator: 2)
!2394 = !DILocation(line: 93, column: 13, scope: !2393)
!2395 = distinct !{!2395, !2396}
!2396 = !DILocation(line: 93, column: 13, scope: !2344)
!2397 = !DILocation(line: 97, column: 9, scope: !2344)
!2398 = !DILocation(line: 98, column: 35, scope: !2399)
!2399 = distinct !DILexicalBlock(scope: !2341, file: !930, line: 97, column: 16)
!2400 = !DILocation(line: 98, column: 53, scope: !2399)
!2401 = !DILocation(line: 98, column: 13, scope: !2399)
!2402 = !DILocation(line: 99, column: 13, scope: !2399)
!2403 = !DILocation(line: 101, column: 5, scope: !2252)
!2404 = !DILocation(line: 101, column: 16, scope: !2405)
!2405 = !DILexicalBlockFile(scope: !2406, file: !930, discriminator: 1)
!2406 = distinct !DILexicalBlock(scope: !2248, file: !930, line: 101, column: 16)
!2407 = !DILocation(line: 101, column: 24, scope: !2405)
!2408 = !DILocation(line: 102, column: 28, scope: !2409)
!2409 = distinct !DILexicalBlock(scope: !2406, file: !930, line: 101, column: 30)
!2410 = !DILocation(line: 102, column: 18, scope: !2409)
!2411 = !DILocation(line: 102, column: 32, scope: !2409)
!2412 = !DILocation(line: 102, column: 16, scope: !2409)
!2413 = !DILocation(line: 103, column: 19, scope: !2409)
!2414 = !DILocation(line: 103, column: 9, scope: !2409)
!2415 = !DILocation(line: 104, column: 34, scope: !2409)
!2416 = !DILocation(line: 104, column: 24, scope: !2409)
!2417 = !DILocation(line: 104, column: 9, scope: !2409)
!2418 = !DILocation(line: 104, column: 13, scope: !2409)
!2419 = !DILocation(line: 104, column: 22, scope: !2409)
!2420 = !DILocation(line: 106, column: 28, scope: !2409)
!2421 = !DILocation(line: 106, column: 18, scope: !2409)
!2422 = !DILocation(line: 106, column: 16, scope: !2409)
!2423 = !DILocation(line: 107, column: 16, scope: !2409)
!2424 = !DILocation(line: 107, column: 9, scope: !2409)
!2425 = !DILocation(line: 112, column: 13, scope: !2426)
!2426 = distinct !DILexicalBlock(scope: !2409, file: !930, line: 107, column: 24)
!2427 = !DILocation(line: 112, column: 18, scope: !2426)
!2428 = !DILocation(line: 112, column: 27, scope: !2426)
!2429 = !DILocation(line: 113, column: 13, scope: !2426)
!2430 = !DILocation(line: 115, column: 13, scope: !2426)
!2431 = !DILocation(line: 115, column: 18, scope: !2426)
!2432 = !DILocation(line: 115, column: 27, scope: !2426)
!2433 = !DILocation(line: 116, column: 13, scope: !2426)
!2434 = !DILocation(line: 118, column: 35, scope: !2426)
!2435 = !DILocation(line: 118, column: 53, scope: !2426)
!2436 = !DILocation(line: 118, column: 13, scope: !2426)
!2437 = !DILocation(line: 119, column: 13, scope: !2426)
!2438 = !DILocation(line: 122, column: 38, scope: !2409)
!2439 = !DILocation(line: 122, column: 28, scope: !2409)
!2440 = !DILocation(line: 122, column: 9, scope: !2409)
!2441 = !DILocation(line: 122, column: 14, scope: !2409)
!2442 = !DILocation(line: 122, column: 26, scope: !2409)
!2443 = !DILocation(line: 123, column: 13, scope: !2444)
!2444 = distinct !DILexicalBlock(scope: !2409, file: !930, line: 123, column: 13)
!2445 = !DILocation(line: 123, column: 18, scope: !2444)
!2446 = !DILocation(line: 123, column: 30, scope: !2444)
!2447 = !DILocation(line: 123, column: 13, scope: !2409)
!2448 = !DILocation(line: 124, column: 13, scope: !2444)
!2449 = !DILocation(line: 125, column: 19, scope: !2409)
!2450 = !DILocation(line: 125, column: 9, scope: !2409)
!2451 = !DILocation(line: 127, column: 35, scope: !2409)
!2452 = !DILocation(line: 127, column: 25, scope: !2409)
!2453 = !DILocation(line: 127, column: 9, scope: !2409)
!2454 = !DILocation(line: 127, column: 14, scope: !2409)
!2455 = !DILocation(line: 127, column: 23, scope: !2409)
!2456 = !DILocation(line: 128, column: 14, scope: !2457)
!2457 = distinct !DILexicalBlock(scope: !2409, file: !930, line: 128, column: 13)
!2458 = !DILocation(line: 128, column: 19, scope: !2457)
!2459 = !DILocation(line: 128, column: 13, scope: !2409)
!2460 = !DILocation(line: 129, column: 13, scope: !2457)
!2461 = !DILocation(line: 131, column: 17, scope: !2409)
!2462 = !DILocation(line: 131, column: 22, scope: !2409)
!2463 = !DILocation(line: 131, column: 9, scope: !2409)
!2464 = !DILocation(line: 133, column: 32, scope: !2465)
!2465 = distinct !DILexicalBlock(scope: !2409, file: !930, line: 131, column: 32)
!2466 = !DILocation(line: 133, column: 13, scope: !2465)
!2467 = !DILocation(line: 134, column: 18, scope: !2468)
!2468 = distinct !DILexicalBlock(scope: !2465, file: !930, line: 134, column: 17)
!2469 = !DILocation(line: 134, column: 23, scope: !2468)
!2470 = !DILocation(line: 134, column: 17, scope: !2465)
!2471 = !DILocation(line: 135, column: 17, scope: !2468)
!2472 = !DILocation(line: 136, column: 20, scope: !2465)
!2473 = !DILocation(line: 136, column: 25, scope: !2465)
!2474 = !DILocation(line: 136, column: 13, scope: !2465)
!2475 = !DILocation(line: 137, column: 13, scope: !2465)
!2476 = !DILocation(line: 137, column: 18, scope: !2465)
!2477 = !DILocation(line: 137, column: 30, scope: !2465)
!2478 = !DILocation(line: 138, column: 13, scope: !2465)
!2479 = !DILocation(line: 140, column: 17, scope: !2480)
!2480 = distinct !DILexicalBlock(scope: !2465, file: !930, line: 140, column: 17)
!2481 = !DILocation(line: 140, column: 22, scope: !2480)
!2482 = !DILocation(line: 140, column: 31, scope: !2480)
!2483 = !DILocation(line: 140, column: 17, scope: !2465)
!2484 = !DILocation(line: 141, column: 17, scope: !2480)
!2485 = !DILocation(line: 142, column: 32, scope: !2465)
!2486 = !DILocation(line: 142, column: 42, scope: !2465)
!2487 = !DILocation(line: 142, column: 47, scope: !2465)
!2488 = !DILocation(line: 142, column: 40, scope: !2465)
!2489 = !DILocation(line: 142, column: 13, scope: !2465)
!2490 = !DILocation(line: 143, column: 18, scope: !2491)
!2491 = distinct !DILexicalBlock(scope: !2465, file: !930, line: 143, column: 17)
!2492 = !DILocation(line: 143, column: 23, scope: !2491)
!2493 = !DILocation(line: 143, column: 17, scope: !2465)
!2494 = !DILocation(line: 144, column: 17, scope: !2491)
!2495 = !DILocation(line: 145, column: 23, scope: !2465)
!2496 = !DILocation(line: 145, column: 13, scope: !2465)
!2497 = !DILocation(line: 146, column: 20, scope: !2498)
!2498 = distinct !DILexicalBlock(scope: !2465, file: !930, line: 146, column: 13)
!2499 = !DILocation(line: 146, column: 18, scope: !2498)
!2500 = !DILocation(line: 146, column: 25, scope: !2501)
!2501 = !DILexicalBlockFile(scope: !2502, file: !930, discriminator: 1)
!2502 = distinct !DILexicalBlock(scope: !2498, file: !930, line: 146, column: 13)
!2503 = !DILocation(line: 146, column: 29, scope: !2501)
!2504 = !DILocation(line: 146, column: 34, scope: !2501)
!2505 = !DILocation(line: 146, column: 27, scope: !2501)
!2506 = !DILocation(line: 146, column: 13, scope: !2501)
!2507 = !DILocation(line: 147, column: 27, scope: !2508)
!2508 = distinct !DILexicalBlock(scope: !2502, file: !930, line: 146, column: 49)
!2509 = !DILocation(line: 147, column: 31, scope: !2508)
!2510 = !DILocation(line: 147, column: 36, scope: !2508)
!2511 = !DILocation(line: 147, column: 53, scope: !2508)
!2512 = !DILocation(line: 147, column: 51, scope: !2508)
!2513 = !DILocation(line: 147, column: 46, scope: !2508)
!2514 = !DILocation(line: 147, column: 17, scope: !2508)
!2515 = !DILocation(line: 148, column: 27, scope: !2508)
!2516 = !DILocation(line: 148, column: 17, scope: !2508)
!2517 = !DILocation(line: 149, column: 13, scope: !2508)
!2518 = !DILocation(line: 146, column: 45, scope: !2519)
!2519 = !DILexicalBlockFile(scope: !2502, file: !930, discriminator: 2)
!2520 = !DILocation(line: 146, column: 13, scope: !2519)
!2521 = distinct !{!2521, !2522}
!2522 = !DILocation(line: 146, column: 13, scope: !2465)
!2523 = !DILocation(line: 150, column: 36, scope: !2465)
!2524 = !DILocation(line: 150, column: 41, scope: !2465)
!2525 = !DILocation(line: 150, column: 34, scope: !2465)
!2526 = !DILocation(line: 150, column: 13, scope: !2465)
!2527 = !DILocation(line: 150, column: 18, scope: !2465)
!2528 = !DILocation(line: 150, column: 30, scope: !2465)
!2529 = !DILocation(line: 151, column: 13, scope: !2465)
!2530 = !DILocation(line: 153, column: 5, scope: !2409)
!2531 = !DILocation(line: 154, column: 9, scope: !2532)
!2532 = distinct !DILexicalBlock(scope: !2406, file: !930, line: 153, column: 12)
!2533 = distinct !{!2533, !2531}
!2534 = !DILocation(line: 154, column: 26, scope: !2535)
!2535 = !DILexicalBlockFile(scope: !2536, file: !930, discriminator: 1)
!2536 = distinct !DILexicalBlock(scope: !2537, file: !930, line: 154, column: 24)
!2537 = distinct !DILexicalBlock(scope: !2538, file: !930, line: 154, column: 18)
!2538 = distinct !DILexicalBlock(scope: !2532, file: !930, line: 154, column: 12)
!2539 = !DILocation(line: 154, column: 79, scope: !2540)
!2540 = !DILexicalBlockFile(scope: !2535, file: !930, discriminator: 2)
!2541 = !DILocation(line: 154, column: 79, scope: !2535)
!2542 = !DILocation(line: 157, column: 15, scope: !2180)
!2543 = !DILocation(line: 157, column: 19, scope: !2180)
!2544 = !DILocation(line: 157, column: 38, scope: !2180)
!2545 = !DILocation(line: 157, column: 28, scope: !2180)
!2546 = !DILocation(line: 559, column: 22, scope: !2186, inlinedAt: !2192)
!2547 = !DILocation(line: 559, column: 12, scope: !2186, inlinedAt: !2192)
!2548 = !DILocation(line: 157, column: 26, scope: !2180)
!2549 = !DILocation(line: 157, column: 5, scope: !2550)
!2550 = !DILexicalBlockFile(scope: !2180, file: !930, discriminator: 1)
!2551 = !DILocation(line: 158, column: 42, scope: !2180)
!2552 = !DILocation(line: 158, column: 32, scope: !2180)
!2553 = !DILocation(line: 559, column: 22, scope: !2186, inlinedAt: !2190)
!2554 = !DILocation(line: 559, column: 12, scope: !2186, inlinedAt: !2190)
!2555 = !DILocation(line: 158, column: 5, scope: !2180)
!2556 = !DILocation(line: 158, column: 8, scope: !2180)
!2557 = !DILocation(line: 158, column: 18, scope: !2180)
!2558 = !DILocation(line: 158, column: 30, scope: !2180)
!2559 = !DILocation(line: 160, column: 25, scope: !2180)
!2560 = !DILocation(line: 160, column: 36, scope: !2180)
!2561 = !DILocation(line: 160, column: 41, scope: !2180)
!2562 = !DILocation(line: 160, column: 5, scope: !2180)
!2563 = !DILocation(line: 162, column: 5, scope: !2180)
!2564 = !DILocation(line: 163, column: 1, scope: !2180)
!2565 = distinct !DISubprogram(name: "fsb_read_packet", scope: !930, file: !930, line: 165, type: !2566, isLocal: true, isDefinition: true, scopeLine: 166, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2148)
!2566 = !DISubroutineType(types: !2567)
!2567 = !{!926, !2183, !1041}
!2568 = !DILocation(line: 557, column: 77, scope: !2186, inlinedAt: !2569)
!2569 = distinct !DILocation(line: 174, column: 11, scope: !2565)
!2570 = !DILocalVariable(name: "s", arg: 1, scope: !2565, file: !930, line: 165, type: !2183)
!2571 = !DILocation(line: 165, column: 45, scope: !2565)
!2572 = !DILocalVariable(name: "pkt", arg: 2, scope: !2565, file: !930, line: 165, type: !1041)
!2573 = !DILocation(line: 165, column: 58, scope: !2565)
!2574 = !DILocalVariable(name: "par", scope: !2565, file: !930, line: 167, type: !1734)
!2575 = !DILocation(line: 167, column: 24, scope: !2565)
!2576 = !DILocation(line: 167, column: 30, scope: !2565)
!2577 = !DILocation(line: 167, column: 33, scope: !2565)
!2578 = !DILocation(line: 167, column: 45, scope: !2565)
!2579 = !DILocalVariable(name: "pos", scope: !2565, file: !930, line: 168, type: !1060)
!2580 = !DILocation(line: 168, column: 13, scope: !2565)
!2581 = !DILocalVariable(name: "ret", scope: !2565, file: !930, line: 169, type: !926)
!2582 = !DILocation(line: 169, column: 9, scope: !2565)
!2583 = !DILocation(line: 171, column: 19, scope: !2584)
!2584 = distinct !DILexicalBlock(scope: !2565, file: !930, line: 171, column: 9)
!2585 = !DILocation(line: 171, column: 22, scope: !2584)
!2586 = !DILocation(line: 171, column: 9, scope: !2584)
!2587 = !DILocation(line: 171, column: 9, scope: !2565)
!2588 = !DILocation(line: 172, column: 9, scope: !2584)
!2589 = !DILocation(line: 174, column: 21, scope: !2565)
!2590 = !DILocation(line: 174, column: 24, scope: !2565)
!2591 = !DILocation(line: 174, column: 11, scope: !2565)
!2592 = !DILocation(line: 559, column: 22, scope: !2186, inlinedAt: !2569)
!2593 = !DILocation(line: 559, column: 12, scope: !2186, inlinedAt: !2569)
!2594 = !DILocation(line: 174, column: 9, scope: !2565)
!2595 = !DILocation(line: 175, column: 9, scope: !2596)
!2596 = distinct !DILexicalBlock(scope: !2565, file: !930, line: 175, column: 9)
!2597 = !DILocation(line: 175, column: 14, scope: !2596)
!2598 = !DILocation(line: 175, column: 23, scope: !2596)
!2599 = !DILocation(line: 175, column: 48, scope: !2596)
!2600 = !DILocation(line: 176, column: 16, scope: !2596)
!2601 = !DILocation(line: 176, column: 21, scope: !2596)
!2602 = !DILocation(line: 176, column: 30, scope: !2596)
!2603 = !DILocation(line: 175, column: 9, scope: !2604)
!2604 = !DILexicalBlockFile(scope: !2565, file: !930, discriminator: 1)
!2605 = !DILocalVariable(name: "i", scope: !2606, file: !930, line: 177, type: !926)
!2606 = distinct !DILexicalBlock(scope: !2596, file: !930, line: 176, column: 35)
!2607 = !DILocation(line: 177, column: 13, scope: !2606)
!2608 = !DILocalVariable(name: "ch", scope: !2606, file: !930, line: 177, type: !926)
!2609 = !DILocation(line: 177, column: 16, scope: !2606)
!2610 = !DILocation(line: 179, column: 29, scope: !2606)
!2611 = !DILocation(line: 179, column: 34, scope: !2606)
!2612 = !DILocation(line: 179, column: 39, scope: !2606)
!2613 = !DILocation(line: 179, column: 15, scope: !2606)
!2614 = !DILocation(line: 179, column: 13, scope: !2606)
!2615 = !DILocation(line: 180, column: 13, scope: !2616)
!2616 = distinct !DILexicalBlock(scope: !2606, file: !930, line: 180, column: 13)
!2617 = !DILocation(line: 180, column: 17, scope: !2616)
!2618 = !DILocation(line: 180, column: 13, scope: !2606)
!2619 = !DILocation(line: 181, column: 20, scope: !2616)
!2620 = !DILocation(line: 181, column: 13, scope: !2616)
!2621 = !DILocation(line: 182, column: 16, scope: !2622)
!2622 = distinct !DILexicalBlock(scope: !2606, file: !930, line: 182, column: 9)
!2623 = !DILocation(line: 182, column: 14, scope: !2622)
!2624 = !DILocation(line: 182, column: 21, scope: !2625)
!2625 = !DILexicalBlockFile(scope: !2626, file: !930, discriminator: 1)
!2626 = distinct !DILexicalBlock(scope: !2622, file: !930, line: 182, column: 9)
!2627 = !DILocation(line: 182, column: 23, scope: !2625)
!2628 = !DILocation(line: 182, column: 9, scope: !2625)
!2629 = !DILocation(line: 183, column: 21, scope: !2630)
!2630 = distinct !DILexicalBlock(scope: !2631, file: !930, line: 183, column: 13)
!2631 = distinct !DILexicalBlock(scope: !2626, file: !930, line: 182, column: 33)
!2632 = !DILocation(line: 183, column: 18, scope: !2630)
!2633 = !DILocation(line: 183, column: 26, scope: !2634)
!2634 = !DILexicalBlockFile(scope: !2635, file: !930, discriminator: 1)
!2635 = distinct !DILexicalBlock(scope: !2630, file: !930, line: 183, column: 13)
!2636 = !DILocation(line: 183, column: 31, scope: !2634)
!2637 = !DILocation(line: 183, column: 36, scope: !2634)
!2638 = !DILocation(line: 183, column: 29, scope: !2634)
!2639 = !DILocation(line: 183, column: 13, scope: !2634)
!2640 = !DILocation(line: 184, column: 57, scope: !2641)
!2641 = distinct !DILexicalBlock(scope: !2635, file: !930, line: 183, column: 52)
!2642 = !DILocation(line: 184, column: 60, scope: !2641)
!2643 = !DILocation(line: 184, column: 49, scope: !2641)
!2644 = !DILocation(line: 184, column: 27, scope: !2641)
!2645 = !DILocation(line: 184, column: 30, scope: !2641)
!2646 = !DILocation(line: 184, column: 36, scope: !2641)
!2647 = !DILocation(line: 184, column: 38, scope: !2641)
!2648 = !DILocation(line: 184, column: 34, scope: !2641)
!2649 = !DILocation(line: 184, column: 42, scope: !2641)
!2650 = !DILocation(line: 184, column: 17, scope: !2641)
!2651 = !DILocation(line: 184, column: 22, scope: !2641)
!2652 = !DILocation(line: 184, column: 47, scope: !2641)
!2653 = !DILocation(line: 185, column: 57, scope: !2641)
!2654 = !DILocation(line: 185, column: 60, scope: !2641)
!2655 = !DILocation(line: 185, column: 49, scope: !2641)
!2656 = !DILocation(line: 185, column: 27, scope: !2641)
!2657 = !DILocation(line: 185, column: 30, scope: !2641)
!2658 = !DILocation(line: 185, column: 36, scope: !2641)
!2659 = !DILocation(line: 185, column: 38, scope: !2641)
!2660 = !DILocation(line: 185, column: 34, scope: !2641)
!2661 = !DILocation(line: 185, column: 42, scope: !2641)
!2662 = !DILocation(line: 185, column: 17, scope: !2641)
!2663 = !DILocation(line: 185, column: 22, scope: !2641)
!2664 = !DILocation(line: 185, column: 47, scope: !2641)
!2665 = !DILocation(line: 186, column: 13, scope: !2641)
!2666 = !DILocation(line: 183, column: 48, scope: !2667)
!2667 = !DILexicalBlockFile(scope: !2635, file: !930, discriminator: 2)
!2668 = !DILocation(line: 183, column: 13, scope: !2667)
!2669 = distinct !{!2669, !2670}
!2670 = !DILocation(line: 183, column: 13, scope: !2631)
!2671 = !DILocation(line: 187, column: 9, scope: !2631)
!2672 = !DILocation(line: 182, column: 29, scope: !2673)
!2673 = !DILexicalBlockFile(scope: !2626, file: !930, discriminator: 2)
!2674 = !DILocation(line: 182, column: 9, scope: !2673)
!2675 = distinct !{!2675, !2676}
!2676 = !DILocation(line: 182, column: 9, scope: !2606)
!2677 = !DILocation(line: 188, column: 13, scope: !2606)
!2678 = !DILocation(line: 189, column: 5, scope: !2606)
!2679 = !DILocation(line: 190, column: 29, scope: !2680)
!2680 = distinct !DILexicalBlock(scope: !2596, file: !930, line: 189, column: 12)
!2681 = !DILocation(line: 190, column: 32, scope: !2680)
!2682 = !DILocation(line: 190, column: 36, scope: !2680)
!2683 = !DILocation(line: 190, column: 41, scope: !2680)
!2684 = !DILocation(line: 190, column: 46, scope: !2680)
!2685 = !DILocation(line: 190, column: 15, scope: !2680)
!2686 = !DILocation(line: 190, column: 13, scope: !2680)
!2687 = !DILocation(line: 193, column: 9, scope: !2688)
!2688 = distinct !DILexicalBlock(scope: !2565, file: !930, line: 193, column: 9)
!2689 = !DILocation(line: 193, column: 14, scope: !2688)
!2690 = !DILocation(line: 193, column: 23, scope: !2688)
!2691 = !DILocation(line: 193, column: 43, scope: !2688)
!2692 = !DILocation(line: 193, column: 46, scope: !2693)
!2693 = !DILexicalBlockFile(scope: !2688, file: !930, discriminator: 1)
!2694 = !DILocation(line: 193, column: 51, scope: !2693)
!2695 = !DILocation(line: 193, column: 56, scope: !2693)
!2696 = !DILocation(line: 193, column: 9, scope: !2693)
!2697 = !DILocation(line: 194, column: 26, scope: !2688)
!2698 = !DILocation(line: 194, column: 31, scope: !2688)
!2699 = !DILocation(line: 194, column: 39, scope: !2688)
!2700 = !DILocation(line: 194, column: 45, scope: !2688)
!2701 = !DILocation(line: 194, column: 25, scope: !2688)
!2702 = !DILocation(line: 194, column: 9, scope: !2688)
!2703 = !DILocation(line: 194, column: 14, scope: !2688)
!2704 = !DILocation(line: 194, column: 23, scope: !2688)
!2705 = !DILocation(line: 196, column: 16, scope: !2565)
!2706 = !DILocation(line: 196, column: 5, scope: !2565)
!2707 = !DILocation(line: 196, column: 10, scope: !2565)
!2708 = !DILocation(line: 196, column: 14, scope: !2565)
!2709 = !DILocation(line: 197, column: 5, scope: !2565)
!2710 = !DILocation(line: 197, column: 10, scope: !2565)
!2711 = !DILocation(line: 197, column: 23, scope: !2565)
!2712 = !DILocation(line: 199, column: 12, scope: !2565)
!2713 = !DILocation(line: 199, column: 5, scope: !2565)
!2714 = !DILocation(line: 200, column: 1, scope: !2565)
