; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--filmstripdec.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--filmstripdec.o.i"
...
@ff_filmstrip_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0), %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 4, i32 (%struct.AVProbeData*)* null, i32 (%struct.AVFormatContext*)* @read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* @read_seek, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
...
entry:
  ...
  %film = alloca %struct.FilmstripDemuxContext*, align 8
  ...
  call void @llvm.dbg.declare(metadata %struct.FilmstripDemuxContext** %film, metadata !2149, metadata !2147), !dbg !2155
  ...
  %2 = bitcast i8* %1 to %struct.FilmstripDemuxContext*, !dbg !2156
  store %struct.FilmstripDemuxContext* %2, %struct.FilmstripDemuxContext** %film, align 8, !dbg !2155
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2158, metadata !2147), !dbg !2159
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2160
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %3, i32 0, i32 4, !dbg !2161
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2161
  store %struct.AVIOContext* %4, %struct.AVIOContext** %pb, align 8, !dbg !2159
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2162, metadata !2147), !dbg !2163
  %5 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2164
  %pb2 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %5, i32 0, i32 4, !dbg !2166
  %6 = load %struct.AVIOContext*, %struct.AVIOContext** %pb2, align 8, !dbg !2166
  %seekable = getelementptr inbounds %struct.AVIOContext, %struct.AVIOContext* %6, i32 0, i32 19, !dbg !2167
  %7 = load i32, i32* %seekable, align 8, !dbg !2167
  %and = and i32 %7, 1, !dbg !2168
  %tobool = icmp ne i32 %and, 0, !dbg !2168
  br i1 %tobool, label %if.end, label %if.then, !dbg !2169

if.then:                                          ; preds = %entry
  store i32 -5, i32* %retval, align 4, !dbg !2170
  br label %return, !dbg !2170

if.end:                                           ; preds = %entry
  %8 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2171
  %9 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2172
  %call = call i64 @avio_size(%struct.AVIOContext* %9), !dbg !2173
  %sub = sub nsw i64 %call, 36, !dbg !2174
  %call3 = call i64 @avio_seek(%struct.AVIOContext* %8, i64 %sub, i32 0), !dbg !2175
  %10 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2177
  %call4 = call i32 @avio_rb32(%struct.AVIOContext* %10), !dbg !2179
  %cmp = icmp ne i32 %call4, 1382116964, !dbg !2180
  br i1 %cmp, label %if.then5, label %if.end6, !dbg !2181

if.then5:                                         ; preds = %if.end
  %11 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2182
  %12 = bitcast %struct.AVFormatContext* %11 to i8*, !dbg !2182
  call void (i8*, i32, i8*, ...) @av_log(i8* %12, i32 16, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.3, i32 0, i32 0)), !dbg !2184
  store i32 -1094995529, i32* %retval, align 4, !dbg !2185
  br label %return, !dbg !2185

if.end6:                                          ; preds = %if.end
  %13 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2186
  %call7 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %13, %struct.AVCodec* null), !dbg !2187
  store %struct.AVStream* %call7, %struct.AVStream** %st, align 8, !dbg !2188
  %14 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2189
  %tobool8 = icmp ne %struct.AVStream* %14, null, !dbg !2189
  br i1 %tobool8, label %if.end10, label %if.then9, !dbg !2191

if.then9:                                         ; preds = %if.end6
  store i32 -12, i32* %retval, align 4, !dbg !2192
  br label %return, !dbg !2192

if.end10:                                         ; preds = %if.end6
  %15 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2193
  %call11 = call i32 @avio_rb32(%struct.AVIOContext* %15), !dbg !2194
  %conv = zext i32 %call11 to i64, !dbg !2194
  %16 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2195
  %nb_frames = getelementptr inbounds %struct.AVStream, %struct.AVStream* %16, i32 0, i32 7, !dbg !2196
  store i64 %conv, i64* %nb_frames, align 8, !dbg !2197
  %17 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2198
  %call12 = call i32 @avio_rb16(%struct.AVIOContext* %17), !dbg !2200
  %cmp13 = icmp ne i32 %call12, 0, !dbg !2201
  br i1 %cmp13, label %if.then15, label %if.end16, !dbg !2202

if.then15:                                        ; preds = %if.end10
  %18 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2203
  %19 = bitcast %struct.AVFormatContext* %18 to i8*, !dbg !2203
  call void (i8*, i8*, ...) @avpriv_request_sample(i8* %19, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.4, i32 0, i32 0)), !dbg !2205
  store i32 -1163346256, i32* %retval, align 4, !dbg !2206
  br label %return, !dbg !2206

if.end16:                                         ; preds = %if.end10
  %20 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2207
  %call17 = call i64 @avio_skip(%struct.AVIOContext* %20, i64 2), !dbg !2208
  %21 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2209
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %21, i32 0, i32 19, !dbg !2210
  %22 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2210
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %22, i32 0, i32 0, !dbg !2211
  store i32 0, i32* %codec_type, align 8, !dbg !2212
  %23 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2213
  %codecpar18 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %23, i32 0, i32 19, !dbg !2214
  %24 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar18, align 8, !dbg !2214
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %24, i32 0, i32 1, !dbg !2215
  store i32 13, i32* %codec_id, align 4, !dbg !2216
  %25 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2217
  %codecpar19 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %25, i32 0, i32 19, !dbg !2218
  %26 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar19, align 8, !dbg !2218
  %format = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %26, i32 0, i32 5, !dbg !2219
  store i32 26, i32* %format, align 4, !dbg !2220
  %27 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2221
  %codecpar20 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %27, i32 0, i32 19, !dbg !2222
  %28 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar20, align 8, !dbg !2222
  %codec_tag = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %28, i32 0, i32 2, !dbg !2223
  store i32 0, i32* %codec_tag, align 8, !dbg !2224
  %29 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2225
  %call21 = call i32 @avio_rb16(%struct.AVIOContext* %29), !dbg !2226
  %30 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2227
  %codecpar22 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %30, i32 0, i32 19, !dbg !2228
  %31 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar22, align 8, !dbg !2228
  %width = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %31, i32 0, i32 11, !dbg !2229
  store i32 %call21, i32* %width, align 8, !dbg !2230
  %32 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2231
  %call23 = call i32 @avio_rb16(%struct.AVIOContext* %32), !dbg !2232
  %33 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2233
  %codecpar24 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %33, i32 0, i32 19, !dbg !2234
  %34 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar24, align 8, !dbg !2234
  %height = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %34, i32 0, i32 12, !dbg !2235
  store i32 %call23, i32* %height, align 4, !dbg !2236
  %35 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2237
  %call25 = call i32 @avio_rb16(%struct.AVIOContext* %35), !dbg !2238
  %36 = load %struct.FilmstripDemuxContext*, %struct.FilmstripDemuxContext** %film, align 8, !dbg !2239
  %leading = getelementptr inbounds %struct.FilmstripDemuxContext, %struct.FilmstripDemuxContext* %36, i32 0, i32 0, !dbg !2240
  store i32 %call25, i32* %leading, align 4, !dbg !2241
  %37 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2242
  %codecpar26 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %37, i32 0, i32 19, !dbg !2244
  %38 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar26, align 8, !dbg !2244
  %width27 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %38, i32 0, i32 11, !dbg !2245
  %39 = load i32, i32* %width27, align 8, !dbg !2245
  %40 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2246
  %codecpar28 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %40, i32 0, i32 19, !dbg !2247
  %41 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar28, align 8, !dbg !2247
  %height29 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %41, i32 0, i32 12, !dbg !2248
  %42 = load i32, i32* %height29, align 4, !dbg !2248
  %43 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2249
  %44 = bitcast %struct.AVFormatContext* %43 to i8*, !dbg !2249
  %call30 = call i32 @av_image_check_size(i32 %39, i32 %42, i32 0, i8* %44), !dbg !2250
  %cmp31 = icmp slt i32 %call30, 0, !dbg !2251
  br i1 %cmp31, label %if.then33, label %if.end34, !dbg !2252
...
if.end34:                                         ; preds = %if.end16
  %45 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2254
  %46 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2255
  %call35 = call i32 @avio_rb16(%struct.AVIOContext* %46), !dbg !2256
  call void @avpriv_set_pts_info(%struct.AVStream* %45, i32 64, i32 1, i32 %call35), !dbg !2257
  %47 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2258
  %call36 = call i64 @avio_seek(%struct.AVIOContext* %47, i64 0, i32 0), !dbg !2259
  store i32 0, i32* %retval, align 4, !dbg !2260
  br label %return, !dbg !2260

return:                                           ; preds = %if.end34, %if.then33, %if.then15, %if.then9, %if.then5, %if.then
  %48 = load i32, i32* %retval, align 4, !dbg !2261
  ret i32 %48, !dbg !2261
}

; Function Attrs: nounwind uwtable
define internal i32 @read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2262 {
entry:
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2265, metadata !2147), !dbg !2269
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  %st = alloca %struct.AVStream*, align 8
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2271, metadata !2147), !dbg !2272
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2273, metadata !2147), !dbg !2274
  call void @llvm.dbg.declare(metadata %struct.FilmstripDemuxContext** %film, metadata !2275, metadata !2147), !dbg !2276
  ...
  %2 = bitcast i8* %1 to %struct.FilmstripDemuxContext*, !dbg !2277
  store %struct.FilmstripDemuxContext* %2, %struct.FilmstripDemuxContext** %film, align 8, !dbg !2276
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2279, metadata !2147), !dbg !2280
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2281
  %streams = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %3, i32 0, i32 7, !dbg !2282
  %4 = load %struct.AVStream**, %struct.AVStream*** %streams, align 8, !dbg !2282
  %arrayidx = getelementptr inbounds %struct.AVStream*, %struct.AVStream** %4, i64 0, !dbg !2281
  %5 = load %struct.AVStream*, %struct.AVStream** %arrayidx, align 8, !dbg !2281
  store %struct.AVStream* %5, %struct.AVStream** %st, align 8, !dbg !2280
  %6 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2283
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %6, i32 0, i32 4, !dbg !2285
  %7 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2285
  %call = call i32 @avio_feof(%struct.AVIOContext* %7), !dbg !2286
  %tobool = icmp ne i32 %call, 0, !dbg !2286
  br i1 %tobool, label %if.then, label %if.end, !dbg !2287

if.then:                                          ; preds = %entry
  store i32 -5, i32* %retval, align 4, !dbg !2288
  br label %return, !dbg !2288

if.end:                                           ; preds = %entry
  %8 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2289
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %8, i32 0, i32 4, !dbg !2290
  %9 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2290
  store %struct.AVIOContext* %9, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2291
  %10 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2292
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %10, i64 0, i32 1) #3, !dbg !2293
  %11 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2294
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %11, i32 0, i32 19, !dbg !2295
  %12 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2295
  %width = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %12, i32 0, i32 11, !dbg !2296
  %13 = load i32, i32* %width, align 8, !dbg !2296
  %conv = sext i32 %13 to i64, !dbg !2294
  %14 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2297
  %codecpar3 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %14, i32 0, i32 19, !dbg !2298
  %15 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar3, align 8, !dbg !2298
  %height = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %15, i32 0, i32 12, !dbg !2299
  %16 = load i32, i32* %height, align 4, !dbg !2299
  %17 = load %struct.FilmstripDemuxContext*, %struct.FilmstripDemuxContext** %film, align 8, !dbg !2300
  %leading = getelementptr inbounds %struct.FilmstripDemuxContext, %struct.FilmstripDemuxContext* %17, i32 0, i32 0, !dbg !2301
  %18 = load i32, i32* %leading, align 4, !dbg !2301
  %add = add nsw i32 %16, %18, !dbg !2302
  %conv4 = sext i32 %add to i64, !dbg !2303
  %mul = mul nsw i64 %conv, %conv4, !dbg !2304
  %mul5 = mul nsw i64 %mul, 4, !dbg !2305
  %div = sdiv i64 %call.i, %mul5, !dbg !2306
  %19 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2307
  %dts = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %19, i32 0, i32 2, !dbg !2308
  store i64 %div, i64* %dts, align 8, !dbg !2309
  %20 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2310
  %pb6 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %20, i32 0, i32 4, !dbg !2311
  %21 = load %struct.AVIOContext*, %struct.AVIOContext** %pb6, align 8, !dbg !2311
  %22 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2312
  %23 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2313
  %codecpar7 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %23, i32 0, i32 19, !dbg !2314
  %24 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar7, align 8, !dbg !2314
  %width8 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %24, i32 0, i32 11, !dbg !2315
  %25 = load i32, i32* %width8, align 8, !dbg !2315
  %26 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2316
  %codecpar9 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %26, i32 0, i32 19, !dbg !2317
  %27 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar9, align 8, !dbg !2317
  %height10 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %27, i32 0, i32 12, !dbg !2318
  %28 = load i32, i32* %height10, align 4, !dbg !2318
  %mul11 = mul nsw i32 %25, %28, !dbg !2319
  %mul12 = mul nsw i32 %mul11, 4, !dbg !2320
  %call13 = call i32 @av_get_packet(%struct.AVIOContext* %21, %struct.AVPacket* %22, i32 %mul12), !dbg !2321
  %29 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2322
  %size = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %29, i32 0, i32 4, !dbg !2323
  store i32 %call13, i32* %size, align 8, !dbg !2324
  %30 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2325
  %pb14 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %30, i32 0, i32 4, !dbg !2326
  %31 = load %struct.AVIOContext*, %struct.AVIOContext** %pb14, align 8, !dbg !2326
  %32 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2327
  %codecpar15 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %32, i32 0, i32 19, !dbg !2328
  %33 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar15, align 8, !dbg !2328
  %width16 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %33, i32 0, i32 11, !dbg !2329
  %34 = load i32, i32* %width16, align 8, !dbg !2329
  %conv17 = sext i32 %34 to i64, !dbg !2327
  %35 = load %struct.FilmstripDemuxContext*, %struct.FilmstripDemuxContext** %film, align 8, !dbg !2330
  %leading18 = getelementptr inbounds %struct.FilmstripDemuxContext, %struct.FilmstripDemuxContext* %35, i32 0, i32 0, !dbg !2331
  %36 = load i32, i32* %leading18, align 4, !dbg !2331
  %conv19 = sext i32 %36 to i64, !dbg !2332
  %mul20 = mul nsw i64 %conv17, %conv19, !dbg !2333
  %mul21 = mul nsw i64 %mul20, 4, !dbg !2334
  %call22 = call i64 @avio_skip(%struct.AVIOContext* %31, i64 %mul21), !dbg !2335
  %37 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2336
  %size23 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %37, i32 0, i32 4, !dbg !2338
  %38 = load i32, i32* %size23, align 8, !dbg !2338
  %cmp = icmp slt i32 %38, 0, !dbg !2339
  br i1 %cmp, label %if.then25, label %if.end27, !dbg !2340

if.then25:                                        ; preds = %if.end
  %39 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2341
  %size26 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %39, i32 0, i32 4, !dbg !2342
  %40 = load i32, i32* %size26, align 8, !dbg !2342
  store i32 %40, i32* %retval, align 4, !dbg !2343
  br label %return, !dbg !2343

if.end27:                                         ; preds = %if.end
  %41 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2344
  %flags = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %41, i32 0, i32 6, !dbg !2345
  %42 = load i32, i32* %flags, align 8, !dbg !2346
  %or = or i32 %42, 1, !dbg !2346
  store i32 %or, i32* %flags, align 8, !dbg !2346
  store i32 0, i32* %retval, align 4, !dbg !2347
  br label %return, !dbg !2347

return:                                           ; preds = %if.end27, %if.then25, %if.then
  %43 = load i32, i32* %retval, align 4, !dbg !2348
  ret i32 %43, !dbg !2348
}

; Function Attrs: nounwind uwtable
define internal i32 @read_seek(%struct.AVFormatContext* %s, i32 %stream_index, i64 %timestamp, i32 %flags) #0 !dbg !2349 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  %st = alloca %struct.AVStream*, align 8
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2352, metadata !2147), !dbg !2353
  store i32 %stream_index, i32* %stream_index.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %stream_index.addr, metadata !2354, metadata !2147), !dbg !2355
  store i64 %timestamp, i64* %timestamp.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %timestamp.addr, metadata !2356, metadata !2147), !dbg !2357
  store i32 %flags, i32* %flags.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr, metadata !2358, metadata !2147), !dbg !2359
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2360, metadata !2147), !dbg !2361
  %0 = load i32, i32* %stream_index.addr, align 4, !dbg !2362
  %idxprom = sext i32 %0 to i64, !dbg !2363
  %1 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2363
  %streams = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %1, i32 0, i32 7, !dbg !2364
  %2 = load %struct.AVStream**, %struct.AVStream*** %streams, align 8, !dbg !2364
  %arrayidx = getelementptr inbounds %struct.AVStream*, %struct.AVStream** %2, i64 %idxprom, !dbg !2363
  %3 = load %struct.AVStream*, %struct.AVStream** %arrayidx, align 8, !dbg !2363
  store %struct.AVStream* %3, %struct.AVStream** %st, align 8, !dbg !2361
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2365
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %4, i32 0, i32 4, !dbg !2367
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2367
  %6 = load i64, i64* %timestamp.addr, align 8, !dbg !2368
  %cmp = icmp sgt i64 %6, 0, !dbg !2369
  br i1 %cmp, label %cond.true, label %cond.false, !dbg !2370

cond.true:                                        ; preds = %entry
  %7 = load i64, i64* %timestamp.addr, align 8, !dbg !2371
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i64 [ %7, %cond.true ], [ 0, %cond.false ], !dbg !2376
  %8 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2378
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %8, i32 0, i32 19, !dbg !2379
  %9 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2379
  %width = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %9, i32 0, i32 11, !dbg !2380
  %10 = load i32, i32* %width, align 8, !dbg !2380
  %conv = sext i32 %10 to i64, !dbg !2378
  %mul = mul nsw i64 %cond, %conv, !dbg !2381
  %11 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2382
  %codecpar1 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %11, i32 0, i32 19, !dbg !2383
  %12 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar1, align 8, !dbg !2383
  %height = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %12, i32 0, i32 12, !dbg !2384
  %13 = load i32, i32* %height, align 4, !dbg !2384
  %conv2 = sext i32 %13 to i64, !dbg !2382
  %mul3 = mul nsw i64 %mul, %conv2, !dbg !2385
  %mul4 = mul nsw i64 %mul3, 4, !dbg !2386
  %call = call i64 @avio_seek(%struct.AVIOContext* %5, i64 %mul4, i32 0), !dbg !2387
  %cmp5 = icmp slt i64 %call, 0, !dbg !2388
  br i1 %cmp5, label %if.then, label %if.end, !dbg !2387
...
return:                                           ; preds = %if.end, %if.then
  %14 = load i32, i32* %retval, align 4, !dbg !2391
  ret i32 %14, !dbg !2391
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--filmstripdec.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!922 = !{!923}
!923 = distinct !DIGlobalVariable(name: "ff_filmstrip_demuxer", scope: !0, file: !924, line: 107, type: !925, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_filmstrip_demuxer)
!924 = !DIFile(filename: "libavformat/filmstripdec.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2140 = distinct !DISubprogram(name: "read_header", scope: !924, file: !924, line: 38, type: !2141, isLocal: true, isDefinition: true, scopeLine: 39, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2145)
...
!2145 = !{}
!2146 = !DILocalVariable(name: "s", arg: 1, scope: !2140, file: !924, line: 38, type: !2143)
!2147 = !DIExpression()
!2148 = !DILocation(line: 38, column: 41, scope: !2140)
!2149 = !DILocalVariable(name: "film", scope: !2140, file: !924, line: 40, type: !2150)
!2150 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2151, size: 64, align: 64)
!2151 = !DIDerivedType(tag: DW_TAG_typedef, name: "FilmstripDemuxContext", file: !924, line: 36, baseType: !2152)
!2152 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "FilmstripDemuxContext", file: !924, line: 34, size: 32, align: 32, elements: !2153)
!2153 = !{!2154}
!2154 = !DIDerivedType(tag: DW_TAG_member, name: "leading", scope: !2152, file: !924, line: 35, baseType: !918, size: 32, align: 32)
!2155 = !DILocation(line: 40, column: 28, scope: !2140)
!2156 = !DILocation(line: 40, column: 35, scope: !2140)
!2157 = !DILocation(line: 40, column: 38, scope: !2140)
!2158 = !DILocalVariable(name: "pb", scope: !2140, file: !924, line: 41, type: !1215)
!2159 = !DILocation(line: 41, column: 18, scope: !2140)
!2160 = !DILocation(line: 41, column: 23, scope: !2140)
!2161 = !DILocation(line: 41, column: 26, scope: !2140)
!2162 = !DILocalVariable(name: "st", scope: !2140, file: !924, line: 42, type: !1283)
!2163 = !DILocation(line: 42, column: 15, scope: !2140)
!2164 = !DILocation(line: 44, column: 11, scope: !2165)
!2165 = distinct !DILexicalBlock(scope: !2140, file: !924, line: 44, column: 9)
!2166 = !DILocation(line: 44, column: 14, scope: !2165)
!2167 = !DILocation(line: 44, column: 18, scope: !2165)
!2168 = !DILocation(line: 44, column: 27, scope: !2165)
!2169 = !DILocation(line: 44, column: 9, scope: !2140)
!2170 = !DILocation(line: 45, column: 9, scope: !2165)
!2171 = !DILocation(line: 47, column: 15, scope: !2140)
!2172 = !DILocation(line: 47, column: 29, scope: !2140)
!2173 = !DILocation(line: 47, column: 19, scope: !2140)
!2174 = !DILocation(line: 47, column: 33, scope: !2140)
!2175 = !DILocation(line: 47, column: 5, scope: !2176)
!2176 = !DILexicalBlockFile(scope: !2140, file: !924, discriminator: 1)
!2177 = !DILocation(line: 48, column: 19, scope: !2178)
!2178 = distinct !DILexicalBlock(scope: !2140, file: !924, line: 48, column: 9)
!2179 = !DILocation(line: 48, column: 9, scope: !2178)
!2180 = !DILocation(line: 48, column: 23, scope: !2178)
!2181 = !DILocation(line: 48, column: 9, scope: !2140)
!2182 = !DILocation(line: 49, column: 16, scope: !2183)
!2183 = distinct !DILexicalBlock(scope: !2178, file: !924, line: 48, column: 92)
!2184 = !DILocation(line: 49, column: 9, scope: !2183)
!2185 = !DILocation(line: 50, column: 9, scope: !2183)
!2186 = !DILocation(line: 53, column: 30, scope: !2140)
!2187 = !DILocation(line: 53, column: 10, scope: !2140)
!2188 = !DILocation(line: 53, column: 8, scope: !2140)
!2189 = !DILocation(line: 54, column: 10, scope: !2190)
!2190 = distinct !DILexicalBlock(scope: !2140, file: !924, line: 54, column: 9)
!2191 = !DILocation(line: 54, column: 9, scope: !2140)
!2192 = !DILocation(line: 55, column: 9, scope: !2190)
!2193 = !DILocation(line: 57, column: 31, scope: !2140)
!2194 = !DILocation(line: 57, column: 21, scope: !2140)
!2195 = !DILocation(line: 57, column: 5, scope: !2140)
!2196 = !DILocation(line: 57, column: 9, scope: !2140)
!2197 = !DILocation(line: 57, column: 19, scope: !2140)
!2198 = !DILocation(line: 58, column: 19, scope: !2199)
!2199 = distinct !DILexicalBlock(scope: !2140, file: !924, line: 58, column: 9)
!2200 = !DILocation(line: 58, column: 9, scope: !2199)
!2201 = !DILocation(line: 58, column: 23, scope: !2199)
!2202 = !DILocation(line: 58, column: 9, scope: !2140)
!2203 = !DILocation(line: 59, column: 31, scope: !2204)
!2204 = distinct !DILexicalBlock(scope: !2199, file: !924, line: 58, column: 29)
!2205 = !DILocation(line: 59, column: 9, scope: !2204)
!2206 = !DILocation(line: 60, column: 9, scope: !2204)
!2207 = !DILocation(line: 63, column: 15, scope: !2140)
!2208 = !DILocation(line: 63, column: 5, scope: !2140)
!2209 = !DILocation(line: 64, column: 5, scope: !2140)
!2210 = !DILocation(line: 64, column: 9, scope: !2140)
!2211 = !DILocation(line: 64, column: 19, scope: !2140)
!2212 = !DILocation(line: 64, column: 30, scope: !2140)
!2213 = !DILocation(line: 65, column: 5, scope: !2140)
!2214 = !DILocation(line: 65, column: 9, scope: !2140)
!2215 = !DILocation(line: 65, column: 19, scope: !2140)
!2216 = !DILocation(line: 65, column: 28, scope: !2140)
!2217 = !DILocation(line: 66, column: 5, scope: !2140)
!2218 = !DILocation(line: 66, column: 9, scope: !2140)
!2219 = !DILocation(line: 66, column: 19, scope: !2140)
!2220 = !DILocation(line: 66, column: 26, scope: !2140)
!2221 = !DILocation(line: 67, column: 5, scope: !2140)
!2222 = !DILocation(line: 67, column: 9, scope: !2140)
!2223 = !DILocation(line: 67, column: 19, scope: !2140)
!2224 = !DILocation(line: 67, column: 29, scope: !2140)
!2225 = !DILocation(line: 68, column: 37, scope: !2140)
!2226 = !DILocation(line: 68, column: 27, scope: !2140)
!2227 = !DILocation(line: 68, column: 5, scope: !2140)
!2228 = !DILocation(line: 68, column: 9, scope: !2140)
!2229 = !DILocation(line: 68, column: 19, scope: !2140)
!2230 = !DILocation(line: 68, column: 25, scope: !2140)
!2231 = !DILocation(line: 69, column: 38, scope: !2140)
!2232 = !DILocation(line: 69, column: 28, scope: !2140)
!2233 = !DILocation(line: 69, column: 5, scope: !2140)
!2234 = !DILocation(line: 69, column: 9, scope: !2140)
!2235 = !DILocation(line: 69, column: 19, scope: !2140)
!2236 = !DILocation(line: 69, column: 26, scope: !2140)
!2237 = !DILocation(line: 70, column: 31, scope: !2140)
!2238 = !DILocation(line: 70, column: 21, scope: !2140)
!2239 = !DILocation(line: 70, column: 5, scope: !2140)
!2240 = !DILocation(line: 70, column: 11, scope: !2140)
!2241 = !DILocation(line: 70, column: 19, scope: !2140)
!2242 = !DILocation(line: 72, column: 29, scope: !2243)
!2243 = distinct !DILexicalBlock(scope: !2140, file: !924, line: 72, column: 9)
!2244 = !DILocation(line: 72, column: 33, scope: !2243)
!2245 = !DILocation(line: 72, column: 43, scope: !2243)
!2246 = !DILocation(line: 72, column: 50, scope: !2243)
!2247 = !DILocation(line: 72, column: 54, scope: !2243)
!2248 = !DILocation(line: 72, column: 64, scope: !2243)
!2249 = !DILocation(line: 72, column: 75, scope: !2243)
!2250 = !DILocation(line: 72, column: 9, scope: !2243)
!2251 = !DILocation(line: 72, column: 78, scope: !2243)
!2252 = !DILocation(line: 72, column: 9, scope: !2140)
!2253 = !DILocation(line: 73, column: 9, scope: !2243)
!2254 = !DILocation(line: 75, column: 25, scope: !2140)
!2255 = !DILocation(line: 75, column: 46, scope: !2140)
!2256 = !DILocation(line: 75, column: 36, scope: !2140)
!2257 = !DILocation(line: 75, column: 5, scope: !2176)
!2258 = !DILocation(line: 77, column: 15, scope: !2140)
!2259 = !DILocation(line: 77, column: 5, scope: !2140)
!2260 = !DILocation(line: 79, column: 5, scope: !2140)
!2261 = !DILocation(line: 80, column: 1, scope: !2140)
!2262 = distinct !DISubprogram(name: "read_packet", scope: !924, file: !924, line: 82, type: !2263, isLocal: true, isDefinition: true, scopeLine: 84, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2145)
!2263 = !DISubroutineType(types: !2264)
!2264 = !{!918, !2143, !1036}
!2265 = !DILocalVariable(name: "s", arg: 1, scope: !2266, file: !628, line: 557, type: !1215)
!2266 = distinct !DISubprogram(name: "avio_tell", scope: !628, file: !628, line: 557, type: !2267, isLocal: true, isDefinition: true, scopeLine: 558, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2145)
!2267 = !DISubroutineType(types: !2268)
!2268 = !{!919, !1215}
!2269 = !DILocation(line: 557, column: 77, scope: !2266, inlinedAt: !2270)
!2270 = distinct !DILocation(line: 90, column: 16, scope: !2262)
!2271 = !DILocalVariable(name: "s", arg: 1, scope: !2262, file: !924, line: 82, type: !2143)
!2272 = !DILocation(line: 82, column: 41, scope: !2262)
!2273 = !DILocalVariable(name: "pkt", arg: 2, scope: !2262, file: !924, line: 83, type: !1036)
!2274 = !DILocation(line: 83, column: 34, scope: !2262)
!2275 = !DILocalVariable(name: "film", scope: !2262, file: !924, line: 85, type: !2150)
!2276 = !DILocation(line: 85, column: 28, scope: !2262)
!2277 = !DILocation(line: 85, column: 35, scope: !2262)
!2278 = !DILocation(line: 85, column: 38, scope: !2262)
!2279 = !DILocalVariable(name: "st", scope: !2262, file: !924, line: 86, type: !1283)
!2280 = !DILocation(line: 86, column: 15, scope: !2262)
!2281 = !DILocation(line: 86, column: 20, scope: !2262)
!2282 = !DILocation(line: 86, column: 23, scope: !2262)
!2283 = !DILocation(line: 88, column: 19, scope: !2284)
!2284 = distinct !DILexicalBlock(scope: !2262, file: !924, line: 88, column: 9)
!2285 = !DILocation(line: 88, column: 22, scope: !2284)
!2286 = !DILocation(line: 88, column: 9, scope: !2284)
!2287 = !DILocation(line: 88, column: 9, scope: !2262)
!2288 = !DILocation(line: 89, column: 9, scope: !2284)
!2289 = !DILocation(line: 90, column: 26, scope: !2262)
!2290 = !DILocation(line: 90, column: 29, scope: !2262)
!2291 = !DILocation(line: 90, column: 16, scope: !2262)
!2292 = !DILocation(line: 559, column: 22, scope: !2266, inlinedAt: !2270)
!2293 = !DILocation(line: 559, column: 12, scope: !2266, inlinedAt: !2270)
!2294 = !DILocation(line: 90, column: 36, scope: !2262)
!2295 = !DILocation(line: 90, column: 40, scope: !2262)
!2296 = !DILocation(line: 90, column: 50, scope: !2262)
!2297 = !DILocation(line: 90, column: 68, scope: !2262)
!2298 = !DILocation(line: 90, column: 72, scope: !2262)
!2299 = !DILocation(line: 90, column: 82, scope: !2262)
!2300 = !DILocation(line: 90, column: 91, scope: !2262)
!2301 = !DILocation(line: 90, column: 97, scope: !2262)
!2302 = !DILocation(line: 90, column: 89, scope: !2262)
!2303 = !DILocation(line: 90, column: 58, scope: !2262)
!2304 = !DILocation(line: 90, column: 56, scope: !2262)
!2305 = !DILocation(line: 90, column: 106, scope: !2262)
!2306 = !DILocation(line: 90, column: 33, scope: !2262)
!2307 = !DILocation(line: 90, column: 5, scope: !2262)
!2308 = !DILocation(line: 90, column: 10, scope: !2262)
!2309 = !DILocation(line: 90, column: 14, scope: !2262)
!2310 = !DILocation(line: 91, column: 31, scope: !2262)
!2311 = !DILocation(line: 91, column: 34, scope: !2262)
!2312 = !DILocation(line: 91, column: 38, scope: !2262)
!2313 = !DILocation(line: 91, column: 43, scope: !2262)
!2314 = !DILocation(line: 91, column: 47, scope: !2262)
!2315 = !DILocation(line: 91, column: 57, scope: !2262)
!2316 = !DILocation(line: 91, column: 65, scope: !2262)
!2317 = !DILocation(line: 91, column: 69, scope: !2262)
!2318 = !DILocation(line: 91, column: 79, scope: !2262)
!2319 = !DILocation(line: 91, column: 63, scope: !2262)
!2320 = !DILocation(line: 91, column: 86, scope: !2262)
!2321 = !DILocation(line: 91, column: 17, scope: !2262)
!2322 = !DILocation(line: 91, column: 5, scope: !2262)
!2323 = !DILocation(line: 91, column: 10, scope: !2262)
!2324 = !DILocation(line: 91, column: 15, scope: !2262)
!2325 = !DILocation(line: 92, column: 15, scope: !2262)
!2326 = !DILocation(line: 92, column: 18, scope: !2262)
!2327 = !DILocation(line: 92, column: 22, scope: !2262)
!2328 = !DILocation(line: 92, column: 26, scope: !2262)
!2329 = !DILocation(line: 92, column: 36, scope: !2262)
!2330 = !DILocation(line: 92, column: 54, scope: !2262)
!2331 = !DILocation(line: 92, column: 60, scope: !2262)
!2332 = !DILocation(line: 92, column: 44, scope: !2262)
!2333 = !DILocation(line: 92, column: 42, scope: !2262)
!2334 = !DILocation(line: 92, column: 68, scope: !2262)
!2335 = !DILocation(line: 92, column: 5, scope: !2262)
!2336 = !DILocation(line: 93, column: 9, scope: !2337)
!2337 = distinct !DILexicalBlock(scope: !2262, file: !924, line: 93, column: 9)
!2338 = !DILocation(line: 93, column: 14, scope: !2337)
!2339 = !DILocation(line: 93, column: 19, scope: !2337)
!2340 = !DILocation(line: 93, column: 9, scope: !2262)
!2341 = !DILocation(line: 94, column: 16, scope: !2337)
!2342 = !DILocation(line: 94, column: 21, scope: !2337)
!2343 = !DILocation(line: 94, column: 9, scope: !2337)
!2344 = !DILocation(line: 95, column: 5, scope: !2262)
!2345 = !DILocation(line: 95, column: 10, scope: !2262)
!2346 = !DILocation(line: 95, column: 16, scope: !2262)
!2347 = !DILocation(line: 96, column: 5, scope: !2262)
!2348 = !DILocation(line: 97, column: 1, scope: !2262)
!2349 = distinct !DISubprogram(name: "read_seek", scope: !924, file: !924, line: 99, type: !2350, isLocal: true, isDefinition: true, scopeLine: 100, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2145)
!2350 = !DISubroutineType(types: !2351)
!2351 = !{!918, !2143, !918, !919, !918}
!2352 = !DILocalVariable(name: "s", arg: 1, scope: !2349, file: !924, line: 99, type: !2143)
!2353 = !DILocation(line: 99, column: 39, scope: !2349)
!2354 = !DILocalVariable(name: "stream_index", arg: 2, scope: !2349, file: !924, line: 99, type: !918)
!2355 = !DILocation(line: 99, column: 46, scope: !2349)
!2356 = !DILocalVariable(name: "timestamp", arg: 3, scope: !2349, file: !924, line: 99, type: !919)
!2357 = !DILocation(line: 99, column: 68, scope: !2349)
!2358 = !DILocalVariable(name: "flags", arg: 4, scope: !2349, file: !924, line: 99, type: !918)
!2359 = !DILocation(line: 99, column: 83, scope: !2349)
!2360 = !DILocalVariable(name: "st", scope: !2349, file: !924, line: 101, type: !1283)
!2361 = !DILocation(line: 101, column: 15, scope: !2349)
!2362 = !DILocation(line: 101, column: 31, scope: !2349)
!2363 = !DILocation(line: 101, column: 20, scope: !2349)
!2364 = !DILocation(line: 101, column: 23, scope: !2349)
!2365 = !DILocation(line: 102, column: 19, scope: !2366)
!2366 = distinct !DILexicalBlock(scope: !2349, file: !924, line: 102, column: 9)
!2367 = !DILocation(line: 102, column: 22, scope: !2366)
!2368 = !DILocation(line: 102, column: 28, scope: !2366)
!2369 = !DILocation(line: 102, column: 39, scope: !2366)
!2370 = !DILocation(line: 102, column: 27, scope: !2366)
!2371 = !DILocation(line: 102, column: 48, scope: !2372)
!2372 = !DILexicalBlockFile(scope: !2366, file: !924, discriminator: 1)
!2373 = !DILocation(line: 102, column: 27, scope: !2372)
!2374 = !DILocation(line: 102, column: 27, scope: !2375)
!2375 = !DILexicalBlockFile(scope: !2366, file: !924, discriminator: 2)
!2376 = !DILocation(line: 102, column: 27, scope: !2377)
!2377 = !DILexicalBlockFile(scope: !2366, file: !924, discriminator: 3)
!2378 = !DILocation(line: 102, column: 68, scope: !2377)
!2379 = !DILocation(line: 102, column: 72, scope: !2377)
!2380 = !DILocation(line: 102, column: 82, scope: !2377)
!2381 = !DILocation(line: 102, column: 66, scope: !2377)
!2382 = !DILocation(line: 102, column: 90, scope: !2377)
!2383 = !DILocation(line: 102, column: 94, scope: !2377)
!2384 = !DILocation(line: 102, column: 104, scope: !2377)
!2385 = !DILocation(line: 102, column: 88, scope: !2377)
!2386 = !DILocation(line: 102, column: 111, scope: !2377)
!2387 = !DILocation(line: 102, column: 9, scope: !2377)
!2388 = !DILocation(line: 102, column: 105, scope: !2377)
!2389 = !DILocation(line: 103, column: 9, scope: !2366)
!2390 = !DILocation(line: 104, column: 5, scope: !2349)
!2391 = !DILocation(line: 105, column: 1, scope: !2349)
