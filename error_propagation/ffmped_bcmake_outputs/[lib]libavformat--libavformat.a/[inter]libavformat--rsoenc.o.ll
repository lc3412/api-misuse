; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--rsoenc.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--rsoenc.o.i"
...
define internal i32 @rso_write_header(%struct.AVFormatContext* %s) #0 !dbg !2140 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2149, metadata !2147), !dbg !2150
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2151
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2152
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2152
  store %struct.AVIOContext* %1, %struct.AVIOContext** %pb, align 8, !dbg !2150
  call void @llvm.dbg.declare(metadata %struct.AVCodecParameters** %par, metadata !2153, metadata !2147), !dbg !2154
  %2 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2155
  %streams = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %2, i32 0, i32 7, !dbg !2156
  %3 = load %struct.AVStream**, %struct.AVStream*** %streams, align 8, !dbg !2156
  %arrayidx = getelementptr inbounds %struct.AVStream*, %struct.AVStream** %3, i64 0, !dbg !2155
  %4 = load %struct.AVStream*, %struct.AVStream** %arrayidx, align 8, !dbg !2155
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %4, i32 0, i32 19, !dbg !2157
  %5 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2157
  store %struct.AVCodecParameters* %5, %struct.AVCodecParameters** %par, align 8, !dbg !2154
  %6 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2158
  %codec_tag = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %6, i32 0, i32 2, !dbg !2160
  %7 = load i32, i32* %codec_tag, align 8, !dbg !2160
  %tobool = icmp ne i32 %7, 0, !dbg !2158
  br i1 %tobool, label %if.end, label %if.then, !dbg !2161

if.then:                                          ; preds = %entry
  store i32 -1094995529, i32* %retval, align 4, !dbg !2162
  br label %return, !dbg !2162

if.end:                                           ; preds = %entry
  %8 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2163
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %8, i32 0, i32 22, !dbg !2165
  %9 = load i32, i32* %channels, align 8, !dbg !2165
  %cmp = icmp ne i32 %9, 1, !dbg !2166
  br i1 %cmp, label %if.then2, label %if.end3, !dbg !2167

if.then2:                                         ; preds = %if.end
  %10 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2168
  %11 = bitcast %struct.AVFormatContext* %10 to i8*, !dbg !2168
  call void (i8*, i32, i8*, ...) @av_log(i8* %11, i32 16, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.2, i32 0, i32 0)), !dbg !2170
  store i32 -1094995529, i32* %retval, align 4, !dbg !2171
  br label %return, !dbg !2171

if.end3:                                          ; preds = %if.end
  %12 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2172
  %pb4 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %12, i32 0, i32 4, !dbg !2174
  %13 = load %struct.AVIOContext*, %struct.AVIOContext** %pb4, align 8, !dbg !2174
  %seekable = getelementptr inbounds %struct.AVIOContext, %struct.AVIOContext* %13, i32 0, i32 19, !dbg !2175
  %14 = load i32, i32* %seekable, align 8, !dbg !2175
  %and = and i32 %14, 1, !dbg !2176
  %tobool5 = icmp ne i32 %and, 0, !dbg !2176
  br i1 %tobool5, label %if.end7, label %if.then6, !dbg !2177

if.then6:                                         ; preds = %if.end3
  %15 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2178
  %16 = bitcast %struct.AVFormatContext* %15 to i8*, !dbg !2178
  call void (i8*, i32, i8*, ...) @av_log(i8* %16, i32 16, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.3, i32 0, i32 0)), !dbg !2180
  store i32 -1094995529, i32* %retval, align 4, !dbg !2181
  br label %return, !dbg !2181

if.end7:                                          ; preds = %if.end3
  %17 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2182
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %17, i32 0, i32 23, !dbg !2184
  %18 = load i32, i32* %sample_rate, align 4, !dbg !2184
  %cmp8 = icmp uge i32 %18, 65536, !dbg !2185
  br i1 %cmp8, label %if.then9, label %if.end10, !dbg !2186
...
if.then9:                                         ; preds = %if.end7
  ...
  call void (i8*, i32, i8*, ...) @av_log(i8* %20, i32 16, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.4, i32 0, i32 0)), !dbg !2189
  store i32 -1094995529, i32* %retval, align 4, !dbg !2190
  br label %return, !dbg !2190

if.end10:                                         ; preds = %if.end7
  %21 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2191
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %21, i32 0, i32 1, !dbg !2193
  %22 = load i32, i32* %codec_id, align 4, !dbg !2193
  %cmp11 = icmp eq i32 %22, 69633, !dbg !2194
  br i1 %cmp11, label %if.then12, label %if.end13, !dbg !2195

if.then12:                                        ; preds = %if.end10
  %23 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2196
  %24 = bitcast %struct.AVFormatContext* %23 to i8*, !dbg !2196
  call void (i8*, i8*, ...) @avpriv_report_missing_feature(i8* %24, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.5, i32 0, i32 0)), !dbg !2198
  store i32 -1163346256, i32* %retval, align 4, !dbg !2199
  br label %return, !dbg !2199

if.end13:                                         ; preds = %if.end10
  %25 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2200
  %26 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2201
  %codec_tag14 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %26, i32 0, i32 2, !dbg !2202
  %27 = load i32, i32* %codec_tag14, align 8, !dbg !2202
  call void @avio_wb16(%struct.AVIOContext* %25, i32 %27), !dbg !2203
  %28 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2204
  call void @avio_wb16(%struct.AVIOContext* %28, i32 0), !dbg !2205
  %29 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2206
  %30 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2207
  %sample_rate15 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %30, i32 0, i32 23, !dbg !2208
  %31 = load i32, i32* %sample_rate15, align 4, !dbg !2208
  call void @avio_wb16(%struct.AVIOContext* %29, i32 %31), !dbg !2209
  %32 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2210
  call void @avio_wb16(%struct.AVIOContext* %32, i32 0), !dbg !2211
  %33 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2212
  call void @avio_flush(%struct.AVIOContext* %33), !dbg !2213
...
return:                                           ; preds = %if.end13, %if.then12, %if.then9, %if.then6, %if.then2, %if.then
  %34 = load i32, i32* %retval, align 4, !dbg !2215
  ret i32 %34, !dbg !2215
}

; Function Attrs: nounwind uwtable
define internal i32 @rso_write_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2216 {
entry:
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %pkt.addr = alloca %struct.AVPacket*, align 8
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2219, metadata !2147), !dbg !2220
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2221, metadata !2147), !dbg !2222
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2223
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2224
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2224
  %2 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2225
  %data = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %2, i32 0, i32 3, !dbg !2226
  %3 = load i8*, i8** %data, align 8, !dbg !2226
  %4 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2227
  %size = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %4, i32 0, i32 4, !dbg !2228
  %5 = load i32, i32* %size, align 8, !dbg !2228
  call void @avio_write(%struct.AVIOContext* %1, i8* %3, i32 %5), !dbg !2229
  ret i32 0, !dbg !2230
}

; Function Attrs: nounwind uwtable
define internal i32 @rso_write_trailer(%struct.AVFormatContext* %s) #0 !dbg !2231 {
entry:
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2232, metadata !2147), !dbg !2236
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %pb = alloca %struct.AVIOContext*, align 8
  %file_size = alloca i64, align 8
  %coded_file_size = alloca i16, align 2
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2238, metadata !2147), !dbg !2239
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2240, metadata !2147), !dbg !2241
  ...
  call void @llvm.dbg.declare(metadata i64* %file_size, metadata !2244, metadata !2147), !dbg !2245
  call void @llvm.dbg.declare(metadata i16* %coded_file_size, metadata !2246, metadata !2147), !dbg !2247
  %2 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2248
  store %struct.AVIOContext* %2, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2249
  %3 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2250
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %3, i64 0, i32 1) #3, !dbg !2251
  store i64 %call.i, i64* %file_size, align 8, !dbg !2252
  %4 = load i64, i64* %file_size, align 8, !dbg !2253
  %cmp = icmp slt i64 %4, 0, !dbg !2255
  br i1 %cmp, label %if.then, label %if.end, !dbg !2256

if.then:                                          ; preds = %entry
  %5 = load i64, i64* %file_size, align 8, !dbg !2257
  %conv = trunc i64 %5 to i32, !dbg !2257
  store i32 %conv, i32* %retval, align 4, !dbg !2258
  br label %return, !dbg !2258

if.end:                                           ; preds = %entry
  %6 = load i64, i64* %file_size, align 8, !dbg !2259
  %cmp2 = icmp sgt i64 %6, 65543, !dbg !2261
  br i1 %cmp2, label %if.then4, label %if.else, !dbg !2262

if.then4:                                         ; preds = %if.end
  %7 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2263
  %8 = bitcast %struct.AVFormatContext* %7 to i8*, !dbg !2263
  %9 = load i64, i64* %file_size, align 8, !dbg !2265
  call void (i8*, i32, i8*, ...) @av_log(i8* %8, i32 24, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.6, i32 0, i32 0), i64 %9), !dbg !2266
  store i16 -1, i16* %coded_file_size, align 2, !dbg !2267
  br label %if.end6, !dbg !2268

if.else:                                          ; preds = %if.end
  %10 = load i64, i64* %file_size, align 8, !dbg !2269
  %sub = sub nsw i64 %10, 8, !dbg !2271
  %conv5 = trunc i64 %sub to i16, !dbg !2269
  store i16 %conv5, i16* %coded_file_size, align 2, !dbg !2272
  br label %if.end6

if.end6:                                          ; preds = %if.else, %if.then4
  %11 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2273
  %call7 = call i64 @avio_seek(%struct.AVIOContext* %11, i64 2, i32 0), !dbg !2274
  %12 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2275
  %13 = load i16, i16* %coded_file_size, align 2, !dbg !2276
  %conv8 = zext i16 %13 to i32, !dbg !2276
  call void @avio_wb16(%struct.AVIOContext* %12, i32 %conv8), !dbg !2277
  %14 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2278
  %15 = load i64, i64* %file_size, align 8, !dbg !2279
  %call9 = call i64 @avio_seek(%struct.AVIOContext* %14, i64 %15, i32 0), !dbg !2280
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--rsoenc.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!919 = !{!920}
!920 = distinct !DIGlobalVariable(name: "ff_rso_muxer", scope: !0, file: !921, line: 101, type: !922, isLocal: false, isDefinition: true, variable: %struct.AVOutputFormat* @ff_rso_muxer)
!921 = !DIFile(filename: "libavformat/rsoenc.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2140 = distinct !DISubprogram(name: "rso_write_header", scope: !921, file: !921, line: 28, type: !2141, isLocal: true, isDefinition: true, scopeLine: 29, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2145)
...
!2145 = !{}
!2146 = !DILocalVariable(name: "s", arg: 1, scope: !2140, file: !921, line: 28, type: !2143)
!2147 = !DIExpression()
!2148 = !DILocation(line: 28, column: 46, scope: !2140)
!2149 = !DILocalVariable(name: "pb", scope: !2140, file: !921, line: 30, type: !1103)
!2150 = !DILocation(line: 30, column: 18, scope: !2140)
!2151 = !DILocation(line: 30, column: 23, scope: !2140)
!2152 = !DILocation(line: 30, column: 26, scope: !2140)
!2153 = !DILocalVariable(name: "par", scope: !2140, file: !921, line: 31, type: !1708)
!2154 = !DILocation(line: 31, column: 24, scope: !2140)
!2155 = !DILocation(line: 31, column: 30, scope: !2140)
!2156 = !DILocation(line: 31, column: 33, scope: !2140)
!2157 = !DILocation(line: 31, column: 45, scope: !2140)
!2158 = !DILocation(line: 33, column: 10, scope: !2159)
!2159 = distinct !DILexicalBlock(scope: !2140, file: !921, line: 33, column: 9)
!2160 = !DILocation(line: 33, column: 15, scope: !2159)
!2161 = !DILocation(line: 33, column: 9, scope: !2140)
!2162 = !DILocation(line: 34, column: 9, scope: !2159)
!2163 = !DILocation(line: 36, column: 9, scope: !2164)
!2164 = distinct !DILexicalBlock(scope: !2140, file: !921, line: 36, column: 9)
!2165 = !DILocation(line: 36, column: 14, scope: !2164)
!2166 = !DILocation(line: 36, column: 23, scope: !2164)
!2167 = !DILocation(line: 36, column: 9, scope: !2140)
!2168 = !DILocation(line: 37, column: 16, scope: !2169)
!2169 = distinct !DILexicalBlock(scope: !2164, file: !921, line: 36, column: 29)
!2170 = !DILocation(line: 37, column: 9, scope: !2169)
!2171 = !DILocation(line: 38, column: 9, scope: !2169)
!2172 = !DILocation(line: 41, column: 11, scope: !2173)
!2173 = distinct !DILexicalBlock(scope: !2140, file: !921, line: 41, column: 9)
!2174 = !DILocation(line: 41, column: 14, scope: !2173)
!2175 = !DILocation(line: 41, column: 18, scope: !2173)
!2176 = !DILocation(line: 41, column: 27, scope: !2173)
!2177 = !DILocation(line: 41, column: 9, scope: !2140)
!2178 = !DILocation(line: 42, column: 16, scope: !2179)
!2179 = distinct !DILexicalBlock(scope: !2173, file: !921, line: 41, column: 40)
!2180 = !DILocation(line: 42, column: 9, scope: !2179)
!2181 = !DILocation(line: 43, column: 9, scope: !2179)
!2182 = !DILocation(line: 47, column: 9, scope: !2183)
!2183 = distinct !DILexicalBlock(scope: !2140, file: !921, line: 47, column: 9)
!2184 = !DILocation(line: 47, column: 14, scope: !2183)
!2185 = !DILocation(line: 47, column: 26, scope: !2183)
!2186 = !DILocation(line: 47, column: 9, scope: !2140)
!2187 = !DILocation(line: 48, column: 16, scope: !2188)
!2188 = distinct !DILexicalBlock(scope: !2183, file: !921, line: 47, column: 37)
!2189 = !DILocation(line: 48, column: 9, scope: !2188)
!2190 = !DILocation(line: 49, column: 9, scope: !2188)
!2191 = !DILocation(line: 52, column: 9, scope: !2192)
!2192 = distinct !DILexicalBlock(scope: !2140, file: !921, line: 52, column: 9)
!2193 = !DILocation(line: 52, column: 14, scope: !2192)
!2194 = !DILocation(line: 52, column: 23, scope: !2192)
!2195 = !DILocation(line: 52, column: 9, scope: !2140)
!2196 = !DILocation(line: 53, column: 39, scope: !2197)
!2197 = distinct !DILexicalBlock(scope: !2192, file: !921, line: 52, column: 53)
!2198 = !DILocation(line: 53, column: 9, scope: !2197)
!2199 = !DILocation(line: 54, column: 9, scope: !2197)
!2200 = !DILocation(line: 58, column: 15, scope: !2140)
!2201 = !DILocation(line: 58, column: 19, scope: !2140)
!2202 = !DILocation(line: 58, column: 24, scope: !2140)
!2203 = !DILocation(line: 58, column: 5, scope: !2140)
!2204 = !DILocation(line: 59, column: 15, scope: !2140)
!2205 = !DILocation(line: 59, column: 5, scope: !2140)
!2206 = !DILocation(line: 60, column: 15, scope: !2140)
!2207 = !DILocation(line: 60, column: 19, scope: !2140)
!2208 = !DILocation(line: 60, column: 24, scope: !2140)
!2209 = !DILocation(line: 60, column: 5, scope: !2140)
!2210 = !DILocation(line: 61, column: 15, scope: !2140)
!2211 = !DILocation(line: 61, column: 5, scope: !2140)
!2212 = !DILocation(line: 63, column: 16, scope: !2140)
!2213 = !DILocation(line: 63, column: 5, scope: !2140)
!2214 = !DILocation(line: 65, column: 5, scope: !2140)
!2215 = !DILocation(line: 66, column: 1, scope: !2140)
!2216 = distinct !DISubprogram(name: "rso_write_packet", scope: !921, file: !921, line: 68, type: !2217, isLocal: true, isDefinition: true, scopeLine: 69, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2145)
!2217 = !DISubroutineType(types: !2218)
!2218 = !{!917, !2143, !1032}
!2219 = !DILocalVariable(name: "s", arg: 1, scope: !2216, file: !921, line: 68, type: !2143)
!2220 = !DILocation(line: 68, column: 46, scope: !2216)
!2221 = !DILocalVariable(name: "pkt", arg: 2, scope: !2216, file: !921, line: 68, type: !1032)
!2222 = !DILocation(line: 68, column: 59, scope: !2216)
!2223 = !DILocation(line: 70, column: 16, scope: !2216)
!2224 = !DILocation(line: 70, column: 19, scope: !2216)
!2225 = !DILocation(line: 70, column: 23, scope: !2216)
!2226 = !DILocation(line: 70, column: 28, scope: !2216)
!2227 = !DILocation(line: 70, column: 34, scope: !2216)
!2228 = !DILocation(line: 70, column: 39, scope: !2216)
!2229 = !DILocation(line: 70, column: 5, scope: !2216)
!2230 = !DILocation(line: 71, column: 5, scope: !2216)
!2231 = distinct !DISubprogram(name: "rso_write_trailer", scope: !921, file: !921, line: 74, type: !2141, isLocal: true, isDefinition: true, scopeLine: 75, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2145)
!2232 = !DILocalVariable(name: "s", arg: 1, scope: !2233, file: !515, line: 557, type: !1103)
!2233 = distinct !DISubprogram(name: "avio_tell", scope: !515, file: !515, line: 557, type: !2234, isLocal: true, isDefinition: true, scopeLine: 558, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2145)
!2234 = !DISubroutineType(types: !2235)
!2235 = !{!1052, !1103}
!2236 = !DILocation(line: 557, column: 77, scope: !2233, inlinedAt: !2237)
!2237 = distinct !DILocation(line: 80, column: 17, scope: !2231)
!2238 = !DILocalVariable(name: "s", arg: 1, scope: !2231, file: !921, line: 74, type: !2143)
!2239 = !DILocation(line: 74, column: 47, scope: !2231)
!2240 = !DILocalVariable(name: "pb", scope: !2231, file: !921, line: 76, type: !1103)
!2241 = !DILocation(line: 76, column: 18, scope: !2231)
!2242 = !DILocation(line: 76, column: 23, scope: !2231)
!2243 = !DILocation(line: 76, column: 26, scope: !2231)
!2244 = !DILocalVariable(name: "file_size", scope: !2231, file: !921, line: 77, type: !1052)
!2245 = !DILocation(line: 77, column: 13, scope: !2231)
!2246 = !DILocalVariable(name: "coded_file_size", scope: !2231, file: !921, line: 78, type: !1261)
!2247 = !DILocation(line: 78, column: 14, scope: !2231)
!2248 = !DILocation(line: 80, column: 27, scope: !2231)
!2249 = !DILocation(line: 80, column: 17, scope: !2231)
!2250 = !DILocation(line: 559, column: 22, scope: !2233, inlinedAt: !2237)
!2251 = !DILocation(line: 559, column: 12, scope: !2233, inlinedAt: !2237)
!2252 = !DILocation(line: 80, column: 15, scope: !2231)
!2253 = !DILocation(line: 82, column: 9, scope: !2254)
!2254 = distinct !DILexicalBlock(scope: !2231, file: !921, line: 82, column: 9)
!2255 = !DILocation(line: 82, column: 19, scope: !2254)
!2256 = !DILocation(line: 82, column: 9, scope: !2231)
!2257 = !DILocation(line: 83, column: 16, scope: !2254)
!2258 = !DILocation(line: 83, column: 9, scope: !2254)
!2259 = !DILocation(line: 85, column: 9, scope: !2260)
!2260 = distinct !DILexicalBlock(scope: !2231, file: !921, line: 85, column: 9)
!2261 = !DILocation(line: 85, column: 19, scope: !2260)
!2262 = !DILocation(line: 85, column: 9, scope: !2231)
!2263 = !DILocation(line: 86, column: 16, scope: !2264)
!2264 = distinct !DILexicalBlock(scope: !2260, file: !921, line: 85, column: 33)
!2265 = !DILocation(line: 87, column: 69, scope: !2264)
!2266 = !DILocation(line: 86, column: 9, scope: !2264)
!2267 = !DILocation(line: 88, column: 25, scope: !2264)
!2268 = !DILocation(line: 89, column: 5, scope: !2264)
!2269 = !DILocation(line: 90, column: 27, scope: !2270)
!2270 = distinct !DILexicalBlock(scope: !2260, file: !921, line: 89, column: 12)
!2271 = !DILocation(line: 90, column: 37, scope: !2270)
!2272 = !DILocation(line: 90, column: 25, scope: !2270)
!2273 = !DILocation(line: 94, column: 15, scope: !2231)
!2274 = !DILocation(line: 94, column: 5, scope: !2231)
!2275 = !DILocation(line: 95, column: 15, scope: !2231)
!2276 = !DILocation(line: 95, column: 19, scope: !2231)
!2277 = !DILocation(line: 95, column: 5, scope: !2231)
!2278 = !DILocation(line: 96, column: 15, scope: !2231)
!2279 = !DILocation(line: 96, column: 19, scope: !2231)
!2280 = !DILocation(line: 96, column: 5, scope: !2231)
!2281 = !DILocation(line: 98, column: 5, scope: !2231)
!2282 = !DILocation(line: 99, column: 1, scope: !2231)
