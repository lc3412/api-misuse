; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--sol.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--sol.o.i"
...
entry:
  ...
  call void @llvm.dbg.declare(metadata i16* %magic, metadata !2151, metadata !2149), !dbg !2152
  ...
  %2 = bitcast i8* %1 to %union.unaligned_32*, !dbg !2155
  %l = bitcast %union.unaligned_32* %2 to i32*, !dbg !2155
  %3 = load i32, i32* %l, align 1, !dbg !2155
  %conv = trunc i32 %3 to i16, !dbg !2156
  store i16 %conv, i16* %magic, align 2, !dbg !2152
  %4 = load i16, i16* %magic, align 2, !dbg !2157
  %conv1 = zext i16 %4 to i32, !dbg !2157
  %cmp = icmp eq i32 %conv1, 2957, !dbg !2159
  br i1 %cmp, label %land.lhs.true, label %lor.lhs.false, !dbg !2160

lor.lhs.false:                                    ; preds = %entry
  %5 = load i16, i16* %magic, align 2, !dbg !2161
  %conv3 = zext i16 %5 to i32, !dbg !2161
  %cmp4 = icmp eq i32 %conv3, 3085, !dbg !2163
  br i1 %cmp4, label %land.lhs.true, label %lor.lhs.false6, !dbg !2164

lor.lhs.false6:                                   ; preds = %lor.lhs.false
  %6 = load i16, i16* %magic, align 2, !dbg !2165
  %conv7 = zext i16 %6 to i32, !dbg !2165
  %cmp8 = icmp eq i32 %conv7, 3213, !dbg !2167
  br i1 %cmp8, label %land.lhs.true, label %if.else, !dbg !2168

land.lhs.true:                                    ; preds = %lor.lhs.false6, %lor.lhs.false, %entry
  %7 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2169
  %buf10 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %7, i32 0, i32 1, !dbg !2170
  %8 = load i8*, i8** %buf10, align 8, !dbg !2170
  %arrayidx = getelementptr inbounds i8, i8* %8, i64 2, !dbg !2169
  %9 = load i8, i8* %arrayidx, align 1, !dbg !2169
  %conv11 = zext i8 %9 to i32, !dbg !2169
  %cmp12 = icmp eq i32 %conv11, 83, !dbg !2171
  br i1 %cmp12, label %land.lhs.true14, label %if.else, !dbg !2172

land.lhs.true14:                                  ; preds = %land.lhs.true
  %10 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2173
  %buf15 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %10, i32 0, i32 1, !dbg !2174
  %11 = load i8*, i8** %buf15, align 8, !dbg !2174
  %arrayidx16 = getelementptr inbounds i8, i8* %11, i64 3, !dbg !2173
  %12 = load i8, i8* %arrayidx16, align 1, !dbg !2173
  %conv17 = zext i8 %12 to i32, !dbg !2173
  %cmp18 = icmp eq i32 %conv17, 79, !dbg !2175
  br i1 %cmp18, label %land.lhs.true20, label %if.else, !dbg !2176

land.lhs.true20:                                  ; preds = %land.lhs.true14
  %13 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2177
  %buf21 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %13, i32 0, i32 1, !dbg !2178
  %14 = load i8*, i8** %buf21, align 8, !dbg !2178
  %arrayidx22 = getelementptr inbounds i8, i8* %14, i64 4, !dbg !2177
  %15 = load i8, i8* %arrayidx22, align 1, !dbg !2177
  %conv23 = zext i8 %15 to i32, !dbg !2177
  %cmp24 = icmp eq i32 %conv23, 76, !dbg !2179
  br i1 %cmp24, label %land.lhs.true26, label %if.else, !dbg !2180

land.lhs.true26:                                  ; preds = %land.lhs.true20
  %16 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2181
  %buf27 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %16, i32 0, i32 1, !dbg !2182
  %17 = load i8*, i8** %buf27, align 8, !dbg !2182
  %arrayidx28 = getelementptr inbounds i8, i8* %17, i64 5, !dbg !2181
  %18 = load i8, i8* %arrayidx28, align 1, !dbg !2181
  %conv29 = zext i8 %18 to i32, !dbg !2181
  %cmp30 = icmp eq i32 %conv29, 0, !dbg !2183
  br i1 %cmp30, label %if.then, label %if.else, !dbg !2184

if.then:                                          ; preds = %land.lhs.true26
  store i32 100, i32* %retval, align 4, !dbg !2186
  br label %return, !dbg !2186

if.else:                                          ; preds = %land.lhs.true26, %land.lhs.true20, %land.lhs.true14, %land.lhs.true, %lor.lhs.false6
  store i32 0, i32* %retval, align 4, !dbg !2187
  br label %return, !dbg !2187

return:                                           ; preds = %if.else, %if.then
  %19 = load i32, i32* %retval, align 4, !dbg !2188
  ret i32 %19, !dbg !2188
}

; Function Attrs: nounwind uwtable
define internal i32 @sol_read_header(%struct.AVFormatContext* %s) #0 !dbg !2189 {
entry:
  %retval = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2194, metadata !2149), !dbg !2195
  call void @llvm.dbg.declare(metadata i32* %magic, metadata !2196, metadata !2149), !dbg !2197
  call void @llvm.dbg.declare(metadata i32* %tag, metadata !2198, metadata !2149), !dbg !2199
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2200, metadata !2149), !dbg !2201
  ...
  call void @llvm.dbg.declare(metadata i32* %id, metadata !2204, metadata !2149), !dbg !2205
  call void @llvm.dbg.declare(metadata i32* %channels, metadata !2206, metadata !2149), !dbg !2207
  call void @llvm.dbg.declare(metadata i32* %rate, metadata !2208, metadata !2149), !dbg !2209
  call void @llvm.dbg.declare(metadata i32* %type, metadata !2210, metadata !2149), !dbg !2211
  call void @llvm.dbg.declare(metadata i32* %codec, metadata !2212, metadata !2149), !dbg !2213
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2214, metadata !2149), !dbg !2215
  %2 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2216
  %call = call i32 @avio_rl16(%struct.AVIOContext* %2), !dbg !2217
  store i32 %call, i32* %magic, align 4, !dbg !2218
  %3 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2219
  %call2 = call i32 @avio_rl32(%struct.AVIOContext* %3), !dbg !2220
  store i32 %call2, i32* %tag, align 4, !dbg !2221
  %4 = load i32, i32* %tag, align 4, !dbg !2222
  %cmp = icmp ne i32 %4, 5001043, !dbg !2224
...
if.end:                                           ; preds = %entry
  ...
  %call3 = call i32 @avio_rl16(%struct.AVIOContext* %5), !dbg !2228
  store i32 %call3, i32* %rate, align 4, !dbg !2229
  %6 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2230
  %call4 = call i32 @avio_r8(%struct.AVIOContext* %6), !dbg !2231
  store i32 %call4, i32* %type, align 4, !dbg !2232
  %7 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2233
  %call5 = call i64 @avio_skip(%struct.AVIOContext* %7, i64 4), !dbg !2234
  %8 = load i32, i32* %magic, align 4, !dbg !2235
  %cmp6 = icmp ne i32 %8, 2957, !dbg !2237
  br i1 %cmp6, label %if.then7, label %if.end9, !dbg !2238

if.then7:                                         ; preds = %if.end
  %9 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2239
  %call8 = call i32 @avio_r8(%struct.AVIOContext* %9), !dbg !2240
  br label %if.end9, !dbg !2240

if.end9:                                          ; preds = %if.then7, %if.end
  %10 = load i32, i32* %magic, align 4, !dbg !2241
  %11 = load i32, i32* %type, align 4, !dbg !2242
  %call10 = call i32 @sol_codec_id(i32 %10, i32 %11), !dbg !2243
  store i32 %call10, i32* %codec, align 4, !dbg !2244
  %12 = load i32, i32* %magic, align 4, !dbg !2245
  %13 = load i32, i32* %type, align 4, !dbg !2246
  %call11 = call i32 @sol_channels(i32 %12, i32 %13), !dbg !2247
  store i32 %call11, i32* %channels, align 4, !dbg !2248
  %14 = load i32, i32* %codec, align 4, !dbg !2249
  %cmp12 = icmp eq i32 %14, 81923, !dbg !2251
  br i1 %cmp12, label %if.then13, label %if.else, !dbg !2252

if.then13:                                        ; preds = %if.end9
  %15 = load i32, i32* %magic, align 4, !dbg !2253
  %16 = load i32, i32* %type, align 4, !dbg !2254
  %call14 = call i32 @sol_codec_type(i32 %15, i32 %16), !dbg !2255
  store i32 %call14, i32* %id, align 4, !dbg !2256
  br label %if.end15, !dbg !2257

if.else:                                          ; preds = %if.end9
  store i32 0, i32* %id, align 4, !dbg !2258
  br label %if.end15

if.end15:                                         ; preds = %if.else, %if.then13
  %17 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2259
  %call16 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %17, %struct.AVCodec* null), !dbg !2260
  store %struct.AVStream* %call16, %struct.AVStream** %st, align 8, !dbg !2261
  %18 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2262
  %tobool = icmp ne %struct.AVStream* %18, null, !dbg !2262
  br i1 %tobool, label %if.end18, label %if.then17, !dbg !2264
...
if.end18:                                         ; preds = %if.end15
  %19 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2266
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %19, i32 0, i32 19, !dbg !2267
  %20 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2267
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %20, i32 0, i32 0, !dbg !2268
  store i32 1, i32* %codec_type, align 8, !dbg !2269
  %21 = load i32, i32* %id, align 4, !dbg !2270
  %22 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2271
  %codecpar19 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %22, i32 0, i32 19, !dbg !2272
  %23 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar19, align 8, !dbg !2272
  %codec_tag = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %23, i32 0, i32 2, !dbg !2273
  store i32 %21, i32* %codec_tag, align 8, !dbg !2274
  %24 = load i32, i32* %codec, align 4, !dbg !2275
  %25 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2276
  %codecpar20 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %25, i32 0, i32 19, !dbg !2277
  %26 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar20, align 8, !dbg !2277
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %26, i32 0, i32 1, !dbg !2278
  store i32 %24, i32* %codec_id, align 4, !dbg !2279
  %27 = load i32, i32* %channels, align 4, !dbg !2280
  %28 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2281
  %codecpar21 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %28, i32 0, i32 19, !dbg !2282
  %29 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar21, align 8, !dbg !2282
  %channels22 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %29, i32 0, i32 22, !dbg !2283
  store i32 %27, i32* %channels22, align 8, !dbg !2284
  %30 = load i32, i32* %channels, align 4, !dbg !2285
  %cmp23 = icmp eq i32 %30, 1, !dbg !2286
  %cond = select i1 %cmp23, i32 4, i32 3, !dbg !2285
  %conv = sext i32 %cond to i64, !dbg !2285
  %31 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2287
  %codecpar24 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %31, i32 0, i32 19, !dbg !2288
  %32 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar24, align 8, !dbg !2288
  %channel_layout = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %32, i32 0, i32 21, !dbg !2289
  store i64 %conv, i64* %channel_layout, align 8, !dbg !2290
  %33 = load i32, i32* %rate, align 4, !dbg !2291
  %34 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2292
  %codecpar25 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %34, i32 0, i32 19, !dbg !2293
  %35 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar25, align 8, !dbg !2293
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %35, i32 0, i32 23, !dbg !2294
  store i32 %33, i32* %sample_rate, align 4, !dbg !2295
  %36 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2296
  %37 = load i32, i32* %rate, align 4, !dbg !2297
  call void @avpriv_set_pts_info(%struct.AVStream* %36, i32 64, i32 1, i32 %37), !dbg !2298
  store i32 0, i32* %retval, align 4, !dbg !2299
  br label %return, !dbg !2299

return:                                           ; preds = %if.end18, %if.then17, %if.then
  %38 = load i32, i32* %retval, align 4, !dbg !2300
  ret i32 %38, !dbg !2300
}

; Function Attrs: nounwind uwtable
define internal i32 @sol_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2301 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2304, metadata !2149), !dbg !2305
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2306, metadata !2149), !dbg !2307
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2308, metadata !2149), !dbg !2309
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2310
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2312
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2312
  %call = call i32 @avio_feof(%struct.AVIOContext* %1), !dbg !2313
  %tobool = icmp ne i32 %call, 0, !dbg !2313
  br i1 %tobool, label %if.then, label %if.end, !dbg !2314

if.then:                                          ; preds = %entry
  store i32 -5, i32* %retval, align 4, !dbg !2315
  br label %return, !dbg !2315

if.end:                                           ; preds = %entry
  %2 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2316
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %2, i32 0, i32 4, !dbg !2317
  %3 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2317
  %4 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2318
  %call2 = call i32 @av_get_packet(%struct.AVIOContext* %3, %struct.AVPacket* %4, i32 4096), !dbg !2319
  store i32 %call2, i32* %ret, align 4, !dbg !2320
  %5 = load i32, i32* %ret, align 4, !dbg !2321
  %cmp = icmp slt i32 %5, 0, !dbg !2323
  br i1 %cmp, label %if.then3, label %if.end4, !dbg !2324
...
if.end4:                                          ; preds = %if.end
  %7 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2327
  %flags = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %7, i32 0, i32 6, !dbg !2328
  %8 = load i32, i32* %flags, align 8, !dbg !2329
  %and = and i32 %8, -3, !dbg !2329
  store i32 %and, i32* %flags, align 8, !dbg !2329
  %9 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2330
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %9, i32 0, i32 5, !dbg !2331
  store i32 0, i32* %stream_index, align 4, !dbg !2332
...
; Function Attrs: nounwind uwtable
define internal i32 @sol_codec_id(i32 %magic, i32 %type) #0 !dbg !2335 {
entry:
  %retval = alloca i32, align 4
  %magic.addr = alloca i32, align 4
  %type.addr = alloca i32, align 4
  store i32 %magic, i32* %magic.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %magic.addr, metadata !2338, metadata !2149), !dbg !2339
  store i32 %type, i32* %type.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %type.addr, metadata !2340, metadata !2149), !dbg !2341
  %0 = load i32, i32* %type.addr, align 4, !dbg !2342
  %and = and i32 %0, 1, !dbg !2344
  %tobool = icmp ne i32 %and, 0, !dbg !2344
  br i1 %tobool, label %if.then, label %if.end, !dbg !2345

if.then:                                          ; preds = %entry
  store i32 81923, i32* %retval, align 4, !dbg !2346
  br label %return, !dbg !2346

if.end:                                           ; preds = %entry
  %1 = load i32, i32* %magic.addr, align 4, !dbg !2347
  %cmp = icmp eq i32 %1, 2957, !dbg !2349
  br i1 %cmp, label %if.then1, label %if.end2, !dbg !2350

if.then1:                                         ; preds = %if.end
  store i32 65541, i32* %retval, align 4, !dbg !2351
  br label %return, !dbg !2351

if.end2:                                          ; preds = %if.end
  %2 = load i32, i32* %type.addr, align 4, !dbg !2352
  %and3 = and i32 %2, 4, !dbg !2354
  %tobool4 = icmp ne i32 %and3, 0, !dbg !2354
  br i1 %tobool4, label %if.then5, label %if.end6, !dbg !2355

if.then5:                                         ; preds = %if.end2
  store i32 65536, i32* %retval, align 4, !dbg !2356
  br label %return, !dbg !2356

if.end6:                                          ; preds = %if.end2
  store i32 65541, i32* %retval, align 4, !dbg !2357
  br label %return, !dbg !2357

return:                                           ; preds = %if.end6, %if.then5, %if.then1, %if.then
  %3 = load i32, i32* %retval, align 4, !dbg !2358
  ret i32 %3, !dbg !2358
}

; Function Attrs: nounwind uwtable
define internal i32 @sol_channels(i32 %magic, i32 %type) #0 !dbg !2359 {
entry:
  %retval = alloca i32, align 4
  %magic.addr = alloca i32, align 4
  %type.addr = alloca i32, align 4
  store i32 %magic, i32* %magic.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %magic.addr, metadata !2362, metadata !2149), !dbg !2363
  store i32 %type, i32* %type.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %type.addr, metadata !2364, metadata !2149), !dbg !2365
  %0 = load i32, i32* %magic.addr, align 4, !dbg !2366
  %cmp = icmp eq i32 %0, 2957, !dbg !2368
  br i1 %cmp, label %if.then, label %lor.lhs.false, !dbg !2369

lor.lhs.false:                                    ; preds = %entry
  %1 = load i32, i32* %type.addr, align 4, !dbg !2370
  %and = and i32 %1, 16, !dbg !2372
  %tobool = icmp ne i32 %and, 0, !dbg !2372
  br i1 %tobool, label %if.end, label %if.then, !dbg !2373

if.then:                                          ; preds = %lor.lhs.false, %entry
  store i32 1, i32* %retval, align 4, !dbg !2374
...
return:                                           ; preds = %if.end, %if.then
  %2 = load i32, i32* %retval, align 4, !dbg !2377
  ret i32 %2, !dbg !2377
}

; Function Attrs: nounwind uwtable
define internal i32 @sol_codec_type(i32 %magic, i32 %type) #0 !dbg !2378 {
entry:
  %retval = alloca i32, align 4
  %magic.addr = alloca i32, align 4
  %type.addr = alloca i32, align 4
  store i32 %magic, i32* %magic.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %magic.addr, metadata !2379, metadata !2149), !dbg !2380
  store i32 %type, i32* %type.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %type.addr, metadata !2381, metadata !2149), !dbg !2382
  %0 = load i32, i32* %magic.addr, align 4, !dbg !2383
  %cmp = icmp eq i32 %0, 2957, !dbg !2385
...
if.end:                                           ; preds = %entry
  %1 = load i32, i32* %type.addr, align 4, !dbg !2389
  %and = and i32 %1, 1, !dbg !2391
  %tobool = icmp ne i32 %and, 0, !dbg !2391
  br i1 %tobool, label %if.then1, label %if.end8, !dbg !2392

if.then1:                                         ; preds = %if.end
  %2 = load i32, i32* %type.addr, align 4, !dbg !2393
  %and2 = and i32 %2, 4, !dbg !2396
  %tobool3 = icmp ne i32 %and2, 0, !dbg !2396
  br i1 %tobool3, label %if.then4, label %if.else, !dbg !2397

if.then4:                                         ; preds = %if.then1
  store i32 3, i32* %retval, align 4, !dbg !2398
  br label %return, !dbg !2398

if.else:                                          ; preds = %if.then1
  %3 = load i32, i32* %magic.addr, align 4, !dbg !2400
  %cmp5 = icmp eq i32 %3, 3213, !dbg !2402
  br i1 %cmp5, label %if.then6, label %if.else7, !dbg !2403
...
if.else7:                                         ; preds = %if.else
  store i32 2, i32* %retval, align 4, !dbg !2406
...
return:                                           ; preds = %if.end8, %if.else7, %if.then6, %if.then4, %if.then
  %4 = load i32, i32* %retval, align 4, !dbg !2408
  ret i32 %4, !dbg !2408
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--sol.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!926 = !{!927}
!927 = distinct !DIGlobalVariable(name: "ff_sol_demuxer", scope: !0, file: !928, line: 141, type: !929, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_sol_demuxer)
!928 = !DIFile(filename: "libavformat/sol.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!931 = !{!932, !936, !937, !939, !940, !950, !992, !993, !995, !996, !997, !1011, !2124, !2125, !2126, !2130, !2134, !2135, !2136, !2140, !2141, !2142}
...
!1064 = !DIDerivedType(tag: DW_TAG_member, name: "size", scope: !1043, file: !4, line: 1469, baseType: !938, size: 32, align: 32, offset: 256)
!1065 = !DIDerivedType(tag: DW_TAG_member, name: "stream_index", scope: !1043, file: !4, line: 1470, baseType: !938, size: 32, align: 32, offset: 288)
!1066 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !1043, file: !4, line: 1474, baseType: !938, size: 32, align: 32, offset: 320)
...
!1073 = !DIDerivedType(tag: DW_TAG_member, name: "size", scope: !1070, file: !4, line: 1413, baseType: !938, size: 32, align: 32, offset: 64)
!1074 = !DIDerivedType(tag: DW_TAG_member, name: "type", scope: !1070, file: !4, line: 1414, baseType: !484, size: 32, align: 32, offset: 96)
!1075 = !DIDerivedType(tag: DW_TAG_member, name: "side_data_elems", scope: !1043, file: !4, line: 1480, baseType: !938, size: 32, align: 32, offset: 448)
...
!1114 = !DICompositeType(tag: DW_TAG_array_type, baseType: !938, size: 256, align: 32, elements: !1111)
...
!1117 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !1107, file: !526, line: 326, baseType: !938, size: 32, align: 32, offset: 832)
!1118 = !DIDerivedType(tag: DW_TAG_member, name: "height", scope: !1107, file: !526, line: 326, baseType: !938, size: 32, align: 32, offset: 864)
!1119 = !DIDerivedType(tag: DW_TAG_member, name: "nb_samples", scope: !1107, file: !526, line: 334, baseType: !938, size: 32, align: 32, offset: 896)
!1120 = !DIDerivedType(tag: DW_TAG_member, name: "format", scope: !1107, file: !526, line: 341, baseType: !938, size: 32, align: 32, offset: 928)
!1121 = !DIDerivedType(tag: DW_TAG_member, name: "key_frame", scope: !1107, file: !526, line: 346, baseType: !938, size: 32, align: 32, offset: 960)
...
!1127 = !{!1128, !1129}
!1128 = !DIDerivedType(tag: DW_TAG_member, name: "num", scope: !1126, file: !1125, line: 59, baseType: !938, size: 32, align: 32)
!1129 = !DIDerivedType(tag: DW_TAG_member, name: "den", scope: !1126, file: !1125, line: 60, baseType: !938, size: 32, align: 32, offset: 32)
...
!1133 = !DIDerivedType(tag: DW_TAG_member, name: "coded_picture_number", scope: !1107, file: !526, line: 382, baseType: !938, size: 32, align: 32, offset: 1280)
!1134 = !DIDerivedType(tag: DW_TAG_member, name: "display_picture_number", scope: !1107, file: !526, line: 386, baseType: !938, size: 32, align: 32, offset: 1312)
!1135 = !DIDerivedType(tag: DW_TAG_member, name: "quality", scope: !1107, file: !526, line: 391, baseType: !938, size: 32, align: 32, offset: 1344)
...
!1140 = !DIDerivedType(tag: DW_TAG_member, name: "repeat_pict", scope: !1107, file: !526, line: 410, baseType: !938, size: 32, align: 32, offset: 1984)
!1141 = !DIDerivedType(tag: DW_TAG_member, name: "interlaced_frame", scope: !1107, file: !526, line: 415, baseType: !938, size: 32, align: 32, offset: 2016)
!1142 = !DIDerivedType(tag: DW_TAG_member, name: "top_field_first", scope: !1107, file: !526, line: 420, baseType: !938, size: 32, align: 32, offset: 2048)
!1143 = !DIDerivedType(tag: DW_TAG_member, name: "palette_has_changed", scope: !1107, file: !526, line: 425, baseType: !938, size: 32, align: 32, offset: 2080)
...
!1145 = !DIDerivedType(tag: DW_TAG_member, name: "sample_rate", scope: !1107, file: !526, line: 440, baseType: !938, size: 32, align: 32, offset: 2176)
...
!1151 = !DIDerivedType(tag: DW_TAG_member, name: "nb_extended_buf", scope: !1107, file: !526, line: 477, baseType: !938, size: 32, align: 32, offset: 2880)
...
!1160 = !DIDerivedType(tag: DW_TAG_member, name: "size", scope: !1156, file: !526, line: 204, baseType: !938, size: 32, align: 32, offset: 128)
...
!1167 = !DIDerivedType(tag: DW_TAG_member, name: "nb_side_data", scope: !1107, file: !526, line: 480, baseType: !938, size: 32, align: 32, offset: 3008)
!1168 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !1107, file: !526, line: 505, baseType: !938, size: 32, align: 32, offset: 3040)
...
!1178 = !DIDerivedType(tag: DW_TAG_member, name: "decode_error_flags", scope: !1107, file: !526, line: 563, baseType: !938, size: 32, align: 32, offset: 3520)
!1179 = !DIDerivedType(tag: DW_TAG_member, name: "channels", scope: !1107, file: !526, line: 572, baseType: !938, size: 32, align: 32, offset: 3552)
!1180 = !DIDerivedType(tag: DW_TAG_member, name: "pkt_size", scope: !1107, file: !526, line: 581, baseType: !938, size: 32, align: 32, offset: 3584)
...
!1185 = !DIDerivedType(tag: DW_TAG_member, name: "qstride", scope: !1107, file: !526, line: 593, baseType: !938, size: 32, align: 32, offset: 3712)
!1186 = !DIDerivedType(tag: DW_TAG_member, name: "qscale_type", scope: !1107, file: !526, line: 596, baseType: !938, size: 32, align: 32, offset: 3744)
...
!1228 = !DIDerivedType(tag: DW_TAG_member, name: "buffer_size", scope: !1224, file: !628, line: 227, baseType: !938, size: 32, align: 32, offset: 128)
...
!1240 = !{!1060, !961, !1060, !938}
!1241 = !DIDerivedType(tag: DW_TAG_member, name: "pos", scope: !1224, file: !628, line: 238, baseType: !1060, size: 64, align: 64, offset: 576)
!1242 = !DIDerivedType(tag: DW_TAG_member, name: "eof_reached", scope: !1224, file: !628, line: 239, baseType: !938, size: 32, align: 32, offset: 640)
!1243 = !DIDerivedType(tag: DW_TAG_member, name: "write_flag", scope: !1224, file: !628, line: 240, baseType: !938, size: 32, align: 32, offset: 672)
!1244 = !DIDerivedType(tag: DW_TAG_member, name: "max_packet_size", scope: !1224, file: !628, line: 241, baseType: !938, size: 32, align: 32, offset: 704)
...
!1253 = !DIDerivedType(tag: DW_TAG_member, name: "error", scope: !1224, file: !628, line: 245, baseType: !938, size: 32, align: 32, offset: 960)
...
!1261 = !{!1060, !961, !938, !1060, !938}
!1262 = !DIDerivedType(tag: DW_TAG_member, name: "seekable", scope: !1224, file: !628, line: 260, baseType: !938, size: 32, align: 32, offset: 1152)
...
!1264 = !DIDerivedType(tag: DW_TAG_member, name: "direct", scope: !1224, file: !628, line: 273, baseType: !938, size: 32, align: 32, offset: 1280)
...
!1266 = !DIDerivedType(tag: DW_TAG_member, name: "seek_count", scope: !1224, file: !628, line: 285, baseType: !938, size: 32, align: 32, offset: 1408)
!1267 = !DIDerivedType(tag: DW_TAG_member, name: "writeout_count", scope: !1224, file: !628, line: 291, baseType: !938, size: 32, align: 32, offset: 1440)
!1268 = !DIDerivedType(tag: DW_TAG_member, name: "orig_buffer_size", scope: !1224, file: !628, line: 298, baseType: !938, size: 32, align: 32, offset: 1472)
!1269 = !DIDerivedType(tag: DW_TAG_member, name: "short_seek_threshold", scope: !1224, file: !628, line: 304, baseType: !938, size: 32, align: 32, offset: 1504)
...
!1275 = !{!938, !961, !1056, !938, !627, !1060}
!1276 = !DIDerivedType(tag: DW_TAG_member, name: "ignore_boundary_point", scope: !1224, file: !628, line: 326, baseType: !938, size: 32, align: 32, offset: 1728)
...
!1285 = !DIDerivedType(tag: DW_TAG_member, name: "min_packet_size", scope: !1224, file: !628, line: 351, baseType: !938, size: 32, align: 32, offset: 2048)
!1286 = !DIDerivedType(tag: DW_TAG_member, name: "ctx_flags", scope: !1016, file: !897, line: 1386, baseType: !938, size: 32, align: 32, offset: 320)
...
!1294 = !DIDerivedType(tag: DW_TAG_member, name: "index", scope: !1292, file: !897, line: 866, baseType: !938, size: 32, align: 32)
!1295 = !DIDerivedType(tag: DW_TAG_member, name: "id", scope: !1292, file: !897, line: 872, baseType: !938, size: 32, align: 32, offset: 32)
...
!1302 = !DIDerivedType(tag: DW_TAG_member, name: "log_level_offset", scope: !1299, file: !4, line: 1562, baseType: !938, size: 32, align: 32, offset: 64)
...
!1313 = !DIDerivedType(tag: DW_TAG_member, name: "capabilities", scope: !1307, file: !4, line: 3487, baseType: !938, size: 32, align: 32, offset: 192)
...
!1322 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !938)
...
!1336 = !{!1337, !1338}
!1337 = !DIDerivedType(tag: DW_TAG_member, name: "profile", scope: !1335, file: !4, line: 3402, baseType: !938, size: 32, align: 32)
...
!1340 = !DIDerivedType(tag: DW_TAG_member, name: "priv_data_size", scope: !1307, file: !4, line: 3516, baseType: !938, size: 32, align: 32, offset: 832)
...
!1433 = !{null, !1297}
!1434 = !DIDerivedType(tag: DW_TAG_member, name: "caps_internal", scope: !1307, file: !4, line: 3594, baseType: !938, size: 32, align: 32, offset: 1792)
!1435 = !DIDerivedType(tag: DW_TAG_member, name: "bsfs", scope: !1307, file: !4, line: 3600, baseType: !933, size: 64, align: 64, offset: 1856)
...
!1449 = !DIDerivedType(tag: DW_TAG_member, name: "bit_rate_tolerance", scope: !1299, file: !4, line: 1614, baseType: !938, size: 32, align: 32, offset: 512)
!1450 = !DIDerivedType(tag: DW_TAG_member, name: "global_quality", scope: !1299, file: !4, line: 1622, baseType: !938, size: 32, align: 32, offset: 544)
!1451 = !DIDerivedType(tag: DW_TAG_member, name: "compression_level", scope: !1299, file: !4, line: 1628, baseType: !938, size: 32, align: 32, offset: 576)
!1452 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !1299, file: !4, line: 1636, baseType: !938, size: 32, align: 32, offset: 608)
!1453 = !DIDerivedType(tag: DW_TAG_member, name: "flags2", scope: !1299, file: !4, line: 1643, baseType: !938, size: 32, align: 32, offset: 640)
...
!1455 = !DIDerivedType(tag: DW_TAG_member, name: "extradata_size", scope: !1299, file: !4, line: 1658, baseType: !938, size: 32, align: 32, offset: 768)
...
!1457 = !DIDerivedType(tag: DW_TAG_member, name: "ticks_per_frame", scope: !1299, file: !4, line: 1688, baseType: !938, size: 32, align: 32, offset: 864)
!1458 = !DIDerivedType(tag: DW_TAG_member, name: "delay", scope: !1299, file: !4, line: 1712, baseType: !938, size: 32, align: 32, offset: 896)
!1459 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !1299, file: !4, line: 1729, baseType: !938, size: 32, align: 32, offset: 928)
!1460 = !DIDerivedType(tag: DW_TAG_member, name: "height", scope: !1299, file: !4, line: 1729, baseType: !938, size: 32, align: 32, offset: 960)
!1461 = !DIDerivedType(tag: DW_TAG_member, name: "coded_width", scope: !1299, file: !4, line: 1744, baseType: !938, size: 32, align: 32, offset: 992)
!1462 = !DIDerivedType(tag: DW_TAG_member, name: "coded_height", scope: !1299, file: !4, line: 1744, baseType: !938, size: 32, align: 32, offset: 1024)
!1463 = !DIDerivedType(tag: DW_TAG_member, name: "gop_size", scope: !1299, file: !4, line: 1751, baseType: !938, size: 32, align: 32, offset: 1056)
...
!1473 = !{!645, !1469, !1318}
!1474 = !DIDerivedType(tag: DW_TAG_member, name: "max_b_frames", scope: !1299, file: !4, line: 1816, baseType: !938, size: 32, align: 32, offset: 1280)
...
!1477 = !DIDerivedType(tag: DW_TAG_member, name: "b_frame_strategy", scope: !1299, file: !4, line: 1830, baseType: !938, size: 32, align: 32, offset: 1344)
...
!1479 = !DIDerivedType(tag: DW_TAG_member, name: "has_b_frames", scope: !1299, file: !4, line: 1846, baseType: !938, size: 32, align: 32, offset: 1408)
!1480 = !DIDerivedType(tag: DW_TAG_member, name: "mpeg_quant", scope: !1299, file: !4, line: 1851, baseType: !938, size: 32, align: 32, offset: 1440)
...
!1488 = !DIDerivedType(tag: DW_TAG_member, name: "slice_count", scope: !1299, file: !4, line: 1910, baseType: !938, size: 32, align: 32, offset: 1696)
!1489 = !DIDerivedType(tag: DW_TAG_member, name: "prediction_method", scope: !1299, file: !4, line: 1915, baseType: !938, size: 32, align: 32, offset: 1728)
...
!1492 = !DIDerivedType(tag: DW_TAG_member, name: "me_cmp", scope: !1299, file: !4, line: 1942, baseType: !938, size: 32, align: 32, offset: 1920)
!1493 = !DIDerivedType(tag: DW_TAG_member, name: "me_sub_cmp", scope: !1299, file: !4, line: 1948, baseType: !938, size: 32, align: 32, offset: 1952)
!1494 = !DIDerivedType(tag: DW_TAG_member, name: "mb_cmp", scope: !1299, file: !4, line: 1954, baseType: !938, size: 32, align: 32, offset: 1984)
!1495 = !DIDerivedType(tag: DW_TAG_member, name: "ildct_cmp", scope: !1299, file: !4, line: 1960, baseType: !938, size: 32, align: 32, offset: 2016)
!1496 = !DIDerivedType(tag: DW_TAG_member, name: "dia_size", scope: !1299, file: !4, line: 1984, baseType: !938, size: 32, align: 32, offset: 2048)
!1497 = !DIDerivedType(tag: DW_TAG_member, name: "last_predictor_count", scope: !1299, file: !4, line: 1991, baseType: !938, size: 32, align: 32, offset: 2080)
!1498 = !DIDerivedType(tag: DW_TAG_member, name: "pre_me", scope: !1299, file: !4, line: 1996, baseType: !938, size: 32, align: 32, offset: 2112)
!1499 = !DIDerivedType(tag: DW_TAG_member, name: "me_pre_cmp", scope: !1299, file: !4, line: 2004, baseType: !938, size: 32, align: 32, offset: 2144)
!1500 = !DIDerivedType(tag: DW_TAG_member, name: "pre_dia_size", scope: !1299, file: !4, line: 2011, baseType: !938, size: 32, align: 32, offset: 2176)
!1501 = !DIDerivedType(tag: DW_TAG_member, name: "me_subpel_quality", scope: !1299, file: !4, line: 2018, baseType: !938, size: 32, align: 32, offset: 2208)
!1502 = !DIDerivedType(tag: DW_TAG_member, name: "me_range", scope: !1299, file: !4, line: 2027, baseType: !938, size: 32, align: 32, offset: 2240)
!1503 = !DIDerivedType(tag: DW_TAG_member, name: "slice_flags", scope: !1299, file: !4, line: 2034, baseType: !938, size: 32, align: 32, offset: 2272)
!1504 = !DIDerivedType(tag: DW_TAG_member, name: "mb_decision", scope: !1299, file: !4, line: 2044, baseType: !938, size: 32, align: 32, offset: 2304)
...
!1508 = !DIDerivedType(tag: DW_TAG_member, name: "scenechange_threshold", scope: !1299, file: !4, line: 2066, baseType: !938, size: 32, align: 32, offset: 2496)
!1509 = !DIDerivedType(tag: DW_TAG_member, name: "noise_reduction", scope: !1299, file: !4, line: 2070, baseType: !938, size: 32, align: 32, offset: 2528)
!1510 = !DIDerivedType(tag: DW_TAG_member, name: "intra_dc_precision", scope: !1299, file: !4, line: 2078, baseType: !938, size: 32, align: 32, offset: 2560)
!1511 = !DIDerivedType(tag: DW_TAG_member, name: "skip_top", scope: !1299, file: !4, line: 2085, baseType: !938, size: 32, align: 32, offset: 2592)
!1512 = !DIDerivedType(tag: DW_TAG_member, name: "skip_bottom", scope: !1299, file: !4, line: 2092, baseType: !938, size: 32, align: 32, offset: 2624)
!1513 = !DIDerivedType(tag: DW_TAG_member, name: "mb_lmin", scope: !1299, file: !4, line: 2099, baseType: !938, size: 32, align: 32, offset: 2656)
!1514 = !DIDerivedType(tag: DW_TAG_member, name: "mb_lmax", scope: !1299, file: !4, line: 2106, baseType: !938, size: 32, align: 32, offset: 2688)
!1515 = !DIDerivedType(tag: DW_TAG_member, name: "me_penalty_compensation", scope: !1299, file: !4, line: 2113, baseType: !938, size: 32, align: 32, offset: 2720)
!1516 = !DIDerivedType(tag: DW_TAG_member, name: "bidir_refine", scope: !1299, file: !4, line: 2120, baseType: !938, size: 32, align: 32, offset: 2752)
!1517 = !DIDerivedType(tag: DW_TAG_member, name: "brd_scale", scope: !1299, file: !4, line: 2125, baseType: !938, size: 32, align: 32, offset: 2784)
!1518 = !DIDerivedType(tag: DW_TAG_member, name: "keyint_min", scope: !1299, file: !4, line: 2133, baseType: !938, size: 32, align: 32, offset: 2816)
!1519 = !DIDerivedType(tag: DW_TAG_member, name: "refs", scope: !1299, file: !4, line: 2140, baseType: !938, size: 32, align: 32, offset: 2848)
!1520 = !DIDerivedType(tag: DW_TAG_member, name: "chromaoffset", scope: !1299, file: !4, line: 2145, baseType: !938, size: 32, align: 32, offset: 2880)
!1521 = !DIDerivedType(tag: DW_TAG_member, name: "mv0_threshold", scope: !1299, file: !4, line: 2153, baseType: !938, size: 32, align: 32, offset: 2912)
!1522 = !DIDerivedType(tag: DW_TAG_member, name: "b_sensitivity", scope: !1299, file: !4, line: 2158, baseType: !938, size: 32, align: 32, offset: 2944)
...
!1528 = !DIDerivedType(tag: DW_TAG_member, name: "slices", scope: !1299, file: !4, line: 2203, baseType: !938, size: 32, align: 32, offset: 3136)
...
!1530 = !DIDerivedType(tag: DW_TAG_member, name: "sample_rate", scope: !1299, file: !4, line: 2212, baseType: !938, size: 32, align: 32, offset: 3200)
!1531 = !DIDerivedType(tag: DW_TAG_member, name: "channels", scope: !1299, file: !4, line: 2213, baseType: !938, size: 32, align: 32, offset: 3232)
...
!1533 = !DIDerivedType(tag: DW_TAG_member, name: "frame_size", scope: !1299, file: !4, line: 2232, baseType: !938, size: 32, align: 32, offset: 3296)
!1534 = !DIDerivedType(tag: DW_TAG_member, name: "frame_number", scope: !1299, file: !4, line: 2243, baseType: !938, size: 32, align: 32, offset: 3328)
!1535 = !DIDerivedType(tag: DW_TAG_member, name: "block_align", scope: !1299, file: !4, line: 2249, baseType: !938, size: 32, align: 32, offset: 3360)
!1536 = !DIDerivedType(tag: DW_TAG_member, name: "cutoff", scope: !1299, file: !4, line: 2256, baseType: !938, size: 32, align: 32, offset: 3392)
...
!1544 = !{!938, !1469, !1105, !938}
!1545 = !DIDerivedType(tag: DW_TAG_member, name: "refcounted_frames", scope: !1299, file: !4, line: 2383, baseType: !938, size: 32, align: 32, offset: 3712)
...
!1548 = !DIDerivedType(tag: DW_TAG_member, name: "qmin", scope: !1299, file: !4, line: 2394, baseType: !938, size: 32, align: 32, offset: 3808)
!1549 = !DIDerivedType(tag: DW_TAG_member, name: "qmax", scope: !1299, file: !4, line: 2401, baseType: !938, size: 32, align: 32, offset: 3840)
!1550 = !DIDerivedType(tag: DW_TAG_member, name: "max_qdiff", scope: !1299, file: !4, line: 2408, baseType: !938, size: 32, align: 32, offset: 3872)
!1551 = !DIDerivedType(tag: DW_TAG_member, name: "rc_buffer_size", scope: !1299, file: !4, line: 2415, baseType: !938, size: 32, align: 32, offset: 3904)
!1552 = !DIDerivedType(tag: DW_TAG_member, name: "rc_override_count", scope: !1299, file: !4, line: 2422, baseType: !938, size: 32, align: 32, offset: 3936)
...
!1566 = !DIDerivedType(tag: DW_TAG_member, name: "rc_initial_buffer_occupancy", scope: !1299, file: !4, line: 2458, baseType: !938, size: 32, align: 32, offset: 4224)
!1567 = !DIDerivedType(tag: DW_TAG_member, name: "coder_type", scope: !1299, file: !4, line: 2469, baseType: !938, size: 32, align: 32, offset: 4256)
!1568 = !DIDerivedType(tag: DW_TAG_member, name: "context_model", scope: !1299, file: !4, line: 2475, baseType: !938, size: 32, align: 32, offset: 4288)
!1569 = !DIDerivedType(tag: DW_TAG_member, name: "frame_skip_threshold", scope: !1299, file: !4, line: 2481, baseType: !938, size: 32, align: 32, offset: 4320)
!1570 = !DIDerivedType(tag: DW_TAG_member, name: "frame_skip_factor", scope: !1299, file: !4, line: 2485, baseType: !938, size: 32, align: 32, offset: 4352)
!1571 = !DIDerivedType(tag: DW_TAG_member, name: "frame_skip_exp", scope: !1299, file: !4, line: 2489, baseType: !938, size: 32, align: 32, offset: 4384)
!1572 = !DIDerivedType(tag: DW_TAG_member, name: "frame_skip_cmp", scope: !1299, file: !4, line: 2493, baseType: !938, size: 32, align: 32, offset: 4416)
!1573 = !DIDerivedType(tag: DW_TAG_member, name: "trellis", scope: !1299, file: !4, line: 2501, baseType: !938, size: 32, align: 32, offset: 4448)
!1574 = !DIDerivedType(tag: DW_TAG_member, name: "min_prediction_order", scope: !1299, file: !4, line: 2506, baseType: !938, size: 32, align: 32, offset: 4480)
!1575 = !DIDerivedType(tag: DW_TAG_member, name: "max_prediction_order", scope: !1299, file: !4, line: 2510, baseType: !938, size: 32, align: 32, offset: 4512)
...
!1580 = !{null, !1469, !961, !938, !938}
!1581 = !DIDerivedType(tag: DW_TAG_member, name: "rtp_payload_size", scope: !1299, file: !4, line: 2534, baseType: !938, size: 32, align: 32, offset: 4672)
!1582 = !DIDerivedType(tag: DW_TAG_member, name: "mv_bits", scope: !1299, file: !4, line: 2545, baseType: !938, size: 32, align: 32, offset: 4704)
!1583 = !DIDerivedType(tag: DW_TAG_member, name: "header_bits", scope: !1299, file: !4, line: 2547, baseType: !938, size: 32, align: 32, offset: 4736)
!1584 = !DIDerivedType(tag: DW_TAG_member, name: "i_tex_bits", scope: !1299, file: !4, line: 2549, baseType: !938, size: 32, align: 32, offset: 4768)
!1585 = !DIDerivedType(tag: DW_TAG_member, name: "p_tex_bits", scope: !1299, file: !4, line: 2551, baseType: !938, size: 32, align: 32, offset: 4800)
!1586 = !DIDerivedType(tag: DW_TAG_member, name: "i_count", scope: !1299, file: !4, line: 2553, baseType: !938, size: 32, align: 32, offset: 4832)
!1587 = !DIDerivedType(tag: DW_TAG_member, name: "p_count", scope: !1299, file: !4, line: 2555, baseType: !938, size: 32, align: 32, offset: 4864)
!1588 = !DIDerivedType(tag: DW_TAG_member, name: "skip_count", scope: !1299, file: !4, line: 2557, baseType: !938, size: 32, align: 32, offset: 4896)
!1589 = !DIDerivedType(tag: DW_TAG_member, name: "misc_bits", scope: !1299, file: !4, line: 2559, baseType: !938, size: 32, align: 32, offset: 4928)
!1590 = !DIDerivedType(tag: DW_TAG_member, name: "frame_bits", scope: !1299, file: !4, line: 2563, baseType: !938, size: 32, align: 32, offset: 4960)
...
!1593 = !DIDerivedType(tag: DW_TAG_member, name: "workaround_bugs", scope: !1299, file: !4, line: 2586, baseType: !938, size: 32, align: 32, offset: 5120)
!1594 = !DIDerivedType(tag: DW_TAG_member, name: "strict_std_compliance", scope: !1299, file: !4, line: 2615, baseType: !938, size: 32, align: 32, offset: 5152)
!1595 = !DIDerivedType(tag: DW_TAG_member, name: "error_concealment", scope: !1299, file: !4, line: 2627, baseType: !938, size: 32, align: 32, offset: 5184)
!1596 = !DIDerivedType(tag: DW_TAG_member, name: "debug", scope: !1299, file: !4, line: 2637, baseType: !938, size: 32, align: 32, offset: 5216)
!1597 = !DIDerivedType(tag: DW_TAG_member, name: "err_recognition", scope: !1299, file: !4, line: 2681, baseType: !938, size: 32, align: 32, offset: 5248)
...
!1637 = !DIDerivedType(tag: DW_TAG_member, name: "dct_algo", scope: !1299, file: !4, line: 2742, baseType: !938, size: 32, align: 32, offset: 6016)
!1638 = !DIDerivedType(tag: DW_TAG_member, name: "idct_algo", scope: !1299, file: !4, line: 2755, baseType: !938, size: 32, align: 32, offset: 6048)
!1639 = !DIDerivedType(tag: DW_TAG_member, name: "bits_per_coded_sample", scope: !1299, file: !4, line: 2776, baseType: !938, size: 32, align: 32, offset: 6080)
!1640 = !DIDerivedType(tag: DW_TAG_member, name: "bits_per_raw_sample", scope: !1299, file: !4, line: 2783, baseType: !938, size: 32, align: 32, offset: 6112)
!1641 = !DIDerivedType(tag: DW_TAG_member, name: "lowres", scope: !1299, file: !4, line: 2791, baseType: !938, size: 32, align: 32, offset: 6144)
...
!1643 = !DIDerivedType(tag: DW_TAG_member, name: "thread_count", scope: !1299, file: !4, line: 2811, baseType: !938, size: 32, align: 32, offset: 6272)
!1644 = !DIDerivedType(tag: DW_TAG_member, name: "thread_type", scope: !1299, file: !4, line: 2821, baseType: !938, size: 32, align: 32, offset: 6304)
!1645 = !DIDerivedType(tag: DW_TAG_member, name: "active_thread_type", scope: !1299, file: !4, line: 2830, baseType: !938, size: 32, align: 32, offset: 6336)
!1646 = !DIDerivedType(tag: DW_TAG_member, name: "thread_safe_callbacks", scope: !1299, file: !4, line: 2840, baseType: !938, size: 32, align: 32, offset: 6368)
...
!1650 = !{!938, !1469, !1651, !961, !1412, !938, !938}
...
!1657 = !{!938, !1469, !1658, !961, !1412, !938}
!1658 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1659, size: 64, align: 64)
!1659 = !DISubroutineType(types: !1660)
!1660 = !{!938, !1469, !961, !938, !938}
!1661 = !DIDerivedType(tag: DW_TAG_member, name: "nsse_weight", scope: !1299, file: !4, line: 2878, baseType: !938, size: 32, align: 32, offset: 6528)
!1662 = !DIDerivedType(tag: DW_TAG_member, name: "profile", scope: !1299, file: !4, line: 2885, baseType: !938, size: 32, align: 32, offset: 6560)
!1663 = !DIDerivedType(tag: DW_TAG_member, name: "level", scope: !1299, file: !4, line: 3005, baseType: !938, size: 32, align: 32, offset: 6592)
...
!1668 = !DIDerivedType(tag: DW_TAG_member, name: "subtitle_header_size", scope: !1299, file: !4, line: 3038, baseType: !938, size: 32, align: 32, offset: 6784)
...
!1670 = !DIDerivedType(tag: DW_TAG_member, name: "side_data_only_packets", scope: !1299, file: !4, line: 3065, baseType: !938, size: 32, align: 32, offset: 6912)
!1671 = !DIDerivedType(tag: DW_TAG_member, name: "initial_padding", scope: !1299, file: !4, line: 3083, baseType: !938, size: 32, align: 32, offset: 6944)
...
!1697 = !DIDerivedType(tag: DW_TAG_member, name: "sub_charenc_mode", scope: !1299, file: !4, line: 3147, baseType: !938, size: 32, align: 32, offset: 7552)
!1698 = !DIDerivedType(tag: DW_TAG_member, name: "skip_alpha", scope: !1299, file: !4, line: 3165, baseType: !938, size: 32, align: 32, offset: 7584)
!1699 = !DIDerivedType(tag: DW_TAG_member, name: "seek_preroll", scope: !1299, file: !4, line: 3172, baseType: !938, size: 32, align: 32, offset: 7616)
!1700 = !DIDerivedType(tag: DW_TAG_member, name: "debug_mv", scope: !1299, file: !4, line: 3180, baseType: !938, size: 32, align: 32, offset: 7648)
...
!1706 = !DIDerivedType(tag: DW_TAG_member, name: "nb_coded_side_data", scope: !1299, file: !4, line: 3225, baseType: !938, size: 32, align: 32, offset: 8000)
...
!1708 = !DIDerivedType(tag: DW_TAG_member, name: "sub_text_format", scope: !1299, file: !4, line: 3256, baseType: !938, size: 32, align: 32, offset: 8128)
!1709 = !DIDerivedType(tag: DW_TAG_member, name: "trailing_padding", scope: !1299, file: !4, line: 3271, baseType: !938, size: 32, align: 32, offset: 8160)
...
!1712 = !DIDerivedType(tag: DW_TAG_member, name: "hwaccel_flags", scope: !1299, file: !4, line: 3310, baseType: !938, size: 32, align: 32, offset: 8320)
!1713 = !DIDerivedType(tag: DW_TAG_member, name: "apply_cropping", scope: !1299, file: !4, line: 3337, baseType: !938, size: 32, align: 32, offset: 8352)
!1714 = !DIDerivedType(tag: DW_TAG_member, name: "extra_hw_frames", scope: !1299, file: !4, line: 3351, baseType: !938, size: 32, align: 32, offset: 8384)
!1715 = !DIDerivedType(tag: DW_TAG_member, name: "discard_damaged_percentage", scope: !1299, file: !4, line: 3359, baseType: !938, size: 32, align: 32, offset: 8416)
...
!1721 = !DIDerivedType(tag: DW_TAG_member, name: "disposition", scope: !1292, file: !897, line: 918, baseType: !938, size: 32, align: 32, offset: 448)
...
!1728 = !DIDerivedType(tag: DW_TAG_member, name: "nb_side_data", scope: !1292, file: !897, line: 971, baseType: !938, size: 32, align: 32, offset: 1472)
!1729 = !DIDerivedType(tag: DW_TAG_member, name: "event_flags", scope: !1292, file: !897, line: 978, baseType: !938, size: 32, align: 32, offset: 1504)
...
!1790 = !DIDerivedType(tag: DW_TAG_member, name: "pts_wrap_bits", scope: !1292, file: !897, line: 1057, baseType: !938, size: 32, align: 32, offset: 1792)
...
!1794 = !DIDerivedType(tag: DW_TAG_member, name: "last_IP_duration", scope: !1292, file: !897, line: 1070, baseType: !938, size: 32, align: 32, offset: 2048)
!1795 = !DIDerivedType(tag: DW_TAG_member, name: "probe_packets", scope: !1292, file: !897, line: 1075, baseType: !938, size: 32, align: 32, offset: 2080)
!1796 = !DIDerivedType(tag: DW_TAG_member, name: "codec_info_nb_frames", scope: !1292, file: !897, line: 1080, baseType: !938, size: 32, align: 32, offset: 2112)
...
!1821 = !{!938, !1816, !1297, !1822, !1412, !1251, !938}
...
!1888 = !DIDerivedType(tag: DW_TAG_member, name: "nb_index_entries", scope: !1292, file: !897, line: 1096, baseType: !938, size: 32, align: 32, offset: 3712)
...
!1890 = !DIDerivedType(tag: DW_TAG_member, name: "stream_identifier", scope: !1292, file: !897, line: 1104, baseType: !938, size: 32, align: 32, offset: 3776)
!1891 = !DIDerivedType(tag: DW_TAG_member, name: "program_num", scope: !1292, file: !897, line: 1109, baseType: !938, size: 32, align: 32, offset: 3808)
!1892 = !DIDerivedType(tag: DW_TAG_member, name: "pmt_version", scope: !1292, file: !897, line: 1110, baseType: !938, size: 32, align: 32, offset: 3840)
!1893 = !DIDerivedType(tag: DW_TAG_member, name: "pmt_stream_idx", scope: !1292, file: !897, line: 1111, baseType: !938, size: 32, align: 32, offset: 3872)
...
!1896 = !DIDerivedType(tag: DW_TAG_member, name: "request_probe", scope: !1292, file: !897, line: 1123, baseType: !938, size: 32, align: 32, offset: 4032)
!1897 = !DIDerivedType(tag: DW_TAG_member, name: "skip_to_keyframe", scope: !1292, file: !897, line: 1128, baseType: !938, size: 32, align: 32, offset: 4064)
!1898 = !DIDerivedType(tag: DW_TAG_member, name: "skip_samples", scope: !1292, file: !897, line: 1133, baseType: !938, size: 32, align: 32, offset: 4096)
...
!1902 = !DIDerivedType(tag: DW_TAG_member, name: "nb_decoded_frames", scope: !1292, file: !897, line: 1163, baseType: !938, size: 32, align: 32, offset: 4352)
...
!1905 = !DIDerivedType(tag: DW_TAG_member, name: "pts_wrap_behavior", scope: !1292, file: !897, line: 1186, baseType: !938, size: 32, align: 32, offset: 4544)
!1906 = !DIDerivedType(tag: DW_TAG_member, name: "update_initial_durations_done", scope: !1292, file: !897, line: 1191, baseType: !938, size: 32, align: 32, offset: 4576)
...
!1913 = !DIDerivedType(tag: DW_TAG_member, name: "inject_global_side_data", scope: !1292, file: !897, line: 1209, baseType: !938, size: 32, align: 32, offset: 5984)
...
!1990 = !DIDerivedType(tag: DW_TAG_member, name: "max_delay", scope: !1016, file: !897, line: 1462, baseType: !938, size: 32, align: 32, offset: 8928)
!1991 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !1016, file: !897, line: 1468, baseType: !938, size: 32, align: 32, offset: 8960)
...
!1995 = !DIDerivedType(tag: DW_TAG_member, name: "keylen", scope: !1016, file: !897, line: 1514, baseType: !938, size: 32, align: 32, offset: 9216)
...
!2037 = !DIDerivedType(tag: DW_TAG_member, name: "fps_probe_size", scope: !1016, file: !897, line: 1597, baseType: !938, size: 32, align: 32, offset: 9728)
!2038 = !DIDerivedType(tag: DW_TAG_member, name: "error_recognition", scope: !1016, file: !897, line: 1604, baseType: !938, size: 32, align: 32, offset: 9760)
...
!2045 = !DIDerivedType(tag: DW_TAG_member, name: "debug", scope: !1016, file: !897, line: 1620, baseType: !938, size: 32, align: 32, offset: 9920)
...
!2047 = !DIDerivedType(tag: DW_TAG_member, name: "strict_std_compliance", scope: !1016, file: !897, line: 1645, baseType: !938, size: 32, align: 32, offset: 10048)
!2048 = !DIDerivedType(tag: DW_TAG_member, name: "event_flags", scope: !1016, file: !897, line: 1652, baseType: !938, size: 32, align: 32, offset: 10080)
!2049 = !DIDerivedType(tag: DW_TAG_member, name: "max_ts_probe", scope: !1016, file: !897, line: 1659, baseType: !938, size: 32, align: 32, offset: 10112)
!2050 = !DIDerivedType(tag: DW_TAG_member, name: "avoid_negative_ts", scope: !1016, file: !897, line: 1668, baseType: !938, size: 32, align: 32, offset: 10144)
!2051 = !DIDerivedType(tag: DW_TAG_member, name: "ts_id", scope: !1016, file: !897, line: 1677, baseType: !938, size: 32, align: 32, offset: 10176)
!2052 = !DIDerivedType(tag: DW_TAG_member, name: "audio_preload", scope: !1016, file: !897, line: 1685, baseType: !938, size: 32, align: 32, offset: 10208)
!2053 = !DIDerivedType(tag: DW_TAG_member, name: "max_chunk_duration", scope: !1016, file: !897, line: 1693, baseType: !938, size: 32, align: 32, offset: 10240)
!2054 = !DIDerivedType(tag: DW_TAG_member, name: "max_chunk_size", scope: !1016, file: !897, line: 1701, baseType: !938, size: 32, align: 32, offset: 10272)
!2055 = !DIDerivedType(tag: DW_TAG_member, name: "use_wallclock_as_timestamps", scope: !1016, file: !897, line: 1709, baseType: !938, size: 32, align: 32, offset: 10304)
!2056 = !DIDerivedType(tag: DW_TAG_member, name: "avio_flags", scope: !1016, file: !897, line: 1716, baseType: !938, size: 32, align: 32, offset: 10336)
...
!2060 = !DIDerivedType(tag: DW_TAG_member, name: "seek2any", scope: !1016, file: !897, line: 1745, baseType: !938, size: 32, align: 32, offset: 10528)
!2061 = !DIDerivedType(tag: DW_TAG_member, name: "flush_packets", scope: !1016, file: !897, line: 1752, baseType: !938, size: 32, align: 32, offset: 10560)
!2062 = !DIDerivedType(tag: DW_TAG_member, name: "probe_score", scope: !1016, file: !897, line: 1761, baseType: !938, size: 32, align: 32, offset: 10592)
!2063 = !DIDerivedType(tag: DW_TAG_member, name: "format_probesize", scope: !1016, file: !897, line: 1768, baseType: !938, size: 32, align: 32, offset: 10624)
...
!2090 = !DIDerivedType(tag: DW_TAG_member, name: "io_repositioned", scope: !1016, file: !897, line: 1798, baseType: !938, size: 32, align: 32, offset: 10880)
...
!2097 = !DIDerivedType(tag: DW_TAG_member, name: "metadata_header_padding", scope: !1016, file: !897, line: 1837, baseType: !938, size: 32, align: 32, offset: 11200)
...
!2107 = !{!938, !1015, !2108, !933, !938, !2109, !2111}
...
!2116 = !{!938, !1015, !2108, !933, !938, !2111}
...
!2122 = !DIDerivedType(tag: DW_TAG_member, name: "max_streams", scope: !1016, file: !897, line: 1939, baseType: !938, size: 32, align: 32, offset: 11904)
!2123 = !DIDerivedType(tag: DW_TAG_member, name: "skip_estimate_duration_from_pts", scope: !1016, file: !897, line: 1946, baseType: !938, size: 32, align: 32, offset: 11936)
!2124 = !DIDerivedType(tag: DW_TAG_member, name: "read_packet", scope: !930, file: !897, line: 714, baseType: !1038, size: 64, align: 64, offset: 704)
!2125 = !DIDerivedType(tag: DW_TAG_member, name: "read_close", scope: !930, file: !897, line: 720, baseType: !1012, size: 64, align: 64, offset: 768)
...
!2133 = !{!1060, !1015, !938, !1092, !1060}
!2134 = !DIDerivedType(tag: DW_TAG_member, name: "read_play", scope: !930, file: !897, line: 744, baseType: !1012, size: 64, align: 64, offset: 960)
!2135 = !DIDerivedType(tag: DW_TAG_member, name: "read_pause", scope: !930, file: !897, line: 750, baseType: !1012, size: 64, align: 64, offset: 1024)
...
!2139 = !{!938, !1015, !938, !1060, !1060, !1060, !938}
!2140 = !DIDerivedType(tag: DW_TAG_member, name: "get_device_list", scope: !930, file: !897, line: 764, baseType: !1196, size: 64, align: 64, offset: 1152)
!2141 = !DIDerivedType(tag: DW_TAG_member, name: "create_device_capabilities", scope: !930, file: !897, line: 770, baseType: !1202, size: 64, align: 64, offset: 1216)
!2142 = !DIDerivedType(tag: DW_TAG_member, name: "free_device_capabilities", scope: !930, file: !897, line: 776, baseType: !1202, size: 64, align: 64, offset: 1280)
!2143 = !{i32 2, !"Dwarf Version", i32 4}
!2144 = !{i32 2, !"Debug Info Version", i32 3}
!2145 = !{!"clang version 3.9.0 (tags/RELEASE_390/final)"}
!2146 = distinct !DISubprogram(name: "sol_probe", scope: !928, file: !928, line: 35, type: !999, isLocal: true, isDefinition: true, scopeLine: 36, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2147 = !{}
!2148 = !DILocalVariable(name: "p", arg: 1, scope: !2146, file: !928, line: 35, type: !1001)
!2149 = !DIExpression()
!2150 = !DILocation(line: 35, column: 35, scope: !2146)
!2151 = !DILocalVariable(name: "magic", scope: !2146, file: !928, line: 38, type: !1372)
!2152 = !DILocation(line: 38, column: 14, scope: !2146)
!2153 = !DILocation(line: 38, column: 54, scope: !2146)
!2154 = !DILocation(line: 38, column: 57, scope: !2146)
!2155 = !DILocation(line: 38, column: 64, scope: !2146)
!2156 = !DILocation(line: 38, column: 22, scope: !2146)
!2157 = !DILocation(line: 39, column: 10, scope: !2158)
!2158 = distinct !DILexicalBlock(scope: !2146, file: !928, line: 39, column: 9)
!2159 = !DILocation(line: 39, column: 16, scope: !2158)
!2160 = !DILocation(line: 39, column: 26, scope: !2158)
!2161 = !DILocation(line: 39, column: 29, scope: !2162)
!2162 = !DILexicalBlockFile(scope: !2158, file: !928, discriminator: 1)
!2163 = !DILocation(line: 39, column: 35, scope: !2162)
!2164 = !DILocation(line: 39, column: 45, scope: !2162)
!2165 = !DILocation(line: 39, column: 48, scope: !2166)
!2166 = !DILexicalBlockFile(scope: !2158, file: !928, discriminator: 2)
!2167 = !DILocation(line: 39, column: 54, scope: !2166)
!2168 = !DILocation(line: 39, column: 65, scope: !2166)
!2169 = !DILocation(line: 40, column: 9, scope: !2158)
!2170 = !DILocation(line: 40, column: 12, scope: !2158)
!2171 = !DILocation(line: 40, column: 19, scope: !2158)
!2172 = !DILocation(line: 40, column: 26, scope: !2158)
!2173 = !DILocation(line: 40, column: 29, scope: !2162)
!2174 = !DILocation(line: 40, column: 32, scope: !2162)
!2175 = !DILocation(line: 40, column: 39, scope: !2162)
!2176 = !DILocation(line: 40, column: 46, scope: !2162)
!2177 = !DILocation(line: 41, column: 9, scope: !2158)
!2178 = !DILocation(line: 41, column: 12, scope: !2158)
!2179 = !DILocation(line: 41, column: 19, scope: !2158)
!2180 = !DILocation(line: 41, column: 26, scope: !2158)
!2181 = !DILocation(line: 41, column: 29, scope: !2162)
!2182 = !DILocation(line: 41, column: 32, scope: !2162)
!2183 = !DILocation(line: 41, column: 39, scope: !2162)
!2184 = !DILocation(line: 39, column: 9, scope: !2185)
!2185 = !DILexicalBlockFile(scope: !2146, file: !928, discriminator: 3)
!2186 = !DILocation(line: 42, column: 9, scope: !2158)
!2187 = !DILocation(line: 44, column: 9, scope: !2158)
!2188 = !DILocation(line: 45, column: 1, scope: !2146)
!2189 = distinct !DISubprogram(name: "sol_read_header", scope: !928, file: !928, line: 83, type: !2190, isLocal: true, isDefinition: true, scopeLine: 84, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2190 = !DISubroutineType(types: !2191)
!2191 = !{!938, !2192}
!2192 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2193, size: 64, align: 64)
!2193 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1016)
!2194 = !DILocalVariable(name: "s", arg: 1, scope: !2189, file: !928, line: 83, type: !2192)
!2195 = !DILocation(line: 83, column: 45, scope: !2189)
!2196 = !DILocalVariable(name: "magic", scope: !2189, file: !928, line: 85, type: !925)
!2197 = !DILocation(line: 85, column: 18, scope: !2189)
!2198 = !DILocalVariable(name: "tag", scope: !2189, file: !928, line: 85, type: !925)
!2199 = !DILocation(line: 85, column: 24, scope: !2189)
!2200 = !DILocalVariable(name: "pb", scope: !2189, file: !928, line: 86, type: !1222)
!2201 = !DILocation(line: 86, column: 18, scope: !2189)
!2202 = !DILocation(line: 86, column: 23, scope: !2189)
!2203 = !DILocation(line: 86, column: 26, scope: !2189)
!2204 = !DILocalVariable(name: "id", scope: !2189, file: !928, line: 87, type: !925)
!2205 = !DILocation(line: 87, column: 18, scope: !2189)
!2206 = !DILocalVariable(name: "channels", scope: !2189, file: !928, line: 87, type: !925)
!2207 = !DILocation(line: 87, column: 22, scope: !2189)
!2208 = !DILocalVariable(name: "rate", scope: !2189, file: !928, line: 87, type: !925)
!2209 = !DILocation(line: 87, column: 32, scope: !2189)
!2210 = !DILocalVariable(name: "type", scope: !2189, file: !928, line: 87, type: !925)
!2211 = !DILocation(line: 87, column: 38, scope: !2189)
!2212 = !DILocalVariable(name: "codec", scope: !2189, file: !928, line: 88, type: !3)
!2213 = !DILocation(line: 88, column: 20, scope: !2189)
!2214 = !DILocalVariable(name: "st", scope: !2189, file: !928, line: 89, type: !1290)
!2215 = !DILocation(line: 89, column: 15, scope: !2189)
!2216 = !DILocation(line: 92, column: 23, scope: !2189)
!2217 = !DILocation(line: 92, column: 13, scope: !2189)
!2218 = !DILocation(line: 92, column: 11, scope: !2189)
!2219 = !DILocation(line: 93, column: 21, scope: !2189)
!2220 = !DILocation(line: 93, column: 11, scope: !2189)
!2221 = !DILocation(line: 93, column: 9, scope: !2189)
!2222 = !DILocation(line: 94, column: 9, scope: !2223)
!2223 = distinct !DILexicalBlock(scope: !2189, file: !928, line: 94, column: 9)
!2224 = !DILocation(line: 94, column: 13, scope: !2223)
!2225 = !DILocation(line: 94, column: 9, scope: !2189)
!2226 = !DILocation(line: 95, column: 9, scope: !2223)
!2227 = !DILocation(line: 96, column: 22, scope: !2189)
!2228 = !DILocation(line: 96, column: 12, scope: !2189)
!2229 = !DILocation(line: 96, column: 10, scope: !2189)
!2230 = !DILocation(line: 97, column: 20, scope: !2189)
!2231 = !DILocation(line: 97, column: 12, scope: !2189)
!2232 = !DILocation(line: 97, column: 10, scope: !2189)
!2233 = !DILocation(line: 98, column: 15, scope: !2189)
!2234 = !DILocation(line: 98, column: 5, scope: !2189)
!2235 = !DILocation(line: 99, column: 9, scope: !2236)
!2236 = distinct !DILexicalBlock(scope: !2189, file: !928, line: 99, column: 9)
!2237 = !DILocation(line: 99, column: 15, scope: !2236)
!2238 = !DILocation(line: 99, column: 9, scope: !2189)
!2239 = !DILocation(line: 100, column: 17, scope: !2236)
!2240 = !DILocation(line: 100, column: 9, scope: !2236)
!2241 = !DILocation(line: 102, column: 26, scope: !2189)
!2242 = !DILocation(line: 102, column: 33, scope: !2189)
!2243 = !DILocation(line: 102, column: 13, scope: !2189)
!2244 = !DILocation(line: 102, column: 11, scope: !2189)
!2245 = !DILocation(line: 103, column: 29, scope: !2189)
!2246 = !DILocation(line: 103, column: 36, scope: !2189)
!2247 = !DILocation(line: 103, column: 16, scope: !2189)
!2248 = !DILocation(line: 103, column: 14, scope: !2189)
!2249 = !DILocation(line: 105, column: 9, scope: !2250)
!2250 = distinct !DILexicalBlock(scope: !2189, file: !928, line: 105, column: 9)
!2251 = !DILocation(line: 105, column: 15, scope: !2250)
!2252 = !DILocation(line: 105, column: 9, scope: !2189)
!2253 = !DILocation(line: 106, column: 29, scope: !2250)
!2254 = !DILocation(line: 106, column: 36, scope: !2250)
!2255 = !DILocation(line: 106, column: 14, scope: !2250)
!2256 = !DILocation(line: 106, column: 12, scope: !2250)
!2257 = !DILocation(line: 106, column: 9, scope: !2250)
!2258 = !DILocation(line: 107, column: 13, scope: !2250)
!2259 = !DILocation(line: 110, column: 30, scope: !2189)
!2260 = !DILocation(line: 110, column: 10, scope: !2189)
!2261 = !DILocation(line: 110, column: 8, scope: !2189)
!2262 = !DILocation(line: 111, column: 10, scope: !2263)
!2263 = distinct !DILexicalBlock(scope: !2189, file: !928, line: 111, column: 9)
!2264 = !DILocation(line: 111, column: 9, scope: !2189)
!2265 = !DILocation(line: 112, column: 9, scope: !2263)
!2266 = !DILocation(line: 113, column: 5, scope: !2189)
!2267 = !DILocation(line: 113, column: 9, scope: !2189)
!2268 = !DILocation(line: 113, column: 19, scope: !2189)
!2269 = !DILocation(line: 113, column: 30, scope: !2189)
!2270 = !DILocation(line: 114, column: 31, scope: !2189)
!2271 = !DILocation(line: 114, column: 5, scope: !2189)
!2272 = !DILocation(line: 114, column: 9, scope: !2189)
!2273 = !DILocation(line: 114, column: 19, scope: !2189)
!2274 = !DILocation(line: 114, column: 29, scope: !2189)
!2275 = !DILocation(line: 115, column: 30, scope: !2189)
!2276 = !DILocation(line: 115, column: 5, scope: !2189)
!2277 = !DILocation(line: 115, column: 9, scope: !2189)
!2278 = !DILocation(line: 115, column: 19, scope: !2189)
!2279 = !DILocation(line: 115, column: 28, scope: !2189)
!2280 = !DILocation(line: 116, column: 30, scope: !2189)
!2281 = !DILocation(line: 116, column: 5, scope: !2189)
!2282 = !DILocation(line: 116, column: 9, scope: !2189)
!2283 = !DILocation(line: 116, column: 19, scope: !2189)
!2284 = !DILocation(line: 116, column: 28, scope: !2189)
!2285 = !DILocation(line: 117, column: 36, scope: !2189)
!2286 = !DILocation(line: 117, column: 45, scope: !2189)
!2287 = !DILocation(line: 117, column: 5, scope: !2189)
!2288 = !DILocation(line: 117, column: 9, scope: !2189)
!2289 = !DILocation(line: 117, column: 19, scope: !2189)
!2290 = !DILocation(line: 117, column: 34, scope: !2189)
!2291 = !DILocation(line: 119, column: 33, scope: !2189)
!2292 = !DILocation(line: 119, column: 5, scope: !2189)
!2293 = !DILocation(line: 119, column: 9, scope: !2189)
!2294 = !DILocation(line: 119, column: 19, scope: !2189)
!2295 = !DILocation(line: 119, column: 31, scope: !2189)
!2296 = !DILocation(line: 120, column: 25, scope: !2189)
!2297 = !DILocation(line: 120, column: 36, scope: !2189)
!2298 = !DILocation(line: 120, column: 5, scope: !2189)
!2299 = !DILocation(line: 121, column: 5, scope: !2189)
!2300 = !DILocation(line: 122, column: 1, scope: !2189)
!2301 = distinct !DISubprogram(name: "sol_read_packet", scope: !928, file: !928, line: 126, type: !2302, isLocal: true, isDefinition: true, scopeLine: 128, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2302 = !DISubroutineType(types: !2303)
!2303 = !{!938, !2192, !1041}
!2304 = !DILocalVariable(name: "s", arg: 1, scope: !2301, file: !928, line: 126, type: !2192)
!2305 = !DILocation(line: 126, column: 45, scope: !2301)
!2306 = !DILocalVariable(name: "pkt", arg: 2, scope: !2301, file: !928, line: 127, type: !1041)
!2307 = !DILocation(line: 127, column: 37, scope: !2301)
!2308 = !DILocalVariable(name: "ret", scope: !2301, file: !928, line: 129, type: !938)
!2309 = !DILocation(line: 129, column: 9, scope: !2301)
!2310 = !DILocation(line: 131, column: 19, scope: !2311)
!2311 = distinct !DILexicalBlock(scope: !2301, file: !928, line: 131, column: 9)
!2312 = !DILocation(line: 131, column: 22, scope: !2311)
!2313 = !DILocation(line: 131, column: 9, scope: !2311)
!2314 = !DILocation(line: 131, column: 9, scope: !2301)
!2315 = !DILocation(line: 132, column: 9, scope: !2311)
!2316 = !DILocation(line: 133, column: 24, scope: !2301)
!2317 = !DILocation(line: 133, column: 27, scope: !2301)
!2318 = !DILocation(line: 133, column: 31, scope: !2301)
!2319 = !DILocation(line: 133, column: 10, scope: !2301)
!2320 = !DILocation(line: 133, column: 8, scope: !2301)
!2321 = !DILocation(line: 134, column: 9, scope: !2322)
!2322 = distinct !DILexicalBlock(scope: !2301, file: !928, line: 134, column: 9)
!2323 = !DILocation(line: 134, column: 13, scope: !2322)
!2324 = !DILocation(line: 134, column: 9, scope: !2301)
!2325 = !DILocation(line: 135, column: 16, scope: !2322)
!2326 = !DILocation(line: 135, column: 9, scope: !2322)
!2327 = !DILocation(line: 136, column: 5, scope: !2301)
!2328 = !DILocation(line: 136, column: 10, scope: !2301)
!2329 = !DILocation(line: 136, column: 16, scope: !2301)
!2330 = !DILocation(line: 137, column: 5, scope: !2301)
!2331 = !DILocation(line: 137, column: 10, scope: !2301)
!2332 = !DILocation(line: 137, column: 23, scope: !2301)
!2333 = !DILocation(line: 138, column: 5, scope: !2301)
!2334 = !DILocation(line: 139, column: 1, scope: !2301)
!2335 = distinct !DISubprogram(name: "sol_codec_id", scope: !928, file: !928, line: 51, type: !2336, isLocal: true, isDefinition: true, scopeLine: 52, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2336 = !DISubroutineType(types: !2337)
!2337 = !{!3, !938, !938}
!2338 = !DILocalVariable(name: "magic", arg: 1, scope: !2335, file: !928, line: 51, type: !938)
!2339 = !DILocation(line: 51, column: 40, scope: !2335)
!2340 = !DILocalVariable(name: "type", arg: 2, scope: !2335, file: !928, line: 51, type: !938)
!2341 = !DILocation(line: 51, column: 51, scope: !2335)
!2342 = !DILocation(line: 53, column: 9, scope: !2343)
!2343 = distinct !DILexicalBlock(scope: !2335, file: !928, line: 53, column: 9)
!2344 = !DILocation(line: 53, column: 14, scope: !2343)
!2345 = !DILocation(line: 53, column: 9, scope: !2335)
!2346 = !DILocation(line: 54, column: 9, scope: !2343)
!2347 = !DILocation(line: 56, column: 9, scope: !2348)
!2348 = distinct !DILexicalBlock(scope: !2335, file: !928, line: 56, column: 9)
!2349 = !DILocation(line: 56, column: 15, scope: !2348)
!2350 = !DILocation(line: 56, column: 9, scope: !2335)
!2351 = !DILocation(line: 57, column: 9, scope: !2348)
!2352 = !DILocation(line: 59, column: 9, scope: !2353)
!2353 = distinct !DILexicalBlock(scope: !2335, file: !928, line: 59, column: 9)
!2354 = !DILocation(line: 59, column: 14, scope: !2353)
!2355 = !DILocation(line: 59, column: 9, scope: !2335)
!2356 = !DILocation(line: 60, column: 9, scope: !2353)
!2357 = !DILocation(line: 62, column: 5, scope: !2335)
!2358 = !DILocation(line: 63, column: 1, scope: !2335)
!2359 = distinct !DISubprogram(name: "sol_channels", scope: !928, file: !928, line: 77, type: !2360, isLocal: true, isDefinition: true, scopeLine: 78, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2360 = !DISubroutineType(types: !2361)
!2361 = !{!938, !938, !938}
!2362 = !DILocalVariable(name: "magic", arg: 1, scope: !2359, file: !928, line: 77, type: !938)
!2363 = !DILocation(line: 77, column: 29, scope: !2359)
!2364 = !DILocalVariable(name: "type", arg: 2, scope: !2359, file: !928, line: 77, type: !938)
!2365 = !DILocation(line: 77, column: 40, scope: !2359)
!2366 = !DILocation(line: 79, column: 9, scope: !2367)
!2367 = distinct !DILexicalBlock(scope: !2359, file: !928, line: 79, column: 9)
!2368 = !DILocation(line: 79, column: 15, scope: !2367)
!2369 = !DILocation(line: 79, column: 25, scope: !2367)
!2370 = !DILocation(line: 79, column: 30, scope: !2371)
!2371 = !DILexicalBlockFile(scope: !2367, file: !928, discriminator: 1)
!2372 = !DILocation(line: 79, column: 35, scope: !2371)
!2373 = !DILocation(line: 79, column: 9, scope: !2371)
!2374 = !DILocation(line: 79, column: 42, scope: !2375)
!2375 = !DILexicalBlockFile(scope: !2367, file: !928, discriminator: 2)
!2376 = !DILocation(line: 80, column: 5, scope: !2359)
!2377 = !DILocation(line: 81, column: 1, scope: !2359)
!2378 = distinct !DISubprogram(name: "sol_codec_type", scope: !928, file: !928, line: 65, type: !2360, isLocal: true, isDefinition: true, scopeLine: 66, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2379 = !DILocalVariable(name: "magic", arg: 1, scope: !2378, file: !928, line: 65, type: !938)
!2380 = !DILocation(line: 65, column: 31, scope: !2378)
!2381 = !DILocalVariable(name: "type", arg: 2, scope: !2378, file: !928, line: 65, type: !938)
!2382 = !DILocation(line: 65, column: 42, scope: !2378)
!2383 = !DILocation(line: 67, column: 9, scope: !2384)
!2384 = distinct !DILexicalBlock(scope: !2378, file: !928, line: 67, column: 9)
!2385 = !DILocation(line: 67, column: 15, scope: !2384)
!2386 = !DILocation(line: 67, column: 9, scope: !2378)
!2387 = !DILocation(line: 67, column: 26, scope: !2388)
!2388 = !DILexicalBlockFile(scope: !2384, file: !928, discriminator: 1)
!2389 = !DILocation(line: 68, column: 9, scope: !2390)
!2390 = distinct !DILexicalBlock(scope: !2378, file: !928, line: 68, column: 9)
!2391 = !DILocation(line: 68, column: 14, scope: !2390)
!2392 = !DILocation(line: 68, column: 9, scope: !2378)
!2393 = !DILocation(line: 70, column: 13, scope: !2394)
!2394 = distinct !DILexicalBlock(scope: !2395, file: !928, line: 70, column: 13)
!2395 = distinct !DILexicalBlock(scope: !2390, file: !928, line: 69, column: 5)
!2396 = !DILocation(line: 70, column: 18, scope: !2394)
!2397 = !DILocation(line: 70, column: 13, scope: !2395)
!2398 = !DILocation(line: 70, column: 23, scope: !2399)
!2399 = !DILexicalBlockFile(scope: !2394, file: !928, discriminator: 1)
!2400 = !DILocation(line: 71, column: 18, scope: !2401)
!2401 = distinct !DILexicalBlock(scope: !2394, file: !928, line: 71, column: 18)
!2402 = !DILocation(line: 71, column: 24, scope: !2401)
!2403 = !DILocation(line: 71, column: 18, scope: !2394)
!2404 = !DILocation(line: 71, column: 35, scope: !2405)
!2405 = !DILexicalBlockFile(scope: !2401, file: !928, discriminator: 1)
!2406 = !DILocation(line: 72, column: 14, scope: !2401)
!2407 = !DILocation(line: 74, column: 5, scope: !2378)
!2408 = !DILocation(line: 75, column: 1, scope: !2378)
