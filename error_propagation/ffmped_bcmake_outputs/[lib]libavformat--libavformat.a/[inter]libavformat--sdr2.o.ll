; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--sdr2.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--sdr2.o.i"
...
@ff_sdr2_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i32 0, i32 0), i32 256, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 0, i32 (%struct.AVProbeData*)* @sdr2_probe, i32 (%struct.AVFormatContext*)* @sdr2_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @sdr2_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
@header = internal constant [24 x i8] c"\00\00\00\01gB\00\1E\A6\80\B0~@\00\00\00\01h\CE8\80\00\00\00", align 16

; Function Attrs: nounwind uwtable
define internal i32 @sdr2_probe(%struct.AVProbeData* %p) #0 !dbg !2150 {
entry:
  ...
  %2 = bitcast i8* %1 to %union.unaligned_32*, !dbg !2158
  %l = bitcast %union.unaligned_32* %2 to i32*, !dbg !2158
  %3 = load i32, i32* %l, align 1, !dbg !2158
  %cmp = icmp ne i32 %3, 21058131, !dbg !2159
...
if.end:                                           ; preds = %entry
  store i32 50, i32* %retval, align 4, !dbg !2162
  br label %return, !dbg !2162

return:                                           ; preds = %if.end, %if.then
  %4 = load i32, i32* %retval, align 4, !dbg !2163
  ret i32 %4, !dbg !2163
}

; Function Attrs: nounwind uwtable
define internal i32 @sdr2_read_header(%struct.AVFormatContext* %s) #0 !dbg !2164 {
entry:
  %retval = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2169, metadata !2153), !dbg !2170
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2171, metadata !2153), !dbg !2172
  call void @llvm.dbg.declare(metadata %struct.AVStream** %ast, metadata !2173, metadata !2153), !dbg !2174
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2175
  %call = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %0, %struct.AVCodec* null), !dbg !2176
  store %struct.AVStream* %call, %struct.AVStream** %ast, align 8, !dbg !2177
  %1 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2178
  %tobool = icmp ne %struct.AVStream* %1, null, !dbg !2178
  br i1 %tobool, label %if.end, label %if.then, !dbg !2180

if.then:                                          ; preds = %entry
  store i32 -12, i32* %retval, align 4, !dbg !2181
  br label %return, !dbg !2181

if.end:                                           ; preds = %entry
  %2 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2182
  %call1 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %2, %struct.AVCodec* null), !dbg !2183
  store %struct.AVStream* %call1, %struct.AVStream** %st, align 8, !dbg !2184
  %3 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2185
  %tobool2 = icmp ne %struct.AVStream* %3, null, !dbg !2185
  br i1 %tobool2, label %if.end4, label %if.then3, !dbg !2187

if.then3:                                         ; preds = %if.end
  store i32 -12, i32* %retval, align 4, !dbg !2188
  br label %return, !dbg !2188

if.end4:                                          ; preds = %if.end
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2189
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %4, i32 0, i32 4, !dbg !2190
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2190
  %call5 = call i64 @avio_skip(%struct.AVIOContext* %5, i64 20), !dbg !2191
  %6 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2192
  %7 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2193
  %pb6 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %7, i32 0, i32 4, !dbg !2194
  %8 = load %struct.AVIOContext*, %struct.AVIOContext** %pb6, align 8, !dbg !2194
  %call7 = call i32 @avio_rl32(%struct.AVIOContext* %8), !dbg !2195
  call void @avpriv_set_pts_info(%struct.AVStream* %6, i32 64, i32 1, i32 %call7), !dbg !2196
  %9 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2198
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %9, i32 0, i32 19, !dbg !2199
  %10 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2199
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %10, i32 0, i32 0, !dbg !2200
  store i32 0, i32* %codec_type, align 8, !dbg !2201
  %11 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2202
  %pb8 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %11, i32 0, i32 4, !dbg !2203
  %12 = load %struct.AVIOContext*, %struct.AVIOContext** %pb8, align 8, !dbg !2203
  %call9 = call i32 @avio_rl32(%struct.AVIOContext* %12), !dbg !2204
  %13 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2205
  %codecpar10 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %13, i32 0, i32 19, !dbg !2206
  %14 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar10, align 8, !dbg !2206
  %width = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %14, i32 0, i32 11, !dbg !2207
  store i32 %call9, i32* %width, align 8, !dbg !2208
  %15 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2209
  %pb11 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %15, i32 0, i32 4, !dbg !2210
  %16 = load %struct.AVIOContext*, %struct.AVIOContext** %pb11, align 8, !dbg !2210
  %call12 = call i32 @avio_rl32(%struct.AVIOContext* %16), !dbg !2211
  %17 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2212
  %codecpar13 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %17, i32 0, i32 19, !dbg !2213
  %18 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar13, align 8, !dbg !2213
  %height = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %18, i32 0, i32 12, !dbg !2214
  store i32 %call12, i32* %height, align 4, !dbg !2215
  %19 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2216
  %codecpar14 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %19, i32 0, i32 19, !dbg !2217
  %20 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar14, align 8, !dbg !2217
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %20, i32 0, i32 1, !dbg !2218
  store i32 27, i32* %codec_id, align 4, !dbg !2219
  %21 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2220
  %need_parsing = getelementptr inbounds %struct.AVStream, %struct.AVStream* %21, i32 0, i32 28, !dbg !2221
  store i32 1, i32* %need_parsing, align 4, !dbg !2222
  %22 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2223
  %codecpar15 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %22, i32 0, i32 19, !dbg !2224
  %23 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar15, align 8, !dbg !2224
  %codec_type16 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %23, i32 0, i32 0, !dbg !2225
  store i32 1, i32* %codec_type16, align 8, !dbg !2226
  %24 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2227
  %codecpar17 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %24, i32 0, i32 19, !dbg !2228
  %25 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar17, align 8, !dbg !2228
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %25, i32 0, i32 22, !dbg !2229
  store i32 1, i32* %channels, align 8, !dbg !2230
  %26 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2231
  %codecpar18 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %26, i32 0, i32 19, !dbg !2232
  %27 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar18, align 8, !dbg !2232
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %27, i32 0, i32 23, !dbg !2233
  store i32 8000, i32* %sample_rate, align 4, !dbg !2234
  %28 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2235
  %codecpar19 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %28, i32 0, i32 19, !dbg !2236
  %29 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar19, align 8, !dbg !2236
  %codec_id20 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %29, i32 0, i32 1, !dbg !2237
  store i32 65536, i32* %codec_id20, align 4, !dbg !2238
  %30 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2239
  call void @avpriv_set_pts_info(%struct.AVStream* %30, i32 64, i32 1, i32 8000), !dbg !2240
  %31 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2241
  %pb21 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %31, i32 0, i32 4, !dbg !2242
  %32 = load %struct.AVIOContext*, %struct.AVIOContext** %pb21, align 8, !dbg !2242
  %call22 = call i64 @avio_seek(%struct.AVIOContext* %32, i64 168, i32 0), !dbg !2243
  store i32 0, i32* %retval, align 4, !dbg !2244
  br label %return, !dbg !2244

return:                                           ; preds = %if.end4, %if.then3, %if.then
  %33 = load i32, i32* %retval, align 4, !dbg !2245
  ret i32 %33, !dbg !2245
}

; Function Attrs: nounwind uwtable
define internal i32 @sdr2_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2246 {
entry:
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2249, metadata !2153), !dbg !2253
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2255, metadata !2153), !dbg !2256
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2257, metadata !2153), !dbg !2258
  call void @llvm.dbg.declare(metadata i64* %pos, metadata !2259, metadata !2153), !dbg !2260
  call void @llvm.dbg.declare(metadata i32* %next, metadata !2261, metadata !2153), !dbg !2262
  call void @llvm.dbg.declare(metadata i32* %flags, metadata !2263, metadata !2153), !dbg !2264
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2265, metadata !2153), !dbg !2266
  store i32 0, i32* %ret, align 4, !dbg !2266
  call void @llvm.dbg.declare(metadata i32* %is_video, metadata !2267, metadata !2153), !dbg !2268
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2269
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2270
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2270
  store %struct.AVIOContext* %1, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2271
  %2 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2272
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %2, i64 0, i32 1) #4, !dbg !2273
  store i64 %call.i, i64* %pos, align 8, !dbg !2274
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2275
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %3, i32 0, i32 4, !dbg !2276
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2276
  %call2 = call i32 @avio_rl32(%struct.AVIOContext* %4), !dbg !2277
  store i32 %call2, i32* %flags, align 4, !dbg !2278
  %5 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2279
  %pb3 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %5, i32 0, i32 4, !dbg !2280
  %6 = load %struct.AVIOContext*, %struct.AVIOContext** %pb3, align 8, !dbg !2280
  %call4 = call i64 @avio_skip(%struct.AVIOContext* %6, i64 4), !dbg !2281
  %7 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2282
  %pb5 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %7, i32 0, i32 4, !dbg !2283
  %8 = load %struct.AVIOContext*, %struct.AVIOContext** %pb5, align 8, !dbg !2283
  %call6 = call i32 @avio_rl32(%struct.AVIOContext* %8), !dbg !2284
  store i32 %call6, i32* %next, align 4, !dbg !2285
  %9 = load i32, i32* %next, align 4, !dbg !2286
  %cmp = icmp ule i32 %9, 52, !dbg !2288
...
if.end:                                           ; preds = %entry
  %10 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2291
  %pb7 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %10, i32 0, i32 4, !dbg !2292
  %11 = load %struct.AVIOContext*, %struct.AVIOContext** %pb7, align 8, !dbg !2292
  %call8 = call i64 @avio_skip(%struct.AVIOContext* %11, i64 6), !dbg !2293
  %12 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2294
  %pb9 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %12, i32 0, i32 4, !dbg !2295
  %13 = load %struct.AVIOContext*, %struct.AVIOContext** %pb9, align 8, !dbg !2295
  %call10 = call i32 @avio_rl32(%struct.AVIOContext* %13), !dbg !2296
  store i32 %call10, i32* %is_video, align 4, !dbg !2297
  %14 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2298
  %pb11 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %14, i32 0, i32 4, !dbg !2299
  %15 = load %struct.AVIOContext*, %struct.AVIOContext** %pb11, align 8, !dbg !2299
  %call12 = call i64 @avio_skip(%struct.AVIOContext* %15, i64 30), !dbg !2300
  %16 = load i64, i64* %pos, align 8, !dbg !2301
  %cmp13 = icmp eq i64 %16, 168, !dbg !2303
  br i1 %cmp13, label %if.then14, label %if.else, !dbg !2304

if.then14:                                        ; preds = %if.end
  %17 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2305
  %18 = load i32, i32* %next, align 4, !dbg !2308
  %sub = sub i32 %18, 52, !dbg !2309
  %add = add i32 %sub, 24, !dbg !2310
  %call15 = call i32 @av_new_packet(%struct.AVPacket* %17, i32 %add), !dbg !2311
  %cmp16 = icmp slt i32 %call15, 0, !dbg !2312
  br i1 %cmp16, label %if.then17, label %if.end18, !dbg !2313
...
if.end18:                                         ; preds = %if.then14
  %19 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2315
  %data = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %19, i32 0, i32 3, !dbg !2316
  %20 = load i8*, i8** %data, align 8, !dbg !2316
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %20, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @header, i32 0, i32 0), i64 24, i32 1, i1 false), !dbg !2317
  %21 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2318
  %pb19 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %21, i32 0, i32 4, !dbg !2319
  %22 = load %struct.AVIOContext*, %struct.AVIOContext** %pb19, align 8, !dbg !2319
  %23 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2320
  %data20 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %23, i32 0, i32 3, !dbg !2321
  %24 = load i8*, i8** %data20, align 8, !dbg !2321
  %add.ptr = getelementptr inbounds i8, i8* %24, i64 24, !dbg !2322
  %25 = load i32, i32* %next, align 4, !dbg !2323
  %sub21 = sub i32 %25, 52, !dbg !2324
  %call22 = call i32 @avio_read(%struct.AVIOContext* %22, i8* %add.ptr, i32 %sub21), !dbg !2325
  store i32 %call22, i32* %ret, align 4, !dbg !2326
  %26 = load i32, i32* %ret, align 4, !dbg !2327
  %cmp23 = icmp slt i32 %26, 0, !dbg !2329
  br i1 %cmp23, label %if.then24, label %if.end25, !dbg !2330

if.then24:                                        ; preds = %if.end18
  %27 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2331
  call void @av_packet_unref(%struct.AVPacket* %27), !dbg !2333
  %28 = load i32, i32* %ret, align 4, !dbg !2334
  store i32 %28, i32* %retval, align 4, !dbg !2335
  br label %return, !dbg !2335

if.end25:                                         ; preds = %if.end18
  %29 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2336
  %30 = load i32, i32* %ret, align 4, !dbg !2337
  %add26 = add nsw i32 %30, 24, !dbg !2338
  call void @av_shrink_packet(%struct.AVPacket* %29, i32 %add26), !dbg !2339
  br label %if.end30, !dbg !2340

if.else:                                          ; preds = %if.end
  %31 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2341
  %pb27 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %31, i32 0, i32 4, !dbg !2343
  %32 = load %struct.AVIOContext*, %struct.AVIOContext** %pb27, align 8, !dbg !2343
  %33 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2344
  %34 = load i32, i32* %next, align 4, !dbg !2345
  %sub28 = sub i32 %34, 52, !dbg !2346
  %call29 = call i32 @av_get_packet(%struct.AVIOContext* %32, %struct.AVPacket* %33, i32 %sub28), !dbg !2347
  store i32 %call29, i32* %ret, align 4, !dbg !2348
  br label %if.end30

if.end30:                                         ; preds = %if.else, %if.end25
  %35 = load i32, i32* %is_video, align 4, !dbg !2349
  %tobool = icmp ne i32 %35, 0, !dbg !2350
  %lnot = xor i1 %tobool, true, !dbg !2350
  %lnot31 = xor i1 %lnot, true, !dbg !2351
  %lnot.ext = zext i1 %lnot31 to i32, !dbg !2351
  %36 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2352
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %36, i32 0, i32 5, !dbg !2353
  store i32 %lnot.ext, i32* %stream_index, align 4, !dbg !2354
  %37 = load i64, i64* %pos, align 8, !dbg !2355
  %38 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2356
  %pos32 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %38, i32 0, i32 10, !dbg !2357
  store i64 %37, i64* %pos32, align 8, !dbg !2358
  %39 = load i32, i32* %flags, align 4, !dbg !2359
  %and = and i32 %39, 4096, !dbg !2361
  %tobool33 = icmp ne i32 %and, 0, !dbg !2361
  br i1 %tobool33, label %if.then34, label %if.end36, !dbg !2362

if.then34:                                        ; preds = %if.end30
  %40 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2363
  %flags35 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %40, i32 0, i32 6, !dbg !2364
  %41 = load i32, i32* %flags35, align 8, !dbg !2365
  %or = or i32 %41, 1, !dbg !2365
  store i32 %or, i32* %flags35, align 8, !dbg !2365
  br label %if.end36, !dbg !2363

if.end36:                                         ; preds = %if.then34, %if.end30
  %42 = load i32, i32* %ret, align 4, !dbg !2366
  store i32 %42, i32* %retval, align 4, !dbg !2367
  br label %return, !dbg !2367

return:                                           ; preds = %if.end36, %if.then24, %if.then17, %if.then
  %43 = load i32, i32* %retval, align 4, !dbg !2368
  ret i32 %43, !dbg !2368
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--sdr2.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!927 = !{!928, !2143}
!928 = distinct !DIGlobalVariable(name: "ff_sdr2_demuxer", scope: !0, file: !929, line: 113, type: !930, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_sdr2_demuxer)
!929 = !DIFile(filename: "libavformat/sdr2.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2143 = distinct !DIGlobalVariable(name: "header", scope: !0, file: !929, line: 67, type: !2144, isLocal: true, isDefinition: true, variable: [24 x i8]* @header)
!2144 = !DICompositeType(tag: DW_TAG_array_type, baseType: !1252, size: 192, align: 8, elements: !2145)
!2145 = !{!2146}
!2146 = !DISubrange(count: 24)
!2147 = !{i32 2, !"Dwarf Version", i32 4}
!2148 = !{i32 2, !"Debug Info Version", i32 3}
!2149 = !{!"clang version 3.9.0 (tags/RELEASE_390/final)"}
!2150 = distinct !DISubprogram(name: "sdr2_probe", scope: !929, file: !929, line: 26, type: !999, isLocal: true, isDefinition: true, scopeLine: 27, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2151)
!2151 = !{}
!2152 = !DILocalVariable(name: "p", arg: 1, scope: !2150, file: !929, line: 26, type: !1001)
!2153 = !DIExpression()
!2154 = !DILocation(line: 26, column: 36, scope: !2150)
!2155 = !DILocation(line: 28, column: 41, scope: !2156)
!2156 = distinct !DILexicalBlock(scope: !2150, file: !929, line: 28, column: 9)
!2157 = !DILocation(line: 28, column: 44, scope: !2156)
!2158 = !DILocation(line: 28, column: 51, scope: !2156)
!2159 = !DILocation(line: 28, column: 54, scope: !2156)
!2160 = !DILocation(line: 28, column: 9, scope: !2150)
!2161 = !DILocation(line: 29, column: 9, scope: !2156)
!2162 = !DILocation(line: 31, column: 5, scope: !2150)
!2163 = !DILocation(line: 32, column: 1, scope: !2150)
!2164 = distinct !DISubprogram(name: "sdr2_read_header", scope: !929, file: !929, line: 36, type: !2165, isLocal: true, isDefinition: true, scopeLine: 37, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2151)
!2165 = !DISubroutineType(types: !2166)
!2166 = !{!926, !2167}
!2167 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2168, size: 64, align: 64)
!2168 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1016)
!2169 = !DILocalVariable(name: "s", arg: 1, scope: !2164, file: !929, line: 36, type: !2167)
!2170 = !DILocation(line: 36, column: 46, scope: !2164)
!2171 = !DILocalVariable(name: "st", scope: !2164, file: !929, line: 38, type: !1290)
!2172 = !DILocation(line: 38, column: 15, scope: !2164)
!2173 = !DILocalVariable(name: "ast", scope: !2164, file: !929, line: 38, type: !1290)
!2174 = !DILocation(line: 38, column: 20, scope: !2164)
!2175 = !DILocation(line: 40, column: 31, scope: !2164)
!2176 = !DILocation(line: 40, column: 11, scope: !2164)
!2177 = !DILocation(line: 40, column: 9, scope: !2164)
!2178 = !DILocation(line: 41, column: 10, scope: !2179)
!2179 = distinct !DILexicalBlock(scope: !2164, file: !929, line: 41, column: 9)
!2180 = !DILocation(line: 41, column: 9, scope: !2164)
!2181 = !DILocation(line: 42, column: 9, scope: !2179)
!2182 = !DILocation(line: 44, column: 30, scope: !2164)
!2183 = !DILocation(line: 44, column: 10, scope: !2164)
!2184 = !DILocation(line: 44, column: 8, scope: !2164)
!2185 = !DILocation(line: 45, column: 10, scope: !2186)
!2186 = distinct !DILexicalBlock(scope: !2164, file: !929, line: 45, column: 9)
!2187 = !DILocation(line: 45, column: 9, scope: !2164)
!2188 = !DILocation(line: 46, column: 9, scope: !2186)
!2189 = !DILocation(line: 48, column: 15, scope: !2164)
!2190 = !DILocation(line: 48, column: 18, scope: !2164)
!2191 = !DILocation(line: 48, column: 5, scope: !2164)
!2192 = !DILocation(line: 49, column: 25, scope: !2164)
!2193 = !DILocation(line: 49, column: 46, scope: !2164)
!2194 = !DILocation(line: 49, column: 49, scope: !2164)
!2195 = !DILocation(line: 49, column: 36, scope: !2164)
!2196 = !DILocation(line: 49, column: 5, scope: !2197)
!2197 = !DILexicalBlockFile(scope: !2164, file: !929, discriminator: 1)
!2198 = !DILocation(line: 50, column: 5, scope: !2164)
!2199 = !DILocation(line: 50, column: 9, scope: !2164)
!2200 = !DILocation(line: 50, column: 19, scope: !2164)
!2201 = !DILocation(line: 50, column: 30, scope: !2164)
!2202 = !DILocation(line: 51, column: 37, scope: !2164)
!2203 = !DILocation(line: 51, column: 40, scope: !2164)
!2204 = !DILocation(line: 51, column: 27, scope: !2164)
!2205 = !DILocation(line: 51, column: 5, scope: !2164)
!2206 = !DILocation(line: 51, column: 9, scope: !2164)
!2207 = !DILocation(line: 51, column: 19, scope: !2164)
!2208 = !DILocation(line: 51, column: 25, scope: !2164)
!2209 = !DILocation(line: 52, column: 38, scope: !2164)
!2210 = !DILocation(line: 52, column: 41, scope: !2164)
!2211 = !DILocation(line: 52, column: 28, scope: !2164)
!2212 = !DILocation(line: 52, column: 5, scope: !2164)
!2213 = !DILocation(line: 52, column: 9, scope: !2164)
!2214 = !DILocation(line: 52, column: 19, scope: !2164)
!2215 = !DILocation(line: 52, column: 26, scope: !2164)
!2216 = !DILocation(line: 53, column: 5, scope: !2164)
!2217 = !DILocation(line: 53, column: 9, scope: !2164)
!2218 = !DILocation(line: 53, column: 19, scope: !2164)
!2219 = !DILocation(line: 53, column: 28, scope: !2164)
!2220 = !DILocation(line: 54, column: 5, scope: !2164)
!2221 = !DILocation(line: 54, column: 9, scope: !2164)
!2222 = !DILocation(line: 54, column: 22, scope: !2164)
!2223 = !DILocation(line: 56, column: 5, scope: !2164)
!2224 = !DILocation(line: 56, column: 10, scope: !2164)
!2225 = !DILocation(line: 56, column: 20, scope: !2164)
!2226 = !DILocation(line: 56, column: 31, scope: !2164)
!2227 = !DILocation(line: 57, column: 5, scope: !2164)
!2228 = !DILocation(line: 57, column: 10, scope: !2164)
!2229 = !DILocation(line: 57, column: 20, scope: !2164)
!2230 = !DILocation(line: 57, column: 29, scope: !2164)
!2231 = !DILocation(line: 58, column: 5, scope: !2164)
!2232 = !DILocation(line: 58, column: 10, scope: !2164)
!2233 = !DILocation(line: 58, column: 20, scope: !2164)
!2234 = !DILocation(line: 58, column: 32, scope: !2164)
!2235 = !DILocation(line: 59, column: 5, scope: !2164)
!2236 = !DILocation(line: 59, column: 10, scope: !2164)
!2237 = !DILocation(line: 59, column: 20, scope: !2164)
!2238 = !DILocation(line: 59, column: 29, scope: !2164)
!2239 = !DILocation(line: 60, column: 25, scope: !2164)
!2240 = !DILocation(line: 60, column: 5, scope: !2164)
!2241 = !DILocation(line: 62, column: 15, scope: !2164)
!2242 = !DILocation(line: 62, column: 18, scope: !2164)
!2243 = !DILocation(line: 62, column: 5, scope: !2164)
!2244 = !DILocation(line: 64, column: 5, scope: !2164)
!2245 = !DILocation(line: 65, column: 1, scope: !2164)
!2246 = distinct !DISubprogram(name: "sdr2_read_packet", scope: !929, file: !929, line: 73, type: !2247, isLocal: true, isDefinition: true, scopeLine: 74, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2151)
!2247 = !DISubroutineType(types: !2248)
!2248 = !{!926, !2167, !1041}
!2249 = !DILocalVariable(name: "s", arg: 1, scope: !2250, file: !628, line: 557, type: !1222)
!2250 = distinct !DISubprogram(name: "avio_tell", scope: !628, file: !628, line: 557, type: !2251, isLocal: true, isDefinition: true, scopeLine: 558, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2151)
!2251 = !DISubroutineType(types: !2252)
!2252 = !{!1060, !1222}
!2253 = !DILocation(line: 557, column: 77, scope: !2250, inlinedAt: !2254)
!2254 = distinct !DILocation(line: 79, column: 11, scope: !2246)
!2255 = !DILocalVariable(name: "s", arg: 1, scope: !2246, file: !929, line: 73, type: !2167)
!2256 = !DILocation(line: 73, column: 46, scope: !2246)
!2257 = !DILocalVariable(name: "pkt", arg: 2, scope: !2246, file: !929, line: 73, type: !1041)
!2258 = !DILocation(line: 73, column: 59, scope: !2246)
!2259 = !DILocalVariable(name: "pos", scope: !2246, file: !929, line: 75, type: !1060)
!2260 = !DILocation(line: 75, column: 13, scope: !2246)
!2261 = !DILocalVariable(name: "next", scope: !2246, file: !929, line: 76, type: !925)
!2262 = !DILocation(line: 76, column: 14, scope: !2246)
!2263 = !DILocalVariable(name: "flags", scope: !2246, file: !929, line: 77, type: !926)
!2264 = !DILocation(line: 77, column: 9, scope: !2246)
!2265 = !DILocalVariable(name: "ret", scope: !2246, file: !929, line: 77, type: !926)
!2266 = !DILocation(line: 77, column: 16, scope: !2246)
!2267 = !DILocalVariable(name: "is_video", scope: !2246, file: !929, line: 77, type: !926)
!2268 = !DILocation(line: 77, column: 25, scope: !2246)
!2269 = !DILocation(line: 79, column: 21, scope: !2246)
!2270 = !DILocation(line: 79, column: 24, scope: !2246)
!2271 = !DILocation(line: 79, column: 11, scope: !2246)
!2272 = !DILocation(line: 559, column: 22, scope: !2250, inlinedAt: !2254)
!2273 = !DILocation(line: 559, column: 12, scope: !2250, inlinedAt: !2254)
!2274 = !DILocation(line: 79, column: 9, scope: !2246)
!2275 = !DILocation(line: 81, column: 23, scope: !2246)
!2276 = !DILocation(line: 81, column: 26, scope: !2246)
!2277 = !DILocation(line: 81, column: 13, scope: !2246)
!2278 = !DILocation(line: 81, column: 11, scope: !2246)
!2279 = !DILocation(line: 82, column: 15, scope: !2246)
!2280 = !DILocation(line: 82, column: 18, scope: !2246)
!2281 = !DILocation(line: 82, column: 5, scope: !2246)
!2282 = !DILocation(line: 84, column: 22, scope: !2246)
!2283 = !DILocation(line: 84, column: 25, scope: !2246)
!2284 = !DILocation(line: 84, column: 12, scope: !2246)
!2285 = !DILocation(line: 84, column: 10, scope: !2246)
!2286 = !DILocation(line: 85, column: 9, scope: !2287)
!2287 = distinct !DILexicalBlock(scope: !2246, file: !929, line: 85, column: 9)
!2288 = !DILocation(line: 85, column: 14, scope: !2287)
!2289 = !DILocation(line: 85, column: 9, scope: !2246)
!2290 = !DILocation(line: 86, column: 9, scope: !2287)
!2291 = !DILocation(line: 88, column: 15, scope: !2246)
!2292 = !DILocation(line: 88, column: 18, scope: !2246)
!2293 = !DILocation(line: 88, column: 5, scope: !2246)
!2294 = !DILocation(line: 89, column: 26, scope: !2246)
!2295 = !DILocation(line: 89, column: 29, scope: !2246)
!2296 = !DILocation(line: 89, column: 16, scope: !2246)
!2297 = !DILocation(line: 89, column: 14, scope: !2246)
!2298 = !DILocation(line: 90, column: 15, scope: !2246)
!2299 = !DILocation(line: 90, column: 18, scope: !2246)
!2300 = !DILocation(line: 90, column: 5, scope: !2246)
!2301 = !DILocation(line: 92, column: 9, scope: !2302)
!2302 = distinct !DILexicalBlock(scope: !2246, file: !929, line: 92, column: 9)
!2303 = !DILocation(line: 92, column: 13, scope: !2302)
!2304 = !DILocation(line: 92, column: 9, scope: !2246)
!2305 = !DILocation(line: 93, column: 27, scope: !2306)
!2306 = distinct !DILexicalBlock(scope: !2307, file: !929, line: 93, column: 13)
!2307 = distinct !DILexicalBlock(scope: !2302, file: !929, line: 92, column: 22)
!2308 = !DILocation(line: 93, column: 32, scope: !2306)
!2309 = !DILocation(line: 93, column: 37, scope: !2306)
!2310 = !DILocation(line: 93, column: 42, scope: !2306)
!2311 = !DILocation(line: 93, column: 13, scope: !2306)
!2312 = !DILocation(line: 93, column: 48, scope: !2306)
!2313 = !DILocation(line: 93, column: 13, scope: !2307)
!2314 = !DILocation(line: 94, column: 13, scope: !2306)
!2315 = !DILocation(line: 95, column: 16, scope: !2307)
!2316 = !DILocation(line: 95, column: 21, scope: !2307)
!2317 = !DILocation(line: 95, column: 9, scope: !2307)
!2318 = !DILocation(line: 96, column: 25, scope: !2307)
!2319 = !DILocation(line: 96, column: 28, scope: !2307)
!2320 = !DILocation(line: 96, column: 32, scope: !2307)
!2321 = !DILocation(line: 96, column: 37, scope: !2307)
!2322 = !DILocation(line: 96, column: 42, scope: !2307)
!2323 = !DILocation(line: 96, column: 48, scope: !2307)
!2324 = !DILocation(line: 96, column: 53, scope: !2307)
!2325 = !DILocation(line: 96, column: 15, scope: !2307)
!2326 = !DILocation(line: 96, column: 13, scope: !2307)
!2327 = !DILocation(line: 97, column: 13, scope: !2328)
!2328 = distinct !DILexicalBlock(scope: !2307, file: !929, line: 97, column: 13)
!2329 = !DILocation(line: 97, column: 17, scope: !2328)
!2330 = !DILocation(line: 97, column: 13, scope: !2307)
!2331 = !DILocation(line: 98, column: 29, scope: !2332)
!2332 = distinct !DILexicalBlock(scope: !2328, file: !929, line: 97, column: 22)
!2333 = !DILocation(line: 98, column: 13, scope: !2332)
!2334 = !DILocation(line: 99, column: 20, scope: !2332)
!2335 = !DILocation(line: 99, column: 13, scope: !2332)
!2336 = !DILocation(line: 101, column: 26, scope: !2307)
!2337 = !DILocation(line: 101, column: 31, scope: !2307)
!2338 = !DILocation(line: 101, column: 35, scope: !2307)
!2339 = !DILocation(line: 101, column: 9, scope: !2307)
!2340 = !DILocation(line: 102, column: 5, scope: !2307)
!2341 = !DILocation(line: 103, column: 29, scope: !2342)
!2342 = distinct !DILexicalBlock(scope: !2302, file: !929, line: 102, column: 12)
!2343 = !DILocation(line: 103, column: 32, scope: !2342)
!2344 = !DILocation(line: 103, column: 36, scope: !2342)
!2345 = !DILocation(line: 103, column: 41, scope: !2342)
!2346 = !DILocation(line: 103, column: 46, scope: !2342)
!2347 = !DILocation(line: 103, column: 15, scope: !2342)
!2348 = !DILocation(line: 103, column: 13, scope: !2342)
!2349 = !DILocation(line: 105, column: 27, scope: !2246)
!2350 = !DILocation(line: 105, column: 26, scope: !2246)
!2351 = !DILocation(line: 105, column: 25, scope: !2246)
!2352 = !DILocation(line: 105, column: 5, scope: !2246)
!2353 = !DILocation(line: 105, column: 10, scope: !2246)
!2354 = !DILocation(line: 105, column: 23, scope: !2246)
!2355 = !DILocation(line: 106, column: 16, scope: !2246)
!2356 = !DILocation(line: 106, column: 5, scope: !2246)
!2357 = !DILocation(line: 106, column: 10, scope: !2246)
!2358 = !DILocation(line: 106, column: 14, scope: !2246)
!2359 = !DILocation(line: 107, column: 9, scope: !2360)
!2360 = distinct !DILexicalBlock(scope: !2246, file: !929, line: 107, column: 9)
!2361 = !DILocation(line: 107, column: 15, scope: !2360)
!2362 = !DILocation(line: 107, column: 9, scope: !2246)
!2363 = !DILocation(line: 108, column: 9, scope: !2360)
!2364 = !DILocation(line: 108, column: 14, scope: !2360)
!2365 = !DILocation(line: 108, column: 20, scope: !2360)
!2366 = !DILocation(line: 110, column: 12, scope: !2246)
!2367 = !DILocation(line: 110, column: 5, scope: !2246)
!2368 = !DILocation(line: 111, column: 1, scope: !2246)
