; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--afc.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--afc.o.i"
...
@ff_afc_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0), i32 57344, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 8, i32 (%struct.AVProbeData*)* null, i32 (%struct.AVFormatContext*)* @afc_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @afc_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8

; Function Attrs: nounwind uwtable
define internal i32 @afc_read_header(%struct.AVFormatContext* %s) #0 !dbg !2140 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %c = alloca %struct.AFCDemuxContext*, align 8
  ...
  call void @llvm.dbg.declare(metadata %struct.AFCDemuxContext** %c, metadata !2149, metadata !2147), !dbg !2155
  ...
  %2 = bitcast i8* %1 to %struct.AFCDemuxContext*, !dbg !2156
  store %struct.AFCDemuxContext* %2, %struct.AFCDemuxContext** %c, align 8, !dbg !2155
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2158, metadata !2147), !dbg !2159
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2160
  %call = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %3, %struct.AVCodec* null), !dbg !2161
  store %struct.AVStream* %call, %struct.AVStream** %st, align 8, !dbg !2162
  %4 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2163
  %tobool = icmp ne %struct.AVStream* %4, null, !dbg !2163
...
if.end:                                           ; preds = %entry
  %5 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2167
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %5, i32 0, i32 19, !dbg !2168
  %6 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2168
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %6, i32 0, i32 0, !dbg !2169
  store i32 1, i32* %codec_type, align 8, !dbg !2170
  %7 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2171
  %codecpar1 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %7, i32 0, i32 19, !dbg !2172
  %8 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar1, align 8, !dbg !2172
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %8, i32 0, i32 1, !dbg !2173
  store i32 71680, i32* %codec_id, align 4, !dbg !2174
  %9 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2175
  %codecpar2 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %9, i32 0, i32 19, !dbg !2176
  %10 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar2, align 8, !dbg !2176
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %10, i32 0, i32 22, !dbg !2177
  store i32 2, i32* %channels, align 8, !dbg !2178
  %11 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2179
  %codecpar3 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %11, i32 0, i32 19, !dbg !2180
  %12 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar3, align 8, !dbg !2180
  %channel_layout = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %12, i32 0, i32 21, !dbg !2181
  store i64 3, i64* %channel_layout, align 8, !dbg !2182
  %13 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2183
  %codecpar4 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %13, i32 0, i32 19, !dbg !2185
  %14 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar4, align 8, !dbg !2185
  %call5 = call i32 @ff_alloc_extradata(%struct.AVCodecParameters* %14, i32 1), !dbg !2186
  %tobool6 = icmp ne i32 %call5, 0, !dbg !2186
  br i1 %tobool6, label %if.then7, label %if.end8, !dbg !2187
...
if.end8:                                          ; preds = %if.end
  %15 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2189
  %codecpar9 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %15, i32 0, i32 19, !dbg !2190
  %16 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar9, align 8, !dbg !2190
  %channels10 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %16, i32 0, i32 22, !dbg !2191
  %17 = load i32, i32* %channels10, align 8, !dbg !2191
  %mul = mul nsw i32 8, %17, !dbg !2192
  %conv = trunc i32 %mul to i8, !dbg !2193
  %18 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2194
  %codecpar11 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %18, i32 0, i32 19, !dbg !2195
  %19 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar11, align 8, !dbg !2195
  %extradata = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %19, i32 0, i32 3, !dbg !2196
  %20 = load i8*, i8** %extradata, align 8, !dbg !2196
  %arrayidx = getelementptr inbounds i8, i8* %20, i64 0, !dbg !2194
  store i8 %conv, i8* %arrayidx, align 1, !dbg !2197
  %21 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2198
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %21, i32 0, i32 4, !dbg !2199
  %22 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2199
  %call12 = call i32 @avio_rb32(%struct.AVIOContext* %22), !dbg !2200
  %conv13 = zext i32 %call12 to i64, !dbg !2200
  %add = add nsw i64 %conv13, 32, !dbg !2201
  %23 = load %struct.AFCDemuxContext*, %struct.AFCDemuxContext** %c, align 8, !dbg !2202
  %data_end = getelementptr inbounds %struct.AFCDemuxContext, %struct.AFCDemuxContext* %23, i32 0, i32 0, !dbg !2203
  store i64 %add, i64* %data_end, align 8, !dbg !2204
  %24 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2205
  %pb14 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %24, i32 0, i32 4, !dbg !2206
  %25 = load %struct.AVIOContext*, %struct.AVIOContext** %pb14, align 8, !dbg !2206
  %call15 = call i32 @avio_rb32(%struct.AVIOContext* %25), !dbg !2207
  %conv16 = zext i32 %call15 to i64, !dbg !2207
  %26 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2208
  %duration = getelementptr inbounds %struct.AVStream, %struct.AVStream* %26, i32 0, i32 6, !dbg !2209
  store i64 %conv16, i64* %duration, align 8, !dbg !2210
  %27 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2211
  %pb17 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %27, i32 0, i32 4, !dbg !2212
  %28 = load %struct.AVIOContext*, %struct.AVIOContext** %pb17, align 8, !dbg !2212
  %call18 = call i32 @avio_rb16(%struct.AVIOContext* %28), !dbg !2213
  %29 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2214
  %codecpar19 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %29, i32 0, i32 19, !dbg !2215
  %30 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar19, align 8, !dbg !2215
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %30, i32 0, i32 23, !dbg !2216
  store i32 %call18, i32* %sample_rate, align 4, !dbg !2217
  %31 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2218
  %pb20 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %31, i32 0, i32 4, !dbg !2219
  %32 = load %struct.AVIOContext*, %struct.AVIOContext** %pb20, align 8, !dbg !2219
  %call21 = call i64 @avio_skip(%struct.AVIOContext* %32, i64 22), !dbg !2220
  %33 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2221
  %34 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2222
  %codecpar22 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %34, i32 0, i32 19, !dbg !2223
  %35 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar22, align 8, !dbg !2223
  %sample_rate23 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %35, i32 0, i32 23, !dbg !2224
  %36 = load i32, i32* %sample_rate23, align 4, !dbg !2224
  call void @avpriv_set_pts_info(%struct.AVStream* %33, i32 64, i32 1, i32 %36), !dbg !2225
  store i32 0, i32* %retval, align 4, !dbg !2226
  br label %return, !dbg !2226

return:                                           ; preds = %if.end8, %if.then7, %if.then
  %37 = load i32, i32* %retval, align 4, !dbg !2227
  ret i32 %37, !dbg !2227
}

; Function Attrs: nounwind uwtable
define internal i32 @afc_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2228 {
entry:
  %s.addr.i8 = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i8, metadata !2231, metadata !2147), !dbg !2235
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2231, metadata !2147), !dbg !2238
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2240, metadata !2147), !dbg !2241
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2242, metadata !2147), !dbg !2243
  call void @llvm.dbg.declare(metadata %struct.AFCDemuxContext** %c, metadata !2244, metadata !2147), !dbg !2245
  ...
  %2 = bitcast i8* %1 to %struct.AFCDemuxContext*, !dbg !2246
  store %struct.AFCDemuxContext* %2, %struct.AFCDemuxContext** %c, align 8, !dbg !2245
  call void @llvm.dbg.declare(metadata i64* %size, metadata !2248, metadata !2147), !dbg !2249
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2250, metadata !2147), !dbg !2251
  %3 = load %struct.AFCDemuxContext*, %struct.AFCDemuxContext** %c, align 8, !dbg !2252
  %data_end = getelementptr inbounds %struct.AFCDemuxContext, %struct.AFCDemuxContext* %3, i32 0, i32 0, !dbg !2253
  %4 = load i64, i64* %data_end, align 8, !dbg !2253
  %5 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2254
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %5, i32 0, i32 4, !dbg !2255
  %6 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2255
  store %struct.AVIOContext* %6, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2256
  %7 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2257
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %7, i64 0, i32 1) #3, !dbg !2258
  %sub = sub nsw i64 %4, %call.i, !dbg !2259
  %cmp = icmp sgt i64 %sub, 2304, !dbg !2260
...
cond.false:                                       ; preds = %entry
  %8 = load %struct.AFCDemuxContext*, %struct.AFCDemuxContext** %c, align 8, !dbg !2264
  %data_end1 = getelementptr inbounds %struct.AFCDemuxContext, %struct.AFCDemuxContext* %8, i32 0, i32 0, !dbg !2265
  %9 = load i64, i64* %data_end1, align 8, !dbg !2265
  %10 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2266
  %pb2 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %10, i32 0, i32 4, !dbg !2267
  %11 = load %struct.AVIOContext*, %struct.AVIOContext** %pb2, align 8, !dbg !2267
  store %struct.AVIOContext* %11, %struct.AVIOContext** %s.addr.i8, align 8, !dbg !2268
  %12 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i8, align 8, !dbg !2269
  %call.i9 = call i64 @avio_seek(%struct.AVIOContext* %12, i64 0, i32 1) #3, !dbg !2270
  %sub4 = sub nsw i64 %9, %call.i9, !dbg !2271
  br label %cond.end, !dbg !2272

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i64 [ 2304, %cond.true ], [ %sub4, %cond.false ], !dbg !2273
  store i64 %cond, i64* %size, align 8, !dbg !2275
  %13 = load i64, i64* %size, align 8, !dbg !2276
  %cmp5 = icmp sle i64 %13, 0, !dbg !2278
  br i1 %cmp5, label %if.then, label %if.end, !dbg !2279

if.then:                                          ; preds = %cond.end
  store i32 -541478725, i32* %retval, align 4, !dbg !2280
  br label %return, !dbg !2280

if.end:                                           ; preds = %cond.end
  %14 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2281
  %pb6 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %14, i32 0, i32 4, !dbg !2282
  %15 = load %struct.AVIOContext*, %struct.AVIOContext** %pb6, align 8, !dbg !2282
  %16 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2283
  %17 = load i64, i64* %size, align 8, !dbg !2284
  %conv = trunc i64 %17 to i32, !dbg !2284
  %call7 = call i32 @av_get_packet(%struct.AVIOContext* %15, %struct.AVPacket* %16, i32 %conv), !dbg !2285
  store i32 %call7, i32* %ret, align 4, !dbg !2286
  %18 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2287
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %18, i32 0, i32 5, !dbg !2288
  store i32 0, i32* %stream_index, align 4, !dbg !2289
  %19 = load i32, i32* %ret, align 4, !dbg !2290
  store i32 %19, i32* %retval, align 4, !dbg !2291
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--afc.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!919 = !{!920}
!920 = distinct !DIGlobalVariable(name: "ff_afc_demuxer", scope: !0, file: !921, line: 71, type: !922, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_afc_demuxer)
!921 = !DIFile(filename: "libavformat/afc.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2140 = distinct !DISubprogram(name: "afc_read_header", scope: !921, file: !921, line: 30, type: !2141, isLocal: true, isDefinition: true, scopeLine: 31, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2145)
!2141 = !DISubroutineType(types: !2142)
!2142 = !{!917, !2143}
!2143 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2144, size: 64, align: 64)
!2144 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1008)
!2145 = !{}
!2146 = !DILocalVariable(name: "s", arg: 1, scope: !2140, file: !921, line: 30, type: !2143)
!2147 = !DIExpression()
!2148 = !DILocation(line: 30, column: 45, scope: !2140)
!2149 = !DILocalVariable(name: "c", scope: !2140, file: !921, line: 32, type: !2150)
!2150 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2151, size: 64, align: 64)
!2151 = !DIDerivedType(tag: DW_TAG_typedef, name: "AFCDemuxContext", file: !921, line: 28, baseType: !2152)
!2152 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "AFCDemuxContext", file: !921, line: 26, size: 64, align: 64, elements: !2153)
!2153 = !{!2154}
!2154 = !DIDerivedType(tag: DW_TAG_member, name: "data_end", scope: !2152, file: !921, line: 27, baseType: !1053, size: 64, align: 64)
!2155 = !DILocation(line: 32, column: 22, scope: !2140)
!2156 = !DILocation(line: 32, column: 26, scope: !2140)
!2157 = !DILocation(line: 32, column: 29, scope: !2140)
!2158 = !DILocalVariable(name: "st", scope: !2140, file: !921, line: 33, type: !1283)
!2159 = !DILocation(line: 33, column: 15, scope: !2140)
!2160 = !DILocation(line: 35, column: 30, scope: !2140)
!2161 = !DILocation(line: 35, column: 10, scope: !2140)
!2162 = !DILocation(line: 35, column: 8, scope: !2140)
!2163 = !DILocation(line: 36, column: 10, scope: !2164)
!2164 = distinct !DILexicalBlock(scope: !2140, file: !921, line: 36, column: 9)
!2165 = !DILocation(line: 36, column: 9, scope: !2140)
!2166 = !DILocation(line: 37, column: 9, scope: !2164)
!2167 = !DILocation(line: 38, column: 5, scope: !2140)
!2168 = !DILocation(line: 38, column: 9, scope: !2140)
!2169 = !DILocation(line: 38, column: 19, scope: !2140)
!2170 = !DILocation(line: 38, column: 30, scope: !2140)
!2171 = !DILocation(line: 39, column: 5, scope: !2140)
!2172 = !DILocation(line: 39, column: 9, scope: !2140)
!2173 = !DILocation(line: 39, column: 19, scope: !2140)
!2174 = !DILocation(line: 39, column: 28, scope: !2140)
!2175 = !DILocation(line: 40, column: 5, scope: !2140)
!2176 = !DILocation(line: 40, column: 9, scope: !2140)
!2177 = !DILocation(line: 40, column: 19, scope: !2140)
!2178 = !DILocation(line: 40, column: 28, scope: !2140)
!2179 = !DILocation(line: 41, column: 5, scope: !2140)
!2180 = !DILocation(line: 41, column: 9, scope: !2140)
!2181 = !DILocation(line: 41, column: 19, scope: !2140)
!2182 = !DILocation(line: 41, column: 34, scope: !2140)
!2183 = !DILocation(line: 43, column: 28, scope: !2184)
!2184 = distinct !DILexicalBlock(scope: !2140, file: !921, line: 43, column: 9)
!2185 = !DILocation(line: 43, column: 32, scope: !2184)
!2186 = !DILocation(line: 43, column: 9, scope: !2184)
!2187 = !DILocation(line: 43, column: 9, scope: !2140)
!2188 = !DILocation(line: 44, column: 9, scope: !2184)
!2189 = !DILocation(line: 45, column: 38, scope: !2140)
!2190 = !DILocation(line: 45, column: 42, scope: !2140)
!2191 = !DILocation(line: 45, column: 52, scope: !2140)
!2192 = !DILocation(line: 45, column: 36, scope: !2140)
!2193 = !DILocation(line: 45, column: 34, scope: !2140)
!2194 = !DILocation(line: 45, column: 5, scope: !2140)
!2195 = !DILocation(line: 45, column: 9, scope: !2140)
!2196 = !DILocation(line: 45, column: 19, scope: !2140)
!2197 = !DILocation(line: 45, column: 32, scope: !2140)
!2198 = !DILocation(line: 47, column: 29, scope: !2140)
!2199 = !DILocation(line: 47, column: 32, scope: !2140)
!2200 = !DILocation(line: 47, column: 19, scope: !2140)
!2201 = !DILocation(line: 47, column: 36, scope: !2140)
!2202 = !DILocation(line: 47, column: 5, scope: !2140)
!2203 = !DILocation(line: 47, column: 8, scope: !2140)
!2204 = !DILocation(line: 47, column: 17, scope: !2140)
!2205 = !DILocation(line: 48, column: 30, scope: !2140)
!2206 = !DILocation(line: 48, column: 33, scope: !2140)
!2207 = !DILocation(line: 48, column: 20, scope: !2140)
!2208 = !DILocation(line: 48, column: 5, scope: !2140)
!2209 = !DILocation(line: 48, column: 9, scope: !2140)
!2210 = !DILocation(line: 48, column: 18, scope: !2140)
!2211 = !DILocation(line: 49, column: 43, scope: !2140)
!2212 = !DILocation(line: 49, column: 46, scope: !2140)
!2213 = !DILocation(line: 49, column: 33, scope: !2140)
!2214 = !DILocation(line: 49, column: 5, scope: !2140)
!2215 = !DILocation(line: 49, column: 9, scope: !2140)
!2216 = !DILocation(line: 49, column: 19, scope: !2140)
!2217 = !DILocation(line: 49, column: 31, scope: !2140)
!2218 = !DILocation(line: 50, column: 15, scope: !2140)
!2219 = !DILocation(line: 50, column: 18, scope: !2140)
!2220 = !DILocation(line: 50, column: 5, scope: !2140)
!2221 = !DILocation(line: 51, column: 25, scope: !2140)
!2222 = !DILocation(line: 51, column: 36, scope: !2140)
!2223 = !DILocation(line: 51, column: 40, scope: !2140)
!2224 = !DILocation(line: 51, column: 50, scope: !2140)
!2225 = !DILocation(line: 51, column: 5, scope: !2140)
!2226 = !DILocation(line: 53, column: 5, scope: !2140)
!2227 = !DILocation(line: 54, column: 1, scope: !2140)
!2228 = distinct !DISubprogram(name: "afc_read_packet", scope: !921, file: !921, line: 56, type: !2229, isLocal: true, isDefinition: true, scopeLine: 57, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2145)
!2229 = !DISubroutineType(types: !2230)
!2230 = !{!917, !2143, !1033}
!2231 = !DILocalVariable(name: "s", arg: 1, scope: !2232, file: !628, line: 557, type: !1215)
!2232 = distinct !DISubprogram(name: "avio_tell", scope: !628, file: !628, line: 557, type: !2233, isLocal: true, isDefinition: true, scopeLine: 558, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2145)
!2233 = !DISubroutineType(types: !2234)
!2234 = !{!1053, !1215}
!2235 = !DILocation(line: 557, column: 77, scope: !2232, inlinedAt: !2236)
!2236 = distinct !DILocation(line: 62, column: 89, scope: !2237)
!2237 = !DILexicalBlockFile(scope: !2228, file: !921, discriminator: 2)
!2238 = !DILocation(line: 557, column: 77, scope: !2232, inlinedAt: !2239)
!2239 = distinct !DILocation(line: 62, column: 28, scope: !2228)
!2240 = !DILocalVariable(name: "s", arg: 1, scope: !2228, file: !921, line: 56, type: !2143)
!2241 = !DILocation(line: 56, column: 45, scope: !2228)
!2242 = !DILocalVariable(name: "pkt", arg: 2, scope: !2228, file: !921, line: 56, type: !1033)
!2243 = !DILocation(line: 56, column: 58, scope: !2228)
!2244 = !DILocalVariable(name: "c", scope: !2228, file: !921, line: 58, type: !2150)
!2245 = !DILocation(line: 58, column: 22, scope: !2228)
!2246 = !DILocation(line: 58, column: 26, scope: !2228)
!2247 = !DILocation(line: 58, column: 29, scope: !2228)
!2248 = !DILocalVariable(name: "size", scope: !2228, file: !921, line: 59, type: !1053)
!2249 = !DILocation(line: 59, column: 13, scope: !2228)
!2250 = !DILocalVariable(name: "ret", scope: !2228, file: !921, line: 60, type: !917)
!2251 = !DILocation(line: 60, column: 9, scope: !2228)
!2252 = !DILocation(line: 62, column: 14, scope: !2228)
!2253 = !DILocation(line: 62, column: 17, scope: !2228)
!2254 = !DILocation(line: 62, column: 38, scope: !2228)
!2255 = !DILocation(line: 62, column: 41, scope: !2228)
!2256 = !DILocation(line: 62, column: 28, scope: !2228)
!2257 = !DILocation(line: 559, column: 22, scope: !2232, inlinedAt: !2239)
!2258 = !DILocation(line: 559, column: 12, scope: !2232, inlinedAt: !2239)
!2259 = !DILocation(line: 62, column: 26, scope: !2228)
!2260 = !DILocation(line: 62, column: 46, scope: !2228)
!2261 = !DILocation(line: 62, column: 13, scope: !2228)
!2262 = !DILocation(line: 62, column: 13, scope: !2263)
!2263 = !DILexicalBlockFile(scope: !2228, file: !921, discriminator: 1)
!2264 = !DILocation(line: 62, column: 75, scope: !2237)
!2265 = !DILocation(line: 62, column: 78, scope: !2237)
!2266 = !DILocation(line: 62, column: 99, scope: !2237)
!2267 = !DILocation(line: 62, column: 102, scope: !2237)
!2268 = !DILocation(line: 62, column: 89, scope: !2237)
!2269 = !DILocation(line: 559, column: 22, scope: !2232, inlinedAt: !2236)
!2270 = !DILocation(line: 559, column: 12, scope: !2232, inlinedAt: !2236)
!2271 = !DILocation(line: 62, column: 87, scope: !2237)
!2272 = !DILocation(line: 62, column: 13, scope: !2237)
!2273 = !DILocation(line: 62, column: 13, scope: !2274)
!2274 = !DILexicalBlockFile(scope: !2228, file: !921, discriminator: 3)
!2275 = !DILocation(line: 62, column: 10, scope: !2274)
!2276 = !DILocation(line: 63, column: 9, scope: !2277)
!2277 = distinct !DILexicalBlock(scope: !2228, file: !921, line: 63, column: 9)
!2278 = !DILocation(line: 63, column: 14, scope: !2277)
!2279 = !DILocation(line: 63, column: 9, scope: !2228)
!2280 = !DILocation(line: 64, column: 9, scope: !2277)
!2281 = !DILocation(line: 66, column: 25, scope: !2228)
!2282 = !DILocation(line: 66, column: 28, scope: !2228)
!2283 = !DILocation(line: 66, column: 32, scope: !2228)
!2284 = !DILocation(line: 66, column: 37, scope: !2228)
!2285 = !DILocation(line: 66, column: 11, scope: !2228)
!2286 = !DILocation(line: 66, column: 9, scope: !2228)
!2287 = !DILocation(line: 67, column: 5, scope: !2228)
!2288 = !DILocation(line: 67, column: 10, scope: !2228)
!2289 = !DILocation(line: 67, column: 23, scope: !2228)
!2290 = !DILocation(line: 68, column: 12, scope: !2228)
!2291 = !DILocation(line: 68, column: 5, scope: !2228)
!2292 = !DILocation(line: 69, column: 1, scope: !2228)
