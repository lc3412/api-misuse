; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--3dostr.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--3dostr.o.i"
...
@ff_threedostr_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i32 256, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0), %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 0, i32 (%struct.AVProbeData*)* @threedostr_probe, i32 (%struct.AVFormatContext*)* @threedostr_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @threedostr_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
@.str.3 = private unnamed_addr constant [5 x i8] c"CTRL\00", align 1
@.str.4 = private unnamed_addr constant [5 x i8] c"SHDR\00", align 1
@.str.5 = private unnamed_addr constant [5 x i8] c"SNDS\00", align 1
@.str.6 = private unnamed_addr constant [28 x i8] c"skipping unknown chunk: %X\0A\00", align 1
@.str.7 = private unnamed_addr constant [9 x i8] c"codec %X\00", align 1

; Function Attrs: nounwind uwtable
define internal i32 @threedostr_probe(%struct.AVProbeData* %p) #0 !dbg !2140 {
entry:
  ...
  %call = call i32 @memcmp(i8* %1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i32 0, i32 0), i64 4) #4, !dbg !2148
  %tobool = icmp ne i32 %call, 0, !dbg !2148
  br i1 %tobool, label %land.lhs.true, label %if.end, !dbg !2149

land.lhs.true:                                    ; preds = %entry
  %2 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2150
  %buf1 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %2, i32 0, i32 1, !dbg !2151
  %3 = load i8*, i8** %buf1, align 8, !dbg !2151
  %call2 = call i32 @memcmp(i8* %3, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i32 0, i32 0), i64 4) #4, !dbg !2152
  %tobool3 = icmp ne i32 %call2, 0, !dbg !2152
  br i1 %tobool3, label %land.lhs.true4, label %if.end, !dbg !2153

land.lhs.true4:                                   ; preds = %land.lhs.true
  %4 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2154
  %buf5 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %4, i32 0, i32 1, !dbg !2155
  %5 = load i8*, i8** %buf5, align 8, !dbg !2155
  %call6 = call i32 @memcmp(i8* %5, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.5, i32 0, i32 0), i64 4) #4, !dbg !2156
  %tobool7 = icmp ne i32 %call6, 0, !dbg !2156
  br i1 %tobool7, label %if.then, label %if.end, !dbg !2157
...
if.end:                                           ; preds = %land.lhs.true4, %land.lhs.true, %entry
  store i32 66, i32* %retval, align 4, !dbg !2160
  br label %return, !dbg !2160

return:                                           ; preds = %if.end, %if.then
  %6 = load i32, i32* %retval, align 4, !dbg !2161
  ret i32 %6, !dbg !2161
}

; Function Attrs: nounwind uwtable
define internal i32 @threedostr_read_header(%struct.AVFormatContext* %s) #0 !dbg !2162 {
entry:
  %retval = alloca i32, align 4
  ...
  %ctrl_size = alloca i32, align 4
  %found_shdr = alloca i32, align 4
  %st = alloca %struct.AVStream*, align 8
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2167, metadata !2143), !dbg !2168
  call void @llvm.dbg.declare(metadata i32* %chunk, metadata !2169, metadata !2143), !dbg !2170
  call void @llvm.dbg.declare(metadata i32* %codec, metadata !2171, metadata !2143), !dbg !2172
  store i32 0, i32* %codec, align 4, !dbg !2172
  call void @llvm.dbg.declare(metadata i32* %size, metadata !2173, metadata !2143), !dbg !2174
  call void @llvm.dbg.declare(metadata i32* %ctrl_size, metadata !2175, metadata !2143), !dbg !2176
  store i32 -1, i32* %ctrl_size, align 4, !dbg !2176
  call void @llvm.dbg.declare(metadata i32* %found_shdr, metadata !2177, metadata !2143), !dbg !2178
  store i32 0, i32* %found_shdr, align 4, !dbg !2178
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2179, metadata !2143), !dbg !2180
  br label %while.cond, !dbg !2181

while.cond:                                       ; preds = %sw.epilog, %entry
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2182
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2184
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2184
  %call = call i32 @avio_feof(%struct.AVIOContext* %1), !dbg !2185
  %tobool = icmp ne i32 %call, 0, !dbg !2185
  br i1 %tobool, label %land.end, label %land.rhs, !dbg !2186

land.rhs:                                         ; preds = %while.cond
  %2 = load i32, i32* %found_shdr, align 4, !dbg !2187
  %tobool1 = icmp ne i32 %2, 0, !dbg !2189
  %lnot = xor i1 %tobool1, true, !dbg !2189
  br label %land.end

land.end:                                         ; preds = %land.rhs, %while.cond
  %3 = phi i1 [ false, %while.cond ], [ %lnot, %land.rhs ]
  br i1 %3, label %while.body, label %while.end, !dbg !2190

while.body:                                       ; preds = %land.end
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2192
  %pb2 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %4, i32 0, i32 4, !dbg !2194
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb2, align 8, !dbg !2194
  %call3 = call i32 @avio_rl32(%struct.AVIOContext* %5), !dbg !2195
  store i32 %call3, i32* %chunk, align 4, !dbg !2196
  %6 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2197
  %pb4 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %6, i32 0, i32 4, !dbg !2198
  %7 = load %struct.AVIOContext*, %struct.AVIOContext** %pb4, align 8, !dbg !2198
  %call5 = call i32 @avio_rb32(%struct.AVIOContext* %7), !dbg !2199
  store i32 %call5, i32* %size, align 4, !dbg !2200
  %8 = load i32, i32* %size, align 4, !dbg !2201
  %cmp = icmp ult i32 %8, 8, !dbg !2203
  br i1 %cmp, label %if.then, label %if.end, !dbg !2204

if.then:                                          ; preds = %while.body
  store i32 -1094995529, i32* %retval, align 4, !dbg !2205
  br label %return, !dbg !2205

if.end:                                           ; preds = %while.body
  %9 = load i32, i32* %size, align 4, !dbg !2206
  %sub = sub i32 %9, 8, !dbg !2206
  store i32 %sub, i32* %size, align 4, !dbg !2206
  %10 = load i32, i32* %chunk, align 4, !dbg !2207
  switch i32 %10, label %sw.default [
    i32 1280463939, label %sw.bb
    i32 1396985427, label %sw.bb6
    i32 1380206675, label %sw.bb57
  ], !dbg !2208

sw.bb:                                            ; preds = %if.end
  %11 = load i32, i32* %size, align 4, !dbg !2209
  store i32 %11, i32* %ctrl_size, align 4, !dbg !2211
  br label %sw.epilog, !dbg !2212

sw.bb6:                                           ; preds = %if.end
  %12 = load i32, i32* %size, align 4, !dbg !2213
  %cmp7 = icmp ult i32 %12, 56, !dbg !2215
  br i1 %cmp7, label %if.then8, label %if.end9, !dbg !2216
...
if.end9:                                          ; preds = %sw.bb6
  %13 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2218
  %pb10 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %13, i32 0, i32 4, !dbg !2219
  %14 = load %struct.AVIOContext*, %struct.AVIOContext** %pb10, align 8, !dbg !2219
  %call11 = call i64 @avio_skip(%struct.AVIOContext* %14, i64 8), !dbg !2220
  %15 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2221
  %pb12 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %15, i32 0, i32 4, !dbg !2223
  %16 = load %struct.AVIOContext*, %struct.AVIOContext** %pb12, align 8, !dbg !2223
  %call13 = call i32 @avio_rl32(%struct.AVIOContext* %16), !dbg !2224
  %cmp14 = icmp ne i32 %call13, 1380206675, !dbg !2225
  br i1 %cmp14, label %if.then15, label %if.end16, !dbg !2226
...
if.end16:                                         ; preds = %if.end9
  %17 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2228
  %pb17 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %17, i32 0, i32 4, !dbg !2229
  %18 = load %struct.AVIOContext*, %struct.AVIOContext** %pb17, align 8, !dbg !2229
  %call18 = call i64 @avio_skip(%struct.AVIOContext* %18, i64 24), !dbg !2230
  %19 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2231
  %call19 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %19, %struct.AVCodec* null), !dbg !2232
  store %struct.AVStream* %call19, %struct.AVStream** %st, align 8, !dbg !2233
  %20 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2234
  %tobool20 = icmp ne %struct.AVStream* %20, null, !dbg !2234
  br i1 %tobool20, label %if.end22, label %if.then21, !dbg !2236
...
if.end22:                                         ; preds = %if.end16
  %21 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2238
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %21, i32 0, i32 19, !dbg !2239
  %22 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2239
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %22, i32 0, i32 0, !dbg !2240
  store i32 1, i32* %codec_type, align 8, !dbg !2241
  %23 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2242
  %pb23 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %23, i32 0, i32 4, !dbg !2243
  %24 = load %struct.AVIOContext*, %struct.AVIOContext** %pb23, align 8, !dbg !2243
  %call24 = call i32 @avio_rb32(%struct.AVIOContext* %24), !dbg !2244
  %25 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2245
  %codecpar25 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %25, i32 0, i32 19, !dbg !2246
  %26 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar25, align 8, !dbg !2246
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %26, i32 0, i32 23, !dbg !2247
  store i32 %call24, i32* %sample_rate, align 4, !dbg !2248
  %27 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2249
  %pb26 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %27, i32 0, i32 4, !dbg !2250
  %28 = load %struct.AVIOContext*, %struct.AVIOContext** %pb26, align 8, !dbg !2250
  %call27 = call i32 @avio_rb32(%struct.AVIOContext* %28), !dbg !2251
  %29 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2252
  %codecpar28 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %29, i32 0, i32 19, !dbg !2253
  %30 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar28, align 8, !dbg !2253
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %30, i32 0, i32 22, !dbg !2254
  store i32 %call27, i32* %channels, align 8, !dbg !2255
  %31 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2256
  %codecpar29 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %31, i32 0, i32 19, !dbg !2258
  %32 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar29, align 8, !dbg !2258
  %channels30 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %32, i32 0, i32 22, !dbg !2259
  %33 = load i32, i32* %channels30, align 8, !dbg !2259
  %cmp31 = icmp sle i32 %33, 0, !dbg !2260
  br i1 %cmp31, label %if.then32, label %if.end33, !dbg !2261
...
if.end33:                                         ; preds = %if.end22
  ...
  %pb34 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %34, i32 0, i32 4, !dbg !2264
  %35 = load %struct.AVIOContext*, %struct.AVIOContext** %pb34, align 8, !dbg !2264
  %call35 = call i32 @avio_rl32(%struct.AVIOContext* %35), !dbg !2265
  store i32 %call35, i32* %codec, align 4, !dbg !2266
  %36 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2267
  %pb36 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %36, i32 0, i32 4, !dbg !2268
  %37 = load %struct.AVIOContext*, %struct.AVIOContext** %pb36, align 8, !dbg !2268
  %call37 = call i64 @avio_skip(%struct.AVIOContext* %37, i64 4), !dbg !2269
  %38 = load i32, i32* %ctrl_size, align 4, !dbg !2270
  %cmp38 = icmp eq i32 %38, 20, !dbg !2272
  br i1 %cmp38, label %if.then42, label %lor.lhs.false, !dbg !2273

lor.lhs.false:                                    ; preds = %if.end33
  %39 = load i32, i32* %ctrl_size, align 4, !dbg !2274
  %cmp39 = icmp eq i32 %39, 3, !dbg !2276
  br i1 %cmp39, label %if.then42, label %lor.lhs.false40, !dbg !2277

lor.lhs.false40:                                  ; preds = %lor.lhs.false
  %40 = load i32, i32* %ctrl_size, align 4, !dbg !2278
  %cmp41 = icmp eq i32 %40, -1, !dbg !2280
  br i1 %cmp41, label %if.then42, label %if.else, !dbg !2281

if.then42:                                        ; preds = %lor.lhs.false40, %lor.lhs.false, %if.end33
  %41 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2282
  %pb43 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %41, i32 0, i32 4, !dbg !2283
  %42 = load %struct.AVIOContext*, %struct.AVIOContext** %pb43, align 8, !dbg !2283
  %call44 = call i32 @avio_rb32(%struct.AVIOContext* %42), !dbg !2284
  %sub45 = sub i32 %call44, 1, !dbg !2285
  %43 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2286
  %codecpar46 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %43, i32 0, i32 19, !dbg !2287
  %44 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar46, align 8, !dbg !2287
  %channels47 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %44, i32 0, i32 22, !dbg !2288
  %45 = load i32, i32* %channels47, align 8, !dbg !2288
  %div = udiv i32 %sub45, %45, !dbg !2289
  %conv = zext i32 %div to i64, !dbg !2290
  %46 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2291
  %duration = getelementptr inbounds %struct.AVStream, %struct.AVStream* %46, i32 0, i32 6, !dbg !2292
  store i64 %conv, i64* %duration, align 8, !dbg !2293
  br label %if.end55, !dbg !2291

if.else:                                          ; preds = %lor.lhs.false40
  %47 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2294
  %pb48 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %47, i32 0, i32 4, !dbg !2295
  %48 = load %struct.AVIOContext*, %struct.AVIOContext** %pb48, align 8, !dbg !2295
  %call49 = call i32 @avio_rb32(%struct.AVIOContext* %48), !dbg !2296
  %mul = mul i32 %call49, 16, !dbg !2297
  %49 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2298
  %codecpar50 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %49, i32 0, i32 19, !dbg !2299
  %50 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar50, align 8, !dbg !2299
  %channels51 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %50, i32 0, i32 22, !dbg !2300
  %51 = load i32, i32* %channels51, align 8, !dbg !2300
  %div52 = udiv i32 %mul, %51, !dbg !2301
  %conv53 = zext i32 %div52 to i64, !dbg !2296
  %52 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2302
  %duration54 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %52, i32 0, i32 6, !dbg !2303
  store i64 %conv53, i64* %duration54, align 8, !dbg !2304
  br label %if.end55

if.end55:                                         ; preds = %if.else, %if.then42
  %53 = load i32, i32* %size, align 4, !dbg !2305
  %sub56 = sub i32 %53, 56, !dbg !2305
  store i32 %sub56, i32* %size, align 4, !dbg !2305
  store i32 1, i32* %found_shdr, align 4, !dbg !2306
  br label %sw.epilog, !dbg !2307

sw.bb57:                                          ; preds = %if.end
  %54 = load i32, i32* %size, align 4, !dbg !2308
  %cmp58 = icmp ugt i32 %54, 120, !dbg !2310
  br i1 %cmp58, label %if.then60, label %if.end75, !dbg !2311

if.then60:                                        ; preds = %sw.bb57
  %55 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2312
  %pb61 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %55, i32 0, i32 4, !dbg !2314
  %56 = load %struct.AVIOContext*, %struct.AVIOContext** %pb61, align 8, !dbg !2314
  %call62 = call i64 @avio_skip(%struct.AVIOContext* %56, i64 116), !dbg !2315
  %57 = load i32, i32* %size, align 4, !dbg !2316
  %sub63 = sub i32 %57, 120, !dbg !2316
  store i32 %sub63, i32* %size, align 4, !dbg !2316
  %58 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2317
  %pb64 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %58, i32 0, i32 4, !dbg !2319
  %59 = load %struct.AVIOContext*, %struct.AVIOContext** %pb64, align 8, !dbg !2319
  %call65 = call i32 @avio_rl32(%struct.AVIOContext* %59), !dbg !2320
  %cmp66 = icmp eq i32 %call65, 1280463939, !dbg !2321
  br i1 %cmp66, label %land.lhs.true, label %if.end74, !dbg !2322

land.lhs.true:                                    ; preds = %if.then60
  %60 = load i32, i32* %size, align 4, !dbg !2323
  %cmp68 = icmp ugt i32 %60, 4, !dbg !2325
  br i1 %cmp68, label %if.then70, label %if.end74, !dbg !2326

if.then70:                                        ; preds = %land.lhs.true
  %61 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2327
  %pb71 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %61, i32 0, i32 4, !dbg !2329
  %62 = load %struct.AVIOContext*, %struct.AVIOContext** %pb71, align 8, !dbg !2329
  %call72 = call i32 @avio_rb32(%struct.AVIOContext* %62), !dbg !2330
  store i32 %call72, i32* %ctrl_size, align 4, !dbg !2331
  %63 = load i32, i32* %size, align 4, !dbg !2332
  %sub73 = sub i32 %63, 4, !dbg !2332
  store i32 %sub73, i32* %size, align 4, !dbg !2332
  br label %if.end74, !dbg !2333

if.end74:                                         ; preds = %if.then70, %land.lhs.true, %if.then60
  br label %if.end75, !dbg !2334

if.end75:                                         ; preds = %if.end74, %sw.bb57
  br label %sw.epilog, !dbg !2335

sw.default:                                       ; preds = %if.end
  %64 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2336
  %65 = bitcast %struct.AVFormatContext* %64 to i8*, !dbg !2336
  %66 = load i32, i32* %chunk, align 4, !dbg !2337
  call void (i8*, i32, i8*, ...) @av_log(i8* %65, i32 48, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.6, i32 0, i32 0), i32 %66), !dbg !2338
  br label %sw.epilog, !dbg !2339

sw.epilog:                                        ; preds = %sw.default, %if.end75, %if.end55, %sw.bb
  %67 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2340
  %pb76 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %67, i32 0, i32 4, !dbg !2341
  %68 = load %struct.AVIOContext*, %struct.AVIOContext** %pb76, align 8, !dbg !2341
  %69 = load i32, i32* %size, align 4, !dbg !2342
  %conv77 = zext i32 %69 to i64, !dbg !2342
  %call78 = call i64 @avio_skip(%struct.AVIOContext* %68, i64 %conv77), !dbg !2343
  br label %while.cond, !dbg !2344, !llvm.loop !2346

while.end:                                        ; preds = %land.end
  %70 = load i32, i32* %codec, align 4, !dbg !2347
  switch i32 %70, label %sw.default85 [
    i32 844645459, label %sw.bb79
  ], !dbg !2348

sw.bb79:                                          ; preds = %while.end
  %71 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2349
  %codecpar80 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %71, i32 0, i32 19, !dbg !2351
  %72 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar80, align 8, !dbg !2351
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %72, i32 0, i32 1, !dbg !2352
  store i32 83968, i32* %codec_id, align 4, !dbg !2353
  %73 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2354
  %codecpar81 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %73, i32 0, i32 19, !dbg !2355
  %74 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar81, align 8, !dbg !2355
  %channels82 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %74, i32 0, i32 22, !dbg !2356
  %75 = load i32, i32* %channels82, align 8, !dbg !2356
  %mul83 = mul nsw i32 1, %75, !dbg !2357
  %76 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2358
  %codecpar84 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %76, i32 0, i32 19, !dbg !2359
  %77 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar84, align 8, !dbg !2359
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %77, i32 0, i32 24, !dbg !2360
  store i32 %mul83, i32* %block_align, align 8, !dbg !2361
  br label %sw.epilog86, !dbg !2362

sw.default85:                                     ; preds = %while.end
  %78 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2363
  %79 = bitcast %struct.AVFormatContext* %78 to i8*, !dbg !2363
  %80 = load i32, i32* %codec, align 4, !dbg !2364
  call void (i8*, i8*, ...) @avpriv_request_sample(i8* %79, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.7, i32 0, i32 0), i32 %80), !dbg !2365
  store i32 -1163346256, i32* %retval, align 4, !dbg !2366
  br label %return, !dbg !2366

sw.epilog86:                                      ; preds = %sw.bb79
  %81 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2367
  %82 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2368
  %codecpar87 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %82, i32 0, i32 19, !dbg !2369
  %83 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar87, align 8, !dbg !2369
  %sample_rate88 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %83, i32 0, i32 23, !dbg !2370
  %84 = load i32, i32* %sample_rate88, align 4, !dbg !2370
  call void @avpriv_set_pts_info(%struct.AVStream* %81, i32 64, i32 1, i32 %84), !dbg !2371
  store i32 0, i32* %retval, align 4, !dbg !2372
  br label %return, !dbg !2372

return:                                           ; preds = %sw.epilog86, %sw.default85, %if.then32, %if.then21, %if.then15, %if.then8, %if.then
  %85 = load i32, i32* %retval, align 4, !dbg !2373
  ret i32 %85, !dbg !2373
}

; Function Attrs: nounwind uwtable
define internal i32 @threedostr_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2374 {
entry:
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2377, metadata !2143), !dbg !2381
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %pkt.addr = alloca %struct.AVPacket*, align 8
  %chunk = alloca i32, align 4
  %size = alloca i32, align 4
  %found_ssmp = alloca i32, align 4
  %st = alloca %struct.AVStream*, align 8
  %pos = alloca i64, align 8
  %ret = alloca i32, align 4
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2384, metadata !2143), !dbg !2385
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2386, metadata !2143), !dbg !2387
  call void @llvm.dbg.declare(metadata i32* %chunk, metadata !2388, metadata !2143), !dbg !2389
  call void @llvm.dbg.declare(metadata i32* %size, metadata !2390, metadata !2143), !dbg !2391
  call void @llvm.dbg.declare(metadata i32* %found_ssmp, metadata !2392, metadata !2143), !dbg !2393
  store i32 0, i32* %found_ssmp, align 4, !dbg !2393
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2394, metadata !2143), !dbg !2395
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2396
  %streams = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 7, !dbg !2397
  %1 = load %struct.AVStream**, %struct.AVStream*** %streams, align 8, !dbg !2397
  %arrayidx = getelementptr inbounds %struct.AVStream*, %struct.AVStream** %1, i64 0, !dbg !2396
  %2 = load %struct.AVStream*, %struct.AVStream** %arrayidx, align 8, !dbg !2396
  store %struct.AVStream* %2, %struct.AVStream** %st, align 8, !dbg !2395
  call void @llvm.dbg.declare(metadata i64* %pos, metadata !2398, metadata !2143), !dbg !2399
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2400, metadata !2143), !dbg !2401
  store i32 0, i32* %ret, align 4, !dbg !2401
  br label %while.cond, !dbg !2402

while.cond:                                       ; preds = %sw.epilog, %if.then9, %entry
  %3 = load i32, i32* %found_ssmp, align 4, !dbg !2403
  %tobool = icmp ne i32 %3, 0, !dbg !2405
  %lnot = xor i1 %tobool, true, !dbg !2405
  br i1 %lnot, label %while.body, label %while.end, !dbg !2406

while.body:                                       ; preds = %while.cond
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2407
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %4, i32 0, i32 4, !dbg !2409
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2409
  %call = call i32 @avio_feof(%struct.AVIOContext* %5), !dbg !2410
  %tobool1 = icmp ne i32 %call, 0, !dbg !2410
  br i1 %tobool1, label %if.then, label %if.end, !dbg !2411
...
if.end:                                           ; preds = %while.body
  %6 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2413
  %pb2 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %6, i32 0, i32 4, !dbg !2414
  %7 = load %struct.AVIOContext*, %struct.AVIOContext** %pb2, align 8, !dbg !2414
  store %struct.AVIOContext* %7, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2415
  %8 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2416
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %8, i64 0, i32 1) #5, !dbg !2417
  store i64 %call.i, i64* %pos, align 8, !dbg !2418
  %9 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2419
  %pb4 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %9, i32 0, i32 4, !dbg !2420
  %10 = load %struct.AVIOContext*, %struct.AVIOContext** %pb4, align 8, !dbg !2420
  %call5 = call i32 @avio_rl32(%struct.AVIOContext* %10), !dbg !2421
  store i32 %call5, i32* %chunk, align 4, !dbg !2422
  %11 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2423
  %pb6 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %11, i32 0, i32 4, !dbg !2424
  %12 = load %struct.AVIOContext*, %struct.AVIOContext** %pb6, align 8, !dbg !2424
  %call7 = call i32 @avio_rb32(%struct.AVIOContext* %12), !dbg !2425
  store i32 %call7, i32* %size, align 4, !dbg !2426
  %13 = load i32, i32* %size, align 4, !dbg !2427
  %tobool8 = icmp ne i32 %13, 0, !dbg !2427
  br i1 %tobool8, label %if.end10, label %if.then9, !dbg !2429

if.then9:                                         ; preds = %if.end
  br label %while.cond, !dbg !2430, !llvm.loop !2431

if.end10:                                         ; preds = %if.end
  %14 = load i32, i32* %size, align 4, !dbg !2432
  %cmp = icmp ult i32 %14, 8, !dbg !2434
  br i1 %cmp, label %if.then11, label %if.end12, !dbg !2435
...
if.end12:                                         ; preds = %if.end10
  %15 = load i32, i32* %size, align 4, !dbg !2437
  %sub = sub i32 %15, 8, !dbg !2437
  store i32 %sub, i32* %size, align 4, !dbg !2437
  %16 = load i32, i32* %chunk, align 4, !dbg !2438
  switch i32 %16, label %sw.default [
    i32 1396985427, label %sw.bb
  ], !dbg !2439

sw.bb:                                            ; preds = %if.end12
  %17 = load i32, i32* %size, align 4, !dbg !2440
  %cmp13 = icmp ule i32 %17, 16, !dbg !2443
  br i1 %cmp13, label %if.then14, label %if.end15, !dbg !2444
...
if.end15:                                         ; preds = %sw.bb
  %18 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2446
  %pb16 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %18, i32 0, i32 4, !dbg !2447
  %19 = load %struct.AVIOContext*, %struct.AVIOContext** %pb16, align 8, !dbg !2447
  %call17 = call i64 @avio_skip(%struct.AVIOContext* %19, i64 8), !dbg !2448
  %20 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2449
  %pb18 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %20, i32 0, i32 4, !dbg !2451
  %21 = load %struct.AVIOContext*, %struct.AVIOContext** %pb18, align 8, !dbg !2451
  %call19 = call i32 @avio_rl32(%struct.AVIOContext* %21), !dbg !2452
  %cmp20 = icmp ne i32 %call19, 1347244883, !dbg !2453
  br i1 %cmp20, label %if.then21, label %if.end22, !dbg !2454
...
if.end22:                                         ; preds = %if.end15
  %22 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2456
  %pb23 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %22, i32 0, i32 4, !dbg !2457
  %23 = load %struct.AVIOContext*, %struct.AVIOContext** %pb23, align 8, !dbg !2457
  %call24 = call i64 @avio_skip(%struct.AVIOContext* %23, i64 4), !dbg !2458
  %24 = load i32, i32* %size, align 4, !dbg !2459
  %sub25 = sub i32 %24, 16, !dbg !2459
  store i32 %sub25, i32* %size, align 4, !dbg !2459
  %25 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2460
  %pb26 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %25, i32 0, i32 4, !dbg !2461
  %26 = load %struct.AVIOContext*, %struct.AVIOContext** %pb26, align 8, !dbg !2461
  %27 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2462
  %28 = load i32, i32* %size, align 4, !dbg !2463
  %call27 = call i32 @av_get_packet(%struct.AVIOContext* %26, %struct.AVPacket* %27, i32 %28), !dbg !2464
  store i32 %call27, i32* %ret, align 4, !dbg !2465
  %29 = load i64, i64* %pos, align 8, !dbg !2466
  %30 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2467
  %pos28 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %30, i32 0, i32 10, !dbg !2468
  store i64 %29, i64* %pos28, align 8, !dbg !2469
  %31 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2470
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %31, i32 0, i32 5, !dbg !2471
  store i32 0, i32* %stream_index, align 4, !dbg !2472
  %32 = load i32, i32* %size, align 4, !dbg !2473
  %33 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2474
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %33, i32 0, i32 19, !dbg !2475
  %34 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2475
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %34, i32 0, i32 22, !dbg !2476
  %35 = load i32, i32* %channels, align 8, !dbg !2476
  %div = udiv i32 %32, %35, !dbg !2477
  %conv = zext i32 %div to i64, !dbg !2473
  %36 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2478
  %duration = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %36, i32 0, i32 9, !dbg !2479
  store i64 %conv, i64* %duration, align 8, !dbg !2480
  store i32 0, i32* %size, align 4, !dbg !2481
  store i32 1, i32* %found_ssmp, align 4, !dbg !2482
  br label %sw.epilog, !dbg !2483

sw.default:                                       ; preds = %if.end12
  %37 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2484
  %38 = bitcast %struct.AVFormatContext* %37 to i8*, !dbg !2484
  %39 = load i32, i32* %chunk, align 4, !dbg !2485
  call void (i8*, i32, i8*, ...) @av_log(i8* %38, i32 48, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.6, i32 0, i32 0), i32 %39), !dbg !2486
  br label %sw.epilog, !dbg !2487

sw.epilog:                                        ; preds = %sw.default, %if.end22
  %40 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2488
  %pb29 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %40, i32 0, i32 4, !dbg !2489
  %41 = load %struct.AVIOContext*, %struct.AVIOContext** %pb29, align 8, !dbg !2489
  %42 = load i32, i32* %size, align 4, !dbg !2490
  %conv30 = zext i32 %42 to i64, !dbg !2490
  %call31 = call i64 @avio_skip(%struct.AVIOContext* %41, i64 %conv30), !dbg !2491
  br label %while.cond, !dbg !2492, !llvm.loop !2431

while.end:                                        ; preds = %while.cond
  %43 = load i32, i32* %ret, align 4, !dbg !2494
  store i32 %43, i32* %retval, align 4, !dbg !2495
  br label %return, !dbg !2495

return:                                           ; preds = %while.end, %if.then21, %if.then14, %if.then11, %if.then
  %44 = load i32, i32* %retval, align 4, !dbg !2496
  ret i32 %44, !dbg !2496
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--3dostr.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!919 = !{!920}
!920 = distinct !DIGlobalVariable(name: "ff_threedostr_demuxer", scope: !0, file: !921, line: 160, type: !922, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_threedostr_demuxer)
!921 = !DIFile(filename: "libavformat/3dostr.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2140 = distinct !DISubprogram(name: "threedostr_probe", scope: !921, file: !921, line: 25, type: !991, isLocal: true, isDefinition: true, scopeLine: 26, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2141 = !{}
!2142 = !DILocalVariable(name: "p", arg: 1, scope: !2140, file: !921, line: 25, type: !993)
!2143 = !DIExpression()
!2144 = !DILocation(line: 25, column: 42, scope: !2140)
!2145 = !DILocation(line: 27, column: 16, scope: !2146)
!2146 = distinct !DILexicalBlock(scope: !2140, file: !921, line: 27, column: 9)
!2147 = !DILocation(line: 27, column: 19, scope: !2146)
!2148 = !DILocation(line: 27, column: 9, scope: !2146)
!2149 = !DILocation(line: 27, column: 35, scope: !2146)
!2150 = !DILocation(line: 28, column: 16, scope: !2146)
!2151 = !DILocation(line: 28, column: 19, scope: !2146)
!2152 = !DILocation(line: 28, column: 9, scope: !2146)
!2153 = !DILocation(line: 28, column: 35, scope: !2146)
!2154 = !DILocation(line: 29, column: 16, scope: !2146)
!2155 = !DILocation(line: 29, column: 19, scope: !2146)
!2156 = !DILocation(line: 29, column: 9, scope: !2146)
!2157 = !DILocation(line: 27, column: 9, scope: !2158)
!2158 = !DILexicalBlockFile(scope: !2140, file: !921, discriminator: 1)
!2159 = !DILocation(line: 30, column: 9, scope: !2146)
!2160 = !DILocation(line: 32, column: 5, scope: !2140)
!2161 = !DILocation(line: 33, column: 1, scope: !2140)
!2162 = distinct !DISubprogram(name: "threedostr_read_header", scope: !921, file: !921, line: 35, type: !2163, isLocal: true, isDefinition: true, scopeLine: 36, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2163 = !DISubroutineType(types: !2164)
!2164 = !{!917, !2165}
!2165 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2166, size: 64, align: 64)
!2166 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1008)
!2167 = !DILocalVariable(name: "s", arg: 1, scope: !2162, file: !921, line: 35, type: !2165)
!2168 = !DILocation(line: 35, column: 52, scope: !2162)
!2169 = !DILocalVariable(name: "chunk", scope: !2162, file: !921, line: 37, type: !918)
!2170 = !DILocation(line: 37, column: 14, scope: !2162)
!2171 = !DILocalVariable(name: "codec", scope: !2162, file: !921, line: 37, type: !918)
!2172 = !DILocation(line: 37, column: 21, scope: !2162)
!2173 = !DILocalVariable(name: "size", scope: !2162, file: !921, line: 37, type: !918)
!2174 = !DILocation(line: 37, column: 32, scope: !2162)
!2175 = !DILocalVariable(name: "ctrl_size", scope: !2162, file: !921, line: 37, type: !918)
!2176 = !DILocation(line: 37, column: 38, scope: !2162)
!2177 = !DILocalVariable(name: "found_shdr", scope: !2162, file: !921, line: 37, type: !918)
!2178 = !DILocation(line: 37, column: 54, scope: !2162)
!2179 = !DILocalVariable(name: "st", scope: !2162, file: !921, line: 38, type: !1283)
!2180 = !DILocation(line: 38, column: 15, scope: !2162)
!2181 = !DILocation(line: 40, column: 5, scope: !2162)
!2182 = !DILocation(line: 40, column: 23, scope: !2183)
!2183 = !DILexicalBlockFile(scope: !2162, file: !921, discriminator: 1)
!2184 = !DILocation(line: 40, column: 26, scope: !2183)
!2185 = !DILocation(line: 40, column: 13, scope: !2183)
!2186 = !DILocation(line: 40, column: 30, scope: !2183)
!2187 = !DILocation(line: 40, column: 34, scope: !2188)
!2188 = !DILexicalBlockFile(scope: !2162, file: !921, discriminator: 2)
!2189 = !DILocation(line: 40, column: 33, scope: !2188)
!2190 = !DILocation(line: 40, column: 5, scope: !2191)
!2191 = !DILexicalBlockFile(scope: !2162, file: !921, discriminator: 3)
!2192 = !DILocation(line: 41, column: 27, scope: !2193)
!2193 = distinct !DILexicalBlock(scope: !2162, file: !921, line: 40, column: 46)
!2194 = !DILocation(line: 41, column: 30, scope: !2193)
!2195 = !DILocation(line: 41, column: 17, scope: !2193)
!2196 = !DILocation(line: 41, column: 15, scope: !2193)
!2197 = !DILocation(line: 42, column: 26, scope: !2193)
!2198 = !DILocation(line: 42, column: 29, scope: !2193)
!2199 = !DILocation(line: 42, column: 16, scope: !2193)
!2200 = !DILocation(line: 42, column: 14, scope: !2193)
!2201 = !DILocation(line: 44, column: 13, scope: !2202)
!2202 = distinct !DILexicalBlock(scope: !2193, file: !921, line: 44, column: 13)
!2203 = !DILocation(line: 44, column: 18, scope: !2202)
!2204 = !DILocation(line: 44, column: 13, scope: !2193)
!2205 = !DILocation(line: 45, column: 13, scope: !2202)
!2206 = !DILocation(line: 46, column: 14, scope: !2193)
!2207 = !DILocation(line: 48, column: 17, scope: !2193)
!2208 = !DILocation(line: 48, column: 9, scope: !2193)
!2209 = !DILocation(line: 50, column: 25, scope: !2210)
!2210 = distinct !DILexicalBlock(scope: !2193, file: !921, line: 48, column: 24)
!2211 = !DILocation(line: 50, column: 23, scope: !2210)
!2212 = !DILocation(line: 51, column: 13, scope: !2210)
!2213 = !DILocation(line: 53, column: 17, scope: !2214)
!2214 = distinct !DILexicalBlock(scope: !2210, file: !921, line: 53, column: 17)
!2215 = !DILocation(line: 53, column: 22, scope: !2214)
!2216 = !DILocation(line: 53, column: 17, scope: !2210)
!2217 = !DILocation(line: 54, column: 17, scope: !2214)
!2218 = !DILocation(line: 55, column: 23, scope: !2210)
!2219 = !DILocation(line: 55, column: 26, scope: !2210)
!2220 = !DILocation(line: 55, column: 13, scope: !2210)
!2221 = !DILocation(line: 56, column: 27, scope: !2222)
!2222 = distinct !DILexicalBlock(scope: !2210, file: !921, line: 56, column: 17)
!2223 = !DILocation(line: 56, column: 30, scope: !2222)
!2224 = !DILocation(line: 56, column: 17, scope: !2222)
!2225 = !DILocation(line: 56, column: 34, scope: !2222)
!2226 = !DILocation(line: 56, column: 17, scope: !2210)
!2227 = !DILocation(line: 57, column: 17, scope: !2222)
!2228 = !DILocation(line: 58, column: 23, scope: !2210)
!2229 = !DILocation(line: 58, column: 26, scope: !2210)
!2230 = !DILocation(line: 58, column: 13, scope: !2210)
!2231 = !DILocation(line: 60, column: 38, scope: !2210)
!2232 = !DILocation(line: 60, column: 18, scope: !2210)
!2233 = !DILocation(line: 60, column: 16, scope: !2210)
!2234 = !DILocation(line: 61, column: 18, scope: !2235)
!2235 = distinct !DILexicalBlock(scope: !2210, file: !921, line: 61, column: 17)
!2236 = !DILocation(line: 61, column: 17, scope: !2210)
!2237 = !DILocation(line: 62, column: 17, scope: !2235)
!2238 = !DILocation(line: 64, column: 13, scope: !2210)
!2239 = !DILocation(line: 64, column: 17, scope: !2210)
!2240 = !DILocation(line: 64, column: 27, scope: !2210)
!2241 = !DILocation(line: 64, column: 38, scope: !2210)
!2242 = !DILocation(line: 65, column: 51, scope: !2210)
!2243 = !DILocation(line: 65, column: 54, scope: !2210)
!2244 = !DILocation(line: 65, column: 41, scope: !2210)
!2245 = !DILocation(line: 65, column: 13, scope: !2210)
!2246 = !DILocation(line: 65, column: 17, scope: !2210)
!2247 = !DILocation(line: 65, column: 27, scope: !2210)
!2248 = !DILocation(line: 65, column: 39, scope: !2210)
!2249 = !DILocation(line: 66, column: 48, scope: !2210)
!2250 = !DILocation(line: 66, column: 51, scope: !2210)
!2251 = !DILocation(line: 66, column: 38, scope: !2210)
!2252 = !DILocation(line: 66, column: 13, scope: !2210)
!2253 = !DILocation(line: 66, column: 17, scope: !2210)
!2254 = !DILocation(line: 66, column: 27, scope: !2210)
!2255 = !DILocation(line: 66, column: 36, scope: !2210)
!2256 = !DILocation(line: 67, column: 17, scope: !2257)
!2257 = distinct !DILexicalBlock(scope: !2210, file: !921, line: 67, column: 17)
!2258 = !DILocation(line: 67, column: 21, scope: !2257)
!2259 = !DILocation(line: 67, column: 31, scope: !2257)
!2260 = !DILocation(line: 67, column: 40, scope: !2257)
!2261 = !DILocation(line: 67, column: 17, scope: !2210)
!2262 = !DILocation(line: 68, column: 17, scope: !2257)
!2263 = !DILocation(line: 69, column: 31, scope: !2210)
!2264 = !DILocation(line: 69, column: 34, scope: !2210)
!2265 = !DILocation(line: 69, column: 21, scope: !2210)
!2266 = !DILocation(line: 69, column: 19, scope: !2210)
!2267 = !DILocation(line: 70, column: 23, scope: !2210)
!2268 = !DILocation(line: 70, column: 26, scope: !2210)
!2269 = !DILocation(line: 70, column: 13, scope: !2210)
!2270 = !DILocation(line: 71, column: 17, scope: !2271)
!2271 = distinct !DILexicalBlock(scope: !2210, file: !921, line: 71, column: 17)
!2272 = !DILocation(line: 71, column: 27, scope: !2271)
!2273 = !DILocation(line: 71, column: 33, scope: !2271)
!2274 = !DILocation(line: 71, column: 36, scope: !2275)
!2275 = !DILexicalBlockFile(scope: !2271, file: !921, discriminator: 1)
!2276 = !DILocation(line: 71, column: 46, scope: !2275)
!2277 = !DILocation(line: 71, column: 51, scope: !2275)
!2278 = !DILocation(line: 71, column: 54, scope: !2279)
!2279 = !DILexicalBlockFile(scope: !2271, file: !921, discriminator: 2)
!2280 = !DILocation(line: 71, column: 64, scope: !2279)
!2281 = !DILocation(line: 71, column: 17, scope: !2279)
!2282 = !DILocation(line: 72, column: 43, scope: !2271)
!2283 = !DILocation(line: 72, column: 46, scope: !2271)
!2284 = !DILocation(line: 72, column: 33, scope: !2271)
!2285 = !DILocation(line: 72, column: 50, scope: !2271)
!2286 = !DILocation(line: 72, column: 57, scope: !2271)
!2287 = !DILocation(line: 72, column: 61, scope: !2271)
!2288 = !DILocation(line: 72, column: 71, scope: !2271)
!2289 = !DILocation(line: 72, column: 55, scope: !2271)
!2290 = !DILocation(line: 72, column: 32, scope: !2271)
!2291 = !DILocation(line: 72, column: 17, scope: !2271)
!2292 = !DILocation(line: 72, column: 21, scope: !2271)
!2293 = !DILocation(line: 72, column: 30, scope: !2271)
!2294 = !DILocation(line: 74, column: 42, scope: !2271)
!2295 = !DILocation(line: 74, column: 45, scope: !2271)
!2296 = !DILocation(line: 74, column: 32, scope: !2271)
!2297 = !DILocation(line: 74, column: 49, scope: !2271)
!2298 = !DILocation(line: 74, column: 56, scope: !2271)
!2299 = !DILocation(line: 74, column: 60, scope: !2271)
!2300 = !DILocation(line: 74, column: 70, scope: !2271)
!2301 = !DILocation(line: 74, column: 54, scope: !2271)
!2302 = !DILocation(line: 74, column: 17, scope: !2271)
!2303 = !DILocation(line: 74, column: 21, scope: !2271)
!2304 = !DILocation(line: 74, column: 30, scope: !2271)
!2305 = !DILocation(line: 75, column: 18, scope: !2210)
!2306 = !DILocation(line: 76, column: 24, scope: !2210)
!2307 = !DILocation(line: 77, column: 13, scope: !2210)
!2308 = !DILocation(line: 79, column: 17, scope: !2309)
!2309 = distinct !DILexicalBlock(scope: !2210, file: !921, line: 79, column: 17)
!2310 = !DILocation(line: 79, column: 22, scope: !2309)
!2311 = !DILocation(line: 79, column: 17, scope: !2210)
!2312 = !DILocation(line: 80, column: 27, scope: !2313)
!2313 = distinct !DILexicalBlock(scope: !2309, file: !921, line: 79, column: 30)
!2314 = !DILocation(line: 80, column: 30, scope: !2313)
!2315 = !DILocation(line: 80, column: 17, scope: !2313)
!2316 = !DILocation(line: 81, column: 22, scope: !2313)
!2317 = !DILocation(line: 82, column: 31, scope: !2318)
!2318 = distinct !DILexicalBlock(scope: !2313, file: !921, line: 82, column: 21)
!2319 = !DILocation(line: 82, column: 34, scope: !2318)
!2320 = !DILocation(line: 82, column: 21, scope: !2318)
!2321 = !DILocation(line: 82, column: 38, scope: !2318)
!2322 = !DILocation(line: 82, column: 106, scope: !2318)
!2323 = !DILocation(line: 82, column: 109, scope: !2324)
!2324 = !DILexicalBlockFile(scope: !2318, file: !921, discriminator: 1)
!2325 = !DILocation(line: 82, column: 114, scope: !2324)
!2326 = !DILocation(line: 82, column: 21, scope: !2324)
!2327 = !DILocation(line: 83, column: 43, scope: !2328)
!2328 = distinct !DILexicalBlock(scope: !2318, file: !921, line: 82, column: 119)
!2329 = !DILocation(line: 83, column: 46, scope: !2328)
!2330 = !DILocation(line: 83, column: 33, scope: !2328)
!2331 = !DILocation(line: 83, column: 31, scope: !2328)
!2332 = !DILocation(line: 84, column: 26, scope: !2328)
!2333 = !DILocation(line: 85, column: 17, scope: !2328)
!2334 = !DILocation(line: 86, column: 13, scope: !2313)
!2335 = !DILocation(line: 87, column: 13, scope: !2210)
!2336 = !DILocation(line: 89, column: 20, scope: !2210)
!2337 = !DILocation(line: 89, column: 59, scope: !2210)
!2338 = !DILocation(line: 89, column: 13, scope: !2210)
!2339 = !DILocation(line: 90, column: 13, scope: !2210)
!2340 = !DILocation(line: 93, column: 19, scope: !2193)
!2341 = !DILocation(line: 93, column: 22, scope: !2193)
!2342 = !DILocation(line: 93, column: 26, scope: !2193)
!2343 = !DILocation(line: 93, column: 9, scope: !2193)
!2344 = !DILocation(line: 40, column: 5, scope: !2345)
!2345 = !DILexicalBlockFile(scope: !2162, file: !921, discriminator: 4)
!2346 = distinct !{!2346, !2181}
!2347 = !DILocation(line: 96, column: 13, scope: !2162)
!2348 = !DILocation(line: 96, column: 5, scope: !2162)
!2349 = !DILocation(line: 98, column: 9, scope: !2350)
!2350 = distinct !DILexicalBlock(scope: !2162, file: !921, line: 96, column: 20)
!2351 = !DILocation(line: 98, column: 13, scope: !2350)
!2352 = !DILocation(line: 98, column: 23, scope: !2350)
!2353 = !DILocation(line: 98, column: 32, scope: !2350)
!2354 = !DILocation(line: 99, column: 41, scope: !2350)
!2355 = !DILocation(line: 99, column: 45, scope: !2350)
!2356 = !DILocation(line: 99, column: 55, scope: !2350)
!2357 = !DILocation(line: 99, column: 39, scope: !2350)
!2358 = !DILocation(line: 99, column: 9, scope: !2350)
!2359 = !DILocation(line: 99, column: 13, scope: !2350)
!2360 = !DILocation(line: 99, column: 23, scope: !2350)
!2361 = !DILocation(line: 99, column: 35, scope: !2350)
!2362 = !DILocation(line: 100, column: 9, scope: !2350)
!2363 = !DILocation(line: 102, column: 31, scope: !2350)
!2364 = !DILocation(line: 102, column: 46, scope: !2350)
!2365 = !DILocation(line: 102, column: 9, scope: !2350)
!2366 = !DILocation(line: 103, column: 9, scope: !2350)
!2367 = !DILocation(line: 106, column: 25, scope: !2162)
!2368 = !DILocation(line: 106, column: 36, scope: !2162)
!2369 = !DILocation(line: 106, column: 40, scope: !2162)
!2370 = !DILocation(line: 106, column: 50, scope: !2162)
!2371 = !DILocation(line: 106, column: 5, scope: !2162)
!2372 = !DILocation(line: 108, column: 5, scope: !2162)
!2373 = !DILocation(line: 109, column: 1, scope: !2162)
!2374 = distinct !DISubprogram(name: "threedostr_read_packet", scope: !921, file: !921, line: 111, type: !2375, isLocal: true, isDefinition: true, scopeLine: 112, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2375 = !DISubroutineType(types: !2376)
!2376 = !{!917, !2165, !1033}
!2377 = !DILocalVariable(name: "s", arg: 1, scope: !2378, file: !628, line: 557, type: !1215)
!2378 = distinct !DISubprogram(name: "avio_tell", scope: !628, file: !628, line: 557, type: !2379, isLocal: true, isDefinition: true, scopeLine: 558, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2379 = !DISubroutineType(types: !2380)
!2380 = !{!1053, !1215}
!2381 = !DILocation(line: 557, column: 77, scope: !2378, inlinedAt: !2382)
!2382 = distinct !DILocation(line: 122, column: 15, scope: !2383)
!2383 = distinct !DILexicalBlock(scope: !2374, file: !921, line: 118, column: 25)
!2384 = !DILocalVariable(name: "s", arg: 1, scope: !2374, file: !921, line: 111, type: !2165)
!2385 = !DILocation(line: 111, column: 52, scope: !2374)
!2386 = !DILocalVariable(name: "pkt", arg: 2, scope: !2374, file: !921, line: 111, type: !1033)
!2387 = !DILocation(line: 111, column: 65, scope: !2374)
!2388 = !DILocalVariable(name: "chunk", scope: !2374, file: !921, line: 113, type: !918)
!2389 = !DILocation(line: 113, column: 14, scope: !2374)
!2390 = !DILocalVariable(name: "size", scope: !2374, file: !921, line: 113, type: !918)
!2391 = !DILocation(line: 113, column: 21, scope: !2374)
!2392 = !DILocalVariable(name: "found_ssmp", scope: !2374, file: !921, line: 113, type: !918)
!2393 = !DILocation(line: 113, column: 27, scope: !2374)
!2394 = !DILocalVariable(name: "st", scope: !2374, file: !921, line: 114, type: !1283)
!2395 = !DILocation(line: 114, column: 15, scope: !2374)
!2396 = !DILocation(line: 114, column: 20, scope: !2374)
!2397 = !DILocation(line: 114, column: 23, scope: !2374)
!2398 = !DILocalVariable(name: "pos", scope: !2374, file: !921, line: 115, type: !1053)
!2399 = !DILocation(line: 115, column: 13, scope: !2374)
!2400 = !DILocalVariable(name: "ret", scope: !2374, file: !921, line: 116, type: !917)
!2401 = !DILocation(line: 116, column: 9, scope: !2374)
!2402 = !DILocation(line: 118, column: 5, scope: !2374)
!2403 = !DILocation(line: 118, column: 13, scope: !2404)
!2404 = !DILexicalBlockFile(scope: !2374, file: !921, discriminator: 1)
!2405 = !DILocation(line: 118, column: 12, scope: !2404)
!2406 = !DILocation(line: 118, column: 5, scope: !2404)
!2407 = !DILocation(line: 119, column: 23, scope: !2408)
!2408 = distinct !DILexicalBlock(scope: !2383, file: !921, line: 119, column: 13)
!2409 = !DILocation(line: 119, column: 26, scope: !2408)
!2410 = !DILocation(line: 119, column: 13, scope: !2408)
!2411 = !DILocation(line: 119, column: 13, scope: !2383)
!2412 = !DILocation(line: 120, column: 13, scope: !2408)
!2413 = !DILocation(line: 122, column: 25, scope: !2383)
!2414 = !DILocation(line: 122, column: 28, scope: !2383)
!2415 = !DILocation(line: 122, column: 15, scope: !2383)
!2416 = !DILocation(line: 559, column: 22, scope: !2378, inlinedAt: !2382)
!2417 = !DILocation(line: 559, column: 12, scope: !2378, inlinedAt: !2382)
!2418 = !DILocation(line: 122, column: 13, scope: !2383)
!2419 = !DILocation(line: 123, column: 27, scope: !2383)
!2420 = !DILocation(line: 123, column: 30, scope: !2383)
!2421 = !DILocation(line: 123, column: 17, scope: !2383)
!2422 = !DILocation(line: 123, column: 15, scope: !2383)
!2423 = !DILocation(line: 124, column: 26, scope: !2383)
!2424 = !DILocation(line: 124, column: 29, scope: !2383)
!2425 = !DILocation(line: 124, column: 16, scope: !2383)
!2426 = !DILocation(line: 124, column: 14, scope: !2383)
!2427 = !DILocation(line: 126, column: 14, scope: !2428)
!2428 = distinct !DILexicalBlock(scope: !2383, file: !921, line: 126, column: 13)
!2429 = !DILocation(line: 126, column: 13, scope: !2383)
!2430 = !DILocation(line: 127, column: 13, scope: !2428)
!2431 = distinct !{!2431, !2402}
!2432 = !DILocation(line: 129, column: 13, scope: !2433)
!2433 = distinct !DILexicalBlock(scope: !2383, file: !921, line: 129, column: 13)
!2434 = !DILocation(line: 129, column: 18, scope: !2433)
!2435 = !DILocation(line: 129, column: 13, scope: !2383)
!2436 = !DILocation(line: 130, column: 13, scope: !2433)
!2437 = !DILocation(line: 131, column: 14, scope: !2383)
!2438 = !DILocation(line: 133, column: 17, scope: !2383)
!2439 = !DILocation(line: 133, column: 9, scope: !2383)
!2440 = !DILocation(line: 135, column: 17, scope: !2441)
!2441 = distinct !DILexicalBlock(scope: !2442, file: !921, line: 135, column: 17)
!2442 = distinct !DILexicalBlock(scope: !2383, file: !921, line: 133, column: 24)
!2443 = !DILocation(line: 135, column: 22, scope: !2441)
!2444 = !DILocation(line: 135, column: 17, scope: !2442)
!2445 = !DILocation(line: 136, column: 17, scope: !2441)
!2446 = !DILocation(line: 137, column: 23, scope: !2442)
!2447 = !DILocation(line: 137, column: 26, scope: !2442)
!2448 = !DILocation(line: 137, column: 13, scope: !2442)
!2449 = !DILocation(line: 138, column: 27, scope: !2450)
!2450 = distinct !DILexicalBlock(scope: !2442, file: !921, line: 138, column: 17)
!2451 = !DILocation(line: 138, column: 30, scope: !2450)
!2452 = !DILocation(line: 138, column: 17, scope: !2450)
!2453 = !DILocation(line: 138, column: 34, scope: !2450)
!2454 = !DILocation(line: 138, column: 17, scope: !2442)
!2455 = !DILocation(line: 139, column: 17, scope: !2450)
!2456 = !DILocation(line: 140, column: 23, scope: !2442)
!2457 = !DILocation(line: 140, column: 26, scope: !2442)
!2458 = !DILocation(line: 140, column: 13, scope: !2442)
!2459 = !DILocation(line: 141, column: 18, scope: !2442)
!2460 = !DILocation(line: 142, column: 33, scope: !2442)
!2461 = !DILocation(line: 142, column: 36, scope: !2442)
!2462 = !DILocation(line: 142, column: 40, scope: !2442)
!2463 = !DILocation(line: 142, column: 45, scope: !2442)
!2464 = !DILocation(line: 142, column: 19, scope: !2442)
!2465 = !DILocation(line: 142, column: 17, scope: !2442)
!2466 = !DILocation(line: 143, column: 24, scope: !2442)
!2467 = !DILocation(line: 143, column: 13, scope: !2442)
!2468 = !DILocation(line: 143, column: 18, scope: !2442)
!2469 = !DILocation(line: 143, column: 22, scope: !2442)
!2470 = !DILocation(line: 144, column: 13, scope: !2442)
!2471 = !DILocation(line: 144, column: 18, scope: !2442)
!2472 = !DILocation(line: 144, column: 31, scope: !2442)
!2473 = !DILocation(line: 145, column: 29, scope: !2442)
!2474 = !DILocation(line: 145, column: 36, scope: !2442)
!2475 = !DILocation(line: 145, column: 40, scope: !2442)
!2476 = !DILocation(line: 145, column: 50, scope: !2442)
!2477 = !DILocation(line: 145, column: 34, scope: !2442)
!2478 = !DILocation(line: 145, column: 13, scope: !2442)
!2479 = !DILocation(line: 145, column: 18, scope: !2442)
!2480 = !DILocation(line: 145, column: 27, scope: !2442)
!2481 = !DILocation(line: 146, column: 18, scope: !2442)
!2482 = !DILocation(line: 147, column: 24, scope: !2442)
!2483 = !DILocation(line: 148, column: 13, scope: !2442)
!2484 = !DILocation(line: 150, column: 20, scope: !2442)
!2485 = !DILocation(line: 150, column: 59, scope: !2442)
!2486 = !DILocation(line: 150, column: 13, scope: !2442)
!2487 = !DILocation(line: 151, column: 13, scope: !2442)
!2488 = !DILocation(line: 154, column: 19, scope: !2383)
!2489 = !DILocation(line: 154, column: 22, scope: !2383)
!2490 = !DILocation(line: 154, column: 26, scope: !2383)
!2491 = !DILocation(line: 154, column: 9, scope: !2383)
!2492 = !DILocation(line: 118, column: 5, scope: !2493)
!2493 = !DILexicalBlockFile(scope: !2374, file: !921, discriminator: 2)
!2494 = !DILocation(line: 157, column: 12, scope: !2374)
!2495 = !DILocation(line: 157, column: 5, scope: !2374)
!2496 = !DILocation(line: 158, column: 1, scope: !2374)
