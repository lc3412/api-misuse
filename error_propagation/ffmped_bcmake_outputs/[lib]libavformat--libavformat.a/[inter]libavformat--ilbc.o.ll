; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--ilbc.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--ilbc.o.i"
...
@ff_ilbc_muxer = global { i8*, i8*, i8*, i8*, i32, i32, i32, i32, %struct.AVCodecTag**, %struct.AVClass*, %struct.AVOutputFormat*, i32, i32 (%struct.AVFormatContext*)*, i32 (%struct.AVFormatContext*, %struct.AVPacket*)*, i32 (%struct.AVFormatContext*)*, i32 (%struct.AVFormatContext*, %struct.AVPacket*, %struct.AVPacket*, i32)*, i32 (i32, i32)*, void (%struct.AVFormatContext*, i32, i64*, i64*)*, i32 (%struct.AVFormatContext*, i32, i8*, i64)*, i32 (%struct.AVFormatContext*, i32, %struct.AVFrame**, i32)*, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)*, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)*, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)*, i32, i32 (%struct.AVFormatContext*)*, void (%struct.AVFormatContext*)*, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* } { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0), i32 86075, i32 0, i32 0, i32 128, %struct.AVCodecTag** null, %struct.AVClass* null, %struct.AVOutputFormat* null, i32 0, i32 (%struct.AVFormatContext*)* @ilbc_write_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @ilbc_write_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, %struct.AVPacket*, %struct.AVPacket*, i32)* null, i32 (i32, i32)* null, void (%struct.AVFormatContext*, i32, i64*, i64*)* null, i32 (%struct.AVFormatContext*, i32, i8*, i64)* null, i32 (%struct.AVFormatContext*, i32, %struct.AVFrame**, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 0, i32 (%struct.AVFormatContext*)* null, void (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* null }, align 8
...
@.str.5 = private unnamed_addr constant [31 x i8] c"Unsupported number of streams\0A\00", align 1
@.str.6 = private unnamed_addr constant [19 x i8] c"Unsupported codec\0A\00", align 1
@.str.7 = private unnamed_addr constant [18 x i8] c"Unsupported mode\0A\00", align 1

; Function Attrs: nounwind uwtable
define internal i32 @ilbc_probe(%struct.AVProbeData* %p) #0 !dbg !2147 {
entry:
  ...
  %call = call i32 @memcmp(i8* %1, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @mode20_header, i32 0, i32 0), i64 6) #4, !dbg !2155
  %tobool = icmp ne i32 %call, 0, !dbg !2155
  br i1 %tobool, label %if.else, label %if.then, !dbg !2156
...
return:                                           ; preds = %if.else, %if.then
  %2 = load i32, i32* %retval, align 4, !dbg !2159
  ret i32 %2, !dbg !2159
}

; Function Attrs: nounwind uwtable
define internal i32 @ilbc_read_header(%struct.AVFormatContext* %s) #0 !dbg !2160 {
entry:
  %retval = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2165, metadata !2150), !dbg !2166
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2167, metadata !2150), !dbg !2168
  ...
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2171, metadata !2150), !dbg !2172
  call void @llvm.dbg.declare(metadata [9 x i8]* %header, metadata !2173, metadata !2150), !dbg !2177
  %2 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2178
  %arraydecay = getelementptr inbounds [9 x i8], [9 x i8]* %header, i32 0, i32 0, !dbg !2179
  %call = call i32 @avio_read(%struct.AVIOContext* %2, i8* %arraydecay, i32 9), !dbg !2180
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2181
  %call2 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %3, %struct.AVCodec* null), !dbg !2182
  store %struct.AVStream* %call2, %struct.AVStream** %st, align 8, !dbg !2183
  %4 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2184
  %tobool = icmp ne %struct.AVStream* %4, null, !dbg !2184
  br i1 %tobool, label %if.end, label %if.then, !dbg !2186

if.then:                                          ; preds = %entry
  store i32 -12, i32* %retval, align 4, !dbg !2187
  br label %return, !dbg !2187

if.end:                                           ; preds = %entry
  %5 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2188
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %5, i32 0, i32 19, !dbg !2189
  %6 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2189
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %6, i32 0, i32 1, !dbg !2190
  store i32 86075, i32* %codec_id, align 4, !dbg !2191
  %7 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2192
  %codecpar3 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %7, i32 0, i32 19, !dbg !2193
  %8 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar3, align 8, !dbg !2193
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %8, i32 0, i32 23, !dbg !2194
  store i32 8000, i32* %sample_rate, align 4, !dbg !2195
  %9 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2196
  %codecpar4 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %9, i32 0, i32 19, !dbg !2197
  %10 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar4, align 8, !dbg !2197
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %10, i32 0, i32 22, !dbg !2198
  store i32 1, i32* %channels, align 8, !dbg !2199
  %11 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2200
  %codecpar5 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %11, i32 0, i32 19, !dbg !2201
  %12 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar5, align 8, !dbg !2201
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %12, i32 0, i32 0, !dbg !2202
  store i32 1, i32* %codec_type, align 8, !dbg !2203
  %13 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2204
  %start_time = getelementptr inbounds %struct.AVStream, %struct.AVStream* %13, i32 0, i32 5, !dbg !2205
  store i64 0, i64* %start_time, align 8, !dbg !2206
  %14 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2207
  %15 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2208
  %codecpar6 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %15, i32 0, i32 19, !dbg !2209
  %16 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar6, align 8, !dbg !2209
  %sample_rate7 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %16, i32 0, i32 23, !dbg !2210
  %17 = load i32, i32* %sample_rate7, align 4, !dbg !2210
  call void @avpriv_set_pts_info(%struct.AVStream* %14, i32 64, i32 1, i32 %17), !dbg !2211
  %arraydecay8 = getelementptr inbounds [9 x i8], [9 x i8]* %header, i32 0, i32 0, !dbg !2212
  %call9 = call i32 @memcmp(i8* %arraydecay8, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @mode20_header, i32 0, i32 0), i64 9) #4, !dbg !2214
  %tobool10 = icmp ne i32 %call9, 0, !dbg !2214
  br i1 %tobool10, label %if.else, label %if.then11, !dbg !2215

if.then11:                                        ; preds = %if.end
  %18 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2216
  %codecpar12 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %18, i32 0, i32 19, !dbg !2218
  %19 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar12, align 8, !dbg !2218
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %19, i32 0, i32 24, !dbg !2219
  store i32 38, i32* %block_align, align 8, !dbg !2220
  %20 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2221
  %codecpar13 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %20, i32 0, i32 19, !dbg !2222
  %21 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar13, align 8, !dbg !2222
  %bit_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %21, i32 0, i32 6, !dbg !2223
  store i64 15200, i64* %bit_rate, align 8, !dbg !2224
  br label %if.end24, !dbg !2225

if.else:                                          ; preds = %if.end
  %arraydecay14 = getelementptr inbounds [9 x i8], [9 x i8]* %header, i32 0, i32 0, !dbg !2226
  %call15 = call i32 @memcmp(i8* %arraydecay14, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @mode30_header, i32 0, i32 0), i64 9) #4, !dbg !2229
  %tobool16 = icmp ne i32 %call15, 0, !dbg !2229
  br i1 %tobool16, label %if.else22, label %if.then17, !dbg !2230

if.then17:                                        ; preds = %if.else
  %22 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2231
  %codecpar18 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %22, i32 0, i32 19, !dbg !2233
  %23 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar18, align 8, !dbg !2233
  %block_align19 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %23, i32 0, i32 24, !dbg !2234
  store i32 50, i32* %block_align19, align 8, !dbg !2235
  %24 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2236
  %codecpar20 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %24, i32 0, i32 19, !dbg !2237
  %25 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar20, align 8, !dbg !2237
  %bit_rate21 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %25, i32 0, i32 6, !dbg !2238
  store i64 13333, i64* %bit_rate21, align 8, !dbg !2239
  br label %if.end23, !dbg !2240

if.else22:                                        ; preds = %if.else
  %26 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2241
  %27 = bitcast %struct.AVFormatContext* %26 to i8*, !dbg !2241
  call void (i8*, i32, i8*, ...) @av_log(i8* %27, i32 16, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.4, i32 0, i32 0)), !dbg !2243
...
return:                                           ; preds = %if.end24, %if.else22, %if.then
  %28 = load i32, i32* %retval, align 4, !dbg !2246
  ret i32 %28, !dbg !2246
}

; Function Attrs: nounwind uwtable
define internal i32 @ilbc_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2247 {
entry:
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2250, metadata !2150), !dbg !2254
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2256, metadata !2150), !dbg !2257
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2258, metadata !2150), !dbg !2259
  call void @llvm.dbg.declare(metadata %struct.AVCodecParameters** %par, metadata !2260, metadata !2150), !dbg !2261
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2262
  %streams = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 7, !dbg !2263
  %1 = load %struct.AVStream**, %struct.AVStream*** %streams, align 8, !dbg !2263
  %arrayidx = getelementptr inbounds %struct.AVStream*, %struct.AVStream** %1, i64 0, !dbg !2262
  %2 = load %struct.AVStream*, %struct.AVStream** %arrayidx, align 8, !dbg !2262
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %2, i32 0, i32 19, !dbg !2264
  %3 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2264
  store %struct.AVCodecParameters* %3, %struct.AVCodecParameters** %par, align 8, !dbg !2261
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2265, metadata !2150), !dbg !2266
  %4 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2267
  %5 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2269
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %5, i32 0, i32 24, !dbg !2270
  %6 = load i32, i32* %block_align, align 8, !dbg !2270
  %call = call i32 @av_new_packet(%struct.AVPacket* %4, i32 %6), !dbg !2271
  store i32 %call, i32* %ret, align 4, !dbg !2272
  %cmp = icmp slt i32 %call, 0, !dbg !2273
  br i1 %cmp, label %if.then, label %if.end, !dbg !2274

if.then:                                          ; preds = %entry
  %7 = load i32, i32* %ret, align 4, !dbg !2275
  store i32 %7, i32* %retval, align 4, !dbg !2276
  br label %return, !dbg !2276

if.end:                                           ; preds = %entry
  %8 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2277
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %8, i32 0, i32 5, !dbg !2278
  store i32 0, i32* %stream_index, align 4, !dbg !2279
  %9 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2280
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %9, i32 0, i32 4, !dbg !2281
  %10 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2281
  store %struct.AVIOContext* %10, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2282
  %11 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2283
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %11, i64 0, i32 1) #5, !dbg !2284
  %12 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2285
  %pos = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %12, i32 0, i32 10, !dbg !2286
  store i64 %call.i, i64* %pos, align 8, !dbg !2287
  %13 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2288
  %block_align2 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %13, i32 0, i32 24, !dbg !2289
  %14 = load i32, i32* %block_align2, align 8, !dbg !2289
  %cmp3 = icmp eq i32 %14, 38, !dbg !2290
  %cond = select i1 %cmp3, i32 160, i32 240, !dbg !2288
  %conv = sext i32 %cond to i64, !dbg !2288
  %15 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2291
  %duration = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %15, i32 0, i32 9, !dbg !2292
  store i64 %conv, i64* %duration, align 8, !dbg !2293
  %16 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2294
  %pb4 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %16, i32 0, i32 4, !dbg !2296
  %17 = load %struct.AVIOContext*, %struct.AVIOContext** %pb4, align 8, !dbg !2296
  %18 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2297
  %data = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %18, i32 0, i32 3, !dbg !2298
  %19 = load i8*, i8** %data, align 8, !dbg !2298
  %20 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2299
  %block_align5 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %20, i32 0, i32 24, !dbg !2300
  %21 = load i32, i32* %block_align5, align 8, !dbg !2300
  %call6 = call i32 @avio_read(%struct.AVIOContext* %17, i8* %19, i32 %21), !dbg !2301
  store i32 %call6, i32* %ret, align 4, !dbg !2302
  %22 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2303
  %block_align7 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %22, i32 0, i32 24, !dbg !2304
  %23 = load i32, i32* %block_align7, align 8, !dbg !2304
  %cmp8 = icmp ne i32 %call6, %23, !dbg !2305
  br i1 %cmp8, label %if.then10, label %if.end14, !dbg !2306

if.then10:                                        ; preds = %if.end
  %24 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2307
  call void @av_packet_unref(%struct.AVPacket* %24), !dbg !2309
  %25 = load i32, i32* %ret, align 4, !dbg !2310
  %cmp11 = icmp slt i32 %25, 0, !dbg !2311
  br i1 %cmp11, label %cond.true, label %cond.false, !dbg !2310

cond.true:                                        ; preds = %if.then10
  %26 = load i32, i32* %ret, align 4, !dbg !2312
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond13 = phi i32 [ %26, %cond.true ], [ -5, %cond.false ], !dbg !2317
  store i32 %cond13, i32* %retval, align 4, !dbg !2319
  br label %return, !dbg !2319

if.end14:                                         ; preds = %if.end
  store i32 0, i32* %retval, align 4, !dbg !2320
  br label %return, !dbg !2320

return:                                           ; preds = %if.end14, %cond.end, %if.then
  %27 = load i32, i32* %retval, align 4, !dbg !2321
  ret i32 %27, !dbg !2321
}

; Function Attrs: nounwind uwtable
define internal i32 @ilbc_write_header(%struct.AVFormatContext* %s) #0 !dbg !2322 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %pb = alloca %struct.AVIOContext*, align 8
  %par = alloca %struct.AVCodecParameters*, align 8
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2323, metadata !2150), !dbg !2324
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2325, metadata !2150), !dbg !2326
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2327
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2328
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2328
  store %struct.AVIOContext* %1, %struct.AVIOContext** %pb, align 8, !dbg !2326
  call void @llvm.dbg.declare(metadata %struct.AVCodecParameters** %par, metadata !2329, metadata !2150), !dbg !2330
  %2 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2331
  %nb_streams = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %2, i32 0, i32 6, !dbg !2333
  %3 = load i32, i32* %nb_streams, align 4, !dbg !2333
  %cmp = icmp ne i32 %3, 1, !dbg !2334
  br i1 %cmp, label %if.then, label %if.end, !dbg !2335

if.then:                                          ; preds = %entry
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2336
  %5 = bitcast %struct.AVFormatContext* %4 to i8*, !dbg !2336
  call void (i8*, i32, i8*, ...) @av_log(i8* %5, i32 16, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.5, i32 0, i32 0)), !dbg !2338
  store i32 -22, i32* %retval, align 4, !dbg !2339
  br label %return, !dbg !2339

if.end:                                           ; preds = %entry
  %6 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2340
  %streams = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %6, i32 0, i32 7, !dbg !2341
  %7 = load %struct.AVStream**, %struct.AVStream*** %streams, align 8, !dbg !2341
  %arrayidx = getelementptr inbounds %struct.AVStream*, %struct.AVStream** %7, i64 0, !dbg !2340
  %8 = load %struct.AVStream*, %struct.AVStream** %arrayidx, align 8, !dbg !2340
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %8, i32 0, i32 19, !dbg !2342
  %9 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2342
  store %struct.AVCodecParameters* %9, %struct.AVCodecParameters** %par, align 8, !dbg !2343
  %10 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2344
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %10, i32 0, i32 1, !dbg !2346
  %11 = load i32, i32* %codec_id, align 4, !dbg !2346
  %cmp2 = icmp ne i32 %11, 86075, !dbg !2347
  br i1 %cmp2, label %if.then3, label %if.end4, !dbg !2348

if.then3:                                         ; preds = %if.end
  %12 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2349
  %13 = bitcast %struct.AVFormatContext* %12 to i8*, !dbg !2349
  call void (i8*, i32, i8*, ...) @av_log(i8* %13, i32 16, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.6, i32 0, i32 0)), !dbg !2351
  store i32 -22, i32* %retval, align 4, !dbg !2352
  br label %return, !dbg !2352

if.end4:                                          ; preds = %if.end
  %14 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2353
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %14, i32 0, i32 24, !dbg !2355
  %15 = load i32, i32* %block_align, align 8, !dbg !2355
  %cmp5 = icmp eq i32 %15, 50, !dbg !2356
  br i1 %cmp5, label %if.then6, label %if.else, !dbg !2357

if.then6:                                         ; preds = %if.end4
  %16 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2358
  call void @avio_write(%struct.AVIOContext* %16, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @mode30_header, i32 0, i32 0), i32 9), !dbg !2360
  br label %if.end12, !dbg !2361

if.else:                                          ; preds = %if.end4
  %17 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2362
  %block_align7 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %17, i32 0, i32 24, !dbg !2365
  %18 = load i32, i32* %block_align7, align 8, !dbg !2365
  %cmp8 = icmp eq i32 %18, 38, !dbg !2366
  br i1 %cmp8, label %if.then9, label %if.else10, !dbg !2362

if.then9:                                         ; preds = %if.else
  %19 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2367
  call void @avio_write(%struct.AVIOContext* %19, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @mode20_header, i32 0, i32 0), i32 9), !dbg !2369
  br label %if.end11, !dbg !2370
...
if.else10:                                        ; preds = %if.else
  ...
  call void (i8*, i32, i8*, ...) @av_log(i8* %21, i32 16, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.7, i32 0, i32 0)), !dbg !2373
...
if.end12:                                         ; preds = %if.end11, %if.then6
  %22 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2375
  call void @avio_flush(%struct.AVIOContext* %22), !dbg !2376
  store i32 0, i32* %retval, align 4, !dbg !2377
  br label %return, !dbg !2377

return:                                           ; preds = %if.end12, %if.else10, %if.then3, %if.then
  %23 = load i32, i32* %retval, align 4, !dbg !2378
  ret i32 %23, !dbg !2378
}

; Function Attrs: nounwind uwtable
define internal i32 @ilbc_write_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2379 {
entry:
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %pkt.addr = alloca %struct.AVPacket*, align 8
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2380, metadata !2150), !dbg !2381
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2382, metadata !2150), !dbg !2383
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2384
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2385
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2385
  %2 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2386
  %data = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %2, i32 0, i32 3, !dbg !2387
  %3 = load i8*, i8** %data, align 8, !dbg !2387
  %4 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2388
  %size = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %4, i32 0, i32 4, !dbg !2389
  %5 = load i32, i32* %size, align 8, !dbg !2389
  call void @avio_write(%struct.AVIOContext* %1, i8* %3, i32 %5), !dbg !2390
  ret i32 0, !dbg !2391
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--ilbc.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!919 = !{!920, !2137, !2139, !2143}
!920 = distinct !DIGlobalVariable(name: "ff_ilbc_demuxer", scope: !0, file: !921, line: 122, type: !922, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_ilbc_demuxer)
!921 = !DIFile(filename: "libavformat/ilbc.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2137 = distinct !DIGlobalVariable(name: "ff_ilbc_muxer", scope: !0, file: !921, line: 131, type: !2138, isLocal: false, isDefinition: true, variable: { i8*, i8*, i8*, i8*, i32, i32, i32, i32, %struct.AVCodecTag**, %struct.AVClass*, %struct.AVOutputFormat*, i32, i32 (%struct.AVFormatContext*)*, i32 (%struct.AVFormatContext*, %struct.AVPacket*)*, i32 (%struct.AVFormatContext*)*, i32 (%struct.AVFormatContext*, %struct.AVPacket*, %struct.AVPacket*, i32)*, i32 (i32, i32)*, void (%struct.AVFormatContext*, i32, i64*, i64*)*, i32 (%struct.AVFormatContext*, i32, i8*, i64)*, i32 (%struct.AVFormatContext*, i32, %struct.AVFrame**, i32)*, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)*, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)*, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)*, i32, i32 (%struct.AVFormatContext*)*, void (%struct.AVFormatContext*)*, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* }* @ff_ilbc_muxer)
!2138 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVOutputFormat", file: !897, line: 624, baseType: !1014)
!2139 = distinct !DIGlobalVariable(name: "mode20_header", scope: !0, file: !921, line: 25, type: !2140, isLocal: true, isDefinition: true, variable: [10 x i8]* @mode20_header)
!2140 = !DICompositeType(tag: DW_TAG_array_type, baseType: !927, size: 80, align: 8, elements: !2141)
!2141 = !{!2142}
!2142 = !DISubrange(count: 10)
!2143 = distinct !DIGlobalVariable(name: "mode30_header", scope: !0, file: !921, line: 26, type: !2140, isLocal: true, isDefinition: true, variable: [10 x i8]* @mode30_header)
!2144 = !{i32 2, !"Dwarf Version", i32 4}
!2145 = !{i32 2, !"Debug Info Version", i32 3}
!2146 = !{!"clang version 3.9.0 (tags/RELEASE_390/final)"}
!2147 = distinct !DISubprogram(name: "ilbc_probe", scope: !921, file: !921, line: 62, type: !991, isLocal: true, isDefinition: true, scopeLine: 63, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2148)
!2148 = !{}
!2149 = !DILocalVariable(name: "p", arg: 1, scope: !2147, file: !921, line: 62, type: !993)
!2150 = !DIExpression()
!2151 = !DILocation(line: 62, column: 36, scope: !2147)
!2152 = !DILocation(line: 65, column: 17, scope: !2153)
!2153 = distinct !DILexicalBlock(scope: !2147, file: !921, line: 65, column: 9)
!2154 = !DILocation(line: 65, column: 20, scope: !2153)
!2155 = !DILocation(line: 65, column: 10, scope: !2153)
!2156 = !DILocation(line: 65, column: 9, scope: !2147)
!2157 = !DILocation(line: 66, column: 9, scope: !2153)
!2158 = !DILocation(line: 68, column: 9, scope: !2153)
!2159 = !DILocation(line: 69, column: 1, scope: !2147)
!2160 = distinct !DISubprogram(name: "ilbc_read_header", scope: !921, file: !921, line: 71, type: !2161, isLocal: true, isDefinition: true, scopeLine: 72, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2148)
!2161 = !DISubroutineType(types: !2162)
!2162 = !{!917, !2163}
!2163 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2164, size: 64, align: 64)
!2164 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1008)
!2165 = !DILocalVariable(name: "s", arg: 1, scope: !2160, file: !921, line: 71, type: !2163)
!2166 = !DILocation(line: 71, column: 46, scope: !2160)
!2167 = !DILocalVariable(name: "pb", scope: !2160, file: !921, line: 73, type: !1215)
!2168 = !DILocation(line: 73, column: 18, scope: !2160)
!2169 = !DILocation(line: 73, column: 23, scope: !2160)
!2170 = !DILocation(line: 73, column: 26, scope: !2160)
!2171 = !DILocalVariable(name: "st", scope: !2160, file: !921, line: 74, type: !1283)
!2172 = !DILocation(line: 74, column: 15, scope: !2160)
!2173 = !DILocalVariable(name: "header", scope: !2160, file: !921, line: 75, type: !2174)
!2174 = !DICompositeType(tag: DW_TAG_array_type, baseType: !1049, size: 72, align: 8, elements: !2175)
!2175 = !{!2176}
!2176 = !DISubrange(count: 9)
!2177 = !DILocation(line: 75, column: 13, scope: !2160)
!2178 = !DILocation(line: 77, column: 15, scope: !2160)
!2179 = !DILocation(line: 77, column: 19, scope: !2160)
!2180 = !DILocation(line: 77, column: 5, scope: !2160)
!2181 = !DILocation(line: 79, column: 30, scope: !2160)
!2182 = !DILocation(line: 79, column: 10, scope: !2160)
!2183 = !DILocation(line: 79, column: 8, scope: !2160)
!2184 = !DILocation(line: 80, column: 10, scope: !2185)
!2185 = distinct !DILexicalBlock(scope: !2160, file: !921, line: 80, column: 9)
!2186 = !DILocation(line: 80, column: 9, scope: !2160)
!2187 = !DILocation(line: 81, column: 9, scope: !2185)
!2188 = !DILocation(line: 82, column: 5, scope: !2160)
!2189 = !DILocation(line: 82, column: 9, scope: !2160)
!2190 = !DILocation(line: 82, column: 19, scope: !2160)
!2191 = !DILocation(line: 82, column: 28, scope: !2160)
!2192 = !DILocation(line: 83, column: 5, scope: !2160)
!2193 = !DILocation(line: 83, column: 9, scope: !2160)
!2194 = !DILocation(line: 83, column: 19, scope: !2160)
!2195 = !DILocation(line: 83, column: 31, scope: !2160)
!2196 = !DILocation(line: 84, column: 5, scope: !2160)
!2197 = !DILocation(line: 84, column: 9, scope: !2160)
!2198 = !DILocation(line: 84, column: 19, scope: !2160)
!2199 = !DILocation(line: 84, column: 28, scope: !2160)
!2200 = !DILocation(line: 85, column: 5, scope: !2160)
!2201 = !DILocation(line: 85, column: 9, scope: !2160)
!2202 = !DILocation(line: 85, column: 19, scope: !2160)
!2203 = !DILocation(line: 85, column: 30, scope: !2160)
!2204 = !DILocation(line: 86, column: 5, scope: !2160)
!2205 = !DILocation(line: 86, column: 9, scope: !2160)
!2206 = !DILocation(line: 86, column: 20, scope: !2160)
!2207 = !DILocation(line: 87, column: 25, scope: !2160)
!2208 = !DILocation(line: 87, column: 36, scope: !2160)
!2209 = !DILocation(line: 87, column: 40, scope: !2160)
!2210 = !DILocation(line: 87, column: 50, scope: !2160)
!2211 = !DILocation(line: 87, column: 5, scope: !2160)
!2212 = !DILocation(line: 88, column: 17, scope: !2213)
!2213 = distinct !DILexicalBlock(scope: !2160, file: !921, line: 88, column: 9)
!2214 = !DILocation(line: 88, column: 10, scope: !2213)
!2215 = !DILocation(line: 88, column: 9, scope: !2160)
!2216 = !DILocation(line: 89, column: 9, scope: !2217)
!2217 = distinct !DILexicalBlock(scope: !2213, file: !921, line: 88, column: 68)
!2218 = !DILocation(line: 89, column: 13, scope: !2217)
!2219 = !DILocation(line: 89, column: 23, scope: !2217)
!2220 = !DILocation(line: 89, column: 35, scope: !2217)
!2221 = !DILocation(line: 90, column: 9, scope: !2217)
!2222 = !DILocation(line: 90, column: 13, scope: !2217)
!2223 = !DILocation(line: 90, column: 23, scope: !2217)
!2224 = !DILocation(line: 90, column: 32, scope: !2217)
!2225 = !DILocation(line: 91, column: 5, scope: !2217)
!2226 = !DILocation(line: 91, column: 24, scope: !2227)
!2227 = !DILexicalBlockFile(scope: !2228, file: !921, discriminator: 1)
!2228 = distinct !DILexicalBlock(scope: !2213, file: !921, line: 91, column: 16)
!2229 = !DILocation(line: 91, column: 17, scope: !2227)
!2230 = !DILocation(line: 91, column: 16, scope: !2227)
!2231 = !DILocation(line: 92, column: 9, scope: !2232)
!2232 = distinct !DILexicalBlock(scope: !2228, file: !921, line: 91, column: 75)
!2233 = !DILocation(line: 92, column: 13, scope: !2232)
!2234 = !DILocation(line: 92, column: 23, scope: !2232)
!2235 = !DILocation(line: 92, column: 35, scope: !2232)
!2236 = !DILocation(line: 93, column: 9, scope: !2232)
!2237 = !DILocation(line: 93, column: 13, scope: !2232)
!2238 = !DILocation(line: 93, column: 23, scope: !2232)
!2239 = !DILocation(line: 93, column: 32, scope: !2232)
!2240 = !DILocation(line: 94, column: 5, scope: !2232)
!2241 = !DILocation(line: 95, column: 16, scope: !2242)
!2242 = distinct !DILexicalBlock(scope: !2228, file: !921, line: 94, column: 12)
!2243 = !DILocation(line: 95, column: 9, scope: !2242)
!2244 = !DILocation(line: 96, column: 9, scope: !2242)
!2245 = !DILocation(line: 99, column: 5, scope: !2160)
!2246 = !DILocation(line: 100, column: 1, scope: !2160)
!2247 = distinct !DISubprogram(name: "ilbc_read_packet", scope: !921, file: !921, line: 102, type: !2248, isLocal: true, isDefinition: true, scopeLine: 104, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2148)
!2248 = !DISubroutineType(types: !2249)
!2249 = !{!917, !2163, !1033}
!2250 = !DILocalVariable(name: "s", arg: 1, scope: !2251, file: !628, line: 557, type: !1215)
!2251 = distinct !DISubprogram(name: "avio_tell", scope: !628, file: !628, line: 557, type: !2252, isLocal: true, isDefinition: true, scopeLine: 558, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2148)
!2252 = !DISubroutineType(types: !2253)
!2253 = !{!1053, !1215}
!2254 = !DILocation(line: 557, column: 77, scope: !2251, inlinedAt: !2255)
!2255 = distinct !DILocation(line: 112, column: 16, scope: !2247)
!2256 = !DILocalVariable(name: "s", arg: 1, scope: !2247, file: !921, line: 102, type: !2163)
!2257 = !DILocation(line: 102, column: 46, scope: !2247)
!2258 = !DILocalVariable(name: "pkt", arg: 2, scope: !2247, file: !921, line: 103, type: !1033)
!2259 = !DILocation(line: 103, column: 37, scope: !2247)
!2260 = !DILocalVariable(name: "par", scope: !2247, file: !921, line: 105, type: !1727)
!2261 = !DILocation(line: 105, column: 24, scope: !2247)
!2262 = !DILocation(line: 105, column: 30, scope: !2247)
!2263 = !DILocation(line: 105, column: 33, scope: !2247)
!2264 = !DILocation(line: 105, column: 45, scope: !2247)
!2265 = !DILocalVariable(name: "ret", scope: !2247, file: !921, line: 106, type: !917)
!2266 = !DILocation(line: 106, column: 9, scope: !2247)
!2267 = !DILocation(line: 108, column: 30, scope: !2268)
!2268 = distinct !DILexicalBlock(scope: !2247, file: !921, line: 108, column: 9)
!2269 = !DILocation(line: 108, column: 35, scope: !2268)
!2270 = !DILocation(line: 108, column: 40, scope: !2268)
!2271 = !DILocation(line: 108, column: 16, scope: !2268)
!2272 = !DILocation(line: 108, column: 14, scope: !2268)
!2273 = !DILocation(line: 108, column: 54, scope: !2268)
!2274 = !DILocation(line: 108, column: 9, scope: !2247)
!2275 = !DILocation(line: 109, column: 16, scope: !2268)
!2276 = !DILocation(line: 109, column: 9, scope: !2268)
!2277 = !DILocation(line: 111, column: 5, scope: !2247)
!2278 = !DILocation(line: 111, column: 10, scope: !2247)
!2279 = !DILocation(line: 111, column: 23, scope: !2247)
!2280 = !DILocation(line: 112, column: 26, scope: !2247)
!2281 = !DILocation(line: 112, column: 29, scope: !2247)
!2282 = !DILocation(line: 112, column: 16, scope: !2247)
!2283 = !DILocation(line: 559, column: 22, scope: !2251, inlinedAt: !2255)
!2284 = !DILocation(line: 559, column: 12, scope: !2251, inlinedAt: !2255)
!2285 = !DILocation(line: 112, column: 5, scope: !2247)
!2286 = !DILocation(line: 112, column: 10, scope: !2247)
!2287 = !DILocation(line: 112, column: 14, scope: !2247)
!2288 = !DILocation(line: 113, column: 21, scope: !2247)
!2289 = !DILocation(line: 113, column: 26, scope: !2247)
!2290 = !DILocation(line: 113, column: 38, scope: !2247)
!2291 = !DILocation(line: 113, column: 5, scope: !2247)
!2292 = !DILocation(line: 113, column: 10, scope: !2247)
!2293 = !DILocation(line: 113, column: 19, scope: !2247)
!2294 = !DILocation(line: 114, column: 26, scope: !2295)
!2295 = distinct !DILexicalBlock(scope: !2247, file: !921, line: 114, column: 9)
!2296 = !DILocation(line: 114, column: 29, scope: !2295)
!2297 = !DILocation(line: 114, column: 33, scope: !2295)
!2298 = !DILocation(line: 114, column: 38, scope: !2295)
!2299 = !DILocation(line: 114, column: 44, scope: !2295)
!2300 = !DILocation(line: 114, column: 49, scope: !2295)
!2301 = !DILocation(line: 114, column: 16, scope: !2295)
!2302 = !DILocation(line: 114, column: 14, scope: !2295)
!2303 = !DILocation(line: 114, column: 66, scope: !2295)
!2304 = !DILocation(line: 114, column: 71, scope: !2295)
!2305 = !DILocation(line: 114, column: 63, scope: !2295)
!2306 = !DILocation(line: 114, column: 9, scope: !2247)
!2307 = !DILocation(line: 115, column: 25, scope: !2308)
!2308 = distinct !DILexicalBlock(scope: !2295, file: !921, line: 114, column: 84)
!2309 = !DILocation(line: 115, column: 9, scope: !2308)
!2310 = !DILocation(line: 116, column: 16, scope: !2308)
!2311 = !DILocation(line: 116, column: 20, scope: !2308)
!2312 = !DILocation(line: 116, column: 26, scope: !2313)
!2313 = !DILexicalBlockFile(scope: !2308, file: !921, discriminator: 1)
!2314 = !DILocation(line: 116, column: 16, scope: !2313)
!2315 = !DILocation(line: 116, column: 16, scope: !2316)
!2316 = !DILexicalBlockFile(scope: !2308, file: !921, discriminator: 2)
!2317 = !DILocation(line: 116, column: 16, scope: !2318)
!2318 = !DILexicalBlockFile(scope: !2308, file: !921, discriminator: 3)
!2319 = !DILocation(line: 116, column: 9, scope: !2318)
!2320 = !DILocation(line: 119, column: 5, scope: !2247)
!2321 = !DILocation(line: 120, column: 1, scope: !2247)
!2322 = distinct !DISubprogram(name: "ilbc_write_header", scope: !921, file: !921, line: 28, type: !2161, isLocal: true, isDefinition: true, scopeLine: 29, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2148)
!2323 = !DILocalVariable(name: "s", arg: 1, scope: !2322, file: !921, line: 28, type: !2163)
!2324 = !DILocation(line: 28, column: 47, scope: !2322)
!2325 = !DILocalVariable(name: "pb", scope: !2322, file: !921, line: 30, type: !1215)
!2326 = !DILocation(line: 30, column: 18, scope: !2322)
!2327 = !DILocation(line: 30, column: 23, scope: !2322)
!2328 = !DILocation(line: 30, column: 26, scope: !2322)
!2329 = !DILocalVariable(name: "par", scope: !2322, file: !921, line: 31, type: !1727)
!2330 = !DILocation(line: 31, column: 24, scope: !2322)
!2331 = !DILocation(line: 33, column: 9, scope: !2332)
!2332 = distinct !DILexicalBlock(scope: !2322, file: !921, line: 33, column: 9)
!2333 = !DILocation(line: 33, column: 12, scope: !2332)
!2334 = !DILocation(line: 33, column: 23, scope: !2332)
!2335 = !DILocation(line: 33, column: 9, scope: !2322)
!2336 = !DILocation(line: 34, column: 16, scope: !2337)
!2337 = distinct !DILexicalBlock(scope: !2332, file: !921, line: 33, column: 29)
!2338 = !DILocation(line: 34, column: 9, scope: !2337)
!2339 = !DILocation(line: 35, column: 9, scope: !2337)
!2340 = !DILocation(line: 37, column: 11, scope: !2322)
!2341 = !DILocation(line: 37, column: 14, scope: !2322)
!2342 = !DILocation(line: 37, column: 26, scope: !2322)
!2343 = !DILocation(line: 37, column: 9, scope: !2322)
!2344 = !DILocation(line: 39, column: 9, scope: !2345)
!2345 = distinct !DILexicalBlock(scope: !2322, file: !921, line: 39, column: 9)
!2346 = !DILocation(line: 39, column: 14, scope: !2345)
!2347 = !DILocation(line: 39, column: 23, scope: !2345)
!2348 = !DILocation(line: 39, column: 9, scope: !2322)
!2349 = !DILocation(line: 40, column: 16, scope: !2350)
!2350 = distinct !DILexicalBlock(scope: !2345, file: !921, line: 39, column: 44)
!2351 = !DILocation(line: 40, column: 9, scope: !2350)
!2352 = !DILocation(line: 41, column: 9, scope: !2350)
!2353 = !DILocation(line: 44, column: 9, scope: !2354)
!2354 = distinct !DILexicalBlock(scope: !2322, file: !921, line: 44, column: 9)
!2355 = !DILocation(line: 44, column: 14, scope: !2354)
!2356 = !DILocation(line: 44, column: 26, scope: !2354)
!2357 = !DILocation(line: 44, column: 9, scope: !2322)
!2358 = !DILocation(line: 45, column: 20, scope: !2359)
!2359 = distinct !DILexicalBlock(scope: !2354, file: !921, line: 44, column: 33)
!2360 = !DILocation(line: 45, column: 9, scope: !2359)
!2361 = !DILocation(line: 46, column: 5, scope: !2359)
!2362 = !DILocation(line: 46, column: 16, scope: !2363)
!2363 = !DILexicalBlockFile(scope: !2364, file: !921, discriminator: 1)
!2364 = distinct !DILexicalBlock(scope: !2354, file: !921, line: 46, column: 16)
!2365 = !DILocation(line: 46, column: 21, scope: !2363)
!2366 = !DILocation(line: 46, column: 33, scope: !2363)
!2367 = !DILocation(line: 47, column: 20, scope: !2368)
!2368 = distinct !DILexicalBlock(scope: !2364, file: !921, line: 46, column: 40)
!2369 = !DILocation(line: 47, column: 9, scope: !2368)
!2370 = !DILocation(line: 48, column: 5, scope: !2368)
!2371 = !DILocation(line: 49, column: 16, scope: !2372)
!2372 = distinct !DILexicalBlock(scope: !2364, file: !921, line: 48, column: 12)
!2373 = !DILocation(line: 49, column: 9, scope: !2372)
!2374 = !DILocation(line: 50, column: 9, scope: !2372)
!2375 = !DILocation(line: 52, column: 16, scope: !2322)
!2376 = !DILocation(line: 52, column: 5, scope: !2322)
!2377 = !DILocation(line: 53, column: 5, scope: !2322)
!2378 = !DILocation(line: 54, column: 1, scope: !2322)
!2379 = distinct !DISubprogram(name: "ilbc_write_packet", scope: !921, file: !921, line: 56, type: !2248, isLocal: true, isDefinition: true, scopeLine: 57, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2148)
!2380 = !DILocalVariable(name: "s", arg: 1, scope: !2379, file: !921, line: 56, type: !2163)
!2381 = !DILocation(line: 56, column: 47, scope: !2379)
!2382 = !DILocalVariable(name: "pkt", arg: 2, scope: !2379, file: !921, line: 56, type: !1033)
!2383 = !DILocation(line: 56, column: 60, scope: !2379)
!2384 = !DILocation(line: 58, column: 16, scope: !2379)
!2385 = !DILocation(line: 58, column: 19, scope: !2379)
!2386 = !DILocation(line: 58, column: 23, scope: !2379)
!2387 = !DILocation(line: 58, column: 28, scope: !2379)
!2388 = !DILocation(line: 58, column: 34, scope: !2379)
!2389 = !DILocation(line: 58, column: 39, scope: !2379)
!2390 = !DILocation(line: 58, column: 5, scope: !2379)
!2391 = !DILocation(line: 59, column: 5, scope: !2379)
