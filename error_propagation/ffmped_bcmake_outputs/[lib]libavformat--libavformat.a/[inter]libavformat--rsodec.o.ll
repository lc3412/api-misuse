; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--rsodec.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--rsodec.o.i"
...
@ff_rso_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), %struct.AVCodecTag** getelementptr inbounds ([2 x %struct.AVCodecTag*], [2 x %struct.AVCodecTag*]* @.compoundliteral, i32 0, i32 0), %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 0, i32 (%struct.AVProbeData*)* null, i32 (%struct.AVFormatContext*)* @rso_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @ff_pcm_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* @ff_pcm_read_seek, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
...
define internal i32 @rso_read_header(%struct.AVFormatContext* %s) #0 !dbg !2140 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %id, metadata !2153, metadata !2147), !dbg !2154
  call void @llvm.dbg.declare(metadata i32* %rate, metadata !2155, metadata !2147), !dbg !2156
  call void @llvm.dbg.declare(metadata i32* %bps, metadata !2157, metadata !2147), !dbg !2158
  call void @llvm.dbg.declare(metadata i32* %size, metadata !2159, metadata !2147), !dbg !2160
  call void @llvm.dbg.declare(metadata i32* %codec, metadata !2161, metadata !2147), !dbg !2162
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2163, metadata !2147), !dbg !2164
  %2 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2165
  %call = call i32 @avio_rb16(%struct.AVIOContext* %2), !dbg !2166
  store i32 %call, i32* %id, align 4, !dbg !2167
  %3 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2168
  %call2 = call i32 @avio_rb16(%struct.AVIOContext* %3), !dbg !2169
  store i32 %call2, i32* %size, align 4, !dbg !2170
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2171
  %call3 = call i32 @avio_rb16(%struct.AVIOContext* %4), !dbg !2172
  store i32 %call3, i32* %rate, align 4, !dbg !2173
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2174
  %call4 = call i32 @avio_rb16(%struct.AVIOContext* %5), !dbg !2175
  %6 = load i32, i32* %id, align 4, !dbg !2176
  %call5 = call i32 @ff_codec_get_id(%struct.AVCodecTag* getelementptr inbounds ([0 x %struct.AVCodecTag], [0 x %struct.AVCodecTag]* @ff_codec_rso_tags, i32 0, i32 0), i32 %6), !dbg !2177
  store i32 %call5, i32* %codec, align 4, !dbg !2178
  %7 = load i32, i32* %codec, align 4, !dbg !2179
  %cmp = icmp eq i32 %7, 69633, !dbg !2181
  br i1 %cmp, label %if.then, label %if.end, !dbg !2182

if.then:                                          ; preds = %entry
  %8 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2183
  %9 = bitcast %struct.AVFormatContext* %8 to i8*, !dbg !2183
  call void (i8*, i8*, ...) @avpriv_report_missing_feature(i8* %9, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.2, i32 0, i32 0)), !dbg !2185
  store i32 -1163346256, i32* %retval, align 4, !dbg !2186
  br label %return, !dbg !2186

if.end:                                           ; preds = %entry
  %10 = load i32, i32* %codec, align 4, !dbg !2187
  %call6 = call i32 @av_get_bits_per_sample(i32 %10), !dbg !2188
  store i32 %call6, i32* %bps, align 4, !dbg !2189
  %11 = load i32, i32* %bps, align 4, !dbg !2190
  %tobool = icmp ne i32 %11, 0, !dbg !2190
  br i1 %tobool, label %if.end8, label %if.then7, !dbg !2192

if.then7:                                         ; preds = %if.end
  %12 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2193
  %13 = bitcast %struct.AVFormatContext* %12 to i8*, !dbg !2193
  call void (i8*, i8*, ...) @avpriv_request_sample(i8* %13, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.3, i32 0, i32 0)), !dbg !2195
  store i32 -1163346256, i32* %retval, align 4, !dbg !2196
  br label %return, !dbg !2196

if.end8:                                          ; preds = %if.end
  %14 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2197
  %call9 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %14, %struct.AVCodec* null), !dbg !2198
  store %struct.AVStream* %call9, %struct.AVStream** %st, align 8, !dbg !2199
  %15 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2200
  %tobool10 = icmp ne %struct.AVStream* %15, null, !dbg !2200
  br i1 %tobool10, label %if.end12, label %if.then11, !dbg !2202
...
if.end12:                                         ; preds = %if.end8
  %16 = load i32, i32* %size, align 4, !dbg !2204
  %mul = mul i32 %16, 8, !dbg !2205
  %17 = load i32, i32* %bps, align 4, !dbg !2206
  %div = udiv i32 %mul, %17, !dbg !2207
  %conv = zext i32 %div to i64, !dbg !2208
  %18 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2209
  %duration = getelementptr inbounds %struct.AVStream, %struct.AVStream* %18, i32 0, i32 6, !dbg !2210
  store i64 %conv, i64* %duration, align 8, !dbg !2211
  %19 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2212
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %19, i32 0, i32 19, !dbg !2213
  %20 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2213
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %20, i32 0, i32 0, !dbg !2214
  store i32 1, i32* %codec_type, align 8, !dbg !2215
  %21 = load i32, i32* %id, align 4, !dbg !2216
  %22 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2217
  %codecpar13 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %22, i32 0, i32 19, !dbg !2218
  %23 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar13, align 8, !dbg !2218
  %codec_tag = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %23, i32 0, i32 2, !dbg !2219
  store i32 %21, i32* %codec_tag, align 8, !dbg !2220
  %24 = load i32, i32* %codec, align 4, !dbg !2221
  %25 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2222
  %codecpar14 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %25, i32 0, i32 19, !dbg !2223
  %26 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar14, align 8, !dbg !2223
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %26, i32 0, i32 1, !dbg !2224
  store i32 %24, i32* %codec_id, align 4, !dbg !2225
  %27 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2226
  %codecpar15 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %27, i32 0, i32 19, !dbg !2227
  %28 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar15, align 8, !dbg !2227
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %28, i32 0, i32 22, !dbg !2228
  store i32 1, i32* %channels, align 8, !dbg !2229
  %29 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2230
  %codecpar16 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %29, i32 0, i32 19, !dbg !2231
  %30 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar16, align 8, !dbg !2231
  %channel_layout = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %30, i32 0, i32 21, !dbg !2232
  store i64 4, i64* %channel_layout, align 8, !dbg !2233
  %31 = load i32, i32* %rate, align 4, !dbg !2234
  %32 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2235
  %codecpar17 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %32, i32 0, i32 19, !dbg !2236
  %33 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar17, align 8, !dbg !2236
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %33, i32 0, i32 23, !dbg !2237
  store i32 %31, i32* %sample_rate, align 4, !dbg !2238
  %34 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2239
  %codecpar18 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %34, i32 0, i32 19, !dbg !2240
  %35 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar18, align 8, !dbg !2240
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %35, i32 0, i32 24, !dbg !2241
  store i32 1, i32* %block_align, align 8, !dbg !2242
  %36 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2243
  %37 = load i32, i32* %rate, align 4, !dbg !2244
  call void @avpriv_set_pts_info(%struct.AVStream* %36, i32 64, i32 1, i32 %37), !dbg !2245
  store i32 0, i32* %retval, align 4, !dbg !2246
  br label %return, !dbg !2246

return:                                           ; preds = %if.end12, %if.then11, %if.then7, %if.then
  %38 = load i32, i32* %retval, align 4, !dbg !2247
  ret i32 %38, !dbg !2247
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--rsodec.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!919 = !{!920}
!920 = distinct !DIGlobalVariable(name: "ff_rso_demuxer", scope: !0, file: !921, line: 75, type: !922, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_rso_demuxer)
!921 = !DIFile(filename: "libavformat/rsodec.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2140 = distinct !DISubprogram(name: "rso_read_header", scope: !921, file: !921, line: 30, type: !2141, isLocal: true, isDefinition: true, scopeLine: 31, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2145)
...
!2149 = !DILocalVariable(name: "pb", scope: !2140, file: !921, line: 32, type: !1215)
!2150 = !DILocation(line: 32, column: 18, scope: !2140)
!2151 = !DILocation(line: 32, column: 23, scope: !2140)
!2152 = !DILocation(line: 32, column: 26, scope: !2140)
!2153 = !DILocalVariable(name: "id", scope: !2140, file: !921, line: 33, type: !917)
!2154 = !DILocation(line: 33, column: 9, scope: !2140)
!2155 = !DILocalVariable(name: "rate", scope: !2140, file: !921, line: 33, type: !917)
!2156 = !DILocation(line: 33, column: 13, scope: !2140)
!2157 = !DILocalVariable(name: "bps", scope: !2140, file: !921, line: 33, type: !917)
!2158 = !DILocation(line: 33, column: 19, scope: !2140)
!2159 = !DILocalVariable(name: "size", scope: !2140, file: !921, line: 34, type: !918)
!2160 = !DILocation(line: 34, column: 18, scope: !2140)
!2161 = !DILocalVariable(name: "codec", scope: !2140, file: !921, line: 35, type: !3)
!2162 = !DILocation(line: 35, column: 20, scope: !2140)
!2163 = !DILocalVariable(name: "st", scope: !2140, file: !921, line: 36, type: !1283)
!2164 = !DILocation(line: 36, column: 15, scope: !2140)
!2165 = !DILocation(line: 38, column: 20, scope: !2140)
!2166 = !DILocation(line: 38, column: 10, scope: !2140)
!2167 = !DILocation(line: 38, column: 8, scope: !2140)
!2168 = !DILocation(line: 39, column: 22, scope: !2140)
!2169 = !DILocation(line: 39, column: 12, scope: !2140)
!2170 = !DILocation(line: 39, column: 10, scope: !2140)
!2171 = !DILocation(line: 40, column: 22, scope: !2140)
!2172 = !DILocation(line: 40, column: 12, scope: !2140)
!2173 = !DILocation(line: 40, column: 10, scope: !2140)
!2174 = !DILocation(line: 41, column: 15, scope: !2140)
!2175 = !DILocation(line: 41, column: 5, scope: !2140)
!2176 = !DILocation(line: 43, column: 48, scope: !2140)
!2177 = !DILocation(line: 43, column: 13, scope: !2140)
!2178 = !DILocation(line: 43, column: 11, scope: !2140)
!2179 = !DILocation(line: 45, column: 9, scope: !2180)
!2180 = distinct !DILexicalBlock(scope: !2140, file: !921, line: 45, column: 9)
!2181 = !DILocation(line: 45, column: 15, scope: !2180)
!2182 = !DILocation(line: 45, column: 9, scope: !2140)
!2183 = !DILocation(line: 46, column: 39, scope: !2184)
!2184 = distinct !DILexicalBlock(scope: !2180, file: !921, line: 45, column: 45)
!2185 = !DILocation(line: 46, column: 9, scope: !2184)
!2186 = !DILocation(line: 47, column: 9, scope: !2184)
!2187 = !DILocation(line: 50, column: 34, scope: !2140)
!2188 = !DILocation(line: 50, column: 11, scope: !2140)
!2189 = !DILocation(line: 50, column: 9, scope: !2140)
!2190 = !DILocation(line: 51, column: 10, scope: !2191)
!2191 = distinct !DILexicalBlock(scope: !2140, file: !921, line: 51, column: 9)
!2192 = !DILocation(line: 51, column: 9, scope: !2140)
!2193 = !DILocation(line: 52, column: 31, scope: !2194)
!2194 = distinct !DILexicalBlock(scope: !2191, file: !921, line: 51, column: 15)
!2195 = !DILocation(line: 52, column: 9, scope: !2194)
!2196 = !DILocation(line: 53, column: 9, scope: !2194)
!2197 = !DILocation(line: 57, column: 30, scope: !2140)
!2198 = !DILocation(line: 57, column: 10, scope: !2140)
!2199 = !DILocation(line: 57, column: 8, scope: !2140)
!2200 = !DILocation(line: 58, column: 10, scope: !2201)
!2201 = distinct !DILexicalBlock(scope: !2140, file: !921, line: 58, column: 9)
!2202 = !DILocation(line: 58, column: 9, scope: !2140)
!2203 = !DILocation(line: 59, column: 9, scope: !2201)
!2204 = !DILocation(line: 61, column: 21, scope: !2140)
!2205 = !DILocation(line: 61, column: 26, scope: !2140)
!2206 = !DILocation(line: 61, column: 33, scope: !2140)
!2207 = !DILocation(line: 61, column: 31, scope: !2140)
!2208 = !DILocation(line: 61, column: 20, scope: !2140)
!2209 = !DILocation(line: 61, column: 5, scope: !2140)
!2210 = !DILocation(line: 61, column: 9, scope: !2140)
!2211 = !DILocation(line: 61, column: 18, scope: !2140)
!2212 = !DILocation(line: 62, column: 5, scope: !2140)
!2213 = !DILocation(line: 62, column: 9, scope: !2140)
!2214 = !DILocation(line: 62, column: 19, scope: !2140)
!2215 = !DILocation(line: 62, column: 30, scope: !2140)
!2216 = !DILocation(line: 63, column: 31, scope: !2140)
!2217 = !DILocation(line: 63, column: 5, scope: !2140)
!2218 = !DILocation(line: 63, column: 9, scope: !2140)
!2219 = !DILocation(line: 63, column: 19, scope: !2140)
!2220 = !DILocation(line: 63, column: 29, scope: !2140)
!2221 = !DILocation(line: 64, column: 30, scope: !2140)
!2222 = !DILocation(line: 64, column: 5, scope: !2140)
!2223 = !DILocation(line: 64, column: 9, scope: !2140)
!2224 = !DILocation(line: 64, column: 19, scope: !2140)
!2225 = !DILocation(line: 64, column: 28, scope: !2140)
!2226 = !DILocation(line: 65, column: 5, scope: !2140)
!2227 = !DILocation(line: 65, column: 9, scope: !2140)
!2228 = !DILocation(line: 65, column: 19, scope: !2140)
!2229 = !DILocation(line: 65, column: 28, scope: !2140)
!2230 = !DILocation(line: 66, column: 5, scope: !2140)
!2231 = !DILocation(line: 66, column: 9, scope: !2140)
!2232 = !DILocation(line: 66, column: 19, scope: !2140)
!2233 = !DILocation(line: 66, column: 34, scope: !2140)
!2234 = !DILocation(line: 67, column: 33, scope: !2140)
!2235 = !DILocation(line: 67, column: 5, scope: !2140)
!2236 = !DILocation(line: 67, column: 9, scope: !2140)
!2237 = !DILocation(line: 67, column: 19, scope: !2140)
!2238 = !DILocation(line: 67, column: 31, scope: !2140)
!2239 = !DILocation(line: 68, column: 5, scope: !2140)
!2240 = !DILocation(line: 68, column: 9, scope: !2140)
!2241 = !DILocation(line: 68, column: 19, scope: !2140)
!2242 = !DILocation(line: 68, column: 31, scope: !2140)
!2243 = !DILocation(line: 70, column: 25, scope: !2140)
!2244 = !DILocation(line: 70, column: 36, scope: !2140)
!2245 = !DILocation(line: 70, column: 5, scope: !2140)
!2246 = !DILocation(line: 72, column: 5, scope: !2140)
!2247 = !DILocation(line: 73, column: 1, scope: !2140)
