; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--ivfdec.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--ivfdec.o.i"
...
@.compoundliteral = internal constant [2 x %struct.AVCodecTag*] [%struct.AVCodecTag* getelementptr inbounds ([0 x %struct.AVCodecTag], [0 x %struct.AVCodecTag]* @ff_codec_bmp_tags, i32 0, i32 0), %struct.AVCodecTag* null], align 8
...
entry:
  ...
  %cmp = icmp eq i32 %3, 1179208516, !dbg !2160
...
land.lhs.true:                                    ; preds = %entry
  ...
  %buf1 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %4, i32 0, i32 1, !dbg !2164
  %5 = load i8*, i8** %buf1, align 8, !dbg !2164
  %add.ptr = getelementptr inbounds i8, i8* %5, i64 4, !dbg !2165
  %6 = bitcast i8* %add.ptr to %union.unaligned_16*, !dbg !2166
  %l2 = bitcast %union.unaligned_16* %6 to i16*, !dbg !2166
  %7 = load i16, i16* %l2, align 1, !dbg !2166
  %tobool = icmp ne i16 %7, 0, !dbg !2167
  br i1 %tobool, label %if.end, label %land.lhs.true3, !dbg !2168

land.lhs.true3:                                   ; preds = %land.lhs.true
  %8 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2169
  %buf4 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %8, i32 0, i32 1, !dbg !2171
  %9 = load i8*, i8** %buf4, align 8, !dbg !2171
  %add.ptr5 = getelementptr inbounds i8, i8* %9, i64 6, !dbg !2172
  %10 = bitcast i8* %add.ptr5 to %union.unaligned_16*, !dbg !2173
  %l6 = bitcast %union.unaligned_16* %10 to i16*, !dbg !2173
  %11 = load i16, i16* %l6, align 1, !dbg !2173
  %conv = zext i16 %11 to i32, !dbg !2174
  %cmp7 = icmp eq i32 %conv, 32, !dbg !2175
  br i1 %cmp7, label %if.then, label %if.end, !dbg !2176

if.then:                                          ; preds = %land.lhs.true3
  store i32 98, i32* %retval, align 4, !dbg !2178
...
return:                                           ; preds = %if.end, %if.then
  %12 = load i32, i32* %retval, align 4, !dbg !2180
  ret i32 %12, !dbg !2180
}

; Function Attrs: nounwind uwtable
define internal i32 @read_header(%struct.AVFormatContext* %s) #0 !dbg !2181 {
entry:
  %retval = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2186, metadata !2154), !dbg !2187
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2188, metadata !2154), !dbg !2189
  call void @llvm.dbg.declare(metadata %struct.AVRational* %time_base, metadata !2190, metadata !2154), !dbg !2191
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2192
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2193
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2193
  %call = call i32 @avio_rl32(%struct.AVIOContext* %1), !dbg !2194
  %2 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2195
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %2, i32 0, i32 4, !dbg !2196
  %3 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2196
  %call2 = call i32 @avio_rl16(%struct.AVIOContext* %3), !dbg !2197
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2198
  %pb3 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %4, i32 0, i32 4, !dbg !2199
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb3, align 8, !dbg !2199
  %call4 = call i32 @avio_rl16(%struct.AVIOContext* %5), !dbg !2200
  %6 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2201
  %call5 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %6, %struct.AVCodec* null), !dbg !2202
  store %struct.AVStream* %call5, %struct.AVStream** %st, align 8, !dbg !2203
  %7 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2204
  %tobool = icmp ne %struct.AVStream* %7, null, !dbg !2204
...
if.end:                                           ; preds = %entry
  %8 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2208
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %8, i32 0, i32 19, !dbg !2209
  %9 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2209
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %9, i32 0, i32 0, !dbg !2210
  store i32 0, i32* %codec_type, align 8, !dbg !2211
  %10 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2212
  %pb6 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %10, i32 0, i32 4, !dbg !2213
  %11 = load %struct.AVIOContext*, %struct.AVIOContext** %pb6, align 8, !dbg !2213
  %call7 = call i32 @avio_rl32(%struct.AVIOContext* %11), !dbg !2214
  %12 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2215
  %codecpar8 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %12, i32 0, i32 19, !dbg !2216
  %13 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar8, align 8, !dbg !2216
  %codec_tag = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %13, i32 0, i32 2, !dbg !2217
  store i32 %call7, i32* %codec_tag, align 8, !dbg !2218
  %14 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2219
  %codecpar9 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %14, i32 0, i32 19, !dbg !2220
  %15 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar9, align 8, !dbg !2220
  %codec_tag10 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %15, i32 0, i32 2, !dbg !2221
  %16 = load i32, i32* %codec_tag10, align 8, !dbg !2221
  %call11 = call i32 @ff_codec_get_id(%struct.AVCodecTag* getelementptr inbounds ([0 x %struct.AVCodecTag], [0 x %struct.AVCodecTag]* @ff_codec_bmp_tags, i32 0, i32 0), i32 %16), !dbg !2222
  %17 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2223
  %codecpar12 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %17, i32 0, i32 19, !dbg !2224
  %18 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar12, align 8, !dbg !2224
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %18, i32 0, i32 1, !dbg !2225
  store i32 %call11, i32* %codec_id, align 4, !dbg !2226
  %19 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2227
  %pb13 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %19, i32 0, i32 4, !dbg !2228
  %20 = load %struct.AVIOContext*, %struct.AVIOContext** %pb13, align 8, !dbg !2228
  %call14 = call i32 @avio_rl16(%struct.AVIOContext* %20), !dbg !2229
  %21 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2230
  %codecpar15 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %21, i32 0, i32 19, !dbg !2231
  %22 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar15, align 8, !dbg !2231
  %width = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %22, i32 0, i32 11, !dbg !2232
  store i32 %call14, i32* %width, align 8, !dbg !2233
  %23 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2234
  %pb16 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %23, i32 0, i32 4, !dbg !2235
  %24 = load %struct.AVIOContext*, %struct.AVIOContext** %pb16, align 8, !dbg !2235
  %call17 = call i32 @avio_rl16(%struct.AVIOContext* %24), !dbg !2236
  %25 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2237
  %codecpar18 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %25, i32 0, i32 19, !dbg !2238
  %26 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar18, align 8, !dbg !2238
  %height = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %26, i32 0, i32 12, !dbg !2239
  store i32 %call17, i32* %height, align 4, !dbg !2240
  %27 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2241
  %pb19 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %27, i32 0, i32 4, !dbg !2242
  %28 = load %struct.AVIOContext*, %struct.AVIOContext** %pb19, align 8, !dbg !2242
  %call20 = call i32 @avio_rl32(%struct.AVIOContext* %28), !dbg !2243
  %den = getelementptr inbounds %struct.AVRational, %struct.AVRational* %time_base, i32 0, i32 1, !dbg !2244
  store i32 %call20, i32* %den, align 4, !dbg !2245
  %29 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2246
  %pb21 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %29, i32 0, i32 4, !dbg !2247
  %30 = load %struct.AVIOContext*, %struct.AVIOContext** %pb21, align 8, !dbg !2247
  %call22 = call i32 @avio_rl32(%struct.AVIOContext* %30), !dbg !2248
  %num = getelementptr inbounds %struct.AVRational, %struct.AVRational* %time_base, i32 0, i32 0, !dbg !2249
  store i32 %call22, i32* %num, align 4, !dbg !2250
  %31 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2251
  %pb23 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %31, i32 0, i32 4, !dbg !2252
  %32 = load %struct.AVIOContext*, %struct.AVIOContext** %pb23, align 8, !dbg !2252
  %call24 = call i64 @avio_rl64(%struct.AVIOContext* %32), !dbg !2253
  %33 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2254
  %duration = getelementptr inbounds %struct.AVStream, %struct.AVStream* %33, i32 0, i32 6, !dbg !2255
  store i64 %call24, i64* %duration, align 8, !dbg !2256
  %34 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2257
  %need_parsing = getelementptr inbounds %struct.AVStream, %struct.AVStream* %34, i32 0, i32 28, !dbg !2258
  store i32 2, i32* %need_parsing, align 4, !dbg !2259
  %den25 = getelementptr inbounds %struct.AVRational, %struct.AVRational* %time_base, i32 0, i32 1, !dbg !2260
  %35 = load i32, i32* %den25, align 4, !dbg !2260
  %tobool26 = icmp ne i32 %35, 0, !dbg !2262
  br i1 %tobool26, label %lor.lhs.false, label %if.then29, !dbg !2263

lor.lhs.false:                                    ; preds = %if.end
  %num27 = getelementptr inbounds %struct.AVRational, %struct.AVRational* %time_base, i32 0, i32 0, !dbg !2264
  %36 = load i32, i32* %num27, align 4, !dbg !2264
  %tobool28 = icmp ne i32 %36, 0, !dbg !2266
  br i1 %tobool28, label %if.end30, label %if.then29, !dbg !2267

if.then29:                                        ; preds = %lor.lhs.false, %if.end
  %37 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2268
  %38 = bitcast %struct.AVFormatContext* %37 to i8*, !dbg !2268
  call void (i8*, i32, i8*, ...) @av_log(i8* %38, i32 16, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.2, i32 0, i32 0)), !dbg !2270
  store i32 -1094995529, i32* %retval, align 4, !dbg !2271
  br label %return, !dbg !2271

if.end30:                                         ; preds = %lor.lhs.false
  %39 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2272
  %num31 = getelementptr inbounds %struct.AVRational, %struct.AVRational* %time_base, i32 0, i32 0, !dbg !2273
  %40 = load i32, i32* %num31, align 4, !dbg !2273
  %den32 = getelementptr inbounds %struct.AVRational, %struct.AVRational* %time_base, i32 0, i32 1, !dbg !2274
  %41 = load i32, i32* %den32, align 4, !dbg !2274
  call void @avpriv_set_pts_info(%struct.AVStream* %39, i32 64, i32 %40, i32 %41), !dbg !2275
  store i32 0, i32* %retval, align 4, !dbg !2276
  br label %return, !dbg !2276

return:                                           ; preds = %if.end30, %if.then29, %if.then
  %42 = load i32, i32* %retval, align 4, !dbg !2277
  ret i32 %42, !dbg !2277
}

; Function Attrs: nounwind uwtable
define internal i32 @read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2278 {
entry:
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2281, metadata !2154), !dbg !2282
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2283, metadata !2154), !dbg !2284
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2285, metadata !2154), !dbg !2286
  call void @llvm.dbg.declare(metadata i32* %size, metadata !2287, metadata !2154), !dbg !2288
  ...
  %call = call i32 @avio_rl32(%struct.AVIOContext* %1), !dbg !2291
  store i32 %call, i32* %size, align 4, !dbg !2288
  call void @llvm.dbg.declare(metadata i64* %pts, metadata !2292, metadata !2154), !dbg !2293
  %2 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2294
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %2, i32 0, i32 4, !dbg !2295
  %3 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2295
  %call2 = call i64 @avio_rl64(%struct.AVIOContext* %3), !dbg !2296
  store i64 %call2, i64* %pts, align 8, !dbg !2293
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2297
  %pb3 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %4, i32 0, i32 4, !dbg !2298
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb3, align 8, !dbg !2298
  %6 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2299
  %7 = load i32, i32* %size, align 4, !dbg !2300
  %call4 = call i32 @av_get_packet(%struct.AVIOContext* %5, %struct.AVPacket* %6, i32 %7), !dbg !2301
  store i32 %call4, i32* %ret, align 4, !dbg !2302
  %8 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2303
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %8, i32 0, i32 5, !dbg !2304
  store i32 0, i32* %stream_index, align 4, !dbg !2305
  %9 = load i64, i64* %pts, align 8, !dbg !2306
  %10 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2307
  %pts5 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %10, i32 0, i32 1, !dbg !2308
  store i64 %9, i64* %pts5, align 8, !dbg !2309
  %11 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2310
  %pos = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %11, i32 0, i32 10, !dbg !2311
  %12 = load i64, i64* %pos, align 8, !dbg !2312
  %sub = sub nsw i64 %12, 12, !dbg !2312
  store i64 %sub, i64* %pos, align 8, !dbg !2312
  %13 = load i32, i32* %ret, align 4, !dbg !2313
  ret i32 %13, !dbg !2314
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--ivfdec.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!934 = !{!935}
!935 = distinct !DIGlobalVariable(name: "ff_ivf_demuxer", scope: !0, file: !936, line: 83, type: !937, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_ivf_demuxer)
!936 = !DIFile(filename: "libavformat/ivfdec.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2151 = distinct !DISubprogram(name: "probe", scope: !936, file: !936, line: 26, type: !1006, isLocal: true, isDefinition: true, scopeLine: 27, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2152 = !{}
!2153 = !DILocalVariable(name: "p", arg: 1, scope: !2151, file: !936, line: 26, type: !1008)
!2154 = !DIExpression()
!2155 = !DILocation(line: 26, column: 31, scope: !2151)
!2156 = !DILocation(line: 28, column: 41, scope: !2157)
!2157 = distinct !DILexicalBlock(scope: !2151, file: !936, line: 28, column: 9)
!2158 = !DILocation(line: 28, column: 44, scope: !2157)
!2159 = !DILocation(line: 28, column: 51, scope: !2157)
!2160 = !DILocation(line: 28, column: 54, scope: !2157)
!2161 = !DILocation(line: 29, column: 9, scope: !2157)
!2162 = !DILocation(line: 29, column: 45, scope: !2163)
!2163 = !DILexicalBlockFile(scope: !2157, file: !936, discriminator: 1)
!2164 = !DILocation(line: 29, column: 48, scope: !2163)
!2165 = !DILocation(line: 29, column: 51, scope: !2163)
!2166 = !DILocation(line: 29, column: 57, scope: !2163)
!2167 = !DILocation(line: 29, column: 13, scope: !2163)
!2168 = !DILocation(line: 29, column: 60, scope: !2163)
!2169 = !DILocation(line: 29, column: 95, scope: !2170)
!2170 = !DILexicalBlockFile(scope: !2157, file: !936, discriminator: 2)
!2171 = !DILocation(line: 29, column: 98, scope: !2170)
!2172 = !DILocation(line: 29, column: 101, scope: !2170)
!2173 = !DILocation(line: 29, column: 107, scope: !2170)
!2174 = !DILocation(line: 29, column: 63, scope: !2170)
!2175 = !DILocation(line: 29, column: 110, scope: !2170)
!2176 = !DILocation(line: 28, column: 9, scope: !2177)
!2177 = !DILexicalBlockFile(scope: !2151, file: !936, discriminator: 1)
!2178 = !DILocation(line: 30, column: 9, scope: !2157)
!2179 = !DILocation(line: 32, column: 5, scope: !2151)
!2180 = !DILocation(line: 33, column: 1, scope: !2151)
!2181 = distinct !DISubprogram(name: "read_header", scope: !936, file: !936, line: 35, type: !2182, isLocal: true, isDefinition: true, scopeLine: 36, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2182 = !DISubroutineType(types: !2183)
!2183 = !{!933, !2184}
!2184 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2185, size: 64, align: 64)
!2185 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1023)
!2186 = !DILocalVariable(name: "s", arg: 1, scope: !2181, file: !936, line: 35, type: !2184)
!2187 = !DILocation(line: 35, column: 41, scope: !2181)
!2188 = !DILocalVariable(name: "st", scope: !2181, file: !936, line: 37, type: !1297)
!2189 = !DILocation(line: 37, column: 15, scope: !2181)
!2190 = !DILocalVariable(name: "time_base", scope: !2181, file: !936, line: 38, type: !1131)
!2191 = !DILocation(line: 38, column: 16, scope: !2181)
!2192 = !DILocation(line: 40, column: 15, scope: !2181)
!2193 = !DILocation(line: 40, column: 18, scope: !2181)
!2194 = !DILocation(line: 40, column: 5, scope: !2181)
!2195 = !DILocation(line: 41, column: 15, scope: !2181)
!2196 = !DILocation(line: 41, column: 18, scope: !2181)
!2197 = !DILocation(line: 41, column: 5, scope: !2181)
!2198 = !DILocation(line: 42, column: 15, scope: !2181)
!2199 = !DILocation(line: 42, column: 18, scope: !2181)
!2200 = !DILocation(line: 42, column: 5, scope: !2181)
!2201 = !DILocation(line: 44, column: 30, scope: !2181)
!2202 = !DILocation(line: 44, column: 10, scope: !2181)
!2203 = !DILocation(line: 44, column: 8, scope: !2181)
!2204 = !DILocation(line: 45, column: 10, scope: !2205)
!2205 = distinct !DILexicalBlock(scope: !2181, file: !936, line: 45, column: 9)
!2206 = !DILocation(line: 45, column: 9, scope: !2181)
!2207 = !DILocation(line: 46, column: 9, scope: !2205)
!2208 = !DILocation(line: 49, column: 5, scope: !2181)
!2209 = !DILocation(line: 49, column: 9, scope: !2181)
!2210 = !DILocation(line: 49, column: 19, scope: !2181)
!2211 = !DILocation(line: 49, column: 30, scope: !2181)
!2212 = !DILocation(line: 50, column: 41, scope: !2181)
!2213 = !DILocation(line: 50, column: 44, scope: !2181)
!2214 = !DILocation(line: 50, column: 31, scope: !2181)
!2215 = !DILocation(line: 50, column: 5, scope: !2181)
!2216 = !DILocation(line: 50, column: 9, scope: !2181)
!2217 = !DILocation(line: 50, column: 19, scope: !2181)
!2218 = !DILocation(line: 50, column: 29, scope: !2181)
!2219 = !DILocation(line: 51, column: 65, scope: !2181)
!2220 = !DILocation(line: 51, column: 69, scope: !2181)
!2221 = !DILocation(line: 51, column: 79, scope: !2181)
!2222 = !DILocation(line: 51, column: 30, scope: !2181)
!2223 = !DILocation(line: 51, column: 5, scope: !2181)
!2224 = !DILocation(line: 51, column: 9, scope: !2181)
!2225 = !DILocation(line: 51, column: 19, scope: !2181)
!2226 = !DILocation(line: 51, column: 28, scope: !2181)
!2227 = !DILocation(line: 52, column: 37, scope: !2181)
!2228 = !DILocation(line: 52, column: 40, scope: !2181)
!2229 = !DILocation(line: 52, column: 27, scope: !2181)
!2230 = !DILocation(line: 52, column: 5, scope: !2181)
!2231 = !DILocation(line: 52, column: 9, scope: !2181)
!2232 = !DILocation(line: 52, column: 19, scope: !2181)
!2233 = !DILocation(line: 52, column: 25, scope: !2181)
!2234 = !DILocation(line: 53, column: 38, scope: !2181)
!2235 = !DILocation(line: 53, column: 41, scope: !2181)
!2236 = !DILocation(line: 53, column: 28, scope: !2181)
!2237 = !DILocation(line: 53, column: 5, scope: !2181)
!2238 = !DILocation(line: 53, column: 9, scope: !2181)
!2239 = !DILocation(line: 53, column: 19, scope: !2181)
!2240 = !DILocation(line: 53, column: 26, scope: !2181)
!2241 = !DILocation(line: 54, column: 31, scope: !2181)
!2242 = !DILocation(line: 54, column: 34, scope: !2181)
!2243 = !DILocation(line: 54, column: 21, scope: !2181)
!2244 = !DILocation(line: 54, column: 15, scope: !2181)
!2245 = !DILocation(line: 54, column: 19, scope: !2181)
!2246 = !DILocation(line: 55, column: 31, scope: !2181)
!2247 = !DILocation(line: 55, column: 34, scope: !2181)
!2248 = !DILocation(line: 55, column: 21, scope: !2181)
!2249 = !DILocation(line: 55, column: 15, scope: !2181)
!2250 = !DILocation(line: 55, column: 19, scope: !2181)
!2251 = !DILocation(line: 56, column: 30, scope: !2181)
!2252 = !DILocation(line: 56, column: 33, scope: !2181)
!2253 = !DILocation(line: 56, column: 20, scope: !2181)
!2254 = !DILocation(line: 56, column: 5, scope: !2181)
!2255 = !DILocation(line: 56, column: 9, scope: !2181)
!2256 = !DILocation(line: 56, column: 18, scope: !2181)
!2257 = !DILocation(line: 58, column: 5, scope: !2181)
!2258 = !DILocation(line: 58, column: 9, scope: !2181)
!2259 = !DILocation(line: 58, column: 22, scope: !2181)
!2260 = !DILocation(line: 60, column: 20, scope: !2261)
!2261 = distinct !DILexicalBlock(scope: !2181, file: !936, line: 60, column: 9)
!2262 = !DILocation(line: 60, column: 10, scope: !2261)
!2263 = !DILocation(line: 60, column: 24, scope: !2261)
!2264 = !DILocation(line: 60, column: 38, scope: !2265)
!2265 = !DILexicalBlockFile(scope: !2261, file: !936, discriminator: 1)
!2266 = !DILocation(line: 60, column: 28, scope: !2265)
!2267 = !DILocation(line: 60, column: 9, scope: !2265)
!2268 = !DILocation(line: 61, column: 16, scope: !2269)
!2269 = distinct !DILexicalBlock(scope: !2261, file: !936, line: 60, column: 43)
!2270 = !DILocation(line: 61, column: 9, scope: !2269)
!2271 = !DILocation(line: 62, column: 9, scope: !2269)
!2272 = !DILocation(line: 65, column: 25, scope: !2181)
!2273 = !DILocation(line: 65, column: 43, scope: !2181)
!2274 = !DILocation(line: 65, column: 58, scope: !2181)
!2275 = !DILocation(line: 65, column: 5, scope: !2181)
!2276 = !DILocation(line: 67, column: 5, scope: !2181)
!2277 = !DILocation(line: 68, column: 1, scope: !2181)
!2278 = distinct !DISubprogram(name: "read_packet", scope: !936, file: !936, line: 70, type: !2279, isLocal: true, isDefinition: true, scopeLine: 71, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2279 = !DISubroutineType(types: !2280)
!2280 = !{!933, !2184, !1048}
!2281 = !DILocalVariable(name: "s", arg: 1, scope: !2278, file: !936, line: 70, type: !2184)
!2282 = !DILocation(line: 70, column: 41, scope: !2278)
!2283 = !DILocalVariable(name: "pkt", arg: 2, scope: !2278, file: !936, line: 70, type: !1048)
!2284 = !DILocation(line: 70, column: 54, scope: !2278)
!2285 = !DILocalVariable(name: "ret", scope: !2278, file: !936, line: 72, type: !933)
!2286 = !DILocation(line: 72, column: 9, scope: !2278)
!2287 = !DILocalVariable(name: "size", scope: !2278, file: !936, line: 72, type: !933)
!2288 = !DILocation(line: 72, column: 14, scope: !2278)
!2289 = !DILocation(line: 72, column: 31, scope: !2278)
!2290 = !DILocation(line: 72, column: 34, scope: !2278)
!2291 = !DILocation(line: 72, column: 21, scope: !2278)
!2292 = !DILocalVariable(name: "pts", scope: !2278, file: !936, line: 73, type: !1067)
!2293 = !DILocation(line: 73, column: 13, scope: !2278)
!2294 = !DILocation(line: 73, column: 29, scope: !2278)
!2295 = !DILocation(line: 73, column: 32, scope: !2278)
!2296 = !DILocation(line: 73, column: 19, scope: !2278)
!2297 = !DILocation(line: 75, column: 25, scope: !2278)
!2298 = !DILocation(line: 75, column: 28, scope: !2278)
!2299 = !DILocation(line: 75, column: 32, scope: !2278)
!2300 = !DILocation(line: 75, column: 37, scope: !2278)
!2301 = !DILocation(line: 75, column: 11, scope: !2278)
!2302 = !DILocation(line: 75, column: 9, scope: !2278)
!2303 = !DILocation(line: 76, column: 5, scope: !2278)
!2304 = !DILocation(line: 76, column: 10, scope: !2278)
!2305 = !DILocation(line: 76, column: 23, scope: !2278)
!2306 = !DILocation(line: 77, column: 16, scope: !2278)
!2307 = !DILocation(line: 77, column: 5, scope: !2278)
!2308 = !DILocation(line: 77, column: 10, scope: !2278)
!2309 = !DILocation(line: 77, column: 14, scope: !2278)
!2310 = !DILocation(line: 78, column: 5, scope: !2278)
!2311 = !DILocation(line: 78, column: 10, scope: !2278)
!2312 = !DILocation(line: 78, column: 14, scope: !2278)
!2313 = !DILocation(line: 80, column: 12, scope: !2278)
!2314 = !DILocation(line: 80, column: 5, scope: !2278)
