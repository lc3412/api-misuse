; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--vag.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--vag.o.i"
...
@ff_vag_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 0, i32 (%struct.AVProbeData*)* @vag_probe, i32 (%struct.AVFormatContext*)* @vag_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @vag_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
@.str.2 = private unnamed_addr constant [8 x i8] c"VAGp\00\00\00\00", align 1

; Function Attrs: nounwind uwtable
define internal i32 @vag_probe(%struct.AVProbeData* %p) #0 !dbg !2140 {
entry:
  ...
  %call = call i32 @memcmp(i8* %1, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i32 0, i32 0), i64 7) #4, !dbg !2148
...
; Function Attrs: nounwind uwtable
define internal i32 @vag_read_header(%struct.AVFormatContext* %s) #0 !dbg !2153 {
entry:
  %retval = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2160, metadata !2143), !dbg !2161
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2162
  %call = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %0, %struct.AVCodec* null), !dbg !2163
  store %struct.AVStream* %call, %struct.AVStream** %st, align 8, !dbg !2164
  %1 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2165
  %tobool = icmp ne %struct.AVStream* %1, null, !dbg !2165
...
if.end:                                           ; preds = %entry
  %2 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2169
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %2, i32 0, i32 4, !dbg !2170
  %3 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2170
  %call1 = call i64 @avio_skip(%struct.AVIOContext* %3, i64 4), !dbg !2171
  %4 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2172
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %4, i32 0, i32 19, !dbg !2173
  %5 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2173
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %5, i32 0, i32 0, !dbg !2174
  store i32 1, i32* %codec_type, align 8, !dbg !2175
  %6 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2176
  %codecpar2 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %6, i32 0, i32 19, !dbg !2177
  %7 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar2, align 8, !dbg !2177
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %7, i32 0, i32 1, !dbg !2178
  store i32 71686, i32* %codec_id, align 4, !dbg !2179
  %8 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2180
  %pb3 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %8, i32 0, i32 4, !dbg !2181
  %9 = load %struct.AVIOContext*, %struct.AVIOContext** %pb3, align 8, !dbg !2181
  %call4 = call i32 @avio_rb32(%struct.AVIOContext* %9), !dbg !2182
  %cmp = icmp eq i32 %call4, 4, !dbg !2183
  %conv = zext i1 %cmp to i32, !dbg !2183
  %add = add nsw i32 1, %conv, !dbg !2184
  %10 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2185
  %codecpar5 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %10, i32 0, i32 19, !dbg !2186
  %11 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar5, align 8, !dbg !2186
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %11, i32 0, i32 22, !dbg !2187
  store i32 %add, i32* %channels, align 8, !dbg !2188
  %12 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2189
  %pb6 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %12, i32 0, i32 4, !dbg !2190
  %13 = load %struct.AVIOContext*, %struct.AVIOContext** %pb6, align 8, !dbg !2190
  %call7 = call i64 @avio_skip(%struct.AVIOContext* %13, i64 4), !dbg !2191
  %14 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2192
  %codecpar8 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %14, i32 0, i32 19, !dbg !2194
  %15 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar8, align 8, !dbg !2194
  %channels9 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %15, i32 0, i32 22, !dbg !2195
  %16 = load i32, i32* %channels9, align 8, !dbg !2195
  %cmp10 = icmp sgt i32 %16, 1, !dbg !2196
  br i1 %cmp10, label %if.then12, label %if.else, !dbg !2197

if.then12:                                        ; preds = %if.end
  %17 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2198
  %pb13 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %17, i32 0, i32 4, !dbg !2200
  %18 = load %struct.AVIOContext*, %struct.AVIOContext** %pb13, align 8, !dbg !2200
  %call14 = call i32 @avio_rb32(%struct.AVIOContext* %18), !dbg !2201
  %conv15 = zext i32 %call14 to i64, !dbg !2201
  %19 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2202
  %duration = getelementptr inbounds %struct.AVStream, %struct.AVStream* %19, i32 0, i32 6, !dbg !2203
  store i64 %conv15, i64* %duration, align 8, !dbg !2204
  br label %if.end20, !dbg !2205

if.else:                                          ; preds = %if.end
  %20 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2206
  %pb16 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %20, i32 0, i32 4, !dbg !2208
  %21 = load %struct.AVIOContext*, %struct.AVIOContext** %pb16, align 8, !dbg !2208
  %call17 = call i32 @avio_rb32(%struct.AVIOContext* %21), !dbg !2209
  %div = udiv i32 %call17, 16, !dbg !2210
  %mul = mul i32 %div, 28, !dbg !2211
  %conv18 = zext i32 %mul to i64, !dbg !2209
  %22 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2212
  %duration19 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %22, i32 0, i32 6, !dbg !2213
  store i64 %conv18, i64* %duration19, align 8, !dbg !2214
  br label %if.end20

if.end20:                                         ; preds = %if.else, %if.then12
  %23 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2215
  %pb21 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %23, i32 0, i32 4, !dbg !2216
  %24 = load %struct.AVIOContext*, %struct.AVIOContext** %pb21, align 8, !dbg !2216
  %call22 = call i32 @avio_rb32(%struct.AVIOContext* %24), !dbg !2217
  %25 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2218
  %codecpar23 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %25, i32 0, i32 19, !dbg !2219
  %26 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar23, align 8, !dbg !2219
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %26, i32 0, i32 23, !dbg !2220
  store i32 %call22, i32* %sample_rate, align 4, !dbg !2221
  %27 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2222
  %codecpar24 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %27, i32 0, i32 19, !dbg !2224
  %28 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar24, align 8, !dbg !2224
  %sample_rate25 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %28, i32 0, i32 23, !dbg !2225
  %29 = load i32, i32* %sample_rate25, align 4, !dbg !2225
  %cmp26 = icmp sle i32 %29, 0, !dbg !2226
  br i1 %cmp26, label %if.then28, label %if.end29, !dbg !2227
...
if.end29:                                         ; preds = %if.end20
  %30 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2229
  %pb30 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %30, i32 0, i32 4, !dbg !2230
  %31 = load %struct.AVIOContext*, %struct.AVIOContext** %pb30, align 8, !dbg !2230
  %call31 = call i64 @avio_seek(%struct.AVIOContext* %31, i64 4096, i32 0), !dbg !2231
  %32 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2232
  %pb32 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %32, i32 0, i32 4, !dbg !2234
  %33 = load %struct.AVIOContext*, %struct.AVIOContext** %pb32, align 8, !dbg !2234
  %call33 = call i32 @avio_rl32(%struct.AVIOContext* %33), !dbg !2235
  %cmp34 = icmp eq i32 %call33, 1883717974, !dbg !2236
  br i1 %cmp34, label %if.then36, label %if.else47, !dbg !2237

if.then36:                                        ; preds = %if.end29
  %34 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2238
  %codecpar37 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %34, i32 0, i32 19, !dbg !2240
  %35 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar37, align 8, !dbg !2240
  %channels38 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %35, i32 0, i32 22, !dbg !2241
  %36 = load i32, i32* %channels38, align 8, !dbg !2241
  %mul39 = mul nsw i32 4096, %36, !dbg !2242
  %37 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2243
  %codecpar40 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %37, i32 0, i32 19, !dbg !2244
  %38 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar40, align 8, !dbg !2244
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %38, i32 0, i32 24, !dbg !2245
  store i32 %mul39, i32* %block_align, align 8, !dbg !2246
  %39 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2247
  %pb41 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %39, i32 0, i32 4, !dbg !2248
  %40 = load %struct.AVIOContext*, %struct.AVIOContext** %pb41, align 8, !dbg !2248
  %call42 = call i64 @avio_seek(%struct.AVIOContext* %40, i64 0, i32 0), !dbg !2249
  %41 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2250
  %duration43 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %41, i32 0, i32 6, !dbg !2251
  %42 = load i64, i64* %duration43, align 8, !dbg !2251
  %div44 = sdiv i64 %42, 16, !dbg !2252
  %mul45 = mul nsw i64 %div44, 28, !dbg !2253
  %43 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2254
  %duration46 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %43, i32 0, i32 6, !dbg !2255
  store i64 %mul45, i64* %duration46, align 8, !dbg !2256
  br label %if.end60, !dbg !2257

if.else47:                                        ; preds = %if.end29
  %44 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2258
  %codecpar48 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %44, i32 0, i32 19, !dbg !2260
  %45 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar48, align 8, !dbg !2260
  %channels49 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %45, i32 0, i32 22, !dbg !2261
  %46 = load i32, i32* %channels49, align 8, !dbg !2261
  %mul50 = mul nsw i32 16, %46, !dbg !2262
  %47 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2263
  %codecpar51 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %47, i32 0, i32 19, !dbg !2264
  %48 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar51, align 8, !dbg !2264
  %block_align52 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %48, i32 0, i32 24, !dbg !2265
  store i32 %mul50, i32* %block_align52, align 8, !dbg !2266
  %49 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2267
  %pb53 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %49, i32 0, i32 4, !dbg !2268
  %50 = load %struct.AVIOContext*, %struct.AVIOContext** %pb53, align 8, !dbg !2268
  %51 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2269
  %codecpar54 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %51, i32 0, i32 19, !dbg !2270
  %52 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar54, align 8, !dbg !2270
  %channels55 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %52, i32 0, i32 22, !dbg !2271
  %53 = load i32, i32* %channels55, align 8, !dbg !2271
  %cmp56 = icmp sgt i32 %53, 1, !dbg !2272
  %cond = select i1 %cmp56, i32 128, i32 48, !dbg !2269
  %conv58 = sext i32 %cond to i64, !dbg !2269
  %call59 = call i64 @avio_seek(%struct.AVIOContext* %50, i64 %conv58, i32 0), !dbg !2273
  br label %if.end60

if.end60:                                         ; preds = %if.else47, %if.then36
  %54 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2274
  %55 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2275
  %codecpar61 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %55, i32 0, i32 19, !dbg !2276
  %56 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar61, align 8, !dbg !2276
  %sample_rate62 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %56, i32 0, i32 23, !dbg !2277
  %57 = load i32, i32* %sample_rate62, align 4, !dbg !2277
  call void @avpriv_set_pts_info(%struct.AVStream* %54, i32 64, i32 1, i32 %57), !dbg !2278
  store i32 0, i32* %retval, align 4, !dbg !2279
  br label %return, !dbg !2279

return:                                           ; preds = %if.end60, %if.then28, %if.then
  %58 = load i32, i32* %retval, align 4, !dbg !2280
  ret i32 %58, !dbg !2280
}

; Function Attrs: nounwind uwtable
define internal i32 @vag_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2281 {
entry:
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %pkt.addr = alloca %struct.AVPacket*, align 8
  %par = alloca %struct.AVCodecParameters*, align 8
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2284, metadata !2143), !dbg !2285
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2286, metadata !2143), !dbg !2287
  call void @llvm.dbg.declare(metadata %struct.AVCodecParameters** %par, metadata !2288, metadata !2143), !dbg !2289
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2290
  %streams = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 7, !dbg !2291
  %1 = load %struct.AVStream**, %struct.AVStream*** %streams, align 8, !dbg !2291
  %arrayidx = getelementptr inbounds %struct.AVStream*, %struct.AVStream** %1, i64 0, !dbg !2290
  %2 = load %struct.AVStream*, %struct.AVStream** %arrayidx, align 8, !dbg !2290
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %2, i32 0, i32 19, !dbg !2292
  %3 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2292
  store %struct.AVCodecParameters* %3, %struct.AVCodecParameters** %par, align 8, !dbg !2289
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2293
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %4, i32 0, i32 4, !dbg !2294
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2294
  %6 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2295
  %7 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2296
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %7, i32 0, i32 24, !dbg !2297
  %8 = load i32, i32* %block_align, align 8, !dbg !2297
  %call = call i32 @av_get_packet(%struct.AVIOContext* %5, %struct.AVPacket* %6, i32 %8), !dbg !2298
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--vag.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!919 = !{!920}
!920 = distinct !DIGlobalVariable(name: "ff_vag_demuxer", scope: !0, file: !921, line: 76, type: !922, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_vag_demuxer)
!921 = !DIFile(filename: "libavformat/vag.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2140 = distinct !DISubprogram(name: "vag_probe", scope: !921, file: !921, line: 26, type: !991, isLocal: true, isDefinition: true, scopeLine: 27, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2141 = !{}
...
!2149 = !DILocation(line: 28, column: 9, scope: !2140)
!2150 = !DILocation(line: 29, column: 9, scope: !2146)
!2151 = !DILocation(line: 31, column: 5, scope: !2140)
!2152 = !DILocation(line: 32, column: 1, scope: !2140)
!2153 = distinct !DISubprogram(name: "vag_read_header", scope: !921, file: !921, line: 34, type: !2154, isLocal: true, isDefinition: true, scopeLine: 35, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
...
!2158 = !DILocalVariable(name: "s", arg: 1, scope: !2153, file: !921, line: 34, type: !2156)
!2159 = !DILocation(line: 34, column: 45, scope: !2153)
!2160 = !DILocalVariable(name: "st", scope: !2153, file: !921, line: 36, type: !1283)
!2161 = !DILocation(line: 36, column: 15, scope: !2153)
!2162 = !DILocation(line: 38, column: 30, scope: !2153)
!2163 = !DILocation(line: 38, column: 10, scope: !2153)
!2164 = !DILocation(line: 38, column: 8, scope: !2153)
!2165 = !DILocation(line: 39, column: 10, scope: !2166)
!2166 = distinct !DILexicalBlock(scope: !2153, file: !921, line: 39, column: 9)
!2167 = !DILocation(line: 39, column: 9, scope: !2153)
!2168 = !DILocation(line: 40, column: 9, scope: !2166)
!2169 = !DILocation(line: 42, column: 15, scope: !2153)
!2170 = !DILocation(line: 42, column: 18, scope: !2153)
!2171 = !DILocation(line: 42, column: 5, scope: !2153)
!2172 = !DILocation(line: 43, column: 5, scope: !2153)
!2173 = !DILocation(line: 43, column: 9, scope: !2153)
!2174 = !DILocation(line: 43, column: 19, scope: !2153)
!2175 = !DILocation(line: 43, column: 30, scope: !2153)
!2176 = !DILocation(line: 44, column: 5, scope: !2153)
!2177 = !DILocation(line: 44, column: 9, scope: !2153)
!2178 = !DILocation(line: 44, column: 19, scope: !2153)
!2179 = !DILocation(line: 44, column: 28, scope: !2153)
!2180 = !DILocation(line: 45, column: 45, scope: !2153)
!2181 = !DILocation(line: 45, column: 48, scope: !2153)
!2182 = !DILocation(line: 45, column: 35, scope: !2153)
!2183 = !DILocation(line: 45, column: 52, scope: !2153)
!2184 = !DILocation(line: 45, column: 32, scope: !2153)
!2185 = !DILocation(line: 45, column: 5, scope: !2153)
!2186 = !DILocation(line: 45, column: 9, scope: !2153)
!2187 = !DILocation(line: 45, column: 19, scope: !2153)
!2188 = !DILocation(line: 45, column: 28, scope: !2153)
!2189 = !DILocation(line: 46, column: 15, scope: !2153)
!2190 = !DILocation(line: 46, column: 18, scope: !2153)
!2191 = !DILocation(line: 46, column: 5, scope: !2153)
!2192 = !DILocation(line: 47, column: 9, scope: !2193)
!2193 = distinct !DILexicalBlock(scope: !2153, file: !921, line: 47, column: 9)
!2194 = !DILocation(line: 47, column: 13, scope: !2193)
!2195 = !DILocation(line: 47, column: 23, scope: !2193)
!2196 = !DILocation(line: 47, column: 32, scope: !2193)
!2197 = !DILocation(line: 47, column: 9, scope: !2153)
!2198 = !DILocation(line: 48, column: 34, scope: !2199)
!2199 = distinct !DILexicalBlock(scope: !2193, file: !921, line: 47, column: 37)
!2200 = !DILocation(line: 48, column: 37, scope: !2199)
!2201 = !DILocation(line: 48, column: 24, scope: !2199)
!2202 = !DILocation(line: 48, column: 9, scope: !2199)
!2203 = !DILocation(line: 48, column: 13, scope: !2199)
!2204 = !DILocation(line: 48, column: 22, scope: !2199)
!2205 = !DILocation(line: 49, column: 5, scope: !2199)
!2206 = !DILocation(line: 50, column: 34, scope: !2207)
!2207 = distinct !DILexicalBlock(scope: !2193, file: !921, line: 49, column: 12)
!2208 = !DILocation(line: 50, column: 37, scope: !2207)
!2209 = !DILocation(line: 50, column: 24, scope: !2207)
!2210 = !DILocation(line: 50, column: 41, scope: !2207)
!2211 = !DILocation(line: 50, column: 46, scope: !2207)
!2212 = !DILocation(line: 50, column: 9, scope: !2207)
!2213 = !DILocation(line: 50, column: 13, scope: !2207)
!2214 = !DILocation(line: 50, column: 22, scope: !2207)
!2215 = !DILocation(line: 52, column: 43, scope: !2153)
!2216 = !DILocation(line: 52, column: 46, scope: !2153)
!2217 = !DILocation(line: 52, column: 33, scope: !2153)
!2218 = !DILocation(line: 52, column: 5, scope: !2153)
!2219 = !DILocation(line: 52, column: 9, scope: !2153)
!2220 = !DILocation(line: 52, column: 19, scope: !2153)
!2221 = !DILocation(line: 52, column: 31, scope: !2153)
!2222 = !DILocation(line: 53, column: 9, scope: !2223)
!2223 = distinct !DILexicalBlock(scope: !2153, file: !921, line: 53, column: 9)
!2224 = !DILocation(line: 53, column: 13, scope: !2223)
!2225 = !DILocation(line: 53, column: 23, scope: !2223)
!2226 = !DILocation(line: 53, column: 35, scope: !2223)
!2227 = !DILocation(line: 53, column: 9, scope: !2153)
!2228 = !DILocation(line: 54, column: 9, scope: !2223)
!2229 = !DILocation(line: 55, column: 15, scope: !2153)
!2230 = !DILocation(line: 55, column: 18, scope: !2153)
!2231 = !DILocation(line: 55, column: 5, scope: !2153)
!2232 = !DILocation(line: 56, column: 19, scope: !2233)
!2233 = distinct !DILexicalBlock(scope: !2153, file: !921, line: 56, column: 9)
!2234 = !DILocation(line: 56, column: 22, scope: !2233)
!2235 = !DILocation(line: 56, column: 9, scope: !2233)
!2236 = !DILocation(line: 56, column: 26, scope: !2233)
!2237 = !DILocation(line: 56, column: 9, scope: !2153)
!2238 = !DILocation(line: 57, column: 46, scope: !2239)
!2239 = distinct !DILexicalBlock(scope: !2233, file: !921, line: 56, column: 95)
!2240 = !DILocation(line: 57, column: 50, scope: !2239)
!2241 = !DILocation(line: 57, column: 60, scope: !2239)
!2242 = !DILocation(line: 57, column: 44, scope: !2239)
!2243 = !DILocation(line: 57, column: 9, scope: !2239)
!2244 = !DILocation(line: 57, column: 13, scope: !2239)
!2245 = !DILocation(line: 57, column: 23, scope: !2239)
!2246 = !DILocation(line: 57, column: 35, scope: !2239)
!2247 = !DILocation(line: 58, column: 19, scope: !2239)
!2248 = !DILocation(line: 58, column: 22, scope: !2239)
!2249 = !DILocation(line: 58, column: 9, scope: !2239)
!2250 = !DILocation(line: 59, column: 24, scope: !2239)
!2251 = !DILocation(line: 59, column: 28, scope: !2239)
!2252 = !DILocation(line: 59, column: 37, scope: !2239)
!2253 = !DILocation(line: 59, column: 42, scope: !2239)
!2254 = !DILocation(line: 59, column: 9, scope: !2239)
!2255 = !DILocation(line: 59, column: 13, scope: !2239)
!2256 = !DILocation(line: 59, column: 22, scope: !2239)
!2257 = !DILocation(line: 60, column: 5, scope: !2239)
!2258 = !DILocation(line: 61, column: 42, scope: !2259)
!2259 = distinct !DILexicalBlock(scope: !2233, file: !921, line: 60, column: 12)
!2260 = !DILocation(line: 61, column: 46, scope: !2259)
!2261 = !DILocation(line: 61, column: 56, scope: !2259)
!2262 = !DILocation(line: 61, column: 40, scope: !2259)
!2263 = !DILocation(line: 61, column: 9, scope: !2259)
!2264 = !DILocation(line: 61, column: 13, scope: !2259)
!2265 = !DILocation(line: 61, column: 23, scope: !2259)
!2266 = !DILocation(line: 61, column: 35, scope: !2259)
!2267 = !DILocation(line: 62, column: 19, scope: !2259)
!2268 = !DILocation(line: 62, column: 22, scope: !2259)
!2269 = !DILocation(line: 62, column: 26, scope: !2259)
!2270 = !DILocation(line: 62, column: 30, scope: !2259)
!2271 = !DILocation(line: 62, column: 40, scope: !2259)
!2272 = !DILocation(line: 62, column: 49, scope: !2259)
!2273 = !DILocation(line: 62, column: 9, scope: !2259)
!2274 = !DILocation(line: 64, column: 25, scope: !2153)
!2275 = !DILocation(line: 64, column: 36, scope: !2153)
!2276 = !DILocation(line: 64, column: 40, scope: !2153)
!2277 = !DILocation(line: 64, column: 50, scope: !2153)
!2278 = !DILocation(line: 64, column: 5, scope: !2153)
!2279 = !DILocation(line: 66, column: 5, scope: !2153)
!2280 = !DILocation(line: 67, column: 1, scope: !2153)
!2281 = distinct !DISubprogram(name: "vag_read_packet", scope: !921, file: !921, line: 69, type: !2282, isLocal: true, isDefinition: true, scopeLine: 70, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2282 = !DISubroutineType(types: !2283)
!2283 = !{!917, !2156, !1033}
!2284 = !DILocalVariable(name: "s", arg: 1, scope: !2281, file: !921, line: 69, type: !2156)
!2285 = !DILocation(line: 69, column: 45, scope: !2281)
!2286 = !DILocalVariable(name: "pkt", arg: 2, scope: !2281, file: !921, line: 69, type: !1033)
!2287 = !DILocation(line: 69, column: 58, scope: !2281)
!2288 = !DILocalVariable(name: "par", scope: !2281, file: !921, line: 71, type: !1727)
!2289 = !DILocation(line: 71, column: 24, scope: !2281)
!2290 = !DILocation(line: 71, column: 30, scope: !2281)
!2291 = !DILocation(line: 71, column: 33, scope: !2281)
!2292 = !DILocation(line: 71, column: 45, scope: !2281)
!2293 = !DILocation(line: 73, column: 26, scope: !2281)
!2294 = !DILocation(line: 73, column: 29, scope: !2281)
!2295 = !DILocation(line: 73, column: 33, scope: !2281)
!2296 = !DILocation(line: 73, column: 38, scope: !2281)
!2297 = !DILocation(line: 73, column: 43, scope: !2281)
!2298 = !DILocation(line: 73, column: 12, scope: !2281)
!2299 = !DILocation(line: 73, column: 5, scope: !2281)
