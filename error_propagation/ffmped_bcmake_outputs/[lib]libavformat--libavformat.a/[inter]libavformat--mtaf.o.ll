; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--mtaf.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--mtaf.o.i"
...
@ff_mtaf_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 0, i32 (%struct.AVProbeData*)* @mtaf_probe, i32 (%struct.AVFormatContext*)* @mtaf_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @mtaf_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8

; Function Attrs: nounwind uwtable
define internal i32 @mtaf_probe(%struct.AVProbeData* %p) #0 !dbg !2146 {
entry:
  ...
  %cmp = icmp slt i32 %1, 68, !dbg !2154
...
if.end:                                           ; preds = %entry
  ...
  %4 = bitcast i8* %3 to %union.unaligned_32*, !dbg !2160
  %l = bitcast %union.unaligned_32* %4 to i32*, !dbg !2160
  %5 = load i32, i32* %l, align 1, !dbg !2160
  %cmp1 = icmp ne i32 %5, 1178686541, !dbg !2161
  br i1 %cmp1, label %if.then5, label %lor.lhs.false, !dbg !2162
...
lor.lhs.false:                                    ; preds = %if.end
  ...
  %add.ptr = getelementptr inbounds i8, i8* %7, i64 64, !dbg !2165
  %8 = bitcast i8* %add.ptr to %union.unaligned_32*, !dbg !2166
  %l3 = bitcast %union.unaligned_32* %8 to i32*, !dbg !2166
  %9 = load i32, i32* %l3, align 1, !dbg !2166
  %cmp4 = icmp ne i32 %9, 1145128264, !dbg !2167
  br i1 %cmp4, label %if.then5, label %if.end6, !dbg !2168
...
return:                                           ; preds = %if.end6, %if.then5, %if.then
  %10 = load i32, i32* %retval, align 4, !dbg !2172
  ret i32 %10, !dbg !2172
}

; Function Attrs: nounwind uwtable
define internal i32 @mtaf_read_header(%struct.AVFormatContext* %s) #0 !dbg !2173 {
entry:
  %retval = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2178, metadata !2149), !dbg !2179
  call void @llvm.dbg.declare(metadata i32* %stream_count, metadata !2180, metadata !2149), !dbg !2181
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2182, metadata !2149), !dbg !2183
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2184
  %call = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %0, %struct.AVCodec* null), !dbg !2185
  store %struct.AVStream* %call, %struct.AVStream** %st, align 8, !dbg !2186
  %1 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2187
  %tobool = icmp ne %struct.AVStream* %1, null, !dbg !2187
  br i1 %tobool, label %if.end, label %if.then, !dbg !2189

if.then:                                          ; preds = %entry
  store i32 -12, i32* %retval, align 4, !dbg !2190
  br label %return, !dbg !2190

if.end:                                           ; preds = %entry
  %2 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2191
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %2, i32 0, i32 4, !dbg !2192
  %3 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2192
  %call1 = call i64 @avio_skip(%struct.AVIOContext* %3, i64 92), !dbg !2193
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2194
  %pb2 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %4, i32 0, i32 4, !dbg !2195
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb2, align 8, !dbg !2195
  %call3 = call i32 @avio_rl32(%struct.AVIOContext* %5), !dbg !2196
  %conv = zext i32 %call3 to i64, !dbg !2196
  %6 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2197
  %duration = getelementptr inbounds %struct.AVStream, %struct.AVStream* %6, i32 0, i32 6, !dbg !2198
  store i64 %conv, i64* %duration, align 8, !dbg !2199
  %7 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2200
  %pb4 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %7, i32 0, i32 4, !dbg !2201
  %8 = load %struct.AVIOContext*, %struct.AVIOContext** %pb4, align 8, !dbg !2201
  %call5 = call i64 @avio_skip(%struct.AVIOContext* %8, i64 1), !dbg !2202
  %9 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2203
  %pb6 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %9, i32 0, i32 4, !dbg !2204
  %10 = load %struct.AVIOContext*, %struct.AVIOContext** %pb6, align 8, !dbg !2204
  %call7 = call i32 @avio_r8(%struct.AVIOContext* %10), !dbg !2205
  store i32 %call7, i32* %stream_count, align 4, !dbg !2206
  %11 = load i32, i32* %stream_count, align 4, !dbg !2207
  %tobool8 = icmp ne i32 %11, 0, !dbg !2207
  br i1 %tobool8, label %if.end10, label %if.then9, !dbg !2209
...
if.end10:                                         ; preds = %if.end
  %12 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2211
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %12, i32 0, i32 19, !dbg !2212
  %13 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2212
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %13, i32 0, i32 0, !dbg !2213
  store i32 1, i32* %codec_type, align 8, !dbg !2214
  %14 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2215
  %codecpar11 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %14, i32 0, i32 19, !dbg !2216
  %15 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar11, align 8, !dbg !2216
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %15, i32 0, i32 1, !dbg !2217
  store i32 71689, i32* %codec_id, align 4, !dbg !2218
  %16 = load i32, i32* %stream_count, align 4, !dbg !2219
  %mul = mul nsw i32 2, %16, !dbg !2220
  %17 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2221
  %codecpar12 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %17, i32 0, i32 19, !dbg !2222
  %18 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar12, align 8, !dbg !2222
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %18, i32 0, i32 22, !dbg !2223
  store i32 %mul, i32* %channels, align 8, !dbg !2224
  %19 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2225
  %codecpar13 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %19, i32 0, i32 19, !dbg !2226
  %20 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar13, align 8, !dbg !2226
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %20, i32 0, i32 23, !dbg !2227
  store i32 48000, i32* %sample_rate, align 4, !dbg !2228
  %21 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2229
  %codecpar14 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %21, i32 0, i32 19, !dbg !2230
  %22 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar14, align 8, !dbg !2230
  %channels15 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %22, i32 0, i32 22, !dbg !2231
  %23 = load i32, i32* %channels15, align 8, !dbg !2231
  %mul16 = mul nsw i32 272, %23, !dbg !2232
  %div = sdiv i32 %mul16, 2, !dbg !2233
  %24 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2234
  %codecpar17 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %24, i32 0, i32 19, !dbg !2235
  %25 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar17, align 8, !dbg !2235
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %25, i32 0, i32 24, !dbg !2236
  store i32 %div, i32* %block_align, align 8, !dbg !2237
  %26 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2238
  %27 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2239
  %codecpar18 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %27, i32 0, i32 19, !dbg !2240
  %28 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar18, align 8, !dbg !2240
  %sample_rate19 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %28, i32 0, i32 23, !dbg !2241
  %29 = load i32, i32* %sample_rate19, align 4, !dbg !2241
  call void @avpriv_set_pts_info(%struct.AVStream* %26, i32 64, i32 1, i32 %29), !dbg !2242
  %30 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2243
  %pb20 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %30, i32 0, i32 4, !dbg !2244
  %31 = load %struct.AVIOContext*, %struct.AVIOContext** %pb20, align 8, !dbg !2244
  %call21 = call i64 @avio_seek(%struct.AVIOContext* %31, i64 2048, i32 0), !dbg !2245
  store i32 0, i32* %retval, align 4, !dbg !2246
  br label %return, !dbg !2246

return:                                           ; preds = %if.end10, %if.then9, %if.then
  %32 = load i32, i32* %retval, align 4, !dbg !2247
  ret i32 %32, !dbg !2247
}

; Function Attrs: nounwind uwtable
define internal i32 @mtaf_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2248 {
entry:
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %pkt.addr = alloca %struct.AVPacket*, align 8
  %par = alloca %struct.AVCodecParameters*, align 8
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2251, metadata !2149), !dbg !2252
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2253, metadata !2149), !dbg !2254
  call void @llvm.dbg.declare(metadata %struct.AVCodecParameters** %par, metadata !2255, metadata !2149), !dbg !2256
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2257
  %streams = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 7, !dbg !2258
  %1 = load %struct.AVStream**, %struct.AVStream*** %streams, align 8, !dbg !2258
  %arrayidx = getelementptr inbounds %struct.AVStream*, %struct.AVStream** %1, i64 0, !dbg !2257
  %2 = load %struct.AVStream*, %struct.AVStream** %arrayidx, align 8, !dbg !2257
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %2, i32 0, i32 19, !dbg !2259
  %3 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2259
  store %struct.AVCodecParameters* %3, %struct.AVCodecParameters** %par, align 8, !dbg !2256
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2260
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %4, i32 0, i32 4, !dbg !2261
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2261
  %6 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2262
  %7 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2263
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %7, i32 0, i32 24, !dbg !2264
  %8 = load i32, i32* %block_align, align 8, !dbg !2264
  %call = call i32 @av_get_packet(%struct.AVIOContext* %5, %struct.AVPacket* %6, i32 %8), !dbg !2265
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--mtaf.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!927 = !{!928}
!928 = distinct !DIGlobalVariable(name: "ff_mtaf_demuxer", scope: !0, file: !929, line: 74, type: !930, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_mtaf_demuxer)
!929 = !DIFile(filename: "libavformat/mtaf.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2146 = distinct !DISubprogram(name: "mtaf_probe", scope: !929, file: !929, line: 27, type: !999, isLocal: true, isDefinition: true, scopeLine: 28, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2147 = !{}
!2148 = !DILocalVariable(name: "p", arg: 1, scope: !2146, file: !929, line: 27, type: !1001)
!2149 = !DIExpression()
!2150 = !DILocation(line: 27, column: 36, scope: !2146)
!2151 = !DILocation(line: 29, column: 9, scope: !2152)
!2152 = distinct !DILexicalBlock(scope: !2146, file: !929, line: 29, column: 9)
!2153 = !DILocation(line: 29, column: 12, scope: !2152)
!2154 = !DILocation(line: 29, column: 21, scope: !2152)
!2155 = !DILocation(line: 29, column: 9, scope: !2146)
!2156 = !DILocation(line: 30, column: 9, scope: !2152)
!2157 = !DILocation(line: 32, column: 41, scope: !2158)
!2158 = distinct !DILexicalBlock(scope: !2146, file: !929, line: 32, column: 9)
!2159 = !DILocation(line: 32, column: 44, scope: !2158)
!2160 = !DILocation(line: 32, column: 51, scope: !2158)
!2161 = !DILocation(line: 32, column: 54, scope: !2158)
!2162 = !DILocation(line: 32, column: 122, scope: !2158)
!2163 = !DILocation(line: 33, column: 41, scope: !2158)
!2164 = !DILocation(line: 33, column: 44, scope: !2158)
!2165 = !DILocation(line: 33, column: 48, scope: !2158)
!2166 = !DILocation(line: 33, column: 58, scope: !2158)
!2167 = !DILocation(line: 33, column: 61, scope: !2158)
!2168 = !DILocation(line: 32, column: 9, scope: !2169)
!2169 = !DILexicalBlockFile(scope: !2146, file: !929, discriminator: 1)
!2170 = !DILocation(line: 34, column: 9, scope: !2158)
!2171 = !DILocation(line: 36, column: 5, scope: !2146)
!2172 = !DILocation(line: 37, column: 1, scope: !2146)
!2173 = distinct !DISubprogram(name: "mtaf_read_header", scope: !929, file: !929, line: 39, type: !2174, isLocal: true, isDefinition: true, scopeLine: 40, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2174 = !DISubroutineType(types: !2175)
!2175 = !{!926, !2176}
!2176 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2177, size: 64, align: 64)
!2177 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1016)
!2178 = !DILocalVariable(name: "s", arg: 1, scope: !2173, file: !929, line: 39, type: !2176)
!2179 = !DILocation(line: 39, column: 46, scope: !2173)
!2180 = !DILocalVariable(name: "stream_count", scope: !2173, file: !929, line: 41, type: !926)
!2181 = !DILocation(line: 41, column: 9, scope: !2173)
!2182 = !DILocalVariable(name: "st", scope: !2173, file: !929, line: 42, type: !1290)
!2183 = !DILocation(line: 42, column: 15, scope: !2173)
!2184 = !DILocation(line: 44, column: 30, scope: !2173)
!2185 = !DILocation(line: 44, column: 10, scope: !2173)
!2186 = !DILocation(line: 44, column: 8, scope: !2173)
!2187 = !DILocation(line: 45, column: 10, scope: !2188)
!2188 = distinct !DILexicalBlock(scope: !2173, file: !929, line: 45, column: 9)
!2189 = !DILocation(line: 45, column: 9, scope: !2173)
!2190 = !DILocation(line: 46, column: 9, scope: !2188)
!2191 = !DILocation(line: 48, column: 15, scope: !2173)
!2192 = !DILocation(line: 48, column: 18, scope: !2173)
!2193 = !DILocation(line: 48, column: 5, scope: !2173)
!2194 = !DILocation(line: 49, column: 30, scope: !2173)
!2195 = !DILocation(line: 49, column: 33, scope: !2173)
!2196 = !DILocation(line: 49, column: 20, scope: !2173)
!2197 = !DILocation(line: 49, column: 5, scope: !2173)
!2198 = !DILocation(line: 49, column: 9, scope: !2173)
!2199 = !DILocation(line: 49, column: 18, scope: !2173)
!2200 = !DILocation(line: 50, column: 15, scope: !2173)
!2201 = !DILocation(line: 50, column: 18, scope: !2173)
!2202 = !DILocation(line: 50, column: 5, scope: !2173)
!2203 = !DILocation(line: 51, column: 28, scope: !2173)
!2204 = !DILocation(line: 51, column: 31, scope: !2173)
!2205 = !DILocation(line: 51, column: 20, scope: !2173)
!2206 = !DILocation(line: 51, column: 18, scope: !2173)
!2207 = !DILocation(line: 52, column: 10, scope: !2208)
!2208 = distinct !DILexicalBlock(scope: !2173, file: !929, line: 52, column: 9)
!2209 = !DILocation(line: 52, column: 9, scope: !2173)
!2210 = !DILocation(line: 53, column: 9, scope: !2208)
!2211 = !DILocation(line: 55, column: 5, scope: !2173)
!2212 = !DILocation(line: 55, column: 9, scope: !2173)
!2213 = !DILocation(line: 55, column: 19, scope: !2173)
!2214 = !DILocation(line: 55, column: 30, scope: !2173)
!2215 = !DILocation(line: 56, column: 5, scope: !2173)
!2216 = !DILocation(line: 56, column: 9, scope: !2173)
!2217 = !DILocation(line: 56, column: 19, scope: !2173)
!2218 = !DILocation(line: 56, column: 28, scope: !2173)
!2219 = !DILocation(line: 57, column: 34, scope: !2173)
!2220 = !DILocation(line: 57, column: 32, scope: !2173)
!2221 = !DILocation(line: 57, column: 5, scope: !2173)
!2222 = !DILocation(line: 57, column: 9, scope: !2173)
!2223 = !DILocation(line: 57, column: 19, scope: !2173)
!2224 = !DILocation(line: 57, column: 28, scope: !2173)
!2225 = !DILocation(line: 58, column: 5, scope: !2173)
!2226 = !DILocation(line: 58, column: 9, scope: !2173)
!2227 = !DILocation(line: 58, column: 19, scope: !2173)
!2228 = !DILocation(line: 58, column: 31, scope: !2173)
!2229 = !DILocation(line: 59, column: 41, scope: !2173)
!2230 = !DILocation(line: 59, column: 45, scope: !2173)
!2231 = !DILocation(line: 59, column: 55, scope: !2173)
!2232 = !DILocation(line: 59, column: 39, scope: !2173)
!2233 = !DILocation(line: 59, column: 64, scope: !2173)
!2234 = !DILocation(line: 59, column: 5, scope: !2173)
!2235 = !DILocation(line: 59, column: 9, scope: !2173)
!2236 = !DILocation(line: 59, column: 19, scope: !2173)
!2237 = !DILocation(line: 59, column: 31, scope: !2173)
!2238 = !DILocation(line: 60, column: 25, scope: !2173)
!2239 = !DILocation(line: 60, column: 36, scope: !2173)
!2240 = !DILocation(line: 60, column: 40, scope: !2173)
!2241 = !DILocation(line: 60, column: 50, scope: !2173)
!2242 = !DILocation(line: 60, column: 5, scope: !2173)
!2243 = !DILocation(line: 62, column: 15, scope: !2173)
!2244 = !DILocation(line: 62, column: 18, scope: !2173)
!2245 = !DILocation(line: 62, column: 5, scope: !2173)
!2246 = !DILocation(line: 64, column: 5, scope: !2173)
!2247 = !DILocation(line: 65, column: 1, scope: !2173)
!2248 = distinct !DISubprogram(name: "mtaf_read_packet", scope: !929, file: !929, line: 67, type: !2249, isLocal: true, isDefinition: true, scopeLine: 68, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2249 = !DISubroutineType(types: !2250)
!2250 = !{!926, !2176, !1041}
!2251 = !DILocalVariable(name: "s", arg: 1, scope: !2248, file: !929, line: 67, type: !2176)
!2252 = !DILocation(line: 67, column: 46, scope: !2248)
!2253 = !DILocalVariable(name: "pkt", arg: 2, scope: !2248, file: !929, line: 67, type: !1041)
!2254 = !DILocation(line: 67, column: 59, scope: !2248)
!2255 = !DILocalVariable(name: "par", scope: !2248, file: !929, line: 69, type: !1733)
!2256 = !DILocation(line: 69, column: 24, scope: !2248)
!2257 = !DILocation(line: 69, column: 30, scope: !2248)
!2258 = !DILocation(line: 69, column: 33, scope: !2248)
!2259 = !DILocation(line: 69, column: 45, scope: !2248)
!2260 = !DILocation(line: 71, column: 26, scope: !2248)
!2261 = !DILocation(line: 71, column: 29, scope: !2248)
!2262 = !DILocation(line: 71, column: 33, scope: !2248)
!2263 = !DILocation(line: 71, column: 38, scope: !2248)
!2264 = !DILocation(line: 71, column: 43, scope: !2248)
!2265 = !DILocation(line: 71, column: 12, scope: !2248)
!2266 = !DILocation(line: 71, column: 5, scope: !2248)
