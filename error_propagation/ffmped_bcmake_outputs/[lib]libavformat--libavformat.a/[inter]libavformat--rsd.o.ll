; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--rsd.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--rsd.o.i"
...
@rsd_tags = internal constant [9 x %struct.AVCodecTag] [%struct.AVCodecTag { i32 71686, i32 541540694 }, %struct.AVCodecTag { i32 71685, i32 1346650439 }, %struct.AVCodecTag { i32 69650, i32 1346650455 }, %struct.AVCodecTag { i32 71683, i32 1346650450 }, %struct.AVCodecTag { i32 69633, i32 1346650456 }, %struct.AVCodecTag { i32 65537, i32 1112359760 }, %struct.AVCodecTag { i32 65536, i32 541934416 }, %struct.AVCodecTag { i32 88076, i32 541150552 }, %struct.AVCodecTag zeroinitializer], align 16
@.compoundliteral = internal constant [2 x %struct.AVCodecTag*] [%struct.AVCodecTag* getelementptr inbounds ([9 x %struct.AVCodecTag], [9 x %struct.AVCodecTag]* @rsd_tags, i32 0, i32 0), %struct.AVCodecTag* null], align 8
@ff_rsd_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i32 256, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), %struct.AVCodecTag** getelementptr inbounds ([2 x %struct.AVCodecTag*], [2 x %struct.AVCodecTag*]* @.compoundliteral, i32 0, i32 0), %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 0, i32 (%struct.AVProbeData*)* @rsd_probe, i32 (%struct.AVFormatContext*)* @rsd_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @rsd_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
...
define internal i32 @rsd_probe(%struct.AVProbeData* %p) #0 !dbg !2157 {
entry:
  ...
  %call = call i32 @memcmp(i8* %1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0), i64 3) #5, !dbg !2165
  %tobool = icmp ne i32 %call, 0, !dbg !2165
  br i1 %tobool, label %if.then, label %lor.lhs.false, !dbg !2166

lor.lhs.false:                                    ; preds = %entry
  %2 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2167
  %buf1 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %2, i32 0, i32 1, !dbg !2169
  %3 = load i8*, i8** %buf1, align 8, !dbg !2169
  %arrayidx = getelementptr inbounds i8, i8* %3, i64 3, !dbg !2167
  %4 = load i8, i8* %arrayidx, align 1, !dbg !2167
  %conv = zext i8 %4 to i32, !dbg !2167
  %sub = sub nsw i32 %conv, 48, !dbg !2170
  %cmp = icmp slt i32 %sub, 2, !dbg !2171
  br i1 %cmp, label %if.then, label %lor.lhs.false3, !dbg !2172

lor.lhs.false3:                                   ; preds = %lor.lhs.false
  %5 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2173
  %buf4 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %5, i32 0, i32 1, !dbg !2175
  %6 = load i8*, i8** %buf4, align 8, !dbg !2175
  %arrayidx5 = getelementptr inbounds i8, i8* %6, i64 3, !dbg !2173
  %7 = load i8, i8* %arrayidx5, align 1, !dbg !2173
  %conv6 = zext i8 %7 to i32, !dbg !2173
  %sub7 = sub nsw i32 %conv6, 48, !dbg !2176
  %cmp8 = icmp sgt i32 %sub7, 6, !dbg !2177
  br i1 %cmp8, label %if.then, label %if.end, !dbg !2178
...
if.end:                                           ; preds = %lor.lhs.false3
  ...
  %buf10 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %8, i32 0, i32 1, !dbg !2182
  %9 = load i8*, i8** %buf10, align 8, !dbg !2182
  %add.ptr = getelementptr inbounds i8, i8* %9, i64 8, !dbg !2183
  %10 = bitcast i8* %add.ptr to %union.unaligned_32*, !dbg !2184
  %l = bitcast %union.unaligned_32* %10 to i32*, !dbg !2184
  %11 = load i32, i32* %l, align 1, !dbg !2184
  %cmp11 = icmp ugt i32 %11, 256, !dbg !2185
  br i1 %cmp11, label %if.then18, label %lor.lhs.false13, !dbg !2186

lor.lhs.false13:                                  ; preds = %if.end
  %12 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2187
  %buf14 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %12, i32 0, i32 1, !dbg !2189
  %13 = load i8*, i8** %buf14, align 8, !dbg !2189
  %add.ptr15 = getelementptr inbounds i8, i8* %13, i64 8, !dbg !2190
  %14 = bitcast i8* %add.ptr15 to %union.unaligned_32*, !dbg !2191
  %l16 = bitcast %union.unaligned_32* %14 to i32*, !dbg !2191
  %15 = load i32, i32* %l16, align 1, !dbg !2191
  %tobool17 = icmp ne i32 %15, 0, !dbg !2192
  br i1 %tobool17, label %if.end19, label %if.then18, !dbg !2193
...
if.end19:                                         ; preds = %lor.lhs.false13
  %16 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2195
  %buf20 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %16, i32 0, i32 1, !dbg !2197
  %17 = load i8*, i8** %buf20, align 8, !dbg !2197
  %add.ptr21 = getelementptr inbounds i8, i8* %17, i64 16, !dbg !2198
  %18 = bitcast i8* %add.ptr21 to %union.unaligned_32*, !dbg !2199
  %l22 = bitcast %union.unaligned_32* %18 to i32*, !dbg !2199
  %19 = load i32, i32* %l22, align 1, !dbg !2199
  %cmp23 = icmp ugt i32 %19, 384000, !dbg !2200
  br i1 %cmp23, label %if.then30, label %lor.lhs.false25, !dbg !2201

lor.lhs.false25:                                  ; preds = %if.end19
  %20 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2202
  %buf26 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %20, i32 0, i32 1, !dbg !2204
  %21 = load i8*, i8** %buf26, align 8, !dbg !2204
  %add.ptr27 = getelementptr inbounds i8, i8* %21, i64 16, !dbg !2205
  %22 = bitcast i8* %add.ptr27 to %union.unaligned_32*, !dbg !2206
  %l28 = bitcast %union.unaligned_32* %22 to i32*, !dbg !2206
  %23 = load i32, i32* %l28, align 1, !dbg !2206
  %tobool29 = icmp ne i32 %23, 0, !dbg !2207
  br i1 %tobool29, label %if.end31, label %if.then30, !dbg !2208
...
return:                                           ; preds = %if.end31, %if.then30, %if.then18, %if.then
  %24 = load i32, i32* %retval, align 4, !dbg !2211
  ret i32 %24, !dbg !2211
}

; Function Attrs: nounwind uwtable
define internal i32 @rsd_read_header(%struct.AVFormatContext* %s) #0 !dbg !2212 {
entry:
  %s.addr.i192 = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i192, metadata !2217, metadata !2160), !dbg !2221
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2217, metadata !2160), !dbg !2223
  %retval = alloca i32, align 4
  ...
  %tag_buf = alloca i8*, align 8
  %.compoundliteral = alloca [32 x i8], align 1
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2226, metadata !2160), !dbg !2227
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2228, metadata !2160), !dbg !2229
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2230
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2231
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2231
  store %struct.AVIOContext* %1, %struct.AVIOContext** %pb, align 8, !dbg !2229
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2232, metadata !2160), !dbg !2233
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2234, metadata !2160), !dbg !2235
  call void @llvm.dbg.declare(metadata i32* %version, metadata !2236, metadata !2160), !dbg !2237
  call void @llvm.dbg.declare(metadata i32* %start, metadata !2238, metadata !2160), !dbg !2239
  store i32 2048, i32* %start, align 4, !dbg !2239
  call void @llvm.dbg.declare(metadata %struct.AVCodecParameters** %par, metadata !2240, metadata !2160), !dbg !2241
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2242, metadata !2160), !dbg !2243
  %2 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2244
  %call = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %2, %struct.AVCodec* null), !dbg !2245
  store %struct.AVStream* %call, %struct.AVStream** %st, align 8, !dbg !2243
  %3 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2246
  %tobool = icmp ne %struct.AVStream* %3, null, !dbg !2246
...
if.end:                                           ; preds = %entry
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2250
  %call2 = call i64 @avio_skip(%struct.AVIOContext* %4, i64 3), !dbg !2251
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2252
  %call3 = call i32 @avio_r8(%struct.AVIOContext* %5), !dbg !2253
  %sub = sub nsw i32 %call3, 48, !dbg !2254
  store i32 %sub, i32* %version, align 4, !dbg !2255
  %6 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2256
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %6, i32 0, i32 19, !dbg !2257
  %7 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2257
  store %struct.AVCodecParameters* %7, %struct.AVCodecParameters** %par, align 8, !dbg !2258
  %8 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2259
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %8, i32 0, i32 0, !dbg !2260
  store i32 1, i32* %codec_type, align 8, !dbg !2261
  %9 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2262
  %call4 = call i32 @avio_rl32(%struct.AVIOContext* %9), !dbg !2263
  %10 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2264
  %codec_tag = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %10, i32 0, i32 2, !dbg !2265
  store i32 %call4, i32* %codec_tag, align 8, !dbg !2266
  %11 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2267
  %codec_tag5 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %11, i32 0, i32 2, !dbg !2268
  %12 = load i32, i32* %codec_tag5, align 8, !dbg !2268
  %call6 = call i32 @ff_codec_get_id(%struct.AVCodecTag* getelementptr inbounds ([9 x %struct.AVCodecTag], [9 x %struct.AVCodecTag]* @rsd_tags, i32 0, i32 0), i32 %12), !dbg !2269
  %13 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2270
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %13, i32 0, i32 1, !dbg !2271
  store i32 %call6, i32* %codec_id, align 4, !dbg !2272
  %14 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2273
  %codec_id7 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %14, i32 0, i32 1, !dbg !2275
  %15 = load i32, i32* %codec_id7, align 4, !dbg !2275
  %tobool8 = icmp ne i32 %15, 0, !dbg !2273
  br i1 %tobool8, label %if.end18, label %if.then9, !dbg !2276

if.then9:                                         ; preds = %if.end
  call void @llvm.dbg.declare(metadata i8** %tag_buf, metadata !2277, metadata !2160), !dbg !2279
  %16 = bitcast [32 x i8]* %.compoundliteral to i8*, !dbg !2280
  call void @llvm.memset.p0i8.i64(i8* %16, i8 0, i64 32, i32 1, i1 false), !dbg !2280
  %arrayinit.begin = getelementptr inbounds [32 x i8], [32 x i8]* %.compoundliteral, i64 0, i64 0, !dbg !2281
  store i8 0, i8* %arrayinit.begin, align 1, !dbg !2281
  %arraydecay = getelementptr inbounds [32 x i8], [32 x i8]* %.compoundliteral, i32 0, i32 0, !dbg !2280
  %17 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2282
  %codec_tag10 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %17, i32 0, i32 2, !dbg !2283
  %18 = load i32, i32* %codec_tag10, align 8, !dbg !2283
  %call11 = call i8* @av_fourcc_make_string(i8* %arraydecay, i32 %18), !dbg !2284
  store i8* %call11, i8** %tag_buf, align 8, !dbg !2279
  store i32 0, i32* %i, align 4, !dbg !2286
  br label %for.cond, !dbg !2288

for.cond:                                         ; preds = %for.inc, %if.then9
  %19 = load i32, i32* %i, align 4, !dbg !2289
  %conv = sext i32 %19 to i64, !dbg !2289
  %cmp = icmp ult i64 %conv, 1, !dbg !2292
  br i1 %cmp, label %for.body, label %for.end, !dbg !2293

for.body:                                         ; preds = %for.cond
  %20 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2294
  %codec_tag13 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %20, i32 0, i32 2, !dbg !2297
  %21 = load i32, i32* %codec_tag13, align 8, !dbg !2297
  %22 = load i32, i32* %i, align 4, !dbg !2298
  %idxprom = sext i32 %22 to i64, !dbg !2299
  %arrayidx = getelementptr inbounds [1 x i32], [1 x i32]* @rsd_unsupported_tags, i64 0, i64 %idxprom, !dbg !2299
  %23 = load i32, i32* %arrayidx, align 4, !dbg !2299
  %cmp14 = icmp eq i32 %21, %23, !dbg !2300
  br i1 %cmp14, label %if.then16, label %if.end17, !dbg !2301

if.then16:                                        ; preds = %for.body
  %24 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2302
  %25 = bitcast %struct.AVFormatContext* %24 to i8*, !dbg !2302
  %26 = load i8*, i8** %tag_buf, align 8, !dbg !2304
  call void (i8*, i8*, ...) @avpriv_request_sample(i8* %25, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.3, i32 0, i32 0), i8* %26), !dbg !2305
  store i32 -1163346256, i32* %retval, align 4, !dbg !2306
...
for.inc:                                          ; preds = %if.end17
  %27 = load i32, i32* %i, align 4, !dbg !2308
  %inc = add nsw i32 %27, 1, !dbg !2308
  store i32 %inc, i32* %i, align 4, !dbg !2308
  br label %for.cond, !dbg !2310, !llvm.loop !2311

for.end:                                          ; preds = %for.cond
  %28 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2313
  %29 = bitcast %struct.AVFormatContext* %28 to i8*, !dbg !2313
  %30 = load i8*, i8** %tag_buf, align 8, !dbg !2314
  call void (i8*, i32, i8*, ...) @av_log(i8* %29, i32 16, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.4, i32 0, i32 0), i8* %30), !dbg !2315
  store i32 -1094995529, i32* %retval, align 4, !dbg !2316
  br label %return, !dbg !2316

if.end18:                                         ; preds = %if.end
  %31 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2317
  %call19 = call i32 @avio_rl32(%struct.AVIOContext* %31), !dbg !2318
  %32 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2319
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %32, i32 0, i32 22, !dbg !2320
  store i32 %call19, i32* %channels, align 8, !dbg !2321
  %33 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2322
  %channels20 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %33, i32 0, i32 22, !dbg !2324
  %34 = load i32, i32* %channels20, align 8, !dbg !2324
  %cmp21 = icmp sle i32 %34, 0, !dbg !2325
  br i1 %cmp21, label %if.then26, label %lor.lhs.false, !dbg !2326

lor.lhs.false:                                    ; preds = %if.end18
  %35 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2327
  %channels23 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %35, i32 0, i32 22, !dbg !2329
  %36 = load i32, i32* %channels23, align 8, !dbg !2329
  %cmp24 = icmp sgt i32 %36, 59652323, !dbg !2330
  br i1 %cmp24, label %if.then26, label %if.end28, !dbg !2331

if.then26:                                        ; preds = %lor.lhs.false, %if.end18
  %37 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2332
  %38 = bitcast %struct.AVFormatContext* %37 to i8*, !dbg !2332
  %39 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2334
  %channels27 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %39, i32 0, i32 22, !dbg !2335
  %40 = load i32, i32* %channels27, align 8, !dbg !2335
  call void (i8*, i32, i8*, ...) @av_log(i8* %38, i32 16, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.5, i32 0, i32 0), i32 %40), !dbg !2336
  store i32 -1094995529, i32* %retval, align 4, !dbg !2337
  br label %return, !dbg !2337

if.end28:                                         ; preds = %lor.lhs.false
  %41 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2338
  %call29 = call i64 @avio_skip(%struct.AVIOContext* %41, i64 4), !dbg !2339
  %42 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2340
  %call30 = call i32 @avio_rl32(%struct.AVIOContext* %42), !dbg !2341
  %43 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2342
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %43, i32 0, i32 23, !dbg !2343
  store i32 %call30, i32* %sample_rate, align 4, !dbg !2344
  %44 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2345
  %sample_rate31 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %44, i32 0, i32 23, !dbg !2347
  %45 = load i32, i32* %sample_rate31, align 4, !dbg !2347
  %tobool32 = icmp ne i32 %45, 0, !dbg !2345
  br i1 %tobool32, label %if.end34, label %if.then33, !dbg !2348
...
if.end34:                                         ; preds = %if.end28
  %46 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2350
  %call35 = call i64 @avio_skip(%struct.AVIOContext* %46, i64 4), !dbg !2351
  %47 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2352
  %codec_id36 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %47, i32 0, i32 1, !dbg !2353
  %48 = load i32, i32* %codec_id36, align 4, !dbg !2353
  switch i32 %48, label %sw.epilog [
    i32 88076, label %sw.bb
    i32 71686, label %sw.bb42
    i32 71683, label %sw.bb54
    i32 69633, label %sw.bb70
    i32 71685, label %sw.bb91
    i32 69650, label %sw.bb111
    i32 65536, label %sw.bb156
    i32 65537, label %sw.bb156
  ], !dbg !2354

sw.bb:                                            ; preds = %if.end34
  %49 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2355
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %49, i32 0, i32 24, !dbg !2356
  store i32 2048, i32* %block_align, align 8, !dbg !2357
  %50 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2358
  %call37 = call i32 @ff_alloc_extradata(%struct.AVCodecParameters* %50, i32 34), !dbg !2359
  %51 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2360
  %extradata = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %51, i32 0, i32 3, !dbg !2362
  %52 = load i8*, i8** %extradata, align 8, !dbg !2362
  %tobool38 = icmp ne i8* %52, null, !dbg !2360
  br i1 %tobool38, label %if.end40, label %if.then39, !dbg !2363

if.then39:                                        ; preds = %sw.bb
  store i32 -12, i32* %retval, align 4, !dbg !2364
  br label %return, !dbg !2364

if.end40:                                         ; preds = %sw.bb
  %53 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2365
  %extradata41 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %53, i32 0, i32 3, !dbg !2366
  %54 = load i8*, i8** %extradata41, align 8, !dbg !2366
  call void @llvm.memset.p0i8.i64(i8* %54, i8 0, i64 34, i32 1, i1 false), !dbg !2367
  br label %sw.epilog, !dbg !2368

sw.bb42:                                          ; preds = %if.end34
  %55 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2369
  %channels43 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %55, i32 0, i32 22, !dbg !2370
  %56 = load i32, i32* %channels43, align 8, !dbg !2370
  %mul = mul nsw i32 16, %56, !dbg !2371
  %57 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2372
  %block_align44 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %57, i32 0, i32 24, !dbg !2373
  store i32 %mul, i32* %block_align44, align 8, !dbg !2374
  %58 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2375
  %seekable = getelementptr inbounds %struct.AVIOContext, %struct.AVIOContext* %58, i32 0, i32 19, !dbg !2377
  %59 = load i32, i32* %seekable, align 8, !dbg !2377
  %and = and i32 %59, 1, !dbg !2378
  %tobool45 = icmp ne i32 %and, 0, !dbg !2378
  br i1 %tobool45, label %if.then46, label %if.end53, !dbg !2379

if.then46:                                        ; preds = %sw.bb42
  %60 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2380
  %61 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2381
  %call47 = call i64 @avio_size(%struct.AVIOContext* %61), !dbg !2382
  %62 = load i32, i32* %start, align 4, !dbg !2383
  %conv48 = sext i32 %62 to i64, !dbg !2383
  %sub49 = sub nsw i64 %call47, %conv48, !dbg !2384
  %conv50 = trunc i64 %sub49 to i32, !dbg !2382
  %call51 = call i32 @av_get_audio_frame_duration2(%struct.AVCodecParameters* %60, i32 %conv50), !dbg !2385
  %conv52 = sext i32 %call51 to i64, !dbg !2387
  %63 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2388
  %duration = getelementptr inbounds %struct.AVStream, %struct.AVStream* %63, i32 0, i32 6, !dbg !2389
  store i64 %conv52, i64* %duration, align 8, !dbg !2390
  br label %if.end53, !dbg !2388

if.end53:                                         ; preds = %if.then46, %sw.bb42
  br label %sw.epilog, !dbg !2391

sw.bb54:                                          ; preds = %if.end34
  %64 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2392
  %channels55 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %64, i32 0, i32 22, !dbg !2393
  %65 = load i32, i32* %channels55, align 8, !dbg !2393
  %mul56 = mul nsw i32 20, %65, !dbg !2394
  %66 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2395
  %block_align57 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %66, i32 0, i32 24, !dbg !2396
  store i32 %mul56, i32* %block_align57, align 8, !dbg !2397
  %67 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2398
  %seekable58 = getelementptr inbounds %struct.AVIOContext, %struct.AVIOContext* %67, i32 0, i32 19, !dbg !2400
  %68 = load i32, i32* %seekable58, align 8, !dbg !2400
  %and59 = and i32 %68, 1, !dbg !2401
  %tobool60 = icmp ne i32 %and59, 0, !dbg !2401
  br i1 %tobool60, label %if.then61, label %if.end69, !dbg !2402

if.then61:                                        ; preds = %sw.bb54
  %69 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2403
  %70 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2404
  %call62 = call i64 @avio_size(%struct.AVIOContext* %70), !dbg !2405
  %71 = load i32, i32* %start, align 4, !dbg !2406
  %conv63 = sext i32 %71 to i64, !dbg !2406
  %sub64 = sub nsw i64 %call62, %conv63, !dbg !2407
  %conv65 = trunc i64 %sub64 to i32, !dbg !2405
  %call66 = call i32 @av_get_audio_frame_duration2(%struct.AVCodecParameters* %69, i32 %conv65), !dbg !2408
  %conv67 = sext i32 %call66 to i64, !dbg !2410
  %72 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2411
  %duration68 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %72, i32 0, i32 6, !dbg !2412
  store i64 %conv67, i64* %duration68, align 8, !dbg !2413
  br label %if.end69, !dbg !2411

if.end69:                                         ; preds = %if.then61, %sw.bb54
  br label %sw.epilog, !dbg !2414

sw.bb70:                                          ; preds = %if.end34
  %73 = load i32, i32* %version, align 4, !dbg !2415
  %cmp71 = icmp eq i32 %73, 2, !dbg !2417
  br i1 %cmp71, label %if.then73, label %if.end75, !dbg !2418

if.then73:                                        ; preds = %sw.bb70
  %74 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2419
  %call74 = call i32 @avio_rl32(%struct.AVIOContext* %74), !dbg !2420
  store i32 %call74, i32* %start, align 4, !dbg !2421
  br label %if.end75, !dbg !2422

if.end75:                                         ; preds = %if.then73, %sw.bb70
  %75 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2423
  %bits_per_coded_sample = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %75, i32 0, i32 7, !dbg !2424
  store i32 4, i32* %bits_per_coded_sample, align 8, !dbg !2425
  %76 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2426
  %channels76 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %76, i32 0, i32 22, !dbg !2427
  %77 = load i32, i32* %channels76, align 8, !dbg !2427
  %mul77 = mul nsw i32 36, %77, !dbg !2428
  %78 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2429
  %block_align78 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %78, i32 0, i32 24, !dbg !2430
  store i32 %mul77, i32* %block_align78, align 8, !dbg !2431
  %79 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2432
  %seekable79 = getelementptr inbounds %struct.AVIOContext, %struct.AVIOContext* %79, i32 0, i32 19, !dbg !2434
  %80 = load i32, i32* %seekable79, align 8, !dbg !2434
  %and80 = and i32 %80, 1, !dbg !2435
  %tobool81 = icmp ne i32 %and80, 0, !dbg !2435
  br i1 %tobool81, label %if.then82, label %if.end90, !dbg !2436

if.then82:                                        ; preds = %if.end75
  %81 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2437
  %82 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2438
  %call83 = call i64 @avio_size(%struct.AVIOContext* %82), !dbg !2439
  %83 = load i32, i32* %start, align 4, !dbg !2440
  %conv84 = sext i32 %83 to i64, !dbg !2440
  %sub85 = sub nsw i64 %call83, %conv84, !dbg !2441
  %conv86 = trunc i64 %sub85 to i32, !dbg !2439
  %call87 = call i32 @av_get_audio_frame_duration2(%struct.AVCodecParameters* %81, i32 %conv86), !dbg !2442
  %conv88 = sext i32 %call87 to i64, !dbg !2444
  %84 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2445
  %duration89 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %84, i32 0, i32 6, !dbg !2446
  store i64 %conv88, i64* %duration89, align 8, !dbg !2447
  br label %if.end90, !dbg !2445

if.end90:                                         ; preds = %if.then82, %if.end75
  br label %sw.epilog, !dbg !2448

sw.bb91:                                          ; preds = %if.end34
  %85 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2449
  %call92 = call i32 @avio_rl32(%struct.AVIOContext* %85), !dbg !2450
  store i32 %call92, i32* %start, align 4, !dbg !2451
  %86 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2452
  %87 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2454
  %88 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2455
  %pb93 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %88, i32 0, i32 4, !dbg !2456
  %89 = load %struct.AVIOContext*, %struct.AVIOContext** %pb93, align 8, !dbg !2456
  %call94 = call i32 @ff_get_extradata(%struct.AVFormatContext* %86, %struct.AVCodecParameters* %87, %struct.AVIOContext* %89, i32 32), !dbg !2457
  store i32 %call94, i32* %ret, align 4, !dbg !2458
  %cmp95 = icmp slt i32 %call94, 0, !dbg !2459
  br i1 %cmp95, label %if.then97, label %if.end98, !dbg !2460

if.then97:                                        ; preds = %sw.bb91
  %90 = load i32, i32* %ret, align 4, !dbg !2461
  store i32 %90, i32* %retval, align 4, !dbg !2462
  br label %return, !dbg !2462

if.end98:                                         ; preds = %sw.bb91
  %91 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2463
  %seekable99 = getelementptr inbounds %struct.AVIOContext, %struct.AVIOContext* %91, i32 0, i32 19, !dbg !2465
  %92 = load i32, i32* %seekable99, align 8, !dbg !2465
  %and100 = and i32 %92, 1, !dbg !2466
  %tobool101 = icmp ne i32 %and100, 0, !dbg !2466
  br i1 %tobool101, label %if.then102, label %if.end110, !dbg !2467

if.then102:                                       ; preds = %if.end98
  %93 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2468
  %94 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2469
  %call103 = call i64 @avio_size(%struct.AVIOContext* %94), !dbg !2470
  %95 = load i32, i32* %start, align 4, !dbg !2471
  %conv104 = sext i32 %95 to i64, !dbg !2471
  %sub105 = sub nsw i64 %call103, %conv104, !dbg !2472
  %conv106 = trunc i64 %sub105 to i32, !dbg !2470
  %call107 = call i32 @av_get_audio_frame_duration2(%struct.AVCodecParameters* %93, i32 %conv106), !dbg !2473
  %conv108 = sext i32 %call107 to i64, !dbg !2475
  %96 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2476
  %duration109 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %96, i32 0, i32 6, !dbg !2477
  store i64 %conv108, i64* %duration109, align 8, !dbg !2478
  br label %if.end110, !dbg !2476

if.end110:                                        ; preds = %if.then102, %if.end98
  br label %sw.epilog, !dbg !2479

sw.bb111:                                         ; preds = %if.end34
  %97 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2480
  %channels112 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %97, i32 0, i32 22, !dbg !2481
  %98 = load i32, i32* %channels112, align 8, !dbg !2481
  %mul113 = mul nsw i32 8, %98, !dbg !2482
  %99 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2483
  %block_align114 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %99, i32 0, i32 24, !dbg !2484
  store i32 %mul113, i32* %block_align114, align 8, !dbg !2485
  %100 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2486
  %pb115 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %100, i32 0, i32 4, !dbg !2487
  %101 = load %struct.AVIOContext*, %struct.AVIOContext** %pb115, align 8, !dbg !2487
  %102 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2488
  %pb116 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %102, i32 0, i32 4, !dbg !2489
  %103 = load %struct.AVIOContext*, %struct.AVIOContext** %pb116, align 8, !dbg !2489
  store %struct.AVIOContext* %103, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2490
  %104 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2491
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %104, i64 0, i32 1) #6, !dbg !2492
  %sub118 = sub nsw i64 420, %call.i, !dbg !2493
  %call119 = call i64 @avio_skip(%struct.AVIOContext* %101, i64 %sub118), !dbg !2494
  %105 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2496
  %codecpar120 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %105, i32 0, i32 19, !dbg !2498
  %106 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar120, align 8, !dbg !2498
  %107 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2499
  %channels121 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %107, i32 0, i32 22, !dbg !2500
  %108 = load i32, i32* %channels121, align 8, !dbg !2500
  %mul122 = mul nsw i32 32, %108, !dbg !2501
  %call123 = call i32 @ff_alloc_extradata(%struct.AVCodecParameters* %106, i32 %mul122), !dbg !2502
  store i32 %call123, i32* %ret, align 4, !dbg !2503
  %cmp124 = icmp slt i32 %call123, 0, !dbg !2504
  br i1 %cmp124, label %if.then126, label %if.end127, !dbg !2505

if.then126:                                       ; preds = %sw.bb111
  %109 = load i32, i32* %ret, align 4, !dbg !2506
  store i32 %109, i32* %retval, align 4, !dbg !2507
  br label %return, !dbg !2507

if.end127:                                        ; preds = %sw.bb111
  store i32 0, i32* %i, align 4, !dbg !2508
  br label %for.cond128, !dbg !2510

for.cond128:                                      ; preds = %for.inc140, %if.end127
  %110 = load i32, i32* %i, align 4, !dbg !2511
  %111 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2514
  %channels129 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %111, i32 0, i32 22, !dbg !2515
  %112 = load i32, i32* %channels129, align 8, !dbg !2515
  %cmp130 = icmp slt i32 %110, %112, !dbg !2516
  br i1 %cmp130, label %for.body132, label %for.end142, !dbg !2517

for.body132:                                      ; preds = %for.cond128
  %113 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2518
  %pb133 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %113, i32 0, i32 4, !dbg !2520
  %114 = load %struct.AVIOContext*, %struct.AVIOContext** %pb133, align 8, !dbg !2520
  %115 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2521
  %codecpar134 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %115, i32 0, i32 19, !dbg !2522
  %116 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar134, align 8, !dbg !2522
  %extradata135 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %116, i32 0, i32 3, !dbg !2523
  %117 = load i8*, i8** %extradata135, align 8, !dbg !2523
  %118 = load i32, i32* %i, align 4, !dbg !2524
  %mul136 = mul nsw i32 32, %118, !dbg !2525
  %idx.ext = sext i32 %mul136 to i64, !dbg !2526
  %add.ptr = getelementptr inbounds i8, i8* %117, i64 %idx.ext, !dbg !2526
  %call137 = call i32 @avio_read(%struct.AVIOContext* %114, i8* %add.ptr, i32 32), !dbg !2527
  %119 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2528
  %pb138 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %119, i32 0, i32 4, !dbg !2529
  %120 = load %struct.AVIOContext*, %struct.AVIOContext** %pb138, align 8, !dbg !2529
  %call139 = call i64 @avio_skip(%struct.AVIOContext* %120, i64 8), !dbg !2530
  br label %for.inc140, !dbg !2531

for.inc140:                                       ; preds = %for.body132
  %121 = load i32, i32* %i, align 4, !dbg !2532
  %inc141 = add nsw i32 %121, 1, !dbg !2532
  store i32 %inc141, i32* %i, align 4, !dbg !2532
  br label %for.cond128, !dbg !2534, !llvm.loop !2535

for.end142:                                       ; preds = %for.cond128
  %122 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2537
  %seekable143 = getelementptr inbounds %struct.AVIOContext, %struct.AVIOContext* %122, i32 0, i32 19, !dbg !2539
  %123 = load i32, i32* %seekable143, align 8, !dbg !2539
  %and144 = and i32 %123, 1, !dbg !2540
  %tobool145 = icmp ne i32 %and144, 0, !dbg !2540
  br i1 %tobool145, label %if.then146, label %if.end155, !dbg !2541

if.then146:                                       ; preds = %for.end142
  %124 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2542
  %call147 = call i64 @avio_size(%struct.AVIOContext* %124), !dbg !2543
  %125 = load i32, i32* %start, align 4, !dbg !2544
  %conv148 = sext i32 %125 to i64, !dbg !2544
  %sub149 = sub nsw i64 %call147, %conv148, !dbg !2545
  %126 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2546
  %channels150 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %126, i32 0, i32 22, !dbg !2547
  %127 = load i32, i32* %channels150, align 8, !dbg !2547
  %mul151 = mul nsw i32 8, %127, !dbg !2548
  %conv152 = sext i32 %mul151 to i64, !dbg !2549
  %div = sdiv i64 %sub149, %conv152, !dbg !2550
  %mul153 = mul nsw i64 %div, 14, !dbg !2551
  %128 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2552
  %duration154 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %128, i32 0, i32 6, !dbg !2553
  store i64 %mul153, i64* %duration154, align 8, !dbg !2554
  br label %if.end155, !dbg !2552

if.end155:                                        ; preds = %if.then146, %for.end142
  br label %sw.epilog, !dbg !2555

sw.bb156:                                         ; preds = %if.end34, %if.end34
  %129 = load i32, i32* %version, align 4, !dbg !2556
  %cmp157 = icmp ne i32 %129, 4, !dbg !2558
  br i1 %cmp157, label %if.then159, label %if.end161, !dbg !2559

if.then159:                                       ; preds = %sw.bb156
  %130 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2560
  %call160 = call i32 @avio_rl32(%struct.AVIOContext* %130), !dbg !2561
  store i32 %call160, i32* %start, align 4, !dbg !2562
  br label %if.end161, !dbg !2563

if.end161:                                        ; preds = %if.then159, %sw.bb156
  %131 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2564
  %seekable162 = getelementptr inbounds %struct.AVIOContext, %struct.AVIOContext* %131, i32 0, i32 19, !dbg !2566
  %132 = load i32, i32* %seekable162, align 8, !dbg !2566
  %and163 = and i32 %132, 1, !dbg !2567
  %tobool164 = icmp ne i32 %and163, 0, !dbg !2567
  br i1 %tobool164, label %if.then165, label %if.end174, !dbg !2568

if.then165:                                       ; preds = %if.end161
  %133 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2569
  %call166 = call i64 @avio_size(%struct.AVIOContext* %133), !dbg !2570
  %134 = load i32, i32* %start, align 4, !dbg !2571
  %conv167 = sext i32 %134 to i64, !dbg !2571
  %sub168 = sub nsw i64 %call166, %conv167, !dbg !2572
  %div169 = sdiv i64 %sub168, 2, !dbg !2573
  %135 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2574
  %channels170 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %135, i32 0, i32 22, !dbg !2575
  %136 = load i32, i32* %channels170, align 8, !dbg !2575
  %conv171 = sext i32 %136 to i64, !dbg !2574
  %div172 = sdiv i64 %div169, %conv171, !dbg !2576
  %137 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2577
  %duration173 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %137, i32 0, i32 6, !dbg !2578
  store i64 %div172, i64* %duration173, align 8, !dbg !2579
  br label %if.end174, !dbg !2577

if.end174:                                        ; preds = %if.then165, %if.end161
  br label %sw.epilog, !dbg !2580

sw.epilog:                                        ; preds = %if.end34, %if.end174, %if.end155, %if.end110, %if.end90, %if.end69, %if.end53, %if.end40
  %138 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2581
  %139 = load i32, i32* %start, align 4, !dbg !2582
  %conv175 = sext i32 %139 to i64, !dbg !2582
  %140 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2583
  store %struct.AVIOContext* %140, %struct.AVIOContext** %s.addr.i192, align 8, !dbg !2584
  %141 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i192, align 8, !dbg !2585
  %call.i193 = call i64 @avio_seek(%struct.AVIOContext* %141, i64 0, i32 1) #6, !dbg !2586
  %sub177 = sub nsw i64 %conv175, %call.i193, !dbg !2587
  %call178 = call i64 @avio_skip(%struct.AVIOContext* %138, i64 %sub177), !dbg !2588
  %142 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2590
  %codec_id179 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %142, i32 0, i32 1, !dbg !2592
  %143 = load i32, i32* %codec_id179, align 4, !dbg !2592
  %cmp180 = icmp eq i32 %143, 88076, !dbg !2593
  br i1 %cmp180, label %if.then182, label %if.end190, !dbg !2594

if.then182:                                       ; preds = %sw.epilog
  %144 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2595
  %145 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2597
  %call183 = call i32 @avio_rb32(%struct.AVIOContext* %145), !dbg !2598
  %146 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2599
  %call184 = call i32 @avio_rb32(%struct.AVIOContext* %146), !dbg !2600
  %add = add i32 %call183, %call184, !dbg !2602
  %conv185 = zext i32 %add to i64, !dbg !2598
  %call186 = call i64 @avio_skip(%struct.AVIOContext* %144, i64 %conv185), !dbg !2603
  %147 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2605
  %call187 = call i32 @avio_rb32(%struct.AVIOContext* %147), !dbg !2606
  %conv188 = zext i32 %call187 to i64, !dbg !2606
  %148 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2607
  %duration189 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %148, i32 0, i32 6, !dbg !2608
  store i64 %conv188, i64* %duration189, align 8, !dbg !2609
  br label %if.end190, !dbg !2610

if.end190:                                        ; preds = %if.then182, %sw.epilog
  %149 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2611
  %150 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2612
  %sample_rate191 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %150, i32 0, i32 23, !dbg !2613
  %151 = load i32, i32* %sample_rate191, align 4, !dbg !2613
  call void @avpriv_set_pts_info(%struct.AVStream* %149, i32 64, i32 1, i32 %151), !dbg !2614
  store i32 0, i32* %retval, align 4, !dbg !2615
  br label %return, !dbg !2615

return:                                           ; preds = %if.end190, %if.then126, %if.then97, %if.then39, %if.then33, %if.then26, %for.end, %if.then16, %if.then
  %152 = load i32, i32* %retval, align 4, !dbg !2616
  ret i32 %152, !dbg !2616
}

; Function Attrs: nounwind uwtable
define internal i32 @rsd_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2617 {
entry:
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2217, metadata !2160), !dbg !2620
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2622, metadata !2160), !dbg !2623
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2624, metadata !2160), !dbg !2625
  call void @llvm.dbg.declare(metadata %struct.AVCodecParameters** %par, metadata !2626, metadata !2160), !dbg !2627
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2628
  %streams = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 7, !dbg !2629
  %1 = load %struct.AVStream**, %struct.AVStream*** %streams, align 8, !dbg !2629
  %arrayidx = getelementptr inbounds %struct.AVStream*, %struct.AVStream** %1, i64 0, !dbg !2628
  %2 = load %struct.AVStream*, %struct.AVStream** %arrayidx, align 8, !dbg !2628
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %2, i32 0, i32 19, !dbg !2630
  %3 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2630
  store %struct.AVCodecParameters* %3, %struct.AVCodecParameters** %par, align 8, !dbg !2627
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2631, metadata !2160), !dbg !2632
  call void @llvm.dbg.declare(metadata i32* %size, metadata !2633, metadata !2160), !dbg !2634
  store i32 1024, i32* %size, align 4, !dbg !2634
  call void @llvm.dbg.declare(metadata i64* %pos, metadata !2635, metadata !2160), !dbg !2636
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2637
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %4, i32 0, i32 4, !dbg !2639
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2639
  %call = call i32 @avio_feof(%struct.AVIOContext* %5), !dbg !2640
  %tobool = icmp ne i32 %call, 0, !dbg !2640
  br i1 %tobool, label %if.then, label %if.end, !dbg !2641

if.then:                                          ; preds = %entry
  store i32 -541478725, i32* %retval, align 4, !dbg !2642
  br label %return, !dbg !2642

if.end:                                           ; preds = %entry
  %6 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2643
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %6, i32 0, i32 4, !dbg !2644
  %7 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2644
  store %struct.AVIOContext* %7, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2645
  %8 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2646
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %8, i64 0, i32 1) #6, !dbg !2647
  store i64 %call.i, i64* %pos, align 8, !dbg !2648
  %9 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2649
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %9, i32 0, i32 1, !dbg !2651
  %10 = load i32, i32* %codec_id, align 4, !dbg !2651
  %cmp = icmp eq i32 %10, 71683, !dbg !2652
  br i1 %cmp, label %if.then11, label %lor.lhs.false, !dbg !2653

lor.lhs.false:                                    ; preds = %if.end
  %11 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2654
  %codec_id3 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %11, i32 0, i32 1, !dbg !2655
  %12 = load i32, i32* %codec_id3, align 4, !dbg !2655
  %cmp4 = icmp eq i32 %12, 71686, !dbg !2656
  br i1 %cmp4, label %if.then11, label %lor.lhs.false5, !dbg !2657

lor.lhs.false5:                                   ; preds = %lor.lhs.false
  %13 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2658
  %codec_id6 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %13, i32 0, i32 1, !dbg !2659
  %14 = load i32, i32* %codec_id6, align 4, !dbg !2659
  %cmp7 = icmp eq i32 %14, 69633, !dbg !2660
  br i1 %cmp7, label %if.then11, label %lor.lhs.false8, !dbg !2661

lor.lhs.false8:                                   ; preds = %lor.lhs.false5
  %15 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2662
  %codec_id9 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %15, i32 0, i32 1, !dbg !2663
  %16 = load i32, i32* %codec_id9, align 4, !dbg !2663
  %cmp10 = icmp eq i32 %16, 88076, !dbg !2664
  br i1 %cmp10, label %if.then11, label %if.else, !dbg !2665

if.then11:                                        ; preds = %lor.lhs.false8, %lor.lhs.false5, %lor.lhs.false, %if.end
  %17 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2667
  %pb12 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %17, i32 0, i32 4, !dbg !2669
  %18 = load %struct.AVIOContext*, %struct.AVIOContext** %pb12, align 8, !dbg !2669
  %19 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2670
  %20 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2671
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %20, i32 0, i32 24, !dbg !2672
  %21 = load i32, i32* %block_align, align 8, !dbg !2672
  %call13 = call i32 @av_get_packet(%struct.AVIOContext* %18, %struct.AVPacket* %19, i32 %21), !dbg !2673
  store i32 %call13, i32* %ret, align 4, !dbg !2674
  br label %if.end49, !dbg !2675

if.else:                                          ; preds = %lor.lhs.false8
  %22 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2676
  %codec_tag = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %22, i32 0, i32 2, !dbg !2679
  %23 = load i32, i32* %codec_tag, align 8, !dbg !2679
  %cmp14 = icmp eq i32 %23, 1346650455, !dbg !2680
  br i1 %cmp14, label %land.lhs.true, label %if.else45, !dbg !2681

land.lhs.true:                                    ; preds = %if.else
  %24 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2682
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %24, i32 0, i32 22, !dbg !2683
  %25 = load i32, i32* %channels, align 8, !dbg !2683
  %cmp15 = icmp sgt i32 %25, 1, !dbg !2684
  br i1 %cmp15, label %if.then16, label %if.else45, !dbg !2685

if.then16:                                        ; preds = %land.lhs.true
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2687, metadata !2160), !dbg !2689
  call void @llvm.dbg.declare(metadata i32* %ch, metadata !2690, metadata !2160), !dbg !2691
  %26 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2692
  %27 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2693
  %block_align17 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %27, i32 0, i32 24, !dbg !2694
  %28 = load i32, i32* %block_align17, align 8, !dbg !2694
  %call18 = call i32 @av_new_packet(%struct.AVPacket* %26, i32 %28), !dbg !2695
  store i32 %call18, i32* %ret, align 4, !dbg !2696
  %29 = load i32, i32* %ret, align 4, !dbg !2697
  %cmp19 = icmp slt i32 %29, 0, !dbg !2699
  br i1 %cmp19, label %if.then20, label %if.end21, !dbg !2700

if.then20:                                        ; preds = %if.then16
  %30 = load i32, i32* %ret, align 4, !dbg !2701
  store i32 %30, i32* %retval, align 4, !dbg !2702
...
for.cond:                                         ; preds = %for.inc42, %if.end21
  %31 = load i32, i32* %i, align 4, !dbg !2706
  %cmp22 = icmp slt i32 %31, 4, !dbg !2709
  br i1 %cmp22, label %for.body, label %for.end44, !dbg !2710

for.body:                                         ; preds = %for.cond
  store i32 0, i32* %ch, align 4, !dbg !2711
  br label %for.cond23, !dbg !2714

for.cond23:                                       ; preds = %for.inc, %for.body
  %32 = load i32, i32* %ch, align 4, !dbg !2715
  %33 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2718
  %channels24 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %33, i32 0, i32 22, !dbg !2719
  %34 = load i32, i32* %channels24, align 8, !dbg !2719
  %cmp25 = icmp slt i32 %32, %34, !dbg !2720
  br i1 %cmp25, label %for.body26, label %for.end, !dbg !2721

for.body26:                                       ; preds = %for.cond23
  %35 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2722
  %pb27 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %35, i32 0, i32 4, !dbg !2724
  %36 = load %struct.AVIOContext*, %struct.AVIOContext** %pb27, align 8, !dbg !2724
  %call28 = call i32 @avio_r8(%struct.AVIOContext* %36), !dbg !2725
  %conv = trunc i32 %call28 to i8, !dbg !2725
  %37 = load i32, i32* %ch, align 4, !dbg !2726
  %mul = mul nsw i32 %37, 8, !dbg !2727
  %38 = load i32, i32* %i, align 4, !dbg !2728
  %mul29 = mul nsw i32 %38, 2, !dbg !2729
  %add = add nsw i32 %mul, %mul29, !dbg !2730
  %add30 = add nsw i32 %add, 0, !dbg !2731
  %idxprom = sext i32 %add30 to i64, !dbg !2732
  %39 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2732
  %data = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %39, i32 0, i32 3, !dbg !2733
  %40 = load i8*, i8** %data, align 8, !dbg !2733
  %arrayidx31 = getelementptr inbounds i8, i8* %40, i64 %idxprom, !dbg !2732
  store i8 %conv, i8* %arrayidx31, align 1, !dbg !2734
  %41 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2735
  %pb32 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %41, i32 0, i32 4, !dbg !2736
  %42 = load %struct.AVIOContext*, %struct.AVIOContext** %pb32, align 8, !dbg !2736
  %call33 = call i32 @avio_r8(%struct.AVIOContext* %42), !dbg !2737
  %conv34 = trunc i32 %call33 to i8, !dbg !2737
  %43 = load i32, i32* %ch, align 4, !dbg !2738
  %mul35 = mul nsw i32 %43, 8, !dbg !2739
  %44 = load i32, i32* %i, align 4, !dbg !2740
  %mul36 = mul nsw i32 %44, 2, !dbg !2741
  %add37 = add nsw i32 %mul35, %mul36, !dbg !2742
  %add38 = add nsw i32 %add37, 1, !dbg !2743
  %idxprom39 = sext i32 %add38 to i64, !dbg !2744
  %45 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2744
  %data40 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %45, i32 0, i32 3, !dbg !2745
  %46 = load i8*, i8** %data40, align 8, !dbg !2745
  %arrayidx41 = getelementptr inbounds i8, i8* %46, i64 %idxprom39, !dbg !2744
  store i8 %conv34, i8* %arrayidx41, align 1, !dbg !2746
  br label %for.inc, !dbg !2747

for.inc:                                          ; preds = %for.body26
  %47 = load i32, i32* %ch, align 4, !dbg !2748
  %inc = add nsw i32 %47, 1, !dbg !2748
  store i32 %inc, i32* %ch, align 4, !dbg !2748
  br label %for.cond23, !dbg !2750, !llvm.loop !2751

for.end:                                          ; preds = %for.cond23
  br label %for.inc42, !dbg !2753

for.inc42:                                        ; preds = %for.end
  %48 = load i32, i32* %i, align 4, !dbg !2754
  %inc43 = add nsw i32 %48, 1, !dbg !2754
  store i32 %inc43, i32* %i, align 4, !dbg !2754
  br label %for.cond, !dbg !2756, !llvm.loop !2757

for.end44:                                        ; preds = %for.cond
  store i32 0, i32* %ret, align 4, !dbg !2759
  br label %if.end48, !dbg !2760

if.else45:                                        ; preds = %land.lhs.true, %if.else
  %49 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2761
  %pb46 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %49, i32 0, i32 4, !dbg !2763
  %50 = load %struct.AVIOContext*, %struct.AVIOContext** %pb46, align 8, !dbg !2763
  %51 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2764
  %52 = load i32, i32* %size, align 4, !dbg !2765
  %call47 = call i32 @av_get_packet(%struct.AVIOContext* %50, %struct.AVPacket* %51, i32 %52), !dbg !2766
  store i32 %call47, i32* %ret, align 4, !dbg !2767
  br label %if.end48

if.end48:                                         ; preds = %if.else45, %for.end44
  br label %if.end49

if.end49:                                         ; preds = %if.end48, %if.then11
  %53 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %par, align 8, !dbg !2768
  %codec_id50 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %53, i32 0, i32 1, !dbg !2770
  %54 = load i32, i32* %codec_id50, align 4, !dbg !2770
  %cmp51 = icmp eq i32 %54, 88076, !dbg !2771
  br i1 %cmp51, label %land.lhs.true53, label %if.end63, !dbg !2772

land.lhs.true53:                                  ; preds = %if.end49
  %55 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2773
  %size54 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %55, i32 0, i32 4, !dbg !2775
  %56 = load i32, i32* %size54, align 8, !dbg !2775
  %cmp55 = icmp sge i32 %56, 1, !dbg !2776
  br i1 %cmp55, label %if.then57, label %if.end63, !dbg !2777

if.then57:                                        ; preds = %land.lhs.true53
  %57 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2778
  %data58 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %57, i32 0, i32 3, !dbg !2779
  %58 = load i8*, i8** %data58, align 8, !dbg !2779
  %arrayidx59 = getelementptr inbounds i8, i8* %58, i64 0, !dbg !2778
  %59 = load i8, i8* %arrayidx59, align 1, !dbg !2778
  %conv60 = zext i8 %59 to i32, !dbg !2778
  %shr = ashr i32 %conv60, 2, !dbg !2780
  %mul61 = mul nsw i32 %shr, 512, !dbg !2781
  %conv62 = sext i32 %mul61 to i64, !dbg !2782
  %60 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2783
  %duration = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %60, i32 0, i32 9, !dbg !2784
  store i64 %conv62, i64* %duration, align 8, !dbg !2785
  br label %if.end63, !dbg !2783

if.end63:                                         ; preds = %if.then57, %land.lhs.true53, %if.end49
  %61 = load i64, i64* %pos, align 8, !dbg !2786
  %62 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2787
  %pos64 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %62, i32 0, i32 10, !dbg !2788
  store i64 %61, i64* %pos64, align 8, !dbg !2789
  %63 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2790
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %63, i32 0, i32 5, !dbg !2791
  store i32 0, i32* %stream_index, align 4, !dbg !2792
  %64 = load i32, i32* %ret, align 4, !dbg !2793
  store i32 %64, i32* %retval, align 4, !dbg !2794
  br label %return, !dbg !2794

return:                                           ; preds = %if.end63, %if.then20, %if.then
  %65 = load i32, i32* %retval, align 4, !dbg !2795
  ret i32 %65, !dbg !2795
}
...
declare i32 @av_get_audio_frame_duration2(%struct.AVCodecParameters*, i32) #3
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--rsd.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!927 = !{!928, !2143, !2149}
!928 = distinct !DIGlobalVariable(name: "ff_rsd_demuxer", scope: !0, file: !929, line: 212, type: !930, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_rsd_demuxer)
!929 = !DIFile(filename: "libavformat/rsd.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2143 = distinct !DIGlobalVariable(name: "rsd_tags", scope: !0, file: !929, line: 28, type: !2144, isLocal: true, isDefinition: true, variable: [9 x %struct.AVCodecTag]* @rsd_tags)
!2144 = !DICompositeType(tag: DW_TAG_array_type, baseType: !2145, size: 576, align: 32, elements: !2147)
!2145 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !2146)
!2146 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVCodecTag", file: !946, line: 47, baseType: !945)
!2147 = !{!2148}
!2148 = !DISubrange(count: 9)
!2149 = distinct !DIGlobalVariable(name: "rsd_unsupported_tags", scope: !0, file: !929, line: 40, type: !2150, isLocal: true, isDefinition: true, variable: [1 x i32]* @rsd_unsupported_tags)
!2150 = !DICompositeType(tag: DW_TAG_array_type, baseType: !2151, size: 32, align: 32, elements: !2152)
!2151 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !923)
!2152 = !{!2153}
...
!2157 = distinct !DISubprogram(name: "rsd_probe", scope: !929, file: !929, line: 44, type: !999, isLocal: true, isDefinition: true, scopeLine: 45, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2158)
!2158 = !{}
!2159 = !DILocalVariable(name: "p", arg: 1, scope: !2157, file: !929, line: 44, type: !1001)
!2160 = !DIExpression()
!2161 = !DILocation(line: 44, column: 35, scope: !2157)
!2162 = !DILocation(line: 46, column: 16, scope: !2163)
!2163 = distinct !DILexicalBlock(scope: !2157, file: !929, line: 46, column: 9)
!2164 = !DILocation(line: 46, column: 19, scope: !2163)
!2165 = !DILocation(line: 46, column: 9, scope: !2163)
!2166 = !DILocation(line: 46, column: 34, scope: !2163)
!2167 = !DILocation(line: 46, column: 37, scope: !2168)
!2168 = !DILexicalBlockFile(scope: !2163, file: !929, discriminator: 1)
!2169 = !DILocation(line: 46, column: 40, scope: !2168)
!2170 = !DILocation(line: 46, column: 47, scope: !2168)
!2171 = !DILocation(line: 46, column: 53, scope: !2168)
!2172 = !DILocation(line: 46, column: 57, scope: !2168)
!2173 = !DILocation(line: 46, column: 60, scope: !2174)
!2174 = !DILexicalBlockFile(scope: !2163, file: !929, discriminator: 2)
!2175 = !DILocation(line: 46, column: 63, scope: !2174)
!2176 = !DILocation(line: 46, column: 70, scope: !2174)
!2177 = !DILocation(line: 46, column: 76, scope: !2174)
!2178 = !DILocation(line: 46, column: 9, scope: !2174)
!2179 = !DILocation(line: 47, column: 9, scope: !2163)
!2180 = !DILocation(line: 48, column: 41, scope: !2181)
!2181 = distinct !DILexicalBlock(scope: !2157, file: !929, line: 48, column: 9)
!2182 = !DILocation(line: 48, column: 44, scope: !2181)
!2183 = !DILocation(line: 48, column: 48, scope: !2181)
!2184 = !DILocation(line: 48, column: 55, scope: !2181)
!2185 = !DILocation(line: 48, column: 58, scope: !2181)
!2186 = !DILocation(line: 48, column: 64, scope: !2181)
!2187 = !DILocation(line: 48, column: 100, scope: !2188)
!2188 = !DILexicalBlockFile(scope: !2181, file: !929, discriminator: 1)
!2189 = !DILocation(line: 48, column: 103, scope: !2188)
!2190 = !DILocation(line: 48, column: 107, scope: !2188)
!2191 = !DILocation(line: 48, column: 114, scope: !2188)
!2192 = !DILocation(line: 48, column: 68, scope: !2188)
!2193 = !DILocation(line: 48, column: 9, scope: !2188)
!2194 = !DILocation(line: 49, column: 9, scope: !2181)
!2195 = !DILocation(line: 50, column: 41, scope: !2196)
!2196 = distinct !DILexicalBlock(scope: !2157, file: !929, line: 50, column: 9)
!2197 = !DILocation(line: 50, column: 44, scope: !2196)
!2198 = !DILocation(line: 50, column: 48, scope: !2196)
!2199 = !DILocation(line: 50, column: 56, scope: !2196)
!2200 = !DILocation(line: 50, column: 59, scope: !2196)
!2201 = !DILocation(line: 50, column: 69, scope: !2196)
!2202 = !DILocation(line: 50, column: 105, scope: !2203)
!2203 = !DILexicalBlockFile(scope: !2196, file: !929, discriminator: 1)
!2204 = !DILocation(line: 50, column: 108, scope: !2203)
!2205 = !DILocation(line: 50, column: 112, scope: !2203)
!2206 = !DILocation(line: 50, column: 120, scope: !2203)
!2207 = !DILocation(line: 50, column: 73, scope: !2203)
!2208 = !DILocation(line: 50, column: 9, scope: !2203)
!2209 = !DILocation(line: 51, column: 9, scope: !2196)
!2210 = !DILocation(line: 52, column: 5, scope: !2157)
!2211 = !DILocation(line: 53, column: 1, scope: !2157)
!2212 = distinct !DISubprogram(name: "rsd_read_header", scope: !929, file: !929, line: 55, type: !2213, isLocal: true, isDefinition: true, scopeLine: 56, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2158)
!2213 = !DISubroutineType(types: !2214)
!2214 = !{!926, !2215}
!2215 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2216, size: 64, align: 64)
!2216 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1016)
!2217 = !DILocalVariable(name: "s", arg: 1, scope: !2218, file: !628, line: 557, type: !1222)
!2218 = distinct !DISubprogram(name: "avio_tell", scope: !628, file: !628, line: 557, type: !2219, isLocal: true, isDefinition: true, scopeLine: 558, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2158)
!2219 = !DISubroutineType(types: !2220)
!2220 = !{!1060, !1222}
!2221 = !DILocation(line: 557, column: 77, scope: !2218, inlinedAt: !2222)
!2222 = distinct !DILocation(line: 159, column: 27, scope: !2212)
!2223 = !DILocation(line: 557, column: 77, scope: !2218, inlinedAt: !2224)
!2224 = distinct !DILocation(line: 137, column: 34, scope: !2225)
!2225 = distinct !DILexicalBlock(scope: !2212, file: !929, line: 97, column: 28)
!2226 = !DILocalVariable(name: "s", arg: 1, scope: !2212, file: !929, line: 55, type: !2215)
!2227 = !DILocation(line: 55, column: 45, scope: !2212)
!2228 = !DILocalVariable(name: "pb", scope: !2212, file: !929, line: 57, type: !1222)
!2229 = !DILocation(line: 57, column: 18, scope: !2212)
!2230 = !DILocation(line: 57, column: 23, scope: !2212)
!2231 = !DILocation(line: 57, column: 26, scope: !2212)
!2232 = !DILocalVariable(name: "i", scope: !2212, file: !929, line: 58, type: !926)
!2233 = !DILocation(line: 58, column: 9, scope: !2212)
!2234 = !DILocalVariable(name: "ret", scope: !2212, file: !929, line: 58, type: !926)
!2235 = !DILocation(line: 58, column: 12, scope: !2212)
!2236 = !DILocalVariable(name: "version", scope: !2212, file: !929, line: 58, type: !926)
!2237 = !DILocation(line: 58, column: 17, scope: !2212)
!2238 = !DILocalVariable(name: "start", scope: !2212, file: !929, line: 58, type: !926)
!2239 = !DILocation(line: 58, column: 26, scope: !2212)
!2240 = !DILocalVariable(name: "par", scope: !2212, file: !929, line: 59, type: !1733)
!2241 = !DILocation(line: 59, column: 24, scope: !2212)
!2242 = !DILocalVariable(name: "st", scope: !2212, file: !929, line: 60, type: !1290)
!2243 = !DILocation(line: 60, column: 15, scope: !2212)
!2244 = !DILocation(line: 60, column: 40, scope: !2212)
!2245 = !DILocation(line: 60, column: 20, scope: !2212)
!2246 = !DILocation(line: 62, column: 10, scope: !2247)
!2247 = distinct !DILexicalBlock(scope: !2212, file: !929, line: 62, column: 9)
!2248 = !DILocation(line: 62, column: 9, scope: !2212)
!2249 = !DILocation(line: 63, column: 9, scope: !2247)
!2250 = !DILocation(line: 65, column: 15, scope: !2212)
!2251 = !DILocation(line: 65, column: 5, scope: !2212)
!2252 = !DILocation(line: 66, column: 23, scope: !2212)
!2253 = !DILocation(line: 66, column: 15, scope: !2212)
!2254 = !DILocation(line: 66, column: 27, scope: !2212)
!2255 = !DILocation(line: 66, column: 13, scope: !2212)
!2256 = !DILocation(line: 68, column: 11, scope: !2212)
!2257 = !DILocation(line: 68, column: 15, scope: !2212)
!2258 = !DILocation(line: 68, column: 9, scope: !2212)
!2259 = !DILocation(line: 69, column: 5, scope: !2212)
!2260 = !DILocation(line: 69, column: 10, scope: !2212)
!2261 = !DILocation(line: 69, column: 21, scope: !2212)
!2262 = !DILocation(line: 70, column: 32, scope: !2212)
!2263 = !DILocation(line: 70, column: 22, scope: !2212)
!2264 = !DILocation(line: 70, column: 5, scope: !2212)
!2265 = !DILocation(line: 70, column: 10, scope: !2212)
!2266 = !DILocation(line: 70, column: 20, scope: !2212)
!2267 = !DILocation(line: 71, column: 47, scope: !2212)
!2268 = !DILocation(line: 71, column: 52, scope: !2212)
!2269 = !DILocation(line: 71, column: 21, scope: !2212)
!2270 = !DILocation(line: 71, column: 5, scope: !2212)
!2271 = !DILocation(line: 71, column: 10, scope: !2212)
!2272 = !DILocation(line: 71, column: 19, scope: !2212)
!2273 = !DILocation(line: 72, column: 10, scope: !2274)
!2274 = distinct !DILexicalBlock(scope: !2212, file: !929, line: 72, column: 9)
!2275 = !DILocation(line: 72, column: 15, scope: !2274)
!2276 = !DILocation(line: 72, column: 9, scope: !2212)
!2277 = !DILocalVariable(name: "tag_buf", scope: !2278, file: !929, line: 73, type: !934)
!2278 = distinct !DILexicalBlock(scope: !2274, file: !929, line: 72, column: 25)
!2279 = !DILocation(line: 73, column: 21, scope: !2278)
!2280 = !DILocation(line: 73, column: 53, scope: !2278)
!2281 = !DILocation(line: 73, column: 63, scope: !2278)
!2282 = !DILocation(line: 73, column: 68, scope: !2278)
!2283 = !DILocation(line: 73, column: 73, scope: !2278)
!2284 = !DILocation(line: 73, column: 31, scope: !2285)
!2285 = !DILexicalBlockFile(scope: !2278, file: !929, discriminator: 1)
!2286 = !DILocation(line: 74, column: 15, scope: !2287)
!2287 = distinct !DILexicalBlock(scope: !2278, file: !929, line: 74, column: 9)
!2288 = !DILocation(line: 74, column: 14, scope: !2287)
!2289 = !DILocation(line: 74, column: 19, scope: !2290)
!2290 = !DILexicalBlockFile(scope: !2291, file: !929, discriminator: 1)
!2291 = distinct !DILexicalBlock(scope: !2287, file: !929, line: 74, column: 9)
!2292 = !DILocation(line: 74, column: 21, scope: !2290)
!2293 = !DILocation(line: 74, column: 9, scope: !2290)
!2294 = !DILocation(line: 75, column: 17, scope: !2295)
!2295 = distinct !DILexicalBlock(scope: !2296, file: !929, line: 75, column: 17)
!2296 = distinct !DILexicalBlock(scope: !2291, file: !929, line: 74, column: 96)
!2297 = !DILocation(line: 75, column: 22, scope: !2295)
!2298 = !DILocation(line: 75, column: 56, scope: !2295)
!2299 = !DILocation(line: 75, column: 35, scope: !2295)
!2300 = !DILocation(line: 75, column: 32, scope: !2295)
!2301 = !DILocation(line: 75, column: 17, scope: !2296)
!2302 = !DILocation(line: 76, column: 39, scope: !2303)
!2303 = distinct !DILexicalBlock(scope: !2295, file: !929, line: 75, column: 60)
!2304 = !DILocation(line: 76, column: 59, scope: !2303)
!2305 = !DILocation(line: 76, column: 17, scope: !2303)
!2306 = !DILocation(line: 77, column: 17, scope: !2303)
!2307 = !DILocation(line: 79, column: 9, scope: !2296)
!2308 = !DILocation(line: 74, column: 92, scope: !2309)
!2309 = !DILexicalBlockFile(scope: !2291, file: !929, discriminator: 2)
!2310 = !DILocation(line: 74, column: 9, scope: !2309)
!2311 = distinct !{!2311, !2312}
!2312 = !DILocation(line: 74, column: 9, scope: !2278)
!2313 = !DILocation(line: 80, column: 16, scope: !2278)
!2314 = !DILocation(line: 80, column: 50, scope: !2278)
!2315 = !DILocation(line: 80, column: 9, scope: !2278)
!2316 = !DILocation(line: 81, column: 9, scope: !2278)
!2317 = !DILocation(line: 84, column: 31, scope: !2212)
!2318 = !DILocation(line: 84, column: 21, scope: !2212)
!2319 = !DILocation(line: 84, column: 5, scope: !2212)
!2320 = !DILocation(line: 84, column: 10, scope: !2212)
!2321 = !DILocation(line: 84, column: 19, scope: !2212)
!2322 = !DILocation(line: 85, column: 9, scope: !2323)
!2323 = distinct !DILexicalBlock(scope: !2212, file: !929, line: 85, column: 9)
!2324 = !DILocation(line: 85, column: 14, scope: !2323)
!2325 = !DILocation(line: 85, column: 23, scope: !2323)
!2326 = !DILocation(line: 85, column: 28, scope: !2323)
!2327 = !DILocation(line: 85, column: 31, scope: !2328)
!2328 = !DILexicalBlockFile(scope: !2323, file: !929, discriminator: 1)
!2329 = !DILocation(line: 85, column: 36, scope: !2328)
!2330 = !DILocation(line: 85, column: 45, scope: !2328)
!2331 = !DILocation(line: 85, column: 9, scope: !2328)
!2332 = !DILocation(line: 86, column: 16, scope: !2333)
!2333 = distinct !DILexicalBlock(scope: !2323, file: !929, line: 85, column: 64)
!2334 = !DILocation(line: 86, column: 59, scope: !2333)
!2335 = !DILocation(line: 86, column: 64, scope: !2333)
!2336 = !DILocation(line: 86, column: 9, scope: !2333)
!2337 = !DILocation(line: 87, column: 9, scope: !2333)
!2338 = !DILocation(line: 90, column: 15, scope: !2212)
!2339 = !DILocation(line: 90, column: 5, scope: !2212)
!2340 = !DILocation(line: 91, column: 34, scope: !2212)
!2341 = !DILocation(line: 91, column: 24, scope: !2212)
!2342 = !DILocation(line: 91, column: 5, scope: !2212)
!2343 = !DILocation(line: 91, column: 10, scope: !2212)
!2344 = !DILocation(line: 91, column: 22, scope: !2212)
!2345 = !DILocation(line: 92, column: 10, scope: !2346)
!2346 = distinct !DILexicalBlock(scope: !2212, file: !929, line: 92, column: 9)
!2347 = !DILocation(line: 92, column: 15, scope: !2346)
!2348 = !DILocation(line: 92, column: 9, scope: !2212)
!2349 = !DILocation(line: 93, column: 9, scope: !2346)
!2350 = !DILocation(line: 95, column: 15, scope: !2212)
!2351 = !DILocation(line: 95, column: 5, scope: !2212)
!2352 = !DILocation(line: 97, column: 13, scope: !2212)
!2353 = !DILocation(line: 97, column: 18, scope: !2212)
!2354 = !DILocation(line: 97, column: 5, scope: !2212)
!2355 = !DILocation(line: 99, column: 9, scope: !2225)
!2356 = !DILocation(line: 99, column: 14, scope: !2225)
!2357 = !DILocation(line: 99, column: 26, scope: !2225)
!2358 = !DILocation(line: 100, column: 28, scope: !2225)
!2359 = !DILocation(line: 100, column: 9, scope: !2225)
!2360 = !DILocation(line: 101, column: 14, scope: !2361)
!2361 = distinct !DILexicalBlock(scope: !2225, file: !929, line: 101, column: 13)
!2362 = !DILocation(line: 101, column: 19, scope: !2361)
!2363 = !DILocation(line: 101, column: 13, scope: !2225)
!2364 = !DILocation(line: 102, column: 13, scope: !2361)
!2365 = !DILocation(line: 103, column: 16, scope: !2225)
!2366 = !DILocation(line: 103, column: 21, scope: !2225)
!2367 = !DILocation(line: 103, column: 9, scope: !2225)
!2368 = !DILocation(line: 104, column: 9, scope: !2225)
!2369 = !DILocation(line: 106, column: 33, scope: !2225)
!2370 = !DILocation(line: 106, column: 38, scope: !2225)
!2371 = !DILocation(line: 106, column: 31, scope: !2225)
!2372 = !DILocation(line: 106, column: 9, scope: !2225)
!2373 = !DILocation(line: 106, column: 14, scope: !2225)
!2374 = !DILocation(line: 106, column: 26, scope: !2225)
!2375 = !DILocation(line: 107, column: 13, scope: !2376)
!2376 = distinct !DILexicalBlock(scope: !2225, file: !929, line: 107, column: 13)
!2377 = !DILocation(line: 107, column: 17, scope: !2376)
!2378 = !DILocation(line: 107, column: 26, scope: !2376)
!2379 = !DILocation(line: 107, column: 13, scope: !2225)
!2380 = !DILocation(line: 108, column: 57, scope: !2376)
!2381 = !DILocation(line: 108, column: 72, scope: !2376)
!2382 = !DILocation(line: 108, column: 62, scope: !2376)
!2383 = !DILocation(line: 108, column: 78, scope: !2376)
!2384 = !DILocation(line: 108, column: 76, scope: !2376)
!2385 = !DILocation(line: 108, column: 28, scope: !2386)
!2386 = !DILexicalBlockFile(scope: !2376, file: !929, discriminator: 1)
!2387 = !DILocation(line: 108, column: 28, scope: !2376)
!2388 = !DILocation(line: 108, column: 13, scope: !2376)
!2389 = !DILocation(line: 108, column: 17, scope: !2376)
!2390 = !DILocation(line: 108, column: 26, scope: !2376)
!2391 = !DILocation(line: 109, column: 9, scope: !2225)
!2392 = !DILocation(line: 111, column: 33, scope: !2225)
!2393 = !DILocation(line: 111, column: 38, scope: !2225)
!2394 = !DILocation(line: 111, column: 31, scope: !2225)
!2395 = !DILocation(line: 111, column: 9, scope: !2225)
!2396 = !DILocation(line: 111, column: 14, scope: !2225)
!2397 = !DILocation(line: 111, column: 26, scope: !2225)
!2398 = !DILocation(line: 112, column: 13, scope: !2399)
!2399 = distinct !DILexicalBlock(scope: !2225, file: !929, line: 112, column: 13)
!2400 = !DILocation(line: 112, column: 17, scope: !2399)
!2401 = !DILocation(line: 112, column: 26, scope: !2399)
!2402 = !DILocation(line: 112, column: 13, scope: !2225)
!2403 = !DILocation(line: 113, column: 57, scope: !2399)
!2404 = !DILocation(line: 113, column: 72, scope: !2399)
!2405 = !DILocation(line: 113, column: 62, scope: !2399)
!2406 = !DILocation(line: 113, column: 78, scope: !2399)
!2407 = !DILocation(line: 113, column: 76, scope: !2399)
!2408 = !DILocation(line: 113, column: 28, scope: !2409)
!2409 = !DILexicalBlockFile(scope: !2399, file: !929, discriminator: 1)
!2410 = !DILocation(line: 113, column: 28, scope: !2399)
!2411 = !DILocation(line: 113, column: 13, scope: !2399)
!2412 = !DILocation(line: 113, column: 17, scope: !2399)
!2413 = !DILocation(line: 113, column: 26, scope: !2399)
!2414 = !DILocation(line: 114, column: 9, scope: !2225)
!2415 = !DILocation(line: 116, column: 13, scope: !2416)
!2416 = distinct !DILexicalBlock(scope: !2225, file: !929, line: 116, column: 13)
!2417 = !DILocation(line: 116, column: 21, scope: !2416)
!2418 = !DILocation(line: 116, column: 13, scope: !2225)
!2419 = !DILocation(line: 117, column: 31, scope: !2416)
!2420 = !DILocation(line: 117, column: 21, scope: !2416)
!2421 = !DILocation(line: 117, column: 19, scope: !2416)
!2422 = !DILocation(line: 117, column: 13, scope: !2416)
!2423 = !DILocation(line: 119, column: 9, scope: !2225)
!2424 = !DILocation(line: 119, column: 14, scope: !2225)
!2425 = !DILocation(line: 119, column: 36, scope: !2225)
!2426 = !DILocation(line: 120, column: 33, scope: !2225)
!2427 = !DILocation(line: 120, column: 38, scope: !2225)
!2428 = !DILocation(line: 120, column: 31, scope: !2225)
!2429 = !DILocation(line: 120, column: 9, scope: !2225)
!2430 = !DILocation(line: 120, column: 14, scope: !2225)
!2431 = !DILocation(line: 120, column: 26, scope: !2225)
!2432 = !DILocation(line: 121, column: 13, scope: !2433)
!2433 = distinct !DILexicalBlock(scope: !2225, file: !929, line: 121, column: 13)
!2434 = !DILocation(line: 121, column: 17, scope: !2433)
!2435 = !DILocation(line: 121, column: 26, scope: !2433)
!2436 = !DILocation(line: 121, column: 13, scope: !2225)
!2437 = !DILocation(line: 122, column: 57, scope: !2433)
!2438 = !DILocation(line: 122, column: 72, scope: !2433)
!2439 = !DILocation(line: 122, column: 62, scope: !2433)
!2440 = !DILocation(line: 122, column: 78, scope: !2433)
!2441 = !DILocation(line: 122, column: 76, scope: !2433)
!2442 = !DILocation(line: 122, column: 28, scope: !2443)
!2443 = !DILexicalBlockFile(scope: !2433, file: !929, discriminator: 1)
!2444 = !DILocation(line: 122, column: 28, scope: !2433)
!2445 = !DILocation(line: 122, column: 13, scope: !2433)
!2446 = !DILocation(line: 122, column: 17, scope: !2433)
!2447 = !DILocation(line: 122, column: 26, scope: !2433)
!2448 = !DILocation(line: 123, column: 9, scope: !2225)
!2449 = !DILocation(line: 128, column: 27, scope: !2225)
!2450 = !DILocation(line: 128, column: 17, scope: !2225)
!2451 = !DILocation(line: 128, column: 15, scope: !2225)
!2452 = !DILocation(line: 130, column: 37, scope: !2453)
!2453 = distinct !DILexicalBlock(scope: !2225, file: !929, line: 130, column: 13)
!2454 = !DILocation(line: 130, column: 40, scope: !2453)
!2455 = !DILocation(line: 130, column: 45, scope: !2453)
!2456 = !DILocation(line: 130, column: 48, scope: !2453)
!2457 = !DILocation(line: 130, column: 20, scope: !2453)
!2458 = !DILocation(line: 130, column: 18, scope: !2453)
!2459 = !DILocation(line: 130, column: 57, scope: !2453)
!2460 = !DILocation(line: 130, column: 13, scope: !2225)
!2461 = !DILocation(line: 131, column: 20, scope: !2453)
!2462 = !DILocation(line: 131, column: 13, scope: !2453)
!2463 = !DILocation(line: 132, column: 13, scope: !2464)
!2464 = distinct !DILexicalBlock(scope: !2225, file: !929, line: 132, column: 13)
!2465 = !DILocation(line: 132, column: 17, scope: !2464)
!2466 = !DILocation(line: 132, column: 26, scope: !2464)
!2467 = !DILocation(line: 132, column: 13, scope: !2225)
!2468 = !DILocation(line: 133, column: 57, scope: !2464)
!2469 = !DILocation(line: 133, column: 72, scope: !2464)
!2470 = !DILocation(line: 133, column: 62, scope: !2464)
!2471 = !DILocation(line: 133, column: 78, scope: !2464)
!2472 = !DILocation(line: 133, column: 76, scope: !2464)
!2473 = !DILocation(line: 133, column: 28, scope: !2474)
!2474 = !DILexicalBlockFile(scope: !2464, file: !929, discriminator: 1)
!2475 = !DILocation(line: 133, column: 28, scope: !2464)
!2476 = !DILocation(line: 133, column: 13, scope: !2464)
!2477 = !DILocation(line: 133, column: 17, scope: !2464)
!2478 = !DILocation(line: 133, column: 26, scope: !2464)
!2479 = !DILocation(line: 134, column: 9, scope: !2225)
!2480 = !DILocation(line: 136, column: 32, scope: !2225)
!2481 = !DILocation(line: 136, column: 37, scope: !2225)
!2482 = !DILocation(line: 136, column: 30, scope: !2225)
!2483 = !DILocation(line: 136, column: 9, scope: !2225)
!2484 = !DILocation(line: 136, column: 14, scope: !2225)
!2485 = !DILocation(line: 136, column: 26, scope: !2225)
!2486 = !DILocation(line: 137, column: 19, scope: !2225)
!2487 = !DILocation(line: 137, column: 22, scope: !2225)
!2488 = !DILocation(line: 137, column: 44, scope: !2225)
!2489 = !DILocation(line: 137, column: 47, scope: !2225)
!2490 = !DILocation(line: 137, column: 34, scope: !2225)
!2491 = !DILocation(line: 559, column: 22, scope: !2218, inlinedAt: !2224)
!2492 = !DILocation(line: 559, column: 12, scope: !2218, inlinedAt: !2224)
!2493 = !DILocation(line: 137, column: 32, scope: !2225)
!2494 = !DILocation(line: 137, column: 9, scope: !2495)
!2495 = !DILexicalBlockFile(scope: !2225, file: !929, discriminator: 1)
!2496 = !DILocation(line: 139, column: 39, scope: !2497)
!2497 = distinct !DILexicalBlock(scope: !2225, file: !929, line: 139, column: 13)
!2498 = !DILocation(line: 139, column: 43, scope: !2497)
!2499 = !DILocation(line: 139, column: 58, scope: !2497)
!2500 = !DILocation(line: 139, column: 63, scope: !2497)
!2501 = !DILocation(line: 139, column: 56, scope: !2497)
!2502 = !DILocation(line: 139, column: 20, scope: !2497)
!2503 = !DILocation(line: 139, column: 18, scope: !2497)
!2504 = !DILocation(line: 139, column: 74, scope: !2497)
!2505 = !DILocation(line: 139, column: 13, scope: !2225)
!2506 = !DILocation(line: 140, column: 20, scope: !2497)
!2507 = !DILocation(line: 140, column: 13, scope: !2497)
!2508 = !DILocation(line: 142, column: 16, scope: !2509)
!2509 = distinct !DILexicalBlock(scope: !2225, file: !929, line: 142, column: 9)
!2510 = !DILocation(line: 142, column: 14, scope: !2509)
!2511 = !DILocation(line: 142, column: 21, scope: !2512)
!2512 = !DILexicalBlockFile(scope: !2513, file: !929, discriminator: 1)
!2513 = distinct !DILexicalBlock(scope: !2509, file: !929, line: 142, column: 9)
!2514 = !DILocation(line: 142, column: 25, scope: !2512)
!2515 = !DILocation(line: 142, column: 30, scope: !2512)
!2516 = !DILocation(line: 142, column: 23, scope: !2512)
!2517 = !DILocation(line: 142, column: 9, scope: !2512)
!2518 = !DILocation(line: 143, column: 23, scope: !2519)
!2519 = distinct !DILexicalBlock(scope: !2513, file: !929, line: 142, column: 45)
!2520 = !DILocation(line: 143, column: 26, scope: !2519)
!2521 = !DILocation(line: 143, column: 30, scope: !2519)
!2522 = !DILocation(line: 143, column: 34, scope: !2519)
!2523 = !DILocation(line: 143, column: 44, scope: !2519)
!2524 = !DILocation(line: 143, column: 61, scope: !2519)
!2525 = !DILocation(line: 143, column: 59, scope: !2519)
!2526 = !DILocation(line: 143, column: 54, scope: !2519)
!2527 = !DILocation(line: 143, column: 13, scope: !2519)
!2528 = !DILocation(line: 144, column: 23, scope: !2519)
!2529 = !DILocation(line: 144, column: 26, scope: !2519)
!2530 = !DILocation(line: 144, column: 13, scope: !2519)
!2531 = !DILocation(line: 145, column: 9, scope: !2519)
!2532 = !DILocation(line: 142, column: 41, scope: !2533)
!2533 = !DILexicalBlockFile(scope: !2513, file: !929, discriminator: 2)
!2534 = !DILocation(line: 142, column: 9, scope: !2533)
!2535 = distinct !{!2535, !2536}
!2536 = !DILocation(line: 142, column: 9, scope: !2225)
!2537 = !DILocation(line: 146, column: 13, scope: !2538)
!2538 = distinct !DILexicalBlock(scope: !2225, file: !929, line: 146, column: 13)
!2539 = !DILocation(line: 146, column: 17, scope: !2538)
!2540 = !DILocation(line: 146, column: 26, scope: !2538)
!2541 = !DILocation(line: 146, column: 13, scope: !2225)
!2542 = !DILocation(line: 147, column: 39, scope: !2538)
!2543 = !DILocation(line: 147, column: 29, scope: !2538)
!2544 = !DILocation(line: 147, column: 45, scope: !2538)
!2545 = !DILocation(line: 147, column: 43, scope: !2538)
!2546 = !DILocation(line: 147, column: 59, scope: !2538)
!2547 = !DILocation(line: 147, column: 64, scope: !2538)
!2548 = !DILocation(line: 147, column: 57, scope: !2538)
!2549 = !DILocation(line: 147, column: 54, scope: !2538)
!2550 = !DILocation(line: 147, column: 52, scope: !2538)
!2551 = !DILocation(line: 147, column: 74, scope: !2538)
!2552 = !DILocation(line: 147, column: 13, scope: !2538)
!2553 = !DILocation(line: 147, column: 17, scope: !2538)
!2554 = !DILocation(line: 147, column: 26, scope: !2538)
!2555 = !DILocation(line: 148, column: 9, scope: !2225)
!2556 = !DILocation(line: 151, column: 13, scope: !2557)
!2557 = distinct !DILexicalBlock(scope: !2225, file: !929, line: 151, column: 13)
!2558 = !DILocation(line: 151, column: 21, scope: !2557)
!2559 = !DILocation(line: 151, column: 13, scope: !2225)
!2560 = !DILocation(line: 152, column: 31, scope: !2557)
!2561 = !DILocation(line: 152, column: 21, scope: !2557)
!2562 = !DILocation(line: 152, column: 19, scope: !2557)
!2563 = !DILocation(line: 152, column: 13, scope: !2557)
!2564 = !DILocation(line: 154, column: 13, scope: !2565)
!2565 = distinct !DILexicalBlock(scope: !2225, file: !929, line: 154, column: 13)
!2566 = !DILocation(line: 154, column: 17, scope: !2565)
!2567 = !DILocation(line: 154, column: 26, scope: !2565)
!2568 = !DILocation(line: 154, column: 13, scope: !2225)
!2569 = !DILocation(line: 155, column: 39, scope: !2565)
!2570 = !DILocation(line: 155, column: 29, scope: !2565)
!2571 = !DILocation(line: 155, column: 45, scope: !2565)
!2572 = !DILocation(line: 155, column: 43, scope: !2565)
!2573 = !DILocation(line: 155, column: 52, scope: !2565)
!2574 = !DILocation(line: 155, column: 58, scope: !2565)
!2575 = !DILocation(line: 155, column: 63, scope: !2565)
!2576 = !DILocation(line: 155, column: 56, scope: !2565)
!2577 = !DILocation(line: 155, column: 13, scope: !2565)
!2578 = !DILocation(line: 155, column: 17, scope: !2565)
!2579 = !DILocation(line: 155, column: 26, scope: !2565)
!2580 = !DILocation(line: 156, column: 9, scope: !2225)
!2581 = !DILocation(line: 159, column: 15, scope: !2212)
!2582 = !DILocation(line: 159, column: 19, scope: !2212)
!2583 = !DILocation(line: 159, column: 37, scope: !2212)
!2584 = !DILocation(line: 159, column: 27, scope: !2212)
!2585 = !DILocation(line: 559, column: 22, scope: !2218, inlinedAt: !2222)
!2586 = !DILocation(line: 559, column: 12, scope: !2218, inlinedAt: !2222)
!2587 = !DILocation(line: 159, column: 25, scope: !2212)
!2588 = !DILocation(line: 159, column: 5, scope: !2589)
!2589 = !DILexicalBlockFile(scope: !2212, file: !929, discriminator: 1)
!2590 = !DILocation(line: 160, column: 9, scope: !2591)
!2591 = distinct !DILexicalBlock(scope: !2212, file: !929, line: 160, column: 9)
!2592 = !DILocation(line: 160, column: 14, scope: !2591)
!2593 = !DILocation(line: 160, column: 23, scope: !2591)
!2594 = !DILocation(line: 160, column: 9, scope: !2212)
!2595 = !DILocation(line: 161, column: 19, scope: !2596)
!2596 = distinct !DILexicalBlock(scope: !2591, file: !929, line: 160, column: 44)
!2597 = !DILocation(line: 161, column: 33, scope: !2596)
!2598 = !DILocation(line: 161, column: 23, scope: !2596)
!2599 = !DILocation(line: 161, column: 49, scope: !2596)
!2600 = !DILocation(line: 161, column: 39, scope: !2601)
!2601 = !DILexicalBlockFile(scope: !2596, file: !929, discriminator: 1)
!2602 = !DILocation(line: 161, column: 37, scope: !2596)
!2603 = !DILocation(line: 161, column: 9, scope: !2604)
!2604 = !DILexicalBlockFile(scope: !2596, file: !929, discriminator: 2)
!2605 = !DILocation(line: 162, column: 34, scope: !2596)
!2606 = !DILocation(line: 162, column: 24, scope: !2596)
!2607 = !DILocation(line: 162, column: 9, scope: !2596)
!2608 = !DILocation(line: 162, column: 13, scope: !2596)
!2609 = !DILocation(line: 162, column: 22, scope: !2596)
!2610 = !DILocation(line: 163, column: 5, scope: !2596)
!2611 = !DILocation(line: 165, column: 25, scope: !2212)
!2612 = !DILocation(line: 165, column: 36, scope: !2212)
!2613 = !DILocation(line: 165, column: 41, scope: !2212)
!2614 = !DILocation(line: 165, column: 5, scope: !2212)
!2615 = !DILocation(line: 167, column: 5, scope: !2212)
!2616 = !DILocation(line: 168, column: 1, scope: !2212)
!2617 = distinct !DISubprogram(name: "rsd_read_packet", scope: !929, file: !929, line: 170, type: !2618, isLocal: true, isDefinition: true, scopeLine: 171, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2158)
!2618 = !DISubroutineType(types: !2619)
!2619 = !{!926, !2215, !1041}
!2620 = !DILocation(line: 557, column: 77, scope: !2218, inlinedAt: !2621)
!2621 = distinct !DILocation(line: 179, column: 11, scope: !2617)
!2622 = !DILocalVariable(name: "s", arg: 1, scope: !2617, file: !929, line: 170, type: !2215)
!2623 = !DILocation(line: 170, column: 45, scope: !2617)
!2624 = !DILocalVariable(name: "pkt", arg: 2, scope: !2617, file: !929, line: 170, type: !1041)
!2625 = !DILocation(line: 170, column: 58, scope: !2617)
!2626 = !DILocalVariable(name: "par", scope: !2617, file: !929, line: 172, type: !1733)
!2627 = !DILocation(line: 172, column: 24, scope: !2617)
!2628 = !DILocation(line: 172, column: 30, scope: !2617)
!2629 = !DILocation(line: 172, column: 33, scope: !2617)
!2630 = !DILocation(line: 172, column: 45, scope: !2617)
!2631 = !DILocalVariable(name: "ret", scope: !2617, file: !929, line: 173, type: !926)
!2632 = !DILocation(line: 173, column: 9, scope: !2617)
!2633 = !DILocalVariable(name: "size", scope: !2617, file: !929, line: 173, type: !926)
!2634 = !DILocation(line: 173, column: 14, scope: !2617)
!2635 = !DILocalVariable(name: "pos", scope: !2617, file: !929, line: 174, type: !1060)
!2636 = !DILocation(line: 174, column: 13, scope: !2617)
!2637 = !DILocation(line: 176, column: 19, scope: !2638)
!2638 = distinct !DILexicalBlock(scope: !2617, file: !929, line: 176, column: 9)
!2639 = !DILocation(line: 176, column: 22, scope: !2638)
!2640 = !DILocation(line: 176, column: 9, scope: !2638)
!2641 = !DILocation(line: 176, column: 9, scope: !2617)
!2642 = !DILocation(line: 177, column: 9, scope: !2638)
!2643 = !DILocation(line: 179, column: 21, scope: !2617)
!2644 = !DILocation(line: 179, column: 24, scope: !2617)
!2645 = !DILocation(line: 179, column: 11, scope: !2617)
!2646 = !DILocation(line: 559, column: 22, scope: !2218, inlinedAt: !2621)
!2647 = !DILocation(line: 559, column: 12, scope: !2218, inlinedAt: !2621)
!2648 = !DILocation(line: 179, column: 9, scope: !2617)
!2649 = !DILocation(line: 180, column: 9, scope: !2650)
!2650 = distinct !DILexicalBlock(scope: !2617, file: !929, line: 180, column: 9)
!2651 = !DILocation(line: 180, column: 14, scope: !2650)
!2652 = !DILocation(line: 180, column: 23, scope: !2650)
!2653 = !DILocation(line: 180, column: 52, scope: !2650)
!2654 = !DILocation(line: 181, column: 9, scope: !2650)
!2655 = !DILocation(line: 181, column: 14, scope: !2650)
!2656 = !DILocation(line: 181, column: 23, scope: !2650)
!2657 = !DILocation(line: 181, column: 48, scope: !2650)
!2658 = !DILocation(line: 182, column: 9, scope: !2650)
!2659 = !DILocation(line: 182, column: 14, scope: !2650)
!2660 = !DILocation(line: 182, column: 23, scope: !2650)
!2661 = !DILocation(line: 182, column: 52, scope: !2650)
!2662 = !DILocation(line: 183, column: 9, scope: !2650)
!2663 = !DILocation(line: 183, column: 14, scope: !2650)
!2664 = !DILocation(line: 183, column: 23, scope: !2650)
!2665 = !DILocation(line: 180, column: 9, scope: !2666)
!2666 = !DILexicalBlockFile(scope: !2617, file: !929, discriminator: 1)
!2667 = !DILocation(line: 184, column: 29, scope: !2668)
!2668 = distinct !DILexicalBlock(scope: !2650, file: !929, line: 183, column: 44)
!2669 = !DILocation(line: 184, column: 32, scope: !2668)
!2670 = !DILocation(line: 184, column: 36, scope: !2668)
!2671 = !DILocation(line: 184, column: 41, scope: !2668)
!2672 = !DILocation(line: 184, column: 46, scope: !2668)
!2673 = !DILocation(line: 184, column: 15, scope: !2668)
!2674 = !DILocation(line: 184, column: 13, scope: !2668)
!2675 = !DILocation(line: 185, column: 5, scope: !2668)
!2676 = !DILocation(line: 185, column: 16, scope: !2677)
!2677 = !DILexicalBlockFile(scope: !2678, file: !929, discriminator: 1)
!2678 = distinct !DILexicalBlock(scope: !2650, file: !929, line: 185, column: 16)
!2679 = !DILocation(line: 185, column: 21, scope: !2677)
!2680 = !DILocation(line: 185, column: 31, scope: !2677)
!2681 = !DILocation(line: 185, column: 99, scope: !2677)
!2682 = !DILocation(line: 186, column: 16, scope: !2678)
!2683 = !DILocation(line: 186, column: 21, scope: !2678)
!2684 = !DILocation(line: 186, column: 30, scope: !2678)
!2685 = !DILocation(line: 185, column: 16, scope: !2686)
!2686 = !DILexicalBlockFile(scope: !2650, file: !929, discriminator: 2)
!2687 = !DILocalVariable(name: "i", scope: !2688, file: !929, line: 187, type: !926)
!2688 = distinct !DILexicalBlock(scope: !2678, file: !929, line: 186, column: 35)
!2689 = !DILocation(line: 187, column: 13, scope: !2688)
!2690 = !DILocalVariable(name: "ch", scope: !2688, file: !929, line: 187, type: !926)
!2691 = !DILocation(line: 187, column: 16, scope: !2688)
!2692 = !DILocation(line: 189, column: 29, scope: !2688)
!2693 = !DILocation(line: 189, column: 34, scope: !2688)
!2694 = !DILocation(line: 189, column: 39, scope: !2688)
!2695 = !DILocation(line: 189, column: 15, scope: !2688)
!2696 = !DILocation(line: 189, column: 13, scope: !2688)
!2697 = !DILocation(line: 190, column: 13, scope: !2698)
!2698 = distinct !DILexicalBlock(scope: !2688, file: !929, line: 190, column: 13)
!2699 = !DILocation(line: 190, column: 17, scope: !2698)
!2700 = !DILocation(line: 190, column: 13, scope: !2688)
!2701 = !DILocation(line: 191, column: 20, scope: !2698)
!2702 = !DILocation(line: 191, column: 13, scope: !2698)
!2703 = !DILocation(line: 192, column: 16, scope: !2704)
!2704 = distinct !DILexicalBlock(scope: !2688, file: !929, line: 192, column: 9)
!2705 = !DILocation(line: 192, column: 14, scope: !2704)
!2706 = !DILocation(line: 192, column: 21, scope: !2707)
!2707 = !DILexicalBlockFile(scope: !2708, file: !929, discriminator: 1)
!2708 = distinct !DILexicalBlock(scope: !2704, file: !929, line: 192, column: 9)
!2709 = !DILocation(line: 192, column: 23, scope: !2707)
!2710 = !DILocation(line: 192, column: 9, scope: !2707)
!2711 = !DILocation(line: 193, column: 21, scope: !2712)
!2712 = distinct !DILexicalBlock(scope: !2713, file: !929, line: 193, column: 13)
!2713 = distinct !DILexicalBlock(scope: !2708, file: !929, line: 192, column: 33)
!2714 = !DILocation(line: 193, column: 18, scope: !2712)
!2715 = !DILocation(line: 193, column: 26, scope: !2716)
!2716 = !DILexicalBlockFile(scope: !2717, file: !929, discriminator: 1)
!2717 = distinct !DILexicalBlock(scope: !2712, file: !929, line: 193, column: 13)
!2718 = !DILocation(line: 193, column: 31, scope: !2716)
!2719 = !DILocation(line: 193, column: 36, scope: !2716)
!2720 = !DILocation(line: 193, column: 29, scope: !2716)
!2721 = !DILocation(line: 193, column: 13, scope: !2716)
!2722 = !DILocation(line: 194, column: 57, scope: !2723)
!2723 = distinct !DILexicalBlock(scope: !2717, file: !929, line: 193, column: 52)
!2724 = !DILocation(line: 194, column: 60, scope: !2723)
!2725 = !DILocation(line: 194, column: 49, scope: !2723)
!2726 = !DILocation(line: 194, column: 27, scope: !2723)
!2727 = !DILocation(line: 194, column: 30, scope: !2723)
!2728 = !DILocation(line: 194, column: 36, scope: !2723)
!2729 = !DILocation(line: 194, column: 38, scope: !2723)
!2730 = !DILocation(line: 194, column: 34, scope: !2723)
!2731 = !DILocation(line: 194, column: 42, scope: !2723)
!2732 = !DILocation(line: 194, column: 17, scope: !2723)
!2733 = !DILocation(line: 194, column: 22, scope: !2723)
!2734 = !DILocation(line: 194, column: 47, scope: !2723)
!2735 = !DILocation(line: 195, column: 57, scope: !2723)
!2736 = !DILocation(line: 195, column: 60, scope: !2723)
!2737 = !DILocation(line: 195, column: 49, scope: !2723)
!2738 = !DILocation(line: 195, column: 27, scope: !2723)
!2739 = !DILocation(line: 195, column: 30, scope: !2723)
!2740 = !DILocation(line: 195, column: 36, scope: !2723)
!2741 = !DILocation(line: 195, column: 38, scope: !2723)
!2742 = !DILocation(line: 195, column: 34, scope: !2723)
!2743 = !DILocation(line: 195, column: 42, scope: !2723)
!2744 = !DILocation(line: 195, column: 17, scope: !2723)
!2745 = !DILocation(line: 195, column: 22, scope: !2723)
!2746 = !DILocation(line: 195, column: 47, scope: !2723)
!2747 = !DILocation(line: 196, column: 13, scope: !2723)
!2748 = !DILocation(line: 193, column: 48, scope: !2749)
!2749 = !DILexicalBlockFile(scope: !2717, file: !929, discriminator: 2)
!2750 = !DILocation(line: 193, column: 13, scope: !2749)
!2751 = distinct !{!2751, !2752}
!2752 = !DILocation(line: 193, column: 13, scope: !2713)
!2753 = !DILocation(line: 197, column: 9, scope: !2713)
!2754 = !DILocation(line: 192, column: 29, scope: !2755)
!2755 = !DILexicalBlockFile(scope: !2708, file: !929, discriminator: 2)
!2756 = !DILocation(line: 192, column: 9, scope: !2755)
!2757 = distinct !{!2757, !2758}
!2758 = !DILocation(line: 192, column: 9, scope: !2688)
!2759 = !DILocation(line: 198, column: 13, scope: !2688)
!2760 = !DILocation(line: 199, column: 5, scope: !2688)
!2761 = !DILocation(line: 200, column: 29, scope: !2762)
!2762 = distinct !DILexicalBlock(scope: !2678, file: !929, line: 199, column: 12)
!2763 = !DILocation(line: 200, column: 32, scope: !2762)
!2764 = !DILocation(line: 200, column: 36, scope: !2762)
!2765 = !DILocation(line: 200, column: 41, scope: !2762)
!2766 = !DILocation(line: 200, column: 15, scope: !2762)
!2767 = !DILocation(line: 200, column: 13, scope: !2762)
!2768 = !DILocation(line: 203, column: 9, scope: !2769)
!2769 = distinct !DILexicalBlock(scope: !2617, file: !929, line: 203, column: 9)
!2770 = !DILocation(line: 203, column: 14, scope: !2769)
!2771 = !DILocation(line: 203, column: 23, scope: !2769)
!2772 = !DILocation(line: 203, column: 43, scope: !2769)
!2773 = !DILocation(line: 203, column: 46, scope: !2774)
!2774 = !DILexicalBlockFile(scope: !2769, file: !929, discriminator: 1)
!2775 = !DILocation(line: 203, column: 51, scope: !2774)
!2776 = !DILocation(line: 203, column: 56, scope: !2774)
!2777 = !DILocation(line: 203, column: 9, scope: !2774)
!2778 = !DILocation(line: 204, column: 26, scope: !2769)
!2779 = !DILocation(line: 204, column: 31, scope: !2769)
!2780 = !DILocation(line: 204, column: 39, scope: !2769)
!2781 = !DILocation(line: 204, column: 45, scope: !2769)
!2782 = !DILocation(line: 204, column: 25, scope: !2769)
!2783 = !DILocation(line: 204, column: 9, scope: !2769)
!2784 = !DILocation(line: 204, column: 14, scope: !2769)
!2785 = !DILocation(line: 204, column: 23, scope: !2769)
!2786 = !DILocation(line: 206, column: 16, scope: !2617)
!2787 = !DILocation(line: 206, column: 5, scope: !2617)
!2788 = !DILocation(line: 206, column: 10, scope: !2617)
!2789 = !DILocation(line: 206, column: 14, scope: !2617)
!2790 = !DILocation(line: 207, column: 5, scope: !2617)
!2791 = !DILocation(line: 207, column: 10, scope: !2617)
!2792 = !DILocation(line: 207, column: 23, scope: !2617)
!2793 = !DILocation(line: 209, column: 12, scope: !2617)
!2794 = !DILocation(line: 209, column: 5, scope: !2617)
!2795 = !DILocation(line: 210, column: 1, scope: !2617)
