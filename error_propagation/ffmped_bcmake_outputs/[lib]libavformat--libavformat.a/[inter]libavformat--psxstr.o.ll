; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--psxstr.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--psxstr.o.i"
...
@ff_str_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i32 0, i32 0), i32 32768, i8* null, %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 3328, i32 (%struct.AVProbeData*)* @str_probe, i32 (%struct.AVFormatContext*)* @str_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @str_read_packet, i32 (%struct.AVFormatContext*)* @str_read_close, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
...
define internal i32 @str_probe(%struct.AVProbeData* %p) #0 !dbg !2155 {
entry:
  %retval = alloca i32, align 4
  %p.addr = alloca %struct.AVProbeData*, align 8
  %sector = alloca i8*, align 8
  %end = alloca i8*, align 8
  %aud = alloca i32, align 4
  %vid = alloca i32, align 4
  %current_sector = alloca i32, align 4
  %sector_count = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata i8** %sector, metadata !2160, metadata !2158), !dbg !2161
  ...
  store i8* %1, i8** %sector, align 8, !dbg !2161
  call void @llvm.dbg.declare(metadata i8** %end, metadata !2164, metadata !2158), !dbg !2165
  %2 = load i8*, i8** %sector, align 8, !dbg !2166
  %3 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2167
  %buf_size = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %3, i32 0, i32 2, !dbg !2168
  %4 = load i32, i32* %buf_size, align 8, !dbg !2168
  %idx.ext = sext i32 %4 to i64, !dbg !2169
  %add.ptr = getelementptr inbounds i8, i8* %2, i64 %idx.ext, !dbg !2169
  store i8* %add.ptr, i8** %end, align 8, !dbg !2165
  call void @llvm.dbg.declare(metadata i32* %aud, metadata !2170, metadata !2158), !dbg !2171
  store i32 0, i32* %aud, align 4, !dbg !2171
  call void @llvm.dbg.declare(metadata i32* %vid, metadata !2172, metadata !2158), !dbg !2173
  store i32 0, i32* %vid, align 4, !dbg !2173
  %5 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2174
  %buf_size1 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %5, i32 0, i32 2, !dbg !2176
  %6 = load i32, i32* %buf_size1, align 8, !dbg !2176
  %cmp = icmp slt i32 %6, 2352, !dbg !2177
...
if.end:                                           ; preds = %entry
  %7 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2180
  %buf2 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %7, i32 0, i32 1, !dbg !2182
  %8 = load i8*, i8** %buf2, align 8, !dbg !2182
  %arrayidx = getelementptr inbounds i8, i8* %8, i64 0, !dbg !2180
  %9 = bitcast i8* %arrayidx to %union.unaligned_32*, !dbg !2183
  %l = bitcast %union.unaligned_32* %9 to i32*, !dbg !2183
  %10 = load i32, i32* %l, align 1, !dbg !2183
  %cmp3 = icmp eq i32 %10, 1179011410, !dbg !2184
  br i1 %cmp3, label %land.lhs.true, label %if.end10, !dbg !2185

land.lhs.true:                                    ; preds = %if.end
  %11 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2186
  %buf4 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %11, i32 0, i32 1, !dbg !2187
  %12 = load i8*, i8** %buf4, align 8, !dbg !2187
  %arrayidx5 = getelementptr inbounds i8, i8* %12, i64 8, !dbg !2186
  %13 = bitcast i8* %arrayidx5 to %union.unaligned_32*, !dbg !2188
  %l6 = bitcast %union.unaligned_32* %13 to i32*, !dbg !2188
  %14 = load i32, i32* %l6, align 1, !dbg !2188
  %cmp7 = icmp eq i32 %14, 1096303683, !dbg !2189
  br i1 %cmp7, label %if.then8, label %if.end10, !dbg !2190

if.then8:                                         ; preds = %land.lhs.true
  %15 = load i8*, i8** %sector, align 8, !dbg !2192
  %add.ptr9 = getelementptr inbounds i8, i8* %15, i64 44, !dbg !2192
  store i8* %add.ptr9, i8** %sector, align 8, !dbg !2192
  br label %if.end10, !dbg !2194

if.end10:                                         ; preds = %if.then8, %land.lhs.true, %if.end
  br label %while.cond, !dbg !2195

while.cond:                                       ; preds = %sw.epilog, %if.end10
  %16 = load i8*, i8** %end, align 8, !dbg !2196
  %17 = load i8*, i8** %sector, align 8, !dbg !2197
  %sub.ptr.lhs.cast = ptrtoint i8* %16 to i64, !dbg !2198
  %sub.ptr.rhs.cast = ptrtoint i8* %17 to i64, !dbg !2198
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast, !dbg !2198
  %cmp11 = icmp sge i64 %sub.ptr.sub, 2352, !dbg !2199
  br i1 %cmp11, label %while.body, label %while.end, !dbg !2200

while.body:                                       ; preds = %while.cond
  %18 = load i8*, i8** %sector, align 8, !dbg !2201
  %call = call i32 @memcmp(i8* %18, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @sync_header, i32 0, i32 0), i64 12) #5, !dbg !2204
  %tobool = icmp ne i32 %call, 0, !dbg !2204
  br i1 %tobool, label %if.then12, label %if.end13, !dbg !2205
...
if.end13:                                         ; preds = %while.body
  %19 = load i8*, i8** %sector, align 8, !dbg !2207
  %arrayidx14 = getelementptr inbounds i8, i8* %19, i64 17, !dbg !2207
  %20 = load i8, i8* %arrayidx14, align 1, !dbg !2207
  %conv = zext i8 %20 to i32, !dbg !2207
  %cmp15 = icmp sge i32 %conv, 32, !dbg !2209
  br i1 %cmp15, label %if.then17, label %if.end18, !dbg !2210
...
if.end18:                                         ; preds = %if.end13
  %21 = load i8*, i8** %sector, align 8, !dbg !2212
  %arrayidx19 = getelementptr inbounds i8, i8* %21, i64 18, !dbg !2212
  %22 = load i8, i8* %arrayidx19, align 1, !dbg !2212
  %conv20 = zext i8 %22 to i32, !dbg !2212
  %and = and i32 %conv20, 14, !dbg !2213
...
sw.bb:                                            ; preds = %if.end18, %if.end18
  call void @llvm.dbg.declare(metadata i32* %current_sector, metadata !2215, metadata !2158), !dbg !2218
  %23 = load i8*, i8** %sector, align 8, !dbg !2219
  %arrayidx21 = getelementptr inbounds i8, i8* %23, i64 28, !dbg !2219
  %24 = bitcast i8* %arrayidx21 to %union.unaligned_16*, !dbg !2220
  %l22 = bitcast %union.unaligned_16* %24 to i16*, !dbg !2220
  %25 = load i16, i16* %l22, align 1, !dbg !2220
  %conv23 = zext i16 %25 to i32, !dbg !2221
  store i32 %conv23, i32* %current_sector, align 4, !dbg !2218
  call void @llvm.dbg.declare(metadata i32* %sector_count, metadata !2222, metadata !2158), !dbg !2223
  %26 = load i8*, i8** %sector, align 8, !dbg !2224
  %arrayidx24 = getelementptr inbounds i8, i8* %26, i64 30, !dbg !2224
  %27 = bitcast i8* %arrayidx24 to %union.unaligned_16*, !dbg !2225
  %l25 = bitcast %union.unaligned_16* %27 to i16*, !dbg !2225
  %28 = load i16, i16* %l25, align 1, !dbg !2225
  %conv26 = zext i16 %28 to i32, !dbg !2226
  store i32 %conv26, i32* %sector_count, align 4, !dbg !2223
  call void @llvm.dbg.declare(metadata i32* %frame_size, metadata !2227, metadata !2158), !dbg !2228
  %29 = load i8*, i8** %sector, align 8, !dbg !2229
  %arrayidx27 = getelementptr inbounds i8, i8* %29, i64 36, !dbg !2229
  %30 = bitcast i8* %arrayidx27 to %union.unaligned_32*, !dbg !2230
  %l28 = bitcast %union.unaligned_32* %30 to i32*, !dbg !2230
  %31 = load i32, i32* %l28, align 1, !dbg !2230
  store i32 %31, i32* %frame_size, align 4, !dbg !2228
  %32 = load i32, i32* %frame_size, align 4, !dbg !2231
  %cmp29 = icmp sge i32 %32, 0, !dbg !2233
  br i1 %cmp29, label %land.lhs.true31, label %if.then37, !dbg !2234

land.lhs.true31:                                  ; preds = %sw.bb
  %33 = load i32, i32* %current_sector, align 4, !dbg !2235
  %34 = load i32, i32* %sector_count, align 4, !dbg !2237
  %cmp32 = icmp slt i32 %33, %34, !dbg !2238
  br i1 %cmp32, label %land.lhs.true34, label %if.then37, !dbg !2239

land.lhs.true34:                                  ; preds = %land.lhs.true31
  %35 = load i32, i32* %sector_count, align 4, !dbg !2240
  %mul = mul nsw i32 %35, 2016, !dbg !2241
  %36 = load i32, i32* %frame_size, align 4, !dbg !2242
  %cmp35 = icmp sge i32 %mul, %36, !dbg !2243
  br i1 %cmp35, label %if.end38, label %if.then37, !dbg !2244

if.then37:                                        ; preds = %land.lhs.true34, %land.lhs.true31, %sw.bb
  store i32 0, i32* %retval, align 4, !dbg !2246
  br label %return, !dbg !2246

if.end38:                                         ; preds = %land.lhs.true34
  %37 = load i32, i32* %vid, align 4, !dbg !2248
  %inc = add nsw i32 %37, 1, !dbg !2248
  store i32 %inc, i32* %vid, align 4, !dbg !2248
  br label %sw.epilog, !dbg !2249

sw.bb39:                                          ; preds = %if.end18
  %38 = load i8*, i8** %sector, align 8, !dbg !2250
  %arrayidx40 = getelementptr inbounds i8, i8* %38, i64 19, !dbg !2250
  %39 = load i8, i8* %arrayidx40, align 1, !dbg !2250
  %conv41 = zext i8 %39 to i32, !dbg !2250
  %and42 = and i32 %conv41, 42, !dbg !2252
  %tobool43 = icmp ne i32 %and42, 0, !dbg !2252
  br i1 %tobool43, label %if.then44, label %if.end45, !dbg !2253
...
if.end45:                                         ; preds = %sw.bb39
  %40 = load i32, i32* %aud, align 4, !dbg !2255
  %inc46 = add nsw i32 %40, 1, !dbg !2255
  store i32 %inc46, i32* %aud, align 4, !dbg !2255
  br label %sw.epilog, !dbg !2256

sw.default:                                       ; preds = %if.end18
  %41 = load i8*, i8** %sector, align 8, !dbg !2257
  %arrayidx47 = getelementptr inbounds i8, i8* %41, i64 18, !dbg !2257
  %42 = load i8, i8* %arrayidx47, align 1, !dbg !2257
  %conv48 = zext i8 %42 to i32, !dbg !2257
  %and49 = and i32 %conv48, 14, !dbg !2259
  %tobool50 = icmp ne i32 %and49, 0, !dbg !2259
  br i1 %tobool50, label %if.then51, label %if.end52, !dbg !2260
...
sw.epilog:                                        ; preds = %if.end52, %if.end45, %if.end38
  %43 = load i8*, i8** %sector, align 8, !dbg !2263
  %add.ptr53 = getelementptr inbounds i8, i8* %43, i64 2352, !dbg !2263
  store i8* %add.ptr53, i8** %sector, align 8, !dbg !2263
  br label %while.cond, !dbg !2264, !llvm.loop !2266

while.end:                                        ; preds = %while.cond
  %44 = load i32, i32* %vid, align 4, !dbg !2267
  %45 = load i32, i32* %aud, align 4, !dbg !2269
  %add = add nsw i32 %44, %45, !dbg !2270
  %cmp54 = icmp sgt i32 %add, 3, !dbg !2271
  br i1 %cmp54, label %if.then56, label %if.else, !dbg !2272
...
if.else:                                          ; preds = %while.end
  %46 = load i32, i32* %vid, align 4, !dbg !2275
  %47 = load i32, i32* %aud, align 4, !dbg !2277
  %add57 = add nsw i32 %46, %47, !dbg !2278
  %tobool58 = icmp ne i32 %add57, 0, !dbg !2278
  br i1 %tobool58, label %if.then59, label %if.else60, !dbg !2279
...
return:                                           ; preds = %if.else60, %if.then59, %if.then56, %if.then51, %if.then44, %if.then37, %if.then17, %if.then12, %if.then
  %48 = load i32, i32* %retval, align 4, !dbg !2283
  ret i32 %48, !dbg !2283
}

; Function Attrs: nounwind uwtable
define internal i32 @str_read_header(%struct.AVFormatContext* %s) #0 !dbg !2284 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %pb = alloca %struct.AVIOContext*, align 8
  %str = alloca %struct.StrDemuxContext*, align 8
  %sector = alloca [2352 x i8], align 16
  %start = alloca i32, align 4
  %i = alloca i32, align 4
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2289, metadata !2158), !dbg !2290
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2291, metadata !2158), !dbg !2292
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2293
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2294
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2294
  store %struct.AVIOContext* %1, %struct.AVIOContext** %pb, align 8, !dbg !2292
  call void @llvm.dbg.declare(metadata %struct.StrDemuxContext** %str, metadata !2295, metadata !2158), !dbg !2310
  %2 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2311
  %priv_data = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %2, i32 0, i32 3, !dbg !2312
  %3 = load i8*, i8** %priv_data, align 8, !dbg !2312
  %4 = bitcast i8* %3 to %struct.StrDemuxContext*, !dbg !2311
  store %struct.StrDemuxContext* %4, %struct.StrDemuxContext** %str, align 8, !dbg !2310
  call void @llvm.dbg.declare(metadata [2352 x i8]* %sector, metadata !2313, metadata !2158), !dbg !2317
  call void @llvm.dbg.declare(metadata i32* %start, metadata !2318, metadata !2158), !dbg !2319
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2320, metadata !2158), !dbg !2321
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2322
  %arraydecay = getelementptr inbounds [2352 x i8], [2352 x i8]* %sector, i32 0, i32 0, !dbg !2324
  %call = call i32 @avio_read(%struct.AVIOContext* %5, i8* %arraydecay, i32 44), !dbg !2325
  %cmp = icmp ne i32 %call, 44, !dbg !2326
  br i1 %cmp, label %if.then, label %if.end, !dbg !2327

if.then:                                          ; preds = %entry
  store i32 -5, i32* %retval, align 4, !dbg !2328
  br label %return, !dbg !2328

if.end:                                           ; preds = %entry
  %arrayidx = getelementptr inbounds [2352 x i8], [2352 x i8]* %sector, i64 0, i64 0, !dbg !2329
  %6 = bitcast i8* %arrayidx to %union.unaligned_32*, !dbg !2331
  %l = bitcast %union.unaligned_32* %6 to i32*, !dbg !2331
  %7 = load i32, i32* %l, align 16, !dbg !2331
  %cmp2 = icmp eq i32 %7, 1179011410, !dbg !2332
  br i1 %cmp2, label %if.then3, label %if.else, !dbg !2333

if.then3:                                         ; preds = %if.end
  store i32 44, i32* %start, align 4, !dbg !2334
  br label %if.end4, !dbg !2335

if.else:                                          ; preds = %if.end
  store i32 0, i32* %start, align 4, !dbg !2336
  br label %if.end4

if.end4:                                          ; preds = %if.else, %if.then3
  %8 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2337
  %9 = load i32, i32* %start, align 4, !dbg !2338
  %conv = sext i32 %9 to i64, !dbg !2338
  %call5 = call i64 @avio_seek(%struct.AVIOContext* %8, i64 %conv, i32 0), !dbg !2339
  store i32 0, i32* %i, align 4, !dbg !2340
  br label %for.cond, !dbg !2342

for.cond:                                         ; preds = %for.inc, %if.end4
  %10 = load i32, i32* %i, align 4, !dbg !2343
  %cmp6 = icmp slt i32 %10, 32, !dbg !2346
  br i1 %cmp6, label %for.body, label %for.end, !dbg !2347

for.body:                                         ; preds = %for.cond
  %11 = load i32, i32* %i, align 4, !dbg !2348
  %idxprom = sext i32 %11 to i64, !dbg !2350
  %12 = load %struct.StrDemuxContext*, %struct.StrDemuxContext** %str, align 8, !dbg !2350
  %channels = getelementptr inbounds %struct.StrDemuxContext, %struct.StrDemuxContext* %12, i32 0, i32 0, !dbg !2351
  %arrayidx8 = getelementptr inbounds [32 x %struct.StrChannel], [32 x %struct.StrChannel]* %channels, i64 0, i64 %idxprom, !dbg !2350
  %audio_stream_index = getelementptr inbounds %struct.StrChannel, %struct.StrChannel* %arrayidx8, i32 0, i32 2, !dbg !2352
  store i32 -1, i32* %audio_stream_index, align 8, !dbg !2353
  %13 = load i32, i32* %i, align 4, !dbg !2354
  %idxprom9 = sext i32 %13 to i64, !dbg !2355
  %14 = load %struct.StrDemuxContext*, %struct.StrDemuxContext** %str, align 8, !dbg !2355
  %channels10 = getelementptr inbounds %struct.StrDemuxContext, %struct.StrDemuxContext* %14, i32 0, i32 0, !dbg !2356
  %arrayidx11 = getelementptr inbounds [32 x %struct.StrChannel], [32 x %struct.StrChannel]* %channels10, i64 0, i64 %idxprom9, !dbg !2355
  %video_stream_index = getelementptr inbounds %struct.StrChannel, %struct.StrChannel* %arrayidx11, i32 0, i32 0, !dbg !2357
  store i32 -1, i32* %video_stream_index, align 8, !dbg !2358
  br label %for.inc, !dbg !2359

for.inc:                                          ; preds = %for.body
  %15 = load i32, i32* %i, align 4, !dbg !2360
  %inc = add nsw i32 %15, 1, !dbg !2360
  store i32 %inc, i32* %i, align 4, !dbg !2360
  br label %for.cond, !dbg !2362, !llvm.loop !2363

for.end:                                          ; preds = %for.cond
  %16 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2365
  %ctx_flags = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %16, i32 0, i32 5, !dbg !2366
  %17 = load i32, i32* %ctx_flags, align 8, !dbg !2367
  %or = or i32 %17, 1, !dbg !2367
  store i32 %or, i32* %ctx_flags, align 8, !dbg !2367
  store i32 0, i32* %retval, align 4, !dbg !2368
  br label %return, !dbg !2368

return:                                           ; preds = %for.end, %if.then
  %18 = load i32, i32* %retval, align 4, !dbg !2369
  ret i32 %18, !dbg !2369
}

; Function Attrs: nounwind uwtable
define internal i32 @str_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %ret_pkt) #0 !dbg !2370 {
entry:
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2373, metadata !2158), !dbg !2377
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %ret_pkt.addr = alloca %struct.AVPacket*, align 8
  %pb = alloca %struct.AVIOContext*, align 8
  %str = alloca %struct.StrDemuxContext*, align 8
  %sector = alloca [2352 x i8], align 16
  ...
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2384, metadata !2158), !dbg !2385
  store %struct.AVPacket* %ret_pkt, %struct.AVPacket** %ret_pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %ret_pkt.addr, metadata !2386, metadata !2158), !dbg !2387
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2388, metadata !2158), !dbg !2389
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2390
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2391
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2391
  store %struct.AVIOContext* %1, %struct.AVIOContext** %pb, align 8, !dbg !2389
  call void @llvm.dbg.declare(metadata %struct.StrDemuxContext** %str, metadata !2392, metadata !2158), !dbg !2393
  %2 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2394
  %priv_data = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %2, i32 0, i32 3, !dbg !2395
  %3 = load i8*, i8** %priv_data, align 8, !dbg !2395
  %4 = bitcast i8* %3 to %struct.StrDemuxContext*, !dbg !2394
  store %struct.StrDemuxContext* %4, %struct.StrDemuxContext** %str, align 8, !dbg !2393
  call void @llvm.dbg.declare(metadata [2352 x i8]* %sector, metadata !2396, metadata !2158), !dbg !2397
  call void @llvm.dbg.declare(metadata i32* %channel, metadata !2398, metadata !2158), !dbg !2399
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt, metadata !2400, metadata !2158), !dbg !2401
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2402, metadata !2158), !dbg !2403
  br label %while.body, !dbg !2404

while.body:                                       ; preds = %entry, %if.end143
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2405
  %arraydecay = getelementptr inbounds [2352 x i8], [2352 x i8]* %sector, i32 0, i32 0, !dbg !2407
  %call = call i32 @avio_read(%struct.AVIOContext* %5, i8* %arraydecay, i32 2352), !dbg !2408
  %cmp = icmp ne i32 %call, 2352, !dbg !2409
...
if.end:                                           ; preds = %while.body
  %arrayidx = getelementptr inbounds [2352 x i8], [2352 x i8]* %sector, i64 0, i64 17, !dbg !2412
  %6 = load i8, i8* %arrayidx, align 1, !dbg !2412
  %conv = zext i8 %6 to i32, !dbg !2412
  store i32 %conv, i32* %channel, align 4, !dbg !2413
  %7 = load i32, i32* %channel, align 4, !dbg !2414
  %cmp2 = icmp sge i32 %7, 32, !dbg !2416
  br i1 %cmp2, label %if.then4, label %if.end5, !dbg !2417

if.then4:                                         ; preds = %if.end
  store i32 -1094995529, i32* %retval, align 4, !dbg !2418
  br label %return, !dbg !2418

if.end5:                                          ; preds = %if.end
  %arrayidx6 = getelementptr inbounds [2352 x i8], [2352 x i8]* %sector, i64 0, i64 18, !dbg !2419
  %8 = load i8, i8* %arrayidx6, align 2, !dbg !2419
  %conv7 = zext i8 %8 to i32, !dbg !2419
  %and = and i32 %conv7, 14, !dbg !2420
  switch i32 %and, label %sw.default [
    i32 8, label %sw.bb
    i32 2, label %sw.bb
    i32 4, label %sw.bb82
...
sw.bb:                                            ; preds = %if.end5, %if.end5
  call void @llvm.dbg.declare(metadata i32* %current_sector, metadata !2422, metadata !2158), !dbg !2423
  %arrayidx8 = getelementptr inbounds [2352 x i8], [2352 x i8]* %sector, i64 0, i64 28, !dbg !2424
  %9 = bitcast i8* %arrayidx8 to %union.unaligned_16*, !dbg !2425
  %l = bitcast %union.unaligned_16* %9 to i16*, !dbg !2425
  %10 = load i16, i16* %l, align 4, !dbg !2425
  %conv9 = zext i16 %10 to i32, !dbg !2426
  store i32 %conv9, i32* %current_sector, align 4, !dbg !2423
  call void @llvm.dbg.declare(metadata i32* %sector_count, metadata !2427, metadata !2158), !dbg !2428
  %arrayidx10 = getelementptr inbounds [2352 x i8], [2352 x i8]* %sector, i64 0, i64 30, !dbg !2429
  %11 = bitcast i8* %arrayidx10 to %union.unaligned_16*, !dbg !2430
  %l11 = bitcast %union.unaligned_16* %11 to i16*, !dbg !2430
  %12 = load i16, i16* %l11, align 2, !dbg !2430
  %conv12 = zext i16 %12 to i32, !dbg !2431
  store i32 %conv12, i32* %sector_count, align 4, !dbg !2428
  call void @llvm.dbg.declare(metadata i32* %frame_size, metadata !2432, metadata !2158), !dbg !2433
  %arrayidx13 = getelementptr inbounds [2352 x i8], [2352 x i8]* %sector, i64 0, i64 36, !dbg !2434
  %13 = bitcast i8* %arrayidx13 to %union.unaligned_32*, !dbg !2435
  %l14 = bitcast %union.unaligned_32* %13 to i32*, !dbg !2435
  %14 = load i32, i32* %l14, align 4, !dbg !2435
  store i32 %14, i32* %frame_size, align 4, !dbg !2433
  %15 = load i32, i32* %frame_size, align 4, !dbg !2436
  %cmp15 = icmp sge i32 %15, 0, !dbg !2438
  br i1 %cmp15, label %land.lhs.true, label %if.then22, !dbg !2439

land.lhs.true:                                    ; preds = %sw.bb
  %16 = load i32, i32* %current_sector, align 4, !dbg !2440
  %17 = load i32, i32* %sector_count, align 4, !dbg !2442
  %cmp17 = icmp slt i32 %16, %17, !dbg !2443
  br i1 %cmp17, label %land.lhs.true19, label %if.then22, !dbg !2444

land.lhs.true19:                                  ; preds = %land.lhs.true
  %18 = load i32, i32* %sector_count, align 4, !dbg !2445
  %mul = mul nsw i32 %18, 2016, !dbg !2446
  %19 = load i32, i32* %frame_size, align 4, !dbg !2447
  %cmp20 = icmp sge i32 %mul, %19, !dbg !2448
  br i1 %cmp20, label %if.end23, label %if.then22, !dbg !2449

if.then22:                                        ; preds = %land.lhs.true19, %land.lhs.true, %sw.bb
  %20 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2451
  %21 = bitcast %struct.AVFormatContext* %20 to i8*, !dbg !2451
  %22 = load i32, i32* %current_sector, align 4, !dbg !2453
  %23 = load i32, i32* %sector_count, align 4, !dbg !2454
  %24 = load i32, i32* %frame_size, align 4, !dbg !2455
  call void (i8*, i32, i8*, ...) @av_log(i8* %21, i32 16, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i32 0, i32 0), i32 %22, i32 %23, i32 %24), !dbg !2456
  br label %sw.epilog, !dbg !2457

if.end23:                                         ; preds = %land.lhs.true19
  %25 = load i32, i32* %channel, align 4, !dbg !2458
  %idxprom = sext i32 %25 to i64, !dbg !2460
  %26 = load %struct.StrDemuxContext*, %struct.StrDemuxContext** %str, align 8, !dbg !2460
  %channels = getelementptr inbounds %struct.StrDemuxContext, %struct.StrDemuxContext* %26, i32 0, i32 0, !dbg !2461
  %arrayidx24 = getelementptr inbounds [32 x %struct.StrChannel], [32 x %struct.StrChannel]* %channels, i64 0, i64 %idxprom, !dbg !2460
  %video_stream_index = getelementptr inbounds %struct.StrChannel, %struct.StrChannel* %arrayidx24, i32 0, i32 0, !dbg !2462
  %27 = load i32, i32* %video_stream_index, align 8, !dbg !2462
  %cmp25 = icmp slt i32 %27, 0, !dbg !2463
  br i1 %cmp25, label %if.then27, label %if.end45, !dbg !2464

if.then27:                                        ; preds = %if.end23
  %28 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2465
  %call28 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %28, %struct.AVCodec* null), !dbg !2467
  store %struct.AVStream* %call28, %struct.AVStream** %st, align 8, !dbg !2468
  %29 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2469
  %tobool = icmp ne %struct.AVStream* %29, null, !dbg !2469
  br i1 %tobool, label %if.end30, label %if.then29, !dbg !2471

if.then29:                                        ; preds = %if.then27
  store i32 -12, i32* %retval, align 4, !dbg !2472
  br label %return, !dbg !2472

if.end30:                                         ; preds = %if.then27
  %30 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2473
  call void @avpriv_set_pts_info(%struct.AVStream* %30, i32 64, i32 1, i32 15), !dbg !2474
  %31 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2475
  %index = getelementptr inbounds %struct.AVStream, %struct.AVStream* %31, i32 0, i32 0, !dbg !2476
  %32 = load i32, i32* %index, align 8, !dbg !2476
  %33 = load i32, i32* %channel, align 4, !dbg !2477
  %idxprom31 = sext i32 %33 to i64, !dbg !2478
  %34 = load %struct.StrDemuxContext*, %struct.StrDemuxContext** %str, align 8, !dbg !2478
  %channels32 = getelementptr inbounds %struct.StrDemuxContext, %struct.StrDemuxContext* %34, i32 0, i32 0, !dbg !2479
  %arrayidx33 = getelementptr inbounds [32 x %struct.StrChannel], [32 x %struct.StrChannel]* %channels32, i64 0, i64 %idxprom31, !dbg !2478
  %video_stream_index34 = getelementptr inbounds %struct.StrChannel, %struct.StrChannel* %arrayidx33, i32 0, i32 0, !dbg !2480
  store i32 %32, i32* %video_stream_index34, align 8, !dbg !2481
  %35 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2482
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %35, i32 0, i32 19, !dbg !2483
  %36 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2483
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %36, i32 0, i32 0, !dbg !2484
  store i32 0, i32* %codec_type, align 8, !dbg !2485
  %37 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2486
  %codecpar35 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %37, i32 0, i32 19, !dbg !2487
  %38 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar35, align 8, !dbg !2487
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %38, i32 0, i32 1, !dbg !2488
  store i32 37, i32* %codec_id, align 4, !dbg !2489
  %39 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2490
  %codecpar36 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %39, i32 0, i32 19, !dbg !2491
  %40 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar36, align 8, !dbg !2491
  %codec_tag = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %40, i32 0, i32 2, !dbg !2492
  store i32 0, i32* %codec_tag, align 8, !dbg !2493
  %arrayidx37 = getelementptr inbounds [2352 x i8], [2352 x i8]* %sector, i64 0, i64 40, !dbg !2494
  %41 = bitcast i8* %arrayidx37 to %union.unaligned_16*, !dbg !2495
  %l38 = bitcast %union.unaligned_16* %41 to i16*, !dbg !2495
  %42 = load i16, i16* %l38, align 8, !dbg !2495
  %conv39 = zext i16 %42 to i32, !dbg !2496
  %43 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2497
  %codecpar40 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %43, i32 0, i32 19, !dbg !2498
  %44 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar40, align 8, !dbg !2498
  %width = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %44, i32 0, i32 11, !dbg !2499
  store i32 %conv39, i32* %width, align 8, !dbg !2500
  %arrayidx41 = getelementptr inbounds [2352 x i8], [2352 x i8]* %sector, i64 0, i64 42, !dbg !2501
  %45 = bitcast i8* %arrayidx41 to %union.unaligned_16*, !dbg !2502
  %l42 = bitcast %union.unaligned_16* %45 to i16*, !dbg !2502
  %46 = load i16, i16* %l42, align 2, !dbg !2502
  %conv43 = zext i16 %46 to i32, !dbg !2503
  %47 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2504
  %codecpar44 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %47, i32 0, i32 19, !dbg !2505
  %48 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar44, align 8, !dbg !2505
  %height = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %48, i32 0, i32 12, !dbg !2506
  store i32 %conv43, i32* %height, align 4, !dbg !2507
  br label %if.end45, !dbg !2508

if.end45:                                         ; preds = %if.end30, %if.end23
  %49 = load i32, i32* %channel, align 4, !dbg !2509
  %idxprom46 = sext i32 %49 to i64, !dbg !2510
  %50 = load %struct.StrDemuxContext*, %struct.StrDemuxContext** %str, align 8, !dbg !2510
  %channels47 = getelementptr inbounds %struct.StrDemuxContext, %struct.StrDemuxContext* %50, i32 0, i32 0, !dbg !2511
  %arrayidx48 = getelementptr inbounds [32 x %struct.StrChannel], [32 x %struct.StrChannel]* %channels47, i64 0, i64 %idxprom46, !dbg !2510
  %tmp_pkt = getelementptr inbounds %struct.StrChannel, %struct.StrChannel* %arrayidx48, i32 0, i32 1, !dbg !2512
  store %struct.AVPacket* %tmp_pkt, %struct.AVPacket** %pkt, align 8, !dbg !2513
  %51 = load %struct.AVPacket*, %struct.AVPacket** %pkt, align 8, !dbg !2514
  %size = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %51, i32 0, i32 4, !dbg !2515
  %52 = load i32, i32* %size, align 8, !dbg !2515
  %53 = load i32, i32* %sector_count, align 4, !dbg !2516
  %mul49 = mul nsw i32 %53, 2016, !dbg !2517
  %cmp50 = icmp ne i32 %52, %mul49, !dbg !2518
  br i1 %cmp50, label %if.then52, label %if.end69, !dbg !2519

if.then52:                                        ; preds = %if.end45
  %54 = load %struct.AVPacket*, %struct.AVPacket** %pkt, align 8, !dbg !2520
  %data = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %54, i32 0, i32 3, !dbg !2522
  %55 = load i8*, i8** %data, align 8, !dbg !2522
  %tobool53 = icmp ne i8* %55, null, !dbg !2520
  br i1 %tobool53, label %if.then54, label %if.end55, !dbg !2523

if.then54:                                        ; preds = %if.then52
  %56 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2524
  %57 = bitcast %struct.AVFormatContext* %56 to i8*, !dbg !2524
  call void (i8*, i32, i8*, ...) @av_log(i8* %57, i32 16, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.3, i32 0, i32 0)), !dbg !2525
  br label %if.end55, !dbg !2525

if.end55:                                         ; preds = %if.then54, %if.then52
  %58 = load %struct.AVPacket*, %struct.AVPacket** %pkt, align 8, !dbg !2526
  call void @av_packet_unref(%struct.AVPacket* %58), !dbg !2527
  %59 = load %struct.AVPacket*, %struct.AVPacket** %pkt, align 8, !dbg !2528
  %60 = load i32, i32* %sector_count, align 4, !dbg !2530
  %mul56 = mul nsw i32 %60, 2016, !dbg !2531
  %call57 = call i32 @av_new_packet(%struct.AVPacket* %59, i32 %mul56), !dbg !2532
  %tobool58 = icmp ne i32 %call57, 0, !dbg !2532
  br i1 %tobool58, label %if.then59, label %if.end60, !dbg !2533

if.then59:                                        ; preds = %if.end55
  store i32 -5, i32* %retval, align 4, !dbg !2534
  br label %return, !dbg !2534

if.end60:                                         ; preds = %if.end55
  %61 = load %struct.AVPacket*, %struct.AVPacket** %pkt, align 8, !dbg !2535
  %data61 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %61, i32 0, i32 3, !dbg !2536
  %62 = load i8*, i8** %data61, align 8, !dbg !2536
  %63 = load i32, i32* %sector_count, align 4, !dbg !2537
  %mul62 = mul nsw i32 %63, 2016, !dbg !2538
  %conv63 = sext i32 %mul62 to i64, !dbg !2537
  call void @llvm.memset.p0i8.i64(i8* %62, i8 0, i64 %conv63, i32 1, i1 false), !dbg !2539
  %64 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2540
  store %struct.AVIOContext* %64, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2541
  %65 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2542
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %65, i64 0, i32 1) #6, !dbg !2543
  %sub = sub nsw i64 %call.i, 2352, !dbg !2544
  %66 = load %struct.AVPacket*, %struct.AVPacket** %pkt, align 8, !dbg !2545
  %pos = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %66, i32 0, i32 10, !dbg !2546
  store i64 %sub, i64* %pos, align 8, !dbg !2547
  %67 = load i32, i32* %channel, align 4, !dbg !2548
  %idxprom65 = sext i32 %67 to i64, !dbg !2549
  %68 = load %struct.StrDemuxContext*, %struct.StrDemuxContext** %str, align 8, !dbg !2549
  %channels66 = getelementptr inbounds %struct.StrDemuxContext, %struct.StrDemuxContext* %68, i32 0, i32 0, !dbg !2550
  %arrayidx67 = getelementptr inbounds [32 x %struct.StrChannel], [32 x %struct.StrChannel]* %channels66, i64 0, i64 %idxprom65, !dbg !2549
  %video_stream_index68 = getelementptr inbounds %struct.StrChannel, %struct.StrChannel* %arrayidx67, i32 0, i32 0, !dbg !2551
  %69 = load i32, i32* %video_stream_index68, align 8, !dbg !2551
  %70 = load %struct.AVPacket*, %struct.AVPacket** %pkt, align 8, !dbg !2552
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %70, i32 0, i32 5, !dbg !2553
  store i32 %69, i32* %stream_index, align 4, !dbg !2554
  br label %if.end69, !dbg !2555

if.end69:                                         ; preds = %if.end60, %if.end45
  %71 = load %struct.AVPacket*, %struct.AVPacket** %pkt, align 8, !dbg !2556
  %data70 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %71, i32 0, i32 3, !dbg !2557
  %72 = load i8*, i8** %data70, align 8, !dbg !2557
  %73 = load i32, i32* %current_sector, align 4, !dbg !2558
  %mul71 = mul nsw i32 %73, 2016, !dbg !2559
  %idx.ext = sext i32 %mul71 to i64, !dbg !2560
  %add.ptr = getelementptr inbounds i8, i8* %72, i64 %idx.ext, !dbg !2560
  %arraydecay72 = getelementptr inbounds [2352 x i8], [2352 x i8]* %sector, i32 0, i32 0, !dbg !2561
  %add.ptr73 = getelementptr inbounds i8, i8* %arraydecay72, i64 56, !dbg !2562
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %add.ptr, i8* %add.ptr73, i64 2016, i32 1, i1 false), !dbg !2563
  %74 = load i32, i32* %current_sector, align 4, !dbg !2564
  %75 = load i32, i32* %sector_count, align 4, !dbg !2566
  %sub74 = sub nsw i32 %75, 1, !dbg !2567
  %cmp75 = icmp eq i32 %74, %sub74, !dbg !2568
  br i1 %cmp75, label %if.then77, label %if.end81, !dbg !2569

if.then77:                                        ; preds = %if.end69
  %76 = load i32, i32* %frame_size, align 4, !dbg !2570
  %77 = load %struct.AVPacket*, %struct.AVPacket** %pkt, align 8, !dbg !2572
  %size78 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %77, i32 0, i32 4, !dbg !2573
  store i32 %76, i32* %size78, align 8, !dbg !2574
  %78 = load %struct.AVPacket*, %struct.AVPacket** %ret_pkt.addr, align 8, !dbg !2575
  %79 = load %struct.AVPacket*, %struct.AVPacket** %pkt, align 8, !dbg !2576
  %80 = bitcast %struct.AVPacket* %78 to i8*, !dbg !2577
  %81 = bitcast %struct.AVPacket* %79 to i8*, !dbg !2577
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %80, i8* %81, i64 88, i32 8, i1 false), !dbg !2577
  %82 = load %struct.AVPacket*, %struct.AVPacket** %pkt, align 8, !dbg !2578
  %data79 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %82, i32 0, i32 3, !dbg !2579
  store i8* null, i8** %data79, align 8, !dbg !2580
  %83 = load %struct.AVPacket*, %struct.AVPacket** %pkt, align 8, !dbg !2581
  %size80 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %83, i32 0, i32 4, !dbg !2582
  store i32 -1, i32* %size80, align 8, !dbg !2583
  %84 = load %struct.AVPacket*, %struct.AVPacket** %pkt, align 8, !dbg !2584
  %buf = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %84, i32 0, i32 0, !dbg !2585
  store %struct.AVBufferRef* null, %struct.AVBufferRef** %buf, align 8, !dbg !2586
...
sw.bb82:                                          ; preds = %if.end5
  %85 = load i32, i32* %channel, align 4, !dbg !2589
  %idxprom83 = sext i32 %85 to i64, !dbg !2591
  %86 = load %struct.StrDemuxContext*, %struct.StrDemuxContext** %str, align 8, !dbg !2591
  %channels84 = getelementptr inbounds %struct.StrDemuxContext, %struct.StrDemuxContext* %86, i32 0, i32 0, !dbg !2592
  %arrayidx85 = getelementptr inbounds [32 x %struct.StrChannel], [32 x %struct.StrChannel]* %channels84, i64 0, i64 %idxprom83, !dbg !2591
  %audio_stream_index = getelementptr inbounds %struct.StrChannel, %struct.StrChannel* %arrayidx85, i32 0, i32 2, !dbg !2593
  %87 = load i32, i32* %audio_stream_index, align 8, !dbg !2593
  %cmp86 = icmp slt i32 %87, 0, !dbg !2594
  br i1 %cmp86, label %if.then88, label %if.end125, !dbg !2595

if.then88:                                        ; preds = %sw.bb82
  call void @llvm.dbg.declare(metadata i32* %fmt, metadata !2596, metadata !2158), !dbg !2598
  %arrayidx89 = getelementptr inbounds [2352 x i8], [2352 x i8]* %sector, i64 0, i64 19, !dbg !2599
  %88 = load i8, i8* %arrayidx89, align 1, !dbg !2599
  %conv90 = zext i8 %88 to i32, !dbg !2599
  store i32 %conv90, i32* %fmt, align 4, !dbg !2598
  %89 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2600
  %call91 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %89, %struct.AVCodec* null), !dbg !2601
  store %struct.AVStream* %call91, %struct.AVStream** %st, align 8, !dbg !2602
  %90 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2603
  %tobool92 = icmp ne %struct.AVStream* %90, null, !dbg !2603
  br i1 %tobool92, label %if.end94, label %if.then93, !dbg !2605

if.then93:                                        ; preds = %if.then88
  store i32 -12, i32* %retval, align 4, !dbg !2606
  br label %return, !dbg !2606

if.end94:                                         ; preds = %if.then88
  %91 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2607
  %index95 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %91, i32 0, i32 0, !dbg !2608
  %92 = load i32, i32* %index95, align 8, !dbg !2608
  %93 = load i32, i32* %channel, align 4, !dbg !2609
  %idxprom96 = sext i32 %93 to i64, !dbg !2610
  %94 = load %struct.StrDemuxContext*, %struct.StrDemuxContext** %str, align 8, !dbg !2610
  %channels97 = getelementptr inbounds %struct.StrDemuxContext, %struct.StrDemuxContext* %94, i32 0, i32 0, !dbg !2611
  %arrayidx98 = getelementptr inbounds [32 x %struct.StrChannel], [32 x %struct.StrChannel]* %channels97, i64 0, i64 %idxprom96, !dbg !2610
  %audio_stream_index99 = getelementptr inbounds %struct.StrChannel, %struct.StrChannel* %arrayidx98, i32 0, i32 2, !dbg !2612
  store i32 %92, i32* %audio_stream_index99, align 8, !dbg !2613
  %95 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2614
  %codecpar100 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %95, i32 0, i32 19, !dbg !2615
  %96 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar100, align 8, !dbg !2615
  %codec_type101 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %96, i32 0, i32 0, !dbg !2616
  store i32 1, i32* %codec_type101, align 8, !dbg !2617
  %97 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2618
  %codecpar102 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %97, i32 0, i32 19, !dbg !2619
  %98 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar102, align 8, !dbg !2619
  %codec_id103 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %98, i32 0, i32 1, !dbg !2620
  store i32 69640, i32* %codec_id103, align 4, !dbg !2621
  %99 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2622
  %codecpar104 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %99, i32 0, i32 19, !dbg !2623
  %100 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar104, align 8, !dbg !2623
  %codec_tag105 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %100, i32 0, i32 2, !dbg !2624
  store i32 0, i32* %codec_tag105, align 8, !dbg !2625
  %101 = load i32, i32* %fmt, align 4, !dbg !2626
  %and106 = and i32 %101, 1, !dbg !2628
  %tobool107 = icmp ne i32 %and106, 0, !dbg !2628
  br i1 %tobool107, label %if.then108, label %if.else, !dbg !2629

if.then108:                                       ; preds = %if.end94
  %102 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2630
  %codecpar109 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %102, i32 0, i32 19, !dbg !2632
  %103 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar109, align 8, !dbg !2632
  %channels110 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %103, i32 0, i32 22, !dbg !2633
  store i32 2, i32* %channels110, align 8, !dbg !2634
  %104 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2635
  %codecpar111 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %104, i32 0, i32 19, !dbg !2636
  %105 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar111, align 8, !dbg !2636
  %channel_layout = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %105, i32 0, i32 21, !dbg !2637
  store i64 3, i64* %channel_layout, align 8, !dbg !2638
  br label %if.end116, !dbg !2639

if.else:                                          ; preds = %if.end94
  %106 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2640
  %codecpar112 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %106, i32 0, i32 19, !dbg !2642
  %107 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar112, align 8, !dbg !2642
  %channels113 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %107, i32 0, i32 22, !dbg !2643
  store i32 1, i32* %channels113, align 8, !dbg !2644
  %108 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2645
  %codecpar114 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %108, i32 0, i32 19, !dbg !2646
  %109 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar114, align 8, !dbg !2646
  %channel_layout115 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %109, i32 0, i32 21, !dbg !2647
  store i64 4, i64* %channel_layout115, align 8, !dbg !2648
  br label %if.end116

if.end116:                                        ; preds = %if.else, %if.then108
  %110 = load i32, i32* %fmt, align 4, !dbg !2649
  %and117 = and i32 %110, 4, !dbg !2650
  %tobool118 = icmp ne i32 %and117, 0, !dbg !2651
  %cond = select i1 %tobool118, i32 18900, i32 37800, !dbg !2651
  %111 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2652
  %codecpar119 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %111, i32 0, i32 19, !dbg !2653
  %112 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar119, align 8, !dbg !2653
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %112, i32 0, i32 23, !dbg !2654
  store i32 %cond, i32* %sample_rate, align 4, !dbg !2655
  %113 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2656
  %codecpar120 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %113, i32 0, i32 19, !dbg !2657
  %114 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar120, align 8, !dbg !2657
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %114, i32 0, i32 24, !dbg !2658
  store i32 128, i32* %block_align, align 8, !dbg !2659
  %115 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2660
  %116 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2661
  %codecpar121 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %116, i32 0, i32 19, !dbg !2662
  %117 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar121, align 8, !dbg !2662
  %channels122 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %117, i32 0, i32 22, !dbg !2663
  %118 = load i32, i32* %channels122, align 8, !dbg !2663
  %div = sdiv i32 4032, %118, !dbg !2664
  %119 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2665
  %codecpar123 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %119, i32 0, i32 19, !dbg !2666
  %120 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar123, align 8, !dbg !2666
  %sample_rate124 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %120, i32 0, i32 23, !dbg !2667
  %121 = load i32, i32* %sample_rate124, align 4, !dbg !2667
  call void @avpriv_set_pts_info(%struct.AVStream* %115, i32 64, i32 %div, i32 %121), !dbg !2668
  %122 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2669
  %start_time = getelementptr inbounds %struct.AVStream, %struct.AVStream* %122, i32 0, i32 5, !dbg !2670
  store i64 0, i64* %start_time, align 8, !dbg !2671
  br label %if.end125, !dbg !2672

if.end125:                                        ; preds = %if.end116, %sw.bb82
  %123 = load %struct.AVPacket*, %struct.AVPacket** %ret_pkt.addr, align 8, !dbg !2673
  store %struct.AVPacket* %123, %struct.AVPacket** %pkt, align 8, !dbg !2674
  %124 = load %struct.AVPacket*, %struct.AVPacket** %pkt, align 8, !dbg !2675
  %call126 = call i32 @av_new_packet(%struct.AVPacket* %124, i32 2304), !dbg !2677
  %tobool127 = icmp ne i32 %call126, 0, !dbg !2677
  br i1 %tobool127, label %if.then128, label %if.end129, !dbg !2678
...
if.end129:                                        ; preds = %if.end125
  %125 = load %struct.AVPacket*, %struct.AVPacket** %pkt, align 8, !dbg !2680
  %data130 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %125, i32 0, i32 3, !dbg !2681
  %126 = load i8*, i8** %data130, align 8, !dbg !2681
  %arraydecay131 = getelementptr inbounds [2352 x i8], [2352 x i8]* %sector, i32 0, i32 0, !dbg !2682
  %add.ptr132 = getelementptr inbounds i8, i8* %arraydecay131, i64 24, !dbg !2683
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %126, i8* %add.ptr132, i64 2304, i32 1, i1 false), !dbg !2684
  %127 = load i32, i32* %channel, align 4, !dbg !2685
  %idxprom133 = sext i32 %127 to i64, !dbg !2686
  %128 = load %struct.StrDemuxContext*, %struct.StrDemuxContext** %str, align 8, !dbg !2686
  %channels134 = getelementptr inbounds %struct.StrDemuxContext, %struct.StrDemuxContext* %128, i32 0, i32 0, !dbg !2687
  %arrayidx135 = getelementptr inbounds [32 x %struct.StrChannel], [32 x %struct.StrChannel]* %channels134, i64 0, i64 %idxprom133, !dbg !2686
  %audio_stream_index136 = getelementptr inbounds %struct.StrChannel, %struct.StrChannel* %arrayidx135, i32 0, i32 2, !dbg !2688
  %129 = load i32, i32* %audio_stream_index136, align 8, !dbg !2688
  %130 = load %struct.AVPacket*, %struct.AVPacket** %pkt, align 8, !dbg !2689
  %stream_index137 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %130, i32 0, i32 5, !dbg !2690
  store i32 %129, i32* %stream_index137, align 4, !dbg !2691
  %131 = load %struct.AVPacket*, %struct.AVPacket** %pkt, align 8, !dbg !2692
  %duration = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %131, i32 0, i32 9, !dbg !2693
  store i64 1, i64* %duration, align 8, !dbg !2694
  store i32 0, i32* %retval, align 4, !dbg !2695
  br label %return, !dbg !2695

sw.default:                                       ; preds = %if.end5
  %132 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2696
  %133 = bitcast %struct.AVFormatContext* %132 to i8*, !dbg !2696
  %arrayidx138 = getelementptr inbounds [2352 x i8], [2352 x i8]* %sector, i64 0, i64 18, !dbg !2697
  %134 = load i8, i8* %arrayidx138, align 2, !dbg !2697
  %conv139 = zext i8 %134 to i32, !dbg !2697
  call void (i8*, i32, i8*, ...) @av_log(i8* %133, i32 24, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.4, i32 0, i32 0), i32 %conv139), !dbg !2698
  br label %sw.epilog, !dbg !2699

sw.epilog:                                        ; preds = %sw.default, %if.end81, %if.then22
  %135 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2700
  %call140 = call i32 @avio_feof(%struct.AVIOContext* %135), !dbg !2702
  %tobool141 = icmp ne i32 %call140, 0, !dbg !2702
  br i1 %tobool141, label %if.then142, label %if.end143, !dbg !2703
...
if.end143:                                        ; preds = %sw.epilog
  br label %while.body, !dbg !2705, !llvm.loop !2707

return:                                           ; preds = %if.then142, %if.end129, %if.then128, %if.then93, %if.then77, %if.then59, %if.then29, %if.then4, %if.then
  %136 = load i32, i32* %retval, align 4, !dbg !2708
  ret i32 %136, !dbg !2708
}

; Function Attrs: nounwind uwtable
define internal i32 @str_read_close(%struct.AVFormatContext* %s) #0 !dbg !2709 {
entry:
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %str = alloca %struct.StrDemuxContext*, align 8
  %i = alloca i32, align 4
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2710, metadata !2158), !dbg !2711
  call void @llvm.dbg.declare(metadata %struct.StrDemuxContext** %str, metadata !2712, metadata !2158), !dbg !2713
  ...
  %2 = bitcast i8* %1 to %struct.StrDemuxContext*, !dbg !2714
  store %struct.StrDemuxContext* %2, %struct.StrDemuxContext** %str, align 8, !dbg !2713
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2716, metadata !2158), !dbg !2717
  store i32 0, i32* %i, align 4, !dbg !2718
  br label %for.cond, !dbg !2720

for.cond:                                         ; preds = %for.inc, %entry
  %3 = load i32, i32* %i, align 4, !dbg !2721
  %cmp = icmp slt i32 %3, 32, !dbg !2724
  br i1 %cmp, label %for.body, label %for.end, !dbg !2725

for.body:                                         ; preds = %for.cond
  %4 = load i32, i32* %i, align 4, !dbg !2726
  %idxprom = sext i32 %4 to i64, !dbg !2729
  %5 = load %struct.StrDemuxContext*, %struct.StrDemuxContext** %str, align 8, !dbg !2729
  %channels = getelementptr inbounds %struct.StrDemuxContext, %struct.StrDemuxContext* %5, i32 0, i32 0, !dbg !2730
  %arrayidx = getelementptr inbounds [32 x %struct.StrChannel], [32 x %struct.StrChannel]* %channels, i64 0, i64 %idxprom, !dbg !2729
  %tmp_pkt = getelementptr inbounds %struct.StrChannel, %struct.StrChannel* %arrayidx, i32 0, i32 1, !dbg !2731
  %data = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %tmp_pkt, i32 0, i32 3, !dbg !2732
  %6 = load i8*, i8** %data, align 8, !dbg !2732
  %tobool = icmp ne i8* %6, null, !dbg !2729
  br i1 %tobool, label %if.then, label %if.end, !dbg !2733

if.then:                                          ; preds = %for.body
  %7 = load i32, i32* %i, align 4, !dbg !2734
  %idxprom1 = sext i32 %7 to i64, !dbg !2735
  %8 = load %struct.StrDemuxContext*, %struct.StrDemuxContext** %str, align 8, !dbg !2735
  %channels2 = getelementptr inbounds %struct.StrDemuxContext, %struct.StrDemuxContext* %8, i32 0, i32 0, !dbg !2736
  %arrayidx3 = getelementptr inbounds [32 x %struct.StrChannel], [32 x %struct.StrChannel]* %channels2, i64 0, i64 %idxprom1, !dbg !2735
  %tmp_pkt4 = getelementptr inbounds %struct.StrChannel, %struct.StrChannel* %arrayidx3, i32 0, i32 1, !dbg !2737
  call void @av_packet_unref(%struct.AVPacket* %tmp_pkt4), !dbg !2738
...
for.inc:                                          ; preds = %if.end
  %9 = load i32, i32* %i, align 4, !dbg !2740
  %inc = add nsw i32 %9, 1, !dbg !2740
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--psxstr.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!934 = !{!935, !2148}
!935 = distinct !DIGlobalVariable(name: "ff_str_demuxer", scope: !0, file: !936, line: 301, type: !937, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_str_demuxer)
!936 = !DIFile(filename: "libavformat/psxstr.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2148 = distinct !DIGlobalVariable(name: "sync_header", scope: !0, file: !936, line: 69, type: !2149, isLocal: true, isDefinition: true, variable: [12 x i8]* @sync_header)
!2149 = !DICompositeType(tag: DW_TAG_array_type, baseType: !1259, size: 96, align: 8, elements: !2150)
!2150 = !{!2151}
...
!2155 = distinct !DISubprogram(name: "str_probe", scope: !936, file: !936, line: 71, type: !1006, isLocal: true, isDefinition: true, scopeLine: 72, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2156)
!2156 = !{}
!2157 = !DILocalVariable(name: "p", arg: 1, scope: !2155, file: !936, line: 71, type: !1008)
!2158 = !DIExpression()
!2159 = !DILocation(line: 71, column: 35, scope: !2155)
!2160 = !DILocalVariable(name: "sector", scope: !2155, file: !936, line: 73, type: !1258)
!2161 = !DILocation(line: 73, column: 20, scope: !2155)
!2162 = !DILocation(line: 73, column: 28, scope: !2155)
!2163 = !DILocation(line: 73, column: 31, scope: !2155)
!2164 = !DILocalVariable(name: "end", scope: !2155, file: !936, line: 74, type: !1258)
!2165 = !DILocation(line: 74, column: 20, scope: !2155)
!2166 = !DILocation(line: 74, column: 25, scope: !2155)
!2167 = !DILocation(line: 74, column: 34, scope: !2155)
!2168 = !DILocation(line: 74, column: 37, scope: !2155)
!2169 = !DILocation(line: 74, column: 32, scope: !2155)
!2170 = !DILocalVariable(name: "aud", scope: !2155, file: !936, line: 75, type: !933)
!2171 = !DILocation(line: 75, column: 9, scope: !2155)
!2172 = !DILocalVariable(name: "vid", scope: !2155, file: !936, line: 75, type: !933)
!2173 = !DILocation(line: 75, column: 16, scope: !2155)
!2174 = !DILocation(line: 77, column: 9, scope: !2175)
!2175 = distinct !DILexicalBlock(scope: !2155, file: !936, line: 77, column: 9)
!2176 = !DILocation(line: 77, column: 12, scope: !2175)
!2177 = !DILocation(line: 77, column: 21, scope: !2175)
!2178 = !DILocation(line: 77, column: 9, scope: !2155)
!2179 = !DILocation(line: 78, column: 9, scope: !2175)
!2180 = !DILocation(line: 80, column: 43, scope: !2181)
!2181 = distinct !DILexicalBlock(scope: !2155, file: !936, line: 80, column: 9)
!2182 = !DILocation(line: 80, column: 46, scope: !2181)
!2183 = !DILocation(line: 80, column: 56, scope: !2181)
!2184 = !DILocation(line: 80, column: 59, scope: !2181)
!2185 = !DILocation(line: 80, column: 128, scope: !2181)
!2186 = !DILocation(line: 81, column: 43, scope: !2181)
!2187 = !DILocation(line: 81, column: 46, scope: !2181)
!2188 = !DILocation(line: 81, column: 56, scope: !2181)
!2189 = !DILocation(line: 81, column: 59, scope: !2181)
!2190 = !DILocation(line: 80, column: 9, scope: !2191)
!2191 = !DILexicalBlockFile(scope: !2155, file: !936, discriminator: 1)
!2192 = !DILocation(line: 84, column: 16, scope: !2193)
!2193 = distinct !DILexicalBlock(scope: !2181, file: !936, line: 81, column: 129)
!2194 = !DILocation(line: 85, column: 5, scope: !2193)
!2195 = !DILocation(line: 87, column: 5, scope: !2155)
!2196 = !DILocation(line: 87, column: 12, scope: !2191)
!2197 = !DILocation(line: 87, column: 18, scope: !2191)
!2198 = !DILocation(line: 87, column: 16, scope: !2191)
!2199 = !DILocation(line: 87, column: 25, scope: !2191)
!2200 = !DILocation(line: 87, column: 5, scope: !2191)
!2201 = !DILocation(line: 89, column: 20, scope: !2202)
!2202 = distinct !DILexicalBlock(scope: !2203, file: !936, line: 89, column: 13)
!2203 = distinct !DILexicalBlock(scope: !2155, file: !936, line: 87, column: 34)
!2204 = !DILocation(line: 89, column: 13, scope: !2202)
!2205 = !DILocation(line: 89, column: 13, scope: !2203)
!2206 = !DILocation(line: 90, column: 13, scope: !2202)
!2207 = !DILocation(line: 92, column: 13, scope: !2208)
!2208 = distinct !DILexicalBlock(scope: !2203, file: !936, line: 92, column: 13)
!2209 = !DILocation(line: 92, column: 26, scope: !2208)
!2210 = !DILocation(line: 92, column: 13, scope: !2203)
!2211 = !DILocation(line: 93, column: 13, scope: !2208)
!2212 = !DILocation(line: 95, column: 17, scope: !2203)
!2213 = !DILocation(line: 95, column: 30, scope: !2203)
!2214 = !DILocation(line: 95, column: 9, scope: !2203)
!2215 = !DILocalVariable(name: "current_sector", scope: !2216, file: !936, line: 98, type: !933)
!2216 = distinct !DILexicalBlock(scope: !2217, file: !936, line: 97, column: 20)
!2217 = distinct !DILexicalBlock(scope: !2203, file: !936, line: 95, column: 38)
!2218 = !DILocation(line: 98, column: 21, scope: !2216)
!2219 = !DILocation(line: 98, column: 71, scope: !2216)
!2220 = !DILocation(line: 98, column: 87, scope: !2216)
!2221 = !DILocation(line: 98, column: 38, scope: !2216)
!2222 = !DILocalVariable(name: "sector_count", scope: !2216, file: !936, line: 99, type: !933)
!2223 = !DILocation(line: 99, column: 21, scope: !2216)
!2224 = !DILocation(line: 99, column: 69, scope: !2216)
!2225 = !DILocation(line: 99, column: 85, scope: !2216)
!2226 = !DILocation(line: 99, column: 36, scope: !2216)
!2227 = !DILocalVariable(name: "frame_size", scope: !2216, file: !936, line: 100, type: !933)
!2228 = !DILocation(line: 100, column: 21, scope: !2216)
!2229 = !DILocation(line: 100, column: 67, scope: !2216)
!2230 = !DILocation(line: 100, column: 83, scope: !2216)
!2231 = !DILocation(line: 102, column: 23, scope: !2232)
!2232 = distinct !DILexicalBlock(scope: !2216, file: !936, line: 102, column: 20)
!2233 = !DILocation(line: 102, column: 33, scope: !2232)
!2234 = !DILocation(line: 103, column: 22, scope: !2232)
!2235 = !DILocation(line: 103, column: 25, scope: !2236)
!2236 = !DILexicalBlockFile(scope: !2232, file: !936, discriminator: 1)
!2237 = !DILocation(line: 103, column: 42, scope: !2236)
!2238 = !DILocation(line: 103, column: 40, scope: !2236)
!2239 = !DILocation(line: 104, column: 22, scope: !2232)
!2240 = !DILocation(line: 104, column: 25, scope: !2236)
!2241 = !DILocation(line: 104, column: 37, scope: !2236)
!2242 = !DILocation(line: 104, column: 46, scope: !2236)
!2243 = !DILocation(line: 104, column: 44, scope: !2236)
!2244 = !DILocation(line: 102, column: 20, scope: !2245)
!2245 = !DILexicalBlockFile(scope: !2216, file: !936, discriminator: 1)
!2246 = !DILocation(line: 105, column: 21, scope: !2247)
!2247 = distinct !DILexicalBlock(scope: !2232, file: !936, line: 104, column: 58)
!2248 = !DILocation(line: 107, column: 20, scope: !2216)
!2249 = !DILocation(line: 110, column: 13, scope: !2217)
!2250 = !DILocation(line: 112, column: 16, scope: !2251)
!2251 = distinct !DILexicalBlock(scope: !2217, file: !936, line: 112, column: 16)
!2252 = !DILocation(line: 112, column: 28, scope: !2251)
!2253 = !DILocation(line: 112, column: 16, scope: !2217)
!2254 = !DILocation(line: 113, column: 17, scope: !2251)
!2255 = !DILocation(line: 114, column: 16, scope: !2217)
!2256 = !DILocation(line: 115, column: 13, scope: !2217)
!2257 = !DILocation(line: 117, column: 16, scope: !2258)
!2258 = distinct !DILexicalBlock(scope: !2217, file: !936, line: 117, column: 16)
!2259 = !DILocation(line: 117, column: 29, scope: !2258)
!2260 = !DILocation(line: 117, column: 16, scope: !2217)
!2261 = !DILocation(line: 118, column: 17, scope: !2258)
!2262 = !DILocation(line: 119, column: 9, scope: !2217)
!2263 = !DILocation(line: 120, column: 16, scope: !2203)
!2264 = !DILocation(line: 87, column: 5, scope: !2265)
!2265 = !DILexicalBlockFile(scope: !2155, file: !936, discriminator: 2)
!2266 = distinct !{!2266, !2195}
!2267 = !DILocation(line: 124, column: 8, scope: !2268)
!2268 = distinct !DILexicalBlock(scope: !2155, file: !936, line: 124, column: 8)
!2269 = !DILocation(line: 124, column: 12, scope: !2268)
!2270 = !DILocation(line: 124, column: 11, scope: !2268)
!2271 = !DILocation(line: 124, column: 16, scope: !2268)
!2272 = !DILocation(line: 124, column: 8, scope: !2155)
!2273 = !DILocation(line: 124, column: 21, scope: !2274)
!2274 = !DILexicalBlockFile(scope: !2268, file: !936, discriminator: 1)
!2275 = !DILocation(line: 125, column: 13, scope: !2276)
!2276 = distinct !DILexicalBlock(scope: !2268, file: !936, line: 125, column: 13)
!2277 = !DILocation(line: 125, column: 17, scope: !2276)
!2278 = !DILocation(line: 125, column: 16, scope: !2276)
!2279 = !DILocation(line: 125, column: 13, scope: !2268)
!2280 = !DILocation(line: 125, column: 22, scope: !2281)
!2281 = !DILexicalBlockFile(scope: !2276, file: !936, discriminator: 1)
!2282 = !DILocation(line: 126, column: 10, scope: !2276)
!2283 = !DILocation(line: 127, column: 1, scope: !2155)
!2284 = distinct !DISubprogram(name: "str_read_header", scope: !936, file: !936, line: 129, type: !2285, isLocal: true, isDefinition: true, scopeLine: 130, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2156)
!2285 = !DISubroutineType(types: !2286)
!2286 = !{!933, !2287}
!2287 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2288, size: 64, align: 64)
!2288 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1023)
!2289 = !DILocalVariable(name: "s", arg: 1, scope: !2284, file: !936, line: 129, type: !2287)
!2290 = !DILocation(line: 129, column: 45, scope: !2284)
!2291 = !DILocalVariable(name: "pb", scope: !2284, file: !936, line: 131, type: !1229)
!2292 = !DILocation(line: 131, column: 18, scope: !2284)
!2293 = !DILocation(line: 131, column: 23, scope: !2284)
!2294 = !DILocation(line: 131, column: 26, scope: !2284)
!2295 = !DILocalVariable(name: "str", scope: !2284, file: !936, line: 132, type: !2296)
!2296 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2297, size: 64, align: 64)
!2297 = !DIDerivedType(tag: DW_TAG_typedef, name: "StrDemuxContext", file: !936, line: 67, baseType: !2298)
!2298 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "StrDemuxContext", file: !936, line: 63, size: 26624, align: 64, elements: !2299)
!2299 = !{!2300}
!2300 = !DIDerivedType(tag: DW_TAG_member, name: "channels", scope: !2298, file: !936, line: 66, baseType: !2301, size: 26624, align: 64)
!2301 = !DICompositeType(tag: DW_TAG_array_type, baseType: !2302, size: 26624, align: 64, elements: !2308)
!2302 = !DIDerivedType(tag: DW_TAG_typedef, name: "StrChannel", file: !936, line: 61, baseType: !2303)
!2303 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "StrChannel", file: !936, line: 54, size: 832, align: 64, elements: !2304)
!2304 = !{!2305, !2306, !2307}
!2305 = !DIDerivedType(tag: DW_TAG_member, name: "video_stream_index", scope: !2303, file: !936, line: 56, baseType: !933, size: 32, align: 32)
!2306 = !DIDerivedType(tag: DW_TAG_member, name: "tmp_pkt", scope: !2303, file: !936, line: 57, baseType: !1049, size: 704, align: 64, offset: 64)
!2307 = !DIDerivedType(tag: DW_TAG_member, name: "audio_stream_index", scope: !2303, file: !936, line: 60, baseType: !933, size: 32, align: 32, offset: 768)
!2308 = !{!2309}
!2309 = !DISubrange(count: 32)
!2310 = !DILocation(line: 132, column: 22, scope: !2284)
!2311 = !DILocation(line: 132, column: 28, scope: !2284)
!2312 = !DILocation(line: 132, column: 31, scope: !2284)
!2313 = !DILocalVariable(name: "sector", scope: !2284, file: !936, line: 133, type: !2314)
!2314 = !DICompositeType(tag: DW_TAG_array_type, baseType: !1015, size: 18816, align: 8, elements: !2315)
!2315 = !{!2316}
!2316 = !DISubrange(count: 2352)
!2317 = !DILocation(line: 133, column: 19, scope: !2284)
!2318 = !DILocalVariable(name: "start", scope: !2284, file: !936, line: 134, type: !933)
!2319 = !DILocation(line: 134, column: 9, scope: !2284)
!2320 = !DILocalVariable(name: "i", scope: !2284, file: !936, line: 135, type: !933)
!2321 = !DILocation(line: 135, column: 9, scope: !2284)
!2322 = !DILocation(line: 138, column: 19, scope: !2323)
!2323 = distinct !DILexicalBlock(scope: !2284, file: !936, line: 138, column: 9)
!2324 = !DILocation(line: 138, column: 23, scope: !2323)
!2325 = !DILocation(line: 138, column: 9, scope: !2323)
!2326 = !DILocation(line: 138, column: 37, scope: !2323)
!2327 = !DILocation(line: 138, column: 9, scope: !2284)
!2328 = !DILocation(line: 139, column: 9, scope: !2323)
!2329 = !DILocation(line: 140, column: 42, scope: !2330)
!2330 = distinct !DILexicalBlock(scope: !2284, file: !936, line: 140, column: 9)
!2331 = !DILocation(line: 140, column: 55, scope: !2330)
!2332 = !DILocation(line: 140, column: 58, scope: !2330)
!2333 = !DILocation(line: 140, column: 9, scope: !2284)
!2334 = !DILocation(line: 141, column: 15, scope: !2330)
!2335 = !DILocation(line: 141, column: 9, scope: !2330)
!2336 = !DILocation(line: 143, column: 15, scope: !2330)
!2337 = !DILocation(line: 145, column: 15, scope: !2284)
!2338 = !DILocation(line: 145, column: 19, scope: !2284)
!2339 = !DILocation(line: 145, column: 5, scope: !2284)
!2340 = !DILocation(line: 147, column: 10, scope: !2341)
!2341 = distinct !DILexicalBlock(scope: !2284, file: !936, line: 147, column: 5)
!2342 = !DILocation(line: 147, column: 9, scope: !2341)
!2343 = !DILocation(line: 147, column: 14, scope: !2344)
!2344 = !DILexicalBlockFile(scope: !2345, file: !936, discriminator: 1)
!2345 = distinct !DILexicalBlock(scope: !2341, file: !936, line: 147, column: 5)
!2346 = !DILocation(line: 147, column: 15, scope: !2344)
!2347 = !DILocation(line: 147, column: 5, scope: !2344)
!2348 = !DILocation(line: 149, column: 23, scope: !2349)
!2349 = distinct !DILexicalBlock(scope: !2345, file: !936, line: 147, column: 24)
!2350 = !DILocation(line: 149, column: 9, scope: !2349)
!2351 = !DILocation(line: 149, column: 14, scope: !2349)
!2352 = !DILocation(line: 149, column: 26, scope: !2349)
!2353 = !DILocation(line: 149, column: 44, scope: !2349)
!2354 = !DILocation(line: 148, column: 23, scope: !2349)
!2355 = !DILocation(line: 148, column: 9, scope: !2349)
!2356 = !DILocation(line: 148, column: 14, scope: !2349)
!2357 = !DILocation(line: 148, column: 26, scope: !2349)
!2358 = !DILocation(line: 148, column: 44, scope: !2349)
!2359 = !DILocation(line: 150, column: 5, scope: !2349)
!2360 = !DILocation(line: 147, column: 21, scope: !2361)
!2361 = !DILexicalBlockFile(scope: !2345, file: !936, discriminator: 2)
!2362 = !DILocation(line: 147, column: 5, scope: !2361)
!2363 = distinct !{!2363, !2364}
!2364 = !DILocation(line: 147, column: 5, scope: !2284)
!2365 = !DILocation(line: 152, column: 5, scope: !2284)
!2366 = !DILocation(line: 152, column: 8, scope: !2284)
!2367 = !DILocation(line: 152, column: 18, scope: !2284)
!2368 = !DILocation(line: 154, column: 5, scope: !2284)
!2369 = !DILocation(line: 155, column: 1, scope: !2284)
!2370 = distinct !DISubprogram(name: "str_read_packet", scope: !936, file: !936, line: 157, type: !2371, isLocal: true, isDefinition: true, scopeLine: 159, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2156)
!2371 = !DISubroutineType(types: !2372)
!2372 = !{!933, !2287, !1048}
!2373 = !DILocalVariable(name: "s", arg: 1, scope: !2374, file: !628, line: 557, type: !1229)
!2374 = distinct !DISubprogram(name: "avio_tell", scope: !628, file: !628, line: 557, type: !2375, isLocal: true, isDefinition: true, scopeLine: 558, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2156)
!2375 = !DISubroutineType(types: !2376)
!2376 = !{!1067, !1229}
!2377 = !DILocation(line: 557, column: 77, scope: !2374, inlinedAt: !2378)
!2378 = distinct !DILocation(line: 220, column: 31, scope: !2379)
!2379 = distinct !DILexicalBlock(scope: !2380, file: !936, line: 212, column: 52)
!2380 = distinct !DILexicalBlock(scope: !2381, file: !936, line: 212, column: 20)
!2381 = distinct !DILexicalBlock(scope: !2382, file: !936, line: 180, column: 13)
!2382 = distinct !DILexicalBlock(scope: !2383, file: !936, line: 176, column: 38)
!2383 = distinct !DILexicalBlock(scope: !2370, file: !936, line: 167, column: 15)
!2384 = !DILocalVariable(name: "s", arg: 1, scope: !2370, file: !936, line: 157, type: !2287)
!2385 = !DILocation(line: 157, column: 45, scope: !2370)
!2386 = !DILocalVariable(name: "ret_pkt", arg: 2, scope: !2370, file: !936, line: 158, type: !1048)
!2387 = !DILocation(line: 158, column: 38, scope: !2370)
!2388 = !DILocalVariable(name: "pb", scope: !2370, file: !936, line: 160, type: !1229)
!2389 = !DILocation(line: 160, column: 18, scope: !2370)
!2390 = !DILocation(line: 160, column: 23, scope: !2370)
!2391 = !DILocation(line: 160, column: 26, scope: !2370)
!2392 = !DILocalVariable(name: "str", scope: !2370, file: !936, line: 161, type: !2296)
!2393 = !DILocation(line: 161, column: 22, scope: !2370)
!2394 = !DILocation(line: 161, column: 28, scope: !2370)
!2395 = !DILocation(line: 161, column: 31, scope: !2370)
!2396 = !DILocalVariable(name: "sector", scope: !2370, file: !936, line: 162, type: !2314)
!2397 = !DILocation(line: 162, column: 19, scope: !2370)
!2398 = !DILocalVariable(name: "channel", scope: !2370, file: !936, line: 163, type: !933)
!2399 = !DILocation(line: 163, column: 9, scope: !2370)
!2400 = !DILocalVariable(name: "pkt", scope: !2370, file: !936, line: 164, type: !1048)
!2401 = !DILocation(line: 164, column: 15, scope: !2370)
!2402 = !DILocalVariable(name: "st", scope: !2370, file: !936, line: 165, type: !1297)
!2403 = !DILocation(line: 165, column: 15, scope: !2370)
!2404 = !DILocation(line: 167, column: 5, scope: !2370)
!2405 = !DILocation(line: 169, column: 23, scope: !2406)
!2406 = distinct !DILexicalBlock(scope: !2383, file: !936, line: 169, column: 13)
!2407 = !DILocation(line: 169, column: 27, scope: !2406)
!2408 = !DILocation(line: 169, column: 13, scope: !2406)
!2409 = !DILocation(line: 169, column: 41, scope: !2406)
!2410 = !DILocation(line: 169, column: 13, scope: !2383)
!2411 = !DILocation(line: 170, column: 13, scope: !2406)
!2412 = !DILocation(line: 172, column: 19, scope: !2383)
!2413 = !DILocation(line: 172, column: 17, scope: !2383)
!2414 = !DILocation(line: 173, column: 13, scope: !2415)
!2415 = distinct !DILexicalBlock(scope: !2383, file: !936, line: 173, column: 13)
!2416 = !DILocation(line: 173, column: 21, scope: !2415)
!2417 = !DILocation(line: 173, column: 13, scope: !2383)
!2418 = !DILocation(line: 174, column: 13, scope: !2415)
!2419 = !DILocation(line: 176, column: 17, scope: !2383)
!2420 = !DILocation(line: 176, column: 30, scope: !2383)
!2421 = !DILocation(line: 176, column: 9, scope: !2383)
!2422 = !DILocalVariable(name: "current_sector", scope: !2381, file: !936, line: 182, type: !933)
!2423 = !DILocation(line: 182, column: 21, scope: !2381)
!2424 = !DILocation(line: 182, column: 71, scope: !2381)
!2425 = !DILocation(line: 182, column: 87, scope: !2381)
!2426 = !DILocation(line: 182, column: 38, scope: !2381)
!2427 = !DILocalVariable(name: "sector_count", scope: !2381, file: !936, line: 183, type: !933)
!2428 = !DILocation(line: 183, column: 21, scope: !2381)
!2429 = !DILocation(line: 183, column: 69, scope: !2381)
!2430 = !DILocation(line: 183, column: 85, scope: !2381)
!2431 = !DILocation(line: 183, column: 36, scope: !2381)
!2432 = !DILocalVariable(name: "frame_size", scope: !2381, file: !936, line: 184, type: !933)
!2433 = !DILocation(line: 184, column: 21, scope: !2381)
!2434 = !DILocation(line: 184, column: 67, scope: !2381)
!2435 = !DILocation(line: 184, column: 83, scope: !2381)
!2436 = !DILocation(line: 186, column: 23, scope: !2437)
!2437 = distinct !DILexicalBlock(scope: !2381, file: !936, line: 186, column: 20)
!2438 = !DILocation(line: 186, column: 33, scope: !2437)
!2439 = !DILocation(line: 187, column: 22, scope: !2437)
!2440 = !DILocation(line: 187, column: 25, scope: !2441)
!2441 = !DILexicalBlockFile(scope: !2437, file: !936, discriminator: 1)
!2442 = !DILocation(line: 187, column: 42, scope: !2441)
!2443 = !DILocation(line: 187, column: 40, scope: !2441)
!2444 = !DILocation(line: 188, column: 22, scope: !2437)
!2445 = !DILocation(line: 188, column: 25, scope: !2441)
!2446 = !DILocation(line: 188, column: 37, scope: !2441)
!2447 = !DILocation(line: 188, column: 46, scope: !2441)
!2448 = !DILocation(line: 188, column: 44, scope: !2441)
!2449 = !DILocation(line: 186, column: 20, scope: !2450)
!2450 = !DILexicalBlockFile(scope: !2381, file: !936, discriminator: 1)
!2451 = !DILocation(line: 189, column: 28, scope: !2452)
!2452 = distinct !DILexicalBlock(scope: !2437, file: !936, line: 188, column: 58)
!2453 = !DILocation(line: 189, column: 68, scope: !2452)
!2454 = !DILocation(line: 189, column: 84, scope: !2452)
!2455 = !DILocation(line: 189, column: 98, scope: !2452)
!2456 = !DILocation(line: 189, column: 21, scope: !2452)
!2457 = !DILocation(line: 190, column: 21, scope: !2452)
!2458 = !DILocation(line: 193, column: 34, scope: !2459)
!2459 = distinct !DILexicalBlock(scope: !2381, file: !936, line: 193, column: 20)
!2460 = !DILocation(line: 193, column: 20, scope: !2459)
!2461 = !DILocation(line: 193, column: 25, scope: !2459)
!2462 = !DILocation(line: 193, column: 43, scope: !2459)
!2463 = !DILocation(line: 193, column: 62, scope: !2459)
!2464 = !DILocation(line: 193, column: 20, scope: !2381)
!2465 = !DILocation(line: 195, column: 46, scope: !2466)
!2466 = distinct !DILexicalBlock(scope: !2459, file: !936, line: 193, column: 66)
!2467 = !DILocation(line: 195, column: 26, scope: !2466)
!2468 = !DILocation(line: 195, column: 24, scope: !2466)
!2469 = !DILocation(line: 196, column: 26, scope: !2470)
!2470 = distinct !DILexicalBlock(scope: !2466, file: !936, line: 196, column: 25)
!2471 = !DILocation(line: 196, column: 25, scope: !2466)
!2472 = !DILocation(line: 197, column: 25, scope: !2470)
!2473 = !DILocation(line: 198, column: 41, scope: !2466)
!2474 = !DILocation(line: 198, column: 21, scope: !2466)
!2475 = !DILocation(line: 200, column: 65, scope: !2466)
!2476 = !DILocation(line: 200, column: 69, scope: !2466)
!2477 = !DILocation(line: 200, column: 35, scope: !2466)
!2478 = !DILocation(line: 200, column: 21, scope: !2466)
!2479 = !DILocation(line: 200, column: 26, scope: !2466)
!2480 = !DILocation(line: 200, column: 44, scope: !2466)
!2481 = !DILocation(line: 200, column: 63, scope: !2466)
!2482 = !DILocation(line: 202, column: 21, scope: !2466)
!2483 = !DILocation(line: 202, column: 25, scope: !2466)
!2484 = !DILocation(line: 202, column: 35, scope: !2466)
!2485 = !DILocation(line: 202, column: 46, scope: !2466)
!2486 = !DILocation(line: 203, column: 21, scope: !2466)
!2487 = !DILocation(line: 203, column: 25, scope: !2466)
!2488 = !DILocation(line: 203, column: 35, scope: !2466)
!2489 = !DILocation(line: 203, column: 44, scope: !2466)
!2490 = !DILocation(line: 204, column: 21, scope: !2466)
!2491 = !DILocation(line: 204, column: 25, scope: !2466)
!2492 = !DILocation(line: 204, column: 35, scope: !2466)
!2493 = !DILocation(line: 204, column: 45, scope: !2466)
!2494 = !DILocation(line: 205, column: 76, scope: !2466)
!2495 = !DILocation(line: 205, column: 92, scope: !2466)
!2496 = !DILocation(line: 205, column: 43, scope: !2466)
!2497 = !DILocation(line: 205, column: 21, scope: !2466)
!2498 = !DILocation(line: 205, column: 25, scope: !2466)
!2499 = !DILocation(line: 205, column: 35, scope: !2466)
!2500 = !DILocation(line: 205, column: 41, scope: !2466)
!2501 = !DILocation(line: 206, column: 77, scope: !2466)
!2502 = !DILocation(line: 206, column: 93, scope: !2466)
!2503 = !DILocation(line: 206, column: 44, scope: !2466)
!2504 = !DILocation(line: 206, column: 21, scope: !2466)
!2505 = !DILocation(line: 206, column: 25, scope: !2466)
!2506 = !DILocation(line: 206, column: 35, scope: !2466)
!2507 = !DILocation(line: 206, column: 42, scope: !2466)
!2508 = !DILocation(line: 207, column: 17, scope: !2466)
!2509 = !DILocation(line: 210, column: 38, scope: !2381)
!2510 = !DILocation(line: 210, column: 24, scope: !2381)
!2511 = !DILocation(line: 210, column: 29, scope: !2381)
!2512 = !DILocation(line: 210, column: 47, scope: !2381)
!2513 = !DILocation(line: 210, column: 21, scope: !2381)
!2514 = !DILocation(line: 212, column: 20, scope: !2380)
!2515 = !DILocation(line: 212, column: 25, scope: !2380)
!2516 = !DILocation(line: 212, column: 33, scope: !2380)
!2517 = !DILocation(line: 212, column: 45, scope: !2380)
!2518 = !DILocation(line: 212, column: 30, scope: !2380)
!2519 = !DILocation(line: 212, column: 20, scope: !2381)
!2520 = !DILocation(line: 213, column: 24, scope: !2521)
!2521 = distinct !DILexicalBlock(scope: !2379, file: !936, line: 213, column: 24)
!2522 = !DILocation(line: 213, column: 29, scope: !2521)
!2523 = !DILocation(line: 213, column: 24, scope: !2379)
!2524 = !DILocation(line: 214, column: 32, scope: !2521)
!2525 = !DILocation(line: 214, column: 25, scope: !2521)
!2526 = !DILocation(line: 215, column: 37, scope: !2379)
!2527 = !DILocation(line: 215, column: 21, scope: !2379)
!2528 = !DILocation(line: 216, column: 39, scope: !2529)
!2529 = distinct !DILexicalBlock(scope: !2379, file: !936, line: 216, column: 25)
!2530 = !DILocation(line: 216, column: 44, scope: !2529)
!2531 = !DILocation(line: 216, column: 56, scope: !2529)
!2532 = !DILocation(line: 216, column: 25, scope: !2529)
!2533 = !DILocation(line: 216, column: 25, scope: !2379)
!2534 = !DILocation(line: 217, column: 25, scope: !2529)
!2535 = !DILocation(line: 218, column: 28, scope: !2379)
!2536 = !DILocation(line: 218, column: 33, scope: !2379)
!2537 = !DILocation(line: 218, column: 42, scope: !2379)
!2538 = !DILocation(line: 218, column: 54, scope: !2379)
!2539 = !DILocation(line: 218, column: 21, scope: !2379)
!2540 = !DILocation(line: 220, column: 41, scope: !2379)
!2541 = !DILocation(line: 220, column: 31, scope: !2379)
!2542 = !DILocation(line: 559, column: 22, scope: !2374, inlinedAt: !2378)
!2543 = !DILocation(line: 559, column: 12, scope: !2374, inlinedAt: !2378)
!2544 = !DILocation(line: 220, column: 45, scope: !2379)
!2545 = !DILocation(line: 220, column: 21, scope: !2379)
!2546 = !DILocation(line: 220, column: 26, scope: !2379)
!2547 = !DILocation(line: 220, column: 29, scope: !2379)
!2548 = !DILocation(line: 222, column: 39, scope: !2379)
!2549 = !DILocation(line: 222, column: 25, scope: !2379)
!2550 = !DILocation(line: 222, column: 30, scope: !2379)
!2551 = !DILocation(line: 222, column: 48, scope: !2379)
!2552 = !DILocation(line: 221, column: 21, scope: !2379)
!2553 = !DILocation(line: 221, column: 26, scope: !2379)
!2554 = !DILocation(line: 221, column: 39, scope: !2379)
!2555 = !DILocation(line: 223, column: 17, scope: !2379)
!2556 = !DILocation(line: 225, column: 24, scope: !2381)
!2557 = !DILocation(line: 225, column: 29, scope: !2381)
!2558 = !DILocation(line: 225, column: 36, scope: !2381)
!2559 = !DILocation(line: 225, column: 50, scope: !2381)
!2560 = !DILocation(line: 225, column: 34, scope: !2381)
!2561 = !DILocation(line: 226, column: 24, scope: !2381)
!2562 = !DILocation(line: 226, column: 31, scope: !2381)
!2563 = !DILocation(line: 225, column: 17, scope: !2381)
!2564 = !DILocation(line: 229, column: 21, scope: !2565)
!2565 = distinct !DILexicalBlock(scope: !2381, file: !936, line: 229, column: 21)
!2566 = !DILocation(line: 229, column: 39, scope: !2565)
!2567 = !DILocation(line: 229, column: 51, scope: !2565)
!2568 = !DILocation(line: 229, column: 36, scope: !2565)
!2569 = !DILocation(line: 229, column: 21, scope: !2381)
!2570 = !DILocation(line: 230, column: 32, scope: !2571)
!2571 = distinct !DILexicalBlock(scope: !2565, file: !936, line: 229, column: 55)
!2572 = !DILocation(line: 230, column: 21, scope: !2571)
!2573 = !DILocation(line: 230, column: 26, scope: !2571)
!2574 = !DILocation(line: 230, column: 30, scope: !2571)
!2575 = !DILocation(line: 231, column: 22, scope: !2571)
!2576 = !DILocation(line: 231, column: 33, scope: !2571)
!2577 = !DILocation(line: 231, column: 32, scope: !2571)
!2578 = !DILocation(line: 232, column: 21, scope: !2571)
!2579 = !DILocation(line: 232, column: 26, scope: !2571)
!2580 = !DILocation(line: 232, column: 30, scope: !2571)
!2581 = !DILocation(line: 233, column: 21, scope: !2571)
!2582 = !DILocation(line: 233, column: 26, scope: !2571)
!2583 = !DILocation(line: 233, column: 30, scope: !2571)
!2584 = !DILocation(line: 234, column: 21, scope: !2571)
!2585 = !DILocation(line: 234, column: 26, scope: !2571)
!2586 = !DILocation(line: 234, column: 30, scope: !2571)
!2587 = !DILocation(line: 235, column: 21, scope: !2571)
!2588 = !DILocation(line: 239, column: 13, scope: !2382)
!2589 = !DILocation(line: 242, column: 30, scope: !2590)
!2590 = distinct !DILexicalBlock(scope: !2382, file: !936, line: 242, column: 16)
!2591 = !DILocation(line: 242, column: 16, scope: !2590)
!2592 = !DILocation(line: 242, column: 21, scope: !2590)
!2593 = !DILocation(line: 242, column: 39, scope: !2590)
!2594 = !DILocation(line: 242, column: 58, scope: !2590)
!2595 = !DILocation(line: 242, column: 16, scope: !2382)
!2596 = !DILocalVariable(name: "fmt", scope: !2597, file: !936, line: 243, type: !933)
!2597 = distinct !DILexicalBlock(scope: !2590, file: !936, line: 242, column: 62)
!2598 = !DILocation(line: 243, column: 21, scope: !2597)
!2599 = !DILocation(line: 243, column: 27, scope: !2597)
!2600 = !DILocation(line: 245, column: 42, scope: !2597)
!2601 = !DILocation(line: 245, column: 22, scope: !2597)
!2602 = !DILocation(line: 245, column: 20, scope: !2597)
!2603 = !DILocation(line: 246, column: 22, scope: !2604)
!2604 = distinct !DILexicalBlock(scope: !2597, file: !936, line: 246, column: 21)
!2605 = !DILocation(line: 246, column: 21, scope: !2597)
!2606 = !DILocation(line: 247, column: 21, scope: !2604)
!2607 = !DILocation(line: 249, column: 61, scope: !2597)
!2608 = !DILocation(line: 249, column: 65, scope: !2597)
!2609 = !DILocation(line: 249, column: 31, scope: !2597)
!2610 = !DILocation(line: 249, column: 17, scope: !2597)
!2611 = !DILocation(line: 249, column: 22, scope: !2597)
!2612 = !DILocation(line: 249, column: 40, scope: !2597)
!2613 = !DILocation(line: 249, column: 59, scope: !2597)
!2614 = !DILocation(line: 251, column: 17, scope: !2597)
!2615 = !DILocation(line: 251, column: 21, scope: !2597)
!2616 = !DILocation(line: 251, column: 31, scope: !2597)
!2617 = !DILocation(line: 251, column: 42, scope: !2597)
!2618 = !DILocation(line: 252, column: 17, scope: !2597)
!2619 = !DILocation(line: 252, column: 21, scope: !2597)
!2620 = !DILocation(line: 252, column: 31, scope: !2597)
!2621 = !DILocation(line: 252, column: 40, scope: !2597)
!2622 = !DILocation(line: 253, column: 17, scope: !2597)
!2623 = !DILocation(line: 253, column: 21, scope: !2597)
!2624 = !DILocation(line: 253, column: 31, scope: !2597)
!2625 = !DILocation(line: 253, column: 41, scope: !2597)
!2626 = !DILocation(line: 254, column: 21, scope: !2627)
!2627 = distinct !DILexicalBlock(scope: !2597, file: !936, line: 254, column: 21)
!2628 = !DILocation(line: 254, column: 25, scope: !2627)
!2629 = !DILocation(line: 254, column: 21, scope: !2597)
!2630 = !DILocation(line: 255, column: 21, scope: !2631)
!2631 = distinct !DILexicalBlock(scope: !2627, file: !936, line: 254, column: 30)
!2632 = !DILocation(line: 255, column: 25, scope: !2631)
!2633 = !DILocation(line: 255, column: 35, scope: !2631)
!2634 = !DILocation(line: 255, column: 44, scope: !2631)
!2635 = !DILocation(line: 256, column: 21, scope: !2631)
!2636 = !DILocation(line: 256, column: 25, scope: !2631)
!2637 = !DILocation(line: 256, column: 35, scope: !2631)
!2638 = !DILocation(line: 256, column: 50, scope: !2631)
!2639 = !DILocation(line: 257, column: 17, scope: !2631)
!2640 = !DILocation(line: 258, column: 21, scope: !2641)
!2641 = distinct !DILexicalBlock(scope: !2627, file: !936, line: 257, column: 24)
!2642 = !DILocation(line: 258, column: 25, scope: !2641)
!2643 = !DILocation(line: 258, column: 35, scope: !2641)
!2644 = !DILocation(line: 258, column: 44, scope: !2641)
!2645 = !DILocation(line: 259, column: 21, scope: !2641)
!2646 = !DILocation(line: 259, column: 25, scope: !2641)
!2647 = !DILocation(line: 259, column: 35, scope: !2641)
!2648 = !DILocation(line: 259, column: 50, scope: !2641)
!2649 = !DILocation(line: 261, column: 46, scope: !2597)
!2650 = !DILocation(line: 261, column: 49, scope: !2597)
!2651 = !DILocation(line: 261, column: 45, scope: !2597)
!2652 = !DILocation(line: 261, column: 17, scope: !2597)
!2653 = !DILocation(line: 261, column: 21, scope: !2597)
!2654 = !DILocation(line: 261, column: 31, scope: !2597)
!2655 = !DILocation(line: 261, column: 43, scope: !2597)
!2656 = !DILocation(line: 263, column: 17, scope: !2597)
!2657 = !DILocation(line: 263, column: 21, scope: !2597)
!2658 = !DILocation(line: 263, column: 31, scope: !2597)
!2659 = !DILocation(line: 263, column: 43, scope: !2597)
!2660 = !DILocation(line: 265, column: 37, scope: !2597)
!2661 = !DILocation(line: 265, column: 56, scope: !2597)
!2662 = !DILocation(line: 265, column: 60, scope: !2597)
!2663 = !DILocation(line: 265, column: 70, scope: !2597)
!2664 = !DILocation(line: 265, column: 54, scope: !2597)
!2665 = !DILocation(line: 266, column: 37, scope: !2597)
!2666 = !DILocation(line: 266, column: 41, scope: !2597)
!2667 = !DILocation(line: 266, column: 51, scope: !2597)
!2668 = !DILocation(line: 265, column: 17, scope: !2597)
!2669 = !DILocation(line: 267, column: 17, scope: !2597)
!2670 = !DILocation(line: 267, column: 21, scope: !2597)
!2671 = !DILocation(line: 267, column: 32, scope: !2597)
!2672 = !DILocation(line: 268, column: 13, scope: !2597)
!2673 = !DILocation(line: 269, column: 19, scope: !2382)
!2674 = !DILocation(line: 269, column: 17, scope: !2382)
!2675 = !DILocation(line: 270, column: 31, scope: !2676)
!2676 = distinct !DILexicalBlock(scope: !2382, file: !936, line: 270, column: 17)
!2677 = !DILocation(line: 270, column: 17, scope: !2676)
!2678 = !DILocation(line: 270, column: 17, scope: !2382)
!2679 = !DILocation(line: 271, column: 17, scope: !2676)
!2680 = !DILocation(line: 272, column: 20, scope: !2382)
!2681 = !DILocation(line: 272, column: 25, scope: !2382)
!2682 = !DILocation(line: 272, column: 30, scope: !2382)
!2683 = !DILocation(line: 272, column: 36, scope: !2382)
!2684 = !DILocation(line: 272, column: 13, scope: !2382)
!2685 = !DILocation(line: 275, column: 31, scope: !2382)
!2686 = !DILocation(line: 275, column: 17, scope: !2382)
!2687 = !DILocation(line: 275, column: 22, scope: !2382)
!2688 = !DILocation(line: 275, column: 40, scope: !2382)
!2689 = !DILocation(line: 274, column: 13, scope: !2382)
!2690 = !DILocation(line: 274, column: 18, scope: !2382)
!2691 = !DILocation(line: 274, column: 31, scope: !2382)
!2692 = !DILocation(line: 276, column: 13, scope: !2382)
!2693 = !DILocation(line: 276, column: 18, scope: !2382)
!2694 = !DILocation(line: 276, column: 27, scope: !2382)
!2695 = !DILocation(line: 277, column: 13, scope: !2382)
!2696 = !DILocation(line: 279, column: 20, scope: !2382)
!2697 = !DILocation(line: 279, column: 57, scope: !2382)
!2698 = !DILocation(line: 279, column: 13, scope: !2382)
!2699 = !DILocation(line: 281, column: 13, scope: !2382)
!2700 = !DILocation(line: 284, column: 23, scope: !2701)
!2701 = distinct !DILexicalBlock(scope: !2383, file: !936, line: 284, column: 13)
!2702 = !DILocation(line: 284, column: 13, scope: !2701)
!2703 = !DILocation(line: 284, column: 13, scope: !2383)
!2704 = !DILocation(line: 285, column: 13, scope: !2701)
!2705 = !DILocation(line: 167, column: 5, scope: !2706)
!2706 = !DILexicalBlockFile(scope: !2370, file: !936, discriminator: 1)
!2707 = distinct !{!2707, !2404}
!2708 = !DILocation(line: 287, column: 1, scope: !2370)
!2709 = distinct !DISubprogram(name: "str_read_close", scope: !936, file: !936, line: 289, type: !2285, isLocal: true, isDefinition: true, scopeLine: 290, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2156)
!2710 = !DILocalVariable(name: "s", arg: 1, scope: !2709, file: !936, line: 289, type: !2287)
!2711 = !DILocation(line: 289, column: 44, scope: !2709)
!2712 = !DILocalVariable(name: "str", scope: !2709, file: !936, line: 291, type: !2296)
!2713 = !DILocation(line: 291, column: 22, scope: !2709)
!2714 = !DILocation(line: 291, column: 28, scope: !2709)
!2715 = !DILocation(line: 291, column: 31, scope: !2709)
!2716 = !DILocalVariable(name: "i", scope: !2709, file: !936, line: 292, type: !933)
!2717 = !DILocation(line: 292, column: 9, scope: !2709)
!2718 = !DILocation(line: 293, column: 10, scope: !2719)
!2719 = distinct !DILexicalBlock(scope: !2709, file: !936, line: 293, column: 5)
!2720 = !DILocation(line: 293, column: 9, scope: !2719)
!2721 = !DILocation(line: 293, column: 14, scope: !2722)
!2722 = !DILexicalBlockFile(scope: !2723, file: !936, discriminator: 1)
!2723 = distinct !DILexicalBlock(scope: !2719, file: !936, line: 293, column: 5)
!2724 = !DILocation(line: 293, column: 15, scope: !2722)
!2725 = !DILocation(line: 293, column: 5, scope: !2722)
!2726 = !DILocation(line: 294, column: 26, scope: !2727)
!2727 = distinct !DILexicalBlock(scope: !2728, file: !936, line: 294, column: 12)
!2728 = distinct !DILexicalBlock(scope: !2723, file: !936, line: 293, column: 24)
!2729 = !DILocation(line: 294, column: 12, scope: !2727)
!2730 = !DILocation(line: 294, column: 17, scope: !2727)
!2731 = !DILocation(line: 294, column: 29, scope: !2727)
!2732 = !DILocation(line: 294, column: 37, scope: !2727)
!2733 = !DILocation(line: 294, column: 12, scope: !2728)
!2734 = !DILocation(line: 295, column: 44, scope: !2727)
!2735 = !DILocation(line: 295, column: 30, scope: !2727)
!2736 = !DILocation(line: 295, column: 35, scope: !2727)
!2737 = !DILocation(line: 295, column: 47, scope: !2727)
!2738 = !DILocation(line: 295, column: 13, scope: !2727)
!2739 = !DILocation(line: 296, column: 5, scope: !2728)
!2740 = !DILocation(line: 293, column: 21, scope: !2741)
!2741 = !DILexicalBlockFile(scope: !2723, file: !936, discriminator: 2)
!2742 = !DILocation(line: 293, column: 5, scope: !2741)
!2743 = distinct !{!2743, !2744}
!2744 = !DILocation(line: 293, column: 5, scope: !2709)
!2745 = !DILocation(line: 298, column: 5, scope: !2709)
