; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--pmpdec.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--pmpdec.o.i"
...
%struct.PMPContext = type { i32, i32, i32, i32, i32*, i32 }
...
@ff_pmp_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.1, i32 0, i32 0), i32 0, i8* null, %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 32, i32 (%struct.AVProbeData*)* @pmp_probe, i32 (%struct.AVFormatContext*)* @pmp_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @pmp_packet, i32 (%struct.AVFormatContext*)* @pmp_close, i32 (%struct.AVFormatContext*, i32, i64, i32)* @pmp_seek, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
...
define internal i32 @pmp_probe(%struct.AVProbeData* %p) #0 !dbg !2146 {
entry:
  ...
  %4 = load i32, i32* bitcast ([5 x i8]* @.str.2 to i32*), align 1, !dbg !2155
  %cmp = icmp eq i32 %3, %4, !dbg !2156
  br i1 %cmp, label %land.lhs.true, label %if.end, !dbg !2157

land.lhs.true:                                    ; preds = %entry
  %5 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2158
  %buf1 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %5, i32 0, i32 1, !dbg !2159
  %6 = load i8*, i8** %buf1, align 8, !dbg !2159
  %add.ptr = getelementptr inbounds i8, i8* %6, i64 4, !dbg !2160
  %7 = bitcast i8* %add.ptr to %union.unaligned_32*, !dbg !2161
  %l2 = bitcast %union.unaligned_32* %7 to i32*, !dbg !2161
  %8 = load i32, i32* %l2, align 1, !dbg !2161
  %cmp3 = icmp eq i32 %8, 1, !dbg !2162
  br i1 %cmp3, label %if.then, label %if.end, !dbg !2163

if.then:                                          ; preds = %land.lhs.true
  store i32 100, i32* %retval, align 4, !dbg !2165
...
; Function Attrs: nounwind uwtable
define internal i32 @pmp_header(%struct.AVFormatContext* %s) #0 !dbg !2168 {
entry:
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2173, metadata !2149), !dbg !2177
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %pmp = alloca %struct.PMPContext*, align 8
  %pb = alloca %struct.AVIOContext*, align 8
  %tb_num = alloca i32, align 4
  %tb_den = alloca i32, align 4
  %index_cnt = alloca i32, align 4
  %audio_codec_id = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2179, metadata !2149), !dbg !2180
  call void @llvm.dbg.declare(metadata %struct.PMPContext** %pmp, metadata !2181, metadata !2149), !dbg !2193
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2194
  ...
  %2 = bitcast i8* %1 to %struct.PMPContext*, !dbg !2194
  store %struct.PMPContext* %2, %struct.PMPContext** %pmp, align 8, !dbg !2193
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2196, metadata !2149), !dbg !2197
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2198
  ...
  call void @llvm.dbg.declare(metadata i32* %tb_num, metadata !2200, metadata !2149), !dbg !2201
  call void @llvm.dbg.declare(metadata i32* %tb_den, metadata !2202, metadata !2149), !dbg !2203
  call void @llvm.dbg.declare(metadata i32* %index_cnt, metadata !2204, metadata !2149), !dbg !2205
  call void @llvm.dbg.declare(metadata i32* %audio_codec_id, metadata !2206, metadata !2149), !dbg !2207
  store i32 0, i32* %audio_codec_id, align 4, !dbg !2207
  call void @llvm.dbg.declare(metadata i32* %srate, metadata !2208, metadata !2149), !dbg !2209
  call void @llvm.dbg.declare(metadata i32* %channels, metadata !2210, metadata !2149), !dbg !2211
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2212, metadata !2149), !dbg !2213
  call void @llvm.dbg.declare(metadata i64* %pos, metadata !2214, metadata !2149), !dbg !2215
  call void @llvm.dbg.declare(metadata i64* %fsize, metadata !2216, metadata !2149), !dbg !2217
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2218
  %call = call i64 @avio_size(%struct.AVIOContext* %5), !dbg !2219
  store i64 %call, i64* %fsize, align 8, !dbg !2217
  call void @llvm.dbg.declare(metadata %struct.AVStream** %vst, metadata !2220, metadata !2149), !dbg !2221
  %6 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2222
  %call2 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %6, %struct.AVCodec* null), !dbg !2223
  store %struct.AVStream* %call2, %struct.AVStream** %vst, align 8, !dbg !2221
  %7 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2224
  %tobool = icmp ne %struct.AVStream* %7, null, !dbg !2224
  br i1 %tobool, label %if.end, label %if.then, !dbg !2226

if.then:                                          ; preds = %entry
  store i32 -12, i32* %retval, align 4, !dbg !2227
  br label %return, !dbg !2227

if.end:                                           ; preds = %entry
  %8 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2228
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %8, i32 0, i32 19, !dbg !2229
  %9 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2229
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %9, i32 0, i32 0, !dbg !2230
  store i32 0, i32* %codec_type, align 8, !dbg !2231
  %10 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2232
  %call3 = call i64 @avio_skip(%struct.AVIOContext* %10, i64 8), !dbg !2233
  %11 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2234
  %call4 = call i32 @avio_rl32(%struct.AVIOContext* %11), !dbg !2235
...
sw.bb:                                            ; preds = %if.end
  %12 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2237
  ...
  store i32 12, i32* %codec_id, align 4, !dbg !2241
  br label %sw.epilog, !dbg !2242

sw.bb6:                                           ; preds = %if.end
  %14 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2243
  %codecpar7 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %14, i32 0, i32 19, !dbg !2244
  %15 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar7, align 8, !dbg !2244
  %codec_id8 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %15, i32 0, i32 1, !dbg !2245
  store i32 27, i32* %codec_id8, align 4, !dbg !2246
  br label %sw.epilog, !dbg !2247

sw.default:                                       ; preds = %if.end
  %16 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2248
  %17 = bitcast %struct.AVFormatContext* %16 to i8*, !dbg !2248
  call void (i8*, i32, i8*, ...) @av_log(i8* %17, i32 16, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.3, i32 0, i32 0)), !dbg !2249
  br label %sw.epilog, !dbg !2250

sw.epilog:                                        ; preds = %sw.default, %sw.bb6, %sw.bb
  %18 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2251
  %call9 = call i32 @avio_rl32(%struct.AVIOContext* %18), !dbg !2252
  store i32 %call9, i32* %index_cnt, align 4, !dbg !2253
  %19 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2254
  %call10 = call i32 @avio_rl32(%struct.AVIOContext* %19), !dbg !2255
  %20 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2256
  %codecpar11 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %20, i32 0, i32 19, !dbg !2257
  %21 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar11, align 8, !dbg !2257
  %width = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %21, i32 0, i32 11, !dbg !2258
  store i32 %call10, i32* %width, align 8, !dbg !2259
  %22 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2260
  %call12 = call i32 @avio_rl32(%struct.AVIOContext* %22), !dbg !2261
  %23 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2262
  %codecpar13 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %23, i32 0, i32 19, !dbg !2263
  %24 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar13, align 8, !dbg !2263
  %height = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %24, i32 0, i32 12, !dbg !2264
  store i32 %call12, i32* %height, align 4, !dbg !2265
  %25 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2266
  %call14 = call i32 @avio_rl32(%struct.AVIOContext* %25), !dbg !2267
  store i32 %call14, i32* %tb_num, align 4, !dbg !2268
  %26 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2269
  %call15 = call i32 @avio_rl32(%struct.AVIOContext* %26), !dbg !2270
  store i32 %call15, i32* %tb_den, align 4, !dbg !2271
  %27 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2272
  %28 = load i32, i32* %tb_num, align 4, !dbg !2273
  %29 = load i32, i32* %tb_den, align 4, !dbg !2274
  call void @avpriv_set_pts_info(%struct.AVStream* %27, i32 32, i32 %28, i32 %29), !dbg !2275
  %30 = load i32, i32* %index_cnt, align 4, !dbg !2276
  %conv = zext i32 %30 to i64, !dbg !2276
  %31 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2277
  %nb_frames = getelementptr inbounds %struct.AVStream, %struct.AVStream* %31, i32 0, i32 7, !dbg !2278
  store i64 %conv, i64* %nb_frames, align 8, !dbg !2279
  %32 = load i32, i32* %index_cnt, align 4, !dbg !2280
  %conv16 = zext i32 %32 to i64, !dbg !2280
  %33 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2281
  %duration = getelementptr inbounds %struct.AVStream, %struct.AVStream* %33, i32 0, i32 6, !dbg !2282
  store i64 %conv16, i64* %duration, align 8, !dbg !2283
  %34 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2284
  %call17 = call i32 @avio_rl32(%struct.AVIOContext* %34), !dbg !2285
  switch i32 %call17, label %sw.default20 [
    i32 0, label %sw.bb18
    i32 1, label %sw.bb19
  ], !dbg !2286

sw.bb18:                                          ; preds = %sw.epilog
  store i32 86017, i32* %audio_codec_id, align 4, !dbg !2287
  br label %sw.epilog21, !dbg !2289

sw.bb19:                                          ; preds = %sw.epilog
  %35 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2290
  %36 = bitcast %struct.AVFormatContext* %35 to i8*, !dbg !2290
  call void (i8*, i32, i8*, ...) @av_log(i8* %36, i32 16, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.4, i32 0, i32 0)), !dbg !2291
  store i32 86018, i32* %audio_codec_id, align 4, !dbg !2292
  br label %sw.epilog21, !dbg !2293

sw.default20:                                     ; preds = %sw.epilog
  %37 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2294
  %38 = bitcast %struct.AVFormatContext* %37 to i8*, !dbg !2294
  call void (i8*, i32, i8*, ...) @av_log(i8* %38, i32 16, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.5, i32 0, i32 0)), !dbg !2295
  br label %sw.epilog21, !dbg !2296

sw.epilog21:                                      ; preds = %sw.default20, %sw.bb19, %sw.bb18
  %39 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2297
  %call22 = call i32 @avio_rl16(%struct.AVIOContext* %39), !dbg !2298
  %add = add i32 %call22, 1, !dbg !2299
  %40 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2300
  %num_streams = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %40, i32 0, i32 1, !dbg !2301
  store i32 %add, i32* %num_streams, align 4, !dbg !2302
  %41 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2303
  %call23 = call i64 @avio_skip(%struct.AVIOContext* %41, i64 10), !dbg !2304
  %42 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2305
  %call24 = call i32 @avio_rl32(%struct.AVIOContext* %42), !dbg !2306
  store i32 %call24, i32* %srate, align 4, !dbg !2307
  %43 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2308
  %call25 = call i32 @avio_rl32(%struct.AVIOContext* %43), !dbg !2309
  %add26 = add i32 %call25, 1, !dbg !2310
  store i32 %add26, i32* %channels, align 4, !dbg !2311
  %44 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2312
  store %struct.AVIOContext* %44, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2313
  %45 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2314
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %45, i64 0, i32 1) #3, !dbg !2315
  %46 = load i32, i32* %index_cnt, align 4, !dbg !2316
  %conv28 = zext i32 %46 to i64, !dbg !2316
  %mul = mul nsw i64 4, %conv28, !dbg !2317
  %add29 = add nsw i64 %call.i, %mul, !dbg !2318
  store i64 %add29, i64* %pos, align 8, !dbg !2319
  store i32 0, i32* %i, align 4, !dbg !2320
  br label %for.cond, !dbg !2322

for.cond:                                         ; preds = %for.inc, %sw.epilog21
  %47 = load i32, i32* %i, align 4, !dbg !2323
  %48 = load i32, i32* %index_cnt, align 4, !dbg !2326
  %cmp = icmp ult i32 %47, %48, !dbg !2327
  br i1 %cmp, label %for.body, label %for.end, !dbg !2328

for.body:                                         ; preds = %for.cond
  call void @llvm.dbg.declare(metadata i32* %size, metadata !2329, metadata !2149), !dbg !2331
  %49 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2332
  %call31 = call i32 @avio_rl32(%struct.AVIOContext* %49), !dbg !2333
  store i32 %call31, i32* %size, align 4, !dbg !2331
  call void @llvm.dbg.declare(metadata i32* %flags, metadata !2334, metadata !2149), !dbg !2335
  %50 = load i32, i32* %size, align 4, !dbg !2336
  %and = and i32 %50, 1, !dbg !2337
  %tobool32 = icmp ne i32 %and, 0, !dbg !2336
  %cond = select i1 %tobool32, i32 1, i32 0, !dbg !2336
  store i32 %cond, i32* %flags, align 4, !dbg !2335
  %51 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2338
  %call33 = call i32 @avio_feof(%struct.AVIOContext* %51), !dbg !2340
  %tobool34 = icmp ne i32 %call33, 0, !dbg !2340
  br i1 %tobool34, label %if.then35, label %if.end36, !dbg !2341

if.then35:                                        ; preds = %for.body
  %52 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2342
  %53 = bitcast %struct.AVFormatContext* %52 to i8*, !dbg !2342
  call void (i8*, i32, i8*, ...) @av_log(i8* %53, i32 8, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.6, i32 0, i32 0)), !dbg !2344
  store i32 -1094995529, i32* %retval, align 4, !dbg !2345
  br label %return, !dbg !2345

if.end36:                                         ; preds = %for.body
  %54 = load i32, i32* %size, align 4, !dbg !2346
  %shr = lshr i32 %54, 1, !dbg !2346
  store i32 %shr, i32* %size, align 4, !dbg !2346
  %55 = load i32, i32* %size, align 4, !dbg !2347
  %56 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2349
  %num_streams37 = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %56, i32 0, i32 1, !dbg !2350
  %57 = load i32, i32* %num_streams37, align 4, !dbg !2350
  %mul38 = mul nsw i32 4, %57, !dbg !2351
  %add39 = add nsw i32 9, %mul38, !dbg !2352
  %cmp40 = icmp ult i32 %55, %add39, !dbg !2353
  br i1 %cmp40, label %if.then42, label %if.end43, !dbg !2354

if.then42:                                        ; preds = %if.end36
  %58 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2355
  %59 = bitcast %struct.AVFormatContext* %58 to i8*, !dbg !2355
  call void (i8*, i32, i8*, ...) @av_log(i8* %59, i32 16, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.7, i32 0, i32 0)), !dbg !2357
  store i32 -1094995529, i32* %retval, align 4, !dbg !2358
  br label %return, !dbg !2358

if.end43:                                         ; preds = %if.end36
  %60 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2359
  %61 = load i64, i64* %pos, align 8, !dbg !2360
  %62 = load i32, i32* %i, align 4, !dbg !2361
  %conv44 = zext i32 %62 to i64, !dbg !2361
  %63 = load i32, i32* %size, align 4, !dbg !2362
  %64 = load i32, i32* %flags, align 4, !dbg !2363
  %call45 = call i32 @av_add_index_entry(%struct.AVStream* %60, i64 %61, i64 %conv44, i32 %63, i32 0, i32 %64), !dbg !2364
  %65 = load i32, i32* %size, align 4, !dbg !2365
  %conv46 = zext i32 %65 to i64, !dbg !2365
  %66 = load i64, i64* %pos, align 8, !dbg !2366
  %add47 = add i64 %66, %conv46, !dbg !2366
  store i64 %add47, i64* %pos, align 8, !dbg !2366
  %67 = load i64, i64* %fsize, align 8, !dbg !2367
  %cmp48 = icmp sgt i64 %67, 0, !dbg !2369
  br i1 %cmp48, label %land.lhs.true, label %if.end56, !dbg !2370

land.lhs.true:                                    ; preds = %if.end43
  %68 = load i32, i32* %i, align 4, !dbg !2371
  %cmp50 = icmp eq i32 %68, 0, !dbg !2373
  br i1 %cmp50, label %land.lhs.true52, label %if.end56, !dbg !2374

land.lhs.true52:                                  ; preds = %land.lhs.true
  %69 = load i64, i64* %pos, align 8, !dbg !2375
  %70 = load i64, i64* %fsize, align 8, !dbg !2377
  %cmp53 = icmp ugt i64 %69, %70, !dbg !2378
  br i1 %cmp53, label %if.then55, label %if.end56, !dbg !2379

if.then55:                                        ; preds = %land.lhs.true52
  %71 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2380
  %72 = bitcast %struct.AVFormatContext* %71 to i8*, !dbg !2380
  call void (i8*, i32, i8*, ...) @av_log(i8* %72, i32 16, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.8, i32 0, i32 0)), !dbg !2382
  store i32 -1094995529, i32* %retval, align 4, !dbg !2383
  br label %return, !dbg !2383

if.end56:                                         ; preds = %land.lhs.true52, %land.lhs.true, %if.end43
  br label %for.inc, !dbg !2384

for.inc:                                          ; preds = %if.end56
  %73 = load i32, i32* %i, align 4, !dbg !2385
  %inc = add i32 %73, 1, !dbg !2385
  store i32 %inc, i32* %i, align 4, !dbg !2385
  br label %for.cond, !dbg !2387, !llvm.loop !2388

for.end:                                          ; preds = %for.cond
  store i32 1, i32* %i, align 4, !dbg !2390
  br label %for.cond57, !dbg !2392

for.cond57:                                       ; preds = %for.inc73, %for.end
  %74 = load i32, i32* %i, align 4, !dbg !2393
  %75 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2396
  %num_streams58 = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %75, i32 0, i32 1, !dbg !2397
  %76 = load i32, i32* %num_streams58, align 4, !dbg !2397
  %cmp59 = icmp ult i32 %74, %76, !dbg !2398
  br i1 %cmp59, label %for.body61, label %for.end75, !dbg !2399

for.body61:                                       ; preds = %for.cond57
  call void @llvm.dbg.declare(metadata %struct.AVStream** %ast, metadata !2400, metadata !2149), !dbg !2402
  %77 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2403
  %call62 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %77, %struct.AVCodec* null), !dbg !2404
  store %struct.AVStream* %call62, %struct.AVStream** %ast, align 8, !dbg !2402
  %78 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2405
  %tobool63 = icmp ne %struct.AVStream* %78, null, !dbg !2405
  br i1 %tobool63, label %if.end65, label %if.then64, !dbg !2407
...
if.end65:                                         ; preds = %for.body61
  %79 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2409
  %codecpar66 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %79, i32 0, i32 19, !dbg !2410
  %80 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar66, align 8, !dbg !2410
  %codec_type67 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %80, i32 0, i32 0, !dbg !2411
  store i32 1, i32* %codec_type67, align 8, !dbg !2412
  %81 = load i32, i32* %audio_codec_id, align 4, !dbg !2413
  %82 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2414
  %codecpar68 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %82, i32 0, i32 19, !dbg !2415
  %83 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar68, align 8, !dbg !2415
  %codec_id69 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %83, i32 0, i32 1, !dbg !2416
  store i32 %81, i32* %codec_id69, align 4, !dbg !2417
  %84 = load i32, i32* %channels, align 4, !dbg !2418
  %85 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2419
  %codecpar70 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %85, i32 0, i32 19, !dbg !2420
  %86 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar70, align 8, !dbg !2420
  %channels71 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %86, i32 0, i32 22, !dbg !2421
  store i32 %84, i32* %channels71, align 8, !dbg !2422
  %87 = load i32, i32* %srate, align 4, !dbg !2423
  %88 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2424
  %codecpar72 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %88, i32 0, i32 19, !dbg !2425
  %89 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar72, align 8, !dbg !2425
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %89, i32 0, i32 23, !dbg !2426
  store i32 %87, i32* %sample_rate, align 4, !dbg !2427
  %90 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2428
  %91 = load i32, i32* %srate, align 4, !dbg !2429
  call void @avpriv_set_pts_info(%struct.AVStream* %90, i32 32, i32 1, i32 %91), !dbg !2430
  br label %for.inc73, !dbg !2431

for.inc73:                                        ; preds = %if.end65
  %92 = load i32, i32* %i, align 4, !dbg !2432
  %inc74 = add i32 %92, 1, !dbg !2432
  store i32 %inc74, i32* %i, align 4, !dbg !2432
  br label %for.cond57, !dbg !2434, !llvm.loop !2435

for.end75:                                        ; preds = %for.cond57
  store i32 0, i32* %retval, align 4, !dbg !2437
  br label %return, !dbg !2437

return:                                           ; preds = %for.end75, %if.then64, %if.then55, %if.then42, %if.then35, %if.then
  %93 = load i32, i32* %retval, align 4, !dbg !2438
  ret i32 %93, !dbg !2438
}

; Function Attrs: nounwind uwtable
define internal i32 @pmp_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2439 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2442, metadata !2149), !dbg !2443
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2444, metadata !2149), !dbg !2445
  call void @llvm.dbg.declare(metadata %struct.PMPContext** %pmp, metadata !2446, metadata !2149), !dbg !2447
  ...
  %2 = bitcast i8* %1 to %struct.PMPContext*, !dbg !2448
  store %struct.PMPContext* %2, %struct.PMPContext** %pmp, align 8, !dbg !2447
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2450, metadata !2149), !dbg !2451
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2452
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %3, i32 0, i32 4, !dbg !2453
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2453
  store %struct.AVIOContext* %4, %struct.AVIOContext** %pb, align 8, !dbg !2451
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2454, metadata !2149), !dbg !2455
  store i32 0, i32* %ret, align 4, !dbg !2455
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2456, metadata !2149), !dbg !2457
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2458
  %call = call i32 @avio_feof(%struct.AVIOContext* %5), !dbg !2460
  %tobool = icmp ne i32 %call, 0, !dbg !2460
  br i1 %tobool, label %if.then, label %if.end, !dbg !2461

if.then:                                          ; preds = %entry
  store i32 -541478725, i32* %retval, align 4, !dbg !2462
  br label %return, !dbg !2462

if.end:                                           ; preds = %entry
  %6 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2463
  %cur_stream = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %6, i32 0, i32 0, !dbg !2465
  %7 = load i32, i32* %cur_stream, align 8, !dbg !2465
  %cmp = icmp eq i32 %7, 0, !dbg !2466
  br i1 %cmp, label %if.then2, label %if.end19, !dbg !2467

if.then2:                                         ; preds = %if.end
  call void @llvm.dbg.declare(metadata i32* %num_packets, metadata !2468, metadata !2149), !dbg !2470
  %8 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2471
  %call3 = call i32 @avio_r8(%struct.AVIOContext* %8), !dbg !2472
  %9 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2473
  %audio_packets = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %9, i32 0, i32 2, !dbg !2474
  store i32 %call3, i32* %audio_packets, align 8, !dbg !2475
  %10 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2476
  %audio_packets4 = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %10, i32 0, i32 2, !dbg !2478
  %11 = load i32, i32* %audio_packets4, align 8, !dbg !2478
  %tobool5 = icmp ne i32 %11, 0, !dbg !2476
  br i1 %tobool5, label %if.end7, label %if.then6, !dbg !2479

if.then6:                                         ; preds = %if.then2
  %12 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2480
  %13 = bitcast %struct.AVFormatContext* %12 to i8*, !dbg !2480
  call void (i8*, i32, i8*, ...) @av_log(i8* %13, i32 16, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.9, i32 0, i32 0)), !dbg !2482
  store i32 -1094995529, i32* %retval, align 4, !dbg !2483
  br label %return, !dbg !2483

if.end7:                                          ; preds = %if.then2
  %14 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2484
  %num_streams = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %14, i32 0, i32 1, !dbg !2485
  %15 = load i32, i32* %num_streams, align 4, !dbg !2485
  %sub = sub nsw i32 %15, 1, !dbg !2486
  %16 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2487
  %audio_packets8 = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %16, i32 0, i32 2, !dbg !2488
  %17 = load i32, i32* %audio_packets8, align 8, !dbg !2488
  %mul = mul nsw i32 %sub, %17, !dbg !2489
  %add = add nsw i32 %mul, 1, !dbg !2490
  store i32 %add, i32* %num_packets, align 4, !dbg !2491
  %18 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2492
  %call9 = call i64 @avio_skip(%struct.AVIOContext* %18, i64 8), !dbg !2493
  %19 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2494
  %current_packet = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %19, i32 0, i32 3, !dbg !2495
  store i32 0, i32* %current_packet, align 4, !dbg !2496
  %20 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2497
  %packet_sizes = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %20, i32 0, i32 4, !dbg !2498
  %21 = bitcast i32** %packet_sizes to i8*, !dbg !2499
  %22 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2500
  %packet_sizes_alloc = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %22, i32 0, i32 5, !dbg !2501
  %23 = load i32, i32* %num_packets, align 4, !dbg !2502
  %conv = sext i32 %23 to i64, !dbg !2502
  %mul10 = mul i64 %conv, 4, !dbg !2503
  call void @av_fast_malloc(i8* %21, i32* %packet_sizes_alloc, i64 %mul10), !dbg !2504
  %24 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2505
  %packet_sizes_alloc11 = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %24, i32 0, i32 5, !dbg !2507
  %25 = load i32, i32* %packet_sizes_alloc11, align 8, !dbg !2507
  %tobool12 = icmp ne i32 %25, 0, !dbg !2505
  br i1 %tobool12, label %if.end14, label %if.then13, !dbg !2508

if.then13:                                        ; preds = %if.end7
  %26 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2509
  %27 = bitcast %struct.AVFormatContext* %26 to i8*, !dbg !2509
  call void (i8*, i32, i8*, ...) @av_log(i8* %27, i32 16, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.10, i32 0, i32 0)), !dbg !2511
...
for.cond:                                         ; preds = %for.inc, %if.end14
  %28 = load i32, i32* %i, align 4, !dbg !2516
  %29 = load i32, i32* %num_packets, align 4, !dbg !2519
  %cmp15 = icmp slt i32 %28, %29, !dbg !2520
  br i1 %cmp15, label %for.body, label %for.end, !dbg !2521

for.body:                                         ; preds = %for.cond
  %30 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2522
  %call17 = call i32 @avio_rl32(%struct.AVIOContext* %30), !dbg !2523
  %31 = load i32, i32* %i, align 4, !dbg !2524
  %idxprom = sext i32 %31 to i64, !dbg !2525
  %32 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2525
  %packet_sizes18 = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %32, i32 0, i32 4, !dbg !2526
  %33 = load i32*, i32** %packet_sizes18, align 8, !dbg !2526
  %arrayidx = getelementptr inbounds i32, i32* %33, i64 %idxprom, !dbg !2525
  store i32 %call17, i32* %arrayidx, align 4, !dbg !2527
  br label %for.inc, !dbg !2525

for.inc:                                          ; preds = %for.body
  %34 = load i32, i32* %i, align 4, !dbg !2528
  %inc = add nsw i32 %34, 1, !dbg !2528
  store i32 %inc, i32* %i, align 4, !dbg !2528
  br label %for.cond, !dbg !2530, !llvm.loop !2531

for.end:                                          ; preds = %for.cond
  br label %if.end19, !dbg !2533

if.end19:                                         ; preds = %for.end, %if.end
  %35 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2534
  %36 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2535
  %37 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2536
  %current_packet20 = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %37, i32 0, i32 3, !dbg !2537
  %38 = load i32, i32* %current_packet20, align 4, !dbg !2537
  %idxprom21 = sext i32 %38 to i64, !dbg !2538
  %39 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2538
  %packet_sizes22 = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %39, i32 0, i32 4, !dbg !2539
  %40 = load i32*, i32** %packet_sizes22, align 8, !dbg !2539
  %arrayidx23 = getelementptr inbounds i32, i32* %40, i64 %idxprom21, !dbg !2538
  %41 = load i32, i32* %arrayidx23, align 4, !dbg !2538
  %call24 = call i32 @av_get_packet(%struct.AVIOContext* %35, %struct.AVPacket* %36, i32 %41), !dbg !2540
  store i32 %call24, i32* %ret, align 4, !dbg !2541
  %42 = load i32, i32* %ret, align 4, !dbg !2542
  %cmp25 = icmp sge i32 %42, 0, !dbg !2544
  br i1 %cmp25, label %if.then27, label %if.end29, !dbg !2545

if.then27:                                        ; preds = %if.end19
  store i32 0, i32* %ret, align 4, !dbg !2546
  %43 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2548
  %cur_stream28 = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %43, i32 0, i32 0, !dbg !2549
  %44 = load i32, i32* %cur_stream28, align 8, !dbg !2549
  %45 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2550
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %45, i32 0, i32 5, !dbg !2551
  store i32 %44, i32* %stream_index, align 4, !dbg !2552
  br label %if.end29, !dbg !2553

if.end29:                                         ; preds = %if.then27, %if.end19
  %46 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2554
  %current_packet30 = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %46, i32 0, i32 3, !dbg !2556
  %47 = load i32, i32* %current_packet30, align 4, !dbg !2556
  %48 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2557
  %audio_packets31 = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %48, i32 0, i32 2, !dbg !2558
  %49 = load i32, i32* %audio_packets31, align 8, !dbg !2558
  %rem = srem i32 %47, %49, !dbg !2559
  %cmp32 = icmp eq i32 %rem, 0, !dbg !2560
  br i1 %cmp32, label %if.then34, label %if.end40, !dbg !2561

if.then34:                                        ; preds = %if.end29
  %50 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2562
  %cur_stream35 = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %50, i32 0, i32 0, !dbg !2563
  %51 = load i32, i32* %cur_stream35, align 8, !dbg !2563
  %add36 = add nsw i32 %51, 1, !dbg !2564
  %52 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2565
  %num_streams37 = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %52, i32 0, i32 1, !dbg !2566
  %53 = load i32, i32* %num_streams37, align 4, !dbg !2566
  %rem38 = srem i32 %add36, %53, !dbg !2567
  %54 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2568
  %cur_stream39 = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %54, i32 0, i32 0, !dbg !2569
  store i32 %rem38, i32* %cur_stream39, align 8, !dbg !2570
  br label %if.end40, !dbg !2568

if.end40:                                         ; preds = %if.then34, %if.end29
  %55 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2571
  %current_packet41 = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %55, i32 0, i32 3, !dbg !2572
  %56 = load i32, i32* %current_packet41, align 4, !dbg !2573
  %inc42 = add nsw i32 %56, 1, !dbg !2573
  store i32 %inc42, i32* %current_packet41, align 4, !dbg !2573
  %57 = load i32, i32* %ret, align 4, !dbg !2574
  store i32 %57, i32* %retval, align 4, !dbg !2575
  br label %return, !dbg !2575

return:                                           ; preds = %if.end40, %if.then13, %if.then6, %if.then
  %58 = load i32, i32* %retval, align 4, !dbg !2576
  ret i32 %58, !dbg !2576
}

; Function Attrs: nounwind uwtable
define internal i32 @pmp_close(%struct.AVFormatContext* %s) #0 !dbg !2577 {
entry:
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %pmp = alloca %struct.PMPContext*, align 8
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2578, metadata !2149), !dbg !2579
  call void @llvm.dbg.declare(metadata %struct.PMPContext** %pmp, metadata !2580, metadata !2149), !dbg !2581
  ...
  %2 = bitcast i8* %1 to %struct.PMPContext*, !dbg !2582
  store %struct.PMPContext* %2, %struct.PMPContext** %pmp, align 8, !dbg !2581
  %3 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2584
  %packet_sizes = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %3, i32 0, i32 4, !dbg !2585
  %4 = bitcast i32** %packet_sizes to i8*, !dbg !2586
  call void @av_freep(i8* %4), !dbg !2587
  ret i32 0, !dbg !2588
}

; Function Attrs: nounwind uwtable
define internal i32 @pmp_seek(%struct.AVFormatContext* %s, i32 %stream_index, i64 %ts, i32 %flags) #0 !dbg !2589 {
entry:
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  %pmp = alloca %struct.PMPContext*, align 8
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2592, metadata !2149), !dbg !2593
  store i32 %stream_index, i32* %stream_index.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %stream_index.addr, metadata !2594, metadata !2149), !dbg !2595
  store i64 %ts, i64* %ts.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %ts.addr, metadata !2596, metadata !2149), !dbg !2597
  store i32 %flags, i32* %flags.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr, metadata !2598, metadata !2149), !dbg !2599
  call void @llvm.dbg.declare(metadata %struct.PMPContext** %pmp, metadata !2600, metadata !2149), !dbg !2601
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2602
  ...
  %2 = bitcast i8* %1 to %struct.PMPContext*, !dbg !2602
  store %struct.PMPContext* %2, %struct.PMPContext** %pmp, align 8, !dbg !2601
  %3 = load %struct.PMPContext*, %struct.PMPContext** %pmp, align 8, !dbg !2604
  %cur_stream = getelementptr inbounds %struct.PMPContext, %struct.PMPContext* %3, i32 0, i32 0, !dbg !2605
  store i32 0, i32* %cur_stream, align 8, !dbg !2606
  ret i32 -1, !dbg !2607
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--pmpdec.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!927 = !{!928}
!928 = distinct !DIGlobalVariable(name: "ff_pmp_demuxer", scope: !0, file: !929, line: 186, type: !930, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_pmp_demuxer)
!929 = !DIFile(filename: "libavformat/pmpdec.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2146 = distinct !DISubprogram(name: "pmp_probe", scope: !929, file: !929, line: 35, type: !999, isLocal: true, isDefinition: true, scopeLine: 35, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2147 = !{}
!2148 = !DILocalVariable(name: "p", arg: 1, scope: !2146, file: !929, line: 35, type: !1001)
!2149 = !DIExpression()
!2150 = !DILocation(line: 35, column: 35, scope: !2146)
!2151 = !DILocation(line: 36, column: 41, scope: !2152)
!2152 = distinct !DILexicalBlock(scope: !2146, file: !929, line: 36, column: 9)
!2153 = !DILocation(line: 36, column: 44, scope: !2152)
!2154 = !DILocation(line: 36, column: 51, scope: !2152)
!2155 = !DILocation(line: 36, column: 99, scope: !2152)
!2156 = !DILocation(line: 36, column: 54, scope: !2152)
!2157 = !DILocation(line: 36, column: 102, scope: !2152)
!2158 = !DILocation(line: 37, column: 41, scope: !2152)
!2159 = !DILocation(line: 37, column: 44, scope: !2152)
!2160 = !DILocation(line: 37, column: 48, scope: !2152)
!2161 = !DILocation(line: 37, column: 55, scope: !2152)
!2162 = !DILocation(line: 37, column: 58, scope: !2152)
!2163 = !DILocation(line: 36, column: 9, scope: !2164)
!2164 = !DILexicalBlockFile(scope: !2146, file: !929, discriminator: 1)
!2165 = !DILocation(line: 38, column: 9, scope: !2152)
!2166 = !DILocation(line: 39, column: 5, scope: !2146)
!2167 = !DILocation(line: 40, column: 1, scope: !2146)
!2168 = distinct !DISubprogram(name: "pmp_header", scope: !929, file: !929, line: 42, type: !2169, isLocal: true, isDefinition: true, scopeLine: 43, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2169 = !DISubroutineType(types: !2170)
!2170 = !{!926, !2171}
!2171 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2172, size: 64, align: 64)
!2172 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1016)
!2173 = !DILocalVariable(name: "s", arg: 1, scope: !2174, file: !628, line: 557, type: !1222)
!2174 = distinct !DISubprogram(name: "avio_tell", scope: !628, file: !628, line: 557, type: !2175, isLocal: true, isDefinition: true, scopeLine: 558, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2175 = !DISubroutineType(types: !2176)
!2176 = !{!1060, !1222}
!2177 = !DILocation(line: 557, column: 77, scope: !2174, inlinedAt: !2178)
!2178 = distinct !DILocation(line: 96, column: 11, scope: !2168)
!2179 = !DILocalVariable(name: "s", arg: 1, scope: !2168, file: !929, line: 42, type: !2171)
!2180 = !DILocation(line: 42, column: 40, scope: !2168)
!2181 = !DILocalVariable(name: "pmp", scope: !2168, file: !929, line: 44, type: !2182)
!2182 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2183, size: 64, align: 64)
!2183 = !DIDerivedType(tag: DW_TAG_typedef, name: "PMPContext", file: !929, line: 33, baseType: !2184)
!2184 = distinct !DICompositeType(tag: DW_TAG_structure_type, file: !929, line: 26, size: 256, align: 64, elements: !2185)
!2185 = !{!2186, !2187, !2188, !2189, !2190, !2192}
!2186 = !DIDerivedType(tag: DW_TAG_member, name: "cur_stream", scope: !2184, file: !929, line: 27, baseType: !926, size: 32, align: 32)
!2187 = !DIDerivedType(tag: DW_TAG_member, name: "num_streams", scope: !2184, file: !929, line: 28, baseType: !926, size: 32, align: 32, offset: 32)
!2188 = !DIDerivedType(tag: DW_TAG_member, name: "audio_packets", scope: !2184, file: !929, line: 29, baseType: !926, size: 32, align: 32, offset: 64)
!2189 = !DIDerivedType(tag: DW_TAG_member, name: "current_packet", scope: !2184, file: !929, line: 30, baseType: !926, size: 32, align: 32, offset: 96)
!2190 = !DIDerivedType(tag: DW_TAG_member, name: "packet_sizes", scope: !2184, file: !929, line: 31, baseType: !2191, size: 64, align: 64, offset: 128)
!2191 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !923, size: 64, align: 64)
!2192 = !DIDerivedType(tag: DW_TAG_member, name: "packet_sizes_alloc", scope: !2184, file: !929, line: 32, baseType: !926, size: 32, align: 32, offset: 192)
!2193 = !DILocation(line: 44, column: 17, scope: !2168)
!2194 = !DILocation(line: 44, column: 23, scope: !2168)
!2195 = !DILocation(line: 44, column: 26, scope: !2168)
!2196 = !DILocalVariable(name: "pb", scope: !2168, file: !929, line: 45, type: !1222)
!2197 = !DILocation(line: 45, column: 18, scope: !2168)
!2198 = !DILocation(line: 45, column: 23, scope: !2168)
!2199 = !DILocation(line: 45, column: 26, scope: !2168)
!2200 = !DILocalVariable(name: "tb_num", scope: !2168, file: !929, line: 46, type: !926)
!2201 = !DILocation(line: 46, column: 9, scope: !2168)
!2202 = !DILocalVariable(name: "tb_den", scope: !2168, file: !929, line: 46, type: !926)
!2203 = !DILocation(line: 46, column: 17, scope: !2168)
!2204 = !DILocalVariable(name: "index_cnt", scope: !2168, file: !929, line: 47, type: !923)
!2205 = !DILocation(line: 47, column: 14, scope: !2168)
!2206 = !DILocalVariable(name: "audio_codec_id", scope: !2168, file: !929, line: 48, type: !926)
!2207 = !DILocation(line: 48, column: 9, scope: !2168)
!2208 = !DILocalVariable(name: "srate", scope: !2168, file: !929, line: 49, type: !926)
!2209 = !DILocation(line: 49, column: 9, scope: !2168)
!2210 = !DILocalVariable(name: "channels", scope: !2168, file: !929, line: 49, type: !926)
!2211 = !DILocation(line: 49, column: 16, scope: !2168)
!2212 = !DILocalVariable(name: "i", scope: !2168, file: !929, line: 50, type: !925)
!2213 = !DILocation(line: 50, column: 14, scope: !2168)
!2214 = !DILocalVariable(name: "pos", scope: !2168, file: !929, line: 51, type: !1139)
!2215 = !DILocation(line: 51, column: 14, scope: !2168)
!2216 = !DILocalVariable(name: "fsize", scope: !2168, file: !929, line: 52, type: !1060)
!2217 = !DILocation(line: 52, column: 13, scope: !2168)
!2218 = !DILocation(line: 52, column: 31, scope: !2168)
!2219 = !DILocation(line: 52, column: 21, scope: !2168)
!2220 = !DILocalVariable(name: "vst", scope: !2168, file: !929, line: 54, type: !1290)
!2221 = !DILocation(line: 54, column: 15, scope: !2168)
!2222 = !DILocation(line: 54, column: 41, scope: !2168)
!2223 = !DILocation(line: 54, column: 21, scope: !2168)
!2224 = !DILocation(line: 55, column: 10, scope: !2225)
!2225 = distinct !DILexicalBlock(scope: !2168, file: !929, line: 55, column: 9)
!2226 = !DILocation(line: 55, column: 9, scope: !2168)
!2227 = !DILocation(line: 56, column: 9, scope: !2225)
!2228 = !DILocation(line: 57, column: 5, scope: !2168)
!2229 = !DILocation(line: 57, column: 10, scope: !2168)
!2230 = !DILocation(line: 57, column: 20, scope: !2168)
!2231 = !DILocation(line: 57, column: 31, scope: !2168)
!2232 = !DILocation(line: 58, column: 15, scope: !2168)
!2233 = !DILocation(line: 58, column: 5, scope: !2168)
!2234 = !DILocation(line: 59, column: 23, scope: !2168)
!2235 = !DILocation(line: 59, column: 13, scope: !2168)
!2236 = !DILocation(line: 59, column: 5, scope: !2168)
!2237 = !DILocation(line: 61, column: 9, scope: !2238)
!2238 = distinct !DILexicalBlock(scope: !2168, file: !929, line: 59, column: 28)
!2239 = !DILocation(line: 61, column: 14, scope: !2238)
!2240 = !DILocation(line: 61, column: 24, scope: !2238)
!2241 = !DILocation(line: 61, column: 33, scope: !2238)
!2242 = !DILocation(line: 62, column: 9, scope: !2238)
!2243 = !DILocation(line: 64, column: 9, scope: !2238)
!2244 = !DILocation(line: 64, column: 14, scope: !2238)
!2245 = !DILocation(line: 64, column: 24, scope: !2238)
!2246 = !DILocation(line: 64, column: 33, scope: !2238)
!2247 = !DILocation(line: 65, column: 9, scope: !2238)
!2248 = !DILocation(line: 67, column: 16, scope: !2238)
!2249 = !DILocation(line: 67, column: 9, scope: !2238)
!2250 = !DILocation(line: 68, column: 9, scope: !2238)
!2251 = !DILocation(line: 70, column: 27, scope: !2168)
!2252 = !DILocation(line: 70, column: 17, scope: !2168)
!2253 = !DILocation(line: 70, column: 15, scope: !2168)
!2254 = !DILocation(line: 71, column: 38, scope: !2168)
!2255 = !DILocation(line: 71, column: 28, scope: !2168)
!2256 = !DILocation(line: 71, column: 5, scope: !2168)
!2257 = !DILocation(line: 71, column: 10, scope: !2168)
!2258 = !DILocation(line: 71, column: 20, scope: !2168)
!2259 = !DILocation(line: 71, column: 26, scope: !2168)
!2260 = !DILocation(line: 72, column: 39, scope: !2168)
!2261 = !DILocation(line: 72, column: 29, scope: !2168)
!2262 = !DILocation(line: 72, column: 5, scope: !2168)
!2263 = !DILocation(line: 72, column: 10, scope: !2168)
!2264 = !DILocation(line: 72, column: 20, scope: !2168)
!2265 = !DILocation(line: 72, column: 27, scope: !2168)
!2266 = !DILocation(line: 74, column: 24, scope: !2168)
!2267 = !DILocation(line: 74, column: 14, scope: !2168)
!2268 = !DILocation(line: 74, column: 12, scope: !2168)
!2269 = !DILocation(line: 75, column: 24, scope: !2168)
!2270 = !DILocation(line: 75, column: 14, scope: !2168)
!2271 = !DILocation(line: 75, column: 12, scope: !2168)
!2272 = !DILocation(line: 76, column: 25, scope: !2168)
!2273 = !DILocation(line: 76, column: 34, scope: !2168)
!2274 = !DILocation(line: 76, column: 42, scope: !2168)
!2275 = !DILocation(line: 76, column: 5, scope: !2168)
!2276 = !DILocation(line: 77, column: 22, scope: !2168)
!2277 = !DILocation(line: 77, column: 5, scope: !2168)
!2278 = !DILocation(line: 77, column: 10, scope: !2168)
!2279 = !DILocation(line: 77, column: 20, scope: !2168)
!2280 = !DILocation(line: 78, column: 21, scope: !2168)
!2281 = !DILocation(line: 78, column: 5, scope: !2168)
!2282 = !DILocation(line: 78, column: 10, scope: !2168)
!2283 = !DILocation(line: 78, column: 19, scope: !2168)
!2284 = !DILocation(line: 80, column: 23, scope: !2168)
!2285 = !DILocation(line: 80, column: 13, scope: !2168)
!2286 = !DILocation(line: 80, column: 5, scope: !2168)
!2287 = !DILocation(line: 82, column: 24, scope: !2288)
!2288 = distinct !DILexicalBlock(scope: !2168, file: !929, line: 80, column: 28)
!2289 = !DILocation(line: 83, column: 9, scope: !2288)
!2290 = !DILocation(line: 85, column: 16, scope: !2288)
!2291 = !DILocation(line: 85, column: 9, scope: !2288)
!2292 = !DILocation(line: 86, column: 24, scope: !2288)
!2293 = !DILocation(line: 87, column: 9, scope: !2288)
!2294 = !DILocation(line: 89, column: 16, scope: !2288)
!2295 = !DILocation(line: 89, column: 9, scope: !2288)
!2296 = !DILocation(line: 90, column: 9, scope: !2288)
!2297 = !DILocation(line: 92, column: 34, scope: !2168)
!2298 = !DILocation(line: 92, column: 24, scope: !2168)
!2299 = !DILocation(line: 92, column: 38, scope: !2168)
!2300 = !DILocation(line: 92, column: 5, scope: !2168)
!2301 = !DILocation(line: 92, column: 10, scope: !2168)
!2302 = !DILocation(line: 92, column: 22, scope: !2168)
!2303 = !DILocation(line: 93, column: 15, scope: !2168)
!2304 = !DILocation(line: 93, column: 5, scope: !2168)
!2305 = !DILocation(line: 94, column: 23, scope: !2168)
!2306 = !DILocation(line: 94, column: 13, scope: !2168)
!2307 = !DILocation(line: 94, column: 11, scope: !2168)
!2308 = !DILocation(line: 95, column: 26, scope: !2168)
!2309 = !DILocation(line: 95, column: 16, scope: !2168)
!2310 = !DILocation(line: 95, column: 30, scope: !2168)
!2311 = !DILocation(line: 95, column: 14, scope: !2168)
!2312 = !DILocation(line: 96, column: 21, scope: !2168)
!2313 = !DILocation(line: 96, column: 11, scope: !2168)
!2314 = !DILocation(line: 559, column: 22, scope: !2174, inlinedAt: !2178)
!2315 = !DILocation(line: 559, column: 12, scope: !2174, inlinedAt: !2178)
!2316 = !DILocation(line: 96, column: 31, scope: !2168)
!2317 = !DILocation(line: 96, column: 30, scope: !2168)
!2318 = !DILocation(line: 96, column: 25, scope: !2168)
!2319 = !DILocation(line: 96, column: 9, scope: !2168)
!2320 = !DILocation(line: 97, column: 12, scope: !2321)
!2321 = distinct !DILexicalBlock(scope: !2168, file: !929, line: 97, column: 5)
!2322 = !DILocation(line: 97, column: 10, scope: !2321)
!2323 = !DILocation(line: 97, column: 17, scope: !2324)
!2324 = !DILexicalBlockFile(scope: !2325, file: !929, discriminator: 1)
!2325 = distinct !DILexicalBlock(scope: !2321, file: !929, line: 97, column: 5)
!2326 = !DILocation(line: 97, column: 21, scope: !2324)
!2327 = !DILocation(line: 97, column: 19, scope: !2324)
!2328 = !DILocation(line: 97, column: 5, scope: !2324)
!2329 = !DILocalVariable(name: "size", scope: !2330, file: !929, line: 98, type: !923)
!2330 = distinct !DILexicalBlock(scope: !2325, file: !929, line: 97, column: 37)
!2331 = !DILocation(line: 98, column: 18, scope: !2330)
!2332 = !DILocation(line: 98, column: 35, scope: !2330)
!2333 = !DILocation(line: 98, column: 25, scope: !2330)
!2334 = !DILocalVariable(name: "flags", scope: !2330, file: !929, line: 99, type: !926)
!2335 = !DILocation(line: 99, column: 13, scope: !2330)
!2336 = !DILocation(line: 99, column: 21, scope: !2330)
!2337 = !DILocation(line: 99, column: 26, scope: !2330)
!2338 = !DILocation(line: 100, column: 23, scope: !2339)
!2339 = distinct !DILexicalBlock(scope: !2330, file: !929, line: 100, column: 13)
!2340 = !DILocation(line: 100, column: 13, scope: !2339)
!2341 = !DILocation(line: 100, column: 13, scope: !2330)
!2342 = !DILocation(line: 101, column: 20, scope: !2343)
!2343 = distinct !DILexicalBlock(scope: !2339, file: !929, line: 100, column: 28)
!2344 = !DILocation(line: 101, column: 13, scope: !2343)
!2345 = !DILocation(line: 102, column: 13, scope: !2343)
!2346 = !DILocation(line: 104, column: 14, scope: !2330)
!2347 = !DILocation(line: 105, column: 13, scope: !2348)
!2348 = distinct !DILexicalBlock(scope: !2330, file: !929, line: 105, column: 13)
!2349 = !DILocation(line: 105, column: 26, scope: !2348)
!2350 = !DILocation(line: 105, column: 31, scope: !2348)
!2351 = !DILocation(line: 105, column: 25, scope: !2348)
!2352 = !DILocation(line: 105, column: 22, scope: !2348)
!2353 = !DILocation(line: 105, column: 18, scope: !2348)
!2354 = !DILocation(line: 105, column: 13, scope: !2330)
!2355 = !DILocation(line: 106, column: 20, scope: !2356)
!2356 = distinct !DILexicalBlock(scope: !2348, file: !929, line: 105, column: 44)
!2357 = !DILocation(line: 106, column: 13, scope: !2356)
!2358 = !DILocation(line: 107, column: 13, scope: !2356)
!2359 = !DILocation(line: 109, column: 28, scope: !2330)
!2360 = !DILocation(line: 109, column: 33, scope: !2330)
!2361 = !DILocation(line: 109, column: 38, scope: !2330)
!2362 = !DILocation(line: 109, column: 41, scope: !2330)
!2363 = !DILocation(line: 109, column: 50, scope: !2330)
!2364 = !DILocation(line: 109, column: 9, scope: !2330)
!2365 = !DILocation(line: 110, column: 16, scope: !2330)
!2366 = !DILocation(line: 110, column: 13, scope: !2330)
!2367 = !DILocation(line: 111, column: 13, scope: !2368)
!2368 = distinct !DILexicalBlock(scope: !2330, file: !929, line: 111, column: 13)
!2369 = !DILocation(line: 111, column: 19, scope: !2368)
!2370 = !DILocation(line: 111, column: 23, scope: !2368)
!2371 = !DILocation(line: 111, column: 26, scope: !2372)
!2372 = !DILexicalBlockFile(scope: !2368, file: !929, discriminator: 1)
!2373 = !DILocation(line: 111, column: 28, scope: !2372)
!2374 = !DILocation(line: 111, column: 33, scope: !2372)
!2375 = !DILocation(line: 111, column: 36, scope: !2376)
!2376 = !DILexicalBlockFile(scope: !2368, file: !929, discriminator: 2)
!2377 = !DILocation(line: 111, column: 42, scope: !2376)
!2378 = !DILocation(line: 111, column: 40, scope: !2376)
!2379 = !DILocation(line: 111, column: 13, scope: !2376)
!2380 = !DILocation(line: 112, column: 20, scope: !2381)
!2381 = distinct !DILexicalBlock(scope: !2368, file: !929, line: 111, column: 49)
!2382 = !DILocation(line: 112, column: 13, scope: !2381)
!2383 = !DILocation(line: 113, column: 13, scope: !2381)
!2384 = !DILocation(line: 115, column: 5, scope: !2330)
!2385 = !DILocation(line: 97, column: 33, scope: !2386)
!2386 = !DILexicalBlockFile(scope: !2325, file: !929, discriminator: 2)
!2387 = !DILocation(line: 97, column: 5, scope: !2386)
!2388 = distinct !{!2388, !2389}
!2389 = !DILocation(line: 97, column: 5, scope: !2168)
!2390 = !DILocation(line: 116, column: 12, scope: !2391)
!2391 = distinct !DILexicalBlock(scope: !2168, file: !929, line: 116, column: 5)
!2392 = !DILocation(line: 116, column: 10, scope: !2391)
!2393 = !DILocation(line: 116, column: 17, scope: !2394)
!2394 = !DILexicalBlockFile(scope: !2395, file: !929, discriminator: 1)
!2395 = distinct !DILexicalBlock(scope: !2391, file: !929, line: 116, column: 5)
!2396 = !DILocation(line: 116, column: 21, scope: !2394)
!2397 = !DILocation(line: 116, column: 26, scope: !2394)
!2398 = !DILocation(line: 116, column: 19, scope: !2394)
!2399 = !DILocation(line: 116, column: 5, scope: !2394)
!2400 = !DILocalVariable(name: "ast", scope: !2401, file: !929, line: 117, type: !1290)
!2401 = distinct !DILexicalBlock(scope: !2395, file: !929, line: 116, column: 44)
!2402 = !DILocation(line: 117, column: 19, scope: !2401)
!2403 = !DILocation(line: 117, column: 45, scope: !2401)
!2404 = !DILocation(line: 117, column: 25, scope: !2401)
!2405 = !DILocation(line: 118, column: 14, scope: !2406)
!2406 = distinct !DILexicalBlock(scope: !2401, file: !929, line: 118, column: 13)
!2407 = !DILocation(line: 118, column: 13, scope: !2401)
!2408 = !DILocation(line: 119, column: 13, scope: !2406)
!2409 = !DILocation(line: 120, column: 9, scope: !2401)
!2410 = !DILocation(line: 120, column: 14, scope: !2401)
!2411 = !DILocation(line: 120, column: 24, scope: !2401)
!2412 = !DILocation(line: 120, column: 35, scope: !2401)
!2413 = !DILocation(line: 121, column: 35, scope: !2401)
!2414 = !DILocation(line: 121, column: 9, scope: !2401)
!2415 = !DILocation(line: 121, column: 14, scope: !2401)
!2416 = !DILocation(line: 121, column: 24, scope: !2401)
!2417 = !DILocation(line: 121, column: 33, scope: !2401)
!2418 = !DILocation(line: 122, column: 35, scope: !2401)
!2419 = !DILocation(line: 122, column: 9, scope: !2401)
!2420 = !DILocation(line: 122, column: 14, scope: !2401)
!2421 = !DILocation(line: 122, column: 24, scope: !2401)
!2422 = !DILocation(line: 122, column: 33, scope: !2401)
!2423 = !DILocation(line: 123, column: 38, scope: !2401)
!2424 = !DILocation(line: 123, column: 9, scope: !2401)
!2425 = !DILocation(line: 123, column: 14, scope: !2401)
!2426 = !DILocation(line: 123, column: 24, scope: !2401)
!2427 = !DILocation(line: 123, column: 36, scope: !2401)
!2428 = !DILocation(line: 124, column: 29, scope: !2401)
!2429 = !DILocation(line: 124, column: 41, scope: !2401)
!2430 = !DILocation(line: 124, column: 9, scope: !2401)
!2431 = !DILocation(line: 125, column: 5, scope: !2401)
!2432 = !DILocation(line: 116, column: 40, scope: !2433)
!2433 = !DILexicalBlockFile(scope: !2395, file: !929, discriminator: 2)
!2434 = !DILocation(line: 116, column: 5, scope: !2433)
!2435 = distinct !{!2435, !2436}
!2436 = !DILocation(line: 116, column: 5, scope: !2168)
!2437 = !DILocation(line: 126, column: 5, scope: !2168)
!2438 = !DILocation(line: 127, column: 1, scope: !2168)
!2439 = distinct !DISubprogram(name: "pmp_packet", scope: !929, file: !929, line: 129, type: !2440, isLocal: true, isDefinition: true, scopeLine: 130, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2440 = !DISubroutineType(types: !2441)
!2441 = !{!926, !2171, !1041}
!2442 = !DILocalVariable(name: "s", arg: 1, scope: !2439, file: !929, line: 129, type: !2171)
!2443 = !DILocation(line: 129, column: 40, scope: !2439)
!2444 = !DILocalVariable(name: "pkt", arg: 2, scope: !2439, file: !929, line: 129, type: !1041)
!2445 = !DILocation(line: 129, column: 53, scope: !2439)
!2446 = !DILocalVariable(name: "pmp", scope: !2439, file: !929, line: 131, type: !2182)
!2447 = !DILocation(line: 131, column: 17, scope: !2439)
!2448 = !DILocation(line: 131, column: 23, scope: !2439)
!2449 = !DILocation(line: 131, column: 26, scope: !2439)
!2450 = !DILocalVariable(name: "pb", scope: !2439, file: !929, line: 132, type: !1222)
!2451 = !DILocation(line: 132, column: 18, scope: !2439)
!2452 = !DILocation(line: 132, column: 23, scope: !2439)
!2453 = !DILocation(line: 132, column: 26, scope: !2439)
!2454 = !DILocalVariable(name: "ret", scope: !2439, file: !929, line: 133, type: !926)
!2455 = !DILocation(line: 133, column: 9, scope: !2439)
!2456 = !DILocalVariable(name: "i", scope: !2439, file: !929, line: 134, type: !926)
!2457 = !DILocation(line: 134, column: 9, scope: !2439)
!2458 = !DILocation(line: 136, column: 19, scope: !2459)
!2459 = distinct !DILexicalBlock(scope: !2439, file: !929, line: 136, column: 9)
!2460 = !DILocation(line: 136, column: 9, scope: !2459)
!2461 = !DILocation(line: 136, column: 9, scope: !2439)
!2462 = !DILocation(line: 137, column: 9, scope: !2459)
!2463 = !DILocation(line: 138, column: 9, scope: !2464)
!2464 = distinct !DILexicalBlock(scope: !2439, file: !929, line: 138, column: 9)
!2465 = !DILocation(line: 138, column: 14, scope: !2464)
!2466 = !DILocation(line: 138, column: 25, scope: !2464)
!2467 = !DILocation(line: 138, column: 9, scope: !2439)
!2468 = !DILocalVariable(name: "num_packets", scope: !2469, file: !929, line: 139, type: !926)
!2469 = distinct !DILexicalBlock(scope: !2464, file: !929, line: 138, column: 31)
!2470 = !DILocation(line: 139, column: 13, scope: !2469)
!2471 = !DILocation(line: 140, column: 38, scope: !2469)
!2472 = !DILocation(line: 140, column: 30, scope: !2469)
!2473 = !DILocation(line: 140, column: 9, scope: !2469)
!2474 = !DILocation(line: 140, column: 14, scope: !2469)
!2475 = !DILocation(line: 140, column: 28, scope: !2469)
!2476 = !DILocation(line: 142, column: 14, scope: !2477)
!2477 = distinct !DILexicalBlock(scope: !2469, file: !929, line: 142, column: 13)
!2478 = !DILocation(line: 142, column: 19, scope: !2477)
!2479 = !DILocation(line: 142, column: 13, scope: !2469)
!2480 = !DILocation(line: 143, column: 20, scope: !2481)
!2481 = distinct !DILexicalBlock(scope: !2477, file: !929, line: 142, column: 34)
!2482 = !DILocation(line: 143, column: 13, scope: !2481)
!2483 = !DILocation(line: 144, column: 13, scope: !2481)
!2484 = !DILocation(line: 147, column: 24, scope: !2469)
!2485 = !DILocation(line: 147, column: 29, scope: !2469)
!2486 = !DILocation(line: 147, column: 41, scope: !2469)
!2487 = !DILocation(line: 147, column: 48, scope: !2469)
!2488 = !DILocation(line: 147, column: 53, scope: !2469)
!2489 = !DILocation(line: 147, column: 46, scope: !2469)
!2490 = !DILocation(line: 147, column: 67, scope: !2469)
!2491 = !DILocation(line: 147, column: 21, scope: !2469)
!2492 = !DILocation(line: 148, column: 19, scope: !2469)
!2493 = !DILocation(line: 148, column: 9, scope: !2469)
!2494 = !DILocation(line: 149, column: 9, scope: !2469)
!2495 = !DILocation(line: 149, column: 14, scope: !2469)
!2496 = !DILocation(line: 149, column: 29, scope: !2469)
!2497 = !DILocation(line: 150, column: 25, scope: !2469)
!2498 = !DILocation(line: 150, column: 30, scope: !2469)
!2499 = !DILocation(line: 150, column: 24, scope: !2469)
!2500 = !DILocation(line: 151, column: 25, scope: !2469)
!2501 = !DILocation(line: 151, column: 30, scope: !2469)
!2502 = !DILocation(line: 152, column: 24, scope: !2469)
!2503 = !DILocation(line: 152, column: 36, scope: !2469)
!2504 = !DILocation(line: 150, column: 9, scope: !2469)
!2505 = !DILocation(line: 153, column: 14, scope: !2506)
!2506 = distinct !DILexicalBlock(scope: !2469, file: !929, line: 153, column: 13)
!2507 = !DILocation(line: 153, column: 19, scope: !2506)
!2508 = !DILocation(line: 153, column: 13, scope: !2469)
!2509 = !DILocation(line: 154, column: 20, scope: !2510)
!2510 = distinct !DILexicalBlock(scope: !2506, file: !929, line: 153, column: 39)
!2511 = !DILocation(line: 154, column: 13, scope: !2510)
!2512 = !DILocation(line: 155, column: 13, scope: !2510)
!2513 = !DILocation(line: 157, column: 16, scope: !2514)
!2514 = distinct !DILexicalBlock(scope: !2469, file: !929, line: 157, column: 9)
!2515 = !DILocation(line: 157, column: 14, scope: !2514)
!2516 = !DILocation(line: 157, column: 21, scope: !2517)
!2517 = !DILexicalBlockFile(scope: !2518, file: !929, discriminator: 1)
!2518 = distinct !DILexicalBlock(scope: !2514, file: !929, line: 157, column: 9)
!2519 = !DILocation(line: 157, column: 25, scope: !2517)
!2520 = !DILocation(line: 157, column: 23, scope: !2517)
!2521 = !DILocation(line: 157, column: 9, scope: !2517)
!2522 = !DILocation(line: 158, column: 46, scope: !2518)
!2523 = !DILocation(line: 158, column: 36, scope: !2518)
!2524 = !DILocation(line: 158, column: 31, scope: !2518)
!2525 = !DILocation(line: 158, column: 13, scope: !2518)
!2526 = !DILocation(line: 158, column: 18, scope: !2518)
!2527 = !DILocation(line: 158, column: 34, scope: !2518)
!2528 = !DILocation(line: 157, column: 39, scope: !2529)
!2529 = !DILexicalBlockFile(scope: !2518, file: !929, discriminator: 2)
!2530 = !DILocation(line: 157, column: 9, scope: !2529)
!2531 = distinct !{!2531, !2532}
!2532 = !DILocation(line: 157, column: 9, scope: !2469)
!2533 = !DILocation(line: 159, column: 5, scope: !2469)
!2534 = !DILocation(line: 160, column: 25, scope: !2439)
!2535 = !DILocation(line: 160, column: 29, scope: !2439)
!2536 = !DILocation(line: 160, column: 52, scope: !2439)
!2537 = !DILocation(line: 160, column: 57, scope: !2439)
!2538 = !DILocation(line: 160, column: 34, scope: !2439)
!2539 = !DILocation(line: 160, column: 39, scope: !2439)
!2540 = !DILocation(line: 160, column: 11, scope: !2439)
!2541 = !DILocation(line: 160, column: 9, scope: !2439)
!2542 = !DILocation(line: 161, column: 9, scope: !2543)
!2543 = distinct !DILexicalBlock(scope: !2439, file: !929, line: 161, column: 9)
!2544 = !DILocation(line: 161, column: 13, scope: !2543)
!2545 = !DILocation(line: 161, column: 9, scope: !2439)
!2546 = !DILocation(line: 162, column: 13, scope: !2547)
!2547 = distinct !DILexicalBlock(scope: !2543, file: !929, line: 161, column: 19)
!2548 = !DILocation(line: 163, column: 29, scope: !2547)
!2549 = !DILocation(line: 163, column: 34, scope: !2547)
!2550 = !DILocation(line: 163, column: 9, scope: !2547)
!2551 = !DILocation(line: 163, column: 14, scope: !2547)
!2552 = !DILocation(line: 163, column: 27, scope: !2547)
!2553 = !DILocation(line: 164, column: 5, scope: !2547)
!2554 = !DILocation(line: 165, column: 9, scope: !2555)
!2555 = distinct !DILexicalBlock(scope: !2439, file: !929, line: 165, column: 9)
!2556 = !DILocation(line: 165, column: 14, scope: !2555)
!2557 = !DILocation(line: 165, column: 31, scope: !2555)
!2558 = !DILocation(line: 165, column: 36, scope: !2555)
!2559 = !DILocation(line: 165, column: 29, scope: !2555)
!2560 = !DILocation(line: 165, column: 50, scope: !2555)
!2561 = !DILocation(line: 165, column: 9, scope: !2439)
!2562 = !DILocation(line: 166, column: 28, scope: !2555)
!2563 = !DILocation(line: 166, column: 33, scope: !2555)
!2564 = !DILocation(line: 166, column: 44, scope: !2555)
!2565 = !DILocation(line: 166, column: 51, scope: !2555)
!2566 = !DILocation(line: 166, column: 56, scope: !2555)
!2567 = !DILocation(line: 166, column: 49, scope: !2555)
!2568 = !DILocation(line: 166, column: 9, scope: !2555)
!2569 = !DILocation(line: 166, column: 14, scope: !2555)
!2570 = !DILocation(line: 166, column: 25, scope: !2555)
!2571 = !DILocation(line: 167, column: 5, scope: !2439)
!2572 = !DILocation(line: 167, column: 10, scope: !2439)
!2573 = !DILocation(line: 167, column: 24, scope: !2439)
!2574 = !DILocation(line: 168, column: 12, scope: !2439)
!2575 = !DILocation(line: 168, column: 5, scope: !2439)
!2576 = !DILocation(line: 169, column: 1, scope: !2439)
!2577 = distinct !DISubprogram(name: "pmp_close", scope: !929, file: !929, line: 179, type: !2169, isLocal: true, isDefinition: true, scopeLine: 180, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2578 = !DILocalVariable(name: "s", arg: 1, scope: !2577, file: !929, line: 179, type: !2171)
!2579 = !DILocation(line: 179, column: 39, scope: !2577)
!2580 = !DILocalVariable(name: "pmp", scope: !2577, file: !929, line: 181, type: !2182)
!2581 = !DILocation(line: 181, column: 17, scope: !2577)
!2582 = !DILocation(line: 181, column: 23, scope: !2577)
!2583 = !DILocation(line: 181, column: 26, scope: !2577)
!2584 = !DILocation(line: 182, column: 15, scope: !2577)
!2585 = !DILocation(line: 182, column: 20, scope: !2577)
!2586 = !DILocation(line: 182, column: 14, scope: !2577)
!2587 = !DILocation(line: 182, column: 5, scope: !2577)
!2588 = !DILocation(line: 183, column: 5, scope: !2577)
!2589 = distinct !DISubprogram(name: "pmp_seek", scope: !929, file: !929, line: 171, type: !2590, isLocal: true, isDefinition: true, scopeLine: 172, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2590 = !DISubroutineType(types: !2591)
!2591 = !{!926, !2171, !926, !1060, !926}
!2592 = !DILocalVariable(name: "s", arg: 1, scope: !2589, file: !929, line: 171, type: !2171)
!2593 = !DILocation(line: 171, column: 38, scope: !2589)
!2594 = !DILocalVariable(name: "stream_index", arg: 2, scope: !2589, file: !929, line: 171, type: !926)
!2595 = !DILocation(line: 171, column: 45, scope: !2589)
!2596 = !DILocalVariable(name: "ts", arg: 3, scope: !2589, file: !929, line: 171, type: !1060)
!2597 = !DILocation(line: 171, column: 67, scope: !2589)
!2598 = !DILocalVariable(name: "flags", arg: 4, scope: !2589, file: !929, line: 171, type: !926)
!2599 = !DILocation(line: 171, column: 75, scope: !2589)
!2600 = !DILocalVariable(name: "pmp", scope: !2589, file: !929, line: 173, type: !2182)
!2601 = !DILocation(line: 173, column: 17, scope: !2589)
!2602 = !DILocation(line: 173, column: 23, scope: !2589)
!2603 = !DILocation(line: 173, column: 26, scope: !2589)
!2604 = !DILocation(line: 174, column: 5, scope: !2589)
!2605 = !DILocation(line: 174, column: 10, scope: !2589)
!2606 = !DILocation(line: 174, column: 21, scope: !2589)
!2607 = !DILocation(line: 176, column: 5, scope: !2589)
