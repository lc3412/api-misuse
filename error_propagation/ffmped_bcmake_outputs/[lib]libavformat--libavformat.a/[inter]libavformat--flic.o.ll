; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--flic.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--flic.o.i"
...
@ff_flic_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.1, i32 0, i32 0), i32 0, i8* null, %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 12, i32 (%struct.AVProbeData*)* @flic_probe, i32 (%struct.AVFormatContext*)* @flic_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @flic_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
...
define internal i32 @flic_probe(%struct.AVProbeData* %p) #0 !dbg !2151 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %magic_number, metadata !2156, metadata !2154), !dbg !2157
  %0 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2158
  %buf_size = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %0, i32 0, i32 2, !dbg !2160
  %1 = load i32, i32* %buf_size, align 8, !dbg !2160
  %cmp = icmp slt i32 %1, 128, !dbg !2161
...
if.end:                                           ; preds = %entry
  %2 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2164
  %buf = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %2, i32 0, i32 1, !dbg !2165
  %3 = load i8*, i8** %buf, align 8, !dbg !2165
  %arrayidx = getelementptr inbounds i8, i8* %3, i64 4, !dbg !2164
  %4 = bitcast i8* %arrayidx to %union.unaligned_16*, !dbg !2166
  %l = bitcast %union.unaligned_16* %4 to i16*, !dbg !2166
  %5 = load i16, i16* %l, align 1, !dbg !2166
  %conv = zext i16 %5 to i32, !dbg !2167
  store i32 %conv, i32* %magic_number, align 4, !dbg !2168
  %6 = load i32, i32* %magic_number, align 4, !dbg !2169
  %cmp1 = icmp ne i32 %6, 44817, !dbg !2171
  br i1 %cmp1, label %land.lhs.true, label %if.end9, !dbg !2172

land.lhs.true:                                    ; preds = %if.end
  %7 = load i32, i32* %magic_number, align 4, !dbg !2173
  %cmp3 = icmp ne i32 %7, 44818, !dbg !2174
  br i1 %cmp3, label %land.lhs.true5, label %if.end9, !dbg !2175

land.lhs.true5:                                   ; preds = %land.lhs.true
  %8 = load i32, i32* %magic_number, align 4, !dbg !2176
  %cmp6 = icmp ne i32 %8, 44868, !dbg !2177
  br i1 %cmp6, label %if.then8, label %if.end9, !dbg !2178
...
if.end9:                                          ; preds = %land.lhs.true5, %land.lhs.true, %if.end
  %9 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2181
  %buf10 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %9, i32 0, i32 1, !dbg !2183
  %10 = load i8*, i8** %buf10, align 8, !dbg !2183
  %arrayidx11 = getelementptr inbounds i8, i8* %10, i64 16, !dbg !2181
  %11 = bitcast i8* %arrayidx11 to %union.unaligned_16*, !dbg !2184
  %l12 = bitcast %union.unaligned_16* %11 to i16*, !dbg !2184
  %12 = load i16, i16* %l12, align 1, !dbg !2184
  %conv13 = zext i16 %12 to i32, !dbg !2185
  %cmp14 = icmp ne i32 %conv13, 61946, !dbg !2186
  br i1 %cmp14, label %if.then16, label %if.end24, !dbg !2187

if.then16:                                        ; preds = %if.end9
  %13 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2188
  %buf17 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %13, i32 0, i32 1, !dbg !2191
  %14 = load i8*, i8** %buf17, align 8, !dbg !2191
  %arrayidx18 = getelementptr inbounds i8, i8* %14, i64 16, !dbg !2188
  %15 = bitcast i8* %arrayidx18 to %union.unaligned_32*, !dbg !2192
  %l19 = bitcast %union.unaligned_32* %15 to i32*, !dbg !2192
  %16 = load i32, i32* %l19, align 1, !dbg !2192
  %cmp20 = icmp ugt i32 %16, 2000, !dbg !2193
...
if.end24:                                         ; preds = %if.end23, %if.end9
  %17 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2197
  %buf25 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %17, i32 0, i32 1, !dbg !2199
  %18 = load i8*, i8** %buf25, align 8, !dbg !2199
  %arrayidx26 = getelementptr inbounds i8, i8* %18, i64 8, !dbg !2197
  %19 = bitcast i8* %arrayidx26 to %union.unaligned_16*, !dbg !2200
  %l27 = bitcast %union.unaligned_16* %19 to i16*, !dbg !2200
  %20 = load i16, i16* %l27, align 1, !dbg !2200
  %conv28 = zext i16 %20 to i32, !dbg !2201
  %cmp29 = icmp sgt i32 %conv28, 4096, !dbg !2202
  br i1 %cmp29, label %if.then37, label %lor.lhs.false, !dbg !2203

lor.lhs.false:                                    ; preds = %if.end24
  %21 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2204
  %buf31 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %21, i32 0, i32 1, !dbg !2206
  %22 = load i8*, i8** %buf31, align 8, !dbg !2206
  %arrayidx32 = getelementptr inbounds i8, i8* %22, i64 10, !dbg !2204
  %23 = bitcast i8* %arrayidx32 to %union.unaligned_16*, !dbg !2207
  %l33 = bitcast %union.unaligned_16* %23 to i16*, !dbg !2207
  %24 = load i16, i16* %l33, align 1, !dbg !2207
  %conv34 = zext i16 %24 to i32, !dbg !2208
  %cmp35 = icmp sgt i32 %conv34, 4096, !dbg !2209
  br i1 %cmp35, label %if.then37, label %if.end38, !dbg !2210
...
if.end38:                                         ; preds = %lor.lhs.false
  store i32 99, i32* %retval, align 4, !dbg !2212
  br label %return, !dbg !2212

return:                                           ; preds = %if.end38, %if.then37, %if.then22, %if.then8, %if.then
  %25 = load i32, i32* %retval, align 4, !dbg !2213
  ret i32 %25, !dbg !2213
}

; Function Attrs: nounwind uwtable
define internal i32 @flic_read_header(%struct.AVFormatContext* %s) #0 !dbg !2214 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %flic = alloca %struct.FlicDemuxContext*, align 8
  ...
  %magic_number = alloca i32, align 4
  %preamble = alloca [6 x i8], align 1
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2219, metadata !2154), !dbg !2220
  call void @llvm.dbg.declare(metadata %struct.FlicDemuxContext** %flic, metadata !2221, metadata !2154), !dbg !2229
  ...
  %2 = bitcast i8* %1 to %struct.FlicDemuxContext*, !dbg !2230
  store %struct.FlicDemuxContext* %2, %struct.FlicDemuxContext** %flic, align 8, !dbg !2229
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2232, metadata !2154), !dbg !2233
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2234
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %3, i32 0, i32 4, !dbg !2235
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2235
  store %struct.AVIOContext* %4, %struct.AVIOContext** %pb, align 8, !dbg !2233
  call void @llvm.dbg.declare(metadata [128 x i8]* %header, metadata !2236, metadata !2154), !dbg !2240
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2241, metadata !2154), !dbg !2242
  call void @llvm.dbg.declare(metadata %struct.AVStream** %ast, metadata !2243, metadata !2154), !dbg !2244
  call void @llvm.dbg.declare(metadata i32* %speed, metadata !2245, metadata !2154), !dbg !2246
  call void @llvm.dbg.declare(metadata i32* %magic_number, metadata !2247, metadata !2154), !dbg !2248
  call void @llvm.dbg.declare(metadata [6 x i8]* %preamble, metadata !2249, metadata !2154), !dbg !2253
  %5 = load %struct.FlicDemuxContext*, %struct.FlicDemuxContext** %flic, align 8, !dbg !2254
  %frame_number = getelementptr inbounds %struct.FlicDemuxContext, %struct.FlicDemuxContext* %5, i32 0, i32 2, !dbg !2255
  store i32 0, i32* %frame_number, align 4, !dbg !2256
  %6 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2257
  %arraydecay = getelementptr inbounds [128 x i8], [128 x i8]* %header, i32 0, i32 0, !dbg !2259
  %call = call i32 @avio_read(%struct.AVIOContext* %6, i8* %arraydecay, i32 128), !dbg !2260
  %cmp = icmp ne i32 %call, 128, !dbg !2261
  br i1 %cmp, label %if.then, label %if.end, !dbg !2262

if.then:                                          ; preds = %entry
  store i32 -5, i32* %retval, align 4, !dbg !2263
  br label %return, !dbg !2263

if.end:                                           ; preds = %entry
  %arrayidx = getelementptr inbounds [128 x i8], [128 x i8]* %header, i64 0, i64 4, !dbg !2264
  %7 = bitcast i8* %arrayidx to %union.unaligned_16*, !dbg !2265
  %l = bitcast %union.unaligned_16* %7 to i16*, !dbg !2265
  %8 = load i16, i16* %l, align 4, !dbg !2265
  %conv = zext i16 %8 to i32, !dbg !2266
  store i32 %conv, i32* %magic_number, align 4, !dbg !2267
  %arrayidx2 = getelementptr inbounds [128 x i8], [128 x i8]* %header, i64 0, i64 16, !dbg !2268
  %9 = bitcast i8* %arrayidx2 to %union.unaligned_32*, !dbg !2269
  %l3 = bitcast %union.unaligned_32* %9 to i32*, !dbg !2269
  %10 = load i32, i32* %l3, align 16, !dbg !2269
  store i32 %10, i32* %speed, align 4, !dbg !2270
  %11 = load i32, i32* %speed, align 4, !dbg !2271
  %cmp4 = icmp eq i32 %11, 0, !dbg !2273
  br i1 %cmp4, label %if.then6, label %if.end7, !dbg !2274

if.then6:                                         ; preds = %if.end
  store i32 5, i32* %speed, align 4, !dbg !2275
  br label %if.end7, !dbg !2276

if.end7:                                          ; preds = %if.then6, %if.end
  %12 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2277
  %call8 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %12, %struct.AVCodec* null), !dbg !2278
  store %struct.AVStream* %call8, %struct.AVStream** %st, align 8, !dbg !2279
  %13 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2280
  %tobool = icmp ne %struct.AVStream* %13, null, !dbg !2280
  br i1 %tobool, label %if.end10, label %if.then9, !dbg !2282
...
if.end10:                                         ; preds = %if.end7
  %14 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2284
  %index = getelementptr inbounds %struct.AVStream, %struct.AVStream* %14, i32 0, i32 0, !dbg !2285
  %15 = load i32, i32* %index, align 8, !dbg !2285
  %16 = load %struct.FlicDemuxContext*, %struct.FlicDemuxContext** %flic, align 8, !dbg !2286
  %video_stream_index = getelementptr inbounds %struct.FlicDemuxContext, %struct.FlicDemuxContext* %16, i32 0, i32 0, !dbg !2287
  store i32 %15, i32* %video_stream_index, align 4, !dbg !2288
  %17 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2289
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %17, i32 0, i32 19, !dbg !2290
  %18 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2290
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %18, i32 0, i32 0, !dbg !2291
  store i32 0, i32* %codec_type, align 8, !dbg !2292
  %19 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2293
  %codecpar11 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %19, i32 0, i32 19, !dbg !2294
  %20 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar11, align 8, !dbg !2294
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %20, i32 0, i32 1, !dbg !2295
  store i32 50, i32* %codec_id, align 4, !dbg !2296
  %21 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2297
  %codecpar12 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %21, i32 0, i32 19, !dbg !2298
  %22 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar12, align 8, !dbg !2298
  %codec_tag = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %22, i32 0, i32 2, !dbg !2299
  store i32 0, i32* %codec_tag, align 8, !dbg !2300
  %arrayidx13 = getelementptr inbounds [128 x i8], [128 x i8]* %header, i64 0, i64 8, !dbg !2301
  %23 = bitcast i8* %arrayidx13 to %union.unaligned_16*, !dbg !2302
  %l14 = bitcast %union.unaligned_16* %23 to i16*, !dbg !2302
  %24 = load i16, i16* %l14, align 8, !dbg !2302
  %conv15 = zext i16 %24 to i32, !dbg !2303
  %25 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2304
  %codecpar16 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %25, i32 0, i32 19, !dbg !2305
  %26 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar16, align 8, !dbg !2305
  %width = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %26, i32 0, i32 11, !dbg !2306
  store i32 %conv15, i32* %width, align 8, !dbg !2307
  %arrayidx17 = getelementptr inbounds [128 x i8], [128 x i8]* %header, i64 0, i64 10, !dbg !2308
  %27 = bitcast i8* %arrayidx17 to %union.unaligned_16*, !dbg !2309
  %l18 = bitcast %union.unaligned_16* %27 to i16*, !dbg !2309
  %28 = load i16, i16* %l18, align 2, !dbg !2309
  %conv19 = zext i16 %28 to i32, !dbg !2310
  %29 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2311
  %codecpar20 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %29, i32 0, i32 19, !dbg !2312
  %30 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar20, align 8, !dbg !2312
  %height = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %30, i32 0, i32 12, !dbg !2313
  store i32 %conv19, i32* %height, align 4, !dbg !2314
  %31 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2315
  %codecpar21 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %31, i32 0, i32 19, !dbg !2317
  %32 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar21, align 8, !dbg !2317
  %width22 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %32, i32 0, i32 11, !dbg !2318
  %33 = load i32, i32* %width22, align 8, !dbg !2318
  %tobool23 = icmp ne i32 %33, 0, !dbg !2315
  br i1 %tobool23, label %lor.lhs.false, label %if.then27, !dbg !2319

lor.lhs.false:                                    ; preds = %if.end10
  %34 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2320
  %codecpar24 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %34, i32 0, i32 19, !dbg !2322
  %35 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar24, align 8, !dbg !2322
  %height25 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %35, i32 0, i32 12, !dbg !2323
  %36 = load i32, i32* %height25, align 4, !dbg !2323
  %tobool26 = icmp ne i32 %36, 0, !dbg !2320
  br i1 %tobool26, label %if.end32, label %if.then27, !dbg !2324

if.then27:                                        ; preds = %lor.lhs.false, %if.end10
  %37 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2325
  %38 = bitcast %struct.AVFormatContext* %37 to i8*, !dbg !2325
  call void (i8*, i32, i8*, ...) @av_log(i8* %38, i32 24, i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.2, i32 0, i32 0)), !dbg !2327
  %39 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2328
  %codecpar28 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %39, i32 0, i32 19, !dbg !2329
  %40 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar28, align 8, !dbg !2329
  %width29 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %40, i32 0, i32 11, !dbg !2330
  store i32 640, i32* %width29, align 8, !dbg !2331
  %41 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2332
  %codecpar30 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %41, i32 0, i32 19, !dbg !2333
  %42 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar30, align 8, !dbg !2333
  %height31 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %42, i32 0, i32 12, !dbg !2334
  store i32 480, i32* %height31, align 4, !dbg !2335
  br label %if.end32, !dbg !2336

if.end32:                                         ; preds = %if.then27, %lor.lhs.false
  %43 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2337
  %codecpar33 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %43, i32 0, i32 19, !dbg !2339
  %44 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar33, align 8, !dbg !2339
  %call34 = call i32 @ff_alloc_extradata(%struct.AVCodecParameters* %44, i32 128), !dbg !2340
  %tobool35 = icmp ne i32 %call34, 0, !dbg !2340
  br i1 %tobool35, label %if.then36, label %if.end37, !dbg !2341
...
if.end37:                                         ; preds = %if.end32
  %45 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2343
  %codecpar38 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %45, i32 0, i32 19, !dbg !2344
  %46 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar38, align 8, !dbg !2344
  %extradata = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %46, i32 0, i32 3, !dbg !2345
  %47 = load i8*, i8** %extradata, align 8, !dbg !2345
  %arraydecay39 = getelementptr inbounds [128 x i8], [128 x i8]* %header, i32 0, i32 0, !dbg !2346
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %47, i8* %arraydecay39, i64 128, i32 1, i1 false), !dbg !2346
  %48 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2347
  %arraydecay40 = getelementptr inbounds [6 x i8], [6 x i8]* %preamble, i32 0, i32 0, !dbg !2349
  %call41 = call i32 @avio_read(%struct.AVIOContext* %48, i8* %arraydecay40, i32 6), !dbg !2350
  %cmp42 = icmp ne i32 %call41, 6, !dbg !2351
  br i1 %cmp42, label %if.then44, label %if.end45, !dbg !2352

if.then44:                                        ; preds = %if.end37
  %49 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2353
  %50 = bitcast %struct.AVFormatContext* %49 to i8*, !dbg !2353
  call void (i8*, i32, i8*, ...) @av_log(i8* %50, i32 16, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.3, i32 0, i32 0)), !dbg !2355
  store i32 -5, i32* %retval, align 4, !dbg !2356
  br label %return, !dbg !2356

if.end45:                                         ; preds = %if.end37
  %51 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2357
  %call46 = call i64 @avio_seek(%struct.AVIOContext* %51, i64 -6, i32 1), !dbg !2358
  %arrayidx47 = getelementptr inbounds [6 x i8], [6 x i8]* %preamble, i64 0, i64 4, !dbg !2359
  %52 = bitcast i8* %arrayidx47 to %union.unaligned_16*, !dbg !2361
  %l48 = bitcast %union.unaligned_16* %52 to i16*, !dbg !2361
  %53 = load i16, i16* %l48, align 1, !dbg !2361
  %conv49 = zext i16 %53 to i32, !dbg !2362
  %cmp50 = icmp eq i32 %conv49, 43690, !dbg !2363
  br i1 %cmp50, label %if.then52, label %if.else, !dbg !2364

if.then52:                                        ; preds = %if.end45
  %54 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2365
  %call53 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %54, %struct.AVCodec* null), !dbg !2367
  store %struct.AVStream* %call53, %struct.AVStream** %ast, align 8, !dbg !2368
  %55 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2369
  %tobool54 = icmp ne %struct.AVStream* %55, null, !dbg !2369
  br i1 %tobool54, label %if.end56, label %if.then55, !dbg !2371
...
if.end56:                                         ; preds = %if.then52
  %56 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2373
  %index57 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %56, i32 0, i32 0, !dbg !2374
  %57 = load i32, i32* %index57, align 8, !dbg !2374
  %58 = load %struct.FlicDemuxContext*, %struct.FlicDemuxContext** %flic, align 8, !dbg !2375
  %audio_stream_index = getelementptr inbounds %struct.FlicDemuxContext, %struct.FlicDemuxContext* %58, i32 0, i32 1, !dbg !2376
  store i32 %57, i32* %audio_stream_index, align 4, !dbg !2377
  %arrayidx58 = getelementptr inbounds [6 x i8], [6 x i8]* %preamble, i64 0, i64 0, !dbg !2378
  %59 = bitcast i8* %arrayidx58 to %union.unaligned_32*, !dbg !2379
  %l59 = bitcast %union.unaligned_32* %59 to i32*, !dbg !2379
  %60 = load i32, i32* %l59, align 1, !dbg !2379
  %61 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2380
  %codecpar60 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %61, i32 0, i32 19, !dbg !2381
  %62 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar60, align 8, !dbg !2381
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %62, i32 0, i32 24, !dbg !2382
  store i32 %60, i32* %block_align, align 8, !dbg !2383
  %63 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2384
  %codecpar61 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %63, i32 0, i32 19, !dbg !2385
  %64 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar61, align 8, !dbg !2385
  %codec_type62 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %64, i32 0, i32 0, !dbg !2386
  store i32 1, i32* %codec_type62, align 8, !dbg !2387
  %65 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2388
  %codecpar63 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %65, i32 0, i32 19, !dbg !2389
  %66 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar63, align 8, !dbg !2389
  %codec_id64 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %66, i32 0, i32 1, !dbg !2390
  store i32 65541, i32* %codec_id64, align 4, !dbg !2391
  %67 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2392
  %codecpar65 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %67, i32 0, i32 19, !dbg !2393
  %68 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar65, align 8, !dbg !2393
  %codec_tag66 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %68, i32 0, i32 2, !dbg !2394
  store i32 0, i32* %codec_tag66, align 8, !dbg !2395
  %69 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2396
  %codecpar67 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %69, i32 0, i32 19, !dbg !2397
  %70 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar67, align 8, !dbg !2397
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %70, i32 0, i32 23, !dbg !2398
  store i32 22050, i32* %sample_rate, align 4, !dbg !2399
  %71 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2400
  %codecpar68 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %71, i32 0, i32 19, !dbg !2401
  %72 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar68, align 8, !dbg !2401
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %72, i32 0, i32 22, !dbg !2402
  store i32 1, i32* %channels, align 8, !dbg !2403
  %73 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2404
  %codecpar69 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %73, i32 0, i32 19, !dbg !2405
  %74 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar69, align 8, !dbg !2405
  %sample_rate70 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %74, i32 0, i32 23, !dbg !2406
  %75 = load i32, i32* %sample_rate70, align 4, !dbg !2406
  %mul = mul nsw i32 %75, 8, !dbg !2407
  %conv71 = sext i32 %mul to i64, !dbg !2404
  %76 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2408
  %codecpar72 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %76, i32 0, i32 19, !dbg !2409
  %77 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar72, align 8, !dbg !2409
  %bit_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %77, i32 0, i32 6, !dbg !2410
  store i64 %conv71, i64* %bit_rate, align 8, !dbg !2411
  %78 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2412
  %codecpar73 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %78, i32 0, i32 19, !dbg !2413
  %79 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar73, align 8, !dbg !2413
  %bits_per_coded_sample = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %79, i32 0, i32 7, !dbg !2414
  store i32 8, i32* %bits_per_coded_sample, align 8, !dbg !2415
  %80 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2416
  %codecpar74 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %80, i32 0, i32 19, !dbg !2417
  %81 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar74, align 8, !dbg !2417
  %channel_layout = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %81, i32 0, i32 21, !dbg !2418
  store i64 4, i64* %channel_layout, align 8, !dbg !2419
  %82 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2420
  %codecpar75 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %82, i32 0, i32 19, !dbg !2421
  %83 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar75, align 8, !dbg !2421
  %extradata_size = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %83, i32 0, i32 4, !dbg !2422
  store i32 0, i32* %extradata_size, align 8, !dbg !2423
  %84 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2424
  %85 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2425
  %codecpar76 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %85, i32 0, i32 19, !dbg !2426
  %86 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar76, align 8, !dbg !2426
  %block_align77 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %86, i32 0, i32 24, !dbg !2427
  %87 = load i32, i32* %block_align77, align 8, !dbg !2427
  call void @avpriv_set_pts_info(%struct.AVStream* %84, i32 64, i32 %87, i32 22050), !dbg !2428
  %88 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2429
  call void @avpriv_set_pts_info(%struct.AVStream* %88, i32 64, i32 1, i32 22050), !dbg !2430
  br label %if.end110, !dbg !2431

if.else:                                          ; preds = %if.end45
  %arrayidx78 = getelementptr inbounds [128 x i8], [128 x i8]* %header, i64 0, i64 16, !dbg !2432
  %89 = bitcast i8* %arrayidx78 to %union.unaligned_16*, !dbg !2435
  %l79 = bitcast %union.unaligned_16* %89 to i16*, !dbg !2435
  %90 = load i16, i16* %l79, align 16, !dbg !2435
  %conv80 = zext i16 %90 to i32, !dbg !2436
  %cmp81 = icmp eq i32 %conv80, 61946, !dbg !2437
  br i1 %cmp81, label %if.then83, label %if.else95, !dbg !2436

if.then83:                                        ; preds = %if.else
  %91 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2438
  call void @avpriv_set_pts_info(%struct.AVStream* %91, i32 64, i32 5, i32 70), !dbg !2440
  %92 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2441
  %call84 = call i64 @avio_seek(%struct.AVIOContext* %92, i64 12, i32 0), !dbg !2442
  %93 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2443
  %codecpar85 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %93, i32 0, i32 19, !dbg !2444
  %94 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar85, align 8, !dbg !2444
  %extradata86 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %94, i32 0, i32 3, !dbg !2445
  %95 = bitcast i8** %extradata86 to i8*, !dbg !2446
  call void @av_freep(i8* %95), !dbg !2447
  %96 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2448
  %codecpar87 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %96, i32 0, i32 19, !dbg !2450
  %97 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar87, align 8, !dbg !2450
  %call88 = call i32 @ff_alloc_extradata(%struct.AVCodecParameters* %97, i32 12), !dbg !2451
  %tobool89 = icmp ne i32 %call88, 0, !dbg !2451
  br i1 %tobool89, label %if.then90, label %if.end91, !dbg !2452
...
if.end91:                                         ; preds = %if.then83
  %98 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2454
  %codecpar92 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %98, i32 0, i32 19, !dbg !2455
  %99 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar92, align 8, !dbg !2455
  %extradata93 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %99, i32 0, i32 3, !dbg !2456
  %100 = load i8*, i8** %extradata93, align 8, !dbg !2456
  %arraydecay94 = getelementptr inbounds [128 x i8], [128 x i8]* %header, i32 0, i32 0, !dbg !2457
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %100, i8* %arraydecay94, i64 12, i32 1, i1 false), !dbg !2457
  br label %if.end109, !dbg !2458

if.else95:                                        ; preds = %if.else
  %101 = load i32, i32* %magic_number, align 4, !dbg !2459
  %cmp96 = icmp eq i32 %101, 44817, !dbg !2462
  br i1 %cmp96, label %if.then98, label %if.else99, !dbg !2459

if.then98:                                        ; preds = %if.else95
  %102 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2463
  %103 = load i32, i32* %speed, align 4, !dbg !2465
  call void @avpriv_set_pts_info(%struct.AVStream* %102, i32 64, i32 %103, i32 70), !dbg !2466
  br label %if.end108, !dbg !2467

if.else99:                                        ; preds = %if.else95
  %104 = load i32, i32* %magic_number, align 4, !dbg !2468
  %cmp100 = icmp eq i32 %104, 44818, !dbg !2471
  br i1 %cmp100, label %if.then105, label %lor.lhs.false102, !dbg !2472

lor.lhs.false102:                                 ; preds = %if.else99
  %105 = load i32, i32* %magic_number, align 4, !dbg !2473
  %cmp103 = icmp eq i32 %105, 44868, !dbg !2474
  br i1 %cmp103, label %if.then105, label %if.else106, !dbg !2475

if.then105:                                       ; preds = %lor.lhs.false102, %if.else99
  %106 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2477
  %107 = load i32, i32* %speed, align 4, !dbg !2479
  call void @avpriv_set_pts_info(%struct.AVStream* %106, i32 64, i32 %107, i32 1000), !dbg !2480
  br label %if.end107, !dbg !2481

if.else106:                                       ; preds = %lor.lhs.false102
  %108 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2482
  %109 = bitcast %struct.AVFormatContext* %108 to i8*, !dbg !2482
  call void (i8*, i32, i8*, ...) @av_log(i8* %109, i32 16, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.4, i32 0, i32 0)), !dbg !2484
...
if.end110:                                        ; preds = %if.end109, %if.end56
  store i32 0, i32* %retval, align 4, !dbg !2486
  br label %return, !dbg !2486

return:                                           ; preds = %if.end110, %if.else106, %if.then90, %if.then55, %if.then44, %if.then36, %if.then9, %if.then
  %110 = load i32, i32* %retval, align 4, !dbg !2487
  ret i32 %110, !dbg !2487
}

; Function Attrs: nounwind uwtable
define internal i32 @flic_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2488 {
entry:
  %s.addr.i52 = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i52, metadata !2491, metadata !2154), !dbg !2495
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2491, metadata !2154), !dbg !2501
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  %preamble = alloca [6 x i8], align 1
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2504, metadata !2154), !dbg !2505
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2506, metadata !2154), !dbg !2507
  call void @llvm.dbg.declare(metadata %struct.FlicDemuxContext** %flic, metadata !2508, metadata !2154), !dbg !2509
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2510
  %priv_data = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 3, !dbg !2511
  %1 = load i8*, i8** %priv_data, align 8, !dbg !2511
  %2 = bitcast i8* %1 to %struct.FlicDemuxContext*, !dbg !2510
  store %struct.FlicDemuxContext* %2, %struct.FlicDemuxContext** %flic, align 8, !dbg !2509
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2512, metadata !2154), !dbg !2513
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2514
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %3, i32 0, i32 4, !dbg !2515
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2515
  store %struct.AVIOContext* %4, %struct.AVIOContext** %pb, align 8, !dbg !2513
  call void @llvm.dbg.declare(metadata i32* %packet_read, metadata !2516, metadata !2154), !dbg !2517
  store i32 0, i32* %packet_read, align 4, !dbg !2517
  call void @llvm.dbg.declare(metadata i32* %size, metadata !2518, metadata !2154), !dbg !2519
  call void @llvm.dbg.declare(metadata i32* %magic, metadata !2520, metadata !2154), !dbg !2521
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2522, metadata !2154), !dbg !2523
  store i32 0, i32* %ret, align 4, !dbg !2523
  call void @llvm.dbg.declare(metadata [6 x i8]* %preamble, metadata !2524, metadata !2154), !dbg !2525
  br label %while.cond, !dbg !2526

while.cond:                                       ; preds = %if.end49, %entry
  %5 = load i32, i32* %packet_read, align 4, !dbg !2527
  %tobool = icmp ne i32 %5, 0, !dbg !2527
  br i1 %tobool, label %land.end, label %land.rhs, !dbg !2529

land.rhs:                                         ; preds = %while.cond
  %6 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2530
  %call = call i32 @avio_feof(%struct.AVIOContext* %6), !dbg !2532
  %tobool2 = icmp ne i32 %call, 0, !dbg !2533
  %lnot = xor i1 %tobool2, true, !dbg !2533
  br label %land.end

land.end:                                         ; preds = %land.rhs, %while.cond
  %7 = phi i1 [ false, %while.cond ], [ %lnot, %land.rhs ]
  br i1 %7, label %while.body, label %while.end, !dbg !2534

while.body:                                       ; preds = %land.end
  %8 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2536
  %arraydecay = getelementptr inbounds [6 x i8], [6 x i8]* %preamble, i32 0, i32 0, !dbg !2538
  %call3 = call i32 @avio_read(%struct.AVIOContext* %8, i8* %arraydecay, i32 6), !dbg !2539
  store i32 %call3, i32* %ret, align 4, !dbg !2540
  %cmp = icmp ne i32 %call3, 6, !dbg !2541
  br i1 %cmp, label %if.then, label %if.end, !dbg !2542

if.then:                                          ; preds = %while.body
  store i32 -5, i32* %ret, align 4, !dbg !2543
  br label %while.end, !dbg !2545

if.end:                                           ; preds = %while.body
  %arrayidx = getelementptr inbounds [6 x i8], [6 x i8]* %preamble, i64 0, i64 0, !dbg !2546
  %9 = bitcast i8* %arrayidx to %union.unaligned_32*, !dbg !2547
  %l = bitcast %union.unaligned_32* %9 to i32*, !dbg !2547
  %10 = load i32, i32* %l, align 1, !dbg !2547
  store i32 %10, i32* %size, align 4, !dbg !2548
  %arrayidx4 = getelementptr inbounds [6 x i8], [6 x i8]* %preamble, i64 0, i64 4, !dbg !2549
  %11 = bitcast i8* %arrayidx4 to %union.unaligned_16*, !dbg !2550
  %l5 = bitcast %union.unaligned_16* %11 to i16*, !dbg !2550
  %12 = load i16, i16* %l5, align 1, !dbg !2550
  %conv = zext i16 %12 to i32, !dbg !2551
  store i32 %conv, i32* %magic, align 4, !dbg !2552
  %13 = load i32, i32* %magic, align 4, !dbg !2553
  %cmp6 = icmp eq i32 %13, 61946, !dbg !2554
  br i1 %cmp6, label %land.lhs.true, label %lor.lhs.false, !dbg !2555

lor.lhs.false:                                    ; preds = %if.end
  %14 = load i32, i32* %magic, align 4, !dbg !2556
  %cmp8 = icmp eq i32 %14, 62970, !dbg !2558
  br i1 %cmp8, label %land.lhs.true, label %if.else, !dbg !2559

land.lhs.true:                                    ; preds = %lor.lhs.false, %if.end
  %15 = load i32, i32* %size, align 4, !dbg !2560
  %cmp10 = icmp ugt i32 %15, 6, !dbg !2562
  br i1 %cmp10, label %if.then12, label %if.else, !dbg !2563

if.then12:                                        ; preds = %land.lhs.true
  %16 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2564
  %17 = load i32, i32* %size, align 4, !dbg !2566
  %call13 = call i32 @av_new_packet(%struct.AVPacket* %16, i32 %17), !dbg !2567
  %tobool14 = icmp ne i32 %call13, 0, !dbg !2567
  br i1 %tobool14, label %if.then15, label %if.end16, !dbg !2568

if.then15:                                        ; preds = %if.then12
  store i32 -5, i32* %ret, align 4, !dbg !2569
  br label %while.end, !dbg !2571

if.end16:                                         ; preds = %if.then12
  %18 = load %struct.FlicDemuxContext*, %struct.FlicDemuxContext** %flic, align 8, !dbg !2572
  %video_stream_index = getelementptr inbounds %struct.FlicDemuxContext, %struct.FlicDemuxContext* %18, i32 0, i32 0, !dbg !2573
  %19 = load i32, i32* %video_stream_index, align 4, !dbg !2573
  %20 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2574
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %20, i32 0, i32 5, !dbg !2575
  store i32 %19, i32* %stream_index, align 4, !dbg !2576
  %21 = load %struct.FlicDemuxContext*, %struct.FlicDemuxContext** %flic, align 8, !dbg !2577
  %frame_number = getelementptr inbounds %struct.FlicDemuxContext, %struct.FlicDemuxContext* %21, i32 0, i32 2, !dbg !2578
  %22 = load i32, i32* %frame_number, align 4, !dbg !2579
  %inc = add nsw i32 %22, 1, !dbg !2579
  store i32 %inc, i32* %frame_number, align 4, !dbg !2579
  %conv17 = sext i32 %22 to i64, !dbg !2577
  %23 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2580
  %pts = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %23, i32 0, i32 1, !dbg !2581
  store i64 %conv17, i64* %pts, align 8, !dbg !2582
  %24 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2583
  store %struct.AVIOContext* %24, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2584
  %25 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2585
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %25, i64 0, i32 1) #4, !dbg !2586
  %26 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2587
  %pos = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %26, i32 0, i32 10, !dbg !2588
  store i64 %call.i, i64* %pos, align 8, !dbg !2589
  %27 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2590
  %data = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %27, i32 0, i32 3, !dbg !2591
  %28 = load i8*, i8** %data, align 8, !dbg !2591
  %arraydecay19 = getelementptr inbounds [6 x i8], [6 x i8]* %preamble, i32 0, i32 0, !dbg !2592
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %28, i8* %arraydecay19, i64 6, i32 1, i1 false), !dbg !2592
  %29 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2593
  %30 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2594
  %data20 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %30, i32 0, i32 3, !dbg !2595
  %31 = load i8*, i8** %data20, align 8, !dbg !2595
  %add.ptr = getelementptr inbounds i8, i8* %31, i64 6, !dbg !2596
  %32 = load i32, i32* %size, align 4, !dbg !2597
  %sub = sub i32 %32, 6, !dbg !2598
  %call21 = call i32 @avio_read(%struct.AVIOContext* %29, i8* %add.ptr, i32 %sub), !dbg !2599
  store i32 %call21, i32* %ret, align 4, !dbg !2600
  %33 = load i32, i32* %ret, align 4, !dbg !2601
  %34 = load i32, i32* %size, align 4, !dbg !2603
  %sub22 = sub i32 %34, 6, !dbg !2604
  %cmp23 = icmp ne i32 %33, %sub22, !dbg !2605
  br i1 %cmp23, label %if.then25, label %if.end26, !dbg !2606

if.then25:                                        ; preds = %if.end16
  %35 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2607
  call void @av_packet_unref(%struct.AVPacket* %35), !dbg !2609
  store i32 -5, i32* %ret, align 4, !dbg !2610
  br label %if.end26, !dbg !2611

if.end26:                                         ; preds = %if.then25, %if.end16
  store i32 1, i32* %packet_read, align 4, !dbg !2612
  br label %if.end49, !dbg !2613

if.else:                                          ; preds = %land.lhs.true, %lor.lhs.false
  %36 = load i32, i32* %magic, align 4, !dbg !2614
  %cmp27 = icmp eq i32 %36, 43690, !dbg !2616
  br i1 %cmp27, label %if.then29, label %if.else44, !dbg !2614

if.then29:                                        ; preds = %if.else
  %37 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2617
  %38 = load i32, i32* %size, align 4, !dbg !2619
  %call30 = call i32 @av_new_packet(%struct.AVPacket* %37, i32 %38), !dbg !2620
  %tobool31 = icmp ne i32 %call30, 0, !dbg !2620
  br i1 %tobool31, label %if.then32, label %if.end33, !dbg !2621

if.then32:                                        ; preds = %if.then29
  store i32 -5, i32* %ret, align 4, !dbg !2622
  br label %while.end, !dbg !2624

if.end33:                                         ; preds = %if.then29
  %39 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2625
  %call34 = call i64 @avio_skip(%struct.AVIOContext* %39, i64 10), !dbg !2626
  %40 = load %struct.FlicDemuxContext*, %struct.FlicDemuxContext** %flic, align 8, !dbg !2627
  %audio_stream_index = getelementptr inbounds %struct.FlicDemuxContext, %struct.FlicDemuxContext* %40, i32 0, i32 1, !dbg !2628
  %41 = load i32, i32* %audio_stream_index, align 4, !dbg !2628
  %42 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2629
  %stream_index35 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %42, i32 0, i32 5, !dbg !2630
  store i32 %41, i32* %stream_index35, align 4, !dbg !2631
  %43 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2632
  store %struct.AVIOContext* %43, %struct.AVIOContext** %s.addr.i52, align 8, !dbg !2633
  %44 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i52, align 8, !dbg !2634
  %call.i53 = call i64 @avio_seek(%struct.AVIOContext* %44, i64 0, i32 1) #4, !dbg !2635
  %45 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2636
  %pos37 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %45, i32 0, i32 10, !dbg !2637
  store i64 %call.i53, i64* %pos37, align 8, !dbg !2638
  %46 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2639
  %47 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2640
  %data38 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %47, i32 0, i32 3, !dbg !2641
  %48 = load i8*, i8** %data38, align 8, !dbg !2641
  %49 = load i32, i32* %size, align 4, !dbg !2642
  %call39 = call i32 @avio_read(%struct.AVIOContext* %46, i8* %48, i32 %49), !dbg !2643
  store i32 %call39, i32* %ret, align 4, !dbg !2644
  %50 = load i32, i32* %ret, align 4, !dbg !2645
  %51 = load i32, i32* %size, align 4, !dbg !2647
  %cmp40 = icmp ne i32 %50, %51, !dbg !2648
  br i1 %cmp40, label %if.then42, label %if.end43, !dbg !2649

if.then42:                                        ; preds = %if.end33
  %52 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2650
  call void @av_packet_unref(%struct.AVPacket* %52), !dbg !2652
  store i32 -5, i32* %ret, align 4, !dbg !2653
  br label %if.end43, !dbg !2654

if.end43:                                         ; preds = %if.then42, %if.end33
  store i32 1, i32* %packet_read, align 4, !dbg !2655
  br label %if.end48, !dbg !2656

if.else44:                                        ; preds = %if.else
  %53 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2657
  %54 = load i32, i32* %size, align 4, !dbg !2659
  %sub45 = sub i32 %54, 6, !dbg !2660
  %conv46 = zext i32 %sub45 to i64, !dbg !2659
  %call47 = call i64 @avio_skip(%struct.AVIOContext* %53, i64 %conv46), !dbg !2661
  br label %if.end48
...
if.end49:                                         ; preds = %if.end48, %if.end26
  br label %while.cond, !dbg !2662, !llvm.loop !2664

while.end:                                        ; preds = %if.then32, %if.then15, %if.then, %land.end
  %55 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2665
  %call50 = call i32 @avio_feof(%struct.AVIOContext* %55), !dbg !2666
  %tobool51 = icmp ne i32 %call50, 0, !dbg !2666
  br i1 %tobool51, label %cond.true, label %cond.false, !dbg !2666

cond.true:                                        ; preds = %while.end
  br label %cond.end, !dbg !2667

cond.false:                                       ; preds = %while.end
  %56 = load i32, i32* %ret, align 4, !dbg !2668
  br label %cond.end, !dbg !2669

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ -541478725, %cond.true ], [ %56, %cond.false ], !dbg !2670
  ret i32 %cond, !dbg !2671
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--flic.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!934 = !{!935}
!935 = distinct !DIGlobalVariable(name: "ff_flic_demuxer", scope: !0, file: !936, line: 262, type: !937, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_flic_demuxer)
!936 = !DIFile(filename: "libavformat/flic.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2151 = distinct !DISubprogram(name: "flic_probe", scope: !936, file: !936, line: 60, type: !1006, isLocal: true, isDefinition: true, scopeLine: 61, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2152 = !{}
!2153 = !DILocalVariable(name: "p", arg: 1, scope: !2151, file: !936, line: 60, type: !1008)
!2154 = !DIExpression()
!2155 = !DILocation(line: 60, column: 36, scope: !2151)
!2156 = !DILocalVariable(name: "magic_number", scope: !2151, file: !936, line: 62, type: !933)
!2157 = !DILocation(line: 62, column: 9, scope: !2151)
!2158 = !DILocation(line: 64, column: 8, scope: !2159)
!2159 = distinct !DILexicalBlock(scope: !2151, file: !936, line: 64, column: 8)
!2160 = !DILocation(line: 64, column: 11, scope: !2159)
!2161 = !DILocation(line: 64, column: 20, scope: !2159)
!2162 = !DILocation(line: 64, column: 8, scope: !2151)
!2163 = !DILocation(line: 65, column: 9, scope: !2159)
!2164 = !DILocation(line: 67, column: 53, scope: !2151)
!2165 = !DILocation(line: 67, column: 56, scope: !2151)
!2166 = !DILocation(line: 67, column: 66, scope: !2151)
!2167 = !DILocation(line: 67, column: 20, scope: !2151)
!2168 = !DILocation(line: 67, column: 18, scope: !2151)
!2169 = !DILocation(line: 68, column: 10, scope: !2170)
!2170 = distinct !DILexicalBlock(scope: !2151, file: !936, line: 68, column: 9)
!2171 = !DILocation(line: 68, column: 23, scope: !2170)
!2172 = !DILocation(line: 68, column: 34, scope: !2170)
!2173 = !DILocation(line: 69, column: 10, scope: !2170)
!2174 = !DILocation(line: 69, column: 23, scope: !2170)
!2175 = !DILocation(line: 69, column: 34, scope: !2170)
!2176 = !DILocation(line: 70, column: 10, scope: !2170)
!2177 = !DILocation(line: 70, column: 23, scope: !2170)
!2178 = !DILocation(line: 68, column: 9, scope: !2179)
!2179 = !DILexicalBlockFile(scope: !2151, file: !936, discriminator: 1)
!2180 = !DILocation(line: 71, column: 9, scope: !2170)
!2181 = !DILocation(line: 73, column: 41, scope: !2182)
!2182 = distinct !DILexicalBlock(scope: !2151, file: !936, line: 73, column: 8)
!2183 = !DILocation(line: 73, column: 44, scope: !2182)
!2184 = !DILocation(line: 73, column: 57, scope: !2182)
!2185 = !DILocation(line: 73, column: 8, scope: !2182)
!2186 = !DILocation(line: 73, column: 60, scope: !2182)
!2187 = !DILocation(line: 73, column: 8, scope: !2151)
!2188 = !DILocation(line: 74, column: 45, scope: !2189)
!2189 = distinct !DILexicalBlock(scope: !2190, file: !936, line: 74, column: 12)
!2190 = distinct !DILexicalBlock(scope: !2182, file: !936, line: 73, column: 70)
!2191 = !DILocation(line: 74, column: 48, scope: !2189)
!2192 = !DILocation(line: 74, column: 61, scope: !2189)
!2193 = !DILocation(line: 74, column: 64, scope: !2189)
!2194 = !DILocation(line: 74, column: 12, scope: !2190)
!2195 = !DILocation(line: 75, column: 13, scope: !2189)
!2196 = !DILocation(line: 76, column: 5, scope: !2190)
!2197 = !DILocation(line: 78, column: 42, scope: !2198)
!2198 = distinct !DILexicalBlock(scope: !2151, file: !936, line: 78, column: 9)
!2199 = !DILocation(line: 78, column: 45, scope: !2198)
!2200 = !DILocation(line: 78, column: 58, scope: !2198)
!2201 = !DILocation(line: 78, column: 9, scope: !2198)
!2202 = !DILocation(line: 78, column: 61, scope: !2198)
!2203 = !DILocation(line: 79, column: 8, scope: !2198)
!2204 = !DILocation(line: 79, column: 44, scope: !2205)
!2205 = !DILexicalBlockFile(scope: !2198, file: !936, discriminator: 1)
!2206 = !DILocation(line: 79, column: 47, scope: !2205)
!2207 = !DILocation(line: 79, column: 60, scope: !2205)
!2208 = !DILocation(line: 79, column: 11, scope: !2205)
!2209 = !DILocation(line: 79, column: 63, scope: !2205)
!2210 = !DILocation(line: 78, column: 9, scope: !2179)
!2211 = !DILocation(line: 80, column: 9, scope: !2198)
!2212 = !DILocation(line: 83, column: 5, scope: !2151)
!2213 = !DILocation(line: 84, column: 1, scope: !2151)
!2214 = distinct !DISubprogram(name: "flic_read_header", scope: !936, file: !936, line: 86, type: !2215, isLocal: true, isDefinition: true, scopeLine: 87, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2215 = !DISubroutineType(types: !2216)
!2216 = !{!933, !2217}
!2217 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2218, size: 64, align: 64)
!2218 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1023)
!2219 = !DILocalVariable(name: "s", arg: 1, scope: !2214, file: !936, line: 86, type: !2217)
!2220 = !DILocation(line: 86, column: 46, scope: !2214)
!2221 = !DILocalVariable(name: "flic", scope: !2214, file: !936, line: 88, type: !2222)
!2222 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2223, size: 64, align: 64)
!2223 = !DIDerivedType(tag: DW_TAG_typedef, name: "FlicDemuxContext", file: !936, line: 58, baseType: !2224)
!2224 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "FlicDemuxContext", file: !936, line: 54, size: 96, align: 32, elements: !2225)
!2225 = !{!2226, !2227, !2228}
!2226 = !DIDerivedType(tag: DW_TAG_member, name: "video_stream_index", scope: !2224, file: !936, line: 55, baseType: !933, size: 32, align: 32)
!2227 = !DIDerivedType(tag: DW_TAG_member, name: "audio_stream_index", scope: !2224, file: !936, line: 56, baseType: !933, size: 32, align: 32, offset: 32)
!2228 = !DIDerivedType(tag: DW_TAG_member, name: "frame_number", scope: !2224, file: !936, line: 57, baseType: !933, size: 32, align: 32, offset: 64)
!2229 = !DILocation(line: 88, column: 23, scope: !2214)
!2230 = !DILocation(line: 88, column: 30, scope: !2214)
!2231 = !DILocation(line: 88, column: 33, scope: !2214)
!2232 = !DILocalVariable(name: "pb", scope: !2214, file: !936, line: 89, type: !1229)
!2233 = !DILocation(line: 89, column: 18, scope: !2214)
!2234 = !DILocation(line: 89, column: 23, scope: !2214)
!2235 = !DILocation(line: 89, column: 26, scope: !2214)
!2236 = !DILocalVariable(name: "header", scope: !2214, file: !936, line: 90, type: !2237)
!2237 = !DICompositeType(tag: DW_TAG_array_type, baseType: !1015, size: 1024, align: 8, elements: !2238)
!2238 = !{!2239}
!2239 = !DISubrange(count: 128)
!2240 = !DILocation(line: 90, column: 19, scope: !2214)
!2241 = !DILocalVariable(name: "st", scope: !2214, file: !936, line: 91, type: !1297)
!2242 = !DILocation(line: 91, column: 15, scope: !2214)
!2243 = !DILocalVariable(name: "ast", scope: !2214, file: !936, line: 91, type: !1297)
!2244 = !DILocation(line: 91, column: 20, scope: !2214)
!2245 = !DILocalVariable(name: "speed", scope: !2214, file: !936, line: 92, type: !933)
!2246 = !DILocation(line: 92, column: 9, scope: !2214)
!2247 = !DILocalVariable(name: "magic_number", scope: !2214, file: !936, line: 93, type: !933)
!2248 = !DILocation(line: 93, column: 9, scope: !2214)
!2249 = !DILocalVariable(name: "preamble", scope: !2214, file: !936, line: 94, type: !2250)
!2250 = !DICompositeType(tag: DW_TAG_array_type, baseType: !1015, size: 48, align: 8, elements: !2251)
!2251 = !{!2252}
!2252 = !DISubrange(count: 6)
!2253 = !DILocation(line: 94, column: 19, scope: !2214)
!2254 = !DILocation(line: 96, column: 5, scope: !2214)
!2255 = !DILocation(line: 96, column: 11, scope: !2214)
!2256 = !DILocation(line: 96, column: 24, scope: !2214)
!2257 = !DILocation(line: 99, column: 19, scope: !2258)
!2258 = distinct !DILexicalBlock(scope: !2214, file: !936, line: 99, column: 9)
!2259 = !DILocation(line: 99, column: 23, scope: !2258)
!2260 = !DILocation(line: 99, column: 9, scope: !2258)
!2261 = !DILocation(line: 99, column: 36, scope: !2258)
!2262 = !DILocation(line: 99, column: 9, scope: !2214)
!2263 = !DILocation(line: 100, column: 9, scope: !2258)
!2264 = !DILocation(line: 102, column: 53, scope: !2214)
!2265 = !DILocation(line: 102, column: 66, scope: !2214)
!2266 = !DILocation(line: 102, column: 20, scope: !2214)
!2267 = !DILocation(line: 102, column: 18, scope: !2214)
!2268 = !DILocation(line: 103, column: 46, scope: !2214)
!2269 = !DILocation(line: 103, column: 62, scope: !2214)
!2270 = !DILocation(line: 103, column: 11, scope: !2214)
!2271 = !DILocation(line: 104, column: 9, scope: !2272)
!2272 = distinct !DILexicalBlock(scope: !2214, file: !936, line: 104, column: 9)
!2273 = !DILocation(line: 104, column: 15, scope: !2272)
!2274 = !DILocation(line: 104, column: 9, scope: !2214)
!2275 = !DILocation(line: 105, column: 15, scope: !2272)
!2276 = !DILocation(line: 105, column: 9, scope: !2272)
!2277 = !DILocation(line: 108, column: 30, scope: !2214)
!2278 = !DILocation(line: 108, column: 10, scope: !2214)
!2279 = !DILocation(line: 108, column: 8, scope: !2214)
!2280 = !DILocation(line: 109, column: 10, scope: !2281)
!2281 = distinct !DILexicalBlock(scope: !2214, file: !936, line: 109, column: 9)
!2282 = !DILocation(line: 109, column: 9, scope: !2214)
!2283 = !DILocation(line: 110, column: 9, scope: !2281)
!2284 = !DILocation(line: 111, column: 32, scope: !2214)
!2285 = !DILocation(line: 111, column: 36, scope: !2214)
!2286 = !DILocation(line: 111, column: 5, scope: !2214)
!2287 = !DILocation(line: 111, column: 11, scope: !2214)
!2288 = !DILocation(line: 111, column: 30, scope: !2214)
!2289 = !DILocation(line: 112, column: 5, scope: !2214)
!2290 = !DILocation(line: 112, column: 9, scope: !2214)
!2291 = !DILocation(line: 112, column: 19, scope: !2214)
!2292 = !DILocation(line: 112, column: 30, scope: !2214)
!2293 = !DILocation(line: 113, column: 5, scope: !2214)
!2294 = !DILocation(line: 113, column: 9, scope: !2214)
!2295 = !DILocation(line: 113, column: 19, scope: !2214)
!2296 = !DILocation(line: 113, column: 28, scope: !2214)
!2297 = !DILocation(line: 114, column: 5, scope: !2214)
!2298 = !DILocation(line: 114, column: 9, scope: !2214)
!2299 = !DILocation(line: 114, column: 19, scope: !2214)
!2300 = !DILocation(line: 114, column: 29, scope: !2214)
!2301 = !DILocation(line: 115, column: 60, scope: !2214)
!2302 = !DILocation(line: 115, column: 76, scope: !2214)
!2303 = !DILocation(line: 115, column: 27, scope: !2214)
!2304 = !DILocation(line: 115, column: 5, scope: !2214)
!2305 = !DILocation(line: 115, column: 9, scope: !2214)
!2306 = !DILocation(line: 115, column: 19, scope: !2214)
!2307 = !DILocation(line: 115, column: 25, scope: !2214)
!2308 = !DILocation(line: 116, column: 61, scope: !2214)
!2309 = !DILocation(line: 116, column: 77, scope: !2214)
!2310 = !DILocation(line: 116, column: 28, scope: !2214)
!2311 = !DILocation(line: 116, column: 5, scope: !2214)
!2312 = !DILocation(line: 116, column: 9, scope: !2214)
!2313 = !DILocation(line: 116, column: 19, scope: !2214)
!2314 = !DILocation(line: 116, column: 26, scope: !2214)
!2315 = !DILocation(line: 118, column: 10, scope: !2316)
!2316 = distinct !DILexicalBlock(scope: !2214, file: !936, line: 118, column: 9)
!2317 = !DILocation(line: 118, column: 14, scope: !2316)
!2318 = !DILocation(line: 118, column: 24, scope: !2316)
!2319 = !DILocation(line: 118, column: 30, scope: !2316)
!2320 = !DILocation(line: 118, column: 34, scope: !2321)
!2321 = !DILexicalBlockFile(scope: !2316, file: !936, discriminator: 1)
!2322 = !DILocation(line: 118, column: 38, scope: !2321)
!2323 = !DILocation(line: 118, column: 48, scope: !2321)
!2324 = !DILocation(line: 118, column: 9, scope: !2321)
!2325 = !DILocation(line: 121, column: 16, scope: !2326)
!2326 = distinct !DILexicalBlock(scope: !2316, file: !936, line: 118, column: 56)
!2327 = !DILocation(line: 121, column: 9, scope: !2326)
!2328 = !DILocation(line: 123, column: 9, scope: !2326)
!2329 = !DILocation(line: 123, column: 13, scope: !2326)
!2330 = !DILocation(line: 123, column: 23, scope: !2326)
!2331 = !DILocation(line: 123, column: 29, scope: !2326)
!2332 = !DILocation(line: 124, column: 9, scope: !2326)
!2333 = !DILocation(line: 124, column: 13, scope: !2326)
!2334 = !DILocation(line: 124, column: 23, scope: !2326)
!2335 = !DILocation(line: 124, column: 30, scope: !2326)
!2336 = !DILocation(line: 125, column: 5, scope: !2326)
!2337 = !DILocation(line: 128, column: 28, scope: !2338)
!2338 = distinct !DILexicalBlock(scope: !2214, file: !936, line: 128, column: 9)
!2339 = !DILocation(line: 128, column: 32, scope: !2338)
!2340 = !DILocation(line: 128, column: 9, scope: !2338)
!2341 = !DILocation(line: 128, column: 9, scope: !2214)
!2342 = !DILocation(line: 129, column: 9, scope: !2338)
!2343 = !DILocation(line: 130, column: 12, scope: !2214)
!2344 = !DILocation(line: 130, column: 16, scope: !2214)
!2345 = !DILocation(line: 130, column: 26, scope: !2214)
!2346 = !DILocation(line: 130, column: 5, scope: !2214)
!2347 = !DILocation(line: 133, column: 19, scope: !2348)
!2348 = distinct !DILexicalBlock(scope: !2214, file: !936, line: 133, column: 9)
!2349 = !DILocation(line: 133, column: 23, scope: !2348)
!2350 = !DILocation(line: 133, column: 9, scope: !2348)
!2351 = !DILocation(line: 133, column: 36, scope: !2348)
!2352 = !DILocation(line: 133, column: 9, scope: !2214)
!2353 = !DILocation(line: 134, column: 16, scope: !2354)
!2354 = distinct !DILexicalBlock(scope: !2348, file: !936, line: 133, column: 42)
!2355 = !DILocation(line: 134, column: 9, scope: !2354)
!2356 = !DILocation(line: 135, column: 9, scope: !2354)
!2357 = !DILocation(line: 138, column: 15, scope: !2214)
!2358 = !DILocation(line: 138, column: 5, scope: !2214)
!2359 = !DILocation(line: 146, column: 42, scope: !2360)
!2360 = distinct !DILexicalBlock(scope: !2214, file: !936, line: 146, column: 9)
!2361 = !DILocation(line: 146, column: 57, scope: !2360)
!2362 = !DILocation(line: 146, column: 9, scope: !2360)
!2363 = !DILocation(line: 146, column: 60, scope: !2360)
!2364 = !DILocation(line: 146, column: 9, scope: !2214)
!2365 = !DILocation(line: 148, column: 35, scope: !2366)
!2366 = distinct !DILexicalBlock(scope: !2360, file: !936, line: 146, column: 71)
!2367 = !DILocation(line: 148, column: 15, scope: !2366)
!2368 = !DILocation(line: 148, column: 13, scope: !2366)
!2369 = !DILocation(line: 149, column: 14, scope: !2370)
!2370 = distinct !DILexicalBlock(scope: !2366, file: !936, line: 149, column: 13)
!2371 = !DILocation(line: 149, column: 13, scope: !2366)
!2372 = !DILocation(line: 150, column: 13, scope: !2370)
!2373 = !DILocation(line: 152, column: 36, scope: !2366)
!2374 = !DILocation(line: 152, column: 41, scope: !2366)
!2375 = !DILocation(line: 152, column: 9, scope: !2366)
!2376 = !DILocation(line: 152, column: 15, scope: !2366)
!2377 = !DILocation(line: 152, column: 34, scope: !2366)
!2378 = !DILocation(line: 155, column: 71, scope: !2366)
!2379 = !DILocation(line: 155, column: 86, scope: !2366)
!2380 = !DILocation(line: 155, column: 9, scope: !2366)
!2381 = !DILocation(line: 155, column: 14, scope: !2366)
!2382 = !DILocation(line: 155, column: 24, scope: !2366)
!2383 = !DILocation(line: 155, column: 36, scope: !2366)
!2384 = !DILocation(line: 156, column: 9, scope: !2366)
!2385 = !DILocation(line: 156, column: 14, scope: !2366)
!2386 = !DILocation(line: 156, column: 24, scope: !2366)
!2387 = !DILocation(line: 156, column: 35, scope: !2366)
!2388 = !DILocation(line: 157, column: 9, scope: !2366)
!2389 = !DILocation(line: 157, column: 14, scope: !2366)
!2390 = !DILocation(line: 157, column: 24, scope: !2366)
!2391 = !DILocation(line: 157, column: 33, scope: !2366)
!2392 = !DILocation(line: 158, column: 9, scope: !2366)
!2393 = !DILocation(line: 158, column: 14, scope: !2366)
!2394 = !DILocation(line: 158, column: 24, scope: !2366)
!2395 = !DILocation(line: 158, column: 34, scope: !2366)
!2396 = !DILocation(line: 159, column: 9, scope: !2366)
!2397 = !DILocation(line: 159, column: 14, scope: !2366)
!2398 = !DILocation(line: 159, column: 24, scope: !2366)
!2399 = !DILocation(line: 159, column: 36, scope: !2366)
!2400 = !DILocation(line: 160, column: 9, scope: !2366)
!2401 = !DILocation(line: 160, column: 14, scope: !2366)
!2402 = !DILocation(line: 160, column: 24, scope: !2366)
!2403 = !DILocation(line: 160, column: 33, scope: !2366)
!2404 = !DILocation(line: 161, column: 35, scope: !2366)
!2405 = !DILocation(line: 161, column: 39, scope: !2366)
!2406 = !DILocation(line: 161, column: 49, scope: !2366)
!2407 = !DILocation(line: 161, column: 61, scope: !2366)
!2408 = !DILocation(line: 161, column: 9, scope: !2366)
!2409 = !DILocation(line: 161, column: 14, scope: !2366)
!2410 = !DILocation(line: 161, column: 24, scope: !2366)
!2411 = !DILocation(line: 161, column: 33, scope: !2366)
!2412 = !DILocation(line: 162, column: 9, scope: !2366)
!2413 = !DILocation(line: 162, column: 14, scope: !2366)
!2414 = !DILocation(line: 162, column: 24, scope: !2366)
!2415 = !DILocation(line: 162, column: 46, scope: !2366)
!2416 = !DILocation(line: 163, column: 9, scope: !2366)
!2417 = !DILocation(line: 163, column: 14, scope: !2366)
!2418 = !DILocation(line: 163, column: 24, scope: !2366)
!2419 = !DILocation(line: 163, column: 39, scope: !2366)
!2420 = !DILocation(line: 164, column: 9, scope: !2366)
!2421 = !DILocation(line: 164, column: 14, scope: !2366)
!2422 = !DILocation(line: 164, column: 24, scope: !2366)
!2423 = !DILocation(line: 164, column: 39, scope: !2366)
!2424 = !DILocation(line: 169, column: 29, scope: !2366)
!2425 = !DILocation(line: 169, column: 37, scope: !2366)
!2426 = !DILocation(line: 169, column: 42, scope: !2366)
!2427 = !DILocation(line: 169, column: 52, scope: !2366)
!2428 = !DILocation(line: 169, column: 9, scope: !2366)
!2429 = !DILocation(line: 170, column: 29, scope: !2366)
!2430 = !DILocation(line: 170, column: 9, scope: !2366)
!2431 = !DILocation(line: 171, column: 5, scope: !2366)
!2432 = !DILocation(line: 171, column: 49, scope: !2433)
!2433 = !DILexicalBlockFile(scope: !2434, file: !936, discriminator: 1)
!2434 = distinct !DILexicalBlock(scope: !2360, file: !936, line: 171, column: 16)
!2435 = !DILocation(line: 171, column: 65, scope: !2433)
!2436 = !DILocation(line: 171, column: 16, scope: !2433)
!2437 = !DILocation(line: 171, column: 68, scope: !2433)
!2438 = !DILocation(line: 172, column: 29, scope: !2439)
!2439 = distinct !DILexicalBlock(scope: !2434, file: !936, line: 171, column: 79)
!2440 = !DILocation(line: 172, column: 9, scope: !2439)
!2441 = !DILocation(line: 175, column: 19, scope: !2439)
!2442 = !DILocation(line: 175, column: 9, scope: !2439)
!2443 = !DILocation(line: 178, column: 19, scope: !2439)
!2444 = !DILocation(line: 178, column: 23, scope: !2439)
!2445 = !DILocation(line: 178, column: 33, scope: !2439)
!2446 = !DILocation(line: 178, column: 18, scope: !2439)
!2447 = !DILocation(line: 178, column: 9, scope: !2439)
!2448 = !DILocation(line: 179, column: 32, scope: !2449)
!2449 = distinct !DILexicalBlock(scope: !2439, file: !936, line: 179, column: 13)
!2450 = !DILocation(line: 179, column: 36, scope: !2449)
!2451 = !DILocation(line: 179, column: 13, scope: !2449)
!2452 = !DILocation(line: 179, column: 13, scope: !2439)
!2453 = !DILocation(line: 180, column: 13, scope: !2449)
!2454 = !DILocation(line: 181, column: 16, scope: !2439)
!2455 = !DILocation(line: 181, column: 20, scope: !2439)
!2456 = !DILocation(line: 181, column: 30, scope: !2439)
!2457 = !DILocation(line: 181, column: 9, scope: !2439)
!2458 = !DILocation(line: 183, column: 5, scope: !2439)
!2459 = !DILocation(line: 183, column: 16, scope: !2460)
!2460 = !DILexicalBlockFile(scope: !2461, file: !936, discriminator: 1)
!2461 = distinct !DILexicalBlock(scope: !2434, file: !936, line: 183, column: 16)
!2462 = !DILocation(line: 183, column: 29, scope: !2460)
!2463 = !DILocation(line: 184, column: 29, scope: !2464)
!2464 = distinct !DILexicalBlock(scope: !2461, file: !936, line: 183, column: 40)
!2465 = !DILocation(line: 184, column: 37, scope: !2464)
!2466 = !DILocation(line: 184, column: 9, scope: !2464)
!2467 = !DILocation(line: 185, column: 5, scope: !2464)
!2468 = !DILocation(line: 185, column: 17, scope: !2469)
!2469 = !DILexicalBlockFile(scope: !2470, file: !936, discriminator: 1)
!2470 = distinct !DILexicalBlock(scope: !2461, file: !936, line: 185, column: 16)
!2471 = !DILocation(line: 185, column: 30, scope: !2469)
!2472 = !DILocation(line: 185, column: 41, scope: !2469)
!2473 = !DILocation(line: 186, column: 17, scope: !2470)
!2474 = !DILocation(line: 186, column: 30, scope: !2470)
!2475 = !DILocation(line: 185, column: 16, scope: !2476)
!2476 = !DILexicalBlockFile(scope: !2461, file: !936, discriminator: 2)
!2477 = !DILocation(line: 187, column: 29, scope: !2478)
!2478 = distinct !DILexicalBlock(scope: !2470, file: !936, line: 186, column: 42)
!2479 = !DILocation(line: 187, column: 37, scope: !2478)
!2480 = !DILocation(line: 187, column: 9, scope: !2478)
!2481 = !DILocation(line: 188, column: 5, scope: !2478)
!2482 = !DILocation(line: 189, column: 16, scope: !2483)
!2483 = distinct !DILexicalBlock(scope: !2470, file: !936, line: 188, column: 12)
!2484 = !DILocation(line: 189, column: 9, scope: !2483)
!2485 = !DILocation(line: 190, column: 9, scope: !2483)
!2486 = !DILocation(line: 193, column: 5, scope: !2214)
!2487 = !DILocation(line: 194, column: 1, scope: !2214)
!2488 = distinct !DISubprogram(name: "flic_read_packet", scope: !936, file: !936, line: 196, type: !2489, isLocal: true, isDefinition: true, scopeLine: 198, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2489 = !DISubroutineType(types: !2490)
!2490 = !{!933, !2217, !1048}
!2491 = !DILocalVariable(name: "s", arg: 1, scope: !2492, file: !628, line: 557, type: !1229)
!2492 = distinct !DISubprogram(name: "avio_tell", scope: !628, file: !628, line: 557, type: !2493, isLocal: true, isDefinition: true, scopeLine: 558, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2493 = !DISubroutineType(types: !2494)
!2494 = !{!1067, !1229}
!2495 = !DILocation(line: 557, column: 77, scope: !2492, inlinedAt: !2496)
!2496 = distinct !DILocation(line: 244, column: 24, scope: !2497)
!2497 = distinct !DILexicalBlock(scope: !2498, file: !936, line: 234, column: 37)
!2498 = distinct !DILexicalBlock(scope: !2499, file: !936, line: 234, column: 20)
!2499 = distinct !DILexicalBlock(scope: !2500, file: !936, line: 218, column: 13)
!2500 = distinct !DILexicalBlock(scope: !2488, file: !936, line: 207, column: 44)
!2501 = !DILocation(line: 557, column: 77, scope: !2492, inlinedAt: !2502)
!2502 = distinct !DILocation(line: 225, column: 24, scope: !2503)
!2503 = distinct !DILexicalBlock(scope: !2499, file: !936, line: 218, column: 67)
!2504 = !DILocalVariable(name: "s", arg: 1, scope: !2488, file: !936, line: 196, type: !2217)
!2505 = !DILocation(line: 196, column: 46, scope: !2488)
!2506 = !DILocalVariable(name: "pkt", arg: 2, scope: !2488, file: !936, line: 197, type: !1048)
!2507 = !DILocation(line: 197, column: 39, scope: !2488)
!2508 = !DILocalVariable(name: "flic", scope: !2488, file: !936, line: 199, type: !2222)
!2509 = !DILocation(line: 199, column: 23, scope: !2488)
!2510 = !DILocation(line: 199, column: 30, scope: !2488)
!2511 = !DILocation(line: 199, column: 33, scope: !2488)
!2512 = !DILocalVariable(name: "pb", scope: !2488, file: !936, line: 200, type: !1229)
!2513 = !DILocation(line: 200, column: 18, scope: !2488)
!2514 = !DILocation(line: 200, column: 23, scope: !2488)
!2515 = !DILocation(line: 200, column: 26, scope: !2488)
!2516 = !DILocalVariable(name: "packet_read", scope: !2488, file: !936, line: 201, type: !933)
!2517 = !DILocation(line: 201, column: 9, scope: !2488)
!2518 = !DILocalVariable(name: "size", scope: !2488, file: !936, line: 202, type: !932)
!2519 = !DILocation(line: 202, column: 18, scope: !2488)
!2520 = !DILocalVariable(name: "magic", scope: !2488, file: !936, line: 203, type: !933)
!2521 = !DILocation(line: 203, column: 9, scope: !2488)
!2522 = !DILocalVariable(name: "ret", scope: !2488, file: !936, line: 204, type: !933)
!2523 = !DILocation(line: 204, column: 9, scope: !2488)
!2524 = !DILocalVariable(name: "preamble", scope: !2488, file: !936, line: 205, type: !2250)
!2525 = !DILocation(line: 205, column: 19, scope: !2488)
!2526 = !DILocation(line: 207, column: 5, scope: !2488)
!2527 = !DILocation(line: 207, column: 13, scope: !2528)
!2528 = !DILexicalBlockFile(scope: !2488, file: !936, discriminator: 1)
!2529 = !DILocation(line: 207, column: 25, scope: !2528)
!2530 = !DILocation(line: 207, column: 39, scope: !2531)
!2531 = !DILexicalBlockFile(scope: !2488, file: !936, discriminator: 2)
!2532 = !DILocation(line: 207, column: 29, scope: !2531)
!2533 = !DILocation(line: 207, column: 28, scope: !2531)
!2534 = !DILocation(line: 207, column: 5, scope: !2535)
!2535 = !DILexicalBlockFile(scope: !2488, file: !936, discriminator: 3)
!2536 = !DILocation(line: 209, column: 30, scope: !2537)
!2537 = distinct !DILexicalBlock(scope: !2500, file: !936, line: 209, column: 13)
!2538 = !DILocation(line: 209, column: 34, scope: !2537)
!2539 = !DILocation(line: 209, column: 20, scope: !2537)
!2540 = !DILocation(line: 209, column: 18, scope: !2537)
!2541 = !DILocation(line: 209, column: 48, scope: !2537)
!2542 = !DILocation(line: 209, column: 13, scope: !2500)
!2543 = !DILocation(line: 211, column: 17, scope: !2544)
!2544 = distinct !DILexicalBlock(scope: !2537, file: !936, line: 210, column: 16)
!2545 = !DILocation(line: 212, column: 13, scope: !2544)
!2546 = !DILocation(line: 215, column: 49, scope: !2500)
!2547 = !DILocation(line: 215, column: 64, scope: !2500)
!2548 = !DILocation(line: 215, column: 14, scope: !2500)
!2549 = !DILocation(line: 216, column: 50, scope: !2500)
!2550 = !DILocation(line: 216, column: 65, scope: !2500)
!2551 = !DILocation(line: 216, column: 17, scope: !2500)
!2552 = !DILocation(line: 216, column: 15, scope: !2500)
!2553 = !DILocation(line: 218, column: 15, scope: !2499)
!2554 = !DILocation(line: 218, column: 21, scope: !2499)
!2555 = !DILocation(line: 218, column: 32, scope: !2499)
!2556 = !DILocation(line: 218, column: 36, scope: !2557)
!2557 = !DILexicalBlockFile(scope: !2499, file: !936, discriminator: 1)
!2558 = !DILocation(line: 218, column: 42, scope: !2557)
!2559 = !DILocation(line: 218, column: 54, scope: !2557)
!2560 = !DILocation(line: 218, column: 57, scope: !2561)
!2561 = !DILexicalBlockFile(scope: !2499, file: !936, discriminator: 2)
!2562 = !DILocation(line: 218, column: 62, scope: !2561)
!2563 = !DILocation(line: 218, column: 13, scope: !2561)
!2564 = !DILocation(line: 219, column: 31, scope: !2565)
!2565 = distinct !DILexicalBlock(scope: !2503, file: !936, line: 219, column: 17)
!2566 = !DILocation(line: 219, column: 36, scope: !2565)
!2567 = !DILocation(line: 219, column: 17, scope: !2565)
!2568 = !DILocation(line: 219, column: 17, scope: !2503)
!2569 = !DILocation(line: 220, column: 21, scope: !2570)
!2570 = distinct !DILexicalBlock(scope: !2565, file: !936, line: 219, column: 43)
!2571 = !DILocation(line: 221, column: 17, scope: !2570)
!2572 = !DILocation(line: 223, column: 33, scope: !2503)
!2573 = !DILocation(line: 223, column: 39, scope: !2503)
!2574 = !DILocation(line: 223, column: 13, scope: !2503)
!2575 = !DILocation(line: 223, column: 18, scope: !2503)
!2576 = !DILocation(line: 223, column: 31, scope: !2503)
!2577 = !DILocation(line: 224, column: 24, scope: !2503)
!2578 = !DILocation(line: 224, column: 30, scope: !2503)
!2579 = !DILocation(line: 224, column: 42, scope: !2503)
!2580 = !DILocation(line: 224, column: 13, scope: !2503)
!2581 = !DILocation(line: 224, column: 18, scope: !2503)
!2582 = !DILocation(line: 224, column: 22, scope: !2503)
!2583 = !DILocation(line: 225, column: 34, scope: !2503)
!2584 = !DILocation(line: 225, column: 24, scope: !2503)
!2585 = !DILocation(line: 559, column: 22, scope: !2492, inlinedAt: !2502)
!2586 = !DILocation(line: 559, column: 12, scope: !2492, inlinedAt: !2502)
!2587 = !DILocation(line: 225, column: 13, scope: !2503)
!2588 = !DILocation(line: 225, column: 18, scope: !2503)
!2589 = !DILocation(line: 225, column: 22, scope: !2503)
!2590 = !DILocation(line: 226, column: 20, scope: !2503)
!2591 = !DILocation(line: 226, column: 25, scope: !2503)
!2592 = !DILocation(line: 226, column: 13, scope: !2503)
!2593 = !DILocation(line: 227, column: 29, scope: !2503)
!2594 = !DILocation(line: 227, column: 33, scope: !2503)
!2595 = !DILocation(line: 227, column: 38, scope: !2503)
!2596 = !DILocation(line: 227, column: 43, scope: !2503)
!2597 = !DILocation(line: 228, column: 17, scope: !2503)
!2598 = !DILocation(line: 228, column: 22, scope: !2503)
!2599 = !DILocation(line: 227, column: 19, scope: !2503)
!2600 = !DILocation(line: 227, column: 17, scope: !2503)
!2601 = !DILocation(line: 229, column: 17, scope: !2602)
!2602 = distinct !DILexicalBlock(scope: !2503, file: !936, line: 229, column: 17)
!2603 = !DILocation(line: 229, column: 24, scope: !2602)
!2604 = !DILocation(line: 229, column: 29, scope: !2602)
!2605 = !DILocation(line: 229, column: 21, scope: !2602)
!2606 = !DILocation(line: 229, column: 17, scope: !2503)
!2607 = !DILocation(line: 230, column: 33, scope: !2608)
!2608 = distinct !DILexicalBlock(scope: !2602, file: !936, line: 229, column: 34)
!2609 = !DILocation(line: 230, column: 17, scope: !2608)
!2610 = !DILocation(line: 231, column: 21, scope: !2608)
!2611 = !DILocation(line: 232, column: 13, scope: !2608)
!2612 = !DILocation(line: 233, column: 25, scope: !2503)
!2613 = !DILocation(line: 234, column: 9, scope: !2503)
!2614 = !DILocation(line: 234, column: 20, scope: !2615)
!2615 = !DILexicalBlockFile(scope: !2498, file: !936, discriminator: 1)
!2616 = !DILocation(line: 234, column: 26, scope: !2615)
!2617 = !DILocation(line: 235, column: 31, scope: !2618)
!2618 = distinct !DILexicalBlock(scope: !2497, file: !936, line: 235, column: 17)
!2619 = !DILocation(line: 235, column: 36, scope: !2618)
!2620 = !DILocation(line: 235, column: 17, scope: !2618)
!2621 = !DILocation(line: 235, column: 17, scope: !2497)
!2622 = !DILocation(line: 236, column: 21, scope: !2623)
!2623 = distinct !DILexicalBlock(scope: !2618, file: !936, line: 235, column: 43)
!2624 = !DILocation(line: 237, column: 17, scope: !2623)
!2625 = !DILocation(line: 241, column: 23, scope: !2497)
!2626 = !DILocation(line: 241, column: 13, scope: !2497)
!2627 = !DILocation(line: 243, column: 33, scope: !2497)
!2628 = !DILocation(line: 243, column: 39, scope: !2497)
!2629 = !DILocation(line: 243, column: 13, scope: !2497)
!2630 = !DILocation(line: 243, column: 18, scope: !2497)
!2631 = !DILocation(line: 243, column: 31, scope: !2497)
!2632 = !DILocation(line: 244, column: 34, scope: !2497)
!2633 = !DILocation(line: 244, column: 24, scope: !2497)
!2634 = !DILocation(line: 559, column: 22, scope: !2492, inlinedAt: !2496)
!2635 = !DILocation(line: 559, column: 12, scope: !2492, inlinedAt: !2496)
!2636 = !DILocation(line: 244, column: 13, scope: !2497)
!2637 = !DILocation(line: 244, column: 18, scope: !2497)
!2638 = !DILocation(line: 244, column: 22, scope: !2497)
!2639 = !DILocation(line: 245, column: 29, scope: !2497)
!2640 = !DILocation(line: 245, column: 33, scope: !2497)
!2641 = !DILocation(line: 245, column: 38, scope: !2497)
!2642 = !DILocation(line: 245, column: 44, scope: !2497)
!2643 = !DILocation(line: 245, column: 19, scope: !2497)
!2644 = !DILocation(line: 245, column: 17, scope: !2497)
!2645 = !DILocation(line: 247, column: 17, scope: !2646)
!2646 = distinct !DILexicalBlock(scope: !2497, file: !936, line: 247, column: 17)
!2647 = !DILocation(line: 247, column: 24, scope: !2646)
!2648 = !DILocation(line: 247, column: 21, scope: !2646)
!2649 = !DILocation(line: 247, column: 17, scope: !2497)
!2650 = !DILocation(line: 248, column: 33, scope: !2651)
!2651 = distinct !DILexicalBlock(scope: !2646, file: !936, line: 247, column: 30)
!2652 = !DILocation(line: 248, column: 17, scope: !2651)
!2653 = !DILocation(line: 249, column: 21, scope: !2651)
!2654 = !DILocation(line: 250, column: 13, scope: !2651)
!2655 = !DILocation(line: 252, column: 25, scope: !2497)
!2656 = !DILocation(line: 253, column: 9, scope: !2497)
!2657 = !DILocation(line: 255, column: 23, scope: !2658)
!2658 = distinct !DILexicalBlock(scope: !2498, file: !936, line: 253, column: 16)
!2659 = !DILocation(line: 255, column: 27, scope: !2658)
!2660 = !DILocation(line: 255, column: 32, scope: !2658)
!2661 = !DILocation(line: 255, column: 13, scope: !2658)
!2662 = !DILocation(line: 207, column: 5, scope: !2663)
!2663 = !DILexicalBlockFile(scope: !2488, file: !936, discriminator: 4)
!2664 = distinct !{!2664, !2526}
!2665 = !DILocation(line: 259, column: 22, scope: !2488)
!2666 = !DILocation(line: 259, column: 12, scope: !2488)
!2667 = !DILocation(line: 259, column: 12, scope: !2528)
!2668 = !DILocation(line: 259, column: 103, scope: !2531)
!2669 = !DILocation(line: 259, column: 12, scope: !2531)
!2670 = !DILocation(line: 259, column: 12, scope: !2535)
!2671 = !DILocation(line: 259, column: 5, scope: !2535)
