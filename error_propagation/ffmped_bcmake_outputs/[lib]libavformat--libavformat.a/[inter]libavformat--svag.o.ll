; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--svag.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--svag.o.i"
...
@ff_svag_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 0, i32 (%struct.AVProbeData*)* @svag_probe, i32 (%struct.AVFormatContext*)* @svag_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @svag_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
@.str.2 = private unnamed_addr constant [5 x i8] c"Svag\00", align 1

; Function Attrs: nounwind uwtable
define internal i32 @svag_probe(%struct.AVProbeData* %p) #0 !dbg !2140 {
entry:
  ...
  %call = call i32 @memcmp(i8* %1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i32 0, i32 0), i64 4) #4, !dbg !2148
...
; Function Attrs: nounwind uwtable
define internal i32 @svag_read_header(%struct.AVFormatContext* %s) #0 !dbg !2153 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %size, metadata !2166, metadata !2143), !dbg !2167
  call void @llvm.dbg.declare(metadata i32* %align, metadata !2168, metadata !2143), !dbg !2169
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2170, metadata !2143), !dbg !2171
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2172
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2173
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2173
  %call = call i64 @avio_skip(%struct.AVIOContext* %1, i64 4), !dbg !2174
  %2 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2175
  %call1 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %2, %struct.AVCodec* null), !dbg !2176
  store %struct.AVStream* %call1, %struct.AVStream** %st, align 8, !dbg !2177
  %3 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2178
  %tobool = icmp ne %struct.AVStream* %3, null, !dbg !2178
...
if.end:                                           ; preds = %entry
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2182
  %pb2 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %4, i32 0, i32 4, !dbg !2183
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb2, align 8, !dbg !2183
  %call3 = call i32 @avio_rl32(%struct.AVIOContext* %5), !dbg !2184
  store i32 %call3, i32* %size, align 4, !dbg !2185
  %6 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2186
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %6, i32 0, i32 19, !dbg !2187
  %7 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2187
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %7, i32 0, i32 0, !dbg !2188
  store i32 1, i32* %codec_type, align 8, !dbg !2189
  %8 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2190
  %codecpar4 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %8, i32 0, i32 19, !dbg !2191
  %9 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar4, align 8, !dbg !2191
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %9, i32 0, i32 1, !dbg !2192
  store i32 71686, i32* %codec_id, align 4, !dbg !2193
  %10 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2194
  %pb5 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %10, i32 0, i32 4, !dbg !2195
  %11 = load %struct.AVIOContext*, %struct.AVIOContext** %pb5, align 8, !dbg !2195
  %call6 = call i32 @avio_rl32(%struct.AVIOContext* %11), !dbg !2196
  %12 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2197
  %codecpar7 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %12, i32 0, i32 19, !dbg !2198
  %13 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar7, align 8, !dbg !2198
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %13, i32 0, i32 23, !dbg !2199
  store i32 %call6, i32* %sample_rate, align 4, !dbg !2200
  %14 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2201
  %codecpar8 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %14, i32 0, i32 19, !dbg !2203
  %15 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar8, align 8, !dbg !2203
  %sample_rate9 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %15, i32 0, i32 23, !dbg !2204
  %16 = load i32, i32* %sample_rate9, align 4, !dbg !2204
  %cmp = icmp sle i32 %16, 0, !dbg !2205
  br i1 %cmp, label %if.then10, label %if.end11, !dbg !2206
...
if.end11:                                         ; preds = %if.end
  %17 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2208
  %pb12 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %17, i32 0, i32 4, !dbg !2209
  %18 = load %struct.AVIOContext*, %struct.AVIOContext** %pb12, align 8, !dbg !2209
  %call13 = call i32 @avio_rl32(%struct.AVIOContext* %18), !dbg !2210
  %19 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2211
  %codecpar14 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %19, i32 0, i32 19, !dbg !2212
  %20 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar14, align 8, !dbg !2212
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %20, i32 0, i32 22, !dbg !2213
  store i32 %call13, i32* %channels, align 8, !dbg !2214
  %21 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2215
  %codecpar15 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %21, i32 0, i32 19, !dbg !2217
  %22 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar15, align 8, !dbg !2217
  %channels16 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %22, i32 0, i32 22, !dbg !2218
  %23 = load i32, i32* %channels16, align 8, !dbg !2218
  %cmp17 = icmp sle i32 %23, 0, !dbg !2219
  br i1 %cmp17, label %if.then21, label %lor.lhs.false, !dbg !2220

lor.lhs.false:                                    ; preds = %if.end11
  %24 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2221
  %codecpar18 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %24, i32 0, i32 19, !dbg !2223
  %25 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar18, align 8, !dbg !2223
  %channels19 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %25, i32 0, i32 22, !dbg !2224
  %26 = load i32, i32* %channels19, align 8, !dbg !2224
  %cmp20 = icmp sgt i32 %26, 8, !dbg !2225
  br i1 %cmp20, label %if.then21, label %if.end22, !dbg !2226
...
if.end22:                                         ; preds = %lor.lhs.false
  %27 = load i32, i32* %size, align 4, !dbg !2228
  %28 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2229
  %codecpar23 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %28, i32 0, i32 19, !dbg !2230
  %29 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar23, align 8, !dbg !2230
  %channels24 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %29, i32 0, i32 22, !dbg !2231
  %30 = load i32, i32* %channels24, align 8, !dbg !2231
  %mul = mul nsw i32 16, %30, !dbg !2232
  %div = udiv i32 %27, %mul, !dbg !2233
  %mul25 = mul i32 %div, 28, !dbg !2234
  %conv = zext i32 %mul25 to i64, !dbg !2228
  %31 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2235
  %duration = getelementptr inbounds %struct.AVStream, %struct.AVStream* %31, i32 0, i32 6, !dbg !2236
  store i64 %conv, i64* %duration, align 8, !dbg !2237
  %32 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2238
  %pb26 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %32, i32 0, i32 4, !dbg !2239
  %33 = load %struct.AVIOContext*, %struct.AVIOContext** %pb26, align 8, !dbg !2239
  %call27 = call i32 @avio_rl32(%struct.AVIOContext* %33), !dbg !2240
  store i32 %call27, i32* %align, align 4, !dbg !2241
  %34 = load i32, i32* %align, align 4, !dbg !2242
  %cmp28 = icmp ule i32 %34, 0, !dbg !2244
  br i1 %cmp28, label %if.then36, label %lor.lhs.false30, !dbg !2245

lor.lhs.false30:                                  ; preds = %if.end22
  %35 = load i32, i32* %align, align 4, !dbg !2246
  %36 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2248
  %codecpar31 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %36, i32 0, i32 19, !dbg !2249
  %37 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar31, align 8, !dbg !2249
  %channels32 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %37, i32 0, i32 22, !dbg !2250
  %38 = load i32, i32* %channels32, align 8, !dbg !2250
  %div33 = sdiv i32 2147483647, %38, !dbg !2251
  %cmp34 = icmp ugt i32 %35, %div33, !dbg !2252
  br i1 %cmp34, label %if.then36, label %if.end37, !dbg !2253

if.then36:                                        ; preds = %lor.lhs.false30, %if.end22
  store i32 -1094995529, i32* %retval, align 4, !dbg !2254
  br label %return, !dbg !2254

if.end37:                                         ; preds = %lor.lhs.false30
  %39 = load i32, i32* %align, align 4, !dbg !2255
  %40 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2256
  %codecpar38 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %40, i32 0, i32 19, !dbg !2257
  %41 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar38, align 8, !dbg !2257
  %channels39 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %41, i32 0, i32 22, !dbg !2258
  %42 = load i32, i32* %channels39, align 8, !dbg !2258
  %mul40 = mul i32 %39, %42, !dbg !2259
  %43 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2260
  %codecpar41 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %43, i32 0, i32 19, !dbg !2261
  %44 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar41, align 8, !dbg !2261
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %44, i32 0, i32 24, !dbg !2262
  store i32 %mul40, i32* %block_align, align 8, !dbg !2263
  %45 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2264
  %pb42 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %45, i32 0, i32 4, !dbg !2265
  %46 = load %struct.AVIOContext*, %struct.AVIOContext** %pb42, align 8, !dbg !2265
  %47 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2266
  %pb43 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %47, i32 0, i32 4, !dbg !2267
  %48 = load %struct.AVIOContext*, %struct.AVIOContext** %pb43, align 8, !dbg !2267
  store %struct.AVIOContext* %48, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2268
  %49 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2269
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %49, i64 0, i32 1) #5, !dbg !2270
  %sub = sub nsw i64 2048, %call.i, !dbg !2271
  %call45 = call i64 @avio_skip(%struct.AVIOContext* %46, i64 %sub), !dbg !2272
  %50 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2274
  %51 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2275
  %codecpar46 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %51, i32 0, i32 19, !dbg !2276
  %52 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar46, align 8, !dbg !2276
  %sample_rate47 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %52, i32 0, i32 23, !dbg !2277
  %53 = load i32, i32* %sample_rate47, align 4, !dbg !2277
  call void @avpriv_set_pts_info(%struct.AVStream* %50, i32 64, i32 1, i32 %53), !dbg !2278
  store i32 0, i32* %retval, align 4, !dbg !2279
  br label %return, !dbg !2279

return:                                           ; preds = %if.end37, %if.then36, %if.then21, %if.then10, %if.then
  %54 = load i32, i32* %retval, align 4, !dbg !2280
  ret i32 %54, !dbg !2280
}

; Function Attrs: nounwind uwtable
define internal i32 @svag_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2281 {
entry:
  %s.addr = alloca %struct.AVFormatContext*, align 8
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--svag.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!919 = !{!920}
!920 = distinct !DIGlobalVariable(name: "ff_svag_demuxer", scope: !0, file: !921, line: 71, type: !922, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_svag_demuxer)
!921 = !DIFile(filename: "libavformat/svag.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2140 = distinct !DISubprogram(name: "svag_probe", scope: !921, file: !921, line: 25, type: !991, isLocal: true, isDefinition: true, scopeLine: 26, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2141 = !{}
!2142 = !DILocalVariable(name: "p", arg: 1, scope: !2140, file: !921, line: 25, type: !993)
!2143 = !DIExpression()
!2144 = !DILocation(line: 25, column: 36, scope: !2140)
...
!2149 = !DILocation(line: 27, column: 9, scope: !2140)
!2150 = !DILocation(line: 28, column: 9, scope: !2146)
!2151 = !DILocation(line: 30, column: 5, scope: !2140)
!2152 = !DILocation(line: 31, column: 1, scope: !2140)
!2153 = distinct !DISubprogram(name: "svag_read_header", scope: !921, file: !921, line: 33, type: !2154, isLocal: true, isDefinition: true, scopeLine: 34, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
...
!2163 = distinct !DILocation(line: 58, column: 30, scope: !2153)
!2164 = !DILocalVariable(name: "s", arg: 1, scope: !2153, file: !921, line: 33, type: !2156)
!2165 = !DILocation(line: 33, column: 46, scope: !2153)
!2166 = !DILocalVariable(name: "size", scope: !2153, file: !921, line: 35, type: !918)
!2167 = !DILocation(line: 35, column: 14, scope: !2153)
!2168 = !DILocalVariable(name: "align", scope: !2153, file: !921, line: 35, type: !918)
!2169 = !DILocation(line: 35, column: 20, scope: !2153)
!2170 = !DILocalVariable(name: "st", scope: !2153, file: !921, line: 36, type: !1283)
!2171 = !DILocation(line: 36, column: 15, scope: !2153)
!2172 = !DILocation(line: 38, column: 15, scope: !2153)
!2173 = !DILocation(line: 38, column: 18, scope: !2153)
!2174 = !DILocation(line: 38, column: 5, scope: !2153)
!2175 = !DILocation(line: 40, column: 30, scope: !2153)
!2176 = !DILocation(line: 40, column: 10, scope: !2153)
!2177 = !DILocation(line: 40, column: 8, scope: !2153)
!2178 = !DILocation(line: 41, column: 10, scope: !2179)
!2179 = distinct !DILexicalBlock(scope: !2153, file: !921, line: 41, column: 9)
!2180 = !DILocation(line: 41, column: 9, scope: !2153)
!2181 = !DILocation(line: 42, column: 9, scope: !2179)
!2182 = !DILocation(line: 44, column: 22, scope: !2153)
!2183 = !DILocation(line: 44, column: 25, scope: !2153)
!2184 = !DILocation(line: 44, column: 12, scope: !2153)
!2185 = !DILocation(line: 44, column: 10, scope: !2153)
!2186 = !DILocation(line: 45, column: 5, scope: !2153)
!2187 = !DILocation(line: 45, column: 9, scope: !2153)
!2188 = !DILocation(line: 45, column: 19, scope: !2153)
!2189 = !DILocation(line: 45, column: 30, scope: !2153)
!2190 = !DILocation(line: 46, column: 5, scope: !2153)
!2191 = !DILocation(line: 46, column: 9, scope: !2153)
!2192 = !DILocation(line: 46, column: 19, scope: !2153)
!2193 = !DILocation(line: 46, column: 28, scope: !2153)
!2194 = !DILocation(line: 47, column: 43, scope: !2153)
!2195 = !DILocation(line: 47, column: 46, scope: !2153)
!2196 = !DILocation(line: 47, column: 33, scope: !2153)
!2197 = !DILocation(line: 47, column: 5, scope: !2153)
!2198 = !DILocation(line: 47, column: 9, scope: !2153)
!2199 = !DILocation(line: 47, column: 19, scope: !2153)
!2200 = !DILocation(line: 47, column: 31, scope: !2153)
!2201 = !DILocation(line: 48, column: 9, scope: !2202)
!2202 = distinct !DILexicalBlock(scope: !2153, file: !921, line: 48, column: 9)
!2203 = !DILocation(line: 48, column: 13, scope: !2202)
!2204 = !DILocation(line: 48, column: 23, scope: !2202)
!2205 = !DILocation(line: 48, column: 35, scope: !2202)
!2206 = !DILocation(line: 48, column: 9, scope: !2153)
!2207 = !DILocation(line: 49, column: 9, scope: !2202)
!2208 = !DILocation(line: 50, column: 40, scope: !2153)
!2209 = !DILocation(line: 50, column: 43, scope: !2153)
!2210 = !DILocation(line: 50, column: 30, scope: !2153)
!2211 = !DILocation(line: 50, column: 5, scope: !2153)
!2212 = !DILocation(line: 50, column: 9, scope: !2153)
!2213 = !DILocation(line: 50, column: 19, scope: !2153)
!2214 = !DILocation(line: 50, column: 28, scope: !2153)
!2215 = !DILocation(line: 51, column: 9, scope: !2216)
!2216 = distinct !DILexicalBlock(scope: !2153, file: !921, line: 51, column: 9)
!2217 = !DILocation(line: 51, column: 13, scope: !2216)
!2218 = !DILocation(line: 51, column: 23, scope: !2216)
!2219 = !DILocation(line: 51, column: 32, scope: !2216)
!2220 = !DILocation(line: 51, column: 37, scope: !2216)
!2221 = !DILocation(line: 51, column: 40, scope: !2222)
!2222 = !DILexicalBlockFile(scope: !2216, file: !921, discriminator: 1)
!2223 = !DILocation(line: 51, column: 44, scope: !2222)
!2224 = !DILocation(line: 51, column: 54, scope: !2222)
!2225 = !DILocation(line: 51, column: 63, scope: !2222)
!2226 = !DILocation(line: 51, column: 9, scope: !2222)
!2227 = !DILocation(line: 52, column: 9, scope: !2216)
!2228 = !DILocation(line: 53, column: 20, scope: !2153)
!2229 = !DILocation(line: 53, column: 33, scope: !2153)
!2230 = !DILocation(line: 53, column: 37, scope: !2153)
!2231 = !DILocation(line: 53, column: 47, scope: !2153)
!2232 = !DILocation(line: 53, column: 31, scope: !2153)
!2233 = !DILocation(line: 53, column: 25, scope: !2153)
!2234 = !DILocation(line: 53, column: 57, scope: !2153)
!2235 = !DILocation(line: 53, column: 5, scope: !2153)
!2236 = !DILocation(line: 53, column: 9, scope: !2153)
!2237 = !DILocation(line: 53, column: 18, scope: !2153)
!2238 = !DILocation(line: 54, column: 23, scope: !2153)
!2239 = !DILocation(line: 54, column: 26, scope: !2153)
!2240 = !DILocation(line: 54, column: 13, scope: !2153)
!2241 = !DILocation(line: 54, column: 11, scope: !2153)
!2242 = !DILocation(line: 55, column: 9, scope: !2243)
!2243 = distinct !DILexicalBlock(scope: !2153, file: !921, line: 55, column: 9)
!2244 = !DILocation(line: 55, column: 15, scope: !2243)
!2245 = !DILocation(line: 55, column: 20, scope: !2243)
!2246 = !DILocation(line: 55, column: 23, scope: !2247)
!2247 = !DILexicalBlockFile(scope: !2243, file: !921, discriminator: 1)
!2248 = !DILocation(line: 55, column: 44, scope: !2247)
!2249 = !DILocation(line: 55, column: 48, scope: !2247)
!2250 = !DILocation(line: 55, column: 58, scope: !2247)
!2251 = !DILocation(line: 55, column: 42, scope: !2247)
!2252 = !DILocation(line: 55, column: 29, scope: !2247)
!2253 = !DILocation(line: 55, column: 9, scope: !2247)
!2254 = !DILocation(line: 56, column: 9, scope: !2243)
!2255 = !DILocation(line: 57, column: 33, scope: !2153)
!2256 = !DILocation(line: 57, column: 41, scope: !2153)
!2257 = !DILocation(line: 57, column: 45, scope: !2153)
!2258 = !DILocation(line: 57, column: 55, scope: !2153)
!2259 = !DILocation(line: 57, column: 39, scope: !2153)
!2260 = !DILocation(line: 57, column: 5, scope: !2153)
!2261 = !DILocation(line: 57, column: 9, scope: !2153)
!2262 = !DILocation(line: 57, column: 19, scope: !2153)
!2263 = !DILocation(line: 57, column: 31, scope: !2153)
!2264 = !DILocation(line: 58, column: 15, scope: !2153)
!2265 = !DILocation(line: 58, column: 18, scope: !2153)
!2266 = !DILocation(line: 58, column: 40, scope: !2153)
!2267 = !DILocation(line: 58, column: 43, scope: !2153)
!2268 = !DILocation(line: 58, column: 30, scope: !2153)
!2269 = !DILocation(line: 559, column: 22, scope: !2159, inlinedAt: !2163)
!2270 = !DILocation(line: 559, column: 12, scope: !2159, inlinedAt: !2163)
!2271 = !DILocation(line: 58, column: 28, scope: !2153)
!2272 = !DILocation(line: 58, column: 5, scope: !2273)
!2273 = !DILexicalBlockFile(scope: !2153, file: !921, discriminator: 1)
!2274 = !DILocation(line: 59, column: 25, scope: !2153)
!2275 = !DILocation(line: 59, column: 36, scope: !2153)
!2276 = !DILocation(line: 59, column: 40, scope: !2153)
!2277 = !DILocation(line: 59, column: 50, scope: !2153)
!2278 = !DILocation(line: 59, column: 5, scope: !2153)
!2279 = !DILocation(line: 61, column: 5, scope: !2153)
!2280 = !DILocation(line: 62, column: 1, scope: !2153)
!2281 = distinct !DISubprogram(name: "svag_read_packet", scope: !921, file: !921, line: 64, type: !2282, isLocal: true, isDefinition: true, scopeLine: 65, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2282 = !DISubroutineType(types: !2283)
!2283 = !{!917, !2156, !1033}
!2284 = !DILocalVariable(name: "s", arg: 1, scope: !2281, file: !921, line: 64, type: !2156)
!2285 = !DILocation(line: 64, column: 46, scope: !2281)
!2286 = !DILocalVariable(name: "pkt", arg: 2, scope: !2281, file: !921, line: 64, type: !1033)
!2287 = !DILocation(line: 64, column: 59, scope: !2281)
!2288 = !DILocalVariable(name: "par", scope: !2281, file: !921, line: 66, type: !1727)
!2289 = !DILocation(line: 66, column: 24, scope: !2281)
!2290 = !DILocation(line: 66, column: 30, scope: !2281)
!2291 = !DILocation(line: 66, column: 33, scope: !2281)
!2292 = !DILocation(line: 66, column: 45, scope: !2281)
!2293 = !DILocation(line: 68, column: 26, scope: !2281)
!2294 = !DILocation(line: 68, column: 29, scope: !2281)
!2295 = !DILocation(line: 68, column: 33, scope: !2281)
!2296 = !DILocation(line: 68, column: 38, scope: !2281)
!2297 = !DILocation(line: 68, column: 43, scope: !2281)
!2298 = !DILocation(line: 68, column: 12, scope: !2281)
!2299 = !DILocation(line: 68, column: 5, scope: !2281)
