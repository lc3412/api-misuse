; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--smjpegdec.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--smjpegdec.o.i"
...
@ff_smjpeg_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0), i32 256, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i32 0, i32 0), %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 8, i32 (%struct.AVProbeData*)* @smjpeg_probe, i32 (%struct.AVFormatContext*)* @smjpeg_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @smjpeg_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
...
define internal i32 @smjpeg_probe(%struct.AVProbeData* %p) #0 !dbg !2140 {
entry:
  ...
  %call = call i32 @memcmp(i8* %1, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i32 0, i32 0), i64 8) #4, !dbg !2148
...
; Function Attrs: nounwind uwtable
define internal i32 @smjpeg_read_header(%struct.AVFormatContext* %s) #0 !dbg !2153 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %sc = alloca %struct.SMJPEGContext*, align 8
  %ast = alloca %struct.AVStream*, align 8
  %vst = alloca %struct.AVStream*, align 8
  %pb = alloca %struct.AVIOContext*, align 8
  %version = alloca i32, align 4
  %htype = alloca i32, align 4
  %hlength = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.SMJPEGContext** %sc, metadata !2160, metadata !2143), !dbg !2167
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2168
  %priv_data = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 3, !dbg !2169
  %1 = load i8*, i8** %priv_data, align 8, !dbg !2169
  %2 = bitcast i8* %1 to %struct.SMJPEGContext*, !dbg !2168
  store %struct.SMJPEGContext* %2, %struct.SMJPEGContext** %sc, align 8, !dbg !2167
  call void @llvm.dbg.declare(metadata %struct.AVStream** %ast, metadata !2170, metadata !2143), !dbg !2171
  store %struct.AVStream* null, %struct.AVStream** %ast, align 8, !dbg !2171
  call void @llvm.dbg.declare(metadata %struct.AVStream** %vst, metadata !2172, metadata !2143), !dbg !2173
  store %struct.AVStream* null, %struct.AVStream** %vst, align 8, !dbg !2173
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2174, metadata !2143), !dbg !2175
  ...
  call void @llvm.dbg.declare(metadata i32* %version, metadata !2178, metadata !2143), !dbg !2179
  call void @llvm.dbg.declare(metadata i32* %htype, metadata !2180, metadata !2143), !dbg !2181
  call void @llvm.dbg.declare(metadata i32* %hlength, metadata !2182, metadata !2143), !dbg !2183
  call void @llvm.dbg.declare(metadata i32* %duration, metadata !2184, metadata !2143), !dbg !2185
  call void @llvm.dbg.declare(metadata i8** %comment, metadata !2186, metadata !2143), !dbg !2187
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2188
  %call = call i64 @avio_skip(%struct.AVIOContext* %5, i64 8), !dbg !2189
  %6 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2190
  %call2 = call i32 @avio_rb32(%struct.AVIOContext* %6), !dbg !2191
  store i32 %call2, i32* %version, align 4, !dbg !2192
  %7 = load i32, i32* %version, align 4, !dbg !2193
  %tobool = icmp ne i32 %7, 0, !dbg !2193
  br i1 %tobool, label %if.then, label %if.end, !dbg !2195

if.then:                                          ; preds = %entry
  %8 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2196
  %9 = bitcast %struct.AVFormatContext* %8 to i8*, !dbg !2196
  %10 = load i32, i32* %version, align 4, !dbg !2197
  call void (i8*, i8*, ...) @avpriv_request_sample(i8* %9, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.4, i32 0, i32 0), i32 %10), !dbg !2198
  br label %if.end, !dbg !2198

if.end:                                           ; preds = %if.then, %entry
  %11 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2199
  %call3 = call i32 @avio_rb32(%struct.AVIOContext* %11), !dbg !2200
  store i32 %call3, i32* %duration, align 4, !dbg !2201
  br label %while.cond, !dbg !2202

while.cond:                                       ; preds = %sw.epilog, %if.end
  %12 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2203
  %call4 = call i32 @avio_feof(%struct.AVIOContext* %12), !dbg !2205
  %tobool5 = icmp ne i32 %call4, 0, !dbg !2206
  %lnot = xor i1 %tobool5, true, !dbg !2206
  br i1 %lnot, label %while.body, label %while.end, !dbg !2207

while.body:                                       ; preds = %while.cond
  %13 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2208
  %call6 = call i32 @avio_rl32(%struct.AVIOContext* %13), !dbg !2210
  store i32 %call6, i32* %htype, align 4, !dbg !2211
  %14 = load i32, i32* %htype, align 4, !dbg !2212
  switch i32 %14, label %sw.default [
    i32 1415074911, label %sw.bb
    i32 1145983839, label %sw.bb21
    i32 1145656927, label %sw.bb50
    i32 1145980232, label %sw.bb85
  ], !dbg !2213

sw.bb:                                            ; preds = %while.body
  %15 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2214
  %call7 = call i32 @avio_rb32(%struct.AVIOContext* %15), !dbg !2216
  store i32 %call7, i32* %hlength, align 4, !dbg !2217
  %16 = load i32, i32* %hlength, align 4, !dbg !2218
  %tobool8 = icmp ne i32 %16, 0, !dbg !2218
  br i1 %tobool8, label %lor.lhs.false, label %if.then9, !dbg !2220

lor.lhs.false:                                    ; preds = %sw.bb
  %17 = load i32, i32* %hlength, align 4, !dbg !2221
  %cmp = icmp ugt i32 %17, 512, !dbg !2223
  br i1 %cmp, label %if.then9, label %if.end10, !dbg !2224
...
if.end10:                                         ; preds = %lor.lhs.false
  %18 = load i32, i32* %hlength, align 4, !dbg !2226
  %add = add i32 %18, 1, !dbg !2227
  %conv = zext i32 %add to i64, !dbg !2226
  %call11 = call noalias i8* @av_malloc(i64 %conv), !dbg !2228
  store i8* %call11, i8** %comment, align 8, !dbg !2229
  %19 = load i8*, i8** %comment, align 8, !dbg !2230
  %tobool12 = icmp ne i8* %19, null, !dbg !2230
  br i1 %tobool12, label %if.end14, label %if.then13, !dbg !2232
...
if.end14:                                         ; preds = %if.end10
  %20 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2234
  %21 = load i8*, i8** %comment, align 8, !dbg !2236
  %22 = load i32, i32* %hlength, align 4, !dbg !2237
  %call15 = call i32 @avio_read(%struct.AVIOContext* %20, i8* %21, i32 %22), !dbg !2238
  %23 = load i32, i32* %hlength, align 4, !dbg !2239
  %cmp16 = icmp ne i32 %call15, %23, !dbg !2240
  br i1 %cmp16, label %if.then18, label %if.end19, !dbg !2241

if.then18:                                        ; preds = %if.end14
  %24 = bitcast i8** %comment to i8*, !dbg !2242
  call void @av_freep(i8* %24), !dbg !2244
  %25 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2245
  %26 = bitcast %struct.AVFormatContext* %25 to i8*, !dbg !2245
  call void (i8*, i32, i8*, ...) @av_log(i8* %26, i32 16, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.5, i32 0, i32 0)), !dbg !2246
  store i32 -1094995529, i32* %retval, align 4, !dbg !2247
  br label %return, !dbg !2247

if.end19:                                         ; preds = %if.end14
  %27 = load i32, i32* %hlength, align 4, !dbg !2248
  %idxprom = zext i32 %27 to i64, !dbg !2249
  %28 = load i8*, i8** %comment, align 8, !dbg !2249
  %arrayidx = getelementptr inbounds i8, i8* %28, i64 %idxprom, !dbg !2249
  store i8 0, i8* %arrayidx, align 1, !dbg !2250
  %29 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2251
  %metadata = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %29, i32 0, i32 29, !dbg !2252
  %30 = load i8*, i8** %comment, align 8, !dbg !2253
  %call20 = call i32 @av_dict_set(%struct.AVDictionary** %metadata, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.6, i32 0, i32 0), i8* %30, i32 8), !dbg !2254
  br label %sw.epilog, !dbg !2255

sw.bb21:                                          ; preds = %while.body
  %31 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2256
  %tobool22 = icmp ne %struct.AVStream* %31, null, !dbg !2256
  br i1 %tobool22, label %if.then23, label %if.end24, !dbg !2258

if.then23:                                        ; preds = %sw.bb21
  %32 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2259
  %33 = bitcast %struct.AVFormatContext* %32 to i8*, !dbg !2259
  call void (i8*, i8*, ...) @avpriv_request_sample(i8* %33, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.7, i32 0, i32 0)), !dbg !2261
  store i32 -1163346256, i32* %retval, align 4, !dbg !2262
  br label %return, !dbg !2262

if.end24:                                         ; preds = %sw.bb21
  %34 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2263
  %call25 = call i32 @avio_rb32(%struct.AVIOContext* %34), !dbg !2264
  store i32 %call25, i32* %hlength, align 4, !dbg !2265
  %35 = load i32, i32* %hlength, align 4, !dbg !2266
  %cmp26 = icmp ult i32 %35, 8, !dbg !2268
  br i1 %cmp26, label %if.then28, label %if.end29, !dbg !2269
...
if.end29:                                         ; preds = %if.end24
  %36 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2271
  %call30 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %36, %struct.AVCodec* null), !dbg !2272
  store %struct.AVStream* %call30, %struct.AVStream** %ast, align 8, !dbg !2273
  %37 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2274
  %tobool31 = icmp ne %struct.AVStream* %37, null, !dbg !2274
  br i1 %tobool31, label %if.end33, label %if.then32, !dbg !2276
...
if.end33:                                         ; preds = %if.end29
  %38 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2278
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %38, i32 0, i32 19, !dbg !2279
  %39 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2279
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %39, i32 0, i32 0, !dbg !2280
  store i32 1, i32* %codec_type, align 8, !dbg !2281
  %40 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2282
  %call34 = call i32 @avio_rb16(%struct.AVIOContext* %40), !dbg !2283
  %41 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2284
  %codecpar35 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %41, i32 0, i32 19, !dbg !2285
  %42 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar35, align 8, !dbg !2285
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %42, i32 0, i32 23, !dbg !2286
  store i32 %call34, i32* %sample_rate, align 4, !dbg !2287
  %43 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2288
  %call36 = call i32 @avio_r8(%struct.AVIOContext* %43), !dbg !2289
  %44 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2290
  %codecpar37 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %44, i32 0, i32 19, !dbg !2291
  %45 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar37, align 8, !dbg !2291
  %bits_per_coded_sample = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %45, i32 0, i32 7, !dbg !2292
  store i32 %call36, i32* %bits_per_coded_sample, align 8, !dbg !2293
  %46 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2294
  %call38 = call i32 @avio_r8(%struct.AVIOContext* %46), !dbg !2295
  %47 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2296
  %codecpar39 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %47, i32 0, i32 19, !dbg !2297
  %48 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar39, align 8, !dbg !2297
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %48, i32 0, i32 22, !dbg !2298
  store i32 %call38, i32* %channels, align 8, !dbg !2299
  %49 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2300
  %call40 = call i32 @avio_rl32(%struct.AVIOContext* %49), !dbg !2301
  %50 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2302
  %codecpar41 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %50, i32 0, i32 19, !dbg !2303
  %51 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar41, align 8, !dbg !2303
  %codec_tag = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %51, i32 0, i32 2, !dbg !2304
  store i32 %call40, i32* %codec_tag, align 8, !dbg !2305
  %52 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2306
  %codecpar42 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %52, i32 0, i32 19, !dbg !2307
  %53 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar42, align 8, !dbg !2307
  %codec_tag43 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %53, i32 0, i32 2, !dbg !2308
  %54 = load i32, i32* %codec_tag43, align 8, !dbg !2308
  %call44 = call i32 @ff_codec_get_id(%struct.AVCodecTag* getelementptr inbounds ([0 x %struct.AVCodecTag], [0 x %struct.AVCodecTag]* @ff_codec_smjpeg_audio_tags, i32 0, i32 0), i32 %54), !dbg !2309
  %55 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2310
  %codecpar45 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %55, i32 0, i32 19, !dbg !2311
  %56 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar45, align 8, !dbg !2311
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %56, i32 0, i32 1, !dbg !2312
  store i32 %call44, i32* %codec_id, align 4, !dbg !2313
  %57 = load i32, i32* %duration, align 4, !dbg !2314
  %conv46 = zext i32 %57 to i64, !dbg !2314
  %58 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2315
  %duration47 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %58, i32 0, i32 6, !dbg !2316
  store i64 %conv46, i64* %duration47, align 8, !dbg !2317
  %59 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2318
  %index = getelementptr inbounds %struct.AVStream, %struct.AVStream* %59, i32 0, i32 0, !dbg !2319
  %60 = load i32, i32* %index, align 8, !dbg !2319
  %61 = load %struct.SMJPEGContext*, %struct.SMJPEGContext** %sc, align 8, !dbg !2320
  %audio_stream_index = getelementptr inbounds %struct.SMJPEGContext, %struct.SMJPEGContext* %61, i32 0, i32 0, !dbg !2321
  store i32 %60, i32* %audio_stream_index, align 4, !dbg !2322
  %62 = load %struct.AVStream*, %struct.AVStream** %ast, align 8, !dbg !2323
  call void @avpriv_set_pts_info(%struct.AVStream* %62, i32 32, i32 1, i32 1000), !dbg !2324
  %63 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2325
  %64 = load i32, i32* %hlength, align 4, !dbg !2326
  %sub = sub i32 %64, 8, !dbg !2327
  %conv48 = zext i32 %sub to i64, !dbg !2326
  %call49 = call i64 @avio_skip(%struct.AVIOContext* %63, i64 %conv48), !dbg !2328
  br label %sw.epilog, !dbg !2329

sw.bb50:                                          ; preds = %while.body
  %65 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2330
  %tobool51 = icmp ne %struct.AVStream* %65, null, !dbg !2330
  br i1 %tobool51, label %if.then52, label %if.end53, !dbg !2332

if.then52:                                        ; preds = %sw.bb50
  %66 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2333
  %67 = bitcast %struct.AVFormatContext* %66 to i8*, !dbg !2333
  call void (i8*, i8*, ...) @avpriv_request_sample(i8* %67, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.8, i32 0, i32 0)), !dbg !2335
  store i32 -1094995529, i32* %retval, align 4, !dbg !2336
  br label %return, !dbg !2336

if.end53:                                         ; preds = %sw.bb50
  %68 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2337
  %call54 = call i32 @avio_rb32(%struct.AVIOContext* %68), !dbg !2338
  store i32 %call54, i32* %hlength, align 4, !dbg !2339
  %69 = load i32, i32* %hlength, align 4, !dbg !2340
  %cmp55 = icmp ult i32 %69, 12, !dbg !2342
  br i1 %cmp55, label %if.then57, label %if.end58, !dbg !2343
...
if.end58:                                         ; preds = %if.end53
  %70 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2345
  %call59 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %70, %struct.AVCodec* null), !dbg !2346
  store %struct.AVStream* %call59, %struct.AVStream** %vst, align 8, !dbg !2347
  %71 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2348
  %tobool60 = icmp ne %struct.AVStream* %71, null, !dbg !2348
  br i1 %tobool60, label %if.end62, label %if.then61, !dbg !2350
...
if.end62:                                         ; preds = %if.end58
  %72 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2352
  %call63 = call i32 @avio_rb32(%struct.AVIOContext* %72), !dbg !2353
  %conv64 = zext i32 %call63 to i64, !dbg !2353
  %73 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2354
  %nb_frames = getelementptr inbounds %struct.AVStream, %struct.AVStream* %73, i32 0, i32 7, !dbg !2355
  store i64 %conv64, i64* %nb_frames, align 8, !dbg !2356
  %74 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2357
  %codecpar65 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %74, i32 0, i32 19, !dbg !2358
  %75 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar65, align 8, !dbg !2358
  %codec_type66 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %75, i32 0, i32 0, !dbg !2359
  store i32 0, i32* %codec_type66, align 8, !dbg !2360
  %76 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2361
  %call67 = call i32 @avio_rb16(%struct.AVIOContext* %76), !dbg !2362
  %77 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2363
  %codecpar68 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %77, i32 0, i32 19, !dbg !2364
  %78 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar68, align 8, !dbg !2364
  %width = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %78, i32 0, i32 11, !dbg !2365
  store i32 %call67, i32* %width, align 8, !dbg !2366
  %79 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2367
  %call69 = call i32 @avio_rb16(%struct.AVIOContext* %79), !dbg !2368
  %80 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2369
  %codecpar70 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %80, i32 0, i32 19, !dbg !2370
  %81 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar70, align 8, !dbg !2370
  %height = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %81, i32 0, i32 12, !dbg !2371
  store i32 %call69, i32* %height, align 4, !dbg !2372
  %82 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2373
  %call71 = call i32 @avio_rl32(%struct.AVIOContext* %82), !dbg !2374
  %83 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2375
  %codecpar72 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %83, i32 0, i32 19, !dbg !2376
  %84 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar72, align 8, !dbg !2376
  %codec_tag73 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %84, i32 0, i32 2, !dbg !2377
  store i32 %call71, i32* %codec_tag73, align 8, !dbg !2378
  %85 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2379
  %codecpar74 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %85, i32 0, i32 19, !dbg !2380
  %86 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar74, align 8, !dbg !2380
  %codec_tag75 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %86, i32 0, i32 2, !dbg !2381
  %87 = load i32, i32* %codec_tag75, align 8, !dbg !2381
  %call76 = call i32 @ff_codec_get_id(%struct.AVCodecTag* getelementptr inbounds ([0 x %struct.AVCodecTag], [0 x %struct.AVCodecTag]* @ff_codec_smjpeg_video_tags, i32 0, i32 0), i32 %87), !dbg !2382
  %88 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2383
  %codecpar77 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %88, i32 0, i32 19, !dbg !2384
  %89 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar77, align 8, !dbg !2384
  %codec_id78 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %89, i32 0, i32 1, !dbg !2385
  store i32 %call76, i32* %codec_id78, align 4, !dbg !2386
  %90 = load i32, i32* %duration, align 4, !dbg !2387
  %conv79 = zext i32 %90 to i64, !dbg !2387
  %91 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2388
  %duration80 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %91, i32 0, i32 6, !dbg !2389
  store i64 %conv79, i64* %duration80, align 8, !dbg !2390
  %92 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2391
  %index81 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %92, i32 0, i32 0, !dbg !2392
  %93 = load i32, i32* %index81, align 8, !dbg !2392
  %94 = load %struct.SMJPEGContext*, %struct.SMJPEGContext** %sc, align 8, !dbg !2393
  %video_stream_index = getelementptr inbounds %struct.SMJPEGContext, %struct.SMJPEGContext* %94, i32 0, i32 1, !dbg !2394
  store i32 %93, i32* %video_stream_index, align 4, !dbg !2395
  %95 = load %struct.AVStream*, %struct.AVStream** %vst, align 8, !dbg !2396
  call void @avpriv_set_pts_info(%struct.AVStream* %95, i32 32, i32 1, i32 1000), !dbg !2397
  %96 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2398
  %97 = load i32, i32* %hlength, align 4, !dbg !2399
  %sub82 = sub i32 %97, 12, !dbg !2400
  %conv83 = zext i32 %sub82 to i64, !dbg !2399
  %call84 = call i64 @avio_skip(%struct.AVIOContext* %96, i64 %conv83), !dbg !2401
...
sw.default:                                       ; preds = %while.body
  %98 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2404
  %99 = bitcast %struct.AVFormatContext* %98 to i8*, !dbg !2404
  %100 = load i32, i32* %htype, align 4, !dbg !2405
  call void (i8*, i32, i8*, ...) @av_log(i8* %99, i32 16, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.9, i32 0, i32 0), i32 %100), !dbg !2406
  store i32 -1094995529, i32* %retval, align 4, !dbg !2407
  br label %return, !dbg !2407

sw.epilog:                                        ; preds = %if.end62, %if.end33, %if.end19
  br label %while.cond, !dbg !2408, !llvm.loop !2410

while.end:                                        ; preds = %while.cond
  store i32 -541478725, i32* %retval, align 4, !dbg !2411
  br label %return, !dbg !2411

return:                                           ; preds = %while.end, %sw.default, %sw.bb85, %if.then61, %if.then57, %if.then52, %if.then32, %if.then28, %if.then23, %if.then18, %if.then13, %if.then9
  %101 = load i32, i32* %retval, align 4, !dbg !2412
  ret i32 %101, !dbg !2412
}

; Function Attrs: nounwind uwtable
define internal i32 @smjpeg_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2413 {
entry:
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2416, metadata !2143), !dbg !2420
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2422, metadata !2143), !dbg !2423
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2424, metadata !2143), !dbg !2425
  call void @llvm.dbg.declare(metadata %struct.SMJPEGContext** %sc, metadata !2426, metadata !2143), !dbg !2427
  ...
  %2 = bitcast i8* %1 to %struct.SMJPEGContext*, !dbg !2428
  store %struct.SMJPEGContext* %2, %struct.SMJPEGContext** %sc, align 8, !dbg !2427
  call void @llvm.dbg.declare(metadata i32* %dtype, metadata !2430, metadata !2143), !dbg !2431
  call void @llvm.dbg.declare(metadata i32* %size, metadata !2432, metadata !2143), !dbg !2433
  call void @llvm.dbg.declare(metadata i32* %timestamp, metadata !2434, metadata !2143), !dbg !2435
  call void @llvm.dbg.declare(metadata i64* %pos, metadata !2436, metadata !2143), !dbg !2437
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2438, metadata !2143), !dbg !2439
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2440
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %3, i32 0, i32 4, !dbg !2442
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2442
  %call = call i32 @avio_feof(%struct.AVIOContext* %4), !dbg !2443
  %tobool = icmp ne i32 %call, 0, !dbg !2443
...
if.end:                                           ; preds = %entry
  %5 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2446
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %5, i32 0, i32 4, !dbg !2447
  %6 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2447
  store %struct.AVIOContext* %6, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2448
  %7 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2449
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %7, i64 0, i32 1) #5, !dbg !2450
  store i64 %call.i, i64* %pos, align 8, !dbg !2451
  %8 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2452
  %pb3 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %8, i32 0, i32 4, !dbg !2453
  %9 = load %struct.AVIOContext*, %struct.AVIOContext** %pb3, align 8, !dbg !2453
  %call4 = call i32 @avio_rl32(%struct.AVIOContext* %9), !dbg !2454
  store i32 %call4, i32* %dtype, align 4, !dbg !2455
  %10 = load i32, i32* %dtype, align 4, !dbg !2456
  switch i32 %10, label %sw.default [
    i32 1147432563, label %sw.bb
    i32 1147431286, label %sw.bb12
    i32 1162760004, label %sw.bb23
  ], !dbg !2457

sw.bb:                                            ; preds = %if.end
  %11 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2458
  %pb5 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %11, i32 0, i32 4, !dbg !2460
  %12 = load %struct.AVIOContext*, %struct.AVIOContext** %pb5, align 8, !dbg !2460
  %call6 = call i32 @avio_rb32(%struct.AVIOContext* %12), !dbg !2461
  store i32 %call6, i32* %timestamp, align 4, !dbg !2462
  %13 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2463
  %pb7 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %13, i32 0, i32 4, !dbg !2464
  %14 = load %struct.AVIOContext*, %struct.AVIOContext** %pb7, align 8, !dbg !2464
  %call8 = call i32 @avio_rb32(%struct.AVIOContext* %14), !dbg !2465
  store i32 %call8, i32* %size, align 4, !dbg !2466
  %15 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2467
  %pb9 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %15, i32 0, i32 4, !dbg !2468
  %16 = load %struct.AVIOContext*, %struct.AVIOContext** %pb9, align 8, !dbg !2468
  %17 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2469
  %18 = load i32, i32* %size, align 4, !dbg !2470
  %call10 = call i32 @av_get_packet(%struct.AVIOContext* %16, %struct.AVPacket* %17, i32 %18), !dbg !2471
  store i32 %call10, i32* %ret, align 4, !dbg !2472
  %19 = load %struct.SMJPEGContext*, %struct.SMJPEGContext** %sc, align 8, !dbg !2473
  %audio_stream_index = getelementptr inbounds %struct.SMJPEGContext, %struct.SMJPEGContext* %19, i32 0, i32 0, !dbg !2474
  %20 = load i32, i32* %audio_stream_index, align 4, !dbg !2474
  %21 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2475
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %21, i32 0, i32 5, !dbg !2476
  store i32 %20, i32* %stream_index, align 4, !dbg !2477
  %22 = load i32, i32* %timestamp, align 4, !dbg !2478
  %conv = zext i32 %22 to i64, !dbg !2478
  %23 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2479
  %pts = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %23, i32 0, i32 1, !dbg !2480
  store i64 %conv, i64* %pts, align 8, !dbg !2481
  %24 = load i64, i64* %pos, align 8, !dbg !2482
  %25 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2483
  %pos11 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %25, i32 0, i32 10, !dbg !2484
  store i64 %24, i64* %pos11, align 8, !dbg !2485
  br label %sw.epilog, !dbg !2486

sw.bb12:                                          ; preds = %if.end
  %26 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2487
  %pb13 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %26, i32 0, i32 4, !dbg !2488
  %27 = load %struct.AVIOContext*, %struct.AVIOContext** %pb13, align 8, !dbg !2488
  %call14 = call i32 @avio_rb32(%struct.AVIOContext* %27), !dbg !2489
  store i32 %call14, i32* %timestamp, align 4, !dbg !2490
  %28 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2491
  %pb15 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %28, i32 0, i32 4, !dbg !2492
  %29 = load %struct.AVIOContext*, %struct.AVIOContext** %pb15, align 8, !dbg !2492
  %call16 = call i32 @avio_rb32(%struct.AVIOContext* %29), !dbg !2493
  store i32 %call16, i32* %size, align 4, !dbg !2494
  %30 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2495
  %pb17 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %30, i32 0, i32 4, !dbg !2496
  %31 = load %struct.AVIOContext*, %struct.AVIOContext** %pb17, align 8, !dbg !2496
  %32 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2497
  %33 = load i32, i32* %size, align 4, !dbg !2498
  %call18 = call i32 @av_get_packet(%struct.AVIOContext* %31, %struct.AVPacket* %32, i32 %33), !dbg !2499
  store i32 %call18, i32* %ret, align 4, !dbg !2500
  %34 = load %struct.SMJPEGContext*, %struct.SMJPEGContext** %sc, align 8, !dbg !2501
  %video_stream_index = getelementptr inbounds %struct.SMJPEGContext, %struct.SMJPEGContext* %34, i32 0, i32 1, !dbg !2502
  %35 = load i32, i32* %video_stream_index, align 4, !dbg !2502
  %36 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2503
  %stream_index19 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %36, i32 0, i32 5, !dbg !2504
  store i32 %35, i32* %stream_index19, align 4, !dbg !2505
  %37 = load i32, i32* %timestamp, align 4, !dbg !2506
  %conv20 = zext i32 %37 to i64, !dbg !2506
  %38 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2507
  %pts21 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %38, i32 0, i32 1, !dbg !2508
  store i64 %conv20, i64* %pts21, align 8, !dbg !2509
  %39 = load i64, i64* %pos, align 8, !dbg !2510
  %40 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2511
  %pos22 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %40, i32 0, i32 10, !dbg !2512
  store i64 %39, i64* %pos22, align 8, !dbg !2513
  br label %sw.epilog, !dbg !2514

sw.bb23:                                          ; preds = %if.end
  store i32 -541478725, i32* %ret, align 4, !dbg !2515
  br label %sw.epilog, !dbg !2516

sw.default:                                       ; preds = %if.end
  %41 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2517
  %42 = bitcast %struct.AVFormatContext* %41 to i8*, !dbg !2517
  %43 = load i32, i32* %dtype, align 4, !dbg !2518
  call void (i8*, i32, i8*, ...) @av_log(i8* %42, i32 16, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.10, i32 0, i32 0), i32 %43), !dbg !2519
  store i32 -1094995529, i32* %ret, align 4, !dbg !2520
  br label %sw.epilog, !dbg !2521

sw.epilog:                                        ; preds = %sw.default, %sw.bb23, %sw.bb12, %sw.bb
  %44 = load i32, i32* %ret, align 4, !dbg !2522
  store i32 %44, i32* %retval, align 4, !dbg !2523
  br label %return, !dbg !2523

return:                                           ; preds = %sw.epilog, %if.then
  %45 = load i32, i32* %retval, align 4, !dbg !2524
  ret i32 %45, !dbg !2524
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--smjpegdec.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!919 = !{!920}
!920 = distinct !DIGlobalVariable(name: "ff_smjpeg_demuxer", scope: !0, file: !921, line: 176, type: !922, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_smjpeg_demuxer)
!921 = !DIFile(filename: "libavformat/smjpegdec.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2140 = distinct !DISubprogram(name: "smjpeg_probe", scope: !921, file: !921, line: 39, type: !991, isLocal: true, isDefinition: true, scopeLine: 40, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2141 = !{}
!2142 = !DILocalVariable(name: "p", arg: 1, scope: !2140, file: !921, line: 39, type: !993)
!2143 = !DIExpression()
!2144 = !DILocation(line: 39, column: 38, scope: !2140)
!2145 = !DILocation(line: 41, column: 17, scope: !2146)
!2146 = distinct !DILexicalBlock(scope: !2140, file: !921, line: 41, column: 9)
!2147 = !DILocation(line: 41, column: 20, scope: !2146)
!2148 = !DILocation(line: 41, column: 10, scope: !2146)
!2149 = !DILocation(line: 41, column: 9, scope: !2140)
!2150 = !DILocation(line: 42, column: 9, scope: !2146)
!2151 = !DILocation(line: 43, column: 5, scope: !2140)
!2152 = !DILocation(line: 44, column: 1, scope: !2140)
!2153 = distinct !DISubprogram(name: "smjpeg_read_header", scope: !921, file: !921, line: 46, type: !2154, isLocal: true, isDefinition: true, scopeLine: 47, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
...
!2158 = !DILocalVariable(name: "s", arg: 1, scope: !2153, file: !921, line: 46, type: !2156)
!2159 = !DILocation(line: 46, column: 48, scope: !2153)
!2160 = !DILocalVariable(name: "sc", scope: !2153, file: !921, line: 48, type: !2161)
!2161 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2162, size: 64, align: 64)
!2162 = !DIDerivedType(tag: DW_TAG_typedef, name: "SMJPEGContext", file: !921, line: 37, baseType: !2163)
!2163 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "SMJPEGContext", file: !921, line: 34, size: 64, align: 32, elements: !2164)
!2164 = !{!2165, !2166}
!2165 = !DIDerivedType(tag: DW_TAG_member, name: "audio_stream_index", scope: !2163, file: !921, line: 35, baseType: !917, size: 32, align: 32)
!2166 = !DIDerivedType(tag: DW_TAG_member, name: "video_stream_index", scope: !2163, file: !921, line: 36, baseType: !917, size: 32, align: 32, offset: 32)
!2167 = !DILocation(line: 48, column: 20, scope: !2153)
!2168 = !DILocation(line: 48, column: 25, scope: !2153)
!2169 = !DILocation(line: 48, column: 28, scope: !2153)
!2170 = !DILocalVariable(name: "ast", scope: !2153, file: !921, line: 49, type: !1283)
!2171 = !DILocation(line: 49, column: 15, scope: !2153)
!2172 = !DILocalVariable(name: "vst", scope: !2153, file: !921, line: 49, type: !1283)
!2173 = !DILocation(line: 49, column: 27, scope: !2153)
!2174 = !DILocalVariable(name: "pb", scope: !2153, file: !921, line: 50, type: !1215)
!2175 = !DILocation(line: 50, column: 18, scope: !2153)
!2176 = !DILocation(line: 50, column: 23, scope: !2153)
!2177 = !DILocation(line: 50, column: 26, scope: !2153)
!2178 = !DILocalVariable(name: "version", scope: !2153, file: !921, line: 51, type: !1368)
!2179 = !DILocation(line: 51, column: 14, scope: !2153)
!2180 = !DILocalVariable(name: "htype", scope: !2153, file: !921, line: 51, type: !1368)
!2181 = !DILocation(line: 51, column: 23, scope: !2153)
!2182 = !DILocalVariable(name: "hlength", scope: !2153, file: !921, line: 51, type: !1368)
!2183 = !DILocation(line: 51, column: 30, scope: !2153)
!2184 = !DILocalVariable(name: "duration", scope: !2153, file: !921, line: 51, type: !1368)
!2185 = !DILocation(line: 51, column: 39, scope: !2153)
!2186 = !DILocalVariable(name: "comment", scope: !2153, file: !921, line: 52, type: !1396)
!2187 = !DILocation(line: 52, column: 11, scope: !2153)
!2188 = !DILocation(line: 54, column: 15, scope: !2153)
!2189 = !DILocation(line: 54, column: 5, scope: !2153)
!2190 = !DILocation(line: 55, column: 25, scope: !2153)
!2191 = !DILocation(line: 55, column: 15, scope: !2153)
!2192 = !DILocation(line: 55, column: 13, scope: !2153)
!2193 = !DILocation(line: 56, column: 9, scope: !2194)
!2194 = distinct !DILexicalBlock(scope: !2153, file: !921, line: 56, column: 9)
!2195 = !DILocation(line: 56, column: 9, scope: !2153)
!2196 = !DILocation(line: 57, column: 31, scope: !2194)
!2197 = !DILocation(line: 57, column: 60, scope: !2194)
!2198 = !DILocation(line: 57, column: 9, scope: !2194)
!2199 = !DILocation(line: 59, column: 26, scope: !2153)
!2200 = !DILocation(line: 59, column: 16, scope: !2153)
!2201 = !DILocation(line: 59, column: 14, scope: !2153)
!2202 = !DILocation(line: 61, column: 5, scope: !2153)
!2203 = !DILocation(line: 61, column: 23, scope: !2204)
!2204 = !DILexicalBlockFile(scope: !2153, file: !921, discriminator: 1)
!2205 = !DILocation(line: 61, column: 13, scope: !2204)
!2206 = !DILocation(line: 61, column: 12, scope: !2204)
!2207 = !DILocation(line: 61, column: 5, scope: !2204)
!2208 = !DILocation(line: 62, column: 27, scope: !2209)
!2209 = distinct !DILexicalBlock(scope: !2153, file: !921, line: 61, column: 28)
!2210 = !DILocation(line: 62, column: 17, scope: !2209)
!2211 = !DILocation(line: 62, column: 15, scope: !2209)
!2212 = !DILocation(line: 63, column: 17, scope: !2209)
!2213 = !DILocation(line: 63, column: 9, scope: !2209)
!2214 = !DILocation(line: 65, column: 33, scope: !2215)
!2215 = distinct !DILexicalBlock(scope: !2209, file: !921, line: 63, column: 24)
!2216 = !DILocation(line: 65, column: 23, scope: !2215)
!2217 = !DILocation(line: 65, column: 21, scope: !2215)
!2218 = !DILocation(line: 66, column: 18, scope: !2219)
!2219 = distinct !DILexicalBlock(scope: !2215, file: !921, line: 66, column: 17)
!2220 = !DILocation(line: 66, column: 26, scope: !2219)
!2221 = !DILocation(line: 66, column: 29, scope: !2222)
!2222 = !DILexicalBlockFile(scope: !2219, file: !921, discriminator: 1)
!2223 = !DILocation(line: 66, column: 37, scope: !2222)
!2224 = !DILocation(line: 66, column: 17, scope: !2222)
!2225 = !DILocation(line: 67, column: 17, scope: !2219)
!2226 = !DILocation(line: 68, column: 33, scope: !2215)
!2227 = !DILocation(line: 68, column: 41, scope: !2215)
!2228 = !DILocation(line: 68, column: 23, scope: !2215)
!2229 = !DILocation(line: 68, column: 21, scope: !2215)
!2230 = !DILocation(line: 69, column: 18, scope: !2231)
!2231 = distinct !DILexicalBlock(scope: !2215, file: !921, line: 69, column: 17)
!2232 = !DILocation(line: 69, column: 17, scope: !2215)
!2233 = !DILocation(line: 70, column: 17, scope: !2231)
!2234 = !DILocation(line: 71, column: 27, scope: !2235)
!2235 = distinct !DILexicalBlock(scope: !2215, file: !921, line: 71, column: 17)
!2236 = !DILocation(line: 71, column: 31, scope: !2235)
!2237 = !DILocation(line: 71, column: 40, scope: !2235)
!2238 = !DILocation(line: 71, column: 17, scope: !2235)
!2239 = !DILocation(line: 71, column: 52, scope: !2235)
!2240 = !DILocation(line: 71, column: 49, scope: !2235)
!2241 = !DILocation(line: 71, column: 17, scope: !2215)
!2242 = !DILocation(line: 72, column: 26, scope: !2243)
!2243 = distinct !DILexicalBlock(scope: !2235, file: !921, line: 71, column: 61)
!2244 = !DILocation(line: 72, column: 17, scope: !2243)
!2245 = !DILocation(line: 73, column: 24, scope: !2243)
!2246 = !DILocation(line: 73, column: 17, scope: !2243)
!2247 = !DILocation(line: 74, column: 17, scope: !2243)
!2248 = !DILocation(line: 76, column: 21, scope: !2215)
!2249 = !DILocation(line: 76, column: 13, scope: !2215)
!2250 = !DILocation(line: 76, column: 30, scope: !2215)
!2251 = !DILocation(line: 77, column: 26, scope: !2215)
!2252 = !DILocation(line: 77, column: 29, scope: !2215)
!2253 = !DILocation(line: 77, column: 50, scope: !2215)
!2254 = !DILocation(line: 77, column: 13, scope: !2215)
!2255 = !DILocation(line: 79, column: 13, scope: !2215)
!2256 = !DILocation(line: 81, column: 17, scope: !2257)
!2257 = distinct !DILexicalBlock(scope: !2215, file: !921, line: 81, column: 17)
!2258 = !DILocation(line: 81, column: 17, scope: !2215)
!2259 = !DILocation(line: 82, column: 39, scope: !2260)
!2260 = distinct !DILexicalBlock(scope: !2257, file: !921, line: 81, column: 22)
!2261 = !DILocation(line: 82, column: 17, scope: !2260)
!2262 = !DILocation(line: 83, column: 17, scope: !2260)
!2263 = !DILocation(line: 85, column: 33, scope: !2215)
!2264 = !DILocation(line: 85, column: 23, scope: !2215)
!2265 = !DILocation(line: 85, column: 21, scope: !2215)
!2266 = !DILocation(line: 86, column: 17, scope: !2267)
!2267 = distinct !DILexicalBlock(scope: !2215, file: !921, line: 86, column: 17)
!2268 = !DILocation(line: 86, column: 25, scope: !2267)
!2269 = !DILocation(line: 86, column: 17, scope: !2215)
!2270 = !DILocation(line: 87, column: 17, scope: !2267)
!2271 = !DILocation(line: 88, column: 39, scope: !2215)
!2272 = !DILocation(line: 88, column: 19, scope: !2215)
!2273 = !DILocation(line: 88, column: 17, scope: !2215)
!2274 = !DILocation(line: 89, column: 18, scope: !2275)
!2275 = distinct !DILexicalBlock(scope: !2215, file: !921, line: 89, column: 17)
!2276 = !DILocation(line: 89, column: 17, scope: !2215)
!2277 = !DILocation(line: 90, column: 17, scope: !2275)
!2278 = !DILocation(line: 91, column: 13, scope: !2215)
!2279 = !DILocation(line: 91, column: 18, scope: !2215)
!2280 = !DILocation(line: 91, column: 28, scope: !2215)
!2281 = !DILocation(line: 91, column: 39, scope: !2215)
!2282 = !DILocation(line: 92, column: 52, scope: !2215)
!2283 = !DILocation(line: 92, column: 42, scope: !2215)
!2284 = !DILocation(line: 92, column: 13, scope: !2215)
!2285 = !DILocation(line: 92, column: 18, scope: !2215)
!2286 = !DILocation(line: 92, column: 28, scope: !2215)
!2287 = !DILocation(line: 92, column: 40, scope: !2215)
!2288 = !DILocation(line: 93, column: 60, scope: !2215)
!2289 = !DILocation(line: 93, column: 52, scope: !2215)
!2290 = !DILocation(line: 93, column: 13, scope: !2215)
!2291 = !DILocation(line: 93, column: 18, scope: !2215)
!2292 = !DILocation(line: 93, column: 28, scope: !2215)
!2293 = !DILocation(line: 93, column: 50, scope: !2215)
!2294 = !DILocation(line: 94, column: 47, scope: !2215)
!2295 = !DILocation(line: 94, column: 39, scope: !2215)
!2296 = !DILocation(line: 94, column: 13, scope: !2215)
!2297 = !DILocation(line: 94, column: 18, scope: !2215)
!2298 = !DILocation(line: 94, column: 28, scope: !2215)
!2299 = !DILocation(line: 94, column: 37, scope: !2215)
!2300 = !DILocation(line: 95, column: 50, scope: !2215)
!2301 = !DILocation(line: 95, column: 40, scope: !2215)
!2302 = !DILocation(line: 95, column: 13, scope: !2215)
!2303 = !DILocation(line: 95, column: 18, scope: !2215)
!2304 = !DILocation(line: 95, column: 28, scope: !2215)
!2305 = !DILocation(line: 95, column: 38, scope: !2215)
!2306 = !DILocation(line: 97, column: 58, scope: !2215)
!2307 = !DILocation(line: 97, column: 63, scope: !2215)
!2308 = !DILocation(line: 97, column: 73, scope: !2215)
!2309 = !DILocation(line: 96, column: 39, scope: !2215)
!2310 = !DILocation(line: 96, column: 13, scope: !2215)
!2311 = !DILocation(line: 96, column: 18, scope: !2215)
!2312 = !DILocation(line: 96, column: 28, scope: !2215)
!2313 = !DILocation(line: 96, column: 37, scope: !2215)
!2314 = !DILocation(line: 98, column: 29, scope: !2215)
!2315 = !DILocation(line: 98, column: 13, scope: !2215)
!2316 = !DILocation(line: 98, column: 18, scope: !2215)
!2317 = !DILocation(line: 98, column: 27, scope: !2215)
!2318 = !DILocation(line: 99, column: 38, scope: !2215)
!2319 = !DILocation(line: 99, column: 43, scope: !2215)
!2320 = !DILocation(line: 99, column: 13, scope: !2215)
!2321 = !DILocation(line: 99, column: 17, scope: !2215)
!2322 = !DILocation(line: 99, column: 36, scope: !2215)
!2323 = !DILocation(line: 100, column: 33, scope: !2215)
!2324 = !DILocation(line: 100, column: 13, scope: !2215)
!2325 = !DILocation(line: 101, column: 23, scope: !2215)
!2326 = !DILocation(line: 101, column: 27, scope: !2215)
!2327 = !DILocation(line: 101, column: 35, scope: !2215)
!2328 = !DILocation(line: 101, column: 13, scope: !2215)
!2329 = !DILocation(line: 102, column: 13, scope: !2215)
!2330 = !DILocation(line: 104, column: 17, scope: !2331)
!2331 = distinct !DILexicalBlock(scope: !2215, file: !921, line: 104, column: 17)
!2332 = !DILocation(line: 104, column: 17, scope: !2215)
!2333 = !DILocation(line: 105, column: 39, scope: !2334)
!2334 = distinct !DILexicalBlock(scope: !2331, file: !921, line: 104, column: 22)
!2335 = !DILocation(line: 105, column: 17, scope: !2334)
!2336 = !DILocation(line: 106, column: 17, scope: !2334)
!2337 = !DILocation(line: 108, column: 33, scope: !2215)
!2338 = !DILocation(line: 108, column: 23, scope: !2215)
!2339 = !DILocation(line: 108, column: 21, scope: !2215)
!2340 = !DILocation(line: 109, column: 17, scope: !2341)
!2341 = distinct !DILexicalBlock(scope: !2215, file: !921, line: 109, column: 17)
!2342 = !DILocation(line: 109, column: 25, scope: !2341)
!2343 = !DILocation(line: 109, column: 17, scope: !2215)
!2344 = !DILocation(line: 110, column: 17, scope: !2341)
!2345 = !DILocation(line: 111, column: 39, scope: !2215)
!2346 = !DILocation(line: 111, column: 19, scope: !2215)
!2347 = !DILocation(line: 111, column: 17, scope: !2215)
!2348 = !DILocation(line: 112, column: 18, scope: !2349)
!2349 = distinct !DILexicalBlock(scope: !2215, file: !921, line: 112, column: 17)
!2350 = !DILocation(line: 112, column: 17, scope: !2215)
!2351 = !DILocation(line: 113, column: 17, scope: !2349)
!2352 = !DILocation(line: 114, column: 40, scope: !2215)
!2353 = !DILocation(line: 114, column: 30, scope: !2215)
!2354 = !DILocation(line: 114, column: 13, scope: !2215)
!2355 = !DILocation(line: 114, column: 18, scope: !2215)
!2356 = !DILocation(line: 114, column: 28, scope: !2215)
!2357 = !DILocation(line: 115, column: 13, scope: !2215)
!2358 = !DILocation(line: 115, column: 18, scope: !2215)
!2359 = !DILocation(line: 115, column: 28, scope: !2215)
!2360 = !DILocation(line: 115, column: 39, scope: !2215)
!2361 = !DILocation(line: 116, column: 46, scope: !2215)
!2362 = !DILocation(line: 116, column: 36, scope: !2215)
!2363 = !DILocation(line: 116, column: 13, scope: !2215)
!2364 = !DILocation(line: 116, column: 18, scope: !2215)
!2365 = !DILocation(line: 116, column: 28, scope: !2215)
!2366 = !DILocation(line: 116, column: 34, scope: !2215)
!2367 = !DILocation(line: 117, column: 47, scope: !2215)
!2368 = !DILocation(line: 117, column: 37, scope: !2215)
!2369 = !DILocation(line: 117, column: 13, scope: !2215)
!2370 = !DILocation(line: 117, column: 18, scope: !2215)
!2371 = !DILocation(line: 117, column: 28, scope: !2215)
!2372 = !DILocation(line: 117, column: 35, scope: !2215)
!2373 = !DILocation(line: 118, column: 50, scope: !2215)
!2374 = !DILocation(line: 118, column: 40, scope: !2215)
!2375 = !DILocation(line: 118, column: 13, scope: !2215)
!2376 = !DILocation(line: 118, column: 18, scope: !2215)
!2377 = !DILocation(line: 118, column: 28, scope: !2215)
!2378 = !DILocation(line: 118, column: 38, scope: !2215)
!2379 = !DILocation(line: 120, column: 57, scope: !2215)
!2380 = !DILocation(line: 120, column: 62, scope: !2215)
!2381 = !DILocation(line: 120, column: 72, scope: !2215)
!2382 = !DILocation(line: 119, column: 39, scope: !2215)
!2383 = !DILocation(line: 119, column: 13, scope: !2215)
!2384 = !DILocation(line: 119, column: 18, scope: !2215)
!2385 = !DILocation(line: 119, column: 28, scope: !2215)
!2386 = !DILocation(line: 119, column: 37, scope: !2215)
!2387 = !DILocation(line: 121, column: 29, scope: !2215)
!2388 = !DILocation(line: 121, column: 13, scope: !2215)
!2389 = !DILocation(line: 121, column: 18, scope: !2215)
!2390 = !DILocation(line: 121, column: 27, scope: !2215)
!2391 = !DILocation(line: 122, column: 38, scope: !2215)
!2392 = !DILocation(line: 122, column: 43, scope: !2215)
!2393 = !DILocation(line: 122, column: 13, scope: !2215)
!2394 = !DILocation(line: 122, column: 17, scope: !2215)
!2395 = !DILocation(line: 122, column: 36, scope: !2215)
!2396 = !DILocation(line: 123, column: 33, scope: !2215)
!2397 = !DILocation(line: 123, column: 13, scope: !2215)
!2398 = !DILocation(line: 124, column: 23, scope: !2215)
!2399 = !DILocation(line: 124, column: 27, scope: !2215)
!2400 = !DILocation(line: 124, column: 35, scope: !2215)
!2401 = !DILocation(line: 124, column: 13, scope: !2215)
!2402 = !DILocation(line: 125, column: 13, scope: !2215)
!2403 = !DILocation(line: 127, column: 13, scope: !2215)
!2404 = !DILocation(line: 129, column: 20, scope: !2215)
!2405 = !DILocation(line: 129, column: 66, scope: !2215)
!2406 = !DILocation(line: 129, column: 13, scope: !2215)
!2407 = !DILocation(line: 130, column: 13, scope: !2215)
!2408 = !DILocation(line: 61, column: 5, scope: !2409)
!2409 = !DILexicalBlockFile(scope: !2153, file: !921, discriminator: 2)
!2410 = distinct !{!2410, !2202}
!2411 = !DILocation(line: 134, column: 5, scope: !2153)
!2412 = !DILocation(line: 135, column: 1, scope: !2153)
!2413 = distinct !DISubprogram(name: "smjpeg_read_packet", scope: !921, file: !921, line: 137, type: !2414, isLocal: true, isDefinition: true, scopeLine: 138, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2414 = !DISubroutineType(types: !2415)
!2415 = !{!917, !2156, !1033}
!2416 = !DILocalVariable(name: "s", arg: 1, scope: !2417, file: !628, line: 557, type: !1215)
!2417 = distinct !DISubprogram(name: "avio_tell", scope: !628, file: !628, line: 557, type: !2418, isLocal: true, isDefinition: true, scopeLine: 558, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2141)
!2418 = !DISubroutineType(types: !2419)
!2419 = !{!1053, !1215}
!2420 = !DILocation(line: 557, column: 77, scope: !2417, inlinedAt: !2421)
!2421 = distinct !DILocation(line: 146, column: 11, scope: !2413)
!2422 = !DILocalVariable(name: "s", arg: 1, scope: !2413, file: !921, line: 137, type: !2156)
!2423 = !DILocation(line: 137, column: 48, scope: !2413)
!2424 = !DILocalVariable(name: "pkt", arg: 2, scope: !2413, file: !921, line: 137, type: !1033)
!2425 = !DILocation(line: 137, column: 61, scope: !2413)
!2426 = !DILocalVariable(name: "sc", scope: !2413, file: !921, line: 139, type: !2161)
!2427 = !DILocation(line: 139, column: 20, scope: !2413)
!2428 = !DILocation(line: 139, column: 25, scope: !2413)
!2429 = !DILocation(line: 139, column: 28, scope: !2413)
!2430 = !DILocalVariable(name: "dtype", scope: !2413, file: !921, line: 140, type: !1368)
!2431 = !DILocation(line: 140, column: 14, scope: !2413)
!2432 = !DILocalVariable(name: "size", scope: !2413, file: !921, line: 140, type: !1368)
!2433 = !DILocation(line: 140, column: 21, scope: !2413)
!2434 = !DILocalVariable(name: "timestamp", scope: !2413, file: !921, line: 140, type: !1368)
!2435 = !DILocation(line: 140, column: 27, scope: !2413)
!2436 = !DILocalVariable(name: "pos", scope: !2413, file: !921, line: 141, type: !1053)
!2437 = !DILocation(line: 141, column: 13, scope: !2413)
!2438 = !DILocalVariable(name: "ret", scope: !2413, file: !921, line: 142, type: !917)
!2439 = !DILocation(line: 142, column: 9, scope: !2413)
!2440 = !DILocation(line: 144, column: 19, scope: !2441)
!2441 = distinct !DILexicalBlock(scope: !2413, file: !921, line: 144, column: 9)
!2442 = !DILocation(line: 144, column: 22, scope: !2441)
!2443 = !DILocation(line: 144, column: 9, scope: !2441)
!2444 = !DILocation(line: 144, column: 9, scope: !2413)
!2445 = !DILocation(line: 145, column: 9, scope: !2441)
!2446 = !DILocation(line: 146, column: 21, scope: !2413)
!2447 = !DILocation(line: 146, column: 24, scope: !2413)
!2448 = !DILocation(line: 146, column: 11, scope: !2413)
!2449 = !DILocation(line: 559, column: 22, scope: !2417, inlinedAt: !2421)
!2450 = !DILocation(line: 559, column: 12, scope: !2417, inlinedAt: !2421)
!2451 = !DILocation(line: 146, column: 9, scope: !2413)
!2452 = !DILocation(line: 147, column: 23, scope: !2413)
!2453 = !DILocation(line: 147, column: 26, scope: !2413)
!2454 = !DILocation(line: 147, column: 13, scope: !2413)
!2455 = !DILocation(line: 147, column: 11, scope: !2413)
!2456 = !DILocation(line: 148, column: 13, scope: !2413)
!2457 = !DILocation(line: 148, column: 5, scope: !2413)
!2458 = !DILocation(line: 150, column: 31, scope: !2459)
!2459 = distinct !DILexicalBlock(scope: !2413, file: !921, line: 148, column: 20)
!2460 = !DILocation(line: 150, column: 34, scope: !2459)
!2461 = !DILocation(line: 150, column: 21, scope: !2459)
!2462 = !DILocation(line: 150, column: 19, scope: !2459)
!2463 = !DILocation(line: 151, column: 26, scope: !2459)
!2464 = !DILocation(line: 151, column: 29, scope: !2459)
!2465 = !DILocation(line: 151, column: 16, scope: !2459)
!2466 = !DILocation(line: 151, column: 14, scope: !2459)
!2467 = !DILocation(line: 152, column: 29, scope: !2459)
!2468 = !DILocation(line: 152, column: 32, scope: !2459)
!2469 = !DILocation(line: 152, column: 36, scope: !2459)
!2470 = !DILocation(line: 152, column: 41, scope: !2459)
!2471 = !DILocation(line: 152, column: 15, scope: !2459)
!2472 = !DILocation(line: 152, column: 13, scope: !2459)
!2473 = !DILocation(line: 153, column: 29, scope: !2459)
!2474 = !DILocation(line: 153, column: 33, scope: !2459)
!2475 = !DILocation(line: 153, column: 9, scope: !2459)
!2476 = !DILocation(line: 153, column: 14, scope: !2459)
!2477 = !DILocation(line: 153, column: 27, scope: !2459)
!2478 = !DILocation(line: 154, column: 20, scope: !2459)
!2479 = !DILocation(line: 154, column: 9, scope: !2459)
!2480 = !DILocation(line: 154, column: 14, scope: !2459)
!2481 = !DILocation(line: 154, column: 18, scope: !2459)
!2482 = !DILocation(line: 155, column: 20, scope: !2459)
!2483 = !DILocation(line: 155, column: 9, scope: !2459)
!2484 = !DILocation(line: 155, column: 14, scope: !2459)
!2485 = !DILocation(line: 155, column: 18, scope: !2459)
!2486 = !DILocation(line: 156, column: 9, scope: !2459)
!2487 = !DILocation(line: 158, column: 31, scope: !2459)
!2488 = !DILocation(line: 158, column: 34, scope: !2459)
!2489 = !DILocation(line: 158, column: 21, scope: !2459)
!2490 = !DILocation(line: 158, column: 19, scope: !2459)
!2491 = !DILocation(line: 159, column: 26, scope: !2459)
!2492 = !DILocation(line: 159, column: 29, scope: !2459)
!2493 = !DILocation(line: 159, column: 16, scope: !2459)
!2494 = !DILocation(line: 159, column: 14, scope: !2459)
!2495 = !DILocation(line: 160, column: 29, scope: !2459)
!2496 = !DILocation(line: 160, column: 32, scope: !2459)
!2497 = !DILocation(line: 160, column: 36, scope: !2459)
!2498 = !DILocation(line: 160, column: 41, scope: !2459)
!2499 = !DILocation(line: 160, column: 15, scope: !2459)
!2500 = !DILocation(line: 160, column: 13, scope: !2459)
!2501 = !DILocation(line: 161, column: 29, scope: !2459)
!2502 = !DILocation(line: 161, column: 33, scope: !2459)
!2503 = !DILocation(line: 161, column: 9, scope: !2459)
!2504 = !DILocation(line: 161, column: 14, scope: !2459)
!2505 = !DILocation(line: 161, column: 27, scope: !2459)
!2506 = !DILocation(line: 162, column: 20, scope: !2459)
!2507 = !DILocation(line: 162, column: 9, scope: !2459)
!2508 = !DILocation(line: 162, column: 14, scope: !2459)
!2509 = !DILocation(line: 162, column: 18, scope: !2459)
!2510 = !DILocation(line: 163, column: 20, scope: !2459)
!2511 = !DILocation(line: 163, column: 9, scope: !2459)
!2512 = !DILocation(line: 163, column: 14, scope: !2459)
!2513 = !DILocation(line: 163, column: 18, scope: !2459)
!2514 = !DILocation(line: 164, column: 9, scope: !2459)
!2515 = !DILocation(line: 166, column: 13, scope: !2459)
!2516 = !DILocation(line: 167, column: 9, scope: !2459)
!2517 = !DILocation(line: 169, column: 16, scope: !2459)
!2518 = !DILocation(line: 169, column: 61, scope: !2459)
!2519 = !DILocation(line: 169, column: 9, scope: !2459)
!2520 = !DILocation(line: 170, column: 13, scope: !2459)
!2521 = !DILocation(line: 171, column: 9, scope: !2459)
!2522 = !DILocation(line: 173, column: 12, scope: !2413)
!2523 = !DILocation(line: 173, column: 5, scope: !2413)
!2524 = !DILocation(line: 174, column: 1, scope: !2413)
