; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--lvfdec.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--lvfdec.o.i"
...
@ff_lvf_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0), i32 256, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 0, i32 (%struct.AVProbeData*)* @lvf_probe, i32 (%struct.AVFormatContext*)* @lvf_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @lvf_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
...
define internal i32 @lvf_probe(%struct.AVProbeData* %p) #0 !dbg !2146 {
entry:
  ...
  %cmp = icmp ne i32 %3, 1179014732, !dbg !2155
...
if.end:                                           ; preds = %entry
  %4 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2158
  ...
  %add.ptr = getelementptr inbounds i8, i8* %5, i64 16, !dbg !2161
  %6 = bitcast i8* %add.ptr to %union.unaligned_32*, !dbg !2162
  %l2 = bitcast %union.unaligned_32* %6 to i32*, !dbg !2162
  %7 = load i32, i32* %l2, align 1, !dbg !2162
  %tobool = icmp ne i32 %7, 0, !dbg !2163
  br i1 %tobool, label %lor.lhs.false, label %if.then7, !dbg !2164

lor.lhs.false:                                    ; preds = %if.end
  %8 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2165
  %buf3 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %8, i32 0, i32 1, !dbg !2167
  %9 = load i8*, i8** %buf3, align 8, !dbg !2167
  %add.ptr4 = getelementptr inbounds i8, i8* %9, i64 16, !dbg !2168
  %10 = bitcast i8* %add.ptr4 to %union.unaligned_32*, !dbg !2169
  %l5 = bitcast %union.unaligned_32* %10 to i32*, !dbg !2169
  %11 = load i32, i32* %l5, align 1, !dbg !2169
  %cmp6 = icmp ugt i32 %11, 256, !dbg !2170
...
if.end8:                                          ; preds = %lor.lhs.false
  store i32 50, i32* %retval, align 4, !dbg !2173
  br label %return, !dbg !2173

return:                                           ; preds = %if.end8, %if.then7, %if.then
  %12 = load i32, i32* %retval, align 4, !dbg !2174
  ret i32 %12, !dbg !2174
}

; Function Attrs: nounwind uwtable
define internal i32 @lvf_read_header(%struct.AVFormatContext* %s) #0 !dbg !2175 {
entry:
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2180, metadata !2149), !dbg !2184
  %retval = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2187, metadata !2149), !dbg !2188
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2189, metadata !2149), !dbg !2190
  call void @llvm.dbg.declare(metadata i64* %next_offset, metadata !2191, metadata !2149), !dbg !2192
  call void @llvm.dbg.declare(metadata i32* %size, metadata !2193, metadata !2149), !dbg !2194
  call void @llvm.dbg.declare(metadata i32* %nb_streams, metadata !2195, metadata !2149), !dbg !2196
  call void @llvm.dbg.declare(metadata i32* %id, metadata !2197, metadata !2149), !dbg !2198
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2199
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2200
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2200
  %call = call i64 @avio_skip(%struct.AVIOContext* %1, i64 16), !dbg !2201
  %2 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2202
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %2, i32 0, i32 4, !dbg !2203
  %3 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2203
  %call2 = call i32 @avio_rl32(%struct.AVIOContext* %3), !dbg !2204
  store i32 %call2, i32* %nb_streams, align 4, !dbg !2205
  %4 = load i32, i32* %nb_streams, align 4, !dbg !2206
  %tobool = icmp ne i32 %4, 0, !dbg !2206
...
if.end:                                           ; preds = %entry
  %5 = load i32, i32* %nb_streams, align 4, !dbg !2210
  %cmp = icmp ugt i32 %5, 2, !dbg !2212
  br i1 %cmp, label %if.then3, label %if.end4, !dbg !2213

if.then3:                                         ; preds = %if.end
  %6 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2214
  %7 = bitcast %struct.AVFormatContext* %6 to i8*, !dbg !2214
  %8 = load i32, i32* %nb_streams, align 4, !dbg !2216
  call void (i8*, i8*, ...) @avpriv_request_sample(i8* %7, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i32 0, i32 0), i32 %8), !dbg !2217
  store i32 -1163346256, i32* %retval, align 4, !dbg !2218
  br label %return, !dbg !2218

if.end4:                                          ; preds = %if.end
  %9 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2219
  %pb5 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %9, i32 0, i32 4, !dbg !2220
  %10 = load %struct.AVIOContext*, %struct.AVIOContext** %pb5, align 8, !dbg !2220
  %call6 = call i64 @avio_skip(%struct.AVIOContext* %10, i64 1012), !dbg !2221
...
while.cond:                                       ; preds = %sw.epilog, %if.end4
  ...
  %pb7 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %11, i32 0, i32 4, !dbg !2225
  %12 = load %struct.AVIOContext*, %struct.AVIOContext** %pb7, align 8, !dbg !2225
  %call8 = call i32 @avio_feof(%struct.AVIOContext* %12), !dbg !2226
  %tobool9 = icmp ne i32 %call8, 0, !dbg !2227
  %lnot = xor i1 %tobool9, true, !dbg !2227
  br i1 %lnot, label %while.body, label %while.end, !dbg !2228

while.body:                                       ; preds = %while.cond
  %13 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2229
  %pb10 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %13, i32 0, i32 4, !dbg !2230
  %14 = load %struct.AVIOContext*, %struct.AVIOContext** %pb10, align 8, !dbg !2230
  %call11 = call i32 @avio_rl32(%struct.AVIOContext* %14), !dbg !2231
  store i32 %call11, i32* %id, align 4, !dbg !2232
  %15 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2233
  %pb12 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %15, i32 0, i32 4, !dbg !2234
  %16 = load %struct.AVIOContext*, %struct.AVIOContext** %pb12, align 8, !dbg !2234
  %call13 = call i32 @avio_rl32(%struct.AVIOContext* %16), !dbg !2235
  store i32 %call13, i32* %size, align 4, !dbg !2236
  %17 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2237
  %pb14 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %17, i32 0, i32 4, !dbg !2238
  %18 = load %struct.AVIOContext*, %struct.AVIOContext** %pb14, align 8, !dbg !2238
  store %struct.AVIOContext* %18, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2239
  %19 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2240
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %19, i64 0, i32 1) #3, !dbg !2241
  %20 = load i32, i32* %size, align 4, !dbg !2242
  %conv = zext i32 %20 to i64, !dbg !2242
  %add = add nsw i64 %call.i, %conv, !dbg !2243
  store i64 %add, i64* %next_offset, align 8, !dbg !2244
  %21 = load i32, i32* %id, align 4, !dbg !2245
  switch i32 %21, label %sw.default [
    i32 1835413552, label %sw.bb
    i32 1835413808, label %sw.bb37
    i32 0, label %sw.bb64
  ], !dbg !2246

sw.bb:                                            ; preds = %while.body
  %22 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2247
  %call16 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %22, %struct.AVCodec* null), !dbg !2249
  store %struct.AVStream* %call16, %struct.AVStream** %st, align 8, !dbg !2250
  %23 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2251
  %tobool17 = icmp ne %struct.AVStream* %23, null, !dbg !2251
  br i1 %tobool17, label %if.end19, label %if.then18, !dbg !2253

if.then18:                                        ; preds = %sw.bb
  store i32 -12, i32* %retval, align 4, !dbg !2254
  br label %return, !dbg !2254

if.end19:                                         ; preds = %sw.bb
  %24 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2255
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %24, i32 0, i32 19, !dbg !2256
  %25 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2256
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %25, i32 0, i32 0, !dbg !2257
  store i32 0, i32* %codec_type, align 8, !dbg !2258
  %26 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2259
  %pb20 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %26, i32 0, i32 4, !dbg !2260
  %27 = load %struct.AVIOContext*, %struct.AVIOContext** %pb20, align 8, !dbg !2260
  %call21 = call i64 @avio_skip(%struct.AVIOContext* %27, i64 4), !dbg !2261
  %28 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2262
  %pb22 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %28, i32 0, i32 4, !dbg !2263
  %29 = load %struct.AVIOContext*, %struct.AVIOContext** %pb22, align 8, !dbg !2263
  %call23 = call i32 @avio_rl32(%struct.AVIOContext* %29), !dbg !2264
  %30 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2265
  %codecpar24 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %30, i32 0, i32 19, !dbg !2266
  %31 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar24, align 8, !dbg !2266
  %width = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %31, i32 0, i32 11, !dbg !2267
  store i32 %call23, i32* %width, align 8, !dbg !2268
  %32 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2269
  %pb25 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %32, i32 0, i32 4, !dbg !2270
  %33 = load %struct.AVIOContext*, %struct.AVIOContext** %pb25, align 8, !dbg !2270
  %call26 = call i32 @avio_rl32(%struct.AVIOContext* %33), !dbg !2271
  %34 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2272
  %codecpar27 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %34, i32 0, i32 19, !dbg !2273
  %35 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar27, align 8, !dbg !2273
  %height = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %35, i32 0, i32 12, !dbg !2274
  store i32 %call26, i32* %height, align 4, !dbg !2275
  %36 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2276
  %pb28 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %36, i32 0, i32 4, !dbg !2277
  %37 = load %struct.AVIOContext*, %struct.AVIOContext** %pb28, align 8, !dbg !2277
  %call29 = call i64 @avio_skip(%struct.AVIOContext* %37, i64 4), !dbg !2278
  %38 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2279
  %pb30 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %38, i32 0, i32 4, !dbg !2280
  %39 = load %struct.AVIOContext*, %struct.AVIOContext** %pb30, align 8, !dbg !2280
  %call31 = call i32 @avio_rl32(%struct.AVIOContext* %39), !dbg !2281
  %40 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2282
  %codecpar32 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %40, i32 0, i32 19, !dbg !2283
  %41 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar32, align 8, !dbg !2283
  %codec_tag = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %41, i32 0, i32 2, !dbg !2284
  store i32 %call31, i32* %codec_tag, align 8, !dbg !2285
  %42 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2286
  %codecpar33 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %42, i32 0, i32 19, !dbg !2287
  %43 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar33, align 8, !dbg !2287
  %codec_tag34 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %43, i32 0, i32 2, !dbg !2288
  %44 = load i32, i32* %codec_tag34, align 8, !dbg !2288
  %call35 = call i32 @ff_codec_get_id(%struct.AVCodecTag* getelementptr inbounds ([0 x %struct.AVCodecTag], [0 x %struct.AVCodecTag]* @ff_codec_bmp_tags, i32 0, i32 0), i32 %44), !dbg !2289
  %45 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2290
  %codecpar36 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %45, i32 0, i32 19, !dbg !2291
  %46 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar36, align 8, !dbg !2291
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %46, i32 0, i32 1, !dbg !2292
  store i32 %call35, i32* %codec_id, align 4, !dbg !2293
  %47 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2294
  call void @avpriv_set_pts_info(%struct.AVStream* %47, i32 32, i32 1, i32 1000), !dbg !2295
  br label %sw.epilog, !dbg !2296

sw.bb37:                                          ; preds = %while.body
  %48 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2297
  %call38 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %48, %struct.AVCodec* null), !dbg !2298
  store %struct.AVStream* %call38, %struct.AVStream** %st, align 8, !dbg !2299
  %49 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2300
  %tobool39 = icmp ne %struct.AVStream* %49, null, !dbg !2300
  br i1 %tobool39, label %if.end41, label %if.then40, !dbg !2302
...
if.end41:                                         ; preds = %sw.bb37
  ...
  %codecpar42 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %50, i32 0, i32 19, !dbg !2305
  %51 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar42, align 8, !dbg !2305
  %codec_type43 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %51, i32 0, i32 0, !dbg !2306
  store i32 1, i32* %codec_type43, align 8, !dbg !2307
  %52 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2308
  %pb44 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %52, i32 0, i32 4, !dbg !2309
  %53 = load %struct.AVIOContext*, %struct.AVIOContext** %pb44, align 8, !dbg !2309
  %call45 = call i32 @avio_rl16(%struct.AVIOContext* %53), !dbg !2310
  %54 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2311
  %codecpar46 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %54, i32 0, i32 19, !dbg !2312
  %55 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar46, align 8, !dbg !2312
  %codec_tag47 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %55, i32 0, i32 2, !dbg !2313
  store i32 %call45, i32* %codec_tag47, align 8, !dbg !2314
  %56 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2315
  %pb48 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %56, i32 0, i32 4, !dbg !2316
  %57 = load %struct.AVIOContext*, %struct.AVIOContext** %pb48, align 8, !dbg !2316
  %call49 = call i32 @avio_rl16(%struct.AVIOContext* %57), !dbg !2317
  %58 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2318
  %codecpar50 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %58, i32 0, i32 19, !dbg !2319
  %59 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar50, align 8, !dbg !2319
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %59, i32 0, i32 22, !dbg !2320
  store i32 %call49, i32* %channels, align 8, !dbg !2321
  %60 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2322
  %pb51 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %60, i32 0, i32 4, !dbg !2323
  %61 = load %struct.AVIOContext*, %struct.AVIOContext** %pb51, align 8, !dbg !2323
  %call52 = call i32 @avio_rl16(%struct.AVIOContext* %61), !dbg !2324
  %62 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2325
  %codecpar53 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %62, i32 0, i32 19, !dbg !2326
  %63 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar53, align 8, !dbg !2326
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %63, i32 0, i32 23, !dbg !2327
  store i32 %call52, i32* %sample_rate, align 4, !dbg !2328
  %64 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2329
  %pb54 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %64, i32 0, i32 4, !dbg !2330
  %65 = load %struct.AVIOContext*, %struct.AVIOContext** %pb54, align 8, !dbg !2330
  %call55 = call i64 @avio_skip(%struct.AVIOContext* %65, i64 8), !dbg !2331
  %66 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2332
  %pb56 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %66, i32 0, i32 4, !dbg !2333
  %67 = load %struct.AVIOContext*, %struct.AVIOContext** %pb56, align 8, !dbg !2333
  %call57 = call i32 @avio_r8(%struct.AVIOContext* %67), !dbg !2334
  %68 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2335
  %codecpar58 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %68, i32 0, i32 19, !dbg !2336
  %69 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar58, align 8, !dbg !2336
  %bits_per_coded_sample = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %69, i32 0, i32 7, !dbg !2337
  store i32 %call57, i32* %bits_per_coded_sample, align 8, !dbg !2338
  %70 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2339
  %codecpar59 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %70, i32 0, i32 19, !dbg !2340
  %71 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar59, align 8, !dbg !2340
  %codec_tag60 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %71, i32 0, i32 2, !dbg !2341
  %72 = load i32, i32* %codec_tag60, align 8, !dbg !2341
  %call61 = call i32 @ff_codec_get_id(%struct.AVCodecTag* getelementptr inbounds ([0 x %struct.AVCodecTag], [0 x %struct.AVCodecTag]* @ff_codec_wav_tags, i32 0, i32 0), i32 %72), !dbg !2342
  %73 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2343
  %codecpar62 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %73, i32 0, i32 19, !dbg !2344
  %74 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar62, align 8, !dbg !2344
  %codec_id63 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %74, i32 0, i32 1, !dbg !2345
  store i32 %call61, i32* %codec_id63, align 4, !dbg !2346
  %75 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2347
  call void @avpriv_set_pts_info(%struct.AVStream* %75, i32 32, i32 1, i32 1000), !dbg !2348
  br label %sw.epilog, !dbg !2349

sw.bb64:                                          ; preds = %while.body
  %76 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2350
  %pb65 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %76, i32 0, i32 4, !dbg !2351
  %77 = load %struct.AVIOContext*, %struct.AVIOContext** %pb65, align 8, !dbg !2351
  %call66 = call i64 @avio_seek(%struct.AVIOContext* %77, i64 2056, i32 0), !dbg !2352
  store i32 0, i32* %retval, align 4, !dbg !2353
  br label %return, !dbg !2353

sw.default:                                       ; preds = %while.body
  %78 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2354
  %79 = bitcast %struct.AVFormatContext* %78 to i8*, !dbg !2354
  %80 = load i32, i32* %id, align 4, !dbg !2355
  call void (i8*, i8*, ...) @avpriv_request_sample(i8* %79, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i32 0, i32 0), i32 %80), !dbg !2356
  store i32 -1163346256, i32* %retval, align 4, !dbg !2357
  br label %return, !dbg !2357

sw.epilog:                                        ; preds = %if.end41, %if.end19
  %81 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2358
  %pb67 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %81, i32 0, i32 4, !dbg !2359
  %82 = load %struct.AVIOContext*, %struct.AVIOContext** %pb67, align 8, !dbg !2359
  %83 = load i64, i64* %next_offset, align 8, !dbg !2360
  %call68 = call i64 @avio_seek(%struct.AVIOContext* %82, i64 %83, i32 0), !dbg !2361
...
return:                                           ; preds = %while.end, %sw.default, %sw.bb64, %if.then40, %if.then18, %if.then3, %if.then
  %84 = load i32, i32* %retval, align 4, !dbg !2366
  ret i32 %84, !dbg !2366
}

; Function Attrs: nounwind uwtable
define internal i32 @lvf_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2367 {
entry:
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2180, metadata !2149), !dbg !2370
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  %is_video = alloca i32, align 4
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2372, metadata !2149), !dbg !2373
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2374, metadata !2149), !dbg !2375
  call void @llvm.dbg.declare(metadata i32* %size, metadata !2376, metadata !2149), !dbg !2377
  call void @llvm.dbg.declare(metadata i32* %flags, metadata !2378, metadata !2149), !dbg !2379
  call void @llvm.dbg.declare(metadata i32* %timestamp, metadata !2380, metadata !2149), !dbg !2381
  call void @llvm.dbg.declare(metadata i32* %id, metadata !2382, metadata !2149), !dbg !2383
  call void @llvm.dbg.declare(metadata i64* %pos, metadata !2384, metadata !2149), !dbg !2385
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2386, metadata !2149), !dbg !2387
  call void @llvm.dbg.declare(metadata i32* %is_video, metadata !2388, metadata !2149), !dbg !2389
  store i32 0, i32* %is_video, align 4, !dbg !2389
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2390
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2391
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2391
  store %struct.AVIOContext* %1, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2392
  %2 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2393
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %2, i64 0, i32 1) #3, !dbg !2394
  store i64 %call.i, i64* %pos, align 8, !dbg !2395
  br label %while.cond, !dbg !2396

while.cond:                                       ; preds = %if.end30, %entry
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2397
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %3, i32 0, i32 4, !dbg !2399
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2399
  %call2 = call i32 @avio_feof(%struct.AVIOContext* %4), !dbg !2400
  %tobool = icmp ne i32 %call2, 0, !dbg !2401
  %lnot = xor i1 %tobool, true, !dbg !2401
  br i1 %lnot, label %while.body, label %while.end, !dbg !2402

while.body:                                       ; preds = %while.cond
  %5 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2403
  %pb3 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %5, i32 0, i32 4, !dbg !2405
  %6 = load %struct.AVIOContext*, %struct.AVIOContext** %pb3, align 8, !dbg !2405
  %call4 = call i32 @avio_rl32(%struct.AVIOContext* %6), !dbg !2406
  store i32 %call4, i32* %id, align 4, !dbg !2407
  %7 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2408
  %pb5 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %7, i32 0, i32 4, !dbg !2409
  %8 = load %struct.AVIOContext*, %struct.AVIOContext** %pb5, align 8, !dbg !2409
  %call6 = call i32 @avio_rl32(%struct.AVIOContext* %8), !dbg !2410
  store i32 %call6, i32* %size, align 4, !dbg !2411
  %9 = load i32, i32* %size, align 4, !dbg !2412
  %cmp = icmp eq i32 %9, -1, !dbg !2414
  br i1 %cmp, label %if.then, label %if.end, !dbg !2415

if.then:                                          ; preds = %while.body
  store i32 -541478725, i32* %retval, align 4, !dbg !2416
  br label %return, !dbg !2416

if.end:                                           ; preds = %while.body
  %10 = load i32, i32* %id, align 4, !dbg !2417
  switch i32 %10, label %sw.default [
    i32 1667510320, label %sw.bb
    i32 1651978544, label %sw.bb7
  ], !dbg !2418

sw.bb:                                            ; preds = %if.end
  store i32 1, i32* %is_video, align 4, !dbg !2419
  br label %sw.bb7, !dbg !2421

sw.bb7:                                           ; preds = %if.end, %sw.bb
  %11 = load i32, i32* %size, align 4, !dbg !2422
  %cmp8 = icmp ult i32 %11, 8, !dbg !2424
  br i1 %cmp8, label %if.then9, label %if.end10, !dbg !2425
...
if.end10:                                         ; preds = %sw.bb7
  %12 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2427
  %pb11 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %12, i32 0, i32 4, !dbg !2428
  %13 = load %struct.AVIOContext*, %struct.AVIOContext** %pb11, align 8, !dbg !2428
  %call12 = call i32 @avio_rl32(%struct.AVIOContext* %13), !dbg !2429
  store i32 %call12, i32* %timestamp, align 4, !dbg !2430
  %14 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2431
  %pb13 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %14, i32 0, i32 4, !dbg !2432
  %15 = load %struct.AVIOContext*, %struct.AVIOContext** %pb13, align 8, !dbg !2432
  %call14 = call i32 @avio_rl32(%struct.AVIOContext* %15), !dbg !2433
  store i32 %call14, i32* %flags, align 4, !dbg !2434
  %16 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2435
  %pb15 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %16, i32 0, i32 4, !dbg !2436
  %17 = load %struct.AVIOContext*, %struct.AVIOContext** %pb15, align 8, !dbg !2436
  %18 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2437
  %19 = load i32, i32* %size, align 4, !dbg !2438
  %sub = sub i32 %19, 8, !dbg !2439
  %call16 = call i32 @av_get_packet(%struct.AVIOContext* %17, %struct.AVPacket* %18, i32 %sub), !dbg !2440
  store i32 %call16, i32* %ret, align 4, !dbg !2441
  %20 = load i32, i32* %flags, align 4, !dbg !2442
  %and = and i32 %20, 4096, !dbg !2444
  %tobool17 = icmp ne i32 %and, 0, !dbg !2444
  br i1 %tobool17, label %if.then18, label %if.end20, !dbg !2445

if.then18:                                        ; preds = %if.end10
  %21 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2446
  %flags19 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %21, i32 0, i32 6, !dbg !2447
  %22 = load i32, i32* %flags19, align 8, !dbg !2448
  %or = or i32 %22, 1, !dbg !2448
  store i32 %or, i32* %flags19, align 8, !dbg !2448
  br label %if.end20, !dbg !2446

if.end20:                                         ; preds = %if.then18, %if.end10
  %23 = load i32, i32* %is_video, align 4, !dbg !2449
  %tobool21 = icmp ne i32 %23, 0, !dbg !2449
  %cond = select i1 %tobool21, i32 0, i32 1, !dbg !2449
  %24 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2450
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %24, i32 0, i32 5, !dbg !2451
  store i32 %cond, i32* %stream_index, align 4, !dbg !2452
  %25 = load i32, i32* %timestamp, align 4, !dbg !2453
  %conv = zext i32 %25 to i64, !dbg !2453
  %26 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2454
  %pts = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %26, i32 0, i32 1, !dbg !2455
  store i64 %conv, i64* %pts, align 8, !dbg !2456
  %27 = load i64, i64* %pos, align 8, !dbg !2457
  %28 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2458
  %pos22 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %28, i32 0, i32 10, !dbg !2459
  store i64 %27, i64* %pos22, align 8, !dbg !2460
  %29 = load i32, i32* %ret, align 4, !dbg !2461
  store i32 %29, i32* %retval, align 4, !dbg !2462
  br label %return, !dbg !2462

sw.default:                                       ; preds = %if.end
  %30 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2463
  %pb23 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %30, i32 0, i32 4, !dbg !2464
  %31 = load %struct.AVIOContext*, %struct.AVIOContext** %pb23, align 8, !dbg !2464
  %32 = load i32, i32* %size, align 4, !dbg !2465
  %conv24 = zext i32 %32 to i64, !dbg !2465
  %call25 = call i64 @avio_skip(%struct.AVIOContext* %31, i64 %conv24), !dbg !2466
  %conv26 = trunc i64 %call25 to i32, !dbg !2466
  store i32 %conv26, i32* %ret, align 4, !dbg !2467
  br label %sw.epilog, !dbg !2468

sw.epilog:                                        ; preds = %sw.default
  %33 = load i32, i32* %ret, align 4, !dbg !2469
  %cmp27 = icmp slt i32 %33, 0, !dbg !2471
  br i1 %cmp27, label %if.then29, label %if.end30, !dbg !2472

if.then29:                                        ; preds = %sw.epilog
  %34 = load i32, i32* %ret, align 4, !dbg !2473
  store i32 %34, i32* %retval, align 4, !dbg !2474
  br label %return, !dbg !2474

if.end30:                                         ; preds = %sw.epilog
  br label %while.cond, !dbg !2475, !llvm.loop !2477

while.end:                                        ; preds = %while.cond
  store i32 -541478725, i32* %retval, align 4, !dbg !2478
  br label %return, !dbg !2478

return:                                           ; preds = %while.end, %if.then29, %if.end20, %if.then9, %if.then
  %35 = load i32, i32* %retval, align 4, !dbg !2479
  ret i32 %35, !dbg !2479
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--lvfdec.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!927 = !{!928}
!928 = distinct !DIGlobalVariable(name: "ff_lvf_demuxer", scope: !0, file: !929, line: 144, type: !930, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_lvf_demuxer)
!929 = !DIFile(filename: "libavformat/lvfdec.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2146 = distinct !DISubprogram(name: "lvf_probe", scope: !929, file: !929, line: 26, type: !999, isLocal: true, isDefinition: true, scopeLine: 27, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2147 = !{}
!2148 = !DILocalVariable(name: "p", arg: 1, scope: !2146, file: !929, line: 26, type: !1001)
!2149 = !DIExpression()
!2150 = !DILocation(line: 26, column: 35, scope: !2146)
!2151 = !DILocation(line: 28, column: 41, scope: !2152)
!2152 = distinct !DILexicalBlock(scope: !2146, file: !929, line: 28, column: 9)
!2153 = !DILocation(line: 28, column: 44, scope: !2152)
!2154 = !DILocation(line: 28, column: 51, scope: !2152)
!2155 = !DILocation(line: 28, column: 54, scope: !2152)
!2156 = !DILocation(line: 28, column: 9, scope: !2146)
!2157 = !DILocation(line: 29, column: 9, scope: !2152)
!2158 = !DILocation(line: 31, column: 42, scope: !2159)
!2159 = distinct !DILexicalBlock(scope: !2146, file: !929, line: 31, column: 9)
!2160 = !DILocation(line: 31, column: 45, scope: !2159)
!2161 = !DILocation(line: 31, column: 49, scope: !2159)
!2162 = !DILocation(line: 31, column: 57, scope: !2159)
!2163 = !DILocation(line: 31, column: 10, scope: !2159)
!2164 = !DILocation(line: 31, column: 60, scope: !2159)
!2165 = !DILocation(line: 31, column: 95, scope: !2166)
!2166 = !DILexicalBlockFile(scope: !2159, file: !929, discriminator: 1)
!2167 = !DILocation(line: 31, column: 98, scope: !2166)
!2168 = !DILocation(line: 31, column: 102, scope: !2166)
!2169 = !DILocation(line: 31, column: 110, scope: !2166)
!2170 = !DILocation(line: 31, column: 113, scope: !2166)
!2171 = !DILocation(line: 31, column: 9, scope: !2166)
!2172 = !DILocation(line: 32, column: 9, scope: !2159)
!2173 = !DILocation(line: 34, column: 5, scope: !2146)
!2174 = !DILocation(line: 35, column: 1, scope: !2146)
!2175 = distinct !DISubprogram(name: "lvf_read_header", scope: !929, file: !929, line: 37, type: !2176, isLocal: true, isDefinition: true, scopeLine: 38, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
...
!2180 = !DILocalVariable(name: "s", arg: 1, scope: !2181, file: !628, line: 557, type: !1222)
!2181 = distinct !DISubprogram(name: "avio_tell", scope: !628, file: !628, line: 557, type: !2182, isLocal: true, isDefinition: true, scopeLine: 558, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2182 = !DISubroutineType(types: !2183)
!2183 = !{!1060, !1222}
!2184 = !DILocation(line: 557, column: 77, scope: !2181, inlinedAt: !2185)
!2185 = distinct !DILocation(line: 57, column: 23, scope: !2186)
!2186 = distinct !DILexicalBlock(scope: !2175, file: !929, line: 54, column: 31)
!2187 = !DILocalVariable(name: "s", arg: 1, scope: !2175, file: !929, line: 37, type: !2178)
!2188 = !DILocation(line: 37, column: 45, scope: !2175)
!2189 = !DILocalVariable(name: "st", scope: !2175, file: !929, line: 39, type: !1290)
!2190 = !DILocation(line: 39, column: 15, scope: !2175)
!2191 = !DILocalVariable(name: "next_offset", scope: !2175, file: !929, line: 40, type: !1060)
!2192 = !DILocation(line: 40, column: 13, scope: !2175)
!2193 = !DILocalVariable(name: "size", scope: !2175, file: !929, line: 41, type: !925)
!2194 = !DILocation(line: 41, column: 14, scope: !2175)
!2195 = !DILocalVariable(name: "nb_streams", scope: !2175, file: !929, line: 41, type: !925)
!2196 = !DILocation(line: 41, column: 20, scope: !2175)
!2197 = !DILocalVariable(name: "id", scope: !2175, file: !929, line: 41, type: !925)
!2198 = !DILocation(line: 41, column: 32, scope: !2175)
!2199 = !DILocation(line: 43, column: 15, scope: !2175)
!2200 = !DILocation(line: 43, column: 18, scope: !2175)
!2201 = !DILocation(line: 43, column: 5, scope: !2175)
!2202 = !DILocation(line: 44, column: 28, scope: !2175)
!2203 = !DILocation(line: 44, column: 31, scope: !2175)
!2204 = !DILocation(line: 44, column: 18, scope: !2175)
!2205 = !DILocation(line: 44, column: 16, scope: !2175)
!2206 = !DILocation(line: 45, column: 10, scope: !2207)
!2207 = distinct !DILexicalBlock(scope: !2175, file: !929, line: 45, column: 9)
!2208 = !DILocation(line: 45, column: 9, scope: !2175)
!2209 = !DILocation(line: 46, column: 9, scope: !2207)
!2210 = !DILocation(line: 47, column: 9, scope: !2211)
!2211 = distinct !DILexicalBlock(scope: !2175, file: !929, line: 47, column: 9)
!2212 = !DILocation(line: 47, column: 20, scope: !2211)
!2213 = !DILocation(line: 47, column: 9, scope: !2175)
!2214 = !DILocation(line: 48, column: 31, scope: !2215)
!2215 = distinct !DILexicalBlock(scope: !2211, file: !929, line: 47, column: 25)
!2216 = !DILocation(line: 48, column: 48, scope: !2215)
!2217 = !DILocation(line: 48, column: 9, scope: !2215)
!2218 = !DILocation(line: 49, column: 9, scope: !2215)
!2219 = !DILocation(line: 52, column: 15, scope: !2175)
!2220 = !DILocation(line: 52, column: 18, scope: !2175)
!2221 = !DILocation(line: 52, column: 5, scope: !2175)
!2222 = !DILocation(line: 54, column: 5, scope: !2175)
!2223 = !DILocation(line: 54, column: 23, scope: !2224)
!2224 = !DILexicalBlockFile(scope: !2175, file: !929, discriminator: 1)
!2225 = !DILocation(line: 54, column: 26, scope: !2224)
!2226 = !DILocation(line: 54, column: 13, scope: !2224)
!2227 = !DILocation(line: 54, column: 12, scope: !2224)
!2228 = !DILocation(line: 54, column: 5, scope: !2224)
!2229 = !DILocation(line: 55, column: 24, scope: !2186)
!2230 = !DILocation(line: 55, column: 27, scope: !2186)
!2231 = !DILocation(line: 55, column: 14, scope: !2186)
!2232 = !DILocation(line: 55, column: 12, scope: !2186)
!2233 = !DILocation(line: 56, column: 26, scope: !2186)
!2234 = !DILocation(line: 56, column: 29, scope: !2186)
!2235 = !DILocation(line: 56, column: 16, scope: !2186)
!2236 = !DILocation(line: 56, column: 14, scope: !2186)
!2237 = !DILocation(line: 57, column: 33, scope: !2186)
!2238 = !DILocation(line: 57, column: 36, scope: !2186)
!2239 = !DILocation(line: 57, column: 23, scope: !2186)
!2240 = !DILocation(line: 559, column: 22, scope: !2181, inlinedAt: !2185)
!2241 = !DILocation(line: 559, column: 12, scope: !2181, inlinedAt: !2185)
!2242 = !DILocation(line: 57, column: 42, scope: !2186)
!2243 = !DILocation(line: 57, column: 40, scope: !2186)
!2244 = !DILocation(line: 57, column: 21, scope: !2186)
!2245 = !DILocation(line: 59, column: 17, scope: !2186)
!2246 = !DILocation(line: 59, column: 9, scope: !2186)
!2247 = !DILocation(line: 61, column: 38, scope: !2248)
!2248 = distinct !DILexicalBlock(scope: !2186, file: !929, line: 59, column: 21)
!2249 = !DILocation(line: 61, column: 18, scope: !2248)
!2250 = !DILocation(line: 61, column: 16, scope: !2248)
!2251 = !DILocation(line: 62, column: 18, scope: !2252)
!2252 = distinct !DILexicalBlock(scope: !2248, file: !929, line: 62, column: 17)
!2253 = !DILocation(line: 62, column: 17, scope: !2248)
!2254 = !DILocation(line: 63, column: 17, scope: !2252)
!2255 = !DILocation(line: 65, column: 13, scope: !2248)
!2256 = !DILocation(line: 65, column: 17, scope: !2248)
!2257 = !DILocation(line: 65, column: 27, scope: !2248)
!2258 = !DILocation(line: 65, column: 38, scope: !2248)
!2259 = !DILocation(line: 66, column: 23, scope: !2248)
!2260 = !DILocation(line: 66, column: 26, scope: !2248)
!2261 = !DILocation(line: 66, column: 13, scope: !2248)
!2262 = !DILocation(line: 67, column: 45, scope: !2248)
!2263 = !DILocation(line: 67, column: 48, scope: !2248)
!2264 = !DILocation(line: 67, column: 35, scope: !2248)
!2265 = !DILocation(line: 67, column: 13, scope: !2248)
!2266 = !DILocation(line: 67, column: 17, scope: !2248)
!2267 = !DILocation(line: 67, column: 27, scope: !2248)
!2268 = !DILocation(line: 67, column: 33, scope: !2248)
!2269 = !DILocation(line: 68, column: 46, scope: !2248)
!2270 = !DILocation(line: 68, column: 49, scope: !2248)
!2271 = !DILocation(line: 68, column: 36, scope: !2248)
!2272 = !DILocation(line: 68, column: 13, scope: !2248)
!2273 = !DILocation(line: 68, column: 17, scope: !2248)
!2274 = !DILocation(line: 68, column: 27, scope: !2248)
!2275 = !DILocation(line: 68, column: 34, scope: !2248)
!2276 = !DILocation(line: 69, column: 23, scope: !2248)
!2277 = !DILocation(line: 69, column: 26, scope: !2248)
!2278 = !DILocation(line: 69, column: 13, scope: !2248)
!2279 = !DILocation(line: 70, column: 49, scope: !2248)
!2280 = !DILocation(line: 70, column: 52, scope: !2248)
!2281 = !DILocation(line: 70, column: 39, scope: !2248)
!2282 = !DILocation(line: 70, column: 13, scope: !2248)
!2283 = !DILocation(line: 70, column: 17, scope: !2248)
!2284 = !DILocation(line: 70, column: 27, scope: !2248)
!2285 = !DILocation(line: 70, column: 37, scope: !2248)
!2286 = !DILocation(line: 72, column: 56, scope: !2248)
!2287 = !DILocation(line: 72, column: 60, scope: !2248)
!2288 = !DILocation(line: 72, column: 70, scope: !2248)
!2289 = !DILocation(line: 71, column: 38, scope: !2248)
!2290 = !DILocation(line: 71, column: 13, scope: !2248)
!2291 = !DILocation(line: 71, column: 17, scope: !2248)
!2292 = !DILocation(line: 71, column: 27, scope: !2248)
!2293 = !DILocation(line: 71, column: 36, scope: !2248)
!2294 = !DILocation(line: 73, column: 33, scope: !2248)
!2295 = !DILocation(line: 73, column: 13, scope: !2248)
!2296 = !DILocation(line: 74, column: 13, scope: !2248)
!2297 = !DILocation(line: 76, column: 38, scope: !2248)
!2298 = !DILocation(line: 76, column: 18, scope: !2248)
!2299 = !DILocation(line: 76, column: 16, scope: !2248)
!2300 = !DILocation(line: 77, column: 18, scope: !2301)
!2301 = distinct !DILexicalBlock(scope: !2248, file: !929, line: 77, column: 17)
!2302 = !DILocation(line: 77, column: 17, scope: !2248)
!2303 = !DILocation(line: 78, column: 17, scope: !2301)
!2304 = !DILocation(line: 80, column: 13, scope: !2248)
!2305 = !DILocation(line: 80, column: 17, scope: !2248)
!2306 = !DILocation(line: 80, column: 27, scope: !2248)
!2307 = !DILocation(line: 80, column: 38, scope: !2248)
!2308 = !DILocation(line: 81, column: 49, scope: !2248)
!2309 = !DILocation(line: 81, column: 52, scope: !2248)
!2310 = !DILocation(line: 81, column: 39, scope: !2248)
!2311 = !DILocation(line: 81, column: 13, scope: !2248)
!2312 = !DILocation(line: 81, column: 17, scope: !2248)
!2313 = !DILocation(line: 81, column: 27, scope: !2248)
!2314 = !DILocation(line: 81, column: 37, scope: !2248)
!2315 = !DILocation(line: 82, column: 48, scope: !2248)
!2316 = !DILocation(line: 82, column: 51, scope: !2248)
!2317 = !DILocation(line: 82, column: 38, scope: !2248)
!2318 = !DILocation(line: 82, column: 13, scope: !2248)
!2319 = !DILocation(line: 82, column: 17, scope: !2248)
!2320 = !DILocation(line: 82, column: 27, scope: !2248)
!2321 = !DILocation(line: 82, column: 36, scope: !2248)
!2322 = !DILocation(line: 83, column: 51, scope: !2248)
!2323 = !DILocation(line: 83, column: 54, scope: !2248)
!2324 = !DILocation(line: 83, column: 41, scope: !2248)
!2325 = !DILocation(line: 83, column: 13, scope: !2248)
!2326 = !DILocation(line: 83, column: 17, scope: !2248)
!2327 = !DILocation(line: 83, column: 27, scope: !2248)
!2328 = !DILocation(line: 83, column: 39, scope: !2248)
!2329 = !DILocation(line: 84, column: 23, scope: !2248)
!2330 = !DILocation(line: 84, column: 26, scope: !2248)
!2331 = !DILocation(line: 84, column: 13, scope: !2248)
!2332 = !DILocation(line: 85, column: 59, scope: !2248)
!2333 = !DILocation(line: 85, column: 62, scope: !2248)
!2334 = !DILocation(line: 85, column: 51, scope: !2248)
!2335 = !DILocation(line: 85, column: 13, scope: !2248)
!2336 = !DILocation(line: 85, column: 17, scope: !2248)
!2337 = !DILocation(line: 85, column: 27, scope: !2248)
!2338 = !DILocation(line: 85, column: 49, scope: !2248)
!2339 = !DILocation(line: 87, column: 57, scope: !2248)
!2340 = !DILocation(line: 87, column: 61, scope: !2248)
!2341 = !DILocation(line: 87, column: 71, scope: !2248)
!2342 = !DILocation(line: 86, column: 38, scope: !2248)
!2343 = !DILocation(line: 86, column: 13, scope: !2248)
!2344 = !DILocation(line: 86, column: 17, scope: !2248)
!2345 = !DILocation(line: 86, column: 27, scope: !2248)
!2346 = !DILocation(line: 86, column: 36, scope: !2248)
!2347 = !DILocation(line: 88, column: 33, scope: !2248)
!2348 = !DILocation(line: 88, column: 13, scope: !2248)
!2349 = !DILocation(line: 89, column: 13, scope: !2248)
!2350 = !DILocation(line: 91, column: 23, scope: !2248)
!2351 = !DILocation(line: 91, column: 26, scope: !2248)
!2352 = !DILocation(line: 91, column: 13, scope: !2248)
!2353 = !DILocation(line: 92, column: 13, scope: !2248)
!2354 = !DILocation(line: 94, column: 35, scope: !2248)
!2355 = !DILocation(line: 94, column: 47, scope: !2248)
!2356 = !DILocation(line: 94, column: 13, scope: !2248)
!2357 = !DILocation(line: 95, column: 13, scope: !2248)
!2358 = !DILocation(line: 98, column: 19, scope: !2186)
!2359 = !DILocation(line: 98, column: 22, scope: !2186)
!2360 = !DILocation(line: 98, column: 26, scope: !2186)
!2361 = !DILocation(line: 98, column: 9, scope: !2186)
!2362 = !DILocation(line: 54, column: 5, scope: !2363)
!2363 = !DILexicalBlockFile(scope: !2175, file: !929, discriminator: 2)
!2364 = distinct !{!2364, !2222}
!2365 = !DILocation(line: 101, column: 5, scope: !2175)
!2366 = !DILocation(line: 102, column: 1, scope: !2175)
!2367 = distinct !DISubprogram(name: "lvf_read_packet", scope: !929, file: !929, line: 104, type: !2368, isLocal: true, isDefinition: true, scopeLine: 105, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2368 = !DISubroutineType(types: !2369)
!2369 = !{!926, !2178, !1041}
!2370 = !DILocation(line: 557, column: 77, scope: !2181, inlinedAt: !2371)
!2371 = distinct !DILocation(line: 110, column: 11, scope: !2367)
!2372 = !DILocalVariable(name: "s", arg: 1, scope: !2367, file: !929, line: 104, type: !2178)
!2373 = !DILocation(line: 104, column: 45, scope: !2367)
!2374 = !DILocalVariable(name: "pkt", arg: 2, scope: !2367, file: !929, line: 104, type: !1041)
!2375 = !DILocation(line: 104, column: 58, scope: !2367)
!2376 = !DILocalVariable(name: "size", scope: !2367, file: !929, line: 106, type: !925)
!2377 = !DILocation(line: 106, column: 14, scope: !2367)
!2378 = !DILocalVariable(name: "flags", scope: !2367, file: !929, line: 106, type: !925)
!2379 = !DILocation(line: 106, column: 20, scope: !2367)
!2380 = !DILocalVariable(name: "timestamp", scope: !2367, file: !929, line: 106, type: !925)
!2381 = !DILocation(line: 106, column: 27, scope: !2367)
!2382 = !DILocalVariable(name: "id", scope: !2367, file: !929, line: 106, type: !925)
!2383 = !DILocation(line: 106, column: 38, scope: !2367)
!2384 = !DILocalVariable(name: "pos", scope: !2367, file: !929, line: 107, type: !1060)
!2385 = !DILocation(line: 107, column: 13, scope: !2367)
!2386 = !DILocalVariable(name: "ret", scope: !2367, file: !929, line: 108, type: !926)
!2387 = !DILocation(line: 108, column: 9, scope: !2367)
!2388 = !DILocalVariable(name: "is_video", scope: !2367, file: !929, line: 108, type: !926)
!2389 = !DILocation(line: 108, column: 14, scope: !2367)
!2390 = !DILocation(line: 110, column: 21, scope: !2367)
!2391 = !DILocation(line: 110, column: 24, scope: !2367)
!2392 = !DILocation(line: 110, column: 11, scope: !2367)
!2393 = !DILocation(line: 559, column: 22, scope: !2181, inlinedAt: !2371)
!2394 = !DILocation(line: 559, column: 12, scope: !2181, inlinedAt: !2371)
!2395 = !DILocation(line: 110, column: 9, scope: !2367)
!2396 = !DILocation(line: 111, column: 5, scope: !2367)
!2397 = !DILocation(line: 111, column: 23, scope: !2398)
!2398 = !DILexicalBlockFile(scope: !2367, file: !929, discriminator: 1)
!2399 = !DILocation(line: 111, column: 26, scope: !2398)
!2400 = !DILocation(line: 111, column: 13, scope: !2398)
!2401 = !DILocation(line: 111, column: 12, scope: !2398)
!2402 = !DILocation(line: 111, column: 5, scope: !2398)
!2403 = !DILocation(line: 112, column: 24, scope: !2404)
!2404 = distinct !DILexicalBlock(scope: !2367, file: !929, line: 111, column: 31)
!2405 = !DILocation(line: 112, column: 27, scope: !2404)
!2406 = !DILocation(line: 112, column: 14, scope: !2404)
!2407 = !DILocation(line: 112, column: 12, scope: !2404)
!2408 = !DILocation(line: 113, column: 26, scope: !2404)
!2409 = !DILocation(line: 113, column: 29, scope: !2404)
!2410 = !DILocation(line: 113, column: 16, scope: !2404)
!2411 = !DILocation(line: 113, column: 14, scope: !2404)
!2412 = !DILocation(line: 115, column: 13, scope: !2413)
!2413 = distinct !DILexicalBlock(scope: !2404, file: !929, line: 115, column: 13)
!2414 = !DILocation(line: 115, column: 18, scope: !2413)
!2415 = !DILocation(line: 115, column: 13, scope: !2404)
!2416 = !DILocation(line: 116, column: 13, scope: !2413)
!2417 = !DILocation(line: 118, column: 17, scope: !2404)
!2418 = !DILocation(line: 118, column: 9, scope: !2404)
!2419 = !DILocation(line: 120, column: 22, scope: !2420)
!2420 = distinct !DILexicalBlock(scope: !2404, file: !929, line: 118, column: 21)
!2421 = !DILocation(line: 120, column: 13, scope: !2420)
!2422 = !DILocation(line: 122, column: 17, scope: !2423)
!2423 = distinct !DILexicalBlock(scope: !2420, file: !929, line: 122, column: 17)
!2424 = !DILocation(line: 122, column: 22, scope: !2423)
!2425 = !DILocation(line: 122, column: 17, scope: !2420)
!2426 = !DILocation(line: 123, column: 17, scope: !2423)
!2427 = !DILocation(line: 124, column: 35, scope: !2420)
!2428 = !DILocation(line: 124, column: 38, scope: !2420)
!2429 = !DILocation(line: 124, column: 25, scope: !2420)
!2430 = !DILocation(line: 124, column: 23, scope: !2420)
!2431 = !DILocation(line: 125, column: 31, scope: !2420)
!2432 = !DILocation(line: 125, column: 34, scope: !2420)
!2433 = !DILocation(line: 125, column: 21, scope: !2420)
!2434 = !DILocation(line: 125, column: 19, scope: !2420)
!2435 = !DILocation(line: 126, column: 33, scope: !2420)
!2436 = !DILocation(line: 126, column: 36, scope: !2420)
!2437 = !DILocation(line: 126, column: 40, scope: !2420)
!2438 = !DILocation(line: 126, column: 45, scope: !2420)
!2439 = !DILocation(line: 126, column: 50, scope: !2420)
!2440 = !DILocation(line: 126, column: 19, scope: !2420)
!2441 = !DILocation(line: 126, column: 17, scope: !2420)
!2442 = !DILocation(line: 127, column: 17, scope: !2443)
!2443 = distinct !DILexicalBlock(scope: !2420, file: !929, line: 127, column: 17)
!2444 = !DILocation(line: 127, column: 23, scope: !2443)
!2445 = !DILocation(line: 127, column: 17, scope: !2420)
!2446 = !DILocation(line: 128, column: 17, scope: !2443)
!2447 = !DILocation(line: 128, column: 22, scope: !2443)
!2448 = !DILocation(line: 128, column: 28, scope: !2443)
!2449 = !DILocation(line: 129, column: 33, scope: !2420)
!2450 = !DILocation(line: 129, column: 13, scope: !2420)
!2451 = !DILocation(line: 129, column: 18, scope: !2420)
!2452 = !DILocation(line: 129, column: 31, scope: !2420)
!2453 = !DILocation(line: 130, column: 24, scope: !2420)
!2454 = !DILocation(line: 130, column: 13, scope: !2420)
!2455 = !DILocation(line: 130, column: 18, scope: !2420)
!2456 = !DILocation(line: 130, column: 22, scope: !2420)
!2457 = !DILocation(line: 131, column: 24, scope: !2420)
!2458 = !DILocation(line: 131, column: 13, scope: !2420)
!2459 = !DILocation(line: 131, column: 18, scope: !2420)
!2460 = !DILocation(line: 131, column: 22, scope: !2420)
!2461 = !DILocation(line: 132, column: 20, scope: !2420)
!2462 = !DILocation(line: 132, column: 13, scope: !2420)
!2463 = !DILocation(line: 134, column: 29, scope: !2420)
!2464 = !DILocation(line: 134, column: 32, scope: !2420)
!2465 = !DILocation(line: 134, column: 36, scope: !2420)
!2466 = !DILocation(line: 134, column: 19, scope: !2420)
!2467 = !DILocation(line: 134, column: 17, scope: !2420)
!2468 = !DILocation(line: 135, column: 9, scope: !2420)
!2469 = !DILocation(line: 137, column: 13, scope: !2470)
!2470 = distinct !DILexicalBlock(scope: !2404, file: !929, line: 137, column: 13)
!2471 = !DILocation(line: 137, column: 17, scope: !2470)
!2472 = !DILocation(line: 137, column: 13, scope: !2404)
!2473 = !DILocation(line: 138, column: 20, scope: !2470)
!2474 = !DILocation(line: 138, column: 13, scope: !2470)
!2475 = !DILocation(line: 111, column: 5, scope: !2476)
!2476 = !DILexicalBlockFile(scope: !2367, file: !929, discriminator: 2)
!2477 = distinct !{!2477, !2396}
!2478 = !DILocation(line: 141, column: 5, scope: !2367)
!2479 = !DILocation(line: 142, column: 1, scope: !2367)
