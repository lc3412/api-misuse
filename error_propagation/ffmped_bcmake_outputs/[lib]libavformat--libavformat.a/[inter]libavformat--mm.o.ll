; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--mm.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--mm.o.i"
...
%struct.MmDemuxContext = type { i32, i32 }
...
@ff_mm_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.1, i32 0, i32 0), i32 0, i8* null, %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 8, i32 (%struct.AVProbeData*)* @probe, i32 (%struct.AVFormatContext*)* @read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
...
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %len, metadata !2156, metadata !2154), !dbg !2157
  call void @llvm.dbg.declare(metadata i32* %type, metadata !2158, metadata !2154), !dbg !2159
  call void @llvm.dbg.declare(metadata i32* %fps, metadata !2160, metadata !2154), !dbg !2161
  call void @llvm.dbg.declare(metadata i32* %w, metadata !2162, metadata !2154), !dbg !2163
  call void @llvm.dbg.declare(metadata i32* %h, metadata !2164, metadata !2154), !dbg !2165
  %0 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2166
  %buf_size = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %0, i32 0, i32 2, !dbg !2168
  %1 = load i32, i32* %buf_size, align 8, !dbg !2168
  %cmp = icmp slt i32 %1, 30, !dbg !2169
...
if.end:                                           ; preds = %entry
  ...
  %arrayidx = getelementptr inbounds i8, i8* %3, i64 0, !dbg !2172
  %4 = bitcast i8* %arrayidx to %union.unaligned_16*, !dbg !2175
  %l = bitcast %union.unaligned_16* %4 to i16*, !dbg !2175
  %5 = load i16, i16* %l, align 1, !dbg !2175
  %conv = zext i16 %5 to i32, !dbg !2176
  %cmp1 = icmp ne i32 %conv, 0, !dbg !2177
  br i1 %cmp1, label %if.then3, label %if.end4, !dbg !2178
...
if.end4:                                          ; preds = %if.end
  ...
  %buf5 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %6, i32 0, i32 1, !dbg !2181
  %7 = load i8*, i8** %buf5, align 8, !dbg !2181
  %arrayidx6 = getelementptr inbounds i8, i8* %7, i64 2, !dbg !2180
  %8 = bitcast i8* %arrayidx6 to %union.unaligned_32*, !dbg !2182
  %l7 = bitcast %union.unaligned_32* %8 to i32*, !dbg !2182
  %9 = load i32, i32* %l7, align 1, !dbg !2182
  store i32 %9, i32* %len, align 4, !dbg !2183
  %10 = load i32, i32* %len, align 4, !dbg !2184
  %cmp8 = icmp ne i32 %10, 22, !dbg !2186
  br i1 %cmp8, label %land.lhs.true, label %if.end13, !dbg !2187

land.lhs.true:                                    ; preds = %if.end4
  %11 = load i32, i32* %len, align 4, !dbg !2188
  %cmp10 = icmp ne i32 %11, 24, !dbg !2190
  br i1 %cmp10, label %if.then12, label %if.end13, !dbg !2191
...
if.end13:                                         ; preds = %land.lhs.true, %if.end4
  %12 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2193
  %buf14 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %12, i32 0, i32 1, !dbg !2194
  %13 = load i8*, i8** %buf14, align 8, !dbg !2194
  %arrayidx15 = getelementptr inbounds i8, i8* %13, i64 8, !dbg !2193
  %14 = bitcast i8* %arrayidx15 to %union.unaligned_16*, !dbg !2195
  %l16 = bitcast %union.unaligned_16* %14 to i16*, !dbg !2195
  %15 = load i16, i16* %l16, align 1, !dbg !2195
  %conv17 = zext i16 %15 to i32, !dbg !2196
  store i32 %conv17, i32* %fps, align 4, !dbg !2197
  %16 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2198
  %buf18 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %16, i32 0, i32 1, !dbg !2199
  %17 = load i8*, i8** %buf18, align 8, !dbg !2199
  %arrayidx19 = getelementptr inbounds i8, i8* %17, i64 12, !dbg !2198
  %18 = bitcast i8* %arrayidx19 to %union.unaligned_16*, !dbg !2200
  %l20 = bitcast %union.unaligned_16* %18 to i16*, !dbg !2200
  %19 = load i16, i16* %l20, align 1, !dbg !2200
  %conv21 = zext i16 %19 to i32, !dbg !2201
  store i32 %conv21, i32* %w, align 4, !dbg !2202
  %20 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2203
  %buf22 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %20, i32 0, i32 1, !dbg !2204
  %21 = load i8*, i8** %buf22, align 8, !dbg !2204
  %arrayidx23 = getelementptr inbounds i8, i8* %21, i64 14, !dbg !2203
  %22 = bitcast i8* %arrayidx23 to %union.unaligned_16*, !dbg !2205
  %l24 = bitcast %union.unaligned_16* %22 to i16*, !dbg !2205
  %23 = load i16, i16* %l24, align 1, !dbg !2205
  %conv25 = zext i16 %23 to i32, !dbg !2206
  store i32 %conv25, i32* %h, align 4, !dbg !2207
  %24 = load i32, i32* %fps, align 4, !dbg !2208
  %tobool = icmp ne i32 %24, 0, !dbg !2208
  br i1 %tobool, label %lor.lhs.false, label %if.then38, !dbg !2210

lor.lhs.false:                                    ; preds = %if.end13
  %25 = load i32, i32* %fps, align 4, !dbg !2211
  %cmp26 = icmp sgt i32 %25, 60, !dbg !2213
  br i1 %cmp26, label %if.then38, label %lor.lhs.false28, !dbg !2214

lor.lhs.false28:                                  ; preds = %lor.lhs.false
  %26 = load i32, i32* %w, align 4, !dbg !2215
  %tobool29 = icmp ne i32 %26, 0, !dbg !2215
  br i1 %tobool29, label %lor.lhs.false30, label %if.then38, !dbg !2217

lor.lhs.false30:                                  ; preds = %lor.lhs.false28
  %27 = load i32, i32* %w, align 4, !dbg !2218
  %cmp31 = icmp sgt i32 %27, 2048, !dbg !2220
  br i1 %cmp31, label %if.then38, label %lor.lhs.false33, !dbg !2221

lor.lhs.false33:                                  ; preds = %lor.lhs.false30
  %28 = load i32, i32* %h, align 4, !dbg !2222
  %tobool34 = icmp ne i32 %28, 0, !dbg !2222
  br i1 %tobool34, label %lor.lhs.false35, label %if.then38, !dbg !2224

lor.lhs.false35:                                  ; preds = %lor.lhs.false33
  %29 = load i32, i32* %h, align 4, !dbg !2225
  %cmp36 = icmp sgt i32 %29, 2048, !dbg !2227
  br i1 %cmp36, label %if.then38, label %if.end39, !dbg !2228

if.then38:                                        ; preds = %lor.lhs.false35, %lor.lhs.false33, %lor.lhs.false30, %lor.lhs.false28, %lor.lhs.false, %if.end13
  store i32 0, i32* %retval, align 4, !dbg !2229
  br label %return, !dbg !2229

if.end39:                                         ; preds = %lor.lhs.false35
  %30 = load i32, i32* %len, align 4, !dbg !2230
  %idxprom = sext i32 %30 to i64, !dbg !2231
  %31 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2231
  %buf40 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %31, i32 0, i32 1, !dbg !2232
  %32 = load i8*, i8** %buf40, align 8, !dbg !2232
  %arrayidx41 = getelementptr inbounds i8, i8* %32, i64 %idxprom, !dbg !2231
  %33 = bitcast i8* %arrayidx41 to %union.unaligned_16*, !dbg !2233
  %l42 = bitcast %union.unaligned_16* %33 to i16*, !dbg !2233
  %34 = load i16, i16* %l42, align 1, !dbg !2233
  %conv43 = zext i16 %34 to i32, !dbg !2234
  store i32 %conv43, i32* %type, align 4, !dbg !2235
  %35 = load i32, i32* %type, align 4, !dbg !2236
  %tobool44 = icmp ne i32 %35, 0, !dbg !2236
  br i1 %tobool44, label %lor.lhs.false45, label %if.then48, !dbg !2238

lor.lhs.false45:                                  ; preds = %if.end39
  %36 = load i32, i32* %type, align 4, !dbg !2239
  %cmp46 = icmp sgt i32 %36, 49, !dbg !2241
  br i1 %cmp46, label %if.then48, label %if.end49, !dbg !2242

if.then48:                                        ; preds = %lor.lhs.false45, %if.end39
  store i32 0, i32* %retval, align 4, !dbg !2243
  br label %return, !dbg !2243

if.end49:                                         ; preds = %lor.lhs.false45
  store i32 50, i32* %retval, align 4, !dbg !2244
  br label %return, !dbg !2244

return:                                           ; preds = %if.end49, %if.then48, %if.then38, %if.then12, %if.then3, %if.then
  %37 = load i32, i32* %retval, align 4, !dbg !2245
  ret i32 %37, !dbg !2245
}

; Function Attrs: nounwind uwtable
define internal i32 @read_header(%struct.AVFormatContext* %s) #0 !dbg !2246 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %mm = alloca %struct.MmDemuxContext*, align 8
  ...
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2251, metadata !2154), !dbg !2252
  call void @llvm.dbg.declare(metadata %struct.MmDemuxContext** %mm, metadata !2253, metadata !2154), !dbg !2260
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2261
  %priv_data = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 3, !dbg !2262
  %1 = load i8*, i8** %priv_data, align 8, !dbg !2262
  %2 = bitcast i8* %1 to %struct.MmDemuxContext*, !dbg !2261
  store %struct.MmDemuxContext* %2, %struct.MmDemuxContext** %mm, align 8, !dbg !2260
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2263, metadata !2154), !dbg !2264
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2265
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %3, i32 0, i32 4, !dbg !2266
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2266
  store %struct.AVIOContext* %4, %struct.AVIOContext** %pb, align 8, !dbg !2264
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2267, metadata !2154), !dbg !2268
  call void @llvm.dbg.declare(metadata i32* %type, metadata !2269, metadata !2154), !dbg !2270
  call void @llvm.dbg.declare(metadata i32* %length, metadata !2271, metadata !2154), !dbg !2272
  call void @llvm.dbg.declare(metadata i32* %frame_rate, metadata !2273, metadata !2154), !dbg !2274
  call void @llvm.dbg.declare(metadata i32* %width, metadata !2275, metadata !2154), !dbg !2276
  call void @llvm.dbg.declare(metadata i32* %height, metadata !2277, metadata !2154), !dbg !2278
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2279
  %call = call i32 @avio_rl16(%struct.AVIOContext* %5), !dbg !2280
  store i32 %call, i32* %type, align 4, !dbg !2281
  %6 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2282
  %call2 = call i32 @avio_rl32(%struct.AVIOContext* %6), !dbg !2283
  store i32 %call2, i32* %length, align 4, !dbg !2284
  %7 = load i32, i32* %type, align 4, !dbg !2285
  %cmp = icmp ne i32 %7, 0, !dbg !2287
...
if.end:                                           ; preds = %entry
  %8 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2290
  %call3 = call i32 @avio_rl16(%struct.AVIOContext* %8), !dbg !2291
  %9 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2292
  %call4 = call i32 @avio_rl16(%struct.AVIOContext* %9), !dbg !2293
  store i32 %call4, i32* %frame_rate, align 4, !dbg !2294
  %10 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2295
  %call5 = call i32 @avio_rl16(%struct.AVIOContext* %10), !dbg !2296
  %11 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2297
  %call6 = call i32 @avio_rl16(%struct.AVIOContext* %11), !dbg !2298
  store i32 %call6, i32* %width, align 4, !dbg !2299
  %12 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2300
  %call7 = call i32 @avio_rl16(%struct.AVIOContext* %12), !dbg !2301
  store i32 %call7, i32* %height, align 4, !dbg !2302
  %13 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2303
  %14 = load i32, i32* %length, align 4, !dbg !2304
  %sub = sub i32 %14, 10, !dbg !2305
  %conv = zext i32 %sub to i64, !dbg !2304
  %call8 = call i64 @avio_skip(%struct.AVIOContext* %13, i64 %conv), !dbg !2306
  %15 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2307
  %call9 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %15, %struct.AVCodec* null), !dbg !2308
  store %struct.AVStream* %call9, %struct.AVStream** %st, align 8, !dbg !2309
  %16 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2310
  %tobool = icmp ne %struct.AVStream* %16, null, !dbg !2310
  br i1 %tobool, label %if.end11, label %if.then10, !dbg !2312
...
if.end11:                                         ; preds = %if.end
  %17 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2314
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %17, i32 0, i32 19, !dbg !2315
  %18 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2315
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %18, i32 0, i32 0, !dbg !2316
  ...
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %20, i32 0, i32 1, !dbg !2320
  store i32 80, i32* %codec_id, align 4, !dbg !2321
  %21 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2322
  %codecpar13 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %21, i32 0, i32 19, !dbg !2323
  %22 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar13, align 8, !dbg !2323
  %codec_tag = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %22, i32 0, i32 2, !dbg !2324
  store i32 0, i32* %codec_tag, align 8, !dbg !2325
  %23 = load i32, i32* %width, align 4, !dbg !2326
  %24 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2327
  %codecpar14 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %24, i32 0, i32 19, !dbg !2328
  %25 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar14, align 8, !dbg !2328
  %width15 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %25, i32 0, i32 11, !dbg !2329
  store i32 %23, i32* %width15, align 8, !dbg !2330
  %26 = load i32, i32* %height, align 4, !dbg !2331
  %27 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2332
  %codecpar16 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %27, i32 0, i32 19, !dbg !2333
  %28 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar16, align 8, !dbg !2333
  %height17 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %28, i32 0, i32 12, !dbg !2334
  store i32 %26, i32* %height17, align 4, !dbg !2335
  %29 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2336
  %30 = load i32, i32* %frame_rate, align 4, !dbg !2337
  call void @avpriv_set_pts_info(%struct.AVStream* %29, i32 64, i32 1, i32 %30), !dbg !2338
  %31 = load i32, i32* %length, align 4, !dbg !2339
  %cmp18 = icmp eq i32 %31, 24, !dbg !2341
  br i1 %cmp18, label %if.then20, label %if.end34, !dbg !2342

if.then20:                                        ; preds = %if.end11
  %32 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2343
  %call21 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %32, %struct.AVCodec* null), !dbg !2345
  store %struct.AVStream* %call21, %struct.AVStream** %st, align 8, !dbg !2346
  %33 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2347
  %tobool22 = icmp ne %struct.AVStream* %33, null, !dbg !2347
  br i1 %tobool22, label %if.end24, label %if.then23, !dbg !2349
...
if.end24:                                         ; preds = %if.then20
  %34 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2351
  %codecpar25 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %34, i32 0, i32 19, !dbg !2352
  %35 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar25, align 8, !dbg !2352
  %codec_type26 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %35, i32 0, i32 0, !dbg !2353
  store i32 1, i32* %codec_type26, align 8, !dbg !2354
  %36 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2355
  %codecpar27 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %36, i32 0, i32 19, !dbg !2356
  %37 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar27, align 8, !dbg !2356
  %codec_tag28 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %37, i32 0, i32 2, !dbg !2357
  store i32 0, i32* %codec_tag28, align 8, !dbg !2358
  %38 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2359
  %codecpar29 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %38, i32 0, i32 19, !dbg !2360
  %39 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar29, align 8, !dbg !2360
  %codec_id30 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %39, i32 0, i32 1, !dbg !2361
  store i32 65541, i32* %codec_id30, align 4, !dbg !2362
  %40 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2363
  %codecpar31 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %40, i32 0, i32 19, !dbg !2364
  %41 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar31, align 8, !dbg !2364
  %channels = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %41, i32 0, i32 22, !dbg !2365
  store i32 1, i32* %channels, align 8, !dbg !2366
  %42 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2367
  %codecpar32 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %42, i32 0, i32 19, !dbg !2368
  %43 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar32, align 8, !dbg !2368
  %channel_layout = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %43, i32 0, i32 21, !dbg !2369
  store i64 4, i64* %channel_layout, align 8, !dbg !2370
  %44 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2371
  %codecpar33 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %44, i32 0, i32 19, !dbg !2372
  %45 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar33, align 8, !dbg !2372
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %45, i32 0, i32 23, !dbg !2373
  store i32 8000, i32* %sample_rate, align 4, !dbg !2374
  %46 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2375
  call void @avpriv_set_pts_info(%struct.AVStream* %46, i32 64, i32 1, i32 8000), !dbg !2376
  br label %if.end34, !dbg !2377

if.end34:                                         ; preds = %if.end24, %if.end11
  %47 = load %struct.MmDemuxContext*, %struct.MmDemuxContext** %mm, align 8, !dbg !2378
  %audio_pts = getelementptr inbounds %struct.MmDemuxContext, %struct.MmDemuxContext* %47, i32 0, i32 0, !dbg !2379
  store i32 0, i32* %audio_pts, align 4, !dbg !2380
  %48 = load %struct.MmDemuxContext*, %struct.MmDemuxContext** %mm, align 8, !dbg !2381
  %video_pts = getelementptr inbounds %struct.MmDemuxContext, %struct.MmDemuxContext* %48, i32 0, i32 1, !dbg !2382
  store i32 0, i32* %video_pts, align 4, !dbg !2383
  store i32 0, i32* %retval, align 4, !dbg !2384
  br label %return, !dbg !2384

return:                                           ; preds = %if.end34, %if.then23, %if.then10, %if.then
  %49 = load i32, i32* %retval, align 4, !dbg !2385
  ret i32 %49, !dbg !2385
}

; Function Attrs: nounwind uwtable
define internal i32 @read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2386 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  %length = alloca i32, align 4
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2389, metadata !2154), !dbg !2390
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2391, metadata !2154), !dbg !2392
  call void @llvm.dbg.declare(metadata %struct.MmDemuxContext** %mm, metadata !2393, metadata !2154), !dbg !2394
  ...
  %2 = bitcast i8* %1 to %struct.MmDemuxContext*, !dbg !2395
  store %struct.MmDemuxContext* %2, %struct.MmDemuxContext** %mm, align 8, !dbg !2394
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2397, metadata !2154), !dbg !2398
  ...
  call void @llvm.dbg.declare(metadata [6 x i8]* %preamble, metadata !2401, metadata !2154), !dbg !2405
  call void @llvm.dbg.declare(metadata i32* %type, metadata !2406, metadata !2154), !dbg !2407
  call void @llvm.dbg.declare(metadata i32* %length, metadata !2408, metadata !2154), !dbg !2409
  br label %while.body, !dbg !2410

while.body:                                       ; preds = %entry, %sw.epilog
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2411
  %arraydecay = getelementptr inbounds [6 x i8], [6 x i8]* %preamble, i32 0, i32 0, !dbg !2414
  %call = call i32 @avio_read(%struct.AVIOContext* %5, i8* %arraydecay, i32 6), !dbg !2415
  %cmp = icmp ne i32 %call, 6, !dbg !2416
  br i1 %cmp, label %if.then, label %if.end, !dbg !2417

if.then:                                          ; preds = %while.body
  store i32 -5, i32* %retval, align 4, !dbg !2418
  br label %return, !dbg !2418

if.end:                                           ; preds = %while.body
  %arrayidx = getelementptr inbounds [6 x i8], [6 x i8]* %preamble, i64 0, i64 0, !dbg !2420
  %6 = bitcast i8* %arrayidx to %union.unaligned_16*, !dbg !2421
  %l = bitcast %union.unaligned_16* %6 to i16*, !dbg !2421
  %7 = load i16, i16* %l, align 1, !dbg !2421
  %conv = zext i16 %7 to i32, !dbg !2422
  store i32 %conv, i32* %type, align 4, !dbg !2423
  %arrayidx2 = getelementptr inbounds [6 x i8], [6 x i8]* %preamble, i64 0, i64 2, !dbg !2424
  %8 = bitcast i8* %arrayidx2 to %union.unaligned_16*, !dbg !2425
  %l3 = bitcast %union.unaligned_16* %8 to i16*, !dbg !2425
  %9 = load i16, i16* %l3, align 1, !dbg !2425
  %conv4 = zext i16 %9 to i32, !dbg !2426
  store i32 %conv4, i32* %length, align 4, !dbg !2427
  %10 = load i32, i32* %type, align 4, !dbg !2428
...
sw.bb:                                            ; preds = %if.end, %if.end, %if.end, %if.end, %if.end, %if.end, %if.end
  %11 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2430
  %12 = load i32, i32* %length, align 4, !dbg !2433
  %add = add i32 %12, 6, !dbg !2434
  %call5 = call i32 @av_new_packet(%struct.AVPacket* %11, i32 %add), !dbg !2435
  %tobool = icmp ne i32 %call5, 0, !dbg !2435
  br i1 %tobool, label %if.then6, label %if.end7, !dbg !2436

if.then6:                                         ; preds = %sw.bb
  store i32 -12, i32* %retval, align 4, !dbg !2437
  br label %return, !dbg !2437

if.end7:                                          ; preds = %sw.bb
  %13 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2438
  %data = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %13, i32 0, i32 3, !dbg !2439
  %14 = load i8*, i8** %data, align 8, !dbg !2439
  %arraydecay8 = getelementptr inbounds [6 x i8], [6 x i8]* %preamble, i32 0, i32 0, !dbg !2440
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %14, i8* %arraydecay8, i64 6, i32 1, i1 false), !dbg !2440
  %15 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2441
  %16 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2443
  %data9 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %16, i32 0, i32 3, !dbg !2444
  %17 = load i8*, i8** %data9, align 8, !dbg !2444
  %add.ptr = getelementptr inbounds i8, i8* %17, i64 6, !dbg !2445
  %18 = load i32, i32* %length, align 4, !dbg !2446
  %call10 = call i32 @avio_read(%struct.AVIOContext* %15, i8* %add.ptr, i32 %18), !dbg !2447
  %19 = load i32, i32* %length, align 4, !dbg !2448
  %cmp11 = icmp ne i32 %call10, %19, !dbg !2449
  br i1 %cmp11, label %if.then13, label %if.end14, !dbg !2450

if.then13:                                        ; preds = %if.end7
  store i32 -5, i32* %retval, align 4, !dbg !2451
  br label %return, !dbg !2451

if.end14:                                         ; preds = %if.end7
  %20 = load i32, i32* %length, align 4, !dbg !2452
  %add15 = add i32 %20, 6, !dbg !2453
  %21 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2454
  %size = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %21, i32 0, i32 4, !dbg !2455
  store i32 %add15, i32* %size, align 8, !dbg !2456
  %22 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2457
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %22, i32 0, i32 5, !dbg !2458
  store i32 0, i32* %stream_index, align 4, !dbg !2459
  %23 = load %struct.MmDemuxContext*, %struct.MmDemuxContext** %mm, align 8, !dbg !2460
  %video_pts = getelementptr inbounds %struct.MmDemuxContext, %struct.MmDemuxContext* %23, i32 0, i32 1, !dbg !2461
  %24 = load i32, i32* %video_pts, align 4, !dbg !2461
  %conv16 = zext i32 %24 to i64, !dbg !2460
  %25 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2462
  %pts = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %25, i32 0, i32 1, !dbg !2463
  store i64 %conv16, i64* %pts, align 8, !dbg !2464
  %26 = load i32, i32* %type, align 4, !dbg !2465
  %cmp17 = icmp ne i32 %26, 49, !dbg !2467
  br i1 %cmp17, label %if.then19, label %if.end21, !dbg !2468

if.then19:                                        ; preds = %if.end14
  %27 = load %struct.MmDemuxContext*, %struct.MmDemuxContext** %mm, align 8, !dbg !2469
  %video_pts20 = getelementptr inbounds %struct.MmDemuxContext, %struct.MmDemuxContext* %27, i32 0, i32 1, !dbg !2470
  %28 = load i32, i32* %video_pts20, align 4, !dbg !2471
  %inc = add i32 %28, 1, !dbg !2471
  store i32 %inc, i32* %video_pts20, align 4, !dbg !2471
  br label %if.end21, !dbg !2469
...
sw.bb22:                                          ; preds = %if.end
  %29 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2473
  %pb23 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %29, i32 0, i32 4, !dbg !2475
  %30 = load %struct.AVIOContext*, %struct.AVIOContext** %pb23, align 8, !dbg !2475
  %31 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2476
  %32 = load i32, i32* %length, align 4, !dbg !2477
  %call24 = call i32 @av_get_packet(%struct.AVIOContext* %30, %struct.AVPacket* %31, i32 %32), !dbg !2478
  %cmp25 = icmp slt i32 %call24, 0, !dbg !2479
  br i1 %cmp25, label %if.then27, label %if.end28, !dbg !2480
...
if.end28:                                         ; preds = %sw.bb22
  %33 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2482
  %stream_index29 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %33, i32 0, i32 5, !dbg !2483
  store i32 1, i32* %stream_index29, align 4, !dbg !2484
  %34 = load %struct.MmDemuxContext*, %struct.MmDemuxContext** %mm, align 8, !dbg !2485
  %audio_pts = getelementptr inbounds %struct.MmDemuxContext, %struct.MmDemuxContext* %34, i32 0, i32 0, !dbg !2486
  %35 = load i32, i32* %audio_pts, align 4, !dbg !2487
  %inc30 = add i32 %35, 1, !dbg !2487
  store i32 %inc30, i32* %audio_pts, align 4, !dbg !2487
  %conv31 = zext i32 %35 to i64, !dbg !2485
  %36 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2488
  %pts32 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %36, i32 0, i32 1, !dbg !2489
  store i64 %conv31, i64* %pts32, align 8, !dbg !2490
  store i32 0, i32* %retval, align 4, !dbg !2491
  br label %return, !dbg !2491

sw.default:                                       ; preds = %if.end
  %37 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2492
  %38 = bitcast %struct.AVFormatContext* %37 to i8*, !dbg !2492
  %39 = load i32, i32* %type, align 4, !dbg !2493
  call void (i8*, i32, i8*, ...) @av_log(i8* %38, i32 32, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.2, i32 0, i32 0), i32 %39), !dbg !2494
  %40 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2495
  %41 = load i32, i32* %length, align 4, !dbg !2496
  %conv33 = zext i32 %41 to i64, !dbg !2496
  %call34 = call i64 @avio_skip(%struct.AVIOContext* %40, i64 %conv33), !dbg !2497
  br label %sw.epilog, !dbg !2498

sw.epilog:                                        ; preds = %sw.default
  br label %while.body, !dbg !2499, !llvm.loop !2501

return:                                           ; preds = %if.end28, %if.then27, %if.end21, %if.then13, %if.then6, %if.then
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--mm.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!934 = !{!935}
!935 = distinct !DIGlobalVariable(name: "ff_mm_demuxer", scope: !0, file: !936, line: 190, type: !937, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_mm_demuxer)
!936 = !DIFile(filename: "libavformat/mm.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2151 = distinct !DISubprogram(name: "probe", scope: !936, file: !936, line: 61, type: !1006, isLocal: true, isDefinition: true, scopeLine: 62, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2152 = !{}
!2153 = !DILocalVariable(name: "p", arg: 1, scope: !2151, file: !936, line: 61, type: !1008)
!2154 = !DIExpression()
!2155 = !DILocation(line: 61, column: 31, scope: !2151)
!2156 = !DILocalVariable(name: "len", scope: !2151, file: !936, line: 63, type: !933)
!2157 = !DILocation(line: 63, column: 9, scope: !2151)
!2158 = !DILocalVariable(name: "type", scope: !2151, file: !936, line: 63, type: !933)
!2159 = !DILocation(line: 63, column: 14, scope: !2151)
!2160 = !DILocalVariable(name: "fps", scope: !2151, file: !936, line: 63, type: !933)
!2161 = !DILocation(line: 63, column: 20, scope: !2151)
!2162 = !DILocalVariable(name: "w", scope: !2151, file: !936, line: 63, type: !933)
!2163 = !DILocation(line: 63, column: 25, scope: !2151)
!2164 = !DILocalVariable(name: "h", scope: !2151, file: !936, line: 63, type: !933)
!2165 = !DILocation(line: 63, column: 28, scope: !2151)
!2166 = !DILocation(line: 64, column: 9, scope: !2167)
!2167 = distinct !DILexicalBlock(scope: !2151, file: !936, line: 64, column: 9)
!2168 = !DILocation(line: 64, column: 12, scope: !2167)
!2169 = !DILocation(line: 64, column: 21, scope: !2167)
!2170 = !DILocation(line: 64, column: 9, scope: !2151)
!2171 = !DILocation(line: 65, column: 9, scope: !2167)
!2172 = !DILocation(line: 67, column: 42, scope: !2173)
!2173 = distinct !DILexicalBlock(scope: !2151, file: !936, line: 67, column: 9)
!2174 = !DILocation(line: 67, column: 45, scope: !2173)
!2175 = !DILocation(line: 67, column: 55, scope: !2173)
!2176 = !DILocation(line: 67, column: 9, scope: !2173)
!2177 = !DILocation(line: 67, column: 58, scope: !2173)
!2178 = !DILocation(line: 67, column: 9, scope: !2151)
!2179 = !DILocation(line: 68, column: 9, scope: !2173)
!2180 = !DILocation(line: 69, column: 44, scope: !2151)
!2181 = !DILocation(line: 69, column: 47, scope: !2151)
!2182 = !DILocation(line: 69, column: 57, scope: !2151)
!2183 = !DILocation(line: 69, column: 9, scope: !2151)
!2184 = !DILocation(line: 70, column: 9, scope: !2185)
!2185 = distinct !DILexicalBlock(scope: !2151, file: !936, line: 70, column: 9)
!2186 = !DILocation(line: 70, column: 13, scope: !2185)
!2187 = !DILocation(line: 70, column: 21, scope: !2185)
!2188 = !DILocation(line: 70, column: 24, scope: !2189)
!2189 = !DILexicalBlockFile(scope: !2185, file: !936, discriminator: 1)
!2190 = !DILocation(line: 70, column: 28, scope: !2189)
!2191 = !DILocation(line: 70, column: 9, scope: !2189)
!2192 = !DILocation(line: 71, column: 9, scope: !2185)
!2193 = !DILocation(line: 72, column: 44, scope: !2151)
!2194 = !DILocation(line: 72, column: 47, scope: !2151)
!2195 = !DILocation(line: 72, column: 57, scope: !2151)
!2196 = !DILocation(line: 72, column: 11, scope: !2151)
!2197 = !DILocation(line: 72, column: 9, scope: !2151)
!2198 = !DILocation(line: 73, column: 42, scope: !2151)
!2199 = !DILocation(line: 73, column: 45, scope: !2151)
!2200 = !DILocation(line: 73, column: 56, scope: !2151)
!2201 = !DILocation(line: 73, column: 9, scope: !2151)
!2202 = !DILocation(line: 73, column: 7, scope: !2151)
!2203 = !DILocation(line: 74, column: 42, scope: !2151)
!2204 = !DILocation(line: 74, column: 45, scope: !2151)
!2205 = !DILocation(line: 74, column: 56, scope: !2151)
!2206 = !DILocation(line: 74, column: 9, scope: !2151)
!2207 = !DILocation(line: 74, column: 7, scope: !2151)
!2208 = !DILocation(line: 75, column: 10, scope: !2209)
!2209 = distinct !DILexicalBlock(scope: !2151, file: !936, line: 75, column: 9)
!2210 = !DILocation(line: 75, column: 14, scope: !2209)
!2211 = !DILocation(line: 75, column: 17, scope: !2212)
!2212 = !DILexicalBlockFile(scope: !2209, file: !936, discriminator: 1)
!2213 = !DILocation(line: 75, column: 21, scope: !2212)
!2214 = !DILocation(line: 75, column: 26, scope: !2212)
!2215 = !DILocation(line: 75, column: 30, scope: !2216)
!2216 = !DILexicalBlockFile(scope: !2209, file: !936, discriminator: 2)
!2217 = !DILocation(line: 75, column: 32, scope: !2216)
!2218 = !DILocation(line: 75, column: 35, scope: !2219)
!2219 = !DILexicalBlockFile(scope: !2209, file: !936, discriminator: 3)
!2220 = !DILocation(line: 75, column: 37, scope: !2219)
!2221 = !DILocation(line: 75, column: 44, scope: !2219)
!2222 = !DILocation(line: 75, column: 48, scope: !2223)
!2223 = !DILexicalBlockFile(scope: !2209, file: !936, discriminator: 4)
!2224 = !DILocation(line: 75, column: 50, scope: !2223)
!2225 = !DILocation(line: 75, column: 53, scope: !2226)
!2226 = !DILexicalBlockFile(scope: !2209, file: !936, discriminator: 5)
!2227 = !DILocation(line: 75, column: 55, scope: !2226)
!2228 = !DILocation(line: 75, column: 9, scope: !2226)
!2229 = !DILocation(line: 76, column: 9, scope: !2209)
!2230 = !DILocation(line: 77, column: 52, scope: !2151)
!2231 = !DILocation(line: 77, column: 45, scope: !2151)
!2232 = !DILocation(line: 77, column: 48, scope: !2151)
!2233 = !DILocation(line: 77, column: 60, scope: !2151)
!2234 = !DILocation(line: 77, column: 12, scope: !2151)
!2235 = !DILocation(line: 77, column: 10, scope: !2151)
!2236 = !DILocation(line: 78, column: 10, scope: !2237)
!2237 = distinct !DILexicalBlock(scope: !2151, file: !936, line: 78, column: 9)
!2238 = !DILocation(line: 78, column: 15, scope: !2237)
!2239 = !DILocation(line: 78, column: 18, scope: !2240)
!2240 = !DILexicalBlockFile(scope: !2237, file: !936, discriminator: 1)
!2241 = !DILocation(line: 78, column: 23, scope: !2240)
!2242 = !DILocation(line: 78, column: 9, scope: !2240)
!2243 = !DILocation(line: 79, column: 9, scope: !2237)
!2244 = !DILocation(line: 82, column: 5, scope: !2151)
!2245 = !DILocation(line: 83, column: 1, scope: !2151)
!2246 = distinct !DISubprogram(name: "read_header", scope: !936, file: !936, line: 85, type: !2247, isLocal: true, isDefinition: true, scopeLine: 86, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2247 = !DISubroutineType(types: !2248)
!2248 = !{!933, !2249}
!2249 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2250, size: 64, align: 64)
!2250 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1023)
!2251 = !DILocalVariable(name: "s", arg: 1, scope: !2246, file: !936, line: 85, type: !2249)
!2252 = !DILocation(line: 85, column: 41, scope: !2246)
!2253 = !DILocalVariable(name: "mm", scope: !2246, file: !936, line: 87, type: !2254)
!2254 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2255, size: 64, align: 64)
!2255 = !DIDerivedType(tag: DW_TAG_typedef, name: "MmDemuxContext", file: !936, line: 59, baseType: !2256)
!2256 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "MmDemuxContext", file: !936, line: 57, size: 64, align: 32, elements: !2257)
!2257 = !{!2258, !2259}
!2258 = !DIDerivedType(tag: DW_TAG_member, name: "audio_pts", scope: !2256, file: !936, line: 58, baseType: !932, size: 32, align: 32)
!2259 = !DIDerivedType(tag: DW_TAG_member, name: "video_pts", scope: !2256, file: !936, line: 58, baseType: !932, size: 32, align: 32, offset: 32)
!2260 = !DILocation(line: 87, column: 21, scope: !2246)
!2261 = !DILocation(line: 87, column: 26, scope: !2246)
!2262 = !DILocation(line: 87, column: 29, scope: !2246)
!2263 = !DILocalVariable(name: "pb", scope: !2246, file: !936, line: 88, type: !1229)
!2264 = !DILocation(line: 88, column: 18, scope: !2246)
!2265 = !DILocation(line: 88, column: 23, scope: !2246)
!2266 = !DILocation(line: 88, column: 26, scope: !2246)
!2267 = !DILocalVariable(name: "st", scope: !2246, file: !936, line: 89, type: !1297)
!2268 = !DILocation(line: 89, column: 15, scope: !2246)
!2269 = !DILocalVariable(name: "type", scope: !2246, file: !936, line: 91, type: !932)
!2270 = !DILocation(line: 91, column: 18, scope: !2246)
!2271 = !DILocalVariable(name: "length", scope: !2246, file: !936, line: 91, type: !932)
!2272 = !DILocation(line: 91, column: 24, scope: !2246)
!2273 = !DILocalVariable(name: "frame_rate", scope: !2246, file: !936, line: 92, type: !932)
!2274 = !DILocation(line: 92, column: 18, scope: !2246)
!2275 = !DILocalVariable(name: "width", scope: !2246, file: !936, line: 92, type: !932)
!2276 = !DILocation(line: 92, column: 30, scope: !2246)
!2277 = !DILocalVariable(name: "height", scope: !2246, file: !936, line: 92, type: !932)
!2278 = !DILocation(line: 92, column: 37, scope: !2246)
!2279 = !DILocation(line: 94, column: 22, scope: !2246)
!2280 = !DILocation(line: 94, column: 12, scope: !2246)
!2281 = !DILocation(line: 94, column: 10, scope: !2246)
!2282 = !DILocation(line: 95, column: 24, scope: !2246)
!2283 = !DILocation(line: 95, column: 14, scope: !2246)
!2284 = !DILocation(line: 95, column: 12, scope: !2246)
!2285 = !DILocation(line: 97, column: 9, scope: !2286)
!2286 = distinct !DILexicalBlock(scope: !2246, file: !936, line: 97, column: 9)
!2287 = !DILocation(line: 97, column: 14, scope: !2286)
!2288 = !DILocation(line: 97, column: 9, scope: !2246)
!2289 = !DILocation(line: 98, column: 9, scope: !2286)
!2290 = !DILocation(line: 101, column: 15, scope: !2246)
!2291 = !DILocation(line: 101, column: 5, scope: !2246)
!2292 = !DILocation(line: 102, column: 28, scope: !2246)
!2293 = !DILocation(line: 102, column: 18, scope: !2246)
!2294 = !DILocation(line: 102, column: 16, scope: !2246)
!2295 = !DILocation(line: 103, column: 15, scope: !2246)
!2296 = !DILocation(line: 103, column: 5, scope: !2246)
!2297 = !DILocation(line: 104, column: 23, scope: !2246)
!2298 = !DILocation(line: 104, column: 13, scope: !2246)
!2299 = !DILocation(line: 104, column: 11, scope: !2246)
!2300 = !DILocation(line: 105, column: 24, scope: !2246)
!2301 = !DILocation(line: 105, column: 14, scope: !2246)
!2302 = !DILocation(line: 105, column: 12, scope: !2246)
!2303 = !DILocation(line: 106, column: 15, scope: !2246)
!2304 = !DILocation(line: 106, column: 19, scope: !2246)
!2305 = !DILocation(line: 106, column: 26, scope: !2246)
!2306 = !DILocation(line: 106, column: 5, scope: !2246)
!2307 = !DILocation(line: 109, column: 30, scope: !2246)
!2308 = !DILocation(line: 109, column: 10, scope: !2246)
!2309 = !DILocation(line: 109, column: 8, scope: !2246)
!2310 = !DILocation(line: 110, column: 10, scope: !2311)
!2311 = distinct !DILexicalBlock(scope: !2246, file: !936, line: 110, column: 9)
!2312 = !DILocation(line: 110, column: 9, scope: !2246)
!2313 = !DILocation(line: 111, column: 9, scope: !2311)
!2314 = !DILocation(line: 112, column: 5, scope: !2246)
!2315 = !DILocation(line: 112, column: 9, scope: !2246)
!2316 = !DILocation(line: 112, column: 19, scope: !2246)
!2317 = !DILocation(line: 112, column: 30, scope: !2246)
!2318 = !DILocation(line: 113, column: 5, scope: !2246)
!2319 = !DILocation(line: 113, column: 9, scope: !2246)
!2320 = !DILocation(line: 113, column: 19, scope: !2246)
!2321 = !DILocation(line: 113, column: 28, scope: !2246)
!2322 = !DILocation(line: 114, column: 5, scope: !2246)
!2323 = !DILocation(line: 114, column: 9, scope: !2246)
!2324 = !DILocation(line: 114, column: 19, scope: !2246)
!2325 = !DILocation(line: 114, column: 29, scope: !2246)
!2326 = !DILocation(line: 115, column: 27, scope: !2246)
!2327 = !DILocation(line: 115, column: 5, scope: !2246)
!2328 = !DILocation(line: 115, column: 9, scope: !2246)
!2329 = !DILocation(line: 115, column: 19, scope: !2246)
!2330 = !DILocation(line: 115, column: 25, scope: !2246)
!2331 = !DILocation(line: 116, column: 28, scope: !2246)
!2332 = !DILocation(line: 116, column: 5, scope: !2246)
!2333 = !DILocation(line: 116, column: 9, scope: !2246)
!2334 = !DILocation(line: 116, column: 19, scope: !2246)
!2335 = !DILocation(line: 116, column: 26, scope: !2246)
!2336 = !DILocation(line: 117, column: 25, scope: !2246)
!2337 = !DILocation(line: 117, column: 36, scope: !2246)
!2338 = !DILocation(line: 117, column: 5, scope: !2246)
!2339 = !DILocation(line: 120, column: 9, scope: !2340)
!2340 = distinct !DILexicalBlock(scope: !2246, file: !936, line: 120, column: 9)
!2341 = !DILocation(line: 120, column: 16, scope: !2340)
!2342 = !DILocation(line: 120, column: 9, scope: !2246)
!2343 = !DILocation(line: 121, column: 34, scope: !2344)
!2344 = distinct !DILexicalBlock(scope: !2340, file: !936, line: 120, column: 25)
!2345 = !DILocation(line: 121, column: 14, scope: !2344)
!2346 = !DILocation(line: 121, column: 12, scope: !2344)
!2347 = !DILocation(line: 122, column: 14, scope: !2348)
!2348 = distinct !DILexicalBlock(scope: !2344, file: !936, line: 122, column: 13)
!2349 = !DILocation(line: 122, column: 13, scope: !2344)
!2350 = !DILocation(line: 123, column: 13, scope: !2348)
!2351 = !DILocation(line: 124, column: 9, scope: !2344)
!2352 = !DILocation(line: 124, column: 13, scope: !2344)
!2353 = !DILocation(line: 124, column: 23, scope: !2344)
!2354 = !DILocation(line: 124, column: 34, scope: !2344)
!2355 = !DILocation(line: 125, column: 9, scope: !2344)
!2356 = !DILocation(line: 125, column: 13, scope: !2344)
!2357 = !DILocation(line: 125, column: 23, scope: !2344)
!2358 = !DILocation(line: 125, column: 33, scope: !2344)
!2359 = !DILocation(line: 126, column: 9, scope: !2344)
!2360 = !DILocation(line: 126, column: 13, scope: !2344)
!2361 = !DILocation(line: 126, column: 23, scope: !2344)
!2362 = !DILocation(line: 126, column: 32, scope: !2344)
!2363 = !DILocation(line: 127, column: 9, scope: !2344)
!2364 = !DILocation(line: 127, column: 13, scope: !2344)
!2365 = !DILocation(line: 127, column: 23, scope: !2344)
!2366 = !DILocation(line: 127, column: 32, scope: !2344)
!2367 = !DILocation(line: 128, column: 9, scope: !2344)
!2368 = !DILocation(line: 128, column: 13, scope: !2344)
!2369 = !DILocation(line: 128, column: 23, scope: !2344)
!2370 = !DILocation(line: 128, column: 38, scope: !2344)
!2371 = !DILocation(line: 129, column: 9, scope: !2344)
!2372 = !DILocation(line: 129, column: 13, scope: !2344)
!2373 = !DILocation(line: 129, column: 23, scope: !2344)
!2374 = !DILocation(line: 129, column: 35, scope: !2344)
!2375 = !DILocation(line: 130, column: 29, scope: !2344)
!2376 = !DILocation(line: 130, column: 9, scope: !2344)
!2377 = !DILocation(line: 131, column: 5, scope: !2344)
!2378 = !DILocation(line: 133, column: 5, scope: !2246)
!2379 = !DILocation(line: 133, column: 9, scope: !2246)
!2380 = !DILocation(line: 133, column: 19, scope: !2246)
!2381 = !DILocation(line: 134, column: 5, scope: !2246)
!2382 = !DILocation(line: 134, column: 9, scope: !2246)
!2383 = !DILocation(line: 134, column: 19, scope: !2246)
!2384 = !DILocation(line: 135, column: 5, scope: !2246)
!2385 = !DILocation(line: 136, column: 1, scope: !2246)
!2386 = distinct !DISubprogram(name: "read_packet", scope: !936, file: !936, line: 138, type: !2387, isLocal: true, isDefinition: true, scopeLine: 140, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2387 = !DISubroutineType(types: !2388)
!2388 = !{!933, !2249, !1048}
!2389 = !DILocalVariable(name: "s", arg: 1, scope: !2386, file: !936, line: 138, type: !2249)
!2390 = !DILocation(line: 138, column: 41, scope: !2386)
!2391 = !DILocalVariable(name: "pkt", arg: 2, scope: !2386, file: !936, line: 139, type: !1048)
!2392 = !DILocation(line: 139, column: 38, scope: !2386)
!2393 = !DILocalVariable(name: "mm", scope: !2386, file: !936, line: 141, type: !2254)
!2394 = !DILocation(line: 141, column: 21, scope: !2386)
!2395 = !DILocation(line: 141, column: 26, scope: !2386)
!2396 = !DILocation(line: 141, column: 29, scope: !2386)
!2397 = !DILocalVariable(name: "pb", scope: !2386, file: !936, line: 142, type: !1229)
!2398 = !DILocation(line: 142, column: 18, scope: !2386)
!2399 = !DILocation(line: 142, column: 23, scope: !2386)
!2400 = !DILocation(line: 142, column: 26, scope: !2386)
!2401 = !DILocalVariable(name: "preamble", scope: !2386, file: !936, line: 143, type: !2402)
!2402 = !DICompositeType(tag: DW_TAG_array_type, baseType: !1015, size: 48, align: 8, elements: !2403)
!2403 = !{!2404}
!2404 = !DISubrange(count: 6)
!2405 = !DILocation(line: 143, column: 19, scope: !2386)
!2406 = !DILocalVariable(name: "type", scope: !2386, file: !936, line: 144, type: !932)
!2407 = !DILocation(line: 144, column: 18, scope: !2386)
!2408 = !DILocalVariable(name: "length", scope: !2386, file: !936, line: 144, type: !932)
!2409 = !DILocation(line: 144, column: 24, scope: !2386)
!2410 = !DILocation(line: 146, column: 5, scope: !2386)
!2411 = !DILocation(line: 148, column: 23, scope: !2412)
!2412 = distinct !DILexicalBlock(scope: !2413, file: !936, line: 148, column: 13)
!2413 = distinct !DILexicalBlock(scope: !2386, file: !936, line: 146, column: 14)
!2414 = !DILocation(line: 148, column: 27, scope: !2412)
!2415 = !DILocation(line: 148, column: 13, scope: !2412)
!2416 = !DILocation(line: 148, column: 40, scope: !2412)
!2417 = !DILocation(line: 148, column: 13, scope: !2413)
!2418 = !DILocation(line: 149, column: 13, scope: !2419)
!2419 = distinct !DILexicalBlock(scope: !2412, file: !936, line: 148, column: 46)
!2420 = !DILocation(line: 152, column: 49, scope: !2413)
!2421 = !DILocation(line: 152, column: 64, scope: !2413)
!2422 = !DILocation(line: 152, column: 16, scope: !2413)
!2423 = !DILocation(line: 152, column: 14, scope: !2413)
!2424 = !DILocation(line: 153, column: 51, scope: !2413)
!2425 = !DILocation(line: 153, column: 66, scope: !2413)
!2426 = !DILocation(line: 153, column: 18, scope: !2413)
!2427 = !DILocation(line: 153, column: 16, scope: !2413)
!2428 = !DILocation(line: 155, column: 16, scope: !2413)
!2429 = !DILocation(line: 155, column: 9, scope: !2413)
!2430 = !DILocation(line: 164, column: 31, scope: !2431)
!2431 = distinct !DILexicalBlock(scope: !2432, file: !936, line: 164, column: 17)
!2432 = distinct !DILexicalBlock(scope: !2413, file: !936, line: 155, column: 22)
!2433 = !DILocation(line: 164, column: 36, scope: !2431)
!2434 = !DILocation(line: 164, column: 43, scope: !2431)
!2435 = !DILocation(line: 164, column: 17, scope: !2431)
!2436 = !DILocation(line: 164, column: 17, scope: !2432)
!2437 = !DILocation(line: 165, column: 17, scope: !2431)
!2438 = !DILocation(line: 166, column: 20, scope: !2432)
!2439 = !DILocation(line: 166, column: 25, scope: !2432)
!2440 = !DILocation(line: 166, column: 13, scope: !2432)
!2441 = !DILocation(line: 167, column: 27, scope: !2442)
!2442 = distinct !DILexicalBlock(scope: !2432, file: !936, line: 167, column: 17)
!2443 = !DILocation(line: 167, column: 31, scope: !2442)
!2444 = !DILocation(line: 167, column: 36, scope: !2442)
!2445 = !DILocation(line: 167, column: 41, scope: !2442)
!2446 = !DILocation(line: 167, column: 46, scope: !2442)
!2447 = !DILocation(line: 167, column: 17, scope: !2442)
!2448 = !DILocation(line: 167, column: 57, scope: !2442)
!2449 = !DILocation(line: 167, column: 54, scope: !2442)
!2450 = !DILocation(line: 167, column: 17, scope: !2432)
!2451 = !DILocation(line: 168, column: 17, scope: !2442)
!2452 = !DILocation(line: 169, column: 25, scope: !2432)
!2453 = !DILocation(line: 169, column: 32, scope: !2432)
!2454 = !DILocation(line: 169, column: 13, scope: !2432)
!2455 = !DILocation(line: 169, column: 18, scope: !2432)
!2456 = !DILocation(line: 169, column: 23, scope: !2432)
!2457 = !DILocation(line: 170, column: 13, scope: !2432)
!2458 = !DILocation(line: 170, column: 18, scope: !2432)
!2459 = !DILocation(line: 170, column: 31, scope: !2432)
!2460 = !DILocation(line: 171, column: 24, scope: !2432)
!2461 = !DILocation(line: 171, column: 28, scope: !2432)
!2462 = !DILocation(line: 171, column: 13, scope: !2432)
!2463 = !DILocation(line: 171, column: 18, scope: !2432)
!2464 = !DILocation(line: 171, column: 22, scope: !2432)
!2465 = !DILocation(line: 172, column: 17, scope: !2466)
!2466 = distinct !DILexicalBlock(scope: !2432, file: !936, line: 172, column: 17)
!2467 = !DILocation(line: 172, column: 21, scope: !2466)
!2468 = !DILocation(line: 172, column: 17, scope: !2432)
!2469 = !DILocation(line: 173, column: 17, scope: !2466)
!2470 = !DILocation(line: 173, column: 21, scope: !2466)
!2471 = !DILocation(line: 173, column: 30, scope: !2466)
!2472 = !DILocation(line: 174, column: 13, scope: !2432)
!2473 = !DILocation(line: 177, column: 31, scope: !2474)
!2474 = distinct !DILexicalBlock(scope: !2432, file: !936, line: 177, column: 17)
!2475 = !DILocation(line: 177, column: 34, scope: !2474)
!2476 = !DILocation(line: 177, column: 38, scope: !2474)
!2477 = !DILocation(line: 177, column: 43, scope: !2474)
!2478 = !DILocation(line: 177, column: 17, scope: !2474)
!2479 = !DILocation(line: 177, column: 50, scope: !2474)
!2480 = !DILocation(line: 177, column: 17, scope: !2432)
!2481 = !DILocation(line: 178, column: 17, scope: !2474)
!2482 = !DILocation(line: 179, column: 13, scope: !2432)
!2483 = !DILocation(line: 179, column: 18, scope: !2432)
!2484 = !DILocation(line: 179, column: 31, scope: !2432)
!2485 = !DILocation(line: 180, column: 24, scope: !2432)
!2486 = !DILocation(line: 180, column: 28, scope: !2432)
!2487 = !DILocation(line: 180, column: 37, scope: !2432)
!2488 = !DILocation(line: 180, column: 13, scope: !2432)
!2489 = !DILocation(line: 180, column: 18, scope: !2432)
!2490 = !DILocation(line: 180, column: 22, scope: !2432)
!2491 = !DILocation(line: 181, column: 13, scope: !2432)
!2492 = !DILocation(line: 184, column: 20, scope: !2432)
!2493 = !DILocation(line: 184, column: 56, scope: !2432)
!2494 = !DILocation(line: 184, column: 13, scope: !2432)
!2495 = !DILocation(line: 185, column: 23, scope: !2432)
!2496 = !DILocation(line: 185, column: 27, scope: !2432)
!2497 = !DILocation(line: 185, column: 13, scope: !2432)
!2498 = !DILocation(line: 186, column: 9, scope: !2432)
!2499 = !DILocation(line: 146, column: 5, scope: !2500)
!2500 = !DILexicalBlockFile(scope: !2386, file: !936, discriminator: 1)
!2501 = distinct !{!2501, !2410}
!2502 = !DILocation(line: 188, column: 1, scope: !2386)
