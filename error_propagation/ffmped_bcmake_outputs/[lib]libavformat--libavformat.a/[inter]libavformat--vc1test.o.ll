; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--vc1test.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--vc1test.o.i"
...
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %size, metadata !2151, metadata !2149), !dbg !2152
  ...
  %cmp = icmp slt i32 %1, 24, !dbg !2156
...
if.end:                                           ; preds = %entry
  %2 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2159
  %buf = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %2, i32 0, i32 1, !dbg !2160
  %3 = load i8*, i8** %buf, align 8, !dbg !2160
  %arrayidx = getelementptr inbounds i8, i8* %3, i64 4, !dbg !2159
  %4 = bitcast i8* %arrayidx to %union.unaligned_32*, !dbg !2161
  %l = bitcast %union.unaligned_32* %4 to i32*, !dbg !2161
  %5 = load i32, i32* %l, align 1, !dbg !2161
  store i32 %5, i32* %size, align 4, !dbg !2162
  %6 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2163
  %buf1 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %6, i32 0, i32 1, !dbg !2165
  %7 = load i8*, i8** %buf1, align 8, !dbg !2165
  %arrayidx2 = getelementptr inbounds i8, i8* %7, i64 3, !dbg !2163
  %8 = load i8, i8* %arrayidx2, align 1, !dbg !2163
  %conv = zext i8 %8 to i32, !dbg !2163
  %cmp3 = icmp ne i32 %conv, 197, !dbg !2166
  br i1 %cmp3, label %if.then17, label %lor.lhs.false, !dbg !2167

lor.lhs.false:                                    ; preds = %if.end
  %9 = load i32, i32* %size, align 4, !dbg !2168
  %cmp5 = icmp ult i32 %9, 4, !dbg !2170
  br i1 %cmp5, label %if.then17, label %lor.lhs.false7, !dbg !2171

lor.lhs.false7:                                   ; preds = %lor.lhs.false
  %10 = load i32, i32* %size, align 4, !dbg !2172
  %11 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2174
  %buf_size8 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %11, i32 0, i32 2, !dbg !2175
  %12 = load i32, i32* %buf_size8, align 8, !dbg !2175
  %sub = sub nsw i32 %12, 20, !dbg !2176
  %cmp9 = icmp ugt i32 %10, %sub, !dbg !2177
  br i1 %cmp9, label %if.then17, label %lor.lhs.false11, !dbg !2178

lor.lhs.false11:                                  ; preds = %lor.lhs.false7
  %13 = load i32, i32* %size, align 4, !dbg !2179
  %add = add i32 %13, 16, !dbg !2180
  %idxprom = zext i32 %add to i64, !dbg !2181
  %14 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2181
  %buf12 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %14, i32 0, i32 1, !dbg !2182
  %15 = load i8*, i8** %buf12, align 8, !dbg !2182
  %arrayidx13 = getelementptr inbounds i8, i8* %15, i64 %idxprom, !dbg !2181
  %16 = bitcast i8* %arrayidx13 to %union.unaligned_32*, !dbg !2183
  %l14 = bitcast %union.unaligned_32* %16 to i32*, !dbg !2183
  %17 = load i32, i32* %l14, align 1, !dbg !2183
  %cmp15 = icmp ne i32 %17, 12, !dbg !2184
  br i1 %cmp15, label %if.then17, label %if.end18, !dbg !2185

if.then17:                                        ; preds = %lor.lhs.false11, %lor.lhs.false7, %lor.lhs.false, %if.end
  store i32 0, i32* %retval, align 4, !dbg !2187
  br label %return, !dbg !2187

if.end18:                                         ; preds = %lor.lhs.false11
  store i32 50, i32* %retval, align 4, !dbg !2188
  br label %return, !dbg !2188

return:                                           ; preds = %if.end18, %if.then17, %if.then
  %18 = load i32, i32* %retval, align 4, !dbg !2189
  ret i32 %18, !dbg !2189
}

; Function Attrs: nounwind uwtable
define internal i32 @vc1t_read_header(%struct.AVFormatContext* %s) #0 !dbg !2190 {
entry:
  %retval = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2195, metadata !2149), !dbg !2196
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2197, metadata !2149), !dbg !2198
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2199
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2200
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2200
  store %struct.AVIOContext* %1, %struct.AVIOContext** %pb, align 8, !dbg !2198
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2201, metadata !2149), !dbg !2202
  call void @llvm.dbg.declare(metadata i32* %frames, metadata !2203, metadata !2149), !dbg !2204
  call void @llvm.dbg.declare(metadata i32* %fps, metadata !2205, metadata !2149), !dbg !2206
  call void @llvm.dbg.declare(metadata i32* %size, metadata !2207, metadata !2149), !dbg !2208
  %2 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2209
  %call = call i32 @avio_rl24(%struct.AVIOContext* %2), !dbg !2210
  store i32 %call, i32* %frames, align 4, !dbg !2211
  %3 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2212
  %call2 = call i32 @avio_r8(%struct.AVIOContext* %3), !dbg !2214
  %cmp = icmp ne i32 %call2, 197, !dbg !2215
  br i1 %cmp, label %if.then, label %lor.lhs.false, !dbg !2216

lor.lhs.false:                                    ; preds = %entry
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2217
  %call3 = call i32 @avio_rl32(%struct.AVIOContext* %4), !dbg !2219
  store i32 %call3, i32* %size, align 4, !dbg !2220
  %cmp4 = icmp ult i32 %call3, 4, !dbg !2221
  br i1 %cmp4, label %if.then, label %if.end, !dbg !2222

if.then:                                          ; preds = %lor.lhs.false, %entry
  store i32 -1094995529, i32* %retval, align 4, !dbg !2223
  br label %return, !dbg !2223

if.end:                                           ; preds = %lor.lhs.false
  %5 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2224
  %call5 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %5, %struct.AVCodec* null), !dbg !2225
  store %struct.AVStream* %call5, %struct.AVStream** %st, align 8, !dbg !2226
  %6 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2227
  %tobool = icmp ne %struct.AVStream* %6, null, !dbg !2227
  br i1 %tobool, label %if.end7, label %if.then6, !dbg !2229

if.then6:                                         ; preds = %if.end
  store i32 -12, i32* %retval, align 4, !dbg !2230
  br label %return, !dbg !2230

if.end7:                                          ; preds = %if.end
  %7 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2231
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %7, i32 0, i32 19, !dbg !2232
  %8 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2232
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %8, i32 0, i32 0, !dbg !2233
  store i32 0, i32* %codec_type, align 8, !dbg !2234
  %9 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2235
  %codecpar8 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %9, i32 0, i32 19, !dbg !2236
  %10 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar8, align 8, !dbg !2236
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %10, i32 0, i32 1, !dbg !2237
  store i32 71, i32* %codec_id, align 4, !dbg !2238
  %11 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2239
  %12 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2241
  %codecpar9 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %12, i32 0, i32 19, !dbg !2242
  %13 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar9, align 8, !dbg !2242
  %14 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2243
  %call10 = call i32 @ff_get_extradata(%struct.AVFormatContext* %11, %struct.AVCodecParameters* %13, %struct.AVIOContext* %14, i32 4), !dbg !2244
  %cmp11 = icmp slt i32 %call10, 0, !dbg !2245
  br i1 %cmp11, label %if.then12, label %if.end13, !dbg !2246

if.then12:                                        ; preds = %if.end7
  store i32 -12, i32* %retval, align 4, !dbg !2247
  br label %return, !dbg !2247

if.end13:                                         ; preds = %if.end7
  %15 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2248
  %16 = load i32, i32* %size, align 4, !dbg !2249
  %sub = sub i32 %16, 4, !dbg !2250
  %conv = zext i32 %sub to i64, !dbg !2249
  %call14 = call i64 @avio_skip(%struct.AVIOContext* %15, i64 %conv), !dbg !2251
  %17 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2252
  %call15 = call i32 @avio_rl32(%struct.AVIOContext* %17), !dbg !2253
  %18 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2254
  %codecpar16 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %18, i32 0, i32 19, !dbg !2255
  %19 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar16, align 8, !dbg !2255
  %height = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %19, i32 0, i32 12, !dbg !2256
  store i32 %call15, i32* %height, align 4, !dbg !2257
  %20 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2258
  %call17 = call i32 @avio_rl32(%struct.AVIOContext* %20), !dbg !2259
  %21 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2260
  %codecpar18 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %21, i32 0, i32 19, !dbg !2261
  %22 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar18, align 8, !dbg !2261
  %width = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %22, i32 0, i32 11, !dbg !2262
  store i32 %call17, i32* %width, align 8, !dbg !2263
  %23 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2264
  %call19 = call i32 @avio_rl32(%struct.AVIOContext* %23), !dbg !2266
  %cmp20 = icmp ne i32 %call19, 12, !dbg !2267
  br i1 %cmp20, label %if.then22, label %if.end23, !dbg !2268
...
if.end23:                                         ; preds = %if.end13
  %24 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2270
  %call24 = call i64 @avio_skip(%struct.AVIOContext* %24, i64 8), !dbg !2271
  %25 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2272
  %call25 = call i32 @avio_rl32(%struct.AVIOContext* %25), !dbg !2273
  store i32 %call25, i32* %fps, align 4, !dbg !2274
  %26 = load i32, i32* %fps, align 4, !dbg !2275
  %cmp26 = icmp eq i32 %26, -1, !dbg !2277
  br i1 %cmp26, label %if.then28, label %if.else, !dbg !2278

if.then28:                                        ; preds = %if.end23
  %27 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2279
  call void @avpriv_set_pts_info(%struct.AVStream* %27, i32 32, i32 1, i32 1000), !dbg !2280
  br label %if.end33, !dbg !2280

if.else:                                          ; preds = %if.end23
  %28 = load i32, i32* %fps, align 4, !dbg !2281
  %tobool29 = icmp ne i32 %28, 0, !dbg !2281
  br i1 %tobool29, label %if.end31, label %if.then30, !dbg !2284

if.then30:                                        ; preds = %if.else
  %29 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2285
  %30 = bitcast %struct.AVFormatContext* %29 to i8*, !dbg !2285
  call void (i8*, i32, i8*, ...) @av_log(i8* %30, i32 16, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.3, i32 0, i32 0)), !dbg !2287
  store i32 1, i32* %fps, align 4, !dbg !2288
  br label %if.end31, !dbg !2289

if.end31:                                         ; preds = %if.then30, %if.else
  %31 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2290
  %32 = load i32, i32* %fps, align 4, !dbg !2291
  call void @avpriv_set_pts_info(%struct.AVStream* %31, i32 24, i32 1, i32 %32), !dbg !2292
  %33 = load i32, i32* %frames, align 4, !dbg !2293
  %conv32 = sext i32 %33 to i64, !dbg !2293
  %34 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2294
  %duration = getelementptr inbounds %struct.AVStream, %struct.AVStream* %34, i32 0, i32 6, !dbg !2295
  store i64 %conv32, i64* %duration, align 8, !dbg !2296
  br label %if.end33

if.end33:                                         ; preds = %if.end31, %if.then28
  store i32 0, i32* %retval, align 4, !dbg !2297
  br label %return, !dbg !2297

return:                                           ; preds = %if.end33, %if.then22, %if.then12, %if.then6, %if.then
  %35 = load i32, i32* %retval, align 4, !dbg !2298
  ret i32 %35, !dbg !2298
}

; Function Attrs: nounwind uwtable
define internal i32 @vc1t_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2299 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2302, metadata !2149), !dbg !2303
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2304, metadata !2149), !dbg !2305
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2306, metadata !2149), !dbg !2307
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2308
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2309
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2309
  store %struct.AVIOContext* %1, %struct.AVIOContext** %pb, align 8, !dbg !2307
  call void @llvm.dbg.declare(metadata i32* %frame_size, metadata !2310, metadata !2149), !dbg !2311
  call void @llvm.dbg.declare(metadata i32* %keyframe, metadata !2312, metadata !2149), !dbg !2313
  store i32 0, i32* %keyframe, align 4, !dbg !2313
  call void @llvm.dbg.declare(metadata i32* %pts, metadata !2314, metadata !2149), !dbg !2315
  %2 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2316
  %call = call i32 @avio_feof(%struct.AVIOContext* %2), !dbg !2318
  %tobool = icmp ne i32 %call, 0, !dbg !2318
  br i1 %tobool, label %if.then, label %if.end, !dbg !2319
...
if.end:                                           ; preds = %entry
  %3 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2321
  %call2 = call i32 @avio_rl24(%struct.AVIOContext* %3), !dbg !2322
  store i32 %call2, i32* %frame_size, align 4, !dbg !2323
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2324
  %call3 = call i32 @avio_r8(%struct.AVIOContext* %4), !dbg !2326
  %and = and i32 %call3, 128, !dbg !2327
  %tobool4 = icmp ne i32 %and, 0, !dbg !2327
  br i1 %tobool4, label %if.then5, label %if.end6, !dbg !2328

if.then5:                                         ; preds = %if.end
  store i32 1, i32* %keyframe, align 4, !dbg !2329
  br label %if.end6, !dbg !2330

if.end6:                                          ; preds = %if.then5, %if.end
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2331
  %call7 = call i32 @avio_rl32(%struct.AVIOContext* %5), !dbg !2332
  store i32 %call7, i32* %pts, align 4, !dbg !2333
  %6 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2334
  %7 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2336
  %8 = load i32, i32* %frame_size, align 4, !dbg !2337
  %call8 = call i32 @av_get_packet(%struct.AVIOContext* %6, %struct.AVPacket* %7, i32 %8), !dbg !2338
  %cmp = icmp slt i32 %call8, 0, !dbg !2339
  br i1 %cmp, label %if.then9, label %if.end10, !dbg !2340

if.then9:                                         ; preds = %if.end6
  store i32 -5, i32* %retval, align 4, !dbg !2341
  br label %return, !dbg !2341

if.end10:                                         ; preds = %if.end6
  %9 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2342
  %streams = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %9, i32 0, i32 7, !dbg !2344
  %10 = load %struct.AVStream**, %struct.AVStream*** %streams, align 8, !dbg !2344
  %arrayidx = getelementptr inbounds %struct.AVStream*, %struct.AVStream** %10, i64 0, !dbg !2342
  %11 = load %struct.AVStream*, %struct.AVStream** %arrayidx, align 8, !dbg !2342
  %time_base = getelementptr inbounds %struct.AVStream, %struct.AVStream* %11, i32 0, i32 4, !dbg !2345
  %den = getelementptr inbounds %struct.AVRational, %struct.AVRational* %time_base, i32 0, i32 1, !dbg !2346
  %12 = load i32, i32* %den, align 4, !dbg !2346
  %cmp11 = icmp eq i32 %12, 1000, !dbg !2347
  br i1 %cmp11, label %if.then12, label %if.end14, !dbg !2348

if.then12:                                        ; preds = %if.end10
  %13 = load i32, i32* %pts, align 4, !dbg !2349
  %conv = zext i32 %13 to i64, !dbg !2349
  %14 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2350
  %pts13 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %14, i32 0, i32 1, !dbg !2351
  store i64 %conv, i64* %pts13, align 8, !dbg !2352
  br label %if.end14, !dbg !2350

if.end14:                                         ; preds = %if.then12, %if.end10
  %15 = load i32, i32* %keyframe, align 4, !dbg !2353
  %tobool15 = icmp ne i32 %15, 0, !dbg !2353
  %cond = select i1 %tobool15, i32 1, i32 0, !dbg !2353
  %16 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2354
  %flags = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %16, i32 0, i32 6, !dbg !2355
  %17 = load i32, i32* %flags, align 8, !dbg !2356
  %or = or i32 %17, %cond, !dbg !2356
  store i32 %or, i32* %flags, align 8, !dbg !2356
  %18 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2357
  %pos = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %18, i32 0, i32 10, !dbg !2358
  %19 = load i64, i64* %pos, align 8, !dbg !2359
  %sub = sub nsw i64 %19, 8, !dbg !2359
  store i64 %sub, i64* %pos, align 8, !dbg !2359
  %20 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2360
  %size = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %20, i32 0, i32 4, !dbg !2361
  %21 = load i32, i32* %size, align 8, !dbg !2361
  store i32 %21, i32* %retval, align 4, !dbg !2362
  br label %return, !dbg !2362

return:                                           ; preds = %if.end14, %if.then9, %if.then
  %22 = load i32, i32* %retval, align 4, !dbg !2363
  ret i32 %22, !dbg !2363
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--vc1test.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!927 = !{!928}
!928 = distinct !DIGlobalVariable(name: "ff_vc1t_demuxer", scope: !0, file: !929, line: 119, type: !930, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_vc1t_demuxer)
!929 = !DIFile(filename: "libavformat/vc1test.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2146 = distinct !DISubprogram(name: "vc1t_probe", scope: !929, file: !929, line: 35, type: !999, isLocal: true, isDefinition: true, scopeLine: 36, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2147 = !{}
!2148 = !DILocalVariable(name: "p", arg: 1, scope: !2146, file: !929, line: 35, type: !1001)
!2149 = !DIExpression()
!2150 = !DILocation(line: 35, column: 36, scope: !2146)
!2151 = !DILocalVariable(name: "size", scope: !2146, file: !929, line: 37, type: !923)
!2152 = !DILocation(line: 37, column: 14, scope: !2146)
!2153 = !DILocation(line: 39, column: 9, scope: !2154)
!2154 = distinct !DILexicalBlock(scope: !2146, file: !929, line: 39, column: 9)
!2155 = !DILocation(line: 39, column: 12, scope: !2154)
!2156 = !DILocation(line: 39, column: 21, scope: !2154)
!2157 = !DILocation(line: 39, column: 9, scope: !2146)
!2158 = !DILocation(line: 40, column: 9, scope: !2154)
!2159 = !DILocation(line: 42, column: 45, scope: !2146)
!2160 = !DILocation(line: 42, column: 48, scope: !2146)
!2161 = !DILocation(line: 42, column: 58, scope: !2146)
!2162 = !DILocation(line: 42, column: 10, scope: !2146)
!2163 = !DILocation(line: 43, column: 9, scope: !2164)
!2164 = distinct !DILexicalBlock(scope: !2146, file: !929, line: 43, column: 9)
!2165 = !DILocation(line: 43, column: 12, scope: !2164)
!2166 = !DILocation(line: 43, column: 19, scope: !2164)
!2167 = !DILocation(line: 43, column: 27, scope: !2164)
!2168 = !DILocation(line: 43, column: 30, scope: !2169)
!2169 = !DILexicalBlockFile(scope: !2164, file: !929, discriminator: 1)
!2170 = !DILocation(line: 43, column: 35, scope: !2169)
!2171 = !DILocation(line: 43, column: 39, scope: !2169)
!2172 = !DILocation(line: 43, column: 42, scope: !2173)
!2173 = !DILexicalBlockFile(scope: !2164, file: !929, discriminator: 2)
!2174 = !DILocation(line: 43, column: 49, scope: !2173)
!2175 = !DILocation(line: 43, column: 52, scope: !2173)
!2176 = !DILocation(line: 43, column: 61, scope: !2173)
!2177 = !DILocation(line: 43, column: 47, scope: !2173)
!2178 = !DILocation(line: 43, column: 66, scope: !2173)
!2179 = !DILocation(line: 44, column: 49, scope: !2164)
!2180 = !DILocation(line: 44, column: 53, scope: !2164)
!2181 = !DILocation(line: 44, column: 42, scope: !2164)
!2182 = !DILocation(line: 44, column: 45, scope: !2164)
!2183 = !DILocation(line: 44, column: 61, scope: !2164)
!2184 = !DILocation(line: 44, column: 64, scope: !2164)
!2185 = !DILocation(line: 43, column: 9, scope: !2186)
!2186 = !DILexicalBlockFile(scope: !2146, file: !929, discriminator: 3)
!2187 = !DILocation(line: 45, column: 9, scope: !2164)
!2188 = !DILocation(line: 47, column: 5, scope: !2146)
!2189 = !DILocation(line: 48, column: 1, scope: !2146)
!2190 = distinct !DISubprogram(name: "vc1t_read_header", scope: !929, file: !929, line: 50, type: !2191, isLocal: true, isDefinition: true, scopeLine: 51, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2191 = !DISubroutineType(types: !2192)
!2192 = !{!926, !2193}
!2193 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2194, size: 64, align: 64)
!2194 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1016)
!2195 = !DILocalVariable(name: "s", arg: 1, scope: !2190, file: !929, line: 50, type: !2193)
!2196 = !DILocation(line: 50, column: 46, scope: !2190)
!2197 = !DILocalVariable(name: "pb", scope: !2190, file: !929, line: 52, type: !1222)
!2198 = !DILocation(line: 52, column: 18, scope: !2190)
!2199 = !DILocation(line: 52, column: 23, scope: !2190)
!2200 = !DILocation(line: 52, column: 26, scope: !2190)
!2201 = !DILocalVariable(name: "st", scope: !2190, file: !929, line: 53, type: !1290)
!2202 = !DILocation(line: 53, column: 15, scope: !2190)
!2203 = !DILocalVariable(name: "frames", scope: !2190, file: !929, line: 54, type: !926)
!2204 = !DILocation(line: 54, column: 9, scope: !2190)
!2205 = !DILocalVariable(name: "fps", scope: !2190, file: !929, line: 55, type: !923)
!2206 = !DILocation(line: 55, column: 14, scope: !2190)
!2207 = !DILocalVariable(name: "size", scope: !2190, file: !929, line: 56, type: !923)
!2208 = !DILocation(line: 56, column: 14, scope: !2190)
!2209 = !DILocation(line: 58, column: 24, scope: !2190)
!2210 = !DILocation(line: 58, column: 14, scope: !2190)
!2211 = !DILocation(line: 58, column: 12, scope: !2190)
!2212 = !DILocation(line: 59, column: 17, scope: !2213)
!2213 = distinct !DILexicalBlock(scope: !2190, file: !929, line: 59, column: 9)
!2214 = !DILocation(line: 59, column: 9, scope: !2213)
!2215 = !DILocation(line: 59, column: 21, scope: !2213)
!2216 = !DILocation(line: 59, column: 29, scope: !2213)
!2217 = !DILocation(line: 59, column: 51, scope: !2218)
!2218 = !DILexicalBlockFile(scope: !2213, file: !929, discriminator: 1)
!2219 = !DILocation(line: 59, column: 41, scope: !2218)
!2220 = !DILocation(line: 59, column: 39, scope: !2218)
!2221 = !DILocation(line: 59, column: 56, scope: !2218)
!2222 = !DILocation(line: 59, column: 9, scope: !2218)
!2223 = !DILocation(line: 60, column: 9, scope: !2213)
!2224 = !DILocation(line: 63, column: 30, scope: !2190)
!2225 = !DILocation(line: 63, column: 10, scope: !2190)
!2226 = !DILocation(line: 63, column: 8, scope: !2190)
!2227 = !DILocation(line: 64, column: 10, scope: !2228)
!2228 = distinct !DILexicalBlock(scope: !2190, file: !929, line: 64, column: 9)
!2229 = !DILocation(line: 64, column: 9, scope: !2190)
!2230 = !DILocation(line: 65, column: 9, scope: !2228)
!2231 = !DILocation(line: 67, column: 5, scope: !2190)
!2232 = !DILocation(line: 67, column: 9, scope: !2190)
!2233 = !DILocation(line: 67, column: 19, scope: !2190)
!2234 = !DILocation(line: 67, column: 30, scope: !2190)
!2235 = !DILocation(line: 68, column: 5, scope: !2190)
!2236 = !DILocation(line: 68, column: 9, scope: !2190)
!2237 = !DILocation(line: 68, column: 19, scope: !2190)
!2238 = !DILocation(line: 68, column: 28, scope: !2190)
!2239 = !DILocation(line: 70, column: 26, scope: !2240)
!2240 = distinct !DILexicalBlock(scope: !2190, file: !929, line: 70, column: 9)
!2241 = !DILocation(line: 70, column: 29, scope: !2240)
!2242 = !DILocation(line: 70, column: 33, scope: !2240)
!2243 = !DILocation(line: 70, column: 43, scope: !2240)
!2244 = !DILocation(line: 70, column: 9, scope: !2240)
!2245 = !DILocation(line: 70, column: 50, scope: !2240)
!2246 = !DILocation(line: 70, column: 9, scope: !2190)
!2247 = !DILocation(line: 71, column: 9, scope: !2240)
!2248 = !DILocation(line: 73, column: 15, scope: !2190)
!2249 = !DILocation(line: 73, column: 19, scope: !2190)
!2250 = !DILocation(line: 73, column: 24, scope: !2190)
!2251 = !DILocation(line: 73, column: 5, scope: !2190)
!2252 = !DILocation(line: 74, column: 38, scope: !2190)
!2253 = !DILocation(line: 74, column: 28, scope: !2190)
!2254 = !DILocation(line: 74, column: 5, scope: !2190)
!2255 = !DILocation(line: 74, column: 9, scope: !2190)
!2256 = !DILocation(line: 74, column: 19, scope: !2190)
!2257 = !DILocation(line: 74, column: 26, scope: !2190)
!2258 = !DILocation(line: 75, column: 37, scope: !2190)
!2259 = !DILocation(line: 75, column: 27, scope: !2190)
!2260 = !DILocation(line: 75, column: 5, scope: !2190)
!2261 = !DILocation(line: 75, column: 9, scope: !2190)
!2262 = !DILocation(line: 75, column: 19, scope: !2190)
!2263 = !DILocation(line: 75, column: 25, scope: !2190)
!2264 = !DILocation(line: 76, column: 18, scope: !2265)
!2265 = distinct !DILexicalBlock(scope: !2190, file: !929, line: 76, column: 8)
!2266 = !DILocation(line: 76, column: 8, scope: !2265)
!2267 = !DILocation(line: 76, column: 22, scope: !2265)
!2268 = !DILocation(line: 76, column: 8, scope: !2190)
!2269 = !DILocation(line: 77, column: 9, scope: !2265)
!2270 = !DILocation(line: 78, column: 15, scope: !2190)
!2271 = !DILocation(line: 78, column: 5, scope: !2190)
!2272 = !DILocation(line: 79, column: 21, scope: !2190)
!2273 = !DILocation(line: 79, column: 11, scope: !2190)
!2274 = !DILocation(line: 79, column: 9, scope: !2190)
!2275 = !DILocation(line: 80, column: 8, scope: !2276)
!2276 = distinct !DILexicalBlock(scope: !2190, file: !929, line: 80, column: 8)
!2277 = !DILocation(line: 80, column: 12, scope: !2276)
!2278 = !DILocation(line: 80, column: 8, scope: !2190)
!2279 = !DILocation(line: 81, column: 29, scope: !2276)
!2280 = !DILocation(line: 81, column: 9, scope: !2276)
!2281 = !DILocation(line: 83, column: 14, scope: !2282)
!2282 = distinct !DILexicalBlock(scope: !2283, file: !929, line: 83, column: 13)
!2283 = distinct !DILexicalBlock(scope: !2276, file: !929, line: 82, column: 9)
!2284 = !DILocation(line: 83, column: 13, scope: !2283)
!2285 = !DILocation(line: 84, column: 20, scope: !2286)
!2286 = distinct !DILexicalBlock(scope: !2282, file: !929, line: 83, column: 19)
!2287 = !DILocation(line: 84, column: 13, scope: !2286)
!2288 = !DILocation(line: 85, column: 17, scope: !2286)
!2289 = !DILocation(line: 86, column: 9, scope: !2286)
!2290 = !DILocation(line: 87, column: 29, scope: !2283)
!2291 = !DILocation(line: 87, column: 40, scope: !2283)
!2292 = !DILocation(line: 87, column: 9, scope: !2283)
!2293 = !DILocation(line: 88, column: 24, scope: !2283)
!2294 = !DILocation(line: 88, column: 9, scope: !2283)
!2295 = !DILocation(line: 88, column: 13, scope: !2283)
!2296 = !DILocation(line: 88, column: 22, scope: !2283)
!2297 = !DILocation(line: 91, column: 5, scope: !2190)
!2298 = !DILocation(line: 92, column: 1, scope: !2190)
!2299 = distinct !DISubprogram(name: "vc1t_read_packet", scope: !929, file: !929, line: 94, type: !2300, isLocal: true, isDefinition: true, scopeLine: 96, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2300 = !DISubroutineType(types: !2301)
!2301 = !{!926, !2193, !1041}
!2302 = !DILocalVariable(name: "s", arg: 1, scope: !2299, file: !929, line: 94, type: !2193)
!2303 = !DILocation(line: 94, column: 46, scope: !2299)
!2304 = !DILocalVariable(name: "pkt", arg: 2, scope: !2299, file: !929, line: 95, type: !1041)
!2305 = !DILocation(line: 95, column: 38, scope: !2299)
!2306 = !DILocalVariable(name: "pb", scope: !2299, file: !929, line: 97, type: !1222)
!2307 = !DILocation(line: 97, column: 18, scope: !2299)
!2308 = !DILocation(line: 97, column: 23, scope: !2299)
!2309 = !DILocation(line: 97, column: 26, scope: !2299)
!2310 = !DILocalVariable(name: "frame_size", scope: !2299, file: !929, line: 98, type: !926)
!2311 = !DILocation(line: 98, column: 9, scope: !2299)
!2312 = !DILocalVariable(name: "keyframe", scope: !2299, file: !929, line: 99, type: !926)
!2313 = !DILocation(line: 99, column: 9, scope: !2299)
!2314 = !DILocalVariable(name: "pts", scope: !2299, file: !929, line: 100, type: !923)
!2315 = !DILocation(line: 100, column: 14, scope: !2299)
!2316 = !DILocation(line: 102, column: 18, scope: !2317)
!2317 = distinct !DILexicalBlock(scope: !2299, file: !929, line: 102, column: 8)
!2318 = !DILocation(line: 102, column: 8, scope: !2317)
!2319 = !DILocation(line: 102, column: 8, scope: !2299)
!2320 = !DILocation(line: 103, column: 9, scope: !2317)
!2321 = !DILocation(line: 105, column: 28, scope: !2299)
!2322 = !DILocation(line: 105, column: 18, scope: !2299)
!2323 = !DILocation(line: 105, column: 16, scope: !2299)
!2324 = !DILocation(line: 106, column: 16, scope: !2325)
!2325 = distinct !DILexicalBlock(scope: !2299, file: !929, line: 106, column: 8)
!2326 = !DILocation(line: 106, column: 8, scope: !2325)
!2327 = !DILocation(line: 106, column: 20, scope: !2325)
!2328 = !DILocation(line: 106, column: 8, scope: !2299)
!2329 = !DILocation(line: 107, column: 18, scope: !2325)
!2330 = !DILocation(line: 107, column: 9, scope: !2325)
!2331 = !DILocation(line: 108, column: 21, scope: !2299)
!2332 = !DILocation(line: 108, column: 11, scope: !2299)
!2333 = !DILocation(line: 108, column: 9, scope: !2299)
!2334 = !DILocation(line: 109, column: 22, scope: !2335)
!2335 = distinct !DILexicalBlock(scope: !2299, file: !929, line: 109, column: 8)
!2336 = !DILocation(line: 109, column: 26, scope: !2335)
!2337 = !DILocation(line: 109, column: 31, scope: !2335)
!2338 = !DILocation(line: 109, column: 8, scope: !2335)
!2339 = !DILocation(line: 109, column: 43, scope: !2335)
!2340 = !DILocation(line: 109, column: 8, scope: !2299)
!2341 = !DILocation(line: 110, column: 9, scope: !2335)
!2342 = !DILocation(line: 111, column: 8, scope: !2343)
!2343 = distinct !DILexicalBlock(scope: !2299, file: !929, line: 111, column: 8)
!2344 = !DILocation(line: 111, column: 11, scope: !2343)
!2345 = !DILocation(line: 111, column: 23, scope: !2343)
!2346 = !DILocation(line: 111, column: 33, scope: !2343)
!2347 = !DILocation(line: 111, column: 37, scope: !2343)
!2348 = !DILocation(line: 111, column: 8, scope: !2299)
!2349 = !DILocation(line: 112, column: 20, scope: !2343)
!2350 = !DILocation(line: 112, column: 9, scope: !2343)
!2351 = !DILocation(line: 112, column: 14, scope: !2343)
!2352 = !DILocation(line: 112, column: 18, scope: !2343)
!2353 = !DILocation(line: 113, column: 19, scope: !2299)
!2354 = !DILocation(line: 113, column: 5, scope: !2299)
!2355 = !DILocation(line: 113, column: 10, scope: !2299)
!2356 = !DILocation(line: 113, column: 16, scope: !2299)
!2357 = !DILocation(line: 114, column: 5, scope: !2299)
!2358 = !DILocation(line: 114, column: 10, scope: !2299)
!2359 = !DILocation(line: 114, column: 14, scope: !2299)
!2360 = !DILocation(line: 116, column: 12, scope: !2299)
!2361 = !DILocation(line: 116, column: 17, scope: !2299)
!2362 = !DILocation(line: 116, column: 5, scope: !2299)
!2363 = !DILocation(line: 117, column: 1, scope: !2299)
