; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--nspdec.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--nspdec.o.i"
...
@ff_nsp_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.1, i32 0, i32 0), i32 256, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 0, i32 (%struct.AVProbeData*)* @nsp_probe, i32 (%struct.AVFormatContext*)* @nsp_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @ff_pcm_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* @ff_pcm_read_seek, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
...
define internal i32 @nsp_probe(%struct.AVProbeData* %p) #0 !dbg !2146 {
entry:
  %x.addr.i37 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %x.addr.i37, metadata !2148, metadata !2153), !dbg !2154
  %x.addr.i22 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %x.addr.i22, metadata !2148, metadata !2153), !dbg !2158
  %x.addr.i7 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %x.addr.i7, metadata !2148, metadata !2153), !dbg !2160
  %x.addr.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %x.addr.i, metadata !2148, metadata !2153), !dbg !2163
  %retval = alloca i32, align 4
  %p.addr = alloca %struct.AVProbeData*, align 8
  store %struct.AVProbeData* %p, %struct.AVProbeData** %p.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVProbeData** %p.addr, metadata !2165, metadata !2153), !dbg !2166
  ...
  %8 = load i32, i32* bitcast ([5 x i8]* @.str.2 to i32*), align 1, !dbg !2189
  store i32 %8, i32* %x.addr.i37, align 4, !dbg !2190
  %9 = load i32, i32* %x.addr.i37, align 4, !dbg !2191
  %shl.i38 = shl i32 %9, 8, !dbg !2192
  %and.i39 = and i32 %shl.i38, 65280, !dbg !2193
  %10 = load i32, i32* %x.addr.i37, align 4, !dbg !2194
  %shr.i40 = lshr i32 %10, 8, !dbg !2195
  %and1.i41 = and i32 %shr.i40, 255, !dbg !2196
  %or.i42 = or i32 %and.i39, %and1.i41, !dbg !2197
  %shl2.i43 = shl i32 %or.i42, 16, !dbg !2198
  %11 = load i32, i32* %x.addr.i37, align 4, !dbg !2199
  %shr3.i44 = lshr i32 %11, 16, !dbg !2200
  %shl4.i45 = shl i32 %shr3.i44, 8, !dbg !2201
  %and5.i46 = and i32 %shl4.i45, 65280, !dbg !2202
  %12 = load i32, i32* %x.addr.i37, align 4, !dbg !2203
  %shr6.i47 = lshr i32 %12, 16, !dbg !2204
  %shr7.i48 = lshr i32 %shr6.i47, 8, !dbg !2205
  %and8.i49 = and i32 %shr7.i48, 255, !dbg !2206
  %or9.i50 = or i32 %and5.i46, %and8.i49, !dbg !2207
  %or10.i51 = or i32 %shl2.i43, %or9.i50, !dbg !2208
  %cmp = icmp eq i32 %or10.i, %or10.i51, !dbg !2209
  br i1 %cmp, label %land.lhs.true, label %if.end, !dbg !2210

land.lhs.true:                                    ; preds = %entry
  %13 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2211
  %buf2 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %13, i32 0, i32 1, !dbg !2212
  %14 = load i8*, i8** %buf2, align 8, !dbg !2212
  %add.ptr = getelementptr inbounds i8, i8* %14, i64 4, !dbg !2213
  %15 = bitcast i8* %add.ptr to %union.unaligned_32*, !dbg !2214
  %l3 = bitcast %union.unaligned_32* %15 to i32*, !dbg !2214
  %16 = load i32, i32* %l3, align 1, !dbg !2214
  store i32 %16, i32* %x.addr.i22, align 4, !dbg !2215
  %17 = load i32, i32* %x.addr.i22, align 4, !dbg !2216
  %shl.i23 = shl i32 %17, 8, !dbg !2217
  %and.i24 = and i32 %shl.i23, 65280, !dbg !2218
  %18 = load i32, i32* %x.addr.i22, align 4, !dbg !2219
  %shr.i25 = lshr i32 %18, 8, !dbg !2220
  %and1.i26 = and i32 %shr.i25, 255, !dbg !2221
  %or.i27 = or i32 %and.i24, %and1.i26, !dbg !2222
  %shl2.i28 = shl i32 %or.i27, 16, !dbg !2223
  %19 = load i32, i32* %x.addr.i22, align 4, !dbg !2224
  %shr3.i29 = lshr i32 %19, 16, !dbg !2225
  %shl4.i30 = shl i32 %shr3.i29, 8, !dbg !2226
  %and5.i31 = and i32 %shl4.i30, 65280, !dbg !2227
  %20 = load i32, i32* %x.addr.i22, align 4, !dbg !2228
  %shr6.i32 = lshr i32 %20, 16, !dbg !2229
  %shr7.i33 = lshr i32 %shr6.i32, 8, !dbg !2230
  %and8.i34 = and i32 %shr7.i33, 255, !dbg !2231
  %or9.i35 = or i32 %and5.i31, %and8.i34, !dbg !2232
  %or10.i36 = or i32 %shl2.i28, %or9.i35, !dbg !2233
  %21 = load i32, i32* bitcast ([5 x i8]* @.str.3 to i32*), align 1, !dbg !2234
  store i32 %21, i32* %x.addr.i7, align 4, !dbg !2235
  %22 = load i32, i32* %x.addr.i7, align 4, !dbg !2236
  %shl.i8 = shl i32 %22, 8, !dbg !2237
  %and.i9 = and i32 %shl.i8, 65280, !dbg !2238
  %23 = load i32, i32* %x.addr.i7, align 4, !dbg !2239
  %shr.i10 = lshr i32 %23, 8, !dbg !2240
  %and1.i11 = and i32 %shr.i10, 255, !dbg !2241
  %or.i12 = or i32 %and.i9, %and1.i11, !dbg !2242
  %shl2.i13 = shl i32 %or.i12, 16, !dbg !2243
  %24 = load i32, i32* %x.addr.i7, align 4, !dbg !2244
  %shr3.i14 = lshr i32 %24, 16, !dbg !2245
  %shl4.i15 = shl i32 %shr3.i14, 8, !dbg !2246
  %and5.i16 = and i32 %shl4.i15, 65280, !dbg !2247
  %25 = load i32, i32* %x.addr.i7, align 4, !dbg !2248
  %shr6.i17 = lshr i32 %25, 16, !dbg !2249
  %shr7.i18 = lshr i32 %shr6.i17, 8, !dbg !2250
  %and8.i19 = and i32 %shr7.i18, 255, !dbg !2251
  %or9.i20 = or i32 %and5.i16, %and8.i19, !dbg !2252
  %or10.i21 = or i32 %shl2.i13, %or9.i20, !dbg !2253
  %cmp6 = icmp eq i32 %or10.i36, %or10.i21, !dbg !2254
  br i1 %cmp6, label %if.then, label %if.end, !dbg !2255
...
return:                                           ; preds = %if.end, %if.then
  %26 = load i32, i32* %retval, align 4, !dbg !2259
  ret i32 %26, !dbg !2259
}

; Function Attrs: nounwind uwtable
define internal i32 @nsp_read_header(%struct.AVFormatContext* %s) #0 !dbg !2260 {
entry:
  %s.addr.i41 = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i41, metadata !2265, metadata !2153), !dbg !2269
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2265, metadata !2153), !dbg !2273
  %retval = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2275, metadata !2153), !dbg !2276
  call void @llvm.dbg.declare(metadata i32* %channels, metadata !2277, metadata !2153), !dbg !2278
  store i32 0, i32* %channels, align 4, !dbg !2278
  call void @llvm.dbg.declare(metadata i32* %rate, metadata !2279, metadata !2153), !dbg !2280
  store i32 0, i32* %rate, align 4, !dbg !2280
  call void @llvm.dbg.declare(metadata i32* %chunk, metadata !2281, metadata !2153), !dbg !2282
  call void @llvm.dbg.declare(metadata i32* %size, metadata !2283, metadata !2153), !dbg !2284
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2285, metadata !2153), !dbg !2286
  call void @llvm.dbg.declare(metadata i64* %pos, metadata !2287, metadata !2153), !dbg !2288
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2289
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2290
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2290
  %call = call i64 @avio_skip(%struct.AVIOContext* %1, i64 12), !dbg !2291
  %2 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2292
  %call1 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %2, %struct.AVCodec* null), !dbg !2293
  store %struct.AVStream* %call1, %struct.AVStream** %st, align 8, !dbg !2294
  %3 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2295
  %tobool = icmp ne %struct.AVStream* %3, null, !dbg !2295
  br i1 %tobool, label %if.end, label %if.then, !dbg !2297
...
while.cond:                                       ; preds = %if.end35, %if.end
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2300
  %pb2 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %4, i32 0, i32 4, !dbg !2302
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb2, align 8, !dbg !2302
  %call3 = call i32 @avio_feof(%struct.AVIOContext* %5), !dbg !2303
  %tobool4 = icmp ne i32 %call3, 0, !dbg !2304
  %lnot = xor i1 %tobool4, true, !dbg !2304
  br i1 %lnot, label %while.body, label %while.end, !dbg !2305

while.body:                                       ; preds = %while.cond
  call void @llvm.dbg.declare(metadata [1024 x i8]* %value, metadata !2306, metadata !2153), !dbg !2307
  %6 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2308
  %pb5 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %6, i32 0, i32 4, !dbg !2309
  %7 = load %struct.AVIOContext*, %struct.AVIOContext** %pb5, align 8, !dbg !2309
  %call6 = call i32 @avio_rb32(%struct.AVIOContext* %7), !dbg !2310
  store i32 %call6, i32* %chunk, align 4, !dbg !2311
  %8 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2312
  %pb7 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %8, i32 0, i32 4, !dbg !2313
  %9 = load %struct.AVIOContext*, %struct.AVIOContext** %pb7, align 8, !dbg !2313
  %call8 = call i32 @avio_rl32(%struct.AVIOContext* %9), !dbg !2314
  store i32 %call8, i32* %size, align 4, !dbg !2315
  %10 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2316
  %pb9 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %10, i32 0, i32 4, !dbg !2317
  %11 = load %struct.AVIOContext*, %struct.AVIOContext** %pb9, align 8, !dbg !2317
  store %struct.AVIOContext* %11, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2318
  %12 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2319
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %12, i64 0, i32 1) #3, !dbg !2320
  store i64 %call.i, i64* %pos, align 8, !dbg !2321
  %13 = load i32, i32* %chunk, align 4, !dbg !2322
  switch i32 %13, label %sw.epilog [
    i32 1212499026, label %sw.bb
    i32 1212437048, label %sw.bb
    i32 1313821765, label %sw.bb22
    i32 1396982082, label %sw.bb30
    i32 1396989746, label %sw.bb31
    i32 1396989747, label %sw.bb31
    i32 1396989748, label %sw.bb31
    i32 1396989749, label %sw.bb31
    i32 1396989750, label %sw.bb31
    i32 1396989751, label %sw.bb31
    i32 1396989752, label %sw.bb31
    i32 1396982111, label %sw.bb32
    i32 1396989761, label %sw.bb32
  ], !dbg !2323

sw.bb:                                            ; preds = %while.body, %while.body
  %14 = load i32, i32* %size, align 4, !dbg !2324
  %cmp = icmp ult i32 %14, 32, !dbg !2326
  br i1 %cmp, label %if.then11, label %if.end12, !dbg !2327

if.then11:                                        ; preds = %sw.bb
  store i32 -1094995529, i32* %retval, align 4, !dbg !2328
  br label %return, !dbg !2328

if.end12:                                         ; preds = %sw.bb
  %15 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2329
  %pb13 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %15, i32 0, i32 4, !dbg !2330
  %16 = load %struct.AVIOContext*, %struct.AVIOContext** %pb13, align 8, !dbg !2330
  %call14 = call i64 @avio_skip(%struct.AVIOContext* %16, i64 20), !dbg !2331
  %17 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2332
  %pb15 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %17, i32 0, i32 4, !dbg !2333
  %18 = load %struct.AVIOContext*, %struct.AVIOContext** %pb15, align 8, !dbg !2333
  %call16 = call i32 @avio_rl32(%struct.AVIOContext* %18), !dbg !2334
  store i32 %call16, i32* %rate, align 4, !dbg !2335
  %19 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2336
  %pb17 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %19, i32 0, i32 4, !dbg !2337
  %20 = load %struct.AVIOContext*, %struct.AVIOContext** %pb17, align 8, !dbg !2337
  %21 = load i32, i32* %size, align 4, !dbg !2338
  %conv = zext i32 %21 to i64, !dbg !2338
  %22 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2339
  %pb18 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %22, i32 0, i32 4, !dbg !2340
  %23 = load %struct.AVIOContext*, %struct.AVIOContext** %pb18, align 8, !dbg !2340
  store %struct.AVIOContext* %23, %struct.AVIOContext** %s.addr.i41, align 8, !dbg !2341
  %24 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i41, align 8, !dbg !2342
  %call.i42 = call i64 @avio_seek(%struct.AVIOContext* %24, i64 0, i32 1) #3, !dbg !2343
  %25 = load i64, i64* %pos, align 8, !dbg !2344
  %sub = sub nsw i64 %call.i42, %25, !dbg !2345
  %sub20 = sub nsw i64 %conv, %sub, !dbg !2346
  %call21 = call i64 @avio_skip(%struct.AVIOContext* %20, i64 %sub20), !dbg !2347
  br label %sw.epilog, !dbg !2349

sw.bb22:                                          ; preds = %while.body
  %26 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2350
  %pb23 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %26, i32 0, i32 4, !dbg !2351
  %27 = load %struct.AVIOContext*, %struct.AVIOContext** %pb23, align 8, !dbg !2351
  %28 = load i32, i32* %size, align 4, !dbg !2352
  %arraydecay = getelementptr inbounds [1024 x i8], [1024 x i8]* %value, i32 0, i32 0, !dbg !2353
  %call24 = call i32 @avio_get_str(%struct.AVIOContext* %27, i32 %28, i8* %arraydecay, i32 1024), !dbg !2354
  %29 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2355
  %metadata = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %29, i32 0, i32 29, !dbg !2356
  %arraydecay25 = getelementptr inbounds [1024 x i8], [1024 x i8]* %value, i32 0, i32 0, !dbg !2357
  %call26 = call i32 @av_dict_set(%struct.AVDictionary** %metadata, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i32 0, i32 0), i8* %arraydecay25, i32 0), !dbg !2358
  %30 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2359
  %pb27 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %30, i32 0, i32 4, !dbg !2360
  %31 = load %struct.AVIOContext*, %struct.AVIOContext** %pb27, align 8, !dbg !2360
  %32 = load i32, i32* %size, align 4, !dbg !2361
  %and = and i32 %32, 1, !dbg !2362
  %conv28 = zext i32 %and to i64, !dbg !2361
  %call29 = call i64 @avio_skip(%struct.AVIOContext* %31, i64 %conv28), !dbg !2363
  br label %sw.epilog, !dbg !2364

sw.bb30:                                          ; preds = %while.body
  store i32 2, i32* %channels, align 4, !dbg !2365
  br label %sw.epilog, !dbg !2366

sw.bb31:                                          ; preds = %while.body, %while.body, %while.body, %while.body, %while.body, %while.body, %while.body
  %33 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2367
  %34 = bitcast %struct.AVFormatContext* %33 to i8*, !dbg !2367
  call void (i8*, i32, i8*, ...) @av_log(i8* %34, i32 24, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.5, i32 0, i32 0)), !dbg !2368
  br label %sw.bb32, !dbg !2368

sw.bb32:                                          ; preds = %while.body, %while.body, %sw.bb31
  store i32 1, i32* %channels, align 4, !dbg !2369
  br label %sw.epilog, !dbg !2370

sw.epilog:                                        ; preds = %while.body, %sw.bb32, %sw.bb30, %sw.bb22, %if.end12
  %35 = load i32, i32* %channels, align 4, !dbg !2371
  %tobool33 = icmp ne i32 %35, 0, !dbg !2371
  br i1 %tobool33, label %if.then34, label %if.end35, !dbg !2373

if.then34:                                        ; preds = %sw.epilog
  br label %while.end, !dbg !2374

if.end35:                                         ; preds = %sw.epilog
  br label %while.cond, !dbg !2375, !llvm.loop !2377

while.end:                                        ; preds = %if.then34, %while.cond
  %36 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2378
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %36, i32 0, i32 19, !dbg !2379
  %37 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2379
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %37, i32 0, i32 0, !dbg !2380
  store i32 1, i32* %codec_type, align 8, !dbg !2381
  %38 = load i32, i32* %channels, align 4, !dbg !2382
  %39 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2383
  %codecpar36 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %39, i32 0, i32 19, !dbg !2384
  %40 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar36, align 8, !dbg !2384
  %channels37 = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %40, i32 0, i32 22, !dbg !2385
  store i32 %38, i32* %channels37, align 8, !dbg !2386
  %41 = load i32, i32* %rate, align 4, !dbg !2387
  %42 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2388
  %codecpar38 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %42, i32 0, i32 19, !dbg !2389
  %43 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar38, align 8, !dbg !2389
  %sample_rate = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %43, i32 0, i32 23, !dbg !2390
  store i32 %41, i32* %sample_rate, align 4, !dbg !2391
  %44 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2392
  %codecpar39 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %44, i32 0, i32 19, !dbg !2393
  %45 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar39, align 8, !dbg !2393
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %45, i32 0, i32 1, !dbg !2394
  store i32 65536, i32* %codec_id, align 4, !dbg !2395
  %46 = load i32, i32* %channels, align 4, !dbg !2396
  %mul = mul nsw i32 2, %46, !dbg !2397
  %47 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2398
  %codecpar40 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %47, i32 0, i32 19, !dbg !2399
  %48 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar40, align 8, !dbg !2399
  %block_align = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %48, i32 0, i32 24, !dbg !2400
  store i32 %mul, i32* %block_align, align 8, !dbg !2401
  store i32 0, i32* %retval, align 4, !dbg !2402
  br label %return, !dbg !2402

return:                                           ; preds = %while.end, %if.then11, %if.then
  %49 = load i32, i32* %retval, align 4, !dbg !2403
  ret i32 %49, !dbg !2403
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--nspdec.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!927 = !{!928}
!928 = distinct !DIGlobalVariable(name: "ff_nsp_demuxer", scope: !0, file: !929, line: 99, type: !930, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_nsp_demuxer)
!929 = !DIFile(filename: "libavformat/nspdec.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2146 = distinct !DISubprogram(name: "nsp_probe", scope: !929, file: !929, line: 28, type: !999, isLocal: true, isDefinition: true, scopeLine: 29, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2147 = !{}
...
!2155 = distinct !DILocation(line: 30, column: 69, scope: !2156)
!2156 = !DILexicalBlockFile(scope: !2157, file: !929, discriminator: 2)
!2157 = distinct !DILexicalBlock(scope: !2146, file: !929, line: 30, column: 9)
!2158 = !DILocation(line: 66, column: 98, scope: !2149, inlinedAt: !2159)
!2159 = distinct !DILocation(line: 31, column: 9, scope: !2157)
!2160 = !DILocation(line: 66, column: 98, scope: !2149, inlinedAt: !2161)
!2161 = distinct !DILocation(line: 31, column: 73, scope: !2162)
!2162 = !DILexicalBlockFile(scope: !2157, file: !929, discriminator: 1)
!2163 = !DILocation(line: 66, column: 98, scope: !2149, inlinedAt: !2164)
!2164 = distinct !DILocation(line: 30, column: 9, scope: !2157)
!2165 = !DILocalVariable(name: "p", arg: 1, scope: !2146, file: !929, line: 28, type: !1001)
!2166 = !DILocation(line: 28, column: 35, scope: !2146)
!2167 = !DILocation(line: 30, column: 52, scope: !2157)
!2168 = !DILocation(line: 30, column: 55, scope: !2157)
!2169 = !DILocation(line: 30, column: 62, scope: !2157)
!2170 = !DILocation(line: 30, column: 9, scope: !2157)
!2171 = !DILocation(line: 68, column: 16, scope: !2149, inlinedAt: !2164)
!2172 = !DILocation(line: 68, column: 19, scope: !2149, inlinedAt: !2164)
!2173 = !DILocation(line: 68, column: 24, scope: !2149, inlinedAt: !2164)
!2174 = !DILocation(line: 68, column: 38, scope: !2149, inlinedAt: !2164)
!2175 = !DILocation(line: 68, column: 41, scope: !2149, inlinedAt: !2164)
!2176 = !DILocation(line: 68, column: 46, scope: !2149, inlinedAt: !2164)
!2177 = !DILocation(line: 68, column: 34, scope: !2149, inlinedAt: !2164)
!2178 = !DILocation(line: 68, column: 57, scope: !2149, inlinedAt: !2164)
!2179 = !DILocation(line: 68, column: 69, scope: !2149, inlinedAt: !2164)
!2180 = !DILocation(line: 68, column: 72, scope: !2149, inlinedAt: !2164)
!2181 = !DILocation(line: 68, column: 79, scope: !2149, inlinedAt: !2164)
!2182 = !DILocation(line: 68, column: 84, scope: !2149, inlinedAt: !2164)
!2183 = !DILocation(line: 68, column: 99, scope: !2149, inlinedAt: !2164)
!2184 = !DILocation(line: 68, column: 102, scope: !2149, inlinedAt: !2164)
!2185 = !DILocation(line: 68, column: 109, scope: !2149, inlinedAt: !2164)
!2186 = !DILocation(line: 68, column: 114, scope: !2149, inlinedAt: !2164)
!2187 = !DILocation(line: 68, column: 94, scope: !2149, inlinedAt: !2164)
!2188 = !DILocation(line: 68, column: 63, scope: !2149, inlinedAt: !2164)
!2189 = !DILocation(line: 30, column: 122, scope: !2157)
!2190 = !DILocation(line: 30, column: 69, scope: !2156)
!2191 = !DILocation(line: 68, column: 16, scope: !2149, inlinedAt: !2155)
!2192 = !DILocation(line: 68, column: 19, scope: !2149, inlinedAt: !2155)
!2193 = !DILocation(line: 68, column: 24, scope: !2149, inlinedAt: !2155)
!2194 = !DILocation(line: 68, column: 38, scope: !2149, inlinedAt: !2155)
!2195 = !DILocation(line: 68, column: 41, scope: !2149, inlinedAt: !2155)
!2196 = !DILocation(line: 68, column: 46, scope: !2149, inlinedAt: !2155)
!2197 = !DILocation(line: 68, column: 34, scope: !2149, inlinedAt: !2155)
!2198 = !DILocation(line: 68, column: 57, scope: !2149, inlinedAt: !2155)
!2199 = !DILocation(line: 68, column: 69, scope: !2149, inlinedAt: !2155)
!2200 = !DILocation(line: 68, column: 72, scope: !2149, inlinedAt: !2155)
!2201 = !DILocation(line: 68, column: 79, scope: !2149, inlinedAt: !2155)
!2202 = !DILocation(line: 68, column: 84, scope: !2149, inlinedAt: !2155)
!2203 = !DILocation(line: 68, column: 99, scope: !2149, inlinedAt: !2155)
!2204 = !DILocation(line: 68, column: 102, scope: !2149, inlinedAt: !2155)
!2205 = !DILocation(line: 68, column: 109, scope: !2149, inlinedAt: !2155)
!2206 = !DILocation(line: 68, column: 114, scope: !2149, inlinedAt: !2155)
!2207 = !DILocation(line: 68, column: 94, scope: !2149, inlinedAt: !2155)
!2208 = !DILocation(line: 68, column: 63, scope: !2149, inlinedAt: !2155)
!2209 = !DILocation(line: 30, column: 66, scope: !2157)
!2210 = !DILocation(line: 30, column: 126, scope: !2157)
!2211 = !DILocation(line: 31, column: 52, scope: !2157)
!2212 = !DILocation(line: 31, column: 55, scope: !2157)
!2213 = !DILocation(line: 31, column: 59, scope: !2157)
!2214 = !DILocation(line: 31, column: 66, scope: !2157)
!2215 = !DILocation(line: 31, column: 9, scope: !2157)
!2216 = !DILocation(line: 68, column: 16, scope: !2149, inlinedAt: !2159)
!2217 = !DILocation(line: 68, column: 19, scope: !2149, inlinedAt: !2159)
!2218 = !DILocation(line: 68, column: 24, scope: !2149, inlinedAt: !2159)
!2219 = !DILocation(line: 68, column: 38, scope: !2149, inlinedAt: !2159)
!2220 = !DILocation(line: 68, column: 41, scope: !2149, inlinedAt: !2159)
!2221 = !DILocation(line: 68, column: 46, scope: !2149, inlinedAt: !2159)
!2222 = !DILocation(line: 68, column: 34, scope: !2149, inlinedAt: !2159)
!2223 = !DILocation(line: 68, column: 57, scope: !2149, inlinedAt: !2159)
!2224 = !DILocation(line: 68, column: 69, scope: !2149, inlinedAt: !2159)
!2225 = !DILocation(line: 68, column: 72, scope: !2149, inlinedAt: !2159)
!2226 = !DILocation(line: 68, column: 79, scope: !2149, inlinedAt: !2159)
!2227 = !DILocation(line: 68, column: 84, scope: !2149, inlinedAt: !2159)
!2228 = !DILocation(line: 68, column: 99, scope: !2149, inlinedAt: !2159)
!2229 = !DILocation(line: 68, column: 102, scope: !2149, inlinedAt: !2159)
!2230 = !DILocation(line: 68, column: 109, scope: !2149, inlinedAt: !2159)
!2231 = !DILocation(line: 68, column: 114, scope: !2149, inlinedAt: !2159)
!2232 = !DILocation(line: 68, column: 94, scope: !2149, inlinedAt: !2159)
!2233 = !DILocation(line: 68, column: 63, scope: !2149, inlinedAt: !2159)
!2234 = !DILocation(line: 31, column: 126, scope: !2157)
!2235 = !DILocation(line: 31, column: 73, scope: !2162)
!2236 = !DILocation(line: 68, column: 16, scope: !2149, inlinedAt: !2161)
!2237 = !DILocation(line: 68, column: 19, scope: !2149, inlinedAt: !2161)
!2238 = !DILocation(line: 68, column: 24, scope: !2149, inlinedAt: !2161)
!2239 = !DILocation(line: 68, column: 38, scope: !2149, inlinedAt: !2161)
!2240 = !DILocation(line: 68, column: 41, scope: !2149, inlinedAt: !2161)
!2241 = !DILocation(line: 68, column: 46, scope: !2149, inlinedAt: !2161)
!2242 = !DILocation(line: 68, column: 34, scope: !2149, inlinedAt: !2161)
!2243 = !DILocation(line: 68, column: 57, scope: !2149, inlinedAt: !2161)
!2244 = !DILocation(line: 68, column: 69, scope: !2149, inlinedAt: !2161)
!2245 = !DILocation(line: 68, column: 72, scope: !2149, inlinedAt: !2161)
!2246 = !DILocation(line: 68, column: 79, scope: !2149, inlinedAt: !2161)
!2247 = !DILocation(line: 68, column: 84, scope: !2149, inlinedAt: !2161)
!2248 = !DILocation(line: 68, column: 99, scope: !2149, inlinedAt: !2161)
!2249 = !DILocation(line: 68, column: 102, scope: !2149, inlinedAt: !2161)
!2250 = !DILocation(line: 68, column: 109, scope: !2149, inlinedAt: !2161)
!2251 = !DILocation(line: 68, column: 114, scope: !2149, inlinedAt: !2161)
!2252 = !DILocation(line: 68, column: 94, scope: !2149, inlinedAt: !2161)
!2253 = !DILocation(line: 68, column: 63, scope: !2149, inlinedAt: !2161)
!2254 = !DILocation(line: 31, column: 70, scope: !2157)
!2255 = !DILocation(line: 30, column: 9, scope: !2256)
!2256 = !DILexicalBlockFile(scope: !2146, file: !929, discriminator: 1)
!2257 = !DILocation(line: 32, column: 9, scope: !2157)
!2258 = !DILocation(line: 33, column: 5, scope: !2146)
!2259 = !DILocation(line: 34, column: 1, scope: !2146)
!2260 = distinct !DISubprogram(name: "nsp_read_header", scope: !929, file: !929, line: 36, type: !2261, isLocal: true, isDefinition: true, scopeLine: 37, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2261 = !DISubroutineType(types: !2262)
!2262 = !{!926, !2263}
!2263 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2264, size: 64, align: 64)
!2264 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1016)
!2265 = !DILocalVariable(name: "s", arg: 1, scope: !2266, file: !628, line: 557, type: !1222)
!2266 = distinct !DISubprogram(name: "avio_tell", scope: !628, file: !628, line: 557, type: !2267, isLocal: true, isDefinition: true, scopeLine: 558, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2267 = !DISubroutineType(types: !2268)
!2268 = !{!1060, !1222}
!2269 = !DILocation(line: 557, column: 77, scope: !2266, inlinedAt: !2270)
!2270 = distinct !DILocation(line: 62, column: 38, scope: !2271)
!2271 = distinct !DILexicalBlock(scope: !2272, file: !929, line: 55, column: 24)
!2272 = distinct !DILexicalBlock(scope: !2260, file: !929, line: 48, column: 31)
!2273 = !DILocation(line: 557, column: 77, scope: !2266, inlinedAt: !2274)
!2274 = distinct !DILocation(line: 53, column: 15, scope: !2272)
!2275 = !DILocalVariable(name: "s", arg: 1, scope: !2260, file: !929, line: 36, type: !2263)
!2276 = !DILocation(line: 36, column: 45, scope: !2260)
!2277 = !DILocalVariable(name: "channels", scope: !2260, file: !929, line: 38, type: !926)
!2278 = !DILocation(line: 38, column: 9, scope: !2260)
!2279 = !DILocalVariable(name: "rate", scope: !2260, file: !929, line: 38, type: !926)
!2280 = !DILocation(line: 38, column: 23, scope: !2260)
!2281 = !DILocalVariable(name: "chunk", scope: !2260, file: !929, line: 39, type: !923)
!2282 = !DILocation(line: 39, column: 14, scope: !2260)
!2283 = !DILocalVariable(name: "size", scope: !2260, file: !929, line: 39, type: !923)
!2284 = !DILocation(line: 39, column: 21, scope: !2260)
!2285 = !DILocalVariable(name: "st", scope: !2260, file: !929, line: 40, type: !1290)
!2286 = !DILocation(line: 40, column: 15, scope: !2260)
!2287 = !DILocalVariable(name: "pos", scope: !2260, file: !929, line: 41, type: !1060)
!2288 = !DILocation(line: 41, column: 13, scope: !2260)
!2289 = !DILocation(line: 43, column: 15, scope: !2260)
!2290 = !DILocation(line: 43, column: 18, scope: !2260)
!2291 = !DILocation(line: 43, column: 5, scope: !2260)
!2292 = !DILocation(line: 44, column: 30, scope: !2260)
!2293 = !DILocation(line: 44, column: 10, scope: !2260)
!2294 = !DILocation(line: 44, column: 8, scope: !2260)
!2295 = !DILocation(line: 45, column: 10, scope: !2296)
!2296 = distinct !DILexicalBlock(scope: !2260, file: !929, line: 45, column: 9)
!2297 = !DILocation(line: 45, column: 9, scope: !2260)
!2298 = !DILocation(line: 46, column: 9, scope: !2296)
!2299 = !DILocation(line: 48, column: 5, scope: !2260)
!2300 = !DILocation(line: 48, column: 23, scope: !2301)
!2301 = !DILexicalBlockFile(scope: !2260, file: !929, discriminator: 1)
!2302 = !DILocation(line: 48, column: 26, scope: !2301)
!2303 = !DILocation(line: 48, column: 13, scope: !2301)
!2304 = !DILocation(line: 48, column: 12, scope: !2301)
!2305 = !DILocation(line: 48, column: 5, scope: !2301)
!2306 = !DILocalVariable(name: "value", scope: !2272, file: !929, line: 49, type: !1982)
!2307 = !DILocation(line: 49, column: 14, scope: !2272)
!2308 = !DILocation(line: 51, column: 27, scope: !2272)
!2309 = !DILocation(line: 51, column: 30, scope: !2272)
!2310 = !DILocation(line: 51, column: 17, scope: !2272)
!2311 = !DILocation(line: 51, column: 15, scope: !2272)
!2312 = !DILocation(line: 52, column: 26, scope: !2272)
!2313 = !DILocation(line: 52, column: 29, scope: !2272)
!2314 = !DILocation(line: 52, column: 16, scope: !2272)
!2315 = !DILocation(line: 52, column: 14, scope: !2272)
!2316 = !DILocation(line: 53, column: 25, scope: !2272)
!2317 = !DILocation(line: 53, column: 28, scope: !2272)
!2318 = !DILocation(line: 53, column: 15, scope: !2272)
!2319 = !DILocation(line: 559, column: 22, scope: !2266, inlinedAt: !2274)
!2320 = !DILocation(line: 559, column: 12, scope: !2266, inlinedAt: !2274)
!2321 = !DILocation(line: 53, column: 13, scope: !2272)
!2322 = !DILocation(line: 55, column: 17, scope: !2272)
!2323 = !DILocation(line: 55, column: 9, scope: !2272)
!2324 = !DILocation(line: 58, column: 17, scope: !2325)
!2325 = distinct !DILexicalBlock(scope: !2271, file: !929, line: 58, column: 17)
!2326 = !DILocation(line: 58, column: 22, scope: !2325)
!2327 = !DILocation(line: 58, column: 17, scope: !2271)
!2328 = !DILocation(line: 59, column: 17, scope: !2325)
!2329 = !DILocation(line: 60, column: 23, scope: !2271)
!2330 = !DILocation(line: 60, column: 26, scope: !2271)
!2331 = !DILocation(line: 60, column: 13, scope: !2271)
!2332 = !DILocation(line: 61, column: 30, scope: !2271)
!2333 = !DILocation(line: 61, column: 33, scope: !2271)
!2334 = !DILocation(line: 61, column: 20, scope: !2271)
!2335 = !DILocation(line: 61, column: 18, scope: !2271)
!2336 = !DILocation(line: 62, column: 23, scope: !2271)
!2337 = !DILocation(line: 62, column: 26, scope: !2271)
!2338 = !DILocation(line: 62, column: 30, scope: !2271)
!2339 = !DILocation(line: 62, column: 48, scope: !2271)
!2340 = !DILocation(line: 62, column: 51, scope: !2271)
!2341 = !DILocation(line: 62, column: 38, scope: !2271)
!2342 = !DILocation(line: 559, column: 22, scope: !2266, inlinedAt: !2270)
!2343 = !DILocation(line: 559, column: 12, scope: !2266, inlinedAt: !2270)
!2344 = !DILocation(line: 62, column: 57, scope: !2271)
!2345 = !DILocation(line: 62, column: 55, scope: !2271)
!2346 = !DILocation(line: 62, column: 35, scope: !2271)
!2347 = !DILocation(line: 62, column: 13, scope: !2348)
!2348 = !DILexicalBlockFile(scope: !2271, file: !929, discriminator: 1)
!2349 = !DILocation(line: 63, column: 13, scope: !2271)
!2350 = !DILocation(line: 65, column: 26, scope: !2271)
!2351 = !DILocation(line: 65, column: 29, scope: !2271)
!2352 = !DILocation(line: 65, column: 33, scope: !2271)
!2353 = !DILocation(line: 65, column: 39, scope: !2271)
!2354 = !DILocation(line: 65, column: 13, scope: !2271)
!2355 = !DILocation(line: 66, column: 26, scope: !2271)
!2356 = !DILocation(line: 66, column: 29, scope: !2271)
!2357 = !DILocation(line: 66, column: 50, scope: !2271)
!2358 = !DILocation(line: 66, column: 13, scope: !2271)
!2359 = !DILocation(line: 67, column: 23, scope: !2271)
!2360 = !DILocation(line: 67, column: 26, scope: !2271)
!2361 = !DILocation(line: 67, column: 30, scope: !2271)
!2362 = !DILocation(line: 67, column: 35, scope: !2271)
!2363 = !DILocation(line: 67, column: 13, scope: !2271)
!2364 = !DILocation(line: 68, column: 13, scope: !2271)
!2365 = !DILocation(line: 70, column: 22, scope: !2271)
!2366 = !DILocation(line: 71, column: 13, scope: !2271)
!2367 = !DILocation(line: 79, column: 20, scope: !2271)
!2368 = !DILocation(line: 79, column: 13, scope: !2271)
!2369 = !DILocation(line: 82, column: 22, scope: !2271)
!2370 = !DILocation(line: 83, column: 13, scope: !2271)
!2371 = !DILocation(line: 86, column: 13, scope: !2372)
!2372 = distinct !DILexicalBlock(scope: !2272, file: !929, line: 86, column: 13)
!2373 = !DILocation(line: 86, column: 13, scope: !2272)
!2374 = !DILocation(line: 87, column: 13, scope: !2372)
!2375 = !DILocation(line: 48, column: 5, scope: !2376)
!2376 = !DILexicalBlockFile(scope: !2260, file: !929, discriminator: 2)
!2377 = distinct !{!2377, !2299}
!2378 = !DILocation(line: 90, column: 5, scope: !2260)
!2379 = !DILocation(line: 90, column: 9, scope: !2260)
!2380 = !DILocation(line: 90, column: 19, scope: !2260)
!2381 = !DILocation(line: 90, column: 30, scope: !2260)
!2382 = !DILocation(line: 91, column: 30, scope: !2260)
!2383 = !DILocation(line: 91, column: 5, scope: !2260)
!2384 = !DILocation(line: 91, column: 9, scope: !2260)
!2385 = !DILocation(line: 91, column: 19, scope: !2260)
!2386 = !DILocation(line: 91, column: 28, scope: !2260)
!2387 = !DILocation(line: 92, column: 33, scope: !2260)
!2388 = !DILocation(line: 92, column: 5, scope: !2260)
!2389 = !DILocation(line: 92, column: 9, scope: !2260)
!2390 = !DILocation(line: 92, column: 19, scope: !2260)
!2391 = !DILocation(line: 92, column: 31, scope: !2260)
!2392 = !DILocation(line: 93, column: 5, scope: !2260)
!2393 = !DILocation(line: 93, column: 9, scope: !2260)
!2394 = !DILocation(line: 93, column: 19, scope: !2260)
!2395 = !DILocation(line: 93, column: 28, scope: !2260)
!2396 = !DILocation(line: 94, column: 37, scope: !2260)
!2397 = !DILocation(line: 94, column: 35, scope: !2260)
!2398 = !DILocation(line: 94, column: 5, scope: !2260)
!2399 = !DILocation(line: 94, column: 9, scope: !2260)
!2400 = !DILocation(line: 94, column: 19, scope: !2260)
!2401 = !DILocation(line: 94, column: 31, scope: !2260)
!2402 = !DILocation(line: 96, column: 5, scope: !2260)
!2403 = !DILocation(line: 97, column: 1, scope: !2260)
