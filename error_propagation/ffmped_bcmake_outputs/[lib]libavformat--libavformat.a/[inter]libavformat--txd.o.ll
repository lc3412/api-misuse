; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--txd.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--txd.o.i"
...
@.str.1 = private unnamed_addr constant [30 x i8] c"Renderware TeXture Dictionary\00", align 1
@ff_txd_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.1, i32 0, i32 0), i32 0, i8* null, %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 0, i32 (%struct.AVProbeData*)* @txd_probe, i32 (%struct.AVFormatContext*)* @txd_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @txd_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
@.str.2 = private unnamed_addr constant [23 x i8] c"marker does not match\0A\00", align 1
@.str.3 = private unnamed_addr constant [21 x i8] c"unknown chunk id %i\0A\00", align 1

; Function Attrs: nounwind uwtable
define internal i32 @txd_probe(%struct.AVProbeData* %pd) #0 !dbg !2146 {
entry:
  ...
  %0 = load %struct.AVProbeData*, %struct.AVProbeData** %pd.addr, align 8, !dbg !2151
  ...
  %cmp = icmp eq i32 %3, 22, !dbg !2155
  br i1 %cmp, label %land.lhs.true, label %if.end, !dbg !2156

land.lhs.true:                                    ; preds = %entry
  %4 = load %struct.AVProbeData*, %struct.AVProbeData** %pd.addr, align 8, !dbg !2157
  ...
  %add.ptr = getelementptr inbounds i8, i8* %5, i64 8, !dbg !2159
  ...
  %cmp3 = icmp eq i32 %7, 402915327, !dbg !2161
  br i1 %cmp3, label %if.then, label %lor.lhs.false, !dbg !2162

lor.lhs.false:                                    ; preds = %land.lhs.true
  %8 = load %struct.AVProbeData*, %struct.AVProbeData** %pd.addr, align 8, !dbg !2163
  %buf4 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %8, i32 0, i32 1, !dbg !2165
  %9 = load i8*, i8** %buf4, align 8, !dbg !2165
  %add.ptr5 = getelementptr inbounds i8, i8* %9, i64 8, !dbg !2166
  %10 = bitcast i8* %add.ptr5 to %union.unaligned_32*, !dbg !2167
  %l6 = bitcast %union.unaligned_32* %10 to i32*, !dbg !2167
  %11 = load i32, i32* %l6, align 1, !dbg !2167
  %cmp7 = icmp eq i32 %11, 268697599, !dbg !2168
  br i1 %cmp7, label %if.then, label %if.end, !dbg !2169
...
; Function Attrs: nounwind uwtable
define internal i32 @txd_read_header(%struct.AVFormatContext* %s) #0 !dbg !2174 {
entry:
  %retval.i = alloca %struct.AVRational, align 4
  %q.i = alloca %struct.AVRational, align 4
  call void @llvm.dbg.declare(metadata %struct.AVRational* %q.i, metadata !2179, metadata !2149), !dbg !2183
  %r.i = alloca %struct.AVRational, align 4
  call void @llvm.dbg.declare(metadata %struct.AVRational* %r.i, metadata !2185, metadata !2149), !dbg !2186
  %retval = alloca i32, align 4
  ...
  %call = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %0, %struct.AVCodec* null), !dbg !2192
  store %struct.AVStream* %call, %struct.AVStream** %st, align 8, !dbg !2193
  %1 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2194
  %tobool = icmp ne %struct.AVStream* %1, null, !dbg !2194
...
if.end:                                           ; preds = %entry
  %2 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2198
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %2, i32 0, i32 19, !dbg !2199
  %3 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2199
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %3, i32 0, i32 0, !dbg !2200
  store i32 0, i32* %codec_type, align 8, !dbg !2201
  %4 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2202
  %codecpar1 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %4, i32 0, i32 19, !dbg !2203
  %5 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar1, align 8, !dbg !2203
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %5, i32 0, i32 1, !dbg !2204
  store i32 105, i32* %codec_id, align 4, !dbg !2205
  %6 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2206
  call void @avpriv_set_pts_info(%struct.AVStream* %6, i32 64, i32 1, i32 5), !dbg !2207
  %7 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2208
  %avg_frame_rate = getelementptr inbounds %struct.AVStream, %struct.AVStream* %7, i32 0, i32 12, !dbg !2209
  %8 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2210
  %time_base = getelementptr inbounds %struct.AVStream, %struct.AVStream* %8, i32 0, i32 4, !dbg !2211
  %9 = bitcast %struct.AVRational* %time_base to i64*, !dbg !2212
  %10 = load i64, i64* %9, align 8, !dbg !2212
  %11 = bitcast %struct.AVRational* %q.i to i64*, !dbg !2212
  store i64 %10, i64* %11, align 4, !dbg !2212
  %num.i = getelementptr inbounds %struct.AVRational, %struct.AVRational* %r.i, i32 0, i32 0, !dbg !2213
  %den.i = getelementptr inbounds %struct.AVRational, %struct.AVRational* %q.i, i32 0, i32 1, !dbg !2214
  %12 = load i32, i32* %den.i, align 4, !dbg !2214
  store i32 %12, i32* %num.i, align 4, !dbg !2213
  %den1.i = getelementptr inbounds %struct.AVRational, %struct.AVRational* %r.i, i32 0, i32 1, !dbg !2213
  %num2.i = getelementptr inbounds %struct.AVRational, %struct.AVRational* %q.i, i32 0, i32 0, !dbg !2215
  %13 = load i32, i32* %num2.i, align 4, !dbg !2215
  store i32 %13, i32* %den1.i, align 4, !dbg !2213
  %14 = bitcast %struct.AVRational* %retval.i to i8*, !dbg !2216
  %15 = bitcast %struct.AVRational* %r.i to i8*, !dbg !2216
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %14, i8* %15, i64 8, i32 4, i1 false) #4, !dbg !2216
  %16 = bitcast %struct.AVRational* %retval.i to i64*, !dbg !2217
  %17 = load i64, i64* %16, align 4, !dbg !2217
  %18 = bitcast %struct.AVRational* %coerce to i64*, !dbg !2212
  store i64 %17, i64* %18, align 4, !dbg !2212
  %19 = bitcast %struct.AVRational* %avg_frame_rate to i8*, !dbg !2212
  %20 = bitcast %struct.AVRational* %coerce to i8*, !dbg !2212
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %19, i8* %20, i64 8, i32 4, i1 false), !dbg !2218
  store i32 0, i32* %retval, align 4, !dbg !2220
  br label %return, !dbg !2220

return:                                           ; preds = %if.end, %if.then
  %21 = load i32, i32* %retval, align 4, !dbg !2221
  ret i32 %21, !dbg !2221
}

; Function Attrs: nounwind uwtable
define internal i32 @txd_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2222 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2225, metadata !2149), !dbg !2226
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2227, metadata !2149), !dbg !2228
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2229, metadata !2149), !dbg !2230
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2231
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 4, !dbg !2232
  %1 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2232
  store %struct.AVIOContext* %1, %struct.AVIOContext** %pb, align 8, !dbg !2230
  call void @llvm.dbg.declare(metadata i32* %id, metadata !2233, metadata !2149), !dbg !2234
  call void @llvm.dbg.declare(metadata i32* %chunk_size, metadata !2235, metadata !2149), !dbg !2236
  call void @llvm.dbg.declare(metadata i32* %marker, metadata !2237, metadata !2149), !dbg !2238
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2239, metadata !2149), !dbg !2240
  br label %next_chunk, !dbg !2241

next_chunk:                                       ; preds = %sw.bb15, %entry
  %2 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2242
  %call = call i32 @avio_rl32(%struct.AVIOContext* %2), !dbg !2243
  store i32 %call, i32* %id, align 4, !dbg !2244
  %3 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2245
  %call2 = call i32 @avio_rl32(%struct.AVIOContext* %3), !dbg !2246
  store i32 %call2, i32* %chunk_size, align 4, !dbg !2247
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2248
  %call3 = call i32 @avio_rl32(%struct.AVIOContext* %4), !dbg !2249
  store i32 %call3, i32* %marker, align 4, !dbg !2250
  %5 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2251
  %pb4 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %5, i32 0, i32 4, !dbg !2253
  %6 = load %struct.AVIOContext*, %struct.AVIOContext** %pb4, align 8, !dbg !2253
  %call5 = call i32 @avio_feof(%struct.AVIOContext* %6), !dbg !2254
  %tobool = icmp ne i32 %call5, 0, !dbg !2254
  br i1 %tobool, label %if.then, label %if.end, !dbg !2255

if.then:                                          ; preds = %next_chunk
  store i32 -541478725, i32* %retval, align 4, !dbg !2256
  br label %return, !dbg !2256

if.end:                                           ; preds = %next_chunk
  %7 = load i32, i32* %marker, align 4, !dbg !2257
  %cmp = icmp ne i32 %7, 402915327, !dbg !2259
  br i1 %cmp, label %land.lhs.true, label %if.end8, !dbg !2260

land.lhs.true:                                    ; preds = %if.end
  %8 = load i32, i32* %marker, align 4, !dbg !2261
  %cmp6 = icmp ne i32 %8, 268697599, !dbg !2263
  br i1 %cmp6, label %if.then7, label %if.end8, !dbg !2264

if.then7:                                         ; preds = %land.lhs.true
  %9 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2265
  %10 = bitcast %struct.AVFormatContext* %9 to i8*, !dbg !2265
  call void (i8*, i32, i8*, ...) @av_log(i8* %10, i32 16, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.2, i32 0, i32 0)), !dbg !2267
  store i32 -1094995529, i32* %retval, align 4, !dbg !2268
  br label %return, !dbg !2268

if.end8:                                          ; preds = %land.lhs.true, %if.end
  %11 = load i32, i32* %id, align 4, !dbg !2269
...
sw.bb:                                            ; preds = %if.end8
  %12 = load i32, i32* %chunk_size, align 4, !dbg !2271
  %cmp9 = icmp ugt i32 %12, 100, !dbg !2274
  br i1 %cmp9, label %if.then10, label %if.end11, !dbg !2275

if.then10:                                        ; preds = %sw.bb
  br label %sw.epilog, !dbg !2276

if.end11:                                         ; preds = %sw.bb
  br label %sw.bb12, !dbg !2277

sw.bb12:                                          ; preds = %if.end8, %if.end11
  %13 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2279
  %pb13 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %13, i32 0, i32 4, !dbg !2280
  %14 = load %struct.AVIOContext*, %struct.AVIOContext** %pb13, align 8, !dbg !2280
  %15 = load i32, i32* %chunk_size, align 4, !dbg !2281
  %conv = zext i32 %15 to i64, !dbg !2281
  %call14 = call i64 @avio_skip(%struct.AVIOContext* %14, i64 %conv), !dbg !2282
  br label %sw.bb15, !dbg !2282

sw.bb15:                                          ; preds = %if.end8, %if.end8, %sw.bb12
  br label %next_chunk, !dbg !2283

sw.default:                                       ; preds = %if.end8
  %16 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2284
  %17 = bitcast %struct.AVFormatContext* %16 to i8*, !dbg !2284
  %18 = load i32, i32* %id, align 4, !dbg !2285
  call void (i8*, i32, i8*, ...) @av_log(i8* %17, i32 16, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.3, i32 0, i32 0), i32 %18), !dbg !2286
  store i32 -1094995529, i32* %retval, align 4, !dbg !2287
  br label %return, !dbg !2287

sw.epilog:                                        ; preds = %if.then10
  %19 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2288
  %pb16 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %19, i32 0, i32 4, !dbg !2289
  %20 = load %struct.AVIOContext*, %struct.AVIOContext** %pb16, align 8, !dbg !2289
  %21 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2290
  %22 = load i32, i32* %chunk_size, align 4, !dbg !2291
  %call17 = call i32 @av_get_packet(%struct.AVIOContext* %20, %struct.AVPacket* %21, i32 %22), !dbg !2292
  store i32 %call17, i32* %ret, align 4, !dbg !2293
  %23 = load i32, i32* %ret, align 4, !dbg !2294
  %cmp18 = icmp slt i32 %23, 0, !dbg !2296
  br i1 %cmp18, label %if.then20, label %if.end21, !dbg !2297

if.then20:                                        ; preds = %sw.epilog
  %24 = load i32, i32* %ret, align 4, !dbg !2298
  store i32 %24, i32* %retval, align 4, !dbg !2299
  br label %return, !dbg !2299

if.end21:                                         ; preds = %sw.epilog
  %25 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2300
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %25, i32 0, i32 5, !dbg !2301
  store i32 0, i32* %stream_index, align 4, !dbg !2302
  store i32 0, i32* %retval, align 4, !dbg !2303
  br label %return, !dbg !2303

return:                                           ; preds = %if.end21, %if.then20, %sw.default, %if.then7, %if.then
  %26 = load i32, i32* %retval, align 4, !dbg !2304
  ret i32 %26, !dbg !2304
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--txd.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!927 = !{!928}
!928 = distinct !DIGlobalVariable(name: "ff_txd_demuxer", scope: !0, file: !929, line: 95, type: !930, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_txd_demuxer)
!929 = !DIFile(filename: "libavformat/txd.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2146 = distinct !DISubprogram(name: "txd_probe", scope: !929, file: !929, line: 34, type: !999, isLocal: true, isDefinition: true, scopeLine: 34, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2147 = !{}
!2148 = !DILocalVariable(name: "pd", arg: 1, scope: !2146, file: !929, line: 34, type: !1001)
!2149 = !DIExpression()
!2150 = !DILocation(line: 34, column: 36, scope: !2146)
!2151 = !DILocation(line: 35, column: 41, scope: !2152)
!2152 = distinct !DILexicalBlock(scope: !2146, file: !929, line: 35, column: 9)
!2153 = !DILocation(line: 35, column: 45, scope: !2152)
!2154 = !DILocation(line: 35, column: 52, scope: !2152)
!2155 = !DILocation(line: 35, column: 55, scope: !2152)
!2156 = !DILocation(line: 35, column: 63, scope: !2152)
!2157 = !DILocation(line: 36, column: 41, scope: !2152)
!2158 = !DILocation(line: 36, column: 45, scope: !2152)
!2159 = !DILocation(line: 36, column: 48, scope: !2152)
!2160 = !DILocation(line: 36, column: 54, scope: !2152)
!2161 = !DILocation(line: 36, column: 57, scope: !2152)
!2162 = !DILocation(line: 36, column: 71, scope: !2152)
!2163 = !DILocation(line: 36, column: 106, scope: !2164)
!2164 = !DILexicalBlockFile(scope: !2152, file: !929, discriminator: 1)
!2165 = !DILocation(line: 36, column: 110, scope: !2164)
!2166 = !DILocation(line: 36, column: 113, scope: !2164)
!2167 = !DILocation(line: 36, column: 119, scope: !2164)
!2168 = !DILocation(line: 36, column: 122, scope: !2164)
!2169 = !DILocation(line: 35, column: 9, scope: !2170)
!2170 = !DILexicalBlockFile(scope: !2146, file: !929, discriminator: 1)
!2171 = !DILocation(line: 37, column: 9, scope: !2152)
!2172 = !DILocation(line: 38, column: 5, scope: !2146)
!2173 = !DILocation(line: 39, column: 1, scope: !2146)
!2174 = distinct !DISubprogram(name: "txd_read_header", scope: !929, file: !929, line: 41, type: !2175, isLocal: true, isDefinition: true, scopeLine: 41, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2175 = !DISubroutineType(types: !2176)
!2176 = !{!926, !2177}
!2177 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2178, size: 64, align: 64)
!2178 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1016)
!2179 = !DILocalVariable(name: "q", arg: 1, scope: !2180, file: !1125, line: 159, type: !1124)
!2180 = distinct !DISubprogram(name: "av_inv_q", scope: !1125, file: !1125, line: 159, type: !2181, isLocal: true, isDefinition: true, scopeLine: 160, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2181 = !DISubroutineType(types: !2182)
!2182 = !{!1124, !1124}
!2183 = !DILocation(line: 159, column: 77, scope: !2180, inlinedAt: !2184)
!2184 = distinct !DILocation(line: 50, column: 26, scope: !2174)
!2185 = !DILocalVariable(name: "r", scope: !2180, file: !1125, line: 161, type: !1124)
!2186 = !DILocation(line: 161, column: 16, scope: !2180, inlinedAt: !2184)
!2187 = !DILocalVariable(name: "s", arg: 1, scope: !2174, file: !929, line: 41, type: !2177)
!2188 = !DILocation(line: 41, column: 45, scope: !2174)
!2189 = !DILocalVariable(name: "st", scope: !2174, file: !929, line: 42, type: !1290)
!2190 = !DILocation(line: 42, column: 15, scope: !2174)
!2191 = !DILocation(line: 44, column: 30, scope: !2174)
!2192 = !DILocation(line: 44, column: 10, scope: !2174)
!2193 = !DILocation(line: 44, column: 8, scope: !2174)
!2194 = !DILocation(line: 45, column: 10, scope: !2195)
!2195 = distinct !DILexicalBlock(scope: !2174, file: !929, line: 45, column: 9)
!2196 = !DILocation(line: 45, column: 9, scope: !2174)
!2197 = !DILocation(line: 46, column: 9, scope: !2195)
!2198 = !DILocation(line: 47, column: 5, scope: !2174)
!2199 = !DILocation(line: 47, column: 9, scope: !2174)
!2200 = !DILocation(line: 47, column: 19, scope: !2174)
!2201 = !DILocation(line: 47, column: 30, scope: !2174)
!2202 = !DILocation(line: 48, column: 5, scope: !2174)
!2203 = !DILocation(line: 48, column: 9, scope: !2174)
!2204 = !DILocation(line: 48, column: 19, scope: !2174)
!2205 = !DILocation(line: 48, column: 28, scope: !2174)
!2206 = !DILocation(line: 49, column: 25, scope: !2174)
!2207 = !DILocation(line: 49, column: 5, scope: !2174)
!2208 = !DILocation(line: 50, column: 5, scope: !2174)
!2209 = !DILocation(line: 50, column: 9, scope: !2174)
!2210 = !DILocation(line: 50, column: 35, scope: !2174)
!2211 = !DILocation(line: 50, column: 39, scope: !2174)
!2212 = !DILocation(line: 50, column: 26, scope: !2174)
!2213 = !DILocation(line: 161, column: 20, scope: !2180, inlinedAt: !2184)
!2214 = !DILocation(line: 161, column: 24, scope: !2180, inlinedAt: !2184)
!2215 = !DILocation(line: 161, column: 31, scope: !2180, inlinedAt: !2184)
!2216 = !DILocation(line: 162, column: 12, scope: !2180, inlinedAt: !2184)
!2217 = !DILocation(line: 162, column: 5, scope: !2180, inlinedAt: !2184)
!2218 = !DILocation(line: 50, column: 26, scope: !2219)
!2219 = !DILexicalBlockFile(scope: !2174, file: !929, discriminator: 1)
!2220 = !DILocation(line: 53, column: 5, scope: !2174)
!2221 = !DILocation(line: 54, column: 1, scope: !2174)
!2222 = distinct !DISubprogram(name: "txd_read_packet", scope: !929, file: !929, line: 56, type: !2223, isLocal: true, isDefinition: true, scopeLine: 56, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2147)
!2223 = !DISubroutineType(types: !2224)
!2224 = !{!926, !2177, !1041}
!2225 = !DILocalVariable(name: "s", arg: 1, scope: !2222, file: !929, line: 56, type: !2177)
!2226 = !DILocation(line: 56, column: 45, scope: !2222)
!2227 = !DILocalVariable(name: "pkt", arg: 2, scope: !2222, file: !929, line: 56, type: !1041)
!2228 = !DILocation(line: 56, column: 58, scope: !2222)
!2229 = !DILocalVariable(name: "pb", scope: !2222, file: !929, line: 57, type: !1222)
!2230 = !DILocation(line: 57, column: 18, scope: !2222)
!2231 = !DILocation(line: 57, column: 23, scope: !2222)
!2232 = !DILocation(line: 57, column: 26, scope: !2222)
!2233 = !DILocalVariable(name: "id", scope: !2222, file: !929, line: 58, type: !925)
!2234 = !DILocation(line: 58, column: 18, scope: !2222)
!2235 = !DILocalVariable(name: "chunk_size", scope: !2222, file: !929, line: 58, type: !925)
!2236 = !DILocation(line: 58, column: 22, scope: !2222)
!2237 = !DILocalVariable(name: "marker", scope: !2222, file: !929, line: 58, type: !925)
!2238 = !DILocation(line: 58, column: 34, scope: !2222)
!2239 = !DILocalVariable(name: "ret", scope: !2222, file: !929, line: 59, type: !926)
!2240 = !DILocation(line: 59, column: 9, scope: !2222)
!2241 = !DILocation(line: 59, column: 5, scope: !2222)
!2242 = !DILocation(line: 62, column: 20, scope: !2222)
!2243 = !DILocation(line: 62, column: 10, scope: !2222)
!2244 = !DILocation(line: 62, column: 8, scope: !2222)
!2245 = !DILocation(line: 63, column: 28, scope: !2222)
!2246 = !DILocation(line: 63, column: 18, scope: !2222)
!2247 = !DILocation(line: 63, column: 16, scope: !2222)
!2248 = !DILocation(line: 64, column: 24, scope: !2222)
!2249 = !DILocation(line: 64, column: 14, scope: !2222)
!2250 = !DILocation(line: 64, column: 12, scope: !2222)
!2251 = !DILocation(line: 66, column: 19, scope: !2252)
!2252 = distinct !DILexicalBlock(scope: !2222, file: !929, line: 66, column: 9)
!2253 = !DILocation(line: 66, column: 22, scope: !2252)
!2254 = !DILocation(line: 66, column: 9, scope: !2252)
!2255 = !DILocation(line: 66, column: 9, scope: !2222)
!2256 = !DILocation(line: 67, column: 9, scope: !2252)
!2257 = !DILocation(line: 68, column: 9, scope: !2258)
!2258 = distinct !DILexicalBlock(scope: !2222, file: !929, line: 68, column: 9)
!2259 = !DILocation(line: 68, column: 16, scope: !2258)
!2260 = !DILocation(line: 68, column: 30, scope: !2258)
!2261 = !DILocation(line: 68, column: 33, scope: !2262)
!2262 = !DILexicalBlockFile(scope: !2258, file: !929, discriminator: 1)
!2263 = !DILocation(line: 68, column: 40, scope: !2262)
!2264 = !DILocation(line: 68, column: 9, scope: !2262)
!2265 = !DILocation(line: 69, column: 16, scope: !2266)
!2266 = distinct !DILexicalBlock(scope: !2258, file: !929, line: 68, column: 55)
!2267 = !DILocation(line: 69, column: 9, scope: !2266)
!2268 = !DILocation(line: 70, column: 9, scope: !2266)
!2269 = !DILocation(line: 73, column: 13, scope: !2222)
!2270 = !DILocation(line: 73, column: 5, scope: !2222)
!2271 = !DILocation(line: 75, column: 13, scope: !2272)
!2272 = distinct !DILexicalBlock(scope: !2273, file: !929, line: 75, column: 13)
!2273 = distinct !DILexicalBlock(scope: !2222, file: !929, line: 73, column: 17)
!2274 = !DILocation(line: 75, column: 24, scope: !2272)
!2275 = !DILocation(line: 75, column: 13, scope: !2273)
!2276 = !DILocation(line: 76, column: 13, scope: !2272)
!2277 = !DILocation(line: 75, column: 26, scope: !2278)
!2278 = !DILexicalBlockFile(scope: !2272, file: !929, discriminator: 1)
!2279 = !DILocation(line: 78, column: 19, scope: !2273)
!2280 = !DILocation(line: 78, column: 22, scope: !2273)
!2281 = !DILocation(line: 78, column: 26, scope: !2273)
!2282 = !DILocation(line: 78, column: 9, scope: !2273)
!2283 = !DILocation(line: 81, column: 9, scope: !2273)
!2284 = !DILocation(line: 83, column: 16, scope: !2273)
!2285 = !DILocation(line: 83, column: 48, scope: !2273)
!2286 = !DILocation(line: 83, column: 9, scope: !2273)
!2287 = !DILocation(line: 84, column: 9, scope: !2273)
!2288 = !DILocation(line: 87, column: 25, scope: !2222)
!2289 = !DILocation(line: 87, column: 28, scope: !2222)
!2290 = !DILocation(line: 87, column: 32, scope: !2222)
!2291 = !DILocation(line: 87, column: 37, scope: !2222)
!2292 = !DILocation(line: 87, column: 11, scope: !2222)
!2293 = !DILocation(line: 87, column: 9, scope: !2222)
!2294 = !DILocation(line: 88, column: 9, scope: !2295)
!2295 = distinct !DILexicalBlock(scope: !2222, file: !929, line: 88, column: 9)
!2296 = !DILocation(line: 88, column: 13, scope: !2295)
!2297 = !DILocation(line: 88, column: 9, scope: !2222)
!2298 = !DILocation(line: 89, column: 16, scope: !2295)
!2299 = !DILocation(line: 89, column: 9, scope: !2295)
!2300 = !DILocation(line: 90, column: 5, scope: !2222)
!2301 = !DILocation(line: 90, column: 10, scope: !2222)
!2302 = !DILocation(line: 90, column: 23, scope: !2222)
!2303 = !DILocation(line: 92, column: 5, scope: !2222)
!2304 = !DILocation(line: 93, column: 1, scope: !2222)
