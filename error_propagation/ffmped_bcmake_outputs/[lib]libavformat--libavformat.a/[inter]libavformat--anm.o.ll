; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--anm.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--anm.o.i"
...
%struct.AnmDemuxContext = type { i32, i32, i32, [256 x %struct.Page], i32, i32 }
...
@ff_anm_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i32 0, i32 0), i32 0, i8* null, %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 3092, i32 (%struct.AVProbeData*)* @probe, i32 (%struct.AVFormatContext*)* @read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
@.str.2 = private unnamed_addr constant [17 x i8] c"max_pages != 256\00", align 1
@.str.3 = private unnamed_addr constant [23 x i8] c"Invalid header element\00", align 1

; Function Attrs: nounwind uwtable
define internal i32 @probe(%struct.AVProbeData* %p) #0 !dbg !2151 {
entry:
  ...
  %cmp = icmp eq i32 %3, 541478988, !dbg !2160
...
land.lhs.true:                                    ; preds = %entry
  ...
  %arrayidx2 = getelementptr inbounds i8, i8* %5, i64 16, !dbg !2162
  %6 = bitcast i8* %arrayidx2 to %union.unaligned_32*, !dbg !2164
  %l3 = bitcast %union.unaligned_32* %6 to i32*, !dbg !2164
  %7 = load i32, i32* %l3, align 1, !dbg !2164
  %cmp4 = icmp eq i32 %7, 1296649793, !dbg !2165
  br i1 %cmp4, label %land.lhs.true5, label %if.end, !dbg !2166

land.lhs.true5:                                   ; preds = %land.lhs.true
  %8 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2167
  %buf6 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %8, i32 0, i32 1, !dbg !2168
  %9 = load i8*, i8** %buf6, align 8, !dbg !2168
  %arrayidx7 = getelementptr inbounds i8, i8* %9, i64 20, !dbg !2167
  %10 = bitcast i8* %arrayidx7 to %union.unaligned_16*, !dbg !2169
  %l8 = bitcast %union.unaligned_16* %10 to i16*, !dbg !2169
  %11 = load i16, i16* %l8, align 1, !dbg !2169
  %conv = zext i16 %11 to i32, !dbg !2170
  %tobool = icmp ne i32 %conv, 0, !dbg !2170
  br i1 %tobool, label %land.lhs.true9, label %if.end, !dbg !2171

land.lhs.true9:                                   ; preds = %land.lhs.true5
  %12 = load %struct.AVProbeData*, %struct.AVProbeData** %p.addr, align 8, !dbg !2172
  %buf10 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %12, i32 0, i32 1, !dbg !2174
  %13 = load i8*, i8** %buf10, align 8, !dbg !2174
  %arrayidx11 = getelementptr inbounds i8, i8* %13, i64 22, !dbg !2172
  %14 = bitcast i8* %arrayidx11 to %union.unaligned_16*, !dbg !2175
  %l12 = bitcast %union.unaligned_16* %14 to i16*, !dbg !2175
  %15 = load i16, i16* %l12, align 1, !dbg !2175
  %conv13 = zext i16 %15 to i32, !dbg !2176
  %tobool14 = icmp ne i32 %conv13, 0, !dbg !2176
  br i1 %tobool14, label %if.then, label %if.end, !dbg !2177

if.then:                                          ; preds = %land.lhs.true9
  store i32 100, i32* %retval, align 4, !dbg !2179
...
return:                                           ; preds = %if.end, %if.then
  %16 = load i32, i32* %retval, align 4, !dbg !2181
  ret i32 %16, !dbg !2181
}
...
entry:
  ...
  %anm = alloca %struct.AnmDemuxContext*, align 8
  %pb = alloca %struct.AVIOContext*, align 8
  %st = alloca %struct.AVStream*, align 8
  %i = alloca i32, align 4
  %ret = alloca i32, align 4
  %p = alloca %struct.Page*, align 8
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2187, metadata !2154), !dbg !2188
  call void @llvm.dbg.declare(metadata %struct.AnmDemuxContext** %anm, metadata !2189, metadata !2154), !dbg !2209
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2210
  %priv_data = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %0, i32 0, i32 3, !dbg !2211
  %1 = load i8*, i8** %priv_data, align 8, !dbg !2211
  %2 = bitcast i8* %1 to %struct.AnmDemuxContext*, !dbg !2210
  store %struct.AnmDemuxContext* %2, %struct.AnmDemuxContext** %anm, align 8, !dbg !2209
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2212, metadata !2154), !dbg !2213
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2214
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %3, i32 0, i32 4, !dbg !2215
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2215
  store %struct.AVIOContext* %4, %struct.AVIOContext** %pb, align 8, !dbg !2213
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2216, metadata !2154), !dbg !2217
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2218, metadata !2154), !dbg !2219
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2220, metadata !2154), !dbg !2221
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2222
  %call = call i64 @avio_skip(%struct.AVIOContext* %5, i64 4), !dbg !2223
  %6 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2224
  %call2 = call i32 @avio_rl16(%struct.AVIOContext* %6), !dbg !2226
  %cmp = icmp ne i32 %call2, 256, !dbg !2227
  br i1 %cmp, label %if.then, label %if.end, !dbg !2228

if.then:                                          ; preds = %entry
  %7 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2229
  %8 = bitcast %struct.AVFormatContext* %7 to i8*, !dbg !2229
  call void (i8*, i8*, ...) @avpriv_request_sample(i8* %8, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.2, i32 0, i32 0)), !dbg !2231
  store i32 -1163346256, i32* %retval, align 4, !dbg !2232
  br label %return, !dbg !2232

if.end:                                           ; preds = %entry
  %9 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2233
  %call3 = call i32 @avio_rl16(%struct.AVIOContext* %9), !dbg !2234
  %10 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2235
  %nb_pages = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %10, i32 0, i32 0, !dbg !2236
  store i32 %call3, i32* %nb_pages, align 4, !dbg !2237
  %11 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2238
  %call4 = call i32 @avio_rl32(%struct.AVIOContext* %11), !dbg !2239
  %12 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2240
  %nb_records = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %12, i32 0, i32 1, !dbg !2241
  store i32 %call4, i32* %nb_records, align 4, !dbg !2242
  %13 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2243
  %call5 = call i64 @avio_skip(%struct.AVIOContext* %13, i64 2), !dbg !2244
  %14 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2245
  %call6 = call i32 @avio_rl16(%struct.AVIOContext* %14), !dbg !2246
  %15 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2247
  %page_table_offset = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %15, i32 0, i32 2, !dbg !2248
  store i32 %call6, i32* %page_table_offset, align 4, !dbg !2249
  %16 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2250
  %call7 = call i32 @avio_rl32(%struct.AVIOContext* %16), !dbg !2252
  %cmp8 = icmp ne i32 %call7, 1296649793, !dbg !2253
  br i1 %cmp8, label %if.then9, label %if.end10, !dbg !2254
...
if.end10:                                         ; preds = %if.end
  %17 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2256
  %call11 = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %17, %struct.AVCodec* null), !dbg !2257
  store %struct.AVStream* %call11, %struct.AVStream** %st, align 8, !dbg !2258
  %18 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2259
  %tobool = icmp ne %struct.AVStream* %18, null, !dbg !2259
  br i1 %tobool, label %if.end13, label %if.then12, !dbg !2261
...
if.end13:                                         ; preds = %if.end10
  %19 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2263
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %19, i32 0, i32 19, !dbg !2264
  %20 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2264
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %20, i32 0, i32 0, !dbg !2265
  store i32 0, i32* %codec_type, align 8, !dbg !2266
  %21 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2267
  %codecpar14 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %21, i32 0, i32 19, !dbg !2268
  %22 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar14, align 8, !dbg !2268
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %22, i32 0, i32 1, !dbg !2269
  store i32 134, i32* %codec_id, align 4, !dbg !2270
  %23 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2271
  %codecpar15 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %23, i32 0, i32 19, !dbg !2272
  %24 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar15, align 8, !dbg !2272
  %codec_tag = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %24, i32 0, i32 2, !dbg !2273
  store i32 0, i32* %codec_tag, align 8, !dbg !2274
  %25 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2275
  %call16 = call i32 @avio_rl16(%struct.AVIOContext* %25), !dbg !2276
  %26 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2277
  %codecpar17 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %26, i32 0, i32 19, !dbg !2278
  %27 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar17, align 8, !dbg !2278
  %width = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %27, i32 0, i32 11, !dbg !2279
  store i32 %call16, i32* %width, align 8, !dbg !2280
  %28 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2281
  %call18 = call i32 @avio_rl16(%struct.AVIOContext* %28), !dbg !2282
  %29 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2283
  %codecpar19 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %29, i32 0, i32 19, !dbg !2284
  %30 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar19, align 8, !dbg !2284
  %height = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %30, i32 0, i32 12, !dbg !2285
  store i32 %call18, i32* %height, align 4, !dbg !2286
  %31 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2287
  %call20 = call i32 @avio_r8(%struct.AVIOContext* %31), !dbg !2289
  %cmp21 = icmp ne i32 %call20, 0, !dbg !2290
  br i1 %cmp21, label %if.then22, label %if.end23, !dbg !2291

if.then22:                                        ; preds = %if.end13
  br label %invalid, !dbg !2292

if.end23:                                         ; preds = %if.end13
  %32 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2293
  %call24 = call i64 @avio_skip(%struct.AVIOContext* %32, i64 1), !dbg !2294
  %33 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2295
  %call25 = call i32 @avio_r8(%struct.AVIOContext* %33), !dbg !2297
  %tobool26 = icmp ne i32 %call25, 0, !dbg !2297
  br i1 %tobool26, label %if.then27, label %if.end33, !dbg !2298

if.then27:                                        ; preds = %if.end23
  %34 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2299
  %nb_records28 = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %34, i32 0, i32 1, !dbg !2300
  %35 = load i32, i32* %nb_records28, align 4, !dbg !2300
  %sub = sub i32 %35, 1, !dbg !2301
  %cmp29 = icmp ugt i32 %sub, 0, !dbg !2302
  br i1 %cmp29, label %cond.true, label %cond.false, !dbg !2303

cond.true:                                        ; preds = %if.then27
  %36 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2304
  %nb_records30 = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %36, i32 0, i32 1, !dbg !2306
  %37 = load i32, i32* %nb_records30, align 4, !dbg !2306
  %sub31 = sub i32 %37, 1, !dbg !2307
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %sub31, %cond.true ], [ 0, %cond.false ], !dbg !2311
  %38 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2313
  %nb_records32 = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %38, i32 0, i32 1, !dbg !2314
  store i32 %cond, i32* %nb_records32, align 4, !dbg !2315
  br label %if.end33, !dbg !2313

if.end33:                                         ; preds = %cond.end, %if.end23
  %39 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2316
  %call34 = call i64 @avio_skip(%struct.AVIOContext* %39, i64 1), !dbg !2317
  %40 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2318
  %call35 = call i32 @avio_r8(%struct.AVIOContext* %40), !dbg !2320
  %cmp36 = icmp ne i32 %call35, 0, !dbg !2321
  br i1 %cmp36, label %if.then37, label %if.end38, !dbg !2322

if.then37:                                        ; preds = %if.end33
  br label %invalid, !dbg !2323

if.end38:                                         ; preds = %if.end33
  %41 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2324
  %call39 = call i32 @avio_r8(%struct.AVIOContext* %41), !dbg !2326
  %cmp40 = icmp ne i32 %call39, 1, !dbg !2327
  br i1 %cmp40, label %if.then41, label %if.end42, !dbg !2328

if.then41:                                        ; preds = %if.end38
  br label %invalid, !dbg !2329

if.end42:                                         ; preds = %if.end38
  %42 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2330
  %call43 = call i64 @avio_skip(%struct.AVIOContext* %42, i64 1), !dbg !2331
  %43 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2332
  %call44 = call i32 @avio_r8(%struct.AVIOContext* %43), !dbg !2334
  %cmp45 = icmp ne i32 %call44, 1, !dbg !2335
  br i1 %cmp45, label %if.then46, label %if.end47, !dbg !2336

if.then46:                                        ; preds = %if.end42
  br label %invalid, !dbg !2337

if.end47:                                         ; preds = %if.end42
  %44 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2338
  %call48 = call i64 @avio_skip(%struct.AVIOContext* %44, i64 32), !dbg !2339
  %45 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2340
  %call49 = call i32 @avio_rl32(%struct.AVIOContext* %45), !dbg !2341
  %conv = zext i32 %call49 to i64, !dbg !2341
  %46 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2342
  %nb_frames = getelementptr inbounds %struct.AVStream, %struct.AVStream* %46, i32 0, i32 7, !dbg !2343
  store i64 %conv, i64* %nb_frames, align 8, !dbg !2344
  ...
  %call50 = call i32 @avio_rl16(%struct.AVIOContext* %48), !dbg !2347
  call void @avpriv_set_pts_info(%struct.AVStream* %47, i32 64, i32 1, i32 %call50), !dbg !2348
  %49 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2350
  %call51 = call i64 @avio_skip(%struct.AVIOContext* %49, i64 58), !dbg !2351
  %50 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2352
  %51 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2353
  %codecpar52 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %51, i32 0, i32 19, !dbg !2354
  %52 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar52, align 8, !dbg !2354
  %53 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2355
  %pb53 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %53, i32 0, i32 4, !dbg !2356
  %54 = load %struct.AVIOContext*, %struct.AVIOContext** %pb53, align 8, !dbg !2356
  %call54 = call i32 @ff_get_extradata(%struct.AVFormatContext* %50, %struct.AVCodecParameters* %52, %struct.AVIOContext* %54, i32 1152), !dbg !2357
  store i32 %call54, i32* %ret, align 4, !dbg !2358
  %55 = load i32, i32* %ret, align 4, !dbg !2359
  %cmp55 = icmp slt i32 %55, 0, !dbg !2361
  br i1 %cmp55, label %if.then57, label %if.end58, !dbg !2362

if.then57:                                        ; preds = %if.end47
  %56 = load i32, i32* %ret, align 4, !dbg !2363
  store i32 %56, i32* %retval, align 4, !dbg !2364
  br label %return, !dbg !2364

if.end58:                                         ; preds = %if.end47
  %57 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2365
  %58 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2366
  %page_table_offset59 = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %58, i32 0, i32 2, !dbg !2367
  %59 = load i32, i32* %page_table_offset59, align 4, !dbg !2367
  %conv60 = sext i32 %59 to i64, !dbg !2366
  %call61 = call i64 @avio_seek(%struct.AVIOContext* %57, i64 %conv60, i32 0), !dbg !2368
  %conv62 = trunc i64 %call61 to i32, !dbg !2368
  store i32 %conv62, i32* %ret, align 4, !dbg !2369
  %60 = load i32, i32* %ret, align 4, !dbg !2370
  %cmp63 = icmp slt i32 %60, 0, !dbg !2372
  br i1 %cmp63, label %if.then65, label %if.end66, !dbg !2373

if.then65:                                        ; preds = %if.end58
  %61 = load i32, i32* %ret, align 4, !dbg !2374
  store i32 %61, i32* %retval, align 4, !dbg !2375
...
for.cond:                                         ; preds = %for.inc, %if.end66
  %62 = load i32, i32* %i, align 4, !dbg !2379
  %cmp67 = icmp slt i32 %62, 256, !dbg !2382
  br i1 %cmp67, label %for.body, label %for.end, !dbg !2383

for.body:                                         ; preds = %for.cond
  call void @llvm.dbg.declare(metadata %struct.Page** %p, metadata !2384, metadata !2154), !dbg !2387
  %63 = load i32, i32* %i, align 4, !dbg !2388
  %idxprom = sext i32 %63 to i64, !dbg !2389
  %64 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2389
  %pt = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %64, i32 0, i32 3, !dbg !2390
  %arrayidx = getelementptr inbounds [256 x %struct.Page], [256 x %struct.Page]* %pt, i64 0, i64 %idxprom, !dbg !2389
  store %struct.Page* %arrayidx, %struct.Page** %p, align 8, !dbg !2387
  %65 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2391
  %call69 = call i32 @avio_rl16(%struct.AVIOContext* %65), !dbg !2392
  %66 = load %struct.Page*, %struct.Page** %p, align 8, !dbg !2393
  %base_record = getelementptr inbounds %struct.Page, %struct.Page* %66, i32 0, i32 0, !dbg !2394
  store i32 %call69, i32* %base_record, align 4, !dbg !2395
  %67 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2396
  %call70 = call i32 @avio_rl16(%struct.AVIOContext* %67), !dbg !2397
  %68 = load %struct.Page*, %struct.Page** %p, align 8, !dbg !2398
  %nb_records71 = getelementptr inbounds %struct.Page, %struct.Page* %68, i32 0, i32 1, !dbg !2399
  store i32 %call70, i32* %nb_records71, align 4, !dbg !2400
  %69 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2401
  %call72 = call i32 @avio_rl16(%struct.AVIOContext* %69), !dbg !2402
  %70 = load %struct.Page*, %struct.Page** %p, align 8, !dbg !2403
  %size = getelementptr inbounds %struct.Page, %struct.Page* %70, i32 0, i32 2, !dbg !2404
  store i32 %call72, i32* %size, align 4, !dbg !2405
  br label %for.inc, !dbg !2406

for.inc:                                          ; preds = %for.body
  %71 = load i32, i32* %i, align 4, !dbg !2407
  %inc = add nsw i32 %71, 1, !dbg !2407
  store i32 %inc, i32* %i, align 4, !dbg !2407
  br label %for.cond, !dbg !2409, !llvm.loop !2410

for.end:                                          ; preds = %for.cond
  %72 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2412
  %call73 = call i32 @find_record(%struct.AnmDemuxContext* %72, i32 0), !dbg !2413
  %73 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2414
  %page = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %73, i32 0, i32 4, !dbg !2415
  store i32 %call73, i32* %page, align 4, !dbg !2416
  %74 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2417
  %page74 = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %74, i32 0, i32 4, !dbg !2419
  %75 = load i32, i32* %page74, align 4, !dbg !2419
  %cmp75 = icmp slt i32 %75, 0, !dbg !2420
  br i1 %cmp75, label %if.then77, label %if.end79, !dbg !2421

if.then77:                                        ; preds = %for.end
  %76 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2422
  %page78 = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %76, i32 0, i32 4, !dbg !2424
  %77 = load i32, i32* %page78, align 4, !dbg !2424
  store i32 %77, i32* %retval, align 4, !dbg !2425
  br label %return, !dbg !2425

if.end79:                                         ; preds = %for.end
  %78 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2426
  %record = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %78, i32 0, i32 5, !dbg !2427
  store i32 -1, i32* %record, align 4, !dbg !2428
  store i32 0, i32* %retval, align 4, !dbg !2429
  br label %return, !dbg !2429

invalid:                                          ; preds = %if.then46, %if.then41, %if.then37, %if.then22
  ...
  call void (i8*, i8*, ...) @avpriv_request_sample(i8* %80, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3, i32 0, i32 0)), !dbg !2431
  store i32 -1163346256, i32* %retval, align 4, !dbg !2432
  br label %return, !dbg !2432

return:                                           ; preds = %invalid, %if.end79, %if.then77, %if.then65, %if.then57, %if.then12, %if.then9, %if.then
  %81 = load i32, i32* %retval, align 4, !dbg !2433
  ret i32 %81, !dbg !2433
}

; Function Attrs: nounwind uwtable
define internal i32 @read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2434 {
entry:
  %s.addr.i = alloca %struct.AVIOContext*, align 8
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %s.addr.i, metadata !2437, metadata !2154), !dbg !2441
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2443, metadata !2154), !dbg !2444
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2445, metadata !2154), !dbg !2446
  call void @llvm.dbg.declare(metadata %struct.AnmDemuxContext** %anm, metadata !2447, metadata !2154), !dbg !2448
  ...
  %2 = bitcast i8* %1 to %struct.AnmDemuxContext*, !dbg !2449
  store %struct.AnmDemuxContext* %2, %struct.AnmDemuxContext** %anm, align 8, !dbg !2448
  call void @llvm.dbg.declare(metadata %struct.AVIOContext** %pb, metadata !2451, metadata !2154), !dbg !2452
  %3 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2453
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %3, i32 0, i32 4, !dbg !2454
  %4 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2454
  store %struct.AVIOContext* %4, %struct.AVIOContext** %pb, align 8, !dbg !2452
  call void @llvm.dbg.declare(metadata %struct.Page** %p, metadata !2455, metadata !2154), !dbg !2456
  call void @llvm.dbg.declare(metadata i32* %tmp, metadata !2457, metadata !2154), !dbg !2458
  call void @llvm.dbg.declare(metadata i32* %record_size, metadata !2459, metadata !2154), !dbg !2460
  %5 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2461
  %pb3 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %5, i32 0, i32 4, !dbg !2463
  %6 = load %struct.AVIOContext*, %struct.AVIOContext** %pb3, align 8, !dbg !2463
  %call = call i32 @avio_feof(%struct.AVIOContext* %6), !dbg !2464
  %tobool = icmp ne i32 %call, 0, !dbg !2464
  br i1 %tobool, label %if.then, label %if.end, !dbg !2465

if.then:                                          ; preds = %entry
  store i32 -5, i32* %retval, align 4, !dbg !2466
  br label %return, !dbg !2466

if.end:                                           ; preds = %entry
  %7 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2467
  %page = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %7, i32 0, i32 4, !dbg !2469
  %8 = load i32, i32* %page, align 4, !dbg !2469
  %cmp = icmp slt i32 %8, 0, !dbg !2470
  br i1 %cmp, label %if.then4, label %if.end6, !dbg !2471

if.then4:                                         ; preds = %if.end
  %9 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2472
  %page5 = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %9, i32 0, i32 4, !dbg !2473
  %10 = load i32, i32* %page5, align 4, !dbg !2473
  store i32 %10, i32* %retval, align 4, !dbg !2474
  br label %return, !dbg !2474

if.end6:                                          ; preds = %if.end
  br label %repeat, !dbg !2475

repeat:                                           ; preds = %if.end32, %if.end6
  %11 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2477
  %page7 = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %11, i32 0, i32 4, !dbg !2478
  %12 = load i32, i32* %page7, align 4, !dbg !2478
  %idxprom = sext i32 %12 to i64, !dbg !2479
  %13 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2479
  %pt = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %13, i32 0, i32 3, !dbg !2480
  %arrayidx = getelementptr inbounds [256 x %struct.Page], [256 x %struct.Page]* %pt, i64 0, i64 %idxprom, !dbg !2479
  store %struct.Page* %arrayidx, %struct.Page** %p, align 8, !dbg !2481
  %14 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2482
  %record = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %14, i32 0, i32 5, !dbg !2484
  %15 = load i32, i32* %record, align 4, !dbg !2484
  %cmp8 = icmp slt i32 %15, 0, !dbg !2485
  br i1 %cmp8, label %if.then9, label %if.end17, !dbg !2486

if.then9:                                         ; preds = %repeat
  %16 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2487
  %17 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2489
  %page_table_offset = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %17, i32 0, i32 2, !dbg !2490
  %18 = load i32, i32* %page_table_offset, align 4, !dbg !2490
  %add = add nsw i32 %18, 1536, !dbg !2491
  %19 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2492
  %page10 = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %19, i32 0, i32 4, !dbg !2493
  %20 = load i32, i32* %page10, align 4, !dbg !2493
  %shl = shl i32 %20, 16, !dbg !2494
  %add11 = add nsw i32 %add, %shl, !dbg !2495
  %conv = sext i32 %add11 to i64, !dbg !2489
  %call12 = call i64 @avio_seek(%struct.AVIOContext* %16, i64 %conv, i32 0), !dbg !2496
  %21 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2497
  %22 = load %struct.Page*, %struct.Page** %p, align 8, !dbg !2498
  %nb_records = getelementptr inbounds %struct.Page, %struct.Page* %22, i32 0, i32 1, !dbg !2499
  %23 = load i32, i32* %nb_records, align 4, !dbg !2499
  %mul = mul i32 2, %23, !dbg !2500
  %add13 = add i32 8, %mul, !dbg !2501
  %conv14 = zext i32 %add13 to i64, !dbg !2502
  %call15 = call i64 @avio_skip(%struct.AVIOContext* %21, i64 %conv14), !dbg !2503
  %24 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2504
  %record16 = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %24, i32 0, i32 5, !dbg !2505
  store i32 0, i32* %record16, align 4, !dbg !2506
  br label %if.end17, !dbg !2507

if.end17:                                         ; preds = %if.then9, %repeat
  %25 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2508
  %record18 = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %25, i32 0, i32 5, !dbg !2510
  %26 = load i32, i32* %record18, align 4, !dbg !2510
  %27 = load %struct.Page*, %struct.Page** %p, align 8, !dbg !2511
  %nb_records19 = getelementptr inbounds %struct.Page, %struct.Page* %27, i32 0, i32 1, !dbg !2512
  %28 = load i32, i32* %nb_records19, align 4, !dbg !2512
  %cmp20 = icmp uge i32 %26, %28, !dbg !2513
  br i1 %cmp20, label %if.then22, label %if.end34, !dbg !2514

if.then22:                                        ; preds = %if.end17
  %29 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2515
  %30 = load %struct.Page*, %struct.Page** %p, align 8, !dbg !2517
  %base_record = getelementptr inbounds %struct.Page, %struct.Page* %30, i32 0, i32 0, !dbg !2518
  %31 = load i32, i32* %base_record, align 4, !dbg !2518
  %32 = load %struct.Page*, %struct.Page** %p, align 8, !dbg !2519
  %nb_records23 = getelementptr inbounds %struct.Page, %struct.Page* %32, i32 0, i32 1, !dbg !2520
  %33 = load i32, i32* %nb_records23, align 4, !dbg !2520
  %add24 = add i32 %31, %33, !dbg !2521
  %call25 = call i32 @find_record(%struct.AnmDemuxContext* %29, i32 %add24), !dbg !2522
  %34 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2523
  %page26 = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %34, i32 0, i32 4, !dbg !2524
  store i32 %call25, i32* %page26, align 4, !dbg !2525
  %35 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2526
  %page27 = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %35, i32 0, i32 4, !dbg !2528
  %36 = load i32, i32* %page27, align 4, !dbg !2528
  %cmp28 = icmp slt i32 %36, 0, !dbg !2529
  br i1 %cmp28, label %if.then30, label %if.end32, !dbg !2530

if.then30:                                        ; preds = %if.then22
  %37 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2531
  %page31 = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %37, i32 0, i32 4, !dbg !2532
  %38 = load i32, i32* %page31, align 4, !dbg !2532
  store i32 %38, i32* %retval, align 4, !dbg !2533
  br label %return, !dbg !2533

if.end32:                                         ; preds = %if.then22
  %39 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2534
  %record33 = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %39, i32 0, i32 5, !dbg !2535
  store i32 -1, i32* %record33, align 4, !dbg !2536
  br label %repeat, !dbg !2537

if.end34:                                         ; preds = %if.end17
  %40 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2538
  store %struct.AVIOContext* %40, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2539
  %41 = load %struct.AVIOContext*, %struct.AVIOContext** %s.addr.i, align 8, !dbg !2540
  %call.i = call i64 @avio_seek(%struct.AVIOContext* %41, i64 0, i32 1) #3, !dbg !2541
  %conv36 = trunc i64 %call.i to i32, !dbg !2539
  store i32 %conv36, i32* %tmp, align 4, !dbg !2542
  %42 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2543
  %43 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2544
  %page_table_offset37 = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %43, i32 0, i32 2, !dbg !2545
  %44 = load i32, i32* %page_table_offset37, align 4, !dbg !2545
  %add38 = add nsw i32 %44, 1536, !dbg !2546
  %45 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2547
  %page39 = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %45, i32 0, i32 4, !dbg !2548
  %46 = load i32, i32* %page39, align 4, !dbg !2548
  %shl40 = shl i32 %46, 16, !dbg !2549
  %add41 = add nsw i32 %add38, %shl40, !dbg !2550
  %add42 = add nsw i32 %add41, 8, !dbg !2551
  %47 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2552
  %record43 = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %47, i32 0, i32 5, !dbg !2553
  %48 = load i32, i32* %record43, align 4, !dbg !2553
  %mul44 = mul nsw i32 %48, 2, !dbg !2554
  %add45 = add nsw i32 %add42, %mul44, !dbg !2555
  %conv46 = sext i32 %add45 to i64, !dbg !2544
  %call47 = call i64 @avio_seek(%struct.AVIOContext* %42, i64 %conv46, i32 0), !dbg !2556
  %49 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2557
  %call48 = call i32 @avio_rl16(%struct.AVIOContext* %49), !dbg !2558
  store i32 %call48, i32* %record_size, align 4, !dbg !2559
  %50 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2560
  %51 = load i32, i32* %tmp, align 4, !dbg !2561
  %conv49 = sext i32 %51 to i64, !dbg !2561
  %call50 = call i64 @avio_seek(%struct.AVIOContext* %50, i64 %conv49, i32 0), !dbg !2562
  %52 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2563
  %pb51 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %52, i32 0, i32 4, !dbg !2564
  %53 = load %struct.AVIOContext*, %struct.AVIOContext** %pb51, align 8, !dbg !2564
  %54 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2565
  %55 = load i32, i32* %record_size, align 4, !dbg !2566
  %call52 = call i32 @av_get_packet(%struct.AVIOContext* %53, %struct.AVPacket* %54, i32 %55), !dbg !2567
  %56 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2568
  %size = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %56, i32 0, i32 4, !dbg !2569
  store i32 %call52, i32* %size, align 8, !dbg !2570
  %57 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2571
  %size53 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %57, i32 0, i32 4, !dbg !2573
  %58 = load i32, i32* %size53, align 8, !dbg !2573
  %cmp54 = icmp slt i32 %58, 0, !dbg !2574
  br i1 %cmp54, label %if.then56, label %if.end58, !dbg !2575

if.then56:                                        ; preds = %if.end34
  %59 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2576
  %size57 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %59, i32 0, i32 4, !dbg !2577
  %60 = load i32, i32* %size57, align 8, !dbg !2577
  store i32 %60, i32* %retval, align 4, !dbg !2578
  br label %return, !dbg !2578

if.end58:                                         ; preds = %if.end34
  %61 = load %struct.Page*, %struct.Page** %p, align 8, !dbg !2579
  %base_record59 = getelementptr inbounds %struct.Page, %struct.Page* %61, i32 0, i32 0, !dbg !2581
  %62 = load i32, i32* %base_record59, align 4, !dbg !2581
  %63 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2582
  %record60 = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %63, i32 0, i32 5, !dbg !2583
  %64 = load i32, i32* %record60, align 4, !dbg !2583
  %add61 = add nsw i32 %62, %64, !dbg !2584
  %cmp62 = icmp eq i32 %add61, 0, !dbg !2585
  br i1 %cmp62, label %if.then64, label %if.end65, !dbg !2586

if.then64:                                        ; preds = %if.end58
  %65 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2587
  %flags = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %65, i32 0, i32 6, !dbg !2588
  %66 = load i32, i32* %flags, align 8, !dbg !2589
  %or = or i32 %66, 1, !dbg !2589
  store i32 %or, i32* %flags, align 8, !dbg !2589
  br label %if.end65, !dbg !2587

if.end65:                                         ; preds = %if.then64, %if.end58
  %67 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm, align 8, !dbg !2590
  %record66 = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %67, i32 0, i32 5, !dbg !2591
  %68 = load i32, i32* %record66, align 4, !dbg !2592
  %inc = add nsw i32 %68, 1, !dbg !2592
  store i32 %inc, i32* %record66, align 4, !dbg !2592
  store i32 0, i32* %retval, align 4, !dbg !2593
  br label %return, !dbg !2593

return:                                           ; preds = %if.end65, %if.then56, %if.then30, %if.then4, %if.then
  %69 = load i32, i32* %retval, align 4, !dbg !2594
  ret i32 %69, !dbg !2594
}
...
; Function Attrs: nounwind uwtable
define internal i32 @find_record(%struct.AnmDemuxContext* %anm, i32 %record) #0 !dbg !2595 {
entry:
  %retval = alloca i32, align 4
  %anm.addr = alloca %struct.AnmDemuxContext*, align 8
  %record.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %p = alloca %struct.Page*, align 8
  store %struct.AnmDemuxContext* %anm, %struct.AnmDemuxContext** %anm.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AnmDemuxContext** %anm.addr, metadata !2600, metadata !2154), !dbg !2601
  store i32 %record, i32* %record.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %record.addr, metadata !2602, metadata !2154), !dbg !2603
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2604, metadata !2154), !dbg !2605
  %0 = load i32, i32* %record.addr, align 4, !dbg !2606
  %1 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm.addr, align 8, !dbg !2608
  %nb_records = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %1, i32 0, i32 1, !dbg !2609
  %2 = load i32, i32* %nb_records, align 4, !dbg !2609
  %cmp = icmp uge i32 %0, %2, !dbg !2610
  br i1 %cmp, label %if.then, label %if.end, !dbg !2611

if.then:                                          ; preds = %entry
  store i32 -541478725, i32* %retval, align 4, !dbg !2612
...
for.cond:                                         ; preds = %for.inc, %if.end
  ...
  %cmp1 = icmp slt i32 %3, 256, !dbg !2619
  br i1 %cmp1, label %for.body, label %for.end, !dbg !2620

for.body:                                         ; preds = %for.cond
  call void @llvm.dbg.declare(metadata %struct.Page** %p, metadata !2621, metadata !2154), !dbg !2625
  %4 = load i32, i32* %i, align 4, !dbg !2626
  %idxprom = sext i32 %4 to i64, !dbg !2627
  %5 = load %struct.AnmDemuxContext*, %struct.AnmDemuxContext** %anm.addr, align 8, !dbg !2627
  %pt = getelementptr inbounds %struct.AnmDemuxContext, %struct.AnmDemuxContext* %5, i32 0, i32 3, !dbg !2628
  %arrayidx = getelementptr inbounds [256 x %struct.Page], [256 x %struct.Page]* %pt, i64 0, i64 %idxprom, !dbg !2627
  store %struct.Page* %arrayidx, %struct.Page** %p, align 8, !dbg !2625
  %6 = load %struct.Page*, %struct.Page** %p, align 8, !dbg !2629
  %nb_records2 = getelementptr inbounds %struct.Page, %struct.Page* %6, i32 0, i32 1, !dbg !2631
  %7 = load i32, i32* %nb_records2, align 4, !dbg !2631
  %cmp3 = icmp ugt i32 %7, 0, !dbg !2632
  br i1 %cmp3, label %land.lhs.true, label %if.end10, !dbg !2633

land.lhs.true:                                    ; preds = %for.body
  %8 = load i32, i32* %record.addr, align 4, !dbg !2634
  %9 = load %struct.Page*, %struct.Page** %p, align 8, !dbg !2636
  %base_record = getelementptr inbounds %struct.Page, %struct.Page* %9, i32 0, i32 0, !dbg !2637
  %10 = load i32, i32* %base_record, align 4, !dbg !2637
  %cmp4 = icmp sge i32 %8, %10, !dbg !2638
  br i1 %cmp4, label %land.lhs.true5, label %if.end10, !dbg !2639

land.lhs.true5:                                   ; preds = %land.lhs.true
  %11 = load i32, i32* %record.addr, align 4, !dbg !2640
  %12 = load %struct.Page*, %struct.Page** %p, align 8, !dbg !2642
  %base_record6 = getelementptr inbounds %struct.Page, %struct.Page* %12, i32 0, i32 0, !dbg !2643
  %13 = load i32, i32* %base_record6, align 4, !dbg !2643
  %14 = load %struct.Page*, %struct.Page** %p, align 8, !dbg !2644
  %nb_records7 = getelementptr inbounds %struct.Page, %struct.Page* %14, i32 0, i32 1, !dbg !2645
  %15 = load i32, i32* %nb_records7, align 4, !dbg !2645
  %add = add i32 %13, %15, !dbg !2646
  %cmp8 = icmp ult i32 %11, %add, !dbg !2647
  br i1 %cmp8, label %if.then9, label %if.end10, !dbg !2648

if.then9:                                         ; preds = %land.lhs.true5
  %16 = load i32, i32* %i, align 4, !dbg !2649
  store i32 %16, i32* %retval, align 4, !dbg !2650
...
for.inc:                                          ; preds = %if.end10
  %17 = load i32, i32* %i, align 4, !dbg !2652
  %inc = add nsw i32 %17, 1, !dbg !2652
  store i32 %inc, i32* %i, align 4, !dbg !2652
  br label %for.cond, !dbg !2654, !llvm.loop !2655

for.end:                                          ; preds = %for.cond
  store i32 -1094995529, i32* %retval, align 4, !dbg !2657
  br label %return, !dbg !2657

return:                                           ; preds = %for.end, %if.then9, %if.then
  %18 = load i32, i32* %retval, align 4, !dbg !2658
  ret i32 %18, !dbg !2658
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a/[inter]libavformat--anm.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!934 = !{!935}
!935 = distinct !DIGlobalVariable(name: "ff_anm_demuxer", scope: !0, file: !936, line: 217, type: !937, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_anm_demuxer)
!936 = !DIFile(filename: "libavformat/anm.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavformat--libavformat.a")
...
!2151 = distinct !DISubprogram(name: "probe", scope: !936, file: !936, line: 50, type: !1006, isLocal: true, isDefinition: true, scopeLine: 51, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2152 = !{}
!2153 = !DILocalVariable(name: "p", arg: 1, scope: !2151, file: !936, line: 50, type: !1008)
!2154 = !DIExpression()
!2155 = !DILocation(line: 50, column: 31, scope: !2151)
!2156 = !DILocation(line: 53, column: 42, scope: !2157)
!2157 = distinct !DILexicalBlock(scope: !2151, file: !936, line: 53, column: 9)
!2158 = !DILocation(line: 53, column: 45, scope: !2157)
!2159 = !DILocation(line: 53, column: 55, scope: !2157)
!2160 = !DILocation(line: 53, column: 58, scope: !2157)
!2161 = !DILocation(line: 53, column: 126, scope: !2157)
!2162 = !DILocation(line: 54, column: 42, scope: !2157)
!2163 = !DILocation(line: 54, column: 45, scope: !2157)
!2164 = !DILocation(line: 54, column: 56, scope: !2157)
!2165 = !DILocation(line: 54, column: 59, scope: !2157)
!2166 = !DILocation(line: 54, column: 127, scope: !2157)
!2167 = !DILocation(line: 55, column: 42, scope: !2157)
!2168 = !DILocation(line: 55, column: 45, scope: !2157)
!2169 = !DILocation(line: 55, column: 56, scope: !2157)
!2170 = !DILocation(line: 55, column: 9, scope: !2157)
!2171 = !DILocation(line: 55, column: 59, scope: !2157)
!2172 = !DILocation(line: 55, column: 95, scope: !2173)
!2173 = !DILexicalBlockFile(scope: !2157, file: !936, discriminator: 1)
!2174 = !DILocation(line: 55, column: 98, scope: !2173)
!2175 = !DILocation(line: 55, column: 109, scope: !2173)
!2176 = !DILocation(line: 55, column: 62, scope: !2173)
!2177 = !DILocation(line: 53, column: 9, scope: !2178)
!2178 = !DILexicalBlockFile(scope: !2151, file: !936, discriminator: 1)
!2179 = !DILocation(line: 56, column: 9, scope: !2157)
!2180 = !DILocation(line: 57, column: 5, scope: !2151)
!2181 = !DILocation(line: 58, column: 1, scope: !2151)
!2182 = distinct !DISubprogram(name: "read_header", scope: !936, file: !936, line: 79, type: !2183, isLocal: true, isDefinition: true, scopeLine: 80, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2183 = !DISubroutineType(types: !2184)
!2184 = !{!933, !2185}
!2185 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2186, size: 64, align: 64)
!2186 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1023)
!2187 = !DILocalVariable(name: "s", arg: 1, scope: !2182, file: !936, line: 79, type: !2185)
!2188 = !DILocation(line: 79, column: 41, scope: !2182)
!2189 = !DILocalVariable(name: "anm", scope: !2182, file: !936, line: 81, type: !2190)
!2190 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2191, size: 64, align: 64)
!2191 = !DIDerivedType(tag: DW_TAG_typedef, name: "AnmDemuxContext", file: !936, line: 45, baseType: !2192)
!2192 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "AnmDemuxContext", file: !936, line: 37, size: 24736, align: 32, elements: !2193)
!2193 = !{!2194, !2195, !2196, !2197, !2207, !2208}
!2194 = !DIDerivedType(tag: DW_TAG_member, name: "nb_pages", scope: !2192, file: !936, line: 38, baseType: !925, size: 32, align: 32)
!2195 = !DIDerivedType(tag: DW_TAG_member, name: "nb_records", scope: !2192, file: !936, line: 39, baseType: !925, size: 32, align: 32, offset: 32)
!2196 = !DIDerivedType(tag: DW_TAG_member, name: "page_table_offset", scope: !2192, file: !936, line: 40, baseType: !933, size: 32, align: 32, offset: 64)
!2197 = !DIDerivedType(tag: DW_TAG_member, name: "pt", scope: !2192, file: !936, line: 42, baseType: !2198, size: 24576, align: 32, offset: 96)
!2198 = !DICompositeType(tag: DW_TAG_array_type, baseType: !2199, size: 24576, align: 32, elements: !2205)
!2199 = !DIDerivedType(tag: DW_TAG_typedef, name: "Page", file: !936, line: 35, baseType: !2200)
!2200 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "Page", file: !936, line: 31, size: 96, align: 32, elements: !2201)
!2201 = !{!2202, !2203, !2204}
!2202 = !DIDerivedType(tag: DW_TAG_member, name: "base_record", scope: !2200, file: !936, line: 32, baseType: !933, size: 32, align: 32)
!2203 = !DIDerivedType(tag: DW_TAG_member, name: "nb_records", scope: !2200, file: !936, line: 33, baseType: !925, size: 32, align: 32, offset: 32)
!2204 = !DIDerivedType(tag: DW_TAG_member, name: "size", scope: !2200, file: !936, line: 34, baseType: !933, size: 32, align: 32, offset: 64)
!2205 = !{!2206}
!2206 = !DISubrange(count: 256)
!2207 = !DIDerivedType(tag: DW_TAG_member, name: "page", scope: !2192, file: !936, line: 43, baseType: !933, size: 32, align: 32, offset: 24672)
!2208 = !DIDerivedType(tag: DW_TAG_member, name: "record", scope: !2192, file: !936, line: 44, baseType: !933, size: 32, align: 32, offset: 24704)
!2209 = !DILocation(line: 81, column: 22, scope: !2182)
!2210 = !DILocation(line: 81, column: 28, scope: !2182)
!2211 = !DILocation(line: 81, column: 31, scope: !2182)
!2212 = !DILocalVariable(name: "pb", scope: !2182, file: !936, line: 82, type: !1229)
!2213 = !DILocation(line: 82, column: 18, scope: !2182)
!2214 = !DILocation(line: 82, column: 23, scope: !2182)
!2215 = !DILocation(line: 82, column: 26, scope: !2182)
!2216 = !DILocalVariable(name: "st", scope: !2182, file: !936, line: 83, type: !1297)
!2217 = !DILocation(line: 83, column: 15, scope: !2182)
!2218 = !DILocalVariable(name: "i", scope: !2182, file: !936, line: 84, type: !933)
!2219 = !DILocation(line: 84, column: 9, scope: !2182)
!2220 = !DILocalVariable(name: "ret", scope: !2182, file: !936, line: 84, type: !933)
!2221 = !DILocation(line: 84, column: 12, scope: !2182)
!2222 = !DILocation(line: 86, column: 15, scope: !2182)
!2223 = !DILocation(line: 86, column: 5, scope: !2182)
!2224 = !DILocation(line: 87, column: 19, scope: !2225)
!2225 = distinct !DILexicalBlock(scope: !2182, file: !936, line: 87, column: 9)
!2226 = !DILocation(line: 87, column: 9, scope: !2225)
!2227 = !DILocation(line: 87, column: 23, scope: !2225)
!2228 = !DILocation(line: 87, column: 9, scope: !2182)
!2229 = !DILocation(line: 88, column: 31, scope: !2230)
!2230 = distinct !DILexicalBlock(scope: !2225, file: !936, line: 87, column: 31)
!2231 = !DILocation(line: 88, column: 9, scope: !2230)
!2232 = !DILocation(line: 89, column: 9, scope: !2230)
!2233 = !DILocation(line: 92, column: 31, scope: !2182)
!2234 = !DILocation(line: 92, column: 21, scope: !2182)
!2235 = !DILocation(line: 92, column: 5, scope: !2182)
!2236 = !DILocation(line: 92, column: 10, scope: !2182)
!2237 = !DILocation(line: 92, column: 19, scope: !2182)
!2238 = !DILocation(line: 93, column: 33, scope: !2182)
!2239 = !DILocation(line: 93, column: 23, scope: !2182)
!2240 = !DILocation(line: 93, column: 5, scope: !2182)
!2241 = !DILocation(line: 93, column: 10, scope: !2182)
!2242 = !DILocation(line: 93, column: 21, scope: !2182)
!2243 = !DILocation(line: 94, column: 15, scope: !2182)
!2244 = !DILocation(line: 94, column: 5, scope: !2182)
!2245 = !DILocation(line: 95, column: 40, scope: !2182)
!2246 = !DILocation(line: 95, column: 30, scope: !2182)
!2247 = !DILocation(line: 95, column: 5, scope: !2182)
!2248 = !DILocation(line: 95, column: 10, scope: !2182)
!2249 = !DILocation(line: 95, column: 28, scope: !2182)
!2250 = !DILocation(line: 96, column: 19, scope: !2251)
!2251 = distinct !DILexicalBlock(scope: !2182, file: !936, line: 96, column: 9)
!2252 = !DILocation(line: 96, column: 9, scope: !2251)
!2253 = !DILocation(line: 96, column: 23, scope: !2251)
!2254 = !DILocation(line: 96, column: 9, scope: !2182)
!2255 = !DILocation(line: 97, column: 9, scope: !2251)
!2256 = !DILocation(line: 100, column: 30, scope: !2182)
!2257 = !DILocation(line: 100, column: 10, scope: !2182)
!2258 = !DILocation(line: 100, column: 8, scope: !2182)
!2259 = !DILocation(line: 101, column: 10, scope: !2260)
!2260 = distinct !DILexicalBlock(scope: !2182, file: !936, line: 101, column: 9)
!2261 = !DILocation(line: 101, column: 9, scope: !2182)
!2262 = !DILocation(line: 102, column: 9, scope: !2260)
!2263 = !DILocation(line: 103, column: 5, scope: !2182)
!2264 = !DILocation(line: 103, column: 9, scope: !2182)
!2265 = !DILocation(line: 103, column: 19, scope: !2182)
!2266 = !DILocation(line: 103, column: 30, scope: !2182)
!2267 = !DILocation(line: 104, column: 5, scope: !2182)
!2268 = !DILocation(line: 104, column: 9, scope: !2182)
!2269 = !DILocation(line: 104, column: 19, scope: !2182)
!2270 = !DILocation(line: 104, column: 28, scope: !2182)
!2271 = !DILocation(line: 105, column: 5, scope: !2182)
!2272 = !DILocation(line: 105, column: 9, scope: !2182)
!2273 = !DILocation(line: 105, column: 19, scope: !2182)
!2274 = !DILocation(line: 105, column: 29, scope: !2182)
!2275 = !DILocation(line: 106, column: 37, scope: !2182)
!2276 = !DILocation(line: 106, column: 27, scope: !2182)
!2277 = !DILocation(line: 106, column: 5, scope: !2182)
!2278 = !DILocation(line: 106, column: 9, scope: !2182)
!2279 = !DILocation(line: 106, column: 19, scope: !2182)
!2280 = !DILocation(line: 106, column: 25, scope: !2182)
!2281 = !DILocation(line: 107, column: 38, scope: !2182)
!2282 = !DILocation(line: 107, column: 28, scope: !2182)
!2283 = !DILocation(line: 107, column: 5, scope: !2182)
!2284 = !DILocation(line: 107, column: 9, scope: !2182)
!2285 = !DILocation(line: 107, column: 19, scope: !2182)
!2286 = !DILocation(line: 107, column: 26, scope: !2182)
!2287 = !DILocation(line: 108, column: 17, scope: !2288)
!2288 = distinct !DILexicalBlock(scope: !2182, file: !936, line: 108, column: 9)
!2289 = !DILocation(line: 108, column: 9, scope: !2288)
!2290 = !DILocation(line: 108, column: 21, scope: !2288)
!2291 = !DILocation(line: 108, column: 9, scope: !2182)
!2292 = !DILocation(line: 109, column: 9, scope: !2288)
!2293 = !DILocation(line: 110, column: 15, scope: !2182)
!2294 = !DILocation(line: 110, column: 5, scope: !2182)
!2295 = !DILocation(line: 113, column: 17, scope: !2296)
!2296 = distinct !DILexicalBlock(scope: !2182, file: !936, line: 113, column: 9)
!2297 = !DILocation(line: 113, column: 9, scope: !2296)
!2298 = !DILocation(line: 113, column: 9, scope: !2182)
!2299 = !DILocation(line: 114, column: 29, scope: !2296)
!2300 = !DILocation(line: 114, column: 34, scope: !2296)
!2301 = !DILocation(line: 114, column: 45, scope: !2296)
!2302 = !DILocation(line: 114, column: 50, scope: !2296)
!2303 = !DILocation(line: 114, column: 28, scope: !2296)
!2304 = !DILocation(line: 114, column: 59, scope: !2305)
!2305 = !DILexicalBlockFile(scope: !2296, file: !936, discriminator: 1)
!2306 = !DILocation(line: 114, column: 64, scope: !2305)
!2307 = !DILocation(line: 114, column: 75, scope: !2305)
!2308 = !DILocation(line: 114, column: 28, scope: !2305)
!2309 = !DILocation(line: 114, column: 28, scope: !2310)
!2310 = !DILexicalBlockFile(scope: !2296, file: !936, discriminator: 2)
!2311 = !DILocation(line: 114, column: 28, scope: !2312)
!2312 = !DILexicalBlockFile(scope: !2296, file: !936, discriminator: 3)
!2313 = !DILocation(line: 114, column: 9, scope: !2312)
!2314 = !DILocation(line: 114, column: 14, scope: !2312)
!2315 = !DILocation(line: 114, column: 25, scope: !2312)
!2316 = !DILocation(line: 116, column: 15, scope: !2182)
!2317 = !DILocation(line: 116, column: 5, scope: !2182)
!2318 = !DILocation(line: 118, column: 17, scope: !2319)
!2319 = distinct !DILexicalBlock(scope: !2182, file: !936, line: 118, column: 9)
!2320 = !DILocation(line: 118, column: 9, scope: !2319)
!2321 = !DILocation(line: 118, column: 21, scope: !2319)
!2322 = !DILocation(line: 118, column: 9, scope: !2182)
!2323 = !DILocation(line: 119, column: 9, scope: !2319)
!2324 = !DILocation(line: 121, column: 17, scope: !2325)
!2325 = distinct !DILexicalBlock(scope: !2182, file: !936, line: 121, column: 9)
!2326 = !DILocation(line: 121, column: 9, scope: !2325)
!2327 = !DILocation(line: 121, column: 21, scope: !2325)
!2328 = !DILocation(line: 121, column: 9, scope: !2182)
!2329 = !DILocation(line: 122, column: 9, scope: !2325)
!2330 = !DILocation(line: 124, column: 15, scope: !2182)
!2331 = !DILocation(line: 124, column: 5, scope: !2182)
!2332 = !DILocation(line: 126, column: 17, scope: !2333)
!2333 = distinct !DILexicalBlock(scope: !2182, file: !936, line: 126, column: 9)
!2334 = !DILocation(line: 126, column: 9, scope: !2333)
!2335 = !DILocation(line: 126, column: 21, scope: !2333)
!2336 = !DILocation(line: 126, column: 9, scope: !2182)
!2337 = !DILocation(line: 127, column: 9, scope: !2333)
!2338 = !DILocation(line: 129, column: 15, scope: !2182)
!2339 = !DILocation(line: 129, column: 5, scope: !2182)
!2340 = !DILocation(line: 130, column: 31, scope: !2182)
!2341 = !DILocation(line: 130, column: 21, scope: !2182)
!2342 = !DILocation(line: 130, column: 5, scope: !2182)
!2343 = !DILocation(line: 130, column: 9, scope: !2182)
!2344 = !DILocation(line: 130, column: 19, scope: !2182)
!2345 = !DILocation(line: 131, column: 25, scope: !2182)
!2346 = !DILocation(line: 131, column: 46, scope: !2182)
!2347 = !DILocation(line: 131, column: 36, scope: !2182)
!2348 = !DILocation(line: 131, column: 5, scope: !2349)
!2349 = !DILexicalBlockFile(scope: !2182, file: !936, discriminator: 1)
!2350 = !DILocation(line: 132, column: 15, scope: !2182)
!2351 = !DILocation(line: 132, column: 5, scope: !2182)
!2352 = !DILocation(line: 135, column: 28, scope: !2182)
!2353 = !DILocation(line: 135, column: 31, scope: !2182)
!2354 = !DILocation(line: 135, column: 35, scope: !2182)
!2355 = !DILocation(line: 135, column: 45, scope: !2182)
!2356 = !DILocation(line: 135, column: 48, scope: !2182)
!2357 = !DILocation(line: 135, column: 11, scope: !2182)
!2358 = !DILocation(line: 135, column: 9, scope: !2182)
!2359 = !DILocation(line: 136, column: 9, scope: !2360)
!2360 = distinct !DILexicalBlock(scope: !2182, file: !936, line: 136, column: 9)
!2361 = !DILocation(line: 136, column: 13, scope: !2360)
!2362 = !DILocation(line: 136, column: 9, scope: !2182)
!2363 = !DILocation(line: 137, column: 16, scope: !2360)
!2364 = !DILocation(line: 137, column: 9, scope: !2360)
!2365 = !DILocation(line: 140, column: 21, scope: !2182)
!2366 = !DILocation(line: 140, column: 25, scope: !2182)
!2367 = !DILocation(line: 140, column: 30, scope: !2182)
!2368 = !DILocation(line: 140, column: 11, scope: !2182)
!2369 = !DILocation(line: 140, column: 9, scope: !2182)
!2370 = !DILocation(line: 141, column: 9, scope: !2371)
!2371 = distinct !DILexicalBlock(scope: !2182, file: !936, line: 141, column: 9)
!2372 = !DILocation(line: 141, column: 13, scope: !2371)
!2373 = !DILocation(line: 141, column: 9, scope: !2182)
!2374 = !DILocation(line: 142, column: 16, scope: !2371)
!2375 = !DILocation(line: 142, column: 9, scope: !2371)
!2376 = !DILocation(line: 144, column: 12, scope: !2377)
!2377 = distinct !DILexicalBlock(scope: !2182, file: !936, line: 144, column: 5)
!2378 = !DILocation(line: 144, column: 10, scope: !2377)
!2379 = !DILocation(line: 144, column: 17, scope: !2380)
!2380 = !DILexicalBlockFile(scope: !2381, file: !936, discriminator: 1)
!2381 = distinct !DILexicalBlock(scope: !2377, file: !936, line: 144, column: 5)
!2382 = !DILocation(line: 144, column: 19, scope: !2380)
!2383 = !DILocation(line: 144, column: 5, scope: !2380)
!2384 = !DILocalVariable(name: "p", scope: !2385, file: !936, line: 145, type: !2386)
!2385 = distinct !DILexicalBlock(scope: !2381, file: !936, line: 144, column: 31)
!2386 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2199, size: 64, align: 64)
!2387 = !DILocation(line: 145, column: 15, scope: !2385)
!2388 = !DILocation(line: 145, column: 28, scope: !2385)
!2389 = !DILocation(line: 145, column: 20, scope: !2385)
!2390 = !DILocation(line: 145, column: 25, scope: !2385)
!2391 = !DILocation(line: 146, column: 36, scope: !2385)
!2392 = !DILocation(line: 146, column: 26, scope: !2385)
!2393 = !DILocation(line: 146, column: 9, scope: !2385)
!2394 = !DILocation(line: 146, column: 12, scope: !2385)
!2395 = !DILocation(line: 146, column: 24, scope: !2385)
!2396 = !DILocation(line: 147, column: 35, scope: !2385)
!2397 = !DILocation(line: 147, column: 25, scope: !2385)
!2398 = !DILocation(line: 147, column: 9, scope: !2385)
!2399 = !DILocation(line: 147, column: 12, scope: !2385)
!2400 = !DILocation(line: 147, column: 23, scope: !2385)
!2401 = !DILocation(line: 148, column: 29, scope: !2385)
!2402 = !DILocation(line: 148, column: 19, scope: !2385)
!2403 = !DILocation(line: 148, column: 9, scope: !2385)
!2404 = !DILocation(line: 148, column: 12, scope: !2385)
!2405 = !DILocation(line: 148, column: 17, scope: !2385)
!2406 = !DILocation(line: 149, column: 5, scope: !2385)
!2407 = !DILocation(line: 144, column: 27, scope: !2408)
!2408 = !DILexicalBlockFile(scope: !2381, file: !936, discriminator: 2)
!2409 = !DILocation(line: 144, column: 5, scope: !2408)
!2410 = distinct !{!2410, !2411}
!2411 = !DILocation(line: 144, column: 5, scope: !2182)
!2412 = !DILocation(line: 152, column: 29, scope: !2182)
!2413 = !DILocation(line: 152, column: 17, scope: !2182)
!2414 = !DILocation(line: 152, column: 5, scope: !2182)
!2415 = !DILocation(line: 152, column: 10, scope: !2182)
!2416 = !DILocation(line: 152, column: 15, scope: !2182)
!2417 = !DILocation(line: 153, column: 9, scope: !2418)
!2418 = distinct !DILexicalBlock(scope: !2182, file: !936, line: 153, column: 9)
!2419 = !DILocation(line: 153, column: 14, scope: !2418)
!2420 = !DILocation(line: 153, column: 19, scope: !2418)
!2421 = !DILocation(line: 153, column: 9, scope: !2182)
!2422 = !DILocation(line: 154, column: 16, scope: !2423)
!2423 = distinct !DILexicalBlock(scope: !2418, file: !936, line: 153, column: 24)
!2424 = !DILocation(line: 154, column: 21, scope: !2423)
!2425 = !DILocation(line: 154, column: 9, scope: !2423)
!2426 = !DILocation(line: 157, column: 5, scope: !2182)
!2427 = !DILocation(line: 157, column: 10, scope: !2182)
!2428 = !DILocation(line: 157, column: 17, scope: !2182)
!2429 = !DILocation(line: 158, column: 5, scope: !2182)
!2430 = !DILocation(line: 161, column: 27, scope: !2182)
!2431 = !DILocation(line: 161, column: 5, scope: !2182)
!2432 = !DILocation(line: 162, column: 5, scope: !2182)
!2433 = !DILocation(line: 163, column: 1, scope: !2182)
!2434 = distinct !DISubprogram(name: "read_packet", scope: !936, file: !936, line: 165, type: !2435, isLocal: true, isDefinition: true, scopeLine: 167, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2435 = !DISubroutineType(types: !2436)
!2436 = !{!933, !2185, !1048}
!2437 = !DILocalVariable(name: "s", arg: 1, scope: !2438, file: !628, line: 557, type: !1229)
!2438 = distinct !DISubprogram(name: "avio_tell", scope: !628, file: !628, line: 557, type: !2439, isLocal: true, isDefinition: true, scopeLine: 558, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2439 = !DISubroutineType(types: !2440)
!2440 = !{!1067, !1229}
!2441 = !DILocation(line: 557, column: 77, scope: !2438, inlinedAt: !2442)
!2442 = distinct !DILocation(line: 200, column: 11, scope: !2434)
!2443 = !DILocalVariable(name: "s", arg: 1, scope: !2434, file: !936, line: 165, type: !2185)
!2444 = !DILocation(line: 165, column: 41, scope: !2434)
!2445 = !DILocalVariable(name: "pkt", arg: 2, scope: !2434, file: !936, line: 166, type: !1048)
!2446 = !DILocation(line: 166, column: 34, scope: !2434)
!2447 = !DILocalVariable(name: "anm", scope: !2434, file: !936, line: 168, type: !2190)
!2448 = !DILocation(line: 168, column: 22, scope: !2434)
!2449 = !DILocation(line: 168, column: 28, scope: !2434)
!2450 = !DILocation(line: 168, column: 31, scope: !2434)
!2451 = !DILocalVariable(name: "pb", scope: !2434, file: !936, line: 169, type: !1229)
!2452 = !DILocation(line: 169, column: 18, scope: !2434)
!2453 = !DILocation(line: 169, column: 23, scope: !2434)
!2454 = !DILocation(line: 169, column: 26, scope: !2434)
!2455 = !DILocalVariable(name: "p", scope: !2434, file: !936, line: 170, type: !2386)
!2456 = !DILocation(line: 170, column: 11, scope: !2434)
!2457 = !DILocalVariable(name: "tmp", scope: !2434, file: !936, line: 171, type: !933)
!2458 = !DILocation(line: 171, column: 9, scope: !2434)
!2459 = !DILocalVariable(name: "record_size", scope: !2434, file: !936, line: 171, type: !933)
!2460 = !DILocation(line: 171, column: 14, scope: !2434)
!2461 = !DILocation(line: 173, column: 19, scope: !2462)
!2462 = distinct !DILexicalBlock(scope: !2434, file: !936, line: 173, column: 9)
!2463 = !DILocation(line: 173, column: 22, scope: !2462)
!2464 = !DILocation(line: 173, column: 9, scope: !2462)
!2465 = !DILocation(line: 173, column: 9, scope: !2434)
!2466 = !DILocation(line: 174, column: 9, scope: !2462)
!2467 = !DILocation(line: 176, column: 9, scope: !2468)
!2468 = distinct !DILexicalBlock(scope: !2434, file: !936, line: 176, column: 9)
!2469 = !DILocation(line: 176, column: 14, scope: !2468)
!2470 = !DILocation(line: 176, column: 19, scope: !2468)
!2471 = !DILocation(line: 176, column: 9, scope: !2434)
!2472 = !DILocation(line: 177, column: 16, scope: !2468)
!2473 = !DILocation(line: 177, column: 21, scope: !2468)
!2474 = !DILocation(line: 177, column: 9, scope: !2468)
!2475 = !DILocation(line: 176, column: 21, scope: !2476)
!2476 = !DILexicalBlockFile(scope: !2468, file: !936, discriminator: 1)
!2477 = !DILocation(line: 180, column: 18, scope: !2434)
!2478 = !DILocation(line: 180, column: 23, scope: !2434)
!2479 = !DILocation(line: 180, column: 10, scope: !2434)
!2480 = !DILocation(line: 180, column: 15, scope: !2434)
!2481 = !DILocation(line: 180, column: 7, scope: !2434)
!2482 = !DILocation(line: 183, column: 9, scope: !2483)
!2483 = distinct !DILexicalBlock(scope: !2434, file: !936, line: 183, column: 9)
!2484 = !DILocation(line: 183, column: 14, scope: !2483)
!2485 = !DILocation(line: 183, column: 21, scope: !2483)
!2486 = !DILocation(line: 183, column: 9, scope: !2434)
!2487 = !DILocation(line: 184, column: 19, scope: !2488)
!2488 = distinct !DILexicalBlock(scope: !2483, file: !936, line: 183, column: 26)
!2489 = !DILocation(line: 184, column: 23, scope: !2488)
!2490 = !DILocation(line: 184, column: 28, scope: !2488)
!2491 = !DILocation(line: 184, column: 46, scope: !2488)
!2492 = !DILocation(line: 184, column: 57, scope: !2488)
!2493 = !DILocation(line: 184, column: 62, scope: !2488)
!2494 = !DILocation(line: 184, column: 66, scope: !2488)
!2495 = !DILocation(line: 184, column: 54, scope: !2488)
!2496 = !DILocation(line: 184, column: 9, scope: !2488)
!2497 = !DILocation(line: 185, column: 19, scope: !2488)
!2498 = !DILocation(line: 185, column: 29, scope: !2488)
!2499 = !DILocation(line: 185, column: 32, scope: !2488)
!2500 = !DILocation(line: 185, column: 28, scope: !2488)
!2501 = !DILocation(line: 185, column: 25, scope: !2488)
!2502 = !DILocation(line: 185, column: 23, scope: !2488)
!2503 = !DILocation(line: 185, column: 9, scope: !2488)
!2504 = !DILocation(line: 186, column: 9, scope: !2488)
!2505 = !DILocation(line: 186, column: 14, scope: !2488)
!2506 = !DILocation(line: 186, column: 21, scope: !2488)
!2507 = !DILocation(line: 187, column: 5, scope: !2488)
!2508 = !DILocation(line: 191, column: 9, scope: !2509)
!2509 = distinct !DILexicalBlock(scope: !2434, file: !936, line: 191, column: 9)
!2510 = !DILocation(line: 191, column: 14, scope: !2509)
!2511 = !DILocation(line: 191, column: 24, scope: !2509)
!2512 = !DILocation(line: 191, column: 27, scope: !2509)
!2513 = !DILocation(line: 191, column: 21, scope: !2509)
!2514 = !DILocation(line: 191, column: 9, scope: !2434)
!2515 = !DILocation(line: 192, column: 33, scope: !2516)
!2516 = distinct !DILexicalBlock(scope: !2509, file: !936, line: 191, column: 39)
!2517 = !DILocation(line: 192, column: 38, scope: !2516)
!2518 = !DILocation(line: 192, column: 41, scope: !2516)
!2519 = !DILocation(line: 192, column: 55, scope: !2516)
!2520 = !DILocation(line: 192, column: 58, scope: !2516)
!2521 = !DILocation(line: 192, column: 53, scope: !2516)
!2522 = !DILocation(line: 192, column: 21, scope: !2516)
!2523 = !DILocation(line: 192, column: 9, scope: !2516)
!2524 = !DILocation(line: 192, column: 14, scope: !2516)
!2525 = !DILocation(line: 192, column: 19, scope: !2516)
!2526 = !DILocation(line: 193, column: 13, scope: !2527)
!2527 = distinct !DILexicalBlock(scope: !2516, file: !936, line: 193, column: 13)
!2528 = !DILocation(line: 193, column: 18, scope: !2527)
!2529 = !DILocation(line: 193, column: 23, scope: !2527)
!2530 = !DILocation(line: 193, column: 13, scope: !2516)
!2531 = !DILocation(line: 194, column: 20, scope: !2527)
!2532 = !DILocation(line: 194, column: 25, scope: !2527)
!2533 = !DILocation(line: 194, column: 13, scope: !2527)
!2534 = !DILocation(line: 195, column: 9, scope: !2516)
!2535 = !DILocation(line: 195, column: 14, scope: !2516)
!2536 = !DILocation(line: 195, column: 21, scope: !2516)
!2537 = !DILocation(line: 196, column: 9, scope: !2516)
!2538 = !DILocation(line: 200, column: 21, scope: !2434)
!2539 = !DILocation(line: 200, column: 11, scope: !2434)
!2540 = !DILocation(line: 559, column: 22, scope: !2438, inlinedAt: !2442)
!2541 = !DILocation(line: 559, column: 12, scope: !2438, inlinedAt: !2442)
!2542 = !DILocation(line: 200, column: 9, scope: !2434)
!2543 = !DILocation(line: 201, column: 15, scope: !2434)
!2544 = !DILocation(line: 201, column: 19, scope: !2434)
!2545 = !DILocation(line: 201, column: 24, scope: !2434)
!2546 = !DILocation(line: 201, column: 42, scope: !2434)
!2547 = !DILocation(line: 201, column: 53, scope: !2434)
!2548 = !DILocation(line: 201, column: 58, scope: !2434)
!2549 = !DILocation(line: 201, column: 62, scope: !2434)
!2550 = !DILocation(line: 201, column: 50, scope: !2434)
!2551 = !DILocation(line: 201, column: 68, scope: !2434)
!2552 = !DILocation(line: 202, column: 19, scope: !2434)
!2553 = !DILocation(line: 202, column: 24, scope: !2434)
!2554 = !DILocation(line: 202, column: 31, scope: !2434)
!2555 = !DILocation(line: 202, column: 17, scope: !2434)
!2556 = !DILocation(line: 201, column: 5, scope: !2434)
!2557 = !DILocation(line: 203, column: 29, scope: !2434)
!2558 = !DILocation(line: 203, column: 19, scope: !2434)
!2559 = !DILocation(line: 203, column: 17, scope: !2434)
!2560 = !DILocation(line: 204, column: 15, scope: !2434)
!2561 = !DILocation(line: 204, column: 19, scope: !2434)
!2562 = !DILocation(line: 204, column: 5, scope: !2434)
!2563 = !DILocation(line: 207, column: 31, scope: !2434)
!2564 = !DILocation(line: 207, column: 34, scope: !2434)
!2565 = !DILocation(line: 207, column: 38, scope: !2434)
!2566 = !DILocation(line: 207, column: 43, scope: !2434)
!2567 = !DILocation(line: 207, column: 17, scope: !2434)
!2568 = !DILocation(line: 207, column: 5, scope: !2434)
!2569 = !DILocation(line: 207, column: 10, scope: !2434)
!2570 = !DILocation(line: 207, column: 15, scope: !2434)
!2571 = !DILocation(line: 208, column: 9, scope: !2572)
!2572 = distinct !DILexicalBlock(scope: !2434, file: !936, line: 208, column: 9)
!2573 = !DILocation(line: 208, column: 14, scope: !2572)
!2574 = !DILocation(line: 208, column: 19, scope: !2572)
!2575 = !DILocation(line: 208, column: 9, scope: !2434)
!2576 = !DILocation(line: 209, column: 16, scope: !2572)
!2577 = !DILocation(line: 209, column: 21, scope: !2572)
!2578 = !DILocation(line: 209, column: 9, scope: !2572)
!2579 = !DILocation(line: 210, column: 9, scope: !2580)
!2580 = distinct !DILexicalBlock(scope: !2434, file: !936, line: 210, column: 9)
!2581 = !DILocation(line: 210, column: 12, scope: !2580)
!2582 = !DILocation(line: 210, column: 26, scope: !2580)
!2583 = !DILocation(line: 210, column: 31, scope: !2580)
!2584 = !DILocation(line: 210, column: 24, scope: !2580)
!2585 = !DILocation(line: 210, column: 38, scope: !2580)
!2586 = !DILocation(line: 210, column: 9, scope: !2434)
!2587 = !DILocation(line: 211, column: 9, scope: !2580)
!2588 = !DILocation(line: 211, column: 14, scope: !2580)
!2589 = !DILocation(line: 211, column: 20, scope: !2580)
!2590 = !DILocation(line: 213, column: 5, scope: !2434)
!2591 = !DILocation(line: 213, column: 10, scope: !2434)
!2592 = !DILocation(line: 213, column: 16, scope: !2434)
!2593 = !DILocation(line: 214, column: 5, scope: !2434)
!2594 = !DILocation(line: 215, column: 1, scope: !2434)
!2595 = distinct !DISubprogram(name: "find_record", scope: !936, file: !936, line: 63, type: !2596, isLocal: true, isDefinition: true, scopeLine: 64, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2596 = !DISubroutineType(types: !2597)
!2597 = !{!933, !2598, !933}
!2598 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2599, size: 64, align: 64)
!2599 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !2191)
!2600 = !DILocalVariable(name: "anm", arg: 1, scope: !2595, file: !936, line: 63, type: !2598)
!2601 = !DILocation(line: 63, column: 47, scope: !2595)
!2602 = !DILocalVariable(name: "record", arg: 2, scope: !2595, file: !936, line: 63, type: !933)
!2603 = !DILocation(line: 63, column: 56, scope: !2595)
!2604 = !DILocalVariable(name: "i", scope: !2595, file: !936, line: 65, type: !933)
!2605 = !DILocation(line: 65, column: 9, scope: !2595)
!2606 = !DILocation(line: 67, column: 9, scope: !2607)
!2607 = distinct !DILexicalBlock(scope: !2595, file: !936, line: 67, column: 9)
!2608 = !DILocation(line: 67, column: 19, scope: !2607)
!2609 = !DILocation(line: 67, column: 24, scope: !2607)
!2610 = !DILocation(line: 67, column: 16, scope: !2607)
!2611 = !DILocation(line: 67, column: 9, scope: !2595)
!2612 = !DILocation(line: 68, column: 9, scope: !2607)
!2613 = !DILocation(line: 70, column: 12, scope: !2614)
!2614 = distinct !DILexicalBlock(scope: !2595, file: !936, line: 70, column: 5)
!2615 = !DILocation(line: 70, column: 10, scope: !2614)
!2616 = !DILocation(line: 70, column: 17, scope: !2617)
!2617 = !DILexicalBlockFile(scope: !2618, file: !936, discriminator: 1)
!2618 = distinct !DILexicalBlock(scope: !2614, file: !936, line: 70, column: 5)
!2619 = !DILocation(line: 70, column: 19, scope: !2617)
!2620 = !DILocation(line: 70, column: 5, scope: !2617)
!2621 = !DILocalVariable(name: "p", scope: !2622, file: !936, line: 71, type: !2623)
!2622 = distinct !DILexicalBlock(scope: !2618, file: !936, line: 70, column: 31)
!2623 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2624, size: 64, align: 64)
!2624 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !2199)
!2625 = !DILocation(line: 71, column: 21, scope: !2622)
!2626 = !DILocation(line: 71, column: 34, scope: !2622)
!2627 = !DILocation(line: 71, column: 26, scope: !2622)
!2628 = !DILocation(line: 71, column: 31, scope: !2622)
!2629 = !DILocation(line: 72, column: 13, scope: !2630)
!2630 = distinct !DILexicalBlock(scope: !2622, file: !936, line: 72, column: 13)
!2631 = !DILocation(line: 72, column: 16, scope: !2630)
!2632 = !DILocation(line: 72, column: 27, scope: !2630)
!2633 = !DILocation(line: 72, column: 31, scope: !2630)
!2634 = !DILocation(line: 72, column: 34, scope: !2635)
!2635 = !DILexicalBlockFile(scope: !2630, file: !936, discriminator: 1)
!2636 = !DILocation(line: 72, column: 44, scope: !2635)
!2637 = !DILocation(line: 72, column: 47, scope: !2635)
!2638 = !DILocation(line: 72, column: 41, scope: !2635)
!2639 = !DILocation(line: 72, column: 59, scope: !2635)
!2640 = !DILocation(line: 72, column: 62, scope: !2641)
!2641 = !DILexicalBlockFile(scope: !2630, file: !936, discriminator: 2)
!2642 = !DILocation(line: 72, column: 71, scope: !2641)
!2643 = !DILocation(line: 72, column: 74, scope: !2641)
!2644 = !DILocation(line: 72, column: 88, scope: !2641)
!2645 = !DILocation(line: 72, column: 91, scope: !2641)
!2646 = !DILocation(line: 72, column: 86, scope: !2641)
!2647 = !DILocation(line: 72, column: 69, scope: !2641)
!2648 = !DILocation(line: 72, column: 13, scope: !2641)
!2649 = !DILocation(line: 73, column: 20, scope: !2630)
!2650 = !DILocation(line: 73, column: 13, scope: !2630)
!2651 = !DILocation(line: 74, column: 5, scope: !2622)
!2652 = !DILocation(line: 70, column: 27, scope: !2653)
!2653 = !DILexicalBlockFile(scope: !2618, file: !936, discriminator: 2)
!2654 = !DILocation(line: 70, column: 5, scope: !2653)
!2655 = distinct !{!2655, !2656}
!2656 = !DILocation(line: 70, column: 5, scope: !2595)
!2657 = !DILocation(line: 76, column: 5, scope: !2595)
!2658 = !DILocation(line: 77, column: 1, scope: !2595)
