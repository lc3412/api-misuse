; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[inter]libavformat--ncdec.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[inter]libavformat--ncdec.o.i"
...
@ff_nc_demuxer = global %struct.AVInputFormat { i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0), %struct.AVCodecTag** null, %struct.AVClass* null, i8* null, %struct.AVInputFormat* null, i32 0, i32 0, i32 (%struct.AVProbeData*)* @nc_probe, i32 (%struct.AVFormatContext*)* @nc_read_header, i32 (%struct.AVFormatContext*, %struct.AVPacket*)* @nc_read_packet, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i32)* null, i64 (%struct.AVFormatContext*, i32, i64*, i64)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*)* null, i32 (%struct.AVFormatContext*, i32, i64, i64, i64, i32)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceInfoList*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null, i32 (%struct.AVFormatContext*, %struct.AVDeviceCapabilitiesQuery*)* null }, align 8
@.str.3 = private unnamed_addr constant [26 x i8] c"Next packet size is zero\0A\00", align 1

; Function Attrs: nounwind uwtable
define internal i32 @nc_probe(%struct.AVProbeData* %probe_packet) #0 !dbg !2151 {
entry:
  %x.addr.i16 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %x.addr.i16, metadata !2153, metadata !2158), !dbg !2159
  ...
  call void @llvm.dbg.declare(metadata %struct.AVProbeData** %probe_packet.addr, metadata !2165, metadata !2158), !dbg !2166
  call void @llvm.dbg.declare(metadata i32* %size, metadata !2167, metadata !2158), !dbg !2168
  %0 = load %struct.AVProbeData*, %struct.AVProbeData** %probe_packet.addr, align 8, !dbg !2169
  %buf = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %0, i32 0, i32 1, !dbg !2170
  %1 = load i8*, i8** %buf, align 8, !dbg !2170
  %2 = bitcast i8* %1 to %union.unaligned_32*, !dbg !2171
  %l = bitcast %union.unaligned_32* %2 to i32*, !dbg !2171
  %3 = load i32, i32* %l, align 1, !dbg !2171
  store i32 %3, i32* %x.addr.i, align 4, !dbg !2172
  %4 = load i32, i32* %x.addr.i, align 4, !dbg !2173
  %shl.i = shl i32 %4, 8, !dbg !2174
  %and.i = and i32 %shl.i, 65280, !dbg !2175
  %5 = load i32, i32* %x.addr.i, align 4, !dbg !2176
  %shr.i = lshr i32 %5, 8, !dbg !2177
  %and1.i = and i32 %shr.i, 255, !dbg !2178
  %or.i = or i32 %and.i, %and1.i, !dbg !2179
  %shl2.i = shl i32 %or.i, 16, !dbg !2180
  %6 = load i32, i32* %x.addr.i, align 4, !dbg !2181
  %shr3.i = lshr i32 %6, 16, !dbg !2182
  %shl4.i = shl i32 %shr3.i, 8, !dbg !2183
  %and5.i = and i32 %shl4.i, 65280, !dbg !2184
  %7 = load i32, i32* %x.addr.i, align 4, !dbg !2185
  %shr6.i = lshr i32 %7, 16, !dbg !2186
  %shr7.i = lshr i32 %shr6.i, 8, !dbg !2187
  %and8.i = and i32 %shr7.i, 255, !dbg !2188
  %or9.i = or i32 %and5.i, %and8.i, !dbg !2189
  %or10.i = or i32 %shl2.i, %or9.i, !dbg !2190
  %cmp = icmp ne i32 %or10.i, 421, !dbg !2191
...
if.end:                                           ; preds = %entry
  %8 = load %struct.AVProbeData*, %struct.AVProbeData** %probe_packet.addr, align 8, !dbg !2194
  ...
  %add.ptr = getelementptr inbounds i8, i8* %9, i64 5, !dbg !2196
  ...
  %conv = zext i16 %11 to i32, !dbg !2198
  store i32 %conv, i32* %size, align 4, !dbg !2199
  %12 = load i32, i32* %size, align 4, !dbg !2200
  %add = add nsw i32 %12, 20, !dbg !2202
  %13 = load %struct.AVProbeData*, %struct.AVProbeData** %probe_packet.addr, align 8, !dbg !2203
  %buf_size = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %13, i32 0, i32 2, !dbg !2204
  %14 = load i32, i32* %buf_size, align 8, !dbg !2204
  %cmp3 = icmp sgt i32 %add, %14, !dbg !2205
  br i1 %cmp3, label %if.then5, label %if.end6, !dbg !2206

if.then5:                                         ; preds = %if.end
  store i32 25, i32* %retval, align 4, !dbg !2207
  br label %return, !dbg !2207

if.end6:                                          ; preds = %if.end
  %15 = load %struct.AVProbeData*, %struct.AVProbeData** %probe_packet.addr, align 8, !dbg !2208
  %buf7 = getelementptr inbounds %struct.AVProbeData, %struct.AVProbeData* %15, i32 0, i32 1, !dbg !2209
  %16 = load i8*, i8** %buf7, align 8, !dbg !2209
  %add.ptr8 = getelementptr inbounds i8, i8* %16, i64 16, !dbg !2210
  %17 = load i32, i32* %size, align 4, !dbg !2211
  %idx.ext = sext i32 %17 to i64, !dbg !2212
  %add.ptr9 = getelementptr inbounds i8, i8* %add.ptr8, i64 %idx.ext, !dbg !2212
  %18 = bitcast i8* %add.ptr9 to %union.unaligned_32*, !dbg !2213
  %l10 = bitcast %union.unaligned_32* %18 to i32*, !dbg !2213
  %19 = load i32, i32* %l10, align 1, !dbg !2213
  store i32 %19, i32* %x.addr.i16, align 4, !dbg !2214
  %20 = load i32, i32* %x.addr.i16, align 4, !dbg !2215
  %shl.i17 = shl i32 %20, 8, !dbg !2216
  %and.i18 = and i32 %shl.i17, 65280, !dbg !2217
  %21 = load i32, i32* %x.addr.i16, align 4, !dbg !2218
  %shr.i19 = lshr i32 %21, 8, !dbg !2219
  %and1.i20 = and i32 %shr.i19, 255, !dbg !2220
  %or.i21 = or i32 %and.i18, %and1.i20, !dbg !2221
  %shl2.i22 = shl i32 %or.i21, 16, !dbg !2222
  %22 = load i32, i32* %x.addr.i16, align 4, !dbg !2223
  %shr3.i23 = lshr i32 %22, 16, !dbg !2224
  %shl4.i24 = shl i32 %shr3.i23, 8, !dbg !2225
  %and5.i25 = and i32 %shl4.i24, 65280, !dbg !2226
  %23 = load i32, i32* %x.addr.i16, align 4, !dbg !2227
  %shr6.i26 = lshr i32 %23, 16, !dbg !2228
  %shr7.i27 = lshr i32 %shr6.i26, 8, !dbg !2229
  %and8.i28 = and i32 %shr7.i27, 255, !dbg !2230
  %or9.i29 = or i32 %and5.i25, %and8.i28, !dbg !2231
  %or10.i30 = or i32 %shl2.i22, %or9.i29, !dbg !2232
  %cmp12 = icmp eq i32 %or10.i30, 421, !dbg !2233
  br i1 %cmp12, label %if.then14, label %if.end15, !dbg !2234

if.then14:                                        ; preds = %if.end6
  store i32 100, i32* %retval, align 4, !dbg !2235
...
return:                                           ; preds = %if.end15, %if.then14, %if.then5, %if.then
  %24 = load i32, i32* %retval, align 4, !dbg !2237
  ret i32 %24, !dbg !2237
}

; Function Attrs: nounwind uwtable
define internal i32 @nc_read_header(%struct.AVFormatContext* %s) #0 !dbg !2238 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  %st = alloca %struct.AVStream*, align 8
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2243, metadata !2158), !dbg !2244
  call void @llvm.dbg.declare(metadata %struct.AVStream** %st, metadata !2245, metadata !2158), !dbg !2246
  %0 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2247
  %call = call %struct.AVStream* @avformat_new_stream(%struct.AVFormatContext* %0, %struct.AVCodec* null), !dbg !2248
  store %struct.AVStream* %call, %struct.AVStream** %st, align 8, !dbg !2246
  %1 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2249
  %tobool = icmp ne %struct.AVStream* %1, null, !dbg !2249
...
if.end:                                           ; preds = %entry
  %2 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2253
  %codecpar = getelementptr inbounds %struct.AVStream, %struct.AVStream* %2, i32 0, i32 19, !dbg !2254
  %3 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar, align 8, !dbg !2254
  %codec_type = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %3, i32 0, i32 0, !dbg !2255
  store i32 0, i32* %codec_type, align 8, !dbg !2256
  %4 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2257
  %codecpar1 = getelementptr inbounds %struct.AVStream, %struct.AVStream* %4, i32 0, i32 19, !dbg !2258
  %5 = load %struct.AVCodecParameters*, %struct.AVCodecParameters** %codecpar1, align 8, !dbg !2258
  %codec_id = getelementptr inbounds %struct.AVCodecParameters, %struct.AVCodecParameters* %5, i32 0, i32 1, !dbg !2259
  store i32 12, i32* %codec_id, align 4, !dbg !2260
  %6 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2261
  %need_parsing = getelementptr inbounds %struct.AVStream, %struct.AVStream* %6, i32 0, i32 28, !dbg !2262
  store i32 1, i32* %need_parsing, align 4, !dbg !2263
  %7 = load %struct.AVStream*, %struct.AVStream** %st, align 8, !dbg !2264
  call void @avpriv_set_pts_info(%struct.AVStream* %7, i32 64, i32 1, i32 100), !dbg !2265
  store i32 0, i32* %retval, align 4, !dbg !2266
  br label %return, !dbg !2266

return:                                           ; preds = %if.end, %if.then
  %8 = load i32, i32* %retval, align 4, !dbg !2267
  ret i32 %8, !dbg !2267
}

; Function Attrs: nounwind uwtable
define internal i32 @nc_read_packet(%struct.AVFormatContext* %s, %struct.AVPacket* %pkt) #0 !dbg !2268 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca %struct.AVFormatContext*, align 8
  ...
  store %struct.AVFormatContext* %s, %struct.AVFormatContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVFormatContext** %s.addr, metadata !2271, metadata !2158), !dbg !2272
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !2273, metadata !2158), !dbg !2274
  call void @llvm.dbg.declare(metadata i32* %size, metadata !2275, metadata !2158), !dbg !2276
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2277, metadata !2158), !dbg !2278
  call void @llvm.dbg.declare(metadata i32* %state, metadata !2279, metadata !2158), !dbg !2280
  store i32 -1, i32* %state, align 4, !dbg !2280
  br label %while.cond, !dbg !2281

while.cond:                                       ; preds = %if.end, %entry
  %0 = load i32, i32* %state, align 4, !dbg !2282
  %cmp = icmp ne i32 %0, 421, !dbg !2284
  br i1 %cmp, label %while.body, label %while.end, !dbg !2285

while.body:                                       ; preds = %while.cond
  %1 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2286
  %pb = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %1, i32 0, i32 4, !dbg !2289
  %2 = load %struct.AVIOContext*, %struct.AVIOContext** %pb, align 8, !dbg !2289
  %call = call i32 @avio_feof(%struct.AVIOContext* %2), !dbg !2290
  %tobool = icmp ne i32 %call, 0, !dbg !2290
...
if.end:                                           ; preds = %while.body
  %3 = load i32, i32* %state, align 4, !dbg !2293
  %shl = shl i32 %3, 8, !dbg !2294
  %4 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2295
  %pb1 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %4, i32 0, i32 4, !dbg !2296
  %5 = load %struct.AVIOContext*, %struct.AVIOContext** %pb1, align 8, !dbg !2296
  %call2 = call i32 @avio_r8(%struct.AVIOContext* %5), !dbg !2297
  %add = add i32 %shl, %call2, !dbg !2298
  store i32 %add, i32* %state, align 4, !dbg !2299
  br label %while.cond, !dbg !2300, !llvm.loop !2302

while.end:                                        ; preds = %while.cond
  %6 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2303
  %pb3 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %6, i32 0, i32 4, !dbg !2304
  %7 = load %struct.AVIOContext*, %struct.AVIOContext** %pb3, align 8, !dbg !2304
  %call4 = call i32 @avio_r8(%struct.AVIOContext* %7), !dbg !2305
  %8 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2306
  %pb5 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %8, i32 0, i32 4, !dbg !2307
  %9 = load %struct.AVIOContext*, %struct.AVIOContext** %pb5, align 8, !dbg !2307
  %call6 = call i32 @avio_rl16(%struct.AVIOContext* %9), !dbg !2308
  store i32 %call6, i32* %size, align 4, !dbg !2309
  %10 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2310
  %pb7 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %10, i32 0, i32 4, !dbg !2311
  %11 = load %struct.AVIOContext*, %struct.AVIOContext** %pb7, align 8, !dbg !2311
  %call8 = call i64 @avio_skip(%struct.AVIOContext* %11, i64 9), !dbg !2312
  %12 = load i32, i32* %size, align 4, !dbg !2313
  %cmp9 = icmp eq i32 %12, 0, !dbg !2315
  br i1 %cmp9, label %if.then10, label %if.end11, !dbg !2316

if.then10:                                        ; preds = %while.end
  %13 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2317
  %14 = bitcast %struct.AVFormatContext* %13 to i8*, !dbg !2317
  call void (i8*, i32, i8*, ...) @av_log(i8* %14, i32 48, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.3, i32 0, i32 0)), !dbg !2319
  store i32 -11, i32* %retval, align 4, !dbg !2320
  br label %return, !dbg !2320

if.end11:                                         ; preds = %while.end
  %15 = load %struct.AVFormatContext*, %struct.AVFormatContext** %s.addr, align 8, !dbg !2321
  %pb12 = getelementptr inbounds %struct.AVFormatContext, %struct.AVFormatContext* %15, i32 0, i32 4, !dbg !2322
  %16 = load %struct.AVIOContext*, %struct.AVIOContext** %pb12, align 8, !dbg !2322
  %17 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2323
  %18 = load i32, i32* %size, align 4, !dbg !2324
  %call13 = call i32 @av_get_packet(%struct.AVIOContext* %16, %struct.AVPacket* %17, i32 %18), !dbg !2325
  store i32 %call13, i32* %ret, align 4, !dbg !2326
  %19 = load i32, i32* %ret, align 4, !dbg !2327
  %20 = load i32, i32* %size, align 4, !dbg !2329
  %cmp14 = icmp ne i32 %19, %20, !dbg !2330
  br i1 %cmp14, label %if.then15, label %if.end19, !dbg !2331

if.then15:                                        ; preds = %if.end11
  %21 = load i32, i32* %ret, align 4, !dbg !2332
  %cmp16 = icmp sgt i32 %21, 0, !dbg !2335
  br i1 %cmp16, label %if.then17, label %if.end18, !dbg !2336

if.then17:                                        ; preds = %if.then15
  %22 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2337
  call void @av_packet_unref(%struct.AVPacket* %22), !dbg !2339
  br label %if.end18, !dbg !2339

if.end18:                                         ; preds = %if.then17, %if.then15
  store i32 -5, i32* %retval, align 4, !dbg !2340
  br label %return, !dbg !2340

if.end19:                                         ; preds = %if.end11
  %23 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !2341
  %stream_index = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %23, i32 0, i32 5, !dbg !2342
  store i32 0, i32* %stream_index, align 4, !dbg !2343
  %24 = load i32, i32* %size, align 4, !dbg !2344
  store i32 %24, i32* %retval, align 4, !dbg !2345
  br label %return, !dbg !2345

return:                                           ; preds = %if.end19, %if.end18, %if.then10, %if.then
  %25 = load i32, i32* %retval, align 4, !dbg !2346
  ret i32 %25, !dbg !2346
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[inter]libavformat--ncdec.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs")
...
!933 = !{!934}
!934 = distinct !DIGlobalVariable(name: "ff_nc_demuxer", scope: !0, file: !935, line: 94, type: !936, isLocal: false, isDefinition: true, variable: %struct.AVInputFormat* @ff_nc_demuxer)
!935 = !DIFile(filename: "libavformat/ncdec.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs")
...
!938 = !{!939, !943, !944, !946, !947, !957, !999, !1000, !1002, !1003, !1004, !1018, !2129, !2130, !2131, !2135, !2139, !2140, !2141, !2145, !2146, !2147}
...
!944 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !937, file: !897, line: 652, baseType: !945, size: 32, align: 32, offset: 128)
!945 = !DIBasicType(name: "int", size: 32, align: 32, encoding: DW_ATE_signed)
!946 = !DIDerivedType(tag: DW_TAG_member, name: "extensions", scope: !937, file: !897, line: 659, baseType: !940, size: 64, align: 64, offset: 192)
!947 = !DIDerivedType(tag: DW_TAG_member, name: "codec_tag", scope: !937, file: !897, line: 661, baseType: !948, size: 64, align: 64, offset: 256)
...
!957 = !DIDerivedType(tag: DW_TAG_member, name: "priv_class", scope: !937, file: !897, line: 663, baseType: !958, size: 64, align: 64, offset: 320)
...
!973 = !DIDerivedType(tag: DW_TAG_member, name: "version", scope: !961, file: !464, line: 93, baseType: !945, size: 32, align: 32, offset: 192)
!974 = !DIDerivedType(tag: DW_TAG_member, name: "log_level_offset_offset", scope: !961, file: !464, line: 99, baseType: !945, size: 32, align: 32, offset: 224)
!975 = !DIDerivedType(tag: DW_TAG_member, name: "parent_log_context_offset", scope: !961, file: !464, line: 108, baseType: !945, size: 32, align: 32, offset: 256)
...
!999 = !DIDerivedType(tag: DW_TAG_member, name: "mime_type", scope: !937, file: !897, line: 670, baseType: !940, size: 64, align: 64, offset: 384)
!1000 = !DIDerivedType(tag: DW_TAG_member, name: "next", scope: !937, file: !897, line: 679, baseType: !1001, size: 64, align: 64, offset: 448)
!1001 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !937, size: 64, align: 64)
!1002 = !DIDerivedType(tag: DW_TAG_member, name: "raw_codec_id", scope: !937, file: !897, line: 684, baseType: !945, size: 32, align: 32, offset: 512)
!1003 = !DIDerivedType(tag: DW_TAG_member, name: "priv_data_size", scope: !937, file: !897, line: 689, baseType: !945, size: 32, align: 32, offset: 544)
!1004 = !DIDerivedType(tag: DW_TAG_member, name: "read_probe", scope: !937, file: !897, line: 696, baseType: !1005, size: 64, align: 64, offset: 576)
...
!1012 = !DIDerivedType(tag: DW_TAG_member, name: "filename", scope: !1010, file: !897, line: 449, baseType: !940, size: 64, align: 64)
...
!1016 = !DIDerivedType(tag: DW_TAG_member, name: "buf_size", scope: !1010, file: !897, line: 451, baseType: !945, size: 32, align: 32, offset: 128)
!1017 = !DIDerivedType(tag: DW_TAG_member, name: "mime_type", scope: !1010, file: !897, line: 452, baseType: !940, size: 64, align: 64, offset: 192)
!1018 = !DIDerivedType(tag: DW_TAG_member, name: "read_header", scope: !937, file: !897, line: 703, baseType: !1019, size: 64, align: 64, offset: 640)
...
!1031 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !1029, file: !897, line: 498, baseType: !940, size: 64, align: 64)
!1032 = !DIDerivedType(tag: DW_TAG_member, name: "long_name", scope: !1029, file: !897, line: 504, baseType: !940, size: 64, align: 64, offset: 64)
!1033 = !DIDerivedType(tag: DW_TAG_member, name: "mime_type", scope: !1029, file: !897, line: 505, baseType: !940, size: 64, align: 64, offset: 128)
!1034 = !DIDerivedType(tag: DW_TAG_member, name: "extensions", scope: !1029, file: !897, line: 506, baseType: !940, size: 64, align: 64, offset: 192)
...
!1038 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !1029, file: !897, line: 517, baseType: !945, size: 32, align: 32, offset: 352)
...
!1042 = !DIDerivedType(tag: DW_TAG_member, name: "priv_data_size", scope: !1029, file: !897, line: 539, baseType: !945, size: 32, align: 32, offset: 576)
...
!1065 = !DIDerivedType(tag: DW_TAG_member, name: "size", scope: !1056, file: !1055, line: 93, baseType: !945, size: 32, align: 32, offset: 128)
...
!1071 = !DIDerivedType(tag: DW_TAG_member, name: "size", scope: !1050, file: !4, line: 1469, baseType: !945, size: 32, align: 32, offset: 256)
!1072 = !DIDerivedType(tag: DW_TAG_member, name: "stream_index", scope: !1050, file: !4, line: 1470, baseType: !945, size: 32, align: 32, offset: 288)
!1073 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !1050, file: !4, line: 1474, baseType: !945, size: 32, align: 32, offset: 320)
...
!1080 = !DIDerivedType(tag: DW_TAG_member, name: "size", scope: !1077, file: !4, line: 1413, baseType: !945, size: 32, align: 32, offset: 64)
!1081 = !DIDerivedType(tag: DW_TAG_member, name: "type", scope: !1077, file: !4, line: 1414, baseType: !484, size: 32, align: 32, offset: 96)
!1082 = !DIDerivedType(tag: DW_TAG_member, name: "side_data_elems", scope: !1050, file: !4, line: 1480, baseType: !945, size: 32, align: 32, offset: 448)
...
!1121 = !DICompositeType(tag: DW_TAG_array_type, baseType: !945, size: 256, align: 32, elements: !1118)
...
!1124 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !1114, file: !526, line: 326, baseType: !945, size: 32, align: 32, offset: 832)
!1125 = !DIDerivedType(tag: DW_TAG_member, name: "height", scope: !1114, file: !526, line: 326, baseType: !945, size: 32, align: 32, offset: 864)
!1126 = !DIDerivedType(tag: DW_TAG_member, name: "nb_samples", scope: !1114, file: !526, line: 334, baseType: !945, size: 32, align: 32, offset: 896)
!1127 = !DIDerivedType(tag: DW_TAG_member, name: "format", scope: !1114, file: !526, line: 341, baseType: !945, size: 32, align: 32, offset: 928)
!1128 = !DIDerivedType(tag: DW_TAG_member, name: "key_frame", scope: !1114, file: !526, line: 346, baseType: !945, size: 32, align: 32, offset: 960)
...
!1134 = !{!1135, !1136}
!1135 = !DIDerivedType(tag: DW_TAG_member, name: "num", scope: !1133, file: !1132, line: 59, baseType: !945, size: 32, align: 32)
!1136 = !DIDerivedType(tag: DW_TAG_member, name: "den", scope: !1133, file: !1132, line: 60, baseType: !945, size: 32, align: 32, offset: 32)
...
!1140 = !DIDerivedType(tag: DW_TAG_member, name: "coded_picture_number", scope: !1114, file: !526, line: 382, baseType: !945, size: 32, align: 32, offset: 1280)
!1141 = !DIDerivedType(tag: DW_TAG_member, name: "display_picture_number", scope: !1114, file: !526, line: 386, baseType: !945, size: 32, align: 32, offset: 1312)
!1142 = !DIDerivedType(tag: DW_TAG_member, name: "quality", scope: !1114, file: !526, line: 391, baseType: !945, size: 32, align: 32, offset: 1344)
...
!1147 = !DIDerivedType(tag: DW_TAG_member, name: "repeat_pict", scope: !1114, file: !526, line: 410, baseType: !945, size: 32, align: 32, offset: 1984)
!1148 = !DIDerivedType(tag: DW_TAG_member, name: "interlaced_frame", scope: !1114, file: !526, line: 415, baseType: !945, size: 32, align: 32, offset: 2016)
!1149 = !DIDerivedType(tag: DW_TAG_member, name: "top_field_first", scope: !1114, file: !526, line: 420, baseType: !945, size: 32, align: 32, offset: 2048)
!1150 = !DIDerivedType(tag: DW_TAG_member, name: "palette_has_changed", scope: !1114, file: !526, line: 425, baseType: !945, size: 32, align: 32, offset: 2080)
...
!1152 = !DIDerivedType(tag: DW_TAG_member, name: "sample_rate", scope: !1114, file: !526, line: 440, baseType: !945, size: 32, align: 32, offset: 2176)
...
!1158 = !DIDerivedType(tag: DW_TAG_member, name: "nb_extended_buf", scope: !1114, file: !526, line: 477, baseType: !945, size: 32, align: 32, offset: 2880)
...
!1167 = !DIDerivedType(tag: DW_TAG_member, name: "size", scope: !1163, file: !526, line: 204, baseType: !945, size: 32, align: 32, offset: 128)
...
!1174 = !DIDerivedType(tag: DW_TAG_member, name: "nb_side_data", scope: !1114, file: !526, line: 480, baseType: !945, size: 32, align: 32, offset: 3008)
!1175 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !1114, file: !526, line: 505, baseType: !945, size: 32, align: 32, offset: 3040)
...
!1185 = !DIDerivedType(tag: DW_TAG_member, name: "decode_error_flags", scope: !1114, file: !526, line: 563, baseType: !945, size: 32, align: 32, offset: 3520)
!1186 = !DIDerivedType(tag: DW_TAG_member, name: "channels", scope: !1114, file: !526, line: 572, baseType: !945, size: 32, align: 32, offset: 3552)
!1187 = !DIDerivedType(tag: DW_TAG_member, name: "pkt_size", scope: !1114, file: !526, line: 581, baseType: !945, size: 32, align: 32, offset: 3584)
...
!1192 = !DIDerivedType(tag: DW_TAG_member, name: "qstride", scope: !1114, file: !526, line: 593, baseType: !945, size: 32, align: 32, offset: 3712)
!1193 = !DIDerivedType(tag: DW_TAG_member, name: "qscale_type", scope: !1114, file: !526, line: 596, baseType: !945, size: 32, align: 32, offset: 3744)
...
!1235 = !DIDerivedType(tag: DW_TAG_member, name: "buffer_size", scope: !1231, file: !628, line: 227, baseType: !945, size: 32, align: 32, offset: 128)
...
!1247 = !{!1067, !968, !1067, !945}
!1248 = !DIDerivedType(tag: DW_TAG_member, name: "pos", scope: !1231, file: !628, line: 238, baseType: !1067, size: 64, align: 64, offset: 576)
!1249 = !DIDerivedType(tag: DW_TAG_member, name: "eof_reached", scope: !1231, file: !628, line: 239, baseType: !945, size: 32, align: 32, offset: 640)
!1250 = !DIDerivedType(tag: DW_TAG_member, name: "write_flag", scope: !1231, file: !628, line: 240, baseType: !945, size: 32, align: 32, offset: 672)
!1251 = !DIDerivedType(tag: DW_TAG_member, name: "max_packet_size", scope: !1231, file: !628, line: 241, baseType: !945, size: 32, align: 32, offset: 704)
...
!1260 = !DIDerivedType(tag: DW_TAG_member, name: "error", scope: !1231, file: !628, line: 245, baseType: !945, size: 32, align: 32, offset: 960)
...
!1268 = !{!1067, !968, !945, !1067, !945}
!1269 = !DIDerivedType(tag: DW_TAG_member, name: "seekable", scope: !1231, file: !628, line: 260, baseType: !945, size: 32, align: 32, offset: 1152)
...
!1271 = !DIDerivedType(tag: DW_TAG_member, name: "direct", scope: !1231, file: !628, line: 273, baseType: !945, size: 32, align: 32, offset: 1280)
...
!1273 = !DIDerivedType(tag: DW_TAG_member, name: "seek_count", scope: !1231, file: !628, line: 285, baseType: !945, size: 32, align: 32, offset: 1408)
!1274 = !DIDerivedType(tag: DW_TAG_member, name: "writeout_count", scope: !1231, file: !628, line: 291, baseType: !945, size: 32, align: 32, offset: 1440)
!1275 = !DIDerivedType(tag: DW_TAG_member, name: "orig_buffer_size", scope: !1231, file: !628, line: 298, baseType: !945, size: 32, align: 32, offset: 1472)
!1276 = !DIDerivedType(tag: DW_TAG_member, name: "short_seek_threshold", scope: !1231, file: !628, line: 304, baseType: !945, size: 32, align: 32, offset: 1504)
!1277 = !DIDerivedType(tag: DW_TAG_member, name: "protocol_whitelist", scope: !1231, file: !628, line: 309, baseType: !940, size: 64, align: 64, offset: 1536)
!1278 = !DIDerivedType(tag: DW_TAG_member, name: "protocol_blacklist", scope: !1231, file: !628, line: 314, baseType: !940, size: 64, align: 64, offset: 1600)
...
!1282 = !{!945, !968, !1063, !945, !627, !1067}
!1283 = !DIDerivedType(tag: DW_TAG_member, name: "ignore_boundary_point", scope: !1231, file: !628, line: 326, baseType: !945, size: 32, align: 32, offset: 1728)
...
!1292 = !DIDerivedType(tag: DW_TAG_member, name: "min_packet_size", scope: !1231, file: !628, line: 351, baseType: !945, size: 32, align: 32, offset: 2048)
!1293 = !DIDerivedType(tag: DW_TAG_member, name: "ctx_flags", scope: !1023, file: !897, line: 1386, baseType: !945, size: 32, align: 32, offset: 320)
...
!1301 = !DIDerivedType(tag: DW_TAG_member, name: "index", scope: !1299, file: !897, line: 866, baseType: !945, size: 32, align: 32)
!1302 = !DIDerivedType(tag: DW_TAG_member, name: "id", scope: !1299, file: !897, line: 872, baseType: !945, size: 32, align: 32, offset: 32)
...
!1309 = !DIDerivedType(tag: DW_TAG_member, name: "log_level_offset", scope: !1306, file: !4, line: 1562, baseType: !945, size: 32, align: 32, offset: 64)
...
!1316 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !1314, file: !4, line: 3475, baseType: !940, size: 64, align: 64)
!1317 = !DIDerivedType(tag: DW_TAG_member, name: "long_name", scope: !1314, file: !4, line: 3480, baseType: !940, size: 64, align: 64, offset: 64)
...
!1320 = !DIDerivedType(tag: DW_TAG_member, name: "capabilities", scope: !1314, file: !4, line: 3487, baseType: !945, size: 32, align: 32, offset: 192)
...
!1329 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !945)
...
!1343 = !{!1344, !1345}
!1344 = !DIDerivedType(tag: DW_TAG_member, name: "profile", scope: !1342, file: !4, line: 3402, baseType: !945, size: 32, align: 32)
!1345 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !1342, file: !4, line: 3403, baseType: !940, size: 64, align: 64, offset: 64)
!1346 = !DIDerivedType(tag: DW_TAG_member, name: "wrapper_name", scope: !1314, file: !4, line: 3507, baseType: !940, size: 64, align: 64, offset: 768)
!1347 = !DIDerivedType(tag: DW_TAG_member, name: "priv_data_size", scope: !1314, file: !4, line: 3516, baseType: !945, size: 32, align: 32, offset: 832)
...
!1388 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !1386, file: !4, line: 3886, baseType: !945, size: 32, align: 32)
!1389 = !DIDerivedType(tag: DW_TAG_member, name: "y", scope: !1386, file: !4, line: 3887, baseType: !945, size: 32, align: 32, offset: 32)
!1390 = !DIDerivedType(tag: DW_TAG_member, name: "w", scope: !1386, file: !4, line: 3888, baseType: !945, size: 32, align: 32, offset: 64)
!1391 = !DIDerivedType(tag: DW_TAG_member, name: "h", scope: !1386, file: !4, line: 3889, baseType: !945, size: 32, align: 32, offset: 96)
!1392 = !DIDerivedType(tag: DW_TAG_member, name: "nb_colors", scope: !1386, file: !4, line: 3890, baseType: !945, size: 32, align: 32, offset: 128)
...
!1404 = !DICompositeType(tag: DW_TAG_array_type, baseType: !945, size: 128, align: 32, elements: !1401)
...
!1407 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !942, size: 64, align: 64)
!1408 = !DIDerivedType(tag: DW_TAG_member, name: "ass", scope: !1386, file: !4, line: 3915, baseType: !1407, size: 64, align: 64, offset: 1472)
!1409 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !1386, file: !4, line: 3917, baseType: !945, size: 32, align: 32, offset: 1536)
...
!1417 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !945, size: 64, align: 64)
...
!1438 = !{null, !1304}
!1439 = !DIDerivedType(tag: DW_TAG_member, name: "caps_internal", scope: !1314, file: !4, line: 3594, baseType: !945, size: 32, align: 32, offset: 1792)
!1440 = !DIDerivedType(tag: DW_TAG_member, name: "bsfs", scope: !1314, file: !4, line: 3600, baseType: !940, size: 64, align: 64, offset: 1856)
...
!1454 = !DIDerivedType(tag: DW_TAG_member, name: "bit_rate_tolerance", scope: !1306, file: !4, line: 1614, baseType: !945, size: 32, align: 32, offset: 512)
!1455 = !DIDerivedType(tag: DW_TAG_member, name: "global_quality", scope: !1306, file: !4, line: 1622, baseType: !945, size: 32, align: 32, offset: 544)
!1456 = !DIDerivedType(tag: DW_TAG_member, name: "compression_level", scope: !1306, file: !4, line: 1628, baseType: !945, size: 32, align: 32, offset: 576)
!1457 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !1306, file: !4, line: 1636, baseType: !945, size: 32, align: 32, offset: 608)
!1458 = !DIDerivedType(tag: DW_TAG_member, name: "flags2", scope: !1306, file: !4, line: 1643, baseType: !945, size: 32, align: 32, offset: 640)
...
!1460 = !DIDerivedType(tag: DW_TAG_member, name: "extradata_size", scope: !1306, file: !4, line: 1658, baseType: !945, size: 32, align: 32, offset: 768)
...
!1462 = !DIDerivedType(tag: DW_TAG_member, name: "ticks_per_frame", scope: !1306, file: !4, line: 1688, baseType: !945, size: 32, align: 32, offset: 864)
!1463 = !DIDerivedType(tag: DW_TAG_member, name: "delay", scope: !1306, file: !4, line: 1712, baseType: !945, size: 32, align: 32, offset: 896)
!1464 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !1306, file: !4, line: 1729, baseType: !945, size: 32, align: 32, offset: 928)
!1465 = !DIDerivedType(tag: DW_TAG_member, name: "height", scope: !1306, file: !4, line: 1729, baseType: !945, size: 32, align: 32, offset: 960)
!1466 = !DIDerivedType(tag: DW_TAG_member, name: "coded_width", scope: !1306, file: !4, line: 1744, baseType: !945, size: 32, align: 32, offset: 992)
!1467 = !DIDerivedType(tag: DW_TAG_member, name: "coded_height", scope: !1306, file: !4, line: 1744, baseType: !945, size: 32, align: 32, offset: 1024)
!1468 = !DIDerivedType(tag: DW_TAG_member, name: "gop_size", scope: !1306, file: !4, line: 1751, baseType: !945, size: 32, align: 32, offset: 1056)
...
!1473 = !{null, !1474, !1415, !1417, !945, !945, !945}
...
!1478 = !{!645, !1474, !1325}
!1479 = !DIDerivedType(tag: DW_TAG_member, name: "max_b_frames", scope: !1306, file: !4, line: 1816, baseType: !945, size: 32, align: 32, offset: 1280)
...
!1482 = !DIDerivedType(tag: DW_TAG_member, name: "b_frame_strategy", scope: !1306, file: !4, line: 1830, baseType: !945, size: 32, align: 32, offset: 1344)
...
!1484 = !DIDerivedType(tag: DW_TAG_member, name: "has_b_frames", scope: !1306, file: !4, line: 1846, baseType: !945, size: 32, align: 32, offset: 1408)
!1485 = !DIDerivedType(tag: DW_TAG_member, name: "mpeg_quant", scope: !1306, file: !4, line: 1851, baseType: !945, size: 32, align: 32, offset: 1440)
...
!1493 = !DIDerivedType(tag: DW_TAG_member, name: "slice_count", scope: !1306, file: !4, line: 1910, baseType: !945, size: 32, align: 32, offset: 1696)
!1494 = !DIDerivedType(tag: DW_TAG_member, name: "prediction_method", scope: !1306, file: !4, line: 1915, baseType: !945, size: 32, align: 32, offset: 1728)
...
!1497 = !DIDerivedType(tag: DW_TAG_member, name: "me_cmp", scope: !1306, file: !4, line: 1942, baseType: !945, size: 32, align: 32, offset: 1920)
!1498 = !DIDerivedType(tag: DW_TAG_member, name: "me_sub_cmp", scope: !1306, file: !4, line: 1948, baseType: !945, size: 32, align: 32, offset: 1952)
!1499 = !DIDerivedType(tag: DW_TAG_member, name: "mb_cmp", scope: !1306, file: !4, line: 1954, baseType: !945, size: 32, align: 32, offset: 1984)
!1500 = !DIDerivedType(tag: DW_TAG_member, name: "ildct_cmp", scope: !1306, file: !4, line: 1960, baseType: !945, size: 32, align: 32, offset: 2016)
!1501 = !DIDerivedType(tag: DW_TAG_member, name: "dia_size", scope: !1306, file: !4, line: 1984, baseType: !945, size: 32, align: 32, offset: 2048)
!1502 = !DIDerivedType(tag: DW_TAG_member, name: "last_predictor_count", scope: !1306, file: !4, line: 1991, baseType: !945, size: 32, align: 32, offset: 2080)
!1503 = !DIDerivedType(tag: DW_TAG_member, name: "pre_me", scope: !1306, file: !4, line: 1996, baseType: !945, size: 32, align: 32, offset: 2112)
!1504 = !DIDerivedType(tag: DW_TAG_member, name: "me_pre_cmp", scope: !1306, file: !4, line: 2004, baseType: !945, size: 32, align: 32, offset: 2144)
!1505 = !DIDerivedType(tag: DW_TAG_member, name: "pre_dia_size", scope: !1306, file: !4, line: 2011, baseType: !945, size: 32, align: 32, offset: 2176)
!1506 = !DIDerivedType(tag: DW_TAG_member, name: "me_subpel_quality", scope: !1306, file: !4, line: 2018, baseType: !945, size: 32, align: 32, offset: 2208)
!1507 = !DIDerivedType(tag: DW_TAG_member, name: "me_range", scope: !1306, file: !4, line: 2027, baseType: !945, size: 32, align: 32, offset: 2240)
!1508 = !DIDerivedType(tag: DW_TAG_member, name: "slice_flags", scope: !1306, file: !4, line: 2034, baseType: !945, size: 32, align: 32, offset: 2272)
!1509 = !DIDerivedType(tag: DW_TAG_member, name: "mb_decision", scope: !1306, file: !4, line: 2044, baseType: !945, size: 32, align: 32, offset: 2304)
...
!1513 = !DIDerivedType(tag: DW_TAG_member, name: "scenechange_threshold", scope: !1306, file: !4, line: 2066, baseType: !945, size: 32, align: 32, offset: 2496)
!1514 = !DIDerivedType(tag: DW_TAG_member, name: "noise_reduction", scope: !1306, file: !4, line: 2070, baseType: !945, size: 32, align: 32, offset: 2528)
!1515 = !DIDerivedType(tag: DW_TAG_member, name: "intra_dc_precision", scope: !1306, file: !4, line: 2078, baseType: !945, size: 32, align: 32, offset: 2560)
!1516 = !DIDerivedType(tag: DW_TAG_member, name: "skip_top", scope: !1306, file: !4, line: 2085, baseType: !945, size: 32, align: 32, offset: 2592)
!1517 = !DIDerivedType(tag: DW_TAG_member, name: "skip_bottom", scope: !1306, file: !4, line: 2092, baseType: !945, size: 32, align: 32, offset: 2624)
!1518 = !DIDerivedType(tag: DW_TAG_member, name: "mb_lmin", scope: !1306, file: !4, line: 2099, baseType: !945, size: 32, align: 32, offset: 2656)
!1519 = !DIDerivedType(tag: DW_TAG_member, name: "mb_lmax", scope: !1306, file: !4, line: 2106, baseType: !945, size: 32, align: 32, offset: 2688)
!1520 = !DIDerivedType(tag: DW_TAG_member, name: "me_penalty_compensation", scope: !1306, file: !4, line: 2113, baseType: !945, size: 32, align: 32, offset: 2720)
!1521 = !DIDerivedType(tag: DW_TAG_member, name: "bidir_refine", scope: !1306, file: !4, line: 2120, baseType: !945, size: 32, align: 32, offset: 2752)
!1522 = !DIDerivedType(tag: DW_TAG_member, name: "brd_scale", scope: !1306, file: !4, line: 2125, baseType: !945, size: 32, align: 32, offset: 2784)
!1523 = !DIDerivedType(tag: DW_TAG_member, name: "keyint_min", scope: !1306, file: !4, line: 2133, baseType: !945, size: 32, align: 32, offset: 2816)
!1524 = !DIDerivedType(tag: DW_TAG_member, name: "refs", scope: !1306, file: !4, line: 2140, baseType: !945, size: 32, align: 32, offset: 2848)
!1525 = !DIDerivedType(tag: DW_TAG_member, name: "chromaoffset", scope: !1306, file: !4, line: 2145, baseType: !945, size: 32, align: 32, offset: 2880)
!1526 = !DIDerivedType(tag: DW_TAG_member, name: "mv0_threshold", scope: !1306, file: !4, line: 2153, baseType: !945, size: 32, align: 32, offset: 2912)
!1527 = !DIDerivedType(tag: DW_TAG_member, name: "b_sensitivity", scope: !1306, file: !4, line: 2158, baseType: !945, size: 32, align: 32, offset: 2944)
...
!1533 = !DIDerivedType(tag: DW_TAG_member, name: "slices", scope: !1306, file: !4, line: 2203, baseType: !945, size: 32, align: 32, offset: 3136)
...
!1535 = !DIDerivedType(tag: DW_TAG_member, name: "sample_rate", scope: !1306, file: !4, line: 2212, baseType: !945, size: 32, align: 32, offset: 3200)
!1536 = !DIDerivedType(tag: DW_TAG_member, name: "channels", scope: !1306, file: !4, line: 2213, baseType: !945, size: 32, align: 32, offset: 3232)
...
!1538 = !DIDerivedType(tag: DW_TAG_member, name: "frame_size", scope: !1306, file: !4, line: 2232, baseType: !945, size: 32, align: 32, offset: 3296)
!1539 = !DIDerivedType(tag: DW_TAG_member, name: "frame_number", scope: !1306, file: !4, line: 2243, baseType: !945, size: 32, align: 32, offset: 3328)
!1540 = !DIDerivedType(tag: DW_TAG_member, name: "block_align", scope: !1306, file: !4, line: 2249, baseType: !945, size: 32, align: 32, offset: 3360)
!1541 = !DIDerivedType(tag: DW_TAG_member, name: "cutoff", scope: !1306, file: !4, line: 2256, baseType: !945, size: 32, align: 32, offset: 3392)
...
!1549 = !{!945, !1474, !1112, !945}
!1550 = !DIDerivedType(tag: DW_TAG_member, name: "refcounted_frames", scope: !1306, file: !4, line: 2383, baseType: !945, size: 32, align: 32, offset: 3712)
...
!1553 = !DIDerivedType(tag: DW_TAG_member, name: "qmin", scope: !1306, file: !4, line: 2394, baseType: !945, size: 32, align: 32, offset: 3808)
!1554 = !DIDerivedType(tag: DW_TAG_member, name: "qmax", scope: !1306, file: !4, line: 2401, baseType: !945, size: 32, align: 32, offset: 3840)
!1555 = !DIDerivedType(tag: DW_TAG_member, name: "max_qdiff", scope: !1306, file: !4, line: 2408, baseType: !945, size: 32, align: 32, offset: 3872)
!1556 = !DIDerivedType(tag: DW_TAG_member, name: "rc_buffer_size", scope: !1306, file: !4, line: 2415, baseType: !945, size: 32, align: 32, offset: 3904)
!1557 = !DIDerivedType(tag: DW_TAG_member, name: "rc_override_count", scope: !1306, file: !4, line: 2422, baseType: !945, size: 32, align: 32, offset: 3936)
...
!1563 = !DIDerivedType(tag: DW_TAG_member, name: "start_frame", scope: !1561, file: !4, line: 827, baseType: !945, size: 32, align: 32)
!1564 = !DIDerivedType(tag: DW_TAG_member, name: "end_frame", scope: !1561, file: !4, line: 828, baseType: !945, size: 32, align: 32, offset: 32)
!1565 = !DIDerivedType(tag: DW_TAG_member, name: "qscale", scope: !1561, file: !4, line: 829, baseType: !945, size: 32, align: 32, offset: 64)
...
!1571 = !DIDerivedType(tag: DW_TAG_member, name: "rc_initial_buffer_occupancy", scope: !1306, file: !4, line: 2458, baseType: !945, size: 32, align: 32, offset: 4224)
!1572 = !DIDerivedType(tag: DW_TAG_member, name: "coder_type", scope: !1306, file: !4, line: 2469, baseType: !945, size: 32, align: 32, offset: 4256)
!1573 = !DIDerivedType(tag: DW_TAG_member, name: "context_model", scope: !1306, file: !4, line: 2475, baseType: !945, size: 32, align: 32, offset: 4288)
!1574 = !DIDerivedType(tag: DW_TAG_member, name: "frame_skip_threshold", scope: !1306, file: !4, line: 2481, baseType: !945, size: 32, align: 32, offset: 4320)
!1575 = !DIDerivedType(tag: DW_TAG_member, name: "frame_skip_factor", scope: !1306, file: !4, line: 2485, baseType: !945, size: 32, align: 32, offset: 4352)
!1576 = !DIDerivedType(tag: DW_TAG_member, name: "frame_skip_exp", scope: !1306, file: !4, line: 2489, baseType: !945, size: 32, align: 32, offset: 4384)
!1577 = !DIDerivedType(tag: DW_TAG_member, name: "frame_skip_cmp", scope: !1306, file: !4, line: 2493, baseType: !945, size: 32, align: 32, offset: 4416)
!1578 = !DIDerivedType(tag: DW_TAG_member, name: "trellis", scope: !1306, file: !4, line: 2501, baseType: !945, size: 32, align: 32, offset: 4448)
!1579 = !DIDerivedType(tag: DW_TAG_member, name: "min_prediction_order", scope: !1306, file: !4, line: 2506, baseType: !945, size: 32, align: 32, offset: 4480)
!1580 = !DIDerivedType(tag: DW_TAG_member, name: "max_prediction_order", scope: !1306, file: !4, line: 2510, baseType: !945, size: 32, align: 32, offset: 4512)
...
!1585 = !{null, !1474, !968, !945, !945}
!1586 = !DIDerivedType(tag: DW_TAG_member, name: "rtp_payload_size", scope: !1306, file: !4, line: 2534, baseType: !945, size: 32, align: 32, offset: 4672)
!1587 = !DIDerivedType(tag: DW_TAG_member, name: "mv_bits", scope: !1306, file: !4, line: 2545, baseType: !945, size: 32, align: 32, offset: 4704)
!1588 = !DIDerivedType(tag: DW_TAG_member, name: "header_bits", scope: !1306, file: !4, line: 2547, baseType: !945, size: 32, align: 32, offset: 4736)
!1589 = !DIDerivedType(tag: DW_TAG_member, name: "i_tex_bits", scope: !1306, file: !4, line: 2549, baseType: !945, size: 32, align: 32, offset: 4768)
!1590 = !DIDerivedType(tag: DW_TAG_member, name: "p_tex_bits", scope: !1306, file: !4, line: 2551, baseType: !945, size: 32, align: 32, offset: 4800)
!1591 = !DIDerivedType(tag: DW_TAG_member, name: "i_count", scope: !1306, file: !4, line: 2553, baseType: !945, size: 32, align: 32, offset: 4832)
!1592 = !DIDerivedType(tag: DW_TAG_member, name: "p_count", scope: !1306, file: !4, line: 2555, baseType: !945, size: 32, align: 32, offset: 4864)
!1593 = !DIDerivedType(tag: DW_TAG_member, name: "skip_count", scope: !1306, file: !4, line: 2557, baseType: !945, size: 32, align: 32, offset: 4896)
!1594 = !DIDerivedType(tag: DW_TAG_member, name: "misc_bits", scope: !1306, file: !4, line: 2559, baseType: !945, size: 32, align: 32, offset: 4928)
!1595 = !DIDerivedType(tag: DW_TAG_member, name: "frame_bits", scope: !1306, file: !4, line: 2563, baseType: !945, size: 32, align: 32, offset: 4960)
...
!1598 = !DIDerivedType(tag: DW_TAG_member, name: "workaround_bugs", scope: !1306, file: !4, line: 2586, baseType: !945, size: 32, align: 32, offset: 5120)
!1599 = !DIDerivedType(tag: DW_TAG_member, name: "strict_std_compliance", scope: !1306, file: !4, line: 2615, baseType: !945, size: 32, align: 32, offset: 5152)
!1600 = !DIDerivedType(tag: DW_TAG_member, name: "error_concealment", scope: !1306, file: !4, line: 2627, baseType: !945, size: 32, align: 32, offset: 5184)
!1601 = !DIDerivedType(tag: DW_TAG_member, name: "debug", scope: !1306, file: !4, line: 2637, baseType: !945, size: 32, align: 32, offset: 5216)
!1602 = !DIDerivedType(tag: DW_TAG_member, name: "err_recognition", scope: !1306, file: !4, line: 2681, baseType: !945, size: 32, align: 32, offset: 5248)
...
!1609 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !1607, file: !4, line: 3642, baseType: !940, size: 64, align: 64)
...
!1613 = !DIDerivedType(tag: DW_TAG_member, name: "capabilities", scope: !1607, file: !4, line: 3669, baseType: !945, size: 32, align: 32, offset: 160)
...
!1625 = !DIDerivedType(tag: DW_TAG_member, name: "frame_priv_data_size", scope: !1607, file: !4, line: 3746, baseType: !945, size: 32, align: 32, offset: 512)
...
!1634 = !DIDerivedType(tag: DW_TAG_member, name: "priv_data_size", scope: !1607, file: !4, line: 3780, baseType: !945, size: 32, align: 32, offset: 768)
!1635 = !DIDerivedType(tag: DW_TAG_member, name: "caps_internal", scope: !1607, file: !4, line: 3785, baseType: !945, size: 32, align: 32, offset: 800)
...
!1642 = !DIDerivedType(tag: DW_TAG_member, name: "dct_algo", scope: !1306, file: !4, line: 2742, baseType: !945, size: 32, align: 32, offset: 6016)
!1643 = !DIDerivedType(tag: DW_TAG_member, name: "idct_algo", scope: !1306, file: !4, line: 2755, baseType: !945, size: 32, align: 32, offset: 6048)
!1644 = !DIDerivedType(tag: DW_TAG_member, name: "bits_per_coded_sample", scope: !1306, file: !4, line: 2776, baseType: !945, size: 32, align: 32, offset: 6080)
!1645 = !DIDerivedType(tag: DW_TAG_member, name: "bits_per_raw_sample", scope: !1306, file: !4, line: 2783, baseType: !945, size: 32, align: 32, offset: 6112)
!1646 = !DIDerivedType(tag: DW_TAG_member, name: "lowres", scope: !1306, file: !4, line: 2791, baseType: !945, size: 32, align: 32, offset: 6144)
...
!1648 = !DIDerivedType(tag: DW_TAG_member, name: "thread_count", scope: !1306, file: !4, line: 2811, baseType: !945, size: 32, align: 32, offset: 6272)
!1649 = !DIDerivedType(tag: DW_TAG_member, name: "thread_type", scope: !1306, file: !4, line: 2821, baseType: !945, size: 32, align: 32, offset: 6304)
!1650 = !DIDerivedType(tag: DW_TAG_member, name: "active_thread_type", scope: !1306, file: !4, line: 2830, baseType: !945, size: 32, align: 32, offset: 6336)
!1651 = !DIDerivedType(tag: DW_TAG_member, name: "thread_safe_callbacks", scope: !1306, file: !4, line: 2840, baseType: !945, size: 32, align: 32, offset: 6368)
...
!1655 = !{!945, !1474, !1656, !968, !1417, !945, !945}
...
!1662 = !{!945, !1474, !1663, !968, !1417, !945}
!1663 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1664, size: 64, align: 64)
!1664 = !DISubroutineType(types: !1665)
!1665 = !{!945, !1474, !968, !945, !945}
!1666 = !DIDerivedType(tag: DW_TAG_member, name: "nsse_weight", scope: !1306, file: !4, line: 2878, baseType: !945, size: 32, align: 32, offset: 6528)
!1667 = !DIDerivedType(tag: DW_TAG_member, name: "profile", scope: !1306, file: !4, line: 2885, baseType: !945, size: 32, align: 32, offset: 6560)
!1668 = !DIDerivedType(tag: DW_TAG_member, name: "level", scope: !1306, file: !4, line: 3005, baseType: !945, size: 32, align: 32, offset: 6592)
...
!1673 = !DIDerivedType(tag: DW_TAG_member, name: "subtitle_header_size", scope: !1306, file: !4, line: 3038, baseType: !945, size: 32, align: 32, offset: 6784)
...
!1675 = !DIDerivedType(tag: DW_TAG_member, name: "side_data_only_packets", scope: !1306, file: !4, line: 3065, baseType: !945, size: 32, align: 32, offset: 6912)
!1676 = !DIDerivedType(tag: DW_TAG_member, name: "initial_padding", scope: !1306, file: !4, line: 3083, baseType: !945, size: 32, align: 32, offset: 6944)
...
!1688 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !1684, file: !4, line: 720, baseType: !940, size: 64, align: 64, offset: 64)
!1689 = !DIDerivedType(tag: DW_TAG_member, name: "long_name", scope: !1684, file: !4, line: 724, baseType: !940, size: 64, align: 64, offset: 128)
!1690 = !DIDerivedType(tag: DW_TAG_member, name: "props", scope: !1684, file: !4, line: 728, baseType: !945, size: 32, align: 32, offset: 192)
...
!1693 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !940)
...
!1702 = !DIDerivedType(tag: DW_TAG_member, name: "sub_charenc_mode", scope: !1306, file: !4, line: 3147, baseType: !945, size: 32, align: 32, offset: 7552)
!1703 = !DIDerivedType(tag: DW_TAG_member, name: "skip_alpha", scope: !1306, file: !4, line: 3165, baseType: !945, size: 32, align: 32, offset: 7584)
!1704 = !DIDerivedType(tag: DW_TAG_member, name: "seek_preroll", scope: !1306, file: !4, line: 3172, baseType: !945, size: 32, align: 32, offset: 7616)
!1705 = !DIDerivedType(tag: DW_TAG_member, name: "debug_mv", scope: !1306, file: !4, line: 3180, baseType: !945, size: 32, align: 32, offset: 7648)
...
!1711 = !DIDerivedType(tag: DW_TAG_member, name: "nb_coded_side_data", scope: !1306, file: !4, line: 3225, baseType: !945, size: 32, align: 32, offset: 8000)
...
!1713 = !DIDerivedType(tag: DW_TAG_member, name: "sub_text_format", scope: !1306, file: !4, line: 3256, baseType: !945, size: 32, align: 32, offset: 8128)
!1714 = !DIDerivedType(tag: DW_TAG_member, name: "trailing_padding", scope: !1306, file: !4, line: 3271, baseType: !945, size: 32, align: 32, offset: 8160)
...
!1717 = !DIDerivedType(tag: DW_TAG_member, name: "hwaccel_flags", scope: !1306, file: !4, line: 3310, baseType: !945, size: 32, align: 32, offset: 8320)
!1718 = !DIDerivedType(tag: DW_TAG_member, name: "apply_cropping", scope: !1306, file: !4, line: 3337, baseType: !945, size: 32, align: 32, offset: 8352)
!1719 = !DIDerivedType(tag: DW_TAG_member, name: "extra_hw_frames", scope: !1306, file: !4, line: 3351, baseType: !945, size: 32, align: 32, offset: 8384)
!1720 = !DIDerivedType(tag: DW_TAG_member, name: "discard_damaged_percentage", scope: !1306, file: !4, line: 3359, baseType: !945, size: 32, align: 32, offset: 8416)
...
!1726 = !DIDerivedType(tag: DW_TAG_member, name: "disposition", scope: !1299, file: !897, line: 918, baseType: !945, size: 32, align: 32, offset: 448)
...
!1733 = !DIDerivedType(tag: DW_TAG_member, name: "nb_side_data", scope: !1299, file: !897, line: 971, baseType: !945, size: 32, align: 32, offset: 1472)
!1734 = !DIDerivedType(tag: DW_TAG_member, name: "event_flags", scope: !1299, file: !897, line: 978, baseType: !945, size: 32, align: 32, offset: 1504)
...
!1746 = !DIDerivedType(tag: DW_TAG_member, name: "extradata_size", scope: !1740, file: !4, line: 3962, baseType: !945, size: 32, align: 32, offset: 192)
!1747 = !DIDerivedType(tag: DW_TAG_member, name: "format", scope: !1740, file: !4, line: 3968, baseType: !945, size: 32, align: 32, offset: 224)
!1748 = !DIDerivedType(tag: DW_TAG_member, name: "bit_rate", scope: !1740, file: !4, line: 3973, baseType: !1067, size: 64, align: 64, offset: 256)
!1749 = !DIDerivedType(tag: DW_TAG_member, name: "bits_per_coded_sample", scope: !1740, file: !4, line: 3986, baseType: !945, size: 32, align: 32, offset: 320)
!1750 = !DIDerivedType(tag: DW_TAG_member, name: "bits_per_raw_sample", scope: !1740, file: !4, line: 3999, baseType: !945, size: 32, align: 32, offset: 352)
!1751 = !DIDerivedType(tag: DW_TAG_member, name: "profile", scope: !1740, file: !4, line: 4004, baseType: !945, size: 32, align: 32, offset: 384)
!1752 = !DIDerivedType(tag: DW_TAG_member, name: "level", scope: !1740, file: !4, line: 4005, baseType: !945, size: 32, align: 32, offset: 416)
!1753 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !1740, file: !4, line: 4010, baseType: !945, size: 32, align: 32, offset: 448)
!1754 = !DIDerivedType(tag: DW_TAG_member, name: "height", scope: !1740, file: !4, line: 4011, baseType: !945, size: 32, align: 32, offset: 480)
...
!1762 = !DIDerivedType(tag: DW_TAG_member, name: "video_delay", scope: !1740, file: !4, line: 4039, baseType: !945, size: 32, align: 32, offset: 768)
...
!1764 = !DIDerivedType(tag: DW_TAG_member, name: "channels", scope: !1740, file: !4, line: 4050, baseType: !945, size: 32, align: 32, offset: 896)
!1765 = !DIDerivedType(tag: DW_TAG_member, name: "sample_rate", scope: !1740, file: !4, line: 4054, baseType: !945, size: 32, align: 32, offset: 928)
!1766 = !DIDerivedType(tag: DW_TAG_member, name: "block_align", scope: !1740, file: !4, line: 4061, baseType: !945, size: 32, align: 32, offset: 960)
!1767 = !DIDerivedType(tag: DW_TAG_member, name: "frame_size", scope: !1740, file: !4, line: 4065, baseType: !945, size: 32, align: 32, offset: 992)
!1768 = !DIDerivedType(tag: DW_TAG_member, name: "initial_padding", scope: !1740, file: !4, line: 4073, baseType: !945, size: 32, align: 32, offset: 1024)
!1769 = !DIDerivedType(tag: DW_TAG_member, name: "trailing_padding", scope: !1740, file: !4, line: 4080, baseType: !945, size: 32, align: 32, offset: 1056)
!1770 = !DIDerivedType(tag: DW_TAG_member, name: "seek_preroll", scope: !1740, file: !4, line: 4084, baseType: !945, size: 32, align: 32, offset: 1088)
...
!1777 = !DIDerivedType(tag: DW_TAG_member, name: "duration_count", scope: !1773, file: !897, line: 1031, baseType: !945, size: 32, align: 32, offset: 128)
...
!1788 = !DIDerivedType(tag: DW_TAG_member, name: "frame_delay_evidence", scope: !1773, file: !897, line: 1036, baseType: !945, size: 32, align: 32, offset: 448)
!1789 = !DIDerivedType(tag: DW_TAG_member, name: "found_decoder", scope: !1773, file: !897, line: 1043, baseType: !945, size: 32, align: 32, offset: 480)
...
!1792 = !DIDerivedType(tag: DW_TAG_member, name: "fps_first_dts_idx", scope: !1773, file: !897, line: 1051, baseType: !945, size: 32, align: 32, offset: 640)
...
!1794 = !DIDerivedType(tag: DW_TAG_member, name: "fps_last_dts_idx", scope: !1773, file: !897, line: 1053, baseType: !945, size: 32, align: 32, offset: 768)
!1795 = !DIDerivedType(tag: DW_TAG_member, name: "pts_wrap_bits", scope: !1299, file: !897, line: 1057, baseType: !945, size: 32, align: 32, offset: 1792)
...
!1799 = !DIDerivedType(tag: DW_TAG_member, name: "last_IP_duration", scope: !1299, file: !897, line: 1070, baseType: !945, size: 32, align: 32, offset: 2048)
!1800 = !DIDerivedType(tag: DW_TAG_member, name: "probe_packets", scope: !1299, file: !897, line: 1075, baseType: !945, size: 32, align: 32, offset: 2080)
!1801 = !DIDerivedType(tag: DW_TAG_member, name: "codec_info_nb_frames", scope: !1299, file: !897, line: 1080, baseType: !945, size: 32, align: 32, offset: 2112)
...
!1813 = !DICompositeType(tag: DW_TAG_array_type, baseType: !945, size: 160, align: 32, elements: !1814)
!1814 = !{!1815}
!1815 = !DISubrange(count: 5)
!1816 = !DIDerivedType(tag: DW_TAG_member, name: "priv_data_size", scope: !1810, file: !4, line: 5261, baseType: !945, size: 32, align: 32, offset: 160)
...
!1826 = !{!945, !1821, !1304, !1827, !1417, !1258, !945}
...
!1840 = !DIDerivedType(tag: DW_TAG_member, name: "pict_type", scope: !1805, file: !4, line: 5100, baseType: !945, size: 32, align: 32, offset: 320)
!1841 = !DIDerivedType(tag: DW_TAG_member, name: "repeat_pict", scope: !1805, file: !4, line: 5110, baseType: !945, size: 32, align: 32, offset: 352)
...
!1846 = !DIDerivedType(tag: DW_TAG_member, name: "fetch_timestamp", scope: !1805, file: !4, line: 5117, baseType: !945, size: 32, align: 32, offset: 640)
!1847 = !DIDerivedType(tag: DW_TAG_member, name: "cur_frame_start_index", scope: !1805, file: !4, line: 5120, baseType: !945, size: 32, align: 32, offset: 672)
...
!1852 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !1805, file: !4, line: 5125, baseType: !945, size: 32, align: 32, offset: 1472)
...
!1855 = !DIDerivedType(tag: DW_TAG_member, name: "key_frame", scope: !1805, file: !4, line: 5141, baseType: !945, size: 32, align: 32, offset: 1856)
...
!1857 = !DIDerivedType(tag: DW_TAG_member, name: "dts_sync_point", scope: !1805, file: !4, line: 5161, baseType: !945, size: 32, align: 32, offset: 1984)
!1858 = !DIDerivedType(tag: DW_TAG_member, name: "dts_ref_dts_delta", scope: !1805, file: !4, line: 5176, baseType: !945, size: 32, align: 32, offset: 2016)
!1859 = !DIDerivedType(tag: DW_TAG_member, name: "pts_dts_delta", scope: !1805, file: !4, line: 5190, baseType: !945, size: 32, align: 32, offset: 2048)
...
!1863 = !DIDerivedType(tag: DW_TAG_member, name: "duration", scope: !1805, file: !4, line: 5214, baseType: !945, size: 32, align: 32, offset: 2496)
...
!1866 = !DIDerivedType(tag: DW_TAG_member, name: "output_picture_number", scope: !1805, file: !4, line: 5234, baseType: !945, size: 32, align: 32, offset: 2592)
!1867 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !1805, file: !4, line: 5239, baseType: !945, size: 32, align: 32, offset: 2624)
!1868 = !DIDerivedType(tag: DW_TAG_member, name: "height", scope: !1805, file: !4, line: 5240, baseType: !945, size: 32, align: 32, offset: 2656)
!1869 = !DIDerivedType(tag: DW_TAG_member, name: "coded_width", scope: !1805, file: !4, line: 5245, baseType: !945, size: 32, align: 32, offset: 2688)
!1870 = !DIDerivedType(tag: DW_TAG_member, name: "coded_height", scope: !1805, file: !4, line: 5246, baseType: !945, size: 32, align: 32, offset: 2720)
!1871 = !DIDerivedType(tag: DW_TAG_member, name: "format", scope: !1805, file: !4, line: 5256, baseType: !945, size: 32, align: 32, offset: 2752)
...
!1890 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !1886, file: !897, line: 805, baseType: !945, size: 2, align: 32, offset: 128, flags: DIFlagBitField, extraData: i64 128)
!1891 = !DIDerivedType(tag: DW_TAG_member, name: "size", scope: !1886, file: !897, line: 806, baseType: !945, size: 30, align: 32, offset: 130, flags: DIFlagBitField, extraData: i64 128)
!1892 = !DIDerivedType(tag: DW_TAG_member, name: "min_distance", scope: !1886, file: !897, line: 807, baseType: !945, size: 32, align: 32, offset: 160)
!1893 = !DIDerivedType(tag: DW_TAG_member, name: "nb_index_entries", scope: !1299, file: !897, line: 1096, baseType: !945, size: 32, align: 32, offset: 3712)
...
!1895 = !DIDerivedType(tag: DW_TAG_member, name: "stream_identifier", scope: !1299, file: !897, line: 1104, baseType: !945, size: 32, align: 32, offset: 3776)
!1896 = !DIDerivedType(tag: DW_TAG_member, name: "program_num", scope: !1299, file: !897, line: 1109, baseType: !945, size: 32, align: 32, offset: 3808)
!1897 = !DIDerivedType(tag: DW_TAG_member, name: "pmt_version", scope: !1299, file: !897, line: 1110, baseType: !945, size: 32, align: 32, offset: 3840)
!1898 = !DIDerivedType(tag: DW_TAG_member, name: "pmt_stream_idx", scope: !1299, file: !897, line: 1111, baseType: !945, size: 32, align: 32, offset: 3872)
...
!1901 = !DIDerivedType(tag: DW_TAG_member, name: "request_probe", scope: !1299, file: !897, line: 1123, baseType: !945, size: 32, align: 32, offset: 4032)
!1902 = !DIDerivedType(tag: DW_TAG_member, name: "skip_to_keyframe", scope: !1299, file: !897, line: 1128, baseType: !945, size: 32, align: 32, offset: 4064)
!1903 = !DIDerivedType(tag: DW_TAG_member, name: "skip_samples", scope: !1299, file: !897, line: 1133, baseType: !945, size: 32, align: 32, offset: 4096)
...
!1907 = !DIDerivedType(tag: DW_TAG_member, name: "nb_decoded_frames", scope: !1299, file: !897, line: 1163, baseType: !945, size: 32, align: 32, offset: 4352)
...
!1910 = !DIDerivedType(tag: DW_TAG_member, name: "pts_wrap_behavior", scope: !1299, file: !897, line: 1186, baseType: !945, size: 32, align: 32, offset: 4544)
!1911 = !DIDerivedType(tag: DW_TAG_member, name: "update_initial_durations_done", scope: !1299, file: !897, line: 1191, baseType: !945, size: 32, align: 32, offset: 4576)
...
!1918 = !DIDerivedType(tag: DW_TAG_member, name: "inject_global_side_data", scope: !1299, file: !897, line: 1209, baseType: !945, size: 32, align: 32, offset: 5984)
...
!1925 = !DIDerivedType(tag: DW_TAG_member, name: "reorder", scope: !1923, file: !953, line: 154, baseType: !945, size: 32, align: 32)
...
!1938 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !1936, file: !4, line: 5797, baseType: !940, size: 64, align: 64)
...
!1943 = !DIDerivedType(tag: DW_TAG_member, name: "priv_data_size", scope: !1936, file: !4, line: 5825, baseType: !945, size: 32, align: 32, offset: 192)
...
!1966 = !DIDerivedType(tag: DW_TAG_member, name: "nb_bsfcs", scope: !1923, file: !953, line: 162, baseType: !945, size: 32, align: 32, offset: 128)
!1967 = !DIDerivedType(tag: DW_TAG_member, name: "bitstream_checked", scope: !1923, file: !953, line: 167, baseType: !945, size: 32, align: 32, offset: 160)
!1968 = !DIDerivedType(tag: DW_TAG_member, name: "avctx", scope: !1923, file: !953, line: 172, baseType: !1304, size: 64, align: 64, offset: 192)
!1969 = !DIDerivedType(tag: DW_TAG_member, name: "avctx_inited", scope: !1923, file: !953, line: 176, baseType: !945, size: 32, align: 32, offset: 256)
...
!1976 = !DIDerivedType(tag: DW_TAG_member, name: "inited", scope: !1972, file: !953, line: 186, baseType: !945, size: 32, align: 32, offset: 128)
!1977 = !DIDerivedType(tag: DW_TAG_member, name: "need_context_update", scope: !1923, file: !953, line: 192, baseType: !945, size: 32, align: 32, offset: 512)
...
!1987 = !DICompositeType(tag: DW_TAG_array_type, baseType: !942, size: 8192, align: 8, elements: !1988)
!1988 = !{!1989}
...
!1995 = !DIDerivedType(tag: DW_TAG_member, name: "max_delay", scope: !1023, file: !897, line: 1462, baseType: !945, size: 32, align: 32, offset: 8928)
!1996 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !1023, file: !897, line: 1468, baseType: !945, size: 32, align: 32, offset: 8960)
...
!2000 = !DIDerivedType(tag: DW_TAG_member, name: "keylen", scope: !1023, file: !897, line: 1514, baseType: !945, size: 32, align: 32, offset: 9216)
...
!2008 = !DIDerivedType(tag: DW_TAG_member, name: "id", scope: !2006, file: !897, line: 1260, baseType: !945, size: 32, align: 32)
!2009 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !2006, file: !897, line: 1261, baseType: !945, size: 32, align: 32, offset: 32)
...
!2015 = !DIDerivedType(tag: DW_TAG_member, name: "program_num", scope: !2006, file: !897, line: 1267, baseType: !945, size: 32, align: 32, offset: 320)
!2016 = !DIDerivedType(tag: DW_TAG_member, name: "pmt_pid", scope: !2006, file: !897, line: 1268, baseType: !945, size: 32, align: 32, offset: 352)
!2017 = !DIDerivedType(tag: DW_TAG_member, name: "pcr_pid", scope: !2006, file: !897, line: 1269, baseType: !945, size: 32, align: 32, offset: 384)
!2018 = !DIDerivedType(tag: DW_TAG_member, name: "pmt_version", scope: !2006, file: !897, line: 1270, baseType: !945, size: 32, align: 32, offset: 416)
...
!2022 = !DIDerivedType(tag: DW_TAG_member, name: "pts_wrap_behavior", scope: !2006, file: !897, line: 1283, baseType: !945, size: 32, align: 32, offset: 640)
...
!2035 = !DIDerivedType(tag: DW_TAG_member, name: "id", scope: !2033, file: !897, line: 1295, baseType: !945, size: 32, align: 32)
...
!2042 = !DIDerivedType(tag: DW_TAG_member, name: "fps_probe_size", scope: !1023, file: !897, line: 1597, baseType: !945, size: 32, align: 32, offset: 9728)
!2043 = !DIDerivedType(tag: DW_TAG_member, name: "error_recognition", scope: !1023, file: !897, line: 1604, baseType: !945, size: 32, align: 32, offset: 9760)
...
!2050 = !DIDerivedType(tag: DW_TAG_member, name: "debug", scope: !1023, file: !897, line: 1620, baseType: !945, size: 32, align: 32, offset: 9920)
...
!2052 = !DIDerivedType(tag: DW_TAG_member, name: "strict_std_compliance", scope: !1023, file: !897, line: 1645, baseType: !945, size: 32, align: 32, offset: 10048)
!2053 = !DIDerivedType(tag: DW_TAG_member, name: "event_flags", scope: !1023, file: !897, line: 1652, baseType: !945, size: 32, align: 32, offset: 10080)
!2054 = !DIDerivedType(tag: DW_TAG_member, name: "max_ts_probe", scope: !1023, file: !897, line: 1659, baseType: !945, size: 32, align: 32, offset: 10112)
!2055 = !DIDerivedType(tag: DW_TAG_member, name: "avoid_negative_ts", scope: !1023, file: !897, line: 1668, baseType: !945, size: 32, align: 32, offset: 10144)
!2056 = !DIDerivedType(tag: DW_TAG_member, name: "ts_id", scope: !1023, file: !897, line: 1677, baseType: !945, size: 32, align: 32, offset: 10176)
!2057 = !DIDerivedType(tag: DW_TAG_member, name: "audio_preload", scope: !1023, file: !897, line: 1685, baseType: !945, size: 32, align: 32, offset: 10208)
!2058 = !DIDerivedType(tag: DW_TAG_member, name: "max_chunk_duration", scope: !1023, file: !897, line: 1693, baseType: !945, size: 32, align: 32, offset: 10240)
!2059 = !DIDerivedType(tag: DW_TAG_member, name: "max_chunk_size", scope: !1023, file: !897, line: 1701, baseType: !945, size: 32, align: 32, offset: 10272)
!2060 = !DIDerivedType(tag: DW_TAG_member, name: "use_wallclock_as_timestamps", scope: !1023, file: !897, line: 1709, baseType: !945, size: 32, align: 32, offset: 10304)
!2061 = !DIDerivedType(tag: DW_TAG_member, name: "avio_flags", scope: !1023, file: !897, line: 1716, baseType: !945, size: 32, align: 32, offset: 10336)
...
!2065 = !DIDerivedType(tag: DW_TAG_member, name: "seek2any", scope: !1023, file: !897, line: 1745, baseType: !945, size: 32, align: 32, offset: 10528)
!2066 = !DIDerivedType(tag: DW_TAG_member, name: "flush_packets", scope: !1023, file: !897, line: 1752, baseType: !945, size: 32, align: 32, offset: 10560)
!2067 = !DIDerivedType(tag: DW_TAG_member, name: "probe_score", scope: !1023, file: !897, line: 1761, baseType: !945, size: 32, align: 32, offset: 10592)
!2068 = !DIDerivedType(tag: DW_TAG_member, name: "format_probesize", scope: !1023, file: !897, line: 1768, baseType: !945, size: 32, align: 32, offset: 10624)
...
!2076 = !DIDerivedType(tag: DW_TAG_member, name: "nb_interleaved_streams", scope: !2074, file: !953, line: 71, baseType: !945, size: 32, align: 32)
...
!2084 = !DIDerivedType(tag: DW_TAG_member, name: "raw_packet_buffer_remaining_size", scope: !2074, file: !953, line: 101, baseType: !945, size: 32, align: 32, offset: 512)
...
!2087 = !DIDerivedType(tag: DW_TAG_member, name: "missing_ts_warning", scope: !2074, file: !953, line: 116, baseType: !945, size: 32, align: 32, offset: 704)
!2088 = !DIDerivedType(tag: DW_TAG_member, name: "inject_global_side_data", scope: !2074, file: !953, line: 119, baseType: !945, size: 32, align: 32, offset: 736)
!2089 = !DIDerivedType(tag: DW_TAG_member, name: "avoid_negative_ts_use_pts", scope: !2074, file: !953, line: 121, baseType: !945, size: 32, align: 32, offset: 768)
...
!2091 = !DIDerivedType(tag: DW_TAG_member, name: "initialized", scope: !2074, file: !953, line: 131, baseType: !945, size: 32, align: 32, offset: 896)
!2092 = !DIDerivedType(tag: DW_TAG_member, name: "streams_initialized", scope: !2074, file: !953, line: 136, baseType: !945, size: 32, align: 32, offset: 928)
...
!2094 = !DIDerivedType(tag: DW_TAG_member, name: "prefer_codec_framerate", scope: !2074, file: !953, line: 146, baseType: !945, size: 32, align: 32, offset: 1024)
!2095 = !DIDerivedType(tag: DW_TAG_member, name: "io_repositioned", scope: !1023, file: !897, line: 1798, baseType: !945, size: 32, align: 32, offset: 10880)
...
!2102 = !DIDerivedType(tag: DW_TAG_member, name: "metadata_header_padding", scope: !1023, file: !897, line: 1837, baseType: !945, size: 32, align: 32, offset: 11200)
...
!2112 = !{!945, !1022, !2113, !940, !945, !2114, !2116}
...
!2121 = !{!945, !1022, !2113, !940, !945, !2116}
...
!2127 = !DIDerivedType(tag: DW_TAG_member, name: "max_streams", scope: !1023, file: !897, line: 1939, baseType: !945, size: 32, align: 32, offset: 11904)
!2128 = !DIDerivedType(tag: DW_TAG_member, name: "skip_estimate_duration_from_pts", scope: !1023, file: !897, line: 1946, baseType: !945, size: 32, align: 32, offset: 11936)
!2129 = !DIDerivedType(tag: DW_TAG_member, name: "read_packet", scope: !937, file: !897, line: 714, baseType: !1045, size: 64, align: 64, offset: 704)
!2130 = !DIDerivedType(tag: DW_TAG_member, name: "read_close", scope: !937, file: !897, line: 720, baseType: !1019, size: 64, align: 64, offset: 768)
!2131 = !DIDerivedType(tag: DW_TAG_member, name: "read_seek", scope: !937, file: !897, line: 730, baseType: !2132, size: 64, align: 64, offset: 832)
!2132 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2133, size: 64, align: 64)
!2133 = !DISubroutineType(types: !2134)
!2134 = !{!945, !1022, !945, !1067, !945}
!2135 = !DIDerivedType(tag: DW_TAG_member, name: "read_timestamp", scope: !937, file: !897, line: 737, baseType: !2136, size: 64, align: 64, offset: 896)
!2136 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2137, size: 64, align: 64)
!2137 = !DISubroutineType(types: !2138)
!2138 = !{!1067, !1022, !945, !1099, !1067}
!2139 = !DIDerivedType(tag: DW_TAG_member, name: "read_play", scope: !937, file: !897, line: 744, baseType: !1019, size: 64, align: 64, offset: 960)
!2140 = !DIDerivedType(tag: DW_TAG_member, name: "read_pause", scope: !937, file: !897, line: 750, baseType: !1019, size: 64, align: 64, offset: 1024)
!2141 = !DIDerivedType(tag: DW_TAG_member, name: "read_seek2", scope: !937, file: !897, line: 758, baseType: !2142, size: 64, align: 64, offset: 1088)
!2142 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2143, size: 64, align: 64)
!2143 = !DISubroutineType(types: !2144)
!2144 = !{!945, !1022, !945, !1067, !1067, !1067, !945}
!2145 = !DIDerivedType(tag: DW_TAG_member, name: "get_device_list", scope: !937, file: !897, line: 764, baseType: !1203, size: 64, align: 64, offset: 1152)
!2146 = !DIDerivedType(tag: DW_TAG_member, name: "create_device_capabilities", scope: !937, file: !897, line: 770, baseType: !1209, size: 64, align: 64, offset: 1216)
!2147 = !DIDerivedType(tag: DW_TAG_member, name: "free_device_capabilities", scope: !937, file: !897, line: 776, baseType: !1209, size: 64, align: 64, offset: 1280)
!2148 = !{i32 2, !"Dwarf Version", i32 4}
!2149 = !{i32 2, !"Debug Info Version", i32 3}
!2150 = !{!"clang version 3.9.0 (tags/RELEASE_390/final)"}
!2151 = distinct !DISubprogram(name: "nc_probe", scope: !935, file: !935, line: 29, type: !1006, isLocal: true, isDefinition: true, scopeLine: 30, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2152 = !{}
...
!2160 = distinct !DILocation(line: 41, column: 9, scope: !2161)
!2161 = distinct !DILexicalBlock(scope: !2151, file: !935, line: 41, column: 9)
!2162 = !DILocation(line: 66, column: 98, scope: !2154, inlinedAt: !2163)
!2163 = distinct !DILocation(line: 33, column: 9, scope: !2164)
!2164 = distinct !DILexicalBlock(scope: !2151, file: !935, line: 33, column: 9)
!2165 = !DILocalVariable(name: "probe_packet", arg: 1, scope: !2151, file: !935, line: 29, type: !1008)
!2166 = !DILocation(line: 29, column: 34, scope: !2151)
!2167 = !DILocalVariable(name: "size", scope: !2151, file: !935, line: 31, type: !945)
!2168 = !DILocation(line: 31, column: 9, scope: !2151)
!2169 = !DILocation(line: 33, column: 52, scope: !2164)
!2170 = !DILocation(line: 33, column: 66, scope: !2164)
!2171 = !DILocation(line: 33, column: 73, scope: !2164)
!2172 = !DILocation(line: 33, column: 9, scope: !2164)
!2173 = !DILocation(line: 68, column: 16, scope: !2154, inlinedAt: !2163)
!2174 = !DILocation(line: 68, column: 19, scope: !2154, inlinedAt: !2163)
!2175 = !DILocation(line: 68, column: 24, scope: !2154, inlinedAt: !2163)
!2176 = !DILocation(line: 68, column: 38, scope: !2154, inlinedAt: !2163)
!2177 = !DILocation(line: 68, column: 41, scope: !2154, inlinedAt: !2163)
!2178 = !DILocation(line: 68, column: 46, scope: !2154, inlinedAt: !2163)
!2179 = !DILocation(line: 68, column: 34, scope: !2154, inlinedAt: !2163)
!2180 = !DILocation(line: 68, column: 57, scope: !2154, inlinedAt: !2163)
!2181 = !DILocation(line: 68, column: 69, scope: !2154, inlinedAt: !2163)
!2182 = !DILocation(line: 68, column: 72, scope: !2154, inlinedAt: !2163)
!2183 = !DILocation(line: 68, column: 79, scope: !2154, inlinedAt: !2163)
!2184 = !DILocation(line: 68, column: 84, scope: !2154, inlinedAt: !2163)
!2185 = !DILocation(line: 68, column: 99, scope: !2154, inlinedAt: !2163)
!2186 = !DILocation(line: 68, column: 102, scope: !2154, inlinedAt: !2163)
!2187 = !DILocation(line: 68, column: 109, scope: !2154, inlinedAt: !2163)
!2188 = !DILocation(line: 68, column: 114, scope: !2154, inlinedAt: !2163)
!2189 = !DILocation(line: 68, column: 94, scope: !2154, inlinedAt: !2163)
!2190 = !DILocation(line: 68, column: 63, scope: !2154, inlinedAt: !2163)
!2191 = !DILocation(line: 33, column: 77, scope: !2164)
!2192 = !DILocation(line: 33, column: 9, scope: !2151)
!2193 = !DILocation(line: 34, column: 9, scope: !2164)
!2194 = !DILocation(line: 36, column: 44, scope: !2151)
!2195 = !DILocation(line: 36, column: 58, scope: !2151)
!2196 = !DILocation(line: 36, column: 62, scope: !2151)
!2197 = !DILocation(line: 36, column: 69, scope: !2151)
!2198 = !DILocation(line: 36, column: 12, scope: !2151)
!2199 = !DILocation(line: 36, column: 10, scope: !2151)
!2200 = !DILocation(line: 38, column: 9, scope: !2201)
!2201 = distinct !DILexicalBlock(scope: !2151, file: !935, line: 38, column: 9)
!2202 = !DILocation(line: 38, column: 14, scope: !2201)
!2203 = !DILocation(line: 38, column: 21, scope: !2201)
!2204 = !DILocation(line: 38, column: 35, scope: !2201)
!2205 = !DILocation(line: 38, column: 19, scope: !2201)
!2206 = !DILocation(line: 38, column: 9, scope: !2151)
!2207 = !DILocation(line: 39, column: 9, scope: !2201)
!2208 = !DILocation(line: 41, column: 52, scope: !2161)
!2209 = !DILocation(line: 41, column: 66, scope: !2161)
!2210 = !DILocation(line: 41, column: 69, scope: !2161)
!2211 = !DILocation(line: 41, column: 73, scope: !2161)
!2212 = !DILocation(line: 41, column: 72, scope: !2161)
!2213 = !DILocation(line: 41, column: 81, scope: !2161)
!2214 = !DILocation(line: 41, column: 9, scope: !2161)
!2215 = !DILocation(line: 68, column: 16, scope: !2154, inlinedAt: !2160)
!2216 = !DILocation(line: 68, column: 19, scope: !2154, inlinedAt: !2160)
!2217 = !DILocation(line: 68, column: 24, scope: !2154, inlinedAt: !2160)
!2218 = !DILocation(line: 68, column: 38, scope: !2154, inlinedAt: !2160)
!2219 = !DILocation(line: 68, column: 41, scope: !2154, inlinedAt: !2160)
!2220 = !DILocation(line: 68, column: 46, scope: !2154, inlinedAt: !2160)
!2221 = !DILocation(line: 68, column: 34, scope: !2154, inlinedAt: !2160)
!2222 = !DILocation(line: 68, column: 57, scope: !2154, inlinedAt: !2160)
!2223 = !DILocation(line: 68, column: 69, scope: !2154, inlinedAt: !2160)
!2224 = !DILocation(line: 68, column: 72, scope: !2154, inlinedAt: !2160)
!2225 = !DILocation(line: 68, column: 79, scope: !2154, inlinedAt: !2160)
!2226 = !DILocation(line: 68, column: 84, scope: !2154, inlinedAt: !2160)
!2227 = !DILocation(line: 68, column: 99, scope: !2154, inlinedAt: !2160)
!2228 = !DILocation(line: 68, column: 102, scope: !2154, inlinedAt: !2160)
!2229 = !DILocation(line: 68, column: 109, scope: !2154, inlinedAt: !2160)
!2230 = !DILocation(line: 68, column: 114, scope: !2154, inlinedAt: !2160)
!2231 = !DILocation(line: 68, column: 94, scope: !2154, inlinedAt: !2160)
!2232 = !DILocation(line: 68, column: 63, scope: !2154, inlinedAt: !2160)
!2233 = !DILocation(line: 41, column: 85, scope: !2161)
!2234 = !DILocation(line: 41, column: 9, scope: !2151)
!2235 = !DILocation(line: 42, column: 9, scope: !2161)
!2236 = !DILocation(line: 44, column: 5, scope: !2151)
!2237 = !DILocation(line: 45, column: 1, scope: !2151)
!2238 = distinct !DISubprogram(name: "nc_read_header", scope: !935, file: !935, line: 47, type: !2239, isLocal: true, isDefinition: true, scopeLine: 48, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2239 = !DISubroutineType(types: !2240)
!2240 = !{!945, !2241}
!2241 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2242, size: 64, align: 64)
!2242 = !DIDerivedType(tag: DW_TAG_typedef, name: "AVFormatContext", file: !897, line: 1947, baseType: !1023)
!2243 = !DILocalVariable(name: "s", arg: 1, scope: !2238, file: !935, line: 47, type: !2241)
!2244 = !DILocation(line: 47, column: 44, scope: !2238)
!2245 = !DILocalVariable(name: "st", scope: !2238, file: !935, line: 49, type: !1297)
!2246 = !DILocation(line: 49, column: 15, scope: !2238)
!2247 = !DILocation(line: 49, column: 40, scope: !2238)
!2248 = !DILocation(line: 49, column: 20, scope: !2238)
!2249 = !DILocation(line: 51, column: 10, scope: !2250)
!2250 = distinct !DILexicalBlock(scope: !2238, file: !935, line: 51, column: 9)
!2251 = !DILocation(line: 51, column: 9, scope: !2238)
!2252 = !DILocation(line: 52, column: 9, scope: !2250)
!2253 = !DILocation(line: 54, column: 5, scope: !2238)
!2254 = !DILocation(line: 54, column: 9, scope: !2238)
!2255 = !DILocation(line: 54, column: 19, scope: !2238)
!2256 = !DILocation(line: 54, column: 30, scope: !2238)
!2257 = !DILocation(line: 55, column: 5, scope: !2238)
!2258 = !DILocation(line: 55, column: 9, scope: !2238)
!2259 = !DILocation(line: 55, column: 19, scope: !2238)
!2260 = !DILocation(line: 55, column: 28, scope: !2238)
!2261 = !DILocation(line: 56, column: 5, scope: !2238)
!2262 = !DILocation(line: 56, column: 9, scope: !2238)
!2263 = !DILocation(line: 56, column: 22, scope: !2238)
!2264 = !DILocation(line: 58, column: 25, scope: !2238)
!2265 = !DILocation(line: 58, column: 5, scope: !2238)
!2266 = !DILocation(line: 60, column: 5, scope: !2238)
!2267 = !DILocation(line: 61, column: 1, scope: !2238)
!2268 = distinct !DISubprogram(name: "nc_read_packet", scope: !935, file: !935, line: 63, type: !2269, isLocal: true, isDefinition: true, scopeLine: 64, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2152)
!2269 = !DISubroutineType(types: !2270)
!2270 = !{!945, !2241, !1048}
!2271 = !DILocalVariable(name: "s", arg: 1, scope: !2268, file: !935, line: 63, type: !2241)
!2272 = !DILocation(line: 63, column: 44, scope: !2268)
!2273 = !DILocalVariable(name: "pkt", arg: 2, scope: !2268, file: !935, line: 63, type: !1048)
!2274 = !DILocation(line: 63, column: 57, scope: !2268)
!2275 = !DILocalVariable(name: "size", scope: !2268, file: !935, line: 65, type: !945)
!2276 = !DILocation(line: 65, column: 9, scope: !2268)
!2277 = !DILocalVariable(name: "ret", scope: !2268, file: !935, line: 66, type: !945)
!2278 = !DILocation(line: 66, column: 9, scope: !2268)
!2279 = !DILocalVariable(name: "state", scope: !2268, file: !935, line: 68, type: !923)
!2280 = !DILocation(line: 68, column: 14, scope: !2268)
!2281 = !DILocation(line: 69, column: 5, scope: !2268)
!2282 = !DILocation(line: 69, column: 12, scope: !2283)
!2283 = !DILexicalBlockFile(scope: !2268, file: !935, discriminator: 1)
!2284 = !DILocation(line: 69, column: 18, scope: !2283)
!2285 = !DILocation(line: 69, column: 5, scope: !2283)
!2286 = !DILocation(line: 70, column: 23, scope: !2287)
!2287 = distinct !DILexicalBlock(scope: !2288, file: !935, line: 70, column: 13)
!2288 = distinct !DILexicalBlock(scope: !2268, file: !935, line: 69, column: 28)
!2289 = !DILocation(line: 70, column: 26, scope: !2287)
!2290 = !DILocation(line: 70, column: 13, scope: !2287)
!2291 = !DILocation(line: 70, column: 13, scope: !2288)
!2292 = !DILocation(line: 71, column: 13, scope: !2287)
!2293 = !DILocation(line: 72, column: 18, scope: !2288)
!2294 = !DILocation(line: 72, column: 23, scope: !2288)
!2295 = !DILocation(line: 72, column: 38, scope: !2288)
!2296 = !DILocation(line: 72, column: 41, scope: !2288)
!2297 = !DILocation(line: 72, column: 30, scope: !2288)
!2298 = !DILocation(line: 72, column: 28, scope: !2288)
!2299 = !DILocation(line: 72, column: 15, scope: !2288)
!2300 = !DILocation(line: 69, column: 5, scope: !2301)
!2301 = !DILexicalBlockFile(scope: !2268, file: !935, discriminator: 2)
!2302 = distinct !{!2302, !2281}
!2303 = !DILocation(line: 75, column: 13, scope: !2268)
!2304 = !DILocation(line: 75, column: 16, scope: !2268)
!2305 = !DILocation(line: 75, column: 5, scope: !2268)
!2306 = !DILocation(line: 76, column: 22, scope: !2268)
!2307 = !DILocation(line: 76, column: 25, scope: !2268)
!2308 = !DILocation(line: 76, column: 12, scope: !2268)
!2309 = !DILocation(line: 76, column: 10, scope: !2268)
!2310 = !DILocation(line: 77, column: 15, scope: !2268)
!2311 = !DILocation(line: 77, column: 18, scope: !2268)
!2312 = !DILocation(line: 77, column: 5, scope: !2268)
!2313 = !DILocation(line: 79, column: 9, scope: !2314)
!2314 = distinct !DILexicalBlock(scope: !2268, file: !935, line: 79, column: 9)
!2315 = !DILocation(line: 79, column: 14, scope: !2314)
!2316 = !DILocation(line: 79, column: 9, scope: !2268)
!2317 = !DILocation(line: 80, column: 16, scope: !2318)
!2318 = distinct !DILexicalBlock(scope: !2314, file: !935, line: 79, column: 20)
!2319 = !DILocation(line: 80, column: 9, scope: !2318)
!2320 = !DILocation(line: 81, column: 9, scope: !2318)
!2321 = !DILocation(line: 84, column: 25, scope: !2268)
!2322 = !DILocation(line: 84, column: 28, scope: !2268)
!2323 = !DILocation(line: 84, column: 32, scope: !2268)
!2324 = !DILocation(line: 84, column: 37, scope: !2268)
!2325 = !DILocation(line: 84, column: 11, scope: !2268)
!2326 = !DILocation(line: 84, column: 9, scope: !2268)
!2327 = !DILocation(line: 85, column: 9, scope: !2328)
!2328 = distinct !DILexicalBlock(scope: !2268, file: !935, line: 85, column: 9)
!2329 = !DILocation(line: 85, column: 16, scope: !2328)
!2330 = !DILocation(line: 85, column: 13, scope: !2328)
!2331 = !DILocation(line: 85, column: 9, scope: !2268)
!2332 = !DILocation(line: 86, column: 13, scope: !2333)
!2333 = distinct !DILexicalBlock(scope: !2334, file: !935, line: 86, column: 13)
!2334 = distinct !DILexicalBlock(scope: !2328, file: !935, line: 85, column: 22)
!2335 = !DILocation(line: 86, column: 17, scope: !2333)
!2336 = !DILocation(line: 86, column: 13, scope: !2334)
!2337 = !DILocation(line: 86, column: 38, scope: !2338)
!2338 = !DILexicalBlockFile(scope: !2333, file: !935, discriminator: 1)
!2339 = !DILocation(line: 86, column: 22, scope: !2338)
!2340 = !DILocation(line: 87, column: 9, scope: !2334)
!2341 = !DILocation(line: 90, column: 5, scope: !2268)
!2342 = !DILocation(line: 90, column: 10, scope: !2268)
!2343 = !DILocation(line: 90, column: 23, scope: !2268)
!2344 = !DILocation(line: 91, column: 12, scope: !2268)
!2345 = !DILocation(line: 91, column: 5, scope: !2268)
!2346 = !DILocation(line: 92, column: 1, scope: !2268)
