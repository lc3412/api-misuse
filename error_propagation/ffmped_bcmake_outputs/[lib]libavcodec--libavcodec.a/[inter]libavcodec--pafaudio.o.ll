; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a/[inter]libavcodec--pafaudio.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a/[inter]libavcodec--pafaudio.o.i"
...
@ff_paf_audio_decoder = global %struct.AVCodec { i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.1, i32 0, i32 0), i32 1, i32 86080, i32 2, %struct.AVRational* null, i32* null, i32* null, i32* null, i64* null, i8 0, %struct.AVClass* null, %struct.AVProfile* null, i8* null, i32 0, %struct.AVCodec* null, i32 (%struct.AVCodecContext*)* null, i32 (%struct.AVCodecContext*, %struct.AVCodecContext*)* null, %struct.AVCodecDefault* null, void (%struct.AVCodec*)* null, i32 (%struct.AVCodecContext*)* @paf_audio_init, i32 (%struct.AVCodecContext*, i8*, i32, %struct.AVSubtitle*)* null, i32 (%struct.AVCodecContext*, %struct.AVPacket*, %struct.AVFrame*, i32*)* null, i32 (%struct.AVCodecContext*, i8*, i32*, %struct.AVPacket*)* @paf_audio_decode, i32 (%struct.AVCodecContext*)* null, i32 (%struct.AVCodecContext*, %struct.AVFrame*)* null, i32 (%struct.AVCodecContext*, %struct.AVPacket*)* null, i32 (%struct.AVCodecContext*, %struct.AVFrame*)* null, void (%struct.AVCodecContext*)* null, i32 0, i8* null, %struct.AVCodecHWConfigInternal** null }, align 8
@.str.2 = private unnamed_addr constant [28 x i8] c"invalid number of channels\0A\00", align 1

; Function Attrs: cold nounwind optsize uwtable
define internal i32 @paf_audio_init(%struct.AVCodecContext* %avctx) #0 !dbg !1636 {
entry:
  ...
  %channels = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %0, i32 0, i32 83, !dbg !1643
  %1 = load i32, i32* %channels, align 4, !dbg !1643
  %cmp = icmp ne i32 %1, 2, !dbg !1644
  br i1 %cmp, label %if.then, label %if.end, !dbg !1645

if.then:                                          ; preds = %entry
  %2 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1646
  %3 = bitcast %struct.AVCodecContext* %2 to i8*, !dbg !1646
  call void (i8*, i32, i8*, ...) @av_log(i8* %3, i32 16, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.2, i32 0, i32 0)), !dbg !1648
  store i32 -1094995529, i32* %retval, align 4, !dbg !1649
  br label %return, !dbg !1649

if.end:                                           ; preds = %entry
  %4 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1650
  %channel_layout = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %4, i32 0, i32 89, !dbg !1651
  store i64 3, i64* %channel_layout, align 8, !dbg !1652
  %5 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1653
  %sample_fmt = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %5, i32 0, i32 84, !dbg !1654
  store i32 1, i32* %sample_fmt, align 8, !dbg !1655
  store i32 0, i32* %retval, align 4, !dbg !1656
  br label %return, !dbg !1656

return:                                           ; preds = %if.end, %if.then
  %6 = load i32, i32* %retval, align 4, !dbg !1657
  ret i32 %6, !dbg !1657
}

; Function Attrs: nounwind uwtable
define internal i32 @paf_audio_decode(%struct.AVCodecContext* %avctx, i8* %data, i32* %got_frame, %struct.AVPacket* %pkt) #1 !dbg !1658 {
entry:
  %retval = alloca i32, align 4
  %avctx.addr = alloca %struct.AVCodecContext*, align 8
  ...
  %cb = alloca [256 x i16], align 16
  store %struct.AVCodecContext* %avctx, %struct.AVCodecContext** %avctx.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVCodecContext** %avctx.addr, metadata !1659, metadata !1639), !dbg !1660
  store i8* %data, i8** %data.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %data.addr, metadata !1661, metadata !1639), !dbg !1662
  store i32* %got_frame, i32** %got_frame.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %got_frame.addr, metadata !1663, metadata !1639), !dbg !1664
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !1665, metadata !1639), !dbg !1666
  call void @llvm.dbg.declare(metadata %struct.AVFrame** %frame, metadata !1667, metadata !1639), !dbg !1668
  %0 = load i8*, i8** %data.addr, align 8, !dbg !1669
  %1 = bitcast i8* %0 to %struct.AVFrame*, !dbg !1669
  store %struct.AVFrame* %1, %struct.AVFrame** %frame, align 8, !dbg !1668
  call void @llvm.dbg.declare(metadata i16** %output_samples, metadata !1670, metadata !1639), !dbg !1671
  call void @llvm.dbg.declare(metadata i8** %src, metadata !1672, metadata !1639), !dbg !1673
  %2 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !1674
  %data1 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %2, i32 0, i32 3, !dbg !1675
  %3 = load i8*, i8** %data1, align 8, !dbg !1675
  store i8* %3, i8** %src, align 8, !dbg !1673
  call void @llvm.dbg.declare(metadata i32* %frames, metadata !1676, metadata !1639), !dbg !1677
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !1678, metadata !1639), !dbg !1679
  call void @llvm.dbg.declare(metadata i32* %i, metadata !1680, metadata !1639), !dbg !1681
  call void @llvm.dbg.declare(metadata i32* %j, metadata !1682, metadata !1639), !dbg !1683
  call void @llvm.dbg.declare(metadata [256 x i16]* %cb, metadata !1684, metadata !1639), !dbg !1688
  %4 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !1689
  %size = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %4, i32 0, i32 4, !dbg !1690
  %5 = load i32, i32* %size, align 8, !dbg !1690
  %div = sdiv i32 %5, 4922, !dbg !1691
  store i32 %div, i32* %frames, align 4, !dbg !1692
  %6 = load i32, i32* %frames, align 4, !dbg !1693
  %cmp = icmp slt i32 %6, 1, !dbg !1695
...
if.end:                                           ; preds = %entry
  %7 = load i32, i32* %frames, align 4, !dbg !1698
  %mul = mul nsw i32 2205, %7, !dbg !1699
  %8 = load %struct.AVFrame*, %struct.AVFrame** %frame, align 8, !dbg !1700
  %nb_samples = getelementptr inbounds %struct.AVFrame, %struct.AVFrame* %8, i32 0, i32 5, !dbg !1701
  store i32 %mul, i32* %nb_samples, align 8, !dbg !1702
  %9 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1703
  %10 = load %struct.AVFrame*, %struct.AVFrame** %frame, align 8, !dbg !1705
  %call = call i32 @ff_get_buffer(%struct.AVCodecContext* %9, %struct.AVFrame* %10, i32 0), !dbg !1706
  store i32 %call, i32* %ret, align 4, !dbg !1707
  %cmp2 = icmp slt i32 %call, 0, !dbg !1708
  br i1 %cmp2, label %if.then3, label %if.end4, !dbg !1709

if.then3:                                         ; preds = %if.end
  %11 = load i32, i32* %ret, align 4, !dbg !1710
  store i32 %11, i32* %retval, align 4, !dbg !1711
  br label %return, !dbg !1711

if.end4:                                          ; preds = %if.end
  %12 = load %struct.AVFrame*, %struct.AVFrame** %frame, align 8, !dbg !1712
  %data5 = getelementptr inbounds %struct.AVFrame, %struct.AVFrame* %12, i32 0, i32 0, !dbg !1713
  %arrayidx = getelementptr inbounds [8 x i8*], [8 x i8*]* %data5, i64 0, i64 0, !dbg !1712
  %13 = load i8*, i8** %arrayidx, align 8, !dbg !1712
  %14 = bitcast i8* %13 to i16*, !dbg !1714
  store i16* %14, i16** %output_samples, align 8, !dbg !1715
  store i32 0, i32* %j, align 4, !dbg !1716
  br label %for.cond, !dbg !1718

for.cond:                                         ; preds = %for.inc25, %if.end4
  %15 = load i32, i32* %j, align 4, !dbg !1719
  %16 = load i32, i32* %frames, align 4, !dbg !1722
  %cmp6 = icmp slt i32 %15, %16, !dbg !1723
  br i1 %cmp6, label %for.body, label %for.end27, !dbg !1724

for.body:                                         ; preds = %for.cond
  store i32 0, i32* %i, align 4, !dbg !1725
  br label %for.cond7, !dbg !1728

for.cond7:                                        ; preds = %for.inc, %for.body
  %17 = load i32, i32* %i, align 4, !dbg !1729
  %cmp8 = icmp slt i32 %17, 256, !dbg !1732
  br i1 %cmp8, label %for.body9, label %for.end, !dbg !1733

for.body9:                                        ; preds = %for.cond7
  %18 = load i8*, i8** %src, align 8, !dbg !1734
  %19 = load i32, i32* %i, align 4, !dbg !1735
  %mul10 = mul nsw i32 %19, 2, !dbg !1736
  %idx.ext = sext i32 %mul10 to i64, !dbg !1737
  %add.ptr = getelementptr inbounds i8, i8* %18, i64 %idx.ext, !dbg !1737
  %20 = bitcast i8* %add.ptr to %union.unaligned_16*, !dbg !1738
  %l = bitcast %union.unaligned_16* %20 to i16*, !dbg !1738
  %21 = load i16, i16* %l, align 1, !dbg !1738
  %conv = zext i16 %21 to i32, !dbg !1739
  %call11 = call i32 @sign_extend(i32 %conv, i32 16) #2, !dbg !1740
  %conv12 = trunc i32 %call11 to i16, !dbg !1740
  %22 = load i32, i32* %i, align 4, !dbg !1741
  %idxprom = sext i32 %22 to i64, !dbg !1742
  %arrayidx13 = getelementptr inbounds [256 x i16], [256 x i16]* %cb, i64 0, i64 %idxprom, !dbg !1742
  store i16 %conv12, i16* %arrayidx13, align 2, !dbg !1743
  br label %for.inc, !dbg !1742

for.inc:                                          ; preds = %for.body9
  %23 = load i32, i32* %i, align 4, !dbg !1744
  %inc = add nsw i32 %23, 1, !dbg !1744
  store i32 %inc, i32* %i, align 4, !dbg !1744
  br label %for.cond7, !dbg !1746, !llvm.loop !1747

for.end:                                          ; preds = %for.cond7
  %24 = load i8*, i8** %src, align 8, !dbg !1749
  %add.ptr14 = getelementptr inbounds i8, i8* %24, i64 512, !dbg !1749
  store i8* %add.ptr14, i8** %src, align 8, !dbg !1749
  store i32 0, i32* %i, align 4, !dbg !1750
  br label %for.cond15, !dbg !1752

for.cond15:                                       ; preds = %for.inc22, %for.end
  %25 = load i32, i32* %i, align 4, !dbg !1753
  %cmp16 = icmp slt i32 %25, 4410, !dbg !1756
  br i1 %cmp16, label %for.body18, label %for.end24, !dbg !1757

for.body18:                                       ; preds = %for.cond15
  %26 = load i8*, i8** %src, align 8, !dbg !1758
  %incdec.ptr = getelementptr inbounds i8, i8* %26, i32 1, !dbg !1758
  store i8* %incdec.ptr, i8** %src, align 8, !dbg !1758
  %27 = load i8, i8* %26, align 1, !dbg !1759
  %idxprom19 = zext i8 %27 to i64, !dbg !1760
  %arrayidx20 = getelementptr inbounds [256 x i16], [256 x i16]* %cb, i64 0, i64 %idxprom19, !dbg !1760
  %28 = load i16, i16* %arrayidx20, align 2, !dbg !1760
  %29 = load i16*, i16** %output_samples, align 8, !dbg !1761
  %incdec.ptr21 = getelementptr inbounds i16, i16* %29, i32 1, !dbg !1761
  store i16* %incdec.ptr21, i16** %output_samples, align 8, !dbg !1761
  store i16 %28, i16* %29, align 2, !dbg !1762
  br label %for.inc22, !dbg !1763

for.inc22:                                        ; preds = %for.body18
  %30 = load i32, i32* %i, align 4, !dbg !1764
  %inc23 = add nsw i32 %30, 1, !dbg !1764
  store i32 %inc23, i32* %i, align 4, !dbg !1764
  br label %for.cond15, !dbg !1766, !llvm.loop !1767

for.end24:                                        ; preds = %for.cond15
  br label %for.inc25, !dbg !1769

for.inc25:                                        ; preds = %for.end24
  %31 = load i32, i32* %j, align 4, !dbg !1770
  %inc26 = add nsw i32 %31, 1, !dbg !1770
  store i32 %inc26, i32* %j, align 4, !dbg !1770
  br label %for.cond, !dbg !1772, !llvm.loop !1773

for.end27:                                        ; preds = %for.cond
  %32 = load i32*, i32** %got_frame.addr, align 8, !dbg !1775
  store i32 1, i32* %32, align 4, !dbg !1776
  %33 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !1777
  %size28 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %33, i32 0, i32 4, !dbg !1778
  %34 = load i32, i32* %size28, align 8, !dbg !1778
  store i32 %34, i32* %retval, align 4, !dbg !1779
  br label %return, !dbg !1779

return:                                           ; preds = %for.end27, %if.then3, %if.then
  %35 = load i32, i32* %retval, align 4, !dbg !1780
  ret i32 %35, !dbg !1780
}
...
define internal i32 @sign_extend(i32 %val, i32 %bits) #4 !dbg !1781 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %val.addr, metadata !1785, metadata !1639), !dbg !1786
  store i32 %bits, i32* %bits.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %bits.addr, metadata !1787, metadata !1639), !dbg !1788
  call void @llvm.dbg.declare(metadata i32* %shift, metadata !1789, metadata !1639), !dbg !1790
  %0 = load i32, i32* %bits.addr, align 4, !dbg !1791
  %conv = zext i32 %0 to i64, !dbg !1791
  %sub = sub i64 32, %conv, !dbg !1792
  %conv1 = trunc i64 %sub to i32, !dbg !1793
  store i32 %conv1, i32* %shift, align 4, !dbg !1790
  call void @llvm.dbg.declare(metadata %union.anon* %v, metadata !1794, metadata !1639), !dbg !1799
  %u = bitcast %union.anon* %v to i32*, !dbg !1800
  %1 = load i32, i32* %val.addr, align 4, !dbg !1801
  %2 = load i32, i32* %shift, align 4, !dbg !1802
  %shl = shl i32 %1, %2, !dbg !1803
  store i32 %shl, i32* %u, align 4, !dbg !1800
  %s = bitcast %union.anon* %v to i32*, !dbg !1804
  %3 = load i32, i32* %s, align 4, !dbg !1804
  %4 = load i32, i32* %shift, align 4, !dbg !1805
  %shr = ashr i32 %3, %4, !dbg !1806
  ret i32 %shr, !dbg !1807
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a/[inter]libavcodec--pafaudio.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a")
...
!902 = !{!903}
!903 = distinct !DIGlobalVariable(name: "ff_paf_audio_decoder", scope: !0, file: !904, line: 74, type: !905, isLocal: false, isDefinition: true, variable: %struct.AVCodec* @ff_paf_audio_decoder)
!904 = !DIFile(filename: "libavcodec/pafaudio.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a")
...
!1636 = distinct !DISubprogram(name: "paf_audio_init", scope: !904, file: !904, line: 29, type: !998, isLocal: true, isDefinition: true, scopeLine: 30, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1637)
!1637 = !{}
!1638 = !DILocalVariable(name: "avctx", arg: 1, scope: !1636, file: !904, line: 29, type: !1000)
!1639 = !DIExpression()
!1640 = !DILocation(line: 29, column: 65, scope: !1636)
!1641 = !DILocation(line: 31, column: 9, scope: !1642)
!1642 = distinct !DILexicalBlock(scope: !1636, file: !904, line: 31, column: 9)
!1643 = !DILocation(line: 31, column: 16, scope: !1642)
!1644 = !DILocation(line: 31, column: 25, scope: !1642)
!1645 = !DILocation(line: 31, column: 9, scope: !1636)
!1646 = !DILocation(line: 32, column: 16, scope: !1647)
!1647 = distinct !DILexicalBlock(scope: !1642, file: !904, line: 31, column: 31)
!1648 = !DILocation(line: 32, column: 9, scope: !1647)
!1649 = !DILocation(line: 33, column: 9, scope: !1647)
!1650 = !DILocation(line: 36, column: 5, scope: !1636)
!1651 = !DILocation(line: 36, column: 12, scope: !1636)
!1652 = !DILocation(line: 36, column: 27, scope: !1636)
!1653 = !DILocation(line: 37, column: 5, scope: !1636)
!1654 = !DILocation(line: 37, column: 12, scope: !1636)
!1655 = !DILocation(line: 37, column: 23, scope: !1636)
!1656 = !DILocation(line: 39, column: 5, scope: !1636)
!1657 = !DILocation(line: 40, column: 1, scope: !1636)
!1658 = distinct !DISubprogram(name: "paf_audio_decode", scope: !904, file: !904, line: 42, type: !1610, isLocal: true, isDefinition: true, scopeLine: 44, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1637)
!1659 = !DILocalVariable(name: "avctx", arg: 1, scope: !1658, file: !904, line: 42, type: !1000)
!1660 = !DILocation(line: 42, column: 45, scope: !1658)
!1661 = !DILocalVariable(name: "data", arg: 2, scope: !1658, file: !904, line: 42, type: !953)
!1662 = !DILocation(line: 42, column: 58, scope: !1658)
!1663 = !DILocalVariable(name: "got_frame", arg: 3, scope: !1658, file: !904, line: 43, type: !1295)
!1664 = !DILocation(line: 43, column: 34, scope: !1658)
!1665 = !DILocalVariable(name: "pkt", arg: 4, scope: !1658, file: !904, line: 43, type: !1148)
!1666 = !DILocation(line: 43, column: 55, scope: !1658)
!1667 = !DILocalVariable(name: "frame", scope: !1658, file: !904, line: 45, type: !1022)
!1668 = !DILocation(line: 45, column: 14, scope: !1658)
!1669 = !DILocation(line: 45, column: 22, scope: !1658)
!1670 = !DILocalVariable(name: "output_samples", scope: !1658, file: !904, line: 46, type: !890)
!1671 = !DILocation(line: 46, column: 14, scope: !1658)
!1672 = !DILocalVariable(name: "src", scope: !1658, file: !904, line: 47, type: !1444)
!1673 = !DILocation(line: 47, column: 20, scope: !1658)
!1674 = !DILocation(line: 47, column: 26, scope: !1658)
!1675 = !DILocation(line: 47, column: 31, scope: !1658)
!1676 = !DILocalVariable(name: "frames", scope: !1658, file: !904, line: 48, type: !888)
!1677 = !DILocation(line: 48, column: 9, scope: !1658)
!1678 = !DILocalVariable(name: "ret", scope: !1658, file: !904, line: 48, type: !888)
!1679 = !DILocation(line: 48, column: 17, scope: !1658)
!1680 = !DILocalVariable(name: "i", scope: !1658, file: !904, line: 48, type: !888)
!1681 = !DILocation(line: 48, column: 22, scope: !1658)
!1682 = !DILocalVariable(name: "j", scope: !1658, file: !904, line: 48, type: !888)
!1683 = !DILocation(line: 48, column: 25, scope: !1658)
!1684 = !DILocalVariable(name: "cb", scope: !1658, file: !904, line: 49, type: !1685)
!1685 = !DICompositeType(tag: DW_TAG_array_type, baseType: !891, size: 4096, align: 16, elements: !1686)
!1686 = !{!1687}
!1687 = !DISubrange(count: 256)
!1688 = !DILocation(line: 49, column: 13, scope: !1658)
!1689 = !DILocation(line: 51, column: 14, scope: !1658)
!1690 = !DILocation(line: 51, column: 19, scope: !1658)
!1691 = !DILocation(line: 51, column: 24, scope: !1658)
!1692 = !DILocation(line: 51, column: 12, scope: !1658)
!1693 = !DILocation(line: 52, column: 9, scope: !1694)
!1694 = distinct !DILexicalBlock(scope: !1658, file: !904, line: 52, column: 9)
!1695 = !DILocation(line: 52, column: 16, scope: !1694)
!1696 = !DILocation(line: 52, column: 9, scope: !1658)
!1697 = !DILocation(line: 53, column: 9, scope: !1694)
!1698 = !DILocation(line: 55, column: 32, scope: !1658)
!1699 = !DILocation(line: 55, column: 30, scope: !1658)
!1700 = !DILocation(line: 55, column: 5, scope: !1658)
!1701 = !DILocation(line: 55, column: 12, scope: !1658)
!1702 = !DILocation(line: 55, column: 23, scope: !1658)
!1703 = !DILocation(line: 56, column: 30, scope: !1704)
!1704 = distinct !DILexicalBlock(scope: !1658, file: !904, line: 56, column: 9)
!1705 = !DILocation(line: 56, column: 37, scope: !1704)
!1706 = !DILocation(line: 56, column: 16, scope: !1704)
!1707 = !DILocation(line: 56, column: 14, scope: !1704)
!1708 = !DILocation(line: 56, column: 48, scope: !1704)
!1709 = !DILocation(line: 56, column: 9, scope: !1658)
!1710 = !DILocation(line: 57, column: 16, scope: !1704)
!1711 = !DILocation(line: 57, column: 9, scope: !1704)
!1712 = !DILocation(line: 59, column: 33, scope: !1658)
!1713 = !DILocation(line: 59, column: 40, scope: !1658)
!1714 = !DILocation(line: 59, column: 22, scope: !1658)
!1715 = !DILocation(line: 59, column: 20, scope: !1658)
!1716 = !DILocation(line: 61, column: 12, scope: !1717)
!1717 = distinct !DILexicalBlock(scope: !1658, file: !904, line: 61, column: 5)
!1718 = !DILocation(line: 61, column: 10, scope: !1717)
!1719 = !DILocation(line: 61, column: 17, scope: !1720)
!1720 = !DILexicalBlockFile(scope: !1721, file: !904, discriminator: 1)
!1721 = distinct !DILexicalBlock(scope: !1717, file: !904, line: 61, column: 5)
!1722 = !DILocation(line: 61, column: 21, scope: !1720)
!1723 = !DILocation(line: 61, column: 19, scope: !1720)
!1724 = !DILocation(line: 61, column: 5, scope: !1720)
!1725 = !DILocation(line: 62, column: 16, scope: !1726)
!1726 = distinct !DILexicalBlock(scope: !1727, file: !904, line: 62, column: 9)
!1727 = distinct !DILexicalBlock(scope: !1721, file: !904, line: 61, column: 34)
!1728 = !DILocation(line: 62, column: 14, scope: !1726)
!1729 = !DILocation(line: 62, column: 21, scope: !1730)
!1730 = !DILexicalBlockFile(scope: !1731, file: !904, discriminator: 1)
!1731 = distinct !DILexicalBlock(scope: !1726, file: !904, line: 62, column: 9)
!1732 = !DILocation(line: 62, column: 23, scope: !1730)
!1733 = !DILocation(line: 62, column: 9, scope: !1730)
!1734 = !DILocation(line: 63, column: 65, scope: !1731)
!1735 = !DILocation(line: 63, column: 71, scope: !1731)
!1736 = !DILocation(line: 63, column: 73, scope: !1731)
!1737 = !DILocation(line: 63, column: 69, scope: !1731)
!1738 = !DILocation(line: 63, column: 80, scope: !1731)
!1739 = !DILocation(line: 63, column: 33, scope: !1731)
!1740 = !DILocation(line: 63, column: 21, scope: !1731)
!1741 = !DILocation(line: 63, column: 16, scope: !1731)
!1742 = !DILocation(line: 63, column: 13, scope: !1731)
!1743 = !DILocation(line: 63, column: 19, scope: !1731)
!1744 = !DILocation(line: 62, column: 31, scope: !1745)
!1745 = !DILexicalBlockFile(scope: !1731, file: !904, discriminator: 2)
!1746 = !DILocation(line: 62, column: 9, scope: !1745)
!1747 = distinct !{!1747, !1748}
!1748 = !DILocation(line: 62, column: 9, scope: !1727)
!1749 = !DILocation(line: 64, column: 13, scope: !1727)
!1750 = !DILocation(line: 66, column: 16, scope: !1751)
!1751 = distinct !DILexicalBlock(scope: !1727, file: !904, line: 66, column: 9)
!1752 = !DILocation(line: 66, column: 14, scope: !1751)
!1753 = !DILocation(line: 66, column: 21, scope: !1754)
!1754 = !DILexicalBlockFile(scope: !1755, file: !904, discriminator: 1)
!1755 = distinct !DILexicalBlock(scope: !1751, file: !904, line: 66, column: 9)
!1756 = !DILocation(line: 66, column: 23, scope: !1754)
!1757 = !DILocation(line: 66, column: 9, scope: !1754)
!1758 = !DILocation(line: 67, column: 40, scope: !1755)
!1759 = !DILocation(line: 67, column: 36, scope: !1755)
!1760 = !DILocation(line: 67, column: 33, scope: !1755)
!1761 = !DILocation(line: 67, column: 28, scope: !1755)
!1762 = !DILocation(line: 67, column: 31, scope: !1755)
!1763 = !DILocation(line: 67, column: 13, scope: !1755)
!1764 = !DILocation(line: 66, column: 36, scope: !1765)
!1765 = !DILexicalBlockFile(scope: !1755, file: !904, discriminator: 2)
!1766 = !DILocation(line: 66, column: 9, scope: !1765)
!1767 = distinct !{!1767, !1768}
!1768 = !DILocation(line: 66, column: 9, scope: !1727)
!1769 = !DILocation(line: 68, column: 5, scope: !1727)
!1770 = !DILocation(line: 61, column: 30, scope: !1771)
!1771 = !DILexicalBlockFile(scope: !1721, file: !904, discriminator: 2)
!1772 = !DILocation(line: 61, column: 5, scope: !1771)
!1773 = distinct !{!1773, !1774}
!1774 = !DILocation(line: 61, column: 5, scope: !1658)
!1775 = !DILocation(line: 69, column: 6, scope: !1658)
!1776 = !DILocation(line: 69, column: 16, scope: !1658)
!1777 = !DILocation(line: 71, column: 12, scope: !1658)
!1778 = !DILocation(line: 71, column: 17, scope: !1658)
!1779 = !DILocation(line: 71, column: 5, scope: !1658)
!1780 = !DILocation(line: 72, column: 1, scope: !1658)
!1781 = distinct !DISubprogram(name: "sign_extend", scope: !1782, file: !1782, line: 130, type: !1783, isLocal: true, isDefinition: true, scopeLine: 131, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1637)
!1782 = !DIFile(filename: "libavcodec/mathops.h", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a")
!1783 = !DISubroutineType(types: !1784)
!1784 = !{!888, !888, !889}
!1785 = !DILocalVariable(name: "val", arg: 1, scope: !1781, file: !1782, line: 130, type: !888)
!1786 = !DILocation(line: 130, column: 58, scope: !1781)
!1787 = !DILocalVariable(name: "bits", arg: 2, scope: !1781, file: !1782, line: 130, type: !889)
!1788 = !DILocation(line: 130, column: 72, scope: !1781)
!1789 = !DILocalVariable(name: "shift", scope: !1781, file: !1782, line: 132, type: !889)
!1790 = !DILocation(line: 132, column: 14, scope: !1781)
!1791 = !DILocation(line: 132, column: 40, scope: !1781)
!1792 = !DILocation(line: 132, column: 38, scope: !1781)
!1793 = !DILocation(line: 132, column: 22, scope: !1781)
!1794 = !DILocalVariable(name: "v", scope: !1781, file: !1782, line: 133, type: !1795)
!1795 = distinct !DICompositeType(tag: DW_TAG_union_type, scope: !1781, file: !1782, line: 133, size: 32, align: 32, elements: !1796)
!1796 = !{!1797, !1798}
!1797 = !DIDerivedType(tag: DW_TAG_member, name: "u", scope: !1795, file: !1782, line: 133, baseType: !889, size: 32, align: 32)
!1798 = !DIDerivedType(tag: DW_TAG_member, name: "s", scope: !1795, file: !1782, line: 133, baseType: !888, size: 32, align: 32)
!1799 = !DILocation(line: 133, column: 34, scope: !1781)
!1800 = !DILocation(line: 133, column: 38, scope: !1781)
!1801 = !DILocation(line: 133, column: 51, scope: !1781)
!1802 = !DILocation(line: 133, column: 58, scope: !1781)
!1803 = !DILocation(line: 133, column: 55, scope: !1781)
!1804 = !DILocation(line: 134, column: 14, scope: !1781)
!1805 = !DILocation(line: 134, column: 19, scope: !1781)
!1806 = !DILocation(line: 134, column: 16, scope: !1781)
!1807 = !DILocation(line: 134, column: 5, scope: !1781)
