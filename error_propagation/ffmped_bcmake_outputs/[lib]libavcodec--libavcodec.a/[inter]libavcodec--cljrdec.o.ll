; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a/[inter]libavcodec--cljrdec.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a/[inter]libavcodec--cljrdec.o.i"
...
entry:
  ...
  store i32 7, i32* %pix_fmt, align 8, !dbg !1640
  ret i32 0, !dbg !1641
}

; Function Attrs: nounwind uwtable
define internal i32 @decode_frame(%struct.AVCodecContext* %avctx, i8* %data, i32* %got_frame, %struct.AVPacket* %avpkt) #1 !dbg !1642 {
entry:
  ...
  store %struct.AVCodecContext* %avctx, %struct.AVCodecContext** %avctx.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVCodecContext** %avctx.addr, metadata !1643, metadata !1636), !dbg !1644
  store i8* %data, i8** %data.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %data.addr, metadata !1645, metadata !1636), !dbg !1646
  store i32* %got_frame, i32** %got_frame.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %got_frame.addr, metadata !1647, metadata !1636), !dbg !1648
  store %struct.AVPacket* %avpkt, %struct.AVPacket** %avpkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %avpkt.addr, metadata !1649, metadata !1636), !dbg !1650
  call void @llvm.dbg.declare(metadata i8** %buf, metadata !1651, metadata !1636), !dbg !1652
  %0 = load %struct.AVPacket*, %struct.AVPacket** %avpkt.addr, align 8, !dbg !1653
  %data1 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %0, i32 0, i32 3, !dbg !1654
  %1 = load i8*, i8** %data1, align 8, !dbg !1654
  store i8* %1, i8** %buf, align 8, !dbg !1652
  call void @llvm.dbg.declare(metadata i32* %buf_size, metadata !1655, metadata !1636), !dbg !1656
  %2 = load %struct.AVPacket*, %struct.AVPacket** %avpkt.addr, align 8, !dbg !1657
  %size = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %2, i32 0, i32 4, !dbg !1658
  %3 = load i32, i32* %size, align 8, !dbg !1658
  store i32 %3, i32* %buf_size, align 4, !dbg !1656
  call void @llvm.dbg.declare(metadata %struct.GetBitContext* %gb, metadata !1659, metadata !1636), !dbg !1669
  call void @llvm.dbg.declare(metadata %struct.AVFrame** %p, metadata !1670, metadata !1636), !dbg !1672
  %4 = load i8*, i8** %data.addr, align 8, !dbg !1673
  %5 = bitcast i8* %4 to %struct.AVFrame*, !dbg !1673
  store %struct.AVFrame* %5, %struct.AVFrame** %p, align 8, !dbg !1672
  call void @llvm.dbg.declare(metadata i32* %x, metadata !1674, metadata !1636), !dbg !1675
  call void @llvm.dbg.declare(metadata i32* %y, metadata !1676, metadata !1636), !dbg !1677
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !1678, metadata !1636), !dbg !1679
  %6 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1680
  %height = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %6, i32 0, i32 21, !dbg !1682
  %7 = load i32, i32* %height, align 8, !dbg !1682
  %cmp = icmp sle i32 %7, 0, !dbg !1683
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %width = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %8, i32 0, i32 20, !dbg !1687
  %9 = load i32, i32* %width, align 4, !dbg !1687
  %cmp2 = icmp sle i32 %9, 0, !dbg !1688
...
if.then:                                          ; preds = %lor.lhs.false, %entry
  ...
  call void (i8*, i32, i8*, ...) @av_log(i8* %11, i32 16, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.2, i32 0, i32 0)), !dbg !1692
  store i32 -1094995529, i32* %retval, align 4, !dbg !1693
  br label %return, !dbg !1693

if.end:                                           ; preds = %lor.lhs.false
  %12 = load i32, i32* %buf_size, align 4, !dbg !1694
  %13 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1696
  %height3 = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %13, i32 0, i32 21, !dbg !1697
  %14 = load i32, i32* %height3, align 8, !dbg !1697
  %div = sdiv i32 %12, %14, !dbg !1698
  %15 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1699
  %width4 = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %15, i32 0, i32 20, !dbg !1700
  %16 = load i32, i32* %width4, align 4, !dbg !1700
  %cmp5 = icmp slt i32 %div, %16, !dbg !1701
  br i1 %cmp5, label %if.then6, label %if.end7, !dbg !1702

if.then6:                                         ; preds = %if.end
  %17 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1703
  %18 = bitcast %struct.AVCodecContext* %17 to i8*, !dbg !1703
  call void (i8*, i32, i8*, ...) @av_log(i8* %18, i32 16, i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.3, i32 0, i32 0)), !dbg !1705
  store i32 -1094995529, i32* %retval, align 4, !dbg !1706
  br label %return, !dbg !1706

if.end7:                                          ; preds = %if.end
  %19 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1707
  %20 = load %struct.AVFrame*, %struct.AVFrame** %p, align 8, !dbg !1709
  %call = call i32 @ff_get_buffer(%struct.AVCodecContext* %19, %struct.AVFrame* %20, i32 0), !dbg !1710
  store i32 %call, i32* %ret, align 4, !dbg !1711
  %cmp8 = icmp slt i32 %call, 0, !dbg !1712
  br i1 %cmp8, label %if.then9, label %if.end10, !dbg !1713

if.then9:                                         ; preds = %if.end7
  %21 = load i32, i32* %ret, align 4, !dbg !1714
  store i32 %21, i32* %retval, align 4, !dbg !1715
  br label %return, !dbg !1715

if.end10:                                         ; preds = %if.end7
  %22 = load %struct.AVFrame*, %struct.AVFrame** %p, align 8, !dbg !1716
  %pict_type = getelementptr inbounds %struct.AVFrame, %struct.AVFrame* %22, i32 0, i32 8, !dbg !1717
  store i32 1, i32* %pict_type, align 4, !dbg !1718
  %23 = load %struct.AVFrame*, %struct.AVFrame** %p, align 8, !dbg !1719
  %key_frame = getelementptr inbounds %struct.AVFrame, %struct.AVFrame* %23, i32 0, i32 7, !dbg !1720
  store i32 1, i32* %key_frame, align 8, !dbg !1721
  %24 = load i8*, i8** %buf, align 8, !dbg !1722
  %25 = load i32, i32* %buf_size, align 4, !dbg !1723
  %mul = mul nsw i32 %25, 8, !dbg !1724
  %call11 = call i32 @init_get_bits(%struct.GetBitContext* %gb, i8* %24, i32 %mul), !dbg !1725
  store i32 0, i32* %y, align 4, !dbg !1726
  br label %for.cond, !dbg !1728

for.cond:                                         ; preds = %for.inc60, %if.end10
  %26 = load i32, i32* %y, align 4, !dbg !1729
  %27 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1732
  %height12 = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %27, i32 0, i32 21, !dbg !1733
  %28 = load i32, i32* %height12, align 8, !dbg !1733
  %cmp13 = icmp slt i32 %26, %28, !dbg !1734
  br i1 %cmp13, label %for.body, label %for.end61, !dbg !1735

for.body:                                         ; preds = %for.cond
  call void @llvm.dbg.declare(metadata i8** %luma, metadata !1736, metadata !1636), !dbg !1738
  %29 = load i32, i32* %y, align 4, !dbg !1739
  %30 = load %struct.AVFrame*, %struct.AVFrame** %p, align 8, !dbg !1740
  %linesize = getelementptr inbounds %struct.AVFrame, %struct.AVFrame* %30, i32 0, i32 1, !dbg !1741
  %arrayidx = getelementptr inbounds [8 x i32], [8 x i32]* %linesize, i64 0, i64 0, !dbg !1740
  %31 = load i32, i32* %arrayidx, align 8, !dbg !1740
  %mul14 = mul nsw i32 %29, %31, !dbg !1742
  %idxprom = sext i32 %mul14 to i64, !dbg !1743
  %32 = load %struct.AVFrame*, %struct.AVFrame** %p, align 8, !dbg !1743
  %data15 = getelementptr inbounds %struct.AVFrame, %struct.AVFrame* %32, i32 0, i32 0, !dbg !1744
  %arrayidx16 = getelementptr inbounds [8 x i8*], [8 x i8*]* %data15, i64 0, i64 0, !dbg !1743
  %33 = load i8*, i8** %arrayidx16, align 8, !dbg !1743
  %arrayidx17 = getelementptr inbounds i8, i8* %33, i64 %idxprom, !dbg !1743
  store i8* %arrayidx17, i8** %luma, align 8, !dbg !1738
  call void @llvm.dbg.declare(metadata i8** %cb, metadata !1745, metadata !1636), !dbg !1746
  %34 = load i32, i32* %y, align 4, !dbg !1747
  %35 = load %struct.AVFrame*, %struct.AVFrame** %p, align 8, !dbg !1748
  %linesize18 = getelementptr inbounds %struct.AVFrame, %struct.AVFrame* %35, i32 0, i32 1, !dbg !1749
  %arrayidx19 = getelementptr inbounds [8 x i32], [8 x i32]* %linesize18, i64 0, i64 1, !dbg !1748
  %36 = load i32, i32* %arrayidx19, align 4, !dbg !1748
  %mul20 = mul nsw i32 %34, %36, !dbg !1750
  %idxprom21 = sext i32 %mul20 to i64, !dbg !1751
  %37 = load %struct.AVFrame*, %struct.AVFrame** %p, align 8, !dbg !1751
  %data22 = getelementptr inbounds %struct.AVFrame, %struct.AVFrame* %37, i32 0, i32 0, !dbg !1752
  %arrayidx23 = getelementptr inbounds [8 x i8*], [8 x i8*]* %data22, i64 0, i64 1, !dbg !1751
  %38 = load i8*, i8** %arrayidx23, align 8, !dbg !1751
  %arrayidx24 = getelementptr inbounds i8, i8* %38, i64 %idxprom21, !dbg !1751
  store i8* %arrayidx24, i8** %cb, align 8, !dbg !1746
  call void @llvm.dbg.declare(metadata i8** %cr, metadata !1753, metadata !1636), !dbg !1754
  %39 = load i32, i32* %y, align 4, !dbg !1755
  %40 = load %struct.AVFrame*, %struct.AVFrame** %p, align 8, !dbg !1756
  %linesize25 = getelementptr inbounds %struct.AVFrame, %struct.AVFrame* %40, i32 0, i32 1, !dbg !1757
  %arrayidx26 = getelementptr inbounds [8 x i32], [8 x i32]* %linesize25, i64 0, i64 2, !dbg !1756
  %41 = load i32, i32* %arrayidx26, align 8, !dbg !1756
  %mul27 = mul nsw i32 %39, %41, !dbg !1758
  %idxprom28 = sext i32 %mul27 to i64, !dbg !1759
  %42 = load %struct.AVFrame*, %struct.AVFrame** %p, align 8, !dbg !1759
  %data29 = getelementptr inbounds %struct.AVFrame, %struct.AVFrame* %42, i32 0, i32 0, !dbg !1760
  %arrayidx30 = getelementptr inbounds [8 x i8*], [8 x i8*]* %data29, i64 0, i64 2, !dbg !1759
  %43 = load i8*, i8** %arrayidx30, align 8, !dbg !1759
  %arrayidx31 = getelementptr inbounds i8, i8* %43, i64 %idxprom28, !dbg !1759
  store i8* %arrayidx31, i8** %cr, align 8, !dbg !1754
  store i32 0, i32* %x, align 4, !dbg !1761
  br label %for.cond32, !dbg !1763

for.cond32:                                       ; preds = %for.inc, %for.body
  %44 = load i32, i32* %x, align 4, !dbg !1764
  %45 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1767
  %width33 = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %45, i32 0, i32 20, !dbg !1768
  %46 = load i32, i32* %width33, align 4, !dbg !1768
  %cmp34 = icmp slt i32 %44, %46, !dbg !1769
  br i1 %cmp34, label %for.body35, label %for.end, !dbg !1770

for.body35:                                       ; preds = %for.cond32
  %call36 = call i32 @get_bits(%struct.GetBitContext* %gb, i32 5), !dbg !1771
  %mul37 = mul i32 %call36, 33, !dbg !1773
  %shr = lshr i32 %mul37, 2, !dbg !1774
  %conv = trunc i32 %shr to i8, !dbg !1775
  %47 = load i8*, i8** %luma, align 8, !dbg !1776
  %arrayidx38 = getelementptr inbounds i8, i8* %47, i64 3, !dbg !1776
  store i8 %conv, i8* %arrayidx38, align 1, !dbg !1777
  %call39 = call i32 @get_bits(%struct.GetBitContext* %gb, i32 5), !dbg !1778
  %mul40 = mul i32 %call39, 33, !dbg !1779
  %shr41 = lshr i32 %mul40, 2, !dbg !1780
  %conv42 = trunc i32 %shr41 to i8, !dbg !1781
  %48 = load i8*, i8** %luma, align 8, !dbg !1782
  %arrayidx43 = getelementptr inbounds i8, i8* %48, i64 2, !dbg !1782
  store i8 %conv42, i8* %arrayidx43, align 1, !dbg !1783
  %call44 = call i32 @get_bits(%struct.GetBitContext* %gb, i32 5), !dbg !1784
  %mul45 = mul i32 %call44, 33, !dbg !1785
  %shr46 = lshr i32 %mul45, 2, !dbg !1786
  %conv47 = trunc i32 %shr46 to i8, !dbg !1787
  %49 = load i8*, i8** %luma, align 8, !dbg !1788
  %arrayidx48 = getelementptr inbounds i8, i8* %49, i64 1, !dbg !1788
  store i8 %conv47, i8* %arrayidx48, align 1, !dbg !1789
  %call49 = call i32 @get_bits(%struct.GetBitContext* %gb, i32 5), !dbg !1790
  %mul50 = mul i32 %call49, 33, !dbg !1791
  %shr51 = lshr i32 %mul50, 2, !dbg !1792
  %conv52 = trunc i32 %shr51 to i8, !dbg !1793
  %50 = load i8*, i8** %luma, align 8, !dbg !1794
  %arrayidx53 = getelementptr inbounds i8, i8* %50, i64 0, !dbg !1794
  store i8 %conv52, i8* %arrayidx53, align 1, !dbg !1795
  %51 = load i8*, i8** %luma, align 8, !dbg !1796
  %add.ptr = getelementptr inbounds i8, i8* %51, i64 4, !dbg !1796
  store i8* %add.ptr, i8** %luma, align 8, !dbg !1796
  %call54 = call i32 @get_bits(%struct.GetBitContext* %gb, i32 6), !dbg !1797
  %shl = shl i32 %call54, 2, !dbg !1798
  %conv55 = trunc i32 %shl to i8, !dbg !1797
  %52 = load i8*, i8** %cb, align 8, !dbg !1799
  %incdec.ptr = getelementptr inbounds i8, i8* %52, i32 1, !dbg !1799
  store i8* %incdec.ptr, i8** %cb, align 8, !dbg !1799
  store i8 %conv55, i8* %52, align 1, !dbg !1800
  %call56 = call i32 @get_bits(%struct.GetBitContext* %gb, i32 6), !dbg !1801
  %shl57 = shl i32 %call56, 2, !dbg !1802
  %conv58 = trunc i32 %shl57 to i8, !dbg !1801
  %53 = load i8*, i8** %cr, align 8, !dbg !1803
  %incdec.ptr59 = getelementptr inbounds i8, i8* %53, i32 1, !dbg !1803
  store i8* %incdec.ptr59, i8** %cr, align 8, !dbg !1803
  store i8 %conv58, i8* %53, align 1, !dbg !1804
  br label %for.inc, !dbg !1805

for.inc:                                          ; preds = %for.body35
  %54 = load i32, i32* %x, align 4, !dbg !1806
  %add = add nsw i32 %54, 4, !dbg !1806
  store i32 %add, i32* %x, align 4, !dbg !1806
  br label %for.cond32, !dbg !1808, !llvm.loop !1809

for.end:                                          ; preds = %for.cond32
  br label %for.inc60, !dbg !1811

for.inc60:                                        ; preds = %for.end
  %55 = load i32, i32* %y, align 4, !dbg !1812
  %inc = add nsw i32 %55, 1, !dbg !1812
  store i32 %inc, i32* %y, align 4, !dbg !1812
  br label %for.cond, !dbg !1814, !llvm.loop !1815

for.end61:                                        ; preds = %for.cond
  %56 = load i32*, i32** %got_frame.addr, align 8, !dbg !1817
  store i32 1, i32* %56, align 4, !dbg !1818
  %57 = load i32, i32* %buf_size, align 4, !dbg !1819
  store i32 %57, i32* %retval, align 4, !dbg !1820
  br label %return, !dbg !1820

return:                                           ; preds = %for.end61, %if.then9, %if.then6, %if.then
  %58 = load i32, i32* %retval, align 4, !dbg !1821
  ret i32 %58, !dbg !1821
}
...
define internal i32 @init_get_bits(%struct.GetBitContext* %s, i8* %buffer, i32 %bit_size) #4 !dbg !1822 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.GetBitContext** %s.addr, metadata !1826, metadata !1636), !dbg !1827
  store i8* %buffer, i8** %buffer.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %buffer.addr, metadata !1828, metadata !1636), !dbg !1829
  store i32 %bit_size, i32* %bit_size.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %bit_size.addr, metadata !1830, metadata !1636), !dbg !1831
  call void @llvm.dbg.declare(metadata i32* %buffer_size, metadata !1832, metadata !1636), !dbg !1833
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !1834, metadata !1636), !dbg !1835
  store i32 0, i32* %ret, align 4, !dbg !1835
  %0 = load i32, i32* %bit_size.addr, align 4, !dbg !1836
  %cmp = icmp sge i32 %0, 2147483135, !dbg !1838
  br i1 %cmp, label %if.then, label %lor.lhs.false, !dbg !1839

lor.lhs.false:                                    ; preds = %entry
  %1 = load i32, i32* %bit_size.addr, align 4, !dbg !1840
  %cmp1 = icmp slt i32 %1, 0, !dbg !1842
  br i1 %cmp1, label %if.then, label %lor.lhs.false2, !dbg !1843

lor.lhs.false2:                                   ; preds = %lor.lhs.false
  %2 = load i8*, i8** %buffer.addr, align 8, !dbg !1844
  %tobool = icmp ne i8* %2, null, !dbg !1844
  br i1 %tobool, label %if.end, label %if.then, !dbg !1846

if.then:                                          ; preds = %lor.lhs.false2, %lor.lhs.false, %entry
  store i32 0, i32* %bit_size.addr, align 4, !dbg !1847
  store i8* null, i8** %buffer.addr, align 8, !dbg !1849
  store i32 -1094995529, i32* %ret, align 4, !dbg !1850
  br label %if.end, !dbg !1851

if.end:                                           ; preds = %if.then, %lor.lhs.false2
  %3 = load i32, i32* %bit_size.addr, align 4, !dbg !1852
  %add = add nsw i32 %3, 7, !dbg !1853
  %shr = ashr i32 %add, 3, !dbg !1854
  store i32 %shr, i32* %buffer_size, align 4, !dbg !1855
  %4 = load i8*, i8** %buffer.addr, align 8, !dbg !1856
  %5 = load %struct.GetBitContext*, %struct.GetBitContext** %s.addr, align 8, !dbg !1857
  %buffer3 = getelementptr inbounds %struct.GetBitContext, %struct.GetBitContext* %5, i32 0, i32 0, !dbg !1858
  store i8* %4, i8** %buffer3, align 8, !dbg !1859
  %6 = load i32, i32* %bit_size.addr, align 4, !dbg !1860
  %7 = load %struct.GetBitContext*, %struct.GetBitContext** %s.addr, align 8, !dbg !1861
  %size_in_bits = getelementptr inbounds %struct.GetBitContext, %struct.GetBitContext* %7, i32 0, i32 3, !dbg !1862
  store i32 %6, i32* %size_in_bits, align 4, !dbg !1863
  %8 = load i32, i32* %bit_size.addr, align 4, !dbg !1864
  %add4 = add nsw i32 %8, 8, !dbg !1865
  %9 = load %struct.GetBitContext*, %struct.GetBitContext** %s.addr, align 8, !dbg !1866
  %size_in_bits_plus8 = getelementptr inbounds %struct.GetBitContext, %struct.GetBitContext* %9, i32 0, i32 4, !dbg !1867
  store i32 %add4, i32* %size_in_bits_plus8, align 8, !dbg !1868
  %10 = load i8*, i8** %buffer.addr, align 8, !dbg !1869
  %11 = load i32, i32* %buffer_size, align 4, !dbg !1870
  %idx.ext = sext i32 %11 to i64, !dbg !1871
  %add.ptr = getelementptr inbounds i8, i8* %10, i64 %idx.ext, !dbg !1871
  %12 = load %struct.GetBitContext*, %struct.GetBitContext** %s.addr, align 8, !dbg !1872
  %buffer_end = getelementptr inbounds %struct.GetBitContext, %struct.GetBitContext* %12, i32 0, i32 1, !dbg !1873
  store i8* %add.ptr, i8** %buffer_end, align 8, !dbg !1874
  %13 = load %struct.GetBitContext*, %struct.GetBitContext** %s.addr, align 8, !dbg !1875
  %index = getelementptr inbounds %struct.GetBitContext, %struct.GetBitContext* %13, i32 0, i32 2, !dbg !1876
  store i32 0, i32* %index, align 8, !dbg !1877
  %14 = load i32, i32* %ret, align 4, !dbg !1878
  ret i32 %14, !dbg !1879
}

; Function Attrs: inlinehint nounwind uwtable
define internal i32 @get_bits(%struct.GetBitContext* %s, i32 %n) #4 !dbg !1880 {
entry:
  %x.addr.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %x.addr.i, metadata !1883, metadata !1636), !dbg !1888
  %s.addr = alloca %struct.GetBitContext*, align 8
  ...
  store %struct.GetBitContext* %s, %struct.GetBitContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.GetBitContext** %s.addr, metadata !1890, metadata !1636), !dbg !1891
  store i32 %n, i32* %n.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %n.addr, metadata !1892, metadata !1636), !dbg !1893
  call void @llvm.dbg.declare(metadata i32* %tmp, metadata !1894, metadata !1636), !dbg !1895
  call void @llvm.dbg.declare(metadata i32* %re_index, metadata !1896, metadata !1636), !dbg !1897
  %0 = load %struct.GetBitContext*, %struct.GetBitContext** %s.addr, align 8, !dbg !1898
  %index = getelementptr inbounds %struct.GetBitContext, %struct.GetBitContext* %0, i32 0, i32 2, !dbg !1899
  %1 = load i32, i32* %index, align 8, !dbg !1899
  store i32 %1, i32* %re_index, align 4, !dbg !1897
  call void @llvm.dbg.declare(metadata i32* %re_cache, metadata !1900, metadata !1636), !dbg !1901
  call void @llvm.dbg.declare(metadata i32* %re_size_plus8, metadata !1902, metadata !1636), !dbg !1903
  %2 = load %struct.GetBitContext*, %struct.GetBitContext** %s.addr, align 8, !dbg !1904
  %size_in_bits_plus8 = getelementptr inbounds %struct.GetBitContext, %struct.GetBitContext* %2, i32 0, i32 4, !dbg !1905
  %3 = load i32, i32* %size_in_bits_plus8, align 8, !dbg !1905
  store i32 %3, i32* %re_size_plus8, align 4, !dbg !1903
  %4 = load %struct.GetBitContext*, %struct.GetBitContext** %s.addr, align 8, !dbg !1906
  %buffer = getelementptr inbounds %struct.GetBitContext, %struct.GetBitContext* %4, i32 0, i32 0, !dbg !1907
  %5 = load i8*, i8** %buffer, align 8, !dbg !1907
  %6 = load i32, i32* %re_index, align 4, !dbg !1908
  %shr = lshr i32 %6, 3, !dbg !1909
  %idx.ext = zext i32 %shr to i64, !dbg !1910
  %add.ptr = getelementptr inbounds i8, i8* %5, i64 %idx.ext, !dbg !1910
  %7 = bitcast i8* %add.ptr to %union.unaligned_32*, !dbg !1911
  %l = bitcast %union.unaligned_32* %7 to i32*, !dbg !1911
  %8 = load i32, i32* %l, align 1, !dbg !1911
  store i32 %8, i32* %x.addr.i, align 4, !dbg !1912
  %9 = load i32, i32* %x.addr.i, align 4, !dbg !1913
  %shl.i = shl i32 %9, 8, !dbg !1914
  %and.i = and i32 %shl.i, 65280, !dbg !1915
  %10 = load i32, i32* %x.addr.i, align 4, !dbg !1916
  %shr.i = lshr i32 %10, 8, !dbg !1917
  %and1.i = and i32 %shr.i, 255, !dbg !1918
  %or.i = or i32 %and.i, %and1.i, !dbg !1919
  %shl2.i = shl i32 %or.i, 16, !dbg !1920
  %11 = load i32, i32* %x.addr.i, align 4, !dbg !1921
  %shr3.i = lshr i32 %11, 16, !dbg !1922
  %shl4.i = shl i32 %shr3.i, 8, !dbg !1923
  %and5.i = and i32 %shl4.i, 65280, !dbg !1924
  %12 = load i32, i32* %x.addr.i, align 4, !dbg !1925
  %shr6.i = lshr i32 %12, 16, !dbg !1926
  %shr7.i = lshr i32 %shr6.i, 8, !dbg !1927
  %and8.i = and i32 %shr7.i, 255, !dbg !1928
  %or9.i = or i32 %and5.i, %and8.i, !dbg !1929
  %or10.i = or i32 %shl2.i, %or9.i, !dbg !1930
  %13 = load i32, i32* %re_index, align 4, !dbg !1931
  %and = and i32 %13, 7, !dbg !1932
  %shl = shl i32 %or10.i, %and, !dbg !1933
  store i32 %shl, i32* %re_cache, align 4, !dbg !1934
  %14 = load i32, i32* %re_cache, align 4, !dbg !1935
  %15 = load i32, i32* %n.addr, align 4, !dbg !1936
  %conv = trunc i32 %15 to i8, !dbg !1936
  %call4 = call i32 @NEG_USR32(i32 %14, i8 signext %conv), !dbg !1937
  store i32 %call4, i32* %tmp, align 4, !dbg !1938
  %16 = load i32, i32* %re_size_plus8, align 4, !dbg !1939
  %17 = load i32, i32* %re_index, align 4, !dbg !1940
  %18 = load i32, i32* %n.addr, align 4, !dbg !1941
  %add = add i32 %17, %18, !dbg !1942
  %cmp = icmp ugt i32 %16, %add, !dbg !1943
  br i1 %cmp, label %cond.true, label %cond.false, !dbg !1944

cond.true:                                        ; preds = %entry
  %19 = load i32, i32* %re_index, align 4, !dbg !1945
  %20 = load i32, i32* %n.addr, align 4, !dbg !1947
  %add6 = add i32 %19, %20, !dbg !1948
  br label %cond.end, !dbg !1949

cond.false:                                       ; preds = %entry
  %21 = load i32, i32* %re_size_plus8, align 4, !dbg !1950
  br label %cond.end, !dbg !1952

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %add6, %cond.true ], [ %21, %cond.false ], !dbg !1953
  store i32 %cond, i32* %re_index, align 4, !dbg !1955
  %22 = load i32, i32* %re_index, align 4, !dbg !1956
  %23 = load %struct.GetBitContext*, %struct.GetBitContext** %s.addr, align 8, !dbg !1957
  %index7 = getelementptr inbounds %struct.GetBitContext, %struct.GetBitContext* %23, i32 0, i32 2, !dbg !1958
  store i32 %22, i32* %index7, align 8, !dbg !1959
  %24 = load i32, i32* %tmp, align 4, !dbg !1960
  ret i32 %24, !dbg !1961
}

; Function Attrs: inlinehint nounwind uwtable
define internal i32 @NEG_USR32(i32 %a, i8 signext %s) #4 !dbg !1962 {
entry:
  %a.addr = alloca i32, align 4
  %s.addr = alloca i8, align 1
  store i32 %a, i32* %a.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %a.addr, metadata !1966, metadata !1636), !dbg !1967
  store i8 %s, i8* %s.addr, align 1
  call void @llvm.dbg.declare(metadata i8* %s.addr, metadata !1968, metadata !1636), !dbg !1969
  %0 = load i32, i32* %a.addr, align 4, !dbg !1970
  %1 = load i8, i8* %s.addr, align 1, !dbg !1971
  %conv = sext i8 %1 to i32, !dbg !1971
  %sub = sub nsw i32 0, %conv, !dbg !1972
  %conv1 = trunc i32 %sub to i8, !dbg !1973
  %2 = call i32 asm "shrl $1, $0\0A\09", "=r,i{cx},0,~{dirflag},~{fpsr},~{flags}"(i8 %conv1, i32 %0) #2, !dbg !1970, !srcloc !1974
  store i32 %2, i32* %a.addr, align 4, !dbg !1970
  %3 = load i32, i32* %a.addr, align 4, !dbg !1975
  ret i32 %3, !dbg !1976
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a/[inter]libavcodec--cljrdec.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a")
...
!900 = !{!901}
!901 = distinct !DIGlobalVariable(name: "ff_cljr_decoder", scope: !0, file: !902, line: 85, type: !903, isLocal: false, isDefinition: true, variable: %struct.AVCodec* @ff_cljr_decoder)
!902 = !DIFile(filename: "libavcodec/cljrdec.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a")
...
!1633 = distinct !DISubprogram(name: "decode_init", scope: !902, file: !902, line: 79, type: !994, isLocal: true, isDefinition: true, scopeLine: 80, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1634)
!1634 = !{}
!1635 = !DILocalVariable(name: "avctx", arg: 1, scope: !1633, file: !902, line: 79, type: !996)
!1636 = !DIExpression()
!1637 = !DILocation(line: 79, column: 62, scope: !1633)
!1638 = !DILocation(line: 81, column: 5, scope: !1633)
!1639 = !DILocation(line: 81, column: 12, scope: !1633)
!1640 = !DILocation(line: 81, column: 20, scope: !1633)
!1641 = !DILocation(line: 82, column: 5, scope: !1633)
!1642 = distinct !DISubprogram(name: "decode_frame", scope: !902, file: !902, line: 31, type: !1607, isLocal: true, isDefinition: true, scopeLine: 34, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1634)
!1643 = !DILocalVariable(name: "avctx", arg: 1, scope: !1642, file: !902, line: 31, type: !996)
!1644 = !DILocation(line: 31, column: 41, scope: !1642)
!1645 = !DILocalVariable(name: "data", arg: 2, scope: !1642, file: !902, line: 32, type: !949)
!1646 = !DILocation(line: 32, column: 31, scope: !1642)
!1647 = !DILocalVariable(name: "got_frame", arg: 3, scope: !1642, file: !902, line: 32, type: !1290)
!1648 = !DILocation(line: 32, column: 42, scope: !1642)
!1649 = !DILocalVariable(name: "avpkt", arg: 4, scope: !1642, file: !902, line: 33, type: !1144)
!1650 = !DILocation(line: 33, column: 35, scope: !1642)
!1651 = !DILocalVariable(name: "buf", scope: !1642, file: !902, line: 35, type: !1441)
!1652 = !DILocation(line: 35, column: 20, scope: !1642)
!1653 = !DILocation(line: 35, column: 26, scope: !1642)
!1654 = !DILocation(line: 35, column: 33, scope: !1642)
!1655 = !DILocalVariable(name: "buf_size", scope: !1642, file: !902, line: 36, type: !888)
!1656 = !DILocation(line: 36, column: 9, scope: !1642)
!1657 = !DILocation(line: 36, column: 20, scope: !1642)
!1658 = !DILocation(line: 36, column: 27, scope: !1642)
!1659 = !DILocalVariable(name: "gb", scope: !1642, file: !902, line: 37, type: !1660)
!1660 = !DIDerivedType(tag: DW_TAG_typedef, name: "GetBitContext", file: !1661, line: 70, baseType: !1662)
!1661 = !DIFile(filename: "libavcodec/get_bits.h", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a")
!1662 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "GetBitContext", file: !1661, line: 61, size: 256, align: 64, elements: !1663)
!1663 = !{!1664, !1665, !1666, !1667, !1668}
!1664 = !DIDerivedType(tag: DW_TAG_member, name: "buffer", scope: !1662, file: !1661, line: 62, baseType: !1441, size: 64, align: 64)
!1665 = !DIDerivedType(tag: DW_TAG_member, name: "buffer_end", scope: !1662, file: !1661, line: 62, baseType: !1441, size: 64, align: 64, offset: 64)
!1666 = !DIDerivedType(tag: DW_TAG_member, name: "index", scope: !1662, file: !1661, line: 67, baseType: !888, size: 32, align: 32, offset: 128)
!1667 = !DIDerivedType(tag: DW_TAG_member, name: "size_in_bits", scope: !1662, file: !1661, line: 68, baseType: !888, size: 32, align: 32, offset: 160)
!1668 = !DIDerivedType(tag: DW_TAG_member, name: "size_in_bits_plus8", scope: !1662, file: !1661, line: 69, baseType: !888, size: 32, align: 32, offset: 192)
!1669 = !DILocation(line: 37, column: 19, scope: !1642)
!1670 = !DILocalVariable(name: "p", scope: !1642, file: !902, line: 38, type: !1671)
!1671 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1018)
!1672 = !DILocation(line: 38, column: 21, scope: !1642)
!1673 = !DILocation(line: 38, column: 25, scope: !1642)
!1674 = !DILocalVariable(name: "x", scope: !1642, file: !902, line: 39, type: !888)
!1675 = !DILocation(line: 39, column: 9, scope: !1642)
!1676 = !DILocalVariable(name: "y", scope: !1642, file: !902, line: 39, type: !888)
!1677 = !DILocation(line: 39, column: 12, scope: !1642)
!1678 = !DILocalVariable(name: "ret", scope: !1642, file: !902, line: 39, type: !888)
!1679 = !DILocation(line: 39, column: 15, scope: !1642)
!1680 = !DILocation(line: 41, column: 9, scope: !1681)
!1681 = distinct !DILexicalBlock(scope: !1642, file: !902, line: 41, column: 9)
!1682 = !DILocation(line: 41, column: 16, scope: !1681)
!1683 = !DILocation(line: 41, column: 23, scope: !1681)
!1684 = !DILocation(line: 41, column: 28, scope: !1681)
!1685 = !DILocation(line: 41, column: 31, scope: !1686)
!1686 = !DILexicalBlockFile(scope: !1681, file: !902, discriminator: 1)
!1687 = !DILocation(line: 41, column: 38, scope: !1686)
!1688 = !DILocation(line: 41, column: 44, scope: !1686)
!1689 = !DILocation(line: 41, column: 9, scope: !1686)
!1690 = !DILocation(line: 42, column: 16, scope: !1691)
!1691 = distinct !DILexicalBlock(scope: !1681, file: !902, line: 41, column: 50)
!1692 = !DILocation(line: 42, column: 9, scope: !1691)
!1693 = !DILocation(line: 43, column: 9, scope: !1691)
!1694 = !DILocation(line: 46, column: 9, scope: !1695)
!1695 = distinct !DILexicalBlock(scope: !1642, file: !902, line: 46, column: 9)
!1696 = !DILocation(line: 46, column: 20, scope: !1695)
!1697 = !DILocation(line: 46, column: 27, scope: !1695)
!1698 = !DILocation(line: 46, column: 18, scope: !1695)
!1699 = !DILocation(line: 46, column: 36, scope: !1695)
!1700 = !DILocation(line: 46, column: 43, scope: !1695)
!1701 = !DILocation(line: 46, column: 34, scope: !1695)
!1702 = !DILocation(line: 46, column: 9, scope: !1642)
!1703 = !DILocation(line: 47, column: 16, scope: !1704)
!1704 = distinct !DILexicalBlock(scope: !1695, file: !902, line: 46, column: 50)
!1705 = !DILocation(line: 47, column: 9, scope: !1704)
!1706 = !DILocation(line: 49, column: 9, scope: !1704)
!1707 = !DILocation(line: 52, column: 30, scope: !1708)
!1708 = distinct !DILexicalBlock(scope: !1642, file: !902, line: 52, column: 9)
!1709 = !DILocation(line: 52, column: 37, scope: !1708)
!1710 = !DILocation(line: 52, column: 16, scope: !1708)
!1711 = !DILocation(line: 52, column: 14, scope: !1708)
!1712 = !DILocation(line: 52, column: 44, scope: !1708)
!1713 = !DILocation(line: 52, column: 9, scope: !1642)
!1714 = !DILocation(line: 53, column: 16, scope: !1708)
!1715 = !DILocation(line: 53, column: 9, scope: !1708)
!1716 = !DILocation(line: 54, column: 5, scope: !1642)
!1717 = !DILocation(line: 54, column: 8, scope: !1642)
!1718 = !DILocation(line: 54, column: 18, scope: !1642)
!1719 = !DILocation(line: 55, column: 5, scope: !1642)
!1720 = !DILocation(line: 55, column: 8, scope: !1642)
!1721 = !DILocation(line: 55, column: 18, scope: !1642)
!1722 = !DILocation(line: 57, column: 24, scope: !1642)
!1723 = !DILocation(line: 57, column: 29, scope: !1642)
!1724 = !DILocation(line: 57, column: 38, scope: !1642)
!1725 = !DILocation(line: 57, column: 5, scope: !1642)
!1726 = !DILocation(line: 59, column: 12, scope: !1727)
!1727 = distinct !DILexicalBlock(scope: !1642, file: !902, line: 59, column: 5)
!1728 = !DILocation(line: 59, column: 10, scope: !1727)
!1729 = !DILocation(line: 59, column: 17, scope: !1730)
!1730 = !DILexicalBlockFile(scope: !1731, file: !902, discriminator: 1)
!1731 = distinct !DILexicalBlock(scope: !1727, file: !902, line: 59, column: 5)
!1732 = !DILocation(line: 59, column: 21, scope: !1730)
!1733 = !DILocation(line: 59, column: 28, scope: !1730)
!1734 = !DILocation(line: 59, column: 19, scope: !1730)
!1735 = !DILocation(line: 59, column: 5, scope: !1730)
!1736 = !DILocalVariable(name: "luma", scope: !1737, file: !902, line: 60, type: !1024)
!1737 = distinct !DILexicalBlock(scope: !1731, file: !902, line: 59, column: 41)
!1738 = !DILocation(line: 60, column: 18, scope: !1737)
!1739 = !DILocation(line: 60, column: 37, scope: !1737)
!1740 = !DILocation(line: 60, column: 41, scope: !1737)
!1741 = !DILocation(line: 60, column: 44, scope: !1737)
!1742 = !DILocation(line: 60, column: 39, scope: !1737)
!1743 = !DILocation(line: 60, column: 26, scope: !1737)
!1744 = !DILocation(line: 60, column: 29, scope: !1737)
!1745 = !DILocalVariable(name: "cb", scope: !1737, file: !902, line: 61, type: !1024)
!1746 = !DILocation(line: 61, column: 18, scope: !1737)
!1747 = !DILocation(line: 61, column: 35, scope: !1737)
!1748 = !DILocation(line: 61, column: 39, scope: !1737)
!1749 = !DILocation(line: 61, column: 42, scope: !1737)
!1750 = !DILocation(line: 61, column: 37, scope: !1737)
!1751 = !DILocation(line: 61, column: 24, scope: !1737)
!1752 = !DILocation(line: 61, column: 27, scope: !1737)
!1753 = !DILocalVariable(name: "cr", scope: !1737, file: !902, line: 62, type: !1024)
!1754 = !DILocation(line: 62, column: 18, scope: !1737)
!1755 = !DILocation(line: 62, column: 35, scope: !1737)
!1756 = !DILocation(line: 62, column: 39, scope: !1737)
!1757 = !DILocation(line: 62, column: 42, scope: !1737)
!1758 = !DILocation(line: 62, column: 37, scope: !1737)
!1759 = !DILocation(line: 62, column: 24, scope: !1737)
!1760 = !DILocation(line: 62, column: 27, scope: !1737)
!1761 = !DILocation(line: 63, column: 16, scope: !1762)
!1762 = distinct !DILexicalBlock(scope: !1737, file: !902, line: 63, column: 9)
!1763 = !DILocation(line: 63, column: 14, scope: !1762)
!1764 = !DILocation(line: 63, column: 21, scope: !1765)
!1765 = !DILexicalBlockFile(scope: !1766, file: !902, discriminator: 1)
!1766 = distinct !DILexicalBlock(scope: !1762, file: !902, line: 63, column: 9)
!1767 = !DILocation(line: 63, column: 25, scope: !1765)
!1768 = !DILocation(line: 63, column: 32, scope: !1765)
!1769 = !DILocation(line: 63, column: 23, scope: !1765)
!1770 = !DILocation(line: 63, column: 9, scope: !1765)
!1771 = !DILocation(line: 64, column: 24, scope: !1772)
!1772 = distinct !DILexicalBlock(scope: !1766, file: !902, line: 63, column: 47)
!1773 = !DILocation(line: 64, column: 40, scope: !1772)
!1774 = !DILocation(line: 64, column: 45, scope: !1772)
!1775 = !DILocation(line: 64, column: 23, scope: !1772)
!1776 = !DILocation(line: 64, column: 13, scope: !1772)
!1777 = !DILocation(line: 64, column: 21, scope: !1772)
!1778 = !DILocation(line: 65, column: 24, scope: !1772)
!1779 = !DILocation(line: 65, column: 40, scope: !1772)
!1780 = !DILocation(line: 65, column: 45, scope: !1772)
!1781 = !DILocation(line: 65, column: 23, scope: !1772)
!1782 = !DILocation(line: 65, column: 13, scope: !1772)
!1783 = !DILocation(line: 65, column: 21, scope: !1772)
!1784 = !DILocation(line: 66, column: 24, scope: !1772)
!1785 = !DILocation(line: 66, column: 40, scope: !1772)
!1786 = !DILocation(line: 66, column: 45, scope: !1772)
!1787 = !DILocation(line: 66, column: 23, scope: !1772)
!1788 = !DILocation(line: 66, column: 13, scope: !1772)
!1789 = !DILocation(line: 66, column: 21, scope: !1772)
!1790 = !DILocation(line: 67, column: 24, scope: !1772)
!1791 = !DILocation(line: 67, column: 40, scope: !1772)
!1792 = !DILocation(line: 67, column: 45, scope: !1772)
!1793 = !DILocation(line: 67, column: 23, scope: !1772)
!1794 = !DILocation(line: 67, column: 13, scope: !1772)
!1795 = !DILocation(line: 67, column: 21, scope: !1772)
!1796 = !DILocation(line: 68, column: 18, scope: !1772)
!1797 = !DILocation(line: 69, column: 23, scope: !1772)
!1798 = !DILocation(line: 69, column: 40, scope: !1772)
!1799 = !DILocation(line: 69, column: 17, scope: !1772)
!1800 = !DILocation(line: 69, column: 21, scope: !1772)
!1801 = !DILocation(line: 70, column: 23, scope: !1772)
!1802 = !DILocation(line: 70, column: 40, scope: !1772)
!1803 = !DILocation(line: 70, column: 17, scope: !1772)
!1804 = !DILocation(line: 70, column: 21, scope: !1772)
!1805 = !DILocation(line: 71, column: 9, scope: !1772)
!1806 = !DILocation(line: 63, column: 41, scope: !1807)
!1807 = !DILexicalBlockFile(scope: !1766, file: !902, discriminator: 2)
!1808 = !DILocation(line: 63, column: 9, scope: !1807)
!1809 = distinct !{!1809, !1810}
!1810 = !DILocation(line: 63, column: 9, scope: !1737)
!1811 = !DILocation(line: 72, column: 5, scope: !1737)
!1812 = !DILocation(line: 59, column: 37, scope: !1813)
!1813 = !DILexicalBlockFile(scope: !1731, file: !902, discriminator: 2)
!1814 = !DILocation(line: 59, column: 5, scope: !1813)
!1815 = distinct !{!1815, !1816}
!1816 = !DILocation(line: 59, column: 5, scope: !1642)
!1817 = !DILocation(line: 74, column: 6, scope: !1642)
!1818 = !DILocation(line: 74, column: 16, scope: !1642)
!1819 = !DILocation(line: 76, column: 12, scope: !1642)
!1820 = !DILocation(line: 76, column: 5, scope: !1642)
!1821 = !DILocation(line: 77, column: 1, scope: !1642)
!1822 = distinct !DISubprogram(name: "init_get_bits", scope: !1661, file: !1661, line: 615, type: !1823, isLocal: true, isDefinition: true, scopeLine: 617, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1634)
!1823 = !DISubroutineType(types: !1824)
!1824 = !{!888, !1825, !1441, !888}
!1825 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1660, size: 64, align: 64)
!1826 = !DILocalVariable(name: "s", arg: 1, scope: !1822, file: !1661, line: 615, type: !1825)
!1827 = !DILocation(line: 615, column: 48, scope: !1822)
!1828 = !DILocalVariable(name: "buffer", arg: 2, scope: !1822, file: !1661, line: 615, type: !1441)
!1829 = !DILocation(line: 615, column: 66, scope: !1822)
!1830 = !DILocalVariable(name: "bit_size", arg: 3, scope: !1822, file: !1661, line: 616, type: !888)
!1831 = !DILocation(line: 616, column: 37, scope: !1822)
!1832 = !DILocalVariable(name: "buffer_size", scope: !1822, file: !1661, line: 618, type: !888)
!1833 = !DILocation(line: 618, column: 9, scope: !1822)
!1834 = !DILocalVariable(name: "ret", scope: !1822, file: !1661, line: 619, type: !888)
!1835 = !DILocation(line: 619, column: 9, scope: !1822)
!1836 = !DILocation(line: 621, column: 9, scope: !1837)
!1837 = distinct !DILexicalBlock(scope: !1822, file: !1661, line: 621, column: 9)
!1838 = !DILocation(line: 621, column: 18, scope: !1837)
!1839 = !DILocation(line: 621, column: 64, scope: !1837)
!1840 = !DILocation(line: 621, column: 67, scope: !1841)
!1841 = !DILexicalBlockFile(scope: !1837, file: !1661, discriminator: 1)
!1842 = !DILocation(line: 621, column: 76, scope: !1841)
!1843 = !DILocation(line: 621, column: 80, scope: !1841)
!1844 = !DILocation(line: 621, column: 84, scope: !1845)
!1845 = !DILexicalBlockFile(scope: !1837, file: !1661, discriminator: 2)
!1846 = !DILocation(line: 621, column: 9, scope: !1845)
!1847 = !DILocation(line: 622, column: 18, scope: !1848)
!1848 = distinct !DILexicalBlock(scope: !1837, file: !1661, line: 621, column: 92)
!1849 = !DILocation(line: 623, column: 16, scope: !1848)
!1850 = !DILocation(line: 624, column: 13, scope: !1848)
!1851 = !DILocation(line: 625, column: 5, scope: !1848)
!1852 = !DILocation(line: 627, column: 20, scope: !1822)
!1853 = !DILocation(line: 627, column: 29, scope: !1822)
!1854 = !DILocation(line: 627, column: 34, scope: !1822)
!1855 = !DILocation(line: 627, column: 17, scope: !1822)
!1856 = !DILocation(line: 629, column: 17, scope: !1822)
!1857 = !DILocation(line: 629, column: 5, scope: !1822)
!1858 = !DILocation(line: 629, column: 8, scope: !1822)
!1859 = !DILocation(line: 629, column: 15, scope: !1822)
!1860 = !DILocation(line: 630, column: 23, scope: !1822)
!1861 = !DILocation(line: 630, column: 5, scope: !1822)
!1862 = !DILocation(line: 630, column: 8, scope: !1822)
!1863 = !DILocation(line: 630, column: 21, scope: !1822)
!1864 = !DILocation(line: 631, column: 29, scope: !1822)
!1865 = !DILocation(line: 631, column: 38, scope: !1822)
!1866 = !DILocation(line: 631, column: 5, scope: !1822)
!1867 = !DILocation(line: 631, column: 8, scope: !1822)
!1868 = !DILocation(line: 631, column: 27, scope: !1822)
!1869 = !DILocation(line: 632, column: 21, scope: !1822)
!1870 = !DILocation(line: 632, column: 30, scope: !1822)
!1871 = !DILocation(line: 632, column: 28, scope: !1822)
!1872 = !DILocation(line: 632, column: 5, scope: !1822)
!1873 = !DILocation(line: 632, column: 8, scope: !1822)
!1874 = !DILocation(line: 632, column: 19, scope: !1822)
!1875 = !DILocation(line: 633, column: 5, scope: !1822)
!1876 = !DILocation(line: 633, column: 8, scope: !1822)
!1877 = !DILocation(line: 633, column: 14, scope: !1822)
!1878 = !DILocation(line: 639, column: 12, scope: !1822)
!1879 = !DILocation(line: 639, column: 5, scope: !1822)
!1880 = distinct !DISubprogram(name: "get_bits", scope: !1661, file: !1661, line: 381, type: !1881, isLocal: true, isDefinition: true, scopeLine: 382, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1634)
!1881 = !DISubroutineType(types: !1882)
!1882 = !{!889, !1825, !888}
!1883 = !DILocalVariable(name: "x", arg: 1, scope: !1884, file: !1885, line: 66, type: !896)
!1884 = distinct !DISubprogram(name: "av_bswap32", scope: !1885, file: !1885, line: 66, type: !1886, isLocal: true, isDefinition: true, scopeLine: 67, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1634)
...
!1889 = distinct !DILocation(line: 401, column: 16, scope: !1880)
!1890 = !DILocalVariable(name: "s", arg: 1, scope: !1880, file: !1661, line: 381, type: !1825)
!1891 = !DILocation(line: 381, column: 52, scope: !1880)
!1892 = !DILocalVariable(name: "n", arg: 2, scope: !1880, file: !1661, line: 381, type: !888)
!1893 = !DILocation(line: 381, column: 59, scope: !1880)
!1894 = !DILocalVariable(name: "tmp", scope: !1880, file: !1661, line: 383, type: !888)
!1895 = !DILocation(line: 383, column: 18, scope: !1880)
!1896 = !DILocalVariable(name: "re_index", scope: !1880, file: !1661, line: 399, type: !889)
!1897 = !DILocation(line: 399, column: 18, scope: !1880)
!1898 = !DILocation(line: 399, column: 30, scope: !1880)
!1899 = !DILocation(line: 399, column: 34, scope: !1880)
!1900 = !DILocalVariable(name: "re_cache", scope: !1880, file: !1661, line: 399, type: !889)
!1901 = !DILocation(line: 399, column: 78, scope: !1880)
!1902 = !DILocalVariable(name: "re_size_plus8", scope: !1880, file: !1661, line: 399, type: !889)
!1903 = !DILocation(line: 399, column: 101, scope: !1880)
!1904 = !DILocation(line: 399, column: 118, scope: !1880)
!1905 = !DILocation(line: 399, column: 122, scope: !1880)
!1906 = !DILocation(line: 401, column: 60, scope: !1880)
!1907 = !DILocation(line: 401, column: 64, scope: !1880)
!1908 = !DILocation(line: 401, column: 74, scope: !1880)
!1909 = !DILocation(line: 401, column: 83, scope: !1880)
!1910 = !DILocation(line: 401, column: 71, scope: !1880)
!1911 = !DILocation(line: 401, column: 92, scope: !1880)
!1912 = !DILocation(line: 401, column: 16, scope: !1880)
!1913 = !DILocation(line: 68, column: 16, scope: !1884, inlinedAt: !1889)
!1914 = !DILocation(line: 68, column: 19, scope: !1884, inlinedAt: !1889)
!1915 = !DILocation(line: 68, column: 24, scope: !1884, inlinedAt: !1889)
!1916 = !DILocation(line: 68, column: 38, scope: !1884, inlinedAt: !1889)
!1917 = !DILocation(line: 68, column: 41, scope: !1884, inlinedAt: !1889)
!1918 = !DILocation(line: 68, column: 46, scope: !1884, inlinedAt: !1889)
!1919 = !DILocation(line: 68, column: 34, scope: !1884, inlinedAt: !1889)
!1920 = !DILocation(line: 68, column: 57, scope: !1884, inlinedAt: !1889)
!1921 = !DILocation(line: 68, column: 69, scope: !1884, inlinedAt: !1889)
!1922 = !DILocation(line: 68, column: 72, scope: !1884, inlinedAt: !1889)
!1923 = !DILocation(line: 68, column: 79, scope: !1884, inlinedAt: !1889)
!1924 = !DILocation(line: 68, column: 84, scope: !1884, inlinedAt: !1889)
!1925 = !DILocation(line: 68, column: 99, scope: !1884, inlinedAt: !1889)
!1926 = !DILocation(line: 68, column: 102, scope: !1884, inlinedAt: !1889)
!1927 = !DILocation(line: 68, column: 109, scope: !1884, inlinedAt: !1889)
!1928 = !DILocation(line: 68, column: 114, scope: !1884, inlinedAt: !1889)
!1929 = !DILocation(line: 68, column: 94, scope: !1884, inlinedAt: !1889)
!1930 = !DILocation(line: 68, column: 63, scope: !1884, inlinedAt: !1889)
!1931 = !DILocation(line: 401, column: 100, scope: !1880)
!1932 = !DILocation(line: 401, column: 109, scope: !1880)
!1933 = !DILocation(line: 401, column: 96, scope: !1880)
!1934 = !DILocation(line: 401, column: 14, scope: !1880)
!1935 = !DILocation(line: 402, column: 21, scope: !1880)
!1936 = !DILocation(line: 402, column: 31, scope: !1880)
!1937 = !DILocation(line: 402, column: 11, scope: !1880)
!1938 = !DILocation(line: 402, column: 9, scope: !1880)
!1939 = !DILocation(line: 403, column: 18, scope: !1880)
!1940 = !DILocation(line: 403, column: 36, scope: !1880)
!1941 = !DILocation(line: 403, column: 48, scope: !1880)
!1942 = !DILocation(line: 403, column: 45, scope: !1880)
!1943 = !DILocation(line: 403, column: 33, scope: !1880)
!1944 = !DILocation(line: 403, column: 17, scope: !1880)
!1945 = !DILocation(line: 403, column: 55, scope: !1946)
!1946 = !DILexicalBlockFile(scope: !1880, file: !1661, discriminator: 1)
!1947 = !DILocation(line: 403, column: 67, scope: !1946)
!1948 = !DILocation(line: 403, column: 64, scope: !1946)
!1949 = !DILocation(line: 403, column: 17, scope: !1946)
!1950 = !DILocation(line: 403, column: 74, scope: !1951)
!1951 = !DILexicalBlockFile(scope: !1880, file: !1661, discriminator: 2)
!1952 = !DILocation(line: 403, column: 17, scope: !1951)
!1953 = !DILocation(line: 403, column: 17, scope: !1954)
!1954 = !DILexicalBlockFile(scope: !1880, file: !1661, discriminator: 3)
!1955 = !DILocation(line: 403, column: 14, scope: !1954)
!1956 = !DILocation(line: 404, column: 18, scope: !1880)
!1957 = !DILocation(line: 404, column: 6, scope: !1880)
!1958 = !DILocation(line: 404, column: 10, scope: !1880)
!1959 = !DILocation(line: 404, column: 16, scope: !1880)
!1960 = !DILocation(line: 406, column: 12, scope: !1880)
!1961 = !DILocation(line: 406, column: 5, scope: !1880)
!1962 = distinct !DISubprogram(name: "NEG_USR32", scope: !1963, file: !1963, line: 124, type: !1964, isLocal: true, isDefinition: true, scopeLine: 124, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1634)
!1963 = !DIFile(filename: "libavcodec/x86/mathops.h", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a")
!1964 = !DISubroutineType(types: !1965)
!1965 = !{!896, !896, !1103}
!1966 = !DILocalVariable(name: "a", arg: 1, scope: !1962, file: !1963, line: 124, type: !896)
!1967 = !DILocation(line: 124, column: 43, scope: !1962)
!1968 = !DILocalVariable(name: "s", arg: 2, scope: !1962, file: !1963, line: 124, type: !1103)
!1969 = !DILocation(line: 124, column: 53, scope: !1962)
!1970 = !DILocation(line: 125, column: 5, scope: !1962)
!1971 = !DILocation(line: 127, column: 29, scope: !1962)
!1972 = !DILocation(line: 127, column: 28, scope: !1962)
!1973 = !DILocation(line: 127, column: 18, scope: !1962)
!1974 = !{i32 178627, i32 178641}
!1975 = !DILocation(line: 129, column: 12, scope: !1962)
!1976 = !DILocation(line: 129, column: 5, scope: !1962)
