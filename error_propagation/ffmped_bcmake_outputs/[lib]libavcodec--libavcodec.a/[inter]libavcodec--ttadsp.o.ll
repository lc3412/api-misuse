; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a/[inter]libavcodec--ttadsp.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a/[inter]libavcodec--ttadsp.o.i"
...
define void @ff_ttadsp_init(%struct.TTADSPContext* %c) #0 !dbg !6 {
entry:
  ...
  %0 = load %struct.TTADSPContext*, %struct.TTADSPContext** %c.addr, align 8, !dbg !26
  %filter_process = getelementptr inbounds %struct.TTADSPContext, %struct.TTADSPContext* %0, i32 0, i32 0, !dbg !27
  store void (i32*, i32*, i32*, i32*, i32*, i32, i32)* @tta_filter_process_c, void (i32*, i32*, i32*, i32*, i32*, i32, i32)** %filter_process, align 8, !dbg !28
  %1 = load %struct.TTADSPContext*, %struct.TTADSPContext** %c.addr, align 8, !dbg !29
  call void @ff_ttadsp_init_x86(%struct.TTADSPContext* %1), !dbg !31
  ret void, !dbg !32
}
...
define internal void @tta_filter_process_c(i32* %qm, i32* %dx, i32* %dl, i32* %error, i32* %in, i32 %shift, i32 %round) #2 !dbg !33 {
entry:
...
if.end48:                                         ; preds = %if.end, %if.then
  ...
  %137 = load i32*, i32** %in.addr, align 8, !dbg !189
  %138 = load i32, i32* %137, align 4, !dbg !190
  %139 = load i32*, i32** %error.addr, align 8, !dbg !191
  store i32 %138, i32* %139, align 4, !dbg !192
  %140 = load i32, i32* %round.addr, align 4, !dbg !193
  %141 = load i32, i32* %shift.addr, align 4, !dbg !194
  %shr112 = ashr i32 %140, %141, !dbg !195
  %142 = load i32*, i32** %in.addr, align 8, !dbg !196
  %143 = load i32, i32* %142, align 4, !dbg !197
  %add113 = add nsw i32 %143, %shr112, !dbg !197
  store i32 %add113, i32* %142, align 4, !dbg !197
  %144 = load i32*, i32** %dl.addr, align 8, !dbg !198
  %arrayidx114 = getelementptr inbounds i32, i32* %144, i64 5, !dbg !198
  %145 = load i32, i32* %arrayidx114, align 4, !dbg !198
  %sub115 = sub nsw i32 0, %145, !dbg !199
  %146 = load i32*, i32** %dl.addr, align 8, !dbg !200
  %arrayidx116 = getelementptr inbounds i32, i32* %146, i64 4, !dbg !200
  store i32 %sub115, i32* %arrayidx116, align 4, !dbg !201
  %147 = load i32*, i32** %dl.addr, align 8, !dbg !202
  %arrayidx117 = getelementptr inbounds i32, i32* %147, i64 6, !dbg !202
  %148 = load i32, i32* %arrayidx117, align 4, !dbg !202
  %sub118 = sub nsw i32 0, %148, !dbg !203
  %149 = load i32*, i32** %dl.addr, align 8, !dbg !204
  %arrayidx119 = getelementptr inbounds i32, i32* %149, i64 5, !dbg !204
  store i32 %sub118, i32* %arrayidx119, align 4, !dbg !205
  %150 = load i32*, i32** %in.addr, align 8, !dbg !206
  %151 = load i32, i32* %150, align 4, !dbg !207
  %152 = load i32*, i32** %dl.addr, align 8, !dbg !208
  %arrayidx120 = getelementptr inbounds i32, i32* %152, i64 7, !dbg !208
  %153 = load i32, i32* %arrayidx120, align 4, !dbg !208
  %sub121 = sub nsw i32 %151, %153, !dbg !209
  %154 = load i32*, i32** %dl.addr, align 8, !dbg !210
  %arrayidx122 = getelementptr inbounds i32, i32* %154, i64 6, !dbg !210
  store i32 %sub121, i32* %arrayidx122, align 4, !dbg !211
  %155 = load i32*, i32** %in.addr, align 8, !dbg !212
  %156 = load i32, i32* %155, align 4, !dbg !213
  %157 = load i32*, i32** %dl.addr, align 8, !dbg !214
  %arrayidx123 = getelementptr inbounds i32, i32* %157, i64 7, !dbg !214
  store i32 %156, i32* %arrayidx123, align 4, !dbg !215
  %158 = load i32*, i32** %dl.addr, align 8, !dbg !216
  %arrayidx124 = getelementptr inbounds i32, i32* %158, i64 6, !dbg !216
  %159 = load i32, i32* %arrayidx124, align 4, !dbg !216
  %160 = load i32*, i32** %dl.addr, align 8, !dbg !217
  %arrayidx125 = getelementptr inbounds i32, i32* %160, i64 5, !dbg !217
  %161 = load i32, i32* %arrayidx125, align 4, !dbg !218
  %add126 = add nsw i32 %161, %159, !dbg !218
  store i32 %add126, i32* %arrayidx125, align 4, !dbg !218
  %162 = load i32*, i32** %dl.addr, align 8, !dbg !219
  %arrayidx127 = getelementptr inbounds i32, i32* %162, i64 5, !dbg !219
  %163 = load i32, i32* %arrayidx127, align 4, !dbg !219
  %164 = load i32*, i32** %dl.addr, align 8, !dbg !220
  %arrayidx128 = getelementptr inbounds i32, i32* %164, i64 4, !dbg !220
  %165 = load i32, i32* %arrayidx128, align 4, !dbg !221
  %add129 = add nsw i32 %165, %163, !dbg !221
  store i32 %add129, i32* %arrayidx128, align 4, !dbg !221
  ret void, !dbg !222
}

declare void @ff_ttadsp_init_x86(%struct.TTADSPContext*) #3
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a/[inter]libavcodec--ttadsp.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{!"clang version 3.9.0 (tags/RELEASE_390/final)"}
!6 = distinct !DISubprogram(name: "ff_ttadsp_init", scope: !7, file: !7, line: 53, type: !8, isLocal: false, isDefinition: true, scopeLine: 54, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!7 = !DIFile(filename: "libavcodec/ttadsp.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a")
!8 = !DISubroutineType(types: !9)
!9 = !{null, !10}
!10 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !11, size: 64, align: 64)
!11 = !DIDerivedType(tag: DW_TAG_typedef, name: "TTADSPContext", file: !12, line: 28, baseType: !13)
!12 = !DIFile(filename: "libavcodec/ttadsp.h", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a")
...
!29 = !DILocation(line: 58, column: 28, scope: !30)
...
!33 = distinct !DISubprogram(name: "tta_filter_process_c", scope: !7, file: !7, line: 23, type: !17, isLocal: true, isDefinition: true, scopeLine: 25, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!34 = !DILocalVariable(name: "qm", arg: 1, scope: !33, file: !7, line: 23, type: !19)
!35 = !DILocation(line: 23, column: 43, scope: !33)
!36 = !DILocalVariable(name: "dx", arg: 2, scope: !33, file: !7, line: 23, type: !19)
!37 = !DILocation(line: 23, column: 56, scope: !33)
!38 = !DILocalVariable(name: "dl", arg: 3, scope: !33, file: !7, line: 23, type: !19)
!39 = !DILocation(line: 23, column: 69, scope: !33)
!40 = !DILocalVariable(name: "error", arg: 4, scope: !33, file: !7, line: 24, type: !19)
!41 = !DILocation(line: 24, column: 43, scope: !33)
!42 = !DILocalVariable(name: "in", arg: 5, scope: !33, file: !7, line: 24, type: !19)
!43 = !DILocation(line: 24, column: 59, scope: !33)
!44 = !DILocalVariable(name: "shift", arg: 6, scope: !33, file: !7, line: 24, type: !20)
!45 = !DILocation(line: 24, column: 71, scope: !33)
!46 = !DILocalVariable(name: "round", arg: 7, scope: !33, file: !7, line: 25, type: !20)
!47 = !DILocation(line: 25, column: 42, scope: !33)
...
!189 = !DILocation(line: 45, column: 15, scope: !33)
!190 = !DILocation(line: 45, column: 14, scope: !33)
!191 = !DILocation(line: 45, column: 6, scope: !33)
!192 = !DILocation(line: 45, column: 12, scope: !33)
!193 = !DILocation(line: 46, column: 13, scope: !33)
!194 = !DILocation(line: 46, column: 22, scope: !33)
!195 = !DILocation(line: 46, column: 19, scope: !33)
!196 = !DILocation(line: 46, column: 6, scope: !33)
!197 = !DILocation(line: 46, column: 9, scope: !33)
!198 = !DILocation(line: 48, column: 14, scope: !33)
!199 = !DILocation(line: 48, column: 13, scope: !33)
!200 = !DILocation(line: 48, column: 5, scope: !33)
!201 = !DILocation(line: 48, column: 11, scope: !33)
!202 = !DILocation(line: 48, column: 30, scope: !33)
!203 = !DILocation(line: 48, column: 29, scope: !33)
!204 = !DILocation(line: 48, column: 21, scope: !33)
!205 = !DILocation(line: 48, column: 27, scope: !33)
!206 = !DILocation(line: 49, column: 14, scope: !33)
!207 = !DILocation(line: 49, column: 13, scope: !33)
!208 = !DILocation(line: 49, column: 19, scope: !33)
!209 = !DILocation(line: 49, column: 17, scope: !33)
!210 = !DILocation(line: 49, column: 5, scope: !33)
!211 = !DILocation(line: 49, column: 11, scope: !33)
!212 = !DILocation(line: 49, column: 35, scope: !33)
!213 = !DILocation(line: 49, column: 34, scope: !33)
!214 = !DILocation(line: 49, column: 26, scope: !33)
!215 = !DILocation(line: 49, column: 32, scope: !33)
!216 = !DILocation(line: 50, column: 14, scope: !33)
!217 = !DILocation(line: 50, column: 5, scope: !33)
!218 = !DILocation(line: 50, column: 11, scope: !33)
!219 = !DILocation(line: 50, column: 30, scope: !33)
!220 = !DILocation(line: 50, column: 21, scope: !33)
!221 = !DILocation(line: 50, column: 27, scope: !33)
