; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a/[inter]libavcodec--hcom.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a/[inter]libavcodec--hcom.o.i"
...
%struct.HCOMContext = type { %struct.AVCodecContext*, i8, i8, i32, i32, i32, %struct.HEntry* }
...
@ff_hcom_decoder = global %struct.AVCodec { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 1, i32 88085, i32 2, %struct.AVRational* null, i32* null, i32* null, i32* null, i64* null, i8 0, %struct.AVClass* null, %struct.AVProfile* null, i8* null, i32 32, %struct.AVCodec* null, i32 (%struct.AVCodecContext*)* null, i32 (%struct.AVCodecContext*, %struct.AVCodecContext*)* null, %struct.AVCodecDefault* null, void (%struct.AVCodec*)* null, i32 (%struct.AVCodecContext*)* @hcom_init, i32 (%struct.AVCodecContext*, i8*, i32, %struct.AVSubtitle*)* null, i32 (%struct.AVCodecContext*, %struct.AVPacket*, %struct.AVFrame*, i32*)* null, i32 (%struct.AVCodecContext*, i8*, i32*, %struct.AVPacket*)* @hcom_decode, i32 (%struct.AVCodecContext*)* @hcom_close, i32 (%struct.AVCodecContext*, %struct.AVFrame*)* null, i32 (%struct.AVCodecContext*, %struct.AVPacket*)* null, i32 (%struct.AVCodecContext*, %struct.AVFrame*)* null, void (%struct.AVCodecContext*)* null, i32 0, i8* null, %struct.AVCodecHWConfigInternal** null }, align 8
@.str.2 = private unnamed_addr constant [28 x i8] c"invalid number of channels\0A\00", align 1

; Function Attrs: cold nounwind optsize uwtable
define internal i32 @hcom_init(%struct.AVCodecContext* %avctx) #0 !dbg !1638 {
entry:
  %x.addr.i59 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %x.addr.i59, metadata !1640, metadata !1645), !dbg !1646
  %x.addr.i52 = alloca i16, align 2
  call void @llvm.dbg.declare(metadata i16* %x.addr.i52, metadata !1648, metadata !1645), !dbg !1652
  %x.addr.i45 = alloca i16, align 2
  call void @llvm.dbg.declare(metadata i16* %x.addr.i45, metadata !1648, metadata !1645), !dbg !1657
  %x.addr.i = alloca i16, align 2
  call void @llvm.dbg.declare(metadata i16* %x.addr.i, metadata !1648, metadata !1645), !dbg !1659
  %retval = alloca i32, align 4
  %avctx.addr = alloca %struct.AVCodecContext*, align 8
  %s = alloca %struct.HCOMContext*, align 8
  %i = alloca i32, align 4
  store %struct.AVCodecContext* %avctx, %struct.AVCodecContext** %avctx.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVCodecContext** %avctx.addr, metadata !1661, metadata !1645), !dbg !1662
  call void @llvm.dbg.declare(metadata %struct.HCOMContext** %s, metadata !1663, metadata !1645), !dbg !1683
  ...
  %2 = bitcast i8* %1 to %struct.HCOMContext*, !dbg !1684
  store %struct.HCOMContext* %2, %struct.HCOMContext** %s, align 8, !dbg !1683
  %3 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1686
  %channels = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %3, i32 0, i32 83, !dbg !1688
  %4 = load i32, i32* %channels, align 4, !dbg !1688
  %cmp = icmp ne i32 %4, 1, !dbg !1689
...
if.then:                                          ; preds = %entry
  ...
  %6 = bitcast %struct.AVCodecContext* %5 to i8*, !dbg !1691
  call void (i8*, i32, i8*, ...) @av_log(i8* %6, i32 16, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.2, i32 0, i32 0)), !dbg !1693
  store i32 -1094995529, i32* %retval, align 4, !dbg !1694
  br label %return, !dbg !1694

if.end:                                           ; preds = %entry
  %7 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1695
  ...
  %cmp1 = icmp sle i32 %8, 7, !dbg !1698
  br i1 %cmp1, label %if.then2, label %if.end3, !dbg !1699

if.then2:                                         ; preds = %if.end
  store i32 -1094995529, i32* %retval, align 4, !dbg !1700
  br label %return, !dbg !1700

if.end3:                                          ; preds = %if.end
  %9 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1701
  %extradata = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %9, i32 0, i32 15, !dbg !1702
  %10 = load i8*, i8** %extradata, align 8, !dbg !1702
  %11 = bitcast i8* %10 to %union.unaligned_16*, !dbg !1703
  %l = bitcast %union.unaligned_16* %11 to i16*, !dbg !1703
  %12 = load i16, i16* %l, align 1, !dbg !1703
  store i16 %12, i16* %x.addr.i, align 2, !dbg !1704
  %13 = load i16, i16* %x.addr.i, align 2, !dbg !1705
  %conv.i = zext i16 %13 to i32, !dbg !1705
  %shr.i = ashr i32 %conv.i, 8, !dbg !1706
  %14 = load i16, i16* %x.addr.i, align 2, !dbg !1707
  %conv1.i = zext i16 %14 to i32, !dbg !1707
  %shl.i = shl i32 %conv1.i, 8, !dbg !1708
  %or.i = or i32 %shr.i, %shl.i, !dbg !1709
  %conv2.i = trunc i32 %or.i to i16, !dbg !1710
  store i16 %conv2.i, i16* %x.addr.i, align 2, !dbg !1711
  %15 = load i16, i16* %x.addr.i, align 2, !dbg !1712
  %conv = zext i16 %15 to i32, !dbg !1704
  %16 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1713
  %dict_entries = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %16, i32 0, i32 3, !dbg !1714
  store i32 %conv, i32* %dict_entries, align 4, !dbg !1715
  %17 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1716
  %extradata_size4 = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %17, i32 0, i32 16, !dbg !1718
  %18 = load i32, i32* %extradata_size4, align 8, !dbg !1718
  %19 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1719
  %dict_entries5 = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %19, i32 0, i32 3, !dbg !1720
  %20 = load i32, i32* %dict_entries5, align 4, !dbg !1720
  %mul = mul nsw i32 %20, 4, !dbg !1721
  %add = add nsw i32 %mul, 7, !dbg !1722
  %cmp6 = icmp slt i32 %18, %add, !dbg !1723
  br i1 %cmp6, label %if.then8, label %if.end9, !dbg !1724
...
if.end9:                                          ; preds = %if.end3
  %21 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1726
  %extradata10 = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %21, i32 0, i32 15, !dbg !1727
  %22 = load i8*, i8** %extradata10, align 8, !dbg !1727
  %add.ptr = getelementptr inbounds i8, i8* %22, i64 2, !dbg !1728
  %23 = bitcast i8* %add.ptr to %union.unaligned_32*, !dbg !1729
  %l11 = bitcast %union.unaligned_32* %23 to i32*, !dbg !1729
  %24 = load i32, i32* %l11, align 1, !dbg !1729
  store i32 %24, i32* %x.addr.i59, align 4, !dbg !1730
  %25 = load i32, i32* %x.addr.i59, align 4, !dbg !1731
  %shl.i60 = shl i32 %25, 8, !dbg !1732
  %and.i = and i32 %shl.i60, 65280, !dbg !1733
  %26 = load i32, i32* %x.addr.i59, align 4, !dbg !1734
  %shr.i61 = lshr i32 %26, 8, !dbg !1735
  %and1.i = and i32 %shr.i61, 255, !dbg !1736
  %or.i62 = or i32 %and.i, %and1.i, !dbg !1737
  %shl2.i = shl i32 %or.i62, 16, !dbg !1738
  %27 = load i32, i32* %x.addr.i59, align 4, !dbg !1739
  %shr3.i = lshr i32 %27, 16, !dbg !1740
  %shl4.i = shl i32 %shr3.i, 8, !dbg !1741
  %and5.i = and i32 %shl4.i, 65280, !dbg !1742
  %28 = load i32, i32* %x.addr.i59, align 4, !dbg !1743
  %shr6.i = lshr i32 %28, 16, !dbg !1744
  %shr7.i = lshr i32 %shr6.i, 8, !dbg !1745
  %and8.i = and i32 %shr7.i, 255, !dbg !1746
  %or9.i = or i32 %and5.i, %and8.i, !dbg !1747
  %or10.i = or i32 %shl2.i, %or9.i, !dbg !1748
  %29 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1749
  %delta_compression = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %29, i32 0, i32 5, !dbg !1750
  store i32 %or10.i, i32* %delta_compression, align 4, !dbg !1751
  %30 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1752
  %extradata_size13 = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %30, i32 0, i32 16, !dbg !1753
  %31 = load i32, i32* %extradata_size13, align 8, !dbg !1753
  %sub = sub nsw i32 %31, 1, !dbg !1754
  %idxprom = sext i32 %sub to i64, !dbg !1755
  %32 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1755
  %extradata14 = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %32, i32 0, i32 15, !dbg !1756
  %33 = load i8*, i8** %extradata14, align 8, !dbg !1756
  %arrayidx = getelementptr inbounds i8, i8* %33, i64 %idxprom, !dbg !1755
  %34 = load i8, i8* %arrayidx, align 1, !dbg !1755
  %35 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1757
  %first_sample = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %35, i32 0, i32 1, !dbg !1758
  store i8 %34, i8* %first_sample, align 8, !dbg !1759
  %36 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1760
  %sample = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %36, i32 0, i32 2, !dbg !1761
  store i8 %34, i8* %sample, align 1, !dbg !1762
  %37 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1763
  %dict_entries15 = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %37, i32 0, i32 3, !dbg !1764
  %38 = load i32, i32* %dict_entries15, align 4, !dbg !1764
  %conv16 = sext i32 %38 to i64, !dbg !1763
  %call17 = call noalias i8* @av_calloc(i64 %conv16, i64 4), !dbg !1765
  %39 = bitcast i8* %call17 to %struct.HEntry*, !dbg !1765
  %40 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1766
  %dict = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %40, i32 0, i32 6, !dbg !1767
  store %struct.HEntry* %39, %struct.HEntry** %dict, align 8, !dbg !1768
  %41 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1769
  %dict18 = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %41, i32 0, i32 6, !dbg !1771
  %42 = load %struct.HEntry*, %struct.HEntry** %dict18, align 8, !dbg !1771
  %tobool = icmp ne %struct.HEntry* %42, null, !dbg !1769
  br i1 %tobool, label %if.end20, label %if.then19, !dbg !1772
...
if.end20:                                         ; preds = %if.end9
  call void @llvm.dbg.declare(metadata i32* %i, metadata !1774, metadata !1645), !dbg !1775
  store i32 0, i32* %i, align 4, !dbg !1775
  br label %for.cond, !dbg !1776

for.cond:                                         ; preds = %for.inc, %if.end20
  %43 = load i32, i32* %i, align 4, !dbg !1777
  %44 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1779
  %dict_entries21 = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %44, i32 0, i32 3, !dbg !1780
  %45 = load i32, i32* %dict_entries21, align 4, !dbg !1780
  %cmp22 = icmp slt i32 %43, %45, !dbg !1781
  br i1 %cmp22, label %for.body, label %for.end, !dbg !1782

for.body:                                         ; preds = %for.cond
  %46 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1783
  %extradata24 = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %46, i32 0, i32 15, !dbg !1784
  %47 = load i8*, i8** %extradata24, align 8, !dbg !1784
  %add.ptr25 = getelementptr inbounds i8, i8* %47, i64 6, !dbg !1785
  %48 = load i32, i32* %i, align 4, !dbg !1786
  %mul26 = mul nsw i32 4, %48, !dbg !1787
  %idx.ext = sext i32 %mul26 to i64, !dbg !1788
  %add.ptr27 = getelementptr inbounds i8, i8* %add.ptr25, i64 %idx.ext, !dbg !1788
  %49 = bitcast i8* %add.ptr27 to %union.unaligned_16*, !dbg !1789
  %l28 = bitcast %union.unaligned_16* %49 to i16*, !dbg !1789
  %50 = load i16, i16* %l28, align 1, !dbg !1789
  store i16 %50, i16* %x.addr.i52, align 2, !dbg !1790
  %51 = load i16, i16* %x.addr.i52, align 2, !dbg !1791
  %conv.i53 = zext i16 %51 to i32, !dbg !1791
  %shr.i54 = ashr i32 %conv.i53, 8, !dbg !1792
  %52 = load i16, i16* %x.addr.i52, align 2, !dbg !1793
  %conv1.i55 = zext i16 %52 to i32, !dbg !1793
  %shl.i56 = shl i32 %conv1.i55, 8, !dbg !1794
  %or.i57 = or i32 %shr.i54, %shl.i56, !dbg !1795
  %conv2.i58 = trunc i32 %or.i57 to i16, !dbg !1796
  store i16 %conv2.i58, i16* %x.addr.i52, align 2, !dbg !1797
  %53 = load i16, i16* %x.addr.i52, align 2, !dbg !1798
  %54 = load i32, i32* %i, align 4, !dbg !1799
  %idxprom30 = sext i32 %54 to i64, !dbg !1800
  %55 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1800
  %dict31 = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %55, i32 0, i32 6, !dbg !1801
  %56 = load %struct.HEntry*, %struct.HEntry** %dict31, align 8, !dbg !1801
  %arrayidx32 = getelementptr inbounds %struct.HEntry, %struct.HEntry* %56, i64 %idxprom30, !dbg !1800
  %l33 = getelementptr inbounds %struct.HEntry, %struct.HEntry* %arrayidx32, i32 0, i32 0, !dbg !1802
  store i16 %53, i16* %l33, align 2, !dbg !1803
  %57 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1804
  %extradata34 = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %57, i32 0, i32 15, !dbg !1805
  %58 = load i8*, i8** %extradata34, align 8, !dbg !1805
  %add.ptr35 = getelementptr inbounds i8, i8* %58, i64 6, !dbg !1806
  %59 = load i32, i32* %i, align 4, !dbg !1807
  %mul36 = mul nsw i32 4, %59, !dbg !1808
  %idx.ext37 = sext i32 %mul36 to i64, !dbg !1809
  %add.ptr38 = getelementptr inbounds i8, i8* %add.ptr35, i64 %idx.ext37, !dbg !1809
  %add.ptr39 = getelementptr inbounds i8, i8* %add.ptr38, i64 2, !dbg !1810
  %60 = bitcast i8* %add.ptr39 to %union.unaligned_16*, !dbg !1811
  %l40 = bitcast %union.unaligned_16* %60 to i16*, !dbg !1811
  %61 = load i16, i16* %l40, align 1, !dbg !1811
  store i16 %61, i16* %x.addr.i45, align 2, !dbg !1812
  %62 = load i16, i16* %x.addr.i45, align 2, !dbg !1813
  %conv.i46 = zext i16 %62 to i32, !dbg !1813
  %shr.i47 = ashr i32 %conv.i46, 8, !dbg !1814
  %63 = load i16, i16* %x.addr.i45, align 2, !dbg !1815
  %conv1.i48 = zext i16 %63 to i32, !dbg !1815
  %shl.i49 = shl i32 %conv1.i48, 8, !dbg !1816
  %or.i50 = or i32 %shr.i47, %shl.i49, !dbg !1817
  %conv2.i51 = trunc i32 %or.i50 to i16, !dbg !1818
  store i16 %conv2.i51, i16* %x.addr.i45, align 2, !dbg !1819
  %64 = load i16, i16* %x.addr.i45, align 2, !dbg !1820
  %65 = load i32, i32* %i, align 4, !dbg !1821
  %idxprom42 = sext i32 %65 to i64, !dbg !1822
  %66 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1822
  %dict43 = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %66, i32 0, i32 6, !dbg !1823
  %67 = load %struct.HEntry*, %struct.HEntry** %dict43, align 8, !dbg !1823
  %arrayidx44 = getelementptr inbounds %struct.HEntry, %struct.HEntry* %67, i64 %idxprom42, !dbg !1822
  %r = getelementptr inbounds %struct.HEntry, %struct.HEntry* %arrayidx44, i32 0, i32 1, !dbg !1824
  store i16 %64, i16* %r, align 2, !dbg !1825
  br label %for.inc, !dbg !1826

for.inc:                                          ; preds = %for.body
  %68 = load i32, i32* %i, align 4, !dbg !1827
  %inc = add nsw i32 %68, 1, !dbg !1827
  store i32 %inc, i32* %i, align 4, !dbg !1827
  br label %for.cond, !dbg !1829, !llvm.loop !1830

for.end:                                          ; preds = %for.cond
  %69 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1832
  %sample_fmt = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %69, i32 0, i32 84, !dbg !1833
  store i32 0, i32* %sample_fmt, align 8, !dbg !1834
  %70 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1835
  %dict_entry = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %70, i32 0, i32 4, !dbg !1836
  store i32 0, i32* %dict_entry, align 8, !dbg !1837
  store i32 0, i32* %retval, align 4, !dbg !1838
  br label %return, !dbg !1838

return:                                           ; preds = %for.end, %if.then19, %if.then8, %if.then2, %if.then
  %71 = load i32, i32* %retval, align 4, !dbg !1839
  ret i32 %71, !dbg !1839
}

; Function Attrs: nounwind uwtable
define internal i32 @hcom_decode(%struct.AVCodecContext* %avctx, i8* %data, i32* %got_frame, %struct.AVPacket* %pkt) #1 !dbg !1840 {
entry:
  %retval = alloca i32, align 4
  %avctx.addr = alloca %struct.AVCodecContext*, align 8
  ...
  store %struct.AVCodecContext* %avctx, %struct.AVCodecContext** %avctx.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVCodecContext** %avctx.addr, metadata !1841, metadata !1645), !dbg !1842
  store i8* %data, i8** %data.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %data.addr, metadata !1843, metadata !1645), !dbg !1844
  store i32* %got_frame, i32** %got_frame.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %got_frame.addr, metadata !1845, metadata !1645), !dbg !1846
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !1847, metadata !1645), !dbg !1848
  call void @llvm.dbg.declare(metadata %struct.HCOMContext** %s, metadata !1849, metadata !1645), !dbg !1850
  ...
  %2 = bitcast i8* %1 to %struct.HCOMContext*, !dbg !1851
  store %struct.HCOMContext* %2, %struct.HCOMContext** %s, align 8, !dbg !1850
  call void @llvm.dbg.declare(metadata %struct.AVFrame** %frame, metadata !1853, metadata !1645), !dbg !1854
  %3 = load i8*, i8** %data.addr, align 8, !dbg !1855
  %4 = bitcast i8* %3 to %struct.AVFrame*, !dbg !1855
  store %struct.AVFrame* %4, %struct.AVFrame** %frame, align 8, !dbg !1854
  call void @llvm.dbg.declare(metadata %struct.GetBitContext* %gb, metadata !1856, metadata !1645), !dbg !1866
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !1867, metadata !1645), !dbg !1868
  call void @llvm.dbg.declare(metadata i32* %n, metadata !1869, metadata !1645), !dbg !1870
  store i32 0, i32* %n, align 4, !dbg !1870
  %5 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !1871
  %size = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %5, i32 0, i32 4, !dbg !1873
  %6 = load i32, i32* %size, align 8, !dbg !1873
  %cmp = icmp sgt i32 %6, 32767, !dbg !1874
...
if.end:                                           ; preds = %entry
  %7 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !1877
  %size1 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %7, i32 0, i32 4, !dbg !1878
  %8 = load i32, i32* %size1, align 8, !dbg !1878
  %mul = mul nsw i32 %8, 8, !dbg !1879
  ...
  store i32 %mul, i32* %nb_samples, align 8, !dbg !1882
  ...
  %cmp2 = icmp slt i32 %call, 0, !dbg !1888
  br i1 %cmp2, label %if.then3, label %if.end4, !dbg !1889
...
if.end4:                                          ; preds = %if.end
  %13 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !1892
  %data5 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %13, i32 0, i32 3, !dbg !1894
  %14 = load i8*, i8** %data5, align 8, !dbg !1894
  %15 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !1895
  %size6 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %15, i32 0, i32 4, !dbg !1896
  %16 = load i32, i32* %size6, align 8, !dbg !1896
  %call7 = call i32 @init_get_bits8(%struct.GetBitContext* %gb, i8* %14, i32 %16), !dbg !1897
  store i32 %call7, i32* %ret, align 4, !dbg !1898
  %cmp8 = icmp slt i32 %call7, 0, !dbg !1899
  br i1 %cmp8, label %if.then9, label %if.end10, !dbg !1900

if.then9:                                         ; preds = %if.end4
  %17 = load i32, i32* %ret, align 4, !dbg !1901
  store i32 %17, i32* %retval, align 4, !dbg !1902
  br label %return, !dbg !1902

if.end10:                                         ; preds = %if.end4
  br label %while.cond, !dbg !1903

while.cond:                                       ; preds = %if.end51, %if.end10
  %call11 = call i32 @get_bits_left(%struct.GetBitContext* %gb), !dbg !1904
  %cmp12 = icmp sgt i32 %call11, 0, !dbg !1906
  br i1 %cmp12, label %while.body, label %while.end, !dbg !1907

while.body:                                       ; preds = %while.cond
  %call13 = call i32 @get_bits1(%struct.GetBitContext* %gb), !dbg !1908
  %tobool = icmp ne i32 %call13, 0, !dbg !1908
  br i1 %tobool, label %if.then14, label %if.else, !dbg !1911

if.then14:                                        ; preds = %while.body
  %18 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1912
  %dict_entry = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %18, i32 0, i32 4, !dbg !1913
  %19 = load i32, i32* %dict_entry, align 8, !dbg !1913
  %idxprom = sext i32 %19 to i64, !dbg !1914
  %20 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1914
  %dict = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %20, i32 0, i32 6, !dbg !1915
  %21 = load %struct.HEntry*, %struct.HEntry** %dict, align 8, !dbg !1915
  %arrayidx = getelementptr inbounds %struct.HEntry, %struct.HEntry* %21, i64 %idxprom, !dbg !1914
  %r = getelementptr inbounds %struct.HEntry, %struct.HEntry* %arrayidx, i32 0, i32 1, !dbg !1916
  %22 = load i16, i16* %r, align 2, !dbg !1916
  %conv = sext i16 %22 to i32, !dbg !1914
  %23 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1917
  %dict_entry15 = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %23, i32 0, i32 4, !dbg !1918
  store i32 %conv, i32* %dict_entry15, align 8, !dbg !1919
  br label %if.end22, !dbg !1917

if.else:                                          ; preds = %while.body
  %24 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1920
  %dict_entry16 = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %24, i32 0, i32 4, !dbg !1921
  %25 = load i32, i32* %dict_entry16, align 8, !dbg !1921
  %idxprom17 = sext i32 %25 to i64, !dbg !1922
  %26 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1922
  %dict18 = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %26, i32 0, i32 6, !dbg !1923
  %27 = load %struct.HEntry*, %struct.HEntry** %dict18, align 8, !dbg !1923
  %arrayidx19 = getelementptr inbounds %struct.HEntry, %struct.HEntry* %27, i64 %idxprom17, !dbg !1922
  %l = getelementptr inbounds %struct.HEntry, %struct.HEntry* %arrayidx19, i32 0, i32 0, !dbg !1924
  %28 = load i16, i16* %l, align 2, !dbg !1924
  %conv20 = sext i16 %28 to i32, !dbg !1922
  %29 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1925
  %dict_entry21 = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %29, i32 0, i32 4, !dbg !1926
  store i32 %conv20, i32* %dict_entry21, align 8, !dbg !1927
  br label %if.end22

if.end22:                                         ; preds = %if.else, %if.then14
  %30 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1928
  %dict_entry23 = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %30, i32 0, i32 4, !dbg !1930
  %31 = load i32, i32* %dict_entry23, align 8, !dbg !1930
  %idxprom24 = sext i32 %31 to i64, !dbg !1931
  %32 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1931
  %dict25 = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %32, i32 0, i32 6, !dbg !1932
  %33 = load %struct.HEntry*, %struct.HEntry** %dict25, align 8, !dbg !1932
  %arrayidx26 = getelementptr inbounds %struct.HEntry, %struct.HEntry* %33, i64 %idxprom24, !dbg !1931
  %l27 = getelementptr inbounds %struct.HEntry, %struct.HEntry* %arrayidx26, i32 0, i32 0, !dbg !1933
  %34 = load i16, i16* %l27, align 2, !dbg !1933
  %conv28 = sext i16 %34 to i32, !dbg !1931
  %cmp29 = icmp slt i32 %conv28, 0, !dbg !1934
  br i1 %cmp29, label %if.then31, label %if.end51, !dbg !1935

if.then31:                                        ; preds = %if.end22
  call void @llvm.dbg.declare(metadata i16* %datum, metadata !1936, metadata !1645), !dbg !1938
  %35 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1939
  %dict_entry32 = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %35, i32 0, i32 4, !dbg !1940
  %36 = load i32, i32* %dict_entry32, align 8, !dbg !1940
  %idxprom33 = sext i32 %36 to i64, !dbg !1941
  %37 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1941
  %dict34 = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %37, i32 0, i32 6, !dbg !1942
  %38 = load %struct.HEntry*, %struct.HEntry** %dict34, align 8, !dbg !1942
  %arrayidx35 = getelementptr inbounds %struct.HEntry, %struct.HEntry* %38, i64 %idxprom33, !dbg !1941
  %r36 = getelementptr inbounds %struct.HEntry, %struct.HEntry* %arrayidx35, i32 0, i32 1, !dbg !1943
  %39 = load i16, i16* %r36, align 2, !dbg !1943
  store i16 %39, i16* %datum, align 2, !dbg !1944
  %40 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1945
  %delta_compression = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %40, i32 0, i32 5, !dbg !1947
  %41 = load i32, i32* %delta_compression, align 4, !dbg !1947
  %tobool37 = icmp ne i32 %41, 0, !dbg !1945
  br i1 %tobool37, label %if.end39, label %if.then38, !dbg !1948

if.then38:                                        ; preds = %if.then31
  %42 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1949
  %sample = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %42, i32 0, i32 2, !dbg !1950
  store i8 0, i8* %sample, align 1, !dbg !1951
  br label %if.end39, !dbg !1949

if.end39:                                         ; preds = %if.then38, %if.then31
  %43 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1952
  %sample40 = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %43, i32 0, i32 2, !dbg !1953
  %44 = load i8, i8* %sample40, align 1, !dbg !1953
  %conv41 = zext i8 %44 to i32, !dbg !1952
  %45 = load i16, i16* %datum, align 2, !dbg !1954
  %conv42 = sext i16 %45 to i32, !dbg !1954
  %add = add nsw i32 %conv41, %conv42, !dbg !1955
  %and = and i32 %add, 255, !dbg !1956
  %conv43 = trunc i32 %and to i8, !dbg !1957
  %46 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1958
  %sample44 = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %46, i32 0, i32 2, !dbg !1959
  store i8 %conv43, i8* %sample44, align 1, !dbg !1960
  %47 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1961
  %sample45 = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %47, i32 0, i32 2, !dbg !1962
  %48 = load i8, i8* %sample45, align 1, !dbg !1962
  %49 = load i32, i32* %n, align 4, !dbg !1963
  %inc = add nsw i32 %49, 1, !dbg !1963
  store i32 %inc, i32* %n, align 4, !dbg !1963
  %idxprom46 = sext i32 %49 to i64, !dbg !1964
  %50 = load %struct.AVFrame*, %struct.AVFrame** %frame, align 8, !dbg !1964
  %data47 = getelementptr inbounds %struct.AVFrame, %struct.AVFrame* %50, i32 0, i32 0, !dbg !1965
  %arrayidx48 = getelementptr inbounds [8 x i8*], [8 x i8*]* %data47, i64 0, i64 0, !dbg !1964
  %51 = load i8*, i8** %arrayidx48, align 8, !dbg !1964
  %arrayidx49 = getelementptr inbounds i8, i8* %51, i64 %idxprom46, !dbg !1964
  store i8 %48, i8* %arrayidx49, align 1, !dbg !1966
  %52 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1967
  %dict_entry50 = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %52, i32 0, i32 4, !dbg !1968
  store i32 0, i32* %dict_entry50, align 8, !dbg !1969
  br label %if.end51, !dbg !1970

if.end51:                                         ; preds = %if.end39, %if.end22
  br label %while.cond, !dbg !1971, !llvm.loop !1973

while.end:                                        ; preds = %while.cond
  %53 = load i32, i32* %n, align 4, !dbg !1974
  %54 = load %struct.AVFrame*, %struct.AVFrame** %frame, align 8, !dbg !1975
  %nb_samples52 = getelementptr inbounds %struct.AVFrame, %struct.AVFrame* %54, i32 0, i32 5, !dbg !1976
  store i32 %53, i32* %nb_samples52, align 8, !dbg !1977
  %55 = load i32*, i32** %got_frame.addr, align 8, !dbg !1978
  store i32 1, i32* %55, align 4, !dbg !1979
  %56 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !1980
  %size53 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %56, i32 0, i32 4, !dbg !1981
  %57 = load i32, i32* %size53, align 8, !dbg !1981
  store i32 %57, i32* %retval, align 4, !dbg !1982
  br label %return, !dbg !1982

return:                                           ; preds = %while.end, %if.then9, %if.then3, %if.then
  %58 = load i32, i32* %retval, align 4, !dbg !1983
  ret i32 %58, !dbg !1983
}

; Function Attrs: cold nounwind optsize uwtable
define internal i32 @hcom_close(%struct.AVCodecContext* %avctx) #0 !dbg !1984 {
entry:
  %avctx.addr = alloca %struct.AVCodecContext*, align 8
  %s = alloca %struct.HCOMContext*, align 8
  store %struct.AVCodecContext* %avctx, %struct.AVCodecContext** %avctx.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVCodecContext** %avctx.addr, metadata !1985, metadata !1645), !dbg !1986
  call void @llvm.dbg.declare(metadata %struct.HCOMContext** %s, metadata !1987, metadata !1645), !dbg !1988
  %0 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1989
  %priv_data = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %0, i32 0, i32 6, !dbg !1990
  %1 = load i8*, i8** %priv_data, align 8, !dbg !1990
  %2 = bitcast i8* %1 to %struct.HCOMContext*, !dbg !1989
  store %struct.HCOMContext* %2, %struct.HCOMContext** %s, align 8, !dbg !1988
  %3 = load %struct.HCOMContext*, %struct.HCOMContext** %s, align 8, !dbg !1991
  %dict = getelementptr inbounds %struct.HCOMContext, %struct.HCOMContext* %3, i32 0, i32 6, !dbg !1992
  %4 = bitcast %struct.HEntry** %dict to i8*, !dbg !1993
  call void @av_freep(i8* %4), !dbg !1994
  ret i32 0, !dbg !1995
}
...
define internal i32 @init_get_bits8(%struct.GetBitContext* %s, i8* %buffer, i32 %byte_size) #4 !dbg !1996 {
entry:
  %s.addr = alloca %struct.GetBitContext*, align 8
  %buffer.addr = alloca i8*, align 8
  %byte_size.addr = alloca i32, align 4
  store %struct.GetBitContext* %s, %struct.GetBitContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.GetBitContext** %s.addr, metadata !2000, metadata !1645), !dbg !2001
  store i8* %buffer, i8** %buffer.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %buffer.addr, metadata !2002, metadata !1645), !dbg !2003
  store i32 %byte_size, i32* %byte_size.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %byte_size.addr, metadata !2004, metadata !1645), !dbg !2005
  %0 = load i32, i32* %byte_size.addr, align 4, !dbg !2006
  %cmp = icmp sgt i32 %0, 268435455, !dbg !2008
  br i1 %cmp, label %if.then, label %lor.lhs.false, !dbg !2009

lor.lhs.false:                                    ; preds = %entry
  %1 = load i32, i32* %byte_size.addr, align 4, !dbg !2010
  %cmp1 = icmp slt i32 %1, 0, !dbg !2012
  br i1 %cmp1, label %if.then, label %if.end, !dbg !2013

if.then:                                          ; preds = %lor.lhs.false, %entry
  store i32 -1, i32* %byte_size.addr, align 4, !dbg !2014
  br label %if.end, !dbg !2015

if.end:                                           ; preds = %if.then, %lor.lhs.false
  %2 = load %struct.GetBitContext*, %struct.GetBitContext** %s.addr, align 8, !dbg !2016
  %3 = load i8*, i8** %buffer.addr, align 8, !dbg !2017
  %4 = load i32, i32* %byte_size.addr, align 4, !dbg !2018
  %mul = mul nsw i32 %4, 8, !dbg !2019
  %call = call i32 @init_get_bits(%struct.GetBitContext* %2, i8* %3, i32 %mul), !dbg !2020
  ret i32 %call, !dbg !2021
}

; Function Attrs: inlinehint nounwind uwtable
define internal i32 @get_bits_left(%struct.GetBitContext* %gb) #4 !dbg !2022 {
entry:
  %gb.addr = alloca %struct.GetBitContext*, align 8
  store %struct.GetBitContext* %gb, %struct.GetBitContext** %gb.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.GetBitContext** %gb.addr, metadata !2025, metadata !1645), !dbg !2026
  %0 = load %struct.GetBitContext*, %struct.GetBitContext** %gb.addr, align 8, !dbg !2027
  %size_in_bits = getelementptr inbounds %struct.GetBitContext, %struct.GetBitContext* %0, i32 0, i32 3, !dbg !2028
  %1 = load i32, i32* %size_in_bits, align 4, !dbg !2028
  %2 = load %struct.GetBitContext*, %struct.GetBitContext** %gb.addr, align 8, !dbg !2029
  %call = call i32 @get_bits_count(%struct.GetBitContext* %2), !dbg !2030
  %sub = sub nsw i32 %1, %call, !dbg !2031
  ret i32 %sub, !dbg !2032
}

; Function Attrs: inlinehint nounwind uwtable
define internal i32 @get_bits1(%struct.GetBitContext* %s) #4 !dbg !2033 {
entry:
  %s.addr = alloca %struct.GetBitContext*, align 8
  %index = alloca i32, align 4
  %result = alloca i8, align 1
  store %struct.GetBitContext* %s, %struct.GetBitContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.GetBitContext** %s.addr, metadata !2036, metadata !1645), !dbg !2037
  call void @llvm.dbg.declare(metadata i32* %index, metadata !2038, metadata !1645), !dbg !2039
  %0 = load %struct.GetBitContext*, %struct.GetBitContext** %s.addr, align 8, !dbg !2040
  %index1 = getelementptr inbounds %struct.GetBitContext, %struct.GetBitContext* %0, i32 0, i32 2, !dbg !2041
  %1 = load i32, i32* %index1, align 8, !dbg !2041
  store i32 %1, i32* %index, align 4, !dbg !2039
  call void @llvm.dbg.declare(metadata i8* %result, metadata !2042, metadata !1645), !dbg !2043
  %2 = load i32, i32* %index, align 4, !dbg !2044
  %shr = lshr i32 %2, 3, !dbg !2045
  %idxprom = zext i32 %shr to i64, !dbg !2046
  %3 = load %struct.GetBitContext*, %struct.GetBitContext** %s.addr, align 8, !dbg !2046
  %buffer = getelementptr inbounds %struct.GetBitContext, %struct.GetBitContext* %3, i32 0, i32 0, !dbg !2047
  %4 = load i8*, i8** %buffer, align 8, !dbg !2047
  %arrayidx = getelementptr inbounds i8, i8* %4, i64 %idxprom, !dbg !2046
  %5 = load i8, i8* %arrayidx, align 1, !dbg !2046
  store i8 %5, i8* %result, align 1, !dbg !2043
  %6 = load i32, i32* %index, align 4, !dbg !2048
  %and = and i32 %6, 7, !dbg !2049
  %7 = load i8, i8* %result, align 1, !dbg !2050
  %conv = zext i8 %7 to i32, !dbg !2050
  %shl = shl i32 %conv, %and, !dbg !2050
  %conv2 = trunc i32 %shl to i8, !dbg !2050
  store i8 %conv2, i8* %result, align 1, !dbg !2050
  %8 = load i8, i8* %result, align 1, !dbg !2051
  %conv3 = zext i8 %8 to i32, !dbg !2051
  %shr4 = ashr i32 %conv3, 7, !dbg !2051
  %conv5 = trunc i32 %shr4 to i8, !dbg !2051
  store i8 %conv5, i8* %result, align 1, !dbg !2051
  %9 = load %struct.GetBitContext*, %struct.GetBitContext** %s.addr, align 8, !dbg !2052
  %index6 = getelementptr inbounds %struct.GetBitContext, %struct.GetBitContext* %9, i32 0, i32 2, !dbg !2054
  %10 = load i32, i32* %index6, align 8, !dbg !2054
  %11 = load %struct.GetBitContext*, %struct.GetBitContext** %s.addr, align 8, !dbg !2055
  %size_in_bits_plus8 = getelementptr inbounds %struct.GetBitContext, %struct.GetBitContext* %11, i32 0, i32 4, !dbg !2056
  %12 = load i32, i32* %size_in_bits_plus8, align 8, !dbg !2056
  %cmp = icmp slt i32 %10, %12, !dbg !2057
  br i1 %cmp, label %if.then, label %if.end, !dbg !2058

if.then:                                          ; preds = %entry
  %13 = load i32, i32* %index, align 4, !dbg !2059
  %inc = add i32 %13, 1, !dbg !2059
  store i32 %inc, i32* %index, align 4, !dbg !2059
  br label %if.end, !dbg !2060

if.end:                                           ; preds = %if.then, %entry
  %14 = load i32, i32* %index, align 4, !dbg !2061
  %15 = load %struct.GetBitContext*, %struct.GetBitContext** %s.addr, align 8, !dbg !2062
  %index8 = getelementptr inbounds %struct.GetBitContext, %struct.GetBitContext* %15, i32 0, i32 2, !dbg !2063
  store i32 %14, i32* %index8, align 8, !dbg !2064
  %16 = load i8, i8* %result, align 1, !dbg !2065
  %conv9 = zext i8 %16 to i32, !dbg !2065
  ret i32 %conv9, !dbg !2066
}

; Function Attrs: inlinehint nounwind uwtable
define internal i32 @init_get_bits(%struct.GetBitContext* %s, i8* %buffer, i32 %bit_size) #4 !dbg !2067 {
entry:
  %s.addr = alloca %struct.GetBitContext*, align 8
  %buffer.addr = alloca i8*, align 8
  ...
  %ret = alloca i32, align 4
  store %struct.GetBitContext* %s, %struct.GetBitContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.GetBitContext** %s.addr, metadata !2068, metadata !1645), !dbg !2069
  store i8* %buffer, i8** %buffer.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %buffer.addr, metadata !2070, metadata !1645), !dbg !2071
  store i32 %bit_size, i32* %bit_size.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %bit_size.addr, metadata !2072, metadata !1645), !dbg !2073
  call void @llvm.dbg.declare(metadata i32* %buffer_size, metadata !2074, metadata !1645), !dbg !2075
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !2076, metadata !1645), !dbg !2077
  store i32 0, i32* %ret, align 4, !dbg !2077
  %0 = load i32, i32* %bit_size.addr, align 4, !dbg !2078
  %cmp = icmp sge i32 %0, 2147483135, !dbg !2080
  br i1 %cmp, label %if.then, label %lor.lhs.false, !dbg !2081

lor.lhs.false:                                    ; preds = %entry
  %1 = load i32, i32* %bit_size.addr, align 4, !dbg !2082
  %cmp1 = icmp slt i32 %1, 0, !dbg !2084
  br i1 %cmp1, label %if.then, label %lor.lhs.false2, !dbg !2085

lor.lhs.false2:                                   ; preds = %lor.lhs.false
  %2 = load i8*, i8** %buffer.addr, align 8, !dbg !2086
  %tobool = icmp ne i8* %2, null, !dbg !2086
  br i1 %tobool, label %if.end, label %if.then, !dbg !2088

if.then:                                          ; preds = %lor.lhs.false2, %lor.lhs.false, %entry
  store i32 0, i32* %bit_size.addr, align 4, !dbg !2089
  store i8* null, i8** %buffer.addr, align 8, !dbg !2091
  store i32 -1094995529, i32* %ret, align 4, !dbg !2092
  br label %if.end, !dbg !2093

if.end:                                           ; preds = %if.then, %lor.lhs.false2
  %3 = load i32, i32* %bit_size.addr, align 4, !dbg !2094
  %add = add nsw i32 %3, 7, !dbg !2095
  %shr = ashr i32 %add, 3, !dbg !2096
  store i32 %shr, i32* %buffer_size, align 4, !dbg !2097
  %4 = load i8*, i8** %buffer.addr, align 8, !dbg !2098
  %5 = load %struct.GetBitContext*, %struct.GetBitContext** %s.addr, align 8, !dbg !2099
  %buffer3 = getelementptr inbounds %struct.GetBitContext, %struct.GetBitContext* %5, i32 0, i32 0, !dbg !2100
  store i8* %4, i8** %buffer3, align 8, !dbg !2101
  %6 = load i32, i32* %bit_size.addr, align 4, !dbg !2102
  %7 = load %struct.GetBitContext*, %struct.GetBitContext** %s.addr, align 8, !dbg !2103
  %size_in_bits = getelementptr inbounds %struct.GetBitContext, %struct.GetBitContext* %7, i32 0, i32 3, !dbg !2104
  store i32 %6, i32* %size_in_bits, align 4, !dbg !2105
  %8 = load i32, i32* %bit_size.addr, align 4, !dbg !2106
  %add4 = add nsw i32 %8, 8, !dbg !2107
  %9 = load %struct.GetBitContext*, %struct.GetBitContext** %s.addr, align 8, !dbg !2108
  %size_in_bits_plus8 = getelementptr inbounds %struct.GetBitContext, %struct.GetBitContext* %9, i32 0, i32 4, !dbg !2109
  store i32 %add4, i32* %size_in_bits_plus8, align 8, !dbg !2110
  %10 = load i8*, i8** %buffer.addr, align 8, !dbg !2111
  %11 = load i32, i32* %buffer_size, align 4, !dbg !2112
  %idx.ext = sext i32 %11 to i64, !dbg !2113
  %add.ptr = getelementptr inbounds i8, i8* %10, i64 %idx.ext, !dbg !2113
  %12 = load %struct.GetBitContext*, %struct.GetBitContext** %s.addr, align 8, !dbg !2114
  %buffer_end = getelementptr inbounds %struct.GetBitContext, %struct.GetBitContext* %12, i32 0, i32 1, !dbg !2115
  store i8* %add.ptr, i8** %buffer_end, align 8, !dbg !2116
  %13 = load %struct.GetBitContext*, %struct.GetBitContext** %s.addr, align 8, !dbg !2117
  %index = getelementptr inbounds %struct.GetBitContext, %struct.GetBitContext* %13, i32 0, i32 2, !dbg !2118
  store i32 0, i32* %index, align 8, !dbg !2119
  %14 = load i32, i32* %ret, align 4, !dbg !2120
  ret i32 %14, !dbg !2121
}

; Function Attrs: inlinehint nounwind uwtable
define internal i32 @get_bits_count(%struct.GetBitContext* %s) #4 !dbg !2122 {
entry:
  %s.addr = alloca %struct.GetBitContext*, align 8
  store %struct.GetBitContext* %s, %struct.GetBitContext** %s.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.GetBitContext** %s.addr, metadata !2127, metadata !1645), !dbg !2128
  %0 = load %struct.GetBitContext*, %struct.GetBitContext** %s.addr, align 8, !dbg !2129
  %index = getelementptr inbounds %struct.GetBitContext, %struct.GetBitContext* %0, i32 0, i32 2, !dbg !2130
  %1 = load i32, i32* %index, align 8, !dbg !2130
  ret i32 %1, !dbg !2131
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a/[inter]libavcodec--hcom.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a")
...
!905 = !{!906}
!906 = distinct !DIGlobalVariable(name: "ff_hcom_decoder", scope: !0, file: !907, line: 129, type: !908, isLocal: false, isDefinition: true, variable: %struct.AVCodec* @ff_hcom_decoder)
!907 = !DIFile(filename: "libavcodec/hcom.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a")
...
!910 = !{!911, !915, !916, !917, !918, !919, !928, !931, !934, !937, !942, !945, !987, !995, !996, !997, !999, !1550, !1556, !1564, !1568, !1569, !1606, !1610, !1614, !1615, !1619, !1623, !1624, !1628, !1629, !1630}
...
!1055 = !DICompositeType(tag: DW_TAG_array_type, baseType: !940, size: 512, align: 64, elements: !1032)
...
!1062 = !DIDerivedType(tag: DW_TAG_member, name: "channel_layout", scope: !1027, file: !722, line: 445, baseType: !940, size: 64, align: 64, offset: 2240)
...
!1118 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !1119, line: 216, baseType: !941)
...
!1191 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !1189, file: !14, line: 5797, baseType: !912, size: 64, align: 64)
...
!1222 = !DIDerivedType(tag: DW_TAG_member, name: "codec_tag", scope: !1218, file: !14, line: 3948, baseType: !904, size: 32, align: 32, offset: 64)
...
!1233 = !DIDerivedType(tag: DW_TAG_member, name: "sample_aspect_ratio", scope: !1218, file: !14, line: 4020, baseType: !922, size: 64, align: 32, offset: 512)
...
!1241 = !DIDerivedType(tag: DW_TAG_member, name: "channel_layout", scope: !1218, file: !14, line: 4046, baseType: !940, size: 64, align: 64, offset: 832)
...
!1250 = !DIDerivedType(tag: DW_TAG_member, name: "time_base_in", scope: !1183, file: !14, line: 5787, baseType: !922, size: 64, align: 32, offset: 384)
!1251 = !DIDerivedType(tag: DW_TAG_member, name: "time_base_out", scope: !1183, file: !14, line: 5793, baseType: !922, size: 64, align: 32, offset: 448)
...
!1281 = !DIDerivedType(tag: DW_TAG_member, name: "time_base", scope: !1005, file: !14, line: 1679, baseType: !922, size: 64, align: 32, offset: 800)
...
!1319 = !DIDerivedType(tag: DW_TAG_member, name: "sample_aspect_ratio", scope: !1005, file: !14, line: 1935, baseType: !922, size: 64, align: 32, offset: 1856)
...
!1365 = !DIDerivedType(tag: DW_TAG_member, name: "channel_layout", scope: !1005, file: !14, line: 2263, baseType: !940, size: 64, align: 64, offset: 3456)
!1366 = !DIDerivedType(tag: DW_TAG_member, name: "request_channel_layout", scope: !1005, file: !14, line: 2270, baseType: !940, size: 64, align: 64, offset: 3520)
...
!1420 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !914, size: 64, align: 64)
...
!1433 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !1431, file: !14, line: 3642, baseType: !912, size: 64, align: 64)
...
!1445 = !{!888, !1003, !1446, !904}
!1446 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1447, size: 64, align: 64)
!1447 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !943)
...
!1484 = !{!888, !1294, !1485, !956, !1297, !888, !888}
...
!1491 = !{!888, !1294, !1492, !956, !1297, !888}
!1492 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1493, size: 64, align: 64)
!1493 = !DISubroutineType(types: !1494)
!1494 = !{!888, !1294, !956, !888, !888}
...
!1503 = !DIDerivedType(tag: DW_TAG_member, name: "vbv_delay", scope: !1005, file: !14, line: 3050, baseType: !940, size: 64, align: 64, offset: 6848)
...
!1506 = !DIDerivedType(tag: DW_TAG_member, name: "framerate", scope: !1005, file: !14, line: 3092, baseType: !922, size: 64, align: 32, offset: 6976)
...
!1508 = !DIDerivedType(tag: DW_TAG_member, name: "pkt_timebase", scope: !1005, file: !14, line: 3106, baseType: !922, size: 64, align: 32, offset: 7072)
...
!1517 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !1513, file: !14, line: 720, baseType: !912, size: 64, align: 64, offset: 64)
!1518 = !DIDerivedType(tag: DW_TAG_member, name: "long_name", scope: !1513, file: !14, line: 724, baseType: !912, size: 64, align: 64, offset: 128)
...
!1522 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !912)
...
!1550 = !DIDerivedType(tag: DW_TAG_member, name: "update_thread_context", scope: !909, file: !14, line: 3535, baseType: !1551, size: 64, align: 64, offset: 1024)
...
!1556 = !DIDerivedType(tag: DW_TAG_member, name: "defaults", scope: !909, file: !14, line: 3541, baseType: !1557, size: 64, align: 64, offset: 1088)
...
!1564 = !DIDerivedType(tag: DW_TAG_member, name: "init_static_data", scope: !909, file: !14, line: 3549, baseType: !1565, size: 64, align: 64, offset: 1152)
!1565 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1566, size: 64, align: 64)
!1566 = !DISubroutineType(types: !1567)
!1567 = !{null, !998}
!1568 = !DIDerivedType(tag: DW_TAG_member, name: "init", scope: !909, file: !14, line: 3551, baseType: !1000, size: 64, align: 64, offset: 1216)
!1569 = !DIDerivedType(tag: DW_TAG_member, name: "encode_sub", scope: !909, file: !14, line: 3552, baseType: !1570, size: 64, align: 64, offset: 1280)
...
!1578 = !DIDerivedType(tag: DW_TAG_member, name: "start_display_time", scope: !1575, file: !14, line: 3922, baseType: !904, size: 32, align: 32, offset: 32)
!1579 = !DIDerivedType(tag: DW_TAG_member, name: "end_display_time", scope: !1575, file: !14, line: 3923, baseType: !904, size: 32, align: 32, offset: 64)
...
!1606 = !DIDerivedType(tag: DW_TAG_member, name: "encode2", scope: !909, file: !14, line: 3564, baseType: !1607, size: 64, align: 64, offset: 1344)
!1607 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1608, size: 64, align: 64)
!1608 = !DISubroutineType(types: !1609)
!1609 = !{!888, !1003, !1151, !1295, !1297}
!1610 = !DIDerivedType(tag: DW_TAG_member, name: "decode", scope: !909, file: !14, line: 3566, baseType: !1611, size: 64, align: 64, offset: 1408)
!1611 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1612, size: 64, align: 64)
!1612 = !DISubroutineType(types: !1613)
!1613 = !{!888, !1003, !956, !1297, !1151}
!1614 = !DIDerivedType(tag: DW_TAG_member, name: "close", scope: !909, file: !14, line: 3567, baseType: !1000, size: 64, align: 64, offset: 1472)
!1615 = !DIDerivedType(tag: DW_TAG_member, name: "send_frame", scope: !909, file: !14, line: 3576, baseType: !1616, size: 64, align: 64, offset: 1536)
!1616 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1617, size: 64, align: 64)
!1617 = !DISubroutineType(types: !1618)
!1618 = !{!888, !1003, !1295}
!1619 = !DIDerivedType(tag: DW_TAG_member, name: "receive_packet", scope: !909, file: !14, line: 3577, baseType: !1620, size: 64, align: 64, offset: 1600)
!1620 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1621, size: 64, align: 64)
!1621 = !DISubroutineType(types: !1622)
!1622 = !{!888, !1003, !1151}
!1623 = !DIDerivedType(tag: DW_TAG_member, name: "receive_frame", scope: !909, file: !14, line: 3584, baseType: !1439, size: 64, align: 64, offset: 1664)
!1624 = !DIDerivedType(tag: DW_TAG_member, name: "flush", scope: !909, file: !14, line: 3589, baseType: !1625, size: 64, align: 64, offset: 1728)
!1625 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1626, size: 64, align: 64)
!1626 = !DISubroutineType(types: !1627)
!1627 = !{null, !1003}
!1628 = !DIDerivedType(tag: DW_TAG_member, name: "caps_internal", scope: !909, file: !14, line: 3594, baseType: !888, size: 32, align: 32, offset: 1792)
!1629 = !DIDerivedType(tag: DW_TAG_member, name: "bsfs", scope: !909, file: !14, line: 3600, baseType: !912, size: 64, align: 64, offset: 1856)
!1630 = !DIDerivedType(tag: DW_TAG_member, name: "hw_configs", scope: !909, file: !14, line: 3609, baseType: !1631, size: 64, align: 64, offset: 1920)
...
!1638 = distinct !DISubprogram(name: "hcom_init", scope: !907, file: !907, line: 43, type: !1001, isLocal: true, isDefinition: true, scopeLine: 44, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1639)
!1639 = !{}
!1640 = !DILocalVariable(name: "x", arg: 1, scope: !1641, file: !1642, line: 66, type: !904)
!1641 = distinct !DISubprogram(name: "av_bswap32", scope: !1642, file: !1642, line: 66, type: !1643, isLocal: true, isDefinition: true, scopeLine: 67, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1639)
...
!1644 = !{!904, !904}
!1645 = !DIExpression()
!1646 = !DILocation(line: 66, column: 98, scope: !1641, inlinedAt: !1647)
!1647 = distinct !DILocation(line: 57, column: 28, scope: !1638)
!1648 = !DILocalVariable(name: "x", arg: 1, scope: !1649, file: !1642, line: 58, type: !896)
!1649 = distinct !DISubprogram(name: "av_bswap16", scope: !1642, file: !1642, line: 58, type: !1650, isLocal: true, isDefinition: true, scopeLine: 59, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1639)
!1650 = !DISubroutineType(types: !1651)
!1651 = !{!896, !896}
!1652 = !DILocation(line: 58, column: 98, scope: !1649, inlinedAt: !1653)
!1653 = distinct !DILocation(line: 64, column: 24, scope: !1654)
!1654 = distinct !DILexicalBlock(scope: !1655, file: !907, line: 63, column: 47)
!1655 = distinct !DILexicalBlock(scope: !1656, file: !907, line: 63, column: 5)
!1656 = distinct !DILexicalBlock(scope: !1638, file: !907, line: 63, column: 5)
!1657 = !DILocation(line: 58, column: 98, scope: !1649, inlinedAt: !1658)
!1658 = distinct !DILocation(line: 65, column: 24, scope: !1654)
!1659 = !DILocation(line: 58, column: 98, scope: !1649, inlinedAt: !1660)
!1660 = distinct !DILocation(line: 54, column: 23, scope: !1638)
!1661 = !DILocalVariable(name: "avctx", arg: 1, scope: !1638, file: !907, line: 43, type: !1003)
!1662 = !DILocation(line: 43, column: 60, scope: !1638)
!1663 = !DILocalVariable(name: "s", scope: !1638, file: !907, line: 45, type: !1664)
!1664 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1665, size: 64, align: 64)
!1665 = !DIDerivedType(tag: DW_TAG_typedef, name: "HCOMContext", file: !907, line: 41, baseType: !1666)
!1666 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "HCOMContext", file: !907, line: 31, size: 256, align: 64, elements: !1667)
!1667 = !{!1668, !1669, !1670, !1671, !1672, !1673, !1674}
!1668 = !DIDerivedType(tag: DW_TAG_member, name: "avctx", scope: !1666, file: !907, line: 32, baseType: !1003, size: 64, align: 64)
!1669 = !DIDerivedType(tag: DW_TAG_member, name: "first_sample", scope: !1666, file: !907, line: 34, baseType: !943, size: 8, align: 8, offset: 64)
!1670 = !DIDerivedType(tag: DW_TAG_member, name: "sample", scope: !1666, file: !907, line: 35, baseType: !943, size: 8, align: 8, offset: 72)
!1671 = !DIDerivedType(tag: DW_TAG_member, name: "dict_entries", scope: !1666, file: !907, line: 36, baseType: !888, size: 32, align: 32, offset: 96)
!1672 = !DIDerivedType(tag: DW_TAG_member, name: "dict_entry", scope: !1666, file: !907, line: 37, baseType: !888, size: 32, align: 32, offset: 128)
!1673 = !DIDerivedType(tag: DW_TAG_member, name: "delta_compression", scope: !1666, file: !907, line: 38, baseType: !888, size: 32, align: 32, offset: 160)
!1674 = !DIDerivedType(tag: DW_TAG_member, name: "dict", scope: !1666, file: !907, line: 40, baseType: !1675, size: 64, align: 64, offset: 192)
!1675 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1676, size: 64, align: 64)
!1676 = !DIDerivedType(tag: DW_TAG_typedef, name: "HEntry", file: !907, line: 29, baseType: !1677)
!1677 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "HEntry", file: !907, line: 27, size: 32, align: 16, elements: !1678)
!1678 = !{!1679, !1682}
!1679 = !DIDerivedType(tag: DW_TAG_member, name: "l", scope: !1677, file: !907, line: 28, baseType: !1680, size: 16, align: 16)
!1680 = !DIDerivedType(tag: DW_TAG_typedef, name: "int16_t", file: !897, line: 37, baseType: !1681)
!1681 = !DIBasicType(name: "short", size: 16, align: 16, encoding: DW_ATE_signed)
!1682 = !DIDerivedType(tag: DW_TAG_member, name: "r", scope: !1677, file: !907, line: 28, baseType: !1680, size: 16, align: 16, offset: 16)
!1683 = !DILocation(line: 45, column: 18, scope: !1638)
!1684 = !DILocation(line: 45, column: 22, scope: !1638)
!1685 = !DILocation(line: 45, column: 29, scope: !1638)
!1686 = !DILocation(line: 47, column: 9, scope: !1687)
!1687 = distinct !DILexicalBlock(scope: !1638, file: !907, line: 47, column: 9)
!1688 = !DILocation(line: 47, column: 16, scope: !1687)
!1689 = !DILocation(line: 47, column: 25, scope: !1687)
!1690 = !DILocation(line: 47, column: 9, scope: !1638)
!1691 = !DILocation(line: 48, column: 16, scope: !1692)
!1692 = distinct !DILexicalBlock(scope: !1687, file: !907, line: 47, column: 31)
!1693 = !DILocation(line: 48, column: 9, scope: !1692)
!1694 = !DILocation(line: 49, column: 9, scope: !1692)
!1695 = !DILocation(line: 52, column: 9, scope: !1696)
!1696 = distinct !DILexicalBlock(scope: !1638, file: !907, line: 52, column: 9)
!1697 = !DILocation(line: 52, column: 16, scope: !1696)
!1698 = !DILocation(line: 52, column: 31, scope: !1696)
!1699 = !DILocation(line: 52, column: 9, scope: !1638)
!1700 = !DILocation(line: 53, column: 9, scope: !1696)
!1701 = !DILocation(line: 54, column: 66, scope: !1638)
!1702 = !DILocation(line: 54, column: 73, scope: !1638)
!1703 = !DILocation(line: 54, column: 86, scope: !1638)
!1704 = !DILocation(line: 54, column: 23, scope: !1638)
!1705 = !DILocation(line: 60, column: 9, scope: !1649, inlinedAt: !1660)
!1706 = !DILocation(line: 60, column: 10, scope: !1649, inlinedAt: !1660)
!1707 = !DILocation(line: 60, column: 18, scope: !1649, inlinedAt: !1660)
!1708 = !DILocation(line: 60, column: 19, scope: !1649, inlinedAt: !1660)
!1709 = !DILocation(line: 60, column: 15, scope: !1649, inlinedAt: !1660)
!1710 = !DILocation(line: 60, column: 8, scope: !1649, inlinedAt: !1660)
!1711 = !DILocation(line: 60, column: 6, scope: !1649, inlinedAt: !1660)
!1712 = !DILocation(line: 61, column: 12, scope: !1649, inlinedAt: !1660)
!1713 = !DILocation(line: 54, column: 5, scope: !1638)
!1714 = !DILocation(line: 54, column: 8, scope: !1638)
!1715 = !DILocation(line: 54, column: 21, scope: !1638)
!1716 = !DILocation(line: 55, column: 9, scope: !1717)
!1717 = distinct !DILexicalBlock(scope: !1638, file: !907, line: 55, column: 9)
!1718 = !DILocation(line: 55, column: 16, scope: !1717)
!1719 = !DILocation(line: 55, column: 33, scope: !1717)
!1720 = !DILocation(line: 55, column: 36, scope: !1717)
!1721 = !DILocation(line: 55, column: 49, scope: !1717)
!1722 = !DILocation(line: 55, column: 53, scope: !1717)
!1723 = !DILocation(line: 55, column: 31, scope: !1717)
!1724 = !DILocation(line: 55, column: 9, scope: !1638)
!1725 = !DILocation(line: 56, column: 9, scope: !1717)
!1726 = !DILocation(line: 57, column: 71, scope: !1638)
!1727 = !DILocation(line: 57, column: 78, scope: !1638)
!1728 = !DILocation(line: 57, column: 88, scope: !1638)
!1729 = !DILocation(line: 57, column: 95, scope: !1638)
!1730 = !DILocation(line: 57, column: 28, scope: !1638)
!1731 = !DILocation(line: 68, column: 16, scope: !1641, inlinedAt: !1647)
!1732 = !DILocation(line: 68, column: 19, scope: !1641, inlinedAt: !1647)
!1733 = !DILocation(line: 68, column: 24, scope: !1641, inlinedAt: !1647)
!1734 = !DILocation(line: 68, column: 38, scope: !1641, inlinedAt: !1647)
!1735 = !DILocation(line: 68, column: 41, scope: !1641, inlinedAt: !1647)
!1736 = !DILocation(line: 68, column: 46, scope: !1641, inlinedAt: !1647)
!1737 = !DILocation(line: 68, column: 34, scope: !1641, inlinedAt: !1647)
!1738 = !DILocation(line: 68, column: 57, scope: !1641, inlinedAt: !1647)
!1739 = !DILocation(line: 68, column: 69, scope: !1641, inlinedAt: !1647)
!1740 = !DILocation(line: 68, column: 72, scope: !1641, inlinedAt: !1647)
!1741 = !DILocation(line: 68, column: 79, scope: !1641, inlinedAt: !1647)
!1742 = !DILocation(line: 68, column: 84, scope: !1641, inlinedAt: !1647)
!1743 = !DILocation(line: 68, column: 99, scope: !1641, inlinedAt: !1647)
!1744 = !DILocation(line: 68, column: 102, scope: !1641, inlinedAt: !1647)
!1745 = !DILocation(line: 68, column: 109, scope: !1641, inlinedAt: !1647)
!1746 = !DILocation(line: 68, column: 114, scope: !1641, inlinedAt: !1647)
!1747 = !DILocation(line: 68, column: 94, scope: !1641, inlinedAt: !1647)
!1748 = !DILocation(line: 68, column: 63, scope: !1641, inlinedAt: !1647)
!1749 = !DILocation(line: 57, column: 5, scope: !1638)
!1750 = !DILocation(line: 57, column: 8, scope: !1638)
!1751 = !DILocation(line: 57, column: 26, scope: !1638)
!1752 = !DILocation(line: 58, column: 52, scope: !1638)
!1753 = !DILocation(line: 58, column: 59, scope: !1638)
!1754 = !DILocation(line: 58, column: 74, scope: !1638)
!1755 = !DILocation(line: 58, column: 35, scope: !1638)
!1756 = !DILocation(line: 58, column: 42, scope: !1638)
!1757 = !DILocation(line: 58, column: 17, scope: !1638)
!1758 = !DILocation(line: 58, column: 20, scope: !1638)
!1759 = !DILocation(line: 58, column: 33, scope: !1638)
!1760 = !DILocation(line: 58, column: 5, scope: !1638)
!1761 = !DILocation(line: 58, column: 8, scope: !1638)
!1762 = !DILocation(line: 58, column: 15, scope: !1638)
!1763 = !DILocation(line: 60, column: 25, scope: !1638)
!1764 = !DILocation(line: 60, column: 28, scope: !1638)
!1765 = !DILocation(line: 60, column: 15, scope: !1638)
!1766 = !DILocation(line: 60, column: 5, scope: !1638)
!1767 = !DILocation(line: 60, column: 8, scope: !1638)
!1768 = !DILocation(line: 60, column: 13, scope: !1638)
!1769 = !DILocation(line: 61, column: 10, scope: !1770)
!1770 = distinct !DILexicalBlock(scope: !1638, file: !907, line: 61, column: 9)
!1771 = !DILocation(line: 61, column: 13, scope: !1770)
!1772 = !DILocation(line: 61, column: 9, scope: !1638)
!1773 = !DILocation(line: 62, column: 9, scope: !1770)
!1774 = !DILocalVariable(name: "i", scope: !1656, file: !907, line: 63, type: !888)
!1775 = !DILocation(line: 63, column: 14, scope: !1656)
!1776 = !DILocation(line: 63, column: 10, scope: !1656)
!1777 = !DILocation(line: 63, column: 21, scope: !1778)
!1778 = !DILexicalBlockFile(scope: !1655, file: !907, discriminator: 1)
!1779 = !DILocation(line: 63, column: 25, scope: !1778)
!1780 = !DILocation(line: 63, column: 28, scope: !1778)
!1781 = !DILocation(line: 63, column: 23, scope: !1778)
!1782 = !DILocation(line: 63, column: 5, scope: !1778)
!1783 = !DILocation(line: 64, column: 67, scope: !1654)
!1784 = !DILocation(line: 64, column: 74, scope: !1654)
!1785 = !DILocation(line: 64, column: 84, scope: !1654)
!1786 = !DILocation(line: 64, column: 94, scope: !1654)
!1787 = !DILocation(line: 64, column: 92, scope: !1654)
!1788 = !DILocation(line: 64, column: 88, scope: !1654)
!1789 = !DILocation(line: 64, column: 99, scope: !1654)
!1790 = !DILocation(line: 64, column: 24, scope: !1654)
!1791 = !DILocation(line: 60, column: 9, scope: !1649, inlinedAt: !1653)
!1792 = !DILocation(line: 60, column: 10, scope: !1649, inlinedAt: !1653)
!1793 = !DILocation(line: 60, column: 18, scope: !1649, inlinedAt: !1653)
!1794 = !DILocation(line: 60, column: 19, scope: !1649, inlinedAt: !1653)
!1795 = !DILocation(line: 60, column: 15, scope: !1649, inlinedAt: !1653)
!1796 = !DILocation(line: 60, column: 8, scope: !1649, inlinedAt: !1653)
!1797 = !DILocation(line: 60, column: 6, scope: !1649, inlinedAt: !1653)
!1798 = !DILocation(line: 61, column: 12, scope: !1649, inlinedAt: !1653)
!1799 = !DILocation(line: 64, column: 17, scope: !1654)
!1800 = !DILocation(line: 64, column: 9, scope: !1654)
!1801 = !DILocation(line: 64, column: 12, scope: !1654)
!1802 = !DILocation(line: 64, column: 20, scope: !1654)
!1803 = !DILocation(line: 64, column: 22, scope: !1654)
!1804 = !DILocation(line: 65, column: 67, scope: !1654)
!1805 = !DILocation(line: 65, column: 74, scope: !1654)
!1806 = !DILocation(line: 65, column: 84, scope: !1654)
!1807 = !DILocation(line: 65, column: 94, scope: !1654)
!1808 = !DILocation(line: 65, column: 92, scope: !1654)
!1809 = !DILocation(line: 65, column: 88, scope: !1654)
!1810 = !DILocation(line: 65, column: 96, scope: !1654)
!1811 = !DILocation(line: 65, column: 103, scope: !1654)
!1812 = !DILocation(line: 65, column: 24, scope: !1654)
!1813 = !DILocation(line: 60, column: 9, scope: !1649, inlinedAt: !1658)
!1814 = !DILocation(line: 60, column: 10, scope: !1649, inlinedAt: !1658)
!1815 = !DILocation(line: 60, column: 18, scope: !1649, inlinedAt: !1658)
!1816 = !DILocation(line: 60, column: 19, scope: !1649, inlinedAt: !1658)
!1817 = !DILocation(line: 60, column: 15, scope: !1649, inlinedAt: !1658)
!1818 = !DILocation(line: 60, column: 8, scope: !1649, inlinedAt: !1658)
!1819 = !DILocation(line: 60, column: 6, scope: !1649, inlinedAt: !1658)
!1820 = !DILocation(line: 61, column: 12, scope: !1649, inlinedAt: !1658)
!1821 = !DILocation(line: 65, column: 17, scope: !1654)
!1822 = !DILocation(line: 65, column: 9, scope: !1654)
!1823 = !DILocation(line: 65, column: 12, scope: !1654)
!1824 = !DILocation(line: 65, column: 20, scope: !1654)
!1825 = !DILocation(line: 65, column: 22, scope: !1654)
!1826 = !DILocation(line: 66, column: 5, scope: !1654)
!1827 = !DILocation(line: 63, column: 43, scope: !1828)
!1828 = !DILexicalBlockFile(scope: !1655, file: !907, discriminator: 2)
!1829 = !DILocation(line: 63, column: 5, scope: !1828)
!1830 = distinct !{!1830, !1831}
!1831 = !DILocation(line: 63, column: 5, scope: !1638)
!1832 = !DILocation(line: 68, column: 5, scope: !1638)
!1833 = !DILocation(line: 68, column: 12, scope: !1638)
!1834 = !DILocation(line: 68, column: 23, scope: !1638)
!1835 = !DILocation(line: 69, column: 5, scope: !1638)
!1836 = !DILocation(line: 69, column: 8, scope: !1638)
!1837 = !DILocation(line: 69, column: 19, scope: !1638)
!1838 = !DILocation(line: 71, column: 5, scope: !1638)
!1839 = !DILocation(line: 72, column: 1, scope: !1638)
!1840 = distinct !DISubprogram(name: "hcom_decode", scope: !907, file: !907, line: 74, type: !1612, isLocal: true, isDefinition: true, scopeLine: 76, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1639)
!1841 = !DILocalVariable(name: "avctx", arg: 1, scope: !1840, file: !907, line: 74, type: !1003)
!1842 = !DILocation(line: 74, column: 40, scope: !1840)
!1843 = !DILocalVariable(name: "data", arg: 2, scope: !1840, file: !907, line: 74, type: !956)
!1844 = !DILocation(line: 74, column: 53, scope: !1840)
!1845 = !DILocalVariable(name: "got_frame", arg: 3, scope: !1840, file: !907, line: 75, type: !1297)
!1846 = !DILocation(line: 75, column: 29, scope: !1840)
!1847 = !DILocalVariable(name: "pkt", arg: 4, scope: !1840, file: !907, line: 75, type: !1151)
!1848 = !DILocation(line: 75, column: 50, scope: !1840)
!1849 = !DILocalVariable(name: "s", scope: !1840, file: !907, line: 77, type: !1664)
!1850 = !DILocation(line: 77, column: 18, scope: !1840)
!1851 = !DILocation(line: 77, column: 22, scope: !1840)
!1852 = !DILocation(line: 77, column: 29, scope: !1840)
!1853 = !DILocalVariable(name: "frame", scope: !1840, file: !907, line: 78, type: !1025)
!1854 = !DILocation(line: 78, column: 14, scope: !1840)
!1855 = !DILocation(line: 78, column: 22, scope: !1840)
!1856 = !DILocalVariable(name: "gb", scope: !1840, file: !907, line: 79, type: !1857)
!1857 = !DIDerivedType(tag: DW_TAG_typedef, name: "GetBitContext", file: !1858, line: 70, baseType: !1859)
!1858 = !DIFile(filename: "libavcodec/get_bits.h", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a")
!1859 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "GetBitContext", file: !1858, line: 61, size: 256, align: 64, elements: !1860)
!1860 = !{!1861, !1862, !1863, !1864, !1865}
!1861 = !DIDerivedType(tag: DW_TAG_member, name: "buffer", scope: !1859, file: !1858, line: 62, baseType: !1446, size: 64, align: 64)
!1862 = !DIDerivedType(tag: DW_TAG_member, name: "buffer_end", scope: !1859, file: !1858, line: 62, baseType: !1446, size: 64, align: 64, offset: 64)
!1863 = !DIDerivedType(tag: DW_TAG_member, name: "index", scope: !1859, file: !1858, line: 67, baseType: !888, size: 32, align: 32, offset: 128)
!1864 = !DIDerivedType(tag: DW_TAG_member, name: "size_in_bits", scope: !1859, file: !1858, line: 68, baseType: !888, size: 32, align: 32, offset: 160)
!1865 = !DIDerivedType(tag: DW_TAG_member, name: "size_in_bits_plus8", scope: !1859, file: !1858, line: 69, baseType: !888, size: 32, align: 32, offset: 192)
!1866 = !DILocation(line: 79, column: 19, scope: !1840)
!1867 = !DILocalVariable(name: "ret", scope: !1840, file: !907, line: 80, type: !888)
!1868 = !DILocation(line: 80, column: 9, scope: !1840)
!1869 = !DILocalVariable(name: "n", scope: !1840, file: !907, line: 80, type: !888)
!1870 = !DILocation(line: 80, column: 14, scope: !1840)
!1871 = !DILocation(line: 82, column: 9, scope: !1872)
!1872 = distinct !DILexicalBlock(scope: !1840, file: !907, line: 82, column: 9)
!1873 = !DILocation(line: 82, column: 14, scope: !1872)
!1874 = !DILocation(line: 82, column: 19, scope: !1872)
!1875 = !DILocation(line: 82, column: 9, scope: !1840)
!1876 = !DILocation(line: 83, column: 9, scope: !1872)
!1877 = !DILocation(line: 85, column: 25, scope: !1840)
!1878 = !DILocation(line: 85, column: 30, scope: !1840)
!1879 = !DILocation(line: 85, column: 35, scope: !1840)
!1880 = !DILocation(line: 85, column: 5, scope: !1840)
!1881 = !DILocation(line: 85, column: 12, scope: !1840)
!1882 = !DILocation(line: 85, column: 23, scope: !1840)
!1883 = !DILocation(line: 86, column: 30, scope: !1884)
!1884 = distinct !DILexicalBlock(scope: !1840, file: !907, line: 86, column: 9)
!1885 = !DILocation(line: 86, column: 37, scope: !1884)
!1886 = !DILocation(line: 86, column: 16, scope: !1884)
!1887 = !DILocation(line: 86, column: 14, scope: !1884)
!1888 = !DILocation(line: 86, column: 48, scope: !1884)
!1889 = !DILocation(line: 86, column: 9, scope: !1840)
!1890 = !DILocation(line: 87, column: 16, scope: !1884)
!1891 = !DILocation(line: 87, column: 9, scope: !1884)
!1892 = !DILocation(line: 89, column: 36, scope: !1893)
!1893 = distinct !DILexicalBlock(scope: !1840, file: !907, line: 89, column: 9)
!1894 = !DILocation(line: 89, column: 41, scope: !1893)
!1895 = !DILocation(line: 89, column: 47, scope: !1893)
!1896 = !DILocation(line: 89, column: 52, scope: !1893)
!1897 = !DILocation(line: 89, column: 16, scope: !1893)
!1898 = !DILocation(line: 89, column: 14, scope: !1893)
!1899 = !DILocation(line: 89, column: 59, scope: !1893)
!1900 = !DILocation(line: 89, column: 9, scope: !1840)
!1901 = !DILocation(line: 90, column: 16, scope: !1893)
!1902 = !DILocation(line: 90, column: 9, scope: !1893)
!1903 = !DILocation(line: 92, column: 5, scope: !1840)
!1904 = !DILocation(line: 92, column: 12, scope: !1905)
!1905 = !DILexicalBlockFile(scope: !1840, file: !907, discriminator: 1)
!1906 = !DILocation(line: 92, column: 31, scope: !1905)
!1907 = !DILocation(line: 92, column: 5, scope: !1905)
!1908 = !DILocation(line: 93, column: 13, scope: !1909)
!1909 = distinct !DILexicalBlock(scope: !1910, file: !907, line: 93, column: 13)
!1910 = distinct !DILexicalBlock(scope: !1840, file: !907, line: 92, column: 36)
!1911 = !DILocation(line: 93, column: 13, scope: !1910)
!1912 = !DILocation(line: 94, column: 37, scope: !1909)
!1913 = !DILocation(line: 94, column: 40, scope: !1909)
!1914 = !DILocation(line: 94, column: 29, scope: !1909)
!1915 = !DILocation(line: 94, column: 32, scope: !1909)
!1916 = !DILocation(line: 94, column: 52, scope: !1909)
!1917 = !DILocation(line: 94, column: 13, scope: !1909)
!1918 = !DILocation(line: 94, column: 16, scope: !1909)
!1919 = !DILocation(line: 94, column: 27, scope: !1909)
!1920 = !DILocation(line: 96, column: 37, scope: !1909)
!1921 = !DILocation(line: 96, column: 40, scope: !1909)
!1922 = !DILocation(line: 96, column: 29, scope: !1909)
!1923 = !DILocation(line: 96, column: 32, scope: !1909)
!1924 = !DILocation(line: 96, column: 52, scope: !1909)
!1925 = !DILocation(line: 96, column: 13, scope: !1909)
!1926 = !DILocation(line: 96, column: 16, scope: !1909)
!1927 = !DILocation(line: 96, column: 27, scope: !1909)
!1928 = !DILocation(line: 98, column: 21, scope: !1929)
!1929 = distinct !DILexicalBlock(scope: !1910, file: !907, line: 98, column: 13)
!1930 = !DILocation(line: 98, column: 24, scope: !1929)
!1931 = !DILocation(line: 98, column: 13, scope: !1929)
!1932 = !DILocation(line: 98, column: 16, scope: !1929)
!1933 = !DILocation(line: 98, column: 36, scope: !1929)
!1934 = !DILocation(line: 98, column: 38, scope: !1929)
!1935 = !DILocation(line: 98, column: 13, scope: !1910)
!1936 = !DILocalVariable(name: "datum", scope: !1937, file: !907, line: 99, type: !1680)
!1937 = distinct !DILexicalBlock(scope: !1929, file: !907, line: 98, column: 43)
!1938 = !DILocation(line: 99, column: 21, scope: !1937)
!1939 = !DILocation(line: 101, column: 29, scope: !1937)
!1940 = !DILocation(line: 101, column: 32, scope: !1937)
!1941 = !DILocation(line: 101, column: 21, scope: !1937)
!1942 = !DILocation(line: 101, column: 24, scope: !1937)
!1943 = !DILocation(line: 101, column: 44, scope: !1937)
!1944 = !DILocation(line: 101, column: 19, scope: !1937)
!1945 = !DILocation(line: 103, column: 18, scope: !1946)
!1946 = distinct !DILexicalBlock(scope: !1937, file: !907, line: 103, column: 17)
!1947 = !DILocation(line: 103, column: 21, scope: !1946)
!1948 = !DILocation(line: 103, column: 17, scope: !1937)
!1949 = !DILocation(line: 104, column: 17, scope: !1946)
!1950 = !DILocation(line: 104, column: 20, scope: !1946)
!1951 = !DILocation(line: 104, column: 27, scope: !1946)
!1952 = !DILocation(line: 105, column: 26, scope: !1937)
!1953 = !DILocation(line: 105, column: 29, scope: !1937)
!1954 = !DILocation(line: 105, column: 38, scope: !1937)
!1955 = !DILocation(line: 105, column: 36, scope: !1937)
!1956 = !DILocation(line: 105, column: 45, scope: !1937)
!1957 = !DILocation(line: 105, column: 25, scope: !1937)
!1958 = !DILocation(line: 105, column: 13, scope: !1937)
!1959 = !DILocation(line: 105, column: 16, scope: !1937)
!1960 = !DILocation(line: 105, column: 23, scope: !1937)
!1961 = !DILocation(line: 107, column: 35, scope: !1937)
!1962 = !DILocation(line: 107, column: 38, scope: !1937)
!1963 = !DILocation(line: 107, column: 29, scope: !1937)
!1964 = !DILocation(line: 107, column: 13, scope: !1937)
!1965 = !DILocation(line: 107, column: 20, scope: !1937)
!1966 = !DILocation(line: 107, column: 33, scope: !1937)
!1967 = !DILocation(line: 109, column: 13, scope: !1937)
!1968 = !DILocation(line: 109, column: 16, scope: !1937)
!1969 = !DILocation(line: 109, column: 27, scope: !1937)
!1970 = !DILocation(line: 110, column: 9, scope: !1937)
!1971 = !DILocation(line: 92, column: 5, scope: !1972)
!1972 = !DILexicalBlockFile(scope: !1840, file: !907, discriminator: 2)
!1973 = distinct !{!1973, !1903}
!1974 = !DILocation(line: 113, column: 25, scope: !1840)
!1975 = !DILocation(line: 113, column: 5, scope: !1840)
!1976 = !DILocation(line: 113, column: 12, scope: !1840)
!1977 = !DILocation(line: 113, column: 23, scope: !1840)
!1978 = !DILocation(line: 115, column: 6, scope: !1840)
!1979 = !DILocation(line: 115, column: 16, scope: !1840)
!1980 = !DILocation(line: 117, column: 12, scope: !1840)
!1981 = !DILocation(line: 117, column: 17, scope: !1840)
!1982 = !DILocation(line: 117, column: 5, scope: !1840)
!1983 = !DILocation(line: 118, column: 1, scope: !1840)
!1984 = distinct !DISubprogram(name: "hcom_close", scope: !907, file: !907, line: 120, type: !1001, isLocal: true, isDefinition: true, scopeLine: 121, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1639)
!1985 = !DILocalVariable(name: "avctx", arg: 1, scope: !1984, file: !907, line: 120, type: !1003)
!1986 = !DILocation(line: 120, column: 61, scope: !1984)
!1987 = !DILocalVariable(name: "s", scope: !1984, file: !907, line: 122, type: !1664)
!1988 = !DILocation(line: 122, column: 18, scope: !1984)
!1989 = !DILocation(line: 122, column: 22, scope: !1984)
!1990 = !DILocation(line: 122, column: 29, scope: !1984)
!1991 = !DILocation(line: 124, column: 15, scope: !1984)
!1992 = !DILocation(line: 124, column: 18, scope: !1984)
!1993 = !DILocation(line: 124, column: 14, scope: !1984)
!1994 = !DILocation(line: 124, column: 5, scope: !1984)
!1995 = !DILocation(line: 126, column: 5, scope: !1984)
!1996 = distinct !DISubprogram(name: "init_get_bits8", scope: !1858, file: !1858, line: 650, type: !1997, isLocal: true, isDefinition: true, scopeLine: 652, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1639)
!1997 = !DISubroutineType(types: !1998)
!1998 = !{!888, !1999, !1446, !888}
!1999 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1857, size: 64, align: 64)
!2000 = !DILocalVariable(name: "s", arg: 1, scope: !1996, file: !1858, line: 650, type: !1999)
!2001 = !DILocation(line: 650, column: 49, scope: !1996)
!2002 = !DILocalVariable(name: "buffer", arg: 2, scope: !1996, file: !1858, line: 650, type: !1446)
!2003 = !DILocation(line: 650, column: 67, scope: !1996)
!2004 = !DILocalVariable(name: "byte_size", arg: 3, scope: !1996, file: !1858, line: 651, type: !888)
!2005 = !DILocation(line: 651, column: 38, scope: !1996)
!2006 = !DILocation(line: 653, column: 9, scope: !2007)
!2007 = distinct !DILexicalBlock(scope: !1996, file: !1858, line: 653, column: 9)
!2008 = !DILocation(line: 653, column: 19, scope: !2007)
!2009 = !DILocation(line: 653, column: 36, scope: !2007)
!2010 = !DILocation(line: 653, column: 39, scope: !2011)
!2011 = !DILexicalBlockFile(scope: !2007, file: !1858, discriminator: 1)
!2012 = !DILocation(line: 653, column: 49, scope: !2011)
!2013 = !DILocation(line: 653, column: 9, scope: !2011)
!2014 = !DILocation(line: 654, column: 19, scope: !2007)
!2015 = !DILocation(line: 654, column: 9, scope: !2007)
!2016 = !DILocation(line: 655, column: 26, scope: !1996)
!2017 = !DILocation(line: 655, column: 29, scope: !1996)
!2018 = !DILocation(line: 655, column: 37, scope: !1996)
!2019 = !DILocation(line: 655, column: 47, scope: !1996)
!2020 = !DILocation(line: 655, column: 12, scope: !1996)
!2021 = !DILocation(line: 655, column: 5, scope: !1996)
!2022 = distinct !DISubprogram(name: "get_bits_left", scope: !1858, file: !1858, line: 814, type: !2023, isLocal: true, isDefinition: true, scopeLine: 815, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1639)
!2023 = !DISubroutineType(types: !2024)
!2024 = !{!888, !1999}
!2025 = !DILocalVariable(name: "gb", arg: 1, scope: !2022, file: !1858, line: 814, type: !1999)
!2026 = !DILocation(line: 814, column: 48, scope: !2022)
!2027 = !DILocation(line: 816, column: 12, scope: !2022)
!2028 = !DILocation(line: 816, column: 16, scope: !2022)
!2029 = !DILocation(line: 816, column: 46, scope: !2022)
!2030 = !DILocation(line: 816, column: 31, scope: !2022)
!2031 = !DILocation(line: 816, column: 29, scope: !2022)
!2032 = !DILocation(line: 816, column: 5, scope: !2022)
!2033 = distinct !DISubprogram(name: "get_bits1", scope: !1858, file: !1858, line: 487, type: !2034, isLocal: true, isDefinition: true, scopeLine: 488, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1639)
!2034 = !DISubroutineType(types: !2035)
!2035 = !{!889, !1999}
!2036 = !DILocalVariable(name: "s", arg: 1, scope: !2033, file: !1858, line: 487, type: !1999)
!2037 = !DILocation(line: 487, column: 53, scope: !2033)
!2038 = !DILocalVariable(name: "index", scope: !2033, file: !1858, line: 499, type: !889)
!2039 = !DILocation(line: 499, column: 18, scope: !2033)
!2040 = !DILocation(line: 499, column: 26, scope: !2033)
!2041 = !DILocation(line: 499, column: 29, scope: !2033)
!2042 = !DILocalVariable(name: "result", scope: !2033, file: !1858, line: 500, type: !943)
!2043 = !DILocation(line: 500, column: 13, scope: !2033)
!2044 = !DILocation(line: 500, column: 32, scope: !2033)
!2045 = !DILocation(line: 500, column: 38, scope: !2033)
!2046 = !DILocation(line: 500, column: 22, scope: !2033)
!2047 = !DILocation(line: 500, column: 25, scope: !2033)
!2048 = !DILocation(line: 505, column: 16, scope: !2033)
!2049 = !DILocation(line: 505, column: 22, scope: !2033)
!2050 = !DILocation(line: 505, column: 12, scope: !2033)
!2051 = !DILocation(line: 506, column: 12, scope: !2033)
!2052 = !DILocation(line: 509, column: 9, scope: !2053)
!2053 = distinct !DILexicalBlock(scope: !2033, file: !1858, line: 509, column: 9)
!2054 = !DILocation(line: 509, column: 12, scope: !2053)
!2055 = !DILocation(line: 509, column: 20, scope: !2053)
!2056 = !DILocation(line: 509, column: 23, scope: !2053)
!2057 = !DILocation(line: 509, column: 18, scope: !2053)
!2058 = !DILocation(line: 509, column: 9, scope: !2033)
!2059 = !DILocation(line: 511, column: 14, scope: !2053)
!2060 = !DILocation(line: 511, column: 9, scope: !2053)
!2061 = !DILocation(line: 512, column: 16, scope: !2033)
!2062 = !DILocation(line: 512, column: 5, scope: !2033)
!2063 = !DILocation(line: 512, column: 8, scope: !2033)
!2064 = !DILocation(line: 512, column: 14, scope: !2033)
!2065 = !DILocation(line: 514, column: 12, scope: !2033)
!2066 = !DILocation(line: 514, column: 5, scope: !2033)
!2067 = distinct !DISubprogram(name: "init_get_bits", scope: !1858, file: !1858, line: 615, type: !1997, isLocal: true, isDefinition: true, scopeLine: 617, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1639)
!2068 = !DILocalVariable(name: "s", arg: 1, scope: !2067, file: !1858, line: 615, type: !1999)
!2069 = !DILocation(line: 615, column: 48, scope: !2067)
!2070 = !DILocalVariable(name: "buffer", arg: 2, scope: !2067, file: !1858, line: 615, type: !1446)
!2071 = !DILocation(line: 615, column: 66, scope: !2067)
!2072 = !DILocalVariable(name: "bit_size", arg: 3, scope: !2067, file: !1858, line: 616, type: !888)
!2073 = !DILocation(line: 616, column: 37, scope: !2067)
!2074 = !DILocalVariable(name: "buffer_size", scope: !2067, file: !1858, line: 618, type: !888)
!2075 = !DILocation(line: 618, column: 9, scope: !2067)
!2076 = !DILocalVariable(name: "ret", scope: !2067, file: !1858, line: 619, type: !888)
!2077 = !DILocation(line: 619, column: 9, scope: !2067)
!2078 = !DILocation(line: 621, column: 9, scope: !2079)
!2079 = distinct !DILexicalBlock(scope: !2067, file: !1858, line: 621, column: 9)
!2080 = !DILocation(line: 621, column: 18, scope: !2079)
!2081 = !DILocation(line: 621, column: 64, scope: !2079)
!2082 = !DILocation(line: 621, column: 67, scope: !2083)
!2083 = !DILexicalBlockFile(scope: !2079, file: !1858, discriminator: 1)
!2084 = !DILocation(line: 621, column: 76, scope: !2083)
!2085 = !DILocation(line: 621, column: 80, scope: !2083)
!2086 = !DILocation(line: 621, column: 84, scope: !2087)
!2087 = !DILexicalBlockFile(scope: !2079, file: !1858, discriminator: 2)
!2088 = !DILocation(line: 621, column: 9, scope: !2087)
!2089 = !DILocation(line: 622, column: 18, scope: !2090)
!2090 = distinct !DILexicalBlock(scope: !2079, file: !1858, line: 621, column: 92)
!2091 = !DILocation(line: 623, column: 16, scope: !2090)
!2092 = !DILocation(line: 624, column: 13, scope: !2090)
!2093 = !DILocation(line: 625, column: 5, scope: !2090)
!2094 = !DILocation(line: 627, column: 20, scope: !2067)
!2095 = !DILocation(line: 627, column: 29, scope: !2067)
!2096 = !DILocation(line: 627, column: 34, scope: !2067)
!2097 = !DILocation(line: 627, column: 17, scope: !2067)
!2098 = !DILocation(line: 629, column: 17, scope: !2067)
!2099 = !DILocation(line: 629, column: 5, scope: !2067)
!2100 = !DILocation(line: 629, column: 8, scope: !2067)
!2101 = !DILocation(line: 629, column: 15, scope: !2067)
!2102 = !DILocation(line: 630, column: 23, scope: !2067)
!2103 = !DILocation(line: 630, column: 5, scope: !2067)
!2104 = !DILocation(line: 630, column: 8, scope: !2067)
!2105 = !DILocation(line: 630, column: 21, scope: !2067)
!2106 = !DILocation(line: 631, column: 29, scope: !2067)
!2107 = !DILocation(line: 631, column: 38, scope: !2067)
!2108 = !DILocation(line: 631, column: 5, scope: !2067)
!2109 = !DILocation(line: 631, column: 8, scope: !2067)
!2110 = !DILocation(line: 631, column: 27, scope: !2067)
!2111 = !DILocation(line: 632, column: 21, scope: !2067)
!2112 = !DILocation(line: 632, column: 30, scope: !2067)
!2113 = !DILocation(line: 632, column: 28, scope: !2067)
!2114 = !DILocation(line: 632, column: 5, scope: !2067)
!2115 = !DILocation(line: 632, column: 8, scope: !2067)
!2116 = !DILocation(line: 632, column: 19, scope: !2067)
!2117 = !DILocation(line: 633, column: 5, scope: !2067)
!2118 = !DILocation(line: 633, column: 8, scope: !2067)
!2119 = !DILocation(line: 633, column: 14, scope: !2067)
!2120 = !DILocation(line: 639, column: 12, scope: !2067)
!2121 = !DILocation(line: 639, column: 5, scope: !2067)
!2122 = distinct !DISubprogram(name: "get_bits_count", scope: !1858, file: !1858, line: 219, type: !2123, isLocal: true, isDefinition: true, scopeLine: 220, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1639)
!2123 = !DISubroutineType(types: !2124)
!2124 = !{!888, !2125}
!2125 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2126, size: 64, align: 64)
!2126 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1857)
!2127 = !DILocalVariable(name: "s", arg: 1, scope: !2122, file: !1858, line: 219, type: !2125)
!2128 = !DILocation(line: 219, column: 55, scope: !2122)
!2129 = !DILocation(line: 224, column: 12, scope: !2122)
!2130 = !DILocation(line: 224, column: 15, scope: !2122)
!2131 = !DILocation(line: 224, column: 5, scope: !2122)
