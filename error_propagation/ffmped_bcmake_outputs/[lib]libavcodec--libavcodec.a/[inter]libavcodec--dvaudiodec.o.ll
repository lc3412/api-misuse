; ModuleID = '/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a/[inter]libavcodec--dvaudiodec.o.i'
source_filename = "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a/[inter]libavcodec--dvaudiodec.o.i"
...
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.DVAudioContext** %s, metadata !1641, metadata !1639), !dbg !1653
  ...
  %2 = bitcast i8* %1 to %struct.DVAudioContext*, !dbg !1654
  store %struct.DVAudioContext* %2, %struct.DVAudioContext** %s, align 8, !dbg !1653
  call void @llvm.dbg.declare(metadata i32* %i, metadata !1656, metadata !1639), !dbg !1657
...
if.then:                                          ; preds = %entry
  ...
  %6 = bitcast %struct.AVCodecContext* %5 to i8*, !dbg !1663
  call void (i8*, i32, i8*, ...) @av_log(i8* %6, i32 16, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.2, i32 0, i32 0)), !dbg !1665
  store i32 -22, i32* %retval, align 4, !dbg !1666
  br label %return, !dbg !1666

if.end:                                           ; preds = %entry
  %7 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1667
  %codec_tag = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %7, i32 0, i32 5, !dbg !1669
  %8 = load i32, i32* %codec_tag, align 4, !dbg !1669
  %cmp1 = icmp eq i32 %8, 533, !dbg !1670
  br i1 %cmp1, label %if.then2, label %if.else, !dbg !1671

if.then2:                                         ; preds = %if.end
  %9 = load %struct.DVAudioContext*, %struct.DVAudioContext** %s, align 8, !dbg !1672
  %block_size = getelementptr inbounds %struct.DVAudioContext, %struct.DVAudioContext* %9, i32 0, i32 0, !dbg !1674
  store i32 7200, i32* %block_size, align 4, !dbg !1675
  br label %if.end17, !dbg !1676

if.else:                                          ; preds = %if.end
  %10 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1677
  %codec_tag3 = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %10, i32 0, i32 5, !dbg !1680
  %11 = load i32, i32* %codec_tag3, align 4, !dbg !1680
  %cmp4 = icmp eq i32 %11, 534, !dbg !1681
  br i1 %cmp4, label %if.then5, label %if.else7, !dbg !1677

if.then5:                                         ; preds = %if.else
  %12 = load %struct.DVAudioContext*, %struct.DVAudioContext** %s, align 8, !dbg !1682
  %block_size6 = getelementptr inbounds %struct.DVAudioContext, %struct.DVAudioContext* %12, i32 0, i32 0, !dbg !1684
  store i32 8640, i32* %block_size6, align 4, !dbg !1685
  br label %if.end16, !dbg !1686

if.else7:                                         ; preds = %if.else
  %13 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1687
  %block_align = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %13, i32 0, i32 87, !dbg !1690
  %14 = load i32, i32* %block_align, align 4, !dbg !1690
  %cmp8 = icmp eq i32 %14, 7200, !dbg !1691
  br i1 %cmp8, label %if.then11, label %lor.lhs.false, !dbg !1692

lor.lhs.false:                                    ; preds = %if.else7
  %15 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1693
  %block_align9 = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %15, i32 0, i32 87, !dbg !1694
  %16 = load i32, i32* %block_align9, align 4, !dbg !1694
  %cmp10 = icmp eq i32 %16, 8640, !dbg !1695
  br i1 %cmp10, label %if.then11, label %if.else14, !dbg !1696

if.then11:                                        ; preds = %lor.lhs.false, %if.else7
  %17 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1698
  %block_align12 = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %17, i32 0, i32 87, !dbg !1700
  %18 = load i32, i32* %block_align12, align 4, !dbg !1700
  %19 = load %struct.DVAudioContext*, %struct.DVAudioContext** %s, align 8, !dbg !1701
  %block_size13 = getelementptr inbounds %struct.DVAudioContext, %struct.DVAudioContext* %19, i32 0, i32 0, !dbg !1702
  store i32 %18, i32* %block_size13, align 4, !dbg !1703
  br label %if.end15, !dbg !1704

if.else14:                                        ; preds = %lor.lhs.false
  store i32 -22, i32* %retval, align 4, !dbg !1705
...
if.end17:                                         ; preds = %if.end16, %if.then2
  %20 = load %struct.DVAudioContext*, %struct.DVAudioContext** %s, align 8, !dbg !1707
  %block_size18 = getelementptr inbounds %struct.DVAudioContext, %struct.DVAudioContext* %20, i32 0, i32 0, !dbg !1708
  %21 = load i32, i32* %block_size18, align 4, !dbg !1708
  %cmp19 = icmp eq i32 %21, 8640, !dbg !1709
  %conv = zext i1 %cmp19 to i32, !dbg !1709
  %22 = load %struct.DVAudioContext*, %struct.DVAudioContext** %s, align 8, !dbg !1710
  %is_pal = getelementptr inbounds %struct.DVAudioContext, %struct.DVAudioContext* %22, i32 0, i32 2, !dbg !1711
  store i32 %conv, i32* %is_pal, align 4, !dbg !1712
  %23 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1713
  %bits_per_coded_sample = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %23, i32 0, i32 142, !dbg !1714
  %24 = load i32, i32* %bits_per_coded_sample, align 8, !dbg !1714
  %cmp20 = icmp eq i32 %24, 12, !dbg !1715
  %conv21 = zext i1 %cmp20 to i32, !dbg !1715
  %25 = load %struct.DVAudioContext*, %struct.DVAudioContext** %s, align 8, !dbg !1716
  %is_12bit = getelementptr inbounds %struct.DVAudioContext, %struct.DVAudioContext* %25, i32 0, i32 1, !dbg !1717
  store i32 %conv21, i32* %is_12bit, align 4, !dbg !1718
  %26 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1719
  %sample_fmt = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %26, i32 0, i32 84, !dbg !1720
  store i32 1, i32* %sample_fmt, align 8, !dbg !1721
  %27 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1722
  %channel_layout = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %27, i32 0, i32 89, !dbg !1723
  store i64 3, i64* %channel_layout, align 8, !dbg !1724
  store i32 0, i32* %i, align 4, !dbg !1725
  br label %for.cond, !dbg !1727

for.cond:                                         ; preds = %for.inc, %if.end17
  %28 = load i32, i32* %i, align 4, !dbg !1728
  %conv22 = sext i32 %28 to i64, !dbg !1728
  %cmp23 = icmp ult i64 %conv22, 2000, !dbg !1731
  br i1 %cmp23, label %for.body, label %for.end, !dbg !1732

for.body:                                         ; preds = %for.cond
  call void @llvm.dbg.declare(metadata i32* %a, metadata !1733, metadata !1639), !dbg !1736
  %29 = load %struct.DVAudioContext*, %struct.DVAudioContext** %s, align 8, !dbg !1737
  %is_pal25 = getelementptr inbounds %struct.DVAudioContext, %struct.DVAudioContext* %29, i32 0, i32 2, !dbg !1738
  %30 = load i32, i32* %is_pal25, align 4, !dbg !1738
  %tobool = icmp ne i32 %30, 0, !dbg !1737
  %cond = select i1 %tobool, i32 18, i32 15, !dbg !1737
  store i32 %cond, i32* %a, align 4, !dbg !1736
  call void @llvm.dbg.declare(metadata i32* %b, metadata !1739, metadata !1639), !dbg !1740
  %31 = load i32, i32* %a, align 4, !dbg !1741
  %mul = mul i32 3, %31, !dbg !1742
  store i32 %mul, i32* %b, align 4, !dbg !1740
  %32 = load i32, i32* %i, align 4, !dbg !1743
  %rem = srem i32 %32, 3, !dbg !1744
  %mul26 = mul nsw i32 21, %rem, !dbg !1745
  %33 = load i32, i32* %i, align 4, !dbg !1746
  %div = sdiv i32 %33, 3, !dbg !1747
  %mul27 = mul nsw i32 9, %div, !dbg !1748
  %add = add nsw i32 %mul26, %mul27, !dbg !1749
  %34 = load i32, i32* %i, align 4, !dbg !1750
  %35 = load i32, i32* %a, align 4, !dbg !1751
  %div28 = udiv i32 %34, %35, !dbg !1752
  %rem29 = urem i32 %div28, 3, !dbg !1753
  %add30 = add i32 %add, %rem29, !dbg !1754
  %36 = load i32, i32* %b, align 4, !dbg !1755
  %rem31 = urem i32 %add30, %36, !dbg !1756
  %mul32 = mul i32 80, %rem31, !dbg !1757
  %37 = load %struct.DVAudioContext*, %struct.DVAudioContext** %s, align 8, !dbg !1758
  %is_12bit33 = getelementptr inbounds %struct.DVAudioContext, %struct.DVAudioContext* %37, i32 0, i32 1, !dbg !1759
  %38 = load i32, i32* %is_12bit33, align 4, !dbg !1759
  %add34 = add nsw i32 2, %38, !dbg !1760
  %39 = load i32, i32* %i, align 4, !dbg !1761
  %40 = load i32, i32* %b, align 4, !dbg !1762
  %div35 = udiv i32 %39, %40, !dbg !1763
  %mul36 = mul i32 %add34, %div35, !dbg !1764
  %add37 = add i32 %mul32, %mul36, !dbg !1765
  %add38 = add i32 %add37, 8, !dbg !1766
  %conv39 = trunc i32 %add38 to i16, !dbg !1767
  %41 = load i32, i32* %i, align 4, !dbg !1768
  %idxprom = sext i32 %41 to i64, !dbg !1769
  %42 = load %struct.DVAudioContext*, %struct.DVAudioContext** %s, align 8, !dbg !1769
  %shuffle = getelementptr inbounds %struct.DVAudioContext, %struct.DVAudioContext* %42, i32 0, i32 3, !dbg !1770
  %arrayidx = getelementptr inbounds [2000 x i16], [2000 x i16]* %shuffle, i64 0, i64 %idxprom, !dbg !1769
  store i16 %conv39, i16* %arrayidx, align 2, !dbg !1771
  br label %for.inc, !dbg !1772

for.inc:                                          ; preds = %for.body
  %43 = load i32, i32* %i, align 4, !dbg !1773
  %inc = add nsw i32 %43, 1, !dbg !1773
  store i32 %inc, i32* %i, align 4, !dbg !1773
...
return:                                           ; preds = %for.end, %if.else14, %if.then
  %44 = load i32, i32* %retval, align 4, !dbg !1779
  ret i32 %44, !dbg !1779
}

; Function Attrs: nounwind uwtable
define internal i32 @decode_frame(%struct.AVCodecContext* %avctx, i8* %data, i32* %got_frame_ptr, %struct.AVPacket* %pkt) #1 !dbg !1780 {
entry:
  %x.addr.i42 = alloca i16, align 2
  call void @llvm.dbg.declare(metadata i16* %x.addr.i42, metadata !1781, metadata !1639), !dbg !1786
  %x.addr.i = alloca i16, align 2
  call void @llvm.dbg.declare(metadata i16* %x.addr.i, metadata !1781, metadata !1639), !dbg !1793
  %retval = alloca i32, align 4
  %avctx.addr = alloca %struct.AVCodecContext*, align 8
  ...
  %v = alloca i8*, align 8
  store %struct.AVCodecContext* %avctx, %struct.AVCodecContext** %avctx.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVCodecContext** %avctx.addr, metadata !1795, metadata !1639), !dbg !1796
  store i8* %data, i8** %data.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %data.addr, metadata !1797, metadata !1639), !dbg !1798
  store i32* %got_frame_ptr, i32** %got_frame_ptr.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %got_frame_ptr.addr, metadata !1799, metadata !1639), !dbg !1800
  store %struct.AVPacket* %pkt, %struct.AVPacket** %pkt.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.AVPacket** %pkt.addr, metadata !1801, metadata !1639), !dbg !1802
  call void @llvm.dbg.declare(metadata %struct.DVAudioContext** %s, metadata !1803, metadata !1639), !dbg !1804
  %0 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1805
  %priv_data = getelementptr inbounds %struct.AVCodecContext, %struct.AVCodecContext* %0, i32 0, i32 6, !dbg !1806
  %1 = load i8*, i8** %priv_data, align 8, !dbg !1806
  %2 = bitcast i8* %1 to %struct.DVAudioContext*, !dbg !1805
  store %struct.DVAudioContext* %2, %struct.DVAudioContext** %s, align 8, !dbg !1804
  call void @llvm.dbg.declare(metadata %struct.AVFrame** %frame, metadata !1807, metadata !1639), !dbg !1808
  %3 = load i8*, i8** %data.addr, align 8, !dbg !1809
  %4 = bitcast i8* %3 to %struct.AVFrame*, !dbg !1809
  store %struct.AVFrame* %4, %struct.AVFrame** %frame, align 8, !dbg !1808
  call void @llvm.dbg.declare(metadata i8** %src, metadata !1810, metadata !1639), !dbg !1811
  %5 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !1812
  %data1 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %5, i32 0, i32 3, !dbg !1813
  %6 = load i8*, i8** %data1, align 8, !dbg !1813
  store i8* %6, i8** %src, align 8, !dbg !1811
  call void @llvm.dbg.declare(metadata i16** %dst, metadata !1814, metadata !1639), !dbg !1815
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !1816, metadata !1639), !dbg !1817
  call void @llvm.dbg.declare(metadata i32* %i, metadata !1818, metadata !1639), !dbg !1819
  %7 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !1820
  %size = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %7, i32 0, i32 4, !dbg !1822
  %8 = load i32, i32* %size, align 8, !dbg !1822
  %9 = load %struct.DVAudioContext*, %struct.DVAudioContext** %s, align 8, !dbg !1823
  %block_size = getelementptr inbounds %struct.DVAudioContext, %struct.DVAudioContext* %9, i32 0, i32 0, !dbg !1824
  %10 = load i32, i32* %block_size, align 4, !dbg !1824
  %cmp = icmp slt i32 %8, %10, !dbg !1825
...
if.end:                                           ; preds = %entry
  %11 = load %struct.AVPacket*, %struct.AVPacket** %pkt.addr, align 8, !dbg !1828
  %data2 = getelementptr inbounds %struct.AVPacket, %struct.AVPacket* %11, i32 0, i32 3, !dbg !1829
  %12 = load i8*, i8** %data2, align 8, !dbg !1829
  %add.ptr = getelementptr inbounds i8, i8* %12, i64 244, !dbg !1830
  %13 = load %struct.DVAudioContext*, %struct.DVAudioContext** %s, align 8, !dbg !1831
  %is_pal = getelementptr inbounds %struct.DVAudioContext, %struct.DVAudioContext* %13, i32 0, i32 2, !dbg !1832
  %14 = load i32, i32* %is_pal, align 4, !dbg !1832
  %call = call i32 @dv_get_audio_sample_count(i8* %add.ptr, i32 %14), !dbg !1833
  %15 = load %struct.AVFrame*, %struct.AVFrame** %frame, align 8, !dbg !1834
  %nb_samples = getelementptr inbounds %struct.AVFrame, %struct.AVFrame* %15, i32 0, i32 5, !dbg !1835
  store i32 %call, i32* %nb_samples, align 8, !dbg !1836
  %16 = load %struct.AVCodecContext*, %struct.AVCodecContext** %avctx.addr, align 8, !dbg !1837
  %17 = load %struct.AVFrame*, %struct.AVFrame** %frame, align 8, !dbg !1839
  %call3 = call i32 @ff_get_buffer(%struct.AVCodecContext* %16, %struct.AVFrame* %17, i32 0), !dbg !1840
  store i32 %call3, i32* %ret, align 4, !dbg !1841
  %cmp4 = icmp slt i32 %call3, 0, !dbg !1842
  br i1 %cmp4, label %if.then5, label %if.end6, !dbg !1843

if.then5:                                         ; preds = %if.end
  %18 = load i32, i32* %ret, align 4, !dbg !1844
  store i32 %18, i32* %retval, align 4, !dbg !1845
  br label %return, !dbg !1845

if.end6:                                          ; preds = %if.end
  %19 = load %struct.AVFrame*, %struct.AVFrame** %frame, align 8, !dbg !1846
  %data7 = getelementptr inbounds %struct.AVFrame, %struct.AVFrame* %19, i32 0, i32 0, !dbg !1847
  %arrayidx = getelementptr inbounds [8 x i8*], [8 x i8*]* %data7, i64 0, i64 0, !dbg !1846
  %20 = load i8*, i8** %arrayidx, align 8, !dbg !1846
  %21 = bitcast i8* %20 to i16*, !dbg !1848
  store i16* %21, i16** %dst, align 8, !dbg !1849
  store i32 0, i32* %i, align 4, !dbg !1850
  br label %for.cond, !dbg !1851

for.cond:                                         ; preds = %for.inc, %if.end6
  %22 = load i32, i32* %i, align 4, !dbg !1852
  %23 = load %struct.AVFrame*, %struct.AVFrame** %frame, align 8, !dbg !1854
  %nb_samples8 = getelementptr inbounds %struct.AVFrame, %struct.AVFrame* %23, i32 0, i32 5, !dbg !1855
  %24 = load i32, i32* %nb_samples8, align 8, !dbg !1855
  %cmp9 = icmp slt i32 %22, %24, !dbg !1856
  br i1 %cmp9, label %for.body, label %for.end, !dbg !1857

for.body:                                         ; preds = %for.cond
  call void @llvm.dbg.declare(metadata i8** %v, metadata !1858, metadata !1639), !dbg !1859
  %25 = load i32, i32* %i, align 4, !dbg !1860
  %idxprom = sext i32 %25 to i64, !dbg !1861
  %26 = load %struct.DVAudioContext*, %struct.DVAudioContext** %s, align 8, !dbg !1861
  %shuffle = getelementptr inbounds %struct.DVAudioContext, %struct.DVAudioContext* %26, i32 0, i32 3, !dbg !1862
  %arrayidx10 = getelementptr inbounds [2000 x i16], [2000 x i16]* %shuffle, i64 0, i64 %idxprom, !dbg !1861
  %27 = load i16, i16* %arrayidx10, align 2, !dbg !1861
  %idxprom11 = sext i16 %27 to i64, !dbg !1863
  %28 = load i8*, i8** %src, align 8, !dbg !1863
  %arrayidx12 = getelementptr inbounds i8, i8* %28, i64 %idxprom11, !dbg !1863
  store i8* %arrayidx12, i8** %v, align 8, !dbg !1859
  %29 = load %struct.DVAudioContext*, %struct.DVAudioContext** %s, align 8, !dbg !1864
  %is_12bit = getelementptr inbounds %struct.DVAudioContext, %struct.DVAudioContext* %29, i32 0, i32 1, !dbg !1865
  %30 = load i32, i32* %is_12bit, align 4, !dbg !1865
  %tobool = icmp ne i32 %30, 0, !dbg !1864
  br i1 %tobool, label %if.then13, label %if.else, !dbg !1866

if.then13:                                        ; preds = %for.body
  %31 = load i8*, i8** %v, align 8, !dbg !1867
  %arrayidx14 = getelementptr inbounds i8, i8* %31, i64 0, !dbg !1867
  %32 = load i8, i8* %arrayidx14, align 1, !dbg !1867
  %conv = zext i8 %32 to i32, !dbg !1867
  %shl = shl i32 %conv, 4, !dbg !1869
  %33 = load i8*, i8** %v, align 8, !dbg !1870
  %arrayidx15 = getelementptr inbounds i8, i8* %33, i64 2, !dbg !1870
  %34 = load i8, i8* %arrayidx15, align 1, !dbg !1870
  %conv16 = zext i8 %34 to i32, !dbg !1870
  %shr = ashr i32 %conv16, 4, !dbg !1871
  %and = and i32 %shr, 15, !dbg !1872
  %or = or i32 %shl, %and, !dbg !1873
  %conv17 = trunc i32 %or to i16, !dbg !1874
  %call18 = call zeroext i16 @dv_audio_12to16(i16 zeroext %conv17), !dbg !1875
  %35 = load i16*, i16** %dst, align 8, !dbg !1876
  %incdec.ptr = getelementptr inbounds i16, i16* %35, i32 1, !dbg !1876
  store i16* %incdec.ptr, i16** %dst, align 8, !dbg !1876
  store i16 %call18, i16* %35, align 2, !dbg !1877
  %36 = load i8*, i8** %v, align 8, !dbg !1878
  %arrayidx19 = getelementptr inbounds i8, i8* %36, i64 1, !dbg !1878
  %37 = load i8, i8* %arrayidx19, align 1, !dbg !1878
  %conv20 = zext i8 %37 to i32, !dbg !1878
  %shl21 = shl i32 %conv20, 4, !dbg !1879
  %38 = load i8*, i8** %v, align 8, !dbg !1880
  %arrayidx22 = getelementptr inbounds i8, i8* %38, i64 2, !dbg !1880
  %39 = load i8, i8* %arrayidx22, align 1, !dbg !1880
  %conv23 = zext i8 %39 to i32, !dbg !1880
  %shr24 = ashr i32 %conv23, 0, !dbg !1881
  %and25 = and i32 %shr24, 15, !dbg !1882
  %or26 = or i32 %shl21, %and25, !dbg !1883
  %conv27 = trunc i32 %or26 to i16, !dbg !1884
  %call28 = call zeroext i16 @dv_audio_12to16(i16 zeroext %conv27), !dbg !1885
  %40 = load i16*, i16** %dst, align 8, !dbg !1886
  %incdec.ptr29 = getelementptr inbounds i16, i16* %40, i32 1, !dbg !1886
  store i16* %incdec.ptr29, i16** %dst, align 8, !dbg !1886
  store i16 %call28, i16* %40, align 2, !dbg !1887
  br label %if.end40, !dbg !1888

if.else:                                          ; preds = %for.body
  %41 = load i8*, i8** %v, align 8, !dbg !1889
  %arrayidx30 = getelementptr inbounds i8, i8* %41, i64 0, !dbg !1889
  %42 = bitcast i8* %arrayidx30 to %union.unaligned_16*, !dbg !1890
  %l = bitcast %union.unaligned_16* %42 to i16*, !dbg !1890
  %43 = load i16, i16* %l, align 1, !dbg !1890
  store i16 %43, i16* %x.addr.i, align 2, !dbg !1891
  %44 = load i16, i16* %x.addr.i, align 2, !dbg !1892
  %conv.i = zext i16 %44 to i32, !dbg !1892
  %shr.i = ashr i32 %conv.i, 8, !dbg !1893
  %45 = load i16, i16* %x.addr.i, align 2, !dbg !1894
  %conv1.i = zext i16 %45 to i32, !dbg !1894
  %shl.i = shl i32 %conv1.i, 8, !dbg !1895
  %or.i = or i32 %shr.i, %shl.i, !dbg !1896
  %conv2.i = trunc i32 %or.i to i16, !dbg !1897
  store i16 %conv2.i, i16* %x.addr.i, align 2, !dbg !1898
  %46 = load i16, i16* %x.addr.i, align 2, !dbg !1899
  %47 = load i16*, i16** %dst, align 8, !dbg !1900
  %incdec.ptr32 = getelementptr inbounds i16, i16* %47, i32 1, !dbg !1900
  store i16* %incdec.ptr32, i16** %dst, align 8, !dbg !1900
  store i16 %46, i16* %47, align 2, !dbg !1901
  %48 = load %struct.DVAudioContext*, %struct.DVAudioContext** %s, align 8, !dbg !1902
  %is_pal33 = getelementptr inbounds %struct.DVAudioContext, %struct.DVAudioContext* %48, i32 0, i32 2, !dbg !1903
  %49 = load i32, i32* %is_pal33, align 4, !dbg !1903
  %tobool34 = icmp ne i32 %49, 0, !dbg !1902
  %cond = select i1 %tobool34, i32 4320, i32 3600, !dbg !1902
  %idxprom35 = sext i32 %cond to i64, !dbg !1904
  %50 = load i8*, i8** %v, align 8, !dbg !1904
  %arrayidx36 = getelementptr inbounds i8, i8* %50, i64 %idxprom35, !dbg !1904
  %51 = bitcast i8* %arrayidx36 to %union.unaligned_16*, !dbg !1905
  %l37 = bitcast %union.unaligned_16* %51 to i16*, !dbg !1905
  %52 = load i16, i16* %l37, align 1, !dbg !1905
  store i16 %52, i16* %x.addr.i42, align 2, !dbg !1906
  %53 = load i16, i16* %x.addr.i42, align 2, !dbg !1907
  %conv.i43 = zext i16 %53 to i32, !dbg !1907
  %shr.i44 = ashr i32 %conv.i43, 8, !dbg !1908
  %54 = load i16, i16* %x.addr.i42, align 2, !dbg !1909
  %conv1.i45 = zext i16 %54 to i32, !dbg !1909
  %shl.i46 = shl i32 %conv1.i45, 8, !dbg !1910
  %or.i47 = or i32 %shr.i44, %shl.i46, !dbg !1911
  %conv2.i48 = trunc i32 %or.i47 to i16, !dbg !1912
  store i16 %conv2.i48, i16* %x.addr.i42, align 2, !dbg !1913
  %55 = load i16, i16* %x.addr.i42, align 2, !dbg !1914
  %56 = load i16*, i16** %dst, align 8, !dbg !1915
  %incdec.ptr39 = getelementptr inbounds i16, i16* %56, i32 1, !dbg !1915
  store i16* %incdec.ptr39, i16** %dst, align 8, !dbg !1915
  store i16 %55, i16* %56, align 2, !dbg !1916
  br label %if.end40
...
for.inc:                                          ; preds = %if.end40
  %57 = load i32, i32* %i, align 4, !dbg !1918
  %inc = add nsw i32 %57, 1, !dbg !1918
  store i32 %inc, i32* %i, align 4, !dbg !1918
  br label %for.cond, !dbg !1920, !llvm.loop !1921

for.end:                                          ; preds = %for.cond
  %58 = load i32*, i32** %got_frame_ptr.addr, align 8, !dbg !1923
  store i32 1, i32* %58, align 4, !dbg !1924
  %59 = load %struct.DVAudioContext*, %struct.DVAudioContext** %s, align 8, !dbg !1925
  %block_size41 = getelementptr inbounds %struct.DVAudioContext, %struct.DVAudioContext* %59, i32 0, i32 0, !dbg !1926
  %60 = load i32, i32* %block_size41, align 4, !dbg !1926
  store i32 %60, i32* %retval, align 4, !dbg !1927
  br label %return, !dbg !1927

return:                                           ; preds = %for.end, %if.then5, %if.then
  %61 = load i32, i32* %retval, align 4, !dbg !1928
  ret i32 %61, !dbg !1928
}
...
define internal i32 @dv_get_audio_sample_count(i8* %buffer, i32 %dsf) #4 !dbg !1929 {
entry:
  %retval = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata i8** %buffer.addr, metadata !1933, metadata !1639), !dbg !1934
  store i32 %dsf, i32* %dsf.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %dsf.addr, metadata !1935, metadata !1639), !dbg !1936
  call void @llvm.dbg.declare(metadata i32* %samples, metadata !1937, metadata !1639), !dbg !1938
  %0 = load i8*, i8** %buffer.addr, align 8, !dbg !1939
  %arrayidx = getelementptr inbounds i8, i8* %0, i64 0, !dbg !1939
  %1 = load i8, i8* %arrayidx, align 1, !dbg !1939
  %conv = zext i8 %1 to i32, !dbg !1939
  %and = and i32 %conv, 63, !dbg !1940
  store i32 %and, i32* %samples, align 4, !dbg !1938
  %2 = load i8*, i8** %buffer.addr, align 8, !dbg !1941
  %arrayidx1 = getelementptr inbounds i8, i8* %2, i64 3, !dbg !1941
  %3 = load i8, i8* %arrayidx1, align 1, !dbg !1941
  %conv2 = zext i8 %3 to i32, !dbg !1941
  %shr = ashr i32 %conv2, 3, !dbg !1942
  %and3 = and i32 %shr, 7, !dbg !1943
...
sw.bb:                                            ; preds = %entry
  %4 = load i32, i32* %samples, align 4, !dbg !1945
  %5 = load i32, i32* %dsf.addr, align 4, !dbg !1947
  %tobool = icmp ne i32 %5, 0, !dbg !1947
  %cond = select i1 %tobool, i32 1896, i32 1580, !dbg !1947
  %add = add nsw i32 %4, %cond, !dbg !1948
  store i32 %add, i32* %retval, align 4, !dbg !1949
  br label %return, !dbg !1949

sw.bb4:                                           ; preds = %entry
  %6 = load i32, i32* %samples, align 4, !dbg !1950
  %7 = load i32, i32* %dsf.addr, align 4, !dbg !1951
  %tobool5 = icmp ne i32 %7, 0, !dbg !1951
  %cond6 = select i1 %tobool5, i32 1742, i32 1452, !dbg !1951
  %add7 = add nsw i32 %6, %cond6, !dbg !1952
  store i32 %add7, i32* %retval, align 4, !dbg !1953
  br label %return, !dbg !1953

sw.bb8:                                           ; preds = %entry
  br label %sw.default, !dbg !1954

sw.default:                                       ; preds = %entry, %sw.bb8
  %8 = load i32, i32* %samples, align 4, !dbg !1956
  %9 = load i32, i32* %dsf.addr, align 4, !dbg !1957
  %tobool9 = icmp ne i32 %9, 0, !dbg !1957
  %cond10 = select i1 %tobool9, i32 1264, i32 1053, !dbg !1957
  %add11 = add nsw i32 %8, %cond10, !dbg !1958
  store i32 %add11, i32* %retval, align 4, !dbg !1959
  br label %return, !dbg !1959

return:                                           ; preds = %sw.default, %sw.bb4, %sw.bb
  %10 = load i32, i32* %retval, align 4, !dbg !1960
  ret i32 %10, !dbg !1960
}
...
; Function Attrs: inlinehint nounwind uwtable
define internal zeroext i16 @dv_audio_12to16(i16 zeroext %sample) #4 !dbg !1961 {
entry:
  %sample.addr = alloca i16, align 2
  %shift = alloca i16, align 2
  %result = alloca i16, align 2
  store i16 %sample, i16* %sample.addr, align 2
  call void @llvm.dbg.declare(metadata i16* %sample.addr, metadata !1962, metadata !1639), !dbg !1963
  call void @llvm.dbg.declare(metadata i16* %shift, metadata !1964, metadata !1639), !dbg !1965
  call void @llvm.dbg.declare(metadata i16* %result, metadata !1966, metadata !1639), !dbg !1967
  %0 = load i16, i16* %sample.addr, align 2, !dbg !1968
  %conv = zext i16 %0 to i32, !dbg !1968
  %cmp = icmp slt i32 %conv, 2048, !dbg !1969
  br i1 %cmp, label %cond.true, label %cond.false, !dbg !1970

cond.true:                                        ; preds = %entry
  %1 = load i16, i16* %sample.addr, align 2, !dbg !1971
  %conv2 = zext i16 %1 to i32, !dbg !1971
  br label %cond.end, !dbg !1973

cond.false:                                       ; preds = %entry
  %2 = load i16, i16* %sample.addr, align 2, !dbg !1974
  %conv3 = zext i16 %2 to i32, !dbg !1974
  %or = or i32 %conv3, 61440, !dbg !1976
  br label %cond.end, !dbg !1977

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %conv2, %cond.true ], [ %or, %cond.false ], !dbg !1978
  %conv4 = trunc i32 %cond to i16, !dbg !1978
  store i16 %conv4, i16* %sample.addr, align 2, !dbg !1980
  %3 = load i16, i16* %sample.addr, align 2, !dbg !1981
  %conv5 = zext i16 %3 to i32, !dbg !1981
  %and = and i32 %conv5, 3840, !dbg !1982
  %shr = ashr i32 %and, 8, !dbg !1983
  %conv6 = trunc i32 %shr to i16, !dbg !1984
  store i16 %conv6, i16* %shift, align 2, !dbg !1985
  %4 = load i16, i16* %shift, align 2, !dbg !1986
  %conv7 = zext i16 %4 to i32, !dbg !1986
  %cmp8 = icmp slt i32 %conv7, 2, !dbg !1988
  br i1 %cmp8, label %if.then, label %lor.lhs.false, !dbg !1989

lor.lhs.false:                                    ; preds = %cond.end
  %5 = load i16, i16* %shift, align 2, !dbg !1990
  %conv10 = zext i16 %5 to i32, !dbg !1990
  %cmp11 = icmp sgt i32 %conv10, 13, !dbg !1992
  br i1 %cmp11, label %if.then, label %if.else, !dbg !1993

if.then:                                          ; preds = %lor.lhs.false, %cond.end
  %6 = load i16, i16* %sample.addr, align 2, !dbg !1994
  store i16 %6, i16* %result, align 2, !dbg !1996
  br label %if.end33, !dbg !1997

if.else:                                          ; preds = %lor.lhs.false
  %7 = load i16, i16* %shift, align 2, !dbg !1998
  %conv13 = zext i16 %7 to i32, !dbg !1998
  %cmp14 = icmp slt i32 %conv13, 8, !dbg !2001
  br i1 %cmp14, label %if.then16, label %if.else21, !dbg !1998

if.then16:                                        ; preds = %if.else
  %8 = load i16, i16* %shift, align 2, !dbg !2002
  %dec = add i16 %8, -1, !dbg !2002
  store i16 %dec, i16* %shift, align 2, !dbg !2002
  %9 = load i16, i16* %sample.addr, align 2, !dbg !2004
  %conv17 = zext i16 %9 to i32, !dbg !2004
  %10 = load i16, i16* %shift, align 2, !dbg !2005
  %conv18 = zext i16 %10 to i32, !dbg !2005
  %mul = mul nsw i32 256, %conv18, !dbg !2006
  %sub = sub nsw i32 %conv17, %mul, !dbg !2007
  %11 = load i16, i16* %shift, align 2, !dbg !2008
  %conv19 = zext i16 %11 to i32, !dbg !2008
  %shl = shl i32 %sub, %conv19, !dbg !2009
  %conv20 = trunc i32 %shl to i16, !dbg !2010
  store i16 %conv20, i16* %result, align 2, !dbg !2011
  br label %if.end, !dbg !2012

if.else21:                                        ; preds = %if.else
  %12 = load i16, i16* %shift, align 2, !dbg !2013
  %conv22 = zext i16 %12 to i32, !dbg !2013
  %sub23 = sub nsw i32 14, %conv22, !dbg !2015
  %conv24 = trunc i32 %sub23 to i16, !dbg !2016
  store i16 %conv24, i16* %shift, align 2, !dbg !2017
  %13 = load i16, i16* %sample.addr, align 2, !dbg !2018
  %conv25 = zext i16 %13 to i32, !dbg !2018
  %14 = load i16, i16* %shift, align 2, !dbg !2019
  %conv26 = zext i16 %14 to i32, !dbg !2019
  %mul27 = mul nsw i32 256, %conv26, !dbg !2020
  %add = add nsw i32 %mul27, 1, !dbg !2021
  %add28 = add nsw i32 %conv25, %add, !dbg !2022
  %15 = load i16, i16* %shift, align 2, !dbg !2023
  %conv29 = zext i16 %15 to i32, !dbg !2023
  %shl30 = shl i32 %add28, %conv29, !dbg !2024
  %sub31 = sub nsw i32 %shl30, 1, !dbg !2025
  %conv32 = trunc i32 %sub31 to i16, !dbg !2026
  store i16 %conv32, i16* %result, align 2, !dbg !2027
  br label %if.end
...
if.end33:                                         ; preds = %if.end, %if.then
  %16 = load i16, i16* %result, align 2, !dbg !2028
  ret i16 %16, !dbg !2029
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a/[inter]libavcodec--dvaudiodec.o.i", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a")
...
!902 = !{!903}
!903 = distinct !DIGlobalVariable(name: "ff_dvaudio_decoder", scope: !0, file: !904, line: 124, type: !905, isLocal: false, isDefinition: true, variable: %struct.AVCodec* @ff_dvaudio_decoder)
!904 = !DIFile(filename: "libavcodec/dvaudiodec.c", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a")
...
!937 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint64_t", file: !892, line: 55, baseType: !938)
...
!940 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint8_t", file: !892, line: 48, baseType: !941)
...
!1220 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint32_t", file: !892, line: 51, baseType: !889)
...
!1250 = !DIDerivedType(tag: DW_TAG_member, name: "nb_bsfs", scope: !1174, file: !1016, line: 126, baseType: !888, size: 32, align: 32, offset: 64)
...
!1253 = !DIDerivedType(tag: DW_TAG_member, name: "byte_buffer_size", scope: !1015, file: !1016, line: 178, baseType: !889, size: 32, align: 32, offset: 704)
...
!1255 = !DIDerivedType(tag: DW_TAG_member, name: "skip_samples", scope: !1015, file: !1016, line: 185, baseType: !888, size: 32, align: 32, offset: 832)
...
!1257 = !DIDerivedType(tag: DW_TAG_member, name: "draining", scope: !1015, file: !1016, line: 195, baseType: !888, size: 32, align: 32, offset: 960)
...
!1259 = !DIDerivedType(tag: DW_TAG_member, name: "buffer_pkt_valid", scope: !1015, file: !1016, line: 201, baseType: !888, size: 32, align: 32, offset: 1088)
...
!1261 = !DIDerivedType(tag: DW_TAG_member, name: "draining_done", scope: !1015, file: !1016, line: 203, baseType: !888, size: 32, align: 32, offset: 1216)
!1262 = !DIDerivedType(tag: DW_TAG_member, name: "compat_decode", scope: !1015, file: !1016, line: 205, baseType: !888, size: 32, align: 32, offset: 1248)
!1263 = !DIDerivedType(tag: DW_TAG_member, name: "compat_decode_warned", scope: !1015, file: !1016, line: 206, baseType: !888, size: 32, align: 32, offset: 1280)
...
!1267 = !DIDerivedType(tag: DW_TAG_member, name: "showed_multi_packet_warning", scope: !1015, file: !1016, line: 215, baseType: !888, size: 32, align: 32, offset: 1536)
!1268 = !DIDerivedType(tag: DW_TAG_member, name: "skip_samples_multiplier", scope: !1015, file: !1016, line: 217, baseType: !888, size: 32, align: 32, offset: 1568)
!1269 = !DIDerivedType(tag: DW_TAG_member, name: "nb_draining_errors", scope: !1015, file: !1016, line: 220, baseType: !888, size: 32, align: 32, offset: 1600)
...
!1272 = !DIDerivedType(tag: DW_TAG_member, name: "bit_rate_tolerance", scope: !1002, file: !14, line: 1614, baseType: !888, size: 32, align: 32, offset: 512)
!1273 = !DIDerivedType(tag: DW_TAG_member, name: "global_quality", scope: !1002, file: !14, line: 1622, baseType: !888, size: 32, align: 32, offset: 544)
!1274 = !DIDerivedType(tag: DW_TAG_member, name: "compression_level", scope: !1002, file: !14, line: 1628, baseType: !888, size: 32, align: 32, offset: 576)
!1275 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !1002, file: !14, line: 1636, baseType: !888, size: 32, align: 32, offset: 608)
!1276 = !DIDerivedType(tag: DW_TAG_member, name: "flags2", scope: !1002, file: !14, line: 1643, baseType: !888, size: 32, align: 32, offset: 640)
...
!1278 = !DIDerivedType(tag: DW_TAG_member, name: "extradata_size", scope: !1002, file: !14, line: 1658, baseType: !888, size: 32, align: 32, offset: 768)
...
!1280 = !DIDerivedType(tag: DW_TAG_member, name: "ticks_per_frame", scope: !1002, file: !14, line: 1688, baseType: !888, size: 32, align: 32, offset: 864)
!1281 = !DIDerivedType(tag: DW_TAG_member, name: "delay", scope: !1002, file: !14, line: 1712, baseType: !888, size: 32, align: 32, offset: 896)
!1282 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !1002, file: !14, line: 1729, baseType: !888, size: 32, align: 32, offset: 928)
!1283 = !DIDerivedType(tag: DW_TAG_member, name: "height", scope: !1002, file: !14, line: 1729, baseType: !888, size: 32, align: 32, offset: 960)
!1284 = !DIDerivedType(tag: DW_TAG_member, name: "coded_width", scope: !1002, file: !14, line: 1744, baseType: !888, size: 32, align: 32, offset: 992)
!1285 = !DIDerivedType(tag: DW_TAG_member, name: "coded_height", scope: !1002, file: !14, line: 1744, baseType: !888, size: 32, align: 32, offset: 1024)
!1286 = !DIDerivedType(tag: DW_TAG_member, name: "gop_size", scope: !1002, file: !14, line: 1751, baseType: !888, size: 32, align: 32, offset: 1056)
...
!1299 = !{!473, !1292, !926}
!1300 = !DIDerivedType(tag: DW_TAG_member, name: "max_b_frames", scope: !1002, file: !14, line: 1816, baseType: !888, size: 32, align: 32, offset: 1280)
...
!1303 = !DIDerivedType(tag: DW_TAG_member, name: "b_frame_strategy", scope: !1002, file: !14, line: 1830, baseType: !888, size: 32, align: 32, offset: 1344)
...
!1305 = !DIDerivedType(tag: DW_TAG_member, name: "has_b_frames", scope: !1002, file: !14, line: 1846, baseType: !888, size: 32, align: 32, offset: 1408)
!1306 = !DIDerivedType(tag: DW_TAG_member, name: "mpeg_quant", scope: !1002, file: !14, line: 1851, baseType: !888, size: 32, align: 32, offset: 1440)
...
!1314 = !DIDerivedType(tag: DW_TAG_member, name: "slice_count", scope: !1002, file: !14, line: 1910, baseType: !888, size: 32, align: 32, offset: 1696)
!1315 = !DIDerivedType(tag: DW_TAG_member, name: "prediction_method", scope: !1002, file: !14, line: 1915, baseType: !888, size: 32, align: 32, offset: 1728)
...
!1318 = !DIDerivedType(tag: DW_TAG_member, name: "me_cmp", scope: !1002, file: !14, line: 1942, baseType: !888, size: 32, align: 32, offset: 1920)
!1319 = !DIDerivedType(tag: DW_TAG_member, name: "me_sub_cmp", scope: !1002, file: !14, line: 1948, baseType: !888, size: 32, align: 32, offset: 1952)
!1320 = !DIDerivedType(tag: DW_TAG_member, name: "mb_cmp", scope: !1002, file: !14, line: 1954, baseType: !888, size: 32, align: 32, offset: 1984)
!1321 = !DIDerivedType(tag: DW_TAG_member, name: "ildct_cmp", scope: !1002, file: !14, line: 1960, baseType: !888, size: 32, align: 32, offset: 2016)
!1322 = !DIDerivedType(tag: DW_TAG_member, name: "dia_size", scope: !1002, file: !14, line: 1984, baseType: !888, size: 32, align: 32, offset: 2048)
!1323 = !DIDerivedType(tag: DW_TAG_member, name: "last_predictor_count", scope: !1002, file: !14, line: 1991, baseType: !888, size: 32, align: 32, offset: 2080)
!1324 = !DIDerivedType(tag: DW_TAG_member, name: "pre_me", scope: !1002, file: !14, line: 1996, baseType: !888, size: 32, align: 32, offset: 2112)
!1325 = !DIDerivedType(tag: DW_TAG_member, name: "me_pre_cmp", scope: !1002, file: !14, line: 2004, baseType: !888, size: 32, align: 32, offset: 2144)
!1326 = !DIDerivedType(tag: DW_TAG_member, name: "pre_dia_size", scope: !1002, file: !14, line: 2011, baseType: !888, size: 32, align: 32, offset: 2176)
!1327 = !DIDerivedType(tag: DW_TAG_member, name: "me_subpel_quality", scope: !1002, file: !14, line: 2018, baseType: !888, size: 32, align: 32, offset: 2208)
!1328 = !DIDerivedType(tag: DW_TAG_member, name: "me_range", scope: !1002, file: !14, line: 2027, baseType: !888, size: 32, align: 32, offset: 2240)
!1329 = !DIDerivedType(tag: DW_TAG_member, name: "slice_flags", scope: !1002, file: !14, line: 2034, baseType: !888, size: 32, align: 32, offset: 2272)
!1330 = !DIDerivedType(tag: DW_TAG_member, name: "mb_decision", scope: !1002, file: !14, line: 2044, baseType: !888, size: 32, align: 32, offset: 2304)
...
!1482 = !{!888, !1292, !1483, !953, !1295, !888, !888}
...
!1489 = !{!888, !1292, !1490, !953, !1295, !888}
!1490 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1491, size: 64, align: 64)
!1491 = !DISubroutineType(types: !1492)
!1492 = !{!888, !1292, !953, !888, !888}
...
!1636 = distinct !DISubprogram(name: "decode_init", scope: !904, file: !904, line: 33, type: !998, isLocal: true, isDefinition: true, scopeLine: 34, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1637)
!1637 = !{}
!1638 = !DILocalVariable(name: "avctx", arg: 1, scope: !1636, file: !904, line: 33, type: !1000)
!1639 = !DIExpression()
!1640 = !DILocation(line: 33, column: 62, scope: !1636)
!1641 = !DILocalVariable(name: "s", scope: !1636, file: !904, line: 35, type: !1642)
!1642 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1643, size: 64, align: 64)
!1643 = !DIDerivedType(tag: DW_TAG_typedef, name: "DVAudioContext", file: !904, line: 31, baseType: !1644)
!1644 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "DVAudioContext", file: !904, line: 26, size: 32096, align: 32, elements: !1645)
!1645 = !{!1646, !1647, !1648, !1649}
!1646 = !DIDerivedType(tag: DW_TAG_member, name: "block_size", scope: !1644, file: !904, line: 27, baseType: !888, size: 32, align: 32)
!1647 = !DIDerivedType(tag: DW_TAG_member, name: "is_12bit", scope: !1644, file: !904, line: 28, baseType: !888, size: 32, align: 32, offset: 32)
!1648 = !DIDerivedType(tag: DW_TAG_member, name: "is_pal", scope: !1644, file: !904, line: 29, baseType: !888, size: 32, align: 32, offset: 64)
!1649 = !DIDerivedType(tag: DW_TAG_member, name: "shuffle", scope: !1644, file: !904, line: 30, baseType: !1650, size: 32000, align: 16, offset: 96)
!1650 = !DICompositeType(tag: DW_TAG_array_type, baseType: !891, size: 32000, align: 16, elements: !1651)
!1651 = !{!1652}
!1652 = !DISubrange(count: 2000)
!1653 = !DILocation(line: 35, column: 21, scope: !1636)
!1654 = !DILocation(line: 35, column: 25, scope: !1636)
!1655 = !DILocation(line: 35, column: 32, scope: !1636)
!1656 = !DILocalVariable(name: "i", scope: !1636, file: !904, line: 36, type: !888)
!1657 = !DILocation(line: 36, column: 9, scope: !1636)
!1658 = !DILocation(line: 38, column: 9, scope: !1659)
!1659 = distinct !DILexicalBlock(scope: !1636, file: !904, line: 38, column: 9)
!1660 = !DILocation(line: 38, column: 16, scope: !1659)
!1661 = !DILocation(line: 38, column: 25, scope: !1659)
!1662 = !DILocation(line: 38, column: 9, scope: !1636)
!1663 = !DILocation(line: 39, column: 16, scope: !1664)
!1664 = distinct !DILexicalBlock(scope: !1659, file: !904, line: 38, column: 31)
!1665 = !DILocation(line: 39, column: 9, scope: !1664)
!1666 = !DILocation(line: 40, column: 9, scope: !1664)
!1667 = !DILocation(line: 43, column: 9, scope: !1668)
!1668 = distinct !DILexicalBlock(scope: !1636, file: !904, line: 43, column: 9)
!1669 = !DILocation(line: 43, column: 16, scope: !1668)
!1670 = !DILocation(line: 43, column: 26, scope: !1668)
!1671 = !DILocation(line: 43, column: 9, scope: !1636)
!1672 = !DILocation(line: 44, column: 9, scope: !1673)
!1673 = distinct !DILexicalBlock(scope: !1668, file: !904, line: 43, column: 37)
!1674 = !DILocation(line: 44, column: 12, scope: !1673)
!1675 = !DILocation(line: 44, column: 23, scope: !1673)
!1676 = !DILocation(line: 45, column: 5, scope: !1673)
!1677 = !DILocation(line: 45, column: 16, scope: !1678)
!1678 = !DILexicalBlockFile(scope: !1679, file: !904, discriminator: 1)
!1679 = distinct !DILexicalBlock(scope: !1668, file: !904, line: 45, column: 16)
!1680 = !DILocation(line: 45, column: 23, scope: !1678)
!1681 = !DILocation(line: 45, column: 33, scope: !1678)
!1682 = !DILocation(line: 46, column: 9, scope: !1683)
!1683 = distinct !DILexicalBlock(scope: !1679, file: !904, line: 45, column: 44)
!1684 = !DILocation(line: 46, column: 12, scope: !1683)
!1685 = !DILocation(line: 46, column: 23, scope: !1683)
!1686 = !DILocation(line: 47, column: 5, scope: !1683)
!1687 = !DILocation(line: 47, column: 16, scope: !1688)
!1688 = !DILexicalBlockFile(scope: !1689, file: !904, discriminator: 1)
!1689 = distinct !DILexicalBlock(scope: !1679, file: !904, line: 47, column: 16)
!1690 = !DILocation(line: 47, column: 23, scope: !1688)
!1691 = !DILocation(line: 47, column: 35, scope: !1688)
!1692 = !DILocation(line: 47, column: 43, scope: !1688)
!1693 = !DILocation(line: 48, column: 16, scope: !1689)
!1694 = !DILocation(line: 48, column: 23, scope: !1689)
!1695 = !DILocation(line: 48, column: 35, scope: !1689)
!1696 = !DILocation(line: 47, column: 16, scope: !1697)
!1697 = !DILexicalBlockFile(scope: !1679, file: !904, discriminator: 2)
!1698 = !DILocation(line: 49, column: 25, scope: !1699)
!1699 = distinct !DILexicalBlock(scope: !1689, file: !904, line: 48, column: 44)
!1700 = !DILocation(line: 49, column: 32, scope: !1699)
!1701 = !DILocation(line: 49, column: 9, scope: !1699)
!1702 = !DILocation(line: 49, column: 12, scope: !1699)
!1703 = !DILocation(line: 49, column: 23, scope: !1699)
!1704 = !DILocation(line: 50, column: 5, scope: !1699)
!1705 = !DILocation(line: 51, column: 9, scope: !1706)
!1706 = distinct !DILexicalBlock(scope: !1689, file: !904, line: 50, column: 12)
!1707 = !DILocation(line: 54, column: 17, scope: !1636)
!1708 = !DILocation(line: 54, column: 20, scope: !1636)
!1709 = !DILocation(line: 54, column: 31, scope: !1636)
!1710 = !DILocation(line: 54, column: 5, scope: !1636)
!1711 = !DILocation(line: 54, column: 8, scope: !1636)
!1712 = !DILocation(line: 54, column: 15, scope: !1636)
!1713 = !DILocation(line: 55, column: 19, scope: !1636)
!1714 = !DILocation(line: 55, column: 26, scope: !1636)
!1715 = !DILocation(line: 55, column: 48, scope: !1636)
!1716 = !DILocation(line: 55, column: 5, scope: !1636)
!1717 = !DILocation(line: 55, column: 8, scope: !1636)
!1718 = !DILocation(line: 55, column: 17, scope: !1636)
!1719 = !DILocation(line: 56, column: 5, scope: !1636)
!1720 = !DILocation(line: 56, column: 12, scope: !1636)
!1721 = !DILocation(line: 56, column: 23, scope: !1636)
!1722 = !DILocation(line: 57, column: 5, scope: !1636)
!1723 = !DILocation(line: 57, column: 12, scope: !1636)
!1724 = !DILocation(line: 57, column: 27, scope: !1636)
!1725 = !DILocation(line: 59, column: 12, scope: !1726)
!1726 = distinct !DILexicalBlock(scope: !1636, file: !904, line: 59, column: 5)
!1727 = !DILocation(line: 59, column: 10, scope: !1726)
!1728 = !DILocation(line: 59, column: 17, scope: !1729)
!1729 = !DILexicalBlockFile(scope: !1730, file: !904, discriminator: 1)
!1730 = distinct !DILexicalBlock(scope: !1726, file: !904, line: 59, column: 5)
!1731 = !DILocation(line: 59, column: 19, scope: !1729)
!1732 = !DILocation(line: 59, column: 5, scope: !1729)
!1733 = !DILocalVariable(name: "a", scope: !1734, file: !904, line: 60, type: !1735)
!1734 = distinct !DILexicalBlock(scope: !1730, file: !904, line: 59, column: 74)
!1735 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !889)
!1736 = !DILocation(line: 60, column: 24, scope: !1734)
!1737 = !DILocation(line: 60, column: 28, scope: !1734)
!1738 = !DILocation(line: 60, column: 31, scope: !1734)
!1739 = !DILocalVariable(name: "b", scope: !1734, file: !904, line: 61, type: !1735)
!1740 = !DILocation(line: 61, column: 24, scope: !1734)
!1741 = !DILocation(line: 61, column: 32, scope: !1734)
!1742 = !DILocation(line: 61, column: 30, scope: !1734)
!1743 = !DILocation(line: 63, column: 38, scope: !1734)
!1744 = !DILocation(line: 63, column: 40, scope: !1734)
!1745 = !DILocation(line: 63, column: 35, scope: !1734)
!1746 = !DILocation(line: 63, column: 52, scope: !1734)
!1747 = !DILocation(line: 63, column: 54, scope: !1734)
!1748 = !DILocation(line: 63, column: 49, scope: !1734)
!1749 = !DILocation(line: 63, column: 45, scope: !1734)
!1750 = !DILocation(line: 63, column: 63, scope: !1734)
!1751 = !DILocation(line: 63, column: 67, scope: !1734)
!1752 = !DILocation(line: 63, column: 65, scope: !1734)
!1753 = !DILocation(line: 63, column: 70, scope: !1734)
!1754 = !DILocation(line: 63, column: 59, scope: !1734)
!1755 = !DILocation(line: 63, column: 78, scope: !1734)
!1756 = !DILocation(line: 63, column: 76, scope: !1734)
!1757 = !DILocation(line: 63, column: 28, scope: !1734)
!1758 = !DILocation(line: 64, column: 31, scope: !1734)
!1759 = !DILocation(line: 64, column: 34, scope: !1734)
!1760 = !DILocation(line: 64, column: 29, scope: !1734)
!1761 = !DILocation(line: 64, column: 47, scope: !1734)
!1762 = !DILocation(line: 64, column: 51, scope: !1734)
!1763 = !DILocation(line: 64, column: 49, scope: !1734)
!1764 = !DILocation(line: 64, column: 44, scope: !1734)
!1765 = !DILocation(line: 63, column: 81, scope: !1734)
!1766 = !DILocation(line: 64, column: 54, scope: !1734)
!1767 = !DILocation(line: 63, column: 25, scope: !1734)
!1768 = !DILocation(line: 63, column: 20, scope: !1734)
!1769 = !DILocation(line: 63, column: 9, scope: !1734)
!1770 = !DILocation(line: 63, column: 12, scope: !1734)
!1771 = !DILocation(line: 63, column: 23, scope: !1734)
!1772 = !DILocation(line: 65, column: 5, scope: !1734)
!1773 = !DILocation(line: 59, column: 70, scope: !1774)
!1774 = !DILexicalBlockFile(scope: !1730, file: !904, discriminator: 2)
!1775 = !DILocation(line: 59, column: 5, scope: !1774)
!1776 = distinct !{!1776, !1777}
!1777 = !DILocation(line: 59, column: 5, scope: !1636)
!1778 = !DILocation(line: 67, column: 5, scope: !1636)
!1779 = !DILocation(line: 68, column: 1, scope: !1636)
!1780 = distinct !DISubprogram(name: "decode_frame", scope: !904, file: !904, line: 90, type: !1610, isLocal: true, isDefinition: true, scopeLine: 92, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1637)
!1781 = !DILocalVariable(name: "x", arg: 1, scope: !1782, file: !1783, line: 58, type: !900)
!1782 = distinct !DISubprogram(name: "av_bswap16", scope: !1783, file: !1783, line: 58, type: !1784, isLocal: true, isDefinition: true, scopeLine: 59, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1637)
!1783 = !DIFile(filename: "./libavutil/bswap.h", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a")
!1784 = !DISubroutineType(types: !1785)
!1785 = !{!900, !900}
!1786 = !DILocation(line: 58, column: 98, scope: !1782, inlinedAt: !1787)
!1787 = distinct !DILocation(line: 115, column: 21, scope: !1788)
!1788 = distinct !DILexicalBlock(scope: !1789, file: !904, line: 113, column: 15)
!1789 = distinct !DILexicalBlock(scope: !1790, file: !904, line: 110, column: 12)
!1790 = distinct !DILexicalBlock(scope: !1791, file: !904, line: 107, column: 45)
!1791 = distinct !DILexicalBlock(scope: !1792, file: !904, line: 107, column: 5)
!1792 = distinct !DILexicalBlock(scope: !1780, file: !904, line: 107, column: 5)
!1793 = !DILocation(line: 58, column: 98, scope: !1782, inlinedAt: !1794)
!1794 = distinct !DILocation(line: 114, column: 21, scope: !1788)
!1795 = !DILocalVariable(name: "avctx", arg: 1, scope: !1780, file: !904, line: 90, type: !1000)
!1796 = !DILocation(line: 90, column: 41, scope: !1780)
!1797 = !DILocalVariable(name: "data", arg: 2, scope: !1780, file: !904, line: 90, type: !953)
!1798 = !DILocation(line: 90, column: 54, scope: !1780)
!1799 = !DILocalVariable(name: "got_frame_ptr", arg: 3, scope: !1780, file: !904, line: 91, type: !1295)
!1800 = !DILocation(line: 91, column: 30, scope: !1780)
!1801 = !DILocalVariable(name: "pkt", arg: 4, scope: !1780, file: !904, line: 91, type: !1148)
!1802 = !DILocation(line: 91, column: 55, scope: !1780)
!1803 = !DILocalVariable(name: "s", scope: !1780, file: !904, line: 93, type: !1642)
!1804 = !DILocation(line: 93, column: 21, scope: !1780)
!1805 = !DILocation(line: 93, column: 25, scope: !1780)
!1806 = !DILocation(line: 93, column: 32, scope: !1780)
!1807 = !DILocalVariable(name: "frame", scope: !1780, file: !904, line: 94, type: !1022)
!1808 = !DILocation(line: 94, column: 14, scope: !1780)
!1809 = !DILocation(line: 94, column: 22, scope: !1780)
!1810 = !DILocalVariable(name: "src", scope: !1780, file: !904, line: 95, type: !1444)
!1811 = !DILocation(line: 95, column: 20, scope: !1780)
!1812 = !DILocation(line: 95, column: 26, scope: !1780)
!1813 = !DILocation(line: 95, column: 31, scope: !1780)
!1814 = !DILocalVariable(name: "dst", scope: !1780, file: !904, line: 96, type: !890)
!1815 = !DILocation(line: 96, column: 14, scope: !1780)
!1816 = !DILocalVariable(name: "ret", scope: !1780, file: !904, line: 97, type: !888)
!1817 = !DILocation(line: 97, column: 9, scope: !1780)
!1818 = !DILocalVariable(name: "i", scope: !1780, file: !904, line: 97, type: !888)
!1819 = !DILocation(line: 97, column: 14, scope: !1780)
!1820 = !DILocation(line: 99, column: 9, scope: !1821)
!1821 = distinct !DILexicalBlock(scope: !1780, file: !904, line: 99, column: 9)
!1822 = !DILocation(line: 99, column: 14, scope: !1821)
!1823 = !DILocation(line: 99, column: 21, scope: !1821)
!1824 = !DILocation(line: 99, column: 24, scope: !1821)
!1825 = !DILocation(line: 99, column: 19, scope: !1821)
!1826 = !DILocation(line: 99, column: 9, scope: !1780)
!1827 = !DILocation(line: 100, column: 9, scope: !1821)
!1828 = !DILocation(line: 102, column: 51, scope: !1780)
!1829 = !DILocation(line: 102, column: 56, scope: !1780)
!1830 = !DILocation(line: 102, column: 61, scope: !1780)
!1831 = !DILocation(line: 102, column: 68, scope: !1780)
!1832 = !DILocation(line: 102, column: 71, scope: !1780)
!1833 = !DILocation(line: 102, column: 25, scope: !1780)
!1834 = !DILocation(line: 102, column: 5, scope: !1780)
!1835 = !DILocation(line: 102, column: 12, scope: !1780)
!1836 = !DILocation(line: 102, column: 23, scope: !1780)
!1837 = !DILocation(line: 103, column: 30, scope: !1838)
!1838 = distinct !DILexicalBlock(scope: !1780, file: !904, line: 103, column: 9)
!1839 = !DILocation(line: 103, column: 37, scope: !1838)
!1840 = !DILocation(line: 103, column: 16, scope: !1838)
!1841 = !DILocation(line: 103, column: 14, scope: !1838)
!1842 = !DILocation(line: 103, column: 48, scope: !1838)
!1843 = !DILocation(line: 103, column: 9, scope: !1780)
!1844 = !DILocation(line: 104, column: 16, scope: !1838)
!1845 = !DILocation(line: 104, column: 9, scope: !1838)
!1846 = !DILocation(line: 105, column: 22, scope: !1780)
!1847 = !DILocation(line: 105, column: 29, scope: !1780)
!1848 = !DILocation(line: 105, column: 11, scope: !1780)
!1849 = !DILocation(line: 105, column: 9, scope: !1780)
!1850 = !DILocation(line: 107, column: 12, scope: !1792)
!1851 = !DILocation(line: 107, column: 10, scope: !1792)
!1852 = !DILocation(line: 107, column: 17, scope: !1853)
!1853 = !DILexicalBlockFile(scope: !1791, file: !904, discriminator: 1)
!1854 = !DILocation(line: 107, column: 21, scope: !1853)
!1855 = !DILocation(line: 107, column: 28, scope: !1853)
!1856 = !DILocation(line: 107, column: 19, scope: !1853)
!1857 = !DILocation(line: 107, column: 5, scope: !1853)
!1858 = !DILocalVariable(name: "v", scope: !1790, file: !904, line: 108, type: !1444)
!1859 = !DILocation(line: 108, column: 23, scope: !1790)
!1860 = !DILocation(line: 108, column: 43, scope: !1790)
!1861 = !DILocation(line: 108, column: 32, scope: !1790)
!1862 = !DILocation(line: 108, column: 35, scope: !1790)
!1863 = !DILocation(line: 108, column: 28, scope: !1790)
!1864 = !DILocation(line: 110, column: 12, scope: !1789)
!1865 = !DILocation(line: 110, column: 15, scope: !1789)
!1866 = !DILocation(line: 110, column: 12, scope: !1790)
!1867 = !DILocation(line: 111, column: 38, scope: !1868)
!1868 = distinct !DILexicalBlock(scope: !1789, file: !904, line: 110, column: 25)
!1869 = !DILocation(line: 111, column: 43, scope: !1868)
!1870 = !DILocation(line: 111, column: 53, scope: !1868)
!1871 = !DILocation(line: 111, column: 58, scope: !1868)
!1872 = !DILocation(line: 111, column: 64, scope: !1868)
!1873 = !DILocation(line: 111, column: 49, scope: !1868)
!1874 = !DILocation(line: 111, column: 37, scope: !1868)
!1875 = !DILocation(line: 111, column: 21, scope: !1868)
!1876 = !DILocation(line: 111, column: 16, scope: !1868)
!1877 = !DILocation(line: 111, column: 19, scope: !1868)
!1878 = !DILocation(line: 112, column: 38, scope: !1868)
!1879 = !DILocation(line: 112, column: 43, scope: !1868)
!1880 = !DILocation(line: 112, column: 53, scope: !1868)
!1881 = !DILocation(line: 112, column: 58, scope: !1868)
!1882 = !DILocation(line: 112, column: 64, scope: !1868)
!1883 = !DILocation(line: 112, column: 49, scope: !1868)
!1884 = !DILocation(line: 112, column: 37, scope: !1868)
!1885 = !DILocation(line: 112, column: 21, scope: !1868)
!1886 = !DILocation(line: 112, column: 16, scope: !1868)
!1887 = !DILocation(line: 112, column: 19, scope: !1868)
!1888 = !DILocation(line: 113, column: 8, scope: !1868)
!1889 = !DILocation(line: 114, column: 65, scope: !1788)
!1890 = !DILocation(line: 114, column: 73, scope: !1788)
!1891 = !DILocation(line: 114, column: 21, scope: !1788)
!1892 = !DILocation(line: 60, column: 9, scope: !1782, inlinedAt: !1794)
!1893 = !DILocation(line: 60, column: 10, scope: !1782, inlinedAt: !1794)
!1894 = !DILocation(line: 60, column: 18, scope: !1782, inlinedAt: !1794)
!1895 = !DILocation(line: 60, column: 19, scope: !1782, inlinedAt: !1794)
!1896 = !DILocation(line: 60, column: 15, scope: !1782, inlinedAt: !1794)
!1897 = !DILocation(line: 60, column: 8, scope: !1782, inlinedAt: !1794)
!1898 = !DILocation(line: 60, column: 6, scope: !1782, inlinedAt: !1794)
!1899 = !DILocation(line: 61, column: 12, scope: !1782, inlinedAt: !1794)
!1900 = !DILocation(line: 114, column: 16, scope: !1788)
!1901 = !DILocation(line: 114, column: 19, scope: !1788)
!1902 = !DILocation(line: 115, column: 67, scope: !1788)
!1903 = !DILocation(line: 115, column: 70, scope: !1788)
!1904 = !DILocation(line: 115, column: 65, scope: !1788)
!1905 = !DILocation(line: 115, column: 95, scope: !1788)
!1906 = !DILocation(line: 115, column: 21, scope: !1788)
!1907 = !DILocation(line: 60, column: 9, scope: !1782, inlinedAt: !1787)
!1908 = !DILocation(line: 60, column: 10, scope: !1782, inlinedAt: !1787)
!1909 = !DILocation(line: 60, column: 18, scope: !1782, inlinedAt: !1787)
!1910 = !DILocation(line: 60, column: 19, scope: !1782, inlinedAt: !1787)
!1911 = !DILocation(line: 60, column: 15, scope: !1782, inlinedAt: !1787)
!1912 = !DILocation(line: 60, column: 8, scope: !1782, inlinedAt: !1787)
!1913 = !DILocation(line: 60, column: 6, scope: !1782, inlinedAt: !1787)
!1914 = !DILocation(line: 61, column: 12, scope: !1782, inlinedAt: !1787)
!1915 = !DILocation(line: 115, column: 16, scope: !1788)
!1916 = !DILocation(line: 115, column: 19, scope: !1788)
!1917 = !DILocation(line: 117, column: 5, scope: !1790)
!1918 = !DILocation(line: 107, column: 41, scope: !1919)
!1919 = !DILexicalBlockFile(scope: !1791, file: !904, discriminator: 2)
!1920 = !DILocation(line: 107, column: 5, scope: !1919)
!1921 = distinct !{!1921, !1922}
!1922 = !DILocation(line: 107, column: 5, scope: !1780)
!1923 = !DILocation(line: 119, column: 6, scope: !1780)
!1924 = !DILocation(line: 119, column: 20, scope: !1780)
!1925 = !DILocation(line: 121, column: 12, scope: !1780)
!1926 = !DILocation(line: 121, column: 15, scope: !1780)
!1927 = !DILocation(line: 121, column: 5, scope: !1780)
!1928 = !DILocation(line: 122, column: 1, scope: !1780)
!1929 = distinct !DISubprogram(name: "dv_get_audio_sample_count", scope: !1930, file: !1930, line: 24, type: !1931, isLocal: true, isDefinition: true, scopeLine: 25, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1637)
!1930 = !DIFile(filename: "libavcodec/dvaudio.h", directory: "/home/ubuntu_1604/Desktop/ffmped_bcmake_outputs/[lib]libavcodec--libavcodec.a")
!1931 = !DISubroutineType(types: !1932)
!1932 = !{!888, !1444, !888}
!1933 = !DILocalVariable(name: "buffer", arg: 1, scope: !1929, file: !1930, line: 24, type: !1444)
!1934 = !DILocation(line: 24, column: 60, scope: !1929)
!1935 = !DILocalVariable(name: "dsf", arg: 2, scope: !1929, file: !1930, line: 24, type: !888)
!1936 = !DILocation(line: 24, column: 72, scope: !1929)
!1937 = !DILocalVariable(name: "samples", scope: !1929, file: !1930, line: 26, type: !888)
!1938 = !DILocation(line: 26, column: 9, scope: !1929)
!1939 = !DILocation(line: 26, column: 19, scope: !1929)
!1940 = !DILocation(line: 26, column: 29, scope: !1929)
!1941 = !DILocation(line: 28, column: 14, scope: !1929)
!1942 = !DILocation(line: 28, column: 24, scope: !1929)
!1943 = !DILocation(line: 28, column: 30, scope: !1929)
!1944 = !DILocation(line: 28, column: 5, scope: !1929)
!1945 = !DILocation(line: 30, column: 16, scope: !1946)
!1946 = distinct !DILexicalBlock(scope: !1929, file: !1930, line: 28, column: 38)
!1947 = !DILocation(line: 30, column: 27, scope: !1946)
!1948 = !DILocation(line: 30, column: 24, scope: !1946)
!1949 = !DILocation(line: 30, column: 9, scope: !1946)
!1950 = !DILocation(line: 32, column: 16, scope: !1946)
!1951 = !DILocation(line: 32, column: 27, scope: !1946)
!1952 = !DILocation(line: 32, column: 24, scope: !1946)
!1953 = !DILocation(line: 32, column: 9, scope: !1946)
!1954 = !DILocation(line: 32, column: 9, scope: !1955)
!1955 = !DILexicalBlockFile(scope: !1946, file: !1930, discriminator: 1)
!1956 = !DILocation(line: 35, column: 16, scope: !1946)
!1957 = !DILocation(line: 35, column: 27, scope: !1946)
!1958 = !DILocation(line: 35, column: 24, scope: !1946)
!1959 = !DILocation(line: 35, column: 9, scope: !1946)
!1960 = !DILocation(line: 37, column: 1, scope: !1929)
!1961 = distinct !DISubprogram(name: "dv_audio_12to16", scope: !904, file: !904, line: 70, type: !1784, isLocal: true, isDefinition: true, scopeLine: 71, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !1637)
!1962 = !DILocalVariable(name: "sample", arg: 1, scope: !1961, file: !904, line: 70, type: !900)
!1963 = !DILocation(line: 70, column: 49, scope: !1961)
!1964 = !DILocalVariable(name: "shift", scope: !1961, file: !904, line: 72, type: !900)
!1965 = !DILocation(line: 72, column: 14, scope: !1961)
!1966 = !DILocalVariable(name: "result", scope: !1961, file: !904, line: 72, type: !900)
!1967 = !DILocation(line: 72, column: 21, scope: !1961)
!1968 = !DILocation(line: 74, column: 15, scope: !1961)
!1969 = !DILocation(line: 74, column: 22, scope: !1961)
!1970 = !DILocation(line: 74, column: 14, scope: !1961)
!1971 = !DILocation(line: 74, column: 33, scope: !1972)
!1972 = !DILexicalBlockFile(scope: !1961, file: !904, discriminator: 1)
!1973 = !DILocation(line: 74, column: 14, scope: !1972)
!1974 = !DILocation(line: 74, column: 42, scope: !1975)
!1975 = !DILexicalBlockFile(scope: !1961, file: !904, discriminator: 2)
!1976 = !DILocation(line: 74, column: 49, scope: !1975)
!1977 = !DILocation(line: 74, column: 14, scope: !1975)
!1978 = !DILocation(line: 74, column: 14, scope: !1979)
!1979 = !DILexicalBlockFile(scope: !1961, file: !904, discriminator: 3)
!1980 = !DILocation(line: 74, column: 12, scope: !1979)
!1981 = !DILocation(line: 75, column: 14, scope: !1961)
!1982 = !DILocation(line: 75, column: 21, scope: !1961)
!1983 = !DILocation(line: 75, column: 30, scope: !1961)
!1984 = !DILocation(line: 75, column: 13, scope: !1961)
!1985 = !DILocation(line: 75, column: 11, scope: !1961)
!1986 = !DILocation(line: 77, column: 9, scope: !1987)
!1987 = distinct !DILexicalBlock(scope: !1961, file: !904, line: 77, column: 9)
!1988 = !DILocation(line: 77, column: 15, scope: !1987)
!1989 = !DILocation(line: 77, column: 21, scope: !1987)
!1990 = !DILocation(line: 77, column: 24, scope: !1991)
!1991 = !DILexicalBlockFile(scope: !1987, file: !904, discriminator: 1)
!1992 = !DILocation(line: 77, column: 30, scope: !1991)
!1993 = !DILocation(line: 77, column: 9, scope: !1991)
!1994 = !DILocation(line: 78, column: 18, scope: !1995)
!1995 = distinct !DILexicalBlock(scope: !1987, file: !904, line: 77, column: 37)
!1996 = !DILocation(line: 78, column: 16, scope: !1995)
!1997 = !DILocation(line: 79, column: 5, scope: !1995)
!1998 = !DILocation(line: 79, column: 16, scope: !1999)
!1999 = !DILexicalBlockFile(scope: !2000, file: !904, discriminator: 1)
!2000 = distinct !DILexicalBlock(scope: !1987, file: !904, line: 79, column: 16)
!2001 = !DILocation(line: 79, column: 22, scope: !1999)
!2002 = !DILocation(line: 80, column: 14, scope: !2003)
!2003 = distinct !DILexicalBlock(scope: !2000, file: !904, line: 79, column: 29)
!2004 = !DILocation(line: 81, column: 19, scope: !2003)
!2005 = !DILocation(line: 81, column: 35, scope: !2003)
!2006 = !DILocation(line: 81, column: 33, scope: !2003)
!2007 = !DILocation(line: 81, column: 26, scope: !2003)
!2008 = !DILocation(line: 81, column: 46, scope: !2003)
!2009 = !DILocation(line: 81, column: 43, scope: !2003)
!2010 = !DILocation(line: 81, column: 18, scope: !2003)
!2011 = !DILocation(line: 81, column: 16, scope: !2003)
!2012 = !DILocation(line: 82, column: 5, scope: !2003)
!2013 = !DILocation(line: 83, column: 23, scope: !2014)
!2014 = distinct !DILexicalBlock(scope: !2000, file: !904, line: 82, column: 12)
!2015 = !DILocation(line: 83, column: 21, scope: !2014)
!2016 = !DILocation(line: 83, column: 17, scope: !2014)
!2017 = !DILocation(line: 83, column: 15, scope: !2014)
!2018 = !DILocation(line: 84, column: 20, scope: !2014)
!2019 = !DILocation(line: 84, column: 37, scope: !2014)
!2020 = !DILocation(line: 84, column: 35, scope: !2014)
!2021 = !DILocation(line: 84, column: 44, scope: !2014)
!2022 = !DILocation(line: 84, column: 27, scope: !2014)
!2023 = !DILocation(line: 84, column: 53, scope: !2014)
!2024 = !DILocation(line: 84, column: 50, scope: !2014)
!2025 = !DILocation(line: 84, column: 60, scope: !2014)
!2026 = !DILocation(line: 84, column: 18, scope: !2014)
!2027 = !DILocation(line: 84, column: 16, scope: !2014)
!2028 = !DILocation(line: 87, column: 12, scope: !1961)
!2029 = !DILocation(line: 87, column: 5, scope: !1961)
