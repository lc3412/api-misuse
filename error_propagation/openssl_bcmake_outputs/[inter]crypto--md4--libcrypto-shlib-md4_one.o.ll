; ModuleID = '/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[inter]crypto--md4--libcrypto-shlib-md4_one.o.i'
source_filename = "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[inter]crypto--md4--libcrypto-shlib-md4_one.o.i"
...
define i8* @MD4(i8* %d, i64 %n, i8* %md) #0 !dbg !7 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.MD4state_st* %c, metadata !31, metadata !25), !dbg !46
  %0 = load i8*, i8** %md.addr, align 8, !dbg !47
  %cmp = icmp eq i8* %0, null, !dbg !49
  br i1 %cmp, label %if.then, label %if.end, !dbg !50

if.then:                                          ; preds = %entry
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @MD4.m, i32 0, i32 0), i8** %md.addr, align 8, !dbg !51
  br label %if.end, !dbg !52

if.end:                                           ; preds = %if.then, %entry
  %call = call i32 @MD4_Init(%struct.MD4state_st* %c), !dbg !53
...
if.end2:                                          ; preds = %if.end
  ...
  %call3 = call i32 @MD4_Update(%struct.MD4state_st* %c, i8* %1, i64 %2), !dbg !59
  %3 = load i8*, i8** %md.addr, align 8, !dbg !60
  %call4 = call i32 @MD4_Final(i8* %3, %struct.MD4state_st* %c), !dbg !61
  %4 = bitcast %struct.MD4state_st* %c to i8*, !dbg !62
...
declare i32 @MD4_Init(%struct.MD4state_st*) #2

declare i32 @MD4_Update(%struct.MD4state_st*, i8*, i64) #2

declare i32 @MD4_Final(i8*, %struct.MD4state_st*) #2
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[inter]crypto--md4--libcrypto-shlib-md4_one.o.i", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs")
!2 = !{}
!3 = !{!4}
!4 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64, align: 64)
!5 = !{!6}
!6 = distinct !DIGlobalVariable(name: "m", scope: !7, file: !8, line: 22, type: !18, isLocal: true, isDefinition: true, variable: [16 x i8]* @MD4.m)
!7 = distinct !DISubprogram(name: "MD4", scope: !8, file: !8, line: 19, type: !9, isLocal: false, isDefinition: true, scopeLine: 20, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!8 = !DIFile(filename: "crypto/md4/md4_one.c", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs")
...
!16 = !DIFile(filename: "/usr/lib/gcc/x86_64-linux-gnu/5/include/stddef.h", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs")
...
!32 = !DIDerivedType(tag: DW_TAG_typedef, name: "MD4_CTX", file: !33, line: 38, baseType: !34)
!33 = !DIFile(filename: "include/openssl/md4.h", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs")
!34 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "MD4state_st", file: !33, line: 33, size: 736, align: 32, elements: !35)
