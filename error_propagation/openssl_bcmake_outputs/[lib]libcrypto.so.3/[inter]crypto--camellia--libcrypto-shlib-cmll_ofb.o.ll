; ModuleID = '/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3/[inter]crypto--camellia--libcrypto-shlib-cmll_ofb.o.i'
source_filename = "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3/[inter]crypto--camellia--libcrypto-shlib-cmll_ofb.o.i"
...
define void @Camellia_ofb128_encrypt(i8* %in, i8* %out, i64 %length, %struct.camellia_key_st* %key, i8* %ivec, i32* %num) #0 !dbg !18 {
entry:
  ...
  %0 = load i8*, i8** %in.addr, align 8, !dbg !58
  %1 = load i8*, i8** %out.addr, align 8, !dbg !59
  %2 = load i64, i64* %length.addr, align 8, !dbg !60
  %3 = load %struct.camellia_key_st*, %struct.camellia_key_st** %key.addr, align 8, !dbg !61
  %4 = bitcast %struct.camellia_key_st* %3 to i8*, !dbg !61
  %5 = load i8*, i8** %ivec.addr, align 8, !dbg !62
  %6 = load i32*, i32** %num.addr, align 8, !dbg !63
  call void @CRYPTO_ofb128_encrypt(i8* %0, i8* %1, i64 %2, i8* %4, i8* %5, i32* %6, void (i8*, i8*, i8*)* bitcast (void (i8*, i8*, %struct.camellia_key_st*)* @Camellia_encrypt to void (i8*, i8*, i8*)*)), !dbg !64
  ret void, !dbg !65
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3/[inter]crypto--camellia--libcrypto-shlib-cmll_ofb.o.i", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3")
!2 = !{}
!3 = !{!4}
...
!18 = distinct !DISubprogram(name: "Camellia_ofb128_encrypt", scope: !19, file: !19, line: 18, type: !20, isLocal: false, isDefinition: true, scopeLine: 21, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!19 = !DIFile(filename: "crypto/camellia/cmll_ofb.c", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3")
!20 = !DISubroutineType(types: !21)
!21 = !{null, !9, !12, !22, !25, !12, !44}
...
!28 = !DIFile(filename: "include/openssl/camellia.h", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3")
...
!45 = !DILocalVariable(name: "in", arg: 1, scope: !18, file: !19, line: 18, type: !9)
!46 = !DIExpression()
!47 = !DILocation(line: 18, column: 51, scope: !18)
!48 = !DILocalVariable(name: "out", arg: 2, scope: !18, file: !19, line: 18, type: !12)
!49 = !DILocation(line: 18, column: 70, scope: !18)
!50 = !DILocalVariable(name: "length", arg: 3, scope: !18, file: !19, line: 19, type: !22)
!51 = !DILocation(line: 19, column: 37, scope: !18)
!52 = !DILocalVariable(name: "key", arg: 4, scope: !18, file: !19, line: 19, type: !25)
!53 = !DILocation(line: 19, column: 65, scope: !18)
!54 = !DILocalVariable(name: "ivec", arg: 5, scope: !18, file: !19, line: 20, type: !12)
!55 = !DILocation(line: 20, column: 45, scope: !18)
!56 = !DILocalVariable(name: "num", arg: 6, scope: !18, file: !19, line: 20, type: !44)
!57 = !DILocation(line: 20, column: 56, scope: !18)
!58 = !DILocation(line: 22, column: 27, scope: !18)
!59 = !DILocation(line: 22, column: 31, scope: !18)
!60 = !DILocation(line: 22, column: 36, scope: !18)
!61 = !DILocation(line: 22, column: 44, scope: !18)
!62 = !DILocation(line: 22, column: 49, scope: !18)
!63 = !DILocation(line: 22, column: 55, scope: !18)
!64 = !DILocation(line: 22, column: 5, scope: !18)
!65 = !DILocation(line: 24, column: 1, scope: !18)
