; ModuleID = '/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3/[inter]crypto--dsa--libcrypto-shlib-dsa_prn.o.i'
source_filename = "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3/[inter]crypto--dsa--libcrypto-shlib-dsa_prn.o.i"
...
define i32 @DSA_print_fp(%struct._IO_FILE* %fp, %struct.dsa_st* %x, i32 %off) #0 !dbg !14 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.dsa_st** %x.addr, metadata !83, metadata !81), !dbg !84
...
if.then:                                          ; preds = %entry
  call void @ERR_put_error(i32 10, i32 105, i32 7, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i32 0, i32 0), i32 22), !dbg !101
...
if.end:                                           ; preds = %entry
  ...
  %4 = load %struct.dsa_st*, %struct.dsa_st** %x.addr, align 8, !dbg !109
  %5 = load i32, i32* %off.addr, align 4, !dbg !110
  %call3 = call i32 @DSA_print(%struct.bio_st* %3, %struct.dsa_st* %4, i32 %5), !dbg !111
...
; Function Attrs: nounwind uwtable
define i32 @DSA_print(%struct.bio_st* %bp, %struct.dsa_st* %x, i32 %off) #0 !dbg !118 {
entry:
  %retval = alloca i32, align 4
  ...
  store %struct.dsa_st* %x, %struct.dsa_st** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.dsa_st** %x.addr, metadata !123, metadata !81), !dbg !124
  store i32 %off, i32* %off.addr, align 4
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %2 = load %struct.dsa_st*, %struct.dsa_st** %x.addr, align 8, !dbg !142
  %call1 = call i32 @EVP_PKEY_set1_DSA(%struct.evp_pkey_st* %1, %struct.dsa_st* %2), !dbg !143
...
; Function Attrs: nounwind uwtable
define i32 @DSAparams_print_fp(%struct._IO_FILE* %fp, %struct.dsa_st* %x) #0 !dbg !156 {
entry:
  %retval = alloca i32, align 4
  %fp.addr = alloca %struct._IO_FILE*, align 8
  %x.addr = alloca %struct.dsa_st*, align 8
  ...
  %ret = alloca i32, align 4
  store %struct._IO_FILE* %fp, %struct._IO_FILE** %fp.addr, align 8
  call void @llvm.dbg.declare(metadata %struct._IO_FILE** %fp.addr, metadata !159, metadata !81), !dbg !160
  store %struct.dsa_st* %x, %struct.dsa_st** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.dsa_st** %x.addr, metadata !161, metadata !81), !dbg !162
  call void @llvm.dbg.declare(metadata %struct.bio_st** %b, metadata !163, metadata !81), !dbg !164
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !165, metadata !81), !dbg !166
  %call = call %struct.bio_method_st* @BIO_s_file(), !dbg !167
  ...
  %cmp = icmp eq %struct.bio_st* %call1, null, !dbg !172
  br i1 %cmp, label %if.then, label %if.end, !dbg !173

if.then:                                          ; preds = %entry
  call void @ERR_put_error(i32 10, i32 101, i32 7, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i32 0, i32 0), i32 37), !dbg !174
  store i32 0, i32* %retval, align 4, !dbg !176
  br label %return, !dbg !176

if.end:                                           ; preds = %entry
  %0 = load %struct.bio_st*, %struct.bio_st** %b, align 8, !dbg !177
  %1 = load %struct._IO_FILE*, %struct._IO_FILE** %fp.addr, align 8, !dbg !178
  %2 = bitcast %struct._IO_FILE* %1 to i8*, !dbg !179
  %call2 = call i64 @BIO_ctrl(%struct.bio_st* %0, i32 106, i64 0, i8* %2), !dbg !180
  %3 = load %struct.bio_st*, %struct.bio_st** %b, align 8, !dbg !181
  %4 = load %struct.dsa_st*, %struct.dsa_st** %x.addr, align 8, !dbg !182
  %call3 = call i32 @DSAparams_print(%struct.bio_st* %3, %struct.dsa_st* %4), !dbg !183
  store i32 %call3, i32* %ret, align 4, !dbg !184
  %5 = load %struct.bio_st*, %struct.bio_st** %b, align 8, !dbg !185
  %call4 = call i32 @BIO_free(%struct.bio_st* %5), !dbg !186
  %6 = load i32, i32* %ret, align 4, !dbg !187
  store i32 %6, i32* %retval, align 4, !dbg !188
  br label %return, !dbg !188

return:                                           ; preds = %if.end, %if.then
  %7 = load i32, i32* %retval, align 4, !dbg !189
  ret i32 %7, !dbg !189
}

; Function Attrs: nounwind uwtable
define i32 @DSAparams_print(%struct.bio_st* %bp, %struct.dsa_st* %x) #0 !dbg !190 {
entry:
  %retval = alloca i32, align 4
  %bp.addr = alloca %struct.bio_st*, align 8
  %x.addr = alloca %struct.dsa_st*, align 8
  ...
  %ret = alloca i32, align 4
  store %struct.bio_st* %bp, %struct.bio_st** %bp.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.bio_st** %bp.addr, metadata !193, metadata !81), !dbg !194
  store %struct.dsa_st* %x, %struct.dsa_st** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.dsa_st** %x.addr, metadata !195, metadata !81), !dbg !196
  call void @llvm.dbg.declare(metadata %struct.evp_pkey_st** %pk, metadata !197, metadata !81), !dbg !198
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !199, metadata !81), !dbg !200
  %call = call %struct.evp_pkey_st* @EVP_PKEY_new(), !dbg !201
  store %struct.evp_pkey_st* %call, %struct.evp_pkey_st** %pk, align 8, !dbg !202
  %0 = load %struct.evp_pkey_st*, %struct.evp_pkey_st** %pk, align 8, !dbg !203
  %cmp = icmp eq %struct.evp_pkey_st* %0, null, !dbg !205
  br i1 %cmp, label %if.then, label %lor.lhs.false, !dbg !206

lor.lhs.false:                                    ; preds = %entry
  %1 = load %struct.evp_pkey_st*, %struct.evp_pkey_st** %pk, align 8, !dbg !207
  %2 = load %struct.dsa_st*, %struct.dsa_st** %x.addr, align 8, !dbg !209
  %call1 = call i32 @EVP_PKEY_set1_DSA(%struct.evp_pkey_st* %1, %struct.dsa_st* %2), !dbg !210
...
if.end:                                           ; preds = %lor.lhs.false
  %3 = load %struct.bio_st*, %struct.bio_st** %bp.addr, align 8, !dbg !213
  %4 = load %struct.evp_pkey_st*, %struct.evp_pkey_st** %pk, align 8, !dbg !214
  %call2 = call i32 @EVP_PKEY_print_params(%struct.bio_st* %3, %struct.evp_pkey_st* %4, i32 4, %struct.asn1_pctx_st* null), !dbg !215
  store i32 %call2, i32* %ret, align 4, !dbg !216
  %5 = load %struct.evp_pkey_st*, %struct.evp_pkey_st** %pk, align 8, !dbg !217
  call void @EVP_PKEY_free(%struct.evp_pkey_st* %5), !dbg !218
  %6 = load i32, i32* %ret, align 4, !dbg !219
  store i32 %6, i32* %retval, align 4, !dbg !220
  br label %return, !dbg !220

return:                                           ; preds = %if.end, %if.then
  %7 = load i32, i32* %retval, align 4, !dbg !221
  ret i32 %7, !dbg !221
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3/[inter]crypto--dsa--libcrypto-shlib-dsa_prn.o.i", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3")
!2 = !{}
!3 = !{!4, !5, !7}
...
!8 = !DIDerivedType(tag: DW_TAG_typedef, name: "DSA", file: !9, line: 111, baseType: !10)
...
!10 = !DICompositeType(tag: DW_TAG_structure_type, name: "dsa_st", file: !9, line: 111, flags: DIFlagFwdDecl)
!11 = !{i32 2, !"Dwarf Version", i32 4}
!12 = !{i32 2, !"Debug Info Version", i32 3}
!13 = !{!"clang version 3.9.0 (tags/RELEASE_390/final)"}
!14 = distinct !DISubprogram(name: "DSA_print_fp", scope: !15, file: !15, line: 16, type: !16, isLocal: false, isDefinition: true, scopeLine: 17, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!15 = !DIFile(filename: "crypto/dsa/dsa_prn.c", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3")
!16 = !DISubroutineType(types: !17)
!17 = !{!18, !19, !78, !18}
!18 = !DIBasicType(name: "int", size: 32, align: 32, encoding: DW_ATE_signed)
!19 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64, align: 64)
!20 = !DIDerivedType(tag: DW_TAG_typedef, name: "FILE", file: !21, line: 48, baseType: !22)
!21 = !DIFile(filename: "/usr/include/stdio.h", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3")
!22 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "_IO_FILE", file: !23, line: 241, size: 1728, align: 64, elements: !24)
!23 = !DIFile(filename: "/usr/include/libio.h", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3")
...
!50 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/bits/types.h", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3")
...
!71 = !DIFile(filename: "/usr/lib/gcc/x86_64-linux-gnu/5/include/stddef.h", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3")
...
!118 = distinct !DISubprogram(name: "DSA_print", scope: !15, file: !15, line: 47, type: !119, isLocal: false, isDefinition: true, scopeLine: 48, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!119 = !DISubroutineType(types: !120)
!120 = !{!18, !88, !78, !18}
!121 = !DILocalVariable(name: "bp", arg: 1, scope: !118, file: !15, line: 47, type: !88)
!122 = !DILocation(line: 47, column: 20, scope: !118)
!123 = !DILocalVariable(name: "x", arg: 2, scope: !118, file: !15, line: 47, type: !78)
!124 = !DILocation(line: 47, column: 35, scope: !118)
!125 = !DILocalVariable(name: "off", arg: 3, scope: !118, file: !15, line: 47, type: !18)
!126 = !DILocation(line: 47, column: 42, scope: !118)
!127 = !DILocalVariable(name: "pk", scope: !118, file: !15, line: 49, type: !128)
...
!131 = !DILocation(line: 49, column: 15, scope: !118)
!132 = !DILocalVariable(name: "ret", scope: !118, file: !15, line: 50, type: !18)
!133 = !DILocation(line: 50, column: 9, scope: !118)
!134 = !DILocation(line: 51, column: 10, scope: !118)
!135 = !DILocation(line: 51, column: 8, scope: !118)
!136 = !DILocation(line: 52, column: 9, scope: !137)
!137 = distinct !DILexicalBlock(scope: !118, file: !15, line: 52, column: 9)
!138 = !DILocation(line: 52, column: 12, scope: !137)
!139 = !DILocation(line: 52, column: 19, scope: !137)
!140 = !DILocation(line: 52, column: 41, scope: !141)
!141 = !DILexicalBlockFile(scope: !137, file: !15, discriminator: 1)
!142 = !DILocation(line: 52, column: 52, scope: !141)
!143 = !DILocation(line: 52, column: 23, scope: !141)
!144 = !DILocation(line: 52, column: 9, scope: !141)
!145 = !DILocation(line: 53, column: 9, scope: !137)
!146 = !DILocation(line: 54, column: 34, scope: !118)
!147 = !DILocation(line: 54, column: 38, scope: !118)
!148 = !DILocation(line: 54, column: 42, scope: !118)
!149 = !DILocation(line: 54, column: 11, scope: !118)
!150 = !DILocation(line: 54, column: 9, scope: !118)
!151 = !DILocation(line: 55, column: 19, scope: !118)
!152 = !DILocation(line: 55, column: 5, scope: !118)
!153 = !DILocation(line: 56, column: 12, scope: !118)
!154 = !DILocation(line: 56, column: 5, scope: !118)
!155 = !DILocation(line: 57, column: 1, scope: !118)
!156 = distinct !DISubprogram(name: "DSAparams_print_fp", scope: !15, file: !15, line: 31, type: !157, isLocal: false, isDefinition: true, scopeLine: 32, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!157 = !DISubroutineType(types: !158)
!158 = !{!18, !19, !78}
!159 = !DILocalVariable(name: "fp", arg: 1, scope: !156, file: !15, line: 31, type: !19)
!160 = !DILocation(line: 31, column: 30, scope: !156)
!161 = !DILocalVariable(name: "x", arg: 2, scope: !156, file: !15, line: 31, type: !78)
!162 = !DILocation(line: 31, column: 45, scope: !156)
!163 = !DILocalVariable(name: "b", scope: !156, file: !15, line: 33, type: !88)
!164 = !DILocation(line: 33, column: 10, scope: !156)
!165 = !DILocalVariable(name: "ret", scope: !156, file: !15, line: 34, type: !18)
!166 = !DILocation(line: 34, column: 9, scope: !156)
!167 = !DILocation(line: 36, column: 22, scope: !168)
!168 = distinct !DILexicalBlock(scope: !156, file: !15, line: 36, column: 9)
!169 = !DILocation(line: 36, column: 14, scope: !170)
!170 = !DILexicalBlockFile(scope: !168, file: !15, discriminator: 1)
!171 = !DILocation(line: 36, column: 12, scope: !168)
!172 = !DILocation(line: 36, column: 37, scope: !168)
!173 = !DILocation(line: 36, column: 9, scope: !156)
!174 = !DILocation(line: 37, column: 9, scope: !175)
!175 = distinct !DILexicalBlock(scope: !168, file: !15, line: 36, column: 45)
!176 = !DILocation(line: 38, column: 9, scope: !175)
!177 = !DILocation(line: 40, column: 14, scope: !156)
!178 = !DILocation(line: 40, column: 34, scope: !156)
!179 = !DILocation(line: 40, column: 25, scope: !156)
!180 = !DILocation(line: 40, column: 5, scope: !156)
!181 = !DILocation(line: 41, column: 27, scope: !156)
!182 = !DILocation(line: 41, column: 30, scope: !156)
!183 = !DILocation(line: 41, column: 11, scope: !156)
!184 = !DILocation(line: 41, column: 9, scope: !156)
!185 = !DILocation(line: 42, column: 14, scope: !156)
!186 = !DILocation(line: 42, column: 5, scope: !156)
!187 = !DILocation(line: 43, column: 12, scope: !156)
!188 = !DILocation(line: 43, column: 5, scope: !156)
!189 = !DILocation(line: 44, column: 1, scope: !156)
!190 = distinct !DISubprogram(name: "DSAparams_print", scope: !15, file: !15, line: 59, type: !191, isLocal: false, isDefinition: true, scopeLine: 60, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!191 = !DISubroutineType(types: !192)
!192 = !{!18, !88, !78}
!193 = !DILocalVariable(name: "bp", arg: 1, scope: !190, file: !15, line: 59, type: !88)
!194 = !DILocation(line: 59, column: 26, scope: !190)
!195 = !DILocalVariable(name: "x", arg: 2, scope: !190, file: !15, line: 59, type: !78)
!196 = !DILocation(line: 59, column: 41, scope: !190)
!197 = !DILocalVariable(name: "pk", scope: !190, file: !15, line: 61, type: !128)
!198 = !DILocation(line: 61, column: 15, scope: !190)
!199 = !DILocalVariable(name: "ret", scope: !190, file: !15, line: 62, type: !18)
!200 = !DILocation(line: 62, column: 9, scope: !190)
!201 = !DILocation(line: 63, column: 10, scope: !190)
!202 = !DILocation(line: 63, column: 8, scope: !190)
!203 = !DILocation(line: 64, column: 9, scope: !204)
!204 = distinct !DILexicalBlock(scope: !190, file: !15, line: 64, column: 9)
!205 = !DILocation(line: 64, column: 12, scope: !204)
!206 = !DILocation(line: 64, column: 19, scope: !204)
!207 = !DILocation(line: 64, column: 41, scope: !208)
!208 = !DILexicalBlockFile(scope: !204, file: !15, discriminator: 1)
!209 = !DILocation(line: 64, column: 52, scope: !208)
!210 = !DILocation(line: 64, column: 23, scope: !208)
!211 = !DILocation(line: 64, column: 9, scope: !208)
!212 = !DILocation(line: 65, column: 9, scope: !204)
!213 = !DILocation(line: 66, column: 33, scope: !190)
!214 = !DILocation(line: 66, column: 37, scope: !190)
!215 = !DILocation(line: 66, column: 11, scope: !190)
!216 = !DILocation(line: 66, column: 9, scope: !190)
!217 = !DILocation(line: 67, column: 19, scope: !190)
!218 = !DILocation(line: 67, column: 5, scope: !190)
!219 = !DILocation(line: 68, column: 12, scope: !190)
!220 = !DILocation(line: 68, column: 5, scope: !190)
!221 = !DILocation(line: 69, column: 1, scope: !190)
