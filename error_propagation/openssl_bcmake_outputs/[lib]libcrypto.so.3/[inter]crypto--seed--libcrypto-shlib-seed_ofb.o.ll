; ModuleID = '/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3/[inter]crypto--seed--libcrypto-shlib-seed_ofb.o.i'
source_filename = "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3/[inter]crypto--seed--libcrypto-shlib-seed_ofb.o.i"
...
define void @SEED_ofb128_encrypt(i8* %in, i8* %out, i64 %len, %struct.seed_key_st* %ks, i8* %ivec, i32* %num) #0 !dbg !18 {
entry:
  ...
  %1 = load i8*, i8** %out.addr, align 8, !dbg !52
  %2 = load i64, i64* %len.addr, align 8, !dbg !53
  %3 = load %struct.seed_key_st*, %struct.seed_key_st** %ks.addr, align 8, !dbg !54
  %4 = bitcast %struct.seed_key_st* %3 to i8*, !dbg !54
  %5 = load i8*, i8** %ivec.addr, align 8, !dbg !55
  %6 = load i32*, i32** %num.addr, align 8, !dbg !56
  call void @CRYPTO_ofb128_encrypt(i8* %0, i8* %1, i64 %2, i8* %4, i8* %5, i32* %6, void (i8*, i8*, i8*)* bitcast (void (i8*, i8*, %struct.seed_key_st*)* @SEED_encrypt to void (i8*, i8*, i8*)*)), !dbg !57
  ret void, !dbg !58
}
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3/[inter]crypto--seed--libcrypto-shlib-seed_ofb.o.i", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3")
!2 = !{}
!3 = !{!4}
...
!18 = distinct !DISubprogram(name: "SEED_ofb128_encrypt", scope: !19, file: !19, line: 13, type: !20, isLocal: false, isDefinition: true, scopeLine: 16, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!19 = !DIFile(filename: "crypto/seed/seed_ofb.c", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3")
...
!28 = !DIFile(filename: "include/openssl/seed.h", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3")
...
!51 = !DILocation(line: 17, column: 27, scope: !18)
!52 = !DILocation(line: 17, column: 31, scope: !18)
!53 = !DILocation(line: 17, column: 36, scope: !18)
!54 = !DILocation(line: 17, column: 41, scope: !18)
!55 = !DILocation(line: 17, column: 45, scope: !18)
!56 = !DILocation(line: 17, column: 51, scope: !18)
!57 = !DILocation(line: 17, column: 5, scope: !18)
!58 = !DILocation(line: 19, column: 1, scope: !18)
