; ModuleID = '/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3/[inter]crypto--pem--libcrypto-shlib-pem_x509.o.i'
source_filename = "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3/[inter]crypto--pem--libcrypto-shlib-pem_x509.o.i"
...
define %struct.x509_st* @PEM_read_bio_X509(%struct.bio_st* %bp, %struct.x509_st** %x, i32 (i8*, i32, i32, i8*)* %cb, i8* %u) #0 !dbg !26 {
entry:
  ...
  %call = call i8* @PEM_ASN1_read_bio(i8* (i8**, i8**, i64)* bitcast (%struct.x509_st* (%struct.x509_st**, i8**, i64)* @d2i_X509 to i8* (i8**, i8**, i64)*), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i32 0, i32 0), %struct.bio_st* %0, i8** %2, i32 (i8*, i32, i32, i8*)* %3, i8* %4), !dbg !59
...
; Function Attrs: nounwind uwtable
define %struct.x509_st* @PEM_read_X509(%struct._IO_FILE* %fp, %struct.x509_st** %x, i32 (i8*, i32, i32, i8*)* %cb, i8* %u) #0 !dbg !61 {
entry:
  ...
  %call = call i8* @PEM_ASN1_read(i8* (i8**, i8**, i64)* bitcast (%struct.x509_st* (%struct.x509_st**, i8**, i64)* @d2i_X509 to i8* (i8**, i8**, i64)*), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i32 0, i32 0), %struct._IO_FILE* %0, i8** %2, i32 (i8*, i32, i32, i8*)* %3, i8* %4), !dbg !135
...
; Function Attrs: nounwind uwtable
define i32 @PEM_write_bio_X509(%struct.bio_st* %bp, %struct.x509_st* %x) #0 !dbg !137 {
entry:
  %bp.addr = alloca %struct.bio_st*, align 8
  %x.addr = alloca %struct.x509_st*, align 8
  store %struct.bio_st* %bp, %struct.bio_st** %bp.addr, align 8
  ...
  %call = call i32 @PEM_ASN1_write_bio(i32 (i8*, i8**)* bitcast (i32 (%struct.x509_st*, i8**)* @i2d_X509 to i32 (i8*, i8**)*), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i32 0, i32 0), %struct.bio_st* %0, i8* %2, %struct.evp_cipher_st* null, i8* null, i32 0, i32 (i8*, i32, i32, i8*)* null, i8* null), !dbg !146
...
; Function Attrs: nounwind uwtable
define i32 @PEM_write_X509(%struct._IO_FILE* %fp, %struct.x509_st* %x) #0 !dbg !148 {
entry:
  %fp.addr = alloca %struct._IO_FILE*, align 8
  %x.addr = alloca %struct.x509_st*, align 8
  store %struct._IO_FILE* %fp, %struct._IO_FILE** %fp.addr, align 8
  ...
  %call = call i32 @PEM_ASN1_write(i32 (i8*, i8**)* bitcast (i32 (%struct.x509_st*, i8**)* @i2d_X509 to i32 (i8*, i8**)*), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i32 0, i32 0), %struct._IO_FILE* %0, i8* %2, %struct.evp_cipher_st* null, i8* null, i32 0, i32 (i8*, i32, i32, i8*)* null, i8* null), !dbg !157
...
!1 = !DIFile(filename: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3/[inter]crypto--pem--libcrypto-shlib-pem_x509.o.i", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3")
!2 = !{}
!3 = !{!4, !10, !16, !9}
...
!26 = distinct !DISubprogram(name: "PEM_read_bio_X509", scope: !27, file: !27, line: 18, type: !28, isLocal: false, isDefinition: true, scopeLine: 18, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!27 = !DIFile(filename: "crypto/pem/pem_x509.c", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3")
!28 = !DISubroutineType(types: !29)
!29 = !{!30, !34, !37, !38, !9}
!30 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !31, size: 64, align: 64)
!31 = !DIDerivedType(tag: DW_TAG_typedef, name: "X509", file: !32, line: 124, baseType: !33)
!32 = !DIFile(filename: "include/openssl/ossl_typ.h", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3")
...
!40 = !DIFile(filename: "include/openssl/pem.h", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3")
...
!46 = !DIExpression()
!47 = !DILocation(line: 18, column: 30, scope: !26)
!48 = !DILocalVariable(name: "x", arg: 2, scope: !26, file: !27, line: 18, type: !37)
!49 = !DILocation(line: 18, column: 41, scope: !26)
!50 = !DILocalVariable(name: "cb", arg: 3, scope: !26, file: !27, line: 18, type: !38)
!51 = !DILocation(line: 18, column: 61, scope: !26)
!52 = !DILocalVariable(name: "u", arg: 4, scope: !26, file: !27, line: 18, type: !9)
!53 = !DILocation(line: 18, column: 71, scope: !26)
!54 = !DILocation(line: 18, column: 139, scope: !26)
!55 = !DILocation(line: 18, column: 151, scope: !26)
!56 = !DILocation(line: 18, column: 142, scope: !26)
!57 = !DILocation(line: 18, column: 153, scope: !26)
!58 = !DILocation(line: 18, column: 156, scope: !26)
!59 = !DILocation(line: 18, column: 82, scope: !26)
!60 = !DILocation(line: 18, column: 75, scope: !26)
!61 = distinct !DISubprogram(name: "PEM_read_X509", scope: !27, file: !27, line: 18, type: !62, isLocal: false, isDefinition: true, scopeLine: 18, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!62 = !DISubroutineType(types: !63)
!63 = !{!30, !64, !37, !38, !9}
!64 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !65, size: 64, align: 64)
!65 = !DIDerivedType(tag: DW_TAG_typedef, name: "FILE", file: !66, line: 48, baseType: !67)
!66 = !DIFile(filename: "/usr/include/stdio.h", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3")
!67 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "_IO_FILE", file: !68, line: 241, size: 1728, align: 64, elements: !69)
!68 = !DIFile(filename: "/usr/include/libio.h", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3")
...
!95 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/bits/types.h", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3")
...
!115 = !DIFile(filename: "/usr/lib/gcc/x86_64-linux-gnu/5/include/stddef.h", directory: "/home/ubuntu_1604/Desktop/openssl_bcmake_outputs/[lib]libcrypto.so.3")
...
!123 = !DILocation(line: 18, column: 188, scope: !61)
!124 = !DILocalVariable(name: "x", arg: 2, scope: !61, file: !27, line: 18, type: !37)
!125 = !DILocation(line: 18, column: 199, scope: !61)
!126 = !DILocalVariable(name: "cb", arg: 3, scope: !61, file: !27, line: 18, type: !38)
!127 = !DILocation(line: 18, column: 219, scope: !61)
!128 = !DILocalVariable(name: "u", arg: 4, scope: !61, file: !27, line: 18, type: !9)
!129 = !DILocation(line: 18, column: 229, scope: !61)
!130 = !DILocation(line: 18, column: 293, scope: !61)
!131 = !DILocation(line: 18, column: 305, scope: !61)
!132 = !DILocation(line: 18, column: 296, scope: !61)
!133 = !DILocation(line: 18, column: 307, scope: !61)
!134 = !DILocation(line: 18, column: 310, scope: !61)
!135 = !DILocation(line: 18, column: 240, scope: !61)
!136 = !DILocation(line: 18, column: 233, scope: !61)
!137 = distinct !DISubprogram(name: "PEM_write_bio_X509", scope: !27, file: !27, line: 18, type: !138, isLocal: false, isDefinition: true, scopeLine: 18, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!138 = !DISubroutineType(types: !139)
!139 = !{!20, !34, !30}
!140 = !DILocalVariable(name: "bp", arg: 1, scope: !137, file: !27, line: 18, type: !34)
!141 = !DILocation(line: 18, column: 344, scope: !137)
!142 = !DILocalVariable(name: "x", arg: 2, scope: !137, file: !27, line: 18, type: !30)
!143 = !DILocation(line: 18, column: 354, scope: !137)
!144 = !DILocation(line: 18, column: 423, scope: !137)
!145 = !DILocation(line: 18, column: 426, scope: !137)
!146 = !DILocation(line: 18, column: 366, scope: !137)
!147 = !DILocation(line: 18, column: 359, scope: !137)
!148 = distinct !DISubprogram(name: "PEM_write_X509", scope: !27, file: !27, line: 18, type: !149, isLocal: false, isDefinition: true, scopeLine: 18, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!149 = !DISubroutineType(types: !150)
!150 = !{!20, !64, !30}
!151 = !DILocalVariable(name: "fp", arg: 1, scope: !148, file: !27, line: 18, type: !64)
!152 = !DILocation(line: 18, column: 31, scope: !148)
!153 = !DILocalVariable(name: "x", arg: 2, scope: !148, file: !27, line: 18, type: !30)
!154 = !DILocation(line: 18, column: 41, scope: !148)
!155 = !DILocation(line: 18, column: 106, scope: !148)
!156 = !DILocation(line: 18, column: 109, scope: !148)
!157 = !DILocation(line: 18, column: 53, scope: !148)
!158 = !DILocation(line: 18, column: 46, scope: !148)
